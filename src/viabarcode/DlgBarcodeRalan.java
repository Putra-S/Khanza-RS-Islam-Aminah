            ...
            if (Sequel.cariRegistrasi(NoRawat.getText()) > 0) {
                ...
                for (i = 0; i < tbTindakan.getRowCount(); i++) {
                    if (tbTindakan.getValueAt(i, 0).toString().equals("true")) {
                        if (Sequel.menyimpantf2("rawat_jl_dr",
                                "?,?,?,?,?,?,?,?,?,?,?,'Belum'", "Tindakan", 11,
                                new String[]{
                                    NoRawat.getText(), tbTindakan.getValueAt(i,
                                    1).toString(), kd_dokter,
                ...
                if (sukses == true) {
                    ...
                    if (ttlpendapatan > 0) {
                        ...
                        Sequel.menyimpan("tampjurnal",
                                "'" + Tindakan_Ralan + "','Pendapatan Tindakan Rawat Jalan','0','" + ttlpendapatan + "'",
                    ...
                    sukses = jur.simpanJurnal(NoRawat.getText(), "U",
                            "TINDAKAN RAWAT JALAN PASIEN " + NoRawat.getText() + " DIPOSTING OLEH " + akses.
                            getkode());
                }
                                                ...
                                                if (aktifkanbatch.equals("yes")) {
                                                    ...
                                                    Sequel.menyimpan(
                                                            ...
                                                            "kode_brng='" + tbObat.
                                                                    getValueAt(i,
                                                                            2).
                                                                    toString() + "' and kd_bangsal='" + bangsal + "' and no_batch='" + tbObat.
                                                                    getValueAt(i,
                                                                            12).
                ...
                if (sukses == true) {
                    ...
                    sukses = jur.simpanJurnal(NoRawat.getText(), "U",
                            "PEMBERIAN OBAT RAWAT JALAN PASIEN, DIPOSTING OLEH " + akses.
                                    getkode());
                }
