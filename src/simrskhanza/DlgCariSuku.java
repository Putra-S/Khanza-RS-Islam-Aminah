 ...
 * @author dosen
 */
public class DlgCariSuku extends javax.swing.JDialog {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    iyem = iyem + "{\"ID\":\"" + rs.getString(1) + "\",\"Suku\":\"" + rs.
                            getString(2) + "\"},";
                }
        ...
        try {
            ...
            if (response.isArray()) {
                if (TCari.getText().trim().isEmpty()) {
                    ...
                    for (JsonNode list : response) {
                        if (list.path("Suku").asText().toLowerCase().contains(
                                TCari.getText().toLowerCase())) {
                            tabMode.addRow(new Object[]{
                                list.path("ID").asText(), list.path("Suku").
                                asText()
                            });
                        }
                    }
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariSuku.class.
            getName());
}
