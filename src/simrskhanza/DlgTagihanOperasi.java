...
public class DlgTagihanOperasi extends javax.swing.JDialog {
    ...
    public DlgTagihanOperasi(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"P", "Kode Paket", "Nama Operasi", "Kategori",
            ...
            "dr Anak", "Perawat Resus", "dr Anastesi",
            "Asisten Anast 1", "Asisten Anast 2", "Bidan 1", "Bidan 2",
            "Bidan 3", "Perawat Luar", "Alat", "Sewa OK/VK",
        ...
        kdasistoperator1.setDocument(new batasInput((byte) 20).getKata(
                kdasistoperator1));
        kdasistoperator2.setDocument(new batasInput((byte) 20).getKata(
                kdasistoperator2));
        kdasistoperator3.setDocument(new batasInput((byte) 20).getKata(
                kdasistoperator3));
        ...
        kdasistanestesi.setDocument(new batasInput((byte) 20).getKata(
                kdasistanestesi));
        kdasistanestesi2.setDocument(new batasInput((byte) 20).getKata(
                kdasistanestesi2));
        ...
        if (koneksiDB.CARICEPAT().equals("aktif")) {
            TCariPaket.getDocument().addDocumentListener(
        ...
        try {
            psset_tarif = koneksi.prepareStatement(
                    "select set_tarif.cara_bayar_operasi,set_tarif.kelas_operasi from set_tarif");
            try {
                rsset_tarif = psset_tarif.executeQuery();
                if (rsset_tarif.next()) {
                    cara_bayar_operasi = rsset_tarif.getString(
                            "cara_bayar_operasi");
...
private void TNoRwKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TNoRwKeyPressed
    if (evt.getKeyCode() == KeyEvent.VK_PAGE_DOWN) {
        Sequel.cariIsi(
                "select concat(pasien.no_rkm_medis,', ',pasien.nm_pasien) from reg_periksa inner join pasien "
                + " on pasien.no_rkm_medis=reg_periksa.no_rkm_medis where reg_periksa.no_rawat=? ",
            ...
            try {
                ...
                if ((row != 0) || (row != 28)) {
                    if (tbtindakan.getSelectedRow() > -1) {
                        tbtindakan.setValueAt(true, tbtindakan.getSelectedRow(),
                                0);
                    }
                    TCariPaket.setText("");
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if (TNoRw.getText().trim().isEmpty() || TPasien.getText().trim().
        ...
        } else if (jenis.getText().trim().isEmpty()) {
            Valid.textKosong(jenis, "Jenis");
        } else if (kdoperator1.getText().trim().isEmpty() || nmoperator1.
                getText().trim().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null,
                    "Maaf, pilihan operasi kosong...!!!!");
            TCari.requestFocus();
        } else if (jml == 0) {
            JOptionPane.showMessageDialog(null,
                    "Maaf, silahkan pilih operasi...!!!!");
            TCari.requestFocus();
        } else {
            if (Sequel.cariRegistrasi(TNoRw.getText()) > 0) {
                ...
                for (i = 0; i < tbtindakan.getRowCount(); i++) {
                    if (tabMode.getValueAt(i, 0).toString().equals("true")) {
                        if (Sequel.menyimpantf2("operasi",
                                ...
                                tgl.getSelectedItem() + "") + " " + tgl.
                                getSelectedItem().toString().substring(11, 19)
                                + "','" + jenis.getText() + "','" + Kategori.
                                getSelectedItem() + "','" + kdoperator1.
                                        getText() + "','" + kdoperator2.
                                        getText() + "','" + kdoperator3.
                                        getText()
                                + "','" + kdasistoperator1.getText() + "','" + kdasistoperator2.
                                getText() + "','" + kdasistoperator3.getText() + "','" + kdInstrumen.
                                getText()
                                + "','" + kddranak.getText() + "','" + kdprwresust.
                                getText() + "','" + kdanestesi.getText() + "','" + kdasistanestesi.
                                getText() + "','" + kdasistanestesi2.getText()
                                + "','" + kdbidan.getText() + "','" + kdbidan2.
                                getText() + "','" + kdbidan3.getText() + "','" + kdprwluar.
                                getText()
                                + "','" + kdonloop1.getText() + "','" + kdonloop2.
                                getText() + "','" + kdonloop3.getText() + "','" + kdonloop4.
                                getText() + "','" + kdonloop5.getText()
                                + "','" + kdpjanak.getText() + "','" + kddrumum.
                                getText()
                                ...
                                + "','" + tbtindakan.getValueAt(i, 31).
                                        toString() + "','" + status + "'",
                                "data") == true) {
                            ttljmdokter = ttljmdokter + Double.parseDouble(
                                    tbtindakan.getValueAt(i, 4).toString())
                                    + Double.parseDouble(tbtindakan.
                            ...
                            ttljmpetugas = ttljmpetugas + Double.parseDouble(
                                    tbtindakan.getValueAt(i, 7).toString())
                                    + Double.parseDouble(tbtindakan.
                                    ...
                                    + Double.parseDouble(tbtindakan.
                                            getValueAt(i, 24).toString())
                                    + Double.parseDouble(tbtindakan.
                                            getValueAt(i, 25).toString())
                                    + Double.parseDouble(tbtindakan.
                                            getValueAt(i, 26).toString())
                                    + Double.parseDouble(tbtindakan.
                                            getValueAt(i, 27).toString())
                                    + Double.parseDouble(tbtindakan.
                ...
                if (sukses == true) {
                    for (int r = 0; r < tbObat.getRowCount(); r++) {
                        if (Valid.SetAngka(tbObat.getValueAt(r, 0).toString()) > 0) {
                            if (Sequel.menyimpantf2("beri_obat_operasi",
                                    "'" + TNoRw.getText() + "','" + Valid.
                                    SetTgl(tgl.getSelectedItem() + "") + " " + tgl.
                                    getSelectedItem().toString().substring(11,
                                            19)
                                    + "','" + tbObat.getValueAt(r, 1).toString() + "','" + tbObat.
                                    getValueAt(r, 4).toString()
                                    + "','" + tbObat.getValueAt(r, 0).toString() + "'",
                                    "data") == true) {
                                ttlbhp += Double.parseDouble(tbObat.
                ...
                if (sukses == true) {
                    if (!Laporan.getText().isEmpty()) {
                        if (Sequel.menyimpantf2("laporan_operasi",
                                "?,?,?,?,?,?,?,?", "laporan operasi", 8,
                                new String[]{
                                    TNoRw.getText(), Valid.SetTgl(tgl.
                                    getSelectedItem() + "") + " " + tgl.
                                            getSelectedItem().toString().
                                            substring(11, 19), PreOp.getText(),
                                    PostOp.getText(), Jaringan.getText(), Valid.
                                    SetTgl(tgl2.getSelectedItem() + "") + " " + tgl2.
                                    getSelectedItem().toString().substring(11,
                                            19),
                    ...
                    if (status.equals("Ranap")) {
                        ...
                        if (ttlpendapatan > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Suspen_Piutang_Operasi_Ranap + "','Suspen Piutang Operasi Ranap','" + ttlpendapatan + "','0'",
                                    "debet=debet+'" + (ttlpendapatan) + "'",
                                    "kd_rek='" + Suspen_Piutang_Operasi_Ranap + "'");
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Operasi_Ranap + "','Pendapatan Operasi Rawat Inap','0','" + ttlpendapatan + "'",
                                    "kredit=kredit+'" + (ttlpendapatan) + "'",
                                    "kd_rek='" + Operasi_Ranap + "'");
                        }
                        if (ttljmdokter > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Dokter_Operasi_Ranap + "','Beban Jasa Medik Dokter Operasi Ranap','" + ttljmdokter + "','0'",
                                    "debet=debet+'" + (ttljmdokter) + "'",
                                    "kd_rek='" + Beban_Jasa_Medik_Dokter_Operasi_Ranap + "'");
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Utang_Jasa_Medik_Dokter_Operasi_Ranap + "','Utang Jasa Medik Dokter Operasi Ranap','0','" + ttljmdokter + "'",
                                    "kredit=kredit+'" + (ttljmdokter) + "'",
                                    "kd_rek='" + Utang_Jasa_Medik_Dokter_Operasi_Ranap + "'");
                        }
                        if (ttljmpetugas > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Paramedis_Operasi_Ranap + "','Beban Jasa Medik Petugas Operasi Ranap','" + ttljmpetugas + "','0'",
                                    "debet=debet+'" + (ttljmpetugas) + "'",
                                    "kd_rek='" + Beban_Jasa_Medik_Paramedis_Operasi_Ranap + "'");
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Utang_Jasa_Medik_Paramedis_Operasi_Ranap + "','Utang Jasa Medik Petugas Operasi Ranap','0','" + ttljmpetugas + "'",
                                    "kredit=kredit+'" + (ttljmpetugas) + "'",
                                    "kd_rek='" + Utang_Jasa_Medik_Paramedis_Operasi_Ranap + "'");
                        }
                        if (ttlbhp > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + HPP_Obat_Operasi_Ranap + "','HPP Persediaan Operasi Rawat Inap','" + ttlbhp + "','0'",
                                    "debet=debet+'" + (ttlbhp) + "'",
                                    "kd_rek='" + HPP_Obat_Operasi_Ranap + "'");
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Persediaan_Obat_Kamar_Operasi_Ranap + "','Persediaan BHP Operasi Rawat Inap','0','" + ttlbhp + "'",
                                    "kredit=kredit+'" + (ttlbhp) + "'",
                                    "kd_rek='" + Persediaan_Obat_Kamar_Operasi_Ranap + "'");
                        }
                        sukses = jur.simpanJurnal(TNoRw.getText(), "U",
                                "OPERASI RAWAT INAP PASIEN " + TPasien.getText() + " DIPOSTING OLEH " + akses.
                                getkode());
                    } else if (status.equals("Ralan")) {
                        Sequel.queryu("delete from tampjurnal");
                        if (ttlpendapatan > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Suspen_Piutang_Operasi_Ralan + "','Suspen Piutang Operasi Ralan','" + ttlpendapatan + "','0'",
                                    "debet=debet+'" + (ttlpendapatan) + "'",
                                    "kd_rek='" + Suspen_Piutang_Operasi_Ralan + "'");
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Operasi_Ralan + "','Pendapatan Operasi Rawat Inap','0','" + ttlpendapatan + "'",
                                    "kredit=kredit+'" + (ttlpendapatan) + "'",
                                    "kd_rek='" + Operasi_Ralan + "'");
                        }
                        if (ttljmdokter > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Dokter_Operasi_Ralan + "','Beban Jasa Medik Dokter Operasi Ralan','" + ttljmdokter + "','0'",
                                    "debet=debet+'" + (ttljmdokter) + "'",
                                    "kd_rek='" + Beban_Jasa_Medik_Dokter_Operasi_Ralan + "'");
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Utang_Jasa_Medik_Dokter_Operasi_Ralan + "','Utang Jasa Medik Dokter Operasi Ralan','0','" + ttljmdokter + "'",
                                    "kredit=kredit+'" + (ttljmdokter) + "'",
                                    "kd_rek='" + Utang_Jasa_Medik_Dokter_Operasi_Ralan + "'");
                        }
                        if (ttljmpetugas > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Paramedis_Operasi_Ralan + "','Beban Jasa Medik Petugas Operasi Ralan','" + ttljmpetugas + "','0'",
                                    "debet=debet+'" + (ttljmpetugas) + "'",
                                    "kd_rek='" + Beban_Jasa_Medik_Paramedis_Operasi_Ralan + "'");
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Utang_Jasa_Medik_Paramedis_Operasi_Ralan + "','Utang Jasa Medik Petugas Operasi Ralan','0','" + ttljmpetugas + "'",
                                    "kredit=kredit+'" + (ttljmpetugas) + "'",
                                    "kd_rek='" + Utang_Jasa_Medik_Paramedis_Operasi_Ralan + "'");
                        }
                        if (ttlbhp > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + HPP_Obat_Operasi_Ralan + "','HPP Persediaan Operasi Rawat Jalan','" + ttlbhp + "','0'",
                                    "debet=debet+'" + (ttlbhp) + "'",
                                    "kd_rek='" + HPP_Obat_Operasi_Ralan + "'");
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Persediaan_Obat_Kamar_Operasi_Ralan + "','Persediaan BHP Operasi Rawat Jalan','0','" + ttlbhp + "'",
                                    "kredit=kredit+'" + (ttlbhp) + "'",
                                    "kd_rek='" + Persediaan_Obat_Kamar_Operasi_Ralan + "'");
                        }
                        sukses = jur.simpanJurnal(TNoRw.getText(), "U",
                                "OPERASI RAWAT JALAN PASIEN " + TPasien.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTagihanOperasi dialog = new DlgTagihanOperasi(
    ...
    private void tampil() {
        ...
        for (i = 0; i < tabMode.getRowCount(); i++) {
            if (tabMode.getValueAt(i, 0).toString().equals("true")) {
                ...
                operator1[index] = Double.parseDouble(tabMode.getValueAt(i, 4).
                        toString());
                operator2[index] = Double.parseDouble(tabMode.getValueAt(i, 5).
                        toString());
                operator3[index] = Double.parseDouble(tabMode.getValueAt(i, 6).
                        toString());
                asisten_operator1[index] = Double.parseDouble(tabMode.
                        getValueAt(i, 7).toString());
                asisten_operator2[index] = Double.parseDouble(tabMode.
                        getValueAt(i, 8).toString());
                asisten_operator3[index] = Double.parseDouble(tabMode.
                        getValueAt(i, 9).toString());
                instrumen[index] = Double.parseDouble(tabMode.getValueAt(i, 10).
                        toString());
                dokter_anak[index] = Double.parseDouble(tabMode.
                        getValueAt(i, 11).toString());
                perawaat_resusitas[index] = Double.parseDouble(tabMode.
                        getValueAt(i, 12).toString());
                dokter_anestesi[index] = Double.parseDouble(tabMode.
                        getValueAt(i, 13).toString());
                asisten_anestesi[index] = Double.parseDouble(tabMode.getValueAt(
                        i, 14).toString());
                asisten_anestesi2[index] = Double.parseDouble(tabMode.
                        getValueAt(i, 15).toString());
                bidan[index] = Double.parseDouble(tabMode.getValueAt(i, 16).
                        toString());
                bidan2[index] = Double.parseDouble(tabMode.getValueAt(i, 17).
                        toString());
                bidan3[index] = Double.parseDouble(tabMode.getValueAt(i, 18).
                        toString());
                perawat_luar[index] = Double.parseDouble(tabMode.getValueAt(i,
                        19).toString());
                alat[index] = Double.parseDouble(tabMode.getValueAt(i, 20).
                        toString());
                sewa_ok[index] = Double.parseDouble(tabMode.getValueAt(i, 21).
                        toString());
                akomodasi[index] = Double.parseDouble(tabMode.getValueAt(i, 22).
                        toString());
                bagian_rs[index] = Double.parseDouble(tabMode.getValueAt(i, 23).
                        toString());
                omloop[index] = Double.parseDouble(tabMode.getValueAt(i, 24).
                        toString());
                omloop2[index] = Double.parseDouble(tabMode.getValueAt(i, 25).
                        toString());
                omloop3[index] = Double.parseDouble(tabMode.getValueAt(i, 26).
                        toString());
                omloop4[index] = Double.parseDouble(tabMode.getValueAt(i, 27).
                        toString());
                omloop5[index] = Double.parseDouble(tabMode.getValueAt(i, 28).
                        toString());
                sarpras[index] = Double.parseDouble(tabMode.getValueAt(i, 29).
                        toString());
                dokter_pjanak[index] = Double.parseDouble(tabMode.getValueAt(i,
                        30).toString());
                dokter_umum[index] = Double.parseDouble(tabMode.
                        getValueAt(i, 31).toString());
                ttltindakan[index] = Double.parseDouble(tabMode.
                        getValueAt(i, 32).toString());
                index++;
            }
        }
        ...
        for (i = 0; i < jml; i++) {
            tabMode.addRow(
                    new Object[]{pilih[i], kode_paket[i], nm_perawatan[i],
                        kategori[i], operator1[i],
                        operator2[i], operator3[i], asisten_operator1[i],
                        asisten_operator2[i], asisten_operator3[i],
                        instrumen[i], dokter_anak[i], perawaat_resusitas[i],
                        dokter_anestesi[i],
                        asisten_anestesi[i], asisten_anestesi2[i], bidan[i],
                        bidan2[i], bidan3[i], perawat_luar[i],
                        alat[i], sewa_ok[i], akomodasi[i], bagian_rs[i],
                        omloop[i], omloop2[i],
                        omloop3[i], omloop4[i], omloop5[i], sarpras[i],
                        dokter_pjanak[i], dokter_umum[i], ttltindakan[i]
                    });
        }
        ...
        try {
            ...
            try {
                if (cara_bayar_operasi.equals("Yes") && kelas_operasi.equals(
                        "No")) {
    ...
    private void tampil2() {
        ...
        for (i = 0; i < tabMode2.getRowCount(); i++) {
            if (!tabMode2.getValueAt(i, 0).toString().isEmpty()) {
                jmlobat[index] = Double.parseDouble(tabMode2.getValueAt(i, 0).
                        toString());
                ...
                hargasatuan[index] = Double.parseDouble(tabMode2.
                        getValueAt(i, 4).toString());
                ttlobat[index] = Double.parseDouble(tabMode2.getValueAt(i, 5).
                        toString());
                index++;
            }
        }
        ...
        for (i = 0; i < jml; i++) {
            tabMode2.addRow(new Object[]{jmlobat[i], kd_obat[i], nm_obat[i],
                satuan[i], hargasatuan[i], ttlobat[i]});
        }

        try {
            psobat = koneksi.prepareStatement(
                    "select obatbhp_ok.kd_obat, obatbhp_ok.nm_obat, kodesatuan.satuan, "
        ...
        if (row != -1) {
            ...
            if ((kolom == 0) || (kolom == 1)) {
                if (!tbObat.getValueAt(row, 0).toString().isEmpty()) {
                    try {
                        tbObat.setValueAt(Valid.SetAngka2(Double.parseDouble(
                                tbObat.getValueAt(row, 0).toString()) * Double.
                                parseDouble(tbObat.getValueAt(row, 4).toString())),
                                row, 5);
                    } catch (Exception e) {
                        tbObat.setValueAt(0, row, 5);
                    }
                } else if (tbObat.getValueAt(row, 0).toString().isEmpty()) {
                    tbObat.setValueAt(0, row, 5);
                }
            }
            ...
            for (int r = 0; r < row2; r++) {
                if (!tbObat.getValueAt(r, 5).toString().isEmpty()) {
                    try {
                        y = Double.parseDouble(tbObat.getValueAt(r, 5).
                                toString());
                    } catch (Exception e) {
                        y = 0;
                    }
    ...
    private void getData2() {
        ...
        if (row != -1) {
            if (tbtindakan.getValueAt(tbtindakan.getSelectedRow(), 0).toString().
                    equals("true")) {
                try {
                    tbtindakan.setValueAt(Double.parseDouble(tbtindakan.
                            getValueAt(row, 4).toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 5).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 6).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 7).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 8).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 9).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 10).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 11).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 12).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 13).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 14).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 15).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 16).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 17).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 18).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 19).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 20).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 21).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 22).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 23).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 24).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 25).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 26).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 27).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 28).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 29).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 30).
                                    toString())
                            + Double.parseDouble(tbtindakan.getValueAt(row, 31).
                                    toString()), row, 32);
                } catch (Exception e) {
            ...
            for (int r = 0; r < row2; r++) {
                switch (tbtindakan.getValueAt(r, 0).toString()) {
                    case "true":
                        try {
                            y = Double.parseDouble(tbtindakan.getValueAt(r, 32).
                                    toString());
                        } catch (Exception e) {
                            y = 0;
                        }
     ...
     */
    public void setNoRm(String norm, String nama, String posisi,
            String KodeOperator, String NamaOperator) {
        TNoRw.setText(norm);
        TPasien.setText(nama);
        this.status = posisi;
        this.kd_pj = Sequel.cariIsi(
    ...
    public void SetCariOperasi(String Operasi, String kodedokter,
            String namadokter) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgTagihanOperasi.class.
            getName());
