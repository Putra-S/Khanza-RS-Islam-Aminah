...
public class DlgSpesialis extends javax.swing.JDialog {
    ...
    public DlgSpesialis(java.awt.Frame parent, boolean modal) {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select * from spesialis where kd_sps like ? " + "or nm_sps like ? order by kd_sps ");
    ...
    private static final Logger LOG = Logger.getLogger(DlgSpesialis.class.getName());
