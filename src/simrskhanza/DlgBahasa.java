...
public class DlgBahasa extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("bahasa_pasien", "'0','" + Nama.getText() + "'",
                    "Bahasa");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            if (tbkecamatan.getSelectedRow() != -1) {
                if (Sequel.meghapustf("bahasa_pasien", "id", tbkecamatan.
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from bahasa_pasien where nama_bahasa like ? ");
            try {
    ...
    private static final Logger LOG = Logger.
            getLogger(DlgBahasa.class.getName());
}
