...
public class DlgCariSpesialis extends javax.swing.JDialog {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    iyem = iyem + "{\"KodeSpesialis\":\"" + rs.getString(1) + "\",\"NamaSpesialis\":\""
                            + rs.getString(2) + "\"},";
                }
            ...
            if (response.isArray()) {
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{list.path("KodeSpesialis").asText(),
                            list.path("NamaSpesialis").asText()});
                    }
                } else {
                    for (JsonNode list : response) {
                        if (list.path("KodeSpesialis").asText().toLowerCase().contains(TCari.getText().toLowerCase())
                                || list.path("NamaSpesialis")
                                        .asText()
                                        .toLowerCase()
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariSpesialis.class.getName());
