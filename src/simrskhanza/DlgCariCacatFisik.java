 ...
 * @author dosen
 */
public class DlgCariCacatFisik extends javax.swing.JDialog {
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        ...
        cacatfisik.emptTeks();
        cacatfisik.isCek();
        cacatfisik.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariCacatFisik dialog = new DlgCariCacatFisik(
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    iyem = iyem + "{\"ID\":\"" + rs.getString(1) + "\",\"Cacat\":\"" + rs.
                            getString(2) + "\"},";
                }
            ...
            fileWriter.write("{\"cacatfisik\":[" + iyem.substring(0, iyem.
                    length() - 1) + "]}");
            fileWriter.flush();
            fileWriter.close();
            iyem = null;
                ...
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{
                            list.path("ID").asText(), list.path("Cacat").
                            asText()
                        });
                    }
                } else {
                    for (JsonNode list : response) {
                        if (list.path("Cacat").asText().toLowerCase().contains(
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariCacatFisik.class.
            getName());
}
