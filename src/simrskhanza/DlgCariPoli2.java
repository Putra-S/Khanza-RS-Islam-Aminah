...
public class DlgCariPoli2 extends javax.swing.JDialog {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    iyem = iyem + "{\"KodeUnit\":\"" + rs.getString(1) + "\",\"NamaUnit\":\"" + rs.getString(2)
                            + "\",\"RegistrasiBaru\":\"" + rs.getString(3) + "\",\"RegistrasiLama\":\""
                            + rs.getString(4) + "\"},";
                }
            ...
            if (response.isArray()) {
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{list.path("KodeUnit").asText(), list.path("NamaUnit").asText(),
                    ...
                    for (JsonNode list : response) {
                        if (list.path("KodeUnit").asText().toLowerCase().contains(TCari.getText().toLowerCase())
                            ...
                            tabMode
                                    .addRow(new Object[]{list.path("KodeUnit").asText(), list.path("NamaUnit").asText(),
                                list.path("RegistrasiBaru").asText(), list.path("RegistrasiLama").asText()});
                        }
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariPoli2.class.getName());
