 ...
 * @author dosen
 */
public class DlgCariPoli2 extends javax.swing.JDialog {
    ...
    public DlgCariPoli2(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Kode Unit", "Nama Unit", "Registrasi Baru",
            "Registrasi Lama"};
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPoli2 dialog = new DlgCariPoli2(new javax.swing.JFrame(),
                    true);
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    iyem = iyem + "{\"KodeUnit\":\"" + rs.getString(1) + "\",\"NamaUnit\":\"" + rs.
                            getString(2) + "\",\"RegistrasiBaru\":\"" + rs.
                            getString(3) + "\",\"RegistrasiLama\":\"" + rs.
                            getString(4) + "\"},";
                }
                ...
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{
                            list.path("KodeUnit").asText(), list.
                            path("NamaUnit").asText(), list.path(
                            "RegistrasiBaru").asText(), list.path(
                            "RegistrasiLama").asText()
                        });
                    }
                } else {
                    for (JsonNode list : response) {
                        if (list.path("KodeUnit").asText().toLowerCase().
                                contains(TCari.getText().toLowerCase()) || list.
                                path("NamaUnit").asText().toLowerCase().
                                contains(TCari.getText().toLowerCase())) {
                            tabMode.addRow(new Object[]{
                                list.path("KodeUnit").asText(), list.path(
                                "NamaUnit").asText(), list.
                                path("RegistrasiBaru").asText(), list.path(
                                "RegistrasiLama").asText()
                            });
                        }
                    }
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariPoli2.class.
            getName());
}
