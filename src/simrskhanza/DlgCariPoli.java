...
public class DlgCariPoli extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select * from poliklinik where poliklinik.status='1'");
            try {
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(
                            new Object[]{rs.getString(1), rs.getString(2),
                                Valid.SetAngka(rs.getDouble(3)), Valid.
                                SetAngka(rs.getDouble(4))});
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariPoli.class.
            getName());
}
