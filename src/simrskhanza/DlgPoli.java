...
private void NmKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmKeyPressed
    ...
    private void tampil(String order) {
        ...
        if (TCari.getText().isEmpty()) {
            ...
            sql = "select poliklinik.kd_poli,poliklinik.nm_poli,poliklinik.registrasi,poliklinik.registrasilama "
                    + "from poliklinik where poliklinik.status='1' and poliklinik.kd_poli like '%"
                    + TCari.getText().trim() + "%' or " + "poliklinik.status='1' and poliklinik.nm_poli like '%"
                    + TCari.getText().trim() + "%' " + order;
        }
        prosesCari(sql);
    }
    ...
    private void prosesCari(String sql) {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(
                            new Object[]{false, rs.getString(1), rs.getString(2), rs.getDouble(3), rs.getDouble(4)});
                }
    ...
    private void getData() {
        if (tbKamar.getSelectedRow() != -1) {
            ...
            ByLm.setText(
                    Valid.SetAngka2(Double.parseDouble(tbKamar.getValueAt(tbKamar.getSelectedRow(), 4).toString())));
        }
    }
