...
//        Valid.pindah(evt,TCari,BtnSimpan,TCari);
            ...
            if (response.isArray()) {
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{list.path("NamaKec").asText(), list.path("KodeKec").asText()});
                    }
                } else {
                    for (JsonNode list : response) {
                        if (list.path("NamaKec").asText().toLowerCase().contains(TCari.getText().toLowerCase())) {
                            tabMode
                                    .addRow(new Object[]{list.path("NamaKec").asText(), list.path("KodeKec").asText()});
                        }
                    }
                }
            }
    ...
    private static final Logger LOG = Logger.getLogger(DlgKecamatan.class.getName());
