...
//        Valid.pindah(evt,TCari,BtnSimpan,TCari);
            ...
            if (response.isArray()) {
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{list.path("NamaKel").asText(), list.path("KodeKel").asText()});
                    }
                } else {
                    for (JsonNode list : response) {
                        if (list.path("NamaKel").asText().toLowerCase().contains(TCari.getText().toLowerCase())) {
                            tabMode
                                    .addRow(new Object[]{list.path("NamaKel").asText(), list.path("KodeKel").asText()});
                        }
                    }
                }
            }
    ...
    private static final Logger LOG = Logger.getLogger(DlgKelurahan.class.getName());
