...
public class DlgBangsal extends javax.swing.JDialog {
    ...
    public DlgBangsal(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"P", "Kode Kamar",
            "Nama Kamar"}) {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("bangsal", "?,?,?", "Kode Kamar", 3,
                    new String[]{TKd.getText(), TNm.getText(), "1"}) == true) {
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbBangsal.getRowCount(); i++) {
            if (tbBangsal.getValueAt(i, 0).toString().equals("true")) {
                Sequel.mengedit("bangsal", "kd_bangsal='" + tbBangsal.
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbBangsal.getSelectedRow() > -1) {
                if (Sequel.mengedittf("bangsal", "kd_bangsal=?",
                        "nm_bangsal=?,kd_bangsal=?", 3, new String[]{TNm.
                                    getText(), TKd.getText(), tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 1).toString()}) == true) {
                    tabMode.
                            setValueAt(TKd.getText(), tbBangsal.getSelectedRow(),
                                    1);
                    tabMode.
                            setValueAt(TNm.getText(), tbBangsal.getSelectedRow(),
                                    2);
                    emptTeks();
                }
            }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from bangsal where status='1' and kd_bangsal like ? "
    ...
    private void getData() {
        if (tbBangsal.getSelectedRow() != -1) {
            TKd.setText(tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 1).
                    toString());
            TNm.setText(tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 2).
                    toString());
        }
    }
    ...
    private static final Logger LOG = Logger.getLogger(DlgBangsal.class.
            getName());
