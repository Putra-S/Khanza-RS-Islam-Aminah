...
public class DlgSatuanTNI extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("satuan_tni", "'0','" + Nama.getText() + "'",
                    "Satuan TNI");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            Sequel.meghapus("satuan_tni", "id", tbkecamatan.getValueAt(
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSatuanTNI dialog = new DlgSatuanTNI(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from satuan_tni where nama_satuan like ? ");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(DlgSatuanTNI.class.
            getName());
}
