...
public class DlgPangkatPolri extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("pangkat_polri", "'0','" + Nama.getText() + "'",
                    "Pangkat POLRI");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            if (tbkecamatan.getSelectedRow() != -1) {
                if (Sequel.meghapustf("pangkat_polri", "id", tbkecamatan.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPangkatPolri dialog = new DlgPangkatPolri(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from pangkat_polri where nama_pangkat like ? ");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(DlgPangkatPolri.class.
            getName());
}
