...
public class DlgGolonganPolri extends javax.swing.JDialog {
    ...
    public DlgGolonganPolri(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"ID",
            "Golongan POLRI"}) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("golongan_polri", "'0','" + Nama.getText() + "'",
                    "Golongan POLRI");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            if (tbkecamatan.getSelectedRow() != -1) {
                if (Sequel.meghapustf("golongan_polri", "id", tbkecamatan.
                        getValueAt(tbkecamatan.getSelectedRow(), 0).toString()) == true) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgGolonganPolri dialog = new DlgGolonganPolri(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from golongan_polri where nama_golongan like ? ");
            try {
    ...
    private void getData() {
        if (tbkecamatan.getSelectedRow() != -1) {
            Nama.setText(
                    tbkecamatan.getValueAt(tbkecamatan.getSelectedRow(), 1).
                            toString());
        }
    }
    ...
    private static final Logger LOG = Logger.getLogger(DlgGolonganPolri.class.
            getName());
}
