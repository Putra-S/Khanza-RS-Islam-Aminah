...
public class DlgObatOperasi extends javax.swing.JDialog {
    ...
    public DlgObatOperasi(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Kode", "Nama", "Satuan", "Harga"};
...
private void BtnSatuanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSatuanActionPerformed
    ...
    private void getData() {
        if (tbObat.getRowCount() != -1) {
            ...
            kdsat.setText(Sequel.cariIsi("select kode_sat from obatbhp_ok where kd_obat=?",
                    tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()));
    ...
    private static final Logger LOG = Logger.getLogger(DlgObatOperasi.class.getName());
