...
public class DlgCariCaraBayar extends javax.swing.JDialog {
    ...
    public DlgCariCaraBayar(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.", "Kode Asuransi", "Nama Asuransi",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariCaraBayar dialog = new DlgCariCaraBayar(
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                i = 1;
                while (rs.next()) {
                    tabMode.addRow(new Object[]{i, rs.getString(1), rs.
                ...
                if (TCari.getText().trim().isEmpty()) {
                    ...
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{
                            i, list.path("KodeAsuransi").asText(), list.path(
                            "NamaAsuransi").asText(), list.path(
                    ...
                    for (JsonNode list : response) {
                        if (list.path("KodeAsuransi").asText().toLowerCase().
                            ...
                            tabMode.addRow(new Object[]{
                                i, list.path("KodeAsuransi").asText(), list.
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariCaraBayar.class.
            getName());
}
