...
public class DlgSatuanPolri extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("satuan_polri", "'0','" + Nama.getText() + "'",
                    "Satuan POLRI");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            Sequel.meghapus("satuan_polri", "id", tbkecamatan.getValueAt(
                    tbkecamatan.getSelectedRow(), 0).toString());
            tampil();
            emptTeks();
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSatuanPolri dialog = new DlgSatuanPolri(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from satuan_polri where nama_satuan like ? ");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(DlgSatuanPolri.class.
            getName());
}
