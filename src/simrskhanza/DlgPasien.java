...
public class DlgPasien extends javax.swing.JDialog {
     ...
     *
     */
    public YaskiReferensiPropinsi propinsiref = new YaskiReferensiPropinsi(null,
            false);

    /**
     *
     */
    public YaskiReferensiKabupaten kabupatenref = new YaskiReferensiKabupaten(
            null, false);

    /**
     *
     */
    public YaskiReferensiKecamatan kecamatanref = new YaskiReferensiKecamatan(
            null, false);

    /**
     *
     */
    public YaskiReferensiKelurahan kelurahanref = new YaskiReferensiKelurahan(
            null, false);
    ...
    private String kdkel = "", kdkec = "", kdkab = "", kdprop = "", pengurutan = "", asalform = "", bulan = "", tahun = "", awalantahun = "", awalanbulan = "", posisitahun = "",
            ...
            kabupatenpj = "", propinsi = "", propinsipj = "", tampilkantni = Sequel.
                    cariIsi("select set_tni_polri.tampilkan_tni_polri from set_tni_polri");
    ...
    public DlgPasien(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "P", "No.R.M", "Nama Pasien", "No.SIM/KTP", "J.K.", "Tmp.Lahir",
            "Tgl.Lahir", "Nama Ibu", "Alamat",
            "G.D.", "Pekerjaan", "Stts.Nikah", "Agama", "Tgl.Daftar",
            "No.Telp/HP", "Umur", "Pendidikan",
            "Penanggung Jawab", "Nama Penanggung Jawab", "Asuransi/Askes",
            "No.Peserta", "Daftar", "Pekerjaan P.J.", "Alamat P.J.",
            "ID Suku", "Suku/Bangsa", "ID Bahasa", "Bahasa", "ID Peru",
            "Instansi/Perusahaan", "NIP/NRP", "Email",
            "Id Cacat", "Cacat Fisik", "kd_pj", "alamat", "nm_kel", "nm_kec",
            "nm_kab", "nm_prop", "alamatpj", "kelurahanpj",
        ...
        tabMode2 = new DefaultTableModel(null, new Object[]{
            ...
            "G.D.", "Pekerjaan", "Stts.Nikah", "Agama", "Tgl.Daftar",
            "No.Telp/HP", "Umur", "Pendidikan",
            "Keluarga", "Nama Keluarga", "Asuransi/Askes", "No.Peserta",
            "Daftar", "Pekerjaan P.J.", "Alamat P.J.",
            "ID Suku", "Suku/Bangsa", "ID Bahasa", "Bahasa", "ID Peru",
            "Instansi/Perusahaan", "Id Gol", "Golongan",
            "Id Kes", "Kesatuan", "Id Pang", "Pangkat", "id Jab", "Jabatan",
            "NIP/NRP", "Email", "Id Cacat", "Cacat Fisik"
        }) {
            Class[] types = new Class[]{
                java.lang.Boolean.class, java.lang.Object.class,
                java.lang.Object.class, java.lang.Object.class,
        ...
        TTlp.setDocument(new batasInput(40).getKata(TTlp));
        ...
        KabupatenPj.
                setDocument(new batasInput((byte) 60).getFilter(KabupatenPj));
        KecamatanPj.
                setDocument(new batasInput((byte) 60).getFilter(KecamatanPj));
        KelurahanPj.
                setDocument(new batasInput((byte) 60).getFilter(KelurahanPj));
        ...
        PasswordPasien.setDocument(new batasInput((byte) 50).getKata(
                PasswordPasien));
        ...
        posisitahun = Sequel.cariIsi(
                "select posisi_tahun_bulan from set_urut_no_rkm_medis");
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPasien")) {
                    if (penjab.getTable().getSelectedRow() != -1) {
                        Kdpnj.setText(penjab.getTable().getValueAt(penjab.
                                getTable().getSelectedRow(), 1).toString());
                        nmpnj.setText(penjab.getTable().getValueAt(penjab.
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPasien")) {
                    if (golongantni.getTable().getSelectedRow() != -1) {
                        kdgolongantni.setText(golongantni.getTable().getValueAt(
                                golongantni.getTable().getSelectedRow(), 0).
                                toString());
                        nmgolongantni.setText(golongantni.getTable().getValueAt(
                                golongantni.getTable().getSelectedRow(), 1).
                                toString());
                    }
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPasien")) {
                    if (jabatantni.getTable().getSelectedRow() != -1) {
                        kdjabatantni.setText(jabatantni.getTable().getValueAt(
                                jabatantni.getTable().getSelectedRow(), 0).
                                toString());
                        nmjabatantni.setText(jabatantni.getTable().getValueAt(
                                jabatantni.getTable().getSelectedRow(), 1).
                                toString());
                    }
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPasien")) {
                    if (satuantni.getTable().getSelectedRow() != -1) {
                        kdsatuantni.setText(satuantni.getTable().getValueAt(
                                satuantni.getTable().getSelectedRow(), 0).
                                toString());
                        nmsatuantni.setText(satuantni.getTable().getValueAt(
                                satuantni.getTable().getSelectedRow(), 1).
                                toString());
                    }
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPasien")) {
                    if (pangkattni.getTable().getSelectedRow() != -1) {
                        kdpangkattni.setText(pangkattni.getTable().getValueAt(
                                pangkattni.getTable().getSelectedRow(), 0).
                                toString());
                        nmpangkattni.setText(pangkattni.getTable().getValueAt(
                                pangkattni.getTable().getSelectedRow(), 1).
                                toString());
                    }
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPasien")) {
                    if (golonganpolri.getTable().getSelectedRow() != -1) {
                        kdgolonganpolri.setText(golonganpolri.getTable().
                                getValueAt(golonganpolri.getTable().
                                        getSelectedRow(), 0).toString());
                        nmgolonganpolri.setText(golonganpolri.getTable().
                                getValueAt(golonganpolri.getTable().
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPasien")) {
                    if (jabatanpolri.getTable().getSelectedRow() != -1) {
                        kdjabatanpolri.setText(jabatanpolri.getTable().
                                getValueAt(jabatanpolri.getTable().
                                        getSelectedRow(), 0).toString());
                        nmjabatanpolri.setText(jabatanpolri.getTable().
                                getValueAt(jabatanpolri.getTable().
                                        getSelectedRow(), 1).toString());
                    }
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPasien")) {
                    if (satuanpolri.getTable().getSelectedRow() != -1) {
                        kdsatuanpolri.setText(satuanpolri.getTable().getValueAt(
                                satuanpolri.getTable().getSelectedRow(), 0).
                                toString());
                        nmsatuanpolri.setText(satuanpolri.getTable().getValueAt(
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPasien")) {
                    if (pangkatpolri.getTable().getSelectedRow() != -1) {
                        kdpangkatpolri.setText(pangkatpolri.getTable().
                                getValueAt(pangkatpolri.getTable().
                                        getSelectedRow(), 0).toString());
                        nmpangkatpolri.setText(pangkatpolri.getTable().
                                getValueAt(pangkatpolri.getTable().
                                        getSelectedRow(), 1).toString());
                    }
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPasien")) {
                    if (bahasa.getTable().getSelectedRow() != -1) {
                        kdbahasa.setText(bahasa.getTable().getValueAt(bahasa.
                                getTable().getSelectedRow(), 0).toString());
                        nmbahasa.setText(bahasa.getTable().getValueAt(bahasa.
                                getTable().getSelectedRow(), 1).toString());
                    }
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPasien")) {
                    if (suku.getTable().getSelectedRow() != -1) {
                        kdsuku.setText(suku.getTable().getValueAt(suku.
                                getTable().getSelectedRow(), 0).toString());
                        nmsukubangsa.setText(suku.getTable().getValueAt(suku.
                                getTable().getSelectedRow(), 1).toString());
                    }
                    kdsuku.requestFocus();
                }
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPasien")) {
                    if (prop.getTable().getSelectedRow() != -1) {
                        switch (pilih) {
                            case 1:
                                Propinsi.setText(prop.getTable().getValueAt(
                                        prop.getTable().getSelectedRow(), 0).
                                        toString());
                                kdprop = prop.getTable().getValueAt(prop.
                                        getTable().getSelectedRow(), 1).
                                        toString();
                                Propinsi.requestFocus();
                                break;
                            case 2:
                                Propinsi2.setText(prop.getTable().getValueAt(
                                        prop.getTable().getSelectedRow(), 0).
                                        toString());
                                Propinsi2.requestFocus();
                                break;
                            case 3:
                                PropinsiPj.setText(prop.getTable().getValueAt(
                                        prop.getTable().getSelectedRow(), 0).
                                        toString());
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPasien")) {
                    if (kab.getTable().getSelectedRow() != -1) {
                        switch (pilih) {
                            case 1:
                                Kabupaten.setText(kab.getTable().getValueAt(kab.
                                        getTable().getSelectedRow(), 0).
                                        toString());
                                kdkab = kab.getTable().getValueAt(
                                        kab.getTable().getSelectedRow(), 1).
                                        toString();
                                Kabupaten.requestFocus();
                                break;
                            case 2:
                                Kabupaten2.setText(kab.getTable().getValueAt(
                                        kab.getTable().getSelectedRow(), 0).
                                        toString());
                                Kabupaten2.requestFocus();
                                break;
                            case 3:
                                KabupatenPj.setText(kab.getTable().getValueAt(
                                        kab.getTable().getSelectedRow(), 0).
                                        toString());
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPasien")) {
                    if (kec.getTable().getSelectedRow() != -1) {
                        switch (pilih) {
                            case 1:
                                Kecamatan.setText(kec.getTable().getValueAt(kec.
                                        getTable().getSelectedRow(), 0).
                                        toString());
                                kdkec = kec.getTable().getValueAt(
                                        kec.getTable().getSelectedRow(), 1).
                                        toString();
                                Kecamatan.requestFocus();
                                break;
                            case 2:
                                Kecamatan2.setText(kec.getTable().getValueAt(
                                        kec.getTable().getSelectedRow(), 0).
                                        toString());
                                Kecamatan2.requestFocus();
                                break;
                            case 3:
                                KecamatanPj.setText(kec.getTable().getValueAt(
                                        kec.getTable().getSelectedRow(), 0).
                                        toString());
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPasien")) {
                    if (kel.getTable().getSelectedRow() != -1) {
                        switch (pilih) {
                            case 1:
                                Kelurahan.setText(kel.getTable().getValueAt(kel.
                                        getTable().getSelectedRow(), 0).
                                        toString());
                                kdkel = kel.getTable().getValueAt(
                                        kel.getTable().getSelectedRow(), 1).
                                        toString();
                                Kelurahan.requestFocus();
                                break;
                            case 2:
                                Kelurahan2.setText(kel.getTable().getValueAt(
                                        kel.getTable().getSelectedRow(), 0).
                                        toString());
                                Kelurahan2.requestFocus();
                                break;
                            case 3:
                                KelurahanPj.setText(kel.getTable().getValueAt(
                                        kel.getTable().getSelectedRow(), 0).
                                        toString());
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPasien")) {
                    if (cacat.getTable().getSelectedRow() != -1) {
                        kdcacat.setText(cacat.getTable().getValueAt(cacat.
                                getTable().getSelectedRow(), 0).toString());
                        nmcacat.setText(cacat.getTable().getValueAt(cacat.
                                getTable().getSelectedRow(), 1).toString());
                    }
        ...
        propinsiref.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (propinsiref.getTable().getSelectedRow() != -1) {
                    KdProp.setText(propinsiref.getTable().getValueAt(
                            propinsiref.getTable().getSelectedRow(), 1).
                            toString());
                    kdprop = "";
                    switch (pilih) {
                        case 1:
                            Propinsi.setText(propinsiref.getTable().getValueAt(
                                    propinsiref.getTable().getSelectedRow(), 2).
                                    toString().toUpperCase());
                            break;
                        case 2:
                            PropinsiPj.setText(propinsiref.getTable().
                                    getValueAt(propinsiref.getTable().
        ...
        kabupatenref.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (kabupatenref.getTable().getSelectedRow() != -1) {
                    KdKab.setText(kabupatenref.getTable().getValueAt(
                            kabupatenref.getTable().getSelectedRow(), 1).
                            toString());
                    kdkab = "";
                    switch (pilih) {
                        case 1:
                            Kabupaten.setText(kabupatenref.getTable().
                                    getValueAt(kabupatenref.getTable().
                                            getSelectedRow(), 2).toString().
                                    toUpperCase());
                            break;
                        case 2:
                            KabupatenPj.setText(kabupatenref.getTable().
                                    getValueAt(kabupatenref.getTable().
                                            getSelectedRow(), 2).toString().
                                    toUpperCase());
                            break;
        ...
        kecamatanref.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (kecamatanref.getTable().getSelectedRow() != -1) {
                    KdKec.setText(kecamatanref.getTable().getValueAt(
                            kecamatanref.getTable().getSelectedRow(), 1).
                            toString());
                    kdkec = "";
                    switch (pilih) {
                        case 1:
                            Kecamatan.setText(kecamatanref.getTable().
                                    getValueAt(kecamatanref.getTable().
                                            getSelectedRow(), 2).toString().
                                    toUpperCase());
                            break;
                        case 2:
                            KecamatanPj.setText(kecamatanref.getTable().
                                    getValueAt(kecamatanref.getTable().
                                            getSelectedRow(), 2).toString().
                                    toUpperCase());
                            break;
        ...
        kelurahanref.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (kelurahanref.getTable().getSelectedRow() != -1) {
                    KdKel.setText(kelurahanref.getTable().getValueAt(
                            kelurahanref.getTable().getSelectedRow(), 1).
                            toString());
                    kdkel = "";
                    switch (pilih) {
                        case 1:
                            Kelurahan.setText(kelurahanref.getTable().
                                    getValueAt(kelurahanref.getTable().
                                            getSelectedRow(), 2).toString().
                                    toUpperCase());
                            break;
                        case 2:
                            KelurahanPj.setText(kelurahanref.getTable().
                                    getValueAt(kelurahanref.getTable().
                                            getSelectedRow(), 2).toString().
                                    toUpperCase());
                            break;
        ...
        try {
            pssetalamat = koneksi.prepareStatement(
                    "select * from set_alamat_pasien");
            try {
            ...
            pskelengkapan = koneksi.prepareStatement(
    ...
    private void initComponents() {
        ...
        ppBerkasDigital.setText("Berkas Digital Pasien");
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-10-2023" }));
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-10-2023" }));
        ...
        KecamatanPj.setDisabledTextColor(new java.awt.Color(204, 204, 204));
        ...
        KabupatenPj.setDisabledTextColor(new java.awt.Color(204, 204, 204));
        ...
        KelurahanPj.setDisabledTextColor(new java.awt.Color(204, 204, 204));
        ...
        TNoPeserta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TNoPesertaActionPerformed(evt);
            }
        });
        ...
        PropinsiPj.setDisabledTextColor(new java.awt.Color(204, 204, 204));
        ...
        Propinsi.setDisabledTextColor(new java.awt.Color(0, 0, 0));
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
    if (TNo.getText().trim().isEmpty()) {
        Valid.textKosong(TNo, "No.Rekam Medis");
    } else if (TNm.getText().trim().isEmpty()) {
        Valid.textKosong(TNm, "nama pasien");
    } else if (nmpnj.getText().trim().isEmpty() || Kdpnj.getText().trim().
            isEmpty()) {
        Valid.textKosong(Kdpnj, "Asuransi/Askes/Png.Jawab");
    } else if (no_ktp.equals("Yes") && (TKtp.getText().trim().length() < p_no_ktp)) {
        Valid.textKosong(TKtp,
                "No.KTP/SIM minimal " + p_no_ktp + " karakter dan ");
    } else if (tmp_lahir.equals("Yes") && (TTmp.getText().trim().length() < p_tmp_lahir)) {
        Valid.textKosong(TTmp,
                "Tempat Lahir minimal " + p_tmp_lahir + " karakter dan ");
    } else if (nm_ibu.equals("Yes") && (NmIbu.getText().trim().length() < p_nm_ibu)) {
        Valid.textKosong(NmIbu,
                "Nama Ibu minimal " + p_nm_ibu + " karakter dan ");
    } else if (alamat.equals("Yes") && (Alamat.getText().trim().length() < p_alamat)) {
        Valid.textKosong(Alamat,
                "Alamat Pasien minimal " + p_alamat + " karakter dan ");
    } else if (pekerjaan.equals("Yes") && (Pekerjaan.getText().trim().length() < p_pekerjaan)) {
        Valid.textKosong(Pekerjaan,
                "Pekerjaan Pasien minimal " + p_pekerjaan + " karakter dan ");
    } else if (no_tlp.equals("Yes") && (TTlp.getText().trim().length() < p_no_tlp)) {
        Valid.textKosong(TTlp,
                "Telp Pasien minimal " + p_no_tlp + " karakter dan ");
    } else if (umur.equals("Yes") && (TUmurTh.getText().trim().length() < p_umur)) {
        Valid.textKosong(TUmurTh,
                "Umur Pasien minimal " + p_umur + " karakter dan ");
    } else if (namakeluarga.equals("Yes") && (Saudara.getText().trim().length() < p_namakeluarga)) {
        Valid.textKosong(Saudara,
                "Penanggung Jawab Pasien minimal " + p_namakeluarga + " karakter dan ");
    } else if (no_peserta.equals("Yes") && (TNoPeserta.getText().trim().length() < p_no_peserta)) {
        Valid.textKosong(TNoPeserta,
                "No.Peserta Pasien minimal " + p_no_peserta + " karakter dan ");
    } else if (kelurahan.equals("Yes") && (Kelurahan.getText().trim().length() < p_kelurahan)) {
        Valid.textKosong(Kelurahan,
                "Kelurahan minimal " + p_kelurahan + " karakter dan ");
    } else if (kecamatan.equals("Yes") && (Kecamatan.getText().trim().length() < p_kecamatan)) {
        Valid.textKosong(Kecamatan,
                "Kecamatan minimal " + p_kecamatan + " karakter dan ");
    } else if (kabupaten.equals("Yes") && (Kabupaten.getText().trim().length() < p_kabupaten)) {
        Valid.textKosong(Kabupaten,
                "Kabupaten minimal " + p_kabupaten + " karakter dan ");
    } else if (propinsi.equals("Yes") && (Propinsi.getText().trim().length() < p_propinsi)) {
        Valid.textKosong(Propinsi,
                "Propinsi minimal " + p_propinsi + " karakter dan ");
    } else if (propinsipj.equals("Yes") && (PropinsiPj.getText().trim().length() < p_propinsipj)) {
        Valid.textKosong(PropinsiPj,
                "Propinsi P.J. minimal " + p_propinsipj + " karakter dan ");
    } else if (pekerjaanpj.equals("Yes") && (PekerjaanPj.getText().trim().
            length() < p_pekerjaanpj)) {
        Valid.textKosong(PekerjaanPj,
                "Pekerjaan P.J. minimal " + p_pekerjaanpj + " karakter dan ");
    } else if (alamatpj.equals("Yes") && (AlamatPj.getText().trim().length() < p_alamatpj)) {
        Valid.textKosong(AlamatPj,
                "Alamat P.J. minimal " + p_alamatpj + " karakter dan ");
    } else if (kelurahanpj.equals("Yes") && (KelurahanPj.getText().trim().
            length() < p_kelurahanpj)) {
        Valid.textKosong(KelurahanPj,
                "Kelurahan P.J. minimal " + p_kelurahanpj + " karakter dan ");
    } else if (kecamatanpj.equals("Yes") && (KecamatanPj.getText().trim().
            length() < p_kecamatanpj)) {
        Valid.textKosong(KecamatanPj,
                "Kecamatan P.J. minimal " + p_kecamatanpj + " karakter dan ");
    } else if (kabupatenpj.equals("Yes") && (KabupatenPj.getText().trim().
            length() < p_kabupatenpj)) {
        Valid.textKosong(KabupatenPj,
                "Kabupaten P.J. minimal " + p_kabupatenpj + " karakter dan ");
    } else if (nmsukubangsa.getText().trim().isEmpty()) {
        Valid.textKosong(nmsukubangsa, "Suku/Bangsa");
    } else if (nmcacat.getText().trim().isEmpty()) {
        Valid.textKosong(nmcacat, "Cacat Fisik");
    } else if (nmbahasa.getText().trim().isEmpty()) {
        Valid.textKosong(nmbahasa, "Bahasa");
    } else if (nmperusahaan.getText().trim().isEmpty()) {
        Valid.textKosong(nmperusahaan, "Perusahaan/Instansi");
    } else if ((chkTNI.isSelected() == true) && nmgolongantni.getText().trim().
            isEmpty()) {
        Valid.textKosong(nmgolongantni, "Golongan TNI");
    } else if ((chkTNI.isSelected() == true) && nmsatuantni.getText().trim().
            isEmpty()) {
        Valid.textKosong(nmsatuantni, "Satuan TNI");
    } else if ((chkTNI.isSelected() == true) && nmpangkattni.getText().trim().
            isEmpty()) {
        Valid.textKosong(nmpangkattni, "Pangkat TNI");
    } else if ((chkTNI.isSelected() == true) && nmjabatantni.getText().trim().
            isEmpty()) {
        Valid.textKosong(nmjabatantni, "Jabatan TNI");
    } else if ((chkPolri.isSelected() == true) && nmgolonganpolri.getText().
            trim().isEmpty()) {
        Valid.textKosong(nmgolonganpolri, "Golongan POLRI");
    } else if ((chkPolri.isSelected() == true) && nmsatuanpolri.getText().trim().
            isEmpty()) {
        Valid.textKosong(nmsatuanpolri, "Satuan POLRI");
    } else if ((chkPolri.isSelected() == true) && nmpangkatpolri.getText().
            trim().isEmpty()) {
        Valid.textKosong(nmpangkatpolri, "Pangkat POLRI");
    } else if ((chkPolri.isSelected() == true) && nmjabatanpolri.getText().
            trim().isEmpty()) {
        ...
        if (Sequel.menyimpantf2("pasien",
                ...
                "No.Rekam Medis Pasien", 36, new String[]{
                    TNo.getText(), TNm.getText(), TKtp.getText(), CmbJk.
                    getSelectedItem().toString().substring(0, 1), TTmp.getText(),
                    Valid.SetTgl(DTPLahir.getSelectedItem() + ""), NmIbu.
                    getText(),
                    Alamat.getText().replaceAll("ALAMAT", ""), CMbGd.
                    getSelectedItem().toString(), Pekerjaan.getText(), CmbStts.
                    getSelectedItem().toString(), cmbAgama.getSelectedItem().
                            toString(),
                    DTPDaftar.getSelectedItem().toString().substring(6, 10) + "-" + DTPDaftar.
                    getSelectedItem().toString().substring(3, 5) + "-" + DTPDaftar.
                    getSelectedItem().toString().substring(0, 2),
                    TTlp.getText(), TUmurTh.getText() + " Th " + TUmurBl.
                    getText() + " Bl " + TUmurHr.getText() + " Hr", CMbPnd.
                    getSelectedItem().toString(), CmbKeluarga.getSelectedItem().
                            toString(), Saudara.getText(),
                    Kdpnj.getText(), TNoPeserta.getText(), kdkel, kdkec, kdkab,
                    PekerjaanPj.getText(), AlamatPj.getText(), KelurahanPj.
                    getText(), KecamatanPj.getText(), KabupatenPj.getText(),
                    kdperusahaan.getText(),
                    kdsuku.getText(), kdbahasa.getText(), kdcacat.getText(),
                    EMail.getText(), NIP.getText(), kdprop, PropinsiPj.getText()
                }) == true) {
            if (akses.getform().equals("DlgReg")) {
                TCari.setText(TNo.getText());
            }
            if (chkTNI.isSelected() == true) {
                Sequel.menyimpan2("pasien_tni", "?,?,?,?,?", "Data", 5,
                        new String[]{
                            TNo.getText(), kdgolongantni.getText(),
                            kdpangkattni.getText(),
                            kdsatuantni.getText(), kdjabatantni.getText()
                        });
            }
            if (chkPolri.isSelected() == true) {
                Sequel.menyimpan2("pasien_polri", "?,?,?,?,?,?", "Data", 5,
                        new String[]{
                            TNo.getText(), kdgolonganpolri.getText(),
                            kdpangkatpolri.getText(),
            ...
            if (Sequel.menyimpantf2("pasien",
                    ...
                    "No.Rekam Medis Pasien", 36, new String[]{
                        TNo.getText(), TNm.getText(), TKtp.getText(), CmbJk.
                        getSelectedItem().toString().substring(0, 1), TTmp.
                        getText(),
                        Valid.SetTgl(DTPLahir.getSelectedItem() + ""), NmIbu.
                        getText(),
                        Alamat.getText().replaceAll("ALAMAT", ""), CMbGd.
                        getSelectedItem().toString(), Pekerjaan.getText(),
                        CmbStts.getSelectedItem().toString(), cmbAgama.
                        ...
                        TTlp.getText(), TUmurTh.getText() + " Th " + TUmurBl.
                        getText() + " Bl " + TUmurHr.getText() + " Hr", CMbPnd.
                        getSelectedItem().toString(), CmbKeluarga.
                                getSelectedItem().toString(), Saudara.getText(),
                        Kdpnj.getText(), TNoPeserta.getText(), kdkel, kdkec,
                        kdkab, PekerjaanPj.getText(), AlamatPj.getText(),
                        KelurahanPj.getText(), KecamatanPj.getText(),
                        KabupatenPj.getText(), kdperusahaan.getText(),
                        kdsuku.getText(), kdbahasa.getText(), kdcacat.getText(),
                        EMail.getText(), NIP.getText(), kdprop, PropinsiPj.
                        getText()
                    }) == true) {
                if (akses.getform().equals("DlgReg")) {
                    TCari.setText(TNo.getText());
                ...
                if (chkPolri.isSelected() == true) {
                    Sequel.menyimpan2("pasien_polri", "?,?,?,?,?,?", "Data", 5,
                            new String[]{
                                TNo.getText(), kdgolonganpolri.getText(),
                                kdpangkatpolri.getText(),
                                kdsatuanpolri.getText(), kdjabatanpolri.
                                getText()
                            });
                }
                if (ChkRM.isSelected() == true) {
                ...
                if (Sequel.menyimpantf2("pasien",
                        ...
                        "No.Rekam Medis Pasien", 36, new String[]{
                            ...
                            CmbStts.getSelectedItem().toString(), cmbAgama.
                            getSelectedItem().toString(),
                            DTPDaftar.getSelectedItem().toString().substring(6,
                                    10) + "-" + DTPDaftar.getSelectedItem().
                                    toString().substring(3, 5) + "-" + DTPDaftar.
                            getSelectedItem().toString().substring(0, 2),
                            TTlp.getText(),
                            TUmurTh.getText() + " Th " + TUmurBl.getText() + " Bl " + TUmurHr.
                            getText() + " Hr", CMbPnd.getSelectedItem().
                                    toString(), CmbKeluarga.getSelectedItem().
                                    toString(), Saudara.getText(),
                            Kdpnj.getText(), TNoPeserta.getText(), kdkel, kdkec,
                            kdkab, PekerjaanPj.getText(), AlamatPj.getText(),
                            KelurahanPj.getText(), KecamatanPj.getText(),
                            KabupatenPj.getText(), kdperusahaan.getText(),
                            kdsuku.getText(), kdbahasa.getText(), kdcacat.
                            getText(), EMail.getText(), NIP.getText(), kdprop,
                            PropinsiPj.getText()
                        }) == true) {
                    if (akses.getform().equals("DlgReg")) {
                        TCari.setText(TNo.getText());
                    ...
                    if (chkTNI.isSelected() == true) {
                        Sequel.menyimpan2("pasien_tni", "?,?,?,?,?", "Data", 5,
                                new String[]{
                                    TNo.getText(), kdgolongantni.getText(),
                                    kdpangkattni.getText(),
                                    kdsatuantni.getText(), kdjabatantni.
                                    getText()
                                });
                    }
                    if (chkPolri.isSelected() == true) {
                        Sequel.menyimpan2("pasien_polri", "?,?,?,?,?,?", "Data",
                                5, new String[]{
                                    TNo.getText(), kdgolonganpolri.getText(),
                                    kdpangkatpolri.getText(),
                                    kdsatuanpolri.getText(), kdjabatanpolri.
                    ...
                    if (ChkRM.isSelected() == true) {
                        Sequel.queryu2("delete from set_no_rkm_medis");
                        Sequel.queryu2("insert into set_no_rkm_medis values(?)",
                                1, new String[]{TNo.getText()});
                    }
                    emptTeks();
                } else {
                    autoNomor();
                    if (Sequel.menyimpantf2("pasien",
                            "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                            "No.Rekam Medis Pasien", 36, new String[]{
                                TNo.getText(), TNm.getText(), TKtp.getText(),
                                CmbJk.getSelectedItem().toString().substring(0,
                                        1), TTmp.getText(),
                                Valid.SetTgl(DTPLahir.getSelectedItem() + ""),
                                NmIbu.getText(),
                                Alamat.getText().replaceAll("ALAMAT", ""),
                                CMbGd.getSelectedItem().toString(), Pekerjaan.
                                getText(), CmbStts.getSelectedItem().toString(),
                                cmbAgama.getSelectedItem().toString(),
                                DTPDaftar.getSelectedItem().toString().
                                        substring(6, 10) + "-" + DTPDaftar.
                                getSelectedItem().toString().substring(3, 5) + "-" + DTPDaftar.
                                getSelectedItem().toString().substring(0, 2),
                                TTlp.getText(),
                                TUmurTh.getText() + " Th " + TUmurBl.getText() + " Bl " + TUmurHr.
                                getText() + " Hr", CMbPnd.getSelectedItem().
                                        toString(), CmbKeluarga.
                                        getSelectedItem().toString(), Saudara.
                                        getText(),
                                Kdpnj.getText(), TNoPeserta.getText(), kdkel,
                                kdkec, kdkab, PekerjaanPj.getText(), AlamatPj.
                                getText(), KelurahanPj.getText(), KecamatanPj.
                                getText(), KabupatenPj.getText(), kdperusahaan.
                                getText(),
                                kdsuku.getText(), kdbahasa.getText(), kdcacat.
                                getText(), EMail.getText(), NIP.getText(),
                        ...
                        if (chkTNI.isSelected() == true) {
                            Sequel.menyimpan2("pasien_tni", "?,?,?,?,?", "Data",
                                    5, new String[]{
                                        TNo.getText(), kdgolongantni.getText(),
                                        kdpangkattni.getText(),
                                        kdsatuantni.getText(), kdjabatantni.
                        ...
                        if (chkPolri.isSelected() == true) {
                            Sequel.menyimpan2("pasien_polri", "?,?,?,?,?,?",
                                    "Data", 5, new String[]{
                                        TNo.getText(), kdgolonganpolri.getText(),
                                        kdpangkatpolri.getText(),
                                        kdsatuanpolri.getText(), kdjabatanpolri.
                        ...
                        if (ChkRM.isSelected() == true) {
                            Sequel.queryu2("delete from set_no_rkm_medis");
                            Sequel.queryu2(
                                    "insert into set_no_rkm_medis values(?)", 1,
                                    new String[]{TNo.getText()});
                        }
                        emptTeks();
                    } else {
                        autoNomor();
                        if (Sequel.menyimpantf("pasien",
                                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                "No.Rekam Medis Pasien", 36, new String[]{
                                    TNo.getText(), TNm.getText(), TKtp.getText(),
                                    CmbJk.getSelectedItem().toString().
                                            substring(0, 1), TTmp.getText(),
                                    Valid.
                                            SetTgl(DTPLahir.getSelectedItem() + ""),
                                    NmIbu.getText(),
                                    Alamat.getText().replaceAll("ALAMAT", ""),
                                    CMbGd.getSelectedItem().toString(),
                                    Pekerjaan.getText(), CmbStts.
                                    getSelectedItem().toString(), cmbAgama.
                                            getSelectedItem().toString(),
                                    DTPDaftar.getSelectedItem().toString().
                                            substring(6, 10) + "-" + DTPDaftar.
                                    getSelectedItem().toString().substring(3, 5) + "-" + DTPDaftar.
                                    getSelectedItem().toString().substring(0, 2),
                                    TTlp.getText(),
                                    TUmurTh.getText() + " Th " + TUmurBl.
                                    getText() + " Bl " + TUmurHr.getText() + " Hr",
                                    CMbPnd.getSelectedItem().toString(),
                                    CmbKeluarga.getSelectedItem().toString(),
                                    Saudara.getText(),
                                    Kdpnj.getText(), TNoPeserta.getText(), kdkel,
                                    kdkec, kdkab, PekerjaanPj.getText(),
                                    AlamatPj.getText(), KelurahanPj.getText(),
                                    KecamatanPj.getText(), KabupatenPj.getText(),
                                    kdperusahaan.getText(),
                                    kdsuku.getText(), kdbahasa.getText(),
                                    kdcacat.getText(), EMail.getText(), NIP.
                                    getText(), kdprop, PropinsiPj.getText()
                                }) == true) {
                            if (akses.getform().equals("DlgReg")) {
                                TCari.setText(TNo.getText());
                            }
                            if (chkTNI.isSelected() == true) {
                                Sequel.menyimpan2("pasien_tni", "?,?,?,?,?",
                                        "Data", 5, new String[]{
                                            TNo.getText(), kdgolongantni.
                                            getText(), kdpangkattni.getText(),
                                            kdsatuantni.getText(), kdjabatantni.
                                            getText()
                                        });
                            }
                            if (chkPolri.isSelected() == true) {
                                Sequel.menyimpan2("pasien_polri", "?,?,?,?,?,?",
                                        "Data", 5, new String[]{
                                            TNo.getText(), kdgolonganpolri.
                                            getText(), kdpangkatpolri.getText(),
                                            kdsatuanpolri.getText(),
                                            kdjabatanpolri.getText()
                                        });
                            }
                            if (ChkRM.isSelected() == true) {
                                Sequel.queryu2("delete from set_no_rkm_medis");
                                Sequel.queryu2(
                                        "insert into set_no_rkm_medis values(?)",
                                        1, new String[]{TNo.getText()});
                            }
                            emptTeks();
                        } else {
        ...
        case 1:
            for (z = 0; z < tbPasien.getRowCount(); z++) {
                if (tbPasien.getValueAt(z, 0).toString().equals("true")) {
                    if (Sequel.meghapustf("pasien", "no_rkm_medis", tbPasien.
                            getValueAt(z, 1).toString()) == true) {
                        tabMode.removeRow(z);
                        z--;
                    }
                }
        ...
        case 2:
            for (z = 0; z < tbPasien2.getRowCount(); z++) {
                if (tbPasien2.getValueAt(z, 0).toString().equals("true")) {
                    if (Sequel.meghapustf("pasien", "no_rkm_medis", tbPasien2.
                            getValueAt(z, 1).toString()) == true) {
        ...
        case 3:
            for (z = 0; z < tbPasien3.getRowCount(); z++) {
                if (tbPasien3.getValueAt(z, 0).toString().equals("true")) {
                    if (Sequel.meghapustf("pasien", "no_rkm_medis", tbPasien3.
                            getValueAt(z, 1).toString()) == true) {
...
private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
    if (TNo.getText().trim().isEmpty()) {
        ...
        if (Sequel.mengedittf("pasien", "no_rkm_medis=?",
                ...
                new String[]{TNo.getText(), TNm.getText(), TKtp.getText(),
                    CmbJk.getSelectedItem().toString().substring(0, 1), TTmp.
                    getText(),
                    Valid.SetTgl(DTPLahir.getSelectedItem() + ""),
                    Alamat.getText(), CMbGd.getSelectedItem().toString(),
                    Pekerjaan.getText(), CmbStts.getSelectedItem().toString(),
                    cmbAgama.getSelectedItem().toString(),
                    DTPDaftar.getSelectedItem().toString().substring(6, 10) + "-" + DTPDaftar.
                    getSelectedItem().toString().substring(3, 5) + "-" + DTPDaftar.
                    getSelectedItem().toString().substring(0, 2),
                    ...
                    getSelectedItem().toString(), CmbKeluarga.getSelectedItem().
                            toString(),
                    Saudara.getText(), Kdpnj.getText(), TNoPeserta.getText(),
                    kdkel, kdkec, kdkab, NmIbu.getText(), PekerjaanPj.getText(),
                    AlamatPj.getText(), KelurahanPj.getText(), KecamatanPj.
                    getText(),
                    KabupatenPj.getText(), kdperusahaan.getText(), kdsuku.
                    getText(), kdbahasa.getText(), kdcacat.getText(), EMail.
                    getText(), NIP.getText(),
            ...
            if (tbPasien.getSelectedRow() > -1) {
                ...
                tbPasien.
                        setValueAt(TKtp.getText(), tbPasien.getSelectedRow(), 3);
                tbPasien.setValueAt(CmbJk.getSelectedItem().toString().
                        substring(0, 1), tbPasien.getSelectedRow(), 4);
                tbPasien.
                        setValueAt(TTmp.getText(), tbPasien.getSelectedRow(), 5);
                tbPasien.setValueAt(Valid.
                        SetTgl(DTPLahir.getSelectedItem() + ""), tbPasien.
                        getSelectedRow(), 6);
                tbPasien.setValueAt(NmIbu.getText(), tbPasien.getSelectedRow(),
                        7);
                tbPasien.setValueAt(Alamat.getText() + ", " + Kelurahan.
                        getText() + ", " + Kecamatan.getText() + ", " + Kabupaten.
                        getText() + ", " + Propinsi.getText(), tbPasien.
                        getSelectedRow(), 8);
                tbPasien.setValueAt(CMbGd.getSelectedItem().toString(),
                        tbPasien.getSelectedRow(), 9);
                tbPasien.setValueAt(Pekerjaan.getText(), tbPasien.
                        getSelectedRow(), 10);
                tbPasien.setValueAt(CmbStts.getSelectedItem().toString(),
                        tbPasien.getSelectedRow(), 11);
                tbPasien.setValueAt(cmbAgama.getSelectedItem().toString(),
                        tbPasien.getSelectedRow(), 12);
                tbPasien.setValueAt(DTPDaftar.getSelectedItem().toString().
                        substring(6, 10) + "-" + DTPDaftar.getSelectedItem().
                        toString().substring(3, 5) + "-" + DTPDaftar.
                        getSelectedItem().toString().substring(0, 2), tbPasien.
                        getSelectedRow(), 13);
                tbPasien.setValueAt(TTlp.getText(), tbPasien.getSelectedRow(),
                        14);
                tbPasien.setValueAt(TUmurTh.getText() + " Th " + TUmurBl.
                        getText() + " Bl " + TUmurHr.getText() + " Hr",
                        tbPasien.getSelectedRow(), 15);
                tbPasien.setValueAt(CMbPnd.getSelectedItem().toString(),
                        tbPasien.getSelectedRow(), 16);
                tbPasien.setValueAt(CmbKeluarga.getSelectedItem().toString(),
                        tbPasien.getSelectedRow(), 17);
                tbPasien.
                        setValueAt(Saudara.getText(), tbPasien.getSelectedRow(),
                                18);
                tbPasien.setValueAt(nmpnj.getText(), tbPasien.getSelectedRow(),
                        19);
                tbPasien.setValueAt(TNoPeserta.getText(), tbPasien.
                        getSelectedRow(), 20);
                tbPasien.setValueAt(PekerjaanPj.getText(), tbPasien.
                        getSelectedRow(), 22);
                tbPasien.setValueAt(AlamatPj.getText() + ", " + KelurahanPj.
                        getText() + ", " + KecamatanPj.getText() + ", " + KabupatenPj.
                        getText() + ", " + PropinsiPj.getText(), tbPasien.
                        getSelectedRow(), 23);
                tbPasien.setValueAt(kdsuku.getText(), tbPasien.getSelectedRow(),
                        24);
                tbPasien.setValueAt(nmsukubangsa.getText(), tbPasien.
                        getSelectedRow(), 25);
                tbPasien.setValueAt(kdbahasa.getText(), tbPasien.
                        getSelectedRow(), 26);
                tbPasien.setValueAt(nmbahasa.getText(), tbPasien.
                        getSelectedRow(), 27);
                tbPasien.setValueAt(kdperusahaan.getText(), tbPasien.
                        getSelectedRow(), 28);
                tbPasien.setValueAt(nmperusahaan.getText(), tbPasien.
                        getSelectedRow(), 29);
                tbPasien.
                        setValueAt(NIP.getText(), tbPasien.getSelectedRow(), 30);
                tbPasien.setValueAt(EMail.getText(), tbPasien.getSelectedRow(),
                        31);
                tbPasien.
                        setValueAt(kdcacat.getText(), tbPasien.getSelectedRow(),
                                32);
                tbPasien.
                        setValueAt(nmcacat.getText(), tbPasien.getSelectedRow(),
                                33);
                tbPasien.setValueAt(Kdpnj.getText(), tbPasien.getSelectedRow(),
                        34);
                tbPasien.setValueAt(Alamat.getText(), tbPasien.getSelectedRow(),
                        35);
                tbPasien.setValueAt(Kelurahan.getText(), tbPasien.
                        getSelectedRow(), 36);
                tbPasien.setValueAt(Kecamatan.getText(), tbPasien.
                        getSelectedRow(), 37);
                tbPasien.setValueAt(Kabupaten.getText(), tbPasien.
                        getSelectedRow(), 38);
                tbPasien.setValueAt(Propinsi.getText(), tbPasien.
                        getSelectedRow(), 39);
                tbPasien.setValueAt(AlamatPj.getText(), tbPasien.
                        getSelectedRow(), 40);
                tbPasien.setValueAt(KelurahanPj.getText(), tbPasien.
                        getSelectedRow(), 41);
                tbPasien.setValueAt(KecamatanPj.getText(), tbPasien.
                        getSelectedRow(), 42);
                tbPasien.setValueAt(KabupatenPj.getText(), tbPasien.
                        getSelectedRow(), 43);
                tbPasien.setValueAt(PropinsiPj.getText(), tbPasien.
                        getSelectedRow(), 44);
            }
        ...
        case 1:
            if (tabMode.getRowCount() == 0) {
                ...
                if (!cmbHlm.getSelectedItem().toString().equals("Semua")) {
                    if (Carialamat.getText().trim().isEmpty() && TCari.getText().
                            trim().isEmpty()) {
                        Valid.MyReportqry("rptPasien.jasper", "report",
                                "::[ Data Pasien Umum ]::",
                                ...
                                + "inner join penjab on pasien.kd_pj=penjab.kd_pj order by pasien.no_rkm_medis desc" + " LIMIT " + cmbHlm.
                                        getSelectedItem(), param);
                    } else {
                        Valid.MyReportqry("rptPasien.jasper", "report",
                                "::[ Data Pasien Umum ]::",
                                "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                                ...
                                + "where concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%' and pasien.no_rkm_medis like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.nm_pasien like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.no_ktp like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.no_peserta like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.tmp_lahir like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.tgl_lahir like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and penjab.png_jawab like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.alamat like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.gol_darah like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.pekerjaan like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.stts_nikah like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.nip like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and cacat_fisik.nama_cacat like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.namakeluarga like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and perusahaan_pasien.nama_perusahaan like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and bahasa_pasien.nama_bahasa like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and suku_bangsa.nama_suku_bangsa like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.agama like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.nm_ibu like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.tgl_daftar like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.no_tlp like '%" + TCari.
                                        getText().trim() + "%'  order by pasien.no_rkm_medis desc" + " LIMIT " + cmbHlm.
                                        getSelectedItem(), param);
                    }
                    ...
                    if (Carialamat.getText().trim().isEmpty() && TCari.getText().
                        ...
                        Valid.MyReportqry("rptPasien.jasper", "report",
                                ...
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.no_tlp like '%" + TCari.
                                        getText().trim() + "%'   order by pasien.no_rkm_medis desc ",
                                param);
                    }
                }
            }
        ...
        case 2:
            if (tabMode2.getRowCount() == 0) {
                ...
                if (!cmbHlm.getSelectedItem().toString().equals("Semua")) {
                    if (Carialamat.getText().trim().isEmpty() && TCari.getText().
                            trim().isEmpty()) {
                        Valid.MyReportqry("rptPasien2.jasper", "report",
                                "::[ Data Pasien Umum ]::",
                                "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                                ...
                                + "order by pasien.no_rkm_medis desc LIMIT " + cmbHlm.
                                        getSelectedItem(), param);
                    } else {
                        Valid.MyReportqry("rptPasien2.jasper", "report",
                                "::[ Data Pasien Umum ]::",
                                ...
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        ...
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and golongan_tni.nama_golongan like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and satuan_tni.nama_satuan like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pangkat_tni.nama_pangkat like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and jabatan_tni.nama_jabatan like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.nip like '%" + TCari.
                                        getText().trim() + "%' "
        ...
        case 3:
            if (tabMode3.getRowCount() == 0) {
                ...
                if (!cmbHlm.getSelectedItem().toString().equals("Semua")) {
                    if (Carialamat.getText().trim().isEmpty() && TCari.getText().
                            trim().isEmpty()) {
                        Valid.MyReportqry("rptPasien3.jasper", "report",
                                "::[ Data Pasien Umum ]::",
                                "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                                + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                                + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
                        ...
                        Valid.MyReportqry("rptPasien3.jasper", "report",
                                ...
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        ...
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and golongan_polri.nama_golongan like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and satuan_polri.nama_satuan like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pangkat_polri.nama_pangkat like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and jabatan_polri.nama_jabatan like '%" + TCari.
                                        getText().trim() + "%' "
                                + "or  concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) like '%" + Carialamat.
                                        getText().trim() + "%'  and pasien.nip like '%" + TCari.
                                        getText().trim() + "%' "
...
private void MnKartuStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKartuStatusActionPerformed
    if (tabMode.getRowCount() == 0) {
        ...
        param.put("emailrs", akses.getemailrs());
        param.put("logo", Sequel.cariGambar("select setting.logo from setting"));
        Valid.MyReportqry("rptKartuPasien.jasper", "report",
                "::[ Kartu Periksa Pasien(Umum) ]::",
                "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                ...
                + "inner join propinsi on pasien.kd_prop=propinsi.kd_prop and pasien.kd_kel=kelurahan.kd_kel and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab where pasien.no_rkm_medis='" + TNo.
                        getText() + "' ", param);
        this.setCursor(Cursor.getDefaultCursor());
    }
...
private void MnKartu2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKartu2ActionPerformed
    if (tabMode.getRowCount() == 0) {
        ...
        param.put("kontakrs", akses.getkontakrs());
        param.put("emailrs", akses.getemailrs());
        Valid.MyReportqry("rptKartuBerobat.jasper", "report",
                "::[ Kartu Periksa Pasien ]::",
                "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                + "pasien.tmp_lahir, pasien.tgl_lahir, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
                + "pasien.pnd, pasien.keluarga, pasien.namakeluarga from pasien inner join kelurahan inner join kecamatan inner join kabupaten "
                + "inner join propinsi on pasien.kd_prop=propinsi.kd_prop and pasien.kd_kel=kelurahan.kd_kel "
                + "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab where pasien.no_rkm_medis='" + TNo.
                        getText() + "' ", param);
        this.setCursor(Cursor.getDefaultCursor());
    }
...
private void MnLaporanRMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanRMActionPerformed
    if (tabMode.getRowCount() == 0) {
        ...
        param.put("emailrs", akses.getemailrs());
        param.put("logo", Sequel.cariGambar("select setting.logo from setting"));
        Valid.MyReportqry("rptRM2.jasper", "report", "::[ Identitas Pasien ]::",
                "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
...
private void MnLaporanIGDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanIGDActionPerformed
    if (tabMode.getRowCount() == 0) {
        ...
        param.put("kontakrs", akses.getkontakrs());
        param.put("emailrs", akses.getemailrs());
        Valid.MyReportqry("rptKartuIgd.jasper", "report",
                "::[ Laporan Rekam Medik ]::",
                "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                + "pasien.tmp_lahir, pasien.tgl_lahir, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
...
private void ppKelahiranBayiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppKelahiranBayiActionPerformed
    if (tabMode.getRowCount() == 0) {
        ...
        resume.setNoRM(TNo.getText(), TNm.getText(), NmIbu.getText(), Alamat.
                getText() + ", " + Kelurahan.getText() + ", " + Kecamatan.
                getText() + ", " + Kabupaten.getText(), CmbJk.getSelectedItem().
                toString(),
                TUmurTh.getText() + " Th " + TUmurBl.getText() + " Bl " + TUmurHr.
                getText() + " Hr", DTPLahir.getDate(), DTPDaftar.getDate());
        resume.tampil();
...
private void MnLembarKeluarMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLembarKeluarMasukActionPerformed
    if (tabMode.getRowCount() == 0) {
        ...
        param.put("emailrs", akses.getemailrs());
        param.put("logo", Sequel.cariGambar("select setting.logo from setting"));
        Valid.MyReportqry("rptLembarKeluarMasuk.jasper", "report",
...
private void MnLembarAnamNesaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLembarAnamNesaActionPerformed
    if (tabMode.getRowCount() == 0) {
        ...
        param.put("kontakrs", akses.getkontakrs());
        param.put("emailrs", akses.getemailrs());
        Valid.MyReportqry("rptLembarAnamnesi.jasper", "report",
                "::[ Lembar Anamnesa ]::",
                "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                + "pasien.tmp_lahir, pasien.tgl_lahir, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
...
private void MnLembarGrafikActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLembarGrafikActionPerformed
    if (tabMode.getRowCount() == 0) {
        ...
        param.put("kontakrs", akses.getkontakrs());
        param.put("emailrs", akses.getemailrs());
        Valid.MyReportqry("rptLembarGrafik.jasper", "report",
                "::[ Lembar Grafik ]::",
                "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                + "pasien.tmp_lahir, pasien.tgl_lahir, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
...
private void MnLembarCatatanPerkembanganActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLembarCatatanPerkembanganActionPerformed
    if (tabMode.getRowCount() == 0) {
        ...
        param.put("kontakrs", akses.getkontakrs());
        param.put("emailrs", akses.getemailrs());
        Valid.MyReportqry("rptLembarPerkembangan.jasper", "report",
...
private void MnLaporanAnestesiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanAnestesiaActionPerformed
    if (tabMode.getRowCount() == 0) {
        ...
        param.put("kontakrs", akses.getkontakrs());
        param.put("emailrs", akses.getemailrs());
        Valid.MyReportqry("rptLaporanAnestesia.jasper", "report",
                "::[ Lembar Catatan Keperawatan ]::",
                "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                + "pasien.tmp_lahir, pasien.tgl_lahir, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
...
private void MnKartu3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKartu3ActionPerformed
    if (tabMode.getRowCount() == 0) {
        ...
        param.put("kontakrs", akses.getkontakrs());
        param.put("emailrs", akses.getemailrs());
        Valid.MyReportqry("rptKartuBerobat2.jasper", "report",
                "::[ Kartu Periksa Pasien ]::",
                "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                + "pasien.tmp_lahir, pasien.tgl_lahir, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
...
private void ppGrafikPerAgamaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppGrafikPerAgamaActionPerformed
    grafikpasienperagama kas = new grafikpasienperagama(
            "Grafik Pasien Per Agama ", " ");
    kas.setSize(this.getWidth(), this.getHeight());
    kas.setLocationRelativeTo(this);
    kas.setVisible(true);
...
private void ppGrafikPerPekerjaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppGrafikPerPekerjaanActionPerformed
    grafikpasienperpekerjaaan kas = new grafikpasienperpekerjaaan(
            "Grafik Pasien Per Pekerjaan ", " ");
    kas.setSize(this.getWidth(), this.getHeight());
    kas.setLocationRelativeTo(this);
    kas.setVisible(true);
...
private void BtnPrint2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint2ActionPerformed
    if (!Kelurahan2.getText().isEmpty()) {
        ...
        grafiksql kas = new grafiksql(
                ...
                + " and pasien.kd_prop=propinsi.kd_prop where kabupaten.nm_kab='" + Kabupaten2.
                        getText() + "' and kecamatan.nm_kec='" + Kecamatan2.
                        getText() + "' and kelurahan.nm_kel='" + Kelurahan2.
                        getText() + "' and propinsi.nm_prop='" + Propinsi2.
                        getText() + "' ",
                "pasien.alamat", "Area");
        kas.setSize(this.getWidth(), this.getHeight());
        kas.setLocationRelativeTo(this);
        ...
        grafiksql kas = new grafiksql(
                ...
                + "and propinsi.kd_prop=pasien.kd_prop where kabupaten.nm_kab='" + Kabupaten2.
                        getText() + "' and kecamatan.nm_kec='" + Kecamatan2.
                        getText() + "' and propinsi.nm_prop='" + Propinsi2.
                        getText() + "' ",
        ...
        grafiksql kas = new grafiksql(
                ...
                + "and pasien.kd_kec=kecamatan.kd_kec and propinsi.kd_prop=pasien.kd_prop where kabupaten.nm_kab='" + Kabupaten2.
                        getText() + "' and propinsi.nm_prop='" + Propinsi2.
                        getText() + "' ",
        ...
        kas.setLocationRelativeTo(this);
        kas.setVisible(true);
    } else if (!Propinsi2.getText().isEmpty()) {
        DlgDemografi.dispose();
        grafiksql kas = new grafiksql("::[ Data Demografi Per Propinsi ]::",
                " pasien inner join propinsi on pasien.kd_prop=propinsi.kd_prop where propinsi.nm_prop='" + Propinsi2.
                        getText() + "' ",
...
private void BtnSeek8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeek8ActionPerformed
    if (Kecamatan2.getText().isEmpty()) {
        Valid.textKosong(Kecamatan2, "Kecamatan");
    } else {
        akses.setform("DlgPasien");
        pilih = 2;
        kel.emptTeks();
        kel.setSize(internalFrame1.getWidth() - 20,
                internalFrame1.getHeight() - 20);
        kel.setLocationRelativeTo(internalFrame1);
        kel.setVisible(true);
    }
...
private void BtnSeek9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeek9ActionPerformed
    if (Kabupaten2.getText().isEmpty()) {
        Valid.textKosong(Kabupaten2, "Kabupaten");
    } else {
        akses.setform("DlgPasien");
        pilih = 2;
        kec.emptTeks();
        kec.setSize(internalFrame1.getWidth() - 20,
                internalFrame1.getHeight() - 20);
        kec.setLocationRelativeTo(internalFrame1);
        kec.setVisible(true);
    }
...
private void BtnSeek10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeek10ActionPerformed
    if (Propinsi2.getText().isEmpty()) {
        Valid.textKosong(Propinsi2, "Propinsi");
    } else {
        akses.setform("DlgPasien");
        pilih = 2;
        kab.emptTeks();
        kab.setSize(internalFrame1.getWidth() - 20,
                internalFrame1.getHeight() - 20);
        kab.setLocationRelativeTo(internalFrame1);
        kab.setVisible(true);
    }
    ...
    if (tabMode.getRowCount() == 0) {
        ...
        if (!Kelurahan2.getText().isEmpty()) {
            ...
            Valid.MyReportqry("rptDemografi.jasper", "report",
                    ...
                    getText() + "' "
                    + "and kelurahan.nm_kel='" + Kelurahan2.getText() + "' and propinsi.nm_prop='" + Propinsi2.
                    getText() + "' "
            ...
            Valid.MyReportqry("rptDemografi.jasper", "report",
                    ...
                    + "where kabupaten.nm_kab='" + Kabupaten2.getText() + "' and kecamatan.nm_kec='" + Kecamatan2.
                    getText() + "' "
                    + "and propinsi.nm_prop='" + Propinsi2.getText() + "' group by kelurahan.nm_kel order by kelurahan.nm_kel",
                    data);
        } else if (!Kabupaten2.getText().isEmpty()) {
            DlgDemografi.dispose();
            Map<String, Object> data = new HashMap<>();
            ...
            Valid.MyReportqry("rptDemografi.jasper", "report",
                    ...
                    + "and pasien.kd_kec=kecamatan.kd_kec where kabupaten.nm_kab='" + Kabupaten2.
                            getText() + "' "
                    + "and propinsi.nm_prop='" + Propinsi2.getText() + "' group by kecamatan.nm_kec order by kecamatan.nm_kec",
                    data);
        } else if (!Propinsi2.getText().isEmpty()) {
            DlgDemografi.dispose();
            Map<String, Object> data = new HashMap<>();
            ...
            data.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptDemografi.jasper", "report",
                    "::[ Data Demografi Per Propinsi ]::",
                    "select propinsi.nm_prop as area,count(propinsi.nm_prop) as jumlah from pasien "
                    + "inner join propinsi on pasien.kd_prop=propinsi.kd_prop where propinsi.nm_prop='" + Propinsi2.
                            getText() + "' group by propinsi.nm_prop order by propinsi.nm_prop",
                    data);
        } else if (Propinsi2.getText().isEmpty()) {
            DlgDemografi.dispose();
            Map<String, Object> data = new HashMap<>();
            ...
            Valid.MyReportqry("rptDemografi.jasper", "report",
                    "::[ Data Demografi Per Propinsi ]::",
                    "select propinsi.nm_prop as area,count(propinsi.nm_prop) as jumlah from pasien "
                    + "inner join propinsi on pasien.kd_prop=propinsi.kd_prop group by propinsi.nm_prop order by propinsi.nm_prop",
                    data);
        }
    }
    this.setCursor(Cursor.getDefaultCursor());
...
private void AlamatMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AlamatMouseMoved
    ...
    private void MnIdentitasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnIdentitasActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptRM1.jasper", "report",
                    "::[ Identitas Pasien ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnPengantarHemodalisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPengantarHemodalisaActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("kontakrs", akses.getkontakrs());
            param.put("emailrs", akses.getemailrs());
            String nip = Sequel.cariIsi(
                    "select kd_dokterhemodialisa from set_pjlab");
            param.put("dokter", Sequel.cariIsi(
                    "select dokter.nm_dokter from dokter where dokter.kd_dokter='" + nip + "'"));
            param.put("nipdokter", nip);
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptRM3.jasper", "report",
                    "::[ Identitas Pasien ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void KecamatanPjMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KecamatanPjMouseExited
        if (KecamatanPj.getText().isEmpty()) {
            KecamatanPj.setText("KECAMATAN");
        }
    ...
    private void KecamatanPjKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KecamatanPjKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (KdKab.getText().trim().isEmpty() || KabupatenPj.getText().trim().
                    isEmpty() || KabupatenPj.getText().trim().
                            equals("KABUPATEN")) {
                JOptionPane.showMessageDialog(null,
                        "Silahkan pilih kabupaten dulu..!!");
                BtnKabupaten.requestFocus();
            } else {
                pilih = 2;
                kecamatanref.setPropinsi(KdKab.getText(), KabupatenPj.getText());
                kecamatanref.setSize(internalFrame1.getWidth() - 20,
                        internalFrame1.getHeight() - 20);
    ...
    private void KabupatenPjMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KabupatenPjMouseExited
        if (KabupatenPj.getText().isEmpty()) {
            KabupatenPj.setText("KABUPATEN");
        }
    ...
    private void KabupatenPjKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KabupatenPjKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (KdProp.getText().trim().isEmpty() || PropinsiPj.getText().trim().
                    isEmpty() || PropinsiPj.getText().trim().equals("PROPINSI")) {
                JOptionPane.showMessageDialog(null,
                ...
                kabupatenref.setSize(internalFrame1.getWidth() - 20,
                        internalFrame1.getHeight() - 20);
    ...
    private void KelurahanPjMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KelurahanPjMouseExited
        if (KelurahanPj.getText().isEmpty()) {
            KelurahanPj.setText("KELURAHAN");
        }
    ...
    private void KelurahanPjKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KelurahanPjKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (KdKec.getText().trim().isEmpty() || KecamatanPj.getText().trim().
                    isEmpty() || KecamatanPj.getText().trim().
                            equals("KECAMATAN")) {
                JOptionPane.showMessageDialog(null,
                        "Silahkan pilih kecamatan dulu..!!");
                BtnKelurahan.requestFocus();
            } else {
                pilih = 2;
                kelurahanref.setPropinsi(KdKec.getText(), KecamatanPj.getText());
                kelurahanref.setSize(internalFrame1.getWidth() - 20,
                        internalFrame1.getHeight() - 20);
    ...
    private void MnBarcodeRMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBarcodeRMActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptBarcodeRM.jasper", "report",
                    "::[ Label Rekam Medis ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnBarcodeRM2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBarcodeRM2ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptBarcodeRM2.jasper", "report",
                    "::[ Label Rekam Medis ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnBarcodeRM1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBarcodeRM1ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptBarcodeRM3.jasper", "report",
                    "::[ Label Rekam Medis ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnBarcodeRM3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBarcodeRM3ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptBarcodeRM9.jasper", "report",
                    "::[ Label Rekam Medis ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnKartu1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKartu1ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("kontakrs", akses.getkontakrs());
            param.put("emailrs", akses.getemailrs());
            Valid.MyReportqry("rptKartuBerobat5.jasper", "report",
                    "::[ Kartu Periksa Pasien ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    ...
                    + "where pasien.no_rkm_medis='" + TNo.getText() + "' ",
                    param);
            this.setCursor(Cursor.getDefaultCursor());
        }
    ...
    private void MnBarcodeRM4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBarcodeRM4ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptBarcodeRM11.jasper", "report",
                    "::[ Label Rekam Medis ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
    ...
    private void MnBarcodeRM5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBarcodeRM5ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptBarcodeRM12.jasper", "report",
                    "::[ Label Rekam Medis ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, DATE_FORMAT(pasien.tgl_lahir,'%d/%m/%Y') as tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnBarcodeRM6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBarcodeRM6ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptBarcodeRM13.jasper", "report",
                    "::[ Label Rekam Medis ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, DATE_FORMAT(pasien.tgl_lahir,'%d/%m/%Y') as tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnViaBPJSNikActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnViaBPJSNikActionPerformed
        if (TKtp.getText().trim().isEmpty()) {
            TKtp.requestFocus();
            JOptionPane.showMessageDialog(null,
                    "Silahkan isi terlebih dahulu NIK/No.KTP..!!");
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    ...
    private void MnViaBPJSNoKartuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnViaBPJSNoKartuActionPerformed
        if (TNoPeserta.getText().trim().isEmpty()) {
            TNoPeserta.requestFocus();
            JOptionPane.showMessageDialog(null,
                    "Silahkan isi terlebih dahulu No.Peserta..!!");
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    ...
    private void MnLaporanRM1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanRM1ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptRM4.jasper", "report",
                    "::[ Identitas Pasien ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnIdentitas2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnIdentitas2ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptRM5.jasper", "report",
                    "::[ Identitas Pasien ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnLaporanRM2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanRM2ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptRM6.jasper", "report",
                    "::[ Lembar Rawat Jalan ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnFormulirPendaftaranActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnFormulirPendaftaranActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptRM7.jasper", "report",
    ...
    private void MnSCreeningActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSCreeningActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptRM8.jasper", "report",
                    "::[ Screening Awal ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnCopyResepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCopyResepActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptRM9.jasper", "report", "::[ Copy Resep ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
                    + "pasien.pnd, pasien.keluarga, pasien.namakeluarga,penjab.png_jawab,pasien.pekerjaanpj,"
    ...
    private void MnKartu4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKartu4ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("kontakrs", akses.getkontakrs());
            param.put("emailrs", akses.getemailrs());
            Valid.MyReportqry("rptKartuBerobat6.jasper", "report",
                    "::[ Kartu Periksa Pasien ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnLembarKeluarMasuk2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLembarKeluarMasuk2ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptLembarKeluarMasuk2.jasper", "report",
                    "::[ Ringkasan Masuk Keluar ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnIdentitas3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnIdentitas3ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptRM10.jasper", "report",
                    "::[ Identitas Pasien ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnBarcodeRM7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBarcodeRM7ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptBarcodeRM15.jasper", "report",
                    "::[ Label Rekam Medis ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, DATE_FORMAT(pasien.tgl_lahir,'%d/%m/%Y') as tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void TUmurThKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TUmurThKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            try {
                Valid.SetTgl(DTPLahir, Sequel.cariIsi(
                        "select DATE_SUB('" + Valid.SetTgl(DTPLahir.
                                getSelectedItem() + "") + "', interval " + TUmurTh.
                                getText() + " year)"));
            } catch (Exception e) {
            }
    ...
    private void MnKartu5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKartu5ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("kontakrs", akses.getkontakrs());
            param.put("emailrs", akses.getemailrs());
            Valid.MyReportqry("rptKartuBerobat7.jasper", "report",
                    "::[ Kartu Periksa Pasien ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
    ...
    private void ppCatatanPasienBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppCatatanPasienBtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            JOptionPane.showMessageDialog(null,
                    "Maaf, Silahkan anda pilih dulu data pasien pada table...!!!");
            TCari.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    ...
    private void MnCoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCoverActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptCoverMap.jasper", "report",
                    "::[ Cover Rekam Medis ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
    ...
    private void ppGabungRMBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppGabungRMBtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            TCari.requestFocus();
        } else if (TNo.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null,
                    "Maaf, Silahkan anda pilih dulu pasien yang mau digabung data rekam medisnya...!!!");
            TCari.requestFocus();
        } else if (TNm.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null,
                    "Maaf, Silahkan anda pilih dulu pasien yang mau digabung data rekam medisnya...!!!");
    ...
    private void BtnSimpan6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan6ActionPerformed
        if (NoRmTujuan.getText().trim().isEmpty()) {
            Valid.textKosong(NoRmTujuan, "No.R.M Tujuan masih kosong");
        } else if (NmPasienTujuan.getText().trim().isEmpty()) {
            Valid.textKosong(NmPasienTujuan, "Nama Pasien Tujuan");
        } else if (NoRmTujuan.getText().trim().equals(TNo.getText().trim())) {
            JOptionPane.showMessageDialog(rootPane,
                    "No.R.M dan No.R.M. tujuan tidak boleh sama...!!");
        } else {
            Sequel.mengedit("bayar_piutang", "no_rkm_medis=?", "no_rkm_medis=?",
                    2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("booking_periksa_diterima", "no_rkm_medis=?",
                    "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("booking_registrasi", "no_rkm_medis=?",
                    "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("bridging_dukcapil", "no_rkm_medis=?",
                    "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.
                    mengedit("catatan_pasien", "no_rkm_medis=?",
                            "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("diagnosa_corona", "no_rkm_medis=?",
                    "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.
                    mengedit("pasien_bayi", "no_rkm_medis=?", "no_rkm_medis=?",
                            2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("pasien_corona", "no_rkm_medis=?", "no_rkm_medis=?",
                    2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.
                    mengedit("pasien_mati", "no_rkm_medis=?", "no_rkm_medis=?",
                            2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("pasien_polri", "no_rkm_medis=?", "no_rkm_medis=?",
                    2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("pasien_tni", "no_rkm_medis=?", "no_rkm_medis=?", 2,
                    new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("pcare_peserta_kegiatan_kelompok", "no_rkm_medis=?",
                    "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("peminjaman_berkas", "no_rkm_medis=?",
                    "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("pengaduan", "no_rkm_medis=?", "no_rkm_medis=?", 2,
                    new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("penjualan", "no_rkm_medis=?", "no_rkm_medis=?", 2,
                    new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("personal_pasien", "no_rkm_medis=?",
                    "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("piutang", "no_rkm_medis=?", "no_rkm_medis=?", 2,
                    new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.
                    mengedit("piutang_pasien", "no_rkm_medis=?",
                            "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("referensi_mobilejkn_bpjs_batal", "no_rkm_medis=?",
                    "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.
                    mengedit("reg_periksa", "no_rkm_medis=?", "no_rkm_medis=?",
                            2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.
                    mengedit("retensi_pasien", "no_rkm_medis=?",
                            "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("returjual", "no_rkm_medis=?", "no_rkm_medis=?", 2,
                    new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("riwayat_imunisasi", "no_rkm_medis=?",
                    "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("riwayat_persalinan_pasien", "no_rkm_medis=?",
                    "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("returpiutang", "no_rkm_medis=?", "no_rkm_medis=?",
                    2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("rujukanranap_dokter_rs", "no_rkm_medis=?",
                    "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("sidikjaripasien", "no_rkm_medis=?",
                    "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("skdp_bpjs", "no_rkm_medis=?", "no_rkm_medis=?", 2,
                    new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("skrining_rawat_jalan", "no_rkm_medis=?",
                    "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
            Sequel.mengedit("tagihan_bpd_jateng", "no_rkm_medis=?",
                    "no_rkm_medis=?", 2, new String[]{
                        NoRmTujuan.getText(), TNo.getText()
                    });
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (!NoRmTujuan.getText().trim().isEmpty()) {
                Sequel.cariIsi(
                        ...
                        NmPasienTujuan, NoRmTujuan.getText());
                if (NmPasienTujuan.getText().trim().isEmpty()) {
                    JOptionPane.showMessageDialog(rootPane,
    ...
    private void MnViaDukcapilNikDKIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnViaDukcapilNikDKIActionPerformed
        if (TKtp.getText().trim().isEmpty()) {
            ...
            Alamat.setText(
                    cekViaDukcapilJakarta.ALAMAT + " RT " + cekViaDukcapilJakarta.NO_RT + " RW " + cekViaDukcapilJakarta.NO_RW);
            AlamatPj.setText(
                    cekViaDukcapilJakarta.ALAMAT + " RT " + cekViaDukcapilJakarta.NO_RT + " RW " + cekViaDukcapilJakarta.NO_RW);
            ...
            DTPLahirItemStateChanged(null);
            this.setCursor(Cursor.getDefaultCursor());
            if ((Kelurahan.isEditable() == false) || (Kecamatan.isEditable() == false) || (Kabupaten.
                    isEditable() == false) || (Propinsi.isEditable() == false)) {
                JOptionPane.showMessageDialog(null,
                        "Pengaturan Kelurahan, Kecamatan, Kabupaten dan Propinsi harus diaktifkan terlebih dahulu di Set RM agar data mau disimpan..");
            }
        }
    ...
    private void MnBarcodeRM8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBarcodeRM8ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptBarcodeRM17.jasper", "report",
                    "::[ Label Rekam Medis ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnViaDukcapilNikAcehActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnViaDukcapilNikAcehActionPerformed
        if (TKtp.getText().trim().isEmpty()) {
            ...
            Alamat.setText(
                    cekViaDukcapilAceh.ALAMAT + " RT " + cekViaDukcapilAceh.NO_RT + " RW " + cekViaDukcapilAceh.NO_RW);
            AlamatPj.setText(
                    cekViaDukcapilAceh.ALAMAT + " RT " + cekViaDukcapilAceh.NO_RT + " RW " + cekViaDukcapilAceh.NO_RW);
            ...
            CmbStts.setSelectedItem(cekViaDukcapilAceh.STATUS_KAWIN.replaceAll(
                    "KAWIN", "MENIKAH"));
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        if (tampilkantni.equals("Yes")) {
            if (this.getHeight() < 640) {
                ...
                FormInput.setPreferredSize(new Dimension(PanelBiasa.WIDTH, 530));
                ...
                if (this.getWidth() < 900) {
                    Scroll1.setHorizontalScrollBarPolicy(
                            javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
                    FormInput.setPreferredSize(new Dimension(890,
                            PanelBiasa.HEIGHT));
                } else {
                    Scroll1.setHorizontalScrollBarPolicy(
                            javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
            ...
            if (this.getHeight() < 530) {
                Scroll1.setVerticalScrollBarPolicy(
                        javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
                FormInput.setPreferredSize(new Dimension(PanelBiasa.WIDTH, 380));
                if (this.getWidth() < 900) {
                    Scroll1.setHorizontalScrollBarPolicy(
                            javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
    ...
    private void BtnSukuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSukuActionPerformed
        akses.setform("DlgPasien");
        suku.isCek();
        suku.setSize(internalFrame1.getWidth() - 20,
                internalFrame1.getHeight() - 20);
    ...
    private void BtnBahasaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBahasaActionPerformed
        akses.setform("DlgPasien");
        bahasa.isCek();
        bahasa.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void BtnPerusahaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPerusahaanActionPerformed
        akses.setform("DlgPasien");
        perusahaan.isCek();
        perusahaan.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void BtnGolonganTNIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGolonganTNIActionPerformed
        akses.setform("DlgPasien");
        golongantni.isCek();
        golongantni.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void BtnSatuanTNIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSatuanTNIActionPerformed
        akses.setform("DlgPasien");
        satuantni.isCek();
        satuantni.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void BtnPangkatTNIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPangkatTNIActionPerformed
        akses.setform("DlgPasien");
        pangkattni.isCek();
        pangkattni.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void BtnJabatanTNIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnJabatanTNIActionPerformed
        akses.setform("DlgPasien");
        jabatantni.isCek();
        jabatantni.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void BtnGolonganPolriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGolonganPolriActionPerformed
        akses.setform("DlgPasien");
        golonganpolri.isCek();
        golonganpolri.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void BtnSatuanPolriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSatuanPolriActionPerformed
        akses.setform("DlgPasien");
        satuanpolri.isCek();
        satuanpolri.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void BtnPangkatPolriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPangkatPolriActionPerformed
        akses.setform("DlgPasien");
        pangkatpolri.isCek();
        pangkatpolri.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void BtnJabatanPolriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnJabatanPolriActionPerformed
        akses.setform("DlgPasien");
        jabatanpolri.isCek();
        jabatanpolri.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void BtnPropinsiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPropinsiActionPerformed
        akses.setform("DlgPasien");
        pilih = 1;
        prop.setSize(internalFrame1.getWidth() - 20,
                internalFrame1.getHeight() - 20);
    ...
    private void PropinsiPjKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PropinsiPjKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            pilih = 2;
            propinsiref.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                    getHeight() - 20);
    ...
    private void BtnCacatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCacatActionPerformed
        akses.setform("DlgPasien");
        cacat.isCek();
        cacat.setSize(internalFrame1.getWidth() - 20,
                internalFrame1.getHeight() - 20);
    ...
    private void MnIdentitas4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnIdentitas4ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptIdentitasPasien.jasper", "report",
                    "::[ Identitas Pasien ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnLaporanRM3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanRM3ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptRM13.jasper", "report",
                    "::[ Identitas Pasien ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
    ...
    private void MnCover1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCover1ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptCoverMap2.jasper", "report",
                    "::[ Cover Rekam Medis ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
    ...
    private void MnKartu6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKartu6ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("kontakrs", akses.getkontakrs());
            param.put("emailrs", akses.getemailrs());
            Valid.MyReportqry("rptKartuBerobat8.jasper", "report",
                    "::[ Kartu Periksa Pasien ]::",
                    "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,pasien.nm_ibu,"
    ...
    private void btnUbahPasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahPasswordActionPerformed
        if (NoRekamMedisDipilih.getText().isEmpty() || NamaPasienDipilih.
                getText().isEmpty()) {
            JOptionPane.showMessageDialog(null,
                    "Maaf, silahkan pilih data pasien terlebih dahulu...!!!!");
        } else {
            if (Sequel.menyimpantf("personal_pasien",
                    "?,'',aes_encrypt(?,'windi')", 2, new String[]{
                        NoRekamMedisDipilih.getText(), PasswordPasien.
                        getText()}, "no_rkm_medis=?",
                    "password=aes_encrypt(?,'windi')", 2, new String[]{
                        PasswordPasien.getText(), NoRekamMedisDipilih.
                        getText()}) == true) {
                JOptionPane.showMessageDialog(null,
                        "Update password pasien berhasil..!!");
            } else {
                JOptionPane.showMessageDialog(null,
                        "Update password pasien gagal..!!");
    ...
    private void btnAmbilPhotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilPhotoActionPerformed
        ...
        if (NoRekamMedisDipilih.getText().isEmpty() || NamaPasienDipilih.
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            Sequel.menyimpan2("personal_pasien", "?,'',''", 1, new String[]{
                NoRekamMedisDipilih.getText()});
            Valid.panggilUrl(
                    "photopasien/login.php?act=login&usere=" + koneksiDB.
                            USERHYBRIDWEB() + "&passwordte=" + koneksiDB.
                            PASHYBRIDWEB() + "&norm=" + NoRekamMedisDipilih.
                            getText());
            this.setCursor(Cursor.getDefaultCursor());
        }
        this.setCursor(Cursor.getDefaultCursor());
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("suku_bangsa"), rs.getString(
                        "nama_suku_bangsa"), rs.getString("bahasa_pasien"),
                        rs.getString("nama_bahasa"), rs.getString(
                        "kode_perusahaan"), rs.getString("nama_perusahaan"),
                        rs.getString("nip"), rs.getString("email"), rs.
                        getString("cacat_fisik"), rs.getString("nama_cacat")
                    });
                }
            } catch (SQLException e) {
                System.out.println("Notifikasi : " + e);
    ...
    private void MnViaSatuSehatNikActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnViaSatuSehatNikActionPerformed
        if (TKtp.getText().trim().isEmpty()) {
            ...
            Alamat.setText(
                    cekViaSatuSehat.line + " RT " + cekViaSatuSehat.rt + "/RW " + cekViaSatuSehat.rw + " Kode Pos " + cekViaSatuSehat.postalCode);
            AlamatPj.setText(
                    cekViaSatuSehat.line + " RT " + cekViaSatuSehat.rt + "/RW " + cekViaSatuSehat.rw + " Kode Pos " + cekViaSatuSehat.postalCode);
    ...
    private void ppBerkasDigitalBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBerkasDigitalBtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgBerkasPasien berkaspasien = new DlgBerkasPasien(null, true);
            berkaspasien.setJudul("::[ Berkas Digital Perawatan ]::",
                    "berkasrawat/pages");
            try {
                if (akses.gethapus_berkas_digital_perawatan() == true) {
                    berkaspasien.loadURL(
                            "http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.
                            PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/" + "berkaspasien/login2.php?act=login&usere=" + koneksiDB.
                            USERHYBRIDWEB() + "&passwordte=" + koneksiDB.
                                    PASHYBRIDWEB() + "&no_rkm_medis=" + tbPasien.
                                    getValueAt(tbPasien.getSelectedRow(), 1).
                                    toString());
                } else {
                    berkaspasien.loadURL(
                            "http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.
                            PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/" + "berkaspasien/login2nonhapus.php?act=login&usere=" + koneksiDB.
                            USERHYBRIDWEB() + "&passwordte=" + koneksiDB.
                                    PASHYBRIDWEB() + "&no_rkm_medis=" + tbPasien.
                                    getValueAt(tbPasien.getSelectedRow(), 1).
                                    toString());
            ...
            berkaspasien.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                    getHeight() - 20);
            berkaspasien.setLocationRelativeTo(internalFrame1);
            berkaspasien.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }
    ...
    private void KelurahanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KelurahanMouseClicked
        if (evt.getClickCount() == 2) {
            if (KdKec.getText().trim().isEmpty() || Kecamatan.getText().trim().
                    isEmpty() || Kecamatan.getText().trim().equals("KECAMATAN")) {
                JOptionPane.showMessageDialog(null,
                        "Silahkan pilih kecamatan dulu..!!");
                BtnKelurahan.requestFocus();
            } else {
    ...
    private void KecamatanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KecamatanMouseClicked
        if (evt.getClickCount() == 2) {
            if (KdKab.getText().trim().isEmpty() || Kabupaten.getText().trim().
                    isEmpty() || Kabupaten.getText().trim().equals("KABUPATEN")) {
                JOptionPane.showMessageDialog(null,
                        "Silahkan pilih kabupaten dulu..!!");
                BtnKabupaten.requestFocus();
            } else {
    ...
    private void KabupatenMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KabupatenMouseClicked
        if (evt.getClickCount() == 2) {
            if (KdProp.getText().trim().isEmpty() || Propinsi.getText().trim().
                    isEmpty() || Propinsi.getText().trim().equals("PROPINSI")) {
                JOptionPane.showMessageDialog(null,
                        "Silahkan pilih propinsi dulu..!!");
                BtnPropinsi.requestFocus();
            } else {
    ...
    private void PropinsiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PropinsiMouseClicked
        if (evt.getClickCount() == 2) {
            pilih = 1;
            propinsiref.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                    getHeight() - 20);
    ...
    private void TNoPesertaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TNoPesertaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TNoPesertaActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgPasien.class.getName()).log(
        ...
        try {
            ...
            try {
                if (cmbHlm.getSelectedItem().toString().equals("Semua")) {
                    ...
                    if (Carialamat.getText().trim().isEmpty() && TCari.getText().
                            trim().isEmpty()) {
                        ps.setInt(1, Integer.parseInt(cmbHlm.getSelectedItem().
                                toString()));
                    } else {
                        ps.setString(1, "%" + Carialamat.getText().trim() + "%");
                        ps.setString(2, "%" + TCari.getText().trim() + "%");
                        ...
                        ps.setString(21, "%" + TCari.getText().trim() + "%");
                        ps.setString(22, "%" + TCari.getText().trim() + "%");
                        ps.setInt(23, Integer.parseInt(cmbHlm.getSelectedItem().
                                toString()));
                    }
                }
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        false, rs.getString("no_rkm_medis"), rs.getString(
                        "nm_pasien"), rs.getString("no_ktp"), rs.getString("jk"),
                        rs.getString("tmp_lahir"), rs.getString("tgl_lahir"),
                        rs.getString("nm_ibu"),
                        rs.getString("alamat") + ", " + rs.getString("nm_kel") + ", " + rs.
                        getString("nm_kec") + ", " + rs.getString("nm_kab") + ", " + rs.
                        getString("nm_prop"), rs.getString("gol_darah"), rs.
                        getString("pekerjaan"),
                        rs.getString("stts_nikah"), rs.getString("agama"), rs.
                        getString("tgl_daftar"), rs.getString("no_tlp"), rs.
                        getString("umur"), rs.getString("pnd"), rs.getString(
                        "keluarga"),
                        rs.getString("namakeluarga"), rs.getString("png_jawab"),
                        rs.getString("no_peserta"),
                        "Klik Kanan, Tampilkan Banyak Daftar", rs.getString(
                        "pekerjaanpj"),
                        rs.getString("alamatpj") + ", " + rs.getString(
                        "kelurahanpj") + ", " + rs.getString("kecamatanpj") + ", " + rs.
                        getString("kabupatenpj") + ", " + rs.getString(
                        "propinsipj"),
                        rs.getString("suku_bangsa"), rs.getString(
                        "nama_suku_bangsa"), rs.getString("bahasa_pasien"), rs.
                        getString("nama_bahasa"),
                        rs.getString("kode_perusahaan"), rs.getString(
                        "nama_perusahaan"), rs.getString("nip"), rs.getString(
                        "email"), rs.getString("cacat_fisik"),
                        rs.getString("nama_cacat"), rs.getString("kd_pj"), rs.
                        getString("alamat"), rs.getString("nm_kel"), rs.
                        getString("nm_kec"),
                        rs.getString("nm_kab"), rs.getString("nm_prop"), rs.
                        getString("alamatpj"), rs.getString("kelurahanpj"),
                        rs.getString("kecamatanpj"), rs.getString("kabupatenpj"),
                        rs.getString("propinsipj")
                    });
                }
            ...
            try {
                    ...
                    if (Carialamat.getText().trim().isEmpty() && TCari.getText().
                        ...
                        ps.
                                setString(49,
                                        "%" + Carialamat.getText().trim() + "%");
                        ps.setString(50, "%" + TCari.getText().trim() + "%");
                        ps.setInt(51, Integer.parseInt(cmbHlm.getSelectedItem().
                                toString()));
                    }
                }
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode2.addRow(new Object[]{
                        ...
                        rs.getString("nama_bahasa"), rs.getString(
                        "kode_perusahaan"), rs.getString("nama_perusahaan"),
                        rs.getString("golongan_tni"), rs.getString(
                        "nama_golongan"), rs.getString("satuan_tni"),
                        rs.getString("nama_satuan"), rs.getString("pangkat_tni"),
                        rs.getString("nama_pangkat"),
                        rs.getString("jabatan_tni"), rs.
                        getString("nama_jabatan"),
                        rs.getString("nip"), rs.getString("email"), rs.
                        getString("cacat_fisik"), rs.getString("nama_cacat")
                    });
                }
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode3.addRow(new Object[]{
                        ...
                        rs.getString("nama_bahasa"), rs.getString(
                        "kode_perusahaan"), rs.getString("nama_perusahaan"),
                        rs.getString("golongan_polri"), rs.getString(
                        "nama_golongan"), rs.getString("satuan_polri"),
                        rs.getString("nama_satuan"), rs.getString(
                        "pangkat_polri"), rs.getString("nama_pangkat"),
                        rs.getString("jabatan_polri"), rs.getString(
                        "nama_jabatan"),
                        rs.getString("nip"), rs.getString("email"), rs.
                        getString("cacat_fisik"), rs.getString("nama_cacat")
                    });
    ...
    private void getData() {
        if (tbPasien.getSelectedRow() != -1) {
            try {
                TNo.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(), 1).
                        toString());
                Kd2.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(), 1).
                        toString());
                TNm.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(), 2).
                        toString());
                NoRekamMedisDipilih.setText(tbPasien.getValueAt(tbPasien.
                        getSelectedRow(), 1).toString());
                NamaPasienDipilih.setText(tbPasien.getValueAt(tbPasien.
                        getSelectedRow(), 2).toString());
                TKtp.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(), 3).
                        toString());

                switch (tbPasien.getValueAt(tbPasien.getSelectedRow(), 4).
                        toString()) {
                    case "L":
                        CmbJk.setSelectedItem("LAKI-LAKI");
                        break;
                ...
                TTmp.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(), 5).
                        toString());
                CMbGd.setSelectedItem(tbPasien.getValueAt(tbPasien.
                        getSelectedRow(), 9).toString());
                Pekerjaan.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),
                        10).toString());
                CmbStts.setSelectedItem(tbPasien.getValueAt(tbPasien.
                        getSelectedRow(), 11).toString());
                cmbAgama.setSelectedItem(tbPasien.getValueAt(tbPasien.
                        getSelectedRow(), 12).toString());
                TTlp.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(), 14).
                        toString());
                Saudara.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),
                        18).toString());
                nmpnj.setText(
                        tbPasien.getValueAt(tbPasien.getSelectedRow(), 19).
                                toString());
                TNoPeserta.setText(tbPasien.
                        getValueAt(tbPasien.getSelectedRow(), 20).toString());
                NmIbu.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(), 7).
                        toString());
                CMbPnd.setSelectedItem(tbPasien.getValueAt(tbPasien.
                        getSelectedRow(), 16).toString());
                CmbKeluarga.setSelectedItem(tbPasien.getValueAt(tbPasien.
                        getSelectedRow(), 17).toString());
                PekerjaanPj.setText(tbPasien.getValueAt(tbPasien.
                        getSelectedRow(), 22).toString());
                kdsuku.setText(tbPasien.
                        getValueAt(tbPasien.getSelectedRow(), 24).toString());
                nmsukubangsa.setText(tbPasien.getValueAt(tbPasien.
                        getSelectedRow(), 25).toString());
                kdbahasa.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),
                        26).toString());
                nmbahasa.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),
                        27).toString());
                kdperusahaan.setText(tbPasien.getValueAt(tbPasien.
                        getSelectedRow(), 28).toString());
                nmperusahaan.setText(tbPasien.getValueAt(tbPasien.
                        getSelectedRow(), 29).toString());
                NIP.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(), 30).
                        toString());
                EMail.setText(
                        tbPasien.getValueAt(tbPasien.getSelectedRow(), 31).
                                toString());
                kdcacat.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),
                        32).toString());
                nmcacat.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),
                        33).toString());
                Kdpnj.setText(
                        tbPasien.getValueAt(tbPasien.getSelectedRow(), 34).
                                toString());
                Alamat.setText(tbPasien.
                        getValueAt(tbPasien.getSelectedRow(), 35).toString());
                Kelurahan.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),
                        36).toString());
                Kecamatan.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),
                        37).toString());
                Kabupaten.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),
                        38).toString());
                Propinsi.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),
                        39).toString());
                AlamatPj.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(),
                        40).toString());
                KelurahanPj.setText(tbPasien.getValueAt(tbPasien.
                        getSelectedRow(), 41).toString());
                KecamatanPj.setText(tbPasien.getValueAt(tbPasien.
                        getSelectedRow(), 42).toString());
                KabupatenPj.setText(tbPasien.getValueAt(tbPasien.
                        getSelectedRow(), 43).toString());
                PropinsiPj.setText(tbPasien.
                        getValueAt(tbPasien.getSelectedRow(), 44).toString());
                ...
                Valid.SetTgl(DTPLahir, tbPasien.getValueAt(tbPasien.
                        getSelectedRow(), 6).toString());
                Valid.SetTgl(DTPDaftar, tbPasien.getValueAt(tbPasien.
    ...
    private void getDataTni() {
        if (tbPasien2.getSelectedRow() != -1) {
            try {
                TNo.setText(tbPasien2.getValueAt(tbPasien2.getSelectedRow(), 1).
                        toString());
                Kd2.setText(tbPasien2.getValueAt(tbPasien2.getSelectedRow(), 1).
                        toString());
                TNm.setText(tbPasien2.getValueAt(tbPasien2.getSelectedRow(), 2).
                        toString());
                NoRekamMedisDipilih.setText(tbPasien2.getValueAt(tbPasien2.
                        getSelectedRow(), 1).toString());
                NamaPasienDipilih.setText(tbPasien2.getValueAt(tbPasien2.
                        getSelectedRow(), 2).toString());
                TKtp.setText(
                        tbPasien2.getValueAt(tbPasien2.getSelectedRow(), 3).
                                toString());

                switch (tbPasien2.getValueAt(tbPasien2.getSelectedRow(), 4).
                        toString()) {
                    case "L":
                        CmbJk.setSelectedItem("LAKI-LAKI");
                        break;
                ...
                TTmp.setText(
                        tbPasien2.getValueAt(tbPasien2.getSelectedRow(), 5).
                                toString());
                ...
                try {
                    pscariwilayah.setString(1, tbPasien2.getValueAt(tbPasien2.
                            getSelectedRow(), 1).toString());
                ...
                CMbGd.setSelectedItem(tbPasien2.getValueAt(tbPasien2.
                        getSelectedRow(), 9).toString());
                Pekerjaan.setText(tbPasien2.getValueAt(tbPasien2.
                        getSelectedRow(), 10).toString());
                CmbStts.setSelectedItem(tbPasien2.getValueAt(tbPasien2.
                        getSelectedRow(), 11).toString());
                cmbAgama.setSelectedItem(tbPasien2.getValueAt(tbPasien2.
                        getSelectedRow(), 12).toString());
                TTlp.setText(tbPasien2.
                        getValueAt(tbPasien2.getSelectedRow(), 14).toString());
                Saudara.setText(tbPasien2.getValueAt(tbPasien2.getSelectedRow(),
                        18).toString());
                Sequel.cariIsi(
                        "select kd_pj from pasien where no_rkm_medis='" + TNo.
                                getText() + "'", Kdpnj);
                nmpnj.setText(tbPasien2.getValueAt(tbPasien2.getSelectedRow(),
                        19).toString());
                TNoPeserta.setText(tbPasien2.getValueAt(tbPasien2.
                        getSelectedRow(), 20).toString());
                NmIbu.setText(tbPasien2.
                        getValueAt(tbPasien2.getSelectedRow(), 7).toString());
                CMbPnd.setSelectedItem(tbPasien2.getValueAt(tbPasien2.
                        getSelectedRow(), 16).toString());
                CmbKeluarga.setSelectedItem(tbPasien2.getValueAt(tbPasien2.
                        getSelectedRow(), 17).toString());
            } catch (SQLException ex) {
            }

            kdsuku.setText(tbPasien2.getValueAt(tbPasien2.getSelectedRow(), 24).
                    toString());
            nmsukubangsa.setText(tbPasien2.
                    getValueAt(tbPasien2.getSelectedRow(), 25).toString());
            kdbahasa.setText(tbPasien2.
                    getValueAt(tbPasien2.getSelectedRow(), 26).toString());
            nmbahasa.setText(tbPasien2.
                    getValueAt(tbPasien2.getSelectedRow(), 27).toString());
            kdperusahaan.setText(tbPasien2.
                    getValueAt(tbPasien2.getSelectedRow(), 28).toString());
            nmperusahaan.setText(tbPasien2.
                    getValueAt(tbPasien2.getSelectedRow(), 29).toString());
            kdgolongantni.setText(tbPasien2.getValueAt(tbPasien2.
                    getSelectedRow(), 30).toString());
            nmgolongantni.setText(tbPasien2.getValueAt(tbPasien2.
                    getSelectedRow(), 31).toString());
            kdsatuantni.setText(tbPasien2.getValueAt(tbPasien2.getSelectedRow(),
                    32).toString());
            nmsatuantni.setText(tbPasien2.getValueAt(tbPasien2.getSelectedRow(),
                    33).toString());
            kdpangkattni.setText(tbPasien2.
                    getValueAt(tbPasien2.getSelectedRow(), 34).toString());
            nmpangkattni.setText(tbPasien2.
                    getValueAt(tbPasien2.getSelectedRow(), 35).toString());
            kdjabatantni.setText(tbPasien2.
                    getValueAt(tbPasien2.getSelectedRow(), 36).toString());
            nmjabatantni.setText(tbPasien2.
                    getValueAt(tbPasien2.getSelectedRow(), 37).toString());
            NIP.setText(tbPasien2.getValueAt(tbPasien2.getSelectedRow(), 38).
                    toString());
            EMail.setText(tbPasien2.getValueAt(tbPasien2.getSelectedRow(), 39).
                    toString());
            kdcacat.setText(
                    tbPasien2.getValueAt(tbPasien2.getSelectedRow(), 40).
                            toString());
            nmcacat.setText(
                    tbPasien2.getValueAt(tbPasien2.getSelectedRow(), 41).
                            toString());
            chkTNI.setSelected(true);
            chkTNIActionPerformed(null);

            Valid.SetTgl(DTPLahir, tbPasien2.getValueAt(tbPasien2.
                    getSelectedRow(), 6).toString());
            Valid.SetTgl(DTPDaftar, tbPasien2.getValueAt(tbPasien2.
                    getSelectedRow(), 13).toString());
            panggilPhoto();
        }
    }
    ...
    private void getDataPolri() {
        if (tbPasien3.getSelectedRow() != -1) {
            try {
                TNo.setText(tbPasien3.getValueAt(tbPasien3.getSelectedRow(), 1).
                        toString());
                Kd2.setText(tbPasien3.getValueAt(tbPasien3.getSelectedRow(), 1).
                        toString());
                TNm.setText(tbPasien3.getValueAt(tbPasien3.getSelectedRow(), 2).
                        toString());
                NoRekamMedisDipilih.setText(tbPasien3.getValueAt(tbPasien3.
                        getSelectedRow(), 1).toString());
                NamaPasienDipilih.setText(tbPasien3.getValueAt(tbPasien3.
                        getSelectedRow(), 2).toString());
                TKtp.setText(
                        tbPasien3.getValueAt(tbPasien3.getSelectedRow(), 3).
                                toString());

                switch (tbPasien3.getValueAt(tbPasien3.getSelectedRow(), 4).
                        toString()) {
                    case "L":
                        CmbJk.setSelectedItem("LAKI-LAKI");
                        break;
                ...
                TTmp.setText(
                        tbPasien3.getValueAt(tbPasien3.getSelectedRow(), 5).
                                toString());
                ...
                pscariwilayah = koneksi.prepareStatement(
                        ...
                        + "where pasien.no_rkm_medis=?");
                try {
                    pscariwilayah.setString(1, tbPasien3.getValueAt(tbPasien3.
                            getSelectedRow(), 1).toString());
                    rs = pscariwilayah.executeQuery();
                    if (rs.next()) {
                        Alamat.setText(rs.getString("alamat"));
                ...
                CMbGd.setSelectedItem(tbPasien3.getValueAt(tbPasien3.
                        getSelectedRow(), 9).toString());
                Pekerjaan.setText(tbPasien3.getValueAt(tbPasien3.
                        getSelectedRow(), 10).toString());
                CmbStts.setSelectedItem(tbPasien3.getValueAt(tbPasien3.
                        getSelectedRow(), 11).toString());
                cmbAgama.setSelectedItem(tbPasien3.getValueAt(tbPasien3.
                        getSelectedRow(), 12).toString());
                TTlp.setText(tbPasien3.
                        getValueAt(tbPasien3.getSelectedRow(), 14).toString());
                Saudara.setText(tbPasien3.getValueAt(tbPasien3.getSelectedRow(),
                        18).toString());
                Sequel.cariIsi(
                        "select kd_pj from pasien where no_rkm_medis='" + TNo.
                                getText() + "'", Kdpnj);
                nmpnj.setText(tbPasien3.getValueAt(tbPasien3.getSelectedRow(),
                        19).toString());
                TNoPeserta.setText(tbPasien3.getValueAt(tbPasien3.
                        getSelectedRow(), 20).toString());
                NmIbu.setText(tbPasien3.
                        getValueAt(tbPasien3.getSelectedRow(), 7).toString());
                CMbPnd.setSelectedItem(tbPasien3.getValueAt(tbPasien3.
                        getSelectedRow(), 16).toString());
                CmbKeluarga.setSelectedItem(tbPasien3.getValueAt(tbPasien3.
                        getSelectedRow(), 17).toString());
            } catch (SQLException ex) {
            }

            kdsuku.setText(tbPasien3.getValueAt(tbPasien3.getSelectedRow(), 24).
                    toString());
            nmsukubangsa.setText(tbPasien3.
                    getValueAt(tbPasien3.getSelectedRow(), 25).toString());
            kdbahasa.setText(tbPasien3.
                    getValueAt(tbPasien3.getSelectedRow(), 26).toString());
            nmbahasa.setText(tbPasien3.
                    getValueAt(tbPasien3.getSelectedRow(), 27).toString());
            kdperusahaan.setText(tbPasien3.
                    getValueAt(tbPasien3.getSelectedRow(), 28).toString());
            nmperusahaan.setText(tbPasien3.
                    getValueAt(tbPasien3.getSelectedRow(), 29).toString());
            kdgolonganpolri.setText(tbPasien3.getValueAt(tbPasien3.
                    getSelectedRow(), 30).toString());
            nmgolonganpolri.setText(tbPasien3.getValueAt(tbPasien3.
                    getSelectedRow(), 31).toString());
            kdsatuanpolri.setText(tbPasien3.getValueAt(tbPasien3.
                    getSelectedRow(), 32).toString());
            nmsatuanpolri.setText(tbPasien3.getValueAt(tbPasien3.
                    getSelectedRow(), 33).toString());
            kdpangkatpolri.setText(tbPasien3.getValueAt(tbPasien3.
                    getSelectedRow(), 34).toString());
            nmpangkatpolri.setText(tbPasien3.getValueAt(tbPasien3.
                    getSelectedRow(), 35).toString());
            kdjabatanpolri.setText(tbPasien3.getValueAt(tbPasien3.
                    getSelectedRow(), 36).toString());
            nmjabatanpolri.setText(tbPasien3.getValueAt(tbPasien3.
                    getSelectedRow(), 37).toString());
            NIP.setText(tbPasien3.getValueAt(tbPasien3.getSelectedRow(), 38).
                    toString());
            EMail.setText(tbPasien3.getValueAt(tbPasien3.getSelectedRow(), 39).
                    toString());
            kdcacat.setText(
                    tbPasien3.getValueAt(tbPasien3.getSelectedRow(), 40).
                            toString());
            nmcacat.setText(
                    tbPasien3.getValueAt(tbPasien3.getSelectedRow(), 41).
                            toString());
            chkPolri.setSelected(true);
            chkPolriActionPerformed(null);

            Valid.SetTgl(DTPLahir, tbPasien3.getValueAt(tbPasien3.
                    getSelectedRow(), 6).toString());
            Valid.SetTgl(DTPDaftar, tbPasien3.getValueAt(tbPasien3.
                    getSelectedRow(), 13).toString());
            panggilPhoto();
        }
    }
    ...
    private void prosesCari2() {
        switch (TabRawat.getSelectedIndex()) {
            case 1:
                for (z = 0; z < tbPasien.getRowCount(); z++) {
                    tbPasien.setValueAt(Sequel.cariIsi(
                            "select count(reg_periksa.no_rkm_medis) from reg_periksa where reg_periksa.no_rkm_medis=?",
                            tbPasien.getValueAt(z, 1).toString()) + " X", z, 21);
                }
                break;
            case 2:
                for (z = 0; z < tbPasien2.getRowCount(); z++) {
                    tbPasien2.setValueAt(Sequel.cariIsi(
                            "select count(reg_periksa.no_rkm_medis) from reg_periksa where reg_periksa.no_rkm_medis=?",
                            tbPasien2.getValueAt(z, 1).toString()) + " X", z, 21);
                }
                break;
            case 3:
                for (z = 0; z < tbPasien3.getRowCount(); z++) {
                    tbPasien3.setValueAt(Sequel.cariIsi(
                            "select count(reg_periksa.no_rkm_medis) from reg_periksa where reg_periksa.no_rkm_medis=?",
                            tbPasien3.getValueAt(z, 1).toString()) + " X", z, 21);
                }
                break;
            default:
                break;
    ...
    private void autoNomor() {
        if (Kd2.getText().isEmpty()) {
            if (ChkRM.isSelected() == true) {
                if (tahun.equals("Yes")) {
                    awalantahun = DTPDaftar.getSelectedItem().toString().
                            substring(8, 10);
                } else {
                    awalantahun = "";
                }
                ...
                if (bulan.equals("Yes")) {
                    awalanbulan = DTPDaftar.getSelectedItem().toString().
                            substring(3, 5);
                } else {
                    awalanbulan = "";
                }
                ...
                if (posisitahun.equals("Depan")) {
                    switch (pengurutan) {
                        case "Straight":
                            Valid.autoNomer3(
                                    "select ifnull(MAX(CONVERT(RIGHT(set_no_rkm_medis.no_rkm_medis,6),signed)),0) from set_no_rkm_medis",
                                    "", 6, NoRm);
                            break;
                        case "Terminal":
                            Valid.autoNomer4(
                                    "select ifnull(MAX(CONVERT(CONCAT(SUBSTRING(RIGHT(set_no_rkm_medis.no_rkm_medis,6),5,2),SUBSTRING(RIGHT(set_no_rkm_medis.no_rkm_medis,6),3,2),SUBSTRING(RIGHT(set_no_rkm_medis.no_rkm_medis,6),1,2)),signed)),0) from set_no_rkm_medis",
                                    "", 6, NoRm);
                            break;
                        case "Middle":
                            Valid.autoNomer5(
                                    "select ifnull(MAX(CONVERT(CONCAT(SUBSTRING(RIGHT(set_no_rkm_medis.no_rkm_medis,6),3,2),SUBSTRING(RIGHT(set_no_rkm_medis.no_rkm_medis,6),1,2),SUBSTRING(RIGHT(set_no_rkm_medis.no_rkm_medis,6),5,2)),signed)),0) from set_no_rkm_medis",
                                    "", 6, NoRm);
                            break;
                    }
                    ...
                    switch (pengurutan) {
                        case "Straight":
                            Valid.autoNomer3(
                                    "select ifnull(MAX(CONVERT(LEFT(set_no_rkm_medis.no_rkm_medis,6),signed)),0) from set_no_rkm_medis",
                                    "", 6, NoRm);
                            break;
                        case "Terminal":
                            Valid.autoNomer4(
                                    "select ifnull(MAX(CONVERT(CONCAT(SUBSTRING(LEFT(set_no_rkm_medis.no_rkm_medis,6),5,2),SUBSTRING(LEFT(set_no_rkm_medis.no_rkm_medis,6),3,2),SUBSTRING(LEFT(set_no_rkm_medis.no_rkm_medis,6),1,2)),signed)),0) from set_no_rkm_medis",
                                    "", 6, NoRm);
                            break;
                        case "Middle":
                            Valid.autoNomer5(
                                    "select ifnull(MAX(CONVERT(CONCAT(SUBSTRING(LEFT(set_no_rkm_medis.no_rkm_medis,6),3,2),SUBSTRING(LEFT(set_no_rkm_medis.no_rkm_medis,6),1,2),SUBSTRING(LEFT(set_no_rkm_medis.no_rkm_medis,6),5,2)),signed)),0) from set_no_rkm_medis",
                                    "", 6, NoRm);
                            break;
                    }
                }
                ...
                if (posisitahun.equals("Depan")) {
                    ...
                    if (!(awalanbulan + awalantahun).isEmpty()) {
                        TNo.setText(
                                NoRm.getText() + "-" + awalanbulan + awalantahun);
                    } else {
    ...
    public void setPasien(String NamaPasien, String Kontak, String Alamat,
            String TempatLahir, String TglLahir, String JK, String NoKartuJKN,
            String NIK) {
    ...
    private void panggilPhoto() {
        if (FormPhotoPass.isVisible() == true) {
            try {
                ps = koneksi.prepareStatement(
                        "select personal_pasien.gambar,aes_decrypt(personal_pasien.password,'windi') as password from personal_pasien where personal_pasien.no_rkm_medis=?");
                try {
                    ps.setString(1, NoRekamMedisDipilih.getText());
                    rs = ps.executeQuery();
                    if (rs.next()) {
                        if (rs.getString("gambar").isEmpty() || rs.getString(
                                "gambar").equals("-")) {
                            LoadHTML.setText(
                            ...
                            LoadHTML.setText(
                                    "<html><body><center><img src='http://" + koneksiDB.
                                            ...
                                            PORTWEB() + "/" + koneksiDB.
                                            HYBRIDWEB() + "/photopasien/" + rs.
                                            getString("gambar") + "' alt='photo' width='200' height='200'/></center></body></html>");
                        }
    ...
    private static final Logger LOG = Logger.
            getLogger(DlgPasien.class.getName());
}
