 ...
 * @author dosen
 */
public class DlgPilihanCetakDokumen extends javax.swing.JDialog {
            ...
            if (tbData.getValueAt(i, 0).toString().equals("true")) {
                if (tbData.getValueAt(i, 1).toString().equals("Kartu Pasien 1")) {
                    ...
                    Valid.MyReportqry("rptKartuBerobat5.jasper", "report",
                            ...
                            "select * from pasien where pasien.no_rkm_medis='" + NoRm + "' ",
                            param);
                    this.setCursor(Cursor.getDefaultCursor());
                } else if (tbData.getValueAt(i, 1).toString().equals(
                        "Kartu Pasien 2")) {
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();
                    ...
                    Valid.MyReportqry("rptKartuPasien.jasper", "report",
                            ...
                            + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
                            + "pasien.pnd, pasien.keluarga, pasien.namakeluarga from pasien inner join kelurahan inner join kecamatan inner join kabupaten "
                            + "on pasien.kd_kel=kelurahan.kd_kel and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab where pasien.no_rkm_medis='" + NoRm + "' ",
                            param);
                    this.setCursor(Cursor.getDefaultCursor());
                } else if (tbData.getValueAt(i, 1).toString().equals(
                        "Lembar Rawat Jalan Model 1")) {
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();
                    param.put("namars", akses.getnamars());
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptRM2.jasper", "report",
                            "::[ Identitas Pasien ]::",
                            "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                            + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                            + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
                    ...
                    this.setCursor(Cursor.getDefaultCursor());
                        ...
                        "Lembar Screening Awal Pasien Masuk Rawat Jalan")) {
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();
                    param.put("namars", akses.getnamars());
                    ...
                    this.setCursor(Cursor.getDefaultCursor());
                        ...
                        "Formulir Penempelan Copy Resep")) {
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();
                    param.put("namars", akses.getnamars());
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptRM9.jasper", "report",
                            "::[ Copy Resep ]::",
                            "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                            + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                            + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("persetujuantindakanmedis.jasper",
                            "report", "::[ Persetujuan Tindakan ]::",
                            "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                            + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                            + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
                            + "pasien.pnd, pasien.keluarga, pasien.namakeluarga,penjab.png_jawab,pasien.pekerjaanpj,"
                    ...
                    this.setCursor(Cursor.getDefaultCursor());
                        ...
                        "Surat Jaminan & Bukti Pelayanan Ralan")) {
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();
                    param.put("namars", akses.getnamars());
                    ...
                    this.setCursor(Cursor.getDefaultCursor());
                        ...
                        "Check List Kelengkapan Pendaftaran Kanan")) {
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptCheckList.jasper", "report",
                            "::[ Check List ]::",
                            "select current_date() as sekarang", param);
                    this.setCursor(Cursor.getDefaultCursor());
                } else if (tbData.getValueAt(i, 1).toString().equals(
                        "Check List Kelengkapan Pendaftaran Kiri")) {
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();
                    param.put("poli", NamaPoli);
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptCheckList2.jasper", "report",
                            "::[ Check List ]::",
                            "select current_date() as sekarang", param);
                    this.setCursor(Cursor.getDefaultCursor());
                } else if (tbData.getValueAt(i, 1).toString().equals(
                        "Check List Kelengkapan Pendaftaran Kanan+Tracker")) {
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();
                    param.put("poli", NamaPoli);
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptCheckList4.jasper", "report",
                            "::[ Check List ]::",
                            "select current_date() as sekarang", param);
                    this.setCursor(Cursor.getDefaultCursor());
                } else if (tbData.getValueAt(i, 1).toString().equals(
                        "Check List Kelengkapan Pendaftaran Kiri+Tracker")) {
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();
                    param.put("poli", NamaPoli);
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptCheckList3.jasper", "report",
                            "::[ Check List ]::",
                            "select current_date() as sekarang", param);
                    this.setCursor(Cursor.getDefaultCursor());
                } else if (tbData.getValueAt(i, 1).toString().equals(
                        "Lembar Periksa Pasien Kanan")) {
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();
                    param.put("poli", NamaPoli);
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptLembarPeriksa.jasper", "report",
                            "::[ Lembar Periksa ]::",
                            "select date_format(current_date(),'%d/%m/%Y') as sekarang",
                            param);
                    this.setCursor(Cursor.getDefaultCursor());
                } else if (tbData.getValueAt(i, 1).toString().equals(
                        "Lembar Periksa Pasien Kiri")) {
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();
                    param.put("poli", NamaPoli);
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptLembarPeriksa2.jasper", "report",
                            "::[ Lembar Periksa ]::",
                            "select date_format(current_date(),'%d/%m/%Y') as sekarang",
                            param);
                    this.setCursor(Cursor.getDefaultCursor());
                } else if (tbData.getValueAt(i, 1).toString().equals(
                        "Lembar Periksa Pasien Kanan 2")) {
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();
                    param.put("poli", NamaPoli);
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptLembarPeriksa3.jasper", "report",
                            "::[ Lembar Periksa]::",
                            "select date_format(current_date(),'%d/%m/%Y') as sekarang",
                            param);
                    this.setCursor(Cursor.getDefaultCursor());
                } else if (tbData.getValueAt(i, 1).toString().equals(
                        "Lembar Periksa Pasien Kiri 2")) {
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();
                    param.put("poli", NamaPoli);
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptLembarPeriksa4.jasper", "report",
                            "::[ Lembar Periksa]::",
                            "select date_format(current_date(),'%d/%m/%Y') as sekarang",
                            param);
                    this.setCursor(Cursor.getDefaultCursor());
                    ...
                    Valid.MyReportqry("rptBarcodeRawat.jasper", "report",
                            "::[ Barcode No.Rawat ]::",
                            "select reg_periksa.no_rawat from reg_periksa where no_rawat='" + NoRawat + "'",
                            param);
                    this.setCursor(Cursor.getDefaultCursor());
                } else if (tbData.getValueAt(i, 1).toString().equals(
                        "Gelang Pasien Ralan 1")) {
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    Map<String, Object> param = new HashMap<>();
                    param.put("namars", akses.getnamars());
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptBarcodeRM6.jasper", "report",
                            "::[ Gelang Pasien ]::",
                            "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                            + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                            + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptBarcodeRM4.jasper", "report",
                            "::[ Gelang Pasien ]::",
                            "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                            + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                            + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptBarcodeRM5.jasper", "report",
                            "::[ Gelang Pasien ]::",
                            "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                            + "pasien.tmp_lahir, pasien.tgl_lahir,pasien.nm_ibu, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                            + "pasien.stts_nikah,pasien.agama,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
                    ...
                    param.put("prb", Sequel.cariIsi(
                            ...
                            NoSEP));
                    if (TglRujukan.isEmpty()) {
                        if (JenisPelayanan.equals("ranap")) {
                            Valid.MyReportqry("rptBridgingSEP.jasper", "report",
                                    "::[ Cetak SEP ]::",
                                    ...
                                    + "bridging_sep.tujuankunjungan,bridging_sep.flagprosedur,bridging_sep.klsnaik,bridging_sep.pembiayaan,bridging_sep.nmdpdjp,bridging_sep.lakalantas from bridging_sep where no_sep='" + NoSEP + "'",
                                    param);
                        } else {
                            Valid.
                                    MyReportqry("rptBridgingSEP2.jasper",
                                            "report", "::[ Cetak SEP ]::",
                                            "select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"
                                            + "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"
                                            + "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"
                        ...
                        if (JenisPelayanan.equals("ranap")) {
                            Valid.MyReportqry("rptBridgingSEPInternal.jasper",
                                    ...
                                    + "where bridging_sep_internal.no_sep='" + NoSEP + "' and bridging_sep_internal.noskdp='" + NoRujukan + "' and bridging_sep_internal.tglrujukan='" + TglRujukan + "' and bridging_sep_internal.kdpolitujuan='" + KdpoliTujuan + "'",
                                    param);
                        } else {
                            Valid.MyReportqry("rptBridgingSEPInternal2.jasper",
                                    "report", "::[ Cetak SEP Internal ]::",
                                    "select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"
                                    + "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"
                                    + "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"
                    ...
                    if (TglRujukan.isEmpty()) {
                        if (JenisPelayanan.equals("ranap")) {
                            Valid.
                                    MyReportqry("rptBridgingSEP3.jasper",
                                            "report", "::[ Cetak SEP ]::",
                                            "select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"
                                            + "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"
                                            + "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"
                            ...
                            Valid.
                                    MyReportqry("rptBridgingSEP4.jasper",
                                            "report", "::[ Cetak SEP ]::",
                                            "select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"
                                            + "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"
                                            + "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"
                        ...
                        if (JenisPelayanan.equals("ranap")) {
                            Valid.MyReportqry("rptBridgingSEPInternal3.jasper",
                                    "report", "::[ Cetak SEP Internal ]::",
                                    "select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"
                                    + "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"
                                    + "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"
                            ...
                            Valid.MyReportqry("rptBridgingSEPInternal4.jasper",
                                    "report", "::[ Cetak SEP Internal ]::",
                                    "select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"
                                    + "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"
                                    + "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"
                    ...
                    if (TglRujukan.isEmpty()) {
                        if (JenisPelayanan.equals("ranap")) {
                            Valid.
                                    MyReportqry("rptBridgingSEP5.jasper",
                                            "report", "::[ Cetak SEP ]::",
                                            "select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"
                                            + "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"
                                            + "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"
                            ...
                            Valid.
                                    MyReportqry("rptBridgingSEP6.jasper",
                                            "report", "::[ Cetak SEP ]::",
                                            "select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"
                                            + "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"
                                            + "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"
                        ...
                        if (JenisPelayanan.equals("ranap")) {
                            Valid.MyReportqry("rptBridgingSEPInternal5.jasper",
                                    "report", "::[ Cetak SEP Internal ]::",
                                    "select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"
                                    + "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"
                                    + "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"
                            ...
                            Valid.MyReportqry("rptBridgingSEPInternal6.jasper",
                                    "report", "::[ Cetak SEP Internal ]::",
                                    "select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"
                                    + "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"
                                    + "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"
                    ...
                    if (TglRujukan.isEmpty()) {
                        if (JenisPelayanan.equals("ranap")) {
                            Valid.
                                    MyReportqry("rptBridgingSEP7.jasper",
                                            "report", "::[ Cetak SEP ]::",
                                            "select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"
                                            + "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"
                                            + "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"
                            ...
                            Valid.
                                    MyReportqry("rptBridgingSEP8.jasper",
                                            "report", "::[ Cetak SEP ]::",
                                            "select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"
                                            + "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"
                                            + "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"
                        ...
                        if (JenisPelayanan.equals("ranap")) {
                            Valid.MyReportqry("rptBridgingSEPInternal7.jasper",
                                    "report", "::[ Cetak SEP Internal ]::",
                                    "select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"
                                    + "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"
                                    + "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"
                            ...
                            Valid.MyReportqry("rptBridgingSEPInternal8.jasper",
                                    "report", "::[ Cetak SEP Internal ]::",
                                    "select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"
                                    + "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"
                                    + "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"
                    ...
                    param.put("kontakrs", akses.getkontakrs());
                    if (JenisPelayanan.equals("ranap")) {
                        Valid.MyReportqry("rptBridgingSJP.jasper", "report",
                                "::[ Cetak SEP ]::",
                                "select * from bridging_inhealth where no_sjp='" + NoSEP + "'",
                                param);
                    } else {
                        Valid.MyReportqry("rptBridgingSJP2.jasper", "report",
                                "::[ Cetak SEP ]::",
                                "select * from bridging_inhealth where no_sjp='" + NoSEP + "'",
                                param);
                    }
                    ...
                    if (TglRujukan.isEmpty()) {
                        if (JenisPelayanan.equals("ranap")) {
                            Valid.MyReportqrypdf("rptBridgingSEP.jasper",
                                    "report", "::[ Cetak SEP ]::",
                                    "select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"
                                    + "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"
                                    + "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"
                            ...
                            Valid.MyReportqrypdf("rptBridgingSEP2.jasper",
                                    "report", "::[ Cetak SEP ]::",
                                    "select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"
                                    + "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"
                                    + "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"
                        ...
                        if (JenisPelayanan.equals("ranap")) {
                            ...
                            Valid.MyReportqrypdf(
                                    "rptBridgingSEPInternal2.jasper", "report",
                                    "::[ Cetak SEP Internal ]::",
                                    "select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"
                                    + "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"
                                    + "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"
                    ...
                    if (TglRujukan.isEmpty()) {
                        if (JenisPelayanan.equals("ranap")) {
                            Valid.MyReportqrypdf("rptBridgingSEP3.jasper",
                                    "report", "::[ Cetak SEP ]::",
                                    "select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"
                                    + "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"
                                    + "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"
                            ...
                            Valid.MyReportqrypdf("rptBridgingSEP4.jasper",
                                    "report", "::[ Cetak SEP ]::",
                                    "select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"
                                    + "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"
                                    + "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"
                        ...
                        if (JenisPelayanan.equals("ranap")) {
                            Valid.MyReportqrypdf(
                                    "rptBridgingSEPInternal3.jasper", "report",
                                    "::[ Cetak SEP Internal ]::",
                                    "select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"
                                    + "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"
                                    + "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"
                            ...
                            Valid.MyReportqrypdf(
                                    "rptBridgingSEPInternal4.jasper", "report",
                                    "::[ Cetak SEP Internal ]::",
                                    "select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"
                                    + "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"
                                    + "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"
                    ...
                    if (TglRujukan.isEmpty()) {
                        if (JenisPelayanan.equals("ranap")) {
                            Valid.MyReportqrypdf("rptBridgingSEP5.jasper",
                                    "report", "::[ Cetak SEP ]::",
                                    "select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"
                                    + "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"
                                    + "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"
                            ...
                            Valid.MyReportqrypdf("rptBridgingSEP6.jasper",
                                    "report", "::[ Cetak SEP ]::",
                                    "select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"
                                    + "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"
                                    + "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"
                        ...
                        if (JenisPelayanan.equals("ranap")) {
                            Valid.MyReportqrypdf(
                                    "rptBridgingSEPInternal5.jasper", "report",
                                    "::[ Cetak SEP Internal ]::",
                                    "select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"
                                    + "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"
                                    + "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"
                            ...
                            Valid.MyReportqrypdf(
                                    "rptBridgingSEPInternal6.jasper", "report",
                                    "::[ Cetak SEP Internal ]::",
                                    "select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"
                                    + "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"
                                    + "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"
                    ...
                    if (TglRujukan.isEmpty()) {
                        if (JenisPelayanan.equals("ranap")) {
                            Valid.MyReportqrypdf("rptBridgingSEP7.jasper",
                                    "report", "::[ Cetak SEP ]::",
                                    "select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"
                                    + "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"
                                    + "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"
                            ...
                            Valid.MyReportqrypdf("rptBridgingSEP8.jasper",
                                    "report", "::[ Cetak SEP ]::",
                                    "select bridging_sep.no_sep, bridging_sep.no_rawat,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tglsep,"
                                    + "bridging_sep.tglrujukan,bridging_sep.no_rujukan,bridging_sep.kdppkrujukan,"
                                    + "bridging_sep.nmppkrujukan,bridging_sep.kdppkpelayanan,bridging_sep.nmppkpelayanan,"
                        ...
                        if (JenisPelayanan.equals("ranap")) {
                            Valid.MyReportqrypdf(
                                    "rptBridgingSEPInternal7.jasper", "report",
                                    "::[ Cetak SEP Internal ]::",
                                    "select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"
                                    + "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"
                                    + "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"
                            ...
                            Valid.MyReportqrypdf(
                                    "rptBridgingSEPInternal8.jasper", "report",
                                    "::[ Cetak SEP Internal ]::",
                                    "select bridging_sep_internal.no_sep, bridging_sep_internal.no_rawat,bridging_sep_internal.nomr,bridging_sep_internal.nama_pasien,bridging_sep_internal.tglsep,"
                                    + "bridging_sep_internal.tglrujukan,bridging_sep_internal.no_rujukan,bridging_sep_internal.kdppkrujukan,"
                                    + "bridging_sep_internal.nmppkrujukan,bridging_sep_internal.kdppkpelayanan,bridging_sep_internal.nmppkpelayanan,"
                    ...
                    param.put("kontakrs", akses.getkontakrs());
                    if (JenisPelayanan.equals("ranap")) {
                        Valid.MyReportqrypdf("rptBridgingSJP.jasper", "report",
                                "::[ Cetak SEP ]::",
                                "select * from bridging_inhealth where no_sjp='" + NoSEP + "'",
                                param);
                    } else {
                        Valid.MyReportqrypdf("rptBridgingSJP2.jasper", "report",
                                "::[ Cetak SEP ]::",
                                "select * from bridging_inhealth where no_sjp='" + NoSEP + "'",
                                param);
                    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPilihanCetakDokumen dialog = new DlgPilihanCetakDokumen(
    ...
    public void tampil() {
        try {
            ...
            TabMode.addRow(new Object[]{false,
                "Lembar Screening Awal Pasien Masuk Rawat Jalan"});//18,0
            TabMode.
                    addRow(new Object[]{false, "Formulir Penempelan Copy Resep"});//19,0
            ...
            TabMode.addRow(new Object[]{false,
                "Surat Jaminan & Bukti Pelayanan Ralan"});//23,0
            TabMode.addRow(new Object[]{false,
                "Check List Kelengkapan Pendaftaran Kanan"});//24,0
            TabMode.addRow(new Object[]{false,
                "Check List Kelengkapan Pendaftaran Kiri"});//25,0
            TabMode.addRow(new Object[]{false,
                "Check List Kelengkapan Pendaftaran Kanan+Tracker"});//26,0
            TabMode.addRow(new Object[]{false,
                "Check List Kelengkapan Pendaftaran Kiri+Tracker"});//27,0
    ...
    public void tampil2() {
        try {
            ...
            TabMode.addRow(new Object[]{false,
                "Check List Kelengkapan Pendaftaran Kanan+Tracker"});//26,0
            TabMode.addRow(new Object[]{false,
                "Check List Kelengkapan Pendaftaran Kiri+Tracker"});//26,0
    ...
    public void tampil3() {
        try {
            ...
            TabMode.addRow(new Object[]{false,
                "Surat Jaminan & Bukti Pelayanan Ralan"});//22,0
            TabMode.addRow(new Object[]{false,
                "Check List Kelengkapan Pendaftaran Kanan"});//23,0
            TabMode.addRow(new Object[]{false,
                "Check List Kelengkapan Pendaftaran Kiri"});//24,0
            TabMode.addRow(new Object[]{false,
                "Check List Kelengkapan Pendaftaran Kanan+Tracker"});//25,0
            TabMode.addRow(new Object[]{false,
                "Check List Kelengkapan Pendaftaran Kiri+Tracker"});//26,0
            TabMode.addRow(new Object[]{false, "Lembar Periksa Pasien Kanan"});//27,0
            TabMode.addRow(new Object[]{false, "Lembar Periksa Pasien Kiri"});//28,0
    ...
    public void setNoRm(String NoRawat, String NoRm, String NoSEP, String NoReg,
            String NamaPoli,
            String NamaBayar, String NamaDokter, String NamaPasien,
            String AlamatPasien,
     ...
     * @param KdpoliTujuan
     */
    public void setRujukan(String NoRujukan, String TglRujukan,
            String KdpoliTujuan) {
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgPilihanCetakDokumen.class.getName());
}
