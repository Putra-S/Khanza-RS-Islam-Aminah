...
public class DlgDiet extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("diet", "'" + TKd.getText() + "','" + TNm.
                    getText() + "'", "Kode diet") == true) {
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbSpesialis.getSelectedRow() != -1) {
            if (Sequel.meghapustf("diet", "kd_diet", tbSpesialis.getValueAt(
                    tbSpesialis.getSelectedRow(), 0).toString()) == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                if (Sequel.mengedittf("diet", "kd_diet=?",
                        "kd_diet=?,nama_diet=?", 3, new String[]{
                            TKd.getText(), TNm.getText(), tbSpesialis.
                            getValueAt(tbSpesialis.getSelectedRow(), 0).
                            toString()
                        }) == true) {
                    tabMode.setValueAt(TKd.getText(), tbSpesialis.
                            getSelectedRow(), 0);
                    tabMode.setValueAt(TNm.getText(), tbSpesialis.
                            getSelectedRow(), 1);
                    emptTeks();
                }
            } else {
    ...
    private static final Logger LOG = Logger.getLogger(DlgDiet.class.getName());
}
