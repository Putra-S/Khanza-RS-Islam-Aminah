...
public class DlgSuku extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("suku_bangsa", "'0','" + Nama.getText() + "'",
                    "Suku Bangsa");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            if (Sequel.meghapustf("suku_bangsa", "id", tbkecamatan.getValueAt(
                    tbkecamatan.getSelectedRow(), 0).toString()) == true) {
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from suku_bangsa where nama_suku_bangsa like ? ");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(DlgSuku.class.getName());
}
