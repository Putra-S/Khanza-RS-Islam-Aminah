...
public class DlgPerusahaan extends javax.swing.JDialog {
    ...
    public DlgPerusahaan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Kode", "Nama Instansi/Perusahaan",
            "Alamat Instansi/Perusahaan", "Kota", "No.Telp"};
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Nm.getText().trim().isEmpty()) {
            ...
            if (Valid.hapusTabletf(tabMode, Kd, "perusahaan_pasien",
                    "kode_perusahaan") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            if (Valid.editTabletf(tabMode, "perusahaan_pasien",
                    "kode_perusahaan", "?",
                    "kode_perusahaan=?,nama_perusahaan=?,alamat=?,kota=?,no_telp=?",
                    6, new String[]{
                ...
                if (tbDokter.getSelectedRow() != -1) {
                    tbDokter.setValueAt(Kd.getText(), tbDokter.getSelectedRow(),
                            0);
                    tbDokter.setValueAt(Nm.getText(), tbDokter.getSelectedRow(),
                            1);
                    tbDokter.setValueAt(Alamat.getText(), tbDokter.
                            getSelectedRow(), 2);
                    tbDokter.setValueAt(Kota.getText(), tbDokter.
                            getSelectedRow(), 3);
                    tbDokter.setValueAt(Telp.getText(), tbDokter.
                            getSelectedRow(), 4);
                    emptTeks();
                }
            }
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().isEmpty()) {
                ...
                sql = "select perusahaan_pasien.kode_perusahaan, perusahaan_pasien.nama_perusahaan, "
                        ...
                        + " where perusahaan_pasien.kode_perusahaan like '%" + TCari.
                                getText().trim() + "%' or "
                        + " perusahaan_pasien.nama_perusahaan like '%" + TCari.
                                getText().trim() + "%' or "
                        + " perusahaan_pasien.alamat like '%" + TCari.getText().
                                trim() + "%' or "
                        + " perusahaan_pasien.kota like '%" + TCari.getText().
                                trim() + "%' or "
                        + " perusahaan_pasien.no_telp like '%" + TCari.getText().
                                trim() + "%' order by perusahaan_pasien.kode_perusahaan";
            }
            ...
            Valid.MyReportqry("rptPerusahaan.jasper", "report",
                    "::[ Data Instansi/Perusahaan ]::", sql, param);
        }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("perusahaan_pasien", "?,?,?,?,?",
                    "Kode Instasi/Perusahaan", 5, new String[]{
                        Kd.getText(), Nm.getText(), Alamat.getText(), Kota.
                        getText(), Telp.getText()
                    }) == true) {
                tabMode.addRow(new String[]{
                    Kd.getText(), Nm.getText(), Alamat.getText(), Kota.getText(),
                    Telp.getText()
                });
                LCount.setText("" + tabMode.getRowCount());
                emptTeks();
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPerusahaan dialog = new DlgPerusahaan(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select perusahaan_pasien.kode_perusahaan, perusahaan_pasien.nama_perusahaan, "
                    + " perusahaan_pasien.alamat,perusahaan_pasien.kota, perusahaan_pasien.no_telp from perusahaan_pasien "
    ...
    private static final Logger LOG = Logger.getLogger(DlgPerusahaan.class.
            getName());
