...
public class DlgUbahNilaiLab extends javax.swing.JDialog {
    ...
    public void setNoRm(String norwt, String tanggal, String jam) {
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{"   " + rs.getString("Pemeriksaan"), rs.getString("nilai"),
                        rs.getString("satuan"), rs.getString("nilai_rujukan"), rs.getString("keterangan"),
    ...
    private static final Logger LOG = Logger.getLogger(DlgUbahNilaiLab.class.getName());
