...
public class DlgJabatanPolri extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("jabatan_polri", "'0','" + Nama.getText() + "'",
                    "Jabatan POLRI");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            if (tbkecamatan.getSelectedRow() != -1) {
                if (Sequel.meghapustf("jabatan_polri", "id", tbkecamatan.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJabatanPolri dialog = new DlgJabatanPolri(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from jabatan_polri where nama_jabatan like ? ");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(DlgJabatanPolri.class.
            getName());
}
