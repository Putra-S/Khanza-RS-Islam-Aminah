...
public class DlgKtgPerawatan extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from kategori_perawatan where kd_kategori like ? " + "or nm_kategori like ? ");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(DlgKtgPerawatan.class.getName());
