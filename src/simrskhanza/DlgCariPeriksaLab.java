        ...
        switch (TabRawat.getSelectedIndex()) {
            case 0:
                if (tabMode.getRowCount() == 0) {
                    ...
                    Valid.MyReport("rptDataLab.jasper", "report",
                            "::[ Data Pemeriksaan Laboratorium ]::", param);
                }
                break;
            case 1:
                if (tabMode2.getRowCount() == 0) {
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReport("rptDataLab2.jasper", "report",
                            "::[ Data Item Pemeriksaan Laboratorium ]::", param);
                }
                break;
            case 2:
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                try {
                    ...
                    try (BufferedWriter bw = new BufferedWriter(
                        ...
                        bw.write(LoadHTML1.getText().replaceAll("<head>",
                                ...
                                getemailrs() + "<br><br>"
                                + "<font size='2' face='Tahoma'>DETAIL KUNJUNGAN LAB PERIODE " + Tgl1.
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
    if (TabRawat.getSelectedIndex() == 0) {
        if (tabMode.getRowCount() == 0) {
            ...
            TCari.requestFocus();
        } else if (Kd2.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null,
                ...
                if (reply == JOptionPane.YES_OPTION) {
                    try {
                        ...
                        ttljmdokter = Sequel.cariIsiAngka(
                                "select sum(tarif_tindakan_dokter) from periksa_lab where periksa_lab.kategori='PK' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                                        getSelectedRow(), 4) + "'");
                        ttljmpetugas = Sequel.cariIsiAngka(
                                "select sum(tarif_tindakan_petugas) from periksa_lab where periksa_lab.kategori='PK' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        ttlkso = Sequel.cariIsiAngka(
                                "select sum(kso) from periksa_lab where periksa_lab.kategori='PK' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        ttlbhp = Sequel.cariIsiAngka(
                                "select sum(bhp) from periksa_lab where periksa_lab.kategori='PK' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        ttlpendapatan = Sequel.cariIsiAngka(
                                "select sum(biaya) from periksa_lab where periksa_lab.kategori='PK' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        ttljasasarana = Sequel.cariIsiAngka(
                                "select sum(bagian_rs) from periksa_lab where periksa_lab.kategori='PK' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        ttljmperujuk = Sequel.cariIsiAngka(
                                "select sum(tarif_perujuk) from periksa_lab where periksa_lab.kategori='PK' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        ttlmenejemen = Sequel.cariIsiAngka(
                                "select sum(menejemen) from periksa_lab where periksa_lab.kategori='PK' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        ttljmdokter += Sequel.cariIsiAngka(
                                "select sum(bagian_dokter) from detail_periksa_lab where no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                                        getSelectedRow(), 4) + "'");
                        ttljmpetugas += Sequel.cariIsiAngka(
                                "select sum(bagian_laborat) from detail_periksa_lab where no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                                        getSelectedRow(), 4) + "'");
                        ttlkso += Sequel.cariIsiAngka(
                                "select sum(kso) from detail_periksa_lab where no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                                        getSelectedRow(), 4) + "'");
                        ttlbhp += Sequel.cariIsiAngka(
                                "select sum(bhp) from detail_periksa_lab where no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                                        getSelectedRow(), 4) + "'");
                        ttlpendapatan += Sequel.cariIsiAngka(
                                "select sum(biaya_item) from detail_periksa_lab where no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                                        getSelectedRow(), 4) + "'");
                        ttljasasarana += Sequel.cariIsiAngka(
                                "select sum(bagian_rs) from detail_periksa_lab where no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                                        getSelectedRow(), 4) + "'");
                        ttljmperujuk += Sequel.cariIsiAngka(
                                "select sum(bagian_perujuk) from detail_periksa_lab where no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                                        getSelectedRow(), 4) + "'");
                        ttlmenejemen += Sequel.cariIsiAngka(
                                "select sum(menejemen) from detail_periksa_lab where no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        status = Sequel.cariIsi(
                                "select status from periksa_lab where periksa_lab.kategori='PK' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        if (Sequel.queryutf(
                                "delete from periksa_lab where periksa_lab.kategori='PK' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                                        getSelectedRow(), 4) + "'") == true) {
                            if (Sequel.queryutf(
                                    "delete from detail_periksa_lab where no_rawat='" + tbDokter.
                                            getValueAt(tbDokter.getSelectedRow(),
                                                    0)
                                    + "' and tgl_periksa='" + tbDokter.
                                            getValueAt(tbDokter.getSelectedRow(),
                                                    3)
                                    + "' and jam='" + tbDokter.getValueAt(
                                            tbDokter.getSelectedRow(), 4) + "'") == false) {
                                sukses = false;
                            }
                        } else {
                            sukses = false;
                        ...
                        if (sukses == true) {
                            if (status.equals("Ranap")) {
                                ...
                                sukses = jur.simpanJurnal(tbDokter.getValueAt(
                                        ...
                                        "U",
                                        "PEMBATALAN PEMERIKSAAN LABORAT RAWAT INAP PASIEN " + tbDokter.
                                                getValueAt(tbDokter.
                                                        getSelectedRow(), 1).
                                                toString() + " OLEH " + akses.
                                                getkode());
                                ...
                                sukses = jur.simpanJurnal(tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 0).toString(),
                                        "U",
                                        "PEMBATALAN PEMERIKSAAN LABORAT RAWAT JALAN PASIEN " + tbDokter.
                                                getValueAt(tbDokter.
                                                        getSelectedRow(), 1).
                                                toString() + " OLEH " + akses.
                                                getkode());
        ...
        JOptionPane.showMessageDialog(null,
                "Hanya bisa dilakukan hapus di Data Pemeriksaan..!!!");
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
    ...
    private void MnCetakHasilLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilLabActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            JOptionPane.showMessageDialog(null,
                    "Maaf, Gagal mencetak. Pilih dulu data yang mau dicetak.\nKlik No.Rawat pada table untuk memilih...!!!!");
        } else if (!(Kd2.getText().trim().isEmpty())) {
            try {
                ...
                try {
                    ps4.setString(1, tbDokter.getValueAt(tbDokter.
                            getSelectedRow(), 3).toString());
                    ps4.setString(2, tbDokter.getValueAt(tbDokter.
                            getSelectedRow(), 4).toString());
                    ps4.setString(3, tbDokter.getValueAt(tbDokter.
                    ...
                    while (rs.next()) {
                        ...
                        param.put("notlp", Sequel.cariIsi(
                        ...
                        param.put("noktp", Sequel.cariIsi(
                                ...
                                rs.getString("no_rkm_medis")));
                        param.put("alamatpj", Sequel.cariIsi(
                                "select concat(pasien.alamatpj,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) AS alamat from pasien inner join kelurahan inner join kecamatan inner join kabupaten on pasien.kd_kel=kelurahan.kd_kel and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab where pasien.no_rkm_medis=?",
                                rs.getString("no_rkm_medis")));
                        param.put("pengirim", Sequel.cariIsi(
                        ...
                        param.put("finger2", "Dikeluarkan di " + akses.
                                getnamars() + ", Kabupaten/Kota " + akses.
                                        getkabupatenrs() + "\nDitandatangani secara elektronik oleh " + rs.
                                        getString("nama") + "\nID " + (finger.
                                isEmpty() ? rs.getString("nip") : finger) + "\n" + rs.
                                getString("tgl_periksa"));
                        Sequel.queryu("delete from temporary_lab");
                        ...
                        try {
                            ...
                            ps2.setString(2, Valid.SetTgl(rs.getString(
                                    "tgl_periksa")));
                            ...
                            while (rs2.next()) {
                                ...
                                try {
                                    ...
                                    ps3.setString(2, rs2.getString(
                                            "kd_jenis_prw"));
                                    ps3.setString(3, Valid.SetTgl(rs.getString(
                                            "tgl_periksa")));
                                    ...
                                    while (rs3.next()) {
                                        Sequel.menyimpan("temporary_lab",
                                                "'" + i + "','  " + rs3.
                                                        getString("Pemeriksaan") + "','" + rs3.
                                                getString("nilai").replaceAll(
                                                "'", "`") + "','" + rs3.
                                                        getString("satuan")
                                                + "','" + rs3.getString(
                                                        "nilai_rujukan") + "','" + rs3.
                        ...
                        try {
                            ...
                            pspermintaan.setString(2, Valid.SetTgl(rs.getString(
                                    "tgl_periksa")));
                            pspermintaan.setString(3, rs.getString("jam"));
                            rspermintaan = pspermintaan.executeQuery();
                            if (rspermintaan.next()) {
                                param.put("nopermintaan", rspermintaan.
                                        getString("noorder"));
                                param.put("tanggalpermintaan", rspermintaan.
                                        getString("tgl_permintaan"));
                                param.put("jampermintaan", rspermintaan.
                                        getString("jam_permintaan"));
            ...
            try {
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        try {
                            ...
                            while (rs2.next()) {
                                ...
                                Sequel.menyimpan("temporary_lab",
                                        "'" + i + "','" + rs2.getString(
                                                "kd_jenis_prw") + "','" + rs2.
                                                getString("nm_perawatan") + "','" + item + "','Pemeriksaan','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',''",
                                        "Transaksi Biaya Lab");
                                i++;
                                ps3 = koneksi.prepareStatement(
                                        "select template_laboratorium.Pemeriksaan, detail_periksa_lab.nilai,template_laboratorium.satuan,detail_periksa_lab.nilai_rujukan,detail_periksa_lab.biaya_item,"
                                ...
                                try {
                                    ...
                                    while (rs3.next()) {
                                        ...
                                        Sequel.menyimpan("temporary_lab",
                                                "'" + i + "','" + rs3.getString(
                                                        "kd_jenis_prw") + "','   " + rs3.
                                                        getString("Pemeriksaan") + "','" + item + "','Detail Pemeriksaan','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',''",
                                                "Transaksi Biaya Lab");
                                        i++;
                                    }
                                } catch (SQLException e) {
                        ...
                        Sequel.menyimpan("temporary_lab",
                                "'" + i + "','','Total Biaya Pemeriksaan Lab','" + ttl + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',''",
                                "Transaksi Biaya Lab");
                        i++;
                        Valid.panggilUrl(
                                "billing/LaporanBiayaLab.php?norm=" + rs.
                                        getString("no_rkm_medis") + "&pasien=" + rs.
                                getString("nm_pasien").replaceAll(" ", "_")
                                + "&tanggal=" + rs.getString("tgl_periksa") + "&jam=" + rs.
                                getString("jam") + "&pjlab=" + rs.getString(
                                "nm_dokter").replaceAll(" ", "_")
                                + "&petugas=" + rs.getString("nama").replaceAll(
                                        " ", "_") + "&kasir=" + Sequel.cariIsi(
                                        "select pegawai.nama from pegawai where pegawai.nik=?",
                                        akses.getkode())
                                + "&usere=" + koneksiDB.USERHYBRIDWEB() + "&passwordte=" + koneksiDB.
                                PASHYBRIDWEB());
                    }
                } catch (SQLException e) {
                    System.out.println("Notif ps4 : " + e);
    ...
    private void MnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnUbahActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            JOptionPane.showMessageDialog(null,
                    "Maaf, Gagal mengubah. Pilih dulu data yang mau dicetak.\nKlik No.Rawat pada table untuk memilih...!!!!");
        } else if (!(Kd2.getText().trim().isEmpty())) {
            if (Sequel.cariRegistrasi(tbDokter.getValueAt(tbDokter.
                    getSelectedRow(), 0).toString()) > 0) {
                JOptionPane.showMessageDialog(rootPane,
                ...
                ubah.setNoRm(tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).
                        toString(),
                        tbDokter.getValueAt(tbDokter.getSelectedRow(), 3).
                                toString(),
                        tbDokter.getValueAt(tbDokter.getSelectedRow(), 4).
                                toString());
    ...
    private void MnCetakHasilLab1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilLab1ActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            JOptionPane.showMessageDialog(null,
                    "Maaf, Gagal mencteak. Pilih dulu data yang mau dicetak.\nKlik No.Rawat pada table untuk memilih...!!!!");
        } else if (!(Kd2.getText().trim().isEmpty())) {
            try {
                ps4 = koneksi.prepareStatement(
                        "select periksa_lab.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.umur,petugas.nama,DATE_FORMAT(periksa_lab.tgl_periksa,'%d-%m-%Y') as tgl_periksa,periksa_lab.jam,periksa_lab.nip,"
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.
                                        MyReport("rptPeriksaLab2.jasper",
                                                "report",
                                                "::[ Pemeriksaan Laboratorium ]::",
                                                param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.
                                        MyReport("rptPeriksaLab3.jasper",
                                                "report",
                                                "::[ Pemeriksaan Laboratorium ]::",
                                                param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.
                                        MyReport("rptPeriksaLab4.jasper",
                                                "report",
                                                "::[ Pemeriksaan Laboratorium ]::",
                                                param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.
                                        MyReport(
                                                "rptPeriksaLab5Permintaan.jasper",
                                                "report",
                                                "::[ Pemeriksaan Laboratorium ]::",
                                                param);
                            } else {
                                Valid.
                                        MyReport("rptPeriksaLab5.jasper",
                                                "report",
                                                "::[ Pemeriksaan Laboratorium ]::",
                                                param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.
                                        MyReport(
                                                "rptPeriksaLab6Permintaan.jasper",
                                                "report",
                                                "::[ Pemeriksaan Laboratorium ]::",
                                                param);
                            } else {
                                Valid.
                                        MyReport("rptPeriksaLab6.jasper",
                                                "report",
                                                "::[ Pemeriksaan Laboratorium ]::",
                                                param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        if (!kamar.isEmpty()) {
                            ...
                            diagnosa = Sequel.cariIsi(
                                    "select nm_penyakit from penyakit inner join diagnosa_pasien on penyakit.kd_penyakit=diagnosa_pasien.kd_penyakit where diagnosa_pasien.status='Ranap' and diagnosa_pasien.prioritas='1' and diagnosa_pasien.no_rawat=?",
                            ...
                            namakamar = Sequel.cariIsi(
                                    ...
                                    + "where reg_periksa.no_rawat='" + rs.
                                            getString("no_rawat") + "'");
                            diagnosa = Sequel.cariIsi(
                                    "select nm_penyakit from penyakit inner join diagnosa_pasien on penyakit.kd_penyakit=diagnosa_pasien.kd_penyakit where diagnosa_pasien.status='Ralan' and diagnosa_pasien.prioritas='1' and diagnosa_pasien.no_rawat=?",
                                    rs.getString("no_rawat"));
                        }
                        Map<String, Object> param = new HashMap<>();
                        param.put("noperiksa", rs.getString("no_rawat"));
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.
                                        MyReport(
                                                "rptPeriksaLab7Permintaan.jasper",
                                                "report",
                                                "::[ Pemeriksaan Laboratorium ]::",
                                                param);
                            } else {
                                Valid.
                                        MyReport("rptPeriksaLab7.jasper",
                                                "report",
                                                "::[ Pemeriksaan Laboratorium ]::",
                                                param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.
                                        MyReport(
                                                "rptPeriksaLab8Permintaan.jasper",
                                                "report",
                                                "::[ Pemeriksaan Laboratorium ]::",
                                                param);
                            } else {
                                Valid.
                                        MyReport("rptPeriksaLab8.jasper",
                                                "report",
                                                "::[ Pemeriksaan Laboratorium ]::",
                                                param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.
                                        MyReport(
                                                "rptPeriksaLab9Permintaan.jasper",
                                                "report",
                                                "::[ Pemeriksaan Laboratorium ]::",
                                                param);
                            } else {
                                Valid.
                                        MyReport("rptPeriksaLab9.jasper",
                                                "report",
                                                "::[ Pemeriksaan Laboratorium ]::",
                                                param);
                            }
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                param.put("jampermintaan", rspermintaan.
                                        getString("jam_permintaan"));
                                Valid.MyReport(
                                        "rptPeriksaLab10Permintaan.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            } else {
                                Valid.MyReport("rptPeriksaLab10.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                param.put("jampermintaan", rspermintaan.
                                        getString("jam_permintaan"));
                                Valid.MyReport(
                                        "rptPeriksaLab11Permintaan.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            } else {
                                Valid.MyReport("rptPeriksaLab11.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (Kd2.getText().isEmpty()) {
                ...
                try {
                    ...
                    WindowSaran.setSize(internalFrame1.getWidth() - 20,
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd2.getText().isEmpty()) {
            ...
            if (Saran.getText().isEmpty() && Kesan.getText().isEmpty()) {
                Sequel.queryu2(
                        ...
                        3, new String[]{
                            tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).
                                    ...
                                    getSelectedRow(), 3).toString(), tbDokter.
                                    getValueAt(tbDokter.getSelectedRow(), 4).
                                    toString()
                        });
            } else {
                if (Sequel.menyimpantf2("saran_kesan_lab", "?,?,?,?,?",
                        "Kesan & Saran", 5, new String[]{
                            tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).
                                    toString(), tbDokter.getValueAt(tbDokter.
                                    getSelectedRow(), 3).toString(),
                            tbDokter.getValueAt(tbDokter.getSelectedRow(), 4).
                                    toString(), Saran.getText(), Kesan.getText()
                        }) == false) {
                    Sequel.queryu2(
                            "update saran_kesan_lab set saran=?,kesan=? where no_rawat=? and tgl_periksa=? and jam=?",
                            5, new String[]{
                                Saran.getText(), Kesan.getText(), tbDokter.
                                getValueAt(tbDokter.getSelectedRow(), 0).
                                toString(),
                                tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 3).
                                        toString(), tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 4).toString()
                            });
                }
            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReportPDF("rptPeriksaLab.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReportPDF("rptPeriksaLab2.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReportPDF("rptPeriksaLab3.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReportPDF("rptPeriksaLab4.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReportPDF("rptPeriksaLab5.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReportPDF("rptPeriksaLab6.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReportPDF("rptPeriksaLab7.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReportPDF("rptPeriksaLab8.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReportPDF("rptPeriksaLab9.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReportPDF("rptPeriksaLab10.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReportPDF("rptPeriksaLab11.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
    ...
    private void MnCetakSuratCovidActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratCovidActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbDokter.getSelectedRow() != -1) {
                ...
                resume.setNoRm(
                        tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).
                                toString(), Tgl1.getDate(), Tgl2.getDate());
                resume.tampil();
...
//                        param.put("lahir",rs.getString("tgl_lahir"));
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                param.put("jampermintaan", rspermintaan.
                                        getString("jam_permintaan"));
                                param.put("klinis", rspermintaan.getString(
                                        "diagnosa_klinis"));
                                Valid.MyReport(
                                        "rptPeriksaLab12Permintaan.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            } else {
                                Valid.MyReport("rptPeriksaLab12.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
...
//                        param.put("lahir",rs.getString("tgl_lahir"));
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReportPDF("rptPeriksaLab12.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
    ...
    private void ppRiwayatBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppRiwayatBtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (Kd2.getText().isEmpty()) {
                ...
                datapasien = Sequel.cariIsi(
                        "select reg_periksa.no_rkm_medis from reg_periksa where reg_periksa.no_rawat=?",
                        Kd2.getText());
                resume.setNoRm(datapasien, tbDokter.getValueAt(tbDokter.
                        getSelectedRow(), 1).toString().replaceAll(
                                datapasien + " ", ""));
                resume.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                        getHeight() - 20);
                resume.setLocationRelativeTo(internalFrame1);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPeriksaLab dialog = new DlgCariPeriksaLab(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{rs.getString("no_rawat"), rs.
                        ...
                        rs.getString("nama"), rs.getString("tgl_periksa"), rs.
                        getString("jam"),
                        Sequel.cariIsi(
                        "select dokter.nm_dokter from dokter where dokter.kd_dokter=?",
                        rs.getString("dokter_perujuk")), rs.getString(
                        "nm_dokter")});
                    tabMode.addRow(new Object[]{"", "Cara Bayar : " + rs.
                        getString("png_jawab"), "Pemeriksaan", "Hasil", "Satuan",
                            ...
                            try {
                                ...
                                while (rs3.next()) {
                                    ...
                                    tabMode.addRow(new Object[]{"", "",
                                        "  " + rs3.getString("Pemeriksaan") + " " + Valid.
                                        SetAngka(rs3.getDouble("biaya_item")),
                                        rs3.getString("nilai").replaceAll("'",
                                        "`"),
                                        rs3.getString("satuan"), rs3.getString(
                                        "nilai_rujukan"), rs3.getString(
                                        "keterangan")});
                                }
                            } catch (SQLException e) {
                                System.out.println("Notif ps3 : " + e);
                    ...
                    if (item > 0) {
                        tabMode.addRow(new Object[]{"", "",
                            "Biaya Periksa : " + Valid.SetAngka(item), "", "",
                ...
                while (rs.next()) {
                    ...
                    if (rs.getString("status").equals("Ranap")) {
                        kamar = Sequel.cariIsi(
                                ...
                                + " and kamar_inap.kd_kamar=kamar.kd_kamar where no_rawat=? order by tgl_masuk desc limit 1 ",
                                rs.getString("no_rawat"));
                    }
                    ...
                    tabMode2.addRow(new String[]{
                        ...
                        "nm_pasien") + " (" + rs.getString("png_jawab") + ")",
                        rs.getString("tgl_periksa"), rs.getString("jam"), rs.
                        getString("nm_perawatan"), rs.getString("Pemeriksaan"),
                        rs.getString("nilai"), rs.getString("satuan"), rs.
                        getString("nilai_rujukan"), rs.getString("keterangan"),
                        kamar, rs.getString("nama"), Sequel.cariIsi(
                        "select dokter.nm_dokter from dokter where dokter.kd_dokter=?",
                        rs.getString("dokter_perujuk")),
            ...
            try {
                ...
                while (rs.next()) {
                    htmlContent.append(
                            ...
                            + "<td valign='top' align='center'>" + rs.getString(
                                    "no_rkm_medis") + "</td>"
                            + "<td valign='top'>" + rs.getString("nm_pasien") + " (" + rs.
                            getString("png_jawab") + ")" + "</td>"
                            + "<td valign='top'>" + rs.getString("umurdaftar") + " " + rs.
                            getString("sttsumur") + "</td>"
                    ...
                    try {
                        ...
                        ps2.setString(5, Valid.SetTgl(
                                Tgl1.getSelectedItem() + ""));
                        ps2.setString(6, Valid.SetTgl(
                        ...
                        while (rs2.next()) {
                            htmlContent.append(
                                    "<tr class='isi'>"
                                    + "<td valign='top' align='center'>" + rs2.
                                            getString("no_rawat") + "</td>"
                                    + "<td valign='top'>" + rs2.getString(
                                            "tgl_periksa") + " " + rs2.
                                            getString("jam") + "</td>"
                                    + "<td valign='top'>"
                                    + "<table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0' class='tbl_form'>"
                            ...
                            try {
                                ...
                                ps3.setString(8, Valid.SetTgl(Tgl1.
                                        getSelectedItem() + ""));
                                ps3.setString(9, Valid.SetTgl(Tgl2.
                                        getSelectedItem() + ""));
                                ps3.setString(10,
                                        "%" + TCari.getText().trim() + "%");
                                ps3.setString(11,
                                ...
                                while (rs3.next()) {
                                    htmlContent.append(
                                            "<tr class='isi'>"
                                            + "<td valign='top'>" + Sequel.
                                                    cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",
                                                            rs3.getString(
                                                                    "kd_dokter")) + "</td>"
                                            + "<td valign='top'>" + rs3.
                                                    getString("nm_dokter") + "</td>"
                                            + "<td valign='top'>" + rs3.
                                                    getString("nm_petugas") + "</td>"
                                            + "<td valign='top'>"
                                            + "<table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0' class='tbl_form'>"
                                            + "<tr class='isi'>"
                                            + "<td valign='top' bgcolor='#fdfff9' align='left' colspan='5'>" + rs3.
                                                    getString("nm_perawatan") + "</td>"
                                            + "</tr>");
                                    ps5 = koneksi.prepareStatement(
                                    ...
                                    try {
                                        ps5.setString(1, rs2.getString(
                                                "no_rawat"));
                                        ps5.setString(2, rs3.getString(
                                                "kd_jenis_prw"));
                                        ps5.setString(3, rs2.getString(
                                                "tgl_periksa"));
                                        ...
                                        while (rs5.next()) {
                                            htmlContent.append(
                                                    ...
                                                    + "<td valign='top'>" + rs5.
                                                            getString(
                                                                    "Pemeriksaan") + "</td>"
                                                    + "<td valign='top' align='center'>" + rs5.
                                                            getString("nilai") + "</td>"
                                                    + "<td valign='top' align='center'>" + rs5.
                                                            getString("satuan") + "</td>"
                                                    + "<td valign='top' align='center'>" + rs5.
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariPeriksaLab.class.
            getName());
