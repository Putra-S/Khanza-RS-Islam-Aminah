...
public class DlgCariCaraBayar2 extends javax.swing.JDialog {
    ...
    private void tampil2() {
        try {
            ...
            Valid.tabelKosong(tabMode);
            for (i = 0; i < jml; i++) {
                tabMode.addRow(new Object[]{pilih[i], KodeAsuransi[i], NamaAsuransi[i], PerusahaanAsuransi[i],
                    AlamatAsuransi[i], NoTelp[i], Attn[i]});
            }
            ...
            if (response.isArray()) {
                if (TCari.getText().trim().isEmpty()) {
                    ...
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{false, list.path("KodeAsuransi").asText(),
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariCaraBayar2.class.getName());
