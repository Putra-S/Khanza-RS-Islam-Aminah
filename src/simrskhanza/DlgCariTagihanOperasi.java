...
public class DlgCariTagihanOperasi extends javax.swing.JDialog {
    ...
    private MasterCariTemplateLaporanOperasi template = new MasterCariTemplateLaporanOperasi(
            null, false);
    ...
    public DlgCariTagihanOperasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Jaringan Yang di-Eksisi/-Insisi", "Kirim PA", "Selesai Operasi",
            "Laporan Operasi"
        }) {
            @Override
        ...
        dokter.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (dokter.getTable().getSelectedRow() != -1) {
                    if (pilihan == 1) {
                        kdoperator1.setText(dokter.getTable().getValueAt(dokter.
                                getTable().getSelectedRow(), 0).toString());
                        nmoperator1.setText(dokter.getTable().getValueAt(dokter.
                                getTable().getSelectedRow(), 1).toString());
                        kdoperator1.requestFocus();
                    } else if (pilihan == 2) {
                        kdoperator2.setText(dokter.getTable().getValueAt(dokter.
                                getTable().getSelectedRow(), 0).toString());
                        nmoperator2.setText(dokter.getTable().getValueAt(dokter.
                                getTable().getSelectedRow(), 1).toString());
                        kdoperator2.requestFocus();
                    } else if (pilihan == 3) {
                        kdoperator3.setText(dokter.getTable().getValueAt(dokter.
                                getTable().getSelectedRow(), 0).toString());
                        nmoperator3.setText(dokter.getTable().getValueAt(dokter.
                                getTable().getSelectedRow(), 1).toString());
                        kdoperator3.requestFocus();
                    } else if (pilihan == 4) {
                        kdanestesi.setText(dokter.getTable().getValueAt(dokter.
                                getTable().getSelectedRow(), 0).toString());
                        nmanestesi.setText(dokter.getTable().getValueAt(dokter.
                                getTable().getSelectedRow(), 1).toString());
                        kdanestesi.requestFocus();
                    } else if (pilihan == 5) {
                        kddranak.setText(dokter.getTable().getValueAt(dokter.
                                getTable().getSelectedRow(), 0).toString());
                        nmdranak.setText(dokter.getTable().getValueAt(dokter.
                                getTable().getSelectedRow(), 1).toString());
                        kddranak.requestFocus();
                    } else if (pilihan == 6) {
                        kdpjanak.setText(dokter.getTable().getValueAt(dokter.
                                getTable().getSelectedRow(), 0).toString());
                        nmpjanak.setText(dokter.getTable().getValueAt(dokter.
                                getTable().getSelectedRow(), 1).toString());
                        kdpjanak.requestFocus();
                    } else if (pilihan == 7) {
                        kddrumum.setText(dokter.getTable().getValueAt(dokter.
                                getTable().getSelectedRow(), 0).toString());
                        nmdrumum.setText(dokter.getTable().getValueAt(dokter.
                                getTable().getSelectedRow(), 1).toString());
        ...
        petugas.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (petugas.getTable().getSelectedRow() != -1) {
                    if (pilihan == 1) {
                        kdasistoperator1.setText(petugas.getTable().getValueAt(
                                petugas.getTable().getSelectedRow(), 0).
                                toString());
                        nmasistoperator1.setText(petugas.getTable().getValueAt(
                                petugas.getTable().getSelectedRow(), 1).
                                toString());
                        kdasistoperator1.requestFocus();
                    } else if (pilihan == 2) {
                        kdasistoperator2.setText(petugas.getTable().getValueAt(
                                petugas.getTable().getSelectedRow(), 0).
                                toString());
                        nmasistoperator2.setText(petugas.getTable().getValueAt(
                                petugas.getTable().getSelectedRow(), 1).
                                toString());
                        kdasistoperator2.requestFocus();
                    } else if (pilihan == 3) {
                        kdInstrumen.setText(petugas.getTable().getValueAt(
                                petugas.getTable().getSelectedRow(), 0).
                                toString());
                        nminstrumen.setText(petugas.getTable().getValueAt(
                                petugas.getTable().getSelectedRow(), 1).
                                toString());
                        kdInstrumen.requestFocus();
                    } else if (pilihan == 4) {
                        kdasistanestesi.setText(petugas.getTable().getValueAt(
                                petugas.getTable().getSelectedRow(), 0).
                                toString());
                        nmasistanestesi.setText(petugas.getTable().getValueAt(
                                petugas.getTable().getSelectedRow(), 1).
                                toString());
                        kdasistanestesi.requestFocus();
                    } else if (pilihan == 5) {
                        kdprwresust.setText(petugas.getTable().getValueAt(
                                petugas.getTable().getSelectedRow(), 0).
                                toString());
                        nmprwresust.setText(petugas.getTable().getValueAt(
                                petugas.getTable().getSelectedRow(), 1).
                                toString());
                        kdprwresust.requestFocus();
                    } else if (pilihan == 6) {
                        kdprwluar.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 0).toString());
                        nmprwluar.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 1).toString());
                        kdprwluar.requestFocus();
                    } else if (pilihan == 7) {
                        kdbidan.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 0).toString());
                        nmbidan.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 1).toString());
                        kdbidan.requestFocus();
                    } else if (pilihan == 8) {
                        kdbidan2.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 0).toString());
                        nmbidan2.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 1).toString());
                        kdbidan2.requestFocus();
                    } else if (pilihan == 9) {
                        kdbidan3.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 0).toString());
                        nmbidan3.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 1).toString());
                        kdbidan3.requestFocus();
                    } else if (pilihan == 10) {
                        kdonloop1.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 0).toString());
                        nmonloop1.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 1).toString());
                        kdonloop1.requestFocus();
                    } else if (pilihan == 11) {
                        kdonloop2.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 0).toString());
                        nmonloop2.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 1).toString());
                        kdonloop2.requestFocus();
                    } else if (pilihan == 12) {
                        kdonloop3.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 0).toString());
                        nmonloop3.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 1).toString());
                        kdonloop3.requestFocus();
                    } else if (pilihan == 13) {
                        kdonloop4.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 0).toString());
                        nmonloop4.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 1).toString());
                        kdonloop4.requestFocus();
                    } else if (pilihan == 14) {
                        kdonloop5.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 0).toString());
                        nmonloop5.setText(petugas.getTable().getValueAt(petugas.
                                getTable().getSelectedRow(), 1).toString());
                        kdonloop5.requestFocus();
                    } else if (pilihan == 15) {
                        kdasistoperator3.setText(petugas.getTable().getValueAt(
                                petugas.getTable().getSelectedRow(), 0).
                                toString());
                        nmasistoperator3.setText(petugas.getTable().getValueAt(
                                petugas.getTable().getSelectedRow(), 1).
                                toString());
                        kdasistoperator3.requestFocus();
                    } else if (pilihan == 16) {
                        kdasistanestesi2.setText(petugas.getTable().getValueAt(
                                petugas.getTable().getSelectedRow(), 0).
                                toString());
                        nmasistanestesi2.setText(petugas.getTable().getValueAt(
                                petugas.getTable().getSelectedRow(), 1).
                                toString());
        ...
        template.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (template.getTable().getSelectedRow() != -1) {
                    PreOp.setText(template.getTable().getValueAt(template.
                            getTable().getSelectedRow(), 2).toString());
                    PostOp.setText(template.getTable().getValueAt(template.
                            getTable().getSelectedRow(), 3).toString());
                    Jaringan.setText(template.getTable().getValueAt(template.
                            getTable().getSelectedRow(), 4).toString());
                    DikirimPA.setSelectedItem(template.getTable().getValueAt(
                            template.getTable().getSelectedRow(), 5).toString());
                    Laporan.setText(template.getTable().getValueAt(template.
        ...
        try {
            ...
            try {
                ...
                while (rsrekening.next()) {
                    Suspen_Piutang_Operasi_Ralan = rsrekening.getString(
                    ...
                    Beban_Jasa_Medik_Paramedis_Operasi_Ralan = rsrekening.
                            getString("Beban_Jasa_Medik_Paramedis_Operasi_Ralan");
                    Utang_Jasa_Medik_Paramedis_Operasi_Ralan = rsrekening.
                            getString("Utang_Jasa_Medik_Paramedis_Operasi_Ralan");
                    HPP_Obat_Operasi_Ralan = rsrekening.getString(
                            "HPP_Obat_Operasi_Ralan");
                    Persediaan_Obat_Kamar_Operasi_Ralan = rsrekening.getString(
            ...
            try {
                rsrekening = psrekening.executeQuery();
                while (rsrekening.next()) {
                    Suspen_Piutang_Operasi_Ranap = rsrekening.getString(
                    ...
                    Beban_Jasa_Medik_Paramedis_Operasi_Ranap = rsrekening.
                            getString("Beban_Jasa_Medik_Paramedis_Operasi_Ranap");
                    Utang_Jasa_Medik_Paramedis_Operasi_Ranap = rsrekening.
                            getString("Utang_Jasa_Medik_Paramedis_Operasi_Ranap");
                    HPP_Obat_Operasi_Ranap = rsrekening.getString(
            ...
            try {
                rsrekening = psrekening.executeQuery();
                while (rsrekening.next()) {
                    Persediaan_Obat_Kamar_Operasi_Ranap = rsrekening.getString(
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (int i = 0; i < row; i++) {
                Sequel.menyimpan("temporary", "'" + i + "','"
                        ...
                        + tabMode.getValueAt(i, 39).toString() + "','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
                        getalamatip() + "'", "Transaksi operasi");
            }
            ...
            Valid.MyReportqry("rptOperasi.jasper", "report",
                    "::[ Transaksi Operasi ]::",
...
private void MnHapusTagihanOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusTagihanOperasiActionPerformed
    if (tbDokter.getSelectedRow() > -1) {
        if (!tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).toString().
                isEmpty()) {
            if (Sequel.cariRegistrasi(tbDokter.getValueAt(tbDokter.
                ...
                if (reply == JOptionPane.YES_OPTION) {
                    ...
                    status = Sequel.cariIsi(
                            "select status from operasi where no_rawat='" + tbDokter.
                                    getValueAt(tbDokter.getSelectedRow(), 1) + "' and tgl_operasi='" + tbDokter.
                            getValueAt(tbDokter.getSelectedRow(), 0) + "'");
                    ttljmdokter = Sequel.cariIsiAngka(
                            "select sum(biayaoperator1+biayaoperator2+biayaoperator3+biayadokter_anak+"
                            + "biayadokter_anestesi+biaya_dokter_pjanak+biaya_dokter_umum) from operasi where no_rawat='" + tbDokter.
                                    getValueAt(tbDokter.getSelectedRow(), 1) + "' and tgl_operasi='" + tbDokter.
                            getValueAt(tbDokter.getSelectedRow(), 0) + "'");
                    ttljmpetugas = Sequel.cariIsiAngka(
                            "select sum(biayaasisten_operator1+biayaasisten_operator2+biayaasisten_operator3+"
                            ...
                            + "from operasi where no_rawat='" + tbDokter.
                                    getValueAt(tbDokter.getSelectedRow(), 1) + "' and tgl_operasi='" + tbDokter.
                            getValueAt(tbDokter.getSelectedRow(), 0) + "'");
                    ttlpendapatan = Sequel.cariIsiAngka(
                            "select sum(operasi.biayaoperator1+operasi.biayaoperator2+"
                            ...
                            + "operasi.biaya_dokter_umum) from operasi where no_rawat='" + tbDokter.
                                    getValueAt(tbDokter.getSelectedRow(), 1) + "' and tgl_operasi='" + tbDokter.
                            getValueAt(tbDokter.getSelectedRow(), 0) + "'");
                    ttlbhp = Sequel.cariIsiAngka(
                            "select sum(jumlah*hargasatuan) from beri_obat_operasi where no_rawat='" + tbDokter.
                                    getValueAt(tbDokter.getSelectedRow(), 1) + "' and tanggal='" + tbDokter.
                            getValueAt(tbDokter.getSelectedRow(), 0) + "'");

                    ttlpendapatan += ttlbhp;
                    if (Sequel.queryutf(
                            "delete from operasi where no_rawat='" + tbDokter.
                                    getValueAt(tbDokter.getSelectedRow(), 1) + "' and tgl_operasi='" + tbDokter.
                            getValueAt(tbDokter.getSelectedRow(), 0) + "'") == true) {
                        if (Sequel.queryutf(
                                "delete from beri_obat_operasi where no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 1) + "' and tanggal='" + tbDokter.
                                getValueAt(tbDokter.getSelectedRow(), 0) + "'") == false) {
                            ttlbhp = 0;
                            sukses = false;
                        }
                    } else {
                    ...
                    if (sukses == true) {
                        Sequel.queryu(
                                "delete from laporan_operasi where no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 1) + "' and tanggal='" + tbDokter.
                                getValueAt(tbDokter.getSelectedRow(), 0) + "'");
                        if (status.equals("Ranap")) {
                            ...
                            if (ttlpendapatan > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Suspen_Piutang_Operasi_Ranap + "','Suspen Piutang Operasi Ranap','0','" + ttlpendapatan + "'",
                                        "kredit=kredit+'" + ttlpendapatan + "'",
                                        "kd_rek='" + Suspen_Piutang_Operasi_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Operasi_Ranap + "','Pendapatan Operasi Rawat Inap','" + ttlpendapatan + "','0'",
                                        "debet=debet+'" + ttlpendapatan + "'",
                                        "kd_rek='" + Operasi_Ranap + "'");
                            }
                            if (ttljmdokter > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Dokter_Operasi_Ranap + "','Beban Jasa Medik Dokter Operasi Ranap','0','" + ttljmdokter + "'",
                                        "kredit=kredit+'" + ttljmdokter + "'",
                                        "kd_rek='" + Beban_Jasa_Medik_Dokter_Operasi_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Dokter_Operasi_Ranap + "','Utang Jasa Medik Dokter Operasi Ranap','" + ttljmdokter + "','0'",
                                        "debet=debet+'" + ttljmdokter + "'",
                                        "kd_rek='" + Utang_Jasa_Medik_Dokter_Operasi_Ranap + "'");
                            }
                            if (ttljmpetugas > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Paramedis_Operasi_Ranap + "','Beban Jasa Medik Petugas Operasi Ranap','0','" + ttljmpetugas + "'",
                                        "kredit=kredit+'" + ttljmpetugas + "'",
                                        "kd_rek='" + Beban_Jasa_Medik_Paramedis_Operasi_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Paramedis_Operasi_Ranap + "','Utang Jasa Medik Petugas Operasi Ranap','" + ttljmpetugas + "','0'",
                                        "debet=debet+'" + ttljmpetugas + "'",
                                        "kd_rek='" + Utang_Jasa_Medik_Paramedis_Operasi_Ranap + "'");
                            }
                            if (ttlbhp > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + HPP_Obat_Operasi_Ranap + "','HPP Persediaan Operasi Rawat Inap','0','" + ttlbhp + "'",
                                        "kredit=kredit+'" + ttlbhp + "'",
                                        "kd_rek='" + HPP_Obat_Operasi_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Persediaan_Obat_Kamar_Operasi_Ranap + "','Persediaan BHP Operasi Rawat Inap','" + ttlbhp + "','0'",
                                        "debet=debet+'" + ttlbhp + "'",
                                        "kd_rek='" + Persediaan_Obat_Kamar_Operasi_Ranap + "'");
                            }
                            sukses = jur.simpanJurnal(tbDokter.getValueAt(
                                    tbDokter.getSelectedRow(), 1).toString(),
                                    "U",
                                    "PEMBATALAN OPERASI RAWAT INAP PASIEN OLEH " + akses.
                                            getkode());
                        } else if (status.equals("Ralan")) {
                            Sequel.queryu("delete from tampjurnal");
                            if (ttlpendapatan > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Suspen_Piutang_Operasi_Ralan + "','Suspen Piutang Operasi Ralan','0','" + ttlpendapatan + "'",
                                        "kredit=kredit+'" + ttlpendapatan + "'",
                                        "kd_rek='" + Suspen_Piutang_Operasi_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Operasi_Ralan + "','Pendapatan Operasi Rawat Jalan','" + ttlpendapatan + "','0'",
                                        "debet=debet+'" + ttlpendapatan + "'",
                                        "kd_rek='" + Operasi_Ralan + "'");
                            }
                            if (ttljmdokter > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Dokter_Operasi_Ralan + "','Beban Jasa Medik Dokter Operasi Ralan','0','" + ttljmdokter + "'",
                                        "kredit=kredit+'" + ttljmdokter + "'",
                                        "kd_rek='" + Beban_Jasa_Medik_Dokter_Operasi_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Dokter_Operasi_Ralan + "','Utang Jasa Medik Dokter Operasi Ralan','" + ttljmdokter + "','0'",
                                        "debet=debet+'" + ttljmdokter + "'",
                                        "kd_rek='" + Utang_Jasa_Medik_Dokter_Operasi_Ralan + "'");
                            }
                            if (ttljmpetugas > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Paramedis_Operasi_Ralan + "','Beban Jasa Medik Petugas Operasi Ralan','0','" + ttljmpetugas + "'",
                                        "kredit=kredit+'" + ttljmpetugas + "'",
                                        "kd_rek='" + Beban_Jasa_Medik_Paramedis_Operasi_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Paramedis_Operasi_Ralan + "','Utang Jasa Medik Petugas Operasi Ralan','" + ttljmpetugas + "','0'",
                                        "debet=debet+'" + ttljmpetugas + "'",
                                        "kd_rek='" + Utang_Jasa_Medik_Paramedis_Operasi_Ralan + "'");
                            }
                            if (ttlbhp > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + HPP_Obat_Operasi_Ralan + "','HPP Persediaan Operasi Rawat Jalan','0','" + ttlbhp + "'",
                                        "kredit=kredit+'" + ttlbhp + "'",
                                        "kd_rek='" + HPP_Obat_Operasi_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Persediaan_Obat_Kamar_Operasi_Ralan + "','Persediaan BHP Operasi Rawat Jalan','" + ttlbhp + "','0'",
                                        "debet=debet+'" + ttlbhp + "'",
                                        "kd_rek='" + Persediaan_Obat_Kamar_Operasi_Ralan + "'");
                            }
                            sukses = jur.simpanJurnal(tbDokter.getValueAt(
                                    tbDokter.getSelectedRow(), 1).toString(),
                                    "U",
                                    "PEMBATALAN OPERASI RAWAT JALAN PASIEN OLEH " + akses.
                                            getkode());
                        }
                    }
            ...
            JOptionPane.showMessageDialog(rootPane,
                    "Silahkan pilih data, klik pada No.Rawat ..!!");
        }
    }
...
private void MnHapusObatOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusObatOperasiActionPerformed
                        ...
                        if (status.equals("Ranap")) {
                            if (ttlbhp > 0) {
                                ...
                                Sequel.menyimpan("tampjurnal",
                                        ...
                                        "kd_rek='" + Persediaan_Obat_Kamar_Operasi_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Suspen_Piutang_Operasi_Ranap + "','Suspen Piutang Operasi Ranap','0','" + ttlbhp + "'",
                                        "kredit=kredit+'" + ttlbhp + "'",
                                        "kd_rek='" + Suspen_Piutang_Operasi_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Operasi_Ranap + "','Pendapatan Operasi Rawat Inap','" + ttlbhp + "','0'",
                                        "debet=debet+'" + ttlbhp + "'",
                                        "kd_rek='" + Operasi_Ranap + "'");
                                sukses = jur.simpanJurnal(tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 1).toString(),
                                        "U",
                                        "PEMBATALAN OBAT OPERASI RAWAT INAP OLEH " + akses.
                                                getkode());
                            }
                        } else if (status.equals("Ralan")) {
                            if (ttlbhp > 0) {
                                ...
                                Sequel.menyimpan("tampjurnal",
                                        ...
                                        "kd_rek='" + Persediaan_Obat_Kamar_Operasi_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Suspen_Piutang_Operasi_Ralan + "','Suspen Piutang Operasi Ralan','0','" + ttlbhp + "'",
                                        "kredit=kredit+'" + ttlbhp + "'",
                                        "kd_rek='" + Suspen_Piutang_Operasi_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Operasi_Ralan + "','Pendapatan Operasi Rawat Jalan','" + ttlbhp + "','0'",
                                        "debet=debet+'" + ttlbhp + "'",
                                        "kd_rek='" + Operasi_Ralan + "'");
                                sukses = jur.simpanJurnal(tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 1).toString(),
                                        "U",
                                        "PEMBATALAN OBAT OPERASI RAWAT JALAN OLEH " + akses.
                                                getkode());
                            }
                        }
                    } else {
                ...
                if (Sequel.cariRegistrasi(tbDokter.getValueAt(tbDokter.
                    ...
                    try {
                        rs2 = koneksi.prepareStatement(
                                ...
                                + "from operasi where operasi.no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 1).
                                        toString() + "' and operasi.tgl_operasi='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0).
                                        toString() + "'").executeQuery();
                        no = 1;
                        while (rs2.next()) {
                            kdoperator1.setText(rs2.getString("operator1"));
                            nmoperator1.setText(dokter.tampil3(rs2.getString(
                                    "operator1")));
                            kdoperator2.setText(rs2.getString("operator2"));
                            nmoperator2.setText(dokter.tampil3(rs2.getString(
                                    "operator2")));
                            kdoperator3.setText(rs2.getString("operator3"));
                            nmoperator3.setText(dokter.tampil3(rs2.getString(
                                    "operator3")));
                            kdasistoperator1.setText(rs2.getString(
                                    "asisten_operator1"));
                            nmasistoperator1.setText(petugas.tampil3(rs2.
                                    getString("asisten_operator1")));
                            kdasistoperator2.setText(rs2.getString(
                                    "asisten_operator2"));
                            nmasistoperator2.setText(petugas.tampil3(rs2.
                                    getString("asisten_operator2")));
                            kdasistoperator3.setText(rs2.getString(
                                    "asisten_operator3"));
                            nmasistoperator3.setText(petugas.tampil3(rs2.
                                    getString("asisten_operator3")));
                            kdInstrumen.setText(rs2.getString("instrumen"));
                            nminstrumen.setText(petugas.tampil3(rs2.getString(
                                    "instrumen")));
                            kddranak.setText(rs2.getString("dokter_anak"));
                            nmdranak.setText(dokter.tampil3(rs2.getString(
                                    "dokter_anak")));
                            kdprwresust.setText(rs2.getString(
                                    "perawaat_resusitas"));
                            nmprwresust.setText(petugas.tampil3(rs2.getString(
                                    "perawaat_resusitas")));
                            kdanestesi.setText(rs2.getString("dokter_anestesi"));
                            nmanestesi.setText(dokter.tampil3(rs2.getString(
                                    "dokter_anestesi")));
                            kdasistanestesi.setText(rs2.getString(
                                    "asisten_anestesi"));
                            nmasistanestesi.setText(petugas.tampil3(rs2.
                                    getString("asisten_anestesi")));
                            kdasistanestesi2.setText(rs2.getString(
                                    "asisten_anestesi2"));
                            nmasistanestesi2.setText(petugas.tampil3(rs2.
                                    getString("asisten_anestesi2")));
                            kdbidan.setText(rs2.getString("bidan"));
                            nmbidan.setText(petugas.tampil3(rs2.getString(
                                    "bidan")));
                            kdbidan2.setText(rs2.getString("bidan2"));
                            nmbidan2.setText(petugas.tampil3(rs2.getString(
                                    "bidan2")));
                            kdbidan3.setText(rs2.getString("bidan3"));
                            nmbidan3.setText(petugas.tampil3(rs2.getString(
                                    "bidan3")));
                            kdprwluar.setText(rs2.getString("perawat_luar"));
                            nmprwluar.setText(petugas.tampil3(rs2.getString(
                                    "perawat_luar")));
                            kdonloop1.setText(rs2.getString("omloop"));
                            nmonloop1.setText(petugas.tampil3(rs2.getString(
                                    "omloop")));
                            kdonloop2.setText(rs2.getString("omloop2"));
                            nmonloop2.setText(petugas.tampil3(rs2.getString(
                                    "omloop2")));
                            kdonloop3.setText(rs2.getString("omloop3"));
                            nmonloop3.setText(petugas.tampil3(rs2.getString(
                                    "omloop3")));
                            kdonloop4.setText(rs2.getString("omloop4"));
                            nmonloop4.setText(petugas.tampil3(rs2.getString(
                                    "omloop4")));
                            kdonloop5.setText(rs2.getString("omloop5"));
                            nmonloop5.setText(petugas.tampil3(rs2.getString(
                                    "omloop5")));
                            kdpjanak.setText(rs2.getString("dokter_pjanak"));
                            nmpjanak.setText(dokter.tampil3(rs2.getString(
                                    "dokter_pjanak")));
                            kddrumum.setText(rs2.getString("dokter_umum"));
                            nmdrumum.setText(dokter.tampil3(rs2.getString(
                                    "dokter_umum")));
                        }
                        if (rs2 != null) {
                            rs2.close();
                    ...
                    WindowGantiDokterParamedis.setSize(
                            internalFrame1.getWidth() - 20, internalFrame1.
                            getHeight() - 20);
    ...
    private void BtnSimpan4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan4ActionPerformed
        if (kdoperator2.getText().trim().isEmpty() || nmoperator2.getText().
                trim().isEmpty()) {
            kdoperator2.setText("-");
            nmoperator2.setText("-");
        }

        if (kdoperator3.getText().trim().isEmpty() || nmoperator3.getText().
                trim().isEmpty()) {
            kdoperator3.setText("-");
            nmoperator3.setText("-");
        }

        if (kdanestesi.getText().trim().isEmpty() || nmanestesi.getText().trim().
                isEmpty()) {
            kdanestesi.setText("-");
            nmanestesi.setText("-");
        }

        if (kddranak.getText().trim().isEmpty() || nmdranak.getText().trim().
                isEmpty()) {
            kddranak.setText("-");
            nmdranak.setText("-");
        }

        if (kdbidan.getText().trim().isEmpty() || nmbidan.getText().trim().
                isEmpty()) {
            kdbidan.setText("-");
            nmbidan.setText("-");
        }

        if (kdbidan2.getText().trim().isEmpty() || nmbidan2.getText().trim().
                isEmpty()) {
            kdbidan2.setText("-");
            nmbidan2.setText("-");
        }

        if (kdbidan3.getText().trim().isEmpty() || nmbidan3.getText().trim().
                isEmpty()) {
            kdbidan3.setText("-");
            nmbidan3.setText("-");
        }

        if (kdonloop1.getText().trim().isEmpty() || nmonloop1.getText().trim().
                isEmpty()) {
            kdonloop1.setText("-");
            nmonloop1.setText("-");
        }

        if (kdonloop2.getText().trim().isEmpty() || nmonloop2.getText().trim().
                isEmpty()) {
            kdonloop2.setText("-");
            nmonloop2.setText("-");
        }

        if (kdonloop3.getText().trim().isEmpty() || nmonloop3.getText().trim().
                isEmpty()) {
            kdonloop3.setText("-");
            nmonloop3.setText("-");
        }

        if (kdonloop4.getText().trim().isEmpty() || nmonloop4.getText().trim().
                isEmpty()) {
            kdonloop4.setText("-");
            nmonloop4.setText("-");
        }

        if (kdonloop5.getText().trim().isEmpty() || nmonloop5.getText().trim().
                isEmpty()) {
            kdonloop5.setText("-");
            nmonloop5.setText("-");
        }

        if (kdasistoperator1.getText().trim().isEmpty() || nmasistoperator1.
                getText().trim().isEmpty()) {
            kdasistoperator1.setText("-");
            nmasistoperator1.setText("-");
        }

        if (kdasistoperator2.getText().trim().isEmpty() || nmasistoperator2.
                getText().trim().isEmpty()) {
            kdasistoperator2.setText("-");
            nmasistoperator2.setText("-");
        }

        if (kdasistoperator3.getText().trim().isEmpty() || nmasistoperator3.
                getText().trim().isEmpty()) {
            kdasistoperator3.setText("-");
            nmasistoperator3.setText("-");
        }

        if (kdInstrumen.getText().trim().isEmpty() || nminstrumen.getText().
                trim().isEmpty()) {
            kdInstrumen.setText("-");
            nminstrumen.setText("-");
        }

        if (kdasistanestesi.getText().trim().isEmpty() || nmasistanestesi.
                getText().trim().isEmpty()) {
            kdasistanestesi.setText("-");
            nmasistanestesi.setText("-");
        }

        if (kdasistanestesi2.getText().trim().isEmpty() || nmasistanestesi2.
                getText().trim().isEmpty()) {
            kdasistanestesi2.setText("-");
            nmasistanestesi2.setText("-");
        }

        if (kdprwresust.getText().trim().isEmpty() || nmprwresust.getText().
                trim().isEmpty()) {
            kdprwresust.setText("-");
            nmprwresust.setText("-");
        }

        if (kdprwluar.getText().trim().isEmpty() || nmprwluar.getText().trim().
                isEmpty()) {
            kdprwluar.setText("-");
            nmprwluar.setText("-");
        }

        if (kdpjanak.getText().trim().isEmpty() || nmpjanak.getText().trim().
                isEmpty()) {
            kdpjanak.setText("-");
            nmpjanak.setText("-");
        }

        if (kddrumum.getText().trim().isEmpty() || nmdrumum.getText().trim().
                isEmpty()) {
            kddrumum.setText("-");
            nmdrumum.setText("-");
        }

        if (kdoperator1.getText().trim().isEmpty() || nmoperator1.getText().
                trim().isEmpty()) {
            Valid.textKosong(kdoperator1, "Operator 1");
        } else if (kdoperator2.getText().trim().isEmpty() || nmoperator2.
                getText().trim().isEmpty()) {
            Valid.textKosong(kdoperator2, "Operator 2");
        } else if (kdoperator3.getText().trim().isEmpty() || nmoperator3.
                getText().trim().isEmpty()) {
            Valid.textKosong(kdoperator3, "Operator 3");
        } else if (kdanestesi.getText().trim().isEmpty() || nmanestesi.getText().
                trim().isEmpty()) {
            Valid.textKosong(kdanestesi, "dr Anestesi");
        } else if (kddranak.getText().trim().isEmpty() || nmdranak.getText().
                trim().isEmpty()) {
            Valid.textKosong(kddranak, "dr Anak");
        } else if (kdbidan.getText().trim().isEmpty() || nmbidan.getText().
                trim().isEmpty()) {
            Valid.textKosong(kdbidan, "Bidan 1");
        } else if (kdbidan2.getText().trim().isEmpty() || nmbidan2.getText().
                trim().isEmpty()) {
            Valid.textKosong(kdbidan, "Bidan 2");
        } else if (kdbidan3.getText().trim().isEmpty() || nmbidan3.getText().
                trim().isEmpty()) {
            Valid.textKosong(kdbidan, "Bidan 3");
        } else if (kdonloop1.getText().trim().isEmpty() || nmonloop1.getText().
                trim().isEmpty()) {
            Valid.textKosong(kdonloop1, "Onloop 1");
        } else if (kdonloop2.getText().trim().isEmpty() || nmonloop2.getText().
                trim().isEmpty()) {
            Valid.textKosong(kdonloop2, "Onloop 2");
        } else if (kdonloop3.getText().trim().isEmpty() || nmonloop3.getText().
                trim().isEmpty()) {
            Valid.textKosong(kdonloop3, "Onloop 3");
        } else if (kdonloop4.getText().trim().isEmpty() || nmonloop4.getText().
                trim().isEmpty()) {
            Valid.textKosong(kdonloop4, "Onloop 4");
        } else if (kdonloop5.getText().trim().isEmpty() || nmonloop5.getText().
                trim().isEmpty()) {
            Valid.textKosong(kdonloop5, "Onloop 5");
        } else if (kdasistoperator1.getText().trim().isEmpty() || nmasistoperator1.
                getText().trim().isEmpty()) {
            Valid.textKosong(kdasistoperator1, "Asisten Operator 1");
        } else if (kdasistoperator2.getText().trim().isEmpty() || nmasistoperator2.
                getText().trim().isEmpty()) {
            Valid.textKosong(kdasistoperator2, "Asisten Operator 2");
        } else if (kdasistoperator3.getText().trim().isEmpty() || nmasistoperator3.
                getText().trim().isEmpty()) {
            Valid.textKosong(kdasistoperator3, "Asisten Operator 3");
        } else if (kdInstrumen.getText().trim().isEmpty() || nminstrumen.
                getText().trim().isEmpty()) {
            Valid.textKosong(kdInstrumen, "Instrumen");
        } else if (kdasistanestesi.getText().trim().isEmpty() || nmasistanestesi.
                getText().trim().isEmpty()) {
            Valid.textKosong(kdasistanestesi, "Asisten Anastesi 1");
        } else if (kdasistanestesi2.getText().trim().isEmpty() || nmasistanestesi2.
                getText().trim().isEmpty()) {
            Valid.textKosong(kdasistanestesi2, "Asisten Anastesi 2");
        } else if (kdprwresust.getText().trim().isEmpty() || nmprwresust.
                getText().trim().isEmpty()) {
            Valid.textKosong(kdprwresust, "Perawat Resusitas");
        } else if (kdprwluar.getText().trim().isEmpty() || nmprwluar.getText().
                trim().isEmpty()) {
            Valid.textKosong(kdprwluar, "Perawat Luar");
        } else if (kdpjanak.getText().trim().isEmpty() || nmpjanak.getText().
                trim().isEmpty()) {
            Valid.textKosong(kdpjanak, "dr Pj Anak");
        } else if (kddrumum.getText().trim().isEmpty() || nmdrumum.getText().
                trim().isEmpty()) {
            ...
            if (Sequel.mengedittf("operasi", "no_rawat=? and tgl_operasi=?",
                    ...
                    + "omloop2=?,omloop3=?,omloop4=?,omloop5=?,dokter_pjanak=?,dokter_umum=?",
                    25, new String[]{
                        kdoperator1.getText(), kdoperator2.getText(),
                        kdoperator3.getText(), kdasistoperator1.getText(),
                        kdasistoperator2.getText(), kdasistoperator3.getText(),
                        kdInstrumen.getText(), kddranak.getText(),
                        kdprwresust.getText(), kdanestesi.getText(),
                        kdasistanestesi.getText(), kdasistanestesi2.getText(),
                        kdbidan.getText(), kdbidan2.getText(), kdbidan3.
                        getText(), kdprwluar.getText(), kdonloop1.getText(),
                        kdonloop2.getText(), kdonloop3.getText(), kdonloop4.
                        getText(), kdonloop5.getText(), kdpjanak.getText(),
                        kddrumum.getText(), tbDokter.getValueAt(tbDokter.
    ...
    private void kdasistoperator1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdasistoperator1KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_PAGE_DOWN) {
            nmasistoperator1.
                    setText(petugas.tampil3(kdasistoperator1.getText()));
        } else if (evt.getKeyCode() == KeyEvent.VK_UP) {
    ...
    private void kdasistoperator2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdasistoperator2KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_PAGE_DOWN) {
            nmasistoperator2.
                    setText(petugas.tampil3(kdasistoperator2.getText()));
        } else if (evt.getKeyCode() == KeyEvent.VK_UP) {
    ...
    private void kdInstrumenKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdInstrumenKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_PAGE_DOWN) {
            Sequel.cariIsi("select nama from petugas where nip='" + kdInstrumen.
                    getText() + "'", nminstrumen);
        } else if (evt.getKeyCode() == KeyEvent.VK_UP) {
    ...
    private void MnLaporanOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanOperasiActionPerformed
        if (tbDokter.getSelectedRow() > -1) {
            if (!tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).toString().
                ...
                param.put("logo", Sequel.cariGambar(
                        "select setting.logo from setting"));
                param.put("norawat", tbDokter.getValueAt(tbDokter.
                        getSelectedRow(), 1).toString());
                param.put("tanggaloperasi", tbDokter.getValueAt(tbDokter.
                        getSelectedRow(), 0).toString());
                kodeoperator = Sequel.cariIsi(
                        "select operasi.operator1 from operasi where operasi.no_rawat='" + tbDokter.
                                getValueAt(tbDokter.getSelectedRow(), 1).
                                toString() + "' and tgl_operasi='" + tbDokter.
                                getValueAt(tbDokter.getSelectedRow(), 0).
                                toString() + "'");
                ...
                param.put("finger",
                        ...
                        getkabupatenrs() + "\nDitandatangani secara elektronik oleh " + tbDokter.
                                getValueAt(tbDokter.getSelectedRow() + 1, 5).
                ...
                try {
                    try {
                        rs = koneksi.prepareStatement(
                                ...
                                + "operasi.no_rawat='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 1).toString() + "' and operasi.tgl_operasi='" + tbDokter.
                                getValueAt(tbDokter.getSelectedRow(), 0).
                                toString() + "' ").executeQuery();
                        while (rs.next()) {
                    ...
                    try {
                        try {
                            rs = koneksi.prepareStatement(
                                    ...
                                    + "pemeriksaan_ralan.penilaian from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat='" + tbDokter.
                                            getValueAt(tbDokter.getSelectedRow(),
                                                    1).toString() + "' "
                                    + "and concat(pemeriksaan_ralan.tgl_perawatan,' ',pemeriksaan_ralan.jam_rawat) <= '" + tbDokter.
                                            getValueAt(tbDokter.getSelectedRow(),
                                                    0).toString() + "' "
                                    + "order by pemeriksaan_ralan.tgl_perawatan desc,pemeriksaan_ralan.jam_rawat desc limit 1").
                                    executeQuery();
                            if (rs.next()) {
                                param.put("tgl_perawatan", rs.getDate(
                                        "tgl_perawatan"));
                                param.
                                        put("jam_rawat", rs.getString(
                                                "jam_rawat"));
                                param.put("alergi", rs.getString("alergi"));
                                param.put("keluhan", rs.getString("keluhan"));
                                param.put("pemeriksaan", rs.getString(
                                        "pemeriksaan"));
                                param.
                                        put("penilaian", rs.getString(
                                                "penilaian"));
                                param.put("rtl", rs.getString("rtl"));
                                param.put("ruang", Sequel.cariIsi(
                                        "select poliklinik.nm_poli from poliklinik inner join reg_periksa on reg_periksa.kd_poli=poliklinik.kd_poli where reg_periksa.no_rawat=?",
                                        rs.getString("no_rawat")));
                                param.put("suhu_tubuh", rs.getString(
                                        "suhu_tubuh"));
                    ...
                    try {
                        try {
                            rs = koneksi.prepareStatement(
                                    ...
                                    + "pemeriksaan_ranap.penilaian from pemeriksaan_ranap where pemeriksaan_ranap.no_rawat='" + tbDokter.
                                            getValueAt(tbDokter.getSelectedRow(),
                                                    1).toString() + "' "
                                    + "and concat(pemeriksaan_ranap.tgl_perawatan,' ',pemeriksaan_ranap.jam_rawat) <= '" + tbDokter.
                                            getValueAt(tbDokter.getSelectedRow(),
                                                    0).toString() + "' "
                            ...
                            if (rs.next()) {
                                ...
                                param.put("rtl", rs.getString("rtl"));
                                param.put("ruang", Sequel.cariIsi(
                                        "select nm_bangsal from bangsal inner join kamar inner join kamar_inap on bangsal.kd_bangsal=kamar.kd_bangsal and kamar_inap.kd_kamar=kamar.kd_kamar where no_rawat=? order by tgl_masuk desc limit 1 ",
                                        rs.getString("no_rawat")));
                                param.put("suhu_tubuh", rs.getString(
                                        "suhu_tubuh"));
                                param.put("tensi", rs.getString("tensi"));
                ...
                Valid.MyReport("rptLaporanOperasi.jasper", "report",
                        "::[ Laporan Operasi ]::", param);
            } else {
                JOptionPane.showMessageDialog(rootPane,
                        "Silahkan pilih data, klik pada No.Rawat ..!!");
            }
            ...
            if (!tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).toString().
                ...
                try {
                    rs2 = koneksi.prepareStatement(
                            ...
                            + "laporan_operasi.laporan_operasi from laporan_operasi where laporan_operasi.no_rawat='" + tbDokter.
                                    getValueAt(tbDokter.getSelectedRow(), 1) + "' and "
                            + "laporan_operasi.tanggal='" + tbDokter.getValueAt(
                                    tbDokter.getSelectedRow(), 0) + "'").
                            executeQuery();
                    if (rs2.next()) {
                        ...
                        DikirimPA.
                                setSelectedItem(rs2.getString("permintaan_pa"));
                ...
                WindowLaporan.setSize(internalFrame1.getWidth() - 20,
        ...
        if (!Laporan.getText().isEmpty()) {
            Sequel.queryu(
                    "delete from laporan_operasi where no_rawat='" + tbDokter.
                            getValueAt(tbDokter.getSelectedRow(), 1) + "' and tanggal='" + tbDokter.
                    getValueAt(tbDokter.getSelectedRow(), 0) + "'");
            Sequel.menyimpan("laporan_operasi", "?,?,?,?,?,?,?,?",
                    "laporan operasi", 8, new String[]{
                        tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).
                                toString(), tbDokter.getValueAt(tbDokter.
                                getSelectedRow(), 0).toString(), PreOp.getText(),
                        PostOp.getText(), Jaringan.getText(), Valid.SetTgl(tgl2.
                        getSelectedItem() + "") + " " + tgl2.getSelectedItem().
                                toString().substring(11, 19),
                        DikirimPA.getSelectedItem().toString(), Laporan.
                        getText()
                    });
    ...
    private void ppBerkasDigitalBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBerkasDigitalBtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbDokter.getSelectedRow() > -1) {
                if (!tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).
                        toString().isEmpty()) {
                        ...
                        if (akses.gethapus_berkas_digital_perawatan() == true) {
                            berkas.loadURL(
                                    ...
                                    USERHYBRIDWEB() + "&passwordte=" + koneksiDB.
                                            PASHYBRIDWEB() + "&no_rawat=" + tbDokter.
                                            getValueAt(tbDokter.getSelectedRow(),
                                                    1).toString());
                        } else {
                            berkas.loadURL(
                    ...
                    berkas.setSize(internalFrame1.getWidth() - 20,
                            internalFrame1.getHeight() - 20);
    ...
    private void btnAmbilPhoto1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilPhoto1ActionPerformed
        template.emptTeks();
        template.isCek();
        template.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariTagihanOperasi dialog = new DlgCariTagihanOperasi(
    ...
    private void tampil() {
        tanggal = "  operasi.tgl_operasi between '" + Valid.SetTgl(Tgl1.
                getSelectedItem() + "") + " 00:00:00' and '" + Valid.SetTgl(
                        Tgl2.getSelectedItem() + "") + " 23:59:59' ";
        mem = "";
        if (!kdmem.getText().isEmpty()) {
        ...
        if (TCari.getText().trim().isEmpty() && kdmem.getText().trim().isEmpty() && NoRawat.
                getText().trim().isEmpty()) {
            ...
            sql = "select operasi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,operasi.jenis_anasthesi,"
                    + "operasi.tgl_operasi from operasi inner join reg_periksa on operasi.no_rawat=reg_periksa.no_rawat "
                    + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + " where " + tanggal + mem + norawat + " and operasi.no_rawat like '%" + TCari.
                            getText() + "%' or "
                    + tanggal + mem + norawat + " and reg_periksa.no_rkm_medis like '%" + TCari.
                            getText() + "%' or "
                    + tanggal + mem + norawat + " and pasien.nm_pasien like '%" + TCari.
                            getText() + "%' or "
                    + tanggal + mem + norawat + " and operasi.tgl_operasi like '%" + TCari.
                            getText() + "%' or "
                    + tanggal + mem + norawat + " and operasi.jenis_anasthesi like '%" + TCari.
                            getText() + "%'  "
        ...
        try {
            ...
            while (rs.next()) {
                ...
                rs2 = koneksi.prepareStatement(
                        ...
                        + "from laporan_operasi where no_rawat='" + rs.
                                getString("no_rawat") + "' and tanggal='" + rs.
                        getString("tgl_operasi") + "'").executeQuery();
                if (rs2.next()) {
                ...
                tabMode.addRow(new Object[]{
                    rs.getString("tgl_operasi"), rs.getString("no_rawat"), rs.
                    getString("no_rkm_medis") + ", " + rs.getString("nm_pasien"),
                    rs.getString("jenis_anasthesi"),
                    "Perawatan", "Operator 1", "Operator 2", "Operator 3",
                    "Asisten Operator 1", "Asisten Operator 2",
                    "Asisten Operator 3", "Instrumen", "Dokter Anak",
                    "Perawat Resusitas", "Dokter Anestesi", "Asisten Anestesi 1",
                    "Asisten Anestesi 2", "Bidan 1", "Bidan 2", "Bidan 3",
                    "Perawat Luar", "Onloop 1",
                    "Onloop 2", "Onloop 3", "Onloop 4", "Onloop 5", "Sewa OK/VK",
                    "Alat", "Akomodasi", "N.M.S.", "Sarpras", "Dokter PJ Anak",
                    "Dokter Umum", "Biaya Perawatan",
                    diagnosa_preop, diagnosa_postop, jaringan_dieksekusi,
                    permintaan_pa, selesaioperasi, laporan_operasi
                });
                rs2 = koneksi.prepareStatement(
                        "select operasi.operator1, operasi.operator2, operasi.operator3, operasi.asisten_operator1,"
                        + "operasi.asisten_operator2,operasi.asisten_operator3, operasi.instrumen, operasi.dokter_anak, operasi.perawaat_resusitas, "
                        ...
                        + "on operasi.kode_paket=paket_operasi.kode_paket where operasi.no_rawat='" + rs.
                                getString("no_rawat") + "' and operasi.tgl_operasi='" + rs.
                        getString("tgl_operasi") + "'").executeQuery();
                no = 1;
                while (rs2.next()) {
                    ...
                    tabMode.addRow(new Object[]{"", "", "", "", "", Valid.
                        SetAngka(rs2.getDouble("biayaoperator1")),
                ...
                tabMode.addRow(new Object[]{"", "", "", "", "Obat & BHP",
                    "Satuan", "Harga", "Jml", "", "", "", "", "", "", "", "", "",
                    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                    "", "Biaya Obat", "", "", "", "", "", ""});
                rs2 = koneksi.createStatement().executeQuery(
                        ...
                        + "where beri_obat_operasi.no_rawat='" + rs.getString(
                                "no_rawat") + "' and beri_obat_operasi.tanggal='" + rs.
                                getString("tgl_operasi") + "'");
                no = 1;
                while (rs2.next()) {
                    tabMode.addRow(new Object[]{
                        "", "", "", "", no + ". " + rs2.getString("nm_obat"),
                        rs2.getString("satuan"), rs2.getString("hargasatuan"),
                        rs2.getString("jumlah"), "", "", "", "", "", "",
                        "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                        "", "", "", "", "", Valid.SetAngka(rs2.getDouble(
                        "jumlah") * rs2.getDouble("hargasatuan")), "", "", "",
                        "", "", ""
                    });
                    total += (rs2.getDouble("jumlah") * rs2.getDouble(
                            "hargasatuan"));
                    no++;
                }
                if (rs2 != null) {
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgCariTagihanOperasi.class.getName());
