...
//        Valid.pindah(evt,TCari,BtnSimpan,TCari);
            ...
            if (response.isArray()) {
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{list.path("NamaKab").asText(), list.path("KodeKab").asText()});
                    }
                } else {
                    for (JsonNode list : response) {
                        if (list.path("NamaKab").asText().toLowerCase().contains(TCari.getText().toLowerCase())) {
                            tabMode
                                    .addRow(new Object[]{list.path("NamaKab").asText(), list.path("KodeKab").asText()});
                        }
                    }
                }
            }
    ...
    private static final Logger LOG = Logger.getLogger(DlgKabupaten.class.getName());
