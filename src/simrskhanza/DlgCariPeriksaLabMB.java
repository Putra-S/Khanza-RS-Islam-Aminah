...
public class DlgCariPeriksaLabMB extends javax.swing.JDialog {
    ...
    public DlgCariPeriksaLabMB(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.Rawat", "Pasien", "Petugas", "Tanggal Periksa", "Jam", "Dokter Perujuk",
            "Penanggung Jawab"};
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
                            ...
                            try {
                                ...
                                while (rs3.next()) {
                                    htmlContent.append("<tr class='isi'>" + "<td valign='top'>"
                                            ...
                                            + "<table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0' class='tbl_form'>"
                                            + "<tr class='isi'>"
                                            + "<td valign='top' bgcolor='#fdfff9' align='left' colspan='4'>"
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariPeriksaLabMB.class.getName());
