...
public class DlgCariPeriksaLabMB extends javax.swing.JDialog {
    ...
    public DlgCariPeriksaLabMB(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.Rawat", "Pasien", "Petugas", "Tanggal Periksa",
            "Jam", "Dokter Perujuk", "Penanggung Jawab"};
        ...
        switch (TabRawat.getSelectedIndex()) {
            case 0:
                if (tabMode.getRowCount() == 0) {
                    ...
                    Valid.MyReport("rptDataLabMB.jasper", "report",
            ...
            case 1:
                if (tabMode2.getRowCount() == 0) {
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReport("rptDataLab2MB.jasper", "report",
                ...
                if (reply == JOptionPane.YES_OPTION) {
                    try {
                        ...
                        ttljmdokter = Sequel.cariIsiAngka(
                                "select sum(tarif_tindakan_dokter) from periksa_lab where periksa_lab.kategori='MB' and no_rawat='" + tbDokter.
                        ...
                        ttljmpetugas = Sequel.cariIsiAngka(
                                "select sum(tarif_tindakan_petugas) from periksa_lab where periksa_lab.kategori='MB' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        ttlkso = Sequel.cariIsiAngka(
                                "select sum(kso) from periksa_lab where periksa_lab.kategori='MB' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        ttlbhp = Sequel.cariIsiAngka(
                                "select sum(bhp) from periksa_lab where periksa_lab.kategori='MB' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        ttlpendapatan = Sequel.cariIsiAngka(
                                "select sum(biaya) from periksa_lab where periksa_lab.kategori='MB' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        ttljasasarana = Sequel.cariIsiAngka(
                                "select sum(bagian_rs) from periksa_lab where periksa_lab.kategori='MB' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        ttljmperujuk = Sequel.cariIsiAngka(
                                "select sum(tarif_perujuk) from periksa_lab where periksa_lab.kategori='MB' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        ttlmenejemen = Sequel.cariIsiAngka(
                                "select sum(menejemen) from periksa_lab where periksa_lab.kategori='MB' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        status = Sequel.cariIsi(
                                "select status from periksa_lab where periksa_lab.kategori='MB' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
                        ...
                        if (Sequel.queryutf(
                                "delete from periksa_lab where periksa_lab.kategori='MB' and no_rawat='" + tbDokter.
                                        getValueAt(tbDokter.getSelectedRow(), 0)
                                + "' and tgl_periksa='" + tbDokter.getValueAt(
                                        tbDokter.getSelectedRow(), 3)
                                + "' and jam='" + tbDokter.getValueAt(tbDokter.
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReport(
                                        "rptPeriksaLabPermintaanMB.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            } else {
                                Valid.MyReport("rptPeriksaLabMB.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                param.put("jampermintaan", rspermintaan.
                                        getString("jam_permintaan"));
                                Valid.MyReport(
                                        "rptPeriksaLab2PermintaanMB.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            } else {
                                Valid.MyReport("rptPeriksaLabMB2.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReportPDF("rptPeriksaLabMB.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReportPDF("rptPeriksaLabMB2.jasper",
                                        "report",
                                        "::[ Pemeriksaan Laboratorium ]::",
                                        param);
                            }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPeriksaLabMB dialog = new DlgCariPeriksaLabMB(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{"", "Cara Bayar : " + rs.
                        getString("png_jawab"), "Pemeriksaan", "Hasil", "",
                            ...
                            try {
                                ...
                                while (rs3.next()) {
                                    htmlContent.append(
                                            ...
                                            + "<table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0' class='tbl_form'>"
                                            + "<tr class='isi'>"
                                            + "<td valign='top' bgcolor='#fdfff9' align='left' colspan='4'>" + rs3.
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgCariPeriksaLabMB.class.getName());
