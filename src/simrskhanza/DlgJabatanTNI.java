...
public class DlgJabatanTNI extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("jabatan_tni", "'0','" + Nama.getText() + "'",
                    "Jabatan TNI");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            if (tbkecamatan.getSelectedRow() != -1) {
                if (Sequel.meghapustf("jabatan_tni", "id", tbkecamatan.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJabatanTNI dialog = new DlgJabatanTNI(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from jabatan_tni where nama_jabatan like ? ");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(DlgJabatanTNI.class.
            getName());
}
