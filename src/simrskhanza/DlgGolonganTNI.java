...
public class DlgGolonganTNI extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("golongan_tni", "'0','" + Nama.getText() + "'",
                    "Golongan TNI");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            if (tbkecamatan.getSelectedRow() != -1) {
                if (Sequel.meghapustf("golongan_tni", "id", tbkecamatan.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgGolonganTNI dialog = new DlgGolonganTNI(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from golongan_tni where nama_golongan like ? ");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(DlgGolonganTNI.class.
            getName());
}
