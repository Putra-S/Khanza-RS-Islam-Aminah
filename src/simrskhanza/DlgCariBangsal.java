...
public class DlgCariBangsal extends javax.swing.JDialog {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    iyem = iyem + "{\"KodeKamar\":\"" + rs.getString(1) + "\",\"NamaKamar\":\""
            ...
            if (response.isArray()) {
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode
                                .addRow(new Object[]{list.path("KodeKamar").asText(), list.path("NamaKamar").asText()});
                    }
                } else {
                    for (JsonNode list : response) {
                        if (list.path("NamaKamar").asText().toLowerCase().contains(TCari.getText().toLowerCase())) {
                            tabMode.addRow(
                                    new Object[]{list.path("KodeKamar").asText(), list.path("NamaKamar").asText()});
                        }
                    }
                }
            }
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariBangsal.class.getName());
