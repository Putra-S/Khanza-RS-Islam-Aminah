...
public class DlgCatatan extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (TCatatan.getText().trim().isEmpty()) {
            Valid.textKosong(TCatatan, "Catatan");
        } else {
            Sequel.menyimpan3("catatan_pasien", "?,?", 2, new String[]{TNoRM.
                getText(), TCatatan.getText()}, "no_rkm_medis=?", "catatan=?", 2,
                    new String[]{TCatatan.getText(), TNoRM.getText()});
            BtnKeluarActionPerformed(evt);
        }
...
private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
    if (TNoRM.getText().trim().isEmpty() || TPasien.getText().trim().isEmpty()) {
        ...
        Sequel.mengedit2("catatan_pasien", "no_rkm_medis=?", "catatan=?", 2,
                new String[]{
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    public void setNoRm(String norm) {
        TNoRM.setText(norm);
        isPsien();
        Sequel.cariIsi("select catatan_pasien.catatan from catatan_pasien where catatan_pasien.no_rkm_medis=?",
                TCatatan, TNoRM.getText());
    }
    ...
    private static final Logger LOG = Logger.getLogger(DlgCatatan.class.getName());
