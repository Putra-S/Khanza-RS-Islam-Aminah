...
public class DlgCariBahasa extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariBahasa dialog = new DlgCariBahasa(new javax.swing.JFrame(),
                    true);
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    iyem = iyem + "{\"ID\":\"" + rs.getString(1) + "\",\"Bahasa\":\"" + rs.
                            getString(2) + "\"},";
                }
            ...
            fileWriter.write("{\"bahasa\":[" + iyem.substring(0,
                    iyem.length() - 1) + "]}");
            fileWriter.flush();
            fileWriter.close();
            iyem = null;
                ...
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{
                            list.path("ID").asText(), list.path("Bahasa").
                            asText()
                        });
                    }
                } else {
                    for (JsonNode list : response) {
                        if (list.path("Bahasa").asText().toLowerCase().contains(
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariBahasa.class.
            getName());
}
