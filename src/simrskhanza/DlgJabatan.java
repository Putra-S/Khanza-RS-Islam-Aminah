 ...
 * @author dosen
 */
public class DlgJabatan extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("jabatan", "'" + TKd.getText() + "','" + TNm.
                    getText() + "'", "Kode Jabatan") == true) {
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbJabatan.getSelectedRow() != -1) {
            if (Sequel.meghapustf("jabatan", "kd_jbtn", tbJabatan.getValueAt(
                    tbJabatan.getSelectedRow(), 0).toString()) == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbJabatan.getSelectedRow() > -1) {
                if (Sequel.mengedittf("jabatan", "kd_jbtn=?",
                        "kd_jbtn=?,nm_jbtn=?", 3, new String[]{
    ...
    private static final Logger LOG = Logger.getLogger(DlgJabatan.class.
            getName());
}
