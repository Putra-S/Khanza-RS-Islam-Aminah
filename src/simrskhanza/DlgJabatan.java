...
public class DlgJabatan extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select kd_jbtn, nm_jbtn " + " from jabatan where  kd_jbtn like ? or "
    ...
    private static final Logger LOG = Logger.getLogger(DlgJabatan.class.getName());
