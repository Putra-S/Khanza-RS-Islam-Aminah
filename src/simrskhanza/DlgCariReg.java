 ...
 * @author dosen
 */
public class DlgCariReg extends javax.swing.JDialog {
    ...
    public DlgCariReg(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Reg", "No.Rawat", "Tanggal", "Jam", "Kd.Dokter", "Dokter Dituju", "Nomer RM",
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    : "and (reg_periksa.no_rawat like ? or reg_periksa.kd_dokter like ? or dokter.nm_dokter like ? or "
                    ...
                    + "or reg_periksa.hubunganpj like ? or penjab.png_jawab like ?)")
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4),
                        ...
                        rs.getString(10), rs.getString(11), rs.getString(17), rs.getString(12), rs.getString(13),
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariReg.class.getName());
