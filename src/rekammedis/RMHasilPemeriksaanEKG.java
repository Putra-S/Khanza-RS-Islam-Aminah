...
public class RMHasilPemeriksaanEKG extends javax.swing.JDialog {
    ...
    public RMHasilPemeriksaanEKG(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Irama", "Laju Jantung", "Gelombang P", "Interval PR", "Axis",
            "Kompleks QRS", "Segmen ST", "Gelombang T", "Kesimpulan"
        }) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (Irama.getText().trim().isEmpty()) {
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry("rptCetakHasilPemeriksaanEKG.jasper", "report",
                    ...
                    + "inner join dokter on hasil_pemeriksaan_ekg.kd_dokter=dokter.kd_dokter where hasil_pemeriksaan_ekg.no_rawat='" + tbObat.
    ...
    private void btnAmbilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbObat.getSelectedRow() > -1) {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                Valid.panggilUrl(
                        "hasilpemeriksaanekg/login.php?act=login&usere=" + koneksiDB.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMHasilPemeriksaanEKG dialog = new RMHasilPemeriksaanEKG(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        "diagnosa_klinis"), rs.getString("irama"), rs.getString(
                        "laju_jantung"), rs.getString("gelombangp"), rs.
                        getString("intervalpr"),
                        rs.getString("axis"), rs.getString("kompleksqrs"), rs.
                        getString("segmenst"), rs.getString("gelombangt"), rs.
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Irama.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 9).
                    toString());
            LajuJantung.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 10).
                    toString());
            GelombangP.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 11).
                    toString());
            IntervalPR.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 12).
                    toString());
            Axis.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 13).
                    toString());
            KompleksQRS.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 14).
                    toString());
            SegmenST.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),
                    15).toString());
            GelombangT.setSelectedItem(tbObat.
                    getValueAt(tbObat.getSelectedRow(), 16).toString());
            Kesimpulan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 17).
                    toString());
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from hasil_pemeriksaan_ekg where no_rawat=?", 1,
                new String[]{
                    tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
                }) == true) {
    ...
    private void ganti() {
        if (Sequel.mengedittf("hasil_pemeriksaan_ekg", "no_rawat=?",
                "no_rawat=?,tanggal=?,kd_dokter=?,diagnosa_klinis=?,kiriman_dari=?,irama=?,laju_jantung=?,gelombangp=?,"
                + "intervalpr=?,axis=?,kompleksqrs=?,segmenst=?,gelombangt=?,kesimpulan=?",
                15, new String[]{
                    TNoRw.getText(), Valid.
                    SetTgl(Tanggal.getSelectedItem() + "") + " " + Tanggal.
                    getSelectedItem().toString().substring(11, 19), KdDokter.
                    getText(),
                    DiagnosaKlinis.getText(), KirimanDari.getText(), Irama.
                    getText(), LajuJantung.getText(), GelombangP.getText(),
                    IntervalPR.getText(), Axis.getText(),
                    KompleksQRS.getText(), SegmenST.getSelectedItem().toString(),
                    GelombangT.getSelectedItem().toString(), Kesimpulan.
            ...
            tbObat.
                    setValueAt(LajuJantung.getText(), tbObat.getSelectedRow(),
                            10);
            ...
            tbObat.
                    setValueAt(KompleksQRS.getText(), tbObat.getSelectedRow(),
                            14);
            tbObat.setValueAt(SegmenST.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 15);
            tbObat.setValueAt(GelombangT.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 16);
    ...
    private void panggilPhoto() {
        if (FormPhoto.isVisible() == true) {
            try {
                ps = koneksi.prepareStatement(
                        "select hasil_pemeriksaan_ekg_gambar.photo from hasil_pemeriksaan_ekg_gambar where hasil_pemeriksaan_ekg_gambar.no_rawat=?");
                try {
                        ...
                        if (rs.getString("photo").isEmpty() || rs.getString(
                            ...
                            LoadHTML2.setText(
                                    "<html><body><center><a href='http://" + koneksiDB.
                                            ...
                                            PORTWEB() + "/" + koneksiDB.
                                            HYBRIDWEB() + "/hasilpemeriksaanekg/" + rs.
    ...
    private void simpan() {
        if (Sequel.menyimpantf("hasil_pemeriksaan_ekg",
                "?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 14, new String[]{
                    TNoRw.getText(), Valid.
                    SetTgl(Tanggal.getSelectedItem() + "") + " " + Tanggal.
                    getSelectedItem().toString().substring(11, 19), KdDokter.
                    getText(),
                    ...
                    getText(), LajuJantung.getText(), GelombangP.getText(),
                    IntervalPR.getText(),
                    Axis.getText(), KompleksQRS.getText(), SegmenST.
                    getSelectedItem().toString(), GelombangT.getSelectedItem().
                            toString(), Kesimpulan.getText()
                }) == true) {
            tabMode.addRow(new String[]{
                ...
                KirimanDari.getText(), DiagnosaKlinis.getText(), Irama.getText(),
                LajuJantung.getText(), GelombangP.getText(), IntervalPR.
                getText(), Axis.getText(), KompleksQRS.getText(), SegmenST.
                getSelectedItem().toString(),
    ...
    private static final Logger LOG = Logger.getLogger(
            RMHasilPemeriksaanEKG.class.getName());
}
