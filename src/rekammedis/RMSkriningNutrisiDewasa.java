...
public class RMSkriningNutrisiDewasa extends javax.swing.JDialog {
    ...
    public RMSkriningNutrisiDewasa(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.", "Kode Petugas", "Nama Petugas",
                    ...
                    "Alergi", "Skrining Gizi 1", "Nilai 1", "Skrining Gizi 2", "Nilai 2", "Total Skor"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("nilai1"), rs.getString("sg2"), rs.getString("nilai2"),
    ...
    private void ganti() {
        Sequel.mengedit("skrining_nutrisi_dewasa", "no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    SpO2.getText(), Alergi.getText(), SG1.getSelectedItem().toString(),
                    Nilai1.getSelectedItem().toString(), SG2.getSelectedItem().toString(),
                    Nilai2.getSelectedItem().toString(), TotalHasil.getText(), KdPetugas.getText(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from skrining_nutrisi_dewasa where no_rawat=?", 1,
    ...
    private static final Logger LOG = Logger.getLogger(RMSkriningNutrisiDewasa.class.getName());
