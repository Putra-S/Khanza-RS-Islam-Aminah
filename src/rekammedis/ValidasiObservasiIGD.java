...
public class ValidasiObservasiIGD extends javax.swing.JDialog {
    ...
    public ValidasiObservasiIGD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Tgl.Rawat", "Status", "No.Rawat", "No.RM", "Nama Pasien", "NIP", "Nama Pemeriksa",
                    "Tanggal Observasi", "Jam Observasi", "GCS (E,V,M)", "TD(mmHg)", "HR(x/menit)", "RR(x/menit)",
                    "Suhu(°C)", "SpO2(%)", "Terapi"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("tgl_registrasi"), rs.getString("status_lanjut"),
                        ...
                        rs.getString("rr"), rs.getString("suhu"), rs.getString("spo2"), rs.getString("terapi")});
                }
    ...
    private static final Logger LOG = Logger.getLogger(ValidasiObservasiIGD.class.getName());
