 ...
 * @author perpustakaan
 */
public class RMPenilaianAwalMedisRanapKandungan extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisRanapKandungan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.", "Kode Dokter", "Nama Dokter",
                    ...
                    "Thoraks", "Jantung", "Paru", "Abdomen", "Genital & Anus", "Ekstremitas", "Kulit", "Ket.Kepala",
                    "Ket.Mata", "Ket.Gigi", "Ket.THT", "Ket.Thoraks", "Ket.Jantung", "Ket.Paru", "Ket.Abdomen",
                    "Ket.Genital", "Ket.Ekstremitas", "Ket.Kulit", "TFU", "TBJ", "His", "Kontraksi", "DJJ",
                    "Inspeksi", "Inspekulo", "VT", "RT", "Ultrasonografi", "Kardiotokografi", "Laboratorium",
                    "Diagnosis/Asesmen", "Tatalaksana", "Edukasi"}) {
            @Override
        ...
        Ultra.setDocument(new batasInput(3000).getKata(Ultra));
        Kardio.setDocument(new batasInput(3000).getKata(Kardio));
        ...
        Inspeksi.setDocument(new batasInput(5000).getKata(Inspeksi));
        Inspekulo.setDocument(new batasInput(5000).getKata(Inspekulo));
        VT.setDocument(new batasInput(5000).getKata(VT));
        RT.setDocument(new batasInput(5000).getKata(RT));
    ...
    private void initComponents() {
        ...
        KetKepala = new widget.TextArea();
        scrollPane6 = new widget.ScrollPane();
        KetMata = new widget.TextArea();
        scrollPane18 = new widget.ScrollPane();
        KetGigi = new widget.TextArea();
        scrollPane19 = new widget.ScrollPane();
        KetTht = new widget.TextArea();
        scrollPane20 = new widget.ScrollPane();
        KetParu = new widget.TextArea();
        scrollPane21 = new widget.ScrollPane();
        KetAbdomen = new widget.TextArea();
        scrollPane22 = new widget.ScrollPane();
        KetGenital = new widget.TextArea();
        scrollPane23 = new widget.ScrollPane();
        KetEkstremitas = new widget.TextArea();
        scrollPane24 = new widget.ScrollPane();
        KetThoraks = new widget.TextArea();
        scrollPane25 = new widget.ScrollPane();
        KetJantung = new widget.TextArea();
        scrollPane26 = new widget.ScrollPane();
        KetKulit = new widget.TextArea();
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(1061, 1163));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-08-2023 13:32:51" }));
        ...
        BtnAmbilDataIGD.setText("Ambil Medis IGD");
        ...
        BtnAmbilDataIGD.setBounds(860, 90, 160, 30);

        jLabel40.setText("Kepala :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(0, 320, 80, 23);
        ...
        Kepala.setBounds(85, 320, 100, 23);

        jLabel44.setText("Gigi & Mulut :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(0, 380, 80, 23);
        ...
        FormInput.add(Gigi);
        Gigi.setBounds(85, 380, 100, 23);

        jLabel45.setText("THT :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(0, 410, 80, 23);
        ...
        FormInput.add(THT);
        THT.setBounds(85, 410, 100, 23);

        jLabel46.setText("Thoraks :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(0, 440, 80, 23);
        ...
        Thoraks.setBounds(85, 440, 100, 23);

        jLabel49.setText("Abdomen :");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(425, 350, 85, 23);
        ...
        Abdomen.setBounds(515, 350, 100, 23);

        jLabel50.setText("Genital & Anus :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(425, 380, 85, 23);
        ...
        Genital.setBounds(515, 380, 100, 23);

        jLabel51.setText("Ekstremitas :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(425, 410, 85, 23);
        ...
        Ekstremitas.setBounds(515, 410, 100, 23);

        jLabel52.setText("Kulit :");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(425, 440, 85, 23);
        ...
        FormInput.add(Kulit);
        Kulit.setBounds(515, 440, 100, 23);

        jLabel42.setText("Mata :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(0, 350, 80, 23);
        ...
        FormInput.add(Mata);
        Mata.setBounds(85, 350, 100, 23);

        jLabel47.setText("Jantung :");
        jLabel47.setName("jLabel47"); // NOI18N
        FormInput.add(jLabel47);
        jLabel47.setBounds(0, 470, 80, 23);
        ...
        Jantung.setBounds(85, 470, 100, 23);

        jLabel53.setText("Paru :");
        jLabel53.setName("jLabel53"); // NOI18N
        FormInput.add(jLabel53);
        jLabel53.setBounds(425, 320, 85, 23);
        ...
        FormInput.add(Paru);
        Paru.setBounds(515, 320, 100, 23);

        scrollPane5.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane5.setName("scrollPane5"); // NOI18N

        KetKepala.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        KetKepala.setColumns(20);
        KetKepala.setRows(8);
        ...
        scrollPane5.setViewportView(KetKepala);

        FormInput.add(scrollPane5);
        scrollPane5.setBounds(190, 320, 230, 23);

        scrollPane6.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane6.setName("scrollPane6"); // NOI18N

        KetMata.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        KetMata.setColumns(20);
        KetMata.setRows(8);
        ...
        scrollPane6.setViewportView(KetMata);

        FormInput.add(scrollPane6);
        scrollPane6.setBounds(190, 350, 230, 23);
        ...
        KetGigi.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        KetGigi.setColumns(20);
        KetGigi.setRows(8);
        ...
        scrollPane18.setViewportView(KetGigi);

        FormInput.add(scrollPane18);
        scrollPane18.setBounds(190, 380, 230, 23);
        ...
        KetTht.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        KetTht.setColumns(20);
        KetTht.setRows(8);
        ...
        scrollPane19.setViewportView(KetTht);

        FormInput.add(scrollPane19);
        scrollPane19.setBounds(190, 410, 230, 23);
        ...
        KetParu.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        KetParu.setColumns(20);
        KetParu.setRows(8);
        ...
        scrollPane20.setViewportView(KetParu);

        FormInput.add(scrollPane20);
        scrollPane20.setBounds(620, 320, 230, 23);
        ...
        KetAbdomen.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        KetAbdomen.setColumns(20);
        KetAbdomen.setRows(8);
        ...
        scrollPane21.setViewportView(KetAbdomen);

        FormInput.add(scrollPane21);
        scrollPane21.setBounds(620, 350, 230, 23);
        ...
        KetGenital.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        KetGenital.setColumns(20);
        KetGenital.setRows(8);
        ...
        scrollPane22.setViewportView(KetGenital);

        FormInput.add(scrollPane22);
        scrollPane22.setBounds(620, 380, 230, 23);
        ...
        KetEkstremitas.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        KetEkstremitas.setColumns(20);
        KetEkstremitas.setRows(8);
        KetEkstremitas.setName("KetEkstremitas"); // NOI18N
        KetEkstremitas.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KetEkstremitasKeyPressed(evt);
            }
        });
        scrollPane23.setViewportView(KetEkstremitas);

        FormInput.add(scrollPane23);
        scrollPane23.setBounds(620, 410, 230, 23);
        ...
        KetThoraks.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        KetThoraks.setColumns(20);
        KetThoraks.setRows(8);
        ...
        scrollPane24.setViewportView(KetThoraks);

        FormInput.add(scrollPane24);
        scrollPane24.setBounds(190, 440, 230, 23);
        ...
        KetJantung.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        KetJantung.setColumns(20);
        KetJantung.setRows(8);
        ...
        scrollPane25.setViewportView(KetJantung);

        FormInput.add(scrollPane25);
        scrollPane25.setBounds(190, 470, 230, 23);
        ...
        KetKulit.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        KetKulit.setColumns(20);
        KetKulit.setRows(8);
        ...
        scrollPane26.setViewportView(KetKulit);

        FormInput.add(scrollPane26);
        scrollPane26.setBounds(620, 440, 230, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRM.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("penilaian_medis_ranap_kandungan",
                    "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                    "No.Rawat", 58, new String[]{
                        ...
                        getSelectedItem().toString(), Mata.getSelectedItem().
                                toString(), Gigi.getSelectedItem().toString(),
                        THT.getSelectedItem().toString(),
                        Thoraks.getSelectedItem().toString(), Jantung.
                        getSelectedItem().toString(), Paru.getSelectedItem().
                                toString(), Abdomen.getSelectedItem().toString(),
                        Genital.getSelectedItem().toString(), Ekstremitas.
                        getSelectedItem().toString(),
                        Kulit.getSelectedItem().toString(), KetKepala.getText(),
                        KetMata.getText(), KetGigi.getText(), KetTht.getText(),
                        KetThoraks.getText(), KetJantung.getText(), KetParu.
                        getText(), KetAbdomen.getText(), KetGenital.getText(),
                        KetEkstremitas.getText(),
                        KetKulit.getText(), TFU.getText(), TBJ.getText(), His.
                        getText(), Kontraksi.getSelectedItem().toString(), DJJ.
                        getText(), Inspeksi.getText(), Inspekulo.getText(), VT.
                        getText(), RT.getText(),
                        Ultra.getText(), Kardio.getText(), Laborat.getText(),
                        Diagnosis.getText(), Tatalaksana.getText(), Edukasi.
                        getText()
                    }) == true) {
                emptTeks();
            }
                    ...
                    while (rs.next()) {
                        htmlContent.append("<tr class='isi'><td valign='top'>").
                                ...
                                "</td><td valign='top'>").append(rs.getString(
                                        "hubungan")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString("keluhan_utama")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "rps")).append("</td><td valign='top'>").
                                append(rs.getString("rpd")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "rpk")).append("</td><td valign='top'>").
                                ...
                                "</td><td valign='top'>").append(rs.getString(
                                        "gcs")).append("</td><td valign='top'>").
                                append(rs.getString("kesadaran")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "td")).append("</td><td valign='top'>").
                                append(rs.getString("nadi")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "rr")).append("</td><td valign='top'>").
                                append(rs.getString("suhu")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "spo")).append("</td><td valign='top'>").
                                append(rs.getString("bb")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "tb")).append("</td><td valign='top'>").
                                append(rs.getString("kepala")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "mata")).
                                append("</td><td valign='top'>").append(rs.
                                getString("gigi")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "tht")).append("</td><td valign='top'>").
                                append(rs.getString("thoraks")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "jantung")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString("paru")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "abdomen")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString("genital")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "ekstremitas")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString("kulit")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "ket_fisik")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString("tfu")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "tbj")).append("</td><td valign='top'>").
                                append(rs.getString("his")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "kontraksi")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString("djj")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "inspeksi")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString("inspekulo")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "vt")).append("</td><td valign='top'>").
                                append(rs.getString("rt")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "ultra")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString("kardio")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                ...
                                "</td><td valign='top'>").append(rs.getString(
                                        "tata")).
                                append("</td><td valign='top'>").append(rs.
                                getString("edukasi")).append("</td></tr>");
                    }
                    LoadHTML.setText(
                            "<html>"
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapKebidanan.jasper",
                    "report",
                    ...
                    + "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join penilaian_medis_ranap_kandungan on reg_periksa.no_rawat=penilaian_medis_ranap_kandungan.no_rawat "
                    + "inner join dokter on penilaian_medis_ranap_kandungan.kd_dokter=dokter.kd_dokter where penilaian_medis_ranap_kandungan.no_rawat='" + tbObat.
    ...
    private void KulitKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KulitKeyPressed
        Valid.pindah(evt, Ekstremitas, KetKepala);
    ...
    private void KetEkstremitasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KetEkstremitasKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KetEkstremitasKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRanapKandungan dialog = new RMPenilaianAwalMedisRanapKandungan(new javax.swing.JFrame(),
                    true);
    ...
    private widget.TextArea KetAbdomen;
    private widget.TextArea KetEkstremitas;
    private widget.TextArea KetGenital;
    private widget.TextArea KetGigi;
    private widget.TextArea KetJantung;
    private widget.TextArea KetKepala;
    private widget.TextArea KetKulit;
    private widget.TextArea KetMata;
    private widget.TextArea KetParu;
    private widget.TextArea KetThoraks;
    private widget.TextArea KetTht;
        ...
        try {
            if (TCari.getText().trim().isEmpty()) {
                ps = koneksi.prepareStatement(
                        ...
                        + "penilaian_medis_ranap_kandungan.keadaan,penilaian_medis_ranap_kandungan.gcs,penilaian_medis_ranap_kandungan.kesadaran,penilaian_medis_ranap_kandungan.td,penilaian_medis_ranap_kandungan.nadi,penilaian_medis_ranap_kandungan.rr,penilaian_medis_ranap_kandungan.suhu,penilaian_medis_ranap_kandungan.spo,penilaian_medis_ranap_kandungan.bb,penilaian_medis_ranap_kandungan.tb,"
                        + "penilaian_medis_ranap_kandungan.kepala,penilaian_medis_ranap_kandungan.mata,penilaian_medis_ranap_kandungan.gigi,penilaian_medis_ranap_kandungan.tht,penilaian_medis_ranap_kandungan.thoraks,penilaian_medis_ranap_kandungan.jantung,penilaian_medis_ranap_kandungan.paru,penilaian_medis_ranap_kandungan.abdomen,penilaian_medis_ranap_kandungan.ekstremitas,"
                        + "penilaian_medis_ranap_kandungan.genital,penilaian_medis_ranap_kandungan.kulit,penilaian_medis_ranap_kandungan.ket_kepala,penilaian_medis_ranap_kandungan.ket_mata,penilaian_medis_ranap_kandungan.ket_gigi,penilaian_medis_ranap_kandungan.ket_tht,penilaian_medis_ranap_kandungan.ket_thoraks,penilaian_medis_ranap_kandungan.ket_jantung,penilaian_medis_ranap_kandungan.ket_paru,"
                        + "penilaian_medis_ranap_kandungan.ket_abdomen,penilaian_medis_ranap_kandungan.ket_genital,penilaian_medis_ranap_kandungan.ket_ekstremitas,penilaian_medis_ranap_kandungan.ket_kulit,penilaian_medis_ranap_kandungan.tfu,penilaian_medis_ranap_kandungan.tbj,penilaian_medis_ranap_kandungan.his,penilaian_medis_ranap_kandungan.kontraksi,penilaian_medis_ranap_kandungan.djj,penilaian_medis_ranap_kandungan.inspeksi,"
                        + "penilaian_medis_ranap_kandungan.inspekulo,penilaian_medis_ranap_kandungan.vt,penilaian_medis_ranap_kandungan.rt,penilaian_medis_ranap_kandungan.ultra,penilaian_medis_ranap_kandungan.kardio,penilaian_medis_ranap_kandungan.lab,penilaian_medis_ranap_kandungan.diagnosis,penilaian_medis_ranap_kandungan.tata,penilaian_medis_ranap_kandungan.edukasi,dokter.nm_dokter "
                        + "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                        + "inner join penilaian_medis_ranap_kandungan on reg_periksa.no_rawat=penilaian_medis_ranap_kandungan.no_rawat "
                        + "inner join dokter on penilaian_medis_ranap_kandungan.kd_dokter=dokter.kd_dokter where "
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("kulit"), rs.getString("ket_kepala"), rs.getString("ket_mata"),
                        rs.getString("ket_gigi"), rs.getString("ket_tht"), rs.getString("ket_thoraks"),
                        rs.getString("ket_jantung"), rs.getString("ket_paru"), rs.getString("ket_abdomen"),
                        rs.getString("ket_genital"), rs.getString("ket_ekstremitas"), rs.getString("ket_kulit"),
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            KetKepala.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 37).toString());
            KetMata.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 38).toString());
            KetGigi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 39).toString());
            KetTht.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 40).toString());
            KetThoraks.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 41).toString());
            KetJantung.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 42).toString());
            KetParu.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 43).toString());
            KetAbdomen.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 44).toString());
            KetGenital.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 45).toString());
            KetEkstremitas.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 46).toString());
            KetKulit.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 47).toString());
            TFU.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 48).toString());
            TBJ.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 49).toString());
            His.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 50).toString());
            Kontraksi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 51).toString());
            DJJ.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 52).toString());
            Inspeksi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 53).toString());
            Inspekulo.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 54).toString());
            VT.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 55).toString());
            RT.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 56).toString());
            Ultra.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 57).toString());
            Kardio.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 58).toString());
            Laborat.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 59).toString());
            Diagnosis.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 60).toString());
            Tatalaksana.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 61).toString());
            Edukasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 62).toString());
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_medis_ranap_kandungan where no_rawat=? and kd_dokter=?", 2,
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_ranap_kandungan", "no_rawat=? and kd_dokter=?",
                ...
                + "kepala=?,mata=?,gigi=?,tht=?,thoraks=?,jantung=?,paru=?,abdomen=?,genital=?,ekstremitas=?,kulit=?,ket_kepala=?,ket_mata=?,ket_gigi=?,ket_tht=?,ket_thoraks=?,ket_jantung=?,ket_paru=?,ket_abdomen=?,ket_genital=?,ket_ekstremitas=?,ket_kulit=?,tfu=?,tbj=?,his=?,kontraksi=?,djj=?,inspeksi=?,inspekulo=?,vt=?,rt=?,ultra=?,kardio=?,lab=?,diagnosis=?,tata=?,edukasi=?",
                60,
                new String[]{TNoRw.getText(),
                    ...
                    KetKepala.getText(), KetMata.getText(), KetGigi.getText(), KetTht.getText(),
                    KetThoraks.getText(), KetJantung.getText(), KetParu.getText(), KetAbdomen.getText(),
                    KetGenital.getText(), KetEkstremitas.getText(), KetKulit.getText(), TFU.getText(),
                    TBJ.getText(), His.getText(), Kontraksi.getSelectedItem().toString(), DJJ.getText(),
    ...
    private void ambildataawalmedisigd() {
        try {
            ps = koneksi.prepareStatement("select penilaian_medis_igd.tanggal,"
                    ...
                    + "penilaian_medis_igd.kepala,penilaian_medis_igd.mata,penilaian_medis_igd.gigi,penilaian_medis_igd.leher,penilaian_medis_igd.thoraks,penilaian_medis_igd.abdomen,penilaian_medis_igd.ekstremitas,penilaian_medis_igd.genital,penilaian_medis_igd.ket_kepala,"
                    + "penilaian_medis_igd.ket_mata,penilaian_medis_igd.ket_gigi,penilaian_medis_igd.ket_leher,penilaian_medis_igd.ket_thorax,penilaian_medis_igd.ket_abdomen,penilaian_medis_igd.ket_genital,penilaian_medis_igd.ket_ekstremitas,"
                    + "penilaian_medis_igd.ket_lokalis,penilaian_medis_igd.ekg,penilaian_medis_igd.rad,penilaian_medis_igd.lab,penilaian_medis_igd.diagnosis,penilaian_medis_igd.tata "
                    + "from penilaian_medis_igd where " + "penilaian_medis_igd.no_rawat=?");
            ...
            while (rs.next()) {
                ...
                KetGenital.setText(rs.getString("ket_genital"));
                KetEkstremitas.setText(rs.getString("ket_ekstremitas"));
            }
        } catch (SQLException e) {
            System.out.println("Notif : " + e);
        }
        TFU.setText(Sequel.cariIsi(
                "select penilaian_awal_keperawatan_kebidanan_ranap.pemeriksaan_kebidanan_tfu from penilaian_awal_keperawatan_kebidanan_ranap where penilaian_awal_keperawatan_kebidanan_ranap.no_rawat=?",
                TNoRw.getText()));
        TBJ.setText(Sequel.cariIsi(
                "select penilaian_awal_keperawatan_kebidanan_ranap.pemeriksaan_kebidanan_tbj from penilaian_awal_keperawatan_kebidanan_ranap where penilaian_awal_keperawatan_kebidanan_ranap.no_rawat=?",
                TNoRw.getText()));
        His.setText(Sequel.cariIsi(
                "select penilaian_awal_keperawatan_kebidanan_ranap.pemeriksaan_kebidanan_his from penilaian_awal_keperawatan_kebidanan_ranap where penilaian_awal_keperawatan_kebidanan_ranap.no_rawat=?",
                TNoRw.getText()));
        DJJ.setText(Sequel.cariIsi(
                "select penilaian_awal_keperawatan_kebidanan_ranap.pemeriksaan_kebidanan_djj from penilaian_awal_keperawatan_kebidanan_ranap where penilaian_awal_keperawatan_kebidanan_ranap.no_rawat=?",
                TNoRw.getText()));
    }

    private static final Logger LOG = Logger.getLogger(RMPenilaianAwalMedisRanapKandungan.class.getName());
