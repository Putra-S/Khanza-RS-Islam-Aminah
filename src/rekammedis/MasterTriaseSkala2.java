...
public class MasterTriaseSkala2 extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdskala.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("master_triase_skala2", "'" + kdpemeriksaan.
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, kdskala, "master_triase_skala2",
                "kode_skala2") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdskala.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("master_triase_skala2", "kode_skala2=?",
                        "kode_skala2=?,pengkajian_skala2=?,kode_pemeriksaan=?",
                        4, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterTriaseSkala2 dialog = new MasterTriaseSkala2(
    ...
    private static final Logger LOG = Logger.getLogger(MasterTriaseSkala2.class.
            getName());
}
