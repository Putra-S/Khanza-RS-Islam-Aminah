...
public class MasterRencanaKeperawatanNeonatus extends javax.swing.JDialog {
    ...
    private MasterMasalahKeperawatanNeonatus masalah = new MasterMasalahKeperawatanNeonatus(
            null, false);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterRencanaKeperawatanNeonatus dialog = new MasterRencanaKeperawatanNeonatus(
    ...
    private static final Logger LOG = Logger.getLogger(
            MasterRencanaKeperawatanNeonatus.class.getName());
}
