...
public class MasterRencanaKeperawatanNeonatus extends javax.swing.JDialog {
    ...
    private MasterMasalahKeperawatanNeonatus masalah = new MasterMasalahKeperawatanNeonatus(null, false);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdrencana.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("master_rencana_keperawatan_neonatus",
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, kdrencana,
                "master_rencana_keperawatan_neonatus", "kode_rencana") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdrencana.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("master_rencana_keperawatan_neonatus",
                        "kode_rencana=?",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterRencanaKeperawatanNeonatus dialog = new MasterRencanaKeperawatanNeonatus(new javax.swing.JFrame(),
                    true);
    ...
    private static final Logger LOG = Logger.getLogger(MasterRencanaKeperawatanNeonatus.class.getName());
