...
public class RMPemantauanPEWS extends javax.swing.JDialog {
    ...
    public RMPemantauanPEWS(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Umur", "JK", "Tanggal", "Skor Perilaku", "Skor 1",
                    "Skor CRT / Warna Kulit", "Skor 2", "Skor Perespirasi", "Skor 3", "Ttl.Skor", "Kesimpulan",
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("jk"), rs.getString("tanggal"), rs.getString("parameter_perilaku"),
                        rs.getString("skor_perilaku"), rs.getString("parameter_crt_atau_warna_kulit"),
                        rs.getString("skor_crt_atau_warna_kulit"), rs.getString("parameter_perespirasi"),
                        rs.getString("skor_perespirasi"), rs.getString("skor_total"),
    ...
    private void ganti() {
        ...
        isjml();
        isHitung();
        if (Sequel.mengedittf("pemantauan_pews_anak", "tanggal=? and no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    Skor2.getText(), cmbSkor3.getSelectedItem().toString(), Skor3.getText(), TotalSkor.getText(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from pemantauan_pews_anak where tanggal=? and no_rawat=?", 2,
    ...
    private void simpan() {
        ...
        isjml();
        isHitung();
        if (Sequel.menyimpantf("pemantauan_pews_anak", "?,?,?,?,?,?,?,?,?,?,?", "Data", 11,
                new String[]{TNoRw.getText(),
                    Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Jam.getSelectedItem() + ":"
                    + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
                    cmbSkor1.getSelectedItem().toString(), Skor1.getText(), cmbSkor2.getSelectedItem().toString(),
    ...
    private static final Logger LOG = Logger.getLogger(RMPemantauanPEWS.class.getName());
