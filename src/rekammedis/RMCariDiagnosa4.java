 ...
 * @author dosen
 */
public class RMCariDiagnosa4 extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMCariDiagnosa4(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariDiagnosa4 dialog = new RMCariDiagnosa4(new javax.swing.JFrame(), true);
    ...
    private static final Logger LOG = Logger.getLogger(RMCariDiagnosa4.class.getName());
