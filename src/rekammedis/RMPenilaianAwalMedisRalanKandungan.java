...
public class RMPenilaianAwalMedisRalanKandungan extends javax.swing.JDialog {
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRalanKebidanan.jasper",
                    "report",
                    "::[ Laporan Penilaian Awal Medis Rawat Jalan Kebidanan & Kandungan ]::",
                    ...
                    + "inner join dokter on penilaian_medis_ralan_kandungan.kd_dokter=dokter.kd_dokter where penilaian_medis_ralan_kandungan.no_rawat='" + tbObat.
