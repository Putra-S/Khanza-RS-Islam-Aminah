...
public class MasterTemplateLaporanOperasi extends javax.swing.JDialog {
    ...
    public MasterTemplateLaporanOperasi(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.Template", "Nama Operasi", "Diagnosis Pre-operatif", "Diagnosis Post-operatif",
            "Jaringan di-Eksisi / -Insisi", "Dikirim PA", "Template Laporan Operasi"};
...
//GEN-FIRST:event_TKdKeyPressed
    private void KdKeyPressed(java.awt.event.KeyEvent evt) {//GEN-LAST:event_TKdKeyPressed
        Valid.pindah(evt, TCari, DiagnosisPostOp, NamaOperasi);//GEN-FIRST:event_KdKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select template_laporan_operasi.no_template,template_laporan_operasi.nama_operasi,"
                            ...
                            : "where template_laporan_operasi.no_template like ? or template_laporan_operasi.nama_operasi like ? or "
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("no_template"), rs.getString("nama_operasi"),
                        rs.getString("diagnosa_preop"), rs.getString("diagnosa_postop"),
                        rs.getString("jaringan_dieksisi"), rs.getString("permintaan_pa"),
    ...
    private static final Logger LOG = Logger.getLogger(MasterTemplateLaporanOperasi.class.getName());
