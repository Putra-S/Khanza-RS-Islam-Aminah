...
public class RMDataCatatanKeperawatanRalan extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataCatatanKeperawatanRalan dialog = new RMDataCatatanKeperawatanRalan(
    ...
    private void ganti() {
        if (Sequel.mengedittf("catatan_keperawatan_ralan",
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from catatan_keperawatan_ralan where tanggal=? and jam=? and no_rawat=?",
                3, new String[]{
    ...
    private void simpan() {
        if (Sequel.menyimpantf("catatan_keperawatan_ralan", "?,?,?,?,?", "Data",
                5, new String[]{
                    Valid.SetTgl(Tanggal.getSelectedItem() + ""), Jam.
                    getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
    ...
    private static final Logger LOG = Logger.getLogger(
            RMDataCatatanKeperawatanRalan.class.getName());
}
