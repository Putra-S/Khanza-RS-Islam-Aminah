...
public class RMDataCatatanKeperawatanRalan extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptDataCatatanKeperawatanRalan.jasper",
                        "report", "::[ Data Catatan Keperawatan Rawat Jalan ]::",
                        ...
                        + "catatan_keperawatan_ralan.tanggal between '" + Valid.
                                SetTgl(DTPCari1.getSelectedItem() + "") + "' and '" + Valid.
                        SetTgl(DTPCari2.getSelectedItem() + "") + "' order by catatan_keperawatan_ralan.tanggal,catatan_keperawatan_ralan.jam",
                        param);
            } else {
                Valid.MyReportqry("rptDataCatatanKeperawatanRalan.jasper",
                        "report", "::[ Data Catatan Keperawatan Rawat Jalan ]::",
                        ...
                        + "(reg_periksa.no_rawat like '%" + TCari.getText().
                                ...
                                getText().trim() + "%' or "
                        + "pasien.nm_pasien like '%" + TCari.getText().trim() + "%' or catatan_keperawatan_ralan.nip like '%" + TCari.
    ...
    private void MnCatatanKeperawatanRawatJalanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCatatanKeperawatanRawatJalanActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptFormulirCatatanKeperawatanRalan.jasper",
                    "report", "::[ Formulir Catatan Keperawatan Rawat Jalan ]::",
                    ...
                    + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join petugas on catatan_keperawatan_ralan.nip=petugas.nip where reg_periksa.no_rawat='" + tbObat.
                            getValueAt(tbObat.getSelectedRow(), 0).toString() + "' order by catatan_keperawatan_ralan.tanggal,catatan_keperawatan_ralan.jam",
                    param);
        }
    ...
    private void ganti() {
        if (Sequel.mengedittf("catatan_keperawatan_ralan", "tanggal=? and jam=? and no_rawat=?",
    ...
    private void simpan() {
        if (Sequel.menyimpantf("catatan_keperawatan_ralan", "?,?,?,?,?", "Data", 5,
    ...
    private static final Logger LOG = Logger.getLogger(RMDataCatatanKeperawatanRalan.class.getName());
