...
public class RMChecklistPostOperasi extends javax.swing.JDialog {
    ...
    public RMChecklistPostOperasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.", "Tanggal", "SN/CN", "Tindakan",
                    ...
                    "Keadaan Umum", "Radiologi", "Keterangan Radiologi", "EKG", "Keterangan EKG", "USG",
                    "Keterangan USG", "CT Scan", "Keterangan CT Scan", "MRI", "Keterangan MRI",
                    "Jenis Cairan Infus", "Kateter Urine", "Tgl.Pemasangan", "Warna Urine", "Jml.Urine",
                    "Area Luka Operasi", "Drain", "Jml.Drain", "Letak Drain", "Warna Drain", "Jaringan PA",
                    "NIP OK", "Petugas Ruang OK", "NIP Anestesi", "Petugas Anestesi"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("keadaan_umum"), rs.getString("pemeriksaan_penunjang_rontgen"),
                        ...
                        rs.getString("keterangan_pemeriksaan_penunjang_mri"), rs.getString("jenis_cairan_infus"),
                        rs.getString("kateter_urine"), rs.getString("tanggal_pemasangan_kateter"),
                        rs.getString("warna_kateter"), rs.getString("jumlah_kateter"),
                        rs.getString("area_luka_operasi"), rs.getString("drain"), rs.getString("jumlah_drain"),
                        rs.getString("letak_drain"), rs.getString("warna_drain"), rs.getString("jaringan_pa"),
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            if (!tbObat.getValueAt(tbObat.getSelectedRow(), 25).toString().isEmpty()) {
    ...
    private void ganti() {
        if (Sequel.mengedittf("checklist_post_operasi", "no_rawat=? and tanggal=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    KeadaanUmum.getSelectedItem().toString(), Radiologi.getSelectedItem().toString(),
                    KeteranganRadiologi.getText(), EKG.getSelectedItem().toString(), KeteranganEKG.getText(),
                    USG.getSelectedItem().toString(), KeteranganUSG.getText(), CTScan.getSelectedItem().toString(),
                    KeteranganCTScan.getText(), MRI.getSelectedItem().toString(), KeteranganMRI.getText(),
                    CairanInfus.getText(), KateterUrine.getSelectedItem().toString(),
                    (KateterUrine.getSelectedIndex() == 0
                    ? Valid.SetTgl(TanggalKateter.getSelectedItem() + "") + " "
                    + TanggalKateter.getSelectedItem().toString().substring(11, 19)
                    : "0000-00-00 00:00:0"),
                    WarnaUrine.getSelectedItem().toString(), JumlahUrine.getText(), AreaLukaOperasi.getText(),
                    Drain.getSelectedItem().toString(), JumlahDrain.getText(), LetakDrain.getText(),
                    WarnaDrain.getText(), JaringanPA.getSelectedItem().toString(), KdPetugasOK.getText(),
                    KdPetugasAnest.getText(), tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString(),
            ...
            tbObat.setValueAt(
                    (KateterUrine.getSelectedIndex() == 0 ? Valid.SetTgl(TanggalKateter.getSelectedItem() + "") + " "
                    + TanggalKateter.getSelectedItem().toString().substring(11, 19) : ""),
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from checklist_post_operasi where no_rawat=? and tanggal=?", 2,
    ...
    private void simpan() {
        if (Sequel.menyimpantf("checklist_post_operasi", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    Drain.getSelectedItem().toString(), JumlahDrain.getText(), LetakDrain.getText(),
                    WarnaDrain.getText(), JaringanPA.getSelectedItem().toString(), KdPetugasOK.getText(),
                    KdPetugasAnest.getText()}) == true) {
            tabMode.addRow(new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), TglLahir.getText(),
                JK.getText(),
                Valid.SetTgl(Tanggal.getSelectedItem() + "") + " "
                + Tanggal.getSelectedItem().toString().substring(11, 19),
                SNCN.getText(), Tindakan.getText(), KodeDokterBedah.getText(), NamaDokterBedah.getText(),
                ...
                Drain.getSelectedItem().toString(), JumlahDrain.getText(), LetakDrain.getText(),
                WarnaDrain.getText(), JaringanPA.getSelectedItem().toString(), KdPetugasOK.getText(),
                NmPetugasOK.getText(), KdPetugasAnest.getText(), NmPetugasAnest.getText()});
            LCount.setText("" + tabMode.getRowCount());
            emptTeks();
        }
    }

    private static final Logger LOG = Logger.getLogger(RMChecklistPostOperasi.class.getName());
