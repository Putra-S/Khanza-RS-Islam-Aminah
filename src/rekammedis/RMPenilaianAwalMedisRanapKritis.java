 ...
 * @author perpustakaan
 */
public class RMPenilaianAwalMedisRanapKritis extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMPenilaianAwalMedisRanapKritis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.", "Kode Dokter", "Nama Dokter",
                    ...
                    "Thoraks", "Jantung", "Paru", "Abdomen", "Genital & Anus", "Ekstremitas", "Kulit", "Keterangan",
                    "Laboratorium", "Radiologi", "Penunjang Lainnya", "Diagnosis/Asesmen", "Tatalaksana", "Edukasi"}) {
            @Override
        ...
        Keterangan.setDocument(new batasInput(5000).getKata(Keterangan));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Rawat Inap Kritis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel49.setBounds(190, 350, 85, 23);
        ...
        Abdomen.setBounds(280, 350, 100, 23);

        jLabel50.setText("Genital & Anus :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(190, 380, 85, 23);
        ...
        Genital.setBounds(280, 380, 100, 23);

        jLabel51.setText("Ekstremitas :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(190, 410, 85, 23);
        ...
        Ekstremitas.setBounds(280, 410, 100, 23);

        jLabel52.setText("Kulit :");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(190, 440, 85, 23);
        ...
        FormInput.add(Kulit);
        Kulit.setBounds(280, 440, 100, 23);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-12-2024 09:31:12" }));
        ...
        jLabel53.setBounds(190, 320, 85, 23);
        ...
        scrollPane5.setBounds(390, 320, 460, 170);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRM.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("penilaian_medis_ranap_kritis",
                    "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                    "No.Rawat", 40, new String[]{
                        ...
                        Kulit.getSelectedItem().toString(), Keterangan.getText(),
                        KetLokalis.getText(), Laborat.getText(), Radiologi.getText(), Penunjang.getText(),
            ...
            try {
                if (TCari.getText().trim().isEmpty()) {
                    ps = koneksi.prepareStatement(
                            "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_kritis.tanggal,"
                            + "penilaian_medis_ranap_kritis.kd_dokter,penilaian_medis_ranap_kritis.anamnesis,penilaian_medis_ranap_kritis.hubungan,penilaian_medis_ranap_kritis.keluhan_utama,penilaian_medis_ranap_kritis.rps,penilaian_medis_ranap_kritis.rpk,penilaian_medis_ranap_kritis.rpd,penilaian_medis_ranap_kritis.rpo,penilaian_medis_ranap_kritis.alergi,"
                            + "penilaian_medis_ranap_kritis.keadaan,penilaian_medis_ranap_kritis.gcs,penilaian_medis_ranap_kritis.kesadaran,penilaian_medis_ranap_kritis.td,penilaian_medis_ranap_kritis.nadi,penilaian_medis_ranap_kritis.rr,penilaian_medis_ranap_kritis.suhu,penilaian_medis_ranap_kritis.spo,penilaian_medis_ranap_kritis.bb,penilaian_medis_ranap_kritis.tb,"
                            + "penilaian_medis_ranap_kritis.kepala,penilaian_medis_ranap_kritis.mata,penilaian_medis_ranap_kritis.gigi,penilaian_medis_ranap_kritis.tht,penilaian_medis_ranap_kritis.thoraks,penilaian_medis_ranap_kritis.jantung,penilaian_medis_ranap_kritis.paru,penilaian_medis_ranap_kritis.abdomen,penilaian_medis_ranap_kritis.ekstremitas,"
                            + "penilaian_medis_ranap_kritis.genital,penilaian_medis_ranap_kritis.kulit,penilaian_medis_ranap_kritis.ket_fisik,penilaian_medis_ranap_kritis.ket_lokalis,penilaian_medis_ranap_kritis.lab,penilaian_medis_ranap_kritis.rad,penilaian_medis_ranap_kritis.penunjang,penilaian_medis_ranap_kritis.diagnosis,penilaian_medis_ranap_kritis.tata,"
                            + "penilaian_medis_ranap_kritis.edukasi,dokter.nm_dokter "
                            + "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                            + "inner join penilaian_medis_ranap_kritis on reg_periksa.no_rawat=penilaian_medis_ranap_kritis.no_rawat "
                            + "inner join dokter on penilaian_medis_ranap_kritis.kd_dokter=dokter.kd_dokter where "
                            + "penilaian_medis_ranap_kritis.tanggal between ? and ? order by penilaian_medis_ranap_kritis.tanggal");
                } else {
                    ps = koneksi.prepareStatement(
                            "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_kritis.tanggal,"
                            + "penilaian_medis_ranap_kritis.kd_dokter,penilaian_medis_ranap_kritis.anamnesis,penilaian_medis_ranap_kritis.hubungan,penilaian_medis_ranap_kritis.keluhan_utama,penilaian_medis_ranap_kritis.rps,penilaian_medis_ranap_kritis.rpk,penilaian_medis_ranap_kritis.rpd,penilaian_medis_ranap_kritis.rpo,penilaian_medis_ranap_kritis.alergi,"
                            ...
                            + "inner join penilaian_medis_ranap_kritis on reg_periksa.no_rawat=penilaian_medis_ranap_kritis.no_rawat "
                            + "inner join dokter on penilaian_medis_ranap_kritis.kd_dokter=dokter.kd_dokter where "
                            + "penilaian_medis_ranap_kritis.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "
                            + "penilaian_medis_ranap_kritis.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ranap_kritis.tanggal");
                }
    ...
    private void KetLokalisKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KetLokalisKeyPressed
        Valid.pindah2(evt, Keterangan, Laborat);
        ...
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.
                    MyReportqry("rptCetakPenilaianAwalMedisRanap.jasper",
                            ...
                            + "penilaian_medis_ranap_kritis.keadaan,penilaian_medis_ranap_kritis.gcs,penilaian_medis_ranap_kritis.kesadaran,penilaian_medis_ranap_kritis.td,penilaian_medis_ranap_kritis.nadi,penilaian_medis_ranap_kritis.rr,penilaian_medis_ranap_kritis.suhu,penilaian_medis_ranap_kritis.spo,penilaian_medis_ranap_kritis.bb,penilaian_medis_ranap_kritis.tb,"
                            + "penilaian_medis_ranap_kritis.kepala,penilaian_medis_ranap_kritis.mata,penilaian_medis_ranap_kritis.gigi,penilaian_medis_ranap_kritis.tht,penilaian_medis_ranap_kritis.thoraks,penilaian_medis_ranap_kritis.jantung,penilaian_medis_ranap_kritis.paru,penilaian_medis_ranap_kritis.abdomen,penilaian_medis_ranap_kritis.ekstremitas,"
                            + "penilaian_medis_ranap_kritis.genital,penilaian_medis_ranap_kritis.kulit,penilaian_medis_ranap_kritis.ket_kepala,penilaian_medis_ranap_kritis.ket_mata,penilaian_medis_ranap_kritis.ket_gigi,penilaian_medis_ranap_kritis.ket_tht,penilaian_medis_ranap_kritis.ket_thoraks,penilaian_medis_ranap_kritis.ket_jantung,penilaian_medis_ranap_kritis.ket_paru,"
                            + "penilaian_medis_ranap_kritis.ket_abdomen,penilaian_medis_ranap_kritis.ket_genital,penilaian_medis_ranap_kritis.ket_ekstremitas,penilaian_medis_ranap_kritis.ket_kulit,penilaian_medis_ranap_kritis.ket_lokalis,penilaian_medis_ranap_kritis.lab,penilaian_medis_ranap_kritis.rad,penilaian_medis_ranap_kritis.penunjang,penilaian_medis_ranap_kritis.diagnosis,penilaian_medis_ranap_kritis.tata,"
                            + "penilaian_medis_ranap_kritis.edukasi,dokter.nm_dokter "
                            + "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                            + "inner join penilaian_medis_ranap_kritis on reg_periksa.no_rawat=penilaian_medis_ranap_kritis.no_rawat "
                            + "inner join dokter on penilaian_medis_ranap_kritis.kd_dokter=dokter.kd_dokter where penilaian_medis_ranap_kritis.no_rawat='" + tbObat.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRanapKritis dialog = new RMPenilaianAwalMedisRanapKritis(new javax.swing.JFrame(),
                    true);
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_medis_ranap_kritis where no_rawat=? and kd_dokter=?", 2,
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_ranap_kritis", "no_rawat=? and kd_dokter=?",
                "no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpk=?,rpd=?,rpo=?,alergi=?,keadaan=?,gcs=?,kesadaran=?,td=?,nadi=?,rr=?,suhu=?,"
                + "spo=?,bb=?,tb=?,kepala=?,mata=?,gigi=?,tht=?,thoraks=?,jantung=?,paru=?,abdomen=?,genital=?,ekstremitas=?,kulit=?,keterangan=?,ket_lokalis=?,lab=?,rad=?,penunjang=?,diagnosis=?,tata=?,edukasi=?",
                42,
                new String[]{TNoRw.getText(),
                    ...
                    Keterangan.getText(), KetLokalis.getText(),
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    Keterangan.setText(rs.getString("ket_kepala"));
                }
            } catch (SQLException e) {
                System.out.println("Notif : " + e);
            } finally {
    ...
    private static final Logger LOG = Logger.getLogger(RMPenilaianAwalMedisRanapKritis.class.getName());
