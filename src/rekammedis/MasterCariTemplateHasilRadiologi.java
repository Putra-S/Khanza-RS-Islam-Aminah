 ...
 * @author dosen
 */
public class MasterCariTemplateHasilRadiologi extends javax.swing.JDialog {
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        ...
        MasterTemplateHasilRadiologi form = new MasterTemplateHasilRadiologi(
                null, false);
            ...
            try {
                if (tbKamar.getSelectedRow() != -1) {
                    Template.setText(tabMode.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString());
                }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterCariTemplateHasilRadiologi dialog = new MasterCariTemplateHasilRadiologi(new javax.swing.JFrame(),
                    true);
    ...
    private static final Logger LOG = Logger.getLogger(MasterCariTemplateHasilRadiologi.class.getName());
