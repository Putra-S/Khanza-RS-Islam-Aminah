...
public class RMTransferPasienAntarRuang extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (ProsedurDilakukan.getText().trim().isEmpty()) {
            Valid.textKosong(ProsedurDilakukan, "Prosedur Dilakukan");
        } else if (ObatYangDiberikan.getText().trim().isEmpty()) {
            Valid.textKosong(ObatYangDiberikan, "Obat Yang Diberikan");
        } else if (TDSebelumTransfer.getText().trim().isEmpty()) {
            Valid.textKosong(TDSebelumTransfer, "TD Sebelum Transfer");
        } else if (NadiSebelumTransfer.getText().trim().isEmpty()) {
            Valid.textKosong(NadiSebelumTransfer, "Nadi Sebelum Transfer");
        } else if (RRSebelumTransfer.getText().trim().isEmpty()) {
            Valid.textKosong(RRSebelumTransfer, "RR Sebelum Transfer");
        } else if (SuhuSebelumTransfer.getText().trim().isEmpty()) {
            Valid.textKosong(SuhuSebelumTransfer, "Suhu Sebelum Transfer");
        } else if (KeluhanUtamaSebelumTransfer.getText().trim().isEmpty()) {
            Valid.textKosong(KeluhanUtamaSebelumTransfer,
                    "Keluhan Utama Sebelum Transfer");
        } else if (TDSetelahTransfer.getText().trim().isEmpty()) {
            Valid.textKosong(TDSetelahTransfer, "TD Setelah Transfer");
        } else if (NadiSetelahTransfer.getText().trim().isEmpty()) {
            Valid.textKosong(NadiSetelahTransfer, "Nadi Setelah Transfer");
        } else if (RRSetelahTransfer.getText().trim().isEmpty()) {
            Valid.textKosong(RRSetelahTransfer, "RR Setelah Transfer");
        } else if (SuhuSetelahTransfer.getText().trim().isEmpty()) {
            Valid.textKosong(SuhuSetelahTransfer, "Suhu Setelah Transfer");
        } else if (KeluhanUtamaSetelahTransfer.getText().trim().isEmpty()) {
            Valid.textKosong(KeluhanUtamaSetelahTransfer,
                    "Keluhan Utama Setelah Transfer");
        } else {
            if (akses.getkode().equals("Admin Utama")) {
                simpan();
            } else {
                if (akses.getkode().equals(KdPetugasMenerima.getText()) || akses.
                        getkode().equals(KdPetugasMenyerahkan.getText())) {
                    simpan();
                } else {
                    ...
                    while (rs.next()) {
                        htmlContent.append("<tr class='isi'><td valign='top'>").
                                ...
                                "</td><td valign='top'>").append(rs.getString(
                                        ...
                                        getString("jk")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "tanggal_masuk")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString("tanggal_pindah")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "indikasi_pindah_ruang")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString(
                                                "keterangan_indikasi_pindah_ruang")).
                                append("</td><td valign='top'>").append(rs.
                                getString("asal_ruang")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "ruang_selanjutnya")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString("metode_pemindahan_pasien")).
                                append("</td><td valign='top'>").append(rs.
                                getString("diagnosa_utama")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "diagnosa_sekunder")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString(
                                                "prosedur_yang_sudah_dilakukan")).
                                append("</td><td valign='top'>").append(rs.
                                getString("obat_yang_telah_diberikan")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "pemeriksaan_penunjang_yang_dilakukan")).
                                append("</td><td valign='top'>").append(rs.
                                getString("peralatan_yang_menyertai")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "keterangan_peralatan_yang_menyertai")).
                                append("</td><td valign='top'>").append(rs.
                                getString("pasien_keluarga_menyetujui")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "nama_menyetujui")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString("hubungan_menyetujui")).
                                append("</td><td valign='top'>").append(rs.
                                getString("keadaan_umum_sebelum_transfer")).
                                append("</td><td valign='top'>").append(rs.
                                getString("td_sebelum_transfer")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "nadi_sebelum_transfer")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString("rr_sebelum_transfer")).
                                append("</td><td valign='top'>").append(rs.
                                getString("suhu_sebelum_transfer")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "keluhan_utama_sebelum_transfer")).
                                append("</td><td valign='top'>").append(rs.
                                getString("keadaan_umum_sesudah_transfer")).
                                append("</td><td valign='top'>").append(rs.
                                getString("td_sesudah_transfer")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "nadi_sesudah_transfer")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString("rr_sesudah_transfer")).
                                append("</td><td valign='top'>").append(rs.
                                getString("suhu_sesudah_transfer")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "keluhan_utama_sesudah_transfer")).
                                append("</td><td valign='top'>").append(rs.
                                getString("nip_menyerahkan")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "petugasmenyerahkan")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString("nip_menerima")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "petugasmenerima")).append("</td></tr>");
                    }
                    LoadHTML.setText(
                            "<html>"
    ...
    private void btnAmbilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbObat.getSelectedRow() > -1) {
                ...
                Sequel.queryu(
                        "insert into antripersetujuantransferantarruang values('" + tbObat.
                                getValueAt(tbObat.getSelectedRow(), 0).
                                toString() + "','" + tbObat.getValueAt(tbObat.
                                getSelectedRow(), 5).toString() + "')");
                Sequel.queryu(
                        "delete from bukti_persetujuan_transfer_pasien_antar_ruang where no_rawat='" + tbObat.
                                getValueAt(tbObat.getSelectedRow(), 0).
                                toString() + "' and tanggal_masuk='" + tbObat.
