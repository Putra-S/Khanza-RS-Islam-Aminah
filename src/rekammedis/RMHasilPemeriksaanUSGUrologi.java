 ...
 * @author perpustakaan
 */
public class RMHasilPemeriksaanUSGUrologi extends javax.swing.JDialog {
    ...
    public RMHasilPemeriksaanUSGUrologi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Ginjal Kanan", "Ginjal Kiri", "Vesica Urinaria", "Tambahan"
        }) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (GinjalKanan.getText().trim().isEmpty()) {
            Valid.textKosong(GinjalKanan, "Ginjal Kanan");
        } else if (GinjalKiri.getText().trim().isEmpty()) {
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry("rptCetakHasilPemeriksaanUSGUrologi.jasper",
                    ...
                    + "inner join dokter on hasil_pemeriksaan_usg_urologi.kd_dokter=dokter.kd_dokter where hasil_pemeriksaan_usg_urologi.no_rawat='" + tbObat.
    ...
    private void btnAmbilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbObat.getSelectedRow() > -1) {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                Valid.panggilUrl(
                        "hasilpemeriksaanusgurologi/login.php?act=login&usere=" + koneksiDB.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMHasilPemeriksaanUSGUrologi dialog = new RMHasilPemeriksaanUSGUrologi(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        "diagnosa_klinis"), rs.getString("ginjal_kanan"), rs.
                        getString("ginjal_kiri"), rs.
                        getString("vesica_urinaria"), rs.getString("tambahan")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            GinjalKanan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 9).
                    toString());
            GinjalKiri.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 10).
                    toString());
            Vesica.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 11).
                    toString());
            Tambahan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 12).
                    toString());
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from hasil_pemeriksaan_usg_urologi where no_rawat=?", 1,
                new String[]{
                    tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
                }) == true) {
    ...
    private void ganti() {
        if (Sequel.mengedittf("hasil_pemeriksaan_usg_urologi", "no_rawat=?",
                "no_rawat=?,tanggal=?,kd_dokter=?,diagnosa_klinis=?,kiriman_dari=?,ginjal_kanan=?,ginjal_kiri=?,vesica_urinaria=?,tambahan=?",
                10, new String[]{
                    ...
                    GinjalKanan.getText(), GinjalKiri.getText(), Vesica.
                    getText(), Tambahan.getText(), tbObat.getValueAt(tbObat.
    ...
    private void panggilPhoto() {
        if (FormPhoto.isVisible() == true) {
            try {
                ps = koneksi.prepareStatement(
                        "select hasil_pemeriksaan_usg_urologi_gambar.photo from hasil_pemeriksaan_usg_urologi_gambar where hasil_pemeriksaan_usg_urologi_gambar.no_rawat=?");
                try {
                        ...
                        if (rs.getString("photo").isEmpty() || rs.getString(
                            ...
                            LoadHTML2.setText(
                                    "<html><body><center><a href='http://" + koneksiDB.
                                            ...
                                            PORTWEB() + "/" + koneksiDB.
                                            HYBRIDWEB() + "/hasilpemeriksaanusgurologi/" + rs.
    ...
    private void simpan() {
        if (Sequel.menyimpantf("hasil_pemeriksaan_usg_urologi",
            ...
            tabMode.addRow(new String[]{
                ...
                getSelectedItem().toString().substring(11, 19),
                KirimanDari.getText(), DiagnosaKlinis.getText(), GinjalKanan.
                getText(), GinjalKiri.getText(), Vesica.getText(), Tambahan.
                getText()
            });
            emptTeks();
            LCount.setText("" + tabMode.getRowCount());
    ...
    private static final Logger LOG = Logger.getLogger(
            RMHasilPemeriksaanUSGUrologi.class.getName());
}
