...
public class RMHasilEndoskopiHidung extends javax.swing.JDialog {
    ...
    public RMHasilEndoskopiHidung(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "Kode Dokter", "Nama Dokter", "Tanggal",
                    "Kiriman Dari", "Diagnosa Klinis", "Hidung Kanan", "Hidung Kiri", "Kavum Nasi Kanan",
                    "Kavum Nasi Kiri", "Konka Inferior Kanan", "Konka Inferior Kiri", "Meatus Medius Kanan",
                    "Meatus Medius Kiri", "Septum Kanan", "Septum Kiri", "Nasofaring Kanan", "Nasofaring Kiri",
                    "Lain-lain Kanan", "Lain-lain Kiri", "Kesimpulan"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("diagnosa_klinis"), rs.getString("kondisi_hidung_kanan"),
                        rs.getString("kondisi_hidung_kiri"), rs.getString("kavum_nasi_kanan"),
                        rs.getString("kavum_nasi_kiri"), rs.getString("konka_inferior_kanan"),
                        rs.getString("konka_inferior_kiri"), rs.getString("meatus_medius_kanan"),
                        rs.getString("meatus_medius_kiri"), rs.getString("septum_kanan"),
                        rs.getString("septum_kiri"), rs.getString("nasofaring_kanan"),
                        rs.getString("nasofaring_kiri"), rs.getString("lainlain_kanan"),
                        rs.getString("lainlain_kiri"), rs.getString("kesimpulan")});
                }
            } catch (Exception e) {
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from hasil_endoskopi_hidung where no_rawat=?", 1,
    ...
    private void ganti() {
        if (Sequel.mengedittf("hasil_endoskopi_hidung", "no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    HidungKanan.getSelectedItem().toString(), HidungKiri.getSelectedItem().toString(),
                    KavumNasiKanan.getSelectedItem().toString(), KavumNasiKiri.getSelectedItem().toString(),
                    KonkaInferiorKanan.getSelectedItem().toString(), KonkaInferiorKiri.getSelectedItem().toString(),
                    MeatusMediusKanan.getSelectedItem().toString(), MeatusMediusKiri.getSelectedItem().toString(),
                    SeptumKanan.getSelectedItem().toString(), SeptumKiri.getSelectedItem().toString(),
                    NasofaringKanan.getSelectedItem().toString(), NasofaringKiri.getSelectedItem().toString(),
                    LainlainKanan.getText(), LainlainKiri.getText(), Kesimpulan.getText(),
                    ...
                    if (rs.next()) {
                        if (rs.getString("photo").isEmpty() || rs.getString("photo").equals("-")) {
                            ...
                            LoadHTML2.setText("<html><body><center><a href='http://" + koneksiDB.HOSTHYBRIDWEB() + ":"
                                    ...
                                    + "/hasilpemeriksaanendoskopihidung/" + rs.getString("photo")
                                    + "'><img src='http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB()
                                    + "/" + koneksiDB.HYBRIDWEB() + "/hasilpemeriksaanendoskopihidung/"
                                    + rs.getString("photo")
    ...
    private void simpan() {
        if (Sequel.menyimpantf("hasil_endoskopi_hidung", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 20,
                new String[]{TNoRw.getText(),
                    Valid.SetTgl(Tanggal.getSelectedItem() + "") + " "
                    + Tanggal.getSelectedItem().toString().substring(11, 19),
                    KdDokter.getText(), DiagnosaKlinis.getText(), KirimanDari.getText(),
                    ...
                    SeptumKanan.getSelectedItem().toString(), SeptumKiri.getSelectedItem().toString(),
                    NasofaringKanan.getSelectedItem().toString(), NasofaringKiri.getSelectedItem().toString(),
                    LainlainKanan.getText(), LainlainKiri.getText(), Kesimpulan.getText()}) == true) {
            tabMode.addRow(new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), TglLahir.getText(),
                KdDokter.getText(), NmDokter.getText(),
                Valid.SetTgl(Tanggal.getSelectedItem() + "") + " "
                + Tanggal.getSelectedItem().toString().substring(11, 19),
                KirimanDari.getText(), DiagnosaKlinis.getText(), HidungKanan.getSelectedItem().toString(),
                HidungKiri.getSelectedItem().toString(), KavumNasiKanan.getSelectedItem().toString(),
                KavumNasiKiri.getSelectedItem().toString(), KonkaInferiorKanan.getSelectedItem().toString(),
                KonkaInferiorKiri.getSelectedItem().toString(), MeatusMediusKanan.getSelectedItem().toString(),
                MeatusMediusKiri.getSelectedItem().toString(), SeptumKanan.getSelectedItem().toString(),
                SeptumKiri.getSelectedItem().toString(), NasofaringKanan.getSelectedItem().toString(),
                NasofaringKiri.getSelectedItem().toString(), LainlainKanan.getText(), LainlainKiri.getText(),
                Kesimpulan.getText()});
            emptTeks();
            LCount.setText("" + tabMode.getRowCount());
        }
    ...
    private static final Logger LOG = Logger.getLogger(RMHasilEndoskopiHidung.class.getName());
