...
public class RMHasilEndoskopiHidung extends javax.swing.JDialog {
    ...
    public RMHasilEndoskopiHidung(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Hidung Kanan",
            "Hidung Kiri", "Kavum Nasi Kanan", "Kavum Nasi Kiri",
            "Konka Inferior Kanan", "Konka Inferior Kiri", "Meatus Medius Kanan",
            "Meatus Medius Kiri", "Septum Kanan", "Septum Kiri",
            "Nasofaring Kanan", "Nasofaring Kiri", "Lain-lain Kanan",
            "Lain-lain Kiri", "Kesimpulan"
        }) {
            @Override
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry("rptCetakHasilEndoskipoHidung.jasper", "report",
                    "::[ Formulir Hasil Pemeriksaan Tele Endoskopi Hidung ]::",
                    ...
                    + "inner join dokter on hasil_endoskopi_hidung.kd_dokter=dokter.kd_dokter where hasil_endoskopi_hidung.no_rawat='" + tbObat.
    ...
    private void btnAmbilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbObat.getSelectedRow() > -1) {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                Valid.panggilUrl(
                        "hasilpemeriksaanendoskopihidung/login.php?act=login&usere=" + koneksiDB.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMHasilEndoskopiHidung dialog = new RMHasilEndoskopiHidung(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        "diagnosa_klinis"), rs.getString("kondisi_hidung_kanan"),
                        rs.getString("kondisi_hidung_kiri"), rs.getString(
                        "kavum_nasi_kanan"), rs.getString("kavum_nasi_kiri"),
                        rs.getString("konka_inferior_kanan"), rs.getString(
                        "konka_inferior_kiri"), rs.getString(
                        "meatus_medius_kanan"), rs.getString(
                        "meatus_medius_kiri"), rs.getString("septum_kanan"), rs.
                        getString("septum_kiri"),
                        rs.getString("nasofaring_kanan"), rs.getString(
                        "nasofaring_kiri"), rs.getString("lainlain_kanan"), rs.
                        getString("lainlain_kiri"), rs.getString("kesimpulan")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            HidungKanan.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 9).toString());
            HidungKiri.setSelectedItem(tbObat.
                    getValueAt(tbObat.getSelectedRow(), 10).toString());
            KavumNasiKanan.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 11).toString());
            KavumNasiKiri.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 12).toString());
            KonkaInferiorKanan.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 13).toString());
            KonkaInferiorKiri.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 14).toString());
            MeatusMediusKanan.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 15).toString());
            MeatusMediusKiri.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 16).toString());
            SeptumKanan.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 17).toString());
            SeptumKiri.setSelectedItem(tbObat.
                    getValueAt(tbObat.getSelectedRow(), 18).toString());
            NasofaringKanan.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 19).toString());
            NasofaringKiri.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 20).toString());
            LainlainKanan.setText(
                    tbObat.getValueAt(tbObat.getSelectedRow(), 21).toString());
            LainlainKiri.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 22).
                    toString());
            Kesimpulan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 23).
                    toString());
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from hasil_endoskopi_hidung where no_rawat=?", 1,
                new String[]{
                    tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
                }) == true) {
    ...
    private void ganti() {
        if (Sequel.mengedittf("hasil_endoskopi_hidung", "no_rawat=?",
                "no_rawat=?,tanggal=?,kd_dokter=?,diagnosa_klinis=?,kiriman_dari=?,kondisi_hidung_kanan=?,kondisi_hidung_kiri=?,"
                ...
                + "nasofaring_kiri=?,lainlain_kanan=?,lainlain_kiri=?,kesimpulan=?",
                21, new String[]{
                    TNoRw.getText(), Valid.
                    ...
                    HidungKanan.getSelectedItem().toString(), HidungKiri.
                    getSelectedItem().toString(),
                    KavumNasiKanan.getSelectedItem().toString(), KavumNasiKiri.
                    getSelectedItem().toString(), KonkaInferiorKanan.
                            getSelectedItem().toString(),
                    KonkaInferiorKiri.getSelectedItem().toString(),
                    MeatusMediusKanan.getSelectedItem().toString(),
                    MeatusMediusKiri.getSelectedItem().toString(),
                    SeptumKanan.getSelectedItem().toString(), SeptumKiri.
                    getSelectedItem().toString(), NasofaringKanan.
                            getSelectedItem().toString(),
                    NasofaringKiri.getSelectedItem().toString(), LainlainKanan.
                    getText(), LainlainKiri.getText(), Kesimpulan.getText(),
                    tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
                }) == true) {
            ...
            tbObat.setValueAt(DiagnosaKlinis.getText(), tbObat.getSelectedRow(),
                    8);
            tbObat.setValueAt(HidungKanan.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 9);
            tbObat.setValueAt(HidungKiri.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 10);
            tbObat.setValueAt(KavumNasiKanan.getSelectedItem().toString(),
                    tbObat.getSelectedRow(), 11);
            tbObat.setValueAt(KavumNasiKiri.getSelectedItem().toString(),
                    tbObat.getSelectedRow(), 12);
            tbObat.setValueAt(KonkaInferiorKanan.getSelectedItem().toString(),
                    tbObat.getSelectedRow(), 13);
            tbObat.setValueAt(KonkaInferiorKiri.getSelectedItem().toString(),
                    tbObat.getSelectedRow(), 14);
            tbObat.setValueAt(MeatusMediusKanan.getSelectedItem().toString(),
                    tbObat.getSelectedRow(), 15);
            tbObat.setValueAt(MeatusMediusKiri.getSelectedItem().toString(),
                    tbObat.getSelectedRow(), 16);
            tbObat.setValueAt(SeptumKanan.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 17);
            tbObat.setValueAt(SeptumKiri.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 18);
            tbObat.setValueAt(NasofaringKanan.getSelectedItem().toString(),
                    tbObat.getSelectedRow(), 19);
            tbObat.setValueAt(NasofaringKiri.getSelectedItem().toString(),
    ...
    private void panggilPhoto() {
        if (FormPhoto.isVisible() == true) {
            try {
                ps = koneksi.prepareStatement(
                        "select hasil_endoskopi_hidung_gambar.photo from hasil_endoskopi_hidung_gambar where hasil_endoskopi_hidung_gambar.no_rawat=?");
                try {
                        ...
                        if (rs.getString("photo").isEmpty() || rs.getString(
                            ...
                            LoadHTML2.setText(
                                    "<html><body><center><a href='http://" + koneksiDB.
                                            ...
                                            PORTWEB() + "/" + koneksiDB.
                                            HYBRIDWEB() + "/hasilpemeriksaanendoskopihidung/" + rs.
    ...
    private void simpan() {
        if (Sequel.menyimpantf("hasil_endoskopi_hidung",
                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 20,
                new String[]{
                    TNoRw.getText(), Valid.
                    SetTgl(Tanggal.getSelectedItem() + "") + " " + Tanggal.
            ...
            tabMode.addRow(new String[]{
                ...
                KirimanDari.getText(), DiagnosaKlinis.getText(), HidungKanan.
                getSelectedItem().toString(), HidungKiri.getSelectedItem().
                toString(),
                KavumNasiKanan.getSelectedItem().toString(), KavumNasiKiri.
                getSelectedItem().toString(), KonkaInferiorKanan.
                getSelectedItem().toString(),
                ...
                MeatusMediusKiri.getSelectedItem().toString(),
                SeptumKanan.getSelectedItem().toString(), SeptumKiri.
                getSelectedItem().toString(), NasofaringKanan.getSelectedItem().
                toString(),
                NasofaringKiri.getSelectedItem().toString(), LainlainKanan.
                getText(), LainlainKiri.getText(), Kesimpulan.getText()
            });
    ...
    private static final Logger LOG = Logger.getLogger(
            RMHasilEndoskopiHidung.class.getName());
}
