...
public class RMCariKeluhan extends javax.swing.JDialog {
    ...
    public RMCariKeluhan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"P", "Tanggal", "Jam", "Keluhan"}) {
...
//GEN-LAST:event_ppSemuaActionPerformed
  ...
  // End of variables declaration//GEN-END:variables
    ...
    public void tampil() {
        ...
        for (i = 0; i < jml; i++) {
            tabMode.addRow(new Object[]{pilih[i], tanggal[i], jam[i], keluhan[i]});
        }
        Valid.tabelKosong(tabMode);
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(
                            new Object[]{false, rs.getString(1), rs.getString(2), rs.getString(3).replace("ᵒ", "")});
                }
            } catch (Exception ex) {
    ...
    private static final Logger LOG = Logger.getLogger(RMCariKeluhan.class.getName());
