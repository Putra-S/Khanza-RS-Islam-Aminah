 ...
 * @author dosen
 */
public class MasterMasalahKeperawatanKebidanan extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public MasterMasalahKeperawatanKebidanan(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row = {"Kode", "Masalah Kebidanan"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Master Masalah Keperawatan Kebidanan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("master_masalah_keperawatan_kebidanan",
                    "'" + TKd.getText() + "','" + TNm.getText() + "'", "Kode") == true) {
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, TKd,
                "master_masalah_keperawatan_kebidanan", "kode_masalah") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                if (Sequel.mengedittf("master_masalah_keperawatan_kebidanan",
                        "kode_masalah=?", "kode_masalah=?,nama_masalah=?", 3,
                        new String[]{
                            TKd.getText(), TNm.getText(), tbSpesialis.
                            getValueAt(tbSpesialis.getSelectedRow(), 0).
                            toString()
                        }) == true) {
                    tbSpesialis.setValueAt(TKd.getText(), tbSpesialis.
                            getSelectedRow(), 0);
                    tbSpesialis.setValueAt(TNm.getText(), tbSpesialis.
                            getSelectedRow(), 1);
                    emptTeks();
                }
            }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterMasalahKeperawatanKebidanan dialog = new MasterMasalahKeperawatanKebidanan(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from master_masalah_keperawatan_kebidanan where master_masalah_keperawatan_kebidanan.kode_masalah like ? or master_masalah_keperawatan_kebidanan.nama_masalah like ? order by master_masalah_keperawatan_kebidanan.kode_masalah");
            try {
    ...
    private void getData() {
        if (tbSpesialis.getSelectedRow() != -1) {
            TKd.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(), 0).
                    toString());
            TNm.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(), 1).
                    toString());
        }
    }
    ...
    private static final Logger LOG = Logger.getLogger(
            MasterMasalahKeperawatanKebidanan.class.getName());
}
