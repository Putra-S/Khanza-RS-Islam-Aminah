 ...
 * @author perpustakaan
 */
public class RMPenilaianAwalKeperawatanKebidananIGD extends javax.swing.JDialog {

    private final DefaultTableModel tabMode, tabModeRiwayatKehamilan, tabModeRiwayatKehamilan2, tabModeMasalah,
            tabModeDetailMasalah, tabModeRencana, tabModeDetailRencana;
     ...
     * @param modal
     */
    public RMPenilaianAwalKeperawatanKebidananIGD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        DlgRiwayatPersalinan.setSize(650, 192);

        tabMode = new DefaultTableModel(null, new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "J.K.", "Agama",
            "Bahasa", "Cacat Fisik", "Tgl.Lahir", "Tgl.Asuhan", "Informasi", "TD", "Nadi", "RR", "Suhu", "GCS",
            "BB", "TB", "LILA", "BMI", "TFU", "TBJ", "Letak", "Presentasi", "Penurunan", "Kontraksi/HIS",
            "Kekuatan", "Lamanya", "DJJ", "Keterangan DJJ", "Portio", "Pembukaan Serviks", "Ketuban", "Hodge",
            "Inspekulo", "Hasil Inspekulo", "CTG", "Hasil CTG", "USG", "Hasil USG", "Laboratorium",
            "Hasil Laboratorium", "Lakmus", "Hasil Lakmus", "Pemeriksaan Panggul", "Keluhan Utama", "Alergi",
            "Menarche", "Lamanya", "Banyaknya", "Haid Terakhir", "Siklus", "Ket.Siklus", "Masalah Menstruasi",
            "Stts.Menikah", "Kali", "Usia Kw 1", "Stts.Kawin 1", "Usia Kw 2", "Stts.Kawin 2", "Usia Kw 3",
            "Stts.Kawin 3", "HPHT", "Usia Hamil", "TP", "Imunisasi", "Jml.Imun", "G", "P", "A", "Hidup",
            "Riwayat Ginekologi", "Obat/Vitamin", "Obat/Vitamin Diminum", "Merokok", "Jml.Rokok", "Alkohol",
            "Jml.Alkohol", "Obat Tidur", "Riwayat KB", "Lama KB", "Komplikasi KB", "Ket.Komplikasi KB",
            "Berhenti KB", "Alasan Berhenti KB", "Alat Bantu", "Ket.Alat Bantu", "Prothesa", "Keterangan Prothesa",
            "ADL", "Stts.Psikologi", "Ket.Stts Psikologi", "Hubungan Keluarga", "Tinggal Dengan",
            "Keterangan Tinggal", "Ekonomi", "Budaya", "Keterangan Budaya", "Edukasi", "Keterangan Edukasi",
            "Agama", "Wajib", "Halangan Lain", "Toharah", "Sholat", "Motivasi Kesembuhan & Ibadah", "R.J.a.1",
            "R.J.a.2", "R.J.b", "Hasil Penilaian Resiko Jatuh", "Dilaporkan", "Jam Lapor", "Skrining Gizi 1", "N1",
            "Skrining Gizi 2", "N2", "Total Skor", "Kondisi Nyeri", "Penyebab Nyeri", "Ket.Peny Nyeri", "Kualitas",
            "Ket.Kualitas", "Lokasi", "Menyebar", "Skala", "Durasi", "Nyeri Hilang", "Ket.Nyeri Hilang",
            "Diberitahukan", "Jam Diberitahukan", "Masalah Kebidanan Lainnya", "Rencana Kebidanan Lainnya", "NIP",
            "Nama Petugas/Bidan"}) {
            @Override
        ...
        tabModeMasalah = new DefaultTableModel(null, new Object[]{"P", "KODE", "MASALAH KEBIDANAN"}) {
        ...
        tabModeRencana = new DefaultTableModel(null, new Object[]{"P", "KODE", "RENCANA KEBIDANAN"}) {
            Class[] types = new Class[]{java.lang.Boolean.class, java.lang.Object.class, java.lang.Object.class,
                java.lang.Double.class};
        ...
        tabModeDetailMasalah = new DefaultTableModel(null, new Object[]{"Kode", "Masalah Kebidanan"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
            }
        ...
        tabModeDetailRencana = new DefaultTableModel(null, new Object[]{"Kode", "Rencana Kebidanan"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
            }
    ...
    private void initComponents() {
        ...
        TanggalPersalinan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-06-2024" }));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Keperawatan IGD Kebidanan & Kandungan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(954, 1879));
        ...
        jLabel27.setBounds(240, 470, 40, 23);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-06-2024 10:52:41" }));
        ...
        jLabel66.setBounds(0, 530, 149, 23);

        jLabel67.setText("Umur Menarche :");
        jLabel67.setName("jLabel67"); // NOI18N
        FormInput.add(jLabel67);
        jLabel67.setBounds(0, 470, 170, 23);
        ...
        jLabel69.setBounds(390, 500, 28, 23);
        ...
        FormInput.add(Lama);
        Lama.setBounds(330, 470, 60, 23);

        jLabel70.setText("(");
        jLabel70.setName("jLabel70"); // NOI18N
        FormInput.add(jLabel70);
        jLabel70.setBounds(250, 500, 20, 23);

        jLabel71.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel71.setText("tahun,");
        jLabel71.setName("jLabel71"); // NOI18N
        FormInput.add(jLabel71);
        jLabel71.setBounds(650, 550, 45, 23);
        ...
        Banyaknya.setBounds(480, 470, 60, 23);

        jLabel72.setText("Masalah yang dirasakan saat menstruasi :");
        jLabel72.setName("jLabel72"); // NOI18N
        FormInput.add(jLabel72);
        jLabel72.setBounds(420, 500, 260, 23);
        ...
        HaidTerakhir.setBounds(680, 470, 175, 23);

        jLabel73.setText("Haid Terakhir :");
        jLabel73.setName("jLabel73"); // NOI18N
        FormInput.add(jLabel73);
        jLabel73.setBounds(590, 470, 90, 23);

        jLabel74.setText("Siklus :");
        jLabel74.setName("jLabel74"); // NOI18N
        FormInput.add(jLabel74);
        jLabel74.setBounds(0, 500, 170, 23);
        ...
        Siklus.setBounds(170, 500, 60, 23);

        jLabel75.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel75.setText("hari,");
        jLabel75.setName("jLabel75"); // NOI18N
        FormInput.add(jLabel75);
        jLabel75.setBounds(240, 500, 30, 23);
        ...
        KetSiklus.setBounds(270, 500, 120, 23);

        jLabel76.setText("Riwayat Menstruasi :");
        jLabel76.setName("jLabel76"); // NOI18N
        FormInput.add(jLabel76);
        jLabel76.setBounds(0, 450, 146, 23);

        jLabel78.setText("banyaknya :");
        jLabel78.setName("jLabel78"); // NOI18N
        FormInput.add(jLabel78);
        jLabel78.setBounds(410, 470, 66, 23);

        jLabel79.setText("lamanya :");
        jLabel79.setName("jLabel79"); // NOI18N
        FormInput.add(jLabel79);
        jLabel79.setBounds(270, 470, 55, 23);

        jLabel80.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel80.setText("hari,");
        jLabel80.setName("jLabel80"); // NOI18N
        FormInput.add(jLabel80);
        jLabel80.setBounds(390, 470, 30, 23);
        ...
        StatusMenikah.setBounds(170, 550, 175, 23);

        jLabel77.setText("Status Menikah :");
        jLabel77.setName("jLabel77"); // NOI18N
        FormInput.add(jLabel77);
        jLabel77.setBounds(0, 550, 170, 23);

        jLabel81.setText("Status :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(680, 550, 50, 23);
        ...
        UsiaKawin1.setBounds(590, 550, 60, 23);

        jLabel82.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel82.setText("pembalut");
        jLabel82.setName("jLabel82"); // NOI18N
        FormInput.add(jLabel82);
        jLabel82.setBounds(540, 470, 50, 23);
        ...
        KetSiklus2.setBounds(680, 500, 175, 23);

        jLabel83.setText("Usia Perkawinan Ke 1 :");
        jLabel83.setName("jLabel83"); // NOI18N
        FormInput.add(jLabel83);
        jLabel83.setBounds(460, 550, 130, 23);

        jLabel84.setText("Usia Perkawinan Ke 3 :");
        jLabel84.setName("jLabel84"); // NOI18N
        FormInput.add(jLabel84);
        jLabel84.setBounds(460, 580, 130, 23);
        ...
        UsiaKawin3.setBounds(590, 580, 60, 23);

        jLabel85.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel85.setText("tahun,");
        jLabel85.setName("jLabel85"); // NOI18N
        FormInput.add(jLabel85);
        jLabel85.setBounds(650, 580, 45, 23);

        jLabel86.setText("Status :");
        jLabel86.setName("jLabel86"); // NOI18N
        FormInput.add(jLabel86);
        jLabel86.setBounds(680, 580, 50, 23);
        ...
        StatusKawin3.setBounds(730, 580, 125, 23);

        jLabel87.setText("Usia Perkawinan 2 :");
        jLabel87.setName("jLabel87"); // NOI18N
        FormInput.add(jLabel87);
        jLabel87.setBounds(0, 580, 170, 23);
        ...
        UsiaKawin2.setBounds(170, 580, 60, 23);
        ...
        StatusKawin2.setBounds(310, 580, 125, 23);

        jLabel88.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel88.setText("tahun,");
        jLabel88.setName("jLabel88"); // NOI18N
        FormInput.add(jLabel88);
        jLabel88.setBounds(240, 580, 50, 23);

        jLabel89.setText("Status :");
        jLabel89.setName("jLabel89"); // NOI18N
        FormInput.add(jLabel89);
        jLabel89.setBounds(260, 580, 50, 23);
        ...
        KaliMenikah.setBounds(350, 550, 60, 23);

        jLabel90.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel90.setText("kali");
        jLabel90.setName("jLabel90"); // NOI18N
        FormInput.add(jLabel90);
        jLabel90.setBounds(420, 550, 30, 23);

        jLabel91.setText("Riwayat Kehamilan Tetap :");
        jLabel91.setName("jLabel91"); // NOI18N
        FormInput.add(jLabel91);
        jLabel91.setBounds(0, 610, 175, 23);

        jLabel92.setText("HPHT :");
        jLabel92.setName("jLabel92"); // NOI18N
        FormInput.add(jLabel92);
        jLabel92.setBounds(0, 630, 170, 23);

        HPHT.setForeground(new java.awt.Color(50, 70, 50));
        HPHT.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-06-2024" }));
        ...
        FormInput.add(HPHT);
        HPHT.setBounds(170, 630, 90, 23);

        jLabel93.setText("Usia Hamil :");
        jLabel93.setName("jLabel93"); // NOI18N
        FormInput.add(jLabel93);
        jLabel93.setBounds(270, 630, 105, 23);
        ...
        UsiaKehamilan.setBounds(370, 630, 60, 23);

        jLabel95.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel95.setText("bln/mgg");
        jLabel95.setName("jLabel95"); // NOI18N
        FormInput.add(jLabel95);
        jLabel95.setBounds(440, 630, 60, 23);

        jLabel96.setText("TP :");
        jLabel96.setName("jLabel96"); // NOI18N
        FormInput.add(jLabel96);
        jLabel96.setBounds(510, 630, 40, 23);

        TP.setForeground(new java.awt.Color(50, 70, 50));
        TP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-06-2024" }));
        ...
        FormInput.add(TP);
        TP.setBounds(550, 630, 90, 23);

        jLabel97.setText("Riwayat Imunisasi :");
        jLabel97.setName("jLabel97"); // NOI18N
        FormInput.add(jLabel97);
        jLabel97.setBounds(660, 630, 110, 23);
        ...
        RiwayatImunisasi.setBounds(770, 630, 80, 23);

        jLabel98.setText("Imunisasi :");
        jLabel98.setName("jLabel98"); // NOI18N
        FormInput.add(jLabel98);
        jLabel98.setBounds(0, 660, 170, 23);
        ...
        JumlahImunisasi.setBounds(170, 660, 60, 23);

        jLabel101.setText("G :");
        jLabel101.setName("jLabel101"); // NOI18N
        FormInput.add(jLabel101);
        jLabel101.setBounds(330, 660, 40, 23);
        ...
        FormInput.add(G);
        G.setBounds(370, 660, 60, 23);

        jLabel100.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel100.setText("kali");
        jLabel100.setName("jLabel100"); // NOI18N
        FormInput.add(jLabel100);
        jLabel100.setBounds(240, 660, 50, 23);

        jLabel102.setText("P :");
        jLabel102.setName("jLabel102"); // NOI18N
        FormInput.add(jLabel102);
        jLabel102.setBounds(440, 660, 30, 23);
        ...
        FormInput.add(P);
        P.setBounds(480, 660, 60, 23);

        jLabel103.setText("A :");
        jLabel103.setName("jLabel103"); // NOI18N
        FormInput.add(jLabel103);
        jLabel103.setBounds(550, 660, 30, 23);
        ...
        FormInput.add(A);
        A.setBounds(580, 660, 60, 23);

        jLabel104.setText("Hidup :");
        jLabel104.setName("jLabel104"); // NOI18N
        FormInput.add(jLabel104);
        jLabel104.setBounds(660, 660, 110, 23);
        ...
        Scroll6.setBounds(170, 690, 680, 93);
        ...
        BtnTambahMasalah.setBounds(140, 690, 28, 23);
        ...
        BtnHapusRiwayatPersalinan.setBounds(140, 720, 28, 23);

        jLabel113.setText("Riwayat Ginekologi :");
        jLabel113.setName("jLabel113"); // NOI18N
        FormInput.add(jLabel113);
        jLabel113.setBounds(560, 820, 144, 23);
        ...
        RiwayatGenekologi.setBounds(710, 820, 145, 23);

        jLabel114.setText("Riwayat KB :");
        jLabel114.setName("jLabel114"); // NOI18N
        FormInput.add(jLabel114);
        jLabel114.setBounds(0, 790, 105, 23);
        ...
        RiwayatKB.setBounds(110, 790, 117, 23);

        jLabel115.setText("Lamanya :");
        jLabel115.setName("jLabel115"); // NOI18N
        FormInput.add(jLabel115);
        jLabel115.setBounds(240, 790, 60, 23);
        ...
        LamanyaKB.setBounds(300, 790, 60, 23);
        ...
        KomplikasiKB.setBounds(440, 790, 100, 23);

        jLabel116.setText("Komplikasi :");
        jLabel116.setName("jLabel116"); // NOI18N
        FormInput.add(jLabel116);
        jLabel116.setBounds(370, 790, 67, 23);
        ...
        KeteranganKomplikasiKB.setBounds(550, 790, 309, 23);

        jLabel117.setText("Kapan Berhenti KB :");
        jLabel117.setName("jLabel117"); // NOI18N
        FormInput.add(jLabel117);
        jLabel117.setBounds(60, 820, 110, 23);
        ...
        BerhentiKB.setBounds(170, 820, 60, 23);

        jLabel118.setText("Alasan :");
        jLabel118.setName("jLabel118"); // NOI18N
        FormInput.add(jLabel118);
        jLabel118.setBounds(240, 820, 60, 23);
        ...
        AlasanBerhentiKB.setBounds(300, 820, 242, 23);

        jLabel119.setText("Riwayat Kebiasaan :");
        jLabel119.setName("jLabel119"); // NOI18N
        FormInput.add(jLabel119);
        jLabel119.setBounds(0, 850, 143, 23);

        jLabel120.setText("Obat/Vitamin :");
        jLabel120.setName("jLabel120"); // NOI18N
        FormInput.add(jLabel120);
        jLabel120.setBounds(0, 870, 170, 23);
        ...
        KebiasaanObat.setBounds(170, 870, 185, 23);
        ...
        KebiasaanMerokok.setBounds(170, 900, 80, 23);
        ...
        KebiasaanAlkohol.setBounds(450, 900, 80, 23);
        ...
        KebiasaanJumlahAlkohol.setBounds(530, 900, 60, 23);

        jLabel124.setText("Alkohol :");
        jLabel124.setName("jLabel124"); // NOI18N
        FormInput.add(jLabel124);
        jLabel124.setBounds(380, 900, 65, 23);
        ...
        KebiasaanNarkoba.setBounds(770, 900, 80, 23);

        jLabel126.setText("Obat Tidur/Narkoba :");
        jLabel126.setName("jLabel126"); // NOI18N
        FormInput.add(jLabel126);
        jLabel126.setBounds(650, 900, 120, 23);
        ...
        AlatBantu.setBounds(120, 950, 90, 23);
        ...
        KetBantu.setBounds(220, 950, 220, 23);
        ...
        Prothesa.setBounds(540, 950, 90, 23);
        ...
        KetProthesa.setBounds(630, 950, 220, 23);

        jLabel128.setText("Alat Bantu :");
        jLabel128.setName("jLabel128"); // NOI18N
        FormInput.add(jLabel128);
        jLabel128.setBounds(0, 950, 120, 23);
        ...
        CacatFisik.setBounds(120, 980, 314, 23);
        ...
        jSeparator5.setBounds(0, 1010, 880, 1);
        ...
        jLabel131.setBounds(10, 1010, 380, 23);
        ...
        StatusPsiko.setBounds(130, 1030, 110, 23);
        ...
        KetPsiko.setBounds(250, 1030, 230, 23);

        jLabel132.setText("Status Psikologis :");
        jLabel132.setName("jLabel132"); // NOI18N
        FormInput.add(jLabel132);
        jLabel132.setBounds(0, 1030, 130, 23);
        ...
        HubunganKeluarga.setBounds(290, 1080, 100, 23);
        ...
        TinggalDengan.setBounds(500, 1080, 110, 23);
        ...
        KetTinggal.setBounds(610, 1080, 85, 23);

        jLabel136.setText("b. Tinggal dengan :");
        jLabel136.setName("jLabel136"); // NOI18N
        FormInput.add(jLabel136);
        jLabel136.setBounds(390, 1080, 100, 23);
        ...
        StatusBudaya.setBounds(370, 1110, 110, 23);
        ...
        KetBudaya.setBounds(480, 1110, 370, 23);

        jLabel139.setText("Edukasi diberikan kepada :");
        jLabel139.setName("jLabel139"); // NOI18N
        FormInput.add(jLabel139);
        jLabel139.setBounds(230, 1140, 140, 23);
        ...
        Edukasi.setBounds(370, 1140, 110, 23);
        ...
        KetEdukasi.setBounds(480, 1140, 370, 23);

        jLabel140.setText("Agama :");
        jLabel140.setName("jLabel140"); // NOI18N
        FormInput.add(jLabel140);
        jLabel140.setBounds(0, 1140, 82, 23);
        ...
        FormInput.add(Agama);
        Agama.setBounds(90, 1140, 110, 23);
        ...
        jLabel145.setBounds(0, 1310, 571, 23);
        ...
        FormInput.add(Lapor);
        Lapor.setBounds(580, 1340, 80, 23);
        ...
        FormInput.add(Hasil);
        Hasil.setBounds(80, 1340, 293, 23);

        jLabel146.setText("Hasil :");
        jLabel146.setName("jLabel146"); // NOI18N
        FormInput.add(jLabel146);
        jLabel146.setBounds(0, 1340, 72, 23);
        ...
        KetLapor.setBounds(770, 1340, 80, 23);

        jLabel147.setText("Dilaporkan kepada dokter ?");
        jLabel147.setName("jLabel147"); // NOI18N
        FormInput.add(jLabel147);
        jLabel147.setBounds(380, 1340, 190, 23);

        jLabel148.setText("Jam dilaporkan :");
        jLabel148.setName("jLabel148"); // NOI18N
        FormInput.add(jLabel148);
        jLabel148.setBounds(680, 1340, 90, 23);
        ...
        Nilai1.setBounds(770, 1390, 80, 23);
        ...
        jLabel150.setBounds(40, 1390, 460, 23);

        jLabel151.setText("Nilai :");
        jLabel151.setName("jLabel151"); // NOI18N
        FormInput.add(jLabel151);
        jLabel151.setBounds(700, 1390, 75, 23);
        ...
        jLabel152.setBounds(40, 1420, 460, 23);
        ...
        FormInput.add(SG2);
        SG2.setBounds(520, 1420, 160, 23);

        jLabel153.setText("Nilai :");
        jLabel153.setName("jLabel153"); // NOI18N
        FormInput.add(jLabel153);
        jLabel153.setBounds(700, 1420, 75, 23);
        ...
        Nilai2.setBounds(770, 1420, 80, 23);

        jLabel154.setText("Total Skor :");
        jLabel154.setName("jLabel154"); // NOI18N
        FormInput.add(jLabel154);
        jLabel154.setBounds(700, 1450, 75, 23);
        ...
        PanelWall.setBounds(40, 1500, 320, 130);
        ...
        FormInput.add(Nyeri);
        Nyeri.setBounds(380, 1500, 130, 23);
        ...
        Provokes.setBounds(570, 1500, 130, 23);
        ...
        KetProvokes.setBounds(710, 1500, 146, 23);

        jLabel156.setText("Penyebab :");
        jLabel156.setName("jLabel156"); // NOI18N
        FormInput.add(jLabel156);
        jLabel156.setBounds(510, 1500, 60, 23);
        ...
        jSeparator9.setBounds(370, 1490, 1, 140);
        ...
        Quality.setBounds(430, 1530, 140, 23);
        ...
        KetQuality.setBounds(570, 1530, 280, 23);

        jLabel157.setText("Kualitas :");
        jLabel157.setName("jLabel157"); // NOI18N
        FormInput.add(jLabel157);
        jLabel157.setBounds(370, 1530, 55, 23);

        jLabel158.setText("Wilayah :");
        jLabel158.setName("jLabel158"); // NOI18N
        FormInput.add(jLabel158);
        jLabel158.setBounds(370, 1560, 55, 23);

        jLabel159.setText("Menyebar :");
        jLabel159.setName("jLabel159"); // NOI18N
        FormInput.add(jLabel159);
        jLabel159.setBounds(690, 1580, 79, 23);
        ...
        Lokasi.setBounds(460, 1580, 220, 23);

        jLabel160.setText("Lokasi :");
        jLabel160.setName("jLabel160"); // NOI18N
        FormInput.add(jLabel160);
        jLabel160.setBounds(390, 1580, 60, 23);
        ...
        SkalaNyeri.setBounds(490, 1610, 70, 23);
        ...
        NyeriHilang.setBounds(130, 1640, 130, 23);
        ...
        KetNyeri.setBounds(270, 1640, 150, 23);

        jLabel167.setText("Nyeri hilang bila :");
        jLabel167.setName("jLabel167"); // NOI18N
        FormInput.add(jLabel167);
        jLabel167.setBounds(0, 1640, 130, 23);
        ...
        PadaDokter.setBounds(630, 1640, 80, 23);
        ...
        KetDokter.setBounds(770, 1640, 80, 23);
        ...
        jSeparator10.setBounds(0, 1670, 880, 1);
        ...
        TabMasalahKeperawatan.setBounds(10, 1680, 450, 143);
        TabMasalahKeperawatan.getAccessibleContext().setAccessibleName("Masalah Keperawatan Kebidanan");
        ...
        TabRencanaKeperawatan.setName("TabRencanaKeperawatanKebidanan"); // NOI18N
        ...
        TabRencanaKeperawatan.setBounds(470, 1680, 450, 143);
        TabRencanaKeperawatan.getAccessibleContext().setAccessibleName("Rencana Keperawatan Kebidanan");

        label12.setText("Key Word :");
        label12.setName("label12"); // NOI18N
        label12.setPreferredSize(new java.awt.Dimension(60, 23));
        FormInput.add(label12);
        label12.setBounds(40, 1830, 60, 23);
        ...
        TCariMasalah.setBounds(100, 1830, 215, 23);
        ...
        BtnCariMasalah.setBounds(320, 1830, 28, 23);
        ...
        BtnAllMasalah.setBounds(350, 1830, 28, 23);
        ...
        BtnTambahMasalah1.setBounds(380, 1830, 28, 23);

        label13.setText("Key Word :");
        label13.setName("label13"); // NOI18N
        label13.setPreferredSize(new java.awt.Dimension(60, 23));
        FormInput.add(label13);
        label13.setBounds(500, 1830, 60, 23);
        ...
        TCariRencana.setBounds(560, 1830, 235, 23);
        ...
        BtnCariRencana.setBounds(800, 1830, 28, 23);
        ...
        BtnAllRencana.setBounds(830, 1830, 28, 23);
        ...
        BtnTambahRencana.setBounds(870, 1830, 28, 23);

        jLabel168.setText("Riwayat Alergi :");
        jLabel168.setName("jLabel168"); // NOI18N
        FormInput.add(jLabel168);
        jLabel168.setBounds(0, 430, 125, 23);
        ...
        Alergi.setBounds(130, 430, 250, 23);

        jLabel169.setText("Wajib :");
        jLabel169.setName("jLabel169"); // NOI18N
        FormInput.add(jLabel169);
        jLabel169.setBounds(0, 1170, 80, 23);
        ...
        FormInput.add(Wajib);
        Wajib.setBounds(90, 1170, 110, 23);
        ...
        KetHalanganLain.setBounds(300, 1170, 210, 23);

        jLabel170.setText("Toharah :");
        jLabel170.setName("jLabel170"); // NOI18N
        FormInput.add(jLabel170);
        jLabel170.setBounds(510, 1170, 60, 23);
        ...
        Toharah.setBounds(580, 1170, 100, 23);

        jLabel171.setText("Halangan Lain :");
        jLabel171.setName("jLabel171"); // NOI18N
        FormInput.add(jLabel171);
        jLabel171.setBounds(200, 1170, 90, 23);

        jLabel172.setText("Sholat :");
        jLabel172.setName("jLabel172"); // NOI18N
        FormInput.add(jLabel172);
        jLabel172.setBounds(680, 1170, 70, 23);
        ...
        Sholat.setBounds(750, 1170, 100, 23);

        jLabel173.setText("Motivasi Kesembuhan Dan Ibadah :");
        jLabel173.setName("jLabel173"); // NOI18N
        jLabel173.setPreferredSize(new java.awt.Dimension(180, 14));
        FormInput.add(jLabel173);
        jLabel173.setBounds(0, 1200, 220, 23);
        ...
        MotivasiKesembuhanIbadah.setBounds(230, 1200, 60, 23);
        ...
        scrollPane8.getAccessibleContext().setAccessibleName("Masalah Keperawatan Lainnya :");
            ...
            if (akses.getkode().equals("Admin Utama")) {
                ...
                if (KdPetugas.getText().equals(tbObat.getValueAt(tbObat.
                    ...
                    if (Sequel.cekTanggal48jam(tbObat.getValueAt(tbObat.
                            getSelectedRow(), 8).toString(), Sequel.
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            try {
                ps = koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,penilaian_awal_keperawatan_kebidanan_igd.tanggal,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.informasi,penilaian_awal_keperawatan_kebidanan_igd.td,penilaian_awal_keperawatan_kebidanan_igd.nadi,penilaian_awal_keperawatan_kebidanan_igd.rr,penilaian_awal_keperawatan_kebidanan_igd.suhu,penilaian_awal_keperawatan_kebidanan_igd.bb,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.tb,penilaian_awal_keperawatan_kebidanan_igd.nadi,penilaian_awal_keperawatan_kebidanan_igd.rr,penilaian_awal_keperawatan_kebidanan_igd.suhu,penilaian_awal_keperawatan_kebidanan_igd.gcs,penilaian_awal_keperawatan_kebidanan_igd.bb,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.tb,penilaian_awal_keperawatan_kebidanan_igd.bmi,penilaian_awal_keperawatan_kebidanan_igd.lila,penilaian_awal_keperawatan_kebidanan_igd.tfu,penilaian_awal_keperawatan_kebidanan_igd.tbj,penilaian_awal_keperawatan_kebidanan_igd.letak,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.presentasi,penilaian_awal_keperawatan_kebidanan_igd.penurunan,penilaian_awal_keperawatan_kebidanan_igd.his,penilaian_awal_keperawatan_kebidanan_igd.kekuatan,penilaian_awal_keperawatan_kebidanan_igd.lamanya,penilaian_awal_keperawatan_kebidanan_igd.bjj,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.ket_bjj,penilaian_awal_keperawatan_kebidanan_igd.portio,penilaian_awal_keperawatan_kebidanan_igd.serviks,penilaian_awal_keperawatan_kebidanan_igd.ketuban,penilaian_awal_keperawatan_kebidanan_igd.hodge,penilaian_awal_keperawatan_kebidanan_igd.inspekulo,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.ket_inspekulo,penilaian_awal_keperawatan_kebidanan_igd.ctg,penilaian_awal_keperawatan_kebidanan_igd.ket_ctg,penilaian_awal_keperawatan_kebidanan_igd.usg,penilaian_awal_keperawatan_kebidanan_igd.ket_usg,penilaian_awal_keperawatan_kebidanan_igd.lab,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.ket_lab,penilaian_awal_keperawatan_kebidanan_igd.lakmus,penilaian_awal_keperawatan_kebidanan_igd.ket_lakmus,penilaian_awal_keperawatan_kebidanan_igd.panggul,penilaian_awal_keperawatan_kebidanan_igd.keluhan_utama,penilaian_awal_keperawatan_kebidanan_igd.umur,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.lama,penilaian_awal_keperawatan_kebidanan_igd.banyaknya,penilaian_awal_keperawatan_kebidanan_igd.haid,penilaian_awal_keperawatan_kebidanan_igd.siklus,penilaian_awal_keperawatan_kebidanan_igd.ket_siklus,penilaian_awal_keperawatan_kebidanan_igd.ket_siklus1,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.status,penilaian_awal_keperawatan_kebidanan_igd.kali,penilaian_awal_keperawatan_kebidanan_igd.usia1,penilaian_awal_keperawatan_kebidanan_igd.ket1,penilaian_awal_keperawatan_kebidanan_igd.usia2,penilaian_awal_keperawatan_kebidanan_igd.ket2,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.usia3,penilaian_awal_keperawatan_kebidanan_igd.ket3,penilaian_awal_keperawatan_kebidanan_igd.hpht,penilaian_awal_keperawatan_kebidanan_igd.usia_kehamilan,penilaian_awal_keperawatan_kebidanan_igd.tp,penilaian_awal_keperawatan_kebidanan_igd.imunisasi,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.ket_imunisasi,penilaian_awal_keperawatan_kebidanan_igd.g,penilaian_awal_keperawatan_kebidanan_igd.p,penilaian_awal_keperawatan_kebidanan_igd.a,penilaian_awal_keperawatan_kebidanan_igd.hidup,penilaian_awal_keperawatan_kebidanan_igd.ginekologi,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.kebiasaan,penilaian_awal_keperawatan_kebidanan_igd.ket_kebiasaan,penilaian_awal_keperawatan_kebidanan_igd.kebiasaan1,penilaian_awal_keperawatan_kebidanan_igd.ket_kebiasaan1,penilaian_awal_keperawatan_kebidanan_igd.kebiasaan2,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.ket_kebiasaan2,penilaian_awal_keperawatan_kebidanan_igd.kebiasaan3,penilaian_awal_keperawatan_kebidanan_igd.kb,penilaian_awal_keperawatan_kebidanan_igd.ket_kb,penilaian_awal_keperawatan_kebidanan_igd.komplikasi,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.ket_komplikasi,penilaian_awal_keperawatan_kebidanan_igd.berhenti,penilaian_awal_keperawatan_kebidanan_igd.alasan,penilaian_awal_keperawatan_kebidanan_igd.alat_bantu,penilaian_awal_keperawatan_kebidanan_igd.ket_bantu,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.prothesa,penilaian_awal_keperawatan_kebidanan_igd.ket_pro,penilaian_awal_keperawatan_kebidanan_igd.adl,penilaian_awal_keperawatan_kebidanan_igd.status_psiko,penilaian_awal_keperawatan_kebidanan_igd.ket_psiko,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.hub_keluarga,penilaian_awal_keperawatan_kebidanan_igd.tinggal_dengan,penilaian_awal_keperawatan_kebidanan_igd.ket_tinggal,penilaian_awal_keperawatan_kebidanan_igd.ekonomi,penilaian_awal_keperawatan_kebidanan_igd.budaya,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.ket_budaya,penilaian_awal_keperawatan_kebidanan_igd.edukasi,penilaian_awal_keperawatan_kebidanan_igd.ket_edukasi,penilaian_awal_keperawatan_kebidanan_igd.berjalan_a,penilaian_awal_keperawatan_kebidanan_igd.berjalan_b,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.berjalan_c,penilaian_awal_keperawatan_kebidanan_igd.hasil,penilaian_awal_keperawatan_kebidanan_igd.lapor,penilaian_awal_keperawatan_kebidanan_igd.ket_lapor,penilaian_awal_keperawatan_kebidanan_igd.sg1,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.nilai1,penilaian_awal_keperawatan_kebidanan_igd.sg2,penilaian_awal_keperawatan_kebidanan_igd.nilai2,penilaian_awal_keperawatan_kebidanan_igd.total_hasil,penilaian_awal_keperawatan_kebidanan_igd.nyeri,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.provokes,penilaian_awal_keperawatan_kebidanan_igd.ket_provokes,penilaian_awal_keperawatan_kebidanan_igd.quality,penilaian_awal_keperawatan_kebidanan_igd.ket_quality,penilaian_awal_keperawatan_kebidanan_igd.lokasi,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.menyebar,penilaian_awal_keperawatan_kebidanan_igd.skala_nyeri,penilaian_awal_keperawatan_kebidanan_igd.durasi,penilaian_awal_keperawatan_kebidanan_igd.nyeri_hilang,penilaian_awal_keperawatan_kebidanan_igd.ket_nyeri,"
                        + "penilaian_awal_keperawatan_kebidanan_igd.pada_dokter,penilaian_awal_keperawatan_kebidanan_igd.ket_dokter,penilaian_awal_keperawatan_kebidanan_igd.rencana,penilaian_awal_keperawatan_kebidanan_igd.nip,petugas.nama "
                        + "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                        + "inner join penilaian_awal_keperawatan_kebidanan_igd on reg_periksa.no_rawat=penilaian_awal_keperawatan_kebidanan_igd.no_rawat "
                        + "inner join petugas on penilaian_awal_keperawatan_kebidanan_igd.nip=petugas.nip "
                        + "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "
                        + "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "
                        + "penilaian_awal_keperawatan_kebidanan_igd.tanggal between ? and ? "
                        + (TCari.getText().trim().isEmpty() ? "" : "and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or penilaian_awal_keperawatan_kebidanan_igd.nip like ? or  petugas.nama like ?)")
                        + " order by penilaian_awal_keperawatan_kebidanan_igd.tanggal");
                ...
                try {
                    ...
                    while (rs.next()) {
                        htmlContent.append(
                                ...
                                + "<tr class='isi2'>"
                                + "<td width='32%' valign='top'>No.Rawat</td><td valign='top'>:&nbsp;</td><td width='67%' valign='top'>" + rs.
                                        getString("no_rawat") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='32%' valign='top'>No.R.M.</td><td valign='top'>:&nbsp;</td><td width='67%' valign='top'>" + rs.
                                        getString("no_rkm_medis") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='32%' valign='top'>Nama Pasien</td><td valign='top'>:&nbsp;</td><td width='67%' valign='top'>" + rs.
                                        getString("nm_pasien") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='32%' valign='top'>J.K.</td><td valign='top'>:&nbsp;</td><td width='67%' valign='top'>" + rs.
                                        getString("jk") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='32%' valign='top'>Agama</td><td valign='top'>:&nbsp;</td><td width='67%' valign='top'>" + rs.
                                        getString("agama") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='32%' valign='top'>Bahasa</td><td valign='top'>:&nbsp;</td><td width='67%' valign='top'>" + rs.
                                        getString("nama_bahasa") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='32%' valign='top'>Tgl.Lahir</td><td valign='top'>:&nbsp;</td><td width='67%' valign='top'>" + rs.
                                        getString("nama_cacat") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='32%' valign='top'>Cacat Fisik</td><td valign='top'>:&nbsp;</td><td width='67%' valign='top'>" + rs.
                                        getString("tgl_lahir") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='32%' valign='top'>Petugas</td><td valign='top'>:&nbsp;</td><td width='67%' valign='top'>" + rs.
                                        getString("nip") + " " + rs.getString(
                                "nama") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='32%' valign='top'>Tgl.Asuhan</td><td valign='top'>:&nbsp;</td><td width='67%' valign='top'>" + rs.
                                        getString("tanggal") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='32%' valign='top'>Informasi</td><td valign='top'>:&nbsp;</td><td width='67%' valign='top'>" + rs.
                                        getString("informasi") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td valign='top' align='center' colspan='3'><b>I. KEADAAN UMUM</b></td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>TD</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("td") + " mmHg</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Nadi</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("nadi") + " x/menit</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>RR</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("rr") + " x/menit</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Suhu</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("suhu") + " °C</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>GCS</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("gcs") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>BB</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("bb") + " Kg</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>TB</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("tb") + " cm</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>LILA</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("lila") + " cm</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>BMI</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("bmi") + " Kg/m²</td>"
                                + "</tr>"
                                + "</table>"
                                + "</td>"
                                + "<td valign='top' cellpadding='0' cellspacing='0'>"
                                + "<table width='100%' border='0' cellpadding='0' cellspacing='0'align='center'>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>TFU</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("tfu") + " cm</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>TBJ</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("tbj") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Letak</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("letak") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Presentasi</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("presentasi") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Penurunan</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("penurunan") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Kontraksi/HIS</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("his") + " x/10’</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Kekuatan</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("kekuatan") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Lamanya</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("lamanya") + " detik</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Gerak janin, DJJ </td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("bjj") + " /mnt</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Status</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("ket_bjj") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Portio</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("portio") + " detik</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Pembukaan Serviks</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("serviks") + " cm </td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Ketuban</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("ketuban") + " kep/bok</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Hodge</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("hodge") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Inspekulo</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("inspekulo") + ", Hasil " + rs.
                                getString("ket_inspekulo") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>CTG</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("ctg") + ", Hasil " + rs.
                                getString("ket_ctg") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>USG</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("usg") + ", Hasil " + rs.
                                getString("ket_usg") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Laborat</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("lab") + ", Hasil " + rs.
                                getString("ket_lab") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Lakmus</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("lakmus") + ", Hasil " + rs.
                                getString("ket_lakmus") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Pemeriksaan Panggul</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("panggul") + "</td>"
                                + "</tr>"
                                + "</table>"
                                + "</td>"
                                + "<td valign='top' cellpadding='0' cellspacing='0'>"
                                + "<table width='100%' border='0' cellpadding='0' cellspacing='0'align='center'>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Keluhan Utama</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("keluhan_utama") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Umur Menarche</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("umur") + " tahun, lamanya " + rs.
                                getString("lama") + " hari, banyaknya " + rs.
                                getString("banyaknya") + " pembalut </td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Haid Terakhir</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("haid") + ", Siklus " + rs.
                                getString("siklus") + " hari, (" + rs.getString(
                                "ket_siklus") + ")</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Masalah Menstruasi</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("ket_siklus1") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Status Menikah</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("status") + ", " + rs.
                                getString("kali") + " kali</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Usia Perkawinan 1</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("usia1") + " tahun, " + rs.
                                getString("ket1") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Usia Perkawinan 2</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("usia2") + " tahun, " + rs.
                                getString("ket2") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Usia Perkawinan 3</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("usia3") + " tahun, " + rs.
                                getString("ket3") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>HPHT</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("hpht") + ", Usia Hamil " + rs.
                                getString("usia_kehamilan") + " bln/mgg</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>TP</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("tp") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Riwayat Imunisasi</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("imunisasi") + ", " + rs.
                                getString("ket_imunisasi") + " kali</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>G,P,A, Hidup</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("g") + ", " + rs.
                                getString("p") + ", " + rs.getString("a") + ", " + rs.
                                getString("hidup") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Riwayat KB</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("kb") + ", lamanya " + rs.
                                getString("ket_kb") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Komplikasi KB</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("komplikasi") + ", " + rs.
                                getString("ket_komplikasi") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Kapan Berhenti KB</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("berhenti") + ", Alasan : " + rs.
                                getString("alasan") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Riwayat Ginekologi</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("ginekologi") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Obat/Vitamin</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("kebiasaan") + (rs.getString(
                                "ket_kebiasaan").isEmpty() ? "" : ", " + rs.
                                                getString("ket_kebiasaan")) + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Merokok</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("kebiasaan1") + (rs.getString(
                                "ket_kebiasaan1").isEmpty() ? "" : ", " + rs.
                                                getString("ket_kebiasaan1")) + " batang/hari</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Alkohol</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("kebiasaan2") + (rs.getString(
                                "ket_kebiasaan2").isEmpty() ? "" : ", " + rs.
                                                getString("ket_kebiasaan2")) + " gelas/hari</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='34%' valign='top'>Obat Tidur/Narkoba</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>" + rs.
                                        getString("kebiasaan3") + "</td>"
                                + "</tr>"
                                + "</table>"
                                + "</td>"
                                + "<td valign='top' cellpadding='0' cellspacing='0'>"
                                + "<table width='100%' border='0' cellpadding='0' cellspacing='0'align='center'>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Alat Bantu</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("alat_bantu") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Ket. Alat Bantu</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("ket_bantu") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Prothesa</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("prothesa") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Ket. Prothesa</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("ket_pro") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>ADL</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("adl") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                ...
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Status Psikologis</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("status_psiko") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Ket. Psikologi</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("ket_psiko") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Hubungan pasien dengan anggota keluarga</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("hub_keluarga") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Tinggal dengan</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("tinggal_dengan") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Ket. Tinggal</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("ket_tinggal") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Ekonomi</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("ekonomi") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Kepercayaan / Budaya / Nilai-nilai khusus yang perlu diperhatikan</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("budaya") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Ket. Budaya</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("ket_budaya") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Edukasi diberikan kepada </td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("edukasi") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Ket. Edukasi</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("ket_edukasi") + "</td>"
                                + "</tr>"
                                + "</table>"
                                + "</td>"
                                + "<td valign='top' cellpadding='0' cellspacing='0'>"
                                + "<table width='100%' border='0' cellpadding='0' cellspacing='0'align='center'>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Tidak seimbang/sempoyongan/limbung</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("berjalan_a") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Jalan dengan menggunakan alat bantu (kruk, tripot, kursi roda, orang lain)</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("berjalan_b") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Menopang saat akan duduk, tampak memegang pinggiran kursi atau meja/benda lain sebagai penopang</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("berjalan_c") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Hasil</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("hasil") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Dilaporan ke dokter?</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("lapor") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Jam Lapor</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("ket_lapor") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td valign='top' align='center' colspan='3'><b>VII. SKRINING GIZI</b></td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Apakah ada penurunan berat badanyang tidak diinginkan selama enam bulan terakhir?</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("sg1") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Apakah nafsu makan berkurang karena tidak nafsu makan?</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("sg2") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Nilai 1</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("nilai1") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Nilai 2</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("nilai2") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='64%' valign='top'>Total Skor</td><td valign='top'>:&nbsp;</td><td width='35%' valign='top'>" + rs.
                                        getString("total_hasil") + "</td>"
                                + "</tr>"
                                + "</table>"
                                + "</td>"
                                + "<td valign='top' cellpadding='0' cellspacing='0'>"
                                + "<table width='100%' border='0' cellpadding='0' cellspacing='0'align='center'>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Tingkat Nyeri</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("nyeri") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Provokes</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("provokes") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Ket. Provokes</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("ket_provokes") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Kualitas</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("quality") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Ket. Kualitas</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("ket_quality") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Lokas</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("lokasi") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Menyebar</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("menyebar") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Skala Nyeri</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("skala_nyeri") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Durasi</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("durasi") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Nyeri Hilang</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("nyeri_hilang") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Ket. Hilang Nyeri</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("ket_nyeri") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Lapor Ke Dokter</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("pada_dokter") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                + "<td width='44%' valign='top'>Jam Lapor</td><td valign='top'>:&nbsp;</td><td width='55%' valign='top'>" + rs.
                                        getString("ket_dokter") + "</td>"
                                + "</tr>"
                                + "<tr class='isi2'>"
                                ...
                                + "Masalah Kebidanan : " + rs.getString(
                                        "masalah") + "<br><br>"
                                + "Tindakan Kebidanan : " + rs.getString(
                                        "tindakan")
                                + "</td>"
                                + "</tr>"
                                + "</table>"
                    ...
                    File f = new File(
                            "DataPenilaianAwalKeperawatanKebidanan.html");
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            finger = Sequel.cariIsi(
                    ...
                    tbObat.getValueAt(tbObat.getSelectedRow(), 124).toString());
            param.put("finger",
                    "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.
                    getkabupatenrs() + "\nDitandatangani secara elektronik oleh " + tbObat.
                            getValueAt(tbObat.getSelectedRow(), 125).toString() + "\nID " + (finger.
                    isEmpty() ? tbObat.getValueAt(tbObat.getSelectedRow(), 124).
                                    toString() : finger) + "\n" + Valid.SetTgl3(
                            tbObat.getValueAt(tbObat.getSelectedRow(), 8).
                                    toString()));
            try {
                ps = koneksi.prepareStatement(
                        "select * from riwayat_persalinan_pasien where no_rkm_medis=? order by tgl_thn");
                try {
                    ...
                    while (rs.next()) {
                        ...
                        param.put("tempatpersalinan" + i, rs.getString(
                                "tempat_persalinan"));
                        param.put("usiahamil" + i, rs.getString("usia_hamil"));
                        param.put("jenispersalinan" + i, rs.getString(
                                "jenis_persalinan"));
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalKebidananRalan.jasper",
                    "report",
                    "::[ Laporan Penilaian Awal Ralan Kebidanan & Kandungan ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,penilaian_awal_keperawatan_kebidanan_igd.tanggal,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.informasi,penilaian_awal_keperawatan_kebidanan_igd.td,penilaian_awal_keperawatan_kebidanan_igd.nadi,penilaian_awal_keperawatan_kebidanan_igd.rr,penilaian_awal_keperawatan_kebidanan_igd.suhu,penilaian_awal_keperawatan_kebidanan_igd.bb,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.tb,penilaian_awal_keperawatan_kebidanan_igd.nadi,penilaian_awal_keperawatan_kebidanan_igd.rr,penilaian_awal_keperawatan_kebidanan_igd.suhu,penilaian_awal_keperawatan_kebidanan_igd.gcs,penilaian_awal_keperawatan_kebidanan_igd.bb,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.tb,penilaian_awal_keperawatan_kebidanan_igd.bmi,penilaian_awal_keperawatan_kebidanan_igd.lila,penilaian_awal_keperawatan_kebidanan_igd.tfu,penilaian_awal_keperawatan_kebidanan_igd.tbj,penilaian_awal_keperawatan_kebidanan_igd.letak,"
                    ...
                    + "inner join petugas on penilaian_awal_keperawatan_kebidanan_igd.nip=petugas.nip "
                    + "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "
                    + "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where reg_periksa.no_rawat='" + tbObat.
                            getValueAt(tbObat.getSelectedRow(), 0).toString() + "'",
                    param);

            Valid.MyReportqry("rptCetakPenilaianAwalKebidananRalan2.jasper",
                    "report",
                    "::[ Laporan Penilaian Awal Ralan Kebidanan & Kandungan ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,penilaian_awal_keperawatan_kebidanan_igd.tanggal,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.informasi,penilaian_awal_keperawatan_kebidanan_igd.td,penilaian_awal_keperawatan_kebidanan_igd.nadi,penilaian_awal_keperawatan_kebidanan_igd.rr,penilaian_awal_keperawatan_kebidanan_igd.suhu,penilaian_awal_keperawatan_kebidanan_igd.bb,"
    ...
    private void BtnSimpanRiwayatKehamilanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanRiwayatKehamilanActionPerformed
        if (TempatPersalinan.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("riwayat_persalinan_pasien",
                    "?,?,?,?,?,?,?,?,?,?", "Riwayat Persalinan", 10,
                    new String[]{
                        TNoRM.getText(), Valid.SetTgl(TanggalPersalinan.
                        getSelectedItem() + ""), TempatPersalinan.getText(),
                        UsiaHamil.getText(), JenisPersalinan.getText(),
                        Penolong.getText(), Penyulit.getText(), JK.
                        getSelectedItem().toString().substring(0, 1), BBPB.
                        getText(), Keadaan.getText()
                    }) == true) {
                emptTeksPersalinan();
                tampilPersalinan();
            }
    ...
    private void BtnHapusRiwayatPersalinanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusRiwayatPersalinanActionPerformed
        if (tbRiwayatKehamilan.getSelectedRow() > -1) {
            Sequel.meghapus("riwayat_persalinan_pasien", "no_rkm_medis",
                    "tgl_thn", TNoRM.getText(), tbRiwayatKehamilan.getValueAt(
                    tbRiwayatKehamilan.getSelectedRow(), 1).toString());
            tampilPersalinan();
        } else {
            JOptionPane.showMessageDialog(rootPane,
                    "Silahkan anda pilih data terlebih dahulu..!!");
    ...
    private void SG1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_SG1ItemStateChanged
        ...
        TotalHasil.setText("" + (Integer.parseInt(Nilai1.getSelectedItem().
                toString()) + Integer.parseInt(Nilai2.getSelectedItem().
                        toString())));
    ...
    private void KetDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KetDokterKeyPressed
        Valid.pindah(evt, PadaDokter, PadaDokter);
    ...
    private void AlergiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AlergiKeyPressed
        Valid.pindah(evt, KeluhanUtama, Umur);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalKeperawatanKebidananIGD dialog = new RMPenilaianAwalKeperawatanKebidananIGD(
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "penilaian_awal_keperawatan_kebidanan_igd.ket_bjj,penilaian_awal_keperawatan_kebidanan_igd.portio,penilaian_awal_keperawatan_kebidanan_igd.serviks,penilaian_awal_keperawatan_kebidanan_igd.ketuban,penilaian_awal_keperawatan_kebidanan_igd.hodge,penilaian_awal_keperawatan_kebidanan_igd.inspekulo,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.ket_inspekulo,penilaian_awal_keperawatan_kebidanan_igd.ctg,penilaian_awal_keperawatan_kebidanan_igd.ket_ctg,penilaian_awal_keperawatan_kebidanan_igd.usg,penilaian_awal_keperawatan_kebidanan_igd.ket_usg,penilaian_awal_keperawatan_kebidanan_igd.lab,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.ket_lab,penilaian_awal_keperawatan_kebidanan_igd.lakmus,penilaian_awal_keperawatan_kebidanan_igd.ket_lakmus,penilaian_awal_keperawatan_kebidanan_igd.panggul,penilaian_awal_keperawatan_kebidanan_igd.keluhan_utama,penilaian_awal_keperawatan_kebidanan_igd.alergi,penilaian_awal_keperawatan_kebidanan_igd.umur,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.lama,penilaian_awal_keperawatan_kebidanan_igd.banyaknya,penilaian_awal_keperawatan_kebidanan_igd.haid,penilaian_awal_keperawatan_kebidanan_igd.siklus,penilaian_awal_keperawatan_kebidanan_igd.ket_siklus,penilaian_awal_keperawatan_kebidanan_igd.ket_siklus1,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.status,penilaian_awal_keperawatan_kebidanan_igd.kali,penilaian_awal_keperawatan_kebidanan_igd.usia1,penilaian_awal_keperawatan_kebidanan_igd.ket1,penilaian_awal_keperawatan_kebidanan_igd.usia2,penilaian_awal_keperawatan_kebidanan_igd.ket2,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.usia3,penilaian_awal_keperawatan_kebidanan_igd.ket3,penilaian_awal_keperawatan_kebidanan_igd.hpht,penilaian_awal_keperawatan_kebidanan_igd.usia_kehamilan,penilaian_awal_keperawatan_kebidanan_igd.tp,penilaian_awal_keperawatan_kebidanan_igd.imunisasi,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.ket_imunisasi,penilaian_awal_keperawatan_kebidanan_igd.g,penilaian_awal_keperawatan_kebidanan_igd.p,penilaian_awal_keperawatan_kebidanan_igd.a,penilaian_awal_keperawatan_kebidanan_igd.hidup,penilaian_awal_keperawatan_kebidanan_igd.ginekologi,"
                    ...
                    + "penilaian_awal_keperawatan_kebidanan_igd.prothesa,penilaian_awal_keperawatan_kebidanan_igd.ket_pro,penilaian_awal_keperawatan_kebidanan_igd.adl,penilaian_awal_keperawatan_kebidanan_igd.status_psiko,penilaian_awal_keperawatan_kebidanan_igd.ket_psiko,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.hub_keluarga,penilaian_awal_keperawatan_kebidanan_igd.tinggal_dengan,penilaian_awal_keperawatan_kebidanan_igd.ket_tinggal,penilaian_awal_keperawatan_kebidanan_igd.ekonomi,penilaian_awal_keperawatan_kebidanan_igd.budaya,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.ket_budaya,penilaian_awal_keperawatan_kebidanan_igd.edukasi,penilaian_awal_keperawatan_kebidanan_igd.ket_edukasi,penilaian_awal_keperawatan_kebidanan_igd.agama,penilaian_awal_keperawatan_kebidanan_igd.wajib,penilaian_awal_keperawatan_kebidanan_igd.ket_halangan_lain,penilaian_awal_keperawatan_kebidanan_igd.toharah,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.sholat,penilaian_awal_keperawatan_kebidanan_igd.motivasi_kesembuhan_ibadah,penilaian_awal_keperawatan_kebidanan_igd.berjalan_a,penilaian_awal_keperawatan_kebidanan_igd.berjalan_b,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.berjalan_c,penilaian_awal_keperawatan_kebidanan_igd.hasil,penilaian_awal_keperawatan_kebidanan_igd.lapor,penilaian_awal_keperawatan_kebidanan_igd.ket_lapor,penilaian_awal_keperawatan_kebidanan_igd.sg1,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.nilai1,penilaian_awal_keperawatan_kebidanan_igd.sg2,penilaian_awal_keperawatan_kebidanan_igd.nilai2,penilaian_awal_keperawatan_kebidanan_igd.total_hasil,penilaian_awal_keperawatan_kebidanan_igd.nyeri,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.provokes,penilaian_awal_keperawatan_kebidanan_igd.ket_provokes,penilaian_awal_keperawatan_kebidanan_igd.quality,penilaian_awal_keperawatan_kebidanan_igd.ket_quality,penilaian_awal_keperawatan_kebidanan_igd.lokasi,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.menyebar,penilaian_awal_keperawatan_kebidanan_igd.skala_nyeri,penilaian_awal_keperawatan_kebidanan_igd.durasi,penilaian_awal_keperawatan_kebidanan_igd.nyeri_hilang,penilaian_awal_keperawatan_kebidanan_igd.ket_nyeri,"
                    + "penilaian_awal_keperawatan_kebidanan_igd.pada_dokter,penilaian_awal_keperawatan_kebidanan_igd.ket_dokter,penilaian_awal_keperawatan_kebidanan_igd.masalah,penilaian_awal_keperawatan_kebidanan_igd.rencana,penilaian_awal_keperawatan_kebidanan_igd.nip,petugas.nama "
                    + "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join penilaian_awal_keperawatan_kebidanan_igd on reg_periksa.no_rawat=penilaian_awal_keperawatan_kebidanan_igd.no_rawat "
                    + "inner join petugas on penilaian_awal_keperawatan_kebidanan_igd.nip=petugas.nip "
                    + "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "
                    ...
                    : "and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or penilaian_awal_keperawatan_kebidanan_igd.nip like ? or  petugas.nama like ?)")
                    + " order by penilaian_awal_keperawatan_kebidanan_igd.tanggal");
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        rs.getString("nm_pasien"), rs.getString("jk"), rs.getString("agama"),
                        rs.getString("nama_bahasa"), rs.getString("nama_cacat"), rs.getString("tgl_lahir"),
                        rs.getString("tanggal"), rs.getString("informasi"), rs.getString("td"),
                        rs.getString("nadi"), rs.getString("rr"), rs.getString("suhu"), rs.getString("gcs"),
                        rs.getString("bb"), rs.getString("tb"), rs.getString("lila"), rs.getString("bmi"),
                        rs.getString("tfu"), rs.getString("tbj"), rs.getString("letak"), rs.getString("presentasi"),
                        rs.getString("penurunan"), rs.getString("his"), rs.getString("kekuatan"),
                        rs.getString("lamanya"), rs.getString("bjj"), rs.getString("ket_bjj"),
                        rs.getString("portio"), rs.getString("serviks"), rs.getString("ketuban"),
                        rs.getString("hodge"), rs.getString("inspekulo"), rs.getString("ket_inspekulo"),
                        rs.getString("ctg"), rs.getString("ket_ctg"), rs.getString("usg"), rs.getString("ket_usg"),
                        rs.getString("lab"), rs.getString("ket_lab"), rs.getString("lakmus"),
                        rs.getString("ket_lakmus"), rs.getString("panggul"), rs.getString("keluhan_utama"),
                        rs.getString("alergi"), rs.getString("umur"), rs.getString("lama"),
                        rs.getString("banyaknya"), rs.getString("haid"), rs.getString("siklus"),
                        rs.getString("ket_siklus"), rs.getString("ket_siklus1"), rs.getString("status"),
                        rs.getString("kali"), rs.getString("usia1"), rs.getString("ket1"), rs.getString("usia2"),
                        rs.getString("ket2"), rs.getString("usia3"), rs.getString("ket3"), rs.getString("hpht"),
                        rs.getString("usia_kehamilan"), rs.getString("tp"), rs.getString("imunisasi"),
                        rs.getString("ket_imunisasi"), rs.getString("g"), rs.getString("P"), rs.getString("a"),
                        rs.getString("hidup"), rs.getString("ginekologi"), rs.getString("kebiasaan"),
                        rs.getString("ket_kebiasaan"), rs.getString("kebiasaan1"), rs.getString("ket_kebiasaan1"),
                        rs.getString("kebiasaan2"), rs.getString("ket_kebiasaan2"), rs.getString("kebiasaan3"),
                        rs.getString("kb"), rs.getString("ket_kb"), rs.getString("komplikasi"),
                        rs.getString("ket_komplikasi"), rs.getString("berhenti"), rs.getString("alasan"),
                        rs.getString("alat_bantu"), rs.getString("ket_bantu"), rs.getString("prothesa"),
                        rs.getString("ket_pro"), rs.getString("adl"), rs.getString("status_psiko"),
                        rs.getString("ket_psiko"), rs.getString("hub_keluarga"), rs.getString("tinggal_dengan"),
                        rs.getString("ket_tinggal"), rs.getString("ekonomi"), rs.getString("budaya"),
                        rs.getString("ket_budaya"), rs.getString("edukasi"), rs.getString("ket_edukasi"),
                        rs.getString("agama"), rs.getString("wajib"), rs.getString("ket_halangan_lain"),
                        rs.getString("toharah"), rs.getString("sholat"), rs.getString("motivasi_kesembuhan_ibadah"),
                        rs.getString("berjalan_a"), rs.getString("berjalan_b"), rs.getString("berjalan_c"),
                        rs.getString("hasil"), rs.getString("lapor"), rs.getString("ket_lapor"),
                        rs.getString("sg1"), rs.getString("nilai1"), rs.getString("sg2"), rs.getString("nilai2"),
                        rs.getString("total_hasil"), rs.getString("nyeri"), rs.getString("provokes"),
                        rs.getString("ket_provokes"), rs.getString("quality"), rs.getString("ket_quality"),
                        rs.getString("lokasi"), rs.getString("menyebar"), rs.getString("skala_nyeri"),
                        rs.getString("durasi"), rs.getString("nyeri_hilang"), rs.getString("ket_nyeri"),
                        rs.getString("pada_dokter"), rs.getString("ket_dokter"), rs.getString("masalah"),
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Alergi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 45).toString());
            Umur.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 46).toString());
            Lama.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 47).toString());
            Banyaknya.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 48).toString());
            HaidTerakhir.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 49).toString());
            Siklus.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 50).toString());
            KetSiklus.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 51).toString());
            KetSiklus2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 52).toString());
            StatusMenikah.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 53).toString());
            KaliMenikah.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 54).toString());
            UsiaKawin1.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 55).toString());
            StatusKawin1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 56).toString());
            UsiaKawin2.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 57).toString());
            StatusKawin2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 58).toString());
            UsiaKawin3.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 59).toString());
            StatusKawin3.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 60).toString());
            UsiaKehamilan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 62).toString());
            RiwayatImunisasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 64).toString());
            JumlahImunisasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 65).toString());
            G.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 66).toString());
            P.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 67).toString());
            A.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 68).toString());
            Hidup.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 69).toString());
            RiwayatGenekologi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 70).toString());
            KebiasaanObat.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 71).toString());
            KebiasaanObatDiminum.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 72).toString());
            KebiasaanMerokok.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 73).toString());
            KebiasaanJumlahRokok.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 74).toString());
            KebiasaanAlkohol.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 75).toString());
            KebiasaanJumlahAlkohol.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 76).toString());
            KebiasaanNarkoba.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 77).toString());
            RiwayatKB.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 78).toString());
            LamanyaKB.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 79).toString());
            KomplikasiKB.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 80).toString());
            KeteranganKomplikasiKB.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 81).toString());
            BerhentiKB.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 82).toString());
            AlasanBerhentiKB.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 83).toString());
            AlatBantu.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 84).toString());
            KetBantu.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 85).toString());
            Prothesa.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 86).toString());
            KetProthesa.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 87).toString());
            ADL.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 88).toString());
            StatusPsiko.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 89).toString());
            KetPsiko.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 90).toString());
            HubunganKeluarga.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 91).toString());
            TinggalDengan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 92).toString());
            KetTinggal.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 93).toString());
            Ekonomi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 94).toString());
            StatusBudaya.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 95).toString());
            KetBudaya.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 96).toString());
            Edukasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 97).toString());
            KetEdukasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 98).toString());
            Agama.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 99).toString());
            Wajib.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 100).toString());
            KetHalanganLain.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 101).toString());
            Toharah.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 102).toString());
            Sholat.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 103).toString());
            MotivasiKesembuhanIbadah.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 104).toString());
            RJa1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 105).toString());
            RJa2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 106).toString());
            RJb.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 107).toString());
            Hasil.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 108).toString());
            Lapor.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 109).toString());
            KetLapor.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 110).toString());
            SG1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 111).toString());
            Nilai1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 112).toString());
            SG2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 113).toString());
            Nilai2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 114).toString());
            TotalHasil.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 115).toString());
            Nyeri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 116).toString());
            Provokes.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 117).toString());
            KetProvokes.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 118).toString());
            Quality.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 119).toString());
            KetQuality.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 120).toString());
            Lokasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 121).toString());
            Menyebar.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 122).toString());
            SkalaNyeri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 123).toString());
            Durasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 124).toString());
            NyeriHilang.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 125).toString());
            KetNyeri.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 126).toString());
            PadaDokter.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 127).toString());
            KetDokter.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 128).toString());
            Masalah.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 129).toString());
            Rencana.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 130).toString());
            tampilPersalinan();
            ...
            try {
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "inner join penilaian_awal_keperawatan_kebidanan_masalah_igd on penilaian_awal_keperawatan_kebidanan_masalah_igd.kode_masalah=master_masalah_keperawatan_kebidanan.kode_masalah "
                        + "where penilaian_awal_keperawatan_kebidanan_masalah_igd.no_rawat=? order by penilaian_awal_keperawatan_kebidanan_masalah_igd.kode_masalah");
                try {
            ...
            try {
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "inner join penilaian_awal_keperawatan_kebidanan_rencana_igd on penilaian_awal_keperawatan_kebidanan_rencana_igd.kode_rencana=master_rencana_keperawatan_kebidanan.kode_rencana "
                        + "where penilaian_awal_keperawatan_kebidanan_rencana_igd.no_rawat=? order by penilaian_awal_keperawatan_kebidanan_rencana_igd.kode_rencana");
                try {
                    ps.setString(1, tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString());
                    rs = ps.executeQuery();
                    while (rs.next()) {
    ...
    private void tampilMasalah() {
        try {
            ...
            iyem = "";
            ps = koneksi.prepareStatement(
                    "select * from master_masalah_keperawatan_kebidanan order by master_masalah_keperawatan_kebidanan.kode_masalah");
            try {
                rs = ps.executeQuery();
                while (rs.next()) {
    ...
    private void tampilRencana() {
        try {
            ...
            iyem = "";
            ps = koneksi.prepareStatement(
                    "select * from master_rencana_keperawatan_kebidanan order by master_rencana_keperawatan_kebidanan.kode_rencana");
            try {
                rs = ps.executeQuery();
                while (rs.next()) {
                    ...
                    if (tbMasalahKeperawatanKebidanan.getValueAt(i, 0).toString().equals("true")) {
                        for (JsonNode list : response) {
                            if (list.path("KodeMasalah")
                                    .asText()
                                    .toLowerCase()
                                    .equals(tbMasalahKeperawatanKebidanan.getValueAt(i, 1).toString())
    ...
    private void getMasalah() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            DetailMasalah.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 129).toString());
            DetailRencana.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 130).toString());
            Valid.tabelKosong(tabModeRiwayatKehamilan2);
            try {
                ps = koneksi.prepareStatement(
                        "select * from riwayat_persalinan_pasien where riwayat_persalinan_pasien.no_rkm_medis=? order by riwayat_persalinan_pasien.tgl_thn");
                try {
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_awal_keperawatan_kebidanan_igd where no_rawat=?", 1,
                new String[]{tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()}) == true) {
            TNoRM1.setText("");
            TPasien1.setText("");
            Sequel.meghapus("penilaian_awal_keperawatan_kebidanan_masalah_igd", "no_rawat",
                    tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString());
            Sequel.meghapus("penilaian_awal_keperawatan_kebidanan_rencana_igd", "no_rawat",
                    tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString());
            ChkAccor.setSelected(false);
            isMenu();
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_awal_keperawatan_kebidanan_igd", "no_rawat=?",
                "no_rawat=?,tanggal=?,informasi=?,td=?,nadi=?,rr=?,suhu=?,gcs=?,bb=?,tb=?,lila=?,bmi=?,tfu=?,tbj=?,letak=?,presentasi=?,penurunan=?,his=?,kekuatan=?,lamanya=?,bjj=?,ket_bjj=?,portio=?,serviks=?,ketuban=?,hodge=?,inspekulo=?,ket_inspekulo=?,ctg=?,ket_ctg=?,usg=?,ket_usg=?,lab=?,ket_lab=?,lakmus=?,ket_lakmus=?,panggul=?,keluhan_utama=?,alergi=?,umur=?,lama=?,banyaknya=?,haid=?,siklus=?,ket_siklus=?,ket_siklus1=?,status=?,kali=?,usia1=?,ket1=?,usia2=?,ket2=?,usia3=?,ket3=?,hpht=?,usia_kehamilan=?,tp=?,imunisasi=?,ket_imunisasi=?,g=?,p=?,a=?,hidup=?,ginekologi=?,kebiasaan=?,ket_kebiasaan=?,kebiasaan1=?,ket_kebiasaan1=?,kebiasaan2=?,ket_kebiasaan2=?,kebiasaan3=?,kb=?,ket_kb=?,komplikasi=?,ket_komplikasi=?,berhenti=?,alasan=?,alat_bantu=?,ket_bantu=?,prothesa=?,ket_pro=?,adl=?,status_psiko=?,ket_psiko=?,hub_keluarga=?,tinggal_dengan=?,ket_tinggal=?,ekonomi=?,budaya=?,ket_budaya=?,edukasi=?,ket_edukasi=?,agama=?,wajib=?,ket_halangan_lain=?,toharah=?,sholat=?,motivasi_kesembuhan_ibadah=?,berjalan_a=?,berjalan_b=?,berjalan_c=?,hasil=?,lapor=?,ket_lapor=?,sg1=?,nilai1=?,sg2=?,nilai2=?,total_hasil=?,nyeri=?,provokes=?,ket_provokes=?,quality=?,ket_quality=?,lokasi=?,menyebar=?,skala_nyeri=?,durasi=?,nyeri_hilang=?,ket_nyeri=?,pada_dokter=?,ket_dokter=?,masalah=?,rencana=?,nip=?",
                126,
                new String[]{TNoRw.getText(),
                    Valid.SetTgl(TglAsuhan.getSelectedItem() + "") + " "
                    + TglAsuhan.getSelectedItem().toString().substring(11, 19),
                    Informasi.getSelectedItem().toString(), TD.getText(), Nadi.getText(), RR.getText(),
                    Suhu.getText(), GCS.getText(), BB.getText(), TB.getText(), LILA.getText(), BMI.getText(),
                    TFU.getText(), TBJ.getText(), Letak.getText(), Presentasi.getText(), Penurunan.getText(),
                    Kontraksi.getText(), Kekuatan.getText(), Lamanya.getText(), BJJ.getText(),
                    KeteranganBJJ.getSelectedItem().toString(), Portio.getText(), PembukaanServiks.getText(),
                    Ketuban.getText(), Hodge.getText(), Inspekulo.getSelectedItem().toString(),
                    KeteranganInspekulo.getText(), CTG.getSelectedItem().toString(), KeteranganCTG.getText(),
                    USG.getSelectedItem().toString(), KeteranganUSG.getText(),
                    Laboratorium.getSelectedItem().toString(), KeteranganLaboratorium.getText(),
                    Lakmus.getSelectedItem().toString(), KeteranganLakmus.getText(),
                    PemeriksaanPanggul.getSelectedItem().toString(), KeluhanUtama.getText(), Alergi.getText(),
                    Umur.getText(), Lama.getText(), Banyaknya.getText(), HaidTerakhir.getText(), Siklus.getText(),
                    KetSiklus.getSelectedItem().toString(), KetSiklus2.getSelectedItem().toString(),
                    StatusMenikah.getSelectedItem().toString(), KaliMenikah.getText(), UsiaKawin1.getText(),
                    StatusKawin1.getSelectedItem().toString(), UsiaKawin2.getText(),
                    StatusKawin2.getSelectedItem().toString(), UsiaKawin3.getText(),
                    StatusKawin3.getSelectedItem().toString(), Valid.SetTgl(HPHT.getSelectedItem() + ""),
                    UsiaKehamilan.getText(), Valid.SetTgl(TP.getSelectedItem() + ""),
                    RiwayatImunisasi.getSelectedItem().toString(), JumlahImunisasi.getText(), G.getText(),
                    P.getText(), A.getText(), Hidup.getText(), RiwayatGenekologi.getSelectedItem().toString(),
                    KebiasaanObat.getSelectedItem().toString(), KebiasaanObatDiminum.getText(),
                    ...
                    KebiasaanNarkoba.getSelectedItem().toString(), RiwayatKB.getSelectedItem().toString(),
                    LamanyaKB.getText(), KomplikasiKB.getSelectedItem().toString(),
                    KeteranganKomplikasiKB.getText(), BerhentiKB.getText(), AlasanBerhentiKB.getText(),
                    AlatBantu.getSelectedItem().toString(), KetBantu.getText(),
                    Prothesa.getSelectedItem().toString(), KetProthesa.getText(), ADL.getSelectedItem().toString(),
                    StatusPsiko.getSelectedItem().toString(), KetPsiko.getText(),
                    HubunganKeluarga.getSelectedItem().toString(), TinggalDengan.getSelectedItem().toString(),
                    KetTinggal.getText(), Ekonomi.getSelectedItem().toString(),
                    StatusBudaya.getSelectedItem().toString(), KetBudaya.getText(),
                    Edukasi.getSelectedItem().toString(), KetEdukasi.getText(), Agama.getText(),
                    Wajib.getSelectedItem().toString(), KetHalanganLain.getText(),
                    Toharah.getSelectedItem().toString(), Sholat.getSelectedItem().toString(),
                    MotivasiKesembuhanIbadah.getSelectedItem().toString(), RJa1.getSelectedItem().toString(),
                    RJa2.getSelectedItem().toString(), RJb.getSelectedItem().toString(),
                    Hasil.getSelectedItem().toString(), Lapor.getSelectedItem().toString(), KetLapor.getText(),
                    SG1.getSelectedItem().toString(), Nilai1.getSelectedItem().toString(),
                    SG2.getSelectedItem().toString(), Nilai2.getSelectedItem().toString(), TotalHasil.getText(),
                    ...
                    PadaDokter.getSelectedItem().toString(), KetDokter.getText(), Masalah.getText(),
            ...
            tbObat.setValueAt(Valid.SetTgl(TglAsuhan.getSelectedItem() + "") + " "
                    + TglAsuhan.getSelectedItem().toString().substring(11, 19), tbObat.getSelectedRow(), 8);
            ...
            tbObat.setValueAt(Alergi.getText(), tbObat.getSelectedRow(), 45);
            tbObat.setValueAt(Umur.getText(), tbObat.getSelectedRow(), 46);
            tbObat.setValueAt(Lama.getText(), tbObat.getSelectedRow(), 47);
            tbObat.setValueAt(Banyaknya.getText(), tbObat.getSelectedRow(), 48);
            tbObat.setValueAt(HaidTerakhir.getText(), tbObat.getSelectedRow(), 49);
            tbObat.setValueAt(Siklus.getText(), tbObat.getSelectedRow(), 50);
            tbObat.setValueAt(KetSiklus.getSelectedItem().toString(), tbObat.getSelectedRow(), 51);
            tbObat.setValueAt(KetSiklus2.getSelectedItem().toString(), tbObat.getSelectedRow(), 52);
            tbObat.setValueAt(StatusMenikah.getSelectedItem().toString(), tbObat.getSelectedRow(), 53);
            tbObat.setValueAt(KaliMenikah.getText(), tbObat.getSelectedRow(), 54);
            tbObat.setValueAt(UsiaKawin1.getText(), tbObat.getSelectedRow(), 55);
            tbObat.setValueAt(StatusKawin1.getSelectedItem().toString(), tbObat.getSelectedRow(), 56);
            tbObat.setValueAt(UsiaKawin2.getText(), tbObat.getSelectedRow(), 57);
            tbObat.setValueAt(StatusKawin2.getSelectedItem().toString(), tbObat.getSelectedRow(), 58);
            tbObat.setValueAt(UsiaKawin3.getText(), tbObat.getSelectedRow(), 59);
            tbObat.setValueAt(StatusKawin3.getSelectedItem().toString(), tbObat.getSelectedRow(), 60);
            tbObat.setValueAt(Valid.SetTgl(HPHT.getSelectedItem() + ""), tbObat.getSelectedRow(), 61);
            tbObat.setValueAt(UsiaKehamilan.getText(), tbObat.getSelectedRow(), 62);
            tbObat.setValueAt(Valid.SetTgl(TP.getSelectedItem() + ""), tbObat.getSelectedRow(), 63);
            tbObat.setValueAt(RiwayatImunisasi.getSelectedItem().toString(), tbObat.getSelectedRow(), 64);
            tbObat.setValueAt(JumlahImunisasi.getText(), tbObat.getSelectedRow(), 65);
            tbObat.setValueAt(G.getText(), tbObat.getSelectedRow(), 66);
            tbObat.setValueAt(P.getText(), tbObat.getSelectedRow(), 67);
            tbObat.setValueAt(A.getText(), tbObat.getSelectedRow(), 68);
            tbObat.setValueAt(Hidup.getText(), tbObat.getSelectedRow(), 69);
            tbObat.setValueAt(RiwayatGenekologi.getSelectedItem().toString(), tbObat.getSelectedRow(), 70);
            tbObat.setValueAt(KebiasaanObat.getSelectedItem().toString(), tbObat.getSelectedRow(), 71);
            tbObat.setValueAt(KebiasaanObatDiminum.getText(), tbObat.getSelectedRow(), 72);
            tbObat.setValueAt(KebiasaanMerokok.getSelectedItem().toString(), tbObat.getSelectedRow(), 73);
            tbObat.setValueAt(KebiasaanJumlahRokok.getText(), tbObat.getSelectedRow(), 74);
            tbObat.setValueAt(KebiasaanAlkohol.getSelectedItem().toString(), tbObat.getSelectedRow(), 75);
            tbObat.setValueAt(KebiasaanJumlahAlkohol.getText(), tbObat.getSelectedRow(), 76);
            tbObat.setValueAt(KebiasaanNarkoba.getSelectedItem().toString(), tbObat.getSelectedRow(), 77);
            tbObat.setValueAt(RiwayatKB.getSelectedItem().toString(), tbObat.getSelectedRow(), 78);
            tbObat.setValueAt(LamanyaKB.getText(), tbObat.getSelectedRow(), 79);
            tbObat.setValueAt(KomplikasiKB.getSelectedItem().toString(), tbObat.getSelectedRow(), 80);
            tbObat.setValueAt(KeteranganKomplikasiKB.getText(), tbObat.getSelectedRow(), 81);
            tbObat.setValueAt(BerhentiKB.getText(), tbObat.getSelectedRow(), 82);
            tbObat.setValueAt(AlasanBerhentiKB.getText(), tbObat.getSelectedRow(), 83);
            tbObat.setValueAt(AlatBantu.getSelectedItem().toString(), tbObat.getSelectedRow(), 84);
            tbObat.setValueAt(KetBantu.getText(), tbObat.getSelectedRow(), 85);
            tbObat.setValueAt(Prothesa.getSelectedItem().toString(), tbObat.getSelectedRow(), 86);
            tbObat.setValueAt(KetProthesa.getText(), tbObat.getSelectedRow(), 87);
            tbObat.setValueAt(ADL.getSelectedItem().toString(), tbObat.getSelectedRow(), 88);
            tbObat.setValueAt(StatusPsiko.getSelectedItem().toString(), tbObat.getSelectedRow(), 89);
            tbObat.setValueAt(KetPsiko.getText(), tbObat.getSelectedRow(), 90);
            tbObat.setValueAt(HubunganKeluarga.getSelectedItem().toString(), tbObat.getSelectedRow(), 91);
            tbObat.setValueAt(TinggalDengan.getSelectedItem().toString(), tbObat.getSelectedRow(), 92);
            tbObat.setValueAt(KetTinggal.getText(), tbObat.getSelectedRow(), 93);
            tbObat.setValueAt(Ekonomi.getSelectedItem().toString(), tbObat.getSelectedRow(), 94);
            tbObat.setValueAt(StatusBudaya.getSelectedItem().toString(), tbObat.getSelectedRow(), 95);
            tbObat.setValueAt(KetBudaya.getText(), tbObat.getSelectedRow(), 96);
            tbObat.setValueAt(Edukasi.getSelectedItem().toString(), tbObat.getSelectedRow(), 97);
            tbObat.setValueAt(KetEdukasi.getText(), tbObat.getSelectedRow(), 98);
            tbObat.setValueAt(Agama.getText(), tbObat.getSelectedRow(), 99);
            tbObat.setValueAt(Wajib.getSelectedItem().toString(), tbObat.getSelectedRow(), 100);
            tbObat.setValueAt(KetHalanganLain.getText(), tbObat.getSelectedRow(), 101);
            tbObat.setValueAt(Toharah.getSelectedItem().toString(), tbObat.getSelectedRow(), 102);
            tbObat.setValueAt(Sholat.getSelectedItem().toString(), tbObat.getSelectedRow(), 103);
            tbObat.setValueAt(MotivasiKesembuhanIbadah.getSelectedItem().toString(), tbObat.getSelectedRow(), 104);
            tbObat.setValueAt(RJa1.getSelectedItem().toString(), tbObat.getSelectedRow(), 105);
            tbObat.setValueAt(RJa2.getSelectedItem().toString(), tbObat.getSelectedRow(), 106);
            tbObat.setValueAt(RJb.getSelectedItem().toString(), tbObat.getSelectedRow(), 107);
            tbObat.setValueAt(Hasil.getSelectedItem().toString(), tbObat.getSelectedRow(), 108);
            tbObat.setValueAt(Lapor.getSelectedItem().toString(), tbObat.getSelectedRow(), 109);
            tbObat.setValueAt(KetLapor.getText(), tbObat.getSelectedRow(), 110);
            tbObat.setValueAt(SG1.getSelectedItem().toString(), tbObat.getSelectedRow(), 111);
            tbObat.setValueAt(Nilai1.getSelectedItem().toString(), tbObat.getSelectedRow(), 112);
            tbObat.setValueAt(SG2.getSelectedItem().toString(), tbObat.getSelectedRow(), 113);
            tbObat.setValueAt(Nilai2.getSelectedItem().toString(), tbObat.getSelectedRow(), 114);
            tbObat.setValueAt(TotalHasil.getText(), tbObat.getSelectedRow(), 115);
            tbObat.setValueAt(Nyeri.getSelectedItem().toString(), tbObat.getSelectedRow(), 116);
            tbObat.setValueAt(Provokes.getSelectedItem().toString(), tbObat.getSelectedRow(), 117);
            tbObat.setValueAt(KetProvokes.getText(), tbObat.getSelectedRow(), 118);
            tbObat.setValueAt(Quality.getSelectedItem().toString(), tbObat.getSelectedRow(), 119);
            tbObat.setValueAt(KetQuality.getText(), tbObat.getSelectedRow(), 120);
            tbObat.setValueAt(Lokasi.getText(), tbObat.getSelectedRow(), 121);
            tbObat.setValueAt(Menyebar.getSelectedItem().toString(), tbObat.getSelectedRow(), 122);
            tbObat.setValueAt(SkalaNyeri.getSelectedItem().toString(), tbObat.getSelectedRow(), 123);
            tbObat.setValueAt(Durasi.getText(), tbObat.getSelectedRow(), 124);
            tbObat.setValueAt(NyeriHilang.getSelectedItem().toString(), tbObat.getSelectedRow(), 125);
            tbObat.setValueAt(KetNyeri.getText(), tbObat.getSelectedRow(), 126);
            tbObat.setValueAt(PadaDokter.getSelectedItem().toString(), tbObat.getSelectedRow(), 127);
            tbObat.setValueAt(KetDokter.getText(), tbObat.getSelectedRow(), 128);
            tbObat.setValueAt(Masalah.getText(), tbObat.getSelectedRow(), 129);
            tbObat.setValueAt(Rencana.getText(), tbObat.getSelectedRow(), 130);
            tbObat.setValueAt(KdPetugas.getText(), tbObat.getSelectedRow(), 131);
            tbObat.setValueAt(NmPetugas.getText(), tbObat.getSelectedRow(), 132);
            Valid.tabelKosong(tabModeRiwayatKehamilan2);
            for (i = 0; i < tbRiwayatKehamilan.getRowCount(); i++) {
                tabModeRiwayatKehamilan2.addRow(new String[]{tbRiwayatKehamilan.getValueAt(i, 0).toString(),
                    tbRiwayatKehamilan.getValueAt(i, 1).toString(), tbRiwayatKehamilan.getValueAt(i, 2).toString(),
                    tbRiwayatKehamilan.getValueAt(i, 3).toString(), tbRiwayatKehamilan.getValueAt(i, 4).toString(),
                    tbRiwayatKehamilan.getValueAt(i, 5).toString(), tbRiwayatKehamilan.getValueAt(i, 6).toString(),
                    tbRiwayatKehamilan.getValueAt(i, 7).toString(), tbRiwayatKehamilan.getValueAt(i, 8).toString(),
            ...
            for (i = 0; i < tbMasalahKeperawatanKebidanan.getRowCount(); i++) {
                if (tbMasalahKeperawatanKebidanan.getValueAt(i, 0).toString().equals("true")) {
                    Sequel.menyimpan2("penilaian_awal_keperawatan_kebidanan_masalah_igd", "?,?", 2, new String[]{
                        TNoRw.getText(), tbMasalahKeperawatanKebidanan.getValueAt(i, 1).toString()});
                }
            }
            Sequel.meghapus("penilaian_awal_keperawatan_kebidanan_rencana_igd", "no_rawat",
                    tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString());
            for (i = 0; i < tbRencanaKeperawatanKebidanan.getRowCount(); i++) {
                if (tbRencanaKeperawatanKebidanan.getValueAt(i, 0).toString().equals("true")) {
                    Sequel.menyimpan2("penilaian_awal_keperawatan_kebidanan_rencana_igd", "?,?", 2, new String[]{
                        TNoRw.getText(), tbRencanaKeperawatanKebidanan.getValueAt(i, 1).toString()});
                }
            }
            getMasalah();
    ...
    private void simpan() {
        if (Sequel.menyimpantf("penilaian_awal_keperawatan_kebidanan_igd",
                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                "No.Rawat", 125,
                new String[]{TNoRw.getText(),
                    Valid.SetTgl(TglAsuhan.getSelectedItem() + "") + " "
                    ...
                    NyeriHilang.getSelectedItem().toString(), KetNyeri.getText(),
                    PadaDokter.getSelectedItem().toString(), KetDokter.getText(), Masalah.getText(),
                    Rencana.getText(), KdPetugas.getText()}) == true) {
            tabMode.addRow(new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), Jk.getText(),
                Agama.getText(), Bahasa.getText(), CacatFisik.getText(), TglLahir.getText(),
                Valid.SetTgl(TglAsuhan.getSelectedItem() + "") + " "
                + TglAsuhan.getSelectedItem().toString().substring(11, 19),
                Informasi.getSelectedItem().toString(), TD.getText(), Nadi.getText(), RR.getText(), Suhu.getText(),
                GCS.getText(), BB.getText(), TB.getText(), LILA.getText(), BMI.getText(), TFU.getText(),
                TBJ.getText(), Letak.getText(), Presentasi.getText(), Penurunan.getText(), Kontraksi.getText(),
                Kekuatan.getText(), Lamanya.getText(), BJJ.getText(), KeteranganBJJ.getSelectedItem().toString(),
                Portio.getText(), PembukaanServiks.getText(), Ketuban.getText(), Hodge.getText(),
                Inspekulo.getSelectedItem().toString(), KeteranganInspekulo.getText(),
                CTG.getSelectedItem().toString(), KeteranganCTG.getText(), USG.getSelectedItem().toString(),
                KeteranganUSG.getText(), Laboratorium.getSelectedItem().toString(),
                KeteranganLaboratorium.getText(), Lakmus.getSelectedItem().toString(), KeteranganLakmus.getText(),
                PemeriksaanPanggul.getSelectedItem().toString(), KeluhanUtama.getText(), Alergi.getText(),
                Umur.getText(), Lama.getText(), Banyaknya.getText(), HaidTerakhir.getText(), Siklus.getText(),
                KetSiklus.getSelectedItem().toString(), KetSiklus2.getSelectedItem().toString(),
                StatusMenikah.getSelectedItem().toString(), KaliMenikah.getText(), UsiaKawin1.getText(),
                ...
                StatusKawin3.getSelectedItem().toString(), Valid.SetTgl(HPHT.getSelectedItem() + ""),
                UsiaKehamilan.getText(), Valid.SetTgl(TP.getSelectedItem() + ""),
                RiwayatImunisasi.getSelectedItem().toString(), JumlahImunisasi.getText(), G.getText(), P.getText(),
                A.getText(), Hidup.getText(), RiwayatGenekologi.getSelectedItem().toString(),
                KebiasaanObat.getSelectedItem().toString(), KebiasaanObatDiminum.getText(),
                KebiasaanMerokok.getSelectedItem().toString(), KebiasaanJumlahRokok.getText(),
                KebiasaanAlkohol.getSelectedItem().toString(), KebiasaanJumlahAlkohol.getText(),
                KebiasaanNarkoba.getSelectedItem().toString(), RiwayatKB.getSelectedItem().toString(),
                LamanyaKB.getText(), KomplikasiKB.getSelectedItem().toString(), KeteranganKomplikasiKB.getText(),
                BerhentiKB.getText(), AlasanBerhentiKB.getText(), AlatBantu.getSelectedItem().toString(),
                KetBantu.getText(), Prothesa.getSelectedItem().toString(), KetProthesa.getText(),
                ADL.getSelectedItem().toString(), StatusPsiko.getSelectedItem().toString(), KetPsiko.getText(),
                HubunganKeluarga.getSelectedItem().toString(), TinggalDengan.getSelectedItem().toString(),
                KetTinggal.getText(), Ekonomi.getSelectedItem().toString(),
                StatusBudaya.getSelectedItem().toString(), KetBudaya.getText(),
                Edukasi.getSelectedItem().toString(), KetEdukasi.getText(), Agama.getText(),
                ...
                RJa1.getSelectedItem().toString(), RJa2.getSelectedItem().toString(),
                RJb.getSelectedItem().toString(), Hasil.getSelectedItem().toString(),
                Lapor.getSelectedItem().toString(), KetLapor.getText(), SG1.getSelectedItem().toString(),
                Nilai1.getSelectedItem().toString(), SG2.getSelectedItem().toString(),
                Nilai2.getSelectedItem().toString(), TotalHasil.getText(), Nyeri.getSelectedItem().toString(),
                Provokes.getSelectedItem().toString(), KetProvokes.getText(), Quality.getSelectedItem().toString(),
                KetQuality.getText(), Lokasi.getText(), Menyebar.getSelectedItem().toString(),
                SkalaNyeri.getSelectedItem().toString(), Durasi.getText(), NyeriHilang.getSelectedItem().toString(),
                KetNyeri.getText(), PadaDokter.getSelectedItem().toString(), KetDokter.getText(), Masalah.getText(),
                Rencana.getText(), KdPetugas.getText(), NmPetugas.getText()});
            LCount.setText("" + tabMode.getRowCount());
            Valid.tabelKosong(tabModeRiwayatKehamilan2);
            for (i = 0; i < tbRiwayatKehamilan.getRowCount(); i++) {
                tabModeRiwayatKehamilan2.addRow(new String[]{tbRiwayatKehamilan.getValueAt(i, 0).toString(),
    ...
    private static final Logger LOG = Logger.getLogger(RMPenilaianAwalKeperawatanKebidananIGD.class.getName());
