 ...
 * @author perpustakaan
 */
public class RMPenilaianLanjutanRisikoJatuhAnak extends javax.swing.JDialog {
    ...
    public RMPenilaianLanjutanRisikoJatuhAnak(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Tgl.Lahir", "JK", "Tanggal",
                    "Skala Humpty Dumpty 1", "N.H. 1", "Skala Humpty Dumpty 2", "N.H. 2", "Skala Humpty Dumpty 3",
                    "N.H. 3", "Skala Humpty Dumpty 4", "N.H. 4", "Skala Humpty Dumpty 5", "N.H. 5",
                    "Skala Humpty Dumpty 6", "N.H. 6", "Skala Humpty Dumpty 7", "N.H. 7", "Total", "Hasil Skrining",
                    "Saran", "NIP", "Petugas"}) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().trim().isEmpty() || TPasien.getText().trim().
            ...
            if (Sequel.menyimpantf("penilaian_lanjutan_resiko_jatuh_anak",
                    "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 20,
                    new String[]{
                ...
                tabMode.addRow(new String[]{
                    ...
                    SkalaResiko7.getSelectedItem().toString(), NilaiResiko7.
                    getText(), NilaiResikoTotal.getText(), HasilSkrining.
                    getText(), Saran.getText(), NIP.getText(), NamaPetugas.
                    getText()
                });
                emptTeks();
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptLanjutanRisikoJatuhAnak.jasper", "report",
                        "::[ Data Penilaian Lanjutan Risiko Jatuh Anak ]::",
                        ...
                        + "penilaian_lanjutan_resiko_jatuh_anak.tanggal between '" + Valid.
                ...
                Valid.MyReportqry("rptLanjutanRisikoJatuhAnak.jasper", "report",
                        ...
                        + "(reg_periksa.no_rawat like '%" + TCari.getText().
                                ...
                                getText().trim() + "%' "
                        + "or penilaian_lanjutan_resiko_jatuh_anak.nip like '%" + TCari.
        ...
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("finger",
                    ...
                    isEmpty() ? tbObat.getValueAt(tbObat.getSelectedRow(), 21).
                            ...
                            getSelectedItem());
            Valid.MyReportqry(
                    "rptFormulirPenilaianLanjutanRisikoJatuhAnak.jasper",
                    "report",
                    "::[ Formulir Penilaian Lanjutan Risiko Jatuh Anak ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,penilaian_lanjutan_resiko_jatuh_anak.tanggal,"
                    + "penilaian_lanjutan_resiko_jatuh_anak.penilaian_humptydumpty_skala1,penilaian_lanjutan_resiko_jatuh_anak.penilaian_humptydumpty_nilai1,"
                    + "penilaian_lanjutan_resiko_jatuh_anak.penilaian_humptydumpty_skala2,penilaian_lanjutan_resiko_jatuh_anak.penilaian_humptydumpty_nilai2,"
                    + "penilaian_lanjutan_resiko_jatuh_anak.penilaian_humptydumpty_skala3,penilaian_lanjutan_resiko_jatuh_anak.penilaian_humptydumpty_nilai3,"
                    ...
                    + "from penilaian_lanjutan_resiko_jatuh_anak inner join reg_periksa on penilaian_lanjutan_resiko_jatuh_anak.no_rawat=reg_periksa.no_rawat "
                    + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join petugas on penilaian_lanjutan_resiko_jatuh_anak.nip=petugas.nip where reg_periksa.no_rawat='" + tbObat.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianLanjutanRisikoJatuhAnak dialog = new RMPenilaianLanjutanRisikoJatuhAnak(new javax.swing.JFrame(),
                    true);
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("tanggal"), rs.getString("penilaian_humptydumpty_skala1"),
                        ...
                        rs.getString("penilaian_humptydumpty_totalnilai"), rs.getString("hasil_skrining"),
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_lanjutan_resiko_jatuh_anak", "tanggal=? and no_rawat=?",
                "no_rawat=?,tanggal=?,penilaian_humptydumpty_skala1=?,penilaian_humptydumpty_nilai1=?,"
                ...
                + "penilaian_humptydumpty_skala7=?,penilaian_humptydumpty_nilai7=?,penilaian_humptydumpty_totalnilai=?,hasil_skrining=?,saran=?,nip=?",
                22,
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_lanjutan_resiko_jatuh_anak where tanggal=? and no_rawat=?", 2,
    ...
    private void isTotalResikoJatuh() {
        try {
            ...
            if (Integer.parseInt(NilaiResikoTotal.getText()) < 12) {
                ...
                TingkatResiko.setText(
                        "Tingkat Resiko : Risiko Rendah (0-7), Tindakan : Intervensi pencegahan risiko jatuh standar");
            }
        } catch (Exception e) {
            NilaiResikoTotal.setText("0");
            TingkatResiko
                    .setText("Tingkat Resiko : Risiko Rendah (0-7), Tindakan : Intervensi pencegahan risiko jatuh standar");
        }
    }

    private static final Logger LOG = Logger.getLogger(RMPenilaianLanjutanRisikoJatuhAnak.class.getName());
