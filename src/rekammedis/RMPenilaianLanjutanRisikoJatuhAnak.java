...
public class RMPenilaianLanjutanRisikoJatuhAnak extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMPenilaianLanjutanRisikoJatuhAnak(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Skala Humpty Dumpty 1", "N.H. 1",
            "Skala Humpty Dumpty 2", "N.H. 2", "Skala Humpty Dumpty 3", "N.H. 3",
            "Skala Humpty Dumpty 4", "N.H. 4", "Skala Humpty Dumpty 5", "N.H. 5",
            "Skala Humpty Dumpty 6", "N.H. 6", "Skala Humpty Dumpty 7", "N.H. 7",
            "Total", "Hasil Skrining", "Saran", "NIP", "Petugas"
        }) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianLanjutanRisikoJatuhAnak dialog = new RMPenilaianLanjutanRisikoJatuhAnak(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("penilaian_humptydumpty_skala1"), rs.
                        getString("penilaian_humptydumpty_nilai1"), rs.
                        getString("penilaian_humptydumpty_skala2"), rs.
                        getString("penilaian_humptydumpty_nilai2"),
                        rs.getString("penilaian_humptydumpty_skala3"), rs.
                        getString("penilaian_humptydumpty_nilai3"), rs.
                        getString("penilaian_humptydumpty_skala4"), rs.
                        getString("penilaian_humptydumpty_nilai4"),
                        rs.getString("penilaian_humptydumpty_skala5"), rs.
                        getString("penilaian_humptydumpty_nilai5"), rs.
                        getString("penilaian_humptydumpty_skala6"), rs.
                        getString("penilaian_humptydumpty_nilai6"),
                        rs.getString("penilaian_humptydumpty_skala7"), rs.
                        getString("penilaian_humptydumpty_nilai7"), rs.
                        getString("penilaian_humptydumpty_totalnilai"), rs.
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            HasilSkrining.setText(
                    tbObat.getValueAt(tbObat.getSelectedRow(), 21).toString());
            Saran.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 22).
                    toString());
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_lanjutan_resiko_jatuh_anak",
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from penilaian_lanjutan_resiko_jatuh_anak where tanggal=? and no_rawat=?",
                2, new String[]{
                    tbObat.getValueAt(tbObat.getSelectedRow(), 5).toString(),
                    tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
                }) == true) {
    ...
    private static final Logger LOG = Logger.getLogger(
            RMPenilaianLanjutanRisikoJatuhAnak.class.getName());
}
