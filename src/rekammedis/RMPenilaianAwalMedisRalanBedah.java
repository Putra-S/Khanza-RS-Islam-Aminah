 ...
 * @author perpustakaan
 */
public class RMPenilaianAwalMedisRalanBedah extends javax.swing.JDialog {
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRalanBedah.jasper",
                    "report",
                    "::[ Laporan Penilaian Awal Medis Rawat Jalan Bedah ]::",
                    ...
                    + "where penilaian_medis_ralan_bedah.no_rawat='" + tbObat.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRalanBedah dialog = new RMPenilaianAwalMedisRalanBedah(
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from penilaian_medis_ralan_bedah where no_rawat=?", 1,
                new String[]{
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_ralan_bedah", "no_rawat=?",
            ...
            tbObat.setValueAt(Ekstremitas.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 27);
            tbObat.setValueAt(Genetalia.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 28);
            tbObat.setValueAt(Columna.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 29);
            tbObat.setValueAt(Muskulos.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 30);
    ...
    private void simpan() {
        if (Sequel.menyimpantf("penilaian_medis_ralan_bedah",
                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
            ...
            tabMode.addRow(new String[]{
                ...
                toString(), Status.getText(), TD.getText(), Nadi.getText(),
                Suhu.getText(), RR.getText(), BB.getText(), Nyeri.getText(),
                GCS.getText(), Kepala.getSelectedItem().toString(), Thoraks.
                getSelectedItem().toString(), Abdomen.getSelectedItem().
                toString(), Ekstremitas.getSelectedItem().toString(),
                Genetalia.getSelectedItem().toString(), Columna.
                getSelectedItem().toString(), Muskulos.getSelectedItem().
                toString(), Lainnya.getText(), KetLokalis.getText(), Lab.
                getText(), Rad.getText(), PenunjangLain.getText(), Diagnosis.
                getText(),
    ...
    private static final Logger LOG = Logger.getLogger(
            RMPenilaianAwalMedisRalanBedah.class.getName());
}
