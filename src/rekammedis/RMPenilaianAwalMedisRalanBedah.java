...
public class RMPenilaianAwalMedisRalanBedah extends javax.swing.JDialog {
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_medis_ralan_bedah where no_rawat=?", 1,
    ...
    private void simpan() {
        if (Sequel.menyimpantf("penilaian_medis_ralan_bedah",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    Muskulos.getSelectedItem().toString(), Lainnya.getText(), KetLokalis.getText(), Lab.getText(),
                    Rad.getText(), PenunjangLain.getText(), Diagnosis.getText(), Diagnosis2.getText(),
                    Permasalahan.getText(), Terapi.getText(), Tindakan.getText(), Edukasi.getText()}) == true) {
            tabMode.addRow(new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), TglLahir.getText(),
                ...
                RPD.getText(), RPO.getText(), Alergi.getText(), Kesadaran.getSelectedItem().toString(),
                Status.getText(), TD.getText(), Nadi.getText(), Suhu.getText(), RR.getText(), BB.getText(),
                Nyeri.getText(), GCS.getText(), Kepala.getSelectedItem().toString(),
                Thoraks.getSelectedItem().toString(), Abdomen.getSelectedItem().toString(),
                Ekstremitas.getSelectedItem().toString(), Genetalia.getSelectedItem().toString(),
                Columna.getSelectedItem().toString(), Muskulos.getSelectedItem().toString(), Lainnya.getText(),
                KetLokalis.getText(), Lab.getText(), Rad.getText(), PenunjangLain.getText(), Diagnosis.getText(),
    ...
    private static final Logger LOG = Logger.getLogger(RMPenilaianAwalMedisRalanBedah.class.getName());
