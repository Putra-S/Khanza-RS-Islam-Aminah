...
public class RMDataCatatanKeperawatanRanap extends javax.swing.JDialog {
    ...
    public RMDataCatatanKeperawatanRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Tanggal", "Jam", "Uraian", "NIP", "Nama Petugas"
        }) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataCatatanKeperawatanRanap dialog = new RMDataCatatanKeperawatanRanap(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        getString("uraian"), rs.getString("nip"),
                        rs.getString("nama")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Uraian.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 8).
                    toString());
    ...
    private void ganti() {
        if (Sequel.mengedittf("catatan_keperawatan_ranap",
                ...
                "no_rawat=?,tanggal=?,jam=?,uraian=?,nip=?", 8, new String[]{
                    ...
                    getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
                    getSelectedItem(),
                    Uraian.getText(), NIP.getText(), tbObat.getValueAt(tbObat.
                    getSelectedRow(), 6).toString(), tbObat.getValueAt(tbObat.
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from catatan_keperawatan_ranap where tanggal=? and jam=? and no_rawat=?",
                3, new String[]{
    ...
    private void simpan() {
        if (Sequel.menyimpantf("catatan_keperawatan_ranap", "?,?,?,?,?", "Data",
                5, new String[]{
                    Valid.SetTgl(Tanggal.getSelectedItem() + ""), Jam.
                    getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
                    getSelectedItem(), TNoRw.getText(), Uraian.getText(), NIP.
                    getText()
                }) == true) {
            tabMode.addRow(new String[]{
                TNoRw.getText(), TNoRM.getText(), TPasien.getText(), Umur.
                getText(), JK.getText(), TglLahir.getText(), Valid.SetTgl(
                Tanggal.getSelectedItem() + ""),
                Jam.getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
                getSelectedItem(), Uraian.getText(), NIP.getText(), NamaPetugas.
                getText()
            });
            LCount.setText("" + tabMode.getRowCount());
            emptTeks();
    ...
    private static final Logger LOG = Logger.getLogger(
            RMDataCatatanKeperawatanRanap.class.getName());
}
