 ...
 * @author perpustakaan
 */
public class RMDataCatatanKeperawatanRanap extends javax.swing.JDialog {
    ...
    public RMDataCatatanKeperawatanRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Umur", "JK",
            "Tgl.Lahir", "Tanggal", "Jam", "Uraian", "NIP", "Nama Petugas"}) {
            @Override
        ...
        Uraian.setDocument(new batasInput(2000).getKata(Uraian));
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-04-2023" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-04-2023" }));
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-04-2023" }));
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptDataCatatanKeperawatanRanap.jasper",
                        "report", "::[ Data Catatan Keperawatan Rawat Inap ]::",
                        ...
                        + "catatan_keperawatan_ranap.tanggal between '" + Valid.
                                SetTgl(DTPCari1.getSelectedItem() + "") + "' and '" + Valid.
                        SetTgl(DTPCari2.getSelectedItem() + "") + "' order by catatan_keperawatan_ranap.tanggal,catatan_keperawatan_ranap.jam",
                        param);
            } else {
                Valid.MyReportqry("rptDataCatatanKeperawatanRanap.jasper",
                        "report", "::[ Data Catatan Keperawatan Rawat Inap ]::",
                        ...
                        + "(reg_periksa.no_rawat like '%" + TCari.getText().
                                ...
                                getText().trim() + "%' or "
                        + "pasien.nm_pasien like '%" + TCari.getText().trim() + "%' or catatan_keperawatan_ranap.nip like '%" + TCari.
    ...
    private void MnCatatanKeperawatanRawatInapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCatatanKeperawatanRawatInapActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptFormulirCatatanKeperawatanRanap.jasper",
                    "report", "::[ Formulir Catatan Keperawatan Rawat Inap ]::",
                    ...
                    + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join petugas on catatan_keperawatan_ranap.nip=petugas.nip where reg_periksa.no_rawat='" + tbObat.
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("jk"), rs.getString("tgl_lahir"), rs.getString("tanggal"), rs.getString("jam"),
                        rs.getString("uraian"), rs.getString("nip"), rs.getString("nama")});
                }
            } catch (Exception e) {
    ...
    private void ganti() {
        if (Sequel.mengedittf("catatan_keperawatan_ranap", "tanggal=? and jam=? and no_rawat=?",
                "no_rawat=?,tanggal=?,jam=?,uraian=?,nip=?", 8,
                new String[]{TNoRw.getText(), Valid.SetTgl(Tanggal.getSelectedItem() + ""),
                    ...
                    Uraian.getText(), NIP.getText(), tbObat.getValueAt(tbObat.getSelectedRow(), 6).toString(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from catatan_keperawatan_ranap where tanggal=? and jam=? and no_rawat=?", 3,
    ...
    private void simpan() {
        if (Sequel.menyimpantf("catatan_keperawatan_ranap", "?,?,?,?,?", "Data", 5,
                new String[]{Valid.SetTgl(Tanggal.getSelectedItem() + ""),
                    Jam.getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
                    TNoRw.getText(), Uraian.getText(), NIP.getText()}) == true) {
            tabMode.addRow(new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), Umur.getText(),
                ...
                Jam.getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
                Uraian.getText(), NIP.getText(), NamaPetugas.getText()});
            LCount.setText("" + tabMode.getRowCount());
            emptTeks();
        }
    }

    private static final Logger LOG = Logger.getLogger(RMDataCatatanKeperawatanRanap.class.getName());
