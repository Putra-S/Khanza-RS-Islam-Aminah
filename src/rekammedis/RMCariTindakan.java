 ...
 * @author dosen
 */
public class RMCariTindakan extends javax.swing.JDialog {
    ...
    private String[] tanggal, jam, tindakan;
    ...
    public RMCariTindakan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"P", "Tanggal", "Jam", "Tindakan/Operasi"}) {
...
//GEN-LAST:event_ppSemuaActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariTindakan dialog = new RMCariTindakan(new javax.swing.JFrame(), true);
  ...
  // End of variables declaration//GEN-END:variables
    ...
    public void tampil() {
        ...
        for (i = 0; i < tabMode.getRowCount(); i++) {
            if (tabMode.getValueAt(i, 0).toString().equals("true")) {
                ...
                tindakan[index] = tabMode.getValueAt(i, 3).toString();
                index++;
            }
        }
        ...
        for (i = 0; i < jml; i++) {
            tabMode.addRow(new Object[]{pilih[i], tanggal[i], jam[i], tindakan[i]});
        }
        Valid.tabelKosong(tabMode);
        try {
            ps = koneksi
                    .prepareStatement("select rawat_jl_dr.tgl_perawatan, rawat_jl_dr.jam_rawat, jns_perawatan.nm_perawatan "
    ...
    private static final Logger LOG = Logger.getLogger(RMCariTindakan.class.getName());
