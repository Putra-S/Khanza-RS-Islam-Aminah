...
public class MasterTriaseMacamKasus extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("master_triase_macam_kasus",
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, TKd, "master_triase_macam_kasus",
                "kode_kasus") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("master_triase_macam_kasus", "kode_kasus=?",
                        "kode_kasus=?,macam_kasus=?", 3, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterTriaseMacamKasus dialog = new MasterTriaseMacamKasus(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from master_triase_macam_kasus where master_triase_macam_kasus.kode_kasus like ? or master_triase_macam_kasus.macam_kasus like ? order by master_triase_macam_kasus.kode_kasus");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(
            MasterTriaseMacamKasus.class.getName());
}
