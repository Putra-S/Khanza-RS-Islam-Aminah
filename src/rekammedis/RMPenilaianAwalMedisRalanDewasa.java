 ...
 * @author perpustakaan
 */
public class RMPenilaianAwalMedisRalanDewasa extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisRalanDewasa(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Kepala",
            "Gigi & Mulut", "THT", "Thoraks", "Abdomen", "Genital & Anus",
            "Ekstremitas", "Kulit", "Ket.Pemeriksaan Fisik",
            "Ket.Status Lokalis", "Pemeriksaan Penunjang", "Diagnosis/Asesmen",
        ...
        KetFisik.setDocument(new batasInput(5000).getKata(KetFisik));
        ...
        Konsul.setDocument(new batasInput(1000).getKata(Konsul));
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.
                    MyReportqry("rptCetakPenilaianAwalMedisRalan.jasper",
                            "report",
                            "::[ Laporan Penilaian Awal Medis Rawat Jalan ]::",
                            ...
                            + "inner join dokter on penilaian_medis_ralan.kd_dokter=dokter.kd_dokter where penilaian_medis_ralan.no_rawat='" + tbObat.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRalanDewasa dialog = new RMPenilaianAwalMedisRalanDewasa(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        getString("ket_lokalis"), rs.getString("penunjang"), rs.
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Gigi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 27).
                    toString());
            THT.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 28).
                    toString());
            ...
            KetFisik.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 34).
                    toString());
            KetLokalis.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 35).
                    toString());
            Penunjang.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 36).
                    toString());
            Diagnosis.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 37).
                    toString());
            Tatalaksana.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 38).
                    toString());
            Konsul.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 39).
                    toString());
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from penilaian_medis_ralan where no_rawat=?", 1,
                new String[]{
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_ralan", "no_rawat=?",
                "no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpk=?,rpd=?,rpo=?,alergi=?,keadaan=?,gcs=?,kesadaran=?,td=?,nadi=?,rr=?,suhu=?,spo=?,bb=?,tb=?,kepala=?,gigi=?,tht=?,thoraks=?,abdomen=?,genital=?,ekstremitas=?,kulit=?,ket_fisik=?,ket_lokalis=?,penunjang=?,diagnosis=?,tata=?,konsulrujuk=?",
                36, new String[]{
                    ...
                    getText(), KeluhanUtama.getText(), RPS.getText(), RPK.
                    getText(), RPD.getText(), RPO.getText(), Alergi.getText(),
                    ...
                    TB.getText(), Kepala.getSelectedItem().toString(), Gigi.
                    getSelectedItem().toString(), THT.getSelectedItem().
                            toString(), Thoraks.getSelectedItem().toString(),
                    ...
                    KetFisik.getText(), KetLokalis.getText(),
    ...
    private void simpan() {
        if (Sequel.menyimpantf("penilaian_medis_ralan",
                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                "No.Rawat", 35, new String[]{
                    TNoRw.getText(), Valid.SetTgl(
                    TglAsuhan.getSelectedItem() + "") + " " + TglAsuhan.
                    getSelectedItem().toString().substring(11, 19), KdDokter.
                    getText(), Anamnesis.getSelectedItem().toString(), Hubungan.
                    ...
                    KetLokalis.getText(), Penunjang.getText(), Diagnosis.
                    getText(), Tatalaksana.getText(), Konsul.getText()
                }) == true) {
            tabMode.addRow(new String[]{
                ...
                toString(),
                Abdomen.getSelectedItem().toString(), Genital.getSelectedItem().
                toString(), Ekstremitas.getSelectedItem().toString(), Kulit.
                getSelectedItem().toString(), KetFisik.getText(), KetLokalis.
                getText(), Penunjang.getText(), Diagnosis.getText(),
    ...
    private static final Logger LOG = Logger.getLogger(
            RMPenilaianAwalMedisRalanDewasa.class.getName());
}
