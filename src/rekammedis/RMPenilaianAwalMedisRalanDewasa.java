...
public class RMPenilaianAwalMedisRalanDewasa extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisRalanDewasa(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.",
            ...
            "Nadi(x/menit)", "RR(x/menit)", "Suhu", "SpO2", "BB(Kg)", "TB(cm)", "Kepala", "Gigi & Mulut", "THT",
            "Thoraks", "Abdomen", "Genital & Anus", "Ekstremitas", "Kulit", "Ket.Pemeriksaan Fisik",
            "Ket.Status Lokalis", "Pemeriksaan Penunjang", "Diagnosis/Asesmen", "Tatalaksana", "Konsul/Rujuk"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRalanDewasa dialog = new RMPenilaianAwalMedisRalanDewasa(new javax.swing.JFrame(),
                    true);
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("kepala"), rs.getString("gigi"), rs.getString("tht"), rs.getString("thoraks"),
                        rs.getString("abdomen"), rs.getString("genital"), rs.getString("ekstremitas"),
                        rs.getString("kulit"), rs.getString("ket_fisik"), rs.getString("ket_lokalis"),
                        rs.getString("penunjang"), rs.getString("diagnosis"), rs.getString("tata"),
                        rs.getString("konsulrujuk")});
                }
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_medis_ralan where no_rawat=?", 1,
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_ralan", "no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    Gigi.getSelectedItem().toString(), THT.getSelectedItem().toString(),
                    ...
                    Kulit.getSelectedItem().toString(), KetFisik.getText(), KetLokalis.getText(),
    ...
    private void simpan() {
        if (Sequel.menyimpantf("penilaian_medis_ralan",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    Genital.getSelectedItem().toString(), Ekstremitas.getSelectedItem().toString(),
                    Kulit.getSelectedItem().toString(), KetFisik.getText(), KetLokalis.getText(),
                    Penunjang.getText(), Diagnosis.getText(), Tatalaksana.getText(), Konsul.getText()}) == true) {
            tabMode.addRow(new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), TglLahir.getText(),
                ...
                Thoraks.getSelectedItem().toString(), Abdomen.getSelectedItem().toString(),
                Genital.getSelectedItem().toString(), Ekstremitas.getSelectedItem().toString(),
                Kulit.getSelectedItem().toString(), KetFisik.getText(), KetLokalis.getText(), Penunjang.getText(),
    ...
    private static final Logger LOG = Logger.getLogger(RMPenilaianAwalMedisRalanDewasa.class.getName());
