...
public class RMPenilaianAwalMedisRalanRehabMedik extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisRalanRehabMedik(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.", "NIP", "Nama Dokter", "Tanggal",
                    "Anamnesis", "Hubungan", "Keluhan Utama", "Riwayat Penyakit Sekarang",
                    "Riwayat Penyakit Dahulu", "Riwayat Alergi", "Kesadaran", "Nyeri", "Skala Nyeri", "TD(mmHg)",
                    "Nadi(x/menit)", "Suhu(°C)", "RR(x/menit)", "BB(Kg)", "Kepala", "Keterangan Kepala", "Thoraks",
                    "Keterangan Thoraks", "Abdomen", "Keterangan Abdomen", "Ekstremitas", "Keterangan Ekstremitas",
                    "Columna Vertebralis", "Keterangan Columna", "Muskuloskeletal", "Keterangan Muskuloskeletal",
                    "Lainnya", "Resiko Jatuh", "Resiko Nutrisional", "Kebutuhan Fungsional", "Diagnosa Medis",
                    "Diagnosa Fungsi", "Pemeriksaan Penunjang", "Fisioterapi", "Okupasi", "Wicara", "Akupuntur",
                    "Tatalaksana Lainnya", "Frekuensi Terapi", "Terapi Fisio", "Terapi Okupasi", "Terapi Wicara",
                    "Terapi Akupuntur", "Terapi Lainnya", "Edukasi"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("rps"), rs.getString("rpd"), rs.getString("alergi"), rs.getString("kesadaran"),
                        rs.getString("nyeri"), rs.getString("skala_nyeri"), rs.getString("td"),
                        rs.getString("nadi"), rs.getString("suhu"), rs.getString("rr"), rs.getString("bb"),
                        rs.getString("kepala"), rs.getString("keterangan_kepala"), rs.getString("thoraks"),
                        rs.getString("keterangan_thoraks"), rs.getString("abdomen"),
                        rs.getString("keterangan_abdomen"), rs.getString("ekstremitas"),
                        rs.getString("keterangan_ekstremitas"), rs.getString("columna"),
                        rs.getString("keterangan_columna"), rs.getString("muskulos"),
                        rs.getString("keterangan_muskulos"), rs.getString("lainnya"), rs.getString("resiko_jatuh"),
                        rs.getString("resiko_nutrisional"), rs.getString("kebutuhan_fungsional"),
                        rs.getString("diagnosa_medis"), rs.getString("diagnosa_fungsi"),
                        rs.getString("penunjang_lain"), rs.getString("fisio"), rs.getString("okupasi"),
                        rs.getString("wicara"), rs.getString("akupuntur"), rs.getString("tatalain"),
                        rs.getString("frekuensi_terapi"), rs.getString("fisioterapi"),
                        rs.getString("terapi_okupasi"), rs.getString("terapi_wicara"),
                        rs.getString("terapi_akupuntur"), rs.getString("terapi_lainnya"),
    ...
    public void isCek() {
        ...
        if (akses.getjml2() >= 1) {
            ...
            Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?", NmDokter,
                    KdDokter.getText());
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_medis_ralan_rehab_medik where no_rawat=?", 1,
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_ralan_rehab_medik", "no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    Kesadaran.getSelectedItem().toString(), Nyeri.getSelectedItem().toString(),
                    SkalaNyeri.getSelectedItem().toString(), TD.getText(), Nadi.getText(), Suhu.getText(),
                    RR.getText(), BB.getText(), Kepala.getSelectedItem().toString(), KeteranganKepala.getText(),
                    Thoraks.getSelectedItem().toString(), KeteranganThoraks.getText(),
                    Abdomen.getSelectedItem().toString(), KeteranganAbdomen.getText(),
                    Ekstremitas.getSelectedItem().toString(), KeteranganEkstremitas.getText(),
                    Columna.getSelectedItem().toString(), KeteranganColumna.getText(),
                    Muskulos.getSelectedItem().toString(), KeteranganMusku.getText(), Lainnya.getText(),
                    Resikojatuh.getSelectedItem().toString(), Resikonutrisional.getSelectedItem().toString(),
                    Kebutuhanfungsional.getSelectedItem().toString(), DiagnosaMedis.getText(),
                    DiagnosaFungsi.getText(), PenunjangLain.getText(), Fisio.getText(), Okupasi.getText(),
                    Wicara.getText(), Akupuntur.getText(), Tatalainnya.getText(), Frekuensiterapi.getText(),
                    (ChkFisioterapi.isSelected() == true ? Valid.SetTgl(TglFisioterapi.getSelectedItem() + "")
                    : "0000-00-00"),
                    (ChkOkupasi.isSelected() == true ? Valid.SetTgl(TglOkupasi.getSelectedItem() + "")
                    : "0000-00-00"),
                    (ChkWicara.isSelected() == true ? Valid.SetTgl(TglWicara.getSelectedItem() + "")
                    : "0000-00-00"),
                    (ChkAkupungtur.isSelected() == true ? Valid.SetTgl(TglAkupuntur.getSelectedItem() + "")
                    : "0000-00-00"),
                    (ChkTerapiLainnya.isSelected() == true ? Valid.SetTgl(TglTerapilainnya.getSelectedItem() + "")
                    : "0000-00-00"),
    ...
    private static final Logger LOG = Logger.getLogger(RMPenilaianAwalMedisRalanRehabMedik.class.getName());
