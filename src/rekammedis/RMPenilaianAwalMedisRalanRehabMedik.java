 ...
 * @author perpustakaan
 */
public class RMPenilaianAwalMedisRalanRehabMedik extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMPenilaianAwalMedisRalanRehabMedik(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Nama Dokter", "Tanggal", "Anamnesis", "Hubungan", "Keluhan Utama",
            "Riwayat Penyakit Sekarang", "Riwayat Penyakit Dahulu",
            "Riwayat Alergi", "Kesadaran", "Nyeri", "Skala Nyeri", "TD(mmHg)",
            "Nadi(x/menit)", "Suhu(°C)", "RR(x/menit)", "BB(Kg)", "Kepala",
            "Keterangan Kepala", "Thoraks", "Keterangan Thoraks",
            "Abdomen", "Keterangan Abdomen", "Ekstremitas",
            "Keterangan Ekstremitas", "Columna Vertebralis",
            "Keterangan Columna", "Muskuloskeletal",
            "Keterangan Muskuloskeletal", "Lainnya",
            "Resiko Jatuh", "Resiko Nutrisional", "Kebutuhan Fungsional",
            "Diagnosa Medis", "Diagnosa Fungsi", "Pemeriksaan Penunjang",
            "Fisioterapi", "Okupasi", "Wicara", "Akupuntur",
            "Tatalaksana Lainnya", "Frekuensi Terapi", "Terapi Fisio",
            "Terapi Okupasi", "Terapi Wicara", "Terapi Akupuntur",
            "Terapi Lainnya", "Edukasi"
        }) {
            @Override
        ...
        KeteranganKepala.setDocument(new batasInput((byte) 30).getKata(
                KeteranganKepala));
        KeteranganThoraks.setDocument(new batasInput((byte) 30).getKata(
                KeteranganThoraks));
        KeteranganAbdomen.setDocument(new batasInput((byte) 30).getKata(
                KeteranganAbdomen));
        KeteranganMusku.setDocument(new batasInput((byte) 30).getKata(
                KeteranganMusku));
        KeteranganEkstremitas.setDocument(new batasInput((byte) 30).getKata(
                KeteranganEkstremitas));
        KeteranganColumna.setDocument(new batasInput((byte) 30).getKata(
                KeteranganColumna));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRM.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("penilaian_medis_ralan_rehab_medik",
                    "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                    "No.Rawat", 48, new String[]{
                        ...
                        Alergi.getText(), Kesadaran.getSelectedItem().toString(),
                        Nyeri.getSelectedItem().toString(), SkalaNyeri.
                        getSelectedItem().toString(), TD.getText(),
                        Nadi.getText(), Suhu.getText(), RR.getText(), BB.
                        getText(), Kepala.getSelectedItem().toString(),
                        KeteranganKepala.getText(), Thoraks.getSelectedItem().
                        toString(), KeteranganThoraks.getText(),
                        Abdomen.getSelectedItem().toString(), KeteranganAbdomen.
                        getText(), Ekstremitas.getSelectedItem().toString(),
                        KeteranganEkstremitas.getText(), Columna.
                        getSelectedItem().toString(), KeteranganColumna.
                                getText(),
                        Muskulos.getSelectedItem().toString(), KeteranganMusku.
                        getText(), Lainnya.getText(), Resikojatuh.
                        getSelectedItem().toString(), Resikonutrisional.
                                getSelectedItem().toString(),
                        Kebutuhanfungsional.getSelectedItem().toString(),
                        DiagnosaMedis.getText(), DiagnosaFungsi.getText(),
                        PenunjangLain.getText(), Fisio.getText(), Okupasi.
                        getText(), Wicara.getText(), Akupuntur.getText(),
                        Tatalainnya.getText(), Frekuensiterapi.getText(),
                        (ChkFisioterapi.isSelected() == true ? Valid.SetTgl(
                        TglFisioterapi.getSelectedItem() + "") : "0000-00-00"),
                        (ChkOkupasi.isSelected() == true ? Valid.SetTgl(
                        TglOkupasi.getSelectedItem() + "") : "0000-00-00"),
                        (ChkWicara.isSelected() == true ? Valid.SetTgl(
                        TglWicara.getSelectedItem() + "") : "0000-00-00"),
                        (ChkAkupungtur.isSelected() == true ? Valid.SetTgl(
                        TglAkupuntur.getSelectedItem() + "") : "0000-00-00"),
                        (ChkTerapiLainnya.isSelected() == true ? Valid.SetTgl(
                        TglTerapilainnya.getSelectedItem() + "") : "0000-00-00"),
                        Edukasi.getText()
                    }) == true) {
                emptTeks();
            }
            ...
            try {
                ...
                for (i = 0; i < tabMode.getRowCount(); i++) {
                    htmlContent.append("<tr class='isi'><td valign='top'>").
                            ...
                            "</td><td valign='top'>").append(tbObat.
                                    getValueAt(i, 47) == null ? "" : tbObat.
                                    getValueAt(i, 47).toString()).append(
                            "</td><td valign='top'>").append(tbObat.
                                    getValueAt(i, 48) == null ? "" : tbObat.
                                    getValueAt(i, 48).toString()).append(
                            "</td><td valign='top'>").append(tbObat.
                                    getValueAt(i, 49) == null ? "" : tbObat.
                                    getValueAt(i, 49).toString()).append(
                            "</td><td valign='top'>").append(tbObat.
                                    getValueAt(i, 50) == null ? "" : tbObat.
                                    getValueAt(i, 50).toString()).append(
                            "</td><td valign='top'>").append(tbObat.
                                    getValueAt(i, 51) == null ? "" : tbObat.
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.
                    MyReportqry(
                            "rptCetakPenilaianAwalMedisRalanRehabMedik.jasper",
                            "report",
                            "::[ Laporan Penilaian Awal Medis Rawat Jalan Kedokteran Fisik dan Rehabilitasi ]::",
                            ...
                            + "inner join dokter on penilaian_medis_ralan_rehab_medik.kd_dokter=dokter.kd_dokter where penilaian_medis_ralan_rehab_medik.no_rawat='" + tbObat.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRalanRehabMedik dialog = new RMPenilaianAwalMedisRalanRehabMedik(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        getString("rpd"), rs.getString("alergi"), rs.getString(
                        "kesadaran"), rs.getString("nyeri"),
                        rs.getString("skala_nyeri"), rs.getString("td"), rs.
                        getString("nadi"), rs.getString("suhu"), rs.getString(
                        "rr"), rs.getString("bb"), rs.getString("kepala"), rs.
                        getString("keterangan_kepala"),
                        rs.getString("thoraks"), rs.getString(
                        "keterangan_thoraks"), rs.getString("abdomen"), rs.
                        getString("keterangan_abdomen"), rs.getString(
                        "ekstremitas"), rs.getString("keterangan_ekstremitas"),
                        rs.getString("columna"), rs.getString(
                        "keterangan_columna"), rs.getString("muskulos"), rs.
                        getString("keterangan_muskulos"), rs.
                        getString("lainnya"), rs.getString("resiko_jatuh"), rs.
                        getString("resiko_nutrisional"),
                        rs.getString("kebutuhan_fungsional"), rs.getString(
                        "diagnosa_medis"), rs.getString("diagnosa_fungsi"), rs.
                        getString("penunjang_lain"), rs.getString("fisio"), rs.
                        getString("okupasi"), rs.getString("wicara"), rs.
                        getString("akupuntur"),
                        rs.getString("tatalain"), rs.getString(
                        "frekuensi_terapi"), rs.getString("fisioterapi"), rs.
                        getString("terapi_okupasi"), rs.getString(
                        "terapi_wicara"), rs.getString("terapi_akupuntur"), rs.
                        getString("terapi_lainnya"), rs.getString("edukasi")
                    });
                }
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            RPD.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 12).
                    toString());
            Alergi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 13).
                    toString());
            ...
            TD.
                    setText(tbObat.getValueAt(tbObat.getSelectedRow(), 17).
                            toString());
            Nadi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 18).
                    toString());
            Suhu.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 19).
                    toString());
            RR.
                    setText(tbObat.getValueAt(tbObat.getSelectedRow(), 20).
                            toString());
            BB.
            ...
            KeteranganKepala.setText(tbObat.getValueAt(tbObat.getSelectedRow(),
                    23).toString());
            Thoraks.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),
                    24).toString());
            KeteranganThoraks.setText(tbObat.getValueAt(tbObat.getSelectedRow(),
                    25).toString());
            Abdomen.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),
                    26).toString());
            KeteranganAbdomen.setText(tbObat.getValueAt(tbObat.getSelectedRow(),
                    27).toString());
            Ekstremitas.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 28).toString());
            KeteranganEkstremitas.setText(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 29).toString());
            Columna.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),
                    30).toString());
            KeteranganColumna.setText(tbObat.getValueAt(tbObat.getSelectedRow(),
                    31).toString());
            Muskulos.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),
                    32).toString().contains("Normal"));
            KeteranganMusku.setText(tbObat.getValueAt(tbObat.getSelectedRow(),
                    33).toString());
            Lainnya.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 34).
                    toString());
            Resikojatuh.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 35).toString());
            Resikonutrisional.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 36).toString());
            Kebutuhanfungsional.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 37).toString());
            DiagnosaMedis.setText(
                    tbObat.getValueAt(tbObat.getSelectedRow(), 38).toString());
            DiagnosaFungsi.setText(tbObat.
                    getValueAt(tbObat.getSelectedRow(), 39).toString());
            PenunjangLain.setText(
                    tbObat.getValueAt(tbObat.getSelectedRow(), 40).toString());
            Fisio.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 41).
                    toString());
            Okupasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 42).
                    toString());
            Wicara.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 43).
                    toString());
            Akupuntur.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 44).
                    toString());
            Tatalainnya.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 45).
                    toString());
            Frekuensiterapi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),
                    46).toString());
            try {
                ChkFisioterapi.setSelected(true);
                Valid.SetTgl(TglFisioterapi, tbObat.getValueAt(tbObat.
            ...
            try {
                ...
                Valid.SetTgl(TglOkupasi, tbObat.getValueAt(tbObat.
            ...
            try {
                ...
                Valid.SetTgl(TglWicara, tbObat.getValueAt(tbObat.
            ...
            try {
                ...
                Valid.SetTgl(TglAkupuntur, tbObat.getValueAt(tbObat.
            ...
            try {
                ...
                Valid.SetTgl(TglTerapilainnya, tbObat.getValueAt(tbObat.
                        getSelectedRow(), 51).toString());
            } catch (Exception e) {
                ChkTerapiLainnya.setSelected(false);
            }
            Edukasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 52).
                    toString());
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from penilaian_medis_ralan_rehab_medik where no_rawat=?",
                1, new String[]{
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_ralan_rehab_medik", "no_rawat=?",
                "no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,alergi=?,kesadaran=?,nyeri=?,skala_nyeri=?,td=?,nadi=?,suhu=?,rr=?,bb=?,"
                ...
                + "fisio=?,okupasi=?,wicara=?,akupuntur=?,tatalain=?,frekuensi_terapi=?,fisioterapi=?,terapi_okupasi=?,terapi_wicara=?,terapi_akupuntur=?,terapi_lainnya=?,edukasi=?",
                49, new String[]{
                    ...
                    Nyeri.getSelectedItem().toString(), SkalaNyeri.
                    getSelectedItem().toString(), TD.getText(),
                    Nadi.getText(), Suhu.getText(), RR.getText(), BB.getText(),
                    Kepala.getSelectedItem().toString(), KeteranganKepala.
                    getText(), Thoraks.getSelectedItem().toString(),
                    KeteranganThoraks.getText(),
                    Abdomen.getSelectedItem().toString(), KeteranganAbdomen.
                    getText(), Ekstremitas.getSelectedItem().toString(),
                    KeteranganEkstremitas.getText(), Columna.getSelectedItem().
                    toString(), KeteranganColumna.getText(),
                    Muskulos.getSelectedItem().toString(), KeteranganMusku.
                    getText(), Lainnya.getText(), Resikojatuh.getSelectedItem().
                    toString(), Resikonutrisional.getSelectedItem().toString(),
                    Kebutuhanfungsional.getSelectedItem().toString(),
                    DiagnosaMedis.getText(), DiagnosaFungsi.getText(),
                    PenunjangLain.getText(), Fisio.getText(), Okupasi.getText(),
                    Wicara.getText(), Akupuntur.getText(), Tatalainnya.getText(),
                    Frekuensiterapi.getText(),
                    (ChkFisioterapi.isSelected() == true ? Valid.SetTgl(
                    TglFisioterapi.getSelectedItem() + "") : "0000-00-00"),
                    (ChkOkupasi.isSelected() == true ? Valid.SetTgl(TglOkupasi.
                    getSelectedItem() + "") : "0000-00-00"),
                    (ChkWicara.isSelected() == true ? Valid.SetTgl(TglWicara.
                    getSelectedItem() + "") : "0000-00-00"), (ChkAkupungtur.
                            isSelected() == true ? Valid.SetTgl(TglAkupuntur.
                                    getSelectedItem() + "") : "0000-00-00"),
                    (ChkTerapiLainnya.isSelected() == true ? Valid.SetTgl(
                    TglTerapilainnya.getSelectedItem() + "") : "0000-00-00"),
                    Edukasi.getText(), tbObat.
    ...
    private static final Logger LOG = Logger.getLogger(
            RMPenilaianAwalMedisRalanRehabMedik.class.getName());
}
