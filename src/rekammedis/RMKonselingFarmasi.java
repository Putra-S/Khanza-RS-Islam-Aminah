...
public class RMKonselingFarmasi extends javax.swing.JDialog {
    ...
    public RMKonselingFarmasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.", "Kode Petugas", "Nama Petugas",
                    "Tanggal", "Diagnosa", "Alergi", "Pernah Konseling", "Nama Obat, Dosis & Cara Pemakaian",
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("diagnosa"), rs.getString("riwayat_alergi"), rs.getString("pernah_datang"),
                        rs.getString("obat_pemakaian"), rs.getString("keluhan"), rs.getString("tindak_lanjut")});
                }
            } catch (Exception e) {
    ...
    private void ganti() {
        if (Sequel.mengedittf("konseling_farmasi", "no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    Diagnosa.getText(), ObatPemakaian.getText(), Alergi.getText(), Keluhan.getText(),
                    PernahKonseling.getSelectedItem().toString(), TindakLanjut.getText(), KdPetugas.getText(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from konseling_farmasi where no_rawat=?", 1,
    ...
    private void simpan() {
        if (Sequel.menyimpantf("konseling_farmasi", "?,?,?,?,?,?,?,?,?", "Data", 9, new String[]{TNoRw.getText(),
            Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Jam.getSelectedItem() + ":"
            + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
            Diagnosa.getText(), ObatPemakaian.getText(), Alergi.getText(), Keluhan.getText(),
            PernahKonseling.getSelectedItem().toString(), TindakLanjut.getText(), KdPetugas.getText()}) == true) {
            tabMode.addRow(new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), TglLahir.getText(),
                ...
                Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Jam.getSelectedItem() + ":"
                + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
                Diagnosa.getText(), Alergi.getText(), PernahKonseling.getSelectedItem().toString(),
                ObatPemakaian.getText(), Keluhan.getText(), TindakLanjut.getText()});
            emptTeks();
            LCount.setText("" + tabMode.getRowCount());
        }
    }

    private static final Logger LOG = Logger.getLogger(RMKonselingFarmasi.class.getName());
