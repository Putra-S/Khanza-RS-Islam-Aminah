...
public class RMKonselingFarmasi extends javax.swing.JDialog {
    ...
    public RMKonselingFarmasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Diagnosa", "Alergi", "Pernah Konseling",
            "Nama Obat, Dosis & Cara Pemakaian", "Keluhan", "Tindak Lanjut"
        }) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (ObatPemakaian.getText().trim().isEmpty()) {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptKonselingFarmasi.jasper", "report",
                        "::[ Data Konseling Farmasi ]::",
                        ...
                        + "konseling_farmasi.tanggal between '" + Valid.SetTgl(
                ...
                Valid.MyReportqry("rptKonselingFarmasi.jasper", "report",
                        ...
                        + "and (reg_periksa.no_rawat like '%" + TCari.getText().
                                ...
                                getText().trim() + "%' or "
                        + "pasien.nm_pasien like '%" + TCari.getText().trim() + "%' or konseling_farmasi.obat_pemakaian like '%" + TCari.
                        getText().trim() + "%' or "
                        + "konseling_farmasi.nip like '%" + TCari.getText().
        ...
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("finger",
                    ...
                    isEmpty() ? tbObat.getValueAt(tbObat.getSelectedRow(), 5).
                                    toString() : finger) + "\n" + Tanggal.
                            getSelectedItem());
            Valid.MyReportqry("rptFormulirKonselingFarmasi.jasper", "report",
                    "::[ Formulir Konseling Farmasi ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,konseling_farmasi.tanggal,"
                    + "konseling_farmasi.diagnosa,konseling_farmasi.obat_pemakaian,konseling_farmasi.riwayat_alergi,konseling_farmasi.keluhan,"
                    + "konseling_farmasi.pernah_datang,konseling_farmasi.tindak_lanjut,konseling_farmasi.nip,petugas.nama,pasien.jk "
                    + "from konseling_farmasi inner join reg_periksa on konseling_farmasi.no_rawat=reg_periksa.no_rawat "
                    + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join petugas on konseling_farmasi.nip=petugas.nip where reg_periksa.no_rawat='" + tbObat.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMKonselingFarmasi dialog = new RMKonselingFarmasi(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        "tanggal"), rs.getString("diagnosa"), rs.getString(
                        "riwayat_alergi"),
                        rs.getString("pernah_datang"), rs.getString(
                        "obat_pemakaian"), rs.getString("keluhan"), rs.
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Diagnosa.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 8).
                    toString());
            Alergi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 9).
                    toString());
            PernahKonseling.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 10).toString());
            ObatPemakaian.setText(
                    tbObat.getValueAt(tbObat.getSelectedRow(), 11).toString());
            Keluhan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 12).
                    toString());
            TindakLanjut.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 13).
                    toString());
    ...
    private void ganti() {
        if (Sequel.mengedittf("konseling_farmasi", "no_rawat=?",
                "no_rawat=?,tanggal=?,diagnosa=?,obat_pemakaian=?,riwayat_alergi=?,keluhan=?,pernah_datang=?,"
                + "tindak_lanjut=?,nip=?", 11, new String[]{
                    TNoRw.getText(), Valid.
                    SetTgl(Tanggal.getSelectedItem() + "") + " " + Jam.
                    getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
                    getSelectedItem(),
                    Diagnosa.getText(), ObatPemakaian.getText(), Alergi.
                    getText(), Keluhan.getText(), PernahKonseling.
                    getSelectedItem().toString(), TindakLanjut.getText(),
            ...
            tbObat.setValueAt(PernahKonseling.getSelectedItem().toString(),
                    tbObat.getSelectedRow(), 10);
            tbObat.setValueAt(ObatPemakaian.getText(), tbObat.getSelectedRow(),
                    11);
    ...
    private void hapus() {
        if (Sequel.
                queryu2tf("delete from konseling_farmasi where no_rawat=?", 1,
                        new String[]{
    ...
    private void simpan() {
        if (Sequel.menyimpantf("konseling_farmasi", "?,?,?,?,?,?,?,?,?", "Data",
                9, new String[]{
                    TNoRw.getText(), Valid.
                    SetTgl(Tanggal.getSelectedItem() + "") + " " + Jam.
                    getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
            ...
            tabMode.addRow(new String[]{
                ...
                getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
                getSelectedItem(),
                Diagnosa.getText(), Alergi.getText(), PernahKonseling.
                getSelectedItem().toString(), ObatPemakaian.getText(), Keluhan.
                getText(),
    ...
    private static final Logger LOG = Logger.getLogger(RMKonselingFarmasi.class.
            getName());
