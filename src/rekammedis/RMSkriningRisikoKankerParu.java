...
public final class RMSkriningRisikoKankerParu extends javax.swing.JDialog {
    ...
    public RMSkriningRisikoKankerParu(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "Umur", "Kode Petugas", "Nama Petugas",
                    "Tanggal", "Jenis Kelamin", "N.A.1", "Usia/Umur", "N.A.2", "Pernah Didiagnosis Kanker", "N.A.3",
                    "Ada Keluarga Kanker", "N.A.4", "Riwayat Merokok", "N.A.5", "Riwayat Bekerja Karsinogenik",
                    "N.A.6", "Lingkungan Tinggal Berpolusi", "N.A.7", "Rumah Tidak Sehat", "N.A.8",
                    "Pernah Paru Kronis", "N.A.9", "Total Skor", "Hasil Skrining", "Keterangan"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("nama"), rs.getString("tanggal"), rs.getString("jenis_kelamin"),
                        rs.getString("nilai_jenis_kelamin"), rs.getString("umur"), rs.getString("nilai_umur"),
                        rs.getString("pernah_kanker"), rs.getString("nilai_pernah_kanker"),
                        rs.getString("ada_keluarga_kanker"), rs.getString("nilai_ada_keluarga_kanker"),
                        rs.getString("riwayat_rokok"), rs.getString("nilai_riwayat_rokok"),
                        rs.getString("riwayat_bekerja_mengandung_karsinogen"),
                        rs.getString("nilai_riwayat_bekerja_mengandung_karsinogen"),
                        rs.getString("lingkungan_tinggal_polusi_tinggi"),
                        rs.getString("nilai_lingkungan_tinggal_polusi_tinggi"),
                        rs.getString("lingkungan_rumah_tidak_sehat"),
                        rs.getString("nilai_lingkungan_rumah_tidak_sehat"), rs.getString("pernah_paru_kronik"),
                        rs.getString("nilai_pernah_paru_kronik"), rs.getString("total_skor"),
    ...
    private void isRawat() {
        try {
            ps = koneksi.prepareStatement("select reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,pasien.jk,"
    ...
    private void ganti() {
        if (Sequel.mengedittf("skrining_risiko_kanker_paru", "no_rawat=?",
                "no_rawat=?,tanggal=?,jenis_kelamin=?,nilai_jenis_kelamin=?,umur=?,nilai_umur=?,pernah_kanker=?,nilai_pernah_kanker=?,"
                ...
                + "nilai_pernah_paru_kronik=?,total_skor=?,hasil_skrining=?,keterangan=?,nip=?",
                25,
                new String[]{TNoRw.getText(),
                    ...
                    JenisKelamin.getSelectedItem().toString(), NilaiJenisKelamin.getText(),
                    Usia.getSelectedItem().toString(), NilaiUsia.getText(),
                    PernahMenderitaKanker.getSelectedItem().toString(), NilaiPernahMenderitaKanker.getText(),
                    KeluargaKanker.getSelectedItem().toString(), NilaiKeluargaKanker.getText(),
                    RiwayatMerokok.getSelectedItem().toString(), NilaiRiwayatMerokok.getText(),
                    RiwayatBekerja.getSelectedItem().toString(), NilaiRiwayatBekerja.getText(),
                    LingkunganTinggal.getSelectedItem().toString(), NilaiLingkunganTinggal.getText(),
                    DalamRumah.getSelectedItem().toString(), NilaiDalamRumah.getText(),
                    PernahParu.getSelectedItem().toString(), NilaiPernahParu.getText(), TotalHasil.getText(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from skrining_risiko_kanker_paru where no_rawat=?", 1,
    ...
    private void isTotal() {
        try {
            TotalHasil.setText("" + (Integer.parseInt(NilaiJenisKelamin.getText())
                    + Integer.parseInt(NilaiUsia.getText()) + Integer.parseInt(NilaiPernahMenderitaKanker.getText())
                    + Integer.parseInt(NilaiKeluargaKanker.getText()) + Integer.parseInt(NilaiRiwayatMerokok.getText())
                    + Integer.parseInt(NilaiRiwayatBekerja.getText())
                    + Integer.parseInt(NilaiLingkunganTinggal.getText()) + Integer.parseInt(NilaiDalamRumah.getText())
                    + Integer.parseInt(NilaiPernahParu.getText())));
    ...
    private void simpan() {
        if (Sequel.menyimpantf("skrining_risiko_kanker_paru", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data",
                24,
                new String[]{TNoRw.getText(),
                    Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Jam.getSelectedItem() + ":"
                    + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
                    ...
                    DalamRumah.getSelectedItem().toString(), NilaiDalamRumah.getText(),
                    PernahParu.getSelectedItem().toString(), NilaiPernahParu.getText(), TotalHasil.getText(),
                    HasilSkrining.getText(), Keterangan.getText(), KdPetugas.getText()}) == true) {
