...
public class MasterRencanaKeperawatanIGD extends javax.swing.JDialog {
    ...
    private MasterMasalahKeperawatanIGD masalah = new MasterMasalahKeperawatanIGD(
            null, false);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdrencana.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("master_rencana_keperawatan_igd", "'" + kdmasalah.
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, kdrencana,
                "master_rencana_keperawatan_igd", "kode_rencana") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdrencana.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("master_rencana_keperawatan_igd",
                        "kode_rencana=?",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterRencanaKeperawatanIGD dialog = new MasterRencanaKeperawatanIGD(
    ...
    private static final Logger LOG = Logger.getLogger(
            MasterRencanaKeperawatanIGD.class.getName());
}
