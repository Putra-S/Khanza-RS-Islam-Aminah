...
public class RMPenilaianAwalMedisRalanPenyakitDalam extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisRalanPenyakitDalam(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.",
            ...
            "Kondisi Umum", "Status Nutrisi", "TD(mmHg)", "Nadi(x/menit)", "Suhu", "RR(x/menit)", "BB(Kg)", "Nyeri",
            "GCS", "Kepala", "Thoraks", "Abdomen", "Ekstremitas", "Lainnya", "Laboratorium", "Radiologi",
            "Pemeriksaan", "Diagnosis", "Diagnosis Banding", "Permasalahan", "Terapi", "Tindakan", "Edukasi"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("kondisi"), rs.getString("status"), rs.getString("td"), rs.getString("nadi"),
                        rs.getString("suhu"), rs.getString("rr"), rs.getString("bb"), rs.getString("nyeri"),
                        rs.getString("gcs"), rs.getString("kepala") + ", " + rs.getString("keterangan_kepala"),
                        rs.getString("thoraks") + ", " + rs.getString("keterangan_thorak"),
                        rs.getString("abdomen") + ", " + rs.getString("keterangan_abdomen"),
                        rs.getString("ekstremitas") + ", " + rs.getString("keterangan_ekstremitas"),
                        rs.getString("lainnya"), rs.getString("lab"), rs.getString("rad"),
                        rs.getString("penunjanglain"), rs.getString("diagnosis"), rs.getString("diagnosis2"),
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            KeteranganKepala.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 24)
                    .toString()
                    .replaceAll(Kepala.getSelectedItem().toString() + ", ", ""));
            ...
            KeteranganThoraks.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 25)
                    .toString()
                    .replaceAll(Thoraks.getSelectedItem().toString() + ", ", ""));
            ...
            KeteranganAbdomen.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 26)
                    .toString()
                    .replaceAll(Abdomen.getSelectedItem().toString() + ", ", ""));
            ...
            KeteranganEkstremitas.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 27)
                    .toString()
                    .replaceAll(Ekstremitas.getSelectedItem().toString() + ", ", ""));
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_medis_ralan_penyakit_dalam where no_rawat=?", 1,
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_ralan_penyakit_dalam", "no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    KondisiUmum.getText(), StatusNutrisi.getText(), TD.getText(), Nadi.getText(), Suhu.getText(),
                    RR.getText(), BB.getText(), Nyeri.getText(), GCS.getText(), Kepala.getSelectedItem().toString(),
                    KeteranganKepala.getText(), Thoraks.getSelectedItem().toString(), KeteranganThoraks.getText(),
                    Abdomen.getSelectedItem().toString(), KeteranganAbdomen.getText(),
                    Ekstremitas.getSelectedItem().toString(), KeteranganEkstremitas.getText(), Lainnya.getText(),
                    Lab.getText(), Rad.getText(), PenunjangLain.getText(), Diagnosis.getText(),
                    Diagnosis2.getText(), Permasalahan.getText(), Terapi.getText(), Tindakan.getText(),
    ...
    private static final Logger LOG = Logger.getLogger(RMPenilaianAwalMedisRalanPenyakitDalam.class.getName());
