 ...
 * @author perpustakaan
 */
public class RMPenilaianAwalMedisRalanPenyakitDalam extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMPenilaianAwalMedisRalanPenyakitDalam(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Thoraks", "Abdomen", "Ekstremitas", "Lainnya", "Laboratorium",
            "Radiologi", "Pemeriksaan", "Diagnosis", "Diagnosis Banding",
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRM.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("penilaian_medis_ralan_penyakit_dalam",
                    "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                    "No.Rawat", 37, new String[]{
                        ...
                        RPO.getText(), Alergi.getText(), KondisiUmum.getText(),
                        StatusNutrisi.getText(), TD.getText(), Nadi.getText(),
                        Suhu.getText(), RR.getText(), BB.getText(), Nyeri.
                        getText(), GCS.getText(),
                        ...
                        toString(), KeteranganAbdomen.getText(),
                        Ekstremitas.getSelectedItem().toString(),
                        KeteranganEkstremitas.getText(), Lainnya.getText(), Lab.
                        getText(), Rad.getText(), PenunjangLain.getText(),
                        Diagnosis.getText(), Diagnosis2.getText(),
                        Permasalahan.getText(), Terapi.getText(), Tindakan.
                        getText(), Edukasi.getText()
                    }) == true) {
                emptTeks();
            }
        }
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry(
                    "rptCetakPenilaianAwalMedisRalanPenyakitDalam.jasper",
                    "report",
                    "::[ Laporan Penilaian Awal Medis Rawat Jalan Penyakit Dalam ]::",
                    ...
                    + "inner join dokter on penilaian_medis_ralan_penyakit_dalam.kd_dokter=dokter.kd_dokter where penilaian_medis_ralan_penyakit_dalam.no_rawat='" + tbObat.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRalanPenyakitDalam dialog = new RMPenilaianAwalMedisRalanPenyakitDalam(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        "alergi"), rs.getString("kondisi"), rs.getString(
                        "status"),
                        rs.getString("td"), rs.getString("nadi"), rs.getString(
                        "suhu"), rs.getString("rr"), rs.getString("bb"), rs.
                        getString("nyeri"), rs.getString("gcs"), rs.getString(
                        "kepala") + ", " + rs.getString("keterangan_kepala"),
                        ...
                        rs.getString("lainnya"), rs.getString("lab"), rs.
                        getString("rad"), rs.getString("penunjanglain"), rs.
                        getString("diagnosis"), rs.getString("diagnosis2"), rs.
                        getString("permasalahan"), rs.getString("terapi"),
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            KeteranganThoraks.setText(tbObat.getValueAt(tbObat.getSelectedRow(),
                    25).toString().replaceAll(Thoraks.getSelectedItem().
                            toString() + ", ", ""));
            ...
            KeteranganAbdomen.setText(tbObat.getValueAt(tbObat.getSelectedRow(),
                    26).toString().replaceAll(Abdomen.getSelectedItem().
                            toString() + ", ", ""));
            ...
            KeteranganEkstremitas.setText(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 27).toString().replaceAll(Ekstremitas.
                            getSelectedItem().toString() + ", ", ""));
            Lainnya.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 28).
                    toString());
            Lab.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 29).
                    toString());
            Rad.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 30).
                    toString());
            PenunjangLain.setText(
                    tbObat.getValueAt(tbObat.getSelectedRow(), 31).toString());
            Diagnosis.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 32).
                    toString());
            Diagnosis2.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 33).
                    toString());
            Permasalahan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 34).
                    toString());
            Terapi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 35).
                    toString());
            Tindakan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 36).
                    toString());
            Edukasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 37).
                    toString());
    ...
    public void isCek() {
        ...
        BtnHapus.
                setEnabled(akses.getpenilaian_awal_medis_ralan_penyakit_dalam());
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from penilaian_medis_ralan_penyakit_dalam where no_rawat=?",
                1, new String[]{
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_ralan_penyakit_dalam",
                "no_rawat=?",
                "no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,kondisi=?,status=?,td=?,nadi=?,suhu=?,"
                ...
                38, new String[]{
                    ...
                    getText(), Alergi.getText(), KondisiUmum.getText(),
                    StatusNutrisi.getText(), TD.getText(), Nadi.getText(), Suhu.
                    getText(), RR.getText(), BB.getText(), Nyeri.getText(), GCS.
                    getText(),
                    Kepala.getSelectedItem().toString(), KeteranganKepala.
                    getText(), Thoraks.getSelectedItem().toString(),
                    KeteranganThoraks.getText(), Abdomen.getSelectedItem().
    ...
    private static final Logger LOG = Logger.getLogger(
            RMPenilaianAwalMedisRalanPenyakitDalam.class.getName());
}
