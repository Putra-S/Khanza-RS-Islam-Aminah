 ...
 * @author dosen
 */
public class RMCariJalanPenyakit extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMCariJalanPenyakit(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//GEN-LAST:event_ppSemuaActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariJalanPenyakit dialog = new RMCariJalanPenyakit(new javax.swing.JFrame(), true);
  ...
  // End of variables declaration//GEN-END:variables
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat,concat(pemeriksaan_ralan.keluhan,', ',pemeriksaan_ralan.pemeriksaan) as pemeriksaan "
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat,concat(pemeriksaan_ranap.keluhan,', ',pemeriksaan_ranap.pemeriksaan) as pemeriksaan "
    ...
    private static final Logger LOG = Logger.getLogger(RMCariJalanPenyakit.class.getName());
