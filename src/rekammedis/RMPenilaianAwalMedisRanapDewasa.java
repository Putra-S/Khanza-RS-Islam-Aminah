 ...
 * @author perpustakaan
 */
public class RMPenilaianAwalMedisRanapDewasa extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisRanapDewasa(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.", "Kode Dokter", "Nama Dokter",
                    ...
                    "Ket.Genital", "Ket.Ekstremitas", "Ket.Kulit", "Ket.Status Lokalis", "Laboratorium",
        ...
        KetMata.setDocument(new batasInput(5000).getKata(KetMata));
        KetGigi.setDocument(new batasInput(5000).getKata(KetGigi));
        KetTht.setDocument(new batasInput(5000).getKata(KetTht));
        KetThoraks.setDocument(new batasInput(5000).getKata(KetThoraks));
        KetJantung.setDocument(new batasInput(5000).getKata(KetJantung));
        KetParu.setDocument(new batasInput(5000).getKata(KetParu));
        KetAbdomen.setDocument(new batasInput(5000).getKata(KetAbdomen));
        KetGenital.setDocument(new batasInput(5000).getKata(KetGenital));
        KetEkstremitas.setDocument(new batasInput(5000).getKata(KetEkstremitas));
        KetKulit.setDocument(new batasInput(5000).getKata(KetKulit));
    ...
    private void initComponents() {
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(1057, 1383));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-08-2023 09:45:41" }));
        ...
        scrollPane15.setViewportView(KetGigi);

        FormInput.add(scrollPane15);
        scrollPane15.setBounds(190, 380, 230, 23);
        ...
        scrollPane16.setViewportView(KetTht);

        FormInput.add(scrollPane16);
        scrollPane16.setBounds(190, 410, 230, 23);
        ...
        scrollPane17.setViewportView(KetParu);

        FormInput.add(scrollPane17);
        scrollPane17.setBounds(620, 320, 230, 23);
        ...
        scrollPane18.setViewportView(KetAbdomen);

        FormInput.add(scrollPane18);
        scrollPane18.setBounds(620, 350, 230, 23);
        ...
        scrollPane19.setViewportView(KetGenital);

        FormInput.add(scrollPane19);
        scrollPane19.setBounds(620, 380, 230, 23);
        ...
        scrollPane20.setViewportView(KetEkstremitas);

        FormInput.add(scrollPane20);
        scrollPane20.setBounds(620, 410, 230, 23);
        ...
        scrollPane21.setViewportView(KetThoraks);

        FormInput.add(scrollPane21);
        scrollPane21.setBounds(190, 440, 230, 23);
        ...
        scrollPane22.setViewportView(KetJantung);

        FormInput.add(scrollPane22);
        scrollPane22.setBounds(190, 470, 230, 23);
        ...
        scrollPane23.setViewportView(KetKulit);

        FormInput.add(scrollPane23);
        scrollPane23.setBounds(620, 440, 230, 23);
        ...
        BtnAmbilDataIGD.setBounds(860, 90, 150, 30);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRM.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("penilaian_medis_ranap",
                    "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                    "No.Rawat", 50, new String[]{
                        ...
                        KetKulit.getText(), KetLokalis.getText(), Laborat.
                        getText(), Radiologi.getText(), Penunjang.getText(),
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, KetKepala, BtnBatal);
        }
                    ...
                    while (rs.next()) {
                        htmlContent.append("<tr class='isi'><td valign='top'>").
                                ...
                                "</td><td valign='top'>").append(rs.getString(
                                        "ket_fisik")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString("ket_lokalis")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "lab")).append("</td><td valign='top'>").
                                append(rs.getString("rad")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "penunjang")).append(
                                        "</td><td valign='top'>").append(rs.
                                        getString("diagnosis")).append(
                                "</td><td valign='top'>").append(rs.getString(
                                        "tata")).
                                append("</td><td valign='top'>").append(rs.
    ...
    private void KetLokalisKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KetLokalisKeyPressed
        Valid.pindah2(evt, KetKepala, Laborat);
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.
                    MyReportqry("rptCetakPenilaianAwalMedisRanap.jasper",
                            "report",
                            "::[ Laporan Penilaian Awal Medis Rawat Inap ]::",
                            "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap.tanggal,"
                            + "penilaian_medis_ranap.kd_dokter,penilaian_medis_ranap.anamnesis,penilaian_medis_ranap.hubungan,penilaian_medis_ranap.keluhan_utama,penilaian_medis_ranap.rps,penilaian_medis_ranap.rpk,penilaian_medis_ranap.rpd,penilaian_medis_ranap.rpo,penilaian_medis_ranap.alergi,"
                            + "penilaian_medis_ranap.keadaan,penilaian_medis_ranap.gcs,penilaian_medis_ranap.kesadaran,penilaian_medis_ranap.td,penilaian_medis_ranap.nadi,penilaian_medis_ranap.rr,penilaian_medis_ranap.suhu,penilaian_medis_ranap.spo,penilaian_medis_ranap.bb,penilaian_medis_ranap.tb,"
                            + "penilaian_medis_ranap.kepala,penilaian_medis_ranap.mata,penilaian_medis_ranap.gigi,penilaian_medis_ranap.tht,penilaian_medis_ranap.thoraks,penilaian_medis_ranap.jantung,penilaian_medis_ranap.paru,penilaian_medis_ranap.abdomen,penilaian_medis_ranap.ekstremitas,"
                            + "penilaian_medis_ranap.genital,penilaian_medis_ranap.kulit,penilaian_medis_ranap.ket_kepala,penilaian_medis_ranap.ket_mata,penilaian_medis_ranap.ket_gigi,penilaian_medis_ranap.ket_tht,penilaian_medis_ranap.ket_thoraks,penilaian_medis_ranap.ket_jantung,penilaian_medis_ranap.ket_paru,"
                            + "penilaian_medis_ranap.ket_abdomen,penilaian_medis_ranap.ket_genital,penilaian_medis_ranap.ket_ekstremitas,penilaian_medis_ranap.ket_kulit,penilaian_medis_ranap.ket_lokalis,penilaian_medis_ranap.lab,penilaian_medis_ranap.rad,penilaian_medis_ranap.penunjang,penilaian_medis_ranap.diagnosis,penilaian_medis_ranap.tata,"
                            + "penilaian_medis_ranap.edukasi,dokter.nm_dokter "
                            + "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                            + "inner join penilaian_medis_ranap on reg_periksa.no_rawat=penilaian_medis_ranap.no_rawat "
                            + "inner join dokter on penilaian_medis_ranap.kd_dokter=dokter.kd_dokter where penilaian_medis_ranap.no_rawat='" + tbObat.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRanapDewasa dialog = new RMPenilaianAwalMedisRanapDewasa(new javax.swing.JFrame(),
                    true);
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("ket_lokalis"), rs.getString("lab"), rs.getString("rad"),
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            KetLokalis.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 48).toString());
            Laborat.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 49).toString());
            Radiologi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 50).toString());
            Penunjang.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 51).toString());
            Diagnosis.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 52).toString());
            Tatalaksana.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 53).toString());
            Edukasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 54).toString());
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_medis_ranap where no_rawat=? and kd_dokter=?", 2,
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_ranap", "no_rawat=? and kd_dokter=?",
                "no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpk=?,rpd=?,rpo=?,alergi=?,keadaan=?,gcs=?,kesadaran=?,td=?,nadi=?,rr=?,suhu=?,"
                + "spo=?,bb=?,tb=?,kepala=?,mata=?,gigi=?,tht=?,thoraks=?,jantung=?,paru=?,abdomen=?,genital=?,ekstremitas=?,kulit=?,ket_kepala=?,ket_mata=?,ket_gigi=?,ket_tht=?,ket_thoraks=?,ket_jantung=?,ket_paru=?,ket_abdomen=?,ket_genital=?,ket_ekstremitas=?,ket_kulit=?,ket_lokalis=?,lab=?,rad=?,penunjang=?,diagnosis=?,tata=?,edukasi=?",
                52,
                new String[]{TNoRw.getText(),
                    ...
                    KetGenital.getText(), KetEkstremitas.getText(), KetKulit.getText(), KetLokalis.getText(),
                    Laborat.getText(), Radiologi.getText(), Penunjang.getText(), Diagnosis.getText(),
                    Tatalaksana.getText(), Edukasi.getText(),
    ...
    private static final Logger LOG = Logger.getLogger(RMPenilaianAwalMedisRanapDewasa.class.getName());
