 ...
 * @author dosen
 */
public class RMCariHasilLaborat extends javax.swing.JDialog {
    ...
    private String norawat = "", sql = "", sqle = "", status = "", norm = "";
...
//GEN-BEGIN:initComponents
    ...
    public void tampil() {
        ...
        if (status.equals("Ralan")) {
            ...
            sqle = "reg_periksa.no_rkm_medis='" + norm + "' and detail_periksa_lab.tgl_periksa = CURDATE()";
        } else {
    ...
    private static final Logger LOG = Logger.getLogger(RMCariHasilLaborat.class.getName());
