...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        rs2 = koneksi.prepareStatement(
                                ...
                                + "where pemeriksaan_ranap_sbar.no_rawat='" + rs.
                                        getString("no_rawat") + "' "
                                + "order by pemeriksaan_ranap_sbar.tgl_perawatan,pemeriksaan_ranap_sbar.jam_rawat").
                                executeQuery();
                        if (rs2.next()) {
                            htmlContent.append(
                                    "<tr class='isi'>"
                            ...
                            while (rs2.next()) {
                                ...
                                if (Sequel.cariInteger(
                                        "select count(validasi_pemeriksaan_sbar.nik_validator) "
                                        ...
                                        + "where pemeriksaan_ranap_sbar.no_rawat='" + rs.
                                                getString("no_rawat") + "' AND validasi_pemeriksaan_sbar.nik_validator='" + rs2.
                                        getString("nik_validator") + "' AND validasi_pemeriksaan_sbar.status_validasi='Validasi'"
                                ...
                                htmlContent.append(
                                        ...
                                        "situation")).append(
                                                "</td><td align='left' ").
                                        append(stylee).append(">").append(rs2.
                                        getString("background")).append(
                                        "</td><td align='left' ").append(stylee).
                                        append(">").append(rs2.getString(
                                        "assesment")).append(
                                                "</td><td align='left' ").
                                        append(stylee).append(">").append(rs2.
                                        getString("recommendation")).append(
                                        "</td><td align='left' ").append(stylee).
                                        append(" ").append(gbrverif).append(
                                        "><br>").append(rs2.getString(
                                                "namavalidator")).append("<br>").
                                        append(rs2.getString("tgl_validasi")).
                                        append("<br>").append(rs2.getString(
                                        "jam_validasi")).append("</td></tr>");
                            }
                        }
                    } catch (Exception e) {
                        System.out.println("Notifikasi : " + e);
    ...
    private static final Logger LOG = Logger.getLogger(DlgSBAR.class.getName());
