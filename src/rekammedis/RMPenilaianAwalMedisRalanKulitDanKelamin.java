...
public class RMPenilaianAwalMedisRalanKulitDanKelamin extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisRalanKulitDanKelamin(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.", "Kode Dokter", "Nama Dokter",
                    ...
                    "Riwayat Penyakit Dahulu", "Riwayat Penggunakan Obat", "Riwayat Penyakit Keluarga", "Kesadaran",
                    "Status Nutrisi", "TD(mmHg)", "Nadi(x/menit)", "Suhu", "RR(x/menit)", "BB(Kg)", "Nyeri", "GCS",
                    "Keterangan Dermatovenereologis", "Pemeriksaan", "Diagnosis Kerja", "Diagnosis Banding",
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("rps"), rs.getString("rpd"), rs.getString("rpo"), rs.getString("rpk"),
                        ...
                        rs.getString("gcs"), rs.getString("statusderma"), rs.getString("pemeriksaan"),
                        rs.getString("diagnosis"), rs.getString("diagnosis2"), rs.getString("permasalahan"),
                        rs.getString("terapi"), rs.getString("tindakan"), rs.getString("edukasi")});
                }
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_medis_ralan_kulitdankelamin where no_rawat=?", 1,
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_ralan_kulitdankelamin", "no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    KeluhanUtama.getText(), RPS.getText(), RPD.getText(), RPO.getText(), RPK.getText(),
                    Kesadaran.getSelectedItem().toString(), StatusNutrisi.getSelectedItem().toString(),
                    TD.getText(), Nadi.getText(), Suhu.getText(), RR.getText(), BB.getText(), Nyeri.getText(),
                    GCS.getText(), Statusderma.getText(), Pemeriksaan.getText(), Diagnosis.getText(),
    ...
    private void simpan() {
        if (Sequel.menyimpantf("penilaian_medis_ralan_kulitdankelamin",
            ...
            tabMode.addRow(new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), TglLahir.getText(),
                ...
                RPD.getText(), RPO.getText(), RPK.getText(), Kesadaran.getSelectedItem().toString(),
                StatusNutrisi.getSelectedItem().toString(), TD.getText(), Nadi.getText(), Suhu.getText(),
                RR.getText(), BB.getText(), Nyeri.getText(), GCS.getText(), Statusderma.getText(),
                Pemeriksaan.getText(), Diagnosis.getText(), Diagnosis2.getText(), Permasalahan.getText(),
    ...
    private static final Logger LOG = Logger.getLogger(RMPenilaianAwalMedisRalanKulitDanKelamin.class.getName());
