...
public class RMPenilaianAwalMedisRalanKulitDanKelamin extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMPenilaianAwalMedisRalanKulitDanKelamin(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Riwayat Penggunakan Obat", "Riwayat Penyakit Keluarga", "Kesadaran",
            "Status Nutrisi", "TD(mmHg)", "Nadi(x/menit)", "Suhu", "RR(x/menit)",
            "BB(Kg)", "Nyeri", "GCS",
            "Keterangan Dermatovenereologis", "Pemeriksaan", "Diagnosis Kerja",
        ...
        Statusderma.setDocument(new batasInput(2000).getKata(Statusderma));
        Pemeriksaan.setDocument(new batasInput(1000).getKata(Pemeriksaan));
        ...
        if (tbObat.getSelectedRow() > -1) {
            ...
            try {
                param.put("lokalis", getClass().getResource(
                        "/picture/kelamin.png").openStream());
            } catch (Exception e) {
            }
            ...
            Valid.MyReportqry(
                    "rptCetakPenilaianAwalMedisRalanKulitKelamin.jasper",
                    "report",
                    "::[ Laporan Penilaian Awal Medis Rawat Jalan Kulit & Kelamin ]::",
                    ...
                    + "where penilaian_medis_ralan_kulitdankelamin.no_rawat='" + tbObat.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRalanKulitDanKelamin dialog = new RMPenilaianAwalMedisRalanKulitDanKelamin(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        "rpk"), rs.getString("kesadaran"), rs.
                        getString("status"),
                        rs.getString("td"), rs.getString("nadi"), rs.getString(
                        "suhu"), rs.getString("rr"), rs.getString("bb"), rs.
                        getString("nyeri"), rs.getString("gcs"),
                        rs.getString("statusderma"), rs.getString("pemeriksaan"),
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            RPO.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 13).
                    toString());
            RPK.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 14).
                    toString());
            Kesadaran.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),
                    15).toString());
            StatusNutrisi.setSelectedItem(tbObat.getValueAt(tbObat.
            ...
            GCS.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 23).
                    toString());
            Statusderma.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 24).
                    toString());
            Pemeriksaan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 25).
                    toString());
            Diagnosis.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 26).
                    toString());
            Diagnosis2.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 27).
                    toString());
            Permasalahan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 28).
                    toString());
            Terapi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 29).
                    toString());
            Tindakan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 30).
                    toString());
            Edukasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 31).
                    toString());
    ...
    public void isCek() {
        BtnSimpan.
                setEnabled(akses.getpenilaian_awal_medis_ralan_kulit_kelamin());
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from penilaian_medis_ralan_kulitdankelamin where no_rawat=?",
                1, new String[]{
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_ralan_kulitdankelamin",
                "no_rawat=?",
                "no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,rpk=?,kesadaran=?,status=?,td=?,nadi=?,suhu=?,rr=?,bb=?,nyeri=?,gcs=?,statusderma=?,pemeriksaan=?,diagnosis=?,diagnosis2=?,permasalahan=?,terapi=?,tindakan=?,edukasi=?",
                28, new String[]{
                    ...
                    getText(), KeluhanUtama.getText(), RPS.getText(), RPD.
                    getText(), RPO.getText(), RPK.getText(), Kesadaran.
                    getSelectedItem().toString(), StatusNutrisi.
                            getSelectedItem().toString(), TD.getText(), Nadi.
                    getText(),
                    Suhu.getText(), RR.getText(), BB.getText(), Nyeri.getText(),
                    GCS.getText(),
                    Statusderma.getText(), Pemeriksaan.getText(), Diagnosis.
                    getText(), Diagnosis2.getText(), Permasalahan.getText(),
            ...
            tbObat.setValueAt(Kesadaran.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 15);
            tbObat.setValueAt(StatusNutrisi.getSelectedItem().toString(),
            ...
            tbObat.
                    setValueAt(Statusderma.getText(), tbObat.getSelectedRow(),
                            24);
            tbObat.
                    setValueAt(Pemeriksaan.getText(), tbObat.getSelectedRow(),
                            25);
    ...
    private void simpan() {
        if (Sequel.menyimpantf("penilaian_medis_ralan_kulitdankelamin",
                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                "No.Rawat", 27, new String[]{
                    ...
                    getText(), RPK.getText(), Kesadaran.getSelectedItem().
                    toString(), StatusNutrisi.getSelectedItem().toString(), TD.
                    getText(), Nadi.getText(), Suhu.getText(), RR.getText(), BB.
                    getText(), Nyeri.getText(), GCS.getText(),
                    Statusderma.getText(), Pemeriksaan.getText(), Diagnosis.
                    getText(), Diagnosis2.getText(),
            ...
            tabMode.addRow(new String[]{
                ...
                KeluhanUtama.getText(), RPS.getText(), RPD.getText(), RPO.
                getText(), RPK.getText(), Kesadaran.getSelectedItem().toString(),
                StatusNutrisi.getSelectedItem().toString(), TD.getText(),
                Nadi.getText(), Suhu.getText(), RR.getText(), BB.getText(),
                Nyeri.getText(), GCS.getText(), Statusderma.getText(),
                Pemeriksaan.getText(), Diagnosis.getText(), Diagnosis2.getText(),
                Permasalahan.getText(), Terapi.getText(), Tindakan.getText(),
                Edukasi.getText()
            });
            LCount.setText("" + tabMode.getRowCount());
    ...
    private static final Logger LOG = Logger.getLogger(
            RMPenilaianAwalMedisRalanKulitDanKelamin.class.getName());
}
