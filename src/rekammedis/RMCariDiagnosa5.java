 ...
 * @author dosen
 */
public class RMCariDiagnosa5 extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMCariDiagnosa5(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariDiagnosa5 dialog = new RMCariDiagnosa5(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select diagnosa_pasien.kd_penyakit,penyakit.nm_penyakit,diagnosa_pasien.status "
    ...
    private static final Logger LOG = Logger.getLogger(RMCariDiagnosa5.class.getName());
