...
public class RMDataCatatanCekGDS extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataCatatanCekGDS dialog = new RMDataCatatanCekGDS(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("gdp"), rs.getString("insulin"),
                        rs.getString("obat_gula"), rs.getString("nip"), rs.
                        getString("nama")
                    });
                }
            } catch (Exception e) {
        ...
        if (tbObat.getSelectedRow() != -1) {
            ...
            GDP.
                    setText(tbObat.getValueAt(tbObat.getSelectedRow(), 8).
                            toString());
            Insulin.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 9).
                    toString());
            ObatGula.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 10).
                    toString());
    ...
    private void ganti() {
        if (Sequel.mengedittf("catatan_cek_gds",
                "tgl_perawatan=? and jam_rawat=? and no_rawat=?",
                "no_rawat=?,tgl_perawatan=?,jam_rawat=?,gdp=?,insulin=?,obat_gula=?,nip=?",
                10, new String[]{
                    TNoRw.getText(), Valid.
                    SetTgl(Tanggal.getSelectedItem() + ""), Jam.
                    getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
                    getSelectedItem(),
                    GDP.getText(), Insulin.getText(), ObatGula.getText(), NIP.
                    getText(), tbObat.getValueAt(tbObat.getSelectedRow(), 6).
                            toString(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from catatan_cek_gds where tgl_perawatan=? and jam_rawat=? and no_rawat=?",
                3, new String[]{
    ...
    private static final Logger LOG = Logger.getLogger(
            RMDataCatatanCekGDS.class.getName());
