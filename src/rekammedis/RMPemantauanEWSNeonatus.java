 ...
 * @author perpustakaan
 */
public class RMPemantauanEWSNeonatus extends javax.swing.JDialog {
    ...
    public RMPemantauanEWSNeonatus(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Pernapasan", "Skor 1", "Saturasi Oksigen", "Skor 2",
            "Penggunaan O2", "Skor 3",
            "Denyut Jantung", "Skor 4", "Retraksi Dada", "Skor 5", "CRT",
            "Skor 6", "Suhu", "Skor 7", "Warna Kulit", "Skor 8", "Ttl.Skor",
            "Kesimpulan",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptDataPemantauanEWSNeonatus.jasper",
                        "report", "::[ Data Pemantauan EWS Neonatus ]::",
                        ...
                        + "pemantauan_ews_neonatus.tanggal between '" + Valid.
                                SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                        SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' order by pemantauan_ews_neonatus.tanggal ",
                        param);
            } else {
                Valid.MyReportqry("rptDataPemantauanEWSNeonatus.jasper",
                        "report", "::[ Data Pemantauan EWS Neonatus ]::",
                        ...
                        + "where pemantauan_ews_neonatus.tanggal between '" + Valid.
                                SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                        SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and "
                        + "(reg_periksa.no_rawat like '%" + TCari.getText() + "%' or pasien.no_rkm_medis like '%" + TCari.
                        getText() + "%' or pasien.nm_pasien like '%" + TCari.
                                getText() + "%' or pemantauan_ews_neonatus.nip like '%" + TCari.
    ...
    private void MnPemantauanEWSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPemantauanEWSActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("diagnosa", Sequel.cariIsi(
                    ...
                    TNoRw.getText()));
            Valid.MyReportqry("rptFormulirPemantauanEWSNeonatus.jasper",
                    "report", "::[ Pemantauan EWS Neonatus ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,pasien.jk,pemantauan_ews_neonatus.tanggal,"
                    + "pemantauan_ews_neonatus.parameter1,pemantauan_ews_neonatus.skor1,pemantauan_ews_neonatus.parameter2,pemantauan_ews_neonatus.skor2,pemantauan_ews_neonatus.parameter3,"
                    + "pemantauan_ews_neonatus.skor3,pemantauan_ews_neonatus.parameter4,pemantauan_ews_neonatus.skor4,pemantauan_ews_neonatus.parameter5,pemantauan_ews_neonatus.skor5,"
                    + "pemantauan_ews_neonatus.parameter6,pemantauan_ews_neonatus.skor6,pemantauan_ews_neonatus.parameter7,pemantauan_ews_neonatus.skor7,pemantauan_ews_neonatus.parameter8,"
                    ...
                    + "from pemantauan_ews_neonatus inner join reg_periksa on pemantauan_ews_neonatus.no_rawat=reg_periksa.no_rawat "
                    + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join petugas on pemantauan_ews_neonatus.nip=petugas.nip where reg_periksa.no_rawat='" + tbObat.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPemantauanEWSNeonatus dialog = new RMPemantauanEWSNeonatus(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("tanggal"), rs.getString("parameter1"), rs.
                        getString("skor1"), rs.getString("parameter2"), rs.
                        getString("skor2"), rs.getString("parameter3"),
                        rs.getString("skor3"), rs.getString("parameter4"), rs.
                        getString("skor4"), rs.getString("parameter5"), rs.
                        getString("skor5"), rs.getString("parameter6"),
                        rs.getString("skor6"), rs.getString("parameter7"), rs.
                        getString("skor7"), rs.getString("parameter8"), rs.
                        getString("skor8"), rs.getString("skor_total"),
                        rs.getString("parameter_total"), rs.getString(
                        "code_blue"), rs.getString("nip"), rs.getString("nama"),
                        rs.getString("lahir")
                    });
                }
            } catch (Exception e) {
    ...
    private void isHitung() {
        if (Integer.parseInt(TotalSkor.getText()) > 6) {
            ParameterSkor.setText(
                    "Petugas : Panggilan Darurat, Monitoring : Berkelanjutan, Tindakan : Menghubungi tim emergency jaga/aktifkan Code Blue");
        } else if (Integer.parseInt(TotalSkor.getText()) == 6) {
            ParameterSkor.setText(
                    "Petugas : Perawat Jaga & Dokter Jaga, Monitoring : Berkelanjutan, Tindakan : Melapor ke DPJP");
        } else if ((Integer.parseInt(TotalSkor.getText()) == 4) || (Integer.
                parseInt(TotalSkor.getText()) == 5)) {
            ParameterSkor.setText(
                    "Petugas : Perawat Jaga & Dokter Jaga, Monitoring : Per 30 menit, Tindakan : Perawat jaga melakukan monitoring ulang dan melapor ke dokter jaga");
        } else if (Integer.parseInt(TotalSkor.getText()) == 3) {
            ParameterSkor.setText(
                    "Petugas : Perawat Jaga & Dokter Jaga, Monitoring : Per 1 jam, Tindakan : Perawat jaga melakukan monitoring ulang dan melapor ke dokter jaga");
        } else if (Integer.parseInt(TotalSkor.getText()) == 2) {
            ParameterSkor.setText(
                    "Petugas : Perawat Jaga, Monitoring : Per 2 jam, Tindakan : Semua perubahan kondisi pasien harus meningkatkan frekuensi monitor untuk tindakan klinis yang tepat");
        } else if (Integer.parseInt(TotalSkor.getText()) == 1) {
            ParameterSkor.setText(
                    "Petugas : Perawat Jaga, Monitoring : Per 4 jam, Tindakan : Semua perubahan kondisi pasien harus meningkatkan frekuensi monitor untuk tindakan klinis yang tepat");
    ...
    private void ganti() {
        ...
        isjml();
        isHitung();
        if (Sequel.mengedittf("pemantauan_ews_neonatus",
                "tanggal=? and no_rawat=?",
                "no_rawat=?,tanggal=?,parameter1=?,skor1=?,parameter2=?,skor2=?,parameter3=?,"
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from pemantauan_ews_neonatus where tanggal=? and no_rawat=?",
                2, new String[]{
                    tbObat.getValueAt(tbObat.getSelectedRow(), 5).toString(),
                    tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
                }) == true) {
    ...
    private void simpan() {
        ...
        isjml();
        isHitung();
        if (Sequel.menyimpantf("pemantauan_ews_neonatus",
                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 22,
                new String[]{
                    TNoRw.getText(), Valid.
                    SetTgl(Tanggal.getSelectedItem() + "") + " " + Jam.
            ...
            tabMode.addRow(new String[]{
                ...
                cmbSkor8.getSelectedItem().toString(), Skor8.getText(),
                TotalSkor.getText(), ParameterSkor.getText(), cmbCodeBlue.
                getSelectedItem().toString(), KdPetugas.getText(), NmPetugas.
                getText(), TglLahir.getText()
            });
            LCount.setText("" + tabMode.getRowCount());
            emptTeks();
        }
    ...
    private static final Logger LOG = Logger.getLogger(
            RMPemantauanEWSNeonatus.class.getName());
}
