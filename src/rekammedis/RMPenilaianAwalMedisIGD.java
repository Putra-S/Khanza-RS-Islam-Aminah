 ...
 * @author perpustakaan
 */
public class RMPenilaianAwalMedisIGD extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisIGD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.", "Kode Dokter", "Nama Dokter",
                    ...
                    "RR(x/menit)", "Suhu", "SpO2", "BB(Kg)", "TB(cm)", "Kepala", "Mata", "Gigi & Mulut", "Leher",
                    "Thoraks", "Abdomen", "Genital & Anus", "Ekstremitas", "Ket.Kepala", "Ket.Mata", "Ket.Gigi",
                    "Ket.Leher", "Ket.Thorax", "Ket.Abdomen", "Ket.Genital", "Ket.Ekstremitas",
                    "Ket.Status Lokalis", "EKG", "Radiologi", "Laborat", "Diagnosis/Asesmen", "Tatalaksana"}) {
            @Override
    ...
    private void initComponents() {
        ...
        KetLeher = new widget.TextArea();
        scrollPane16 = new widget.ScrollPane();
        KetThorax = new widget.TextArea();
        ...
        scrollPane5.setBounds(240, 320, 200, 23);
        ...
        scrollPane6.setBounds(240, 350, 200, 23);
        ...
        scrollPane14.setViewportView(KetGigi);

        FormInput.add(scrollPane14);
        scrollPane14.setBounds(240, 380, 200, 23);

        scrollPane15.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane15.setName("scrollPane15"); // NOI18N

        KetLeher.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        KetLeher.setColumns(20);
        KetLeher.setRows(8);
        KetLeher.setName("KetLeher"); // NOI18N
        scrollPane15.setViewportView(KetLeher);

        FormInput.add(scrollPane15);
        scrollPane15.setBounds(240, 410, 200, 23);

        scrollPane16.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane16.setName("scrollPane16"); // NOI18N

        KetThorax.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        KetThorax.setColumns(20);
        KetThorax.setRows(8);
        KetThorax.setName("KetThorax"); // NOI18N
        scrollPane16.setViewportView(KetThorax);

        FormInput.add(scrollPane16);
        scrollPane16.setBounds(655, 320, 200, 23);
        ...
        scrollPane17.setViewportView(KetAbdomen);

        FormInput.add(scrollPane17);
        scrollPane17.setBounds(655, 350, 200, 23);
        ...
        scrollPane18.setViewportView(KetGenital);

        FormInput.add(scrollPane18);
        scrollPane18.setBounds(655, 380, 200, 23);
        ...
        scrollPane19.setViewportView(KetEkstremitas);

        FormInput.add(scrollPane19);
        scrollPane19.setBounds(655, 410, 200, 23);
        ...
        jLabel40.setBounds(48, 320, 80, 23);
        ...
        Kepala.setBounds(130, 320, 100, 23);

        jLabel44.setText("Gigi & Mulut :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(48, 380, 80, 23);
        ...
        FormInput.add(Gigi);
        Gigi.setBounds(130, 380, 100, 23);

        jLabel45.setText("Leher :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(48, 410, 80, 23);
        ...
        FormInput.add(Leher);
        Leher.setBounds(130, 410, 100, 23);

        jLabel46.setText("Thoraks :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(450, 320, 95, 23);
        ...
        Thoraks.setBounds(550, 320, 100, 23);

        jLabel49.setText("Abdomen :");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(450, 350, 95, 23);
        ...
        Abdomen.setBounds(550, 350, 100, 23);

        jLabel50.setText("Genital & Anus :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(450, 380, 95, 23);
        ...
        Genital.setBounds(550, 380, 100, 23);

        jLabel51.setText("Ekstremitas :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(450, 410, 95, 23);
        ...
        Ekstremitas.setBounds(550, 410, 100, 23);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-05-2024 08:14:46" }));
        ...
        jLabel42.setBounds(48, 350, 80, 23);
    ...
    private void EkstremitasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_EkstremitasKeyPressed
        Valid.pindah(evt, Genital, KetKepala);
    ...
    private void KetLokalisKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KetLokalisKeyPressed
        Valid.pindah2(evt, KetKepala, EKG);
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            try {
                param.put("lokalis", getClass().
                        getResource("/picture/semua.png").openStream());
            } catch (Exception e) {
            }
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisIGD.jasper", "report",
                    ...
                    + "inner join dokter on penilaian_medis_igd.kd_dokter=dokter.kd_dokter where penilaian_medis_igd.no_rawat='" + tbObat.
    ...
    private widget.TextArea KetLeher;
    private widget.TextArea KetLokalis;
    private widget.TextArea KetMata;
    private widget.TextArea KetThorax;
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("kepala"), rs.getString("mata"), rs.getString("gigi"), rs.getString("leher"),
                        rs.getString("thoraks"), rs.getString("abdomen"), rs.getString("genital"),
                        rs.getString("ekstremitas"), rs.getString("ket_kepala"), rs.getString("ket_mata"),
                        rs.getString("ket_gigi"), rs.getString("ket_leher"), rs.getString("ket_thorax"),
                        rs.getString("ket_abdomen"), rs.getString("ket_genital"), rs.getString("ket_ekstremitas"),
                        rs.getString("ket_lokalis"), rs.getString("ekg"), rs.getString("rad"), rs.getString("lab"),
                        rs.getString("diagnosis"), rs.getString("tata")});
                }
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            KetKepala.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 34).toString());
            KetMata.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 35).toString());
            KetGigi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 36).toString());
            KetLeher.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 37).toString());
            KetThorax.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 38).toString());
            KetAbdomen.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 39).toString());
            KetGenital.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 40).toString());
            KetEkstremitas.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 41).toString());
            KetLokalis.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 42).toString());
            EKG.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 43).toString());
            Radiologi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 44).toString());
            Laborat.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 45).toString());
            Diagnosis.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 46).toString());
            Tatalaksana.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 47).toString());
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_medis_igd where no_rawat=?", 1,
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_igd", "no_rawat=?",
                "no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpk=?,rpo=?,alergi=?,keadaan=?,gcs=?,kesadaran=?,td=?,nadi=?,rr=?,suhu=?,spo=?,bb=?,tb=?,kepala=?,mata=?,gigi=?,leher=?,thoraks=?,abdomen=?,genital=?,ekstremitas=?,ket_kepala=?,ket_mata=?,ket_gigi=?,ket_leher=?,ket_thorax=?,ket_abdomen=?,ket_genital=?,ket_ekstremitas=?,ket_lokalis=?,ekg=?,rad=?,lab=?,diagnosis=?,tata=?",
                44,
                new String[]{TNoRw.getText(),
                    ...
                    Leher.getSelectedItem().toString(), Thoraks.getSelectedItem().toString(),
                    Abdomen.getSelectedItem().toString(), Genital.getSelectedItem().toString(),
                    Ekstremitas.getSelectedItem().toString(), KetKepala.getText(), KetMata.getText(),
                    KetGigi.getText(), KetLeher.getText(), KetThorax.getText(), KetAbdomen.getText(),
                    KetGenital.getText(), KetEkstremitas.getText(), KetLokalis.getText(), EKG.getText(),
            ...
            tbObat.setValueAt(KetKepala.getText(), tbObat.getSelectedRow(), 34);
            tbObat.setValueAt(KetMata.getText(), tbObat.getSelectedRow(), 35);
            tbObat.setValueAt(KetGigi.getText(), tbObat.getSelectedRow(), 36);
            tbObat.setValueAt(KetLeher.getText(), tbObat.getSelectedRow(), 37);
            tbObat.setValueAt(KetThorax.getText(), tbObat.getSelectedRow(), 38);
            tbObat.setValueAt(KetAbdomen.getText(), tbObat.getSelectedRow(), 39);
            tbObat.setValueAt(KetGenital.getText(), tbObat.getSelectedRow(), 40);
            tbObat.setValueAt(KetEkstremitas.getText(), tbObat.getSelectedRow(), 41);
            tbObat.setValueAt(KetLokalis.getText(), tbObat.getSelectedRow(), 42);
            tbObat.setValueAt(EKG.getText(), tbObat.getSelectedRow(), 43);
            tbObat.setValueAt(Radiologi.getText(), tbObat.getSelectedRow(), 44);
            tbObat.setValueAt(Laborat.getText(), tbObat.getSelectedRow(), 45);
            tbObat.setValueAt(Diagnosis.getText(), tbObat.getSelectedRow(), 46);
            tbObat.setValueAt(Tatalaksana.getText(), tbObat.getSelectedRow(), 47);
            emptTeks();
            TabRawat.setSelectedIndex(1);
        }
    }
    ...
    private void simpan() {
        if (Sequel.menyimpantf("penilaian_medis_igd",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    KetGigi.getText(), KetLeher.getText(), KetThorax.getText(), KetAbdomen.getText(),
                    KetGenital.getText(), KetEkstremitas.getText(), KetLokalis.getText(), EKG.getText(),
                    Radiologi.getText(), Laborat.getText(), Diagnosis.getText(), Tatalaksana.getText()}) == true) {
            tabMode.addRow(new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), TglLahir.getText(),
                ...
                Leher.getSelectedItem().toString(), Thoraks.getSelectedItem().toString(),
                Abdomen.getSelectedItem().toString(), Genital.getSelectedItem().toString(),
                Ekstremitas.getSelectedItem().toString(), KetKepala.getText(), KetMata.getText(), KetGigi.getText(),
                KetLeher.getText(), KetThorax.getText(), KetAbdomen.getText(), KetGenital.getText(),
                KetEkstremitas.getText(), KetLokalis.getText(), EKG.getText(), Radiologi.getText(),
                Laborat.getText(), Diagnosis.getText(), Tatalaksana.getText()});
            LCount.setText("" + tabMode.getRowCount());
            emptTeks();
        }
    ...
    private static final Logger LOG = Logger.getLogger(RMPenilaianAwalMedisIGD.class.getName());
