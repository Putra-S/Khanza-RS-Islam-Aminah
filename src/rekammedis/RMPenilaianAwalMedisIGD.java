...
public class RMPenilaianAwalMedisIGD extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisIGD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Kepala",
            "Mata", "Gigi & Mulut", "Leher", "Thoraks", "Abdomen",
            "Genital & Anus", "Ekstremitas", "Ket.Kepala", "Ket.Mata",
            "Ket.Gigi", "Ket.Leher", "Ket.Thorax", "Ket.Abdomen", "Ket.Genital",
            "Ket.Ekstremitas",
            "Ket.Status Lokalis", "EKG", "Radiologi", "Laborat",
            "Diagnosis/Asesmen", "Tatalaksana"
        }) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisIGD dialog = new RMPenilaianAwalMedisIGD(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        "leher"), rs.getString("thoraks"), rs.getString(
                        "abdomen"), rs.getString("genital"),
                        rs.getString("ekstremitas"), rs.getString("ket_kepala"),
                        rs.getString("ket_mata"), rs.getString("ket_gigi"), rs.
                        getString("ket_leher"), rs.getString("ket_thorax"), rs.
                        getString("ket_abdomen"),
                        rs.getString("ket_genital"), rs.getString(
                        "ket_ekstremitas"), rs.getString("ket_lokalis"), rs.
                        getString("ekg"), rs.getString("rad"), rs.getString(
                        "lab"), rs.getString("diagnosis"), rs.getString("tata")
                    });
                }
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            KetKepala.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 34).
                    toString());
            KetMata.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 35).
                    toString());
            KetGigi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 36).
                    toString());
            KetLeher.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 37).
                    toString());
            KetThorax.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 38).
                    toString());
            KetAbdomen.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 39).
                    toString());
            KetGenital.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 40).
                    toString());
            KetEkstremitas.setText(tbObat.
                    getValueAt(tbObat.getSelectedRow(), 41).toString());
            KetLokalis.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 42).
                    toString());
            EKG.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 43).
                    toString());
            Radiologi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 44).
                    toString());
            Laborat.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 45).
                    toString());
            Diagnosis.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 46).
                    toString());
            Tatalaksana.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 47).
                    toString());
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_medis_igd where no_rawat=?",
                1, new String[]{
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_igd", "no_rawat=?",
                ...
                44, new String[]{
                    ...
                    getSelectedItem().toString(), Leher.getSelectedItem().
                            toString(),
                    ...
                    KetKepala.getText(), KetMata.getText(), KetGigi.getText(),
                    KetLeher.getText(),
                    KetThorax.getText(), KetAbdomen.getText(), KetGenital.
                    getText(), KetEkstremitas.getText(), KetLokalis.getText(),
                    EKG.getText(),
                    Radiologi.getText(), Laborat.getText(), Diagnosis.getText(),
                    Tatalaksana.getText(), tbObat.getValueAt(tbObat.
            ...
            tbObat.setValueAt(KetEkstremitas.getText(), tbObat.getSelectedRow(),
                    41);
    ...
    private void simpan() {
        if (Sequel.menyimpantf("penilaian_medis_igd",
            ...
            tabMode.addRow(new String[]{
                ...
                getSelectedItem().toString(), KetKepala.getText(), KetMata.
                getText(), KetGigi.getText(), KetLeher.getText(),
                KetThorax.getText(), KetAbdomen.getText(), KetGenital.getText(),
                KetEkstremitas.getText(), KetLokalis.getText(), EKG.getText(),
                Radiologi.getText(), Laborat.getText(),
    ...
    private static final Logger LOG = Logger.getLogger(
            RMPenilaianAwalMedisIGD.class.getName());
}
