...
public class MasterSekolah extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("master_sekolah",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                if (Sequel.mengedittf("master_sekolah", "kd_sekolah=?",
                        "kd_sekolah=?,nm_sekolah=?", 3, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterSekolah dialog = new MasterSekolah(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from master_sekolah where master_sekolah.kd_sekolah like ? or master_sekolah.nm_sekolah like ? order by master_sekolah.kd_sekolah");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(MasterSekolah.class.
            getName());
}
