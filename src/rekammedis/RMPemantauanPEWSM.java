...
public class RMPemantauanPEWSM extends javax.swing.JDialog {
    ...
    public RMPemantauanPEWSM(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Umur", "JK", "Tanggal", "Skor Pernafasan",
                    "Skor 1", "Skor Oksigen", "Skor 2", "Skor Suhu", "Skor 3", "Skor Nadi", "Skor 4",
                    "Skor Systole", "Skor 5", "Skor Diastole", "Skor 6", "Skor Kesadaran", "Skor 7", "Skor Urine",
                    "Skor 8", "Ttl.Pink", "Ttl.Kuning", "Kesimpulan", "NIP", "Petugas", "Tgl.Lahir"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPemantauanPEWSM dialog = new RMPemantauanPEWSM(new javax.swing.JFrame(), true);
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("jk"), rs.getString("tanggal"), rs.getString("parameter_pernafasan"),
                        rs.getString("skor_pernafasan"), rs.getString("parameter_saturasi_oksigen"),
                        rs.getString("skor_saturasi_oksigen"), rs.getString("parameter_suhu"),
                        rs.getString("skor_suhu"), rs.getString("parameter_nadi"), rs.getString("skor_nadi"),
                        rs.getString("parameter_systole"), rs.getString("skor_systole"),
                        rs.getString("parameter_diastole"), rs.getString("skor_diastole"),
                        rs.getString("parameter_kesadaran"), rs.getString("skor_kesadaran"),
                        rs.getString("parameter_urine"), rs.getString("skor_urine"), rs.getString("skor_total"),
                        rs.getString("skor_kuning"), rs.getString("parameter_total"), rs.getString("nip"),
    ...
    private void isHitung() {
        if ((Integer.parseInt(TotalSkor.getText()) == 0) && (Integer.parseInt(TotalKuning.getText()) == 0)) {
            ParameterSkor.setText("");
        } else if ((Integer.parseInt(TotalSkor.getText()) == 0) && (Integer.parseInt(TotalKuning.getText()) == 1)) {
            ParameterSkor.setText("Ulangi observasi dalam 30 menit");
        } else if ((Integer.parseInt(TotalSkor.getText()) >= 2) || (Integer.parseInt(TotalKuning.getText()) > 2)) {
            ParameterSkor.setText(
                    "Segera tinjau dari dokter kandungan dan ulangi observasi dalam 30 menit atau lakukan monitoring secara terus menerus");
        } else if ((Integer.parseInt(TotalSkor.getText()) == 1) || (Integer.parseInt(TotalKuning.getText()) == 2)) {
            ParameterSkor.setText("Hubungi dokter kandungan dan ulangi observasi dalam 30 menit");
        }
    }
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            TotalKuning.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 23).toString());
            ParameterSkor.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 24).toString());
    ...
    private void ganti() {
        ...
        isjml();
        isHitung();
        if (Sequel.mengedittf("pemantauan_pews_maternal", "tanggal=? and no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    cmbSkor1.getSelectedItem().toString(), Skor1.getText(), cmbSkor2.getSelectedItem().toString(),
                    Skor2.getText(), cmbSkor3.getSelectedItem().toString(), Skor3.getText(),
                    cmbSkor4.getSelectedItem().toString(), Skor4.getText(), cmbSkor5.getSelectedItem().toString(),
                    Skor5.getText(), cmbSkor6.getSelectedItem().toString(), Skor6.getText(),
                    cmbSkor7.getSelectedItem().toString(), Skor7.getText(), cmbSkor8.getSelectedItem().toString(),
                    Skor8.getText(), TotalSkor.getText(), ParameterSkor.getText(), KdPetugas.getText(),
            ...
            tbObat.setValueAt(TotalKuning.getText(), tbObat.getSelectedRow(), 23);
            tbObat.setValueAt(ParameterSkor.getText(), tbObat.getSelectedRow(), 24);
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from pemantauan_pews_maternal where tanggal=? and no_rawat=?", 2,
    ...
    private static final Logger LOG = Logger.getLogger(RMPemantauanPEWSM.class.getName());
