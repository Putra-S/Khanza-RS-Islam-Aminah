...
public class ValidasiSOAP extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Validasi SOAP ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Liberation Sans", 0, 13), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-03-2023" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-03-2023" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (TKeluhan.getText().isEmpty()) {
            Valid.textKosong(TKeluhan, "S (SUBJECTIVE");
        } else if (TPemeriksaan.getText().isEmpty()) {
            Valid.textKosong(TPemeriksaan, "O (OBJECTIVE)");
        } else {
            if (Sequel.menyimpantf("validasi_pemeriksaan_ranap",
                    "?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 12, new String[]{
                        TNoRw.getText(), TanggalPemeriksaan.getText(),
                        JamPemeriksaan.getText(), TKeluhan.getText(),
                        TPemeriksaan.getText(), TPenilaian.getText(),
                        TindakLanjut.getText(),
                        KodeDokter1.getText(), KodeDokter.getText(), tanggalNow.
                        format(new Date()), jamNow.format(new Date()),
                        "Validasi",}) == true) {
                tampil();
                emptTeks();
            }
