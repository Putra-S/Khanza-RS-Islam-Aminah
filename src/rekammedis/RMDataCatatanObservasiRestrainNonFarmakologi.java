...
public final class RMDataCatatanObservasiRestrainNonFarmakologi extends javax.swing.JDialog {
    ...
    public RMDataCatatanObservasiRestrainNonFarmakologi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Umur", "JK", "Tgl.Lahir", "Tgl.Obser",
                    "Jam Obser", "Tangan Kiri", "Tangan Kanan", "Badan", "Kaki Kiri", "Kaki Kanan", "Edema",
                    "Iritasi", "Sirkulasi", "Kondisi", "NIP", "Nama Petugas"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataCatatanObservasiRestrainNonFarmakologi dialog = new RMDataCatatanObservasiRestrainNonFarmakologi(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("jam_rawat"), rs.getString("tangan_kiri"), rs.getString("tangan_kanan"),
                        rs.getString("badan"), rs.getString("kaki_kiri"), rs.getString("kaki_kanan"),
                        rs.getString("edema"), rs.getString("iritasi"), rs.getString("sirkulasi"),
                        rs.getString("kondisi_keterangan"), rs.getString("nip"), rs.getString("nama")});
                }
            } catch (Exception e) {
    ...
    private void ganti() {
        if (Sequel.mengedittf("catatan_observasi_restrain_nonfarma", "tgl_perawatan=? and jam_rawat=? and no_rawat=?",
                "no_rawat=?,tgl_perawatan=?,jam_rawat=?,tangan_kiri=?,"
                + "tangan_kanan=?,kaki_kiri=?,kaki_kanan=?,badan=?,edema=?,iritasi=?,sirkulasi=?,kondisi_keterangan=?,nip=?",
                16,
                new String[]{TNoRw.getText(), Valid.SetTgl(Tanggal.getSelectedItem() + ""),
                    ...
                    TanganKiri.getSelectedItem().toString(), TanganKanan.getSelectedItem().toString(),
                    KakiKiri.getSelectedItem().toString(), KakiKanan.getSelectedItem().toString(),
                    Badan.getSelectedItem().toString(), Edema.getSelectedItem().toString(),
                    Iritasi.getSelectedItem().toString(), Sirkulasi.getSelectedItem().toString(), Kondisi.getText(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from catatan_observasi_restrain_nonfarma where tgl_perawatan=? and jam_rawat=? and no_rawat=?",
                3,
    ...
    private void simpan() {
        if (Sequel.menyimpantf("catatan_observasi_restrain_nonfarma", "?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 13,
                new String[]{TNoRw.getText(), Valid.SetTgl(Tanggal.getSelectedItem() + ""),
                    Jam.getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
                    TanganKiri.getSelectedItem().toString(), TanganKanan.getSelectedItem().toString(),
                    KakiKiri.getSelectedItem().toString(), KakiKanan.getSelectedItem().toString(),
            ...
            tabMode.addRow(new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), Umur.getText(),
                ...
                Jam.getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
                TanganKiri.getSelectedItem().toString(), TanganKanan.getSelectedItem().toString(),
                Badan.getSelectedItem().toString(), KakiKiri.getSelectedItem().toString(),
                KakiKanan.getSelectedItem().toString(), Edema.getSelectedItem().toString(),
                Iritasi.getSelectedItem().toString(), Sirkulasi.getSelectedItem().toString(), Kondisi.getText(),
