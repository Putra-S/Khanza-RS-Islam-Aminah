 ...
 * @author perpustakaan
 */
public class RMPenilaianLanjutanRisikoJatuhLansia extends javax.swing.JDialog {
    ...
    public RMPenilaianLanjutanRisikoJatuhLansia(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Tgl.Lahir", "JK", "Tanggal", "Skala Morse 1",
                    "N.M. 1", "Skala Morse 2", "N.M. 2", "Skala Morse 3", "N.M. 3", "Skala Morse 4", "N.M. 4",
                    "Skala Morse 5", "N.M. 5", "Skala Morse 6", "N.M. 6", "Total", "Hasil Skrining", "Saran", "NIP",
                    "Petugas"}) {
            @Override
        ...
        if (TNoRw.getText().trim().isEmpty() || TPasien.getText().trim().
            ...
            if (Sequel.menyimpantf("penilaian_lanjutan_resiko_jatuh_lansia",
                    ...
                    new String[]{
                        ...
                        NilaiResikoTotal.getText(), HasilSkrining.getText(),
                        Saran.getText(), NIP.getText()
                    }) == true) {
                tabMode.addRow(new String[]{
                    ...
                    toString(), NilaiResiko6.getText(),
                    NilaiResikoTotal.getText(), HasilSkrining.getText(), Saran.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptLanjutanRisikoJatuhLansia.jasper",
                        "report",
                        "::[ Data Penilaian Lanjutan Risiko Jatuh Lansia ]::",
                        ...
                        + "penilaian_lanjutan_resiko_jatuh_lansia.tanggal between '" + Valid.
                ...
                Valid.MyReportqry("rptLanjutanRisikoJatuhLansia.jasper",
                        ...
                        + "(reg_periksa.no_rawat like '%" + TCari.getText().
                                ...
                                getText().trim() + "%' "
                        + "or penilaian_lanjutan_resiko_jatuh_lansia.nip like '%" + TCari.
    ...
    private void MnPenilaianLanjutanRisikoJatuhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianLanjutanRisikoJatuhActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("finger",
                    ...
                    isEmpty() ? tbObat.getValueAt(tbObat.getSelectedRow(), 21).
                                    toString() : finger) + "\n" + Tanggal.
                            getSelectedItem());
            Valid.MyReportqry(
                    "rptFormulirPenilaianLanjutanRisikoJatuhLansia.jasper",
                    "report",
                    "::[ Formulir Penilaian Lanjutan Risiko Jatuh Lansia ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,penilaian_lanjutan_resiko_jatuh_lansia.tanggal,"
                    + "penilaian_lanjutan_resiko_jatuh_lansia.penilaian_jatuhmorse_skala1,penilaian_lanjutan_resiko_jatuh_lansia.penilaian_jatuhmorse_nilai1,"
                    + "penilaian_lanjutan_resiko_jatuh_lansia.penilaian_jatuhmorse_skala2,penilaian_lanjutan_resiko_jatuh_lansia.penilaian_jatuhmorse_nilai2,"
                    + "penilaian_lanjutan_resiko_jatuh_lansia.penilaian_jatuhmorse_skala3,penilaian_lanjutan_resiko_jatuh_lansia.penilaian_jatuhmorse_nilai3,"
                    ...
                    + "from penilaian_lanjutan_resiko_jatuh_lansia inner join reg_periksa on penilaian_lanjutan_resiko_jatuh_lansia.no_rawat=reg_periksa.no_rawat "
                    + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join petugas on penilaian_lanjutan_resiko_jatuh_lansia.nip=petugas.nip where reg_periksa.no_rawat='" + tbObat.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianLanjutanRisikoJatuhLansia dialog = new RMPenilaianLanjutanRisikoJatuhLansia(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("tanggal"), rs.getString("penilaian_jatuhmorse_skala1"),
                        rs.getString("penilaian_jatuhmorse_nilai1"), rs.getString("penilaian_jatuhmorse_skala2"),
                        rs.getString("penilaian_jatuhmorse_nilai2"), rs.getString("penilaian_jatuhmorse_skala3"),
                        rs.getString("penilaian_jatuhmorse_nilai3"), rs.getString("penilaian_jatuhmorse_skala4"),
                        rs.getString("penilaian_jatuhmorse_nilai4"), rs.getString("penilaian_jatuhmorse_skala5"),
                        rs.getString("penilaian_jatuhmorse_nilai5"), rs.getString("penilaian_jatuhmorse_skala6"),
                        rs.getString("penilaian_jatuhmorse_nilai6"),
                        rs.getString("penilaian_jatuhmorse_totalnilai"), rs.getString("hasil_skrining"),
    ...
    private void isPsien() {
        try {
            ps = koneksi.prepareStatement(
                    "select pasien.nm_pasien,pasien.jk,date_format(pasien.tgl_lahir,'%d-%m-%Y') as lahir from pasien where pasien.no_rkm_medis=?");
            try {
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_lanjutan_resiko_jatuh_lansia", "tanggal=? and no_rawat=?",
                "no_rawat=?,tanggal=?,penilaian_jatuhmorse_skala1=?,penilaian_jatuhmorse_nilai1=?,"
                ...
                + "penilaian_jatuhmorse_totalnilai=?,hasil_skrining=?,saran=?,nip=?",
                20,
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_lanjutan_resiko_jatuh_lansia where tanggal=? and no_rawat=?", 2,
        ...
        try {
            ...
            NilaiResikoTotal
                    .setText((Integer.parseInt(NilaiResiko1.getText()) + Integer.parseInt(NilaiResiko2.getText())
                            + Integer.parseInt(NilaiResiko3.getText()) + Integer.parseInt(NilaiResiko4.getText()) + rlansia)
                            + "");
            if (Integer.parseInt(NilaiResikoTotal.getText()) < 6) {
                TingkatResiko.setText(
                        "Tingkat Resiko : Risiko Rendah (0-5), Tindakan : Intervensi pencegahan risiko jatuh standar");
            } else if (Integer.parseInt(NilaiResikoTotal.getText()) < 17) {
                TingkatResiko.setText(
                        "Tingkat Resiko : Risiko Sedang (6-16), Tindakan : Intervensi pencegahan risiko jatuh standar");
            } else if (Integer.parseInt(NilaiResikoTotal.getText()) >= 17) {
                TingkatResiko.setText(
                        "Tingkat Resiko : Risiko Tinggi (> 17), Tindakan : Intervensi pencegahan risiko jatuh standar dan Intervensi risiko jatuh tinggi");
            }
        } catch (Exception e) {
            NilaiResikoTotal.setText("0");
            TingkatResiko
                    .setText("Tingkat Resiko : Risiko Rendah (0-5), Tindakan : Intervensi pencegahan risiko jatuh standar");
        }
    }

    private static final Logger LOG = Logger.getLogger(RMPenilaianLanjutanRisikoJatuhLansia.class.getName());
