...
public class RMPenilaianLanjutanRisikoJatuhLansia extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMPenilaianLanjutanRisikoJatuhLansia(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Skala Morse 6", "N.M. 6", "Total", "Hasil Skrining", "Saran", "NIP",
            "Petugas"
        }) {
            @Override
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_lanjutan_resiko_jatuh_lansia",
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from penilaian_lanjutan_resiko_jatuh_lansia where tanggal=? and no_rawat=?",
                2, new String[]{
    ...
    private void isTotalResikoJatuh() {
        try {
            if ((Integer.parseInt(NilaiResiko5.getText()) + Integer.parseInt(
                    NilaiResiko6.getText())) <= 3) {
                rlansia = 0;
            } else {
                rlansia = 7;
            }
    ...
    private static final Logger LOG = Logger.getLogger(
            RMPenilaianLanjutanRisikoJatuhLansia.class.getName());
}
