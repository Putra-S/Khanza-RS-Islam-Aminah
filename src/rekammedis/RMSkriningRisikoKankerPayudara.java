...
public class RMSkriningRisikoKankerPayudara extends javax.swing.JDialog {
    ...
    private void ganti() {
        if (Sequel.mengedittf("skrining_risiko_kanker_payudara", "no_rawat=?",
                "no_rawat=?,tanggal=?,faktor_risiko_awal1=?,nilai_risiko_awal1=?,faktor_risiko_awal2=?,nilai_risiko_awal2=?,faktor_risiko_awal3=?,"
