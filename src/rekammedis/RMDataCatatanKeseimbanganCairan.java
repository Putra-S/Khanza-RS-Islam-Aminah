...
public class RMDataCatatanKeseimbanganCairan extends javax.swing.JDialog {
    ...
    public RMDataCatatanKeseimbanganCairan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Umur", "JK", "Tgl.Lahir", "Tanggal", "Jam",
                    "Infus", "Tranfusi", "Minum", "Urine/Feses", "Drain", "NGT/Oral", "IWL", "Keseimbangan Cairan",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataCatatanKeseimbanganCairan dialog = new RMDataCatatanKeseimbanganCairan(new javax.swing.JFrame(),
                    true);
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("jam_rawat"), rs.getString("infus"), rs.getString("tranfusi"),
                        rs.getString("minum"), rs.getString("urine"), rs.getString("drain"), rs.getString("ngt"),
                        rs.getString("iwl"), rs.getString("keseimbangan"), rs.getString("keterangan"),
    ...
    private void ganti() {
        if (Sequel.mengedittf("catatan_keseimbangan_cairan", "tgl_perawatan=? and jam_rawat=? and no_rawat=?",
                ...
                new String[]{TNoRw.getText(), Valid.SetTgl(Tanggal.getSelectedItem() + ""),
                    ...
                    Infus.getText(), Tranfusi.getText(), Minum.getText(), Urine.getText(), Drain.getText(),
                    NGT.getText(), IWL.getText(), Keseimbangan.getText(), Keterangan.getText(), NIP.getText(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from catatan_keseimbangan_cairan where tgl_perawatan=? and jam_rawat=? and no_rawat=?", 3,
    ...
    private void simpan() {
        if (Sequel.menyimpantf("catatan_keseimbangan_cairan", "?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 13,
                new String[]{TNoRw.getText(), Valid.SetTgl(Tanggal.getSelectedItem() + ""),
                    Jam.getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
                    Infus.getText(), Tranfusi.getText(), Minum.getText(), Urine.getText(), Drain.getText(),
                    NGT.getText(), IWL.getText(), Keseimbangan.getText(), Keterangan.getText(),
                    NIP.getText()}) == true) {
    ...
    private static final Logger LOG = Logger.getLogger(RMDataCatatanKeseimbanganCairan.class.getName());
