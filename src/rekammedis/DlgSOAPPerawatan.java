...
public class DlgSOAPPerawatan extends javax.swing.JDialog {
    ...
    public DlgSOAPPerawatan(java.awt.Frame parent, boolean modal) {
        ...
        webview.getEngine().loadContent(LoadHTML.toString());
    }
...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    private void prosesCari() {
        ...
        try {
            ...
            htmlContent.append("<tr class='isi'>"
                    ...
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='66%'>S.O.A.P.I.E</td>" + "</tr>");
                        ...
                        if (rs2.next()) {
                            ...
                            while (rs2.next()) {
                                htmlContent.append("<tr class='isi'><td align='center'>")
                                        ...
                                        .append(rs2.getString("keluhan").replaceAll("(\r\n|\r|\n|\n\r)", "<br>"))
                                        .append("</td><td align='left'>")
                                        .append(rs2.getString("pemeriksaan").replaceAll("(\r\n|\r|\n|\n\r)", "<br>"))
                                        .append(rs2.getString("alergi").isEmpty() ? ""
                                                : "<br>Alergi : " + rs2.getString("alergi"))
                                        .append(rs2.getString("suhu_tubuh").isEmpty() ? ""
                                                : "<br>Suhu(C) : " + rs2.getString("suhu_tubuh"))
                                        .append(rs2.getString("tensi").isEmpty() ? ""
                                                : "<br>Tensi : " + rs2.getString("tensi"))
                                        .append(rs2.getString("nadi").isEmpty() ? ""
                                                : "<br>Nadi(/menit) : " + rs2.getString("nadi"))
                                        .append(rs2.getString("respirasi").isEmpty() ? ""
                                                : "<br>Respirasi(/menit) : " + rs2.getString("respirasi"))
                                        .append(rs2.getString("tinggi").isEmpty() ? ""
                                                : "<br>Tinggi(Cm) : " + rs2.getString("tinggi"))
                                        .append(rs2.getString("berat").isEmpty() ? ""
                                                : "<br>Berat(Kg) : " + rs2.getString("berat"))
                                        .append(rs2.getString("lingkar_perut").isEmpty() ? ""
                                                : "<br>Lingkar Perut : " + rs2.getString("lingkar_perut"))
                                        .append(rs2.getString("spo2").isEmpty() ? ""
                                                : "<br>SpO2(%) : " + rs2.getString("spo2"))
                                        .append(rs2.getString("gcs").isEmpty() ? ""
                                                : "<br>GCS(E,V,M) : " + rs2.getString("gcs"))
                                        .append(rs2.getString("kesadaran").isEmpty() ? ""
                                                : "<br>Kesadaran : " + rs2.getString("kesadaran"))
                                        .append("</td><td align='left'>")
                                        .append(rs2.getString("penilaian").replaceAll("(\r\n|\r|\n|\n\r)", "<br>"))
                                        .append("</td><td align='left'>")
                                        .append(rs2.getString("rtl").replaceAll("(\r\n|\r|\n|\n\r)", "<br>"))
                                        .append("</td><td align='left'>")
                                        .append(rs2.getString("instruksi").replaceAll("(\r\n|\r|\n|\n\r)", "<br>"))
                                        .append("</td><td align='left'>")
    ...
    private static final Logger LOG = Logger.getLogger(DlgSOAPPerawatan.class.getName());
