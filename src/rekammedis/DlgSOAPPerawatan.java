...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSOAPPerawatan dialog = new DlgSOAPPerawatan(
                ...
                while (rs.next()) {
                    ...
                    try {
                        rs2 = koneksi.prepareStatement(
                                ...
                                + "pemeriksaan_ralan.no_rawat='" + rs.getString(
                                        "no_rawat") + "' "
                        ...
                        if (rs2.next()) {
                            ...
                            while (rs2.next()) {
                                htmlContent.append(
                                        ...
                                        append("<br>").append(rs2.getString(
                                        "jam_rawat")).append(
                                                "</td><td align='center'>").
                                        append(rs2.getString("nip")).append(
                                        "<br>").append(rs2.getString("nama")).
                                        append("</td><td align='left'>").append(
                                        rs2.getString("keluhan").replaceAll(
                                                "(\r\n|\r|\n|\n\r)", "<br>")).
                                        append("</td><td align='left'>").append(
                                        rs2.getString("pemeriksaan").replaceAll(
                                                "(\r\n|\r|\n|\n\r)", "<br>")).
                                        append(rs2.getString("alergi").isEmpty() ? "" : "<br>Alergi : " + rs2.
                                                getString("alergi")).append(rs2.
                                        getString("suhu_tubuh").isEmpty() ? "" : "<br>Suhu(C) : " + rs2.
                                        getString("suhu_tubuh")).append(rs2.
                                        getString("tensi").isEmpty() ? "" : "<br>Tensi : " + rs2.
                                        getString("tensi")).append(rs2.
                                        getString("nadi").isEmpty() ? "" : "<br>Nadi(/menit) : " + rs2.
                                        getString("nadi")).append(rs2.getString(
                                        "respirasi").isEmpty() ? "" : "<br>Respirasi(/menit) : " + rs2.
                                                        getString("respirasi")).
                                        append(rs2.getString("tinggi").isEmpty() ? "" : "<br>Tinggi(Cm) : " + rs2.
                                                getString("tinggi")).append(rs2.
                                        getString("berat").isEmpty() ? "" : "<br>Berat(Kg) : " + rs2.
                                        getString("berat")).append(rs2.
                                        getString("lingkar_perut").isEmpty() ? "" : "<br>Lingkar Perut : " + rs2.
                                        getString("lingkar_perut")).append(rs2.
                                        getString("spo2").isEmpty() ? "" : "<br>SpO2(%) : " + rs2.
                                        getString("spo2")).append(rs2.getString(
                                        "gcs").isEmpty() ? "" : "<br>GCS(E,V,M) : " + rs2.
                                                        getString("gcs")).
                                        append(rs2.getString("kesadaran").
                                                isEmpty() ? "" : "<br>Kesadaran : " + rs2.
                                                                getString(
                                                                        "kesadaran")).
                                        append("</td><td align='left'>").append(
                                        rs2.getString("penilaian").replaceAll(
                                                "(\r\n|\r|\n|\n\r)", "<br>")).
                                        append("</td><td align='left'>").append(
                                        rs2.getString("rtl").replaceAll(
                                                "(\r\n|\r|\n|\n\r)", "<br>")).
                                        append("</td><td align='left'>").append(
                    ...
                    try {
                        rs2 = koneksi.prepareStatement(
                                ...
                                + "inner join pegawai on pemeriksaan_ranap.nip=pegawai.nik where pemeriksaan_ranap.no_rawat='" + rs.
                                        getString("no_rawat") + "' "
    ...
    private static final Logger LOG = Logger.getLogger(DlgSOAPPerawatan.class.
            getName());
