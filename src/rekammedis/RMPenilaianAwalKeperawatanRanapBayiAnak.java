...
public final class RMPenilaianAwalKeperawatanRanapBayiAnak extends javax.swing.JDialog {
    ...
    private final DefaultTableModel tabMode, tabModeMasalah, tabModeImunisasi, tabModeDetailMasalah, tabModeRencana,
            tabModeDetailRencana, tabModeImunisasi2;
    ...
    public RMPenilaianAwalKeperawatanRanapBayiAnak(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.",
            ...
            "Tgl.Asuhan", "Anamnesa", "Keterangan Anamnesa", "Kondisi Tiba Di Ruang", "Riwayat Penyakit Saat Ini",
            "Riwayat Penyakit Dahulu", "Riwayat Penyakit Keluarga", "Riwayat Penggunaan Obat", "Riwayat Alergi",
            "Tengkurap", "Duduk", "Berdiri", "Gigi Pertama", "Berjalan", "Bicara", "Membaca", "Menulis",
            "Gangguan Emosi", "Anak Ke", "Bersaudara", "Cara Kelahiran", "Keterangan Cara Kelahiran",
            "Umur Kelahiran", "Kelainan Bawaan", "Keterangan Kelainan Bawaan", "BB Lahir", "PB Lahir",
            "Riwayat Persalinan Lainnya", "Kesadaran", "GCS", "TD(mmHg)", "RR(x/menit)", "Suhu(°C)",
            "Nadi(x/menit)", "BB(Kg)", "TB(cm)", "LP(cm)", "LK(cm)", "LD(cm)", "Saraf Pusat Kepala",
            "Keterangan Saraf Pusat Kepala", "Saraf Pusat Wajah", "Keterangan Saraf Pusat Wajah",
            "Saraf Pusat Leher", "Saraf Pusat Kejang", "Keterangan Saraf Pusat Kejang", "Saraf Pusat Sensorik",
            "Kardi Pulsasi", "Kardio Sirkulasi", "Keterangan Kardio Sirkulasi", "Kardio Denyut Nadi",
            "Respi Retraksi", "Respi Pola Nafas", "Respi Suara Nafas", "Respi Batuk", "Respi Volume",
            "Respi Jenis Pernapasan", "Keterangan Respi Jenis Pernapasan", "Respirasi Irama", "Gastro Mulut",
            "Keterangan Gastro Mulut", "Gastro Tenggorakan", "Keterangan Gastro Tenggorakan", "Gastro Lidah",
            "Keterangan Gastro Lidah", "Gastro Abdomen", "Keterangan Gastro Abdomen", "Gastro Gigi",
            "Keterangan Gastro Gigi", "Gastro Usus", "Gastro Anus", "Neuro Sensorik", "Neuro Pengelihatan",
            "Keterangan Neuro Pengelihatan", "Neuro Alat Bantu", "Neuro Motorik", "Neuro Pendengaran",
            "Neuro Bicara", "Keterangan Neuro Bicara", "Neurologi Otot", "Inte Kulit", "Inte Warna Kulit",
            "Inte Tugor", "Inte Decubi", "Musku Odema", "Keterangan Musku Odema", "Musku Pegerakan Sendi",
            "Musku Otot", "Musku Fraktur", "Keterangan Musku Fraktur", "Musku Nyeri Sendi",
            "Keterangan Musku Nyeri Sendi", "BAB Frekuensi", "BAB Per", "BAB Konsistesi", "BAB Warna",
            "BAK Frekuensi", "BAK Per", "BAK Warna", "BAK Lain-lain", "Kondisi Psikologi", "Adakah Perilaku",
            "Keterangan Perilaku", "Gangguan Jiwa Masa Lalu", "Hubungan Dengan Keluarga", "Agama Pasien",
            "Tinggal Dengan", "Keterangan Tinggal Dengan", "Pekerjaan P.J.", "Pembayaran Pasien",
            "Nilai Kepercayaan", "Keterangan Nilai Kepercayaan", "Bahasa Sehari-hari Pasien", "Pend.Pasien",
            "Pend.P.J.", "Edukasi Diberikan", "Keterangan Edukasi Diberikan", "Bahasa Sehari-hari Pendamping",
            "Kemampuan Baca & Tulis Pendamping", "Pendamping Butuh Penerjemah",
            "Keterangan Pendamping Butuh Penerjemah", "Terdapat Hambatan", "Hambatan Belajar",
            "Keterangan Hambatan Belajar", "Hambatan Bicara", "Hambatan Bahasa Isyarat", "Cara Belajar Disukai",
            "Menerima Informasi", "Keterangan Kesediaan Menerima Informasi", "Pemahaman Nutrisi/Diet",
            "Pemahaman Penyakit", "Pemahaman Pengobatan", "Pemahaman Perawatan", "Skrining Gizi 1", "N.G.1",
            "Skrining Gizi 2", "N.G.2", "Skrining Gizi 3", "N.G.3", "Skrining Gizi 4", "N.G.4", "T.N.Gizi",
            "Keterangan Skrining Gizi", "Skala Humpty Dumpty 1", "N.H. 1", "Skala Humpty Dumpty 2", "N.H. 2",
            "Skala Humpty Dumpty 3", "N.H. 3", "Skala Humpty Dumpty 4", "N.H. 4", "Skala Humpty Dumpty 5", "N.H. 5",
            "Skala Humpty Dumpty 6", "N.H. 6", "Skala Humpty Dumpty 7", "N.H. 7", "Total H.D.",
            "Hasil Skrining Penilaian H.D.", "Nyeri Wajah", "N.N.Wajah", "Nyeri Kaki", "N.N.Kaki",
            "Nyeri Aktifitas", "N.N.Aktifitas", "Nyeri Menangis", "N.N.Menangis", "Nyeri Bersuara", "N.N.Bersuara",
            "Total Nilai Nyeri", "Kondisi Nyeri", "Lokasi Nyeri", "Durasi Nyeri", "Frekuensi Nyeri",
            "Nyeri Hilang Bila", "Keterangan Nyeri Hilang", "Nyeri Diberitahukan Dokter", "Jam Nyeri Diberitahukan",
            "Informasi Perencanaan Pulang", "Lama Rawat Rata-rata", "Perencanaan Pulang",
            "Kondisi Klinis Saat Pulang", "Perawatan Lanjutan Yang Diberikan Di Rumah", "Cara Transportasi Pulang",
            "Transportasi Yang Digunakan", "Rencana Keperawatan Lainnya"}) {
            @Override
        ...
        KeteranganKesediaanMenerimaInformasi
                .setDocument(new batasInput((int) 30).getKata(KeteranganKesediaanMenerimaInformasi));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalKeperawatanRanapBayiAnak dialog = new RMPenilaianAwalKeperawatanRanapBayiAnak(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("tanggal"), rs.getString("informasi"), rs.getString("ket_informasi"),
                        rs.getString("tiba_diruang_rawat"), rs.getString("rps"), rs.getString("rpd"),
                        rs.getString("rpk"), rs.getString("rpo"), rs.getString("alergi"),
                        rs.getString("tumbuh_kembang_tengkurap"), rs.getString("tumbuh_kembang_duduk"),
                        rs.getString("tumbuh_kembang_berdiri"), rs.getString("tumbuh_kembang_gigi_pertama"),
                        rs.getString("tumbuh_kembang_berjalan"), rs.getString("tumbuh_kembang_bicara"),
                        rs.getString("tumbuh_kembang_membaca"), rs.getString("tumbuh_kembang_menulis"),
                        rs.getString("tumbuh_kembang_gangguan_emosi"), rs.getString("persalinan_anakke"),
                        rs.getString("persalinan_darisaudara"), rs.getString("persalinan_kelahiran"),
                        rs.getString("persalinan_kelahiran_keterangan"), rs.getString("persalinan_umur_kelahiran"),
                        rs.getString("persalinan_kelainan_bawaan"),
                        rs.getString("persalinan_kelainan_bawaan_keterangan"), rs.getString("persalinan_bb_lahir"),
                        rs.getString("persalinan_pb_lahir"), rs.getString("persalinan_lainnya"),
                        rs.getString("fisik_kesadaran"), rs.getString("fisik_gcs"), rs.getString("fisik_td"),
                        rs.getString("fisik_rr"), rs.getString("fisik_suhu"), rs.getString("fisik_nadi"),
                        rs.getString("fisik_bb"), rs.getString("fisik_tb"), rs.getString("fisik_lp"),
                        rs.getString("fisik_lk"), rs.getString("fisik_ld"), rs.getString("saraf_pusat_kepala"),
                        rs.getString("saraf_pusat_kepala_keterangan"), rs.getString("saraf_pusat_wajah"),
                        rs.getString("saraf_pusat_wajah_keterangan"), rs.getString("saraf_pusat_leher"),
                        rs.getString("saraf_pusat_kejang"), rs.getString("saraf_pusat_kejang_keterangan"),
                        rs.getString("saraf_pusat_sensorik"), rs.getString("kardiovaskuler_pulsasi"),
                        rs.getString("kardiovaskuler_sirkulasi"),
                        rs.getString("kardiovaskuler_sirkulasi_keterangan"),
                        rs.getString("kardiovaskuler_denyut_nadi"), rs.getString("respirasi_retraksi"),
                        rs.getString("respirasi_pola_nafas"), rs.getString("respirasi_suara_nafas"),
                        rs.getString("respirasi_batuk"), rs.getString("respirasi_volume"),
                        rs.getString("respirasi_jenis_pernapasan"),
                        rs.getString("respirasi_jenis_pernapasan_keterangan"), rs.getString("respirasi_irama"),
                        rs.getString("gastro_mulut"), rs.getString("gastro_mulut_keterangan"),
                        rs.getString("gastro_tenggorakan"), rs.getString("gastro_tenggorakan_keterangan"),
                        rs.getString("gastro_lidah"), rs.getString("gastro_lidah_keterangan"),
                        rs.getString("gastro_abdomen"), rs.getString("gastro_abdomen_keterangan"),
                        rs.getString("gastro_gigi"), rs.getString("gastro_gigi_keterangan"),
                        rs.getString("gastro_usus"), rs.getString("gastro_anus"),
                        rs.getString("neurologi_sensorik"), rs.getString("neurologi_pengilihatan"),
                        rs.getString("neurologi_pengilihatan_keterangan"),
                        rs.getString("neurologi_alat_bantu_penglihatan"), rs.getString("neurologi_motorik"),
                        rs.getString("neurologi_pendengaran"), rs.getString("neurologi_bicara"),
                        rs.getString("neurologi_bicara_keterangan"), rs.getString("neurologi_otot"),
                        rs.getString("inte_kulit"), rs.getString("inte_warna_kulit"), rs.getString("inte_tugor"),
                        rs.getString("inte_decubi"), rs.getString("musku_odema"),
                        rs.getString("musku_odema_keterangan"), rs.getString("musku_pegerakansendi"),
                        rs.getString("musku_otot"), rs.getString("musku_fraktur"),
                        rs.getString("musku_fraktur_keterangan"), rs.getString("musku_nyerisendi"),
                        rs.getString("musku_nyerisendi_keterangan"), rs.getString("eliminasi_bab_frekuensi"),
                        rs.getString("eliminasi_bab_frekuensi_per"), rs.getString("eliminasi_bab_konsistesi"),
                        rs.getString("eliminasi_bab_warna"), rs.getString("eliminasi_bak_frekuensi"),
                        rs.getString("eliminasi_bak_frekuensi_per"), rs.getString("eliminasi_bak_warna"),
                        rs.getString("eliminasi_bak_lainlain"), rs.getString("psiko_kondisi"),
                        rs.getString("psiko_perilaku"), rs.getString("psiko_perilaku_keterangan"),
                        rs.getString("psiko_gangguan_jiwa"), rs.getString("psiko_hubungan_pasien"),
                        rs.getString("agama"), rs.getString("psiko_tinggal_dengan"),
                        rs.getString("psiko_tinggal_dengan_keterangan"), rs.getString("psiko_pekerjaan_pj"),
                        rs.getString("png_jawab"), rs.getString("psiko_nilai_kepercayaan"),
                        rs.getString("psiko_nilai_kepercayaan_keterangan"), rs.getString("nama_bahasa"),
                        rs.getString("pnd"), rs.getString("psiko_pendidikan_pj"), rs.getString("psiko_edukasi"),
                        rs.getString("psiko_edukasi_keterangan"), rs.getString("edukasi_bahasa"),
                        rs.getString("edukasi_baca_tulis"), rs.getString("edukasi_penerjemah"),
                        rs.getString("edukasi_penerjemah_keterangan"), rs.getString("edukasi_terdapat_hambatan"),
                        rs.getString("edukasi_hambatan_belajar"),
                        rs.getString("edukasi_hambatan_belajar_keterangan"),
                        rs.getString("edukasi_hambatan_bicara"), rs.getString("edukasi_bahasa_isyarat"),
                        rs.getString("edukasi_cara_belajar"), rs.getString("edukasi_menerima_informasi"),
                        rs.getString("edukasi_menerima_informasi_keterangan"), rs.getString("edukasi_nutrisi"),
                        rs.getString("edukasi_penyakit"), rs.getString("edukasi_pengobatan"),
                        rs.getString("edukasi_perawatan"), rs.getString("skrining_gizi1"),
                        ...
                        rs.getString("nilai_gizi4"), rs.getString("total_nilai"),
                        rs.getString("keterangan_skrining_gizi"), rs.getString("penilaian_humptydumpty_skala1"),
                        rs.getString("penilaian_humptydumpty_nilai1"),
                        rs.getString("penilaian_humptydumpty_skala2"),
                        rs.getString("penilaian_humptydumpty_nilai2"),
                        rs.getString("penilaian_humptydumpty_skala3"),
                        rs.getString("penilaian_humptydumpty_nilai3"),
                        rs.getString("penilaian_humptydumpty_skala4"),
                        rs.getString("penilaian_humptydumpty_nilai4"),
                        rs.getString("penilaian_humptydumpty_skala5"),
                        rs.getString("penilaian_humptydumpty_nilai5"),
                        rs.getString("penilaian_humptydumpty_skala6"),
                        rs.getString("penilaian_humptydumpty_nilai6"),
                        rs.getString("penilaian_humptydumpty_skala7"),
                        rs.getString("penilaian_humptydumpty_nilai7"),
                        rs.getString("penilaian_humptydumpty_totalnilai"),
                        rs.getString("hasil_skrining_penilaian_humptydumpty"), rs.getString("nyeri_wajah"),
                        rs.getString("nyeri_nilai_wajah"), rs.getString("nyeri_kaki"),
                        rs.getString("nyeri_nilai_kaki"), rs.getString("nyeri_aktifitas"),
                        rs.getString("nyeri_nilai_aktifitas"), rs.getString("nyeri_menangis"),
                        rs.getString("nyeri_nilai_menangis"), rs.getString("nyeri_bersuara"),
                        rs.getString("nyeri_nilai_bersuara"), rs.getString("nyeri_nilai_total"),
                        rs.getString("nyeri_kondisi"), rs.getString("nyeri_lokasi"), rs.getString("nyeri_durasi"),
                        rs.getString("nyeri_frekuensi"), rs.getString("nyeri_hilang"),
                        rs.getString("nyeri_hilang_keterangan"), rs.getString("nyeri_diberitahukan_pada_dokter"),
                        rs.getString("nyeri_diberitahukan_pada_dokter_keterangan"),
                        rs.getString("informasi_perencanaan_pulang"), rs.getString("lama_ratarata"),
                        rs.getString("perencanaan_pulang"), rs.getString("kondisi_klinis_pulang"),
                        rs.getString("perawatan_lanjutan_dirumah"), rs.getString("cara_transportasi_pulang"),
    ...
    private void isRawat() {
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "
                    + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj " + "where reg_periksa.no_rawat=?");
            try {
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_awal_keperawatan_ranap_bayi", "no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    TibadiRuang.getSelectedItem().toString(), RPS.getText(), RPD.getText(), RPK.getText(),
                    RPO.getText(), Alergi.getText(), UsiaTengkurap.getText(), UsiaDuduk.getText(),
                    UsiaBerdiri.getText(), UsiaGigi.getText(), UsiaBerjalan.getText(), UsiaBicara.getText(),
                    UsiaMembaca.getText(), UsiaMenulis.getText(), GangguanEmosi.getText(), Anakke.getText(),
                    ...
                    KetKelainanBawaan.getText(), BBLahir.getText(), PBLahir.getText(),
                    RiwayatPersalinanLainnya.getText(), Kesadaran.getSelectedItem().toString(), GCS.getText(),
                    TD.getText(), RR.getText(), Suhu.getText(), Nadi.getText(), BB.getText(), TB.getText(),
                    LP.getText(), LK.getText(), LD.getText(), SistemSarafKepala.getSelectedItem().toString(),
                    KetSistemSarafKepala.getText(), SistemSarafWajah.getSelectedItem().toString(),
                    KetSistemSarafWajah.getText(), SistemSarafLeher.getSelectedItem().toString(),
                    ...
                    RespirasiIrama.getSelectedItem().toString(), GastrointestinalMulut.getSelectedItem().toString(),
                    KetGastrointestinalMulut.getText(), GastrointestinalTenggorakan.getSelectedItem().toString(),
                    KetGastrointestinalTenggorakan.getText(), GastrointestinalLidah.getSelectedItem().toString(),
                    KetGastrointestinalLidah.getText(), GastrointestinalAbdomen.getSelectedItem().toString(),
                    KetGastrointestinalAbdomen.getText(), GastrointestinalGigi.getSelectedItem().toString(),
                    KetGastrointestinalGigi.getText(), GastrointestinalUsus.getSelectedItem().toString(),
                    ...
                    NeurologiMotorik.getSelectedItem().toString(),
                    NeurologiPendengaran.getSelectedItem().toString(), NeurologiBicara.getSelectedItem().toString(),
                    KetNeurologiBicara.getText(), NeurologiOtot.getSelectedItem().toString(),
                    IntegumentKulit.getSelectedItem().toString(), IntegumentWarnaKulit.getSelectedItem().toString(),
                    IntegumentTurgor.getSelectedItem().toString(), IntegumentDecubitus.getSelectedItem().toString(),
                    ...
                    WBAK.getText(), LBAK.getText(), KondisiPsikologis.getSelectedItem().toString(),
                    ...
                    PekerjaanPJ.getText(), NilaiKepercayaan.getSelectedItem().toString(),
                    KeteranganNilaiKepercayaan.getText(), PendidikanPJ.getSelectedItem().toString(),
                    EdukasiPsikolgis.getSelectedItem().toString(), KeteranganEdukasiPsikologis.getText(),
                    BahasaSehari.getText(), KemampuanBacaTulis.getSelectedItem().toString(),
                    ButuhPenerjemah.getSelectedItem().toString(), KeteranganButuhPenerjemah.getText(),
                    TerdapatHambatanBelajar.getSelectedItem().toString(),
                    ...
                    KeteranganKesediaanMenerimaInformasi.getText(), PemahamanNutrisi.getSelectedItem().toString(),
                    PemahamanPenyakit.getSelectedItem().toString(),
                    PemahamanPengobatan.getSelectedItem().toString(),
                    PemahamanPerawatan.getSelectedItem().toString(), SG1.getSelectedItem().toString(),
                    NilaiGizi1.getText(), SG2.getSelectedItem().toString(), NilaiGizi2.getText(),
                    SG3.getSelectedItem().toString(), NilaiGizi3.getText(), SG4.getSelectedItem().toString(),
                    NilaiGizi4.getText(), TotalNilaiGizi.getText(), KeteranganSkriningGizi.getText(),
                    ...
                    SkalaResiko7.getSelectedItem().toString(), NilaiResiko7.getText(), NilaiResikoTotal.getText(),
                    KeteranganTingkatRisiko.getText(), SkalaWajah.getSelectedItem().toString(),
                    NilaiWajah.getText(), SkalaKaki.getSelectedItem().toString(), NilaiKaki.getText(),
                    ...
                    Nyeri.getSelectedItem().toString(), LokasiNyeri.getText(), DurasiNyeri.getText(),
                    FrekuensiNyeri.getText(), NyeriHilang.getSelectedItem().toString(), KetNyeriHilang.getText(),
                    NyeriPadaDokter.getSelectedItem().toString(), NyeriJamDiberitahuDokter.getText(),
                    InformasiPerencanaanPulang.getSelectedItem().toString(), LamaRatarata.getText(),
                    Valid.SetTgl(TanggalPulang.getSelectedItem() + ""), KondisiPulang.getText(),
                    PerawatanLanjutan.getText(), CaraTransportasiPulang.getSelectedItem().toString(),
                    TransportasiYangDigunakan.getSelectedItem().toString(), Rencana.getText(), KdPetugas.getText(),
            ...
            Sequel.meghapus("penilaian_awal_keperawatan_ranap_bayi_masalah", "no_rawat",
                    tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString());
            Sequel.meghapus("penilaian_awal_keperawatan_ranap_bayi_rencana", "no_rawat",
                    tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString());
            Valid.tabelKosong(tabModeDetailMasalah);
            Valid.tabelKosong(tabModeDetailRencana);
            Valid.tabelKosong(tabModeImunisasi2);
            for (i = 0; i < tbMasalahKeperawatan.getRowCount(); i++) {
                if (tbMasalahKeperawatan.getValueAt(i, 0).toString().equals("true")) {
                    if (Sequel.menyimpantf2("penilaian_awal_keperawatan_ranap_bayi_masalah", "?,?", 2, new String[]{
            ...
            for (i = 0; i < tbRencanaKeperawatan.getRowCount(); i++) {
                if (tbRencanaKeperawatan.getValueAt(i, 0).toString().equals("true")) {
                    if (Sequel.menyimpantf2("penilaian_awal_keperawatan_ranap_bayi_rencana", "?,?", 2, new String[]{
    ...
    private void simpan() {
        if (Sequel.menyimpantf("penilaian_awal_keperawatan_ranap_bayi",
            ...
            tabMode.addRow(new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), TglLahir.getText(),
                ...
                RespirasiRetraksi.getSelectedItem().toString(), RespirasiPolaNafas.getSelectedItem().toString(),
                RespirasiSuaraNafas.getSelectedItem().toString(), RespirasiBatuk.getSelectedItem().toString(),
                RespirasiVolume.getSelectedItem().toString(), RespirasiJenisPernafasan.getSelectedItem().toString(),
                KetRespirasiJenisPernafasan.getText(), RespirasiIrama.getSelectedItem().toString(),
                GastrointestinalMulut.getSelectedItem().toString(), KetGastrointestinalMulut.getText(),
                GastrointestinalTenggorakan.getSelectedItem().toString(), KetGastrointestinalTenggorakan.getText(),
                ...
                IntegumentDecubitus.getSelectedItem().toString(), MuskuloskletalOedema.getSelectedItem().toString(),
                KetMuskuloskletalOedema.getText(), MuskuloskletalPegerakanSendi.getSelectedItem().toString(),
                MuskuloskletalKekuatanOtot.getSelectedItem().toString(),
                MuskuloskletalFraktur.getSelectedItem().toString(), KetMuskuloskletalFraktur.getText(),
                MuskuloskletalNyeriSendi.getSelectedItem().toString(), KetMuskuloskletalNyeriSendi.getText(),
                BAB.getText(), XBAB.getText(), KBAB.getText(), WBAB.getText(), BAK.getText(), XBAK.getText(),
                ...
                AdakahPerilaku.getSelectedItem().toString(), KeteranganAdakahPerilaku.getText(),
                GangguanJiwa.getSelectedItem().toString(), HubunganAnggotaKeluarga.getSelectedItem().toString(),
                Agama.getText(), TinggalDengan.getSelectedItem().toString(), KeteranganTinggalDengan.getText(),
                PekerjaanPJ.getText(), CaraBayar.getText(), NilaiKepercayaan.getSelectedItem().toString(),
                KeteranganNilaiKepercayaan.getText(), BahasaPasien.getText(), PendidikanPasien.getText(),
                PendidikanPJ.getSelectedItem().toString(), EdukasiPsikolgis.getSelectedItem().toString(),
                KeteranganEdukasiPsikologis.getText(), BahasaSehari.getText(),
                KemampuanBacaTulis.getSelectedItem().toString(), ButuhPenerjemah.getSelectedItem().toString(),
                KeteranganButuhPenerjemah.getText(), TerdapatHambatanBelajar.getSelectedItem().toString(),
                HambatanBelajar.getSelectedItem().toString(), KeteranganHambatanBelajar.getText(),
                HambatanCaraBicara.getSelectedItem().toString(), HambatanBahasaIsyarat.getSelectedItem().toString(),
                CaraBelajarDisukai.getSelectedItem().toString(),
                KesediaanMenerimaInformasi.getSelectedItem().toString(),
                KeteranganKesediaanMenerimaInformasi.getText(), PemahamanNutrisi.getSelectedItem().toString(),
                PemahamanPenyakit.getSelectedItem().toString(), PemahamanPengobatan.getSelectedItem().toString(),
                PemahamanPerawatan.getSelectedItem().toString(), SG1.getSelectedItem().toString(),
                NilaiGizi1.getText(), SG2.getSelectedItem().toString(), NilaiGizi2.getText(),
                SG3.getSelectedItem().toString(), NilaiGizi3.getText(), SG4.getSelectedItem().toString(),
                NilaiGizi4.getText(), TotalNilaiGizi.getText(), KeteranganSkriningGizi.getText(),
                ...
                SkalaResiko6.getSelectedItem().toString(), NilaiResiko6.getText(),
                SkalaResiko7.getSelectedItem().toString(), NilaiResiko7.getText(), NilaiResikoTotal.getText(),
                KeteranganTingkatRisiko.getText(), SkalaWajah.getSelectedItem().toString(), NilaiWajah.getText(),
                ...
                Valid.SetTgl(TanggalPulang.getSelectedItem() + ""), KondisiPulang.getText(),
                PerawatanLanjutan.getText(), CaraTransportasiPulang.getSelectedItem().toString(),
                TransportasiYangDigunakan.getSelectedItem().toString(), Rencana.getText()});
            for (i = 0; i < tbMasalahKeperawatan.getRowCount(); i++) {
                if (tbMasalahKeperawatan.getValueAt(i, 0).toString().equals("true")) {
                    if (Sequel.menyimpantf2("penilaian_awal_keperawatan_ranap_bayi_masalah", "?,?", 2, new String[]{
                        TNoRw.getText(), tbMasalahKeperawatan.getValueAt(i, 1).toString()}) == true) {
