...
public class RMPenilaianLanjutanRisikoJatuhGeriatri extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().trim().isEmpty() || TPasien.getText().trim().
            ...
            if (Sequel.menyimpantf("penilaian_lanjutan_resiko_jatuh_geriatri",
                    "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                    "Data", 28, new String[]{
                        ...
                        NilaiResiko11.getText(), NilaiResikoTotal.getText(),
                ...
                tabMode.addRow(new String[]{
                    ...
                    SkalaResiko7.getSelectedItem().toString(), NilaiResiko7.
                    getText(), SkalaResiko8.getSelectedItem().toString(),
                    NilaiResiko8.getText(), SkalaResiko9.getSelectedItem().
                    toString(), NilaiResiko9.getText(),
                    SkalaResiko10.getSelectedItem().toString(), NilaiResiko10.
                    getText(), SkalaResiko11.getSelectedItem().toString(),
                    NilaiResiko11.getText(), NilaiResikoTotal.getText(),
                    HasilSkrining.getText(),
        ...
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("finger",
                    ...
                    isEmpty() ? tbObat.getValueAt(tbObat.getSelectedRow(), 31).
                            ...
                            getSelectedItem());
            Valid.MyReportqry(
                    "rptFormulirPenilaianLanjutanRisikoJatuhGeriatri.jasper",
                    "report",
                    "::[ Formulir Penilaian Lanjutan Risiko Jatuh Geriatri ]::",
                    ...
                    + "inner join petugas on penilaian_lanjutan_resiko_jatuh_geriatri.nip=petugas.nip where reg_periksa.no_rawat='" + tbObat.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianLanjutanRisikoJatuhGeriatri dialog = new RMPenilaianLanjutanRisikoJatuhGeriatri(
    ...
    private void isTotalResikoJatuh() {
        try {
            ...
            if (Integer.parseInt(NilaiResikoTotal.getText()) <= 3) {
                ...
                TingkatResiko.setText(
                        "Tingkat Resiko : Risiko Tinggi (>= 4), Tindakan : Intervensi pencegahan risiko jatuh standar dan Intervensi risiko jatuh tinggi");
            }
        } catch (Exception e) {
            NilaiResikoTotal.setText("0");
            TingkatResiko.setText(
