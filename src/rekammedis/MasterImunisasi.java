...
public class MasterImunisasi extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("master_imunisasi",
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, TKd, "master_imunisasi",
                "kode_imunisasi") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                if (Sequel.mengedittf("master_imunisasi", "kode_imunisasi=?",
                        "kode_imunisasi=?,nama_imunisasi=?", 3, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterImunisasi dialog = new MasterImunisasi(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from master_imunisasi where master_imunisasi.kode_imunisasi like ? or master_imunisasi.nama_imunisasi like ? order by master_imunisasi.kode_imunisasi");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(MasterImunisasi.class.
            getName());
}
