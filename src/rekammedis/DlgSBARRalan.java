...
public class DlgSBARRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ SBAR Perawatan Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    private void prosesCari() {
        ...
        try {
            ...
            htmlContent.append("<tr class='isi'>"
                    ...
                    + "<td valign='middle' bgcolor='#FFFAF8' align='center' width='66%'>S.B.A.R</td>" + "</tr>");
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        // "+
                        // "from pemeriksaan_ranap inner join pegawai on
                        // pemeriksaan_ranap.nik=pegawai.nik inner join departemen on
                        // pegawai.departemen=departemen.dep_id where
                        // pemeriksaan_ranap.no_rawat='"+rs.getString("no_rawat")+"' "+
                        // "order by
                        // pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat").executeQuery();
                        rs2 = koneksi.prepareStatement(
                                "select pemeriksaan_ralan_sbar.tgl_perawatan,pemeriksaan_ralan_sbar.jam_rawat,pemeriksaan_ralan_sbar.situation,"
                                + "pemeriksaan_ralan_sbar.background,pemeriksaan_ralan_sbar.assesment,pemeriksaan_ralan_sbar.recommendation,pemeriksaan_ralan_sbar.nip,pemeriksaan_ralan_sbar.kd_dokter,pegawai.nama,departemen.nama,"
                                ...
                                + "where pemeriksaan_ralan_sbar.no_rawat='" + rs.getString("no_rawat") + "' "
                                + "order by pemeriksaan_ralan_sbar.tgl_perawatan,pemeriksaan_ralan_sbar.jam_rawat")
                                .executeQuery();
                        if (rs2.next()) {
                            htmlContent.append("<tr class='isi'>"
                            ...
                            while (rs2.next()) {
                                ...
                                bagian = Sequel
                                        .cariIsi("SELECT bidang FROM pegawai WHERE nik='" + rs2.getString("nip") + "'");
                                ...
                                if (Sequel.cariInteger("select count(validasi_pemeriksaan_sbar_ralan.nik_validator) "
                                        + "from pemeriksaan_ralan_sbar inner join pegawai on pemeriksaan_ralan_sbar.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id LEFT JOIN pegawai AS namavalidator ON pemeriksaan_ralan_sbar.kd_dokter=namavalidator.nik left join validasi_pemeriksaan_sbar_ralan on pemeriksaan_ralan_sbar.jam_rawat = validasi_pemeriksaan_sbar_ralan.jam_rawat AND pemeriksaan_ralan_sbar.no_rawat = validasi_pemeriksaan_sbar_ralan.no_rawat AND pemeriksaan_ralan_sbar.tgl_perawatan = validasi_pemeriksaan_sbar_ralan.tgl_perawatan "
                                        + "where pemeriksaan_ralan_sbar.no_rawat='" + rs.getString("no_rawat")
                                        + "' AND validasi_pemeriksaan_sbar_ralan.nik_validator='"
                                        + rs2.getString("nik_validator")
                                        + "' AND validasi_pemeriksaan_sbar_ralan.status_validasi='Validasi'"
                                        + "order by pemeriksaan_ralan_sbar.tgl_perawatan,pemeriksaan_ralan_sbar.jam_rawat") > 0) {
                                    gbrverif = "<img src ='http://" + koneksiDB.HOSTHYBRIDWEB() + ":"
                                            + koneksiDB.PORTWEB() + "/" + koneksiDB.HYBRIDWEB()
                                            + "/images/verif.png' align='center' width='100' height='50'/";
                                } else {
                                    gbrverif = "<img src ='http://" + koneksiDB.HOSTHYBRIDWEB() + ":"
                                            + koneksiDB.PORTWEB() + "/" + koneksiDB.HYBRIDWEB()
                                            + "/images/notverif.png' align='center' width='100' height='50'/";
                                }
                                // System.out.println("Notif Rekening : "+stylee);
                                // System.out.println("Notif Rekening :
                                // "+rs2.getString("nik"));
                                // 2021/04/18/000056
                                htmlContent.append("<tr class='isi'  ><td align='center' ")
                                        ...
                                        .append("<br>(")
                                        .append(rs2.getString("departemen.nama"))
                                        .append(")</td><td align='left' ")
                                        .append(stylee)
                                        .append(" >")
                                        .append(rs2.getString("situation"))
                                        .append("</td><td align='left' ")
                                        .append(stylee)
                                        .append(">")
                                        .append(rs2.getString("background"))
                                        .append("</td><td align='left' ")
                                        .append(stylee)
                                        .append(">")
                                        .append(rs2.getString("assesment"))
                                        .append("</td><td align='left' ")
                                        .append(stylee)
                                        .append(">")
                                        .append(rs2.getString("recommendation"))
                                        .append("</td><td align='left' ")
                                        .append(stylee)
                                        .append(" ")
                                        .append(gbrverif)
                                        .append("><br>")
                                        .append(rs2.getString("namavalidator"))
                                        .append("<br>")
                                        .append(rs2.getString("tgl_validasi"))
                                        .append("<br>")
                                        .append(rs2.getString("jam_validasi"))
                                        .append("</td></tr>");
                            }
                        }
                    } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgSBARRalan.class.getName());
