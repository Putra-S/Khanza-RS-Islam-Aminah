...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSBARRalan dialog = new DlgSBARRalan(new javax.swing.JFrame(),
                    true);
...
//                                "order by pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat").executeQuery();
                        rs2 = koneksi.prepareStatement(
                                ...
                                + "where pemeriksaan_ralan_sbar.no_rawat='" + rs.
                                        getString("no_rawat") + "' "
                        ...
                        if (rs2.next()) {
                            ...
                            while (rs2.next()) {
                                ...
                                bagian = Sequel.cariIsi(
                                        "SELECT bidang FROM pegawai WHERE nik='" + rs2.
                                                getString("nip") + "'");
                                ...
                                if (Sequel.cariInteger(
                                        "select count(validasi_pemeriksaan_sbar_ralan.nik_validator) "
                                        + "from pemeriksaan_ralan_sbar inner join pegawai on pemeriksaan_ralan_sbar.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id LEFT JOIN pegawai AS namavalidator ON pemeriksaan_ralan_sbar.kd_dokter=namavalidator.nik left join validasi_pemeriksaan_sbar_ralan on pemeriksaan_ralan_sbar.jam_rawat = validasi_pemeriksaan_sbar_ralan.jam_rawat AND pemeriksaan_ralan_sbar.no_rawat = validasi_pemeriksaan_sbar_ralan.no_rawat AND pemeriksaan_ralan_sbar.tgl_perawatan = validasi_pemeriksaan_sbar_ralan.tgl_perawatan "
                                        + "where pemeriksaan_ralan_sbar.no_rawat='" + rs.
                                                getString("no_rawat") + "' AND validasi_pemeriksaan_sbar_ralan.nik_validator='" + rs2.
                                        getString("nik_validator") + "' AND validasi_pemeriksaan_sbar_ralan.status_validasi='Validasi'"
                                        + "order by pemeriksaan_ralan_sbar.tgl_perawatan,pemeriksaan_ralan_sbar.jam_rawat") > 0) {
                                    gbrverif = "<img src ='http://" + koneksiDB.
                                            HOSTHYBRIDWEB() + ":" + koneksiDB.
                                                    PORTWEB() + "/" + koneksiDB.
                                                    HYBRIDWEB() + "/images/verif.png' align='center' width='100' height='50'/";
                                } else {
                                    gbrverif = "<img src ='http://" + koneksiDB.
                                            HOSTHYBRIDWEB() + ":" + koneksiDB.
                                                    PORTWEB() + "/" + koneksiDB.
                                                    HYBRIDWEB() + "/images/notverif.png' align='center' width='100' height='50'/";
                                }
...
//                                 System.out.println("Notif Rekening : "+rs2.getString("nik"));
                                ...
                                htmlContent.append(
                                        ...
                                        append(stylee).append(" >").append(rs2.
                                        getString("tgl_perawatan")).append(
                                        "<br>").append(rs2.
                                                getString("jam_rawat")).append(
                                        "</td><td valign='top'  ").
                                        append(stylee).append(" >").append(rs2.
                                        getString("nama")).append("<br>(").
                                        append(rs2.getString("departemen.nama")).
                                        append(")</td><td align='left' ").
                                        append(stylee).append(" >").append(rs2.
                                        getString("situation")).append(
                                        "</td><td align='left' ").append(stylee).
                                        append(">").append(rs2.getString(
                                        "background")).append(
                                                "</td><td align='left' ").
                                        append(stylee).append(">").append(rs2.
                                        getString("assesment")).append(
                                        "</td><td align='left' ").append(stylee).
                                        append(">").append(rs2.getString(
                                        "recommendation")).append(
                                                "</td><td align='left' ").
                                        append(stylee).append(" ").append(
                                        gbrverif).append("><br>").append(rs2.
                                        getString("namavalidator")).append(
                                        "<br>").append(rs2.getString(
                                                "tgl_validasi")).append("<br>").
    ...
    private static final Logger LOG = Logger.getLogger(DlgSBARRalan.class.
            getName());
