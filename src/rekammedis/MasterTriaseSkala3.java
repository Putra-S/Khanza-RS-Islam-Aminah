...
public class MasterTriaseSkala3 extends javax.swing.JDialog {
        ...
        pemeriksaan.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (pemeriksaan.getTable().getSelectedRow() != -1) {
                    kdpemeriksaan.setText(
                            pemeriksaan.getTable().getValueAt(pemeriksaan.getTable().getSelectedRow(), 0).toString());
    ...
    private static final Logger LOG = Logger.getLogger(MasterTriaseSkala3.class.getName());
