...
public class MasterTriaseSkala3 extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdskala.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("master_triase_skala3", "'" + kdpemeriksaan.
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, kdskala, "master_triase_skala3",
                "kode_skala3") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdskala.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("master_triase_skala3", "kode_skala3=?",
                        "kode_skala3=?,pengkajian_skala3=?,kode_pemeriksaan=?",
                        4, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterTriaseSkala3 dialog = new MasterTriaseSkala3(
    ...
    private static final Logger LOG = Logger.getLogger(MasterTriaseSkala3.class.
            getName());
}
