...
public class RMPenilaianUlangNyeri extends javax.swing.JDialog {
    ...
    public RMPenilaianUlangNyeri(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Nyeri Hilang", "Ket. Hilang Nyeri", "NIP", "Petugas"
        }) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().trim().isEmpty() || TPasien.getText().trim().
            ...
            if (Sequel.menyimpantf("penilaian_ulang_nyeri",
                    "?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 14, new String[]{
                        ...
                        SkalaNyeri.getSelectedItem().toString(), Durasi.
                        getText(), NyeriHilang.getSelectedItem().toString(),
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptPenilaianUlangNyeri.jasper", "report",
                        "::[ Data Penilaian Ulang Nyeri ]::",
                        ...
                        + "penilaian_ulang_nyeri.tanggal between '" + Valid.
                ...
                Valid.MyReportqry("rptPenilaianUlangNyeri.jasper", "report",
                        ...
                        + "(reg_periksa.no_rawat like '%" + TCari.getText().
                                ...
                                getText().trim() + "%' "
                        + "or penilaian_ulang_nyeri.nip like '%" + TCari.
    ...
    private void MnPenilaianUlangNyeriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianUlangNyeriActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry("rptFormulirPenilaianUlangNyeri.jasper", "report",
                    "::[ Formulir Penilaian Ulang Nyeri ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,penilaian_ulang_nyeri.tanggal,"
                    + "penilaian_ulang_nyeri.nyeri,penilaian_ulang_nyeri.provokes,penilaian_ulang_nyeri.ket_provokes,penilaian_ulang_nyeri.quality,"
                    + "penilaian_ulang_nyeri.ket_quality,penilaian_ulang_nyeri.lokasi,penilaian_ulang_nyeri.menyebar,penilaian_ulang_nyeri.skala_nyeri,"
                    + "penilaian_ulang_nyeri.durasi,penilaian_ulang_nyeri.nyeri_hilang,penilaian_ulang_nyeri.ket_nyeri,penilaian_ulang_nyeri.nip,petugas.nama "
                    + "from penilaian_ulang_nyeri inner join reg_periksa on penilaian_ulang_nyeri.no_rawat=reg_periksa.no_rawat "
                    + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join petugas on penilaian_ulang_nyeri.nip=petugas.nip where reg_periksa.no_rawat='" + tbObat.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianUlangNyeri dialog = new RMPenilaianUlangNyeri(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        getString("ket_quality"), rs.getString("lokasi"),
                        rs.getString("menyebar"), rs.getString("skala_nyeri"),
                        rs.getString("durasi"), rs.getString("nyeri_hilang"),
                        rs.getString("ket_nyeri"), rs.getString("nip"),
                        rs.getString("nama")
                    });
                }
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Nyeri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 6).
                    toString());
            Provokes.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),
                    7).toString());
            KetProvokes.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 8).
                    toString());
            Quality.setSelectedItem(tbObat.
                    getValueAt(tbObat.getSelectedRow(), 9).toString());
            KetQuality.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 10).
                    toString());
            Lokasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 11).
                    toString());
            ...
            Durasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 14).
                    toString());
            NyeriHilang.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 15).toString());
            KetNyeri.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 16).
                    toString());
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_ulang_nyeri",
                "tanggal=? and no_rawat=?",
                "no_rawat=?,tanggal=?,nyeri=?,provokes=?,ket_provokes=?,quality=?,ket_quality=?,lokasi=?,"
                + "menyebar=?,skala_nyeri=?,durasi=?,nyeri_hilang=?,ket_nyeri=?,nip=?",
                16, new String[]{
                    TNoRw.getText(), Valid.
                    ...
                    Lokasi.getText(), Menyebar.getSelectedItem().toString(),
                    SkalaNyeri.getSelectedItem().toString(), Durasi.getText(),
                    NyeriHilang.getSelectedItem().toString(),
                    KetNyeri.getText(), NIP.getText(), tbObat.getValueAt(tbObat.
                    getSelectedRow(), 5).toString(), tbObat.getValueAt(tbObat.
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from penilaian_ulang_nyeri where tanggal=? and no_rawat=?",
                2, new String[]{
    ...
    private static final Logger LOG = Logger.getLogger(
            RMPenilaianUlangNyeri.class.getName());
}
