...
public class RMPenilaianUlangNyeri extends javax.swing.JDialog {
    ...
    public RMPenilaianUlangNyeri(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Tgl.Lahir", "JK", "Tanggal", "Tingkat Nyeri",
                    "Provokes", "Ket. Provokes", "Kualitas", "Ket. Kualitas", "Lokasi", "Menyebar", "Skala Nyeri",
                    "Durasi", "Nyeri Hilang", "Ket. Hilang Nyeri", "NIP", "Petugas"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("tanggal"), rs.getString("nyeri"), rs.getString("provokes"),
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_ulang_nyeri", "tanggal=? and no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    Lokasi.getText(), Menyebar.getSelectedItem().toString(),
                    SkalaNyeri.getSelectedItem().toString(), Durasi.getText(),
                    NyeriHilang.getSelectedItem().toString(), KetNyeri.getText(), NIP.getText(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_ulang_nyeri where tanggal=? and no_rawat=?", 2,
    ...
    private static final Logger LOG = Logger.getLogger(RMPenilaianUlangNyeri.class.getName());
