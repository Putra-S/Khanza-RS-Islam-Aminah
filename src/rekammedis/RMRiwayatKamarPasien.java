...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMRiwayatKamarPasien dialog = new RMRiwayatKamarPasien(
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + "reg_periksa.tgl_registrasi between ? and ? " + (TCari.
                            getText().trim().isEmpty() ? "" : "and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ?) ")
                            ...
                            while (rs2.next()) {
                                htmlContent.append(
                                        ...
                                        "</td><td valign='top'>").append(rs2.
                                                getString("tgl_masuk")).append(
                                        " ").append(rs2.getString("jam_masuk")).
                                        append("</td><td valign='top'>").append(
                                        rs2.getString("tgl_keluar")).append(" ").
                                        append(rs2.getString("jam_keluar")).
                                        append("</td><td valign='top'>").append(
                                        rs2.getString("lama")).append(
                                        "</td><td valign='top'>").append(rs2.
                                                getString("kd_kamar")).append(
                                        ", ").
                                        append(rs2.getString("nm_bangsal")).
                                        append("</td><td valign='top'>").append(
                                        rs2.getString("stts_pulang")).append(
    ...
    private static final Logger LOG = Logger.getLogger(
            RMRiwayatKamarPasien.class.getName());
