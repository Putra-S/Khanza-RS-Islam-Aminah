...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    private void prosesCari() {
        ...
        try {
            ...
            htmlContent.append("<tr class='isi'>"
                    ...
                    + "<td valign='middle' bgcolor='#FFFAF8' align='center' width='69%'>Riwayat Kamar</td>" + "</tr>");
                    ...
                    try {
                        ...
                        if (rs2.next()) {
                            htmlContent.append(
                                    ...
                                    + "<td valign='top' width='10%' bgcolor='#FFFAF8'>Biaya</td>" + "</tr>");
                            rs2.beforeFirst();
                            w = 1;
                            while (rs2.next()) {
                                htmlContent.append("<tr><td valign='top' align='center'>")
                                        ...
                                        .append(rs2.getString("tgl_masuk"))
                                        .append(" ")
                                        .append(rs2.getString("jam_masuk"))
                                        .append("</td><td valign='top'>")
                                        .append(rs2.getString("tgl_keluar"))
                                        .append(" ")
                                        .append(rs2.getString("jam_keluar"))
                                        .append("</td><td valign='top'>")
                                        .append(rs2.getString("lama"))
                                        .append("</td><td valign='top'>")
                                        .append(rs2.getString("kd_kamar"))
                                        .append(", ")
                                        .append(rs2.getString("nm_bangsal"))
                                        .append("</td><td valign='top'>")
                                        .append(rs2.getString("stts_pulang"))
                                        .append("</td><td valign='top' align='right'>")
                                        .append(Valid.SetAngka(rs2.getDouble("ttl_biaya")))
                                        .append("</td></tr>");
                                w++;
                            }
    ...
    private static final Logger LOG = Logger.getLogger(RMRiwayatKamarPasien.class.getName());
