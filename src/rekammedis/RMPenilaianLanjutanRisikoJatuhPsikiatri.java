 ...
 * @author perpustakaan
 */
public class RMPenilaianLanjutanRisikoJatuhPsikiatri extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMPenilaianLanjutanRisikoJatuhPsikiatri(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Skala Edmonson 1", "N.E. 1",
            "Skala Edmonson 2", "N.E. 2", "Skala Edmonson 3", "N.E. 3",
            "Skala Edmonson 4", "N.E. 4", "Skala Edmonson 5", "N.E. 5",
            "Skala Edmonson 6", "N.E. 6", "Total", "Hasil Skrining", "Saran",
            "NIP", "Petugas"
        }) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().trim().isEmpty() || TPasien.getText().trim().
            ...
            if (Sequel.menyimpantf("penilaian_lanjutan_resiko_jatuh_psikiatri",
                    "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 18,
                    new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptLanjutanRisikoJatuhPsikiatri.jasper",
                        "report",
                        "::[ Data Penilaian Lanjutan Risiko Jatuh Psikiatri ]::",
                        ...
                        + "penilaian_lanjutan_resiko_jatuh_psikiatri.tanggal between '" + Valid.
                ...
                Valid.MyReportqry("rptLanjutanRisikoJatuhPsikiatri.jasper",
                        ...
                        + "(reg_periksa.no_rawat like '%" + TCari.getText().
                                ...
                                getText().trim() + "%' "
                        + "or penilaian_lanjutan_resiko_jatuh_psikiatri.nip like '%" + TCari.
        ...
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("finger",
                    ...
                    isEmpty() ? tbObat.getValueAt(tbObat.getSelectedRow(), 21).
                            ...
                            getSelectedItem());
            Valid.MyReportqry(
                    "rptFormulirPenilaianLanjutanRisikoJatuhPsikiatri.jasper",
                    "report",
                    "::[ Formulir Penilaian Lanjutan Risiko Jatuh Psikiatri ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,penilaian_lanjutan_resiko_jatuh_psikiatri.tanggal,"
                    + "penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_skala1,penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_nilai1,"
                    + "penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_skala2,penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_nilai2,"
                    + "penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_skala3,penilaian_lanjutan_resiko_jatuh_psikiatri.penilaian_jatuhedmonson_nilai3,"
                    ...
                    + "from penilaian_lanjutan_resiko_jatuh_psikiatri inner join reg_periksa on penilaian_lanjutan_resiko_jatuh_psikiatri.no_rawat=reg_periksa.no_rawat "
                    + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join petugas on penilaian_lanjutan_resiko_jatuh_psikiatri.nip=petugas.nip where reg_periksa.no_rawat='" + tbObat.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianLanjutanRisikoJatuhPsikiatri dialog = new RMPenilaianLanjutanRisikoJatuhPsikiatri(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("penilaian_jatuhedmonson_skala1"), rs.
                        getString("penilaian_jatuhedmonson_nilai1"), rs.
                        getString("penilaian_jatuhedmonson_skala2"), rs.
                        getString("penilaian_jatuhedmonson_nilai2"),
                        rs.getString("penilaian_jatuhedmonson_skala3"), rs.
                        getString("penilaian_jatuhedmonson_nilai3"), rs.
                        getString("penilaian_jatuhedmonson_skala4"), rs.
                        getString("penilaian_jatuhedmonson_nilai4"),
                        rs.getString("penilaian_jatuhedmonson_skala5"), rs.
                        getString("penilaian_jatuhedmonson_nilai5"), rs.
                        getString("penilaian_jatuhedmonson_skala6"), rs.
                        getString("penilaian_jatuhedmonson_nilai6"),
                        rs.getString("penilaian_jatuhedmonson_totalnilai"), rs.
                        getString("hasil_skrining"), rs.getString("saran"), rs.
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Saran.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 20).
                    toString());
    ...
    public void isCek() {
        ...
        BtnHapus.
                setEnabled(akses.getpenilaian_lanjutan_resiko_jatuh_psikiatri());
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_lanjutan_resiko_jatuh_psikiatri",
                "tanggal=? and no_rawat=?",
                "no_rawat=?,tanggal=?,penilaian_jatuhedmonson_skala1=?,penilaian_jatuhedmonson_nilai1=?,"
                ...
                + "penilaian_jatuhedmonson_totalnilai=?,hasil_skrining=?,saran=?,nip=?",
                20, new String[]{
                    TNoRw.getText(), Valid.
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from penilaian_lanjutan_resiko_jatuh_psikiatri where tanggal=? and no_rawat=?",
                2, new String[]{
        ...
        try {
            ...
            if (Integer.parseInt(NilaiResikoTotal.getText()) < 90) {
                TingkatResiko.setText(
                        "Tingkat Resiko : Tidak Berisiko (0-89), Tindakan : Intervensi pencegahan risiko jatuh standar");
            } else if (Integer.parseInt(NilaiResikoTotal.getText()) >= 90) {
                TingkatResiko.setText(
                        "Tingkat Resiko : Risiko Tinggi (> 90), Tindakan : Intervensi pencegahan risiko jatuh standar dan Intervensi risiko jatuh tinggi");
            }
        } catch (Exception e) {
            NilaiResikoTotal.setText("0");
            TingkatResiko.setText(
    ...
    private static final Logger LOG = Logger.getLogger(
            RMPenilaianLanjutanRisikoJatuhPsikiatri.class.getName());
}
