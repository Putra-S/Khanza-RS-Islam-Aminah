...
public class RMPenilaianLanjutanRisikoJatuhPsikiatri extends javax.swing.JDialog {
    ...
    public RMPenilaianLanjutanRisikoJatuhPsikiatri(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Tgl.Lahir", "JK", "Tanggal", "Skala Edmonson 1",
                    "N.E. 1", "Skala Edmonson 2", "N.E. 2", "Skala Edmonson 3", "N.E. 3", "Skala Edmonson 4",
                    "N.E. 4", "Skala Edmonson 5", "N.E. 5", "Skala Edmonson 6", "N.E. 6", "Total", "Hasil Skrining",
                    "Saran", "NIP", "Petugas"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("tanggal"), rs.getString("penilaian_jatuhedmonson_skala1"),
                        rs.getString("penilaian_jatuhedmonson_nilai1"),
                        rs.getString("penilaian_jatuhedmonson_skala2"),
                        rs.getString("penilaian_jatuhedmonson_nilai2"),
                        rs.getString("penilaian_jatuhedmonson_skala3"),
                        rs.getString("penilaian_jatuhedmonson_nilai3"),
                        rs.getString("penilaian_jatuhedmonson_skala4"),
                        rs.getString("penilaian_jatuhedmonson_nilai4"),
                        rs.getString("penilaian_jatuhedmonson_skala5"),
                        rs.getString("penilaian_jatuhedmonson_nilai5"),
                        rs.getString("penilaian_jatuhedmonson_skala6"),
                        rs.getString("penilaian_jatuhedmonson_nilai6"),
                        rs.getString("penilaian_jatuhedmonson_totalnilai"), rs.getString("hasil_skrining"),
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_lanjutan_resiko_jatuh_psikiatri", "tanggal=? and no_rawat=?",
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_lanjutan_resiko_jatuh_psikiatri where tanggal=? and no_rawat=?", 2,
    ...
    private static final Logger LOG = Logger.getLogger(RMPenilaianLanjutanRisikoJatuhPsikiatri.class.getName());
