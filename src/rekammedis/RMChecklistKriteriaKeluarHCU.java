 ...
 * @author perpustakaan
 */
public class RMChecklistKriteriaKeluarHCU extends javax.swing.JDialog {
    ...
    public RMChecklistKriteriaKeluarHCU(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Pasien Yang Sudah Tidak Memerlukan Perawatan Di Ruang HCU",
            "Hypertensi Emergency Teratasi / Normal",
            "HR 60 - 100 x/menit (Hasil EKG Menunjukkan Perbaikan / Sinus Rithme)",
            "Kesadaran Dengan GCS >= 7",
            "Gangguan Inotropic / Vasoaktif Gent Teratasi / Normal",
            "MAP >= 60 mmHg", "RR 12 - 20x/menit",
            "Gangguan Elektrolit (Na, Ca, CI, Mg, Cal) & Asam Basa Normal",
            "Perdarahan Saluran Pencernaan Teratasi", "Temperature 35 - 38°C",
            "Gagal Jantung Akut Teratasi", "Gangguan Sirkulasi Teratasi",
            "NIP/Kode Dokter", "DPJP/Dokter Jaga/HCU"
        }) {
            @Override
    ...
    private void MnKriteriaKeluarHCUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKriteriaKeluarHCUActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("finger",
                    ...
                    isEmpty() ? tbObat.getValueAt(tbObat.getSelectedRow(), 18).
                                    toString() : finger) + "\n" + Tanggal.
                            getSelectedItem());
            Valid.MyReportqry("rptFormulirChecklistKriteriaKeluarHCU.jasper",
                    "report", "::[ Formulir Check List Kriteria Keluar HCU ]::",
                    ...
                    + "where checklist_kriteria_keluar_hcu.no_rawat='" + tbObat.
                            getValueAt(tbObat.getSelectedRow(), 0).toString() + "' and checklist_kriteria_keluar_hcu.tanggal='" + tbObat.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMChecklistKriteriaKeluarHCU dialog = new RMChecklistKriteriaKeluarHCU(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("jk"),
                        rs.getString("tanggal"), rs.getString("kriteria1"), rs.
                        getString("kriteria2"), rs.getString("kriteria3"), rs.
                        getString("kriteria4"),
                        rs.getString("kriteria5"), rs.getString("kriteria6"),
                        rs.getString("kriteria7"), rs.getString("kriteria8"),
                        rs.getString("kriteria9"),
                        rs.getString("kriteria10"), rs.getString("kriteria11"),
                        rs.getString("kriteria12"), rs.getString("nik"), rs.
                        getString("nama")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Kriteria4.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),
                    9).toString());
            Kriteria5.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),
                    10).toString());
            Kriteria6.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),
                    11).toString());
            Kriteria7.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),
                    12).toString());
            Kriteria8.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),
                    13).toString());
            Kriteria9.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),
                    14).toString());
            Kriteria10.setSelectedItem(tbObat.
                    getValueAt(tbObat.getSelectedRow(), 15).toString());
            Kriteria11.setSelectedItem(tbObat.
                    getValueAt(tbObat.getSelectedRow(), 16).toString());
            Kriteria12.setSelectedItem(tbObat.
    ...
    private void ganti() {
        if (Sequel.mengedittf("checklist_kriteria_keluar_hcu",
                "no_rawat=? and tanggal=?",
                "no_rawat=?,tanggal=?,kriteria1=?,kriteria2=?,kriteria3=?,kriteria4=?,kriteria5=?,"
                + "kriteria6=?,kriteria7=?,kriteria8=?,kriteria9=?,kriteria10=?,kriteria11=?,kriteria12=?,nik=?",
                17, new String[]{
                    TNoRw.getText(), Valid.
                    SetTgl(Tanggal.getSelectedItem() + "") + " " + Tanggal.
                    getSelectedItem().toString().substring(11, 19), Kriteria1.
                    getSelectedItem().toString(),
                    Kriteria2.getSelectedItem().toString(), Kriteria3.
                    getSelectedItem().toString(), Kriteria4.getSelectedItem().
                            toString(), Kriteria5.getSelectedItem().toString(),
                    Kriteria6.getSelectedItem().toString(), Kriteria7.
                    getSelectedItem().toString(), Kriteria8.getSelectedItem().
                            toString(), Kriteria9.getSelectedItem().toString(),
                    Kriteria10.getSelectedItem().toString(), Kriteria11.
                    getSelectedItem().toString(), Kriteria12.getSelectedItem().
                            toString(), KodePetugas.getText(),
            ...
            tbObat.setValueAt(
                    ...
                    getSelectedRow(), 5);
            tbObat.setValueAt(Kriteria1.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 6);
            tbObat.setValueAt(Kriteria2.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 7);
            tbObat.setValueAt(Kriteria3.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 8);
            tbObat.setValueAt(Kriteria4.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 9);
            tbObat.setValueAt(Kriteria5.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 10);
            tbObat.setValueAt(Kriteria6.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 11);
            tbObat.setValueAt(Kriteria7.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 12);
            tbObat.setValueAt(Kriteria8.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 13);
            tbObat.setValueAt(Kriteria9.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 14);
            tbObat.setValueAt(Kriteria10.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 15);
            tbObat.setValueAt(Kriteria11.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 16);
            tbObat.setValueAt(Kriteria12.getSelectedItem().toString(), tbObat.
                    getSelectedRow(), 17);
            tbObat.
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from checklist_kriteria_keluar_hcu where no_rawat=? and tanggal=?",
                2, new String[]{
                    tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString(),
                    tbObat.getValueAt(tbObat.getSelectedRow(), 5).toString()
                }) == true) {
    ...
    private void simpan() {
        if (Sequel.menyimpantf("checklist_kriteria_keluar_hcu",
                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 15, new String[]{
                    TNoRw.getText(), Valid.
                    SetTgl(Tanggal.getSelectedItem() + "") + " " + Tanggal.
                    getSelectedItem().toString().substring(11, 19), Kriteria1.
            ...
            tabMode.addRow(new String[]{
                ...
                toString(), Kriteria4.getSelectedItem().toString(), Kriteria5.
                getSelectedItem().toString(),
                Kriteria6.getSelectedItem().toString(), Kriteria7.
                getSelectedItem().toString(), Kriteria8.getSelectedItem().
                toString(), Kriteria9.getSelectedItem().toString(), Kriteria10.
                getSelectedItem().toString(),
                Kriteria11.getSelectedItem().toString(), Kriteria12.
    ...
    private static final Logger LOG = Logger.getLogger(
            RMChecklistKriteriaKeluarHCU.class.getName());
}
