...
public class RMPemantauanPEWSD extends javax.swing.JDialog {
    ...
    public RMPemantauanPEWSD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Umur", "JK", "Tanggal", "Skor Respirasi",
                    "Skor 1", "Skor Oksigen", "Skor 2", "Skor Suplemen Oksigen", "Skor 3", "Skor Tekanan Darah",
                    "Skor 4", "Skor Laju Jantung", "Skor 5", "Skor Kesadaran", "Skor 6", "Skor Temperatur",
                    "Skor 7", "Ttl.Skor", "Kesimpulan", "NIP", "Petugas", "Tgl.Lahir"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("jk"), rs.getString("tanggal"), rs.getString("parameter_laju_respirasi"),
                        rs.getString("skor_laju_respirasi"), rs.getString("parameter_saturasi_oksigen"),
                        rs.getString("skor_saturasi_oksigen"), rs.getString("parameter_suplemen_oksigen"),
                        rs.getString("skor_suplemen_oksigen"), rs.getString("parameter_tekanan_darah_sistolik"),
                        rs.getString("skor_tekanan_darah_sistolik"), rs.getString("parameter_laju_jantung"),
                        rs.getString("skor_laju_jantung"), rs.getString("parameter_kesadaran"),
                        rs.getString("skor_kesadaran"), rs.getString("parameter_temperatur"),
                        rs.getString("skor_temperatur"), rs.getString("skor_total"),
                        rs.getString("parameter_total"), rs.getString("nip"), rs.getString("nama"),
                        rs.getString("lahir")});
                }
            } catch (Exception e) {
    ...
    private void ganti() {
        ...
        isjml();
        isHitung();
        if (Sequel.mengedittf("pemantauan_pews_dewasa", "tanggal=? and no_rawat=?",
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from pemantauan_pews_dewasa where tanggal=? and no_rawat=?", 2,
    ...
    private static final Logger LOG = Logger.getLogger(RMPemantauanPEWSD.class.getName());
