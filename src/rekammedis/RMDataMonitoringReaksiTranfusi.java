 ...
 * @author perpustakaan
 */
public class RMDataMonitoringReaksiTranfusi extends javax.swing.JDialog {
    ...
    public RMDataMonitoringReaksiTranfusi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Tanggal", "Jam", "Produk/Jenis Darah",
            "No.Kantong", "Lokasi Insersi", "TD(mmHg)", "HR(x/menit)",
            "RR(x/menit)", "Suhu(°C)", "Alergi", "Keterangan",
            "NIP", "Nama Petugas"
        }) {
            @Override
        ...
        LokasiInsersi.setDocument(new batasInput((byte) 40).getKata(
                LokasiInsersi));
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-03-2023" }));
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        ...
                        for (i = 0; i < tabMode.getRowCount(); i++) {
                            htmlContent.append(
                                    "<tr class='isi'>"
                                    + "<td valign='top'>" + tabMode.
                                            getValueAt(i, 0) + "</td>"
                                    + "<td valign='top'>" + tabMode.
                                            getValueAt(i, 1) + "</td>"
                                    + "<td valign='top'>" + tabMode.
                                            getValueAt(i, 2) + "</td>"
                                    + "<td valign='top' align='center'>" + tabMode.
                                            getValueAt(i, 3) + "</td>"
                                    + "<td valign='top' align='center'>" + tabMode.
                                            getValueAt(i, 4) + "</td>"
                                    + "<td valign='top' align='center'>" + tabMode.
                        ...
                        bw.write("<html>"
                                ...
                                getemailrs() + "<br><br>"
                                + "<font size='2' face='Tahoma'>MONITORING REAKSI TRANFUSI PERIODE " + DTPCari1.
                    ...
                    case "Laporan 3 (CSV)":
                        ...
                        for (i = 0; i < tabMode.getRowCount(); i++) {
                            htmlContent.append(
                                    "\"" + tabMode.getValueAt(i, 0) + "\";\"" + tabMode.
                                    getValueAt(i, 1) + "\";\"" + tabMode.
                                    getValueAt(i, 2) + "\";\"" + tabMode.
                                    getValueAt(i, 3) + "\";\"" + tabMode.
                                    getValueAt(i, 4) + "\";\"" + tabMode.
                                    getValueAt(i, 5) + "\";\"" + tabMode.
                                    getValueAt(i, 6) + "\";\"" + tabMode.
                                    getValueAt(i, 7) + "\";\"" + tabMode.
                                    getValueAt(i, 8) + "\";\"" + tabMode.
                                    getValueAt(i, 9) + "\";\"" + tabMode.
                                    getValueAt(i, 10) + "\";\"" + tabMode.
                                    getValueAt(i, 11) + "\";\"" + tabMode.
                                    getValueAt(i, 12) + "\";\"" + tabMode.
                                    getValueAt(i, 13) + "\";\"" + tabMode.
                                    getValueAt(i, 14) + "\";\"" + tabMode.
                                    getValueAt(i, 15) + "\";\"" + tabMode.
                                    getValueAt(i, 16) + "\";\"" + tabMode.
                                    getValueAt(i, 17) + "\";\"" + tabMode.
                                    getValueAt(i, 18) + "\"\n"
                            );
                        }
    ...
    private void MnMonitoringReaksiTranfusiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnMonitoringReaksiTranfusiActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry("rptFormulirMonitoringReaksiTranfusi.jasper",
                    "report", "::[ Formulir Monitoring Reaksi Tranfusi ]::",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataMonitoringReaksiTranfusi dialog = new RMDataMonitoringReaksiTranfusi(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("produk_darah"), rs.getString("no_kantong"),
                        rs.getString("lokasi_insersi"), rs.getString("td"), rs.
                        getString("hr"), rs.getString("rr"), rs.
                        getString("suhu"),
                        rs.getString("jenis_reaksi_alergi"), rs.getString(
                        "keterangan"), rs.getString("nip"), rs.getString("nama")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            JenisDarah.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 8).
                    toString());
            NoKantong.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 9).
                    toString());
            LokasiInsersi.setText(
            ...
            RR.
                    setText(tbObat.getValueAt(tbObat.getSelectedRow(), 13).
                            toString());
            Suhu.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 14).
                    toString());
    ...
    private void ganti() {
        if (Sequel.mengedittf("monitoring_reaksi_tranfusi",
                "tgl_perawatan=? and jam_rawat=? and no_rawat=?",
                "no_rawat=?,tgl_perawatan=?,jam_rawat=?,produk_darah=?,"
                + "no_kantong=?,lokasi_insersi=?,td=?,hr=?,rr=?,suhu=?,jenis_reaksi_alergi=?,keterangan=?,nip=?",
                16, new String[]{
                    TNoRw.getText(), Valid.
                    SetTgl(Tanggal.getSelectedItem() + ""), Jam.
                    getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
                    getSelectedItem(),
                    JenisDarah.getText(), NoKantong.getText(), LokasiInsersi.
                    getText(), TD.getText(), HR.getText(), RR.getText(), Suhu.
                    getText(), Alergi.getText(),
            ...
            tbObat.setValueAt(LokasiInsersi.getText(), tbObat.getSelectedRow(),
                    10);
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from monitoring_reaksi_tranfusi where tgl_perawatan=? and jam_rawat=? and no_rawat=?",
                3, new String[]{
    ...
    private void simpan() {
        if (Sequel.menyimpantf("monitoring_reaksi_tranfusi",
                "?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 13, new String[]{
                    TNoRw.getText(), Valid.
                    SetTgl(Tanggal.getSelectedItem() + ""), Jam.
                    getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
    ...
    private static final Logger LOG = Logger.getLogger(
            RMDataMonitoringReaksiTranfusi.class.getName());
