...
public class RMUjiFungsiKFR extends javax.swing.JDialog {
    ...
    public RMUjiFungsiKFR(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Umur", "JK", "Tgl.Lahir", "Tanggal Uji",
                    "Diagnosis Fugsional", "Diagnosis Medis", "Hasil Yang Didapat", "Kesimpulan", "Rekomendasi",
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("jk"), rs.getString("lahir"), rs.getString("tanggal"),
                        rs.getString("diagnosis_fungsional"), rs.getString("diagnosis_medis"),
                        rs.getString("hasil_didapat"), rs.getString("kesimpulan"), rs.getString("rekomedasi"),
    ...
    private void ganti() {
        Sequel.mengedit("uji_fungsi_kfr", "no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    DiagnosisFungsional.getText(), DiagnosisMedis.getText(), HasilYangDidapat.getText(),
    ...
    private static final Logger LOG = Logger.getLogger(RMUjiFungsiKFR.class.getName());
