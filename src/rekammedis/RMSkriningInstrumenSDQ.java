...
public final class RMSkriningInstrumenSDQ extends javax.swing.JDialog {
    ...
    public RMSkriningInstrumenSDQ(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Tgl.Lahir", "JK", "NIP", "Petugas", "Tanggal",
                    "SDQ1", "N.SDQ1", "SDQ2", "N.SDQ2", "SDQ3", "N.SDQ3", "SDQ4", "N.SDQ4", "SDQ5", "N.SDQ5",
                    "SDQ6", "N.SDQ6", "SDQ7", "N.SDQ7", "SDQ8", "N.SDQ8", "SDQ9", "N.SDQ9", "SDQ10", "N.SDQ10",
                    "SDQ11", "N.SDQ11", "SDQ12", "N.SDQ12", "SDQ13", "N.SDQ13", "SDQ14", "N.SDQ14", "SDQ15",
                    "N.SDQ15", "SDQ16", "N.SDQ16", "SDQ17", "N.SDQ17", "SDQ18", "N.SDQ18", "SDQ19", "N.SDQ19",
                    "SDQ20", "N.SDQ20", "SDQ21", "N.SDQ21", "SDQ22", "N.SDQ22", "SDQ23", "N.SDQ23", "SDQ24",
                    "N.SDQ24", "SDQ25", "N.SDQ25", "Nilai Total SDQ", "Gejala Emosional (E)", "N.GE",
                    "Masalah Perilaku (C)", "N.MP", "Hiperaktivitas (H)", "N.H", "Teman Sebaya (P)", "N.TS",
                    "Kekuatan(Pr)", "N.KPr", "Kesulitan", "N.K", "Keterangan"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("pernyataansdq1"), rs.getString("nilai_sdq1"), rs.getString("pernyataansdq2"),
                        rs.getString("nilai_sdq2"), rs.getString("pernyataansdq3"), rs.getString("nilai_sdq3"),
                        rs.getString("pernyataansdq4"), rs.getString("nilai_sdq4"), rs.getString("pernyataansdq5"),
                        rs.getString("nilai_sdq5"), rs.getString("pernyataansdq6"), rs.getString("nilai_sdq6"),
                        rs.getString("pernyataansdq7"), rs.getString("nilai_sdq7"), rs.getString("pernyataansdq8"),
                        rs.getString("nilai_sdq8"), rs.getString("pernyataansdq9"), rs.getString("nilai_sdq9"),
                        rs.getString("pernyataansdq10"), rs.getString("nilai_sdq10"),
                        rs.getString("pernyataansdq11"), rs.getString("nilai_sdq11"),
                        rs.getString("pernyataansdq12"), rs.getString("nilai_sdq12"),
                        rs.getString("pernyataansdq13"), rs.getString("nilai_sdq13"),
                        rs.getString("pernyataansdq14"), rs.getString("nilai_sdq14"),
                        rs.getString("pernyataansdq15"), rs.getString("nilai_sdq15"),
                        rs.getString("pernyataansdq16"), rs.getString("nilai_sdq16"),
                        rs.getString("pernyataansdq17"), rs.getString("nilai_sdq17"),
                        rs.getString("pernyataansdq18"), rs.getString("nilai_sdq18"),
                        rs.getString("pernyataansdq19"), rs.getString("nilai_sdq19"),
                        rs.getString("pernyataansdq20"), rs.getString("nilai_sdq20"),
                        rs.getString("pernyataansdq21"), rs.getString("nilai_sdq21"),
                        rs.getString("pernyataansdq22"), rs.getString("nilai_sdq22"),
                        rs.getString("pernyataansdq23"), rs.getString("nilai_sdq23"),
                        rs.getString("pernyataansdq24"), rs.getString("nilai_sdq24"),
                        rs.getString("pernyataansdq25"), rs.getString("nilai_sdq25"),
                        rs.getString("nilai_total_sdq"), rs.getString("gejala_emosional"),
                        rs.getString("nilai_gejala_emosional"), rs.getString("masalah_perilaku"),
                        rs.getString("nilai_masalah_perilaku"), rs.getString("hiperaktivitas"),
                        rs.getString("nilai_hiperaktivitas"), rs.getString("teman_sebaya"),
                        rs.getString("nilai_teman_sebaya"), rs.getString("kekuatan"),
                        rs.getString("nilai_kekuatan"), rs.getString("kesulitan"), rs.getString("nilai_kesulitan"),
    ...
    private void ganti() {
        if (Sequel.mengedittf("skrining_instrumen_sdq", "no_rawat=?",
                "no_rawat=?,tanggal=?,nip=?,pernyataansdq1=?,nilai_sdq1=?,pernyataansdq2=?,nilai_sdq2=?,pernyataansdq3=?,nilai_sdq3=?,"
                ...
                + "kekuatan=?,nilai_kekuatan=?,kesulitan=?,nilai_kesulitan=?,keterangan=?",
                68,
                new String[]{TNoRw.getText(),
                    ...
                    NIP.getText(), SDQ1.getSelectedItem().toString(), NilaiSDQ1.getText(),
                    SDQ2.getSelectedItem().toString(), NilaiSDQ2.getText(), SDQ3.getSelectedItem().toString(),
                    NilaiSDQ3.getText(), SDQ4.getSelectedItem().toString(), NilaiSDQ4.getText(),
                    SDQ5.getSelectedItem().toString(), NilaiSDQ5.getText(), SDQ6.getSelectedItem().toString(),
                    NilaiSDQ6.getText(), SDQ7.getSelectedItem().toString(), NilaiSDQ7.getText(),
                    SDQ8.getSelectedItem().toString(), NilaiSDQ8.getText(), SDQ9.getSelectedItem().toString(),
                    NilaiSDQ9.getText(), SDQ10.getSelectedItem().toString(), NilaiSDQ10.getText(),
                    SDQ11.getSelectedItem().toString(), NilaiSDQ11.getText(), SDQ12.getSelectedItem().toString(),
                    NilaiSDQ12.getText(), SDQ13.getSelectedItem().toString(), NilaiSDQ13.getText(),
                    SDQ14.getSelectedItem().toString(), NilaiSDQ14.getText(), SDQ15.getSelectedItem().toString(),
                    NilaiSDQ15.getText(), SDQ16.getSelectedItem().toString(), NilaiSDQ16.getText(),
                    SDQ17.getSelectedItem().toString(), NilaiSDQ17.getText(), SDQ18.getSelectedItem().toString(),
                    NilaiSDQ18.getText(), SDQ19.getSelectedItem().toString(), NilaiSDQ19.getText(),
                    SDQ20.getSelectedItem().toString(), NilaiSDQ20.getText(), SDQ21.getSelectedItem().toString(),
                    NilaiSDQ21.getText(), SDQ22.getSelectedItem().toString(), NilaiSDQ22.getText(),
                    SDQ23.getSelectedItem().toString(), NilaiSDQ23.getText(), SDQ24.getSelectedItem().toString(),
                    NilaiSDQ24.getText(), SDQ25.getSelectedItem().toString(), NilaiSDQ25.getText(),
                    TotalNilai.getText(), KesimpulanSkorE.getText(), NilaiKesimpulanSkorE.getText(),
                    KesimpulanSkorC.getText(), NilaiKesimpulanSkorC.getText(), KesimpulanSkorH.getText(),
                    NilaiKesimpulanSkorH.getText(), KesimpulanSkorP.getText(), NilaiKesimpulanSkorP.getText(),
                    KesimpulanSkorPr.getText(), NilaiKesimpulanSkorPr.getText(), KesimpulanKesulitan.getText(),
                    NilaiKesimpulanKesulitan.getText(), Keterangan.getText(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from skrining_instrumen_sdq where tanggal=? and no_rawat=?", 2,
    ...
    private void isTotal() {
        TotalNilai.setText("" + (Integer.parseInt(NilaiSDQ1.getText()) + Integer.parseInt(NilaiSDQ2.getText())
                + Integer.parseInt(NilaiSDQ3.getText()) + Integer.parseInt(NilaiSDQ4.getText())
                + Integer.parseInt(NilaiSDQ5.getText()) + Integer.parseInt(NilaiSDQ6.getText())
                + Integer.parseInt(NilaiSDQ7.getText()) + Integer.parseInt(NilaiSDQ8.getText())
                + Integer.parseInt(NilaiSDQ9.getText()) + Integer.parseInt(NilaiSDQ10.getText())
                + Integer.parseInt(NilaiSDQ11.getText()) + Integer.parseInt(NilaiSDQ12.getText())
                + Integer.parseInt(NilaiSDQ13.getText()) + Integer.parseInt(NilaiSDQ14.getText())
                + Integer.parseInt(NilaiSDQ15.getText()) + Integer.parseInt(NilaiSDQ16.getText())
                + Integer.parseInt(NilaiSDQ17.getText()) + Integer.parseInt(NilaiSDQ18.getText())
                + Integer.parseInt(NilaiSDQ19.getText()) + Integer.parseInt(NilaiSDQ20.getText())
                + Integer.parseInt(NilaiSDQ21.getText()) + Integer.parseInt(NilaiSDQ22.getText())
                + Integer.parseInt(NilaiSDQ23.getText()) + Integer.parseInt(NilaiSDQ24.getText())
                + Integer.parseInt(NilaiSDQ25.getText())));
    }

    private void SkorE() {
        try {
            NilaiKesimpulanSkorE.setText("" + (Integer.parseInt(NilaiSDQ3.getText())
                    + Integer.parseInt(NilaiSDQ8.getText()) + Integer.parseInt(NilaiSDQ13.getText())
                    + Integer.parseInt(NilaiSDQ16.getText()) + Integer.parseInt(NilaiSDQ24.getText())));
    ...
    private void SkorC() {
        try {
            NilaiKesimpulanSkorC.setText("" + (Integer.parseInt(NilaiSDQ5.getText())
                    + Integer.parseInt(NilaiSDQ7.getText()) + Integer.parseInt(NilaiSDQ12.getText())
                    + Integer.parseInt(NilaiSDQ18.getText()) + Integer.parseInt(NilaiSDQ22.getText())));
    ...
    private void SkorH() {
        try {
            NilaiKesimpulanSkorH.setText("" + (Integer.parseInt(NilaiSDQ2.getText())
                    + Integer.parseInt(NilaiSDQ10.getText()) + Integer.parseInt(NilaiSDQ15.getText())
                    + Integer.parseInt(NilaiSDQ21.getText()) + Integer.parseInt(NilaiSDQ25.getText())));
    ...
    private void SkorP() {
        try {
            NilaiKesimpulanSkorP.setText("" + (Integer.parseInt(NilaiSDQ6.getText())
                    + Integer.parseInt(NilaiSDQ11.getText()) + Integer.parseInt(NilaiSDQ14.getText())
                    + Integer.parseInt(NilaiSDQ19.getText()) + Integer.parseInt(NilaiSDQ23.getText())));
    ...
    private void SkorPr() {
        try {
            NilaiKesimpulanSkorPr.setText("" + (Integer.parseInt(NilaiSDQ1.getText())
                    + Integer.parseInt(NilaiSDQ4.getText()) + Integer.parseInt(NilaiSDQ9.getText())
                    + Integer.parseInt(NilaiSDQ17.getText()) + Integer.parseInt(NilaiSDQ20.getText())));
    ...
    private void SkorKesulitan() {
        try {
            NilaiKesimpulanKesulitan.setText("" + (Integer.parseInt(NilaiKesimpulanSkorE.getText())
                    + Integer.parseInt(NilaiKesimpulanSkorC.getText())
                    + Integer.parseInt(NilaiKesimpulanSkorH.getText())
                    + Integer.parseInt(NilaiKesimpulanSkorP.getText())));
    ...
    private void simpan() {
        if (Sequel.menyimpantf("skrining_instrumen_sdq",
                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                "Data", 67,
                new String[]{TNoRw.getText(),
                    Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Jam.getSelectedItem() + ":"
                    ...
                    NilaiKesimpulanSkorH.getText(), KesimpulanSkorP.getText(), NilaiKesimpulanSkorP.getText(),
                    KesimpulanSkorPr.getText(), NilaiKesimpulanSkorPr.getText(), KesimpulanKesulitan.getText(),
                    NilaiKesimpulanKesulitan.getText(), Keterangan.getText()}) == true) {
            tabMode.addRow(new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), TglLahir.getText(),
                Jk.getText(), NIP.getText(), NamaPetugas.getText(),
                Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Jam.getSelectedItem() + ":"
                + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
                SDQ1.getSelectedItem().toString(), NilaiSDQ1.getText(), SDQ2.getSelectedItem().toString(),
                NilaiSDQ2.getText(), SDQ3.getSelectedItem().toString(), NilaiSDQ3.getText(),
                SDQ4.getSelectedItem().toString(), NilaiSDQ4.getText(), SDQ5.getSelectedItem().toString(),
                NilaiSDQ5.getText(), SDQ6.getSelectedItem().toString(), NilaiSDQ6.getText(),
                SDQ7.getSelectedItem().toString(), NilaiSDQ7.getText(), SDQ8.getSelectedItem().toString(),
                NilaiSDQ8.getText(), SDQ9.getSelectedItem().toString(), NilaiSDQ9.getText(),
                SDQ10.getSelectedItem().toString(), NilaiSDQ10.getText(), SDQ11.getSelectedItem().toString(),
                NilaiSDQ11.getText(), SDQ12.getSelectedItem().toString(), NilaiSDQ12.getText(),
                SDQ13.getSelectedItem().toString(), NilaiSDQ13.getText(), SDQ14.getSelectedItem().toString(),
                NilaiSDQ14.getText(), SDQ15.getSelectedItem().toString(), NilaiSDQ15.getText(),
                SDQ16.getSelectedItem().toString(), NilaiSDQ16.getText(), SDQ17.getSelectedItem().toString(),
                NilaiSDQ17.getText(), SDQ18.getSelectedItem().toString(), NilaiSDQ18.getText(),
                SDQ19.getSelectedItem().toString(), NilaiSDQ19.getText(), SDQ20.getSelectedItem().toString(),
                NilaiSDQ20.getText(), SDQ21.getSelectedItem().toString(), NilaiSDQ21.getText(),
                SDQ22.getSelectedItem().toString(), NilaiSDQ22.getText(), SDQ23.getSelectedItem().toString(),
                NilaiSDQ23.getText(), SDQ24.getSelectedItem().toString(), NilaiSDQ24.getText(),
                SDQ25.getSelectedItem().toString(), NilaiSDQ25.getText(), TotalNilai.getText(),
                KesimpulanSkorE.getText(), NilaiKesimpulanSkorE.getText(), KesimpulanSkorC.getText(),
                NilaiKesimpulanSkorC.getText(), KesimpulanSkorH.getText(), NilaiKesimpulanSkorH.getText(),
                KesimpulanSkorP.getText(), NilaiKesimpulanSkorP.getText(), KesimpulanSkorPr.getText(),
                NilaiKesimpulanSkorPr.getText(), KesimpulanKesulitan.getText(), NilaiKesimpulanKesulitan.getText(),
                Keterangan.getText()});
            emptTeks();
            LCount.setText("" + tabMode.getRowCount());
        }
