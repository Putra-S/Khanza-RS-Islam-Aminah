 ...
 * @author dosen
 */
public class RMCariHasilRadiologi extends javax.swing.JDialog {
    ...
    private String norawat = "", sqle = "", status = "", norm = "";

    private int z = 0, i = 0, jml = 0, index = 0;

    private boolean[] pilih;

    private String[] tanggal, jam, radiologi;
    ...
    public RMCariHasilRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"P", "Tanggal", "Jam", "Hasil Pemeriksaan"}) {
...
//GEN-LAST:event_ppSemuaActionPerformed
  ...
  // End of variables declaration//GEN-END:variables
    ...
    public void tampil() {
        ...
        for (i = 0; i < tabMode.getRowCount(); i++) {
            if (tabMode.getValueAt(i, 0).toString().equals("true")) {
                ...
                radiologi[index] = tabMode.getValueAt(i, 3).toString();
                index++;
            }
        }
        ...
        for (i = 0; i < jml; i++) {
            tabMode.addRow(new Object[]{pilih[i], tanggal[i], jam[i], radiologi[i]});
        }
        ...
        if (status.equals("Ralan")) {
            ...
            sqle = "reg_periksa.no_rkm_medis='" + norm + "' and hasil_radiologi.tgl_periksa = CURDATE()";
        } else {
            sqle = "reg_periksa.no_rawat='" + norawat + "'";
        }
        Valid.tabelKosong(tabMode);
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "where " + sqle
                    + " and (hasil_radiologi.tgl_periksa like ? or hasil_radiologi.hasil like ?) "
    ...
    private static final Logger LOG = Logger.getLogger(RMCariHasilRadiologi.class.getName());
