...
public class RMCariObatPulang extends javax.swing.JDialog {
    ...
    public RMCariObatPulang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"P", "Tanggal", "Jam", "Obat Pulang"}) {
...
//GEN-LAST:event_ppSemuaActionPerformed
  ...
  // End of variables declaration//GEN-END:variables
    ...
    public void tampil() {
        ...
        for (i = 0; i < jml; i++) {
            tabMode.addRow(new Object[]{pilih[i], tanggal[i], jam[i], obatpulang[i]});
        }
        Valid.tabelKosong(tabMode);
        try {
            ps = koneksi.prepareStatement(
                    // "select
                    // resep_pulang.tanggal,resep_pulang.jam,databarang.nama_brng,resep_pulang.jml_barang,resep_pulang.dosis
                    // "+
                    // "from resep_pulang inner join databarang on
                    // databarang.kode_brng=resep_pulang.kode_brng where
                    // resep_pulang.no_rawat=? "+
                    // "and (resep_pulang.tanggal like ? or databarang.nama_brng like ?)
    ...
    private static final Logger LOG = Logger.getLogger(RMCariObatPulang.class.getName());
