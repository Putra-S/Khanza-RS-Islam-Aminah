...
public class RMRekonsiliasiObat extends javax.swing.JDialog {
    ...
    public RMRekonsiliasiObat(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Nama Obat", "Dosis Obat", "Frekuensi", "Cara Pemberian/Aturan Pakai",
                    "Waktu Pemberian Terakhir", "Tindak Lanjut", "Perubahan Aturan Pakai"}) {
            @Override
    ...
    private void autoNomor() {
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(rekonsiliasi_obat.no_rekonsiliasi,4),signed)),0) from rekonsiliasi_obat where left(rekonsiliasi_obat.tanggal_wawancara,10)='"
                + Valid.SetTgl(Tanggal.getSelectedItem() + "") + "' ",
                "RO" + Valid.SetTgl(Tanggal.getSelectedItem() + "").replaceAll("-", ""), 4, TNoRekonsialiasi);
    }
    ...
    private static final Logger LOG = Logger.getLogger(RMRekonsiliasiObat.class.getName());
