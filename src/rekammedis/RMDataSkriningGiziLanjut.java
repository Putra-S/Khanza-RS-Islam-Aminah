    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptDataSkriningGiziLanjut.jasper", "report",
                        "::[ Data Skrining Gizi ]::",
                        ...
                        + "skrining_gizi.tanggal between '" + Valid.SetTgl(
                                DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                        SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' order by skrining_gizi.tanggal ",
                        param);
            } else {
                Valid.MyReportqry("rptDataSkriningGiziLanjut.jasper", "report",
                        "::[ Data Skrining Gizi ]::",
                        ...
                        + "where skrining_gizi.tanggal between '" + Valid.
                        ...
                        + "(reg_periksa.no_rawat like '%" + TCari.getText().
                                ...
                                getText().trim() + "%' "
                        + "or pasien.nm_pasien like '%" + TCari.getText().trim() + "%' or skrining_gizi.alergi like '%" + TCari.
                        getText().trim() + "%' "
                        + "or skrining_gizi.parameter_total like '%" + TCari.
                                getText().trim() + "%' or skrining_gizi.nip like '%" + TCari.
    ...
    private void MnSkriningGiziActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSkriningGiziActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("diagnosa", Sequel.cariIsi(
                    ...
                    TNoRw.getText()));
            Valid.MyReportqry("rptFormulirSkriningGizi.jasper", "report",
                    ...
                    + "inner join petugas on skrining_gizi.nip=petugas.nip where reg_periksa.no_rawat='" + tbObat.
                            getValueAt(tbObat.getSelectedRow(), 0).toString() + "' and skrining_gizi.tanggal='" + tbObat.
