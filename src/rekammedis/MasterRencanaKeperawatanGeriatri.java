...
public class MasterRencanaKeperawatanGeriatri extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterRencanaKeperawatanGeriatri dialog = new MasterRencanaKeperawatanGeriatri(new javax.swing.JFrame(),
                    true);
    ...
    private static final Logger LOG = Logger.getLogger(MasterRencanaKeperawatanGeriatri.class.getName());
