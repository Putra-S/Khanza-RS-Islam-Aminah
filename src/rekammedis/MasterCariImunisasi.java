...
public class MasterCariImunisasi extends javax.swing.JDialog {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    iyem = iyem + "{\"KodeImunisasi\":\"" + rs.getString(1) + "\",\"NamaImunisasi\":\""
                            + rs.getString(2) + "\"},";
                }
            } catch (Exception e) {
        ...
        try {
            ...
            if (response.isArray()) {
                for (JsonNode list : response) {
                    if (list.path("KodeImunisasi").asText().toLowerCase().contains(TCari.getText().toLowerCase())
                            || list.path("NamaImunisasi")
                                    .asText()
                                    .toLowerCase()
                                    .contains(TCari.getText().toLowerCase())) {
                        tabMode.addRow(new Object[]{list.path("KodeImunisasi").asText(),
                            list.path("NamaImunisasi").asText()});
                    }
                }
            }
            myObj.close();
    ...
    private static final Logger LOG = Logger.getLogger(MasterCariImunisasi.class.getName());
