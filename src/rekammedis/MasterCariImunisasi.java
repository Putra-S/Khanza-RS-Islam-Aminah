 ...
 * @author dosen
 */
public class MasterCariImunisasi extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterCariImunisasi dialog = new MasterCariImunisasi(
    ...
    private void tampil() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select master_imunisasi.kode_imunisasi, master_imunisasi.nama_imunisasi from master_imunisasi order by master_imunisasi.nama_imunisasi");
            try {
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(
                            new String[]{rs.getString(1), rs.getString(2)});
                    iyem = iyem + "{\"KodeImunisasi\":\"" + rs.getString(1) + "\",\"NamaImunisasi\":\"" + rs.
                            getString(2) + "\"},";
                }
            } catch (Exception e) {
            ...
            fileWriter.write("{\"master_imunisasi\":[" + iyem.substring(0, iyem.
                    length() - 1) + "]}");
            fileWriter.flush();
            fileWriter.close();
            iyem = null;
        ...
        try {
            ...
            if (response.isArray()) {
                for (JsonNode list : response) {
                    if (list.path("KodeImunisasi").asText().toLowerCase().
                            contains(TCari.getText().toLowerCase()) || list.
                            path("NamaImunisasi").asText().toLowerCase().
                            contains(TCari.getText().toLowerCase())) {
                        tabMode.addRow(new Object[]{
                            list.path("KodeImunisasi").asText(), list.path(
                            "NamaImunisasi").asText()
                        });
                    }
                }
            }
    ...
    private static final Logger LOG = Logger.getLogger(
            MasterCariImunisasi.class.getName());
}
