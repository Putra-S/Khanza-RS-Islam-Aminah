 ...
 * @author dosen
 */
public class RMCariRencana extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMCariRencana(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(10, 2);
        setSize(656, 250);

        Object[] row = {"Tanggal", "Jam", "Rencana"};
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariRencana dialog = new RMCariRencana(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select tgl_perawatan, jam_rawat, rtl from pemeriksaan_ralan where "
                    + "no_rawat=? and tgl_perawatan like ? or "
                    + "no_rawat=? and rtl like ? order by tgl_perawatan, jam_rawat");
            try {
        ...
        try {
            ps = koneksi.prepareStatement("select tgl_perawatan, jam_rawat, rtl from pemeriksaan_ranap where "
                    + "no_rawat=? and tgl_perawatan like ? or "
                    + "no_rawat=? and rtl like ? order by tgl_perawatan, jam_rawat");
            try {
                ps.setString(1, norawat);
    ...
    private static final Logger LOG = Logger.getLogger(RMCariRencana.class.getName());
