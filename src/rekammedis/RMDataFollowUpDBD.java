...
public class RMDataFollowUpDBD extends javax.swing.JDialog {
    ...
    public RMDataFollowUpDBD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Umur", "JK", "Tgl.Lahir", "Tanggal", "Jam",
                    "Hemoglobin", "Hematokrit", "Leokosit", "Trombosit", "Terapi Cairan", "NIP", "Nama Petugas"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("jam_rawat"), rs.getString("hemoglobin"), rs.getString("hematokrit"),
                        rs.getString("leokosit"), rs.getString("trombosit"), rs.getString("terapi_cairan"),
    ...
    private void ganti() {
        if (Sequel.mengedittf("follow_up_dbd", "tgl_perawatan=? and jam_rawat=? and no_rawat=?",
                ...
                new String[]{TNoRw.getText(), Valid.SetTgl(Tanggal.getSelectedItem() + ""),
                    ...
                    Hemo.getText(), Hema.getText(), Leo.getText(), Trombo.getText(), TerapiCairan.getText(),
                    NIP.getText(), tbObat.getValueAt(tbObat.getSelectedRow(), 6).toString(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from follow_up_dbd where tgl_perawatan=? and jam_rawat=? and no_rawat=?", 3,
    ...
    private static final Logger LOG = Logger.getLogger(RMDataFollowUpDBD.class.getName());
