 ...
 * @author perpustakaan
 */
public class RMDataFollowUpDBD extends javax.swing.JDialog {
    ...
    public RMDataFollowUpDBD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Tanggal", "Jam", "Hemoglobin",
            "Hematokrit", "Leokosit", "Trombosit", "Terapi Cairan", "NIP",
            "Nama Petugas"
        }) {
            @Override
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptDataFollowUpDBD.jasper", "report",
                        "::[ Data Follow Up DBD ]::",
                        ...
                        + "follow_up_dbd.tgl_perawatan between '" + Valid.
                                SetTgl(DTPCari1.getSelectedItem() + "") + "' and '" + Valid.
                        SetTgl(DTPCari2.getSelectedItem() + "") + "' order by follow_up_dbd.tgl_perawatan,follow_up_dbd.jam_rawat",
                        param);
            } else {
                Valid.MyReportqry("rptDataFollowUpDBD.jasper", "report",
                        "::[ Data Follow Up DBD ]::",
                        ...
                        + "(reg_periksa.no_rawat like '%" + TCari.getText().
                                ...
                                getText().trim() + "%' or "
                        + "pasien.nm_pasien like '%" + TCari.getText().trim() + "%' or follow_up_dbd.nip like '%" + TCari.
    ...
    private void MnFollowUpDBDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnFollowUpDBDActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptFormulirFollowUpDBD.jasper", "report",
                    "::[ Formulir Follow Up Pasien DBD ]::",
                    ...
                    + "inner join petugas on follow_up_dbd.nip=petugas.nip where reg_periksa.no_rawat='" + tbObat.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataFollowUpDBD dialog = new RMDataFollowUpDBD(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        getString("tgl_perawatan"), rs.getString("jam_rawat"),
                        rs.getString("hemoglobin"), rs.getString("hematokrit"),
                        rs.getString("leokosit"), rs.getString("trombosit"), rs.
                        getString("terapi_cairan"), rs.getString("nip"), rs.
                        getString("nama")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Hemo.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 8).
                    toString());
            Hema.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 9).
                    toString());
            Leo.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 10).
                    toString());
            Trombo.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 11).
                    toString());
            TerapiCairan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 12).
                    toString());
    ...
    private void ganti() {
        if (Sequel.mengedittf("follow_up_dbd",
                "tgl_perawatan=? and jam_rawat=? and no_rawat=?",
                "no_rawat=?,tgl_perawatan=?,jam_rawat=?,hemoglobin=?,hematokrit=?,leokosit=?,trombosit=?,terapi_cairan=?,nip=?",
                12, new String[]{
                    TNoRw.getText(), Valid.
                    SetTgl(Tanggal.getSelectedItem() + ""), Jam.
                    getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
                    getSelectedItem(),
                    Hemo.getText(), Hema.getText(), Leo.getText(), Trombo.
                    getText(), TerapiCairan.getText(), NIP.getText(), tbObat.
            ...
            tbObat.setValueAt(TerapiCairan.getText(), tbObat.getSelectedRow(),
                    12);
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from follow_up_dbd where tgl_perawatan=? and jam_rawat=? and no_rawat=?",
                3, new String[]{
    ...
    private void simpan() {
        if (Sequel.menyimpantf("follow_up_dbd", "?,?,?,?,?,?,?,?,?", "Data", 9,
                new String[]{
                    TNoRw.getText(), Valid.
                    SetTgl(Tanggal.getSelectedItem() + ""), Jam.
                    getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
                    getSelectedItem(),
                    Hemo.getText(), Hema.getText(), Leo.getText(), Trombo.
                    getText(), TerapiCairan.getText(), NIP.getText()
                }) == true) {
            tabMode.addRow(new String[]{
                ...
                getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
                getSelectedItem(),
                Hemo.getText(), Hema.getText(), Leo.getText(), Trombo.getText(),
                TerapiCairan.getText(), NIP.getText(), NamaPetugas.getText()
            });
            LCount.setText("" + tabMode.getRowCount());
            emptTeks();
        }
    ...
    private static final Logger LOG = Logger.getLogger(RMDataFollowUpDBD.class.
            getName());
