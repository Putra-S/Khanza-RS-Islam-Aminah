...
public class RMPenilaianAwalMedisRalanParu extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisRalanParu(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.", "Kode Dokter", "Nama Dokter",
                    ...
                    "Kepala", "Thoraks", "Abdomen", "Muskuloskeletal", "Lainnya", "Status Lokalis", "Laboratorium",
                    "Radiologi", "Penunjang Lainnya", "Diagnosis", "Diagnosis Banding", "Permasalahan", "Terapi",
                    "Tindakan", "Edukasi"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("abdomen"), rs.getString("muskulos"), rs.getString("lainnya"),
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_medis_ralan_paru where no_rawat=?", 1,
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_ralan_paru", "no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    Abdomen.getSelectedItem().toString(), Muskulos.getSelectedItem().toString(), Lainnya.getText(),
                    KetLokalis.getText(), Lab.getText(), Rad.getText(), PenunjangLain.getText(),
                    Diagnosis.getText(), Diagnosis2.getText(), Permasalahan.getText(), Terapi.getText(),
    ...
    private static final Logger LOG = Logger.getLogger(RMPenilaianAwalMedisRalanParu.class.getName());
