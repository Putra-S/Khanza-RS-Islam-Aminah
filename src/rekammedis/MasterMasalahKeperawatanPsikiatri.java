...
public class MasterMasalahKeperawatanPsikiatri extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public MasterMasalahKeperawatanPsikiatri(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("master_masalah_keperawatan_psikiatri",
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, TKd,
                "master_masalah_keperawatan_psikiatri", "kode_masalah") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                if (Sequel.mengedittf("master_masalah_keperawatan_psikiatri",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterMasalahKeperawatanPsikiatri dialog = new MasterMasalahKeperawatanPsikiatri(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from master_masalah_keperawatan_psikiatri where master_masalah_keperawatan_psikiatri.kode_masalah like ? or master_masalah_keperawatan_psikiatri.nama_masalah like ? order by master_masalah_keperawatan_psikiatri.kode_masalah");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(
            MasterMasalahKeperawatanPsikiatri.class.getName());
}
