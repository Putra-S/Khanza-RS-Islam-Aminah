...
public class MasterTemplateHasilRadiologi extends javax.swing.JDialog {
    ...
    public MasterTemplateHasilRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.Template", "Nama Pemeriksaan",
            "Template Hasil Radiologi"};
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Nm.getText().trim().isEmpty()) {
            ...
            if (Valid.hapusTabletf(tabMode, Kd, "template_hasil_radiologi",
                    "no_template") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            if (Valid.editTabletf(tabMode, "template_hasil_radiologi",
                    "no_template", "?",
                    "no_template=?,nama_pemeriksaan=?,template_hasil_radiologi=?",
                    4, new String[]{
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("template_hasil_radiologi", "?,?,?",
...
*/
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterTemplateHasilRadiologi dialog = new MasterTemplateHasilRadiologi(
    ...
    private void getData() {
        if (tbDokter.getSelectedRow() != -1) {
            ...
            Nm.setText(tabMode.getValueAt(tbDokter.getSelectedRow(), 1).
                    toString());
            Template.setText(tabMode.getValueAt(tbDokter.getSelectedRow(), 2).
                    toString());
        }
    }
    ...
    private static final Logger LOG = Logger.getLogger(
            MasterTemplateHasilRadiologi.class.getName());
}
