 ...
 * @author dosen
 */
public class RMCariDiagnosa2 extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMCariDiagnosa2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariDiagnosa2 dialog = new RMCariDiagnosa2(new javax.swing.JFrame(), true);
    ...
    private static final Logger LOG = Logger.getLogger(RMCariDiagnosa2.class.getName());
