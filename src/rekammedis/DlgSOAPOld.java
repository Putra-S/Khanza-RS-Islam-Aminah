    ...
    private void prosesCari() {
        ...
        try {
            ...
            htmlContent.append(
                    ...
                    + "<td valign='middle' bgcolor='#FFFAF8' align='center' width='70%'>S.O.A.P.I.E</td>"
                    + "</tr>"
            );
                ...
                while (rs.next()) {
                    ...
                    try {
                        rs2 = koneksi.prepareStatement(
                                ...
                                + "from pemeriksaan_ralan inner join pegawai on pemeriksaan_ralan.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id where pemeriksaan_ralan.no_rawat='" + rs.
                                        getString("no_rawat") + "' "
                        ...
                        if (rs2.next()) {
                            ...
                            while (rs2.next()) {
                                ...
                                bagian = Sequel.cariIsi(
                                        "SELECT kd_dokter FROM dokter WHERE kd_dokter='" + rs2.
                                                getString("nip") + "'");
                                ...
                                htmlContent.append(
                                        ...
                                        "keluhan")).append(
                                                "</td><td align='left' ").
                                        append(stylee).append(">").append(rs2.
                                        getString("pemeriksaan")).append(
                                        "</td><td align='left' ").append(stylee).
                                        append(">").append(rs2.getString(
                                        "penilaian")).append(
                                                "</td><td align='left' ").
                                        append(stylee).append(">").append(rs2.
                                        getString("rtl")).append(
                                        "</td><td align='left' ").append(stylee).
                                        append(">").append(rs2.getString(
                                        "instruksi")).append(
                                                "</td><td align='left' ").
                                        append(stylee).append(">").append(rs2.
                                        getString("evaluasi")).append(
                                        "</td></tr>");
                            }
                        }
                    } catch (Exception e) {
                    ...
                    try {
                        rs2 = koneksi.prepareStatement(
                                ...
                                + "from pemeriksaan_ranap inner join pegawai on pemeriksaan_ranap.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id where pemeriksaan_ranap.no_rawat='" + rs.
                                        getString("no_rawat") + "' "
...
//                                }
                                htmlContent.append(
                                        ...
                                        append(stylee).append(">").append(rs2.
                                        getString("evaluasi")).append(
                                        "</td></tr>") //                                        "<td align='left' "+stylee+" "+gbrverif+">"+"<br>"+rs2.getString("namavalidator")+"<br>"+rs2.getString("tgl_validasi")+"<br>"+rs2.getString("jam_validasi")+"</td>"+
                                        ;
                            }
                        }
                    } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgSOAPOld.class.
            getName());
