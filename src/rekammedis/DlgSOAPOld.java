...
public class DlgSOAPOld extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgSOAPOld(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setSize(1285, 674);
        ...
        styleSheet.addRule(
                // ".isi td{border-right: 1px solid #e2e7dd;font: 8.5px
                // tahoma;height:12px;border-bottom: 1px solid #e2e7dd;background:
                // #ffffff;color:#323232;}"+
                // ".isi2 td{font: 8.5px tahoma;height:12px;background:
                // #ffffff;color:#323232;}"+
                // ".isi3 td{border-right: 1px solid #e2e7dd;font: 8.5px
                // tahoma;height:12px;border-top: 1px solid #e2e7dd;background:
                // #ffffff;color:#323232;}"+
                // ".isi4 td{font: 11px tahoma;height:12px;border-top: 1px solid
                // #e2e7dd;background: #ffffff;color:#323232;}"
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ SOAP Perawatan Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSOAPOld dialog = new DlgSOAPOld(new javax.swing.JFrame(), true);
    ...
    private void prosesCari() {
        ...
        try {
            ...
            htmlContent1.append("<tr class='isi'>"
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    htmlContent1.append("<tr class='isi'><td valign='middle' align='center'>")
                    ...
                    try {
                        ...
                        if (rs2.next()) {
                            ...
                            while (rs2.next()) {
                                ...
                                htmlContent1.append("<tr class='isi'><td align='center' ")
                                        .append(stylee)
                                        .append(" >")
                    ...
                    try {
                        ...
                        if (rs2.next()) {
                            ...
                            while (rs2.next()) {
                                ...
                                // if(Sequel.cariInteger("select
                                // count(validasi_pemeriksaan_ranap.nik_validator) " +
                                // "from pemeriksaan_ranap LEFT JOIN
                                // validasi_pemeriksaan_ranap ON
                                // validasi_pemeriksaan_ranap.no_rawat =
                                // pemeriksaan_ranap.no_rawat AND
                                // validasi_pemeriksaan_ranap.tgl_perawatan =
                                // pemeriksaan_ranap.tgl_perawatan AND
                                // validasi_pemeriksaan_ranap.jam_rawat =
                                // pemeriksaan_ranap.jam_rawat inner join pegawai on
                                // pemeriksaan_ranap.nip=pegawai.nik inner join departemen
                                // on pegawai.departemen=departemen.dep_id LEFT JOIN
                                // pegawai AS namavalidator ON
                                // validasi_pemeriksaan_ranap.nik_validator=namavalidator.nik
                                // where
                                // pemeriksaan_ranap.no_rawat='"+rs.getString("no_rawat")+"'
                                // AND
                                // validasi_pemeriksaan_ranap.nik_validator='"+rs2.getString("nik_validator")+"'"
                                // +
                                // "order by
                                // pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat")>0){
                                // gbrverif="<img src
                                // ='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/images/verif.png'
                                // align='center' width='100' height='50'/";
                                // }else{
                                // gbrverif="<img src
                                // ='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/images/notverif.png'
                                // align='center' width='100' height='50'/";
                                // }
                                htmlContent1.append("<tr class='isi'  ><td align='center' ")
                                        .append(stylee)
                                        ...
                                        .append(">")
                                        .append(rs2.getString("evaluasi"))
                                        .append("</td></tr>") // "<td align='left' "+stylee+"
                                        // "+gbrverif+">"+"<br>"+rs2.getString("namavalidator")+"<br>"+rs2.getString("tgl_validasi")+"<br>"+rs2.getString("jam_validasi")+"</td>"+
                                        ;
                            }
                        }
                    } catch (Exception e) {
                    ...
                    htmlContent1.append("</table>" + "</td>" + "</tr>");
                }
            } catch (Exception e) {
            ...
            LoadHTML.setText("<html>"
                    ...
                    + htmlContent1.toString() + "</table>" + "</html>");
        } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgSOAPOld.class.getName());
