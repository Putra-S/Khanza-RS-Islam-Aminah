 ...
 * @author perpustakaan
 */
public class RMDataMonitoringAsuhanGizi extends javax.swing.JDialog {
    ...
    public RMDataMonitoringAsuhanGizi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Umur", "JK",
            "Tanggal", "Monitoring", "Evaluasi", "NIP", "Petugas"}) {
            @Override
        ...
        Monitoring.setDocument(new batasInput(500).getKata(Monitoring));
        Evaluasi.setDocument(new batasInput(500).getKata(Evaluasi));
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().isEmpty()) {
                Valid.
                        MyReportqry("rptDataMonitoringAsuhanGizi.jasper",
                                "report",
                                "::[ Data Monitoring Asuhan Gizi Pasien ]::",
                                ...
                                + "monitoring_asuhan_gizi.tanggal between '" + Valid.
                                        SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                                SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' order by monitoring_asuhan_gizi.tanggal ",
                                param);
            } else {
                Valid.
                        MyReportqry("rptDataMonitoringAsuhanGizi.jasper",
                                ...
                                + "(reg_periksa.no_rawat like '%" + TCari.
                                        ...
                                        getText().trim() + "%' or "
                                + "monitoring_asuhan_gizi.monitoring like '%" + TCari.
                                        getText().trim() + "%' or monitoring_asuhan_gizi.evaluasi like '%" + TCari.
                                        getText().trim() + "%' or monitoring_asuhan_gizi.nip like '%" + TCari.
                                        getText().trim() + "%' or "
                                + "petugas.nama like '%" + TCari.getText().
                                        trim() + "%') order by monitoring_asuhan_gizi.tanggal ",
                                param);
            }
        }
    ...
    private void MnAsuhanGiziActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnAsuhanGiziActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            param.put("diagnosa", Sequel.cariIsi(
                    ...
                    TNoRw.getText()));
            Valid.
                    MyReportqry("rptFormulirMonitoringAsuhanGizi.jasper",
                            "report",
                            "::[ Formulir Monitoring & Evaluasi Asuhan Gizi Pasien ]::",
                            "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"
                            + "pasien.jk,monitoring_asuhan_gizi.tanggal,monitoring_asuhan_gizi.monitoring,monitoring_asuhan_gizi.evaluasi,"
                            + "monitoring_asuhan_gizi.nip,petugas.nama "
                            + "from monitoring_asuhan_gizi inner join reg_periksa on monitoring_asuhan_gizi.no_rawat=reg_periksa.no_rawat "
                            + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                            + "inner join petugas on monitoring_asuhan_gizi.nip=petugas.nip where reg_periksa.no_rawat='" + tbObat.
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("jk"), rs.getString("tanggal"), rs.getString("monitoring"),
                        rs.getString("evaluasi"), rs.getString("nip"), rs.getString("nama")});
                }
            } catch (Exception e) {
    ...
    private void ganti() {
        if (Sequel.mengedittf("monitoring_asuhan_gizi", "tanggal=? and no_rawat=?",
                "no_rawat=?,tanggal=?,monitoring=?,evaluasi=?,nip=?", 7,
                new String[]{TNoRw.getText(),
                    ...
                    Monitoring.getText(), Evaluasi.getText(), KdPetugas.getText(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from monitoring_asuhan_gizi where tanggal=? and no_rawat=?", 2,
    ...
    private void simpan() {
        if (Sequel.menyimpantf("monitoring_asuhan_gizi", "?,?,?,?,?", "Data", 5,
                new String[]{TNoRw.getText(),
                    Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Jam.getSelectedItem() + ":"
                    + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
                    Monitoring.getText(), Evaluasi.getText(), KdPetugas.getText()}) == true) {
            tabMode.addRow(
    ...
    private static final Logger LOG = Logger.getLogger(RMDataMonitoringAsuhanGizi.class.getName());
