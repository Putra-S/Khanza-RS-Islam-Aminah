...
public class RMDataMonitoringAsuhanGizi extends javax.swing.JDialog {
    ...
    public RMDataMonitoringAsuhanGizi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Monitoring", "Evaluasi", "NIP", "Petugas"
        }) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataMonitoringAsuhanGizi dialog = new RMDataMonitoringAsuhanGizi(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("tanggal"), rs.getString("monitoring"), rs.
                        getString("evaluasi"),
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Monitoring.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 6).
                    toString());
            Evaluasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 7).
                    toString());
        }
    }
    ...
    private void ganti() {
        if (Sequel.mengedittf("monitoring_asuhan_gizi",
                ...
                new String[]{
                    ...
                    getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
                    getSelectedItem(), Monitoring.getText(), Evaluasi.getText(),
                    KdPetugas.getText(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from monitoring_asuhan_gizi where tanggal=? and no_rawat=?",
                2, new String[]{
                    tbObat.getValueAt(tbObat.getSelectedRow(), 5).toString(),
                    tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
                }) == true) {
    ...
    private static final Logger LOG = Logger.getLogger(
            RMDataMonitoringAsuhanGizi.class.getName());
