...
public class RMDataCatatanObservasiIGD extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataCatatanObservasiIGD dialog = new RMDataCatatanObservasiIGD(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        "suhu"), rs.getString("spo2"), rs.getString("map"), rs.
                        getString("terapi"),
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            SPO.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 13).
                    toString());
            MAP.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 14).
                    toString());
            Terapi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 15).
                    toString());
    ...
    private void ganti() {
        if (Sequel.mengedittf("catatan_observasi_igd",
                "tgl_perawatan=? and jam_rawat=? and no_rawat=?",
                "no_rawat=?,tgl_perawatan=?,jam_rawat=?,gcs=?,td=?,hr=?,rr=?,suhu=?,spo2=?,map=?,terapi=?,nip=?",
                15, new String[]{
                    TNoRw.getText(), Valid.
                    ...
                    Suhu.getText(), SPO.getText(), MAP.getText(), Terapi.
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from catatan_observasi_igd where tgl_perawatan=? and jam_rawat=? and no_rawat=?",
                3, new String[]{
    ...
    private void simpan() {
        if (Sequel.menyimpantf("catatan_observasi_igd",
                "?,?,?,?,?,?,?,?,?,?,?,?", "Data", 12, new String[]{
                    TNoRw.getText(), Valid.
                    SetTgl(Tanggal.getSelectedItem() + ""), Jam.
                    getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
            ...
            tabMode.addRow(new String[]{
                ...
                getText(), SPO.getText(), MAP.getText(), Terapi.getText(), NIP.
    ...
    private static final Logger LOG = Logger.getLogger(
            RMDataCatatanObservasiIGD.class.getName());
