...
public class MasterTriaseSkala4 extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdskala.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("master_triase_skala4", "'" + kdpemeriksaan.
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, kdskala, "master_triase_skala4",
                "kode_skala4") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdskala.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("master_triase_skala4", "kode_skala4=?",
                        "kode_skala4=?,pengkajian_skala4=?,kode_pemeriksaan=?",
                        4, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterTriaseSkala4 dialog = new MasterTriaseSkala4(
    ...
    private static final Logger LOG = Logger.getLogger(MasterTriaseSkala4.class.
            getName());
}
