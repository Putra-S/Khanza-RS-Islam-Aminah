 ...
 * @author dosen
 */
public class RMCariDiagnosa3 extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMCariDiagnosa3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariDiagnosa3 dialog = new RMCariDiagnosa3(new javax.swing.JFrame(), true);
    ...
    private static final Logger LOG = Logger.getLogger(RMCariDiagnosa3.class.getName());
