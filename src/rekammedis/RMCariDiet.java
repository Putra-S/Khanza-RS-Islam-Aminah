...
public class RMCariDiet extends javax.swing.JDialog {
    ...
    public RMCariDiet(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"P", "Tanggal", "Jam", "Diet"}) {
...
//GEN-LAST:event_ppSemuaActionPerformed
  ...
  // End of variables declaration//GEN-END:variables
    ...
    public void tampil() {
        ...
        for (i = 0; i < jml; i++) {
            tabMode.addRow(new Object[]{pilih[i], tanggal[i], jam[i], diet[i]});
        }
        Valid.tabelKosong(tabMode);
        try {
            ps = koneksi.prepareStatement("select detail_beri_diet.tanggal, detail_beri_diet.waktu, diet.nama_diet "
    ...
    private static final Logger LOG = Logger.getLogger(RMCariDiet.class.getName());
