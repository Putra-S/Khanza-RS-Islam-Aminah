...
public class RMSkriningMPP extends javax.swing.JDialog {
    ...
    private String param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12,
            param13, param14, param15, param16, finger = "";
    ...
    public RMSkriningMPP(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "J.K.", "Tgl.Lahir", "Alamat", "Tgl.Skrining",
                    ...
                    "Parameter 13", "Parameter 14", "Parameter 15", "Parameter 16", "NIP", "Nama Petugas"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("alamat"), rs.getString("tanggal"), rs.getString("param1"),
                        rs.getString("param2"), rs.getString("param3"), rs.getString("param4"),
                        rs.getString("param5"), rs.getString("param6"), rs.getString("param7"),
                        rs.getString("param8"), rs.getString("param9"), rs.getString("param10"),
                        rs.getString("param11"), rs.getString("param12"), rs.getString("param13"),
                        rs.getString("param14"), rs.getString("param15"), rs.getString("param16"),
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            JK.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 3)
                    .toString()
    ...
    private void isPsien() {
        try {
            ps = koneksi
                    .prepareStatement("select pasien.nm_pasien,pasien.jk,date_format(pasien.tgl_lahir,'%d-%m-%Y') as lahir,"
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from mpp_skrining where no_rawat=? and tanggal=?", 2,
    ...
    private void ganti() {
        ...
        if (Sequel.mengedittf("mpp_skrining", "no_rawat=? and tanggal=?",
                ...
                21,
                new String[]{TNoRw.getText(), Valid.SetTgl(TglSkrining.getSelectedItem() + ""), param1, param2,
                    param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13,
                    param14, param15, param16, KdPetugas.getText(),
    ...
    private static final Logger LOG = Logger.getLogger(RMSkriningMPP.class.getName());
