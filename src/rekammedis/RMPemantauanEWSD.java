 ...
 * @author perpustakaan
 */
public class RMPemantauanEWSD extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPemantauanEWSD dialog = new RMPemantauanEWSD(
    ...
    private static final Logger LOG = Logger.getLogger(RMPemantauanEWSD.class.
            getName());
}
