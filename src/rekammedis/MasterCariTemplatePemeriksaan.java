 ...
 * @author dosen
 */
public class MasterCariTemplatePemeriksaan extends javax.swing.JDialog {
    ...
    public MasterCariTemplatePemeriksaan(java.awt.Frame parent, boolean modal) {
        ...
        tabModeDiagnosa = new DefaultTableModel(null, new Object[]{"Kode",
            "Nama Penyakit", "Ciri-ciri Penyakit", "Keterangan", "Ktg.Penyakit",
            "Ciri-ciri Umum"}) {
        ...
        tabModeProsedur = new DefaultTableModel(null, new Object[]{"Kode",
            "Deskripsi Panjang", "Deskripsi Pendek"}) {
            Class[] types = new Class[]{
                java.lang.Object.class, java.lang.Object.class,
                java.lang.Object.class
            };
        ...
        tabModePK = new DefaultTableModel(null, new Object[]{"Kode Periksa",
            "Nama Pemeriksaan"}) {
            Class[] types = new Class[]{
                java.lang.Object.class, java.lang.Object.class
            };
        ...
        tabModeDetailPK = new DefaultTableModel(null,
                new Object[]{"Pemeriksaan", "Satuan", "Nilai Rujukan",
                    "id_template", "Kode Jenis"}) {
            Class[] types = new Class[]{
                java.lang.Object.class, java.lang.Object.class,
                java.lang.Object.class, java.lang.Object.class,
                java.lang.Object.class
        ...
        tabModePA = new DefaultTableModel(null, new Object[]{"Kode Periksa",
            "Nama Pemeriksaan"}) {
            Class[] types = new Class[]{
                java.lang.Object.class, java.lang.Object.class
            };
        ...
        tabModeMB = new DefaultTableModel(null, new Object[]{"Kode Periksa",
            "Nama Pemeriksaan"}) {
            Class[] types = new Class[]{
                java.lang.Object.class, java.lang.Object.class
            };
        ...
        tabModeObatRacikan = new DefaultTableModel(null, new Object[]{"No",
            "Nama Racikan", "Kode Racik", "Metode Racik", "Jml.Racik",
        ...
        tabModeDetailObatRacikan = new DefaultTableModel(null, new Object[]{
            "No", "Kode Barang", "Nama Barang", "Satuan", "Jenis Obat", "Kps",
            "P1", "/", "P2", "Kandungan", "Jml", "I.F.", "Komposisi"
        }) {
            Class[] types = new Class[]{
                java.lang.Object.class, java.lang.Object.class,
                java.lang.Object.class,
        ...
        TabModeTindakan = new DefaultTableModel(null, new Object[]{
            "Kode", "Nama Perawatan/Tindakan", "Kategori", "Tarif/Biaya",
            "Bagian RS", "BHP", "JM Dokter", "KSO", "Menejemen"
        }) {
            Class[] types = new Class[]{
                java.lang.Object.class, java.lang.Object.class,
                java.lang.Object.class, java.lang.Double.class,
    ...
    private void tbDokterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDokterMouseClicked
        if (tabMode.getRowCount() != 0) {
            if (tbDokter.getSelectedRow() > -1) {
                try {
                    Subjek.setText(tabMode.getValueAt(tbDokter.getSelectedRow(),
                            3).toString());
                    Objek.setText(tabMode.getValueAt(tbDokter.getSelectedRow(),
                            4).toString());
                    Asesmen.setText(tabMode.
                            getValueAt(tbDokter.getSelectedRow(), 5).toString());
                    Plan.setText(tabMode.
                            getValueAt(tbDokter.getSelectedRow(), 6).toString());
                    Instruksi.setText(tabMode.getValueAt(tbDokter.
                            getSelectedRow(), 7).toString());
                    Evaluasi.setText(tabMode.getValueAt(tbDokter.
                    ...
                    try {
                        ...
                        rs = ps.executeQuery();
                        while (rs.next()) {
                            tabModeProsedur.addRow(new Object[]{rs.getString(1),
                    ...
                    try {
                        ...
                        rs = ps.executeQuery();
                        while (rs.next()) {
                            tabModeRadiologi.addRow(new Object[]{rs.getString(
                                "kd_jenis_prw"), rs.getString("nm_perawatan")});
                        }
                    } catch (Exception e) {
                        System.out.println("Notif : " + e);
                    } finally {
                    ...
                    try {
                        ...
                        rs = ps.executeQuery();
                        while (rs.next()) {
                            tabModePK.addRow(new Object[]{rs.getString(
                                "kd_jenis_prw"), rs.getString("nm_perawatan")});
                            try {
                                tabModeDetailPK.addRow(new Object[]{rs.
                                ...
                                ps2.setString(1, tabMode.getValueAt(tbDokter.
                                        getSelectedRow(), 0).toString());
                                ...
                                while (rs2.next()) {
                                    ...
                                    pa = "";
                                    pd = "";
                                    if (!rs2.getString("nilai_rujukan_ld").
                                            isEmpty()) {
                                        ld = "LD : " + rs2.getString(
                                                "nilai_rujukan_ld");
                                    }
                                    if (!rs2.getString("nilai_rujukan_la").
                                            isEmpty()) {
                                        la = ", LA : " + rs2.getString(
                                                "nilai_rujukan_la");
                                    }
                                    if (!rs2.getString("nilai_rujukan_pa").
                                            isEmpty()) {
                                        pd = ", PD : " + rs2.getString(
                                                "nilai_rujukan_pd");
                                    }
                                    if (!rs2.getString("nilai_rujukan_pd").
                                            isEmpty()) {
                                        pa = " PA : " + rs2.getString(
                                                "nilai_rujukan_pa");
                                    }
                                    tabModeDetailPK.addRow(new Object[]{
                                        ...
                                        ld + la + pd + pa, rs2.getString(
                                        "id_template"), rs.getString(
                                        "kd_jenis_prw")
                                    });
                                }
                            } catch (Exception e) {
                    ...
                    try {
                        ...
                        rs = ps.executeQuery();
                        while (rs.next()) {
                            tabModePA.addRow(new Object[]{rs.getString(
                                "kd_jenis_prw"), rs.getString("nm_perawatan")});
                        }
                    } catch (Exception e) {
                        System.out.println("Notif : " + e);
                    ...
                    try {
                        ...
                        rs = ps.executeQuery();
                        while (rs.next()) {
                            tabModeMB.addRow(new Object[]{rs.getString(
                                "kd_jenis_prw"), rs.getString("nm_perawatan")});
                            try {
                                tabModeDetailMB.addRow(new Object[]{rs.
                                    getString("nm_perawatan"), "", "", "", ""});
                                ps2 = koneksi.prepareStatement(
                                        "select template_pemeriksaan_dokter_detail_permintaan_lab.id_template,template_laboratorium.Pemeriksaan,template_laboratorium.satuan,template_laboratorium.nilai_rujukan_ld,template_laboratorium.nilai_rujukan_la,template_laboratorium.nilai_rujukan_pd,template_laboratorium.nilai_rujukan_pa "
                                        + "from template_pemeriksaan_dokter_detail_permintaan_lab inner join template_laboratorium on template_pemeriksaan_dokter_detail_permintaan_lab.id_template=template_laboratorium.id_template where template_pemeriksaan_dokter_detail_permintaan_lab.no_template=? and "
                    ...
                    try {
                        ...
                        while (rs.next()) {
                            tabModeObatRacikan.addRow(new Object[]{
                                ...
                                getString("nm_racik"), rs.getString("jml_dr"),
                                rs.getString("aturan_pakai"), rs.getString(
                                "keterangan")
                            });
                            try {
                    ...
                    try {
                        ...
                        while (rs.next()) {
                            TabModeTindakan.addRow(new Object[]{
                                ...
                                "nm_perawatan"), rs.getString("nm_kategori"),
                                rs.getDouble("total_byrdr"),
                                rs.getDouble("material"), rs.getDouble("bhp"),
                                rs.getDouble("tarif_tindakandr"), rs.getDouble(
                                "kso"), rs.getDouble("menejemen")
                            });
                        }
                    } catch (Exception e) {
                        System.out.println("Notif : " + e);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Asesmen.getText().trim().isEmpty()) {
            Valid.textKosong(Asesmen, "Asesmen");
        } else {
            if (tbDokter.getSelectedRow() > -1) {
                Sequel.AutoComitFalse();
                sukses = true;
                if (Sequel.menyimpantf2("pemeriksaan_ralan",
                        "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 21,
                        new String[]{
                            noperawatan, tanggaldilakukan, jamdilakukan, "", "",
                            "", "", "", "", "", "", "Compos Mentis", Subjek.
                                    getText(), Objek.getText(), "", "", Plan.
                            getText(), Asesmen.getText(), Instruksi.getText(),
                            Evaluasi.getText(), kodedokter}
                ) == true) {
                    for (i = 0; i < tbDiagnosa.getRowCount(); i++) {
                        if (Sequel.cariInteger(
                                ...
                                + "on reg_periksa.no_rkm_medis=pasien.no_rkm_medis where pasien.no_rkm_medis='" + norm + "' and diagnosa_pasien.kd_penyakit='" + tbDiagnosa.
                                        getValueAt(i, 1).toString() + "'") > 0) {
                            if (Sequel.menyimpantf2("diagnosa_pasien",
                                    "?,?,?,?,?", "Penyakit " + tbDiagnosa.
                                            getValueAt(i, 1).toString(), 5,
                                    new String[]{
                                        noperawatan,
                                        tbDiagnosa.getValueAt(i, 0).toString(),
                                        "Ralan", Sequel.cariIsi(
                                                "select ifnull(MAX(diagnosa_pasien.prioritas)+1,1) from diagnosa_pasien where diagnosa_pasien.no_rawat=? and diagnosa_pasien.status='Ralan'",
                                                noperawatan), "Lama"
                                    }) == false) {
                                sukses = false;
                            }
                    ...
                    for (i = 0; i < tbProsedur.getRowCount(); i++) {
                        if (Sequel.menyimpantf2("prosedur_pasien", "?,?,?,?",
                                "Prosedur " + tbProsedur.getValueAt(i, 1).
                                        toString(), 4, new String[]{
                                    noperawatan, tbProsedur.getValueAt(i, 0).
                                            toString(), "Ralan", Sequel.cariIsi(
                                            "select ifnull(MAX(prosedur_pasien.prioritas)+1,1) from prosedur_pasien where prosedur_pasien.no_rawat=? and prosedur_pasien.status='Ralan'",
                                            noperawatan)
                                }) == false) {
                            sukses = false;
                        }
                    ...
                    if (tabModeRadiologi.getRowCount() > 0) {
                        nomor = Valid.autoNomer3(
                                "select ifnull(MAX(CONVERT(RIGHT(permintaan_radiologi.noorder,4),signed)),0) from permintaan_radiologi where permintaan_radiologi.tgl_permintaan='" + tanggaldilakukan + "'",
                                "PR" + tanggaldilakukan.replaceAll("-", ""), 4);
                        if (Sequel.menyimpantf2("permintaan_radiologi",
                                "?,?,?,?,?,?,?,?,?,?,?,?",
                                "No.Permintaan Radiologi", 12, new String[]{
                                    nomor, noperawatan, tanggaldilakukan,
                                    jamdilakukan, "0000-00-00", "00:00:00",
                                    "0000-00-00", "00:00:00", kodedokter,
                                    "ralan", "-", Asesmen.getText()
                                }) == true) {
                            for (i = 0; i < tbPermintaanRadiologi.getRowCount(); i++) {
                                if (Sequel.menyimpantf2(
                                        "permintaan_pemeriksaan_radiologi",
                                        "?,?,?",
                                        "Permintaan Radiologi " + tbPermintaanRadiologi.
                                                getValueAt(i, 1).toString(), 3,
                                        new String[]{
                                            nomor, tbPermintaanRadiologi.
                    ...
                    if (tabModePK.getRowCount() > 0) {
                        nomor = Valid.autoNomer3(
                                "select ifnull(MAX(CONVERT(RIGHT(permintaan_lab.noorder,4),signed)),0) from permintaan_lab where permintaan_lab.tgl_permintaan='" + tanggaldilakukan + "' ",
                                "PK" + tanggaldilakukan.replaceAll("-", ""), 4);
                        if (Sequel.menyimpantf2("permintaan_lab",
                                "?,?,?,?,?,?,?,?,?,?,?,?", "No.Permintaan", 12,
                                new String[]{
                                    nomor, noperawatan, tanggaldilakukan,
                                    jamdilakukan, "0000-00-00", "00:00:00",
                            ...
                            for (i = 0; i < tbPermintaanPK.getRowCount(); i++) {
                                if (Sequel.menyimpantf2(
                                        ...
                                        "Permintaan Lab " + tbPermintaanPK.
                                                getValueAt(i, 1).toString(), 3,
                                        new String[]{
                                            nomor, tbPermintaanPK.getValueAt(i,
                                                    0).toString(), "Belum"
                                        }) == false) {
                                    sukses = false;
                                }
                            ...
                            for (i = 0; i < tbDetailPK.getRowCount(); i++) {
                                if (!tbDetailPK.getValueAt(i, 3).toString().
                                        isEmpty()) {
                                    if (Sequel.menyimpantf2(
                                            "permintaan_detail_permintaan_lab",
                                            "?,?,?,?",
                                            "Detail Permintaan Lab " + tbDetailPK.
                                                    getValueAt(i, 0).toString().
                                                    replaceAll("   ", ""), 4,
                                            new String[]{
                                                nomor, tbDetailPK.getValueAt(i,
                                                        4).toString(),
                                                tbDetailPK.getValueAt(i, 3).
                                                        toString(), "Belum"
                                            }) == false) {
                                        sukses = false;
                                    }
                    ...
                    if (tabModePA.getRowCount() > 0) {
                        nomor = Valid.autoNomer3(
                                "select ifnull(MAX(CONVERT(RIGHT(permintaan_labpa.noorder,4),signed)),0) from permintaan_labpa where permintaan_labpa.tgl_permintaan='" + tanggaldilakukan + "' ",
                                "PA" + tanggaldilakukan.replaceAll("-", ""), 4);
                        if (Sequel.menyimpantf2("permintaan_labpa",
                                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                "No.Permintaan", 20, new String[]{
                                    nomor, noperawatan, tanggaldilakukan,
                                    jamdilakukan, "0000-00-00", "00:00:00",
                                    "0000-00-00", "00:00:00", kodedokter,
                                    "ralan", "-", Asesmen.getText(),
                            ...
                            for (i = 0; i < tbPermintaanPA.getRowCount(); i++) {
                                if (Sequel.menyimpantf2(
                                        ...
                                        "Pemeriksaan Lab PA " + tbPermintaanPA.
                                                getValueAt(i, 1).toString(), 3,
                                        new String[]{
                                            nomor, tbPermintaanPA.getValueAt(i,
                                                    0).toString(), "Belum"
                                        }) == false) {
                                    sukses = false;
                                }
                    ...
                    if (tabModeMB.getRowCount() > 0) {
                        nomor = Valid.autoNomer3(
                                "select ifnull(MAX(CONVERT(RIGHT(permintaan_labmb.noorder,4),signed)),0) from permintaan_labmb where permintaan_labmb.tgl_permintaan='" + tanggaldilakukan + "' ",
                                "MB" + tanggaldilakukan.replaceAll("-", ""), 4);
                        if (Sequel.menyimpantf2("permintaan_labmb",
                                "?,?,?,?,?,?,?,?,?,?,?,?", "No.Permintaan", 12,
                                new String[]{
                                    nomor, noperawatan, tanggaldilakukan,
                                    jamdilakukan, "0000-00-00", "00:00:00",
                            ...
                            for (i = 0; i < tbPermintaanMB.getRowCount(); i++) {
                                if (Sequel.menyimpantf2(
                                        ...
                                        "Permintaan Lab MB" + tbPermintaanMB.
                                                getValueAt(i, 1).toString(), 3,
                                        new String[]{
                                            nomor, tbPermintaanMB.getValueAt(i,
                                                    0).toString(), "Belum"
                                        }) == false) {
                                    sukses = false;
                                }
                            ...
                            for (i = 0; i < tbDetailMB.getRowCount(); i++) {
                                if (!tbDetailMB.getValueAt(i, 3).toString().
                                        isEmpty()) {
                                    if (Sequel.menyimpantf2(
                                            "permintaan_detail_permintaan_labmb",
                                            "?,?,?,?",
                                            "Detail Permintaan Lab MB " + tbDetailMB.
                                                    getValueAt(i, 0).toString().
                                                    replaceAll("   ", ""), 4,
                                            new String[]{
                                                nomor, tbDetailMB.getValueAt(i,
                                                        4).toString(),
                                                tbDetailMB.getValueAt(i, 3).
                                                        toString(), "Belum"
                                            }) == false) {
                                        sukses = false;
                                    }
                    ...
                    if ((tabModeObatUmum.getRowCount() > 0) || (tabModeObatRacikan.
                            getRowCount() > 0)) {
                        nomor = Valid.autoNomer3(
                        ...
                        if (Sequel.menyimpantf2("resep_obat",
                            ...
                            for (i = 0; i < tbObatNonRacikan.getRowCount(); i++) {
                                if (Valid.SetAngka(tbObatNonRacikan.
                                        getValueAt(i, 0).toString()) > 0) {
                                    if (Sequel.menyimpantf2("resep_dokter",
                                            "?,?,?,?", "data", 4, new String[]{
                                                nomor, tbObatNonRacikan.
                                                        getValueAt(i, 1).
                                                        toString(),
                                                tbObatNonRacikan.
                                                        getValueAt(i, 0).
                            ...
                            for (i = 0; i < tbObatRacikan.getRowCount(); i++) {
                                if (Valid.SetAngka(tbObatRacikan.
                                        getValueAt(i, 4).toString()) > 0) {
                                    if (Sequel.menyimpantf2(
                                            "resep_dokter_racikan",
                                            "?,?,?,?,?,?,?",
                                            "resep obat racikan", 7,
                                            new String[]{
                                                nomor, tbObatRacikan.getValueAt(
                                                        i, 0).toString(),
                                                tbObatRacikan.getValueAt(i, 1).
                                                        toString(),
                                                tbObatRacikan.getValueAt(i, 2).
                                                        toString(),
                                                tbObatRacikan.getValueAt(i, 4).
                                                        toString(),
                                                tbObatRacikan.getValueAt(i, 5).
                                                        toString(),
                                                tbObatRacikan.getValueAt(i, 6).
                                                        toString()
                                            }) == false) {
                                        sukses = false;
                                    }
                            ...
                            for (i = 0; i < tbDetailObatRacikan.getRowCount(); i++) {
                                if (Valid.SetAngka(tbDetailObatRacikan.
                    ...
                    if (TabModeTindakan.getRowCount() > 0) {
                        ...
                        for (i = 0; i < tbTindakan.getRowCount(); i++) {
                            if (Sequel.menyimpantf2("rawat_jl_dr",
                                    "?,?,?,?,?,?,?,?,?,?,?,?",
                                    "Tindakan/Pemeriksaan " + tbTindakan.
                                            getValueAt(i, 1).toString(), 12,
                                    new String[]{
                                        noperawatan,
                                        tbTindakan.getValueAt(i, 0).toString(),
                                        kodedokter, tanggaldilakukan,
                                        jamdilakukan, tbTindakan.
                                ...
                                ttljasasarana += Double.parseDouble(tbTindakan.
                                        getValueAt(i, 4).toString());
                                ttlbhp += Double.parseDouble(tbTindakan.
                                        getValueAt(i, 5).toString());
                                ttljmdokter += Double.parseDouble(tbTindakan.
                                        getValueAt(i, 6).toString());
                                ttlkso += Double.parseDouble(tbTindakan.
                        ...
                        if (sukses == true) {
                            ...
                            sukses = jur.simpanJurnal(noperawatan, "U",
                                    "TINDAKAN RAWAT JALAN PASIEN " + noperawatan + " DIPOSTING OLEH " + akses.
                                            getkode());
                        }
                    }
                } else {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterCariTemplatePemeriksaan dialog = new MasterCariTemplatePemeriksaan(
    ...
    private static final Logger LOG = Logger.getLogger(
            MasterCariTemplatePemeriksaan.class.getName());
}
