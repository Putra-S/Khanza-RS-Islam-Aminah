...
public class MasterMasalahKeperawatanIGD extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("master_masalah_keperawatan_igd", "'" + TKd.
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, TKd, "master_masalah_keperawatan_igd",
                "kode_masalah") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                if (Sequel.mengedittf("master_masalah_keperawatan_igd",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterMasalahKeperawatanIGD dialog = new MasterMasalahKeperawatanIGD(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from master_masalah_keperawatan_igd where master_masalah_keperawatan_igd.kode_masalah like ? or master_masalah_keperawatan_igd.nama_masalah like ? order by master_masalah_keperawatan_igd.kode_masalah");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(
            MasterMasalahKeperawatanIGD.class.getName());
}
