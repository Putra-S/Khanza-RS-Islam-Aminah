...
public final class RMSkriningTBC extends javax.swing.JDialog {
    ...
    public RMSkriningTBC(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.",
            "Kode Petugas", "Nama Petugas", "Tanggal", "BB(Kg)", "TB(Cm)", "IMT", "Kasifikasi IMT", "Riwayat Kontak TBC",
            "Jenis Kontak TBC", "Pernah Terdiagnosa TBC", "Jika Ya Kapan ?",
            "Pernah Berobat TBC", "Malnutrisi", "Merokok", "Riwayat DM", "ODHIV", "Lansia > 65 Tahun", "Lansia", "Ibu Hamil",
            "Warga Binaan Permasyarakatan (WBP)", "Tinggal Di Wilayah Padat Kumuh Miskin", "Abnormalitas TBC",
            "Gejala Batuk", "Gejala Riwayat/Batuk Darah", "Gejala Sesak Nafas", "Gejala Tidak Nafsu Makan",
            "Gejala Penurunan Berat Badan", "Gejala Berkeringat Malam", "Gejala Hasil Thorax",
    ...
    private void initComponents() {
        ...
        Batukdarah = new widget.ComboBox();
        ...
        Sesaknafas = new widget.ComboBox();
        jLabel123 = new widget.Label();
        jLabel124 = new widget.Label();
        Tidaknafsumakan = new widget.ComboBox();
        jLabel125 = new widget.Label();
        jLabel128 = new widget.Label();
        Hasilthorax = new widget.ComboBox();
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(796, 691));
        ...
        jLabel12.setBounds(44, 100, 40, 23);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Kg");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(120, 100, 25, 23);
        ...
        FormInput.add(TB);
        TB.setBounds(204, 100, 50, 23);

        jLabel15.setText(":");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(150, 100, 50, 23);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("Cm");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(256, 100, 20, 23);
        ...
        jLabel99.setBounds(10, 150, 220, 23);
        ...
        KlasifikasiIMT.setBounds(574, 100, 215, 23);

        jLabel20.setText("Klasifikasi IMT :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(470, 100, 100, 23);
        ...
        jLabel101.setBounds(10, 630, 380, 23);
        ...
        KesimpulanHasilSkrining.setBounds(180, 650, 220, 23);

        jLabel22.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel22.setText("Kesimpulan Hasil Skrining");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(40, 650, 150, 23);

        jLabel93.setText("Keterangan :");
        jLabel93.setName("jLabel93"); // NOI18N
        FormInput.add(jLabel93);
        jLabel93.setBounds(410, 650, 70, 23);
        ...
        KetHasilSkrining.setBounds(490, 650, 300, 23);

        jLabel5.setText(":");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(0, 100, 64, 23);

        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel24.setText("TB");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(180, 100, 50, 23);

        jLabel27.setText(":");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(0, 650, 178, 23);
        ...
        jLabel112.setText("Batuk & demam / riwayat demam");
        jLabel112.setName("jLabel112"); // NOI18N
        FormInput.add(jLabel112);
        jLabel112.setBounds(60, 470, 180, 23);
        ...
        jLabel114.setText("Riwayat / batuk darah");
        jLabel114.setName("jLabel114"); // NOI18N
        FormInput.add(jLabel114);
        jLabel114.setBounds(60, 500, 120, 23);

        Batukdarah.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        Batukdarah.setName("Batukdarah"); // NOI18N
        Batukdarah.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                BatukdarahItemStateChanged(evt);
            }
        });
        Batukdarah.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BatukdarahKeyPressed(evt);
            }
        });
        FormInput.add(Batukdarah);
        Batukdarah.setBounds(230, 500, 80, 23);

        jLabel115.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel115.setText("5.");
        jLabel115.setName("jLabel115"); // NOI18N
        FormInput.add(jLabel115);
        jLabel115.setBounds(320, 470, 20, 23);

        jLabel116.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel116.setText("Penurunan berat badan");
        jLabel116.setName("jLabel116"); // NOI18N
        FormInput.add(jLabel116);
        jLabel116.setBounds(340, 470, 370, 23);
        ...
        BBturun.setBounds(709, 470, 80, 23);

        jLabel117.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel117.setText("6.");
        jLabel117.setName("jLabel117"); // NOI18N
        FormInput.add(jLabel117);
        jLabel117.setBounds(320, 500, 20, 23);

        jLabel118.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel118.setText("Berkeringat malam");
        jLabel118.setName("jLabel118"); // NOI18N
        FormInput.add(jLabel118);
        jLabel118.setBounds(340, 500, 370, 23);
        ...
        jSeparator6.setBounds(0, 630, 807, 1);
        ...
        jLabel119.setBounds(40, 600, 430, 23);
        ...
        KetGejalaPenyakit.setBounds(480, 600, 313, 23);
        ...
        jLabel14.setBounds(0, 600, 472, 23);

        jLabel121.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel121.setText("3.");
        jLabel121.setName("jLabel121"); // NOI18N
        FormInput.add(jLabel121);
        jLabel121.setBounds(44, 530, 30, 23);

        jLabel122.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel122.setText("Sesak nafas");
        jLabel122.setName("jLabel122"); // NOI18N
        FormInput.add(jLabel122);
        jLabel122.setBounds(60, 530, 80, 23);

        Sesaknafas.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        Sesaknafas.setName("Sesaknafas"); // NOI18N
        Sesaknafas.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                SesaknafasItemStateChanged(evt);
            }
        });
        Sesaknafas.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                SesaknafasKeyPressed(evt);
            }
        });
        FormInput.add(Sesaknafas);
        Sesaknafas.setBounds(230, 530, 80, 23);

        jLabel123.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel123.setText("4.");
        jLabel123.setName("jLabel123"); // NOI18N
        FormInput.add(jLabel123);
        jLabel123.setBounds(44, 560, 30, 23);

        jLabel124.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel124.setText("Tidak nafsu makan");
        jLabel124.setName("jLabel124"); // NOI18N
        FormInput.add(jLabel124);
        jLabel124.setBounds(60, 560, 110, 23);

        Tidaknafsumakan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        Tidaknafsumakan.setName("Tidaknafsumakan"); // NOI18N
        Tidaknafsumakan.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                TidaknafsumakanItemStateChanged(evt);
            }
        });
        Tidaknafsumakan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TidaknafsumakanKeyPressed(evt);
            }
        });
        FormInput.add(Tidaknafsumakan);
        Tidaknafsumakan.setBounds(230, 560, 80, 23);

        jLabel125.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel125.setText("7.");
        jLabel125.setName("jLabel125"); // NOI18N
        FormInput.add(jLabel125);
        jLabel125.setBounds(320, 530, 20, 23);

        jLabel128.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel128.setText("Hasil thorax : pneumonia atau gambaran lain yang mendukung TB");
        jLabel128.setName("jLabel128"); // NOI18N
        FormInput.add(jLabel128);
        jLabel128.setBounds(340, 530, 380, 23);

        Hasilthorax.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        Hasilthorax.setName("Hasilthorax"); // NOI18N
        Hasilthorax.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                HasilthoraxItemStateChanged(evt);
            }
        });
        Hasilthorax.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                HasilthoraxKeyPressed(evt);
            }
        });
        FormInput.add(Hasilthorax);
        Hasilthorax.setBounds(710, 530, 80, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (KesimpulanHasilSkrining.getText().trim().isEmpty()) {
            Valid.textKosong(KesimpulanHasilSkrining, "Kesimpulan Skrining");
        } else {
    ...
    private void MnSkriningTBCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSkriningTBCActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry("rptFormulirSkriningTBC.jasper", "report", "::[ Formulir Skrining TBC ]::",
                    ...
                    + "skrining_tbc.berat_badan,skrining_tbc.tinggi_badan,skrining_tbc.imt,skrining_tbc.kasifikasi_imt,"
    ...
    private void TBKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TBKeyPressed
        Valid.pindah(evt, BB, RiwayatKontakTBC);
    ...
    private void RiwayatKontakTBCKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_RiwayatKontakTBCKeyPressed
        Valid.pindah(evt, TB, JenisKontakTBC);
    ...
    private void BatukKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BatukKeyPressed
        Valid.pindah(evt, AbnormalitasTBC, Batukdarah);
    }//GEN-LAST:event_BatukKeyPressed

    private void BatukdarahKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BatukdarahKeyPressed
        Valid.pindah(evt, Batuk, BBturun);
    }//GEN-LAST:event_BatukdarahKeyPressed

    private void BBturunKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BBturunKeyPressed
        Valid.pindah(evt, Batukdarah, BerkeringatMalam);
    ...
    private void BerkeringatMalamKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BerkeringatMalamKeyPressed
        Valid.pindah(evt, BBturun, KetGejalaPenyakit);
    ...
    private void BatukdarahItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_BatukdarahItemStateChanged
        isTbc();
    }//GEN-LAST:event_BatukdarahItemStateChanged
    ...
    private void SesaknafasItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_SesaknafasItemStateChanged
        isTbc();
    }//GEN-LAST:event_SesaknafasItemStateChanged

    private void SesaknafasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SesaknafasKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_SesaknafasKeyPressed

    private void TidaknafsumakanItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_TidaknafsumakanItemStateChanged
        isTbc();
    }//GEN-LAST:event_TidaknafsumakanItemStateChanged

    private void TidaknafsumakanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TidaknafsumakanKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TidaknafsumakanKeyPressed

    private void HasilthoraxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_HasilthoraxItemStateChanged
        isTbc();
    }//GEN-LAST:event_HasilthoraxItemStateChanged

    private void HasilthoraxKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_HasilthoraxKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_HasilthoraxKeyPressed
    ...
    private widget.ComboBox Batukdarah;
    ...
    private widget.ComboBox Hasilthorax;
    ...
    private widget.ComboBox Sesaknafas;
    ...
    private widget.ComboBox Tidaknafsumakan;
        ...
        try {
            if (TCari.getText().trim().isEmpty()) {
                ps = koneksi.prepareStatement(
                        ...
                        + "skrining_tbc.faktor_resiko_pernah_berobat_tbc,skrining_tbc.faktor_resiko_malnutrisi,skrining_tbc.faktor_resiko_merokok,skrining_tbc.faktor_resiko_riwayat_dm,"
                        + "skrining_tbc.faktor_resiko_odhiv,skrining_tbc.faktor_resiko_lansia,skrining_tbc.faktor_resiko_ibu_hamil,skrining_tbc.faktor_resiko_wbp,skrining_tbc.faktor_resiko_tinggal_diwilayah_padat_kumuh,"
                        + "skrining_tbc.abnormalitas_tbc,skrining_tbc.gejala_tbc_batuk,skrining_tbc.gejala_tbc_batuk_darah,skrining_tbc.gejala_tbc_sesak_nafas,skrining_tbc.gejala_tbc_tidak_nafsu_makan,skrining_tbc.gejala_tbc_bb_turun,"
                        + "skrining_tbc.gejala_tbc_berkeringat_malam_hari,skrining_tbc.gejala_tbc_hasil_foto,skrining_tbc.keterangan_gejala_penyakit_lain,"
                        + "skrining_tbc.kesimpulan_skrining,skrining_tbc.keterangan_hasil_skrining from skrining_tbc inner join reg_periksa on skrining_tbc.no_rawat=reg_periksa.no_rawat "
                        + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join petugas on skrining_tbc.nip=petugas.nip "
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("berat_badan"), rs.getString("tinggi_badan"), rs.getString("imt"),
                        rs.getString("kasifikasi_imt"), rs.getString("riwayat_kontak_tbc"),
                        rs.getString("jenis_kontak_tbc"), rs.getString("faktor_resiko_pernah_terdiagnosa_tbc"),
                        rs.getString("keterangan_pernah_terdiagnosa"),
                        rs.getString("faktor_resiko_pernah_berobat_tbc"), rs.getString("faktor_resiko_malnutrisi"),
                        rs.getString("faktor_resiko_merokok"), rs.getString("faktor_resiko_riwayat_dm"),
                        rs.getString("faktor_resiko_odhiv"), rs.getString("faktor_resiko_lansia"),
                        rs.getString("faktor_resiko_ibu_hamil"), rs.getString("faktor_resiko_wbp"),
                        rs.getString("faktor_resiko_tinggal_diwilayah_padat_kumuh"),
                        rs.getString("abnormalitas_tbc"), rs.getString("gejala_tbc_batuk"),
                        rs.getString("gejala_tbc_batuk_darah"), rs.getString("gejala_tbc_sesak_nafas"),
                        rs.getString("gejala_tbc_tidak_nafsu_makan"), rs.getString("gejala_tbc_bb_turun"),
                        rs.getString("gejala_tbc_berkeringat_malam_hari"),
                        rs.getString("gejala_tbc_hasil_foto"), rs.getString("keterangan_gejala_penyakit_lain"),
    ...
    public void emptTeks() {
        ...
        Batukdarah.setSelectedIndex(0);
        Sesaknafas.setSelectedIndex(0);
        Tidaknafsumakan.setSelectedIndex(0);
        BBturun.setSelectedIndex(0);
        BerkeringatMalam.setSelectedIndex(0);
        Hasilthorax.setSelectedIndex(0);
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            RiwayatKontakTBC.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 12).toString());
            JenisKontakTBC.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 13).toString());
            PernahTerdiagnosaTBC.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 14).toString());
            KetPernahTerdiagnosa.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 15).toString());
            PernahberobatTBC.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 16).toString());
            Malnutrisi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 17).toString());
            Merokok.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 18).toString());
            RiwayatDM.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 19).toString());
            Odhiv.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 20).toString());
            Lansia.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 21).toString());
            Ibuhamil.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 22).toString());
            WargaBinaan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 23).toString());
            Tingaldiwilayahkumuh.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 24).toString());
            AbnormalitasTBC.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 25).toString());
            Batuk.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 26).toString());
            Batukdarah.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 27).toString());
            Sesaknafas.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 28).toString());
            Tidaknafsumakan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 29).toString());
            BBturun.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 30).toString());
            BerkeringatMalam.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 31).toString());
            Hasilthorax.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 32).toString());
            KetGejalaPenyakit.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 33).toString());
            KesimpulanHasilSkrining.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 34).toString());
            KetHasilSkrining.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 35).toString());
    ...
    private void ganti() {
        if (Sequel.mengedittf("skrining_tbc", "no_rawat=?",
                "no_rawat=?,tanggal=?,berat_badan=?,tinggi_badan=?,imt=?,kasifikasi_imt=?,"
                ...
                + "faktor_resiko_wbp=?,faktor_resiko_tinggal_diwilayah_padat_kumuh=?,abnormalitas_tbc=?,gejala_tbc_batuk=?,gejala_tbc_batuk_darah=?,gejala_tbc_sesak_nafas=?,"
                + "gejala_tbc_tidak_nafsu_makan=?,gejala_tbc_bb_turun=?,gejala_tbc_berkeringat_malam_hari=?,gejala_tbc_hasil_foto=?,keterangan_gejala_penyakit_lain=?,"
                + "kesimpulan_skrining=?,keterangan_hasil_skrining=?,nip=?",
                32,
                new String[]{TNoRw.getText(),
                    ...
                    BB.getText(), TB.getText(), IMT.getText(), KlasifikasiIMT.getText(),
                    RiwayatKontakTBC.getSelectedItem().toString(),
                    JenisKontakTBC.getSelectedItem().toString(), PernahTerdiagnosaTBC.getSelectedItem().toString(),
                    KetPernahTerdiagnosa.getText(), PernahberobatTBC.getSelectedItem().toString(),
                    Malnutrisi.getSelectedItem().toString(), Merokok.getSelectedItem().toString(),
                    RiwayatDM.getSelectedItem().toString(), Odhiv.getSelectedItem().toString(),
                    Lansia.getSelectedItem().toString(), Ibuhamil.getSelectedItem().toString(),
                    WargaBinaan.getSelectedItem().toString(), Tingaldiwilayahkumuh.getSelectedItem().toString(),
                    AbnormalitasTBC.getSelectedItem().toString(), Batuk.getSelectedItem().toString(),
                    Batukdarah.getSelectedItem().toString(), Sesaknafas.getSelectedItem().toString(),
                    Tidaknafsumakan.getSelectedItem().toString(), BBturun.getSelectedItem().toString(),
                    BerkeringatMalam.getSelectedItem().toString(),
                    Hasilthorax.getSelectedItem().toString(), KetGejalaPenyakit.getText(),
            ...
            tbObat.setValueAt(RiwayatKontakTBC.getSelectedItem().toString(), tbObat.getSelectedRow(), 12);
            tbObat.setValueAt(JenisKontakTBC.getSelectedItem().toString(), tbObat.getSelectedRow(), 13);
            tbObat.setValueAt(PernahTerdiagnosaTBC.getSelectedItem().toString(), tbObat.getSelectedRow(), 14);
            tbObat.setValueAt(KetPernahTerdiagnosa.getText(), tbObat.getSelectedRow(), 15);
            tbObat.setValueAt(PernahberobatTBC.getSelectedItem().toString(), tbObat.getSelectedRow(), 16);
            tbObat.setValueAt(Malnutrisi.getSelectedItem().toString(), tbObat.getSelectedRow(), 17);
            tbObat.setValueAt(Merokok.getSelectedItem().toString(), tbObat.getSelectedRow(), 18);
            tbObat.setValueAt(RiwayatDM.getSelectedItem().toString(), tbObat.getSelectedRow(), 19);
            tbObat.setValueAt(Odhiv.getSelectedItem().toString(), tbObat.getSelectedRow(), 20);
            tbObat.setValueAt(Lansia.getSelectedItem().toString(), tbObat.getSelectedRow(), 21);
            tbObat.setValueAt(Ibuhamil.getSelectedItem().toString(), tbObat.getSelectedRow(), 22);
            tbObat.setValueAt(WargaBinaan.getSelectedItem().toString(), tbObat.getSelectedRow(), 23);
            tbObat.setValueAt(Tingaldiwilayahkumuh.getSelectedItem().toString(), tbObat.getSelectedRow(), 24);
            tbObat.setValueAt(AbnormalitasTBC.getSelectedItem().toString(), tbObat.getSelectedRow(), 25);
            tbObat.setValueAt(Batuk.getSelectedItem().toString(), tbObat.getSelectedRow(), 26);
            tbObat.setValueAt(Batukdarah.getSelectedItem().toString(), tbObat.getSelectedRow(), 27);
            tbObat.setValueAt(Sesaknafas.getSelectedItem().toString(), tbObat.getSelectedRow(), 28);
            tbObat.setValueAt(Tidaknafsumakan.getSelectedItem().toString(), tbObat.getSelectedRow(), 29);
            tbObat.setValueAt(BBturun.getSelectedItem().toString(), tbObat.getSelectedRow(), 30);
            tbObat.setValueAt(BerkeringatMalam.getSelectedItem().toString(), tbObat.getSelectedRow(), 31);
            tbObat.setValueAt(Hasilthorax.getSelectedItem().toString(), tbObat.getSelectedRow(), 32);
            tbObat.setValueAt(KetGejalaPenyakit.getText(), tbObat.getSelectedRow(), 33);
            tbObat.setValueAt(KesimpulanHasilSkrining.getText(), tbObat.getSelectedRow(), 34);
            tbObat.setValueAt(KetHasilSkrining.getText(), tbObat.getSelectedRow(), 35);
            emptTeks();
        }
    }

    private void hapus() {
        if (Sequel.queryu2tf("delete from skrining_tbc where no_rawat=?", 1,
    ...
    private void isBMI() {
        try {
            if ((!TB.getText().isEmpty()) && (!BB.getText().isEmpty())) {
                ...
                if (IMT.getText().isEmpty()) {
                    KlasifikasiIMT.setText("");
                } else if (Valid.SetAngka(IMT.getText()) < 18.5) {
    ...
    private void isTbc() {
        try {
            if ((!RiwayatKontakTBC.getSelectedItem().toString().isEmpty())
                    && (!Batuk.getSelectedItem().toString().isEmpty())
                    && (!Batukdarah.getSelectedItem().toString().isEmpty())
                    && (!Sesaknafas.getSelectedItem().toString().isEmpty())
                    && (!Tidaknafsumakan.getSelectedItem().toString().isEmpty())
                    && (!BBturun.getSelectedItem().toString().isEmpty())
                    && (!BerkeringatMalam.getSelectedItem().toString().isEmpty())
                    && (!Hasilthorax.getSelectedItem().toString().isEmpty())) {
                if (RiwayatKontakTBC.getSelectedItem().toString().equals("Tidak")) {
                    if ((Batuk.getSelectedItem().toString().equals("Ya"))) {
                        if ((Batukdarah.getSelectedItem().toString().equals("Ya"))) {
                            KesimpulanHasilSkrining.setText("Terduga TBC");
                        } else if ((Sesaknafas.getSelectedItem().toString().equals("Ya"))) {
                            KesimpulanHasilSkrining.setText("Terduga TBC");
                        } else if ((Tidaknafsumakan.getSelectedItem().toString().equals("Ya"))) {
                            KesimpulanHasilSkrining.setText("Terduga TBC");
                        } else if ((BBturun.getSelectedItem().toString().equals("Ya"))) {
                            KesimpulanHasilSkrining.setText("Terduga TBC");
                        } else if ((BerkeringatMalam.getSelectedItem().toString().equals("Ya"))) {
                            KesimpulanHasilSkrining.setText("Terduga TBC");
                        } else if ((Hasilthorax.getSelectedItem().toString().equals("Ya"))) {
                            KesimpulanHasilSkrining.setText("Terduga TBC");
                        } else {
                            KesimpulanHasilSkrining.setText("Bukan Terduga TBC");
                        }
                    } else if ((Batuk.getSelectedItem().toString().equals("Tidak"))) {
                        KesimpulanHasilSkrining.setText("Bukan Terduga TBC");
                    }
                    ...
                    if ((Batuk.getSelectedItem().toString().equals("Ya"))) {
                        if ((Batukdarah.getSelectedItem().toString().equals("Ya"))) {
                            ...
                            KesimpulanHasilSkrining.setText("Investigasi Kontak");
                        }
                    } else if ((Batukdarah.getSelectedItem().toString().equals("Tidak"))) {
                        KesimpulanHasilSkrining.setText("Investigasi Kontak");
                    }
                } else {
                    KesimpulanHasilSkrining.setText("Bukan Terduga TBC");
    ...
    private void simpan() {
        if (Sequel.menyimpantf("skrining_tbc", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data",
                31,
                new String[]{TNoRw.getText(),
                    Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Jam.getSelectedItem() + ":"
                    + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
                    ...
                    BerkeringatMalam.getSelectedItem().toString(),
                    Hasilthorax.getSelectedItem().toString(), KetGejalaPenyakit.getText(),
                    KesimpulanHasilSkrining.getText(), KetHasilSkrining.getText(), KdPetugas.getText()}) == true) {
