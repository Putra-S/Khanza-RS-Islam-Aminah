...
public class RMPemantauanMEOWS extends javax.swing.JDialog {
    ...
    public RMPemantauanMEOWS(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Umur", "JK", "Tanggal", "Pernapasan", "Skor 1",
                    "Saturasi", "Skor 2", "Temperatur", "Skor 3", "TD Sistole", "Skor 4", "TD Diastole", "Skor 5",
                    "Denyut Jantung", "Skor 6", "Kesadaran", "Skor 7", "Ketuban", "Skor 8", "Discharge", "Skor 9",
                    "Proteinuria", "Skor 10", "Total Skor", "Parameter Total", "Code Blue", "NIP", "Petugas",
                    "Tgl.Lahir"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("jk"), rs.getString("tanggal"), rs.getString("parameter_pernapasan"),
                        rs.getString("skor_pernapasan"), rs.getString("parameter_saturasi"),
                        rs.getString("skor_saturasi"), rs.getString("parameter_temperatur"),
                        rs.getString("skor_temperatur"), rs.getString("parameter_tekanan_darah_sistole"),
                        rs.getString("skor_tekanan_darah_sistole"),
                        rs.getString("parameter_tekanan_darah_diastole"),
                        rs.getString("skor_tekanan_darah_diastole"), rs.getString("parameter_denyut_jantung"),
                        rs.getString("skor_denyut_jantung"), rs.getString("parameter_kesadaran"),
                        rs.getString("skor_kesadaran"), rs.getString("parameter_ketuban"),
                        rs.getString("skor_ketuban"), rs.getString("parameter_discharge"),
                        rs.getString("skor_discharge"), rs.getString("parameter_proteinuria"),
                        rs.getString("skor_proteinuria"), rs.getString("skor_total"),
                        rs.getString("parameter_total"), rs.getString("code_blue"), rs.getString("nip"),
    ...
    private void isjml() {
        if ((!Skor1.getText().isEmpty()) && (!Skor2.getText().isEmpty()) && (!Skor3.getText().isEmpty())
                && (!Skor4.getText().isEmpty()) && (!Skor5.getText().isEmpty()) && (!Skor6.getText().isEmpty())
                && (!Skor7.getText().isEmpty()) && (!Skor8.getText().isEmpty()) && (!Skor9.getText().isEmpty())
                && (!Skor10.getText().isEmpty())) {
            TotalSkor.setText(Valid
                    .SetAngka2(Double.parseDouble(Skor1.getText().trim()) + Double.parseDouble(Skor2.getText().trim())
                            + Double.parseDouble(Skor3.getText().trim()) + Double.parseDouble(Skor4.getText().trim())
                            + Double.parseDouble(Skor5.getText().trim()) + Double.parseDouble(Skor6.getText().trim())
                            + Double.parseDouble(Skor7.getText().trim()) + Double.parseDouble(Skor8.getText().trim())
                            + Double.parseDouble(Skor9.getText().trim()) + Double.parseDouble(Skor10.getText().trim())));
        }
    }
    ...
    private void ganti() {
        ...
        isjml();
        isHitung();
        if (Sequel.mengedittf("pemantauan_meows_obstetri", "tanggal=? and no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    Skor8.getText(), cmbSkor9.getSelectedItem().toString(), Skor9.getText(),
                    cmbSkor10.getSelectedItem().toString(), Skor10.getText(), TotalSkor.getText(),
                    ParameterSkor.getText(), cmbCodeBlue.getSelectedItem().toString(), KdPetugas.getText(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from pemantauan_meows_obstetri where tanggal=? and no_rawat=?", 2,
    ...
    private void simpan() {
        ...
        if (Sequel.menyimpantf("pemantauan_meows_obstetri", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    Skor8.getText(), cmbSkor9.getSelectedItem().toString(), Skor9.getText(),
                    cmbSkor10.getSelectedItem().toString(), Skor10.getText(), TotalSkor.getText(),
                    ParameterSkor.getText(), cmbCodeBlue.getSelectedItem().toString(),
            ...
            tabMode.addRow(new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), Umur.getText(),
                ...
                cmbSkor10.getSelectedItem().toString(), Skor10.getText(), TotalSkor.getText(),
                ParameterSkor.getText(), cmbCodeBlue.getSelectedItem().toString(), KdPetugas.getText(),
                NmPetugas.getText(), TglLahir.getText()});
            LCount.setText("" + tabMode.getRowCount());
            emptTeks();
        }
    }

    private static final Logger LOG = Logger.getLogger(RMPemantauanMEOWS.class.getName());
