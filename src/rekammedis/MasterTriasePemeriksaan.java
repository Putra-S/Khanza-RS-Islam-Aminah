...
public class MasterTriasePemeriksaan extends javax.swing.JDialog {
    ...
    public MasterTriasePemeriksaan(java.awt.Frame parent, boolean modal) {
        ...
        TNm.setDocument(new batasInput(150).getKata(TNm));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("master_triase_pemeriksaan",
                    "'" + TKd.getText() + "','" + TNm.getText() + "'", "Kode");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, TKd, "master_triase_pemeriksaan",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("master_triase_pemeriksaan",
                        "kode_pemeriksaan=?",
                        "kode_pemeriksaan=?,nama_pemeriksaan=?", 3,
                        new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterTriasePemeriksaan dialog = new MasterTriasePemeriksaan(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from master_triase_pemeriksaan where master_triase_pemeriksaan.kode_pemeriksaan like ? or master_triase_pemeriksaan.nama_pemeriksaan like ? order by master_triase_pemeriksaan.kode_pemeriksaan");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(
            MasterTriasePemeriksaan.class.getName());
}
