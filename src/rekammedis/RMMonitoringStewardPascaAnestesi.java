...
public class RMMonitoringStewardPascaAnestesi extends javax.swing.JDialog {
    ...
    public RMMonitoringStewardPascaAnestesi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Tgl.Lahir", "JK", "Tanggal", "1. Kesadaran",
                    "N.K. 1", "2. Respirasi", "N.K. 2", "3. Aktivitas Motorik", "N.K. 3", "Total", "Keluar",
                    "Instruksi", "Kode Dokter", "Nama Dokter", "NIP", "Petugas"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMMonitoringStewardPascaAnestesi dialog = new RMMonitoringStewardPascaAnestesi(new javax.swing.JFrame(),
                    true);
    ...
    private void ganti() {
        if (Sequel.mengedittf("skor_steward_pasca_anestesi", "tanggal=? and no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    SkalaKriteria1.getSelectedItem().toString(), NilaiKriteria1.getText(),
                    SkalaKriteria2.getSelectedItem().toString(), NilaiKriteria2.getText(),
                    SkalaKriteria3.getSelectedItem().toString(), NilaiKriteria3.getText(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from skor_steward_pasca_anestesi where tanggal=? and no_rawat=?", 2,
    ...
    private void isTotalResiko() {
        try {
            NilaiKriteriaTotal.setText((Integer.parseInt(NilaiKriteria1.getText())
                    + Integer.parseInt(NilaiKriteria2.getText()) + Integer.parseInt(NilaiKriteria3.getText())) + "");
    ...
    private void simpan() {
        if (Sequel.menyimpantf("skor_steward_pasca_anestesi", "?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 13,
                new String[]{TNoRw.getText(),
                    Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Jam.getSelectedItem() + ":"
                    + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
                    SkalaKriteria1.getSelectedItem().toString(), NilaiKriteria1.getText(),
            ...
            tabMode.addRow(new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), TglLahir.getText(),
                ...
                SkalaKriteria1.getSelectedItem().toString(), NilaiKriteria1.getText(),
                SkalaKriteria2.getSelectedItem().toString(), NilaiKriteria2.getText(),
                SkalaKriteria3.getSelectedItem().toString(), NilaiKriteria3.getText(), NilaiKriteriaTotal.getText(),
    ...
    private static final Logger LOG = Logger.getLogger(RMMonitoringStewardPascaAnestesi.class.getName());
