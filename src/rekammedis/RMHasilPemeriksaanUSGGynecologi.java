...
public class RMHasilPemeriksaanUSGGynecologi extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (Uterus.getText().trim().isEmpty()) {
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry("rptCetakHasilPemeriksaanUSGGynecologi.jasper",
                    "report", "::[ Formulir Hasil Pemeriksaan USG ]::",
                    ...
                    + "inner join dokter on hasil_pemeriksaan_usg_gynecologi.kd_dokter=dokter.kd_dokter where hasil_pemeriksaan_usg_gynecologi.no_rawat='" + tbObat.
    ...
    private void btnAmbilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbObat.getSelectedRow() > -1) {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                Valid.panggilUrl(
                        "hasilpemeriksaanusggynecologi/login.php?act=login&usere=" + koneksiDB.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMHasilPemeriksaanUSGGynecologi dialog = new RMHasilPemeriksaanUSGGynecologi(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        "diagnosa_klinis"), rs.getString("uterus"), rs.
                        getString("parametrium"), rs.getString("ovarium"), rs.
                        getString("doppler"), rs.getString("kesimpulan")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Uterus.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 9).
                    toString());
            Parametrium.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 10).
                    toString());
            Ovarium.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 11).
                    toString());
            Doppler.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 12).
                    toString());
            Kesimpulan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 13).
                    toString());
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from hasil_pemeriksaan_usg_gynecologi where no_rawat=?",
                1, new String[]{
                    tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
                }) == true) {
    ...
    private void ganti() {
        if (Sequel.mengedittf("hasil_pemeriksaan_usg_gynecologi", "no_rawat=?",
                "no_rawat=?,tanggal=?,kd_dokter=?,diagnosa_klinis=?,kiriman_dari=?,uterus=?,parametrium=?,ovarium=?,doppler=?,kesimpulan=?",
                11, new String[]{
                    ...
                    KirimanDari.getText(), DiagnosaKlinis.getText(), Uterus.
                    getText(), Parametrium.getText(), Ovarium.getText(),
                    Doppler.getText(), Kesimpulan.getText(), tbObat.getValueAt(
            ...
            tbObat.
                    setValueAt(Parametrium.getText(), tbObat.getSelectedRow(),
                            10);
    ...
    private void panggilPhoto() {
        if (FormPhoto.isVisible() == true) {
            try {
                ps = koneksi.prepareStatement(
                        "select hasil_pemeriksaan_usg_gynecologi_gambar.photo from hasil_pemeriksaan_usg_gynecologi_gambar where hasil_pemeriksaan_usg_gynecologi_gambar.no_rawat=?");
                try {
                        ...
                        if (rs.getString("photo").isEmpty() || rs.getString(
                            ...
                            LoadHTML2.setText(
                                    "<html><body><center><a href='http://" + koneksiDB.
                                            ...
                                            PORTWEB() + "/" + koneksiDB.
                                            HYBRIDWEB() + "/hasilpemeriksaanusggynecologi/" + rs.
    ...
    private void simpan() {
        if (Sequel.menyimpantf("hasil_pemeriksaan_usg_gynecologi",
                "?,?,?,?,?,?,?,?,?,?", "No.Rawat", 10, new String[]{
                    TNoRw.getText(), Valid.
                    SetTgl(Tanggal.getSelectedItem() + "") + " " + Tanggal.
                    getSelectedItem().toString().substring(11, 19), KdDokter.
                    getText(),
                    DiagnosaKlinis.getText(), KirimanDari.getText(), Uterus.
                    getText(), Parametrium.getText(), Ovarium.getText(),
                    Doppler.getText(), Kesimpulan.getText()
                }) == true) {
            tabMode.addRow(new String[]{
                ...
                getSelectedItem().toString().substring(11, 19),
                KirimanDari.getText(), DiagnosaKlinis.getText(), Uterus.
                getText(), Parametrium.getText(), Ovarium.getText(), Doppler.
                getText(), Kesimpulan.getText()
            });
            emptTeks();
            LCount.setText("" + tabMode.getRowCount());
        }
    ...
    private static final Logger LOG = Logger.getLogger(
            RMHasilPemeriksaanUSGGynecologi.class.getName());
}
