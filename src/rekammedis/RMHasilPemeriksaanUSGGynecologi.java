...
public class RMHasilPemeriksaanUSGGynecologi extends javax.swing.JDialog {
    ...
    public RMHasilPemeriksaanUSGGynecologi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "Kode Dokter", "Nama Dokter", "Tanggal",
                    "Kiriman Dari", "Diagnosa Klinis", "Uterus", "Parametrium", "Ovarium", "Doppler",
                    "Kesimpulan"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMHasilPemeriksaanUSGGynecologi dialog = new RMHasilPemeriksaanUSGGynecologi(new javax.swing.JFrame(),
                    true);
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("diagnosa_klinis"), rs.getString("uterus"), rs.getString("parametrium"),
                        rs.getString("ovarium"), rs.getString("doppler"), rs.getString("kesimpulan")});
                }
            } catch (Exception e) {
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from hasil_pemeriksaan_usg_gynecologi where no_rawat=?", 1,
    ...
    private void ganti() {
        if (Sequel.mengedittf("hasil_pemeriksaan_usg_gynecologi", "no_rawat=?",
                ...
                11,
                new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), TglLahir.getText(),
                    KdDokter.getText(), NmDokter.getText(),
                    Valid.SetTgl(Tanggal.getSelectedItem() + "") + " "
                    + Tanggal.getSelectedItem().toString().substring(11, 19),
                    KirimanDari.getText(), DiagnosaKlinis.getText(), Uterus.getText(), Parametrium.getText(),
                    Ovarium.getText(), Doppler.getText(), Kesimpulan.getText(),
                    ...
                    if (rs.next()) {
                        if (rs.getString("photo").isEmpty() || rs.getString("photo").equals("-")) {
                            ...
                            LoadHTML2.setText("<html><body><center><a href='http://" + koneksiDB.HOSTHYBRIDWEB() + ":"
                                    ...
                                    + "/hasilpemeriksaanusggynecologi/" + rs.getString("photo") + "'><img src='http://"
                                    + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/"
                                    + koneksiDB.HYBRIDWEB() + "/hasilpemeriksaanusggynecologi/" + rs.getString("photo")
    ...
    private void simpan() {
        if (Sequel.menyimpantf("hasil_pemeriksaan_usg_gynecologi", "?,?,?,?,?,?,?,?,?,?", "No.Rawat", 10,
                new String[]{TNoRw.getText(),
                    Valid.SetTgl(Tanggal.getSelectedItem() + "") + " "
                    + Tanggal.getSelectedItem().toString().substring(11, 19),
                    KdDokter.getText(), DiagnosaKlinis.getText(), KirimanDari.getText(), Uterus.getText(),
                    Parametrium.getText(), Ovarium.getText(), Doppler.getText(), Kesimpulan.getText()}) == true) {
    ...
    private static final Logger LOG = Logger.getLogger(RMHasilPemeriksaanUSGGynecologi.class.getName());
