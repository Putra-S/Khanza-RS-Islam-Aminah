...
public class MasterRencanaKeperawatanPsikiatri extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterRencanaKeperawatanPsikiatri dialog = new MasterRencanaKeperawatanPsikiatri(new javax.swing.JFrame(),
                    true);
    ...
    private static final Logger LOG = Logger.getLogger(MasterRencanaKeperawatanPsikiatri.class.getName());
