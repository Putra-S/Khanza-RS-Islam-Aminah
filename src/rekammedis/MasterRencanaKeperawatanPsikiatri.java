...
public class MasterRencanaKeperawatanPsikiatri extends javax.swing.JDialog {
    ...
    private MasterMasalahKeperawatanPsikiatri masalah = new MasterMasalahKeperawatanPsikiatri(
            null, false);
     ...
     * @param modal
     */
    public MasterRencanaKeperawatanPsikiatri(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row = {"Kode Masalah", "Masalah Keperawatan", "Kode",
            "Rencana Keperawatan"};
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdrencana.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("master_rencana_keperawatan_psikiatri",
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, kdrencana,
                "master_rencana_keperawatan_psikiatri", "kode_rencana") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdrencana.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("master_rencana_keperawatan_psikiatri",
                        "kode_rencana=?",
                        "kode_rencana=?,rencana_keperawatan=?,kode_masalah=?", 4,
                        new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterRencanaKeperawatanPsikiatri dialog = new MasterRencanaKeperawatanPsikiatri(
    ...
    private static final Logger LOG = Logger.getLogger(
            MasterRencanaKeperawatanPsikiatri.class.getName());
}
