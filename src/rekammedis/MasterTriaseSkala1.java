...
public class MasterTriaseSkala1 extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdskala.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("master_triase_skala1", "'" + kdpemeriksaan.
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, kdskala, "master_triase_skala1",
                "kode_skala1") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdskala.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("master_triase_skala1", "kode_skala1=?",
                        "kode_skala1=?,pengkajian_skala1=?,kode_pemeriksaan=?",
                        4, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterTriaseSkala1 dialog = new MasterTriaseSkala1(
    ...
    private static final Logger LOG = Logger.getLogger(MasterTriaseSkala1.class.
            getName());
}
