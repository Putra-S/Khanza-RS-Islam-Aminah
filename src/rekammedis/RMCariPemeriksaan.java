...
//        tbKamar.setModel(tabMode);
  ...
  private void ppSemuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppSemuaActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCariPemeriksaan dialog = new RMCariPemeriksaan(
  ...
  // End of variables declaration//GEN-END:variables
    ...
    public void tampil() {
        ...
        for (i = 0; i < jml; i++) {
            tabMode.addRow(new Object[]{
                pilih[i], tanggal[i], jam[i], pemeriksaan[i]
            });
        }
        Valid.tabelKosong(tabMode);
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString(3).replace("ᵒ", "").replace("<",
                        "kurang dari").replace(">", "lebih dari")
                    });
                }
            } catch (Exception ex) {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        false, rs.getString(1), rs.getString(2),
                        " \nsuhu:" + rs.getString(4) + " c, tensi:" + rs.
                        getString(5) + " mmHg, nadi:" + rs.getString(6) + " x/menit, respirasi:" + rs.
                        getString(7) + " x/menit, tinggi:" + rs.getString(8) + " cm, berat:" + rs.
                        getString(9) + " kg, spo:" + rs.getString(10) + ", gcs:" + rs.
                        getString(11) + ", kesadaran:" + rs.getString(12)
                    });
                }
            } catch (Exception ex) {
                System.out.println(ex);
    ...
    private static final Logger LOG = Logger.getLogger(RMCariPemeriksaan.class.
            getName());
