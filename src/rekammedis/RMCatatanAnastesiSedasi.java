...
public final class RMCatatanAnastesiSedasi extends javax.swing.JDialog {
    ...
    public RMCatatanAnastesiSedasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.", "Kode DPJP Anastesi",
                    "Nama DPJP Anastesi", "NIP Petugas Anastesi", "Nama Petugas Anastesi", "Kode DPJP Bedah",
                    "Nama DPJP Bedah", "NIP Petugas Bedah", "Nama Petugas Bedah", "Tanggal", "Diagnosa Pra Bedah",
                    "Tindakan/Jenis Pembedahan", "Diagnosa Pasca Bedah", "Jam", "Kesadaran", "TD(mmHg)",
                    "Nadi(x/m)", "RR(x/m)", "Suhu(°C)", "Saturasi O2", "TB(Cm)", "BB(Kg)", "GD", "Rhesus",
                    "HB(gr/dl)", "HT(%)", "Leko(ul)", "Trombo(ul)", "BTCT(mnt)", "GDS(MG/dl)",
                    "Pre Induksi Lainnya", "Hiopotensi", "TCI", "CPB", "Ventilator", "Broncoskopy", "Glidescope",
                    "USG", "Stimulator Syaraf", "Teknik & Alat Khusus Lainnya", "EKG", "Keterangan EKG",
                    "Arteri Line", "Keterangan Arteri Line", "CVP", "Keterangan CVP", "EtCO2", "Stetoskop", "NIBP",
                    "NGT", "BIS", "Cath A Pulmo", "SpO2", "Kateter Urine", "Temp.", "Monitoring Lainnya", "ASA",
                    "Alergi", "Keterangan Alergi", "Penyulit Pra Anastesi/Sedasi", "Lanjut Tindakan", "Sedasi",
                    "Keterangan Sedasi", "Spinal", "Anestesi Umum", "Keterangan Anestesi Umum", "Blok Perifer",
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (NmDokterAnastesi.getText().trim().isEmpty()) {
            Valid.textKosong(BtnDokterAnestesi, "Dokter Anastesi");
        } else if (NmDokterBedah.getText().trim().isEmpty()) {
            Valid.textKosong(BtnDokterBedah, "Dokter Bedah");
        } else if (NmPetugasAnastesi.getText().trim().isEmpty()) {
            Valid.textKosong(BtnPetugasAnastesi, "Petugas Anastesi");
        } else if (NmPetugasBedah.getText().trim().isEmpty()) {
            Valid.textKosong(BtnPetugasBedah, "Petugas Bedah");
        } else if (DiagnosaPreBedah.getText().trim().isEmpty()) {
        ...
        } else if (DiagnosaPaskaBedah.getText().trim().isEmpty()) {
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("nip_perawat_anestesi"), rs.getString("petugasanestesi"),
                        rs.getString("kd_dokter_bedah"), rs.getString("dokterbedah"),
                        rs.getString("nip_perawat_ok"), rs.getString("petugasbedah"), rs.getString("tanggal"),
                        rs.getString("diagnosa_pre_bedah"), rs.getString("tindakan_jenis_pembedahan"),
                        rs.getString("diagnosa_pasca_bedah"), rs.getString("pre_induksi_jam"),
                        rs.getString("pre_induksi_kesadaran"), rs.getString("pre_induksi_td"),
                        rs.getString("pre_induksi_nadi"), rs.getString("pre_induksi_rr"),
                        rs.getString("pre_induksi_suhu"), rs.getString("pre_induksi_o2"),
                        rs.getString("pre_induksi_tb"), rs.getString("pre_induksi_bb"), rs.getString("gol_darah"),
                        rs.getString("pre_induksi_rhesus"), rs.getString("pre_induksi_hb"),
                        rs.getString("pre_induksi_ht"), rs.getString("pre_induksi_leko"),
                        rs.getString("pre_induksi_trombo"), rs.getString("pre_induksi_btct"),
                        rs.getString("pre_induksi_gds"), rs.getString("pre_induksi_lainlain"),
                        rs.getString("teknik_alat_hiopotensi"), rs.getString("teknik_alat_tci"),
                        rs.getString("teknik_alat_cpb"), rs.getString("teknik_alat_ventilasi"),
                        rs.getString("teknik_alat_broncoskopy"), rs.getString("teknik_alat_glidescopi"),
                        rs.getString("teknik_alat_usg"), rs.getString("teknik_alat_stimulator_saraf"),
                        rs.getString("teknik_alat_lainlain"), rs.getString("monitoring_ekg"),
                        rs.getString("monitoring_ekg_keterangan"), rs.getString("monitoring_arteri"),
                        rs.getString("monitoring_arteri_keterangan"), rs.getString("monitoring_cvp"),
                        rs.getString("monitoring_cvp_keterangan"), rs.getString("monitoring_etco"),
                        rs.getString("monitoring_stetoskop"), rs.getString("monitoring_nibp"),
                        rs.getString("monitoring_ngt"), rs.getString("monitoring_bis"),
                        rs.getString("monitoring_cath_a_pulmo"), rs.getString("monitoring_spo2"),
                        rs.getString("monitoring_kateter"), rs.getString("monitoring_temp"),
                        rs.getString("monitoring_lainlain"), rs.getString("status_fisik_asa"),
                        rs.getString("status_fisik_alergi"), rs.getString("status_fisik_alergi_keterangan"),
                        rs.getString("status_fisik_penyulit_sedasi"), rs.getString("perencanaan_lanjut"),
                        rs.getString("perencanaan_lanjut_sedasi"),
                        rs.getString("perencanaan_lanjut_sedasi_keterangan"),
                        rs.getString("perencanaan_lanjut_spinal"), rs.getString("perencanaan_lanjut_anestesi_umum"),
                        rs.getString("perencanaan_lanjut_anestesi_umum_keterangan"),
                        rs.getString("perencanaan_lanjut_blok_perifer"),
                        rs.getString("perencanaan_lanjut_blok_perifer_keterangan"),
                        rs.getString("perencanaan_lanjut_epidural"), rs.getString("perencanaan_batal"),
                        rs.getString("perencanaan_batal_alasan")});
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Jk.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 4)
                    .toString()
    ...
    public void isCek() {
        ...
        if (akses.getjml2() >= 1) {
            ...
            if (NmDokterAnastesi.getText().isEmpty()) {
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from catatan_anestesi_sedasi where no_rawat=? and tanggal=?", 2,
                new String[]{tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString(),
                    tbObat.getValueAt(tbObat.getSelectedRow(), 13).toString()}) == true) {
    ...
    private void ganti() {
        if (Sequel.mengedittf("catatan_anestesi_sedasi", "no_rawat=? and tanggal=?",
                "no_rawat=?,tanggal=?,kd_dokter_bedah=?,kd_dokter_anestesi=?,diagnosa_pre_bedah=?,tindakan_jenis_pembedahan=?,diagnosa_pasca_bedah=?,"
                ...
                + "perencanaan_lanjut_blok_perifer_keterangan=?,perencanaan_lanjut_epidural=?,perencanaan_batal=?,perencanaan_batal_alasan=?,nip_perawat_ok=?,nip_perawat_anestesi=?",
                68,
                new String[]{TNoRw.getText(),
                    Valid.SetTgl(TglAsuhan.getSelectedItem() + "") + " "
                    + TglAsuhan.getSelectedItem().toString().substring(11, 19),
                    KdDokterBedah.getText(), KdDokterAnestesi.getText(), DiagnosaPreBedah.getText(),
                    Tindakan.getText(), DiagnosaPaskaBedah.getText(), Jam.getText(),
                    Kesadaran.getSelectedItem().toString(), TD.getText(), Nadi.getText(), RR.getText(),
                    Suhu.getText(), Saturasi.getText(), TB.getText(), BB.getText(),
                    Rhesus.getSelectedItem().toString(), HB.getText(), HT.getText(), Leko.getText(),
                    Trombo.getText(), BTCT.getText(), GDS.getText(), LainLainPrInduksi.getText(),
                    Hiopotensi.getSelectedItem().toString(), TCI.getSelectedItem().toString(),
                    CPB.getSelectedItem().toString(), Ventilator.getSelectedItem().toString(),
                    Broncoskopy.getSelectedItem().toString(), Glidescope.getSelectedItem().toString(),
                    USG.getSelectedItem().toString(), StimulatorSaraf.getSelectedItem().toString(),
                    TeknikAlatLainnya.getText(), EKGLead.getSelectedItem().toString(), EKGLeadKeterangan.getText(),
                    ArteriLine.getSelectedItem().toString(), ArteriLineKeterangan.getText(),
                    CVP.getSelectedItem().toString(), CVPKeterangan.getText(), Etco2.getSelectedItem().toString(),
                    Stetoskop.getSelectedItem().toString(), NIBP.getSelectedItem().toString(),
                    NGT.getSelectedItem().toString(), BIS.getSelectedItem().toString(),
                    CathAPulmo.getSelectedItem().toString(), SpO2.getSelectedItem().toString(),
                    KateterUrine.getSelectedItem().toString(), Temp.getSelectedItem().toString(),
                    MonitoringLainLain.getText(), AngkaAsa.getSelectedItem().toString(),
                    Alergi.getSelectedItem().toString(), AlergiKeterangan.getText(), PenyulitPra.getText(),
                    LanjutTindakan.getSelectedItem().toString(), Sedasi.getSelectedItem().toString(),
                    SedasiKeterangan.getText(), Spinal.getSelectedItem().toString(),
                    AnastesiUmum.getSelectedItem().toString(), AnastesiUmumKeterangan.getText(),
                    BlokPerifer.getSelectedItem().toString(), BlokPeriferKeterangan.getText(),
                    Epidural.getSelectedItem().toString(), BatalTindakan.getSelectedItem().toString(),
                    BatalTindakanKeterangan.getText(), KdPetugasBedah.getText(), KdPetugasAnastesi.getText(),
            ...
            tbObat.setValueAt(Valid.SetTgl(TglAsuhan.getSelectedItem() + "") + " "
                    + TglAsuhan.getSelectedItem().toString().substring(11, 19), tbObat.getSelectedRow(), 13);
    ...
    private void simpan() {
        if (Sequel.menyimpantf("catatan_anestesi_sedasi",
                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                "No.Rawat, Tanggal & Jam", 66,
                new String[]{TNoRw.getText(),
                    Valid.SetTgl(TglAsuhan.getSelectedItem() + "") + " "
                    + TglAsuhan.getSelectedItem().toString().substring(11, 19),
                    KdDokterBedah.getText(), KdDokterAnestesi.getText(), DiagnosaPreBedah.getText(),
                    ...
                    BlokPerifer.getSelectedItem().toString(), BlokPeriferKeterangan.getText(),
                    Epidural.getSelectedItem().toString(), BatalTindakan.getSelectedItem().toString(),
                    BatalTindakanKeterangan.getText(), KdPetugasBedah.getText(),
                    KdPetugasAnastesi.getText()}) == true) {
            tabMode.addRow(new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), TglLahir.getText(),
                Jk.getText().substring(0, 1), KdDokterAnestesi.getText(), NmDokterAnastesi.getText(),
                KdPetugasAnastesi.getText(), NmPetugasAnastesi.getText(), KdDokterBedah.getText(),
                NmDokterBedah.getText(), KdPetugasBedah.getText(), NmPetugasBedah.getText(),
                Valid.SetTgl(TglAsuhan.getSelectedItem() + "") + " "
                + TglAsuhan.getSelectedItem().toString().substring(11, 19),
                DiagnosaPreBedah.getText(), Tindakan.getText(), DiagnosaPaskaBedah.getText(), Jam.getText(),
                Kesadaran.getSelectedItem().toString(), TD.getText(), Nadi.getText(), RR.getText(), Suhu.getText(),
                Saturasi.getText(), TB.getText(), BB.getText(), GD.getText(), Rhesus.getSelectedItem().toString(),
                HB.getText(), HT.getText(), Leko.getText(), Trombo.getText(), BTCT.getText(), GDS.getText(),
                LainLainPrInduksi.getText(), Hiopotensi.getSelectedItem().toString(),
                TCI.getSelectedItem().toString(), CPB.getSelectedItem().toString(),
                Ventilator.getSelectedItem().toString(), Broncoskopy.getSelectedItem().toString(),
                Glidescope.getSelectedItem().toString(), USG.getSelectedItem().toString(),
                StimulatorSaraf.getSelectedItem().toString(), TeknikAlatLainnya.getText(),
                EKGLead.getSelectedItem().toString(), EKGLeadKeterangan.getText(),
                ArteriLine.getSelectedItem().toString(), ArteriLineKeterangan.getText(),
                CVP.getSelectedItem().toString(), CVPKeterangan.getText(), Etco2.getSelectedItem().toString(),
                Stetoskop.getSelectedItem().toString(), NIBP.getSelectedItem().toString(),
                NGT.getSelectedItem().toString(), BIS.getSelectedItem().toString(),
