...
public class RMPenilaianAwalMedisRalanNeurologi extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisRalanNeurologi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.", "Kode Dokter", "Nama Dokter",
                    ...
                    "Riwayat Penyakit Dahulu", "Riwayat Penggunakan Obat", "Riwayat Alergi", "Kesadaran",
                    "Status Nutrisi", "TD(mmHg)", "Nadi(x/menit)", "Suhu", "RR(x/menit)", "BB(Kg)", "Nyeri", "GCS",
                    "Kepala", "Thoraks", "Abdomen", "Ekstremitas", "Columna Vertebralis", "Muskuloskeletal",
                    "Lainnya", "Laboratorium", "Radiologi", "Pemeriksaan", "Diagnosis", "Diagnosis Banding",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRalanNeurologi dialog = new RMPenilaianAwalMedisRalanNeurologi(new javax.swing.JFrame(),
                    true);
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("kesadaran"), rs.getString("status"), rs.getString("td"), rs.getString("nadi"),
                        ...
                        rs.getString("thoraks") + ", " + rs.getString("keterangan_thoraks"),
                        rs.getString("abdomen") + ", " + rs.getString("keterangan_abdomen"),
                        rs.getString("ekstremitas") + ", " + rs.getString("keterangan_ekstremitas"),
                        rs.getString("columna") + ", " + rs.getString("keterangan_columna"),
                        rs.getString("muskulos") + ", " + rs.getString("keterangan_muskulos"),
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            KeteranganColumna.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 28)
                    .toString()
                    .replaceAll(Kepala.getSelectedItem().toString() + ", ", ""));
            ...
            KeteranganMusku.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 29)
                    .toString()
                    .replaceAll(Kepala.getSelectedItem().toString() + ", ", ""));
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_medis_ralan_neurologi where no_rawat=?", 1,
    ...
    private void ganti() {
        if (Sequel.mengedittf("penilaian_medis_ralan_neurologi", "no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    Kesadaran.getSelectedItem().toString(), Status.getSelectedItem().toString(), TD.getText(),
                    Nadi.getText(), Suhu.getText(), RR.getText(), BB.getText(), Nyeri.getText(), GCS.getText(),
                    Kepala.getSelectedItem().toString(), KeteranganKepala.getText(),
    ...
    private static final Logger LOG = Logger.getLogger(RMPenilaianAwalMedisRalanNeurologi.class.getName());
