...
public class RMCariRekonsiliasiObat extends javax.swing.JDialog {
    ...
    public RMCariRekonsiliasiObat(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.Rekonsiliasi", "Pasien", "Tanggal Wawancara", "Rekonsiliasi Saat", "Alergi Obat",
            "Dampak Alergi", "Manifestasi Alergi", "Petugas Rekonsiliasi"};
...
//GEN-FIRST:event_TKdKeyPressed
    private void btnPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        member.emptTeks();//GEN-FIRST:event_btnPasienActionPerformed
        member.isCek();
...
private void BtnHapusKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnHapusKeyPressed
    ...
    private void tampil() {
        try {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + "where rekonsiliasi_obat.tanggal_wawancara between ? and ? "
                    + (TCari.getText().trim().isEmpty() ? "" : " and "
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rekonsiliasi"),
                        ...
                        rs.getString("tanggal_wawancara"), rs.getString("rekonsiliasi_obat_saat"),
                        rs.getString("alergi_obat"), rs.getString("dampak_alergi"),
                        rs.getString("manifestasi_alergi"), rs.getString("nip") + " " + rs.getString("nama")});
                    tabMode.addRow(new String[]{"", "Nama Obat", "Dosis Obat", "Frekuensi", "Cara Pemberian",
                        "Pemberian Terakhir", "Tindak Lanjut", "Perubahan Aturan Pakai"});
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new String[]{"", rs2.getString("nama_obat"), rs2.getString("dosis_obat"),
                                rs2.getString("frekuensi"), rs2.getString("cara_pemberian"),
                                rs2.getString("waktu_pemberian_terakhir"), rs2.getString("tindak_lanjut"),
                                rs2.getString("perubahan_aturan_pakai")});
                        }
                    } catch (Exception e) {
                    ...
                    try {
                        ...
                        if (rs3.next()) {
                            tabMode.addRow(new String[]{"", "Diterima Farmasi : " + rs3.getString("diterima_farmasi"),
                                "", "", "", "", "", ""});
                            ...
                            tabMode.addRow(new String[]{"",
                                ...
                                "", "", "", "", "", ""});
                            tabMode
                                    .addRow(new String[]{"", "Kembali Ke Pasien : " + rs3.getString("diserahkan_pasien"),
                                "", "", "", "", "", ""});
                        }
                    } catch (Exception e) {
                        System.out.println("Notif 3 : " + e);
    ...
    private static final Logger LOG = Logger.getLogger(RMCariRekonsiliasiObat.class.getName());
