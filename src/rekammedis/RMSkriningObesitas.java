...
public class RMSkriningObesitas extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (KlasifikasiIMT.getText().trim().isEmpty()) {
            Valid.textKosong(IMT, "Klasifikasi IMT");
        } else if (LP.getText().trim().isEmpty()) {
            Valid.textKosong(LP, "Lingkar Pinggang");
        } else if (RisikoLP.getText().trim().isEmpty()) {
            Valid.textKosong(LP, "Risiko Berdasar Lingkar Pinggang");
        } else if (StatusObesitas.getText().trim().isEmpty()) {
    ...
    private void ganti() {
        if (Sequel.mengedittf("skrining_obesitas", "no_rawat=?",
