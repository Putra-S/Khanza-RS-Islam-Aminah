...
public class RMSkriningNutrisiAnak extends javax.swing.JDialog {
    ...
    public RMSkriningNutrisiAnak(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Lahir", "J.K.", "Kode Petugas", "Nama Petugas",
                    ...
                    "Nilai 3", "Skrining Gizi 4", "Nilai 4", "Total Skor", "Hasil Skrining",
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("diketahui_dietisien"), rs.getString("keterangan_diketahui_dietisien")});
                }
            } catch (SQLException e) {
                System.out.println("Notif : " + e);
            } finally {
    ...
    private void ganti() {
        Sequel.mengedit("skrining_nutrisi_anak", "no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    Nilai3.getText(), SG4.getSelectedItem().toString(), Nilai4.getText(), TotalHasil.getText(),
                    LabelSkrining.getText(), Lapor.getSelectedItem().toString(), KetLapor.getText(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from skrining_nutrisi_anak where no_rawat=?", 1,
    ...
    private static final Logger LOG = Logger.getLogger(RMSkriningNutrisiAnak.class.getName());
