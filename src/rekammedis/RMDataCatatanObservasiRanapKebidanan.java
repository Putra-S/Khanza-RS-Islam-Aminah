    ...
    public RMDataCatatanObservasiRanapKebidanan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Umur", "JK", "Tgl.Lahir", "Tgl.Obser",
                    ...
                    "Kontraksi/HIS", "BJJ", "PPV", "VT", "NIP", "Nama Petugas"}) {
            @Override
...
//GEN-BEGIN:initComponents
  ...
  // End of variables declaration//GEN-END:variables
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("rr"), rs.getString("suhu"), rs.getString("spo2"), rs.getString("kontraksi"),
                        rs.getString("bjj"), rs.getString("ppv"), rs.getString("vt"), rs.getString("nip"),
                        rs.getString("nama")});
                }
            } catch (Exception e) {
    ...
    private void ganti() {
        if (Sequel.mengedittf("catatan_observasi_ranap_kebidanan", "tgl_perawatan=? and jam_rawat=? and no_rawat=?",
                ...
                new String[]{TNoRw.getText(), Valid.SetTgl(Tanggal.getSelectedItem() + ""),
                    ...
                    Kontraksi.getText(), BJJ.getText(), PPV.getText(), VT.getText(), NIP.getText(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from catatan_observasi_ranap_kebidanan where tgl_perawatan=? and jam_rawat=? and no_rawat=?", 3,
    ...
    private void simpan() {
        if (Sequel.menyimpantf("catatan_observasi_ranap_kebidanan", "?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 14,
                new String[]{TNoRw.getText(), Valid.SetTgl(Tanggal.getSelectedItem() + ""),
                    Jam.getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
                    GCS.getText(), TD.getText(), HR.getText(), RR.getText(), Suhu.getText(), SPO.getText(),
                    Kontraksi.getText(), BJJ.getText(), PPV.getText(), VT.getText(), NIP.getText()}) == true) {
    ...
    private static final Logger LOG = Logger.getLogger(RMDataCatatanObservasiRanapKebidanan.class.getName());
