...
public class RMHasilPemeriksaanUSGNeonatus extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (VentrikalSinistra.getText().trim().isEmpty()) {
            Valid.textKosong(VentrikalSinistra, "Ventrikel Sinistra");
        } else if (VentrikelDextra.getText().trim().isEmpty()) {
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry("rptCetakHasilPemeriksaanUSGNeonatus.jasper",
                    ...
                    + "inner join dokter on hasil_pemeriksaan_usg_neonatus.kd_dokter=dokter.kd_dokter where hasil_pemeriksaan_usg_neonatus.no_rawat='" + tbObat.
    ...
    private void btnAmbilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbObat.getSelectedRow() > -1) {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                Valid.panggilUrl(
                        "hasilpemeriksaanusgneonatus/login.php?act=login&usere=" + koneksiDB.
