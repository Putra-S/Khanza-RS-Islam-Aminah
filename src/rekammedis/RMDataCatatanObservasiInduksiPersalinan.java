...
public class RMDataCatatanObservasiInduksiPersalinan extends javax.swing.JDialog {
    ...
    public RMDataCatatanObservasiInduksiPersalinan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Umur", "JK", "Tgl.Lahir", "Tgl.Obser",
                    "Jam Obser", "Obat", "Cairan", "Dosis", "HIS", "DJJ", "Keterangan", "NIP",
                    "Nama Bidan/Petugas"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("jam_rawat"), rs.getString("obat"), rs.getString("cairan"),
    ...
    private void ganti() {
        if (Sequel.mengedittf("catatan_observasi_induksi_persalinan", "tgl_perawatan=? and jam_rawat=? and no_rawat=?",
                "no_rawat=?,tgl_perawatan=?,jam_rawat=?,obat=?,cairan=?," + "dosis=?,his=?,djj=?,keterangan=?,nip=?",
                13,
                new String[]{TNoRw.getText(), Valid.SetTgl(Tanggal.getSelectedItem() + ""),
                    ...
                    Obat.getText(), Cairan.getText(), Dosis.getText(), HIS.getText(), DJJ.getText(),
    ...
    private void simpan() {
        if (Sequel.menyimpantf("catatan_observasi_induksi_persalinan", "?,?,?,?,?,?,?,?,?,?", "Data", 10,
                new String[]{TNoRw.getText(), Valid.SetTgl(Tanggal.getSelectedItem() + ""),
                    Jam.getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
                    Obat.getText(), Cairan.getText(), Dosis.getText(), HIS.getText(), DJJ.getText(),
    ...
    private static final Logger LOG = Logger.getLogger(RMDataCatatanObservasiInduksiPersalinan.class.getName());
