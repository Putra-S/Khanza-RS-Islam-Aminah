...
public class RMMonitoringBromagePascaAnestesi extends javax.swing.JDialog {
    ...
    public RMMonitoringBromagePascaAnestesi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.Rawat", "No.R.M.", "Nama Pasien", "Tgl.Lahir", "JK",
            "Tanggal", "Skala", "Nilai", "Keluar", "Instruksi", "Kode Dokter", "Nama Dokter", "NIP", "Petugas"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMMonitoringBromagePascaAnestesi dialog = new RMMonitoringBromagePascaAnestesi(new javax.swing.JFrame(),
                    true);
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("keluar"), rs.getString("instruksi"), rs.getString("kd_dokter"),
    ...
    private void ganti() {
        if (Sequel.mengedittf("skor_bromage_pasca_anestesi", "tanggal=? and no_rawat=?",
                ...
                new String[]{TNoRw.getText(),
                    ...
                    SkalaKriteria.getSelectedItem().toString(), NilaiKriteria.getText(), Keluar.getText(),
                    Instruksi.getText(), KdDokter.getText(), NIP.getText(),
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from skor_bromage_pasca_anestesi where tanggal=? and no_rawat=?", 2,
    ...
    private void isTotalResiko() {
        try {
            if (Integer.parseInt(NilaiKriteria.getText()) <= 2) {
                ...
                TingkatKriteria
                        .setText("Pasien Tidak Dapat Dipindahkan Ke Ruangan Perawatan, Karena Kondisi Yang Lemah");
            }
        } catch (Exception e) {
            TingkatKriteria.setText("Pasien Tidak Dapat Dipindahkan Ke Ruangan Perawatan, Karena Kondisi Yang Lemah");
        }
    ...
    private void simpan() {
        if (Sequel.menyimpantf("skor_bromage_pasca_anestesi", "?,?,?,?,?,?,?,?", "Data", 8,
                new String[]{TNoRw.getText(),
                    Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Jam.getSelectedItem() + ":"
                    + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
                    SkalaKriteria.getSelectedItem().toString(), NilaiKriteria.getText(), Keluar.getText(),
                    Instruksi.getText(), KdDokter.getText(), NIP.getText()}) == true) {
            tabMode.addRow(new String[]{TNoRw.getText(), TNoRM.getText(), TPasien.getText(), TglLahir.getText(),
                JK.getText(),
                Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Jam.getSelectedItem() + ":"
                + Menit.getSelectedItem() + ":" + Detik.getSelectedItem(),
                SkalaKriteria.getSelectedItem().toString(), NilaiKriteria.getText(), Keluar.getText(),
                Instruksi.getText(), KdDokter.getText(), NmDokter.getText(), NIP.getText(),
                NamaPetugas.getText()});
            emptTeks();
            LCount.setText("" + tabMode.getRowCount());
        }
    ...
    private static final Logger LOG = Logger.getLogger(RMMonitoringBromagePascaAnestesi.class.getName());
