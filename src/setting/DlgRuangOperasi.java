...
public class DlgRuangOperasi extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from ruang_ok where kd_ruang_ok like ? " + "or nm_ruang_ok like ? order by kd_ruang_ok");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(DlgRuangOperasi.class.getName());
