 ...
 * @author dosen
 */
public class DlgRuangOperasi extends javax.swing.JDialog {
    ...
    public DlgRuangOperasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Kode Ruang",
            "Nama Ruang Operasi"}) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("ruang_ok", "?,?", "Kode Ruang", 2,
                    new String[]{TKd.getText(), TNm.getText()}) == true) {
                tampil();
                emptTeks();
            } else {
                TKd.requestFocus();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbBangsal.getSelectedRow() > -1) {
            Sequel.meghapus("ruang_ok", "kd_ruang_ok", tbBangsal.getValueAt(
                    tbBangsal.getSelectedRow(), 0).toString());
            tampil();
            emptTeks();
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbBangsal.getSelectedRow() > -1) {
                Sequel.mengedit("ruang_ok", "kd_ruang_ok=?",
                        "nm_ruang_ok=?,kd_ruang_ok=?", 3, new String[]{TNm.
                                    getText(), TKd.getText(), tbBangsal.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptBangsal.jasper", param,
                    "::[ Laporan Data Ruang Operasi ]::");
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRuangOperasi dialog = new DlgRuangOperasi(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from ruang_ok where kd_ruang_ok like ? "
    ...
    private void getData() {
        if (tbBangsal.getSelectedRow() != -1) {
            TKd.setText(tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 0).
                    toString());
            TNm.setText(tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 1).
                    toString());
        }
    }
    ...
    private static final Logger LOG = Logger.getLogger(DlgRuangOperasi.class.
            getName());
