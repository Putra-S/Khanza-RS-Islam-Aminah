...
public class DlgSetKeterlambatan extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Toleransi.getText().trim().isEmpty()) {
            Valid.textKosong(Toleransi, "Embalase");
        } else if (Terlambat1.getText().trim().isEmpty()) {
            Valid.textKosong(Terlambat1, "Tuslah");
        } else if (tabMode.getRowCount() == 0) {
            Sequel.menyimpan("set_keterlambatan",
                    "'" + Toleransi.getText() + "','" + Terlambat1.getText() + "','" + Terlambat2.
                    getText() + "'", "Set Keterlambatan");
            tampil();
            emptTeks();
        } else if (tabMode.getRowCount() > 0) {
            JOptionPane.showMessageDialog(null,
                    "Maaf, Hanya diijinkan satu Set Keterlambatan ...!!!!");
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Toleransi.requestFocus();
        } else if (Toleransi.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null,
...
private void ToleransiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ToleransiKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSetKeterlambatan dialog = new DlgSetKeterlambatan(
    ...
    private void tampil() {
        ...
        try {
            rs = ps.executeQuery();
            while (rs.next()) {
                tabMode.addRow(new Object[]{rs.getString(1) + " Menit", rs.
                    getString(2) + " Menit", rs.getString(3) + " Menit"});
            }
        } catch (SQLException e) {
    ...
    private void getData() {
        ...
        if (row != -1) {
            Toleransi.setText(tbAdmin.getValueAt(row, 0).toString().replaceAll(
                    " Menit", ""));
            Terlambat1.setText(tbAdmin.getValueAt(row, 1).toString().replaceAll(
                    " Menit", ""));
            Terlambat2.setText(tbAdmin.getValueAt(row, 2).toString().replaceAll(
                    " Menit", ""));
        }
    }
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgSetKeterlambatan.class.getName());
}
