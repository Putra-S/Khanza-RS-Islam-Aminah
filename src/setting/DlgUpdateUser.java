...
public class DlgUpdateUser extends javax.swing.JDialog {
    ...
    private boolean penyakit = false, obat_penyakit = false, dokter = false, jadwal_praktek = false, petugas = false,
            pasien = false, registrasi = false, tindakan_ralan = false, kamar_inap = false, tindakan_ranap = false,
            operasi = false, rujukan_keluar = false, rujukan_masuk = false, beri_obat = false, resep_pulang = false,
            pasien_meninggal = false, diet_pasien = false, kelahiran_bayi = false, periksa_lab = false,
            periksa_radiologi = false, kasir_ralan = false, deposit_pasien = false, piutang_pasien = false,
            peminjaman_berkas = false, barcode = false, presensi_harian = false, presensi_bulanan = false,
            pegawai_admin = false, pegawai_user = false, suplier = false, satuan_barang = false,
            konversi_satuan = false, jenis_barang = false, obat = false, stok_opname_obat = false,
            stok_obat_pasien = false, pengadaan_obat = false, pemesanan_obat = false, penjualan_obat = false,
            piutang_obat = false, retur_ke_suplier = false, retur_dari_pembeli = false, retur_obat_ranap = false,
            retur_piutang_pasien = false, keuntungan_penjualan = false, keuntungan_beri_obat = false,
            sirkulasi_obat = false, ipsrs_barang = false, ipsrs_pengadaan_barang = false, ipsrs_stok_keluar = false,
            ipsrs_rekap_pengadaan = false, ipsrs_rekap_stok_keluar = false, ipsrs_pengeluaran_harian = false,
            inventaris_jenis = false, inventaris_kategori = false, inventaris_merk = false, inventaris_ruang = false,
            inventaris_produsen = false, inventaris_koleksi = false, inventaris_inventaris = false,
            inventaris_sirkulasi = false, parkir_jenis = false, parkir_in = false, parkir_out = false,
            parkir_rekap_harian = false, parkir_rekap_bulanan = false, informasi_kamar = false,
            harian_tindakan_poli = false, obat_per_poli = false, obat_per_kamar = false, obat_per_dokter_ralan = false,
            obat_per_dokter_ranap = false, harian_dokter = false, bulanan_dokter = false, harian_paramedis = false,
            bulanan_paramedis = false, pembayaran_ralan = false, pembayaran_ranap = false,
            rekap_pembayaran_ralan = false, rekap_pembayaran_ranap = false, tagihan_masuk = false,
            tambahan_biaya = false, potongan_biaya = false, resep_obat = false, resume_pasien = false,
            penyakit_ralan = false, penyakit_ranap = false, kamar = false, tarif_ralan = false, tarif_ranap = false,
            tarif_lab = false, tarif_radiologi = false, tarif_operasi = false, akun_rekening = false,
            rekening_tahun = false, posting_jurnal = false, buku_besar = false, cashflow = false, keuangan = false,
            pengeluaran = false, setup_pjlab = false, setup_otolokasi = false, setup_jam_kamin = false,
            setup_embalase = false, tracer_login = false, display = false, set_harga_obat = false,
            set_penggunaan_tarif = false, set_oto_ralan = false, biaya_harian = false, biaya_masuk_sekali = false,
            set_no_rm = false, billing_ralan = false, billing_ranap = false, jm_ranap_dokter = false, igd = false,
            barcoderalan = false, barcoderanap = false, set_harga_obat_ralan = false, set_harga_obat_ranap = false,
            penyakit_pd3i = false, surveilans_pd3i = false, surveilans_ralan = false, diagnosa_pasien = false,
            surveilans_ranap = false, pny_takmenular_ranap = false, pny_takmenular_ralan = false,
            kunjungan_ralan = false, rl32 = false, rl33 = false, rl37 = false, rl38 = false,
            harian_tindakan_dokter = false, sms = false, sidikjari = false, jam_masuk = false, jadwal_pegawai = false,
            parkir_barcode = false, set_nota = false, dpjp_ranap = false, mutasi_barang = false, rl34 = false,
            rl36 = false, fee_visit_dokter = false, fee_bacaan_ekg = false, fee_rujukan_rontgen = false,
            fee_rujukan_ranap = false, fee_ralan = false, akun_bayar = false, bayar_pemesanan_obat = false,
            obat_per_dokter_peresep = false, ipsrs_jenis_barang = false, pemasukan_lain = false,
            pengaturan_rekening = false, closing_kasir = false, keterlambatan_presensi = false, set_harga_kamar = false,
            rekap_per_shift = false, bpjs_cek_nik = false, bpjs_cek_kartu = false, bpjs_cek_riwayat = false,
            obat_per_cara_bayar = false, kunjungan_ranap = false, bayar_piutang = false, payment_point = false,
            bpjs_cek_nomor_rujukan = false, icd9 = false, darurat_stok = false, retensi_rm = false,
            temporary_presensi = false, jurnal_harian = false, sirkulasi_obat2 = false, edit_registrasi = false,
            bpjs_referensi_diagnosa = false, bpjs_referensi_poli = false, industrifarmasi = false, harian_js = false,
            bulanan_js = false, harian_paket_bhp = false, bulanan_paket_bhp = false, piutang_pasien2 = false,
            bpjs_referensi_faskes = false, bpjs_sep = false, pengambilan_utd = false, tarif_utd = false,
            pengambilan_utd2 = false, utd_medis_rusak = false, pengambilan_penunjang_utd = false,
            pengambilan_penunjang_utd2 = false, utd_penunjang_rusak = false, suplier_penunjang = false,
            utd_donor = false, bpjs_monitoring_klaim = false, utd_cekal_darah = false, utd_komponen_darah = false,
            utd_stok_darah = false, utd_pemisahan_darah = false, harian_kamar = false, rincian_piutang_pasien = false,
            keuntungan_beri_obat_nonpiutang = false, reklasifikasi_ralan = false, reklasifikasi_ranap = false,
            utd_penyerahan_darah = false, hutang_obat = false, riwayat_obat_alkes_bhp = false,
            sensus_harian_poli = false, rl4a = false, aplicare_referensi_kamar = false,
            aplicare_ketersediaan_kamar = false, inacbg_klaim_baru_otomatis = false, inacbg_klaim_baru_manual = false,
            inacbg_coder_nik = false, mutasi_berkas = false, akun_piutang = false, harian_kso = false,
            bulanan_kso = false, harian_menejemen = false, bulanan_menejemen = false, inhealth_cek_eligibilitas = false,
            inhealth_referensi_jenpel_ruang_rawat = false, inhealth_referensi_poli = false,
            inhealth_referensi_faskes = false, inhealth_sjp = false, piutang_ralan = false, piutang_ranap = false,
            detail_piutang_penjab = false, lama_pelayanan_ralan = false, catatan_pasien = false, rl4b = false,
            rl4asebab = false, rl4bsebab = false, data_HAIs = false, harian_HAIs = false, bulanan_HAIs = false,
            hitung_bor = false, perusahaan_pasien = false, resep_dokter = false, lama_pelayanan_apotek = false,
            hitung_alos = false, detail_tindakan = false, rujukan_poli_internal = false, rekap_poli_anak = false,
            grafik_kunjungan_poli = false, grafik_kunjungan_perdokter = false, grafik_kunjungan_perpekerjaan = false,
            grafik_kunjungan_perpendidikan = false, grafik_kunjungan_pertahun = false, berkas_digital_perawatan = false,
            penyakit_menular_ranap = false, penyakit_menular_ralan = false, grafik_kunjungan_perbulan = false,
            grafik_kunjungan_pertanggal = false, grafik_kunjungan_demografi = false,
            grafik_kunjungan_statusdaftartahun = false, grafik_kunjungan_statusdaftartahun2 = false,
            grafik_kunjungan_statusdaftarbulan = false, grafik_kunjungan_statusdaftarbulan2 = false,
            grafik_kunjungan_statusdaftartanggal = false, grafik_kunjungan_statusdaftartanggal2 = false,
            grafik_kunjungan_statusbataltahun = false, grafik_kunjungan_statusbatalbulan = false,
            pcare_cek_penyakit = false, grafik_kunjungan_statusbataltanggal = false, kategori_barang = false,
            golongan_barang = false, pemberian_obat_pertanggal = false, penjualan_obat_pertanggal = false,
            pcare_cek_kesadaran = false, pembatalan_periksa_dokter = false, pembayaran_per_unit = false,
            rekap_pembayaran_per_unit = false, grafik_kunjungan_percarabayar = false,
            ipsrs_pengadaan_pertanggal = false, ipsrs_stokkeluar_pertanggal = false,
            grafik_kunjungan_ranaptahun = false, pcare_cek_rujukan = false, grafik_lab_ralantahun = false,
            grafik_rad_ralantahun = false, cek_entry_ralan = false, inacbg_klaim_baru_manual2 = false,
            permintaan_medis = false, rekap_permintaan_medis = false, surat_pemesanan_medis = false,
            permintaan_non_medis = false, rekap_permintaan_non_medis = false, surat_pemesanan_non_medis = false,
            grafik_per_perujuk = false, bpjs_cek_prosedur = false, bpjs_cek_kelas_rawat = false,
            bpjs_cek_dokter = false, bpjs_cek_spesialistik = false, bpjs_cek_ruangrawat = false,
            bpjs_cek_carakeluar = false, bpjs_cek_pasca_pulang = false, detail_tindakan_okvk = false,
            billing_parsial = false, bpjs_cek_nomor_rujukan_rs = false, bpjs_cek_rujukan_kartu_pcare = false,
            bpjs_cek_rujukan_kartu_rs = false, akses_depo_obat = false, bpjs_rujukan_keluar = false,
            grafik_lab_ralanbulan = false, pengeluaran_stok_apotek = false, grafik_rad_ralanbulan = false,
            detailjmdokter2 = false, pengaduan_pasien = false, grafik_lab_ralanhari = false,
            grafik_rad_ralanhari = false, sensus_harian_ralan = false, metode_racik = false,
            pembayaran_akun_bayar = false, pengguna_obat_resep = false, rekap_pemesanan = false,
            master_berkas_pegawai = false, berkas_kepegawaian = false, riwayat_jabatan = false,
            riwayat_pendidikan = false, riwayat_naik_gaji = false, kegiatan_ilmiah = false, riwayat_penghargaan = false,
            riwayat_penelitian = false, penerimaan_non_medis = false, bayar_pesan_non_medis = false,
            hutang_barang_non_medis = false, rekap_pemesanan_non_medis = false, insiden_keselamatan = false,
            insiden_keselamatan_pasien = false, grafik_ikp_pertahun = false, grafik_ikp_perbulan = false,
            grafik_ikp_pertanggal = false, riwayat_data_batch = false, grafik_ikp_jenis = false,
            grafik_ikp_dampak = false, piutang_akun_piutang = false, grafik_kunjungan_per_agama = false,
            grafik_kunjungan_per_umur = false, suku_bangsa = false, bahasa_pasien = false, golongan_tni = false,
            satuan_tni = false, jabatan_tni = false, pangkat_tni = false, golongan_polri = false, satuan_polri = false,
            jabatan_polri = false, pangkat_polri = false, cacat_fisik = false, grafik_kunjungan_suku = false,
            grafik_kunjungan_bahasa = false, booking_operasi = false, mapping_poli_bpjs = false,
            grafik_kunjungan_per_cacat = false, barang_cssd = false, skdp_bpjs = false, booking_registrasi = false,
            bpjs_cek_propinsi = false, bpjs_cek_kabupaten = false, bpjs_cek_kecamatan = false,
            bpjs_cek_dokterdpjp = false, bpjs_cek_riwayat_rujukanrs = false, bpjs_cek_tanggal_rujukan = false,
            permintaan_lab = false, permintaan_radiologi = false, surat_indeks = false, surat_map = false,
            surat_almari = false, surat_rak = false, surat_ruang = false, surat_klasifikasi = false,
            surat_status = false, surat_sifat = false, surat_balas = false, surat_masuk = false,
            pcare_cek_dokter = false, pcare_cek_poli = false, pcare_cek_provider = false,
            pcare_cek_statuspulang = false, pcare_cek_spesialis = false, pcare_cek_subspesialis = false,
            pcare_cek_sarana = false, pcare_cek_khusus = false, pcare_cek_obat = false, pcare_cek_tindakan = false,
            pcare_cek_faskessubspesialis = false, pcare_cek_faskesalihrawat = false, pcare_cek_faskesthalasemia = false,
            pcare_mapping_obat = false, pcare_mapping_tindakan = false, pcare_club_prolanis = false,
            pcare_mapping_poli = false, pcare_kegiatan_kelompok = false, pcare_mapping_tindakan_ranap = false,
            pcare_peserta_kegiatan_kelompok = false, sirkulasi_obat3 = false, bridging_pcare_daftar = false,
            pcare_mapping_dokter = false, ranap_per_ruang = false, penyakit_ranap_cara_bayar = false,
            anggota_militer_dirawat = false, set_input_parsial = false, lama_pelayanan_radiologi = false,
            lama_pelayanan_lab = false, bpjs_cek_sep = false, catatan_perawatan = false, surat_keluar = false,
            kegiatan_farmasi = false, stok_opname_logistik = false, sirkulasi_non_medis = false,
            rekap_lab_pertahun = false, perujuk_lab_pertahun = false, rekap_radiologi_pertahun = false,
            perujuk_radiologi_pertahun = false, jumlah_porsi_diet = false, jumlah_macam_diet = false,
            payment_point2 = false, pembayaran_akun_bayar2 = false, hapus_nota_salah = false, pengkajian_askep = false,
            hais_perbangsal = false, ppn_obat = false, saldo_akun_perbulan = false, display_apotek = false,
            sisrute_referensi_faskes = false, sisrute_referensi_alasanrujuk = false, sisrute_referensi_diagnosa = false,
            sisrute_rujukan_masuk = false, sisrute_rujukan_keluar = false, bpjs_cek_skdp = false, data_batch = false,
            kunjungan_permintaan_lab = false, kunjungan_permintaan_lab2 = false, kunjungan_permintaan_radiologi = false,
            kunjungan_permintaan_radiologi2 = false, pcare_pemberian_obat = false, pcare_pemberian_tindakan = false,
            pembayaran_akun_bayar3 = false, password_asuransi = false, kemenkes_sitt = false,
            siranap_ketersediaan_kamar = false, grafik_tb_periodelaporan = false, grafik_tb_rujukan = false,
            grafik_tb_riwayat = false, grafik_tb_tipediagnosis = false, grafik_tb_statushiv = false,
            grafik_tb_skoringanak = false, grafik_tb_konfirmasiskoring5 = false, grafik_tb_konfirmasiskoring6 = false,
            grafik_tb_sumberobat = false, grafik_tb_hasilakhirpengobatan = false, grafik_tb_hasilteshiv = false,
            kadaluarsa_batch = false, sisa_stok = false, obat_per_resep = false, pemakaian_air_pdam = false,
            limbah_b3_medis = false, grafik_air_pdam_pertanggal = false, grafik_air_pdam_perbulan = false,
            grafik_limbahb3_pertanggal = false, grafik_limbahb3_perbulan = false, limbah_domestik = false,
            grafik_limbahdomestik_pertanggal = false, grafik_limbahdomestik_perbulan = false, mutu_air_limbah = false,
            pest_control = false, ruang_perpustakaan = false, kategori_perpustakaan = false, jenis_perpustakaan = false,
            pengarang_perpustakaan = false, penerbit_perpustakaan = false, koleksi_perpustakaan = false,
            inventaris_perpustakaan = false, set_peminjaman_perpustakaan = false, denda_perpustakaan = false,
            anggota_perpustakaan = false, peminjaman_perpustakaan = false, bayar_denda_perpustakaan = false,
            ebook_perpustakaan = false, jenis_cidera_k3rs = false, penyebab_k3rs = false, jenis_luka_k3rs = false,
            lokasi_kejadian_k3rs = false, dampak_cidera_k3rs = false, jenis_pekerjaan_k3rs = false,
            bagian_tubuh_k3rs = false, peristiwa_k3rs = false, grafik_k3_pertahun = false, grafik_k3_perbulan = false,
            grafik_k3_pertanggal = false, grafik_k3_perjeniscidera = false, grafik_k3_perpenyebab = false,
            grafik_k3_perjenisluka = false, grafik_k3_lokasikejadian = false, grafik_k3_dampakcidera = false,
            grafik_k3_perjenispekerjaan = false, grafik_k3_perbagiantubuh = false, jenis_cidera_k3rstahun = false,
            penyebab_k3rstahun = false, jenis_luka_k3rstahun = false, lokasi_kejadian_k3rstahun = false,
            dampak_cidera_k3rstahun = false, jenis_pekerjaan_k3rstahun = false, bagian_tubuh_k3rstahun = false,
            sekrining_rawat_jalan = false, bpjs_histori_pelayanan = false, rekap_mutasi_berkas = false,
            skrining_ralan_pernapasan_pertahun = false, pengajuan_barang_medis = false,
            pengajuan_barang_nonmedis = false, grafik_kunjungan_ranapbulan = false,
            grafik_kunjungan_ranaptanggal = false, grafik_kunjungan_ranap_peruang = false,
            kunjungan_bangsal_pertahun = false, grafik_jenjang_jabatanpegawai = false, grafik_bidangpegawai = false,
            grafik_departemenpegawai = false, grafik_pendidikanpegawai = false, grafik_sttswppegawai = false,
            grafik_sttskerjapegawai = false, grafik_sttspulangranap = false, kip_pasien_ranap = false,
            kip_pasien_ralan = false, bpjs_mapping_dokterdpjp = false, data_triase_igd = false,
            master_triase_skala1 = false, master_triase_skala2 = false, master_triase_skala3 = false,
            master_triase_skala4 = false, master_triase_skala5 = false, master_triase_pemeriksaan = false,
            master_triase_macamkasus = false, rekap_permintaan_diet = false, daftar_pasien_ranap = false,
            daftar_pasien_ranaptni = false, pengajuan_asetinventaris = false, item_apotek_jenis = false,
            item_apotek_kategori = false, item_apotek_golongan = false, item_apotek_industrifarmasi = false,
            sepuluh_obat_terbanyak_poli = false, grafik_pengajuan_aset_urgensi = false,
            grafik_pengajuan_aset_status = false, grafik_pengajuan_aset_departemen = false,
            rekap_pengajuan_aset_departemen = false, grafik_kelompok_jabatanpegawai = false,
            grafik_resiko_kerjapegawai = false, grafik_emergency_indexpegawai = false, grafik_inventaris_ruang = false,
            harian_HAIs2 = false, grafik_inventaris_jenis = false, data_resume_pasien = false,
            perkiraan_biaya_ranap = false, rekap_obat_poli = false, rekap_obat_pasien = false,
            permintaan_perbaikan_inventaris = false, grafik_HAIs_pasienbangsal = false, grafik_HAIs_pasienbulan = false,
            grafik_HAIs_laju_vap = false, grafik_HAIs_laju_iad = false, grafik_HAIs_laju_pleb = false,
            grafik_HAIs_laju_isk = false, grafik_HAIs_laju_ilo = false, grafik_HAIs_laju_hap = false,
            inhealth_mapping_poli = false, inhealth_mapping_dokter = false, inhealth_mapping_tindakan_ralan = false,
            inhealth_mapping_tindakan_ranap = false, inhealth_mapping_tindakan_radiologi = false,
            inhealth_mapping_tindakan_laborat = false, inhealth_mapping_tindakan_operasi = false,
            hibah_obat_bhp = false, asal_hibah = false, asuhan_gizi = false, inhealth_kirim_tagihan = false,
            sirkulasi_obat4 = false, sirkulasi_obat5 = false, sirkulasi_non_medis2 = false,
            monitoring_asuhan_gizi = false, penerimaan_obat_perbulan = false, rekap_kunjungan = false,
            surat_sakit = false, penilaian_awal_keperawatan_ralan = false, permintaan_diet = false,
            master_masalah_keperawatan = false, pengajuan_cuti = false, kedatangan_pasien = false, utd_pendonor = false,
            toko_suplier = false, toko_jenis = false, toko_set_harga = false, toko_barang = false,
            penagihan_piutang_pasien = false, akun_penagihan_piutang = false, stok_opname_toko = false,
            toko_riwayat_barang = false, toko_surat_pemesanan = false, toko_pengajuan_barang = false,
            toko_penerimaan_barang = false, toko_pengadaan_barang = false, toko_hutang = false,
            toko_bayar_pemesanan = false, toko_member = false, toko_penjualan = false,
            registrasi_poli_per_tanggal = false, toko_piutang = false, toko_retur_beli = false, ipsrs_returbeli = false,
            ipsrs_riwayat_barang = false, pasien_corona = false, toko_pendapatan_harian = false,
            diagnosa_pasien_corona = false, perawatan_pasien_corona = false, penilaian_awal_keperawatan_gigi = false,
            master_masalah_keperawatan_gigi = false, toko_bayar_piutang = false, toko_piutang_harian = false,
            toko_penjualan_harian = false, deteksi_corona = false, penilaian_awal_keperawatan_kebidanan = false,
            pengumuman_epasien = false, surat_hamil = false, set_tarif_online = false, booking_periksa = false,
            toko_sirkulasi = false, toko_retur_jual = false, toko_retur_piutang = false, toko_sirkulasi2 = false,
            toko_keuntungan_barang = false, zis_pengeluaran_penerima_dankes = false,
            zis_penghasilan_penerima_dankes = false, zis_ukuran_rumah_penerima_dankes = false,
            zis_dinding_rumah_penerima_dankes = false, zis_lantai_rumah_penerima_dankes = false,
            zis_atap_rumah_penerima_dankes = false, zis_kepemilikan_rumah_penerima_dankes = false,
            zis_kamar_mandi_penerima_dankes = false, zis_dapur_rumah_penerima_dankes = false,
            zis_kursi_rumah_penerima_dankes = false, zis_kategori_phbs_penerima_dankes = false,
            zis_elektronik_penerima_dankes = false, zis_ternak_penerima_dankes = false,
            zis_jenis_simpanan_penerima_dankes = false, penilaian_awal_keperawatan_anak = false,
            zis_kategori_asnaf_penerima_dankes = false, master_masalah_keperawatan_anak = false,
            master_imunisasi = false, zis_patologis_penerima_dankes = false, pcare_cek_kartu = false,
            surat_bebas_narkoba = false, surat_keterangan_covid = false, pemakaian_air_tanah = false,
            grafik_air_tanah_pertanggal = false, grafik_air_tanah_perbulan = false, lama_pelayanan_poli = false,
            hemodialisa = false, laporan_tahunan_irj = false, grafik_harian_hemodialisa = false,
            grafik_bulanan_hemodialisa = false, grafik_tahunan_hemodialisa = false, grafik_bulanan_meninggal = false,
            perbaikan_inventaris = false, surat_cuti_hamil = false, permintaan_stok_obat_pasien = false,
            pemeliharaan_inventaris = false, klasifikasi_pasien_ranap = false, bulanan_klasifikasi_pasien_ranap = false,
            harian_klasifikasi_pasien_ranap = false, klasifikasi_pasien_perbangsal = false, soap_perawatan = false,
            klaim_rawat_jalan = false, skrining_gizi = false, lama_penyiapan_rm = false, dosis_radiologi = false,
            demografi_umur_kunjungan = false, jam_diet_pasien = false, rvu_bpjs = false,
            verifikasi_penerimaan_farmasi = false, verifikasi_penerimaan_logistik = false, pemeriksaan_lab_pa = false,
            ringkasan_pengajuan_obat = false, ringkasan_pemesanan_obat = false, ringkasan_pengadaan_obat = false,
            ringkasan_penerimaan_obat = false, ringkasan_hibah_obat = false, ringkasan_penjualan_obat = false,
            ringkasan_beri_obat = false, ringkasan_piutang_obat = false, ringkasan_stok_keluar_obat = false,
            ringkasan_retur_suplier_obat = false, ringkasan_retur_pembeli_obat = false,
            penilaian_awal_keperawatan_ranapkebidanan = false, ringkasan_pengajuan_nonmedis = false,
            ringkasan_pemesanan_nonmedis = false, ringkasan_pengadaan_nonmedis = false,
            ringkasan_penerimaan_nonmedis = false, ringkasan_stokkeluar_nonmedis = false,
            ringkasan_returbeli_nonmedis = false, omset_penerimaan = false, validasi_penagihan_piutang = false,
            permintaan_ranap = false, bpjs_diagnosa_prb = false, bpjs_obat_prb = false, bpjs_surat_kontrol = false,
            penggunaan_bhp_ok = false, surat_keterangan_rawat_inap = false, surat_keterangan_sehat = false,
            pendapatan_per_carabayar = false, akun_host_to_host_bank_jateng = false, pembayaran_bank_jateng = false,
            bpjs_surat_pri = false, ringkasan_tindakan = false, lama_pelayanan_pasien = false,
            surat_sakit_pihak_2 = false, tagihan_hutang_obat = false, referensi_mobilejkn_bpjs = false,
            batal_pendaftaran_mobilejkn_bpjs = false, lama_operasi = false, grafik_inventaris_kategori = false,
            grafik_inventaris_merk = false, grafik_inventaris_produsen = false, pengembalian_deposit_pasien = false,
            validasi_tagihan_hutang_obat = false, piutang_obat_belum_lunas = false, integrasi_briapi = false,
            pengadaan_aset_inventaris = false, akun_aset_inventaris = false, suplier_inventaris = false,
            penerimaan_aset_inventaris = false, bayar_pemesanan_iventaris = false, hutang_aset_inventaris = false,
            hibah_aset_inventaris = false, titip_faktur_non_medis = false, validasi_tagihan_non_medis = false,
            titip_faktur_aset = false, validasi_tagihan_aset = false, hibah_non_medis = false,
            pcare_alasan_tacc = false, resep_luar = false, surat_bebas_tbc = false, surat_buta_warna = false,
            surat_bebas_tato = false, surat_kewaspadaan_kesehatan = false, grafik_porsidiet_pertanggal = false,
            grafik_porsidiet_perbulan = false, grafik_porsidiet_pertahun = false, grafik_porsidiet_perbangsal = false,
            penilaian_awal_medis_ralan = false, master_masalah_keperawatan_mata = false,
            penilaian_awal_keperawatan_mata = false, penilaian_awal_medis_ranap = false,
            penilaian_awal_medis_ranap_kebidanan = false, penilaian_awal_medis_ralan_kebidanan = false,
            penilaian_awal_medis_igd = false, penilaian_awal_medis_ralan_anak = false, bpjs_referensi_poli_hfis = false,
            bpjs_referensi_dokter_hfis = false, bpjs_referensi_jadwal_hfis = false, penilaian_fisioterapi = false,
            bpjs_program_prb = false, bpjs_suplesi_jasaraharja = false, bpjs_data_induk_kecelakaan = false,
            bpjs_sep_internal = false, bpjs_klaim_jasa_raharja = false, bpjs_daftar_finger_print = false,
            bpjs_rujukan_khusus = false, pemeliharaan_gedung = false, grafik_perbaikan_inventaris_pertanggal = false,
            grafik_perbaikan_inventaris_perbulan = false, grafik_perbaikan_inventaris_pertahun = false,
            grafik_perbaikan_inventaris_perpelaksana_status = false, penilaian_mcu = false, peminjam_piutang = false,
            piutang_lainlain = false, cara_bayar = false, audit_kepatuhan_apd = false, bpjs_task_id = false,
            bayar_piutang_lain = false, pembayaran_akun_bayar4 = false, stok_akhir_farmasi_pertanggal = false,
            riwayat_kamar_pasien = false, uji_fungsi_kfr = false, hapus_berkas_digital_perawatan = false,
            kategori_pengeluaran_harian = false, kategori_pemasukan_lain = false, pembayaran_akun_bayar5 = false,
            ruang_ok = false, telaah_resep = false, jasa_tindakan_pasien = false, permintaan_resep_pulang = false,
            rekap_jm_dokter = false, status_data_rm = false, ubah_petugas_lab_pk = false, ubah_petugas_lab_pa = false,
            ubah_petugas_radiologi = false, gabung_norawat = false, gabung_rm = false,
            ringkasan_biaya_obat_pasien_pertanggal = false, master_masalah_keperawatan_igd = false,
            penilaian_awal_keperawatan_igd = false, bpjs_referensi_dpho_apotek = false,
            bpjs_referensi_poli_apotek = false, bayar_jm_dokter = false, bpjs_referensi_faskes_apotek = false,
            bpjs_referensi_spesialistik_apotek = false, pembayaran_briva = false,
            penilaian_awal_keperawatan_ranap = false, nilai_penerimaan_vendor_farmasi_perbulan = false,
            akun_bayar_hutang = false, master_rencana_keperawatan = false, laporan_tahunan_igd = false,
            obat_bhp_tidakbergerak = false, ringkasan_hutang_vendor_farmasi = false,
            nilai_penerimaan_vendor_nonmedis_perbulan = false, ringkasan_hutang_vendor_nonmedis = false,
            master_rencana_keperawatan_anak = false, anggota_polri_dirawat = false, daftar_pasien_ranap_polri = false,
            soap_ralan_polri = false, soap_ranap_polri = false, laporan_penyakit_polri = false,
            jumlah_pengunjung_ralan_polri = false, catatan_observasi_igd = false, catatan_observasi_ranap = false,
            catatan_observasi_ranap_kebidanan = false, catatan_observasi_ranap_postpartum = false,
            penilaian_awal_medis_ralan_tht = false, penilaian_psikologi = false, audit_cuci_tangan_medis = false,
            audit_pembuangan_limbah = false, ruang_audit_kepatuhan = false, audit_pembuangan_benda_tajam = false,
            audit_penanganan_darah = false, audit_pengelolaan_linen_kotor = false, audit_penempatan_pasien = false,
            audit_kamar_jenazah = false, audit_bundle_iadp = false, audit_bundle_ido = false,
            audit_fasilitas_kebersihan_tangan = false, audit_fasilitas_apd = false,
            audit_pembuangan_limbah_cair_infeksius = false, audit_sterilisasi_alat = false,
            penilaian_awal_medis_ralan_psikiatri = false, persetujuan_penolakan_tindakan = false,
            audit_bundle_isk = false, audit_bundle_plabsi = false, audit_bundle_vap = false,
            akun_host_to_host_bank_papua = false, pembayaran_bank_papua = false,
            penilaian_awal_medis_ralan_penyakit_dalam = false, penilaian_awal_medis_ralan_mata = false,
            penilaian_awal_medis_ralan_neurologi = false, sirkulasi_obat6 = false,
            penilaian_awal_medis_ralan_orthopedi = false, penilaian_awal_medis_ralan_bedah = false,
            integrasi_khanza_health_services = false, soap_ralan_tni = false, soap_ranap_tni = false,
            jumlah_pengunjung_ralan_tni = false, laporan_penyakit_tni = false, catatan_keperawatan_ranap = false,
            master_rencana_keperawatan_gigi = false, master_rencana_keperawatan_mata = false,
            master_rencana_keperawatan_igd = false, master_masalah_keperawatan_psikiatri = false,
            master_rencana_keperawatan_psikiatri = false, penilaian_awal_keperawatan_psikiatri = false,
            pemantauan_pews_anak = false, surat_pulang_atas_permintaan_sendiri = false,
            template_hasil_radiologi = false, laporan_bulanan_irj = false, template_pemeriksaan = false,
            pemeriksaan_lab_mb = false, ubah_petugas_lab_mb = false, penilaian_pre_operasi = false,
            penilaian_pre_anestesi = false, perencanaan_pemulangan = false,
            penilaian_lanjutan_resiko_jatuh_dewasa = false, penilaian_lanjutan_resiko_jatuh_anak = false,
            penilaian_awal_medis_ralan_geriatri = false, penilaian_tambahan_pasien_geriatri = false,
            skrining_nutrisi_dewasa = false, skrining_nutrisi_lansia = false, hasil_pemeriksaan_usg = false,
            skrining_nutrisi_anak = false, akun_host_to_host_bank_jabar = false, pembayaran_bank_jabar = false,
            surat_pernyataan_pasien_umum = false, konseling_farmasi = false, pelayanan_informasi_obat = false,
            jawaban_pio_apoteker = false, surat_persetujuan_umum = false, transfer_pasien_antar_ruang = false,
            satu_sehat_referensi_dokter = false, satu_sehat_referensi_pasien = false,
            satu_sehat_mapping_departemen = false, satu_sehat_mapping_lokasi = false,
            satu_sehat_kirim_encounter = false, catatan_cek_gds = false, satu_sehat_kirim_condition = false,
            checklist_pre_operasi = false, satu_sehat_kirim_observationttv = false, signin_sebelum_anestesi = false,
            satu_sehat_kirim_procedure = false, operasi_per_bulan = false, timeout_sebelum_insisi = false,
            signout_sebelum_menutup_luka = false, dapur_barang = false, dapur_opname = false,
            satu_sehat_mapping_vaksin = false, dapur_suplier = false, satu_sehat_kirim_Immunization = false,
            checklist_post_operasi = false, dapur_pembelian = false, dapur_stok_keluar = false,
            dapur_riwayat_barang = false, permintaan_dapur = false, rekonsiliasi_obat = false,
            biaya_pengadaan_dapur = false, rekap_pengadaan_dapur = false, kesling_limbah_b3medis_cair = false,
            grafik_limbahb3cair_pertanggal = false, grafik_limbahb3cair_perbulan = false,
            rekap_biaya_registrasi = false, konfirmasi_rekonsiliasi_obat = false,
            satu_sehat_kirim_clinicalimpression = false, penilaian_pasien_terminal = false,
            surat_persetujuan_rawat_inap = false, monitoring_reaksi_tranfusi = false,
            penilaian_korban_kekerasan = false, penilaian_lanjutan_resiko_jatuh_lansia = false,
            penilaian_pasien_penyakit_menular = false, mpp_skrining = false, edukasi_pasien_keluarga_rj = false,
            pemantauan_pews_dewasa = false, penilaian_tambahan_bunuh_diri = false, bpjs_antrean_pertanggal = false,
            penilaian_tambahan_perilaku_kekerasan = false, penilaian_tambahan_beresiko_melarikan_diri = false,
            persetujuan_penundaan_pelayanan = false, sisa_diet_pasien = false,
            penilaian_awal_medis_ralan_bedah_mulut = false, penilaian_pasien_keracunan = false,
            pemantauan_meows_obstetri = false, catatan_adime_gizi = false, pengajuan_biaya = false,
            penilaian_awal_keperawatan_ralan_geriatri = false, master_masalah_keperawatan_geriatri = false,
            master_rencana_keperawatan_geriatri = false, checklist_kriteria_masuk_hcu = false,
            checklist_kriteria_keluar_hcu = false, penilaian_risiko_dekubitus = false,
            master_menolak_anjuran_medis = false, penolakan_anjuran_medis = false,
            laporan_tahunan_penolakan_anjuran_medis = false, template_laporan_operasi = false,
            hasil_tindakan_eswl = false, checklist_kriteria_masuk_icu = false, checklist_kriteria_keluar_icu = false,
            akses_dokter_lain_rawat_jalan = false, follow_up_dbd = false, penilaian_risiko_jatuh_neonatus = false,
            persetujuan_pengajuan_biaya = false, pemeriksaan_fisik_ralan_per_penyakit = false,
            penilaian_lanjutan_resiko_jatuh_geriatri = false, pemantauan_ews_neonatus = false,
            ...
            akun_host_to_host_bank_mandiri = false, penilaian_medis_hemodialisa = false,
            penilaian_level_kecemasan_ranap_anak = false, penilaian_lanjutan_resiko_jatuh_psikiatri = false,
            penilaian_lanjutan_skrining_fungsional = false, penilaian_medis_ralan_rehab_medik = false,
            laporan_anestesi = false, template_persetujuan_penolakan_tindakan = false,
            penilaian_medis_ralan_gawat_darurat_psikiatri = false, bpjs_referensi_setting_apotek = false,
            bpjs_referensi_obat_apotek = false, bpjs_mapping_obat_apotek = false, pembayaran_bank_mandiri = false,
            penilaian_ulang_nyeri = false, penilaian_terapi_wicara = false, bpjs_obat_23hari_apotek = false,
            pengkajian_restrain = false, bpjs_kunjungan_sep_apotek = false, bpjs_monitoring_klaim_apotek = false,
            bpjs_daftar_pelayanan_obat_apotek = false, penilaian_awal_medis_ralan_paru = false,
            catatan_keperawatan_ralan = false, catatan_persalinan = false, skor_aldrette_pasca_anestesi = false,
            skor_steward_pasca_anestesi = false, skor_bromage_pasca_anestesi = false, penilaian_pre_induksi = false,
            hasil_usg_urologi = false, hasil_usg_gynecologi = false, hasil_pemeriksaan_ekg = false,
            hapus_edit_sep_bpjs = false, satu_sehat_kirim_diet = false, satu_sehat_mapping_obat = false,
            dapur_ringkasan_pembelian = false, satu_sehat_kirim_medication = false,
            satu_sehat_kirim_medicationrequest = false, penatalaksanaan_terapi_okupasi = false,
            satu_sehat_kirim_medicationdispense = false, hasil_usg_neonatus = false,
            hasil_endoskopi_faring_laring = false, satu_sehat_mapping_radiologi = false,
            satu_sehat_kirim_servicerequest_radiologi = false, hasil_endoskopi_hidung = false,
            satu_sehat_kirim_specimen_radiologi = false, master_masalah_keperawatan_neonatus = false,
            master_rencana_keperawatan_neonatus = false, penilaian_awal_keperawatan_ranap_neonatus = false,
            satu_sehat_kirim_observation_radiologi = false, satu_sehat_kirim_diagnosticreport_radiologi = false,
            hasil_endoskopi_telinga = false, satu_sehat_mapping_lab = false,
            satu_sehat_kirim_servicerequest_lab = false, satu_sehat_kirim_servicerequest_labmb = false,
            satu_sehat_kirim_specimen_lab = false, satu_sehat_kirim_specimen_labmb = false,
            satu_sehat_kirim_observation_lab = false, satu_sehat_kirim_observation_labmb = false,
            satu_sehat_kirim_diagnosticreport_lab = false, satu_sehat_kirim_diagnosticreport_labmb = false,
            kepatuhan_kelengkapan_keselamatan_bedah = false, nilai_piutang_perjenis_bayar_per_bulan = false,
            ringkasan_piutang_jenis_bayar = false, penilaian_pasien_imunitas_rendah = false, balance_cairan = false,
            catatan_observasi_chbp = false, catatan_observasi_induksi_persalinan = false,
            skp_kategori_penilaian = false, skp_kriteria_penilaian = false, skp_penilaian = false,
            referensi_poli_mobilejknfktp = false, referensi_dokter_mobilejknfktp = false,
            skp_rekapitulasi_penilaian = false, pembayaran_pihak_ke3_bankmandiri = false,
            metode_pembayaran_bankmandiri = false, bank_tujuan_transfer_bankmandiri = false,
            kodetransaksi_tujuan_transfer_bankmandiri = false, konsultasi_medik = false,
            jawaban_konsultasi_medik = false, pcare_cek_alergi = false, pcare_cek_prognosa = false,
            data_sasaran_usiaproduktif = false, data_sasaran_usialansia = false,
            skrining_perilaku_merokok_sekolah_remaja = false, skrining_kekerasan_pada_perempuan = false,
            skrining_obesitas = false, skrining_risiko_kanker_payudara = false, skrining_risiko_kanker_paru = false,
            skrining_tbc = false, skrining_kesehatan_gigi_mulut_remaja = false,
            penilaian_awal_keperawatan_ranap_bayi = false, booking_mcu_perusahaan = false,
            catatan_observasi_restrain_nonfarma = false, catatan_observasi_ventilator = false,
            catatan_anestesi_sedasi = false, skrining_puma = false, satu_sehat_kirim_careplan = false,
            satu_sehat_kirim_medicationstatement = false, skrining_adiksi_nikotin = false, skrining_thalassemia = false,
            skrining_instrumen_sdq = false, pemantauan_pews_maternal = false, validasi_sbar = false;
    ...
    public DlgUpdateUser(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"P", "Pilihan Hak Akses Menu di SIMKES", "Status"}) {
            ...
            Class[] types = new Class[]{java.lang.Boolean.class, java.lang.Object.class, java.lang.Boolean.class};
    ...
    private void tampil(String user) {
        ...
        penilaian_awal_keperawatan_ranap_bayi = false;
        booking_mcu_perusahaan = false;
        catatan_observasi_restrain_nonfarma = false;
        catatan_observasi_ventilator = false;
        catatan_anestesi_sedasi = false;
        skrining_puma = false;
        satu_sehat_kirim_careplan = false;
        satu_sehat_kirim_medicationstatement = false;
        skrining_adiksi_nikotin = false;
        skrining_thalassemia = false;
        skrining_instrumen_sdq = false;
        ...
        try {
            ...
            for (i = 0; i < jml; i++) {
                tabMode.addRow(new Object[]{pilih[i], menu[i], akses[i]});
            }

            ps = koneksi.prepareStatement("select user.penyakit,user.obat_penyakit,user.dokter,"
                    ...
                    + "user.skrining_adiksi_nikotin,user.skrining_thalassemia,user.skrining_instrumen_sdq,user.pemantauan_pews_maternal,user.validasi_sbar from user where user.id_user=AES_ENCRYPT(?,'nur')");
            try {
                ps.setString(1, user);
                rs = ps.executeQuery();
                if (rs.next()) {
                    ...
                    ipsrs_pengadaan_barang = rs.getBoolean("ipsrs_pengadaan_barang");
                    ipsrs_stok_keluar = rs.getBoolean("ipsrs_stok_keluar");
                    ipsrs_rekap_pengadaan = rs.getBoolean("ipsrs_rekap_pengadaan");
                    ipsrs_rekap_stok_keluar = rs.getBoolean("ipsrs_rekap_stok_keluar");
                    ipsrs_pengeluaran_harian = rs.getBoolean("ipsrs_pengeluaran_harian");
                    ...
                    inventaris_inventaris = rs.getBoolean("inventaris_inventaris");
                    ...
                    obat_per_dokter_ralan = rs.getBoolean("obat_per_dokter_ralan");
                    obat_per_dokter_ranap = rs.getBoolean("obat_per_dokter_ranap");
                    ...
                    rekap_pembayaran_ralan = rs.getBoolean("rekap_pembayaran_ralan");
                    rekap_pembayaran_ranap = rs.getBoolean("rekap_pembayaran_ranap");
                    ...
                    harian_tindakan_dokter = rs.getBoolean("harian_tindakan_dokter");
                    ...
                    obat_per_dokter_peresep = rs.getBoolean("obat_per_dokter_peresep");
                    ...
                    keterlambatan_presensi = rs.getBoolean("keterlambatan_presensi");
                    ...
                    bpjs_cek_nomor_rujukan = rs.getBoolean("bpjs_cek_nomor_rujukan");
                    ...
                    bpjs_referensi_diagnosa = rs.getBoolean("bpjs_referensi_diagnosa");
                    ...
                    bpjs_referensi_faskes = rs.getBoolean("bpjs_referensi_faskes");
                    ...
                    pengambilan_penunjang_utd2 = rs.getBoolean("pengambilan_penunjang_utd2");
                    ...
                    bpjs_monitoring_klaim = rs.getBoolean("bpjs_monitoring_klaim");
                    ...
                    rincian_piutang_pasien = rs.getBoolean("rincian_piutang_pasien");
                    keuntungan_beri_obat_nonpiutang = rs.getBoolean("keuntungan_beri_obat_nonpiutang");
                    ...
                    riwayat_obat_alkes_bhp = rs.getBoolean("riwayat_obat_alkes_bhp");
                    sensus_harian_poli = rs.getBoolean("sensus_harian_poli");
                    rl4a = rs.getBoolean("rl4a");
                    aplicare_referensi_kamar = rs.getBoolean("aplicare_referensi_kamar");
                    aplicare_ketersediaan_kamar = rs.getBoolean("aplicare_ketersediaan_kamar");
                    inacbg_klaim_baru_otomatis = rs.getBoolean("inacbg_klaim_baru_otomatis");
                    inacbg_klaim_baru_manual = rs.getBoolean("inacbg_klaim_baru_manual");
                    ...
                    inhealth_cek_eligibilitas = rs.getBoolean("inhealth_cek_eligibilitas");
                    inhealth_referensi_jenpel_ruang_rawat = rs.getBoolean("inhealth_referensi_jenpel_ruang_rawat");
                    inhealth_referensi_poli = rs.getBoolean("inhealth_referensi_poli");
                    inhealth_referensi_faskes = rs.getBoolean("inhealth_referensi_faskes");
                    ...
                    detail_piutang_penjab = rs.getBoolean("detail_piutang_penjab");
                    ...
                    lama_pelayanan_apotek = rs.getBoolean("lama_pelayanan_apotek");
                    hitung_alos = rs.getBoolean("hitung_alos");
                    detail_tindakan = rs.getBoolean("detail_tindakan");
                    rujukan_poli_internal = rs.getBoolean("rujukan_poli_internal");
                    rekap_poli_anak = rs.getBoolean("rekap_poli_anak");
                    grafik_kunjungan_poli = rs.getBoolean("grafik_kunjungan_poli");
                    grafik_kunjungan_perdokter = rs.getBoolean("grafik_kunjungan_perdokter");
                    grafik_kunjungan_perpekerjaan = rs.getBoolean("grafik_kunjungan_perpekerjaan");
                    grafik_kunjungan_perpendidikan = rs.getBoolean("grafik_kunjungan_perpendidikan");
                    grafik_kunjungan_pertahun = rs.getBoolean("grafik_kunjungan_pertahun");
                    berkas_digital_perawatan = rs.getBoolean("berkas_digital_perawatan");
                    penyakit_menular_ranap = rs.getBoolean("penyakit_menular_ranap");
                    penyakit_menular_ralan = rs.getBoolean("penyakit_menular_ralan");
                    grafik_kunjungan_perbulan = rs.getBoolean("grafik_kunjungan_perbulan");
                    grafik_kunjungan_pertanggal = rs.getBoolean("grafik_kunjungan_pertanggal");
                    grafik_kunjungan_demografi = rs.getBoolean("grafik_kunjungan_demografi");
                    grafik_kunjungan_statusdaftartahun = rs.getBoolean("grafik_kunjungan_statusdaftartahun");
                    grafik_kunjungan_statusdaftartahun2 = rs.getBoolean("grafik_kunjungan_statusdaftartahun2");
                    grafik_kunjungan_statusdaftarbulan = rs.getBoolean("grafik_kunjungan_statusdaftarbulan");
                    grafik_kunjungan_statusdaftarbulan2 = rs.getBoolean("grafik_kunjungan_statusdaftarbulan2");
                    grafik_kunjungan_statusdaftartanggal = rs.getBoolean("grafik_kunjungan_statusdaftartanggal");
                    grafik_kunjungan_statusdaftartanggal2 = rs.getBoolean("grafik_kunjungan_statusdaftartanggal2");
                    grafik_kunjungan_statusbataltahun = rs.getBoolean("grafik_kunjungan_statusbataltahun");
                    grafik_kunjungan_statusbatalbulan = rs.getBoolean("grafik_kunjungan_statusbatalbulan");
                    pcare_cek_penyakit = rs.getBoolean("pcare_cek_penyakit");
                    grafik_kunjungan_statusbataltanggal = rs.getBoolean("grafik_kunjungan_statusbataltanggal");
                    kategori_barang = rs.getBoolean("kategori_barang");
                    golongan_barang = rs.getBoolean("golongan_barang");
                    pemberian_obat_pertanggal = rs.getBoolean("pemberian_obat_pertanggal");
                    penjualan_obat_pertanggal = rs.getBoolean("penjualan_obat_pertanggal");
                    pcare_cek_kesadaran = rs.getBoolean("pcare_cek_kesadaran");
                    pembatalan_periksa_dokter = rs.getBoolean("pembatalan_periksa_dokter");
                    pembayaran_per_unit = rs.getBoolean("pembayaran_per_unit");
                    rekap_pembayaran_per_unit = rs.getBoolean("rekap_pembayaran_per_unit");
                    grafik_kunjungan_percarabayar = rs.getBoolean("grafik_kunjungan_percarabayar");
                    ...
                    grafik_kunjungan_ranaptahun = rs.getBoolean("grafik_kunjungan_ranaptahun");
                    pcare_cek_rujukan = rs.getBoolean("pcare_cek_rujukan");
                    grafik_lab_ralantahun = rs.getBoolean("grafik_lab_ralantahun");
                    grafik_rad_ralantahun = rs.getBoolean("grafik_rad_ralantahun");
                    cek_entry_ralan = rs.getBoolean("cek_entry_ralan");
                    inacbg_klaim_baru_manual2 = rs.getBoolean("inacbg_klaim_baru_manual2");
                    permintaan_medis = rs.getBoolean("permintaan_medis");
                    rekap_permintaan_medis = rs.getBoolean("rekap_permintaan_medis");
                    surat_pemesanan_medis = rs.getBoolean("surat_pemesanan_medis");
                    ...
                    surat_pemesanan_non_medis = rs.getBoolean("surat_pemesanan_non_medis");
                    ...
                    bpjs_cek_spesialistik = rs.getBoolean("bpjs_cek_spesialistik");
                    bpjs_cek_ruangrawat = rs.getBoolean("bpjs_cek_ruangrawat");
                    bpjs_cek_carakeluar = rs.getBoolean("bpjs_cek_carakeluar");
                    bpjs_cek_pasca_pulang = rs.getBoolean("bpjs_cek_pasca_pulang");
                    detail_tindakan_okvk = rs.getBoolean("detail_tindakan_okvk");
                    billing_parsial = rs.getBoolean("billing_parsial");
                    bpjs_cek_nomor_rujukan_rs = rs.getBoolean("bpjs_cek_nomor_rujukan_rs");
                    bpjs_cek_rujukan_kartu_pcare = rs.getBoolean("bpjs_cek_rujukan_kartu_pcare");
                    bpjs_cek_rujukan_kartu_rs = rs.getBoolean("bpjs_cek_rujukan_kartu_rs");
                    akses_depo_obat = rs.getBoolean("akses_depo_obat");
                    bpjs_rujukan_keluar = rs.getBoolean("bpjs_rujukan_keluar");
                    grafik_lab_ralanbulan = rs.getBoolean("grafik_lab_ralanbulan");
                    pengeluaran_stok_apotek = rs.getBoolean("pengeluaran_stok_apotek");
                    grafik_rad_ralanbulan = rs.getBoolean("grafik_rad_ralanbulan");
                    ...
                    pembayaran_akun_bayar = rs.getBoolean("pembayaran_akun_bayar");
                    pengguna_obat_resep = rs.getBoolean("pengguna_obat_resep");
                    rekap_pemesanan = rs.getBoolean("rekap_pemesanan");
                    master_berkas_pegawai = rs.getBoolean("master_berkas_pegawai");
                    ...
                    bayar_pesan_non_medis = rs.getBoolean("bayar_pesan_non_medis");
                    hutang_barang_non_medis = rs.getBoolean("hutang_barang_non_medis");
                    rekap_pemesanan_non_medis = rs.getBoolean("rekap_pemesanan_non_medis");
                    insiden_keselamatan = rs.getBoolean("insiden_keselamatan");
                    insiden_keselamatan_pasien = rs.getBoolean("insiden_keselamatan_pasien");
                    grafik_ikp_pertahun = rs.getBoolean("grafik_ikp_pertahun");
                    grafik_ikp_perbulan = rs.getBoolean("grafik_ikp_perbulan");
                    grafik_ikp_pertanggal = rs.getBoolean("grafik_ikp_pertanggal");
                    ...
                    grafik_kunjungan_per_agama = rs.getBoolean("grafik_kunjungan_per_agama");
                    grafik_kunjungan_per_umur = rs.getBoolean("grafik_kunjungan_per_umur");
                    ...
                    grafik_kunjungan_suku = rs.getBoolean("grafik_kunjungan_suku");
                    grafik_kunjungan_bahasa = rs.getBoolean("grafik_kunjungan_bahasa");
                    booking_operasi = rs.getBoolean("booking_operasi");
                    mapping_poli_bpjs = rs.getBoolean("mapping_poli_bpjs");
                    grafik_kunjungan_per_cacat = rs.getBoolean("grafik_kunjungan_per_cacat");
                    ...
                    bpjs_cek_riwayat_rujukanrs = rs.getBoolean("bpjs_cek_riwayat_rujukanrs");
                    bpjs_cek_tanggal_rujukan = rs.getBoolean("bpjs_cek_tanggal_rujukan");
                    ...
                    pcare_cek_statuspulang = rs.getBoolean("pcare_cek_statuspulang");
                    pcare_cek_spesialis = rs.getBoolean("pcare_cek_spesialis");
                    pcare_cek_subspesialis = rs.getBoolean("pcare_cek_subspesialis");
                    ...
                    pcare_cek_faskesalihrawat = rs.getBoolean("pcare_cek_faskesalihrawat");
                    pcare_cek_faskesthalasemia = rs.getBoolean("pcare_cek_faskesthalasemia");
                    pcare_mapping_obat = rs.getBoolean("pcare_mapping_obat");
                    pcare_mapping_tindakan = rs.getBoolean("pcare_mapping_tindakan");
                    pcare_club_prolanis = rs.getBoolean("pcare_club_prolanis");
                    pcare_mapping_poli = rs.getBoolean("pcare_mapping_poli");
                    pcare_kegiatan_kelompok = rs.getBoolean("pcare_kegiatan_kelompok");
                    pcare_mapping_tindakan_ranap = rs.getBoolean("pcare_mapping_tindakan_ranap");
                    pcare_peserta_kegiatan_kelompok = rs.getBoolean("pcare_peserta_kegiatan_kelompok");
                    sirkulasi_obat3 = rs.getBoolean("sirkulasi_obat3");
                    bridging_pcare_daftar = rs.getBoolean("bridging_pcare_daftar");
                    pcare_mapping_dokter = rs.getBoolean("pcare_mapping_dokter");
                    ranap_per_ruang = rs.getBoolean("ranap_per_ruang");
                    penyakit_ranap_cara_bayar = rs.getBoolean("penyakit_ranap_cara_bayar");
                    anggota_militer_dirawat = rs.getBoolean("anggota_militer_dirawat");
                    ...
                    rekap_radiologi_pertahun = rs.getBoolean("rekap_radiologi_pertahun");
                    perujuk_radiologi_pertahun = rs.getBoolean("perujuk_radiologi_pertahun");
                    ...
                    pembayaran_akun_bayar2 = rs.getBoolean("pembayaran_akun_bayar2");
                    ...
                    sisrute_referensi_faskes = rs.getBoolean("sisrute_referensi_faskes");
                    sisrute_referensi_alasanrujuk = rs.getBoolean("sisrute_referensi_alasanrujuk");
                    sisrute_referensi_diagnosa = rs.getBoolean("sisrute_referensi_diagnosa");
                    sisrute_rujukan_masuk = rs.getBoolean("sisrute_rujukan_masuk");
                    sisrute_rujukan_keluar = rs.getBoolean("sisrute_rujukan_keluar");
                    bpjs_cek_skdp = rs.getBoolean("bpjs_cek_skdp");
                    data_batch = rs.getBoolean("data_batch");
                    kunjungan_permintaan_lab = rs.getBoolean("kunjungan_permintaan_lab");
                    kunjungan_permintaan_lab2 = rs.getBoolean("kunjungan_permintaan_lab2");
                    kunjungan_permintaan_radiologi = rs.getBoolean("kunjungan_permintaan_radiologi");
                    kunjungan_permintaan_radiologi2 = rs.getBoolean("kunjungan_permintaan_radiologi2");
                    pcare_pemberian_obat = rs.getBoolean("pcare_pemberian_obat");
                    pcare_pemberian_tindakan = rs.getBoolean("pcare_pemberian_tindakan");
                    pembayaran_akun_bayar3 = rs.getBoolean("pembayaran_akun_bayar3");
                    password_asuransi = rs.getBoolean("password_asuransi");
                    kemenkes_sitt = rs.getBoolean("kemenkes_sitt");
                    siranap_ketersediaan_kamar = rs.getBoolean("siranap_ketersediaan_kamar");
                    grafik_tb_periodelaporan = rs.getBoolean("grafik_tb_periodelaporan");
                    grafik_tb_rujukan = rs.getBoolean("grafik_tb_rujukan");
                    grafik_tb_riwayat = rs.getBoolean("grafik_tb_riwayat");
                    grafik_tb_tipediagnosis = rs.getBoolean("grafik_tb_tipediagnosis");
                    grafik_tb_statushiv = rs.getBoolean("grafik_tb_statushiv");
                    grafik_tb_skoringanak = rs.getBoolean("grafik_tb_skoringanak");
                    grafik_tb_konfirmasiskoring5 = rs.getBoolean("grafik_tb_konfirmasiskoring5");
                    grafik_tb_konfirmasiskoring6 = rs.getBoolean("grafik_tb_konfirmasiskoring6");
                    grafik_tb_sumberobat = rs.getBoolean("grafik_tb_sumberobat");
                    grafik_tb_hasilakhirpengobatan = rs.getBoolean("grafik_tb_hasilakhirpengobatan");
                    grafik_tb_hasilteshiv = rs.getBoolean("grafik_tb_hasilteshiv");
                    ...
                    grafik_air_pdam_pertanggal = rs.getBoolean("grafik_air_pdam_pertanggal");
                    grafik_air_pdam_perbulan = rs.getBoolean("grafik_air_pdam_perbulan");
                    grafik_limbahb3_pertanggal = rs.getBoolean("grafik_limbahb3_pertanggal");
                    grafik_limbahb3_perbulan = rs.getBoolean("grafik_limbahb3_perbulan");
                    limbah_domestik = rs.getBoolean("limbah_domestik");
                    grafik_limbahdomestik_pertanggal = rs.getBoolean("grafik_limbahdomestik_pertanggal");
                    grafik_limbahdomestik_perbulan = rs.getBoolean("grafik_limbahdomestik_perbulan");
                    ...
                    kategori_perpustakaan = rs.getBoolean("kategori_perpustakaan");
                    jenis_perpustakaan = rs.getBoolean("jenis_perpustakaan");
                    pengarang_perpustakaan = rs.getBoolean("pengarang_perpustakaan");
                    penerbit_perpustakaan = rs.getBoolean("penerbit_perpustakaan");
                    koleksi_perpustakaan = rs.getBoolean("koleksi_perpustakaan");
                    inventaris_perpustakaan = rs.getBoolean("inventaris_perpustakaan");
                    set_peminjaman_perpustakaan = rs.getBoolean("set_peminjaman_perpustakaan");
                    denda_perpustakaan = rs.getBoolean("denda_perpustakaan");
                    anggota_perpustakaan = rs.getBoolean("anggota_perpustakaan");
                    peminjaman_perpustakaan = rs.getBoolean("peminjaman_perpustakaan");
                    bayar_denda_perpustakaan = rs.getBoolean("bayar_denda_perpustakaan");
                    ...
                    grafik_k3_perjeniscidera = rs.getBoolean("grafik_k3_perjeniscidera");
                    grafik_k3_perpenyebab = rs.getBoolean("grafik_k3_perpenyebab");
                    grafik_k3_perjenisluka = rs.getBoolean("grafik_k3_perjenisluka");
                    grafik_k3_lokasikejadian = rs.getBoolean("grafik_k3_lokasikejadian");
                    grafik_k3_dampakcidera = rs.getBoolean("grafik_k3_dampakcidera");
                    grafik_k3_perjenispekerjaan = rs.getBoolean("grafik_k3_perjenispekerjaan");
                    grafik_k3_perbagiantubuh = rs.getBoolean("grafik_k3_perbagiantubuh");
                    jenis_cidera_k3rstahun = rs.getBoolean("jenis_cidera_k3rstahun");
                    penyebab_k3rstahun = rs.getBoolean("penyebab_k3rstahun");
                    jenis_luka_k3rstahun = rs.getBoolean("jenis_luka_k3rstahun");
                    lokasi_kejadian_k3rstahun = rs.getBoolean("lokasi_kejadian_k3rstahun");
                    dampak_cidera_k3rstahun = rs.getBoolean("dampak_cidera_k3rstahun");
                    jenis_pekerjaan_k3rstahun = rs.getBoolean("jenis_pekerjaan_k3rstahun");
                    bagian_tubuh_k3rstahun = rs.getBoolean("bagian_tubuh_k3rstahun");
                    sekrining_rawat_jalan = rs.getBoolean("sekrining_rawat_jalan");
                    bpjs_histori_pelayanan = rs.getBoolean("bpjs_histori_pelayanan");
                    ...
                    pengajuan_barang_medis = rs.getBoolean("pengajuan_barang_medis");
                    pengajuan_barang_nonmedis = rs.getBoolean("pengajuan_barang_nonmedis");
                    grafik_kunjungan_ranapbulan = rs.getBoolean("grafik_kunjungan_ranapbulan");
                    grafik_kunjungan_ranaptanggal = rs.getBoolean("grafik_kunjungan_ranaptanggal");
                    ...
                    grafik_departemenpegawai = rs.getBoolean("grafik_departemenpegawai");
                    grafik_pendidikanpegawai = rs.getBoolean("grafik_pendidikanpegawai");
                    grafik_sttswppegawai = rs.getBoolean("grafik_sttswppegawai");
                    grafik_sttskerjapegawai = rs.getBoolean("grafik_sttskerjapegawai");
                    grafik_sttspulangranap = rs.getBoolean("grafik_sttspulangranap");
                    kip_pasien_ranap = rs.getBoolean("kip_pasien_ranap");
                    kip_pasien_ralan = rs.getBoolean("kip_pasien_ralan");
                    bpjs_mapping_dokterdpjp = rs.getBoolean("bpjs_mapping_dokterdpjp");
                    ...
                    master_triase_pemeriksaan = rs.getBoolean("master_triase_pemeriksaan");
                    master_triase_macamkasus = rs.getBoolean("master_triase_macamkasus");
                    rekap_permintaan_diet = rs.getBoolean("rekap_permintaan_diet");
                    daftar_pasien_ranap = rs.getBoolean("daftar_pasien_ranap");
                    daftar_pasien_ranaptni = rs.getBoolean("daftar_pasien_ranaptni");
                    pengajuan_asetinventaris = rs.getBoolean("pengajuan_asetinventaris");
                    ...
                    item_apotek_industrifarmasi = rs.getBoolean("item_apotek_industrifarmasi");
                    sepuluh_obat_terbanyak_poli = rs.getBoolean("10_obat_terbanyak_poli");
                    grafik_pengajuan_aset_urgensi = rs.getBoolean("grafik_pengajuan_aset_urgensi");
                    grafik_pengajuan_aset_status = rs.getBoolean("grafik_pengajuan_aset_status");
                    grafik_pengajuan_aset_departemen = rs.getBoolean("grafik_pengajuan_aset_departemen");
                    rekap_pengajuan_aset_departemen = rs.getBoolean("rekap_pengajuan_aset_departemen");
                    grafik_kelompok_jabatanpegawai = rs.getBoolean("grafik_kelompok_jabatanpegawai");
                    grafik_resiko_kerjapegawai = rs.getBoolean("grafik_resiko_kerjapegawai");
                    grafik_emergency_indexpegawai = rs.getBoolean("grafik_emergency_indexpegawai");
                    grafik_inventaris_ruang = rs.getBoolean("grafik_inventaris_ruang");
                    harian_HAIs2 = rs.getBoolean("harian_HAIs2");
                    grafik_inventaris_jenis = rs.getBoolean("grafik_inventaris_jenis");
                    data_resume_pasien = rs.getBoolean("data_resume_pasien");
                    perkiraan_biaya_ranap = rs.getBoolean("perkiraan_biaya_ranap");
                    rekap_obat_poli = rs.getBoolean("rekap_obat_poli");
                    rekap_obat_pasien = rs.getBoolean("rekap_obat_pasien");
                    permintaan_perbaikan_inventaris = rs.getBoolean("permintaan_perbaikan_inventaris");
                    grafik_HAIs_pasienbangsal = rs.getBoolean("grafik_HAIs_pasienbangsal");
                    grafik_HAIs_pasienbulan = rs.getBoolean("grafik_HAIs_pasienbulan");
                    grafik_HAIs_laju_vap = rs.getBoolean("grafik_HAIs_laju_vap");
                    grafik_HAIs_laju_iad = rs.getBoolean("grafik_HAIs_laju_iad");
                    grafik_HAIs_laju_pleb = rs.getBoolean("grafik_HAIs_laju_pleb");
                    ...
                    inhealth_mapping_poli = rs.getBoolean("inhealth_mapping_poli");
                    inhealth_mapping_dokter = rs.getBoolean("inhealth_mapping_dokter");
                    inhealth_mapping_tindakan_ralan = rs.getBoolean("inhealth_mapping_tindakan_ralan");
                    inhealth_mapping_tindakan_ranap = rs.getBoolean("inhealth_mapping_tindakan_ranap");
                    inhealth_mapping_tindakan_radiologi = rs.getBoolean("inhealth_mapping_tindakan_radiologi");
                    inhealth_mapping_tindakan_laborat = rs.getBoolean("inhealth_mapping_tindakan_laborat");
                    inhealth_mapping_tindakan_operasi = rs.getBoolean("inhealth_mapping_tindakan_operasi");
                    hibah_obat_bhp = rs.getBoolean("hibah_obat_bhp");
                    asal_hibah = rs.getBoolean("asal_hibah");
                    asuhan_gizi = rs.getBoolean("asuhan_gizi");
                    inhealth_kirim_tagihan = rs.getBoolean("inhealth_kirim_tagihan");
                    ...
                    monitoring_asuhan_gizi = rs.getBoolean("monitoring_asuhan_gizi");
                    penerimaan_obat_perbulan = rs.getBoolean("penerimaan_obat_perbulan");
                    rekap_kunjungan = rs.getBoolean("rekap_kunjungan");
                    surat_sakit = rs.getBoolean("surat_sakit");
                    penilaian_awal_keperawatan_ralan = rs.getBoolean("penilaian_awal_keperawatan_ralan");
                    permintaan_diet = rs.getBoolean("permintaan_diet");
                    master_masalah_keperawatan = rs.getBoolean("master_masalah_keperawatan");
                    ...
                    penagihan_piutang_pasien = rs.getBoolean("penagihan_piutang_pasien");
                    akun_penagihan_piutang = rs.getBoolean("akun_penagihan_piutang");
                    ...
                    toko_pengajuan_barang = rs.getBoolean("toko_pengajuan_barang");
                    toko_penerimaan_barang = rs.getBoolean("toko_penerimaan_barang");
                    toko_pengadaan_barang = rs.getBoolean("toko_pengadaan_barang");
                    ...
                    registrasi_poli_per_tanggal = rs.getBoolean("registrasi_poli_per_tanggal");
                    ...
                    toko_pendapatan_harian = rs.getBoolean("toko_pendapatan_harian");
                    diagnosa_pasien_corona = rs.getBoolean("diagnosa_pasien_corona");
                    perawatan_pasien_corona = rs.getBoolean("perawatan_pasien_corona");
                    penilaian_awal_keperawatan_gigi = rs.getBoolean("penilaian_awal_keperawatan_gigi");
                    master_masalah_keperawatan_gigi = rs.getBoolean("master_masalah_keperawatan_gigi");
                    toko_bayar_piutang = rs.getBoolean("toko_bayar_piutang");
                    toko_piutang_harian = rs.getBoolean("toko_piutang_harian");
                    toko_penjualan_harian = rs.getBoolean("toko_penjualan_harian");
                    deteksi_corona = rs.getBoolean("deteksi_corona");
                    penilaian_awal_keperawatan_kebidanan = rs.getBoolean("penilaian_awal_keperawatan_kebidanan");
                    ...
                    toko_keuntungan_barang = rs.getBoolean("toko_keuntungan_barang");
                    zis_pengeluaran_penerima_dankes = rs.getBoolean("zis_pengeluaran_penerima_dankes");
                    zis_penghasilan_penerima_dankes = rs.getBoolean("zis_penghasilan_penerima_dankes");
                    zis_ukuran_rumah_penerima_dankes = rs.getBoolean("zis_ukuran_rumah_penerima_dankes");
                    zis_dinding_rumah_penerima_dankes = rs.getBoolean("zis_dinding_rumah_penerima_dankes");
                    zis_lantai_rumah_penerima_dankes = rs.getBoolean("zis_lantai_rumah_penerima_dankes");
                    zis_atap_rumah_penerima_dankes = rs.getBoolean("zis_atap_rumah_penerima_dankes");
                    zis_kepemilikan_rumah_penerima_dankes = rs.getBoolean("zis_kepemilikan_rumah_penerima_dankes");
                    zis_kamar_mandi_penerima_dankes = rs.getBoolean("zis_kamar_mandi_penerima_dankes");
                    zis_dapur_rumah_penerima_dankes = rs.getBoolean("zis_dapur_rumah_penerima_dankes");
                    zis_kursi_rumah_penerima_dankes = rs.getBoolean("zis_kursi_rumah_penerima_dankes");
                    zis_kategori_phbs_penerima_dankes = rs.getBoolean("zis_kategori_phbs_penerima_dankes");
                    zis_elektronik_penerima_dankes = rs.getBoolean("zis_elektronik_penerima_dankes");
                    zis_ternak_penerima_dankes = rs.getBoolean("zis_ternak_penerima_dankes");
                    zis_jenis_simpanan_penerima_dankes = rs.getBoolean("zis_jenis_simpanan_penerima_dankes");
                    penilaian_awal_keperawatan_anak = rs.getBoolean("penilaian_awal_keperawatan_anak");
                    zis_kategori_asnaf_penerima_dankes = rs.getBoolean("zis_kategori_asnaf_penerima_dankes");
                    master_masalah_keperawatan_anak = rs.getBoolean("master_masalah_keperawatan_anak");
                    master_imunisasi = rs.getBoolean("master_imunisasi");
                    zis_patologis_penerima_dankes = rs.getBoolean("zis_patologis_penerima_dankes");
                    pcare_cek_kartu = rs.getBoolean("pcare_cek_kartu");
                    surat_bebas_narkoba = rs.getBoolean("surat_bebas_narkoba");
                    surat_keterangan_covid = rs.getBoolean("surat_keterangan_covid");
                    pemakaian_air_tanah = rs.getBoolean("pemakaian_air_tanah");
                    grafik_air_tanah_pertanggal = rs.getBoolean("grafik_air_tanah_pertanggal");
                    grafik_air_tanah_perbulan = rs.getBoolean("grafik_air_tanah_perbulan");
                    ...
                    grafik_harian_hemodialisa = rs.getBoolean("grafik_harian_hemodialisa");
                    grafik_bulanan_hemodialisa = rs.getBoolean("grafik_bulanan_hemodialisa");
                    grafik_tahunan_hemodialisa = rs.getBoolean("grafik_tahunan_hemodialisa");
                    grafik_bulanan_meninggal = rs.getBoolean("grafik_bulanan_meninggal");
                    perbaikan_inventaris = rs.getBoolean("perbaikan_inventaris");
                    surat_cuti_hamil = rs.getBoolean("surat_cuti_hamil");
                    permintaan_stok_obat_pasien = rs.getBoolean("permintaan_stok_obat_pasien");
                    pemeliharaan_inventaris = rs.getBoolean("pemeliharaan_inventaris");
                    klasifikasi_pasien_ranap = rs.getBoolean("klasifikasi_pasien_ranap");
                    bulanan_klasifikasi_pasien_ranap = rs.getBoolean("bulanan_klasifikasi_pasien_ranap");
                    harian_klasifikasi_pasien_ranap = rs.getBoolean("harian_klasifikasi_pasien_ranap");
                    klasifikasi_pasien_perbangsal = rs.getBoolean("klasifikasi_pasien_perbangsal");
                    ...
                    demografi_umur_kunjungan = rs.getBoolean("demografi_umur_kunjungan");
                    jam_diet_pasien = rs.getBoolean("jam_diet_pasien");
                    rvu_bpjs = rs.getBoolean("rvu_bpjs");
                    verifikasi_penerimaan_farmasi = rs.getBoolean("verifikasi_penerimaan_farmasi");
                    verifikasi_penerimaan_logistik = rs.getBoolean("verifikasi_penerimaan_logistik");
                    pemeriksaan_lab_pa = rs.getBoolean("pemeriksaan_lab_pa");
                    ringkasan_pengajuan_obat = rs.getBoolean("ringkasan_pengajuan_obat");
                    ringkasan_pemesanan_obat = rs.getBoolean("ringkasan_pemesanan_obat");
                    ringkasan_pengadaan_obat = rs.getBoolean("ringkasan_pengadaan_obat");
                    ringkasan_penerimaan_obat = rs.getBoolean("ringkasan_penerimaan_obat");
                    ringkasan_hibah_obat = rs.getBoolean("ringkasan_hibah_obat");
                    ringkasan_penjualan_obat = rs.getBoolean("ringkasan_penjualan_obat");
                    ringkasan_beri_obat = rs.getBoolean("ringkasan_beri_obat");
                    ringkasan_piutang_obat = rs.getBoolean("ringkasan_piutang_obat");
                    ringkasan_stok_keluar_obat = rs.getBoolean("ringkasan_stok_keluar_obat");
                    ringkasan_retur_suplier_obat = rs.getBoolean("ringkasan_retur_suplier_obat");
                    ringkasan_retur_pembeli_obat = rs.getBoolean("ringkasan_retur_pembeli_obat");
                    penilaian_awal_keperawatan_ranapkebidanan = rs
                            .getBoolean("penilaian_awal_keperawatan_ranapkebidanan");
                    ringkasan_pengajuan_nonmedis = rs.getBoolean("ringkasan_pengajuan_nonmedis");
                    ringkasan_pemesanan_nonmedis = rs.getBoolean("ringkasan_pemesanan_nonmedis");
                    ringkasan_pengadaan_nonmedis = rs.getBoolean("ringkasan_pengadaan_nonmedis");
                    ringkasan_penerimaan_nonmedis = rs.getBoolean("ringkasan_penerimaan_nonmedis");
                    ringkasan_stokkeluar_nonmedis = rs.getBoolean("ringkasan_stokkeluar_nonmedis");
                    ringkasan_returbeli_nonmedis = rs.getBoolean("ringkasan_returbeli_nonmedis");
                    omset_penerimaan = rs.getBoolean("omset_penerimaan");
                    validasi_penagihan_piutang = rs.getBoolean("validasi_penagihan_piutang");
                    ...
                    surat_keterangan_rawat_inap = rs.getBoolean("surat_keterangan_rawat_inap");
                    surat_keterangan_sehat = rs.getBoolean("surat_keterangan_sehat");
                    pendapatan_per_carabayar = rs.getBoolean("pendapatan_per_carabayar");
                    akun_host_to_host_bank_jateng = rs.getBoolean("akun_host_to_host_bank_jateng");
                    pembayaran_bank_jateng = rs.getBoolean("pembayaran_bank_jateng");
                    bpjs_surat_pri = rs.getBoolean("bpjs_surat_pri");
                    ringkasan_tindakan = rs.getBoolean("ringkasan_tindakan");
                    lama_pelayanan_pasien = rs.getBoolean("lama_pelayanan_pasien");
                    surat_sakit_pihak_2 = rs.getBoolean("surat_sakit_pihak_2");
                    tagihan_hutang_obat = rs.getBoolean("tagihan_hutang_obat");
                    referensi_mobilejkn_bpjs = rs.getBoolean("referensi_mobilejkn_bpjs");
                    batal_pendaftaran_mobilejkn_bpjs = rs.getBoolean("batal_pendaftaran_mobilejkn_bpjs");
                    lama_operasi = rs.getBoolean("lama_operasi");
                    grafik_inventaris_kategori = rs.getBoolean("grafik_inventaris_kategori");
                    grafik_inventaris_merk = rs.getBoolean("grafik_inventaris_merk");
                    grafik_inventaris_produsen = rs.getBoolean("grafik_inventaris_produsen");
                    pengembalian_deposit_pasien = rs.getBoolean("pengembalian_deposit_pasien");
                    validasi_tagihan_hutang_obat = rs.getBoolean("validasi_tagihan_hutang_obat");
                    piutang_obat_belum_lunas = rs.getBoolean("piutang_obat_belum_lunas");
                    integrasi_briapi = rs.getBoolean("integrasi_briapi");
                    pengadaan_aset_inventaris = rs.getBoolean("pengadaan_aset_inventaris");
                    akun_aset_inventaris = rs.getBoolean("akun_aset_inventaris");
                    suplier_inventaris = rs.getBoolean("suplier_inventaris");
                    penerimaan_aset_inventaris = rs.getBoolean("penerimaan_aset_inventaris");
                    bayar_pemesanan_iventaris = rs.getBoolean("bayar_pemesanan_iventaris");
                    hutang_aset_inventaris = rs.getBoolean("hutang_aset_inventaris");
                    hibah_aset_inventaris = rs.getBoolean("hibah_aset_inventaris");
                    titip_faktur_non_medis = rs.getBoolean("titip_faktur_non_medis");
                    validasi_tagihan_non_medis = rs.getBoolean("validasi_tagihan_non_medis");
                    titip_faktur_aset = rs.getBoolean("titip_faktur_aset");
                    validasi_tagihan_aset = rs.getBoolean("validasi_tagihan_aset");
                    ...
                    surat_kewaspadaan_kesehatan = rs.getBoolean("surat_kewaspadaan_kesehatan");
                    grafik_porsidiet_pertanggal = rs.getBoolean("grafik_porsidiet_pertanggal");
                    grafik_porsidiet_perbulan = rs.getBoolean("grafik_porsidiet_perbulan");
                    grafik_porsidiet_pertahun = rs.getBoolean("grafik_porsidiet_pertahun");
                    grafik_porsidiet_perbangsal = rs.getBoolean("grafik_porsidiet_perbangsal");
                    penilaian_awal_medis_ralan = rs.getBoolean("penilaian_awal_medis_ralan");
                    master_masalah_keperawatan_mata = rs.getBoolean("master_masalah_keperawatan_mata");
                    penilaian_awal_keperawatan_mata = rs.getBoolean("penilaian_awal_keperawatan_mata");
                    penilaian_awal_medis_ranap = rs.getBoolean("penilaian_awal_medis_ranap");
                    penilaian_awal_medis_ranap_kebidanan = rs.getBoolean("penilaian_awal_medis_ranap_kebidanan");
                    penilaian_awal_medis_ralan_kebidanan = rs.getBoolean("penilaian_awal_medis_ralan_kebidanan");
                    ...
                    bpjs_referensi_poli_hfis = rs.getBoolean("bpjs_referensi_poli_hfis");
                    bpjs_referensi_dokter_hfis = rs.getBoolean("bpjs_referensi_dokter_hfis");
                    bpjs_referensi_jadwal_hfis = rs.getBoolean("bpjs_referensi_jadwal_hfis");
                    penilaian_fisioterapi = rs.getBoolean("penilaian_fisioterapi");
                    bpjs_program_prb = rs.getBoolean("bpjs_program_prb");
                    bpjs_suplesi_jasaraharja = rs.getBoolean("bpjs_suplesi_jasaraharja");
                    bpjs_data_induk_kecelakaan = rs.getBoolean("bpjs_data_induk_kecelakaan");
                    bpjs_sep_internal = rs.getBoolean("bpjs_sep_internal");
                    bpjs_klaim_jasa_raharja = rs.getBoolean("bpjs_klaim_jasa_raharja");
                    bpjs_daftar_finger_print = rs.getBoolean("bpjs_daftar_finger_print");
                    bpjs_rujukan_khusus = rs.getBoolean("bpjs_rujukan_khusus");
                    pemeliharaan_gedung = rs.getBoolean("pemeliharaan_gedung");
                    grafik_perbaikan_inventaris_pertanggal = rs.getBoolean("grafik_perbaikan_inventaris_pertanggal");
                    grafik_perbaikan_inventaris_perbulan = rs.getBoolean("grafik_perbaikan_inventaris_perbulan");
                    grafik_perbaikan_inventaris_pertahun = rs.getBoolean("grafik_perbaikan_inventaris_pertahun");
                    grafik_perbaikan_inventaris_perpelaksana_status = rs
                            .getBoolean("grafik_perbaikan_inventaris_perpelaksana_status");
                    ...
                    pembayaran_akun_bayar4 = rs.getBoolean("pembayaran_akun_bayar4");
                    stok_akhir_farmasi_pertanggal = rs.getBoolean("stok_akhir_farmasi_pertanggal");
                    riwayat_kamar_pasien = rs.getBoolean("riwayat_kamar_pasien");
                    uji_fungsi_kfr = rs.getBoolean("uji_fungsi_kfr");
                    hapus_berkas_digital_perawatan = rs.getBoolean("hapus_berkas_digital_perawatan");
                    kategori_pengeluaran_harian = rs.getBoolean("kategori_pengeluaran_harian");
                    kategori_pemasukan_lain = rs.getBoolean("kategori_pemasukan_lain");
                    ...
                    permintaan_resep_pulang = rs.getBoolean("permintaan_resep_pulang");
                    ...
                    ubah_petugas_radiologi = rs.getBoolean("ubah_petugas_radiologi");
                    gabung_norawat = rs.getBoolean("gabung_norawat");
                    gabung_rm = rs.getBoolean("gabung_rm");
                    ringkasan_biaya_obat_pasien_pertanggal = rs.getBoolean("ringkasan_biaya_obat_pasien_pertanggal");
                    ...
                    bpjs_referensi_dpho_apotek = rs.getBoolean("bpjs_referensi_dpho_apotek");
                    bpjs_referensi_poli_apotek = rs.getBoolean("bpjs_referensi_poli_apotek");
                    bayar_jm_dokter = rs.getBoolean("bayar_jm_dokter");
                    bpjs_referensi_faskes_apotek = rs.getBoolean("bpjs_referensi_faskes_apotek");
                    bpjs_referensi_spesialistik_apotek = rs.getBoolean("bpjs_referensi_spesialistik_apotek");
                    pembayaran_briva = rs.getBoolean("pembayaran_briva");
                    penilaian_awal_keperawatan_ranap = rs.getBoolean("penilaian_awal_keperawatan_ranap");
                    nilai_penerimaan_vendor_farmasi_perbulan = rs
                            .getBoolean("nilai_penerimaan_vendor_farmasi_perbulan");
                    akun_bayar_hutang = rs.getBoolean("akun_bayar_hutang");
                    master_rencana_keperawatan = rs.getBoolean("master_rencana_keperawatan");
                    laporan_tahunan_igd = rs.getBoolean("laporan_tahunan_igd");
                    obat_bhp_tidakbergerak = rs.getBoolean("obat_bhp_tidakbergerak");
                    ringkasan_hutang_vendor_farmasi = rs.getBoolean("ringkasan_hutang_vendor_farmasi");
                    nilai_penerimaan_vendor_nonmedis_perbulan = rs
                            .getBoolean("nilai_penerimaan_vendor_nonmedis_perbulan");
                    ringkasan_hutang_vendor_nonmedis = rs.getBoolean("ringkasan_hutang_vendor_nonmedis");
                    master_rencana_keperawatan_anak = rs.getBoolean("master_rencana_keperawatan_anak");
                    anggota_polri_dirawat = rs.getBoolean("anggota_polri_dirawat");
                    daftar_pasien_ranap_polri = rs.getBoolean("daftar_pasien_ranap_polri");
                    soap_ralan_polri = rs.getBoolean("soap_ralan_polri");
                    soap_ranap_polri = rs.getBoolean("soap_ranap_polri");
                    laporan_penyakit_polri = rs.getBoolean("laporan_penyakit_polri");
                    jumlah_pengunjung_ralan_polri = rs.getBoolean("jumlah_pengunjung_ralan_polri");
                    catatan_observasi_igd = rs.getBoolean("catatan_observasi_igd");
                    catatan_observasi_ranap = rs.getBoolean("catatan_observasi_ranap");
                    ...
                    penilaian_awal_medis_ralan_tht = rs.getBoolean("penilaian_awal_medis_ralan_tht");
                    penilaian_psikologi = rs.getBoolean("penilaian_psikologi");
                    audit_cuci_tangan_medis = rs.getBoolean("audit_cuci_tangan_medis");
                    audit_pembuangan_limbah = rs.getBoolean("audit_pembuangan_limbah");
                    ruang_audit_kepatuhan = rs.getBoolean("ruang_audit_kepatuhan");
                    audit_pembuangan_benda_tajam = rs.getBoolean("audit_pembuangan_benda_tajam");
                    audit_penanganan_darah = rs.getBoolean("audit_penanganan_darah");
                    audit_pengelolaan_linen_kotor = rs.getBoolean("audit_pengelolaan_linen_kotor");
                    audit_penempatan_pasien = rs.getBoolean("audit_penempatan_pasien");
                    ...
                    audit_pembuangan_limbah_cair_infeksius = rs.getBoolean("audit_pembuangan_limbah_cair_infeksius");
                    audit_sterilisasi_alat = rs.getBoolean("audit_sterilisasi_alat");
                    penilaian_awal_medis_ralan_psikiatri = rs.getBoolean("penilaian_awal_medis_ralan_psikiatri");
                    persetujuan_penolakan_tindakan = rs.getBoolean("persetujuan_penolakan_tindakan");
                    ...
                    akun_host_to_host_bank_papua = rs.getBoolean("akun_host_to_host_bank_papua");
                    pembayaran_bank_papua = rs.getBoolean("pembayaran_bank_papua");
                    penilaian_awal_medis_ralan_penyakit_dalam = rs
                            .getBoolean("penilaian_awal_medis_ralan_penyakit_dalam");
                    penilaian_awal_medis_ralan_mata = rs.getBoolean("penilaian_awal_medis_ralan_mata");
                    penilaian_awal_medis_ralan_neurologi = rs.getBoolean("penilaian_awal_medis_ralan_neurologi");
                    sirkulasi_obat6 = rs.getBoolean("sirkulasi_obat6");
                    penilaian_awal_medis_ralan_orthopedi = rs.getBoolean("penilaian_awal_medis_ralan_orthopedi");
                    penilaian_awal_medis_ralan_bedah = rs.getBoolean("penilaian_awal_medis_ralan_bedah");
                    integrasi_khanza_health_services = rs.getBoolean("integrasi_khanza_health_services");
                    ...
                    catatan_keperawatan_ranap = rs.getBoolean("catatan_keperawatan_ranap");
                    master_rencana_keperawatan_gigi = rs.getBoolean("master_rencana_keperawatan_gigi");
                    master_rencana_keperawatan_mata = rs.getBoolean("master_rencana_keperawatan_mata");
                    master_rencana_keperawatan_igd = rs.getBoolean("master_rencana_keperawatan_igd");
                    master_masalah_keperawatan_psikiatri = rs.getBoolean("master_masalah_keperawatan_psikiatri");
                    master_rencana_keperawatan_psikiatri = rs.getBoolean("master_rencana_keperawatan_psikiatri");
                    penilaian_awal_keperawatan_psikiatri = rs.getBoolean("penilaian_awal_keperawatan_psikiatri");
                    pemantauan_pews_anak = rs.getBoolean("pemantauan_pews_anak");
                    surat_pulang_atas_permintaan_sendiri = rs.getBoolean("surat_pulang_atas_permintaan_sendiri");
                    template_hasil_radiologi = rs.getBoolean("template_hasil_radiologi");
                    ...
                    penilaian_pre_operasi = rs.getBoolean("penilaian_pre_operasi");
                    penilaian_pre_anestesi = rs.getBoolean("penilaian_pre_anestesi");
                    perencanaan_pemulangan = rs.getBoolean("perencanaan_pemulangan");
                    penilaian_lanjutan_resiko_jatuh_dewasa = rs.getBoolean("penilaian_lanjutan_resiko_jatuh_dewasa");
                    penilaian_lanjutan_resiko_jatuh_anak = rs.getBoolean("penilaian_lanjutan_resiko_jatuh_anak");
                    penilaian_awal_medis_ralan_geriatri = rs.getBoolean("penilaian_awal_medis_ralan_geriatri");
                    penilaian_tambahan_pasien_geriatri = rs.getBoolean("penilaian_tambahan_pasien_geriatri");
                    skrining_nutrisi_dewasa = rs.getBoolean("skrining_nutrisi_dewasa");
                    skrining_nutrisi_lansia = rs.getBoolean("skrining_nutrisi_lansia");
                    hasil_pemeriksaan_usg = rs.getBoolean("hasil_pemeriksaan_usg");
                    skrining_nutrisi_anak = rs.getBoolean("skrining_nutrisi_anak");
                    akun_host_to_host_bank_jabar = rs.getBoolean("akun_host_to_host_bank_jabar");
                    pembayaran_bank_jabar = rs.getBoolean("pembayaran_bank_jabar");
                    surat_pernyataan_pasien_umum = rs.getBoolean("surat_pernyataan_pasien_umum");
                    konseling_farmasi = rs.getBoolean("konseling_farmasi");
                    pelayanan_informasi_obat = rs.getBoolean("pelayanan_informasi_obat");
                    jawaban_pio_apoteker = rs.getBoolean("jawaban_pio_apoteker");
                    surat_persetujuan_umum = rs.getBoolean("surat_persetujuan_umum");
                    transfer_pasien_antar_ruang = rs.getBoolean("transfer_pasien_antar_ruang");
                    satu_sehat_referensi_dokter = rs.getBoolean("satu_sehat_referensi_dokter");
                    satu_sehat_referensi_pasien = rs.getBoolean("satu_sehat_referensi_pasien");
                    satu_sehat_mapping_departemen = rs.getBoolean("satu_sehat_mapping_departemen");
                    satu_sehat_mapping_lokasi = rs.getBoolean("satu_sehat_mapping_lokasi");
                    satu_sehat_kirim_encounter = rs.getBoolean("satu_sehat_kirim_encounter");
                    catatan_cek_gds = rs.getBoolean("catatan_cek_gds");
                    satu_sehat_kirim_condition = rs.getBoolean("satu_sehat_kirim_condition");
                    checklist_pre_operasi = rs.getBoolean("checklist_pre_operasi");
                    satu_sehat_kirim_observationttv = rs.getBoolean("satu_sehat_kirim_observationttv");
                    signin_sebelum_anestesi = rs.getBoolean("signin_sebelum_anestesi");
                    satu_sehat_kirim_procedure = rs.getBoolean("satu_sehat_kirim_procedure");
                    operasi_per_bulan = rs.getBoolean("operasi_per_bulan");
                    timeout_sebelum_insisi = rs.getBoolean("timeout_sebelum_insisi");
                    signout_sebelum_menutup_luka = rs.getBoolean("signout_sebelum_menutup_luka");
                    dapur_barang = rs.getBoolean("dapur_barang");
                    dapur_opname = rs.getBoolean("dapur_opname");
                    satu_sehat_mapping_vaksin = rs.getBoolean("satu_sehat_mapping_vaksin");
                    dapur_suplier = rs.getBoolean("dapur_suplier");
                    satu_sehat_kirim_Immunization = rs.getBoolean("satu_sehat_kirim_Immunization");
                    checklist_post_operasi = rs.getBoolean("checklist_post_operasi");
                    ...
                    biaya_pengadaan_dapur = rs.getBoolean("biaya_pengadaan_dapur");
                    rekap_pengadaan_dapur = rs.getBoolean("rekap_pengadaan_dapur");
                    kesling_limbah_b3medis_cair = rs.getBoolean("kesling_limbah_b3medis_cair");
                    grafik_limbahb3cair_pertanggal = rs.getBoolean("grafik_limbahb3cair_pertanggal");
                    grafik_limbahb3cair_perbulan = rs.getBoolean("grafik_limbahb3cair_perbulan");
                    rekap_biaya_registrasi = rs.getBoolean("rekap_biaya_registrasi");
                    konfirmasi_rekonsiliasi_obat = rs.getBoolean("konfirmasi_rekonsiliasi_obat");
                    satu_sehat_kirim_clinicalimpression = rs.getBoolean("satu_sehat_kirim_clinicalimpression");
                    penilaian_pasien_terminal = rs.getBoolean("penilaian_pasien_terminal");
                    surat_persetujuan_rawat_inap = rs.getBoolean("surat_persetujuan_rawat_inap");
                    monitoring_reaksi_tranfusi = rs.getBoolean("monitoring_reaksi_tranfusi");
                    penilaian_korban_kekerasan = rs.getBoolean("penilaian_korban_kekerasan");
                    penilaian_lanjutan_resiko_jatuh_lansia = rs.getBoolean("penilaian_lanjutan_resiko_jatuh_lansia");
                    penilaian_pasien_penyakit_menular = rs.getBoolean("penilaian_pasien_penyakit_menular");
                    mpp_skrining = rs.getBoolean("mpp_skrining");
                    edukasi_pasien_keluarga_rj = rs.getBoolean("edukasi_pasien_keluarga_rj");
                    pemantauan_pews_dewasa = rs.getBoolean("pemantauan_pews_dewasa");
                    penilaian_tambahan_bunuh_diri = rs.getBoolean("penilaian_tambahan_bunuh_diri");
                    bpjs_antrean_pertanggal = rs.getBoolean("bpjs_antrean_pertanggal");
                    penilaian_tambahan_perilaku_kekerasan = rs.getBoolean("penilaian_tambahan_perilaku_kekerasan");
                    penilaian_tambahan_beresiko_melarikan_diri = rs
                            .getBoolean("penilaian_tambahan_beresiko_melarikan_diri");
                    ...
                    penilaian_awal_medis_ralan_bedah_mulut = rs.getBoolean("penilaian_awal_medis_ralan_bedah_mulut");
                    penilaian_pasien_keracunan = rs.getBoolean("penilaian_pasien_keracunan");
                    pemantauan_meows_obstetri = rs.getBoolean("pemantauan_meows_obstetri");
                    catatan_adime_gizi = rs.getBoolean("catatan_adime_gizi");
                    pengajuan_biaya = rs.getBoolean("pengajuan_biaya");
                    penilaian_awal_keperawatan_ralan_geriatri = rs
                            .getBoolean("penilaian_awal_keperawatan_ralan_geriatri");
                    master_masalah_keperawatan_geriatri = rs.getBoolean("master_masalah_keperawatan_geriatri");
                    master_rencana_keperawatan_geriatri = rs.getBoolean("master_rencana_keperawatan_geriatri");
                    checklist_kriteria_masuk_hcu = rs.getBoolean("checklist_kriteria_masuk_hcu");
                    checklist_kriteria_keluar_hcu = rs.getBoolean("checklist_kriteria_keluar_hcu");
                    penilaian_risiko_dekubitus = rs.getBoolean("penilaian_risiko_dekubitus");
                    master_menolak_anjuran_medis = rs.getBoolean("master_menolak_anjuran_medis");
                    penolakan_anjuran_medis = rs.getBoolean("penolakan_anjuran_medis");
                    laporan_tahunan_penolakan_anjuran_medis = rs.getBoolean("laporan_tahunan_penolakan_anjuran_medis");
                    template_laporan_operasi = rs.getBoolean("template_laporan_operasi");
                    hasil_tindakan_eswl = rs.getBoolean("hasil_tindakan_eswl");
                    checklist_kriteria_masuk_icu = rs.getBoolean("checklist_kriteria_masuk_icu");
                    checklist_kriteria_keluar_icu = rs.getBoolean("checklist_kriteria_keluar_icu");
                    akses_dokter_lain_rawat_jalan = rs.getBoolean("akses_dokter_lain_rawat_jalan");
                    follow_up_dbd = rs.getBoolean("follow_up_dbd");
                    penilaian_risiko_jatuh_neonatus = rs.getBoolean("penilaian_risiko_jatuh_neonatus");
                    persetujuan_pengajuan_biaya = rs.getBoolean("persetujuan_pengajuan_biaya");
                    pemeriksaan_fisik_ralan_per_penyakit = rs.getBoolean("pemeriksaan_fisik_ralan_per_penyakit");
                    penilaian_lanjutan_resiko_jatuh_geriatri = rs
                            .getBoolean("penilaian_lanjutan_resiko_jatuh_geriatri");
                    ...
                    riwayat_perawatan_icare_bpjs = rs.getBoolean("riwayat_perawatan_icare_bpjs");
                    rekap_pengajuan_biaya = rs.getBoolean("rekap_pengajuan_biaya");
                    penilaian_awal_medis_ralan_kulit_kelamin = rs
                            .getBoolean("penilaian_awal_medis_ralan_kulit_kelamin");
                    akun_host_to_host_bank_mandiri = rs.getBoolean("akun_host_to_host_bank_mandiri");
                    penilaian_medis_hemodialisa = rs.getBoolean("penilaian_medis_hemodialisa");
                    penilaian_level_kecemasan_ranap_anak = rs.getBoolean("penilaian_level_kecemasan_ranap_anak");
                    penilaian_lanjutan_resiko_jatuh_psikiatri = rs
                            .getBoolean("penilaian_lanjutan_resiko_jatuh_psikiatri");
                    penilaian_lanjutan_skrining_fungsional = rs.getBoolean("penilaian_lanjutan_skrining_fungsional");
                    penilaian_medis_ralan_rehab_medik = rs.getBoolean("penilaian_medis_ralan_rehab_medik");
                    laporan_anestesi = rs.getBoolean("laporan_anestesi");
                    template_persetujuan_penolakan_tindakan = rs.getBoolean("template_persetujuan_penolakan_tindakan");
                    penilaian_medis_ralan_gawat_darurat_psikiatri = rs
                            .getBoolean("penilaian_medis_ralan_gawat_darurat_psikiatri");
                    ...
                    bpjs_mapping_obat_apotek = rs.getBoolean("bpjs_mapping_obat_apotek");
                    pembayaran_bank_mandiri = rs.getBoolean("pembayaran_bank_mandiri");
                    penilaian_ulang_nyeri = rs.getBoolean("penilaian_ulang_nyeri");
                    penilaian_terapi_wicara = rs.getBoolean("penilaian_terapi_wicara");
                    bpjs_obat_23hari_apotek = rs.getBoolean("bpjs_obat_23hari_apotek");
                    pengkajian_restrain = rs.getBoolean("pengkajian_restrain");
                    bpjs_kunjungan_sep_apotek = rs.getBoolean("bpjs_kunjungan_sep_apotek");
                    bpjs_monitoring_klaim_apotek = rs.getBoolean("bpjs_monitoring_klaim_apotek");
                    bpjs_daftar_pelayanan_obat_apotek = rs.getBoolean("bpjs_daftar_pelayanan_obat_apotek");
                    penilaian_awal_medis_ralan_paru = rs.getBoolean("penilaian_awal_medis_ralan_paru");
                    catatan_keperawatan_ralan = rs.getBoolean("catatan_keperawatan_ralan");
                    catatan_persalinan = rs.getBoolean("catatan_persalinan");
                    skor_aldrette_pasca_anestesi = rs.getBoolean("skor_aldrette_pasca_anestesi");
                    skor_steward_pasca_anestesi = rs.getBoolean("skor_steward_pasca_anestesi");
                    skor_bromage_pasca_anestesi = rs.getBoolean("skor_bromage_pasca_anestesi");
                    penilaian_pre_induksi = rs.getBoolean("penilaian_pre_induksi");
                    hasil_usg_urologi = rs.getBoolean("hasil_usg_urologi");
                    hasil_usg_gynecologi = rs.getBoolean("hasil_usg_gynecologi");
                    hasil_pemeriksaan_ekg = rs.getBoolean("hasil_pemeriksaan_ekg");
                    hapus_edit_sep_bpjs = rs.getBoolean("hapus_edit_sep_bpjs");
                    satu_sehat_kirim_diet = rs.getBoolean("satu_sehat_kirim_diet");
                    satu_sehat_mapping_obat = rs.getBoolean("satu_sehat_mapping_obat");
                    dapur_ringkasan_pembelian = rs.getBoolean("dapur_ringkasan_pembelian");
                    satu_sehat_kirim_medication = rs.getBoolean("satu_sehat_kirim_medication");
                    satu_sehat_kirim_medicationrequest = rs.getBoolean("satu_sehat_kirim_medicationrequest");
                    penatalaksanaan_terapi_okupasi = rs.getBoolean("penatalaksanaan_terapi_okupasi");
                    satu_sehat_kirim_medicationdispense = rs.getBoolean("satu_sehat_kirim_medicationdispense");
                    hasil_usg_neonatus = rs.getBoolean("hasil_usg_neonatus");
                    hasil_endoskopi_faring_laring = rs.getBoolean("hasil_endoskopi_faring_laring");
                    satu_sehat_mapping_radiologi = rs.getBoolean("satu_sehat_mapping_radiologi");
                    satu_sehat_kirim_servicerequest_radiologi = rs
                            .getBoolean("satu_sehat_kirim_servicerequest_radiologi");
                    hasil_endoskopi_hidung = rs.getBoolean("hasil_endoskopi_hidung");
                    satu_sehat_kirim_specimen_radiologi = rs.getBoolean("satu_sehat_kirim_specimen_radiologi");
                    master_masalah_keperawatan_neonatus = rs.getBoolean("master_masalah_keperawatan_neonatus");
                    master_rencana_keperawatan_neonatus = rs.getBoolean("master_rencana_keperawatan_neonatus");
                    penilaian_awal_keperawatan_ranap_neonatus = rs
                            .getBoolean("penilaian_awal_keperawatan_ranap_neonatus");
                    satu_sehat_kirim_observation_radiologi = rs.getBoolean("satu_sehat_kirim_observation_radiologi");
                    satu_sehat_kirim_diagnosticreport_radiologi = rs
                            .getBoolean("satu_sehat_kirim_diagnosticreport_radiologi");
                    hasil_endoskopi_telinga = rs.getBoolean("hasil_endoskopi_telinga");
                    satu_sehat_mapping_lab = rs.getBoolean("satu_sehat_mapping_lab");
                    satu_sehat_kirim_servicerequest_lab = rs.getBoolean("satu_sehat_kirim_servicerequest_lab");
                    satu_sehat_kirim_servicerequest_labmb = rs.getBoolean("satu_sehat_kirim_servicerequest_labmb");
                    satu_sehat_kirim_specimen_lab = rs.getBoolean("satu_sehat_kirim_specimen_lab");
                    satu_sehat_kirim_specimen_labmb = rs.getBoolean("satu_sehat_kirim_specimen_labmb");
                    satu_sehat_kirim_observation_lab = rs.getBoolean("satu_sehat_kirim_observation_lab");
                    satu_sehat_kirim_observation_labmb = rs.getBoolean("satu_sehat_kirim_observation_labmb");
                    satu_sehat_kirim_diagnosticreport_lab = rs.getBoolean("satu_sehat_kirim_diagnosticreport_lab");
                    satu_sehat_kirim_diagnosticreport_labmb = rs.getBoolean("satu_sehat_kirim_diagnosticreport_labmb");
                    kepatuhan_kelengkapan_keselamatan_bedah = rs.getBoolean("kepatuhan_kelengkapan_keselamatan_bedah");
                    nilai_piutang_perjenis_bayar_per_bulan = rs.getBoolean("nilai_piutang_perjenis_bayar_per_bulan");
                    ringkasan_piutang_jenis_bayar = rs.getBoolean("ringkasan_piutang_jenis_bayar");
                    penilaian_pasien_imunitas_rendah = rs.getBoolean("penilaian_pasien_imunitas_rendah");
                    balance_cairan = rs.getBoolean("balance_cairan");
                    catatan_observasi_chbp = rs.getBoolean("catatan_observasi_chbp");
                    catatan_observasi_induksi_persalinan = rs.getBoolean("catatan_observasi_induksi_persalinan");
                    ...
                    referensi_poli_mobilejknfktp = rs.getBoolean("referensi_poli_mobilejknfktp");
                    referensi_dokter_mobilejknfktp = rs.getBoolean("referensi_dokter_mobilejknfktp");
                    skp_rekapitulasi_penilaian = rs.getBoolean("skp_rekapitulasi_penilaian");
                    pembayaran_pihak_ke3_bankmandiri = rs.getBoolean("pembayaran_pihak_ke3_bankmandiri");
                    metode_pembayaran_bankmandiri = rs.getBoolean("metode_pembayaran_bankmandiri");
                    bank_tujuan_transfer_bankmandiri = rs.getBoolean("bank_tujuan_transfer_bankmandiri");
                    kodetransaksi_tujuan_transfer_bankmandiri = rs
                            .getBoolean("kodetransaksi_tujuan_transfer_bankmandiri");
                    konsultasi_medik = rs.getBoolean("konsultasi_medik");
                    jawaban_konsultasi_medik = rs.getBoolean("jawaban_konsultasi_medik");
                    ...
                    data_sasaran_usialansia = rs.getBoolean("data_sasaran_usialansia");
                    skrining_perilaku_merokok_sekolah_remaja = rs
                            .getBoolean("skrining_perilaku_merokok_sekolah_remaja");
                    ...
                    skrining_risiko_kanker_payudara = rs.getBoolean("skrining_risiko_kanker_payudara");
                    skrining_risiko_kanker_paru = rs.getBoolean("skrining_risiko_kanker_paru");
                    skrining_tbc = rs.getBoolean("skrining_tbc");
                    skrining_kesehatan_gigi_mulut_remaja = rs.getBoolean("skrining_kesehatan_gigi_mulut_remaja");
                    penilaian_awal_keperawatan_ranap_bayi = rs.getBoolean("penilaian_awal_keperawatan_ranap_bayi");
                    booking_mcu_perusahaan = rs.getBoolean("booking_mcu_perusahaan");
                    ...
                    catatan_anestesi_sedasi = rs.getBoolean("catatan_anestesi_sedasi");
                    skrining_puma = rs.getBoolean("skrining_puma");
                    satu_sehat_kirim_careplan = rs.getBoolean("satu_sehat_kirim_careplan");
                    satu_sehat_kirim_medicationstatement = rs.getBoolean("satu_sehat_kirim_medicationstatement");
                    skrining_adiksi_nikotin = rs.getBoolean("skrining_adiksi_nikotin");
                    skrining_thalassemia = rs.getBoolean("skrining_thalassemia");
                    skrining_instrumen_sdq = rs.getBoolean("skrining_instrumen_sdq");
    ...
    private void setTampil() {
        ...
        if ("[A]Akses Ke Dokter Lain Rawat Jalan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[A]Akses Ke Dokter Lain Rawat Jalan", akses_dokter_lain_rawat_jalan});
        }
        ...
        if ("[C]Audit Pembuangan Benda Tajam & Jarum".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[C]Audit Pembuangan Benda Tajam & Jarum", audit_pembuangan_benda_tajam});
        }
        ...
        if ("[C]Audit Fasilitas Kebersihan Tangan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[C]Audit Fasilitas Kebersihan Tangan", audit_fasilitas_kebersihan_tangan});
        }
        ...
        if ("[C]Audit Pembuangan Limbah Cair Infeksius".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[C]Audit Pembuangan Limbah Cair Infeksius",
        ...
        if ("[D]Keuntungan Beri Obat, Alkes & BHP 2".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[D]Keuntungan Beri Obat, Alkes & BHP 2", keuntungan_beri_obat_nonpiutang});
        }
        ...
        if ("[D]Verifikasi Penerimaan Obat/Alkes/BHP".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[D]Verifikasi Penerimaan Obat/Alkes/BHP", verifikasi_penerimaan_farmasi});
        }
        ...
        if ("[D]Ringkasan Retur Suplier Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[D]Ringkasan Retur Suplier Obat & BHP", ringkasan_retur_suplier_obat});
        }

        if ("[D]Ringkasan Retur Pembeli Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[D]Ringkasan Retur Pembeli Obat & BHP", ringkasan_retur_pembeli_obat});
        }
        ...
        if ("[D]Ringkasan Biaya Obat Pasien Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[D]Ringkasan Biaya Obat Pasien Per Tanggal",
        ...
        if ("[D]Nilai Penerimaan Vendor Farmasi Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[D]Nilai Penerimaan Vendor Farmasi Per Bulan",
        ...
        if ("[E]Ringkasan Permintaan Barang Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[E]Ringkasan Permintaan Barang Non Medis", rekap_permintaan_non_medis});
        }
        ...
        if ("[E]Verifikasi Penerimaan Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[E]Verifikasi Penerimaan Non Medis", verifikasi_penerimaan_logistik});
        }
        ...
        if ("[E]Ringkasan Retur Suplier Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[E]Ringkasan Retur Suplier Non Medis", ringkasan_returbeli_nonmedis});
        }
        ...
        if ("[E]Nilai Penerimaan Vendor Non Medis Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[E]Nilai Penerimaan Vendor Non Medis Per Bulan",
        ...
        if ("[G]Rekap Pengajuan Aset Departemen".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[G]Rekap Pengajuan Aset Departemen", rekap_pengajuan_aset_departemen});
        }

        if ("[G]Permintaan Perbaikan Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[G]Permintaan Perbaikan Inventaris", permintaan_perbaikan_inventaris});
        }
        ...
        if ("[J]Skrining Pernapasan Ralan Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[J]Skrining Pernapasan Ralan Per Tahun",
        ...
        if ("[J]Bulanan Klasifikasi Pasien Ranap".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[J]Bulanan Klasifikasi Pasien Ranap", bulanan_klasifikasi_pasien_ranap});
        }

        if ("[J]Harian Klasifikasi Pasien Ranap".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[J]Harian Klasifikasi Pasien Ranap", harian_klasifikasi_pasien_ranap});
        }
        ...
        if ("[J]Laporan Tahunan Penolakan Anjuran Medis".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[J]Laporan Tahunan Penolakan Anjuran Medis",
        ...
        if ("[J]Pemeriksaan Fisik Ralan Per Penyakit".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[J]Pemeriksaan Fisik Ralan Per Penyakit",
        ...
        if ("[J]Kepatuhan Kelengkapan Keselamatan Bedah".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[J]Kepatuhan Kelengkapan Keselamatan Bedah",
        ...
        if ("[K]Validasi Titip Faktur/Tagihan Obat & BHP".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[K]Validasi Titip Faktur/Tagihan Obat & BHP",
        ...
        if ("[K]Validasi Titip Faktur/Tagihan Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[K]Validasi Titip Faktur/Tagihan Non Medis", validasi_tagihan_non_medis});
        }
        ...
        if ("[K]Validasi Titip Faktur/Tagihan Aset/Inventaris".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[K]Validasi Titip Faktur/Tagihan Aset/Inventaris", validasi_tagihan_aset});
        }
        ...
        if ("[K]Ringkasan Hutang Vendor Farmasi".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[K]Ringkasan Hutang Vendor Farmasi", ringkasan_hutang_vendor_farmasi});
        }

        if ("[K]Ringkasan Hutang Vendor Non Medis".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[K]Ringkasan Hutang Vendor Non Medis", ringkasan_hutang_vendor_nonmedis});
        }
        ...
        if ("[K]Validasi Persetujuan Pengajuan Biaya".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[K]Validasi Persetujuan Pengajuan Biaya",
        ...
        if ("[K]Nilai Piutang Per Cara Bayar Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[K]Nilai Piutang Per Cara Bayar Per Bulan",
        ...
        if ("[K]Ringkasan Piutang Per Cara Bayar".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[K]Ringkasan Piutang Per Cara Bayar", ringkasan_piutang_jenis_bayar});
        }

        if ("[K]Pembayaran Pihak Ke 3 Bank Mandiri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[K]Pembayaran Pihak Ke 3 Bank Mandiri", pembayaran_pihak_ke3_bankmandiri});
        }
        ...
        if ("[L]Referensi Ruang Rawat Inhealth".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[L]Referensi Ruang Rawat Inhealth", inhealth_referensi_jenpel_ruang_rawat});
        }
        ...
        if ("[L]Cek Rujukan Kartu PCare di VClaim".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[L]Cek Rujukan Kartu PCare di VClaim", bpjs_cek_rujukan_kartu_pcare});
        }
        ...
        if ("[L]Referensi Spesialistik Apotek BPJS".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[L]Referensi Spesialistik Apotek BPJS",
        ...
        if ("[L]Kirim Observation-TTV Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[L]Kirim Observation-TTV Satu Sehat", satu_sehat_kirim_observationttv});
        }
        ...
        if ("[L]Kirim Clinical Impression Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[L]Kirim Clinical Impression Satu Sehat",
        ...
        if ("[L]Referensi Setting PPK Apotek BPJS".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[L]Referensi Setting PPK Apotek BPJS", bpjs_referensi_setting_apotek});
        }
        ...
        if ("[L]Daftar Pelayanan Obat Apotek BPJS".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[L]Daftar Pelayanan Obat Apotek BPJS", bpjs_daftar_pelayanan_obat_apotek});
        }
        ...
        if ("[L]Kirim Medication Request Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[L]Kirim Medication Request Satu Sehat",
        ...
        if ("[L]Kirim Medication Dispense Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[L]Kirim Medication Dispense Satu Sehat",
        ...
        if ("[L]Mapping Tindakan Radiologi Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[L]Mapping Tindakan Radiologi Satu Sehat", satu_sehat_mapping_radiologi});
        }

        if ("[L]Kirim Service Request Radiologi Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[L]Kirim Service Request Radiologi Satu Sehat",
        ...
        if ("[L]Kirim Specimen Radiologi Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[L]Kirim Specimen Radiologi Satu Sehat",
        ...
        if ("[L]Kirim Observation Radiologi Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[L]Kirim Observation Radiologi Satu Sehat",
        ...
        if ("[L]Kirim Diagnostic Report Radiologi Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[L]Kirim Diagnostic Report Radiologi Satu Sehat",
        ...
        if ("[L]Mapping Tindakan Lab PK & MB Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[L]Mapping Tindakan Lab PK & MB Satu Sehat", satu_sehat_mapping_lab});
        }

        if ("[L]Kirim Service Request Lab PK Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[L]Kirim Service Request Lab PK Satu Sehat",
        ...
        if ("[L]Kirim Service Request Lab MB Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[L]Kirim Service Request Lab MB Satu Sehat",
        ...
        if ("[L]Kirim Specimen Lab PK Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[L]Kirim Specimen Lab PK Satu Sehat", satu_sehat_kirim_specimen_lab});
        }

        if ("[L]Kirim Specimen Lab MB Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[L]Kirim Specimen Lab MB Satu Sehat", satu_sehat_kirim_specimen_labmb});
        }

        if ("[L]Kirim Observation Lab PK Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[L]Kirim Observation Lab PK Satu Sehat", satu_sehat_kirim_observation_lab});
        }

        if ("[L]Kirim Observation Lab MB Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[L]Kirim Observation Lab MB Satu Sehat",
        ...
        if ("[L]Kirim Diagnostic Report Lab PK Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[L]Kirim Diagnostic Report Lab PK Satu Sehat",
        ...
        if ("[L]Kirim Diagnostic Report Lab MB Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[L]Kirim Diagnostic Report Lab MB Satu Sehat",
        ...
        if ("[L]Referensi Dokter Mobile JKN FKTP".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[L]Referensi Dokter Mobile JKN FKTP", referensi_dokter_mobilejknfktp});
        }
        ...
        if ("[L]Bank Tujuan Transfer Bank Mandiri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[L]Bank Tujuan Transfer Bank Mandiri", bank_tujuan_transfer_bankmandiri});
        }

        if ("[L]Kode Transaksi Tujuan Transfer Bank Mandiri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[L]Kode Transaksi Tujuan Transfer Bank Mandiri",
        ...
        if ("[L]Kirim Medication Statement Satu Sehat".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[L]Kirim Medication Statement Satu Sehat",
        ...
        if ("[M]Penilaian Awal Keperawatan Ralan Umum".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Keperawatan Ralan Umum",
        ...
        if ("[M]Penilaian Awal Keperawatan Gigi".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[M]Penilaian Awal Keperawatan Gigi", penilaian_awal_keperawatan_gigi});
        }

        if ("[M]Master Masalah Keperawatan Gigi".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[M]Master Masalah Keperawatan Gigi", master_masalah_keperawatan_gigi});
        }

        if ("[M]Penilaian Awal Keperawatan Ralan Kebidanan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Keperawatan Ralan Kebidanan",
        ...
        if ("[M]Penilaian Awal Keperawatan Ralan Bayi/Anak".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Keperawatan Ralan Bayi/Anak",
                penilaian_awal_keperawatan_anak});
        }

        if ("[M]Master Masalah Keperawatan Bayi/Anak".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[M]Master Masalah Keperawatan Bayi/Anak", master_masalah_keperawatan_anak});
        }
        ...
        if ("[M]Penilaian Awal Keperawatan Ranap Kebidanan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Keperawatan Ranap Kebidanan",
        ...
        if ("[M]Master Masalah Keperawatan Mata".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[M]Master Masalah Keperawatan Mata", master_masalah_keperawatan_mata});
        }

        if ("[M]Penilaian Awal Keperawatan Ralan Mata".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Keperawatan Ralan Mata",
        ...
        if ("[M]Penilaian Awal Medis Ranap Kandungan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Medis Ranap Kandungan",
        ...
        if ("[M]Penilaian Awal Medis Ralan Kandungan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Medis Ralan Kandungan",
        ...
        if ("[M]Penilaian Awal Medis Ralan Bayi/Anak".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[M]Penilaian Awal Medis Ralan Bayi/Anak", penilaian_awal_medis_ralan_anak});
        }
        ...
        if ("[M]Penilaian Awal Keperawatan Ranap Umum".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Keperawatan Ranap Umum",
        ...
        if ("[M]Master Rencana Keperawatan Bayi/Anak".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[M]Master Rencana Keperawatan Bayi/Anak", master_rencana_keperawatan_anak});
        }
        ...
        if ("[M]Catatan Observasi Ranap Kebidanan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[M]Catatan Observasi Ranap Kebidanan", catatan_observasi_ranap_kebidanan});
        }

        if ("[M]Catatan Observasi Ranap Post Partum".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Catatan Observasi Ranap Post Partum",
        ...
        if ("[M]Penilaian Awal Medis Ralan Psikiatri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Medis Ralan Psikiatri",
        ...
        if ("[M]Penilaian Awal Medis Ralan Penyakit Dalam".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Medis Ralan Penyakit Dalam",
        ...
        if ("[M]Penilaian Awal Medis Ralan Mata".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[M]Penilaian Awal Medis Ralan Mata", penilaian_awal_medis_ralan_mata});
        }

        if ("[M]Penilaian Awal Medis Ralan Neurologi".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Medis Ralan Neurologi",
        ...
        if ("[M]Penilaian Awal Medis Ralan Orthopedi".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Medis Ralan Orthopedi",
                penilaian_awal_medis_ralan_orthopedi});
        }

        if ("[M]Penilaian Awal Medis Ralan Bedah".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[M]Penilaian Awal Medis Ralan Bedah", penilaian_awal_medis_ralan_bedah});
        }
        ...
        if ("[M]Master Rencana Keperawatan Gigi".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[M]Master Rencana Keperawatan Gigi", master_rencana_keperawatan_gigi});
        }

        if ("[M]Master Rencana Keperawatan Mata".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[M]Master Rencana Keperawatan Mata", master_rencana_keperawatan_mata});
        }
        ...
        if ("[M]Master Masalah Keperawatan Psikiatri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Master Masalah Keperawatan Psikiatri",
        ...
        if ("[M]Master Rencana Keperawatan Psikiatri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Master Rencana Keperawatan Psikiatri",
        ...
        if ("[M]Penilaian Awal Keperawatan Ralan Psikiatri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Keperawatan Ralan Psikiatri",
        ...
        if ("[M]Penilaian Lanjutan Resiko Jatuh Dewasa".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Lanjutan Resiko Jatuh Dewasa",
        ...
        if ("[M]Penilaian Lanjutan Risiko Jatuh Anak".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Lanjutan Risiko Jatuh Anak",
        ...
        if ("[M]Penilaian Awal Medis Ralan Geriatri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Medis Ralan Geriatri",
        ...
        if ("[M]Penilaian Tambahan Pasien Geriatri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Tambahan Pasien Geriatri",
        ...
        if ("[M]Penilaian Lanjutan Risiko Jatuh Lansia".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Lanjutan Risiko Jatuh Lansia",
        ...
        if ("[M]Penilaian Pasien Penyakit Menular".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[M]Penilaian Pasien Penyakit Menular", penilaian_pasien_penyakit_menular});
        }
        ...
        if ("[M]Edukasi Pasien & Keluarga Rawat Jalan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[M]Edukasi Pasien & Keluarga Rawat Jalan", edukasi_pasien_keluarga_rj});
        }
        ...
        if ("[M]Penilaian Tambahan Perilaku Kekerasan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Tambahan Perilaku Kekerasan",
        ...
        if ("[M]Penilaian Tambahan Melarikan Diri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Tambahan Melarikan Diri",
        ...
        if ("[M]Penilaian Awal Medis Ralan Bedah Mulut".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Medis Ralan Bedah Mulut",
        ...
        if ("[M]Penilaian Awal Keperawatan Ralan Geriatri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Keperawatan Ralan Geriatri",
        ...
        if ("[M]Master Masalah Keperawatan Geriatri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Master Masalah Keperawatan Geriatri",
        ...
        if ("[M]Master Rencana Keperawatan Geriatri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Master Rencana Keperawatan Geriatri",
        ...
        if ("[M]Penilaian Lanjutan Risiko Jatuh Neonatus".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Lanjutan Risiko Jatuh Neonatus",
        ...
        if ("[M]Penilaian Lanjutan Risiko Jatuh Geriatri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Lanjutan Risiko Jatuh Geriatri",
        ...
        if ("[M]Penilaian Awal Medis Ralan Kulit & Kelamin".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Medis Ralan Kulit & Kelamin",
        ...
        if ("[M]Penilaian Awal Medis Pasien Hemodialisa".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[M]Penilaian Awal Medis Pasien Hemodialisa", penilaian_medis_hemodialisa});
        }

        if ("[M]Penilaian Level Kecemasan Ranap Anak".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Level Kecemasan Ranap Anak",
        ...
        if ("[M]Penilaian Lanjutan Risiko Jatuh Psikiatri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Lanjutan Risiko Jatuh Psikiatri",
        ...
        if ("[M]Penilaian Lanjutan Skrining Fungsional".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Lanjutan Skrining Fungsional",
        ...
        if ("[M]Penilaian Awal Medis Ralan Fisik & Rehabilitasi".toLowerCase()
            ...
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Medis Ralan Fisik & Rehabilitasi",
        ...
        if ("[M]Penilaian Awal Medis IGD Psikiatri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Medis IGD Psikiatri",
        ...
        if ("[M]Penilaian Awal Medis Ralan Paru".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[M]Penilaian Awal Medis Ralan Paru", penilaian_awal_medis_ralan_paru});
        }
        ...
        if ("[M]Master Masalah Keperawatan Neonatus".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Master Masalah Keperawatan Neonatus",
        ...
        if ("[M]Master Rencana Keperawatan Neonatus".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Master Rencana Keperawatan Neonatus",
        ...
        if ("[M]Penilaian Awal Keperawatan Ranap Neonatus".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Keperawatan Ranap Neonatus",
        ...
        if ("[M]Penilaian Pasien Imunitas Rendah".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[M]Penilaian Pasien Imunitas Rendah", penilaian_pasien_imunitas_rendah});
        }
        ...
        if ("[M]Catatan Observasi Induksi Persalinan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Catatan Observasi Induksi Persalinan",
        ...
        if ("[M]Skrining Merokok Usia Sekolah & Remaja".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Skrining Merokok Usia Sekolah & Remaja",
        ...
        if ("[M]Skrining Kekerasan Pada Perempuan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[M]Skrining Kekerasan Pada Perempuan", skrining_kekerasan_pada_perempuan});
        }
        ...
        if ("[M]Skrining Risiko Kanker Payudara".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[M]Skrining Risiko Kanker Payudara", skrining_risiko_kanker_payudara});
        }
        ...
        if ("[M]Skrining Kesehatan Gigi & Mulut Remaja".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Skrining Kesehatan Gigi & Mulut Remaja",
        ...
        if ("[M]Penilaian Awal Keperawatan Ranap Bayi/Anak".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Penilaian Awal Keperawatan Ranap Bayi/Anak",
        ...
        if ("[M]Catatan Observasi Restrain Nonfarmakologi".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Catatan Observasi Restrain Nonfarmakologi",
        ...
        if ("[M]Pemantauan PEWS Pasien Maternal".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Pemantauan PEWS Pasien Maternal", pemantauan_pews_maternal});
        }

        if ("[M]Validasi SBAR".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[M]Validasi SBAR", validasi_sbar});
        }
        ...
        if ("[O]Limbah Padat Domestik Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[O]Limbah Padat Domestik Per Tanggal", grafik_limbahdomestik_pertanggal});
        }

        if ("[O]Limbah Padat Domestik Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[O]Limbah Padat Domestik Per Bulan", grafik_limbahdomestik_perbulan});
        }
        ...
        if ("[O]Pengajuan Aset Per Departemen".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[O]Pengajuan Aset Per Departemen", grafik_pengajuan_aset_departemen});
        }
        ...
        if ("[O]Penerimaan Obat, Alkes & BHP Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[O]Penerimaan Obat, Alkes & BHP Per Bulan", penerimaan_obat_perbulan});
        }
        ...
        if ("[O]Perbaikan Inventaris Per Tanggal".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[O]Perbaikan Inventaris Per Tanggal",
                grafik_perbaikan_inventaris_pertanggal});
        }

        if ("[O]Perbaikan Inventaris Per Bulan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[O]Perbaikan Inventaris Per Bulan", grafik_perbaikan_inventaris_perbulan});
        }

        if ("[O]Perbaikan Inventaris Per Tahun".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[O]Perbaikan Inventaris Per Tahun", grafik_perbaikan_inventaris_pertahun});
        }

        if ("[O]Perbaikan Inventaris Per Pelaksana & Status".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[O]Perbaikan Inventaris Per Pelaksana & Status",
        ...
        if ("[P]Pulang Atas Permintaan Sendiri".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[P]Pulang Atas Permintaan Sendiri", surat_pulang_atas_permintaan_sendiri});
        }
        ...
        if ("[P]Persetujuan Penundaan Pelayanan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[P]Persetujuan Penundaan Pelayanan", persetujuan_penundaan_pelayanan});
        }
        ...
        if ("[P]Template Persetujuan Penolakan Tindakan".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[P]Template Persetujuan Penolakan Tindakan",
        ...
        if ("[S]Ket Pengeluaran Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[S]Ket Pengeluaran Penerima Dankes", zis_pengeluaran_penerima_dankes});
        }

        if ("[S]Ket Penghasilan Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[S]Ket Penghasilan Penerima Dankes", zis_penghasilan_penerima_dankes});
        }
        ...
        if ("[S]Dinding Rumah Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[S]Dinding Rumah Penerima Dankes", zis_dinding_rumah_penerima_dankes});
        }
        ...
        if ("[S]Kepemilikan Rumah Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(new Object[]{false, "[S]Kepemilikan Rumah Penerima Dankes",
        ...
        if ("[S]Kategori PHBS Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode
                    .addRow(new Object[]{false, "[S]Kategori PHBS Penerima Dankes", zis_kategori_phbs_penerima_dankes});
        }
        ...
        if ("[S]Jenis Simpanan Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[S]Jenis Simpanan Penerima Dankes", zis_jenis_simpanan_penerima_dankes});
        }

        if ("[S]Kategori Asnaf Penerima Dankes".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[S]Kategori Asnaf Penerima Dankes", zis_kategori_asnaf_penerima_dankes});
        }
        ...
        if ("[T]Integrasi Khanza Health Services".toLowerCase().contains(TCari.getText().toLowerCase())) {
            tabMode.addRow(
                    new Object[]{false, "[T]Integrasi Khanza Health Services", integrasi_khanza_health_services});
        }
    }
    ...
    private void Simpan() {
        for (i = 0; i < tbUser.getRowCount(); i++) {
            ...
            if ("[A]Periksa Radiologi".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "periksa_radiologi='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[A]Rujukan Poli Internal".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "rujukan_poli_internal='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[A]Booking Registrasi".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "booking_registrasi='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[A]Permintaan Radiologi".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "permintaan_radiologi='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[A]Catatan Dokter".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "catatan_perawatan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[A]Asesmen Awal Rawat Inap".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pengkajian_askep='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[A]Skrining Rawat Jalan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "sekrining_rawat_jalan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[A]Perkiraan Biaya Ranap".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "perkiraan_biaya_ranap='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[A]Periksa Lab MB".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pemeriksaan_lab_mb='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[A]Ubah Petugas Lab MB".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "ubah_petugas_lab_mb='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[A]Akses Ke Dokter Lain Rawat Jalan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "akses_dokter_lain_rawat_jalan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[A]Booking MCU Perusahaan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "booking_mcu_perusahaan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[C]Presensi Bulanan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "presensi_bulanan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[C]Temporary Presensi".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "temporary_presensi='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[C]Master Berkas Pegawai".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "master_berkas_pegawai='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[C]Berkas Kepegawaian".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "berkas_kepegawaian='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[C]Riwayat Pendidikan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "riwayat_pendidikan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[C]Riwayat Naik Gaji".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "riwayat_naik_gaji='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[C]Riwayat Penghargaan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "riwayat_penghargaan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[C]Riwayat Penelitian".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "riwayat_penelitian='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[C]Jenis Cidera K3".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "jenis_cidera_k3rs='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[C]Lokasi Kejadian K3".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "lokasi_kejadian_k3rs='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[C]Dampak Cidera K3".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "dampak_cidera_k3rs='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[C]Jenis Pekerjaan K3".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "jenis_pekerjaan_k3rs='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[C]Bagian Tubuh K3".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "bagian_tubuh_k3rs='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[C]Rekapitulasi Penilaian SKP".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "skp_rekapitulasi_penilaian='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[D]Stok Opname Apotek".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "stok_opname_obat='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[D]Stok Obat Pasien".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "stok_obat_pasien='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[D]Keuntungan Beri Obat, Alkes & BHP 2".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "keuntungan_beri_obat_nonpiutang='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[D]Riwayat Obat, Alkes & BHP".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "riwayat_obat_alkes_bhp='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[D]Pengguna Obat/Alkes/BHP Resep".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pengguna_obat_resep='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[D]Riwayat Batch".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "riwayat_data_batch='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[D]Kegiatan Farmasi".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "kegiatan_farmasi='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[D]Kadaluarsa Batch".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "kadaluarsa_batch='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[D]Pengajuan Obat & BHP".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pengajuan_barang_medis='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[D]10 Obat Terbanyak Poli".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "10_obat_terbanyak_poli='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[D]Rekap Obat Per Pasien".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "rekap_obat_pasien='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[D]Stok Akhir Farmasi Per Tanggal".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "stok_akhir_farmasi_pertanggal='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[D]Permintaan Resep Pulang".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "permintaan_resep_pulang='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[D]Ringkasan Biaya Obat Pasien Per Tanggal".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "ringkasan_biaya_obat_pasien_pertanggal='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[D]Nilai Penerimaan Vendor Farmasi Per Bulan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "nilai_penerimaan_vendor_farmasi_perbulan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[D]Obat/Alkes/BHP Tidak Bergerak".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "obat_bhp_tidakbergerak='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[E]Nilai Penerimaan Vendor Non Medis Per Bulan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "nilai_penerimaan_vendor_nonmedis_perbulan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[G]Ruang Inventaris".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "inventaris_ruang='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[G]Produsen Inventaris".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "inventaris_produsen='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[G]Koleksi Inventaris".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "inventaris_koleksi='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[G]Inventaris".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "inventaris_inventaris='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[G]Sirkulasi Inventaris".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "inventaris_sirkulasi='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[G]Pemakaian Air PDAM".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pemakaian_air_pdam='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[G]Pengajuan Aset/Inventaris".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pengajuan_asetinventaris='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[G]Rekap Pengajuan Aset Departemen".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "rekap_pengajuan_aset_departemen='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[G]Permintaan Perbaikan Inventaris".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "permintaan_perbaikan_inventaris='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[H]Rekap Parkir Harian".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "parkir_rekap_harian='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[H]Rekap Parkir Bulanan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "parkir_rekap_bulanan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[I]Harian Dokter Poli".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "harian_tindakan_poli='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[I]Obat Per Dokter Ralan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "obat_per_dokter_ralan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[I]Obat Per Dokter Ranap".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "obat_per_dokter_ranap='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[I]Harian Dokter Ralan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "harian_tindakan_dokter='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[I]Fee Visit Dokter".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "fee_visit_dokter='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[I]Fee Rujukan Rontgen".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "fee_rujukan_rontgen='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[I]Fee Rujukan Ranap".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "fee_rujukan_ranap='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[I]Obat Per Dokter Peresep".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "obat_per_dokter_peresep='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[I]Obat Per Cara Bayar".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "obat_per_cara_bayar='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[I]Harian BHP Medis/Paket Obat".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "harian_paket_bhp='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[I]Bulanan BHP Medis/Paket Obat".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "bulanan_paket_bhp='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[I]Harian Menejemen".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "harian_menejemen='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[I]Bulanan Menejemen".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "bulanan_menejemen='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[I]Pembayaran Per Unit".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pembayaran_per_unit='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[I]Rekap Pembayaran Per Unit".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "rekap_pembayaran_per_unit='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[I]Detail VK/OK".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "detail_tindakan_okvk='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[I]Pembayaran Per Akun Bayar".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pembayaran_akun_bayar='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[I]Piutang Per Akun Piutang".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "piutang_akun_piutang='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[I]Rekap Biaya Registrasi".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "rekap_biaya_registrasi='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[J]Surveilans Ralan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "surveilans_ralan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[J]Surveilans Ranap".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "surveilans_ranap='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[J]Pny.Tdk Menular Ranap".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pny_takmenular_ranap='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[J]Pny.Tdk Menular Ralan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pny_takmenular_ralan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[J]Sensus Harian Poli".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "sensus_harian_poli='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[J]Lama Pelayanan Ralan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "lama_pelayanan_ralan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[J]Lama Pelayanan Apotek".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "lama_pelayanan_apotek='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[J]Pny Menular Ranap".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "penyakit_menular_ranap='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[J]Pny Menular Ralan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "penyakit_menular_ralan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[J]Pembatalan Periksa Per Dokter".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pembatalan_periksa_dokter='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[J]Sensus Harian Ralan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "sensus_harian_ralan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[J]Insiden Keselamatan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "insiden_keselamatan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[J]Demografi Umur Kunjungan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "demografi_umur_kunjungan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[J]Lama Pelayanan Pasien".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "lama_pelayanan_pasien='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[K]Bayar Pesan Obat".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "bayar_pemesanan_obat='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[K]Pengaturan Rekening".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pengaturan_rekening='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[K]Rincian Piutang Pasien".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "rincian_piutang_pasien='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[K]Piutang Per Cara Bayar".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "detail_piutang_penjab='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[K]Bayar Pesan Non Medis".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "bayar_pesan_non_medis='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[K]Bayar Pesan Aset/Inventaris".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "bayar_pemesanan_iventaris='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[K]Hutang Barang Non Medis".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "hutang_barang_non_medis='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[K]Penagihan Piutang Pasien".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "penagihan_piutang_pasien='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[K]Akun Penagihan Piutang".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "akun_penagihan_piutang='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[K]Set Tarif Online".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "set_tarif_online='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[K]Klaim Rawat Jalan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "klaim_rawat_jalan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[K]Kategori Pengeluaran Harian".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "kategori_pengeluaran_harian='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[K]Kategori Pemasukan Lain-lain".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "kategori_pemasukan_lain='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
    ...
    private void Simpan2() {
        for (i = 0; i < tbUser.getRowCount(); i++) {
            ...
            if ("[L]Referensi Faskes Sisrute".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "sisrute_referensi_faskes='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[L]Referensi Alasan Rujuk Sisrute".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "sisrute_referensi_alasanrujuk='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[L]Referensi Diagnosa Sisrute".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "sisrute_referensi_diagnosa='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[L]Rujukan Masuk Sisrute".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "sisrute_rujukan_masuk='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[L]Rujukan Keluar Sisrute".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "sisrute_rujukan_keluar='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[L]Diagnosa Pasien Corona".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "diagnosa_pasien_corona='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[L]Perawatan Pasien Corona".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "perawatan_pasien_corona='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[L]Referensi Diagnosa PRB VClaim".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "bpjs_diagnosa_prb='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[L]Surat Kontrol VClaim".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "bpjs_surat_kontrol='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[M]Pasien Meninggal".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pasien_meninggal='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[M]Peminjaman Berkas RM".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "peminjaman_berkas='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[M]Klasifikasi Pasien Ranap".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "klasifikasi_pasien_ranap='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[M]Instansi/Perusahaan Pasien".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "perusahaan_pasien='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[M]Berkas Digital Perawatan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "berkas_digital_perawatan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[M]Pengaduan/Chat".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pengaduan_pasien='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[M]Insiden Keselamatan Pasien".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "insiden_keselamatan_pasien='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[M]Riwayat Kamar Pasien".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "riwayat_kamar_pasien='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[M]Hapus Berkas Digital Perawatan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "hapus_berkas_digital_perawatan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[N]Pengambilan BHP Medis".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pengambilan_utd2='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[N]Pengambilan BHP Non Medis".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pengambilan_penunjang_utd2='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[N]BHP Non Medis Rusak".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "utd_penunjang_rusak='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[N]Komponen Darah".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "utd_komponen_darah='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[N]Pemisahan Darah".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "utd_pemisahan_darah='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[N]Penyerahan Darah".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "utd_penyerahan_darah='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
    ...
    private void Simpan3() {
        for (i = 0; i < tbUser.getRowCount(); i++) {
            ...
            if ("[P]Klasifikasi Surat".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "surat_klasifikasi='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[P]Pengumuman E-Pasien".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "pengumuman_epasien='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[P]Surat Bebas Narkoba".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "surat_bebas_narkoba='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[P]Surat Keterangan Covid".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "surat_keterangan_covid='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[P]Surat Cuti Hamil".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "surat_cuti_hamil='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[P]Surat Keterangan Rawat Inap".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "surat_keterangan_rawat_inap='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[P]Surat Keterangan Sehat".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "surat_keterangan_sehat='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[P]Surat Keterangan Sakit Pihak 2".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "surat_sakit_pihak_2='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[R]Pendapatan Harian Toko".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "toko_pendapatan_harian='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[R]Bayar Piutang Toko".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "toko_bayar_piutang='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[R]Piutang Harian Toko".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "toko_piutang_harian='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[R]Penjualan Harian Toko".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "toko_penjualan_harian='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[R]Bayar Pesan Toko".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "toko_bayar_pemesanan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[R]Retur Jual Piutang".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "toko_retur_piutang='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[T]Set Penggunaan Tarif".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "set_penggunaan_tarif='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[T]Biaya Masuk Sekali".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "biaya_masuk_sekali='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[T]Set Harga Obat Ralan".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "set_harga_obat_ralan='" + tbUser.getValueAt(i, 2).toString() + "'");
            }

            if ("[T]Set Harga Obat Ranap".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "set_harga_obat_ranap='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[T]Set Keterlambatan Presensi".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "keterlambatan_presensi='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[T]Set Input Parsial".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "set_input_parsial='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[T]Password BPJS".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "password_asuransi='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
            ...
            if ("[T]Integrasi Khanza Health Services".equals(tbUser.getValueAt(i, 1).toString())) {
                Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + TKd.getText() + "','nur')",
                        "integrasi_khanza_health_services='" + tbUser.getValueAt(i, 2).toString() + "'");
            }
        }
