...
public class DlgSetAplikasi extends javax.swing.JDialog {
    ...
    public DlgSetAplikasi(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Nama Toko", "Alamat Toko", "Kota", "Propinsi", "Aktifkan?", "Wallpaper", "KontaK", "Email",
            "Logo", "Kode PPK BPJS", "Kode PPK Inhealth", "Kode PPK Kemenkes"};
        ...
        try {
            ...
            while (rs.next()) {
                Object[] data = {rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5),
                    rs.getBlob(6), rs.getString(7), rs.getString(8), rs.getBlob(9), rs.getString(10),
    ...
    private void getData() {
        ...
        if (row != -1) {
            ...
            try {
                try (ResultSet hasil = koneksi.prepareStatement("select wallpaper,logo from setting").executeQuery()) {
                    for (int I = 0; hasil.next(); I++) {
                        ...
                        ((Painter) PhotoLogo)
                                .setImageIcon(new javax.swing.ImageIcon(blob2.getBytes(1, (int) (blob2.length()))));
                        blob2.free();
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(DlgSetAplikasi.class.getName());
