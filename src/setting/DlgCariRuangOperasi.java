 ...
 * @author dosen
 */
public class DlgCariRuangOperasi extends javax.swing.JDialog {
    ...
    public DlgCariRuangOperasi(java.awt.Frame parent, boolean modal) {
        ...
        setSize(656, 250);
        tabMode = new DefaultTableModel(null, new String[]{"Kode Ruang",
            "Nama Ruang Operasi"}) {
            @Override
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        ...
        ruangoperasi.isCek();
        ruangoperasi.setSize(internalFrame1.getWidth(), internalFrame1.
                getHeight());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariRuangOperasi dialog = new DlgCariRuangOperasi(
    ...
    private void tampil() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select * from ruang_ok order by nm_ruang_ok");
            try {
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(
            ...
            fileWriter.write("{\"ruangoperasi\":[" + iyem.substring(0, iyem.
                    length() - 1) + "]}");
            fileWriter.flush();
            fileWriter.close();
            iyem = null;
        ...
        try {
            ...
            if (response.isArray()) {
                for (JsonNode list : response) {
                    if (list.path("NamaRuang").asText().toLowerCase().contains(
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgCariRuangOperasi.class.getName());
}
