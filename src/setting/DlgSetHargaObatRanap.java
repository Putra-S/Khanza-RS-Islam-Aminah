 ...
 * @author dosen
 */
public class DlgSetHargaObatRanap extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (nmpj.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("set_harga_obat_ranap",
                    "'" + kdpj.getText() + "','" + Kelas.getSelectedItem() + "','" + harga.
                    getText() + "'", "Jenis Bayar");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.hapusTable(tabMode, kdpj, "set_harga_obat_ranap",
                    "kelas='" + Kelas.getSelectedItem() + "' and kd_pj");
            tampil();
            emptTeks();
        }
...
private void hargaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_hargaKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSetHargaObatRanap dialog = new DlgSetHargaObatRanap(
    ...
    private void tampil() {
        String sql = "select set_harga_obat_ranap.kd_pj,penjab.png_jawab, set_harga_obat_ranap.hargajual, set_harga_obat_ranap.kelas "
                ...
                + "where set_harga_obat_ranap.kd_pj like '%" + TCari.getText().
                        trim() + "%' or "
                + "penjab.png_jawab like '%" + TCari.getText().trim() + "%' or "
                + "set_harga_obat_ranap.hargajual like '%" + TCari.getText().
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgSetHargaObatRanap.class.getName());
