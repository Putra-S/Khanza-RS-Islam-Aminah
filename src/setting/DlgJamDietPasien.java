...
public class DlgJamDietPasien extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        Sequel.menyimpan("jam_diet_pasien", "?,?", "Waktu", 2, new String[]{
            cmbWaktu.getSelectedItem().toString(),
            cmbJam1.getSelectedItem() + ":" + cmbMnt1.getSelectedItem()
        });
        tampil();
        emptTeks();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (int i = 0; i < tbJadwal.getRowCount(); i++) {
            if (tbJadwal.getValueAt(i, 0).toString().equals("true")) {
                if (Sequel.queryutf2(
                        "delete from jam_diet_pasien where waktu='" + tbJadwal.
                                getValueAt(i, 1).toString() + "'") == false) {
                    JOptionPane.showMessageDialog(null,
                            "Maaf, Tidak bisa dihapus karena data digunakan...!!!!");
                }
            }
        }
        tampil();
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptJamDietPasien.jasper", "report",
                    "::[ Jam Diet Pasien ]::",
                    "select * from jam_diet_pasien where waktu like '%" + TCari.
                            getText().trim() + "%' order by waktu", param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJamDietPasien dialog = new DlgJamDietPasien(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from jam_diet_pasien where waktu like ? order by waktu");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(DlgJamDietPasien.class.
            getName());
}
