...
public class DlgSetInputParsial extends javax.swing.JDialog {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdpj.getText().trim().isEmpty() || nmpj.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("set_input_parsial", "kd_pj=?", "kd_pj=?", 2,
                        new String[]{
                            kdpj.getText(), tabMode.getValueAt(tbSpesialis.
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdpj.getText().trim().isEmpty() || nmpj.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("set_input_parsial", "?", "Cara Bayar", 1,
                    new String[]{
                        kdpj.getText()
                    });
            tampil();
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select set_input_parsial.kd_pj,penjab.png_jawab "
    ...
    private static final Logger LOG = Logger.getLogger(DlgSetInputParsial.class.getName());
