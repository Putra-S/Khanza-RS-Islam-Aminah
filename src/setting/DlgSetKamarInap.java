...
public class DlgSetKamarInap extends javax.swing.JDialog {
    ...
    public DlgSetKamarInap(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Jam Minimal Dihitung di Kamar", "Hitung Hari dari Awal Masuk", "Fee Perujuk Ranap",
            "Aktifkan Diagnosa Akhir", "Biaya Ranap Gabung Bayi", "Aktifkan Hapus Data Salah",
            "Aktifkan Kamar Inap di Ralan", "Ijinkan User Merubah Status Kamar"};
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (Bayi.getText().trim().isEmpty()) {
            Valid.textKosong(Bayi, "Biaya Ranap Gabung Bayi");
        } else if (fee.getText().trim().isEmpty()) {
            Valid.textKosong(fee, "Fee Perujuk Ranap");
        } else if (tabMode.getRowCount() == 0) {
            Sequel.menyimpan("set_jam_minimal",
                    "'" + Jam.getText() + "','" + cmbYes.getSelectedItem() + "','" + fee.
                    getText() + "','" + cmbYes2.getSelectedItem() + "','" + Bayi.
                    getText() + "','" + cmbYes3.getSelectedItem() + "','" + cmbYes4.
                    getSelectedItem() + "','" + cmbYes5.getSelectedItem() + "'",
                    "Set Kamar Inap");
            tampil();
            emptTeks();
        } else if (tabMode.getRowCount() > 0) {
            JOptionPane.showMessageDialog(null,
                    "Maaf, Hanya diijinkan satu setup ...!!!!");
            Jam.requestFocus();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Jam.requestFocus();
        } else if (Jam.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null,
...
private void JamKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JamKeyPressed
    ...
    private static final Logger LOG = Logger.getLogger(DlgSetKamarInap.class.getName());
