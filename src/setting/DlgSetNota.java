...
public class DlgSetNota extends javax.swing.JDialog {
    ...
    private String laborat = "No", radiologi = "No", operasi = "No", obat = "No", ranap_dokter = "No",
            ranap_paramedis = "No", ralan_dokter = "No", ralan_paramedis = "No", tambahan = "No", potongan = "No",
...
private void NotaRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NotaRalanKeyPressed
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{" Cetak Nota/Kwitansi Saat Menyimpan di Billing Rawat Jalan",
                        rs.getString(9)});
                    tabMode.addRow(new Object[]{" Cetak Nota/Kwitansi Saat Menyimpan di Billing Rawat Inap",
                        rs.getString(10)});
                    ...
                    tabMode.addRow(new Object[]{" Cetak Nota/Kwitansi Saat Menyimpan di Penjualan Obat Bebas",
                        rs.getString(23)});
                    ...
                    tabMode.addRow(
                            new Object[]{" Cetak Nota/Kwitansi Saat Menyimpan di Penjualan Toko", rs.getString(27)});
    ...
    private static final Logger LOG = Logger.getLogger(DlgSetNota.class.getName());
