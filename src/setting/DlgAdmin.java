...
public class DlgAdmin extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("admin",
                    "AES_ENCRYPT('" + TKd.getText() + "','nur'),AES_ENCRYPT('" + TNm.
                    getText() + "','windi')", "Kode Admin");
            tampil();
            emptTeks();
        } else if (tabMode.getRowCount() > 0) {
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select AES_DECRYPT(usere,'nur'),AES_DECRYPT(passworde,'windi') from admin");
            try {
                rs = ps.executeQuery();
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgAdmin.class.getName());
}
