...
public class DlgRunTeks extends javax.swing.JDialog {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TTeks.getText().trim().isEmpty()) {
            ...
            if (EGb.getText().trim().isEmpty()) {
                Sequel.mengedit("runtext", "teks='" + TTeks.getText() + "'",
                        "aktifkan='" + YesNo.getSelectedItem() + "'");
            } else {
                Sequel.mengedit("runtext", "teks='" + TTeks.getText() + "'",
                        "aktifkan='" + YesNo.getSelectedItem() + "',gambar=?",
                        EGb);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TTeks.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("runtext", "'" + TTeks.getText() + "','" + YesNo.
                    getSelectedItem() + "'", "Display", EGb);
            tampil();
            emptTeks();
        } else if (tabMode.getRowCount() > 0) {
...
private void TTeksKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TTeksKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                DlgRunTeks dialog = new DlgRunTeks(new javax.swing.JFrame(),
                        true);
        ...
        if (row != -1) {
            ...
            try {
                try (ResultSet hasil = koneksi.createStatement().executeQuery(
                        "select gambar from runtext where teks='" + tabMode.
    ...
    private static final Logger LOG = Logger.getLogger(DlgRunTeks.class.
            getName());
