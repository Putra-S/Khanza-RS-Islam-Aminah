...
public class DlgPenelusuranLogin extends javax.swing.JDialog {
    ...
    private void BtnExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnExcelActionPerformed
        if (TabRawat.getSelectedIndex() == 0) {
            Valid.exportToExcel(tbObat);
        } else if (TabRawat.getSelectedIndex() == 1) {
            Valid.exportToExcel(tbObat1);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select tracker.nip,tracker.tgl_login,tracker.jam_login from tracker  "
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString(1),
                        Sequel.cariIsi("select pegawai.nama from pegawai where pegawai.nik=?", rs.getString(1)),
    ...
    private void tampil2() {
        ...
        try {
            ...
            try {
                ...
                if (keyword.isEmpty()) {
                    while (rs.next()) {
                        tabMode2.addRow(new Object[]{rs.getString("tanggal"),
                            rs.getString("usere") + " "
                            + Sequel.cariIsi("select pegawai.nama from pegawai where pegawai.nik=?",
                            rs.getString("usere")),
                            rs.getString("sqle").replaceAll("\\(\\',\\'", "\\(\\'")});
                    }
                } else {
                    while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgPenelusuranLogin.class.getName());
