...
public class DlgSetHargaToko extends javax.swing.JDialog {
    ...
    public DlgSetHargaToko(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Keuntungan Jual Distributor (%)",
            "Keuntungan Jual Grosir (%)", "Keuntungan Jual Retail (%)"};
        ...
        Distributor.setDocument(new batasInput((byte) 3).getOnlyAngka(
                Distributor));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Distributor.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("tokosetharga",
                    "'" + Distributor.getText() + "','" + Grosir.getText() + "','" + Retail.
                    getText() + "'", "Set Harga");
            tampil();
            emptTeks();
        } else if (tabMode.getRowCount() > 0) {
    ...
    private void BtnKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKeluarActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null,
                    "Maaf, data tokosetharga tidak boleh kosong ...!!!!");
            Distributor.requestFocus();
        } else if (!(tabMode.getRowCount() == 0)) {
            dispose();
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSetHargaToko dialog = new DlgSetHargaToko(
    ...
    private static final Logger LOG = Logger.getLogger(DlgSetHargaToko.class.
            getName());
}
