...
public class DlgSetHargaToko extends javax.swing.JDialog {
    ...
    public DlgSetHargaToko(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Keuntungan Jual Distributor (%)", "Keuntungan Jual Grosir (%)",
            "Keuntungan Jual Retail (%)"};
    ...
    private static final Logger LOG = Logger.getLogger(DlgSetHargaToko.class.getName());
