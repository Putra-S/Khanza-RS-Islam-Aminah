...
public class DlgSetEmbalase extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Embalase.getText().trim().isEmpty()) {
            Valid.textKosong(Embalase, "Embalase");
        } else if (Tuslah.getText().trim().isEmpty()) {
            Valid.textKosong(Tuslah, "Tuslah");
        } else if (tabMode.getRowCount() == 0) {
            Sequel.menyimpan("set_embalase",
                    "'" + Embalase.getText() + "','" + Tuslah.getText() + "'",
                    "Embalase & Tuslah");
            tampil();
            emptTeks();
        } else if (tabMode.getRowCount() > 0) {
            JOptionPane.showMessageDialog(null,
                    "Maaf, Hanya diijinkan satu Set Embalase & Tuslah ...!!!!");
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Embalase.requestFocus();
        } else if (Embalase.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null,
    ...
    private void BtnKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKeluarActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null,
                    "Maaf, data Embalase & Tuslah tidak boleh kosong ...!!!!");
            Embalase.requestFocus();
        } else if (!(tabMode.getRowCount() == 0)) {
            dispose();
        }
...
private void EmbalaseKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_EmbalaseKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSetEmbalase dialog = new DlgSetEmbalase(new javax.swing.JFrame(),
                    true);
    ...
    private static final Logger LOG = Logger.getLogger(DlgSetEmbalase.class.
            getName());
}
