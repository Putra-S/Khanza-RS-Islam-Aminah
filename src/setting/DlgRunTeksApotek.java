...
public class DlgRunTeksApotek extends javax.swing.JDialog {
    ...
    public DlgRunTeksApotek(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Teks Berjalan",
            "Aktifkan?", "Wallpaper"}) {
            @Override
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TTeks.getText().trim().isEmpty()) {
            ...
            if (EGb.getText().trim().isEmpty()) {
                Sequel.mengedit("runtextapotek",
                        "teks='" + TTeks.getText() + "'", "aktifkan='" + YesNo.
                        getSelectedItem() + "'");
            } else {
                Sequel.mengedit("runtextapotek",
                        "teks='" + TTeks.getText() + "'", "aktifkan='" + YesNo.
                        getSelectedItem() + "',gambar=?", EGb);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TTeks.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("runtextapotek",
                    "'" + TTeks.getText() + "','" + YesNo.getSelectedItem() + "'",
                    "Display", EGb);
            tampil();
            emptTeks();
        } else if (tabMode.getRowCount() > 0) {
            JOptionPane.showMessageDialog(null,
                    "Maaf, Hanya diijinkan satu runtext...!!!!");
            TTeks.requestFocus();
        }
...
private void TTeksKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TTeksKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                DlgRunTeksApotek dialog = new DlgRunTeksApotek(
    ...
    private void getData() {
        ...
        if (row != -1) {
            ...
            try {
                try (ResultSet hasil = koneksi.createStatement().executeQuery(
                        "select gambar from runtextapotek where teks='" + tabMode.
    ...
    private static final Logger LOG = Logger.getLogger(DlgRunTeksApotek.class.
            getName());
