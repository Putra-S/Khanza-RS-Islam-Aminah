...
private void TTeksKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TTeksKeyPressed
    ...
    private void getData() {
        ...
        if (row != -1) {
            ...
            try {
                try (ResultSet hasil = koneksi.createStatement()
                        .executeQuery("select gambar from runtextapotek where teks='"
    ...
    private static final Logger LOG = Logger.getLogger(DlgRunTeksApotek.class.getName());
