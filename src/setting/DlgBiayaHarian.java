...
public class DlgBiayaHarian extends javax.swing.JDialog {
    ...
    public DlgBiayaHarian(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Nomer Kamar", "Nama Kamar", "Nama Biaya", "Jumlah",
            "Besar Biaya"};
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (NmBiaya.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("biaya_harian",
                    "'" + kdkamar.getText() + "','" + NmBiaya.getText() + "','" + BiayaHarian.
                    getText() + "','" + Jumlah.getText() + "'", "Nama Biaya");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode, NmBiaya, "biaya_harian",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (NmBiaya.getText().trim().isEmpty()) {
            ...
            Sequel.mengedit("biaya_harian", "kd_kamar='" + tbSpesialis.
                    ...
                    getText()
                    + "',jml='" + Jumlah.getText() + "',besar_biaya='" + BiayaHarian.
                    getText() + "'");
...
private void JumlahKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JumlahKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBiayaHarian dialog = new DlgBiayaHarian(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        String sql = "select biaya_harian.kd_kamar,bangsal.nm_bangsal,biaya_harian.nama_biaya,jml,biaya_harian.besar_biaya"
                ...
                + " where biaya_harian.kd_kamar like '%" + TCari.getText().
                        trim() + "%' or  "
        ...
        try {
            ...
            while (rs.next()) {
                String[] data = {rs.getString(1), rs.getString(2), rs.getString(
                    3), rs.getString(4), Valid.SetAngka(rs.getDouble(5))};
                tabMode.addRow(data);
            }
    ...
    private static final Logger LOG = Logger.getLogger(DlgBiayaHarian.class.
            getName());
