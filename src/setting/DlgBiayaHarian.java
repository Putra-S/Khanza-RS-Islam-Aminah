...
private void JumlahKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JumlahKeyPressed
    ...
    private void tampil() {
        String sql = "select biaya_harian.kd_kamar,bangsal.nm_bangsal,biaya_harian.nama_biaya,jml,biaya_harian.besar_biaya"
                ...
                + " on biaya_harian.kd_kamar=kamar.kd_kamar " + " and kamar.kd_bangsal=bangsal.kd_bangsal "
    ...
    private void isKmr() {
        ...
        Sequel.cariIsi("select bangsal.nm_bangsal from bangsal where bangsal.kd_bangsal=? ", TBangsal,
                TKdBngsal.getText());
    }

    private static final Logger LOG = Logger.getLogger(DlgBiayaHarian.class.getName());
