...
public class DlgUser extends javax.swing.JDialog {
    ...
    public DlgUser(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"ID User", "Nama User", "Jabatan", "Password", "[J]ICD 10", "[J]Obat Penyakit", "[C]Dokter",
            "[A]Jadwal Praktek", "[C]Petugas", "[M]Pasien", "[A]Registrasi", "[A]Tindakan Ralan", "[A]Rawat Inap",
            "[A]Tindakan Ranap", "[A]Operasi", "[A]Rujukan Keluar", "[A]Rujukan Masuk", "[A]Beri Obat, Alkes & BHP",
            "[A]Resep Pulang", "[M]Pasien Meninggal", "[A]Diet Pasien", "[M]Kelahiran Bayi", "[A]Periksa Lab PK",
            "[A]Periksa Radiologi", "[A]Rawat Jalan", "[K]Deposit Pasien", "[K]Piutang Pasien",
            "[M]Peminjaman Berkas RM", "[C]Barcode Presensi", "[C]Presensi Harian", "[C]Presensi Bulanan",
            "[C]Pegawai Admin", "[C]Pegawai User", "[D]Suplier Obat/Alkes/BHP", "[D]Satuan Barang",
            "[D]Konversi Satuan", "[D]Jenis Obat/Alkes/BHP", "[D]Obat, Alkes & BHP", "[D]Stok Opname Apotek",
            "[D]Stok Obat Pasien", "[D]Pengadaan Obat, Alkes & BHP", "[D]Penerimaan Obat, Alkes & BHP",
            "[D]Penjualan Obat, Alkes & BHP", "[D]Piutang Obat, Alkes & BHP", "[D]Retur Ke Suplier",
            "[D]Retur Dari Pembeli", "[D]Retur Obat, Alkes & BHP Ranap", "[D]Retur Piutang Pembeli",
            "[D]Keuntungan Penjualan", "[D]Keuntungan Beri Obat, Alkes & BHP", "[D]Sirkulasi Obat, Alkes & BHP",
            "[E]Barang Non Medis", "[E]Pengadaan Barang Nonmedis", "[E]Stok Keluar Non Medis",
            "[E]Rekap Pengadaan Non Medis", "[E]Rekap Stok Keluar Non Medis", "[E]Biaya Pengadaan Non Medis",
            "[G]Jenis Inventaris", "[G]Kategori Inventaris", "[G]Merk Inventaris", "[G]Ruang Inventaris",
            "[G]Produsen Inventaris", "[G]Koleksi Inventaris", "[G]Inventaris", "[G]Sirkulasi Inventaris",
            "[H]Jenis Parkir", "[H]Parkir Masuk", "[H]Parkir Keluar", "[H]Rekap Parkir Harian",
            "[H]Rekap Parkir Bulanan", "[A]Informasi Kamar", "[I]Harian Dokter Poli", "[I]Obat Per Poli",
            "[I]Obat Per Kamar", "[I]Obat Per Dokter Ralan", "[I]Obat Per Dokter Ranap", "[I]Harian Dokter",
            "[I]Bulanan Dokter", "[I]Harian Paramedis", "[I]Bulanan Paramedis", "[I]Pembayaran Ralan",
            "[I]Pembayaran Ranap", "[I]Rekap Pembayaran Ralan", "[I]Rekap Pembayaran Ranap", "[I]Tagihan Masuk",
            "[I]Tambahan Biaya", "[I]Potongan Biaya", "[A]No.Resep", "[M]Riwayat Perawatan",
            "[J]Frekuensi Penyakit Ralan", "[J]Frekuensi Penyakit Ranap", "[K]Kamar", "[K]Tarif Ralan",
            "[K]Tarif Ranap", "[K]Tarif Lab", "[K]Tarif Radiologi", "[K]Tarif Operasi", "[K]Akun Rekening",
            "[K]Rekening Tahun", "[K]Posting Jurnal", "[K]Buku Besar", "[K]Cash Flow", "[K]Keuangan",
            "[K]Pengeluaran Harian", "[T]Set P.J. Unit Penunjang", "[T]Set Oto Lokasi", "[T]Set Kamar Inap",
            "[T]Set Embalase & Tuslah", "[T]Tracer Login", "[T]Display Antrian Registrasi & Poli",
            "[T]Set Harga Obat", "[T]Set Penggunaan Tarif", "[T]Set Oto Ralan", "[T]Biaya Harian Kamar",
            "[T]Biaya Masuk Sekali", "[T]Set RM", "[A]Billing Ralan", "[A]Billing Ranap", "[I]Detail JM Dokter",
            "[A]IGD", "[B]Barcode Ralan", "[B]Barcode Ranap", "[T]Set Harga Obat Ralan", "[T]Set Harga Obat Ranap",
            "[J]Penyakit AFP & PD3I", "[J]Surveilans AFP & PD3I", "[J]Surveilans Ralan", "[M]Diagnosa Pasien",
            "[J]Surveilans Ranap", "[J]Pny.Tdk Menular Ranap", "[J]Pny.Tdk Menular Ralan", "[J]Kunjungan Ralan",
            "[J]RL 3.2 Rawat Darurat", "[J]RL 3.3 Gigi dan Mulut", "[J]RL 3.7 Radiologi", "[J]RL 3.8 Laboratorium",
            "[I]Harian Dokter Ralan", "[C]SMS Gateway", "[C]Sidik Jari", "[C]Jam Presensi", "[C]Jadwal Pegawai",
            "[H]Barcode Parkir", "[T]Set Billing", "[A]DPJP Ranap", "[D]Mutasi Obat/Alkes/BHP",
            "[J]RL 3.4 Kebidanan", "[J]RL 3.6 Pembedahan", "[I]Fee Visit Dokter", "[I]Fee Bacaan EKG",
            "[I]Fee Rujukan Rontgen", "[I]Fee Rujukan Ranap", "[I]Fee Periksa Ralan", "[K]Akun Bayar",
            "[K]Bayar Pesan Obat", "[I]Obat Per Dokter Peresep", "[E]Jenis Barang Non Medis",
            "[K]Pemasukkan Lain-Lain", "[K]Pengaturan Rekening", "[T]Closing Kasir",
            "[T]Set Keterlambatan Presensi", "[T]Set Harga Kamar", "[I]Rekap Per Shift", "[L]Cek NIK",
            "[L]Cek No.Kartu", "[L]Riwayat Rujukan PCare di VClaim", "[I]Obat Per Cara Bayar", "[J]Kunjungan Ranap",
            "[K]Bayar Piutang", "[I]Payment Point", "[L]Cek No.Rujukan PCare di VClaim", "[J]ICD 9",
            "[D]Darurat Stok", "[M]Retensi Data R.M.", "[C]Temporary Presensi", "[K]Jurnal Harian",
            "[D]Sirkulasi Obat, Alkes & BHP 2", "[A]Edit Registrasi", "[L]Referensi Diagnosa VClaim",
            "[L]Referensi Poli VClaim", "[D]Industri Farmasi", "[I]Harian J.S.", "[I]Bulanan J.S.",
            "[I]Harian BHP Medis/Paket Obat", "[I]Bulanan BHP Medis/Paket Obat", "[K]Piutang Belum Lunas",
            "[L]Referensi Faskes VClaim", "[L]Data Bridging SEP VClaim", "[D]Pengambilan BHP UTD", "[K]Tarif UTD",
            "[N]Pengambilan BHP Medis", "[N]BHP Medis Rusak", "[E]Pengambilan UTD", "[N]Pengambilan BHP Non Medis",
            "[N]BHP Non Medis Rusak", "[E]Suplier Non Medis", "[N]Donor Darah", "[L]Monitoring Verifikasi Klaim",
            "[N]Cekal Darah", "[N]Komponen Darah", "[N]Stok Darah", "[N]Pemisahan Darah", "[I]Harian Kamar",
            "[K]Rincian Piutang Pasien", "[D]Keuntungan Beri Obat, Alkes & BHP 2", "[L]Reklasifikasi Ralan",
            "[L]Reklasifikasi Ranap", "[N]Penyerahan Darah", "[K]Hutang Obat & BHP", "[D]Riwayat Obat, Alkes & BHP",
            "[J]Sensus Harian Poli", "[J]RL 4A Sebab Morbiditas Ranap", "[L]Referensi Kamar Aplicare",
            "[L]Ketersediaan Kamar Aplicare", "[L]Klaim Baru Otomatis INACBG", "[L]Klaim Baru Manual INACBG",
            "[L]Coder NIK INACBG", "[M]Mutasi Berkas RM", "[K]Akun Piutang", "[I]Harian KSO", "[I]Bulanan KSO",
            "[I]Harian Menejemen", "[I]Bulanan Menejemen", "[L]Cek Eligibilitas Inhealth",
            "[L]Referensi Ruang Rawat Inhealth", "[L]Referensi Poli Inhealth", "[L]Referensi Faskes Inhealth",
            "[L]Data Bridging SJP Inhealth", "[I]Piutang Ralan", "[I]Piutang Ranap", "[K]Piutang Per Cara Bayar",
            "[J]Lama Pelayanan Ralan", "[M]Catatan Pasien", "[J]RL 4B Sebab Morbiditas Ralan",
            "[J]RL 4A Morbiditas Ralan", "[J]RL 4B Morbiditas Ralan", "[M]Data HAIs", "[J]Harian HAIs",
            "[J]Bulanan HAIs", "[J]Hitung BOR", "[M]Instansi/Perusahaan Pasien", "[D]Resep Dokter",
            "[J]Lama Pelayanan Apotek", "[J]Hitung ALOS", "[I]Detail Tindakan", "[A]Rujukan Poli Internal",
            "[I]Rekap Poli Anak", "[O]Registrasi Per Poli", "[O]Registrasi Per Dokter",
            "[O]Registrasi Per Pekerjaan", "[O]Registrasi Per Pendidikan", "[O]Registrasi Per Tahun",
            "[M]Berkas Digital Perawatan", "[J]Pny Menular Ranap", "[J]Pny Menular Ralan",
            "[O]Registrasi Per Bulan", "[O]Registrasi Per Tanggal", "[O]Demografi Registrasi",
            "[O]Reg Lama Per Tahun", "[O]Reg Baru Per Tahun", "[O]Reg Lama Per Bulan", "[O]Reg Baru Per Bulan",
            "[O]Reg Lama Per Tanggal", "[O]Reg Baru Per Tanggal", "[O]Batal Periksa Per Tahun",
            "[O]Batal Periksa Per Bulan", "[L]Referensi Diagnosa Pcare", "[O]Batal Periksa Per Tanggal",
            "[D]Kategori Obat/Alkes/BHP", "[D]Golongan Obat/Alkes/BHP", "[D]Obat/Alkes/BHP Per Tanggal",
            "[D]Penjualan Bebas Per Tanggal", "[L]Referensi Kesadaran Pcare", "[J]Pembatalan Periksa Per Dokter",
            "[I]Pembayaran Per Unit", "[I]Rekap Pembayaran Per Unit", "[O]Registrasi Per Cara Bayar",
            "[E]Pengadaan Non Medis Per Tanggal", "[E]Stok Keluar Non Medis Per Tanggal",
            "[O]Kunjungan Ranap Per Tahun", "[L]Cek Rujukan PCare", "[O]Kunjungan Lab Ralan Per Tahun",
            "[O]Kunjungan Rad Ralan Per Tahun", "[J]Cek Entry Ralan", "[L]Klaim Baru Manual INACBG 2",
            "[D]Permintaan Obat & BHP", "[D]Ringkasan Permintaan Obat & BHP", "[D]Surat Pemesanan Obat & BHP",
            "[E]Permintaan Barang Non Medis", "[E]Ringkasan Permintaan Barang Non Medis",
            "[E]Surat Pemesanan Barang Non Medis", "[O]Registrasi Per Perujuk", "[L]Referensi Prosedur VClaim",
            "[L]Referensi Kelas Rawat VClaim", "[L]Referensi Dokter VClaim", "[L]Referensi Spesialistik VClaim",
            "[L]Referensi Ruang Rawat VClaim", "[L]Referensi Cara Keluar VClaim",
            "[L]Referensi Pasca Pulang VClaim", "[I]Detail VK/OK", "[A]Billing Parsial",
            "[L]Cek No.Rujukan RS di VClaim", "[L]Cek Rujukan Kartu PCare di VClaim",
            "[L]Cek Rujukan Kartu RS di VClaim", "[A]Akses Depo Obat/BHP", "[L]Pembuatan Rujukan VClaim",
            "[O]Kunjungan Lab Ralan Per Bulan", "[D]Stok Keluar Medis", "[O]Kunjungan Rad Ralan Per Bulan",
            "[I]Detail JM Dokter 2", "[M]Pengaduan/Chat", "[O]Kunjungan Lab Ralan Per Tanggal",
            "[O]Kunjungan Rad Ralan Per Tanggal", "[J]Sensus Harian Ralan", "[D]Metode Racik",
            "[I]Pembayaran Per Akun Bayar", "[D]Pengguna Obat/Alkes/BHP Resep", "[D]Rekap Penerimaan Obat & BHP",
            "[C]Master Berkas Pegawai", "[C]Berkas Kepegawaian", "[C]Riwayat Jabatan", "[C]Riwayat Pendidikan",
            "[C]Riwayat Naik Gaji", "[C]Kegiatan Ilmiah & Pelatihan", "[C]Riwayat Penghargaan",
            "[C]Riwayat Penelitian", "[E]Penerimaan Barang Non Medis", "[K]Bayar Pesan Non Medis",
            "[K]Hutang Barang Non Medis", "[E]Rekap Penerimaan Non Medis", "[J]Insiden Keselamatan",
            "[M]Insiden Keselamatan Pasien", "[O]Kejadian IKP Per Tahun", "[O]Kejadian IKP Per Bulan",
            "[O]Kejadian IKP Per Tanggal", "[D]Riwayat Batch", "[O]Kejadian IKP Per Jenis",
            "[O]Kejadian IKP Per Dampak", "[I]Piutang Per Akun Piutang", "[O]Registrasi Per Agama",
            "[O]Registrasi Per Umur", "[M]Suku/Bangsa Pasien", "[M]Bahasa Pasien", "[M]Golongan TNI",
            "[M]Satuan TNI", "[M]Jabatan TNI", "[M]Pangkat TNI", "[M]Golongan POLRI", "[M]Satuan POLRI",
            "[M]Jabatan POLRI", "[M]Pangkat POLRI", "[M]Cacat Fisik", "[O]Registrasi Per Suku/Bangsa",
            "[O]Registrasi Per Bahasa", "[A]Jadwal Operasi", "[L]Mapping Poli VClaim",
            "[O]Registrasi Per Cacat Fisik", "[G]Barang CSSD", "[P]Surat Kontrol", "[A]Booking Registrasi",
            "[L]Referensi Propinsi VClaim", "[L]Referensi Kabupaten VClaim", "[L]Referensi Kecamatan VClaim",
            "[L]Referensi Dokter DPJP VClaim", "[L]Riwayat Rujukan RS di VClaim", "[L]Tanggal Rujukan di VClaim",
            "[A]Permintaan Lab", "[A]Permintaan Radiologi", "[P]Indeks Surat", "[P]Map Surat", "[P]Almari Surat",
            "[P]Rak Surat", "[P]Ruang Surat", "[P]Klasifikasi Surat", "[P]Status Surat", "[P]Sifat Surat",
            "[P]Stts Balas Surat", "[P]Surat Masuk", "[L]Referensi Dokter PCare", "[L]Referensi Poli PCare",
            "[L]Referensi Provider PCare", "[L]Referensi Stts Pulang PCare", "[L]Referensi Spesialis PCare",
            "[L]Referensi Subspesialis PCare", "[L]Referensi Sarana PCare", "[L]Referensi Khusus PCare",
            "[L]Referensi Obat PCare", "[L]Referensi Tindakan PCare", "[L]Faskes Subspesialis PCare",
            "[L]Faskes Alih Rawat PCare", "[L]Faskes Thalasemia & Hemofili PCare", "[L]Mapping Obat PCare",
            "[L]Tarif Ralan RS & PCare", "[L]Club Prolanis PCare", "[L]Mapping Poli PCare",
            "[L]Kegiatan Kelompok PCare", "[L]Tarif Ranap RS & PCare", "[L]Peserta Keg Kelompok PCare",
            "[D]Sirkulasi Obat, Alkes & BHP 3", "[L]Data Pendafataran PCare", "[L]Mapping Dokter PCare",
            "[J]Ranap Per Ruang", "[J]Penyakit Ranap Per Cara Bayar", "[J]Anggota TNI Dirawat",
            "[T]Set Input Parsial", "[J]Lama Pelayanan Radiologi", "[J]Lama Pelayanan Lab", "[L]Cek Nomor SEP",
            "[A]Catatan Dokter", "[P]Surat Keluar", "[D]Kegiatan Farmasi", "[E]Stok Opname Non Medis",
            "[E]Sirkulasi Non Medis", "[J]Rekap Lab Per Tahun", "[J]Perujuk Lab Per Tahun",
            "[J]Rekap Radiologi Per Tahun", "[J]Perujuk Radiologi Per Tahun", "[J]Rekap Bulanan Porsi Diet",
            "[J]Rekap Bulanan Macam Diet", "[I]Payment Point 2", "[I]Pembayaran Per Akun Bayar 2",
            "[I]Hapus Nota Salah", "[A]Asesmen Awal Rawat Inap", "[J]HAIs Per Kamar/Bangsal", "[D]PPN Obat",
            "[K]Saldo Akun Per Bulan", "[T]Display Antrian Apotek", "[L]Referensi Faskes Sisrute",
            "[L]Referensi Alasan Rujuk Sisrute", "[L]Referensi Diagnosa Sisrute", "[L]Rujukan Masuk Sisrute",
            "[L]Rujukan Keluar Sisrute", "[L]Cek SKDP VClaim", "[D]Data Batch", "[J]Kunjungan Lab Ralan",
            "[J]Kunjungan Lab Ranap", "[J]Kunjungan Radiologi Ralan", "[J]Kunjungan Radiologi Ranap",
            "[L]Pemberian Obat PCare", "[L]Pemberian Tindakan PCare", "[I]Pembayaran Per Akun Bayar 3",
            "[T]Password BPJS", "[J]Data TB", "[L]Ketersediaan Kamar SIRANAP", "[O]Periode Laporan TB",
            "[O]Rujukan TB", "[O]Riwayat TB", "[O]Tipe Diagnosis TB", "[O]Status HIV TB", "[O]Skoring Anak TB",
            "[O]Konfirmasi Skoring 5 TB", "[O]Konfirmasi Skoring 6 TB", "[O]Sumber Obat TB",
            "[O]Hasil Akhir Pengobatan TB", "[O]Hasil Tes HIV TB", "[D]Kadaluarsa Batch", "[D]Sisa Stok",
            "[D]Obat Per Resep", "[G]Pemakaian Air PDAM", "[G]Limbah Padat B3 Medis",
            "[O]Pemakaian Air PDAM Per Tanggal", "[O]Pemakaian Air PDAM Per Bulan",
            "[O]Limbah B3 Padat Per Tanggal", "[O]Limbah B3 Padat Per Bulan", "[G]Limbah Padat Domestik",
            "[O]Limbah Padat Domestik Per Tanggal", "[O]Limbah Padat Domestik Per Bulan", "[G]Mutu Air Limbah",
            "[G]Pest Control", "[Q]Ruang Perpustakaan", "[Q]Kategori Koleksi", "[Q]Jenis Koleksi",
            "[Q]Pengarang/Penulis", "[Q]Penerbit Koleksi", "[Q]Koleksi Perpustakaan", "[Q]Inventaris Perpustakaan",
            "[Q]Pengaturan Peminjaman", "[Q]Denda Perpustakaan", "[Q]Anggota Perpustakaan",
            "[Q]Peminjaman Koleksi Perpustakaan", "[Q]Bayar Denda Perpustakaan", "[Q]Data Koleksi Ebook",
            "[C]Jenis Cidera K3", "[C]Penyebab Kecelakaan K3", "[C]Jenis Luka K3", "[C]Lokasi Kejadian K3",
            "[C]Dampak Cidera K3", "[C]Jenis Pekerjaan K3", "[C]Bagian Tubuh K3", "[C]Peristiwa K3",
            "[O]K3 Per Tahun", "[O]K3 Per Bulan", "[O]K3 Per Tanggal", "[O]K3 Per Jenis Cidera",
            "[O]K3 Per Penyebab Kecelakaan", "[O]K3 Per Jenis Luka", "[O]K3 Per Lokasi Kejadian",
            "[O]K3 Per Dampak Cidera", "[O]K3 Per Jenis Pekerjaan", "[O]K3 Per Bagian Tubuh",
            "[C]Jenis Cidera K3 Per Tahun", "[C]Penyebab Kecelakaan K3 Per Tahun", "[C]Jenis Luka K3 Per Tahun",
            "[C]Lokasi Kejadian K3 Per Tahun", "[C]Dampak Cidera K3 Per Tahun", "[C]Jenis Pekerjaan K3 Per Tahun",
            "[C]Bagian Tubuh K3 Per Tahun", "[A]Skrining Rawat Jalan", "[L]Histori Pelayanan BPJS",
            "[J]Rekap Mutasi Berkas", "[J]Skrining Pernapasan Ralan Per Tahun", "[D]Pengajuan Obat & BHP",
            "[E]Pengajuan Barang Non Medis", "[O]Kunjungan Ranap Per Bulan", "[O]Kunjungan Ranap Per Tanggal",
            "[O]Kunjungan Ranap Per Ruang", "[J]Masuk Ruang Per Tahun", "[O]Pegawai Per Jenjang Jabatan",
            "[O]Pegawai Per Bidang/Bagian", "[O]Pegawai Per Departemen", "[O]Pegawai Per Pendidikan",
            "[O]Pegawai Per Status WP", "[O]Pegawai Per Status Kerja", "[O]Status Pulang Ranap",
            "[J]KIP Pasien Ranap", "[J]KIP Pasien Ralan", "[L]Mapping Dokter DPJP VClaim", "[M]Data Triase IGD",
            "[M]Master Triase Skala 1", "[M]Master Triase Skala 2", "[M]Master Triase Skala 3",
            "[M]Master Triase Skala 4", "[M]Master Triase Skala 5", "[M]Master Triase Pemeriksaan",
            "[M]Master Triase Macam Kasus", "[J]Rekap Permintaan Diet", "[J]Daftar Pasien Ranap",
            "[J]Daftar Pasien Ranap TNI", "[G]Pengajuan Aset/Inventaris", "[O]Item Apotek Per Jenis",
            "[O]Item Apotek Per Kategori", "[O]Item Apotek Per Golongan", "[O]Item Apotek Per Industri Farmasi",
            "[D]10 Obat Terbanyak Poli", "[O]Pengajuan Aset Per Urgensi", "[O]Pengajuan Aset Per Status",
            "[O]Pengajuan Aset Per Departemen", "[G]Rekap Pengajuan Aset Departemen",
            "[O]Pegawai Per Kelompok Jabatan", "[O]Pegawai Per Risiko Kerja", "[O]Pegawai Per Emergency Index",
            "[O]Jumlah Inventaris Per Ruang", "[J]Harian HAIs 2", "[O]Jumlah Inventaris Per Jenis",
            "[M]Resume Pasien", "[A]Perkiraan Biaya Ranap", "[D]Rekap Obat Per Poli", "[D]Rekap Obat Per Pasien",
            "[G]Permintaan Perbaikan Inventaris", "[O]Pasien HAIs Per Ruang", "[O]Pasien HAIs Per Bulan",
            "[O]Laju HAIs VAP Per Ruang", "[O]Laju HAIs IAD Per Ruang", "[O]Laju HAIs Plebitis Per Ruang",
            "[O]Laju HAIs ISK Per Ruang", "[O]Laju HAIs ILO Per Ruang", "[O]Laju HAIs HAP Per Ruang",
            "[L]Mapping Poli Inhealth", "[L]Mapping Dokter Inhealth", "[L]Tarif Ralan Inhealth",
            "[L]Tarif Ranap Inhealth", "[L]Tarif Radiologi Inhealth", "[L]Tarif Laborat Inhealth",
            "[L]Tarif Operasi Inhealth", "[D]Hibah Obat & BHP", "[G]Asal Hibah", "[M]Asuhan Gizi",
            "[L]Tagihan Inhealth", "[D]Sirkulasi Obat, Alkes & BHP 4", "[D]Sirkulasi Obat, Alkes & BHP 5",
            "[E]Sirkulasi Non Medis 2", "[M]Monitoring Asuhan Gizi", "[O]Penerimaan Obat, Alkes & BHP Per Bulan",
            "[J]Rekap Kunjungan", "[P]Surat Keterangan Sakit", "[M]Penilaian Awal Keperawatan Ralan Umum",
            "[A]Permintaan Diet", "[M]Master Masalah Keperawatan", "[C]Pengajuan Cuti",
            "[J]Kedatangan Pasien Per Jam", "[N]Data Pendonor", "[R]Suplier Toko", "[R]Jenis Barang Toko",
            "[T]Set Harga Toko", "[R]Barang Toko", "[K]Penagihan Piutang Pasien", "[K]Akun Penagihan Piutang",
            "[R]Stok Opname Toko", "[R]Riwayat Barang Toko", "[R]Surat Pemesanan Toko", "[R]Pengajuan Barang Toko",
            "[R]Penerimaan Barang Toko", "[R]Pengadaan Barang Toko", "[R]Hutang Toko", "[R]Bayar Pesan Toko",
            "[R]Member Toko", "[R]Penjualan Toko", "[J]Registrasi Poli Per Tanggal", "[R]Piutang Toko",
            "[R]Retur Ke Suplier Toko", "[E]Retur Ke Suplier Non Medis", "[E]Riwayat Barang Non Medis",
            "[L]Pasien Corona", "[R]Pendapatan Harian Toko", "[L]Diagnosa Pasien Corona",
            "[L]Perawatan Pasien Corona", "[M]Penilaian Awal Keperawatan Gigi",
            "[M]Master Masalah Keperawatan Gigi", "[R]Bayar Piutang Toko", "[R]Piutang Harian Toko",
            "[R]Penjualan Harian Toko", "[A]Deteksi Dini Corona", "[M]Penilaian Awal Keperawatan Ralan Kebidanan",
            "[P]Pengumuman E-Pasien", "[P]Surat Hamil", "[K]Set Tarif Online", "[A]Booking Periksa",
            "[R]Sirkulasi Barang Toko", "[R]Retur Jual Toko", "[R]Retur Jual Piutang", "[R]Sirkulasi Barang Toko 2",
            "[R]Keuntungan Barang Toko", "[S]Ket Pengeluaran Penerima Dankes", "[S]Ket Penghasilan Penerima Dankes",
            "[S]Ukuran Rumah Penerima Dankes", "[S]Dinding Rumah Penerima Dankes",
            "[S]Lantai Rumah Penerima Dankes", "[S]Atap Rumah Penerima Dankes",
            "[S]Kepemilikan Rumah Penerima Dankes", "[S]Kamar Mandi Penerima Dankes",
            "[S]Dapur Rumah Penerima Dankes", "[S]Kursi Rumah Penerima Dankes", "[S]Kategori PHBS Penerima Dankes",
            "[S]Elektronik Penerima Dankes", "[S]Ternak Penerima Dankes", "[S]Jenis Simpanan Penerima Dankes",
            "[M]Penilaian Awal Keperawatan Ralan Bayi/Anak", "[S]Kategori Asnaf Penerima Dankes",
            "[M]Master Masalah Keperawatan Bayi/Anak", "[M]Master Imunisasi", "[S]Patologis Penerima Dankes",
            "[L]Cek No.Kartu PCare", "[P]Surat Bebas Narkoba", "[P]Surat Keterangan Covid",
            "[G]Pemakaian Air Tanah", "[O]Pemakaian Air Tanah Per Tanggal", "[O]Pemakaian Air Tanah Per Bulan",
            "[J]Lama Pelayanan Poli", "[M]Hemodialisa", "[J]Laporan Tahunan IRJ", "[O]Hemodialisa Per Tanggal",
            "[O]Hemodialisa Per Bulan", "[O]Hemodialisa Per Tahun", "[O]Pasien Meninggal Per Bulan",
            "[G]Perbaikan Inventaris", "[P]Surat Cuti Hamil", "[D]Permintaan Stok Obat Pasien",
            "[G]Pemeliharaan Inventaris", "[M]Klasifikasi Pasien Ranap", "[J]Bulanan Klasifikasi Pasien Ranap",
            "[J]Harian Klasifikasi Pasien Ranap", "[J]Klasifikasi Pasien Per Ruang", "[M]SOAP Perawatan",
            "[K]Klaim Rawat Jalan", "[M]Skrining Gizi Lanjut", "[J]Lama Penyiapan RM", "[J]Dosis Radiologi",
            "[J]Demografi Umur Kunjungan", "[T]Jam Diet Pasien", "[K]RVP Piutang BPJS",
            "[D]Verifikasi Penerimaan Obat/Alkes/BHP", "[E]Verifikasi Penerimaan Non Medis", "[A]Periksa Lab PA",
            "[D]Ringkasan Pengajuan Obat & BHP", "[D]Ringkasan Pemesanan Obat & BHP",
            "[D]Ringkasan Pengadaan Obat & BHP", "[D]Ringkasan Penerimaan Obat & BHP",
            "[D]Ringkasan Hibah Obat & BHP", "[D]Ringkasan Penjualan Obat & BHP", "[D]Ringkasan Beri Obat & BHP",
            "[D]Ringkasan Piutang Obat & BHP", "[D]Ringkasan Stok Keluar Obat & BHP",
            "[D]Ringkasan Retur Suplier Obat & BHP", "[D]Ringkasan Retur Pembeli Obat & BHP",
            "[M]Penilaian Awal Keperawatan Ranap Kebidanan", "[E]Ringkasan Pengajuan Non Medis",
            "[E]Ringkasan Pemesanan Non Medis", "[E]Ringkasan Pengadaan Non Medis",
            "[E]Ringkasan Penerimaan Non Medis", "[E]Ringkasan Stok Keluar Non Medis",
            "[E]Ringkasan Retur Suplier Non Medis", "[K]Penerimaan/Omset/Kas Masuk",
            "[K]Validasi Penagihan Piutang", "[A]Permintaan Rawat Inap", "[L]Referensi Diagnosa PRB VClaim",
            "[L]Referensi Obat PRB VClaim", "[L]Surat Kontrol VClaim", "[D]Penggunaan BHP OK/VK",
            "[P]Surat Keterangan Rawat Inap", "[P]Surat Keterangan Sehat", "[K]Pendapatan Per Cara Bayar",
            "[L]Host To Host Bank Jateng", "[K]Pembayaran Bank Jateng", "[L]Surat PRI VClaim",
            "[I]Ringkasan Tindakan", "[J]Lama Pelayanan Pasien", "[P]Surat Keterangan Sakit Pihak 2",
            "[K]Titip Faktur/Tagihan Obat & BHP", "[L]Referensi Pendaftaran Mobile JKN",
            "[L]Batal Pendaftaran Mobile JKN", "[J]Lama Operasi", "[O]Jumlah Inventaris Per Kategori",
            "[O]Jumlah Inventaris Per Merk", "[O]Jumlah Inventaris Per Produsen", "[K]Pengembalian Deposit Pasien",
            "[K]Validasi Titip Faktur/Tagihan Obat & BHP", "[K]Piutang Obat & BHP Belum Lunas",
            "[L]Integrasi BRI API", "[G]Pengadaan Aset/Inventaris", "[K]Akun Jenis Aset/Inventaris",
            "[G]Suplier Aset/Inventaris", "[G]Penerimaan Aset/Inventaris", "[K]Bayar Pesan Aset/Inventaris",
            "[K]Hutang Aset/Inventaris", "[G]Hibah Aset/Inventaris", "[K]Titip Faktur/Tagihan Non Medis",
            "[K]Validasi Titip Faktur/Tagihan Non Medis", "[K]Titip Faktur/Tagihan Aset/Inventaris",
            "[K]Validasi Titip Faktur/Tagihan Aset/Inventaris", "[E]Hibah Non Medis", "[L]Referensi TACC PCare",
            "[D]Resep Luar", "[P]Surat Bebas TBC", "[P]Surat Keterangan Buta Warna", "[P]Surat Bebas Tato",
            "[P]Surat Kewaspadaan Kesehatan", "[O]Porsi Diet Per Tanggal", "[O]Porsi Diet Per Bulan",
            "[O]Porsi Diet Per Tahun", "[O]Porsi Diet Per Ruang", "[M]Penilaian Awal Medis Ralan Umum",
            "[M]Master Masalah Keperawatan Mata", "[M]Penilaian Awal Keperawatan Ralan Mata",
            "[M]Penilaian Awal Medis Ranap Umum", "[M]Penilaian Awal Medis Ranap Kandungan",
            "[M]Penilaian Awal Medis Ralan Kandungan", "[M]Penilaian Awal Medis IGD",
            "[M]Penilaian Awal Medis Ralan Bayi/Anak", "[L]Referensi Poli HFIS", "[L]Referensi Dokter HFIS",
            "[L]Referensi Jadwal HFIS", "[M]Penilaian Awal Fisioterapi", "[L]Program PRB di VClaim",
            "[L]Suplesi Jasa Raharja di VClaim", "[L]Data Induk Kecelakaan VClaim", "[L]Data SEP Internal VClaim",
            "[L]Klaim Jaminan Jasa Raharja VClaim", "[L]Pasien Finger Print VClaim", "[L]Rujukan Khusus VClaim",
            "[G]Pemeliharaan Gedung", "[O]Perbaikan Inventaris Per Tanggal", "[O]Perbaikan Inventaris Per Bulan",
            "[O]Perbaikan Inventaris Per Tahun", "[O]Perbaikan Inventaris Per Pelaksana & Status",
            "[M]Penilaian MCU", "[K]Peminjam Piutang", "[K]Piutang Lain-lain", "[K]Asuransi/Askes/Jenis Bayar",
            "[C]Audit Kepatuhan APD", "[L]Task ID Mobile JKN", "[K]Bayar Piutang Lain-lain",
            "[I]Pembayaran Per Akun Bayar 4", "[D]Stok Akhir Farmasi Per Tanggal", "[M]Riwayat Kamar Pasien",
            "[M]Uji Fungsi/Prosedur KFR", "[M]Hapus Berkas Digital Perawatan", "[K]Kategori Pengeluaran Harian",
            "[K]Kategori Pemasukan Lain-lain", "[I]Pembayaran Per Akun Bayar 5", "[T]Ruang Operasi",
            "[D]Telaah Resep & Obat", "[I]Jasa Tindakan Pasien", "[D]Permintaan Resep Pulang", "[I]Rekap JM Dokter",
            "[J]Status Data RM", "[A]Ubah Petugas Lab PK", "[A]Ubah Petugas Lab PA", "[A]Ubah Petugas Radiologi",
            "[A]Gabung Nomor Rawat", "[M]Gabungkan Data RM", "[D]Ringkasan Biaya Obat Pasien Per Tanggal",
            "[M]Master Masalah Keperawatan IGD", "[M]Penilaian Awal Keperawatan IGD",
            "[L]Referensi DPHO Apotek BPJS", "[L]Referensi Poli Apotek BPJS", "[K]Bayar JM Dokter",
            "[L]Referensi Faskes Apotek BPJS", "[L]Referensi Spesialistik Apotek BPJS", "[K]Pembayaran BRIVA",
            "[M]Penilaian Awal Keperawatan Ranap Umum", "[D]Nilai Penerimaan Vendor Farmasi Per Bulan",
            "[K]Akun Bayar Hutang", "[M]Master Rencana Keperawatan", "[J]Laporan Tahunan IGD",
            "[D]Obat/Alkes/BHP Tidak Bergerak", "[K]Ringkasan Hutang Vendor Farmasi",
            "[E]Nilai Penerimaan Vendor Non Medis Per Bulan", "[K]Ringkasan Hutang Vendor Non Medis",
            "[M]Master Rencana Keperawatan Bayi/Anak", "[J]Anggota POLRI Dirawat", "[J]Daftar Pasien Ranap POLRI",
            "[M]SOAP Ralan Anggota POLRI", "[M]SOAP Ranap Anggota POLRI", "[J]Laporan Penyakit POLRI",
            "[J]Jumlah Pengunjung Ralan POLRI", "[M]Catatan Observasi IGD", "[M]Catatan Observasi Ranap",
            "[M]Catatan Observasi Ranap Kebidanan", "[M]Catatan Observasi Ranap Post Partum",
            "[M]Penilaian Awal Medis Ralan THT", "[M]Penilaian Psikologi", "[C]Audit Cuci Tangan Medis",
            "[C]Audit Pembuangan Limbah", "[C]Ruang/Unit Audit Kepatuhan",
            "[C]Audit Pembuangan Benda Tajam & Jarum", "[C]Audit Penanganan Darah",
            "[C]Audit Pengelolaan Linen Kotor", "[C]Audit Penempatan Pasien", "[C]Audit Kamar Jenazah",
            "[C]Audit Bundle IADP", "[C]Audit Bundle IDO", "[C]Audit Fasilitas Kebersihan Tangan",
            "[C]Audit Fasilitas APD", "[C]Audit Pembuangan Limbah Cair Infeksius", "[C]Audit Sterilisasi Alat",
            "[M]Penilaian Awal Medis Ralan Psikiatri", "[P]Persetujuan/Penolakan Tindakan", "[C]Audit Bundle ISK",
            "[C]Audit Bundle PLABSI", "[C]Audit Bundle VAP", "[L]Host To Host Bank Papua",
            "[K]Pembayaran Bank Papua", "[M]Penilaian Awal Medis Ralan Penyakit Dalam",
            "[M]Penilaian Awal Medis Ralan Mata", "[M]Penilaian Awal Medis Ralan Neurologi",
            "[D]Sirkulasi Obat, Alkes & BHP 6", "[M]Penilaian Awal Medis Ralan Orthopedi",
            "[M]Penilaian Awal Medis Ralan Bedah", "[T]Integrasi Khanza Health Services",
            "[M]SOAP Ralan Anggota TNI", "[M]SOAP Ranap Anggota TNI", "[J]Jumlah Pengunjung Ralan TNI",
            "[J]Laporan Penyakit TNI", "[M]Catatan Keperawatan Ranap", "[M]Master Rencana Keperawatan Gigi",
            "[M]Master Rencana Keperawatan Mata", "[M]Master Rencana Keperawatan IGD",
            "[M]Master Masalah Keperawatan Psikiatri", "[M]Master Rencana Keperawatan Psikiatri",
            "[M]Penilaian Awal Keperawatan Ralan Psikiatri", "[M]Pemantauan PEWS Pasien Anak",
            "[P]Pulang Atas Permintaan Sendiri", "[M]Master Template Hasil Radiologi", "[J]Laporan Bulanan IRJ",
            "[M]Master Template Pemeriksaan", "[A]Periksa Lab MB", "[A]Ubah Petugas Lab MB",
            "[M]Penilaian Pre Operasi", "[M]Penilaian Pre Anestesi", "[M]Perencanaan Pemulangan",
            "[M]Penilaian Lanjutan Risiko Jatuh Dewasa", "[M]Penilaian Lanjutan Risiko Jatuh Anak",
            "[M]Penilaian Awal Medis Ralan Geriatri", "[M]Penilaian Tambahan Pasien Geriatri",
            "[M]Skrining Nutrisi Pasien Dewasa", "[M]Skrining Nutrisi Pasien Lansia", "[M]Hasil USG Kandungan",
            "[M]Skrining Nutrisi Pasien Anak", "[L]Host To Host Bank Jabar", "[K]Pembayaran Bank Jabar",
            "[P]Pernyataan Pasien Umum", "[M]Konseling Farmasi", "[M]Pelayanan Informasi Obat",
            "[M]Jawaban PIO Apoteker", "[P]Persetujuan Umum", "[M]Transfer Pasien Antar Ruang",
            "[L]Referensi Praktisi Satu Sehat", "[L]Referensi Pasien Satu Sehat",
            "[L]Mapping Organisasi Satu Sehat", "[L]Mapping Lokasi Satu Sehat", "[L]Kirim Encounter Satu Sehat",
            "[M]Catatan Cek GDS", "[L]Kirim Condition Satu Sehat", "[M]Check List Pre Operasi",
            "[L]Kirim Observation-TTV Satu Sehat", "[M]Sign-In Sebelum Anestesi", "[L]Kirim Procedure Satu Sehat",
            "[J]Operasi Per Bulan", "[M]Time-Out Sebelum Insisi", "[M]Sign-Out Sebelum Menutup Luka",
            "[F]Barang Dapur", "[F]Stok Opname Dapur", "[L]Mapping Vaksin Satu Sehat", "[F]Suplier Dapur",
            "[L]Kirim Imunisasi Satu Sehat", "[M]Check List Post Operasi", "[F]Pengadaan Barang Dapur",
            "[F]Stok Keluar Dapur", "[F]Riwayat Barang Dapur", "[F]Permintaan Barang Dapur", "[M]Rekonsiliasi Obat",
            "[F]Biaya Pengadaan Dapur", "[F]Rekap Pengadaan Dapur", "[G]Limbah Cair B3 Medis",
            "[O]Limbah B3 Cair Per Tanggal", "[O]Limbah B3 Cair Per Bulan", "[I]Rekap Biaya Registrasi",
            "[M]Konfirmasi Rekonsiliasi Obat", "[L]Kirim Clinical Impression Satu Sehat",
            "[M]Penilaian Pasien Terminal", "[P]Persetujuan Rawat Inap", "[M]Monitoring Reaksi Tranfusi",
            "[M]Penilaian Korban Kekerasan", "[M]Penilaian Lanjutan Risiko Jatuh Lansia",
            "[M]Penilaian Pasien Penyakit Menular", "[M]Skrining Manajer Pelayanan Pasien",
            "[M]Edukasi Pasien & Keluarga Rawat Jalan", "[M]Pemantauan EWS Pasien Dewasa",
            "[M]Penilaian Tambahan Bunuh Diri", "[L]Antrean Per Tanggal Mobile JKN",
            "[M]Penilaian Tambahan Perilaku Kekerasan", "[M]Penilaian Tambahan Melarikan Diri",
            "[P]Persetujuan Penundaan Pelayanan", "[J]Sisa Diet Pasien",
            "[M]Penilaian Awal Medis Ralan Bedah Mulut", "[M]Penilaian Pasien Keracunan",
            "[M]Pemantauan MEOWS Pasien Obstetri", "[M]Catatan ADIME Gizi", "[K]Pengajuan Biaya",
            "[M]Penilaian Awal Keperawatan Ralan Geriatri", "[M]Master Masalah Keperawatan Geriatri",
            "[M]Master Rencana Keperawatan Geriatri", "[M]Check List Kriteria Masuk HCU",
            "[M]Check List Kriteria Keluar HCU", "[M]Penilaian Risiko Dekubitus", "[P]Master Menolak Anjuran Medis",
            "[P]Penolakan Anjuran Medis", "[J]Laporan Tahunan Penolakan Anjuran Medis",
            "[M]Master Template Laporan Operasi", "[M]Dokumentasi Tindakan ESWL",
            "[M]Check List Kriteria Masuk ICU", "[M]Check List Kriteria Keluar ICU",
            "[A]Akses Ke Dokter Lain Rawat Jalan", "[M]Follow Up DBD",
            "[M]Penilaian Lanjutan Risiko Jatuh Neonatus", "[K]Persetujuan Pengajuan Biaya",
            "[J]Pemeriksaan Fisik Ralan Per Penyakit", "[M]Penilaian Lanjutan Risiko Jatuh Geriatri",
            "[M]Pemantauan EWS Pasien Neonatus", "[K]Validasi Persetujuan Pengajuan Biaya",
            "[L]Riwayat Perawatan ICare BPJS", "[K]Rekap Pengajuan Biaya",
            "[M]Penilaian Awal Medis Ralan Kulit & Kelamin", "[L]Host To Host Bank Mandiri",
            "[M]Penilaian Awal Medis Pasien Hemodialisa", "[M]Penilaian Level Kecemasan Ranap Anak",
            "[M]Penilaian Lanjutan Risiko Jatuh Psikiatri", "[M]Penilaian Lanjutan Skrining Fungsional",
            "[M]Penilaian Awal Medis Ralan Fisik & Rehabilitasi", "[M]Laporan Anestesi",
            "[P]Template Persetujuan Penolakan Tindakan", "[M]Penilaian Awal Medis IGD Psikiatri",
            "[L]Referensi Setting PPK Apotek BPJS", "[L]Referensi Obat Apotek BPJS", "[L]Mapping Obat Apotek BPJS",
            "[K]Pembayaran Bank Mandiri", "[M]Penilaian Ulang Nyeri", "[M]Penilaian Terapi Wicara",
            "[L]Obat 23 Hari Apotek BPJS", "[M]Pengkajian Restrain", "[L]Pencarian SEP Apotek BPJS",
            "[L]Monitoring Klaim Apotek BPJS", "[L]Daftar Pelayanan Obat Apotek BPJS",
            "[M]Penilaian Awal Medis Ralan Paru", "[M]Catatan Keperawatan Ralan", "[M]Catatan Persalinan",
            "[M]Skor Aldrette Pasca Anestesi", "[M]Skor Steward Pasca Anestesi", "[M]Skor Bromage Pasca Anestesi",
            "[M]Penilaian Pre Induksi", "[M]Hasil USG Urologi", "[M]Hasil USG Gynecologi",
            "[M]Hasil Pemeriksaan EKG", "[L]Hapus/Edit SEP VClaim", "[L]Kirim Diet Satu Sehat",
            "[L]Mapping Obat/Alkes/BHP Satu Sehat", "[F]Ringkasan Pengadaan Barang Dapur",
            "[L]Kirim Medication Satu Sehat", "[L]Kirim Medication Request Satu Sehat",
            "[M]Penatalaksanaan Terapi Okupasi", "[L]Kirim Medication Dispense Satu Sehat", "[M]Hasil USG Neonatus",
            "[M]Hasil Endoskopi Faring/Laring", "[L]Mapping Tindakan Radiologi Satu Sehat",
            "[L]Kirim Service Request Radiologi Satu Sehat", "[M]Hasil Endoskopi Hidung",
            "[L]Kirim Specimen Radiologi Satu Sehat", "[M]Master Masalah Keperawatan Neonatus",
            "[M]Master Rencana Keperawatan Neonatus", "[M]Penilaian Awal Keperawatan Ranap Neonatus",
            "[L]Kirim Observation Radiologi Satu Sehat", "[L]Kirim Diagnostic Report Radiologi Satu Sehat",
            "[M]Hasil Endoskopi Telinga", "[L]Mapping Tindakan Lab PK & MB Satu Sehat",
            "[L]Kirim Service Request Lab PK Satu Sehat", "[L]Kirim Service Request Lab MB Satu Sehat",
            "[L]Kirim Specimen Lab PK Satu Sehat", "[L]Kirim Specimen Lab MB Satu Sehat",
            "[L]Kirim Observation Lab PK Satu Sehat", "[L]Kirim Observation Lab MB Satu Sehat",
            "[L]Kirim Diagnostic Report Lab PK Satu Sehat", "[L]Kirim Diagnostic Report Lab MB Satu Sehat",
            "[J]Kepatuhan Kelengkapan Keselamatan Bedah", "[K]Nilai Piutang Per Cara Bayar Per Bulan",
            "[K]Ringkasan Piutang Per Cara Bayar", "[M]Penilaian Pasien Imunitas Rendah", "[M]Keseimbangan Cairan",
            "[M]Catatan Observasi CHBP", "[M]Catatan Observasi Induksi Persalinan", "[C]Kategori Penilaian SKP",
            "[C]Kriteria Penilaian SKP", "[C]Penilaian SKP Petugas/Dokter", "[L]Referensi Poli Mobile JKN FKTP",
            "[L]Referensi Dokter Mobile JKN FKTP", "[C]Rekapitulasi Penilaian SKP",
            "[K]Pembayaran Pihak Ke 3 Bank Mandiri", "[L]Metode Pembayaran Bank Mandiri",
            "[L]Bank Tujuan Transfer Bank Mandiri", "[L]Kode Transaksi Tujuan Transfer Bank Mandiri",
            "[M]Konsultasi Medik", "[M]Jawaban Konsultasi Medik", "[L]Referensi Alergi PCare",
            "[L]Referensi Prognosa PCare", "[J]Data Sasaran Usia Produktif", "[J]Data Sasaran Usia Lansia",
            "[M]Skrining Merokok Usia Sekolah & Remaja", "[M]Skrining Kekerasan Pada Perempuan",
            "[M]Skrining Obesitas", "[M]Skrining Risiko Kanker Payudara", "[M]Skrining Risiko Kanker Paru",
            "[M]Skrining TBC", "[M]Skrining Kesehatan Gigi & Mulut Remaja",
            "[M]Penilaian Awal Keperawatan Ranap Bayi/Anak", "[A]Booking MCU Perusahaan",
            "[M]Catatan Observasi Restrain Nonfarmakologi", "[M]Catatan Observasi Ventilator",
            "[M]Catatan Anestesi-Sedasi", "[M]Skrining PUMA", "[L]Kirim Care Plan Satu Sehat",
            "[L]Kirim Medication Statement Satu Sehat", "[M]Skrining Adiksi Nikotin", "[M]Skrining Thalassemia",
            "[M]Skrining Instrumen SDQ", "[M]Pemantauan PEWS Pasien Maternal", "[M]Validasi SBAR"};
        ...
        dlgdokter.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (dlgdokter.getTable().getSelectedRow() != -1) {
                    ...
                    TNmUser
                            .setText(dlgdokter.getTable().getValueAt(dlgdokter.getTable().getSelectedRow(), 1).toString());
                    TPass.setText(dlgdokter.getTable().getValueAt(dlgdokter.getTable().getSelectedRow(), 0).toString());
                    Jabatan
                            .setText(dlgdokter.getTable().getValueAt(dlgdokter.getTable().getSelectedRow(), 10).toString());
                }
                TKd.requestFocus();
            }
        ...
        dlgpetugas.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (dlgpetugas.getTable().getSelectedRow() != -1) {
                    ...
                    TNmUser.setText(
                            dlgpetugas.getTable().getValueAt(dlgpetugas.getTable().getSelectedRow(), 1).toString());
                    TPass.setText(
                            dlgpetugas.getTable().getValueAt(dlgpetugas.getTable().getSelectedRow(), 0).toString());
                    Jabatan.setText(
                            dlgpetugas.getTable().getValueAt(dlgpetugas.getTable().getSelectedRow(), 9).toString());
                }
                TKd.requestFocus();
            }
        ...
        if (TKd.getText().trim().isEmpty() || TNmUser.getText().trim().isEmpty()) {
            ...
            if (i != -1) {
                if (Sequel.mengedittf("user", "id_user=AES_ENCRYPT('" + tbUser.getValueAt(i, 0).toString() + "','nur')",
                        ...
                        + "pemantauan_pews_maternal='" + tbUser.getValueAt(i, 1072).toString() + "',"
                        + "validasi_sbar='" + tbUser.getValueAt(i, 1073).toString() + "'") == true) {
                    emptTeks();
                }
            }
        }
                            ...
                            try {
                                ...
                                if (i != -1) {
                                    Sequel.mengedit("user", "id_user=AES_ENCRYPT('" + tbUser.getValueAt(i, 0).toString() + "','nur')",
                                            ...
                                            + "pemantauan_pews_maternal='" + tbUser.getValueAt(barisdicopy, 1072).toString() + "',"
                                            + "validasi_sbar='" + tbUser.getValueAt(barisdicopy, 1073).toString() + "'");
                                }
                                userdicopy = "";
                                copyhakakses = "";
                                barisdicopy = -1;
    ...
    private void tampil() {
        try {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + "user.skrining_adiksi_nikotin,user.skrining_thalassemia,user.skrining_instrumen_sdq,user.pemantauan_pews_maternal,user.validasi_sbar from user order by AES_DECRYPT(user.id_user,'nur')");
            try {
                rs = ps.executeQuery();
                while (rs.next()) {
                    user = "";
                    user = dlgdokter.tampil3(rs.getString(1));
                    jabatan = Sequel.cariIsi("select spesialis.nm_sps from spesialis where spesialis.kd_sps=?", Sequel
                            .cariIsi("select dokter.kd_sps from dokter where dokter.kd_dokter=?", rs.getString(1)));
                    if (user.isEmpty()) {
                        user = dlgpetugas.tampil3(rs.getString(1));
                        jabatan = Sequel.cariIsi("select jabatan.nm_jbtn from jabatan where jabatan.kd_jbtn=?", Sequel
                                .cariIsi("select petugas.kd_jbtn from petugas where petugas.nip=?", rs.getString(1)));
                    }
                    try {
                        if (rs.getString(1).toLowerCase().contains(TCari.getText().toLowerCase())
                            ...
                            tabMode.addRow(new Object[]{rs.getString(1), user, jabatan, rs.getString(2),
                                rs.getBoolean("penyakit"), rs.getBoolean("obat_penyakit"), rs.getBoolean("dokter"),
                                rs.getBoolean("jadwal_praktek"), rs.getBoolean("petugas"), rs.getBoolean("pasien"),
                                rs.getBoolean("registrasi"), rs.getBoolean("tindakan_ralan"),
                                rs.getBoolean("kamar_inap"), rs.getBoolean("tindakan_ranap"),
                                rs.getBoolean("operasi"), rs.getBoolean("rujukan_keluar"),
                                rs.getBoolean("rujukan_masuk"), rs.getBoolean("beri_obat"),
                                rs.getBoolean("resep_pulang"), rs.getBoolean("pasien_meninggal"),
                                rs.getBoolean("diet_pasien"), rs.getBoolean("kelahiran_bayi"),
                                rs.getBoolean("periksa_lab"), rs.getBoolean("periksa_radiologi"),
                                rs.getBoolean("kasir_ralan"), rs.getBoolean("deposit_pasien"),
                                rs.getBoolean("piutang_pasien"), rs.getBoolean("peminjaman_berkas"),
                                rs.getBoolean("barcode"), rs.getBoolean("presensi_harian"),
                                rs.getBoolean("presensi_bulanan"), rs.getBoolean("pegawai_admin"),
                                rs.getBoolean("pegawai_user"), rs.getBoolean("suplier"),
                                rs.getBoolean("satuan_barang"), rs.getBoolean("konversi_satuan"),
                                rs.getBoolean("jenis_barang"), rs.getBoolean("obat"),
                                rs.getBoolean("stok_opname_obat"), rs.getBoolean("stok_obat_pasien"),
                                rs.getBoolean("pengadaan_obat"), rs.getBoolean("pemesanan_obat"),
                                rs.getBoolean("penjualan_obat"), rs.getBoolean("piutang_obat"),
                                rs.getBoolean("retur_ke_suplier"), rs.getBoolean("retur_dari_pembeli"),
                                rs.getBoolean("retur_obat_ranap"), rs.getBoolean("retur_piutang_pasien"),
                                rs.getBoolean("keuntungan_penjualan"), rs.getBoolean("keuntungan_beri_obat"),
                                rs.getBoolean("sirkulasi_obat"), rs.getBoolean("ipsrs_barang"),
                                rs.getBoolean("ipsrs_pengadaan_barang"), rs.getBoolean("ipsrs_stok_keluar"),
                                rs.getBoolean("ipsrs_rekap_pengadaan"), rs.getBoolean("ipsrs_rekap_stok_keluar"),
                                rs.getBoolean("ipsrs_pengeluaran_harian"), rs.getBoolean("inventaris_jenis"),
                                rs.getBoolean("inventaris_kategori"), rs.getBoolean("inventaris_merk"),
                                rs.getBoolean("inventaris_ruang"), rs.getBoolean("inventaris_produsen"),
                                rs.getBoolean("inventaris_koleksi"), rs.getBoolean("inventaris_inventaris"),
                                rs.getBoolean("inventaris_sirkulasi"), rs.getBoolean("parkir_jenis"),
                                rs.getBoolean("parkir_in"), rs.getBoolean("parkir_out"),
                                rs.getBoolean("parkir_rekap_harian"), rs.getBoolean("parkir_rekap_bulanan"),
                                rs.getBoolean("informasi_kamar"), rs.getBoolean("harian_tindakan_poli"),
                                rs.getBoolean("obat_per_poli"), rs.getBoolean("obat_per_kamar"),
                                rs.getBoolean("obat_per_dokter_ralan"), rs.getBoolean("obat_per_dokter_ranap"),
                                rs.getBoolean("harian_dokter"), rs.getBoolean("bulanan_dokter"),
                                rs.getBoolean("harian_paramedis"), rs.getBoolean("bulanan_paramedis"),
                                rs.getBoolean("pembayaran_ralan"), rs.getBoolean("pembayaran_ranap"),
                                rs.getBoolean("rekap_pembayaran_ralan"), rs.getBoolean("rekap_pembayaran_ranap"),
                                rs.getBoolean("tagihan_masuk"), rs.getBoolean("tambahan_biaya"),
                                rs.getBoolean("potongan_biaya"), rs.getBoolean("resep_obat"),
                                rs.getBoolean("resume_pasien"), rs.getBoolean("penyakit_ralan"),
                                rs.getBoolean("penyakit_ranap"), rs.getBoolean("kamar"),
                                rs.getBoolean("tarif_ralan"), rs.getBoolean("tarif_ranap"),
                                rs.getBoolean("tarif_lab"), rs.getBoolean("tarif_radiologi"),
                                rs.getBoolean("tarif_operasi"), rs.getBoolean("akun_rekening"),
                                rs.getBoolean("rekening_tahun"), rs.getBoolean("posting_jurnal"),
                                rs.getBoolean("buku_besar"), rs.getBoolean("cashflow"), rs.getBoolean("keuangan"),
                                rs.getBoolean("pengeluaran"), rs.getBoolean("setup_pjlab"),
                                rs.getBoolean("setup_otolokasi"), rs.getBoolean("setup_jam_kamin"),
                                rs.getBoolean("setup_embalase"), rs.getBoolean("tracer_login"),
                                rs.getBoolean("display"), rs.getBoolean("set_harga_obat"),
                                rs.getBoolean("set_penggunaan_tarif"), rs.getBoolean("set_oto_ralan"),
                                rs.getBoolean("biaya_harian"), rs.getBoolean("biaya_masuk_sekali"),
                                rs.getBoolean("set_no_rm"), rs.getBoolean("billing_ralan"),
                                rs.getBoolean("billing_ranap"), rs.getBoolean("jm_ranap_dokter"),
                                rs.getBoolean("igd"), rs.getBoolean("barcoderalan"), rs.getBoolean("barcoderanap"),
                                rs.getBoolean("set_harga_obat_ralan"), rs.getBoolean("set_harga_obat_ranap"),
                                rs.getBoolean("penyakit_pd3i"), rs.getBoolean("surveilans_pd3i"),
                                rs.getBoolean("surveilans_ralan"), rs.getBoolean("diagnosa_pasien"),
                                rs.getBoolean("surveilans_ranap"), rs.getBoolean("pny_takmenular_ranap"),
                                rs.getBoolean("pny_takmenular_ralan"), rs.getBoolean("kunjungan_ralan"),
                                rs.getBoolean("rl32"), rs.getBoolean("rl33"), rs.getBoolean("rl37"),
                                rs.getBoolean("rl38"), rs.getBoolean("harian_tindakan_dokter"),
                                rs.getBoolean("sms"), rs.getBoolean("sidikjari"), rs.getBoolean("jam_masuk"),
                                rs.getBoolean("jadwal_pegawai"), rs.getBoolean("parkir_barcode"),
                                rs.getBoolean("set_nota"), rs.getBoolean("dpjp_ranap"),
                                rs.getBoolean("mutasi_barang"), rs.getBoolean("rl34"), rs.getBoolean("rl36"),
                                rs.getBoolean("fee_visit_dokter"), rs.getBoolean("fee_bacaan_ekg"),
                                rs.getBoolean("fee_rujukan_rontgen"), rs.getBoolean("fee_rujukan_ranap"),
                                rs.getBoolean("fee_ralan"), rs.getBoolean("akun_bayar"),
                                rs.getBoolean("bayar_pemesanan_obat"), rs.getBoolean("obat_per_dokter_peresep"),
                                rs.getBoolean("ipsrs_jenis_barang"), rs.getBoolean("pemasukan_lain"),
                                rs.getBoolean("pengaturan_rekening"), rs.getBoolean("closing_kasir"),
                                rs.getBoolean("keterlambatan_presensi"), rs.getBoolean("set_harga_kamar"),
                                rs.getBoolean("rekap_per_shift"), rs.getBoolean("bpjs_cek_nik"),
                                rs.getBoolean("bpjs_cek_kartu"), rs.getBoolean("bpjs_cek_riwayat"),
                                rs.getBoolean("obat_per_cara_bayar"), rs.getBoolean("kunjungan_ranap"),
                                rs.getBoolean("bayar_piutang"), rs.getBoolean("payment_point"),
                                rs.getBoolean("bpjs_cek_nomor_rujukan"), rs.getBoolean("icd9"),
                                rs.getBoolean("darurat_stok"), rs.getBoolean("retensi_rm"),
                                rs.getBoolean("temporary_presensi"), rs.getBoolean("jurnal_harian"),
                                rs.getBoolean("sirkulasi_obat2"), rs.getBoolean("edit_registrasi"),
                                rs.getBoolean("bpjs_referensi_diagnosa"), rs.getBoolean("bpjs_referensi_poli"),
                                rs.getBoolean("industrifarmasi"), rs.getBoolean("harian_js"),
                                rs.getBoolean("bulanan_js"), rs.getBoolean("harian_paket_bhp"),
                                rs.getBoolean("bulanan_paket_bhp"), rs.getBoolean("piutang_pasien2"),
                                rs.getBoolean("bpjs_referensi_faskes"), rs.getBoolean("bpjs_sep"),
                                rs.getBoolean("pengambilan_utd"), rs.getBoolean("tarif_utd"),
                                rs.getBoolean("pengambilan_utd2"), rs.getBoolean("utd_medis_rusak"),
                                rs.getBoolean("pengambilan_penunjang_utd"),
                                rs.getBoolean("pengambilan_penunjang_utd2"), rs.getBoolean("utd_penunjang_rusak"),
                                rs.getBoolean("suplier_penunjang"), rs.getBoolean("utd_donor"),
                                rs.getBoolean("bpjs_monitoring_klaim"), rs.getBoolean("utd_cekal_darah"),
                                rs.getBoolean("utd_komponen_darah"), rs.getBoolean("utd_stok_darah"),
                                rs.getBoolean("utd_pemisahan_darah"), rs.getBoolean("harian_kamar"),
                                rs.getBoolean("rincian_piutang_pasien"),
                                rs.getBoolean("keuntungan_beri_obat_nonpiutang"),
                                rs.getBoolean("reklasifikasi_ralan"), rs.getBoolean("reklasifikasi_ranap"),
                                rs.getBoolean("utd_penyerahan_darah"), rs.getBoolean("hutang_obat"),
                                rs.getBoolean("riwayat_obat_alkes_bhp"), rs.getBoolean("sensus_harian_poli"),
                                rs.getBoolean("rl4a"), rs.getBoolean("aplicare_referensi_kamar"),
                                rs.getBoolean("aplicare_ketersediaan_kamar"),
                                rs.getBoolean("inacbg_klaim_baru_otomatis"),
                                rs.getBoolean("inacbg_klaim_baru_manual"), rs.getBoolean("inacbg_coder_nik"),
                                rs.getBoolean("mutasi_berkas"), rs.getBoolean("akun_piutang"),
                                rs.getBoolean("harian_kso"), rs.getBoolean("bulanan_kso"),
                                rs.getBoolean("harian_menejemen"), rs.getBoolean("bulanan_menejemen"),
                                ...
                                rs.getBoolean("inhealth_referensi_faskes"), rs.getBoolean("inhealth_sjp"),
                                rs.getBoolean("piutang_ralan"), rs.getBoolean("piutang_ranap"),
                                rs.getBoolean("detail_piutang_penjab"), rs.getBoolean("lama_pelayanan_ralan"),
                                rs.getBoolean("catatan_pasien"), rs.getBoolean("rl4b"), rs.getBoolean("rl4asebab"),
                                rs.getBoolean("rl4bsebab"), rs.getBoolean("data_HAIs"),
                                rs.getBoolean("harian_HAIs"), rs.getBoolean("bulanan_HAIs"),
                                rs.getBoolean("hitung_bor"), rs.getBoolean("perusahaan_pasien"),
                                rs.getBoolean("resep_dokter"), rs.getBoolean("lama_pelayanan_apotek"),
                                rs.getBoolean("hitung_alos"), rs.getBoolean("detail_tindakan"),
                                rs.getBoolean("rujukan_poli_internal"), rs.getBoolean("rekap_poli_anak"),
                                rs.getBoolean("grafik_kunjungan_poli"), rs.getBoolean("grafik_kunjungan_perdokter"),
                                ...
                                rs.getBoolean("berkas_digital_perawatan"), rs.getBoolean("penyakit_menular_ranap"),
                                rs.getBoolean("penyakit_menular_ralan"), rs.getBoolean("grafik_kunjungan_perbulan"),
                                ...
                                rs.getBoolean("kategori_barang"), rs.getBoolean("golongan_barang"),
                                rs.getBoolean("pemberian_obat_pertanggal"),
                                rs.getBoolean("penjualan_obat_pertanggal"), rs.getBoolean("pcare_cek_kesadaran"),
                                rs.getBoolean("pembatalan_periksa_dokter"), rs.getBoolean("pembayaran_per_unit"),
                                ...
                                rs.getBoolean("grafik_kunjungan_ranaptahun"), rs.getBoolean("pcare_cek_rujukan"),
                                rs.getBoolean("grafik_lab_ralantahun"), rs.getBoolean("grafik_rad_ralantahun"),
                                rs.getBoolean("cek_entry_ralan"), rs.getBoolean("inacbg_klaim_baru_manual2"),
                                rs.getBoolean("permintaan_medis"), rs.getBoolean("rekap_permintaan_medis"),
                                rs.getBoolean("surat_pemesanan_medis"), rs.getBoolean("permintaan_non_medis"),
                                rs.getBoolean("rekap_permintaan_non_medis"),
                                rs.getBoolean("surat_pemesanan_non_medis"), rs.getBoolean("grafik_per_perujuk"),
                                rs.getBoolean("bpjs_cek_prosedur"), rs.getBoolean("bpjs_cek_kelas_rawat"),
                                rs.getBoolean("bpjs_cek_dokter"), rs.getBoolean("bpjs_cek_spesialistik"),
                                rs.getBoolean("bpjs_cek_ruangrawat"), rs.getBoolean("bpjs_cek_carakeluar"),
                                rs.getBoolean("bpjs_cek_pasca_pulang"), rs.getBoolean("detail_tindakan_okvk"),
                                rs.getBoolean("billing_parsial"), rs.getBoolean("bpjs_cek_nomor_rujukan_rs"),
                                rs.getBoolean("bpjs_cek_rujukan_kartu_pcare"),
                                rs.getBoolean("bpjs_cek_rujukan_kartu_rs"), rs.getBoolean("akses_depo_obat"),
                                rs.getBoolean("bpjs_rujukan_keluar"), rs.getBoolean("grafik_lab_ralanbulan"),
                                rs.getBoolean("pengeluaran_stok_apotek"), rs.getBoolean("grafik_rad_ralanbulan"),
                                rs.getBoolean("detailjmdokter2"), rs.getBoolean("pengaduan_pasien"),
                                rs.getBoolean("grafik_lab_ralanhari"), rs.getBoolean("grafik_rad_ralanhari"),
                                rs.getBoolean("sensus_harian_ralan"), rs.getBoolean("metode_racik"),
                                rs.getBoolean("pembayaran_akun_bayar"), rs.getBoolean("pengguna_obat_resep"),
                                rs.getBoolean("rekap_pemesanan"), rs.getBoolean("master_berkas_pegawai"),
                                rs.getBoolean("berkas_kepegawaian"), rs.getBoolean("riwayat_jabatan"),
                                rs.getBoolean("riwayat_pendidikan"), rs.getBoolean("riwayat_naik_gaji"),
                                rs.getBoolean("kegiatan_ilmiah"), rs.getBoolean("riwayat_penghargaan"),
                                rs.getBoolean("riwayat_penelitian"), rs.getBoolean("penerimaan_non_medis"),
                                rs.getBoolean("bayar_pesan_non_medis"), rs.getBoolean("hutang_barang_non_medis"),
                                rs.getBoolean("rekap_pemesanan_non_medis"), rs.getBoolean("insiden_keselamatan"),
                                rs.getBoolean("insiden_keselamatan_pasien"), rs.getBoolean("grafik_ikp_pertahun"),
                                rs.getBoolean("grafik_ikp_perbulan"), rs.getBoolean("grafik_ikp_pertanggal"),
                                rs.getBoolean("riwayat_data_batch"), rs.getBoolean("grafik_ikp_jenis"),
                                rs.getBoolean("grafik_ikp_dampak"), rs.getBoolean("piutang_akun_piutang"),
                                rs.getBoolean("grafik_kunjungan_per_agama"),
                                rs.getBoolean("grafik_kunjungan_per_umur"), rs.getBoolean("suku_bangsa"),
                                rs.getBoolean("bahasa_pasien"), rs.getBoolean("golongan_tni"),
                                rs.getBoolean("satuan_tni"), rs.getBoolean("jabatan_tni"),
                                rs.getBoolean("pangkat_tni"), rs.getBoolean("golongan_polri"),
                                rs.getBoolean("satuan_polri"), rs.getBoolean("jabatan_polri"),
                                rs.getBoolean("pangkat_polri"), rs.getBoolean("cacat_fisik"),
                                rs.getBoolean("grafik_kunjungan_suku"), rs.getBoolean("grafik_kunjungan_bahasa"),
                                rs.getBoolean("booking_operasi"), rs.getBoolean("mapping_poli_bpjs"),
                                rs.getBoolean("grafik_kunjungan_per_cacat"), rs.getBoolean("barang_cssd"),
                                rs.getBoolean("skdp_bpjs"), rs.getBoolean("booking_registrasi"),
                                rs.getBoolean("bpjs_cek_propinsi"), rs.getBoolean("bpjs_cek_kabupaten"),
                                rs.getBoolean("bpjs_cek_kecamatan"), rs.getBoolean("bpjs_cek_dokterdpjp"),
                                rs.getBoolean("bpjs_cek_riwayat_rujukanrs"),
                                rs.getBoolean("bpjs_cek_tanggal_rujukan"), rs.getBoolean("permintaan_lab"),
                                rs.getBoolean("permintaan_radiologi"), rs.getBoolean("surat_indeks"),
                                rs.getBoolean("surat_map"), rs.getBoolean("surat_almari"),
                                rs.getBoolean("surat_rak"), rs.getBoolean("surat_ruang"),
                                rs.getBoolean("surat_klasifikasi"), rs.getBoolean("surat_status"),
                                rs.getBoolean("surat_sifat"), rs.getBoolean("surat_balas"),
                                rs.getBoolean("surat_masuk"), rs.getBoolean("pcare_cek_dokter"),
                                rs.getBoolean("pcare_cek_poli"), rs.getBoolean("pcare_cek_provider"),
                                rs.getBoolean("pcare_cek_statuspulang"), rs.getBoolean("pcare_cek_spesialis"),
                                rs.getBoolean("pcare_cek_subspesialis"), rs.getBoolean("pcare_cek_sarana"),
                                rs.getBoolean("pcare_cek_khusus"), rs.getBoolean("pcare_cek_obat"),
                                rs.getBoolean("pcare_cek_tindakan"), rs.getBoolean("pcare_cek_faskessubspesialis"),
                                rs.getBoolean("pcare_cek_faskesalihrawat"),
                                rs.getBoolean("pcare_cek_faskesthalasemia"), rs.getBoolean("pcare_mapping_obat"),
                                rs.getBoolean("pcare_mapping_tindakan"), rs.getBoolean("pcare_club_prolanis"),
                                rs.getBoolean("pcare_mapping_poli"), rs.getBoolean("pcare_kegiatan_kelompok"),
                                rs.getBoolean("pcare_mapping_tindakan_ranap"),
                                rs.getBoolean("pcare_peserta_kegiatan_kelompok"), rs.getBoolean("sirkulasi_obat3"),
                                rs.getBoolean("bridging_pcare_daftar"), rs.getBoolean("pcare_mapping_dokter"),
                                rs.getBoolean("ranap_per_ruang"), rs.getBoolean("penyakit_ranap_cara_bayar"),
                                rs.getBoolean("anggota_militer_dirawat"), rs.getBoolean("set_input_parsial"),
                                rs.getBoolean("lama_pelayanan_radiologi"), rs.getBoolean("lama_pelayanan_lab"),
                                rs.getBoolean("bpjs_cek_sep"), rs.getBoolean("catatan_perawatan"),
                                rs.getBoolean("surat_keluar"), rs.getBoolean("kegiatan_farmasi"),
                                rs.getBoolean("stok_opname_logistik"), rs.getBoolean("sirkulasi_non_medis"),
                                rs.getBoolean("rekap_lab_pertahun"), rs.getBoolean("perujuk_lab_pertahun"),
                                rs.getBoolean("rekap_radiologi_pertahun"),
                                rs.getBoolean("perujuk_radiologi_pertahun"), rs.getBoolean("jumlah_porsi_diet"),
                                rs.getBoolean("jumlah_macam_diet"), rs.getBoolean("payment_point2"),
                                rs.getBoolean("pembayaran_akun_bayar2"), rs.getBoolean("hapus_nota_salah"),
                                rs.getBoolean("pengkajian_askep"), rs.getBoolean("hais_perbangsal"),
                                rs.getBoolean("ppn_obat"), rs.getBoolean("saldo_akun_perbulan"),
                                rs.getBoolean("display_apotek"), rs.getBoolean("sisrute_referensi_faskes"),
                                rs.getBoolean("sisrute_referensi_alasanrujuk"),
                                rs.getBoolean("sisrute_referensi_diagnosa"), rs.getBoolean("sisrute_rujukan_masuk"),
                                rs.getBoolean("sisrute_rujukan_keluar"), rs.getBoolean("bpjs_cek_skdp"),
                                rs.getBoolean("data_batch"), rs.getBoolean("kunjungan_permintaan_lab"),
                                ...
                                rs.getBoolean("pcare_pemberian_obat"), rs.getBoolean("pcare_pemberian_tindakan"),
                                rs.getBoolean("pembayaran_akun_bayar3"), rs.getBoolean("password_asuransi"),
                                rs.getBoolean("kemenkes_sitt"), rs.getBoolean("siranap_ketersediaan_kamar"),
                                rs.getBoolean("grafik_tb_periodelaporan"), rs.getBoolean("grafik_tb_rujukan"),
                                rs.getBoolean("grafik_tb_riwayat"), rs.getBoolean("grafik_tb_tipediagnosis"),
                                rs.getBoolean("grafik_tb_statushiv"), rs.getBoolean("grafik_tb_skoringanak"),
                                ...
                                rs.getBoolean("grafik_tb_hasilteshiv"), rs.getBoolean("kadaluarsa_batch"),
                                rs.getBoolean("sisa_stok"), rs.getBoolean("obat_per_resep"),
                                rs.getBoolean("pemakaian_air_pdam"), rs.getBoolean("limbah_b3_medis"),
                                rs.getBoolean("grafik_air_pdam_pertanggal"),
                                rs.getBoolean("grafik_air_pdam_perbulan"),
                                rs.getBoolean("grafik_limbahb3_pertanggal"),
                                rs.getBoolean("grafik_limbahb3_perbulan"), rs.getBoolean("limbah_domestik"),
                                rs.getBoolean("grafik_limbahdomestik_pertanggal"),
                                rs.getBoolean("grafik_limbahdomestik_perbulan"), rs.getBoolean("mutu_air_limbah"),
                                rs.getBoolean("pest_control"), rs.getBoolean("ruang_perpustakaan"),
                                rs.getBoolean("kategori_perpustakaan"), rs.getBoolean("jenis_perpustakaan"),
                                rs.getBoolean("pengarang_perpustakaan"), rs.getBoolean("penerbit_perpustakaan"),
                                rs.getBoolean("koleksi_perpustakaan"), rs.getBoolean("inventaris_perpustakaan"),
                                rs.getBoolean("set_peminjaman_perpustakaan"), rs.getBoolean("denda_perpustakaan"),
                                rs.getBoolean("anggota_perpustakaan"), rs.getBoolean("peminjaman_perpustakaan"),
                                rs.getBoolean("bayar_denda_perpustakaan"), rs.getBoolean("ebook_perpustakaan"),
                                rs.getBoolean("jenis_cidera_k3rs"), rs.getBoolean("penyebab_k3rs"),
                                rs.getBoolean("jenis_luka_k3rs"), rs.getBoolean("lokasi_kejadian_k3rs"),
                                rs.getBoolean("dampak_cidera_k3rs"), rs.getBoolean("jenis_pekerjaan_k3rs"),
                                rs.getBoolean("bagian_tubuh_k3rs"), rs.getBoolean("peristiwa_k3rs"),
                                rs.getBoolean("grafik_k3_pertahun"), rs.getBoolean("grafik_k3_perbulan"),
                                rs.getBoolean("grafik_k3_pertanggal"), rs.getBoolean("grafik_k3_perjeniscidera"),
                                rs.getBoolean("grafik_k3_perpenyebab"), rs.getBoolean("grafik_k3_perjenisluka"),
                                rs.getBoolean("grafik_k3_lokasikejadian"), rs.getBoolean("grafik_k3_dampakcidera"),
                                rs.getBoolean("grafik_k3_perjenispekerjaan"),
                                rs.getBoolean("grafik_k3_perbagiantubuh"), rs.getBoolean("jenis_cidera_k3rstahun"),
                                rs.getBoolean("penyebab_k3rstahun"), rs.getBoolean("jenis_luka_k3rstahun"),
                                rs.getBoolean("lokasi_kejadian_k3rstahun"),
                                rs.getBoolean("dampak_cidera_k3rstahun"),
                                rs.getBoolean("jenis_pekerjaan_k3rstahun"), rs.getBoolean("bagian_tubuh_k3rstahun"),
                                rs.getBoolean("sekrining_rawat_jalan"), rs.getBoolean("bpjs_histori_pelayanan"),
                                rs.getBoolean("rekap_mutasi_berkas"),
                                rs.getBoolean("skrining_ralan_pernapasan_pertahun"),
                                rs.getBoolean("pengajuan_barang_medis"), rs.getBoolean("pengajuan_barang_nonmedis"),
                                ...
                                rs.getBoolean("grafik_bidangpegawai"), rs.getBoolean("grafik_departemenpegawai"),
                                rs.getBoolean("grafik_pendidikanpegawai"), rs.getBoolean("grafik_sttswppegawai"),
                                rs.getBoolean("grafik_sttskerjapegawai"), rs.getBoolean("grafik_sttspulangranap"),
                                rs.getBoolean("kip_pasien_ranap"), rs.getBoolean("kip_pasien_ralan"),
                                rs.getBoolean("bpjs_mapping_dokterdpjp"), rs.getBoolean("data_triase_igd"),
                                rs.getBoolean("master_triase_skala1"), rs.getBoolean("master_triase_skala2"),
                                rs.getBoolean("master_triase_skala3"), rs.getBoolean("master_triase_skala4"),
                                rs.getBoolean("master_triase_skala5"), rs.getBoolean("master_triase_pemeriksaan"),
                                rs.getBoolean("master_triase_macamkasus"), rs.getBoolean("rekap_permintaan_diet"),
                                rs.getBoolean("daftar_pasien_ranap"), rs.getBoolean("daftar_pasien_ranaptni"),
                                rs.getBoolean("pengajuan_asetinventaris"), rs.getBoolean("item_apotek_jenis"),
                                rs.getBoolean("item_apotek_kategori"), rs.getBoolean("item_apotek_golongan"),
                                ...
                                rs.getBoolean("grafik_inventaris_ruang"), rs.getBoolean("harian_HAIs2"),
                                rs.getBoolean("grafik_inventaris_jenis"), rs.getBoolean("data_resume_pasien"),
                                rs.getBoolean("perkiraan_biaya_ranap"), rs.getBoolean("rekap_obat_poli"),
                                rs.getBoolean("rekap_obat_pasien"),
                                rs.getBoolean("permintaan_perbaikan_inventaris"),
                                rs.getBoolean("grafik_HAIs_pasienbangsal"),
                                rs.getBoolean("grafik_HAIs_pasienbulan"), rs.getBoolean("grafik_HAIs_laju_vap"),
                                rs.getBoolean("grafik_HAIs_laju_iad"), rs.getBoolean("grafik_HAIs_laju_pleb"),
                                rs.getBoolean("grafik_HAIs_laju_isk"), rs.getBoolean("grafik_HAIs_laju_ilo"),
                                rs.getBoolean("grafik_HAIs_laju_hap"), rs.getBoolean("inhealth_mapping_poli"),
                                ...
                                rs.getBoolean("inhealth_mapping_tindakan_operasi"), rs.getBoolean("hibah_obat_bhp"),
                                rs.getBoolean("asal_hibah"), rs.getBoolean("asuhan_gizi"),
                                rs.getBoolean("inhealth_kirim_tagihan"), rs.getBoolean("sirkulasi_obat4"),
                                rs.getBoolean("sirkulasi_obat5"), rs.getBoolean("sirkulasi_non_medis2"),
                                rs.getBoolean("monitoring_asuhan_gizi"), rs.getBoolean("penerimaan_obat_perbulan"),
                                rs.getBoolean("rekap_kunjungan"), rs.getBoolean("surat_sakit"),
                                rs.getBoolean("penilaian_awal_keperawatan_ralan"), rs.getBoolean("permintaan_diet"),
                                rs.getBoolean("master_masalah_keperawatan"), rs.getBoolean("pengajuan_cuti"),
                                rs.getBoolean("kedatangan_pasien"), rs.getBoolean("utd_pendonor"),
                                rs.getBoolean("toko_suplier"), rs.getBoolean("toko_jenis"),
                                rs.getBoolean("toko_set_harga"), rs.getBoolean("toko_barang"),
                                rs.getBoolean("penagihan_piutang_pasien"), rs.getBoolean("akun_penagihan_piutang"),
                                rs.getBoolean("stok_opname_toko"), rs.getBoolean("toko_riwayat_barang"),
                                rs.getBoolean("toko_surat_pemesanan"), rs.getBoolean("toko_pengajuan_barang"),
                                rs.getBoolean("toko_penerimaan_barang"), rs.getBoolean("toko_pengadaan_barang"),
                                rs.getBoolean("toko_hutang"), rs.getBoolean("toko_bayar_pemesanan"),
                                rs.getBoolean("toko_member"), rs.getBoolean("toko_penjualan"),
                                rs.getBoolean("registrasi_poli_per_tanggal"), rs.getBoolean("toko_piutang"),
                                rs.getBoolean("toko_retur_beli"), rs.getBoolean("ipsrs_returbeli"),
                                rs.getBoolean("ipsrs_riwayat_barang"), rs.getBoolean("pasien_corona"),
                                rs.getBoolean("toko_pendapatan_harian"), rs.getBoolean("diagnosa_pasien_corona"),
                                ...
                                rs.getBoolean("toko_bayar_piutang"), rs.getBoolean("toko_piutang_harian"),
                                rs.getBoolean("toko_penjualan_harian"), rs.getBoolean("deteksi_corona"),
                                rs.getBoolean("penilaian_awal_keperawatan_kebidanan"),
                                rs.getBoolean("pengumuman_epasien"), rs.getBoolean("surat_hamil"),
                                rs.getBoolean("set_tarif_online"), rs.getBoolean("booking_periksa"),
                                rs.getBoolean("toko_sirkulasi"), rs.getBoolean("toko_retur_jual"),
                                rs.getBoolean("toko_retur_piutang"), rs.getBoolean("toko_sirkulasi2"),
                                ...
                                rs.getBoolean("master_masalah_keperawatan_anak"), rs.getBoolean("master_imunisasi"),
                                rs.getBoolean("zis_patologis_penerima_dankes"), rs.getBoolean("pcare_cek_kartu"),
                                rs.getBoolean("surat_bebas_narkoba"), rs.getBoolean("surat_keterangan_covid"),
                                rs.getBoolean("pemakaian_air_tanah"), rs.getBoolean("grafik_air_tanah_pertanggal"),
                                rs.getBoolean("grafik_air_tanah_perbulan"), rs.getBoolean("lama_pelayanan_poli"),
                                rs.getBoolean("hemodialisa"), rs.getBoolean("laporan_tahunan_irj"),
                                rs.getBoolean("grafik_harian_hemodialisa"),
                                rs.getBoolean("grafik_bulanan_hemodialisa"),
                                rs.getBoolean("grafik_tahunan_hemodialisa"),
                                rs.getBoolean("grafik_bulanan_meninggal"), rs.getBoolean("perbaikan_inventaris"),
                                rs.getBoolean("surat_cuti_hamil"), rs.getBoolean("permintaan_stok_obat_pasien"),
                                rs.getBoolean("pemeliharaan_inventaris"), rs.getBoolean("klasifikasi_pasien_ranap"),
                                rs.getBoolean("bulanan_klasifikasi_pasien_ranap"),
                                rs.getBoolean("harian_klasifikasi_pasien_ranap"),
                                rs.getBoolean("klasifikasi_pasien_perbangsal"), rs.getBoolean("soap_perawatan"),
                                rs.getBoolean("klaim_rawat_jalan"), rs.getBoolean("skrining_gizi"),
                                rs.getBoolean("lama_penyiapan_rm"), rs.getBoolean("dosis_radiologi"),
                                rs.getBoolean("demografi_umur_kunjungan"), rs.getBoolean("jam_diet_pasien"),
                                rs.getBoolean("rvu_bpjs"), rs.getBoolean("verifikasi_penerimaan_farmasi"),
                                rs.getBoolean("verifikasi_penerimaan_logistik"),
                                rs.getBoolean("pemeriksaan_lab_pa"), rs.getBoolean("ringkasan_pengajuan_obat"),
                                rs.getBoolean("ringkasan_pemesanan_obat"),
                                rs.getBoolean("ringkasan_pengadaan_obat"),
                                rs.getBoolean("ringkasan_penerimaan_obat"), rs.getBoolean("ringkasan_hibah_obat"),
                                rs.getBoolean("ringkasan_penjualan_obat"), rs.getBoolean("ringkasan_beri_obat"),
                                ...
                                rs.getBoolean("ringkasan_returbeli_nonmedis"), rs.getBoolean("omset_penerimaan"),
                                rs.getBoolean("validasi_penagihan_piutang"), rs.getBoolean("permintaan_ranap"),
                                rs.getBoolean("bpjs_diagnosa_prb"), rs.getBoolean("bpjs_obat_prb"),
                                rs.getBoolean("bpjs_surat_kontrol"), rs.getBoolean("penggunaan_bhp_ok"),
                                rs.getBoolean("surat_keterangan_rawat_inap"),
                                rs.getBoolean("surat_keterangan_sehat"), rs.getBoolean("pendapatan_per_carabayar"),
                                rs.getBoolean("akun_host_to_host_bank_jateng"),
                                rs.getBoolean("pembayaran_bank_jateng"), rs.getBoolean("bpjs_surat_pri"),
                                rs.getBoolean("ringkasan_tindakan"), rs.getBoolean("lama_pelayanan_pasien"),
                                rs.getBoolean("surat_sakit_pihak_2"), rs.getBoolean("tagihan_hutang_obat"),
                                rs.getBoolean("referensi_mobilejkn_bpjs"),
                                rs.getBoolean("batal_pendaftaran_mobilejkn_bpjs"), rs.getBoolean("lama_operasi"),
                                ...
                                rs.getBoolean("piutang_obat_belum_lunas"), rs.getBoolean("integrasi_briapi"),
                                rs.getBoolean("pengadaan_aset_inventaris"), rs.getBoolean("akun_aset_inventaris"),
                                rs.getBoolean("suplier_inventaris"), rs.getBoolean("penerimaan_aset_inventaris"),
                                rs.getBoolean("bayar_pemesanan_iventaris"), rs.getBoolean("hutang_aset_inventaris"),
                                rs.getBoolean("hibah_aset_inventaris"), rs.getBoolean("titip_faktur_non_medis"),
                                rs.getBoolean("validasi_tagihan_non_medis"), rs.getBoolean("titip_faktur_aset"),
                                rs.getBoolean("validasi_tagihan_aset"), rs.getBoolean("hibah_non_medis"),
                                rs.getBoolean("pcare_alasan_tacc"), rs.getBoolean("resep_luar"),
                                rs.getBoolean("surat_bebas_tbc"), rs.getBoolean("surat_buta_warna"),
                                rs.getBoolean("surat_bebas_tato"), rs.getBoolean("surat_kewaspadaan_kesehatan"),
                                ...
                                rs.getBoolean("bpjs_referensi_jadwal_hfis"), rs.getBoolean("penilaian_fisioterapi"),
                                rs.getBoolean("bpjs_program_prb"), rs.getBoolean("bpjs_suplesi_jasaraharja"),
                                rs.getBoolean("bpjs_data_induk_kecelakaan"), rs.getBoolean("bpjs_sep_internal"),
                                rs.getBoolean("bpjs_klaim_jasa_raharja"), rs.getBoolean("bpjs_daftar_finger_print"),
                                rs.getBoolean("bpjs_rujukan_khusus"), rs.getBoolean("pemeliharaan_gedung"),
                                ...
                                rs.getBoolean("penilaian_mcu"), rs.getBoolean("peminjam_piutang"),
                                rs.getBoolean("piutang_lainlain"), rs.getBoolean("cara_bayar"),
                                rs.getBoolean("audit_kepatuhan_apd"), rs.getBoolean("bpjs_task_id"),
                                rs.getBoolean("bayar_piutang_lain"), rs.getBoolean("pembayaran_akun_bayar4"),
                                rs.getBoolean("stok_akhir_farmasi_pertanggal"),
                                rs.getBoolean("riwayat_kamar_pasien"), rs.getBoolean("uji_fungsi_kfr"),
                                rs.getBoolean("hapus_berkas_digital_perawatan"),
                                rs.getBoolean("kategori_pengeluaran_harian"),
                                rs.getBoolean("kategori_pemasukan_lain"), rs.getBoolean("pembayaran_akun_bayar5"),
                                rs.getBoolean("ruang_ok"), rs.getBoolean("telaah_resep"),
                                rs.getBoolean("jasa_tindakan_pasien"), rs.getBoolean("permintaan_resep_pulang"),
                                rs.getBoolean("rekap_jm_dokter"), rs.getBoolean("status_data_rm"),
                                rs.getBoolean("ubah_petugas_lab_pk"), rs.getBoolean("ubah_petugas_lab_pa"),
                                rs.getBoolean("ubah_petugas_radiologi"), rs.getBoolean("gabung_norawat"),
                                rs.getBoolean("gabung_rm"), rs.getBoolean("ringkasan_biaya_obat_pasien_pertanggal"),
                                ...
                                rs.getBoolean("bpjs_referensi_poli_apotek"), rs.getBoolean("bayar_jm_dokter"),
                                ...
                                rs.getBoolean("akun_bayar_hutang"), rs.getBoolean("master_rencana_keperawatan"),
                                rs.getBoolean("laporan_tahunan_igd"), rs.getBoolean("obat_bhp_tidakbergerak"),
                                ...
                                rs.getBoolean("anggota_polri_dirawat"), rs.getBoolean("daftar_pasien_ranap_polri"),
                                rs.getBoolean("soap_ralan_polri"), rs.getBoolean("soap_ranap_polri"),
                                rs.getBoolean("laporan_penyakit_polri"),
                                rs.getBoolean("jumlah_pengunjung_ralan_polri"),
                                rs.getBoolean("catatan_observasi_igd"), rs.getBoolean("catatan_observasi_ranap"),
                                ...
                                rs.getBoolean("penilaian_psikologi"), rs.getBoolean("audit_cuci_tangan_medis"),
                                rs.getBoolean("audit_pembuangan_limbah"), rs.getBoolean("ruang_audit_kepatuhan"),
                                ...
                                rs.getBoolean("audit_penempatan_pasien"), rs.getBoolean("audit_kamar_jenazah"),
                                rs.getBoolean("audit_bundle_iadp"), rs.getBoolean("audit_bundle_ido"),
                                ...
                                rs.getBoolean("persetujuan_penolakan_tindakan"), rs.getBoolean("audit_bundle_isk"),
                                rs.getBoolean("audit_bundle_plabsi"), rs.getBoolean("audit_bundle_vap"),
                                ...
                                rs.getBoolean("integrasi_khanza_health_services"), rs.getBoolean("soap_ralan_tni"),
                                rs.getBoolean("soap_ranap_tni"), rs.getBoolean("jumlah_pengunjung_ralan_tni"),
                                rs.getBoolean("laporan_penyakit_tni"), rs.getBoolean("catatan_keperawatan_ranap"),
                                ...
                                rs.getBoolean("template_hasil_radiologi"), rs.getBoolean("laporan_bulanan_irj"),
                                rs.getBoolean("template_pemeriksaan"), rs.getBoolean("pemeriksaan_lab_mb"),
                                rs.getBoolean("ubah_petugas_lab_mb"), rs.getBoolean("penilaian_pre_operasi"),
                                rs.getBoolean("penilaian_pre_anestesi"), rs.getBoolean("perencanaan_pemulangan"),
                                ...
                                rs.getBoolean("skrining_nutrisi_dewasa"), rs.getBoolean("skrining_nutrisi_lansia"),
                                rs.getBoolean("hasil_pemeriksaan_usg"), rs.getBoolean("skrining_nutrisi_anak"),
                                rs.getBoolean("akun_host_to_host_bank_jabar"),
                                rs.getBoolean("pembayaran_bank_jabar"),
                                rs.getBoolean("surat_pernyataan_pasien_umum"), rs.getBoolean("konseling_farmasi"),
                                rs.getBoolean("pelayanan_informasi_obat"), rs.getBoolean("jawaban_pio_apoteker"),
                                ...
                                rs.getBoolean("satu_sehat_kirim_encounter"), rs.getBoolean("catatan_cek_gds"),
                                rs.getBoolean("satu_sehat_kirim_condition"), rs.getBoolean("checklist_pre_operasi"),
                                rs.getBoolean("satu_sehat_kirim_observationttv"),
                                rs.getBoolean("signin_sebelum_anestesi"),
                                rs.getBoolean("satu_sehat_kirim_procedure"), rs.getBoolean("operasi_per_bulan"),
                                rs.getBoolean("timeout_sebelum_insisi"),
                                rs.getBoolean("signout_sebelum_menutup_luka"), rs.getBoolean("dapur_barang"),
                                rs.getBoolean("dapur_opname"), rs.getBoolean("satu_sehat_mapping_vaksin"),
                                rs.getBoolean("dapur_suplier"), rs.getBoolean("satu_sehat_kirim_Immunization"),
                                rs.getBoolean("checklist_post_operasi"), rs.getBoolean("dapur_pembelian"),
                                rs.getBoolean("dapur_stok_keluar"), rs.getBoolean("dapur_riwayat_barang"),
                                rs.getBoolean("permintaan_dapur"), rs.getBoolean("rekonsiliasi_obat"),
                                rs.getBoolean("biaya_pengadaan_dapur"), rs.getBoolean("rekap_pengadaan_dapur"),
                                ...
                                rs.getBoolean("penilaian_pasien_penyakit_menular"), rs.getBoolean("mpp_skrining"),
                                ...
                                rs.getBoolean("persetujuan_penundaan_pelayanan"), rs.getBoolean("sisa_diet_pasien"),
                                rs.getBoolean("penilaian_awal_medis_ralan_bedah_mulut"),
                                rs.getBoolean("penilaian_pasien_keracunan"),
                                rs.getBoolean("pemantauan_meows_obstetri"), rs.getBoolean("catatan_adime_gizi"),
                                ...
                                rs.getBoolean("template_laporan_operasi"), rs.getBoolean("hasil_tindakan_eswl"),
                                rs.getBoolean("checklist_kriteria_masuk_icu"),
                                rs.getBoolean("checklist_kriteria_keluar_icu"),
                                rs.getBoolean("akses_dokter_lain_rawat_jalan"), rs.getBoolean("follow_up_dbd"),
                                ...
                                rs.getBoolean("bpjs_mapping_obat_apotek"), rs.getBoolean("pembayaran_bank_mandiri"),
                                rs.getBoolean("penilaian_ulang_nyeri"), rs.getBoolean("penilaian_terapi_wicara"),
                                rs.getBoolean("bpjs_obat_23hari_apotek"), rs.getBoolean("pengkajian_restrain"),
                                ...
                                rs.getBoolean("catatan_keperawatan_ralan"), rs.getBoolean("catatan_persalinan"),
                                ...
                                rs.getBoolean("penilaian_pre_induksi"), rs.getBoolean("hasil_usg_urologi"),
                                rs.getBoolean("hasil_usg_gynecologi"), rs.getBoolean("hasil_pemeriksaan_ekg"),
                                rs.getBoolean("hapus_edit_sep_bpjs"), rs.getBoolean("satu_sehat_kirim_diet"),
                                ...
                                rs.getBoolean("hasil_usg_neonatus"), rs.getBoolean("hasil_endoskopi_faring_laring"),
                                ...
                                rs.getBoolean("hasil_endoskopi_telinga"), rs.getBoolean("satu_sehat_mapping_lab"),
                                ...
                                rs.getBoolean("penilaian_pasien_imunitas_rendah"), rs.getBoolean("balance_cairan"),
                                rs.getBoolean("catatan_observasi_chbp"),
                                rs.getBoolean("catatan_observasi_induksi_persalinan"),
                                rs.getBoolean("skp_kategori_penilaian"), rs.getBoolean("skp_kriteria_penilaian"),
                                rs.getBoolean("skp_penilaian"), rs.getBoolean("referensi_poli_mobilejknfktp"),
                                ...
                                rs.getBoolean("konsultasi_medik"), rs.getBoolean("jawaban_konsultasi_medik"),
                                rs.getBoolean("pcare_cek_alergi"), rs.getBoolean("pcare_cek_prognosa"),
                                ...
                                rs.getBoolean("skrining_risiko_kanker_paru"), rs.getBoolean("skrining_tbc"),
                                ...
                                rs.getBoolean("catatan_anestesi_sedasi"), rs.getBoolean("skrining_puma"),
                                rs.getBoolean("satu_sehat_kirim_careplan"),
                                rs.getBoolean("satu_sehat_kirim_medicationstatement"),
                                rs.getBoolean("skrining_adiksi_nikotin"), rs.getBoolean("skrining_thalassemia"),
                                rs.getBoolean("skrining_instrumen_sdq"), rs.getBoolean("pemantauan_pews_maternal"),
                                rs.getBoolean("validasi_sbar")});
                        }
                    } catch (Exception e) {
                        tabMode.addRow(new Object[]{rs.getString(1), "Turn Out", "Jabatan", rs.getString(2),
                            rs.getBoolean("penyakit"), rs.getBoolean("obat_penyakit"), rs.getBoolean("dokter"),
                            rs.getBoolean("jadwal_praktek"), rs.getBoolean("petugas"), rs.getBoolean("pasien"),
                            rs.getBoolean("registrasi"), rs.getBoolean("tindakan_ralan"),
                            rs.getBoolean("kamar_inap"), rs.getBoolean("tindakan_ranap"), rs.getBoolean("operasi"),
                            rs.getBoolean("rujukan_keluar"), rs.getBoolean("rujukan_masuk"),
                            rs.getBoolean("beri_obat"), rs.getBoolean("resep_pulang"),
                            rs.getBoolean("pasien_meninggal"), rs.getBoolean("diet_pasien"),
                            rs.getBoolean("kelahiran_bayi"), rs.getBoolean("periksa_lab"),
                            rs.getBoolean("periksa_radiologi"), rs.getBoolean("kasir_ralan"),
                            rs.getBoolean("deposit_pasien"), rs.getBoolean("piutang_pasien"),
                            rs.getBoolean("peminjaman_berkas"), rs.getBoolean("barcode"),
                            rs.getBoolean("presensi_harian"), rs.getBoolean("presensi_bulanan"),
                            rs.getBoolean("pegawai_admin"), rs.getBoolean("pegawai_user"), rs.getBoolean("suplier"),
                            rs.getBoolean("satuan_barang"), rs.getBoolean("konversi_satuan"),
                            rs.getBoolean("jenis_barang"), rs.getBoolean("obat"), rs.getBoolean("stok_opname_obat"),
                            rs.getBoolean("stok_obat_pasien"), rs.getBoolean("pengadaan_obat"),
                            rs.getBoolean("pemesanan_obat"), rs.getBoolean("penjualan_obat"),
                            rs.getBoolean("piutang_obat"), rs.getBoolean("retur_ke_suplier"),
                            rs.getBoolean("retur_dari_pembeli"), rs.getBoolean("retur_obat_ranap"),
                            rs.getBoolean("retur_piutang_pasien"), rs.getBoolean("keuntungan_penjualan"),
                            rs.getBoolean("keuntungan_beri_obat"), rs.getBoolean("sirkulasi_obat"),
                            rs.getBoolean("ipsrs_barang"), rs.getBoolean("ipsrs_pengadaan_barang"),
                            rs.getBoolean("ipsrs_stok_keluar"), rs.getBoolean("ipsrs_rekap_pengadaan"),
                            rs.getBoolean("ipsrs_rekap_stok_keluar"), rs.getBoolean("ipsrs_pengeluaran_harian"),
                            rs.getBoolean("inventaris_jenis"), rs.getBoolean("inventaris_kategori"),
                            rs.getBoolean("inventaris_merk"), rs.getBoolean("inventaris_ruang"),
                            rs.getBoolean("inventaris_produsen"), rs.getBoolean("inventaris_koleksi"),
                            rs.getBoolean("inventaris_inventaris"), rs.getBoolean("inventaris_sirkulasi"),
                            rs.getBoolean("parkir_jenis"), rs.getBoolean("parkir_in"), rs.getBoolean("parkir_out"),
                            rs.getBoolean("parkir_rekap_harian"), rs.getBoolean("parkir_rekap_bulanan"),
                            rs.getBoolean("informasi_kamar"), rs.getBoolean("harian_tindakan_poli"),
                            rs.getBoolean("obat_per_poli"), rs.getBoolean("obat_per_kamar"),
                            rs.getBoolean("obat_per_dokter_ralan"), rs.getBoolean("obat_per_dokter_ranap"),
                            ...
                            rs.getBoolean("potongan_biaya"), rs.getBoolean("resep_obat"),
                            rs.getBoolean("resume_pasien"), rs.getBoolean("penyakit_ralan"),
                            rs.getBoolean("penyakit_ranap"), rs.getBoolean("kamar"), rs.getBoolean("tarif_ralan"),
                            rs.getBoolean("tarif_ranap"), rs.getBoolean("tarif_lab"),
                            rs.getBoolean("tarif_radiologi"), rs.getBoolean("tarif_operasi"),
                            rs.getBoolean("akun_rekening"), rs.getBoolean("rekening_tahun"),
                            rs.getBoolean("posting_jurnal"), rs.getBoolean("buku_besar"), rs.getBoolean("cashflow"),
                            rs.getBoolean("keuangan"), rs.getBoolean("pengeluaran"), rs.getBoolean("setup_pjlab"),
                            rs.getBoolean("setup_otolokasi"), rs.getBoolean("setup_jam_kamin"),
                            rs.getBoolean("setup_embalase"), rs.getBoolean("tracer_login"),
                            rs.getBoolean("display"), rs.getBoolean("set_harga_obat"),
                            rs.getBoolean("set_penggunaan_tarif"), rs.getBoolean("set_oto_ralan"),
                            rs.getBoolean("biaya_harian"), rs.getBoolean("biaya_masuk_sekali"),
                            rs.getBoolean("set_no_rm"), rs.getBoolean("billing_ralan"),
                            rs.getBoolean("billing_ranap"), rs.getBoolean("jm_ranap_dokter"), rs.getBoolean("igd"),
                            rs.getBoolean("barcoderalan"), rs.getBoolean("barcoderanap"),
                            rs.getBoolean("set_harga_obat_ralan"), rs.getBoolean("set_harga_obat_ranap"),
                            rs.getBoolean("penyakit_pd3i"), rs.getBoolean("surveilans_pd3i"),
                            rs.getBoolean("surveilans_ralan"), rs.getBoolean("diagnosa_pasien"),
                            rs.getBoolean("surveilans_ranap"), rs.getBoolean("pny_takmenular_ranap"),
                            rs.getBoolean("pny_takmenular_ralan"), rs.getBoolean("kunjungan_ralan"),
                            rs.getBoolean("rl32"), rs.getBoolean("rl33"), rs.getBoolean("rl37"),
                            rs.getBoolean("rl38"), rs.getBoolean("harian_tindakan_dokter"), rs.getBoolean("sms"),
                            rs.getBoolean("sidikjari"), rs.getBoolean("jam_masuk"), rs.getBoolean("jadwal_pegawai"),
                            rs.getBoolean("parkir_barcode"), rs.getBoolean("set_nota"), rs.getBoolean("dpjp_ranap"),
                            rs.getBoolean("mutasi_barang"), rs.getBoolean("rl34"), rs.getBoolean("rl36"),
                            rs.getBoolean("fee_visit_dokter"), rs.getBoolean("fee_bacaan_ekg"),
                            rs.getBoolean("fee_rujukan_rontgen"), rs.getBoolean("fee_rujukan_ranap"),
                            rs.getBoolean("fee_ralan"), rs.getBoolean("akun_bayar"),
                            ...
                            rs.getBoolean("pengambilan_utd"), rs.getBoolean("tarif_utd"),
                            rs.getBoolean("pengambilan_utd2"), rs.getBoolean("utd_medis_rusak"),
                            rs.getBoolean("pengambilan_penunjang_utd"), rs.getBoolean("pengambilan_penunjang_utd2"),
                            rs.getBoolean("utd_penunjang_rusak"), rs.getBoolean("suplier_penunjang"),
                            rs.getBoolean("utd_donor"), rs.getBoolean("bpjs_monitoring_klaim"),
                            rs.getBoolean("utd_cekal_darah"), rs.getBoolean("utd_komponen_darah"),
                            rs.getBoolean("utd_stok_darah"), rs.getBoolean("utd_pemisahan_darah"),
                            rs.getBoolean("harian_kamar"), rs.getBoolean("rincian_piutang_pasien"),
                            rs.getBoolean("keuntungan_beri_obat_nonpiutang"), rs.getBoolean("reklasifikasi_ralan"),
                            rs.getBoolean("reklasifikasi_ranap"), rs.getBoolean("utd_penyerahan_darah"),
                            rs.getBoolean("hutang_obat"), rs.getBoolean("riwayat_obat_alkes_bhp"),
                            rs.getBoolean("sensus_harian_poli"), rs.getBoolean("rl4a"),
                            rs.getBoolean("aplicare_referensi_kamar"), rs.getBoolean("aplicare_ketersediaan_kamar"),
                            rs.getBoolean("inacbg_klaim_baru_otomatis"), rs.getBoolean("inacbg_klaim_baru_manual"),
                            rs.getBoolean("inacbg_coder_nik"), rs.getBoolean("mutasi_berkas"),
                            rs.getBoolean("akun_piutang"), rs.getBoolean("harian_kso"),
                            rs.getBoolean("bulanan_kso"), rs.getBoolean("harian_menejemen"),
                            rs.getBoolean("bulanan_menejemen"), rs.getBoolean("inhealth_cek_eligibilitas"),
                            rs.getBoolean("inhealth_referensi_jenpel_ruang_rawat"),
                            rs.getBoolean("inhealth_referensi_poli"), rs.getBoolean("inhealth_referensi_faskes"),
                            rs.getBoolean("inhealth_sjp"), rs.getBoolean("piutang_ralan"),
                            rs.getBoolean("piutang_ranap"), rs.getBoolean("detail_piutang_penjab"),
                            rs.getBoolean("lama_pelayanan_ralan"), rs.getBoolean("catatan_pasien"),
                            rs.getBoolean("rl4b"), rs.getBoolean("rl4asebab"), rs.getBoolean("rl4bsebab"),
                            rs.getBoolean("data_HAIs"), rs.getBoolean("harian_HAIs"), rs.getBoolean("bulanan_HAIs"),
                            rs.getBoolean("hitung_bor"), rs.getBoolean("perusahaan_pasien"),
                            rs.getBoolean("resep_dokter"), rs.getBoolean("lama_pelayanan_apotek"),
                            rs.getBoolean("hitung_alos"), rs.getBoolean("detail_tindakan"),
                            rs.getBoolean("rujukan_poli_internal"), rs.getBoolean("rekap_poli_anak"),
                            ...
                            rs.getBoolean("grafik_kunjungan_perpekerjaan"),
                            rs.getBoolean("grafik_kunjungan_perpendidikan"),
                            rs.getBoolean("grafik_kunjungan_pertahun"), rs.getBoolean("berkas_digital_perawatan"),
                            rs.getBoolean("penyakit_menular_ranap"), rs.getBoolean("penyakit_menular_ralan"),
                            ...
                            rs.getBoolean("grafik_kunjungan_statusdaftartanggal2"),
                            rs.getBoolean("grafik_kunjungan_statusbataltahun"),
                            rs.getBoolean("grafik_kunjungan_statusbatalbulan"), rs.getBoolean("pcare_cek_penyakit"),
                            rs.getBoolean("grafik_kunjungan_statusbataltanggal"), rs.getBoolean("kategori_barang"),
                            rs.getBoolean("golongan_barang"), rs.getBoolean("pemberian_obat_pertanggal"),
                            rs.getBoolean("penjualan_obat_pertanggal"), rs.getBoolean("pcare_cek_kesadaran"),
                            rs.getBoolean("pembatalan_periksa_dokter"), rs.getBoolean("pembayaran_per_unit"),
                            rs.getBoolean("rekap_pembayaran_per_unit"),
                            rs.getBoolean("grafik_kunjungan_percarabayar"),
                            ...
                            rs.getBoolean("permintaan_medis"), rs.getBoolean("rekap_permintaan_medis"),
                            rs.getBoolean("surat_pemesanan_medis"), rs.getBoolean("permintaan_non_medis"),
                            rs.getBoolean("rekap_permintaan_non_medis"), rs.getBoolean("surat_pemesanan_non_medis"),
                            rs.getBoolean("grafik_per_perujuk"), rs.getBoolean("bpjs_cek_prosedur"),
                            rs.getBoolean("bpjs_cek_kelas_rawat"), rs.getBoolean("bpjs_cek_dokter"),
                            rs.getBoolean("bpjs_cek_spesialistik"), rs.getBoolean("bpjs_cek_ruangrawat"),
                            rs.getBoolean("bpjs_cek_carakeluar"), rs.getBoolean("bpjs_cek_pasca_pulang"),
                            rs.getBoolean("detail_tindakan_okvk"), rs.getBoolean("billing_parsial"),
                            ...
                            rs.getBoolean("riwayat_data_batch"), rs.getBoolean("grafik_ikp_jenis"),
                            rs.getBoolean("grafik_ikp_dampak"), rs.getBoolean("piutang_akun_piutang"),
                            rs.getBoolean("grafik_kunjungan_per_agama"), rs.getBoolean("grafik_kunjungan_per_umur"),
                            rs.getBoolean("suku_bangsa"), rs.getBoolean("bahasa_pasien"),
                            rs.getBoolean("golongan_tni"), rs.getBoolean("satuan_tni"),
                            rs.getBoolean("jabatan_tni"), rs.getBoolean("pangkat_tni"),
                            rs.getBoolean("golongan_polri"), rs.getBoolean("satuan_polri"),
                            rs.getBoolean("jabatan_polri"), rs.getBoolean("pangkat_polri"),
                            rs.getBoolean("cacat_fisik"), rs.getBoolean("grafik_kunjungan_suku"),
                            rs.getBoolean("grafik_kunjungan_bahasa"), rs.getBoolean("booking_operasi"),
                            rs.getBoolean("mapping_poli_bpjs"), rs.getBoolean("grafik_kunjungan_per_cacat"),
                            rs.getBoolean("barang_cssd"), rs.getBoolean("skdp_bpjs"),
                            rs.getBoolean("booking_registrasi"), rs.getBoolean("bpjs_cek_propinsi"),
                            rs.getBoolean("bpjs_cek_kabupaten"), rs.getBoolean("bpjs_cek_kecamatan"),
                            rs.getBoolean("bpjs_cek_dokterdpjp"), rs.getBoolean("bpjs_cek_riwayat_rujukanrs"),
                            rs.getBoolean("bpjs_cek_tanggal_rujukan"), rs.getBoolean("permintaan_lab"),
                            rs.getBoolean("permintaan_radiologi"), rs.getBoolean("surat_indeks"),
                            rs.getBoolean("surat_map"), rs.getBoolean("surat_almari"), rs.getBoolean("surat_rak"),
                            rs.getBoolean("surat_ruang"), rs.getBoolean("surat_klasifikasi"),
                            rs.getBoolean("surat_status"), rs.getBoolean("surat_sifat"),
                            rs.getBoolean("surat_balas"), rs.getBoolean("surat_masuk"),
                            rs.getBoolean("pcare_cek_dokter"), rs.getBoolean("pcare_cek_poli"),
                            rs.getBoolean("pcare_cek_provider"), rs.getBoolean("pcare_cek_statuspulang"),
                            rs.getBoolean("pcare_cek_spesialis"), rs.getBoolean("pcare_cek_subspesialis"),
                            rs.getBoolean("pcare_cek_sarana"), rs.getBoolean("pcare_cek_khusus"),
                            rs.getBoolean("pcare_cek_obat"), rs.getBoolean("pcare_cek_tindakan"),
                            rs.getBoolean("pcare_cek_faskessubspesialis"),
                            rs.getBoolean("pcare_cek_faskesalihrawat"), rs.getBoolean("pcare_cek_faskesthalasemia"),
                            rs.getBoolean("pcare_mapping_obat"), rs.getBoolean("pcare_mapping_tindakan"),
                            rs.getBoolean("pcare_club_prolanis"), rs.getBoolean("pcare_mapping_poli"),
                            rs.getBoolean("pcare_kegiatan_kelompok"), rs.getBoolean("pcare_mapping_tindakan_ranap"),
                            rs.getBoolean("pcare_peserta_kegiatan_kelompok"), rs.getBoolean("sirkulasi_obat3"),
                            rs.getBoolean("bridging_pcare_daftar"), rs.getBoolean("pcare_mapping_dokter"),
                            rs.getBoolean("ranap_per_ruang"), rs.getBoolean("penyakit_ranap_cara_bayar"),
                            rs.getBoolean("anggota_militer_dirawat"), rs.getBoolean("set_input_parsial"),
                            ...
                            rs.getBoolean("stok_opname_logistik"), rs.getBoolean("sirkulasi_non_medis"),
                            rs.getBoolean("rekap_lab_pertahun"), rs.getBoolean("perujuk_lab_pertahun"),
                            rs.getBoolean("rekap_radiologi_pertahun"), rs.getBoolean("perujuk_radiologi_pertahun"),
                            rs.getBoolean("jumlah_porsi_diet"), rs.getBoolean("jumlah_macam_diet"),
                            rs.getBoolean("payment_point2"), rs.getBoolean("pembayaran_akun_bayar2"),
                            rs.getBoolean("hapus_nota_salah"), rs.getBoolean("pengkajian_askep"),
                            rs.getBoolean("hais_perbangsal"), rs.getBoolean("ppn_obat"),
                            rs.getBoolean("saldo_akun_perbulan"), rs.getBoolean("display_apotek"),
                            ...
                            rs.getBoolean("kunjungan_permintaan_lab2"),
                            rs.getBoolean("kunjungan_permintaan_radiologi"),
                            rs.getBoolean("kunjungan_permintaan_radiologi2"), rs.getBoolean("pcare_pemberian_obat"),
                            rs.getBoolean("pcare_pemberian_tindakan"), rs.getBoolean("pembayaran_akun_bayar3"),
                            rs.getBoolean("password_asuransi"), rs.getBoolean("kemenkes_sitt"),
                            rs.getBoolean("siranap_ketersediaan_kamar"), rs.getBoolean("grafik_tb_periodelaporan"),
                            rs.getBoolean("grafik_tb_rujukan"), rs.getBoolean("grafik_tb_riwayat"),
                            rs.getBoolean("grafik_tb_tipediagnosis"), rs.getBoolean("grafik_tb_statushiv"),
                            rs.getBoolean("grafik_tb_skoringanak"), rs.getBoolean("grafik_tb_konfirmasiskoring5"),
                            rs.getBoolean("grafik_tb_konfirmasiskoring6"), rs.getBoolean("grafik_tb_sumberobat"),
                            rs.getBoolean("grafik_tb_hasilakhirpengobatan"), rs.getBoolean("grafik_tb_hasilteshiv"),
                            rs.getBoolean("kadaluarsa_batch"), rs.getBoolean("sisa_stok"),
                            rs.getBoolean("obat_per_resep"), rs.getBoolean("pemakaian_air_pdam"),
                            rs.getBoolean("limbah_b3_medis"), rs.getBoolean("grafik_air_pdam_pertanggal"),
                            rs.getBoolean("grafik_air_pdam_perbulan"), rs.getBoolean("grafik_limbahb3_pertanggal"),
                            rs.getBoolean("grafik_limbahb3_perbulan"), rs.getBoolean("limbah_domestik"),
                            rs.getBoolean("grafik_limbahdomestik_pertanggal"),
                            rs.getBoolean("grafik_limbahdomestik_perbulan"), rs.getBoolean("mutu_air_limbah"),
                            rs.getBoolean("pest_control"), rs.getBoolean("ruang_perpustakaan"),
                            ...
                            rs.getBoolean("grafik_k3_perpenyebab"), rs.getBoolean("grafik_k3_perjenisluka"),
                            rs.getBoolean("grafik_k3_lokasikejadian"), rs.getBoolean("grafik_k3_dampakcidera"),
                            rs.getBoolean("grafik_k3_perjenispekerjaan"), rs.getBoolean("grafik_k3_perbagiantubuh"),
                            rs.getBoolean("jenis_cidera_k3rstahun"), rs.getBoolean("penyebab_k3rstahun"),
                            rs.getBoolean("jenis_luka_k3rstahun"), rs.getBoolean("lokasi_kejadian_k3rstahun"),
                            rs.getBoolean("dampak_cidera_k3rstahun"), rs.getBoolean("jenis_pekerjaan_k3rstahun"),
                            rs.getBoolean("bagian_tubuh_k3rstahun"), rs.getBoolean("sekrining_rawat_jalan"),
                            rs.getBoolean("bpjs_histori_pelayanan"), rs.getBoolean("rekap_mutasi_berkas"),
                            rs.getBoolean("skrining_ralan_pernapasan_pertahun"),
                            rs.getBoolean("pengajuan_barang_medis"), rs.getBoolean("pengajuan_barang_nonmedis"),
                            rs.getBoolean("grafik_kunjungan_ranapbulan"),
                            rs.getBoolean("grafik_kunjungan_ranaptanggal"),
                            rs.getBoolean("grafik_kunjungan_ranap_peruang"),
                            rs.getBoolean("kunjungan_bangsal_pertahun"),
                            rs.getBoolean("grafik_jenjang_jabatanpegawai"), rs.getBoolean("grafik_bidangpegawai"),
                            rs.getBoolean("grafik_departemenpegawai"), rs.getBoolean("grafik_pendidikanpegawai"),
                            rs.getBoolean("grafik_sttswppegawai"), rs.getBoolean("grafik_sttskerjapegawai"),
                            rs.getBoolean("grafik_sttspulangranap"), rs.getBoolean("kip_pasien_ranap"),
                            rs.getBoolean("kip_pasien_ralan"), rs.getBoolean("bpjs_mapping_dokterdpjp"),
                            rs.getBoolean("data_triase_igd"), rs.getBoolean("master_triase_skala1"),
                            rs.getBoolean("master_triase_skala2"), rs.getBoolean("master_triase_skala3"),
                            rs.getBoolean("master_triase_skala4"), rs.getBoolean("master_triase_skala5"),
                            rs.getBoolean("master_triase_pemeriksaan"), rs.getBoolean("master_triase_macamkasus"),
                            rs.getBoolean("rekap_permintaan_diet"), rs.getBoolean("daftar_pasien_ranap"),
                            rs.getBoolean("daftar_pasien_ranaptni"), rs.getBoolean("pengajuan_asetinventaris"),
                            rs.getBoolean("item_apotek_jenis"), rs.getBoolean("item_apotek_kategori"),
                            rs.getBoolean("item_apotek_golongan"), rs.getBoolean("item_apotek_industrifarmasi"),
                            rs.getBoolean("10_obat_terbanyak_poli"), rs.getBoolean("grafik_pengajuan_aset_urgensi"),
                            rs.getBoolean("grafik_pengajuan_aset_status"),
                            rs.getBoolean("grafik_pengajuan_aset_departemen"),
                            rs.getBoolean("rekap_pengajuan_aset_departemen"),
                            rs.getBoolean("grafik_kelompok_jabatanpegawai"),
                            ...
                            rs.getBoolean("grafik_inventaris_jenis"), rs.getBoolean("data_resume_pasien"),
                            rs.getBoolean("perkiraan_biaya_ranap"), rs.getBoolean("rekap_obat_poli"),
                            rs.getBoolean("rekap_obat_pasien"), rs.getBoolean("permintaan_perbaikan_inventaris"),
                            rs.getBoolean("grafik_HAIs_pasienbangsal"), rs.getBoolean("grafik_HAIs_pasienbulan"),
                            rs.getBoolean("grafik_HAIs_laju_vap"), rs.getBoolean("grafik_HAIs_laju_iad"),
                            rs.getBoolean("grafik_HAIs_laju_pleb"), rs.getBoolean("grafik_HAIs_laju_isk"),
                            rs.getBoolean("grafik_HAIs_laju_ilo"), rs.getBoolean("grafik_HAIs_laju_hap"),
                            rs.getBoolean("inhealth_mapping_poli"), rs.getBoolean("inhealth_mapping_dokter"),
                            rs.getBoolean("inhealth_mapping_tindakan_ralan"),
                            rs.getBoolean("inhealth_mapping_tindakan_ranap"),
                            rs.getBoolean("inhealth_mapping_tindakan_radiologi"),
                            rs.getBoolean("inhealth_mapping_tindakan_laborat"),
                            ...
                            rs.getBoolean("perawatan_pasien_corona"),
                            rs.getBoolean("penilaian_awal_keperawatan_gigi"),
                            rs.getBoolean("master_masalah_keperawatan_gigi"), rs.getBoolean("toko_bayar_piutang"),
                            rs.getBoolean("toko_piutang_harian"), rs.getBoolean("toko_penjualan_harian"),
                            rs.getBoolean("deteksi_corona"), rs.getBoolean("penilaian_awal_keperawatan_kebidanan"),
                            rs.getBoolean("pengumuman_epasien"), rs.getBoolean("surat_hamil"),
                            rs.getBoolean("set_tarif_online"), rs.getBoolean("booking_periksa"),
                            rs.getBoolean("toko_sirkulasi"), rs.getBoolean("toko_retur_jual"),
                            rs.getBoolean("toko_retur_piutang"), rs.getBoolean("toko_sirkulasi2"),
                            ...
                            rs.getBoolean("grafik_air_tanah_perbulan"), rs.getBoolean("lama_pelayanan_poli"),
                            rs.getBoolean("hemodialisa"), rs.getBoolean("laporan_tahunan_irj"),
                            rs.getBoolean("grafik_harian_hemodialisa"), rs.getBoolean("grafik_bulanan_hemodialisa"),
                            rs.getBoolean("grafik_tahunan_hemodialisa"), rs.getBoolean("grafik_bulanan_meninggal"),
                            rs.getBoolean("perbaikan_inventaris"), rs.getBoolean("surat_cuti_hamil"),
                            rs.getBoolean("permintaan_stok_obat_pasien"), rs.getBoolean("pemeliharaan_inventaris"),
                            ...
                            rs.getBoolean("demografi_umur_kunjungan"), rs.getBoolean("jam_diet_pasien"),
                            rs.getBoolean("rvu_bpjs"), rs.getBoolean("verifikasi_penerimaan_farmasi"),
                            rs.getBoolean("verifikasi_penerimaan_logistik"), rs.getBoolean("pemeriksaan_lab_pa"),
                            rs.getBoolean("ringkasan_pengajuan_obat"), rs.getBoolean("ringkasan_pemesanan_obat"),
                            rs.getBoolean("ringkasan_pengadaan_obat"), rs.getBoolean("ringkasan_penerimaan_obat"),
                            rs.getBoolean("ringkasan_hibah_obat"), rs.getBoolean("ringkasan_penjualan_obat"),
                            rs.getBoolean("ringkasan_beri_obat"), rs.getBoolean("ringkasan_piutang_obat"),
                            rs.getBoolean("ringkasan_stok_keluar_obat"),
                            rs.getBoolean("ringkasan_retur_suplier_obat"),
                            rs.getBoolean("ringkasan_retur_pembeli_obat"),
                            rs.getBoolean("penilaian_awal_keperawatan_ranapkebidanan"),
                            ...
                            rs.getBoolean("bpjs_diagnosa_prb"), rs.getBoolean("bpjs_obat_prb"),
                            rs.getBoolean("bpjs_surat_kontrol"), rs.getBoolean("penggunaan_bhp_ok"),
                            rs.getBoolean("surat_keterangan_rawat_inap"), rs.getBoolean("surat_keterangan_sehat"),
                            rs.getBoolean("pendapatan_per_carabayar"),
                            rs.getBoolean("akun_host_to_host_bank_jateng"), rs.getBoolean("pembayaran_bank_jateng"),
                            rs.getBoolean("bpjs_surat_pri"), rs.getBoolean("ringkasan_tindakan"),
                            rs.getBoolean("lama_pelayanan_pasien"), rs.getBoolean("surat_sakit_pihak_2"),
                            rs.getBoolean("tagihan_hutang_obat"), rs.getBoolean("referensi_mobilejkn_bpjs"),
                            rs.getBoolean("batal_pendaftaran_mobilejkn_bpjs"), rs.getBoolean("lama_operasi"),
                            rs.getBoolean("grafik_inventaris_kategori"), rs.getBoolean("grafik_inventaris_merk"),
                            rs.getBoolean("grafik_inventaris_produsen"),
                            rs.getBoolean("pengembalian_deposit_pasien"),
                            rs.getBoolean("validasi_tagihan_hutang_obat"),
                            rs.getBoolean("piutang_obat_belum_lunas"), rs.getBoolean("integrasi_briapi"),
                            ...
                            rs.getBoolean("surat_bebas_tato"), rs.getBoolean("surat_kewaspadaan_kesehatan"),
                            rs.getBoolean("grafik_porsidiet_pertanggal"),
                            rs.getBoolean("grafik_porsidiet_perbulan"), rs.getBoolean("grafik_porsidiet_pertahun"),
                            rs.getBoolean("grafik_porsidiet_perbangsal"),
                            rs.getBoolean("penilaian_awal_medis_ralan"),
                            rs.getBoolean("master_masalah_keperawatan_mata"),
                            rs.getBoolean("penilaian_awal_keperawatan_mata"),
                            ...
                            rs.getBoolean("penilaian_awal_medis_igd"),
                            rs.getBoolean("penilaian_awal_medis_ralan_anak"),
                            rs.getBoolean("bpjs_referensi_poli_hfis"), rs.getBoolean("bpjs_referensi_dokter_hfis"),
                            rs.getBoolean("bpjs_referensi_jadwal_hfis"), rs.getBoolean("penilaian_fisioterapi"),
                            rs.getBoolean("bpjs_program_prb"), rs.getBoolean("bpjs_suplesi_jasaraharja"),
                            rs.getBoolean("bpjs_data_induk_kecelakaan"), rs.getBoolean("bpjs_sep_internal"),
                            rs.getBoolean("bpjs_klaim_jasa_raharja"), rs.getBoolean("bpjs_daftar_finger_print"),
                            ...
                            rs.getBoolean("audit_kepatuhan_apd"), rs.getBoolean("bpjs_task_id"),
                            rs.getBoolean("bayar_piutang_lain"), rs.getBoolean("pembayaran_akun_bayar4"),
                            rs.getBoolean("stok_akhir_farmasi_pertanggal"), rs.getBoolean("riwayat_kamar_pasien"),
                            rs.getBoolean("uji_fungsi_kfr"), rs.getBoolean("hapus_berkas_digital_perawatan"),
                            rs.getBoolean("kategori_pengeluaran_harian"), rs.getBoolean("kategori_pemasukan_lain"),
                            rs.getBoolean("pembayaran_akun_bayar5"), rs.getBoolean("ruang_ok"),
                            rs.getBoolean("telaah_resep"), rs.getBoolean("jasa_tindakan_pasien"),
                            rs.getBoolean("permintaan_resep_pulang"), rs.getBoolean("rekap_jm_dokter"),
                            rs.getBoolean("status_data_rm"), rs.getBoolean("ubah_petugas_lab_pk"),
                            rs.getBoolean("ubah_petugas_lab_pa"), rs.getBoolean("ubah_petugas_radiologi"),
                            rs.getBoolean("gabung_norawat"), rs.getBoolean("gabung_rm"),
                            ...
                            rs.getBoolean("bpjs_referensi_poli_apotek"), rs.getBoolean("bayar_jm_dokter"),
                            rs.getBoolean("bpjs_referensi_faskes_apotek"),
                            rs.getBoolean("bpjs_referensi_spesialistik_apotek"), rs.getBoolean("pembayaran_briva"),
                            rs.getBoolean("penilaian_awal_keperawatan_ranap"),
                            rs.getBoolean("nilai_penerimaan_vendor_farmasi_perbulan"),
                            rs.getBoolean("akun_bayar_hutang"), rs.getBoolean("master_rencana_keperawatan"),
                            rs.getBoolean("laporan_tahunan_igd"), rs.getBoolean("obat_bhp_tidakbergerak"),
                            ...
                            rs.getBoolean("anggota_polri_dirawat"), rs.getBoolean("daftar_pasien_ranap_polri"),
                            rs.getBoolean("soap_ralan_polri"), rs.getBoolean("soap_ranap_polri"),
                            rs.getBoolean("laporan_penyakit_polri"), rs.getBoolean("jumlah_pengunjung_ralan_polri"),
                            rs.getBoolean("catatan_observasi_igd"), rs.getBoolean("catatan_observasi_ranap"),
                            rs.getBoolean("catatan_observasi_ranap_kebidanan"),
                            rs.getBoolean("catatan_observasi_ranap_postpartum"),
                            rs.getBoolean("penilaian_awal_medis_ralan_tht"), rs.getBoolean("penilaian_psikologi"),
                            rs.getBoolean("audit_cuci_tangan_medis"), rs.getBoolean("audit_pembuangan_limbah"),
                            rs.getBoolean("ruang_audit_kepatuhan"), rs.getBoolean("audit_pembuangan_benda_tajam"),
                            rs.getBoolean("audit_penanganan_darah"), rs.getBoolean("audit_pengelolaan_linen_kotor"),
                            rs.getBoolean("audit_penempatan_pasien"), rs.getBoolean("audit_kamar_jenazah"),
                            rs.getBoolean("audit_bundle_iadp"), rs.getBoolean("audit_bundle_ido"),
                            rs.getBoolean("audit_fasilitas_kebersihan_tangan"),
                            rs.getBoolean("audit_fasilitas_apd"),
                            ...
                            rs.getBoolean("persetujuan_penolakan_tindakan"), rs.getBoolean("audit_bundle_isk"),
                            rs.getBoolean("audit_bundle_plabsi"), rs.getBoolean("audit_bundle_vap"),
                            rs.getBoolean("akun_host_to_host_bank_papua"), rs.getBoolean("pembayaran_bank_papua"),
                            rs.getBoolean("penilaian_awal_medis_ralan_penyakit_dalam"),
                            rs.getBoolean("penilaian_awal_medis_ralan_mata"),
                            rs.getBoolean("penilaian_awal_medis_ralan_neurologi"), rs.getBoolean("sirkulasi_obat6"),
                            rs.getBoolean("penilaian_awal_medis_ralan_orthopedi"),
                            rs.getBoolean("penilaian_awal_medis_ralan_bedah"),
                            rs.getBoolean("integrasi_khanza_health_services"), rs.getBoolean("soap_ralan_tni"),
                            rs.getBoolean("soap_ranap_tni"), rs.getBoolean("jumlah_pengunjung_ralan_tni"),
                            ...
                            rs.getBoolean("skrining_nutrisi_dewasa"), rs.getBoolean("skrining_nutrisi_lansia"),
                            rs.getBoolean("hasil_pemeriksaan_usg"), rs.getBoolean("skrining_nutrisi_anak"),
                            rs.getBoolean("akun_host_to_host_bank_jabar"), rs.getBoolean("pembayaran_bank_jabar"),
                            rs.getBoolean("surat_pernyataan_pasien_umum"), rs.getBoolean("konseling_farmasi"),
                            rs.getBoolean("pelayanan_informasi_obat"), rs.getBoolean("jawaban_pio_apoteker"),
                            rs.getBoolean("surat_persetujuan_umum"), rs.getBoolean("transfer_pasien_antar_ruang"),
                            rs.getBoolean("satu_sehat_referensi_dokter"),
                            rs.getBoolean("satu_sehat_referensi_pasien"),
                            rs.getBoolean("satu_sehat_mapping_departemen"),
                            rs.getBoolean("satu_sehat_mapping_lokasi"), rs.getBoolean("satu_sehat_kirim_encounter"),
                            rs.getBoolean("catatan_cek_gds"), rs.getBoolean("satu_sehat_kirim_condition"),
                            rs.getBoolean("checklist_pre_operasi"),
                            rs.getBoolean("satu_sehat_kirim_observationttv"),
                            rs.getBoolean("signin_sebelum_anestesi"), rs.getBoolean("satu_sehat_kirim_procedure"),
                            rs.getBoolean("operasi_per_bulan"), rs.getBoolean("timeout_sebelum_insisi"),
                            rs.getBoolean("signout_sebelum_menutup_luka"), rs.getBoolean("dapur_barang"),
                            rs.getBoolean("dapur_opname"), rs.getBoolean("satu_sehat_mapping_vaksin"),
                            rs.getBoolean("dapur_suplier"), rs.getBoolean("satu_sehat_kirim_Immunization"),
                            rs.getBoolean("checklist_post_operasi"), rs.getBoolean("dapur_pembelian"),
                            ...
                            rs.getBoolean("kesling_limbah_b3medis_cair"),
                            rs.getBoolean("grafik_limbahb3cair_pertanggal"),
                            rs.getBoolean("grafik_limbahb3cair_perbulan"), rs.getBoolean("rekap_biaya_registrasi"),
                            rs.getBoolean("konfirmasi_rekonsiliasi_obat"),
                            rs.getBoolean("satu_sehat_kirim_clinicalimpression"),
                            rs.getBoolean("penilaian_pasien_terminal"),
                            rs.getBoolean("surat_persetujuan_rawat_inap"),
                            ...
                            rs.getBoolean("penilaian_lanjutan_resiko_jatuh_lansia"),
                            rs.getBoolean("penilaian_pasien_penyakit_menular"), rs.getBoolean("mpp_skrining"),
                            rs.getBoolean("edukasi_pasien_keluarga_rj"), rs.getBoolean("pemantauan_pews_dewasa"),
                            rs.getBoolean("penilaian_tambahan_bunuh_diri"),
                            rs.getBoolean("bpjs_antrean_pertanggal"),
                            rs.getBoolean("penilaian_tambahan_perilaku_kekerasan"),
                            rs.getBoolean("penilaian_tambahan_beresiko_melarikan_diri"),
                            rs.getBoolean("persetujuan_penundaan_pelayanan"), rs.getBoolean("sisa_diet_pasien"),
                            rs.getBoolean("penilaian_awal_medis_ralan_bedah_mulut"),
                            rs.getBoolean("penilaian_pasien_keracunan"), rs.getBoolean("pemantauan_meows_obstetri"),
                            rs.getBoolean("catatan_adime_gizi"), rs.getBoolean("pengajuan_biaya"),
                            rs.getBoolean("penilaian_awal_keperawatan_ralan_geriatri"),
                            rs.getBoolean("master_masalah_keperawatan_geriatri"),
                            rs.getBoolean("master_rencana_keperawatan_geriatri"),
                            rs.getBoolean("checklist_kriteria_masuk_hcu"),
                            rs.getBoolean("checklist_kriteria_keluar_hcu"),
                            rs.getBoolean("penilaian_risiko_dekubitus"),
                            rs.getBoolean("master_menolak_anjuran_medis"), rs.getBoolean("penolakan_anjuran_medis"),
                            rs.getBoolean("laporan_tahunan_penolakan_anjuran_medis"),
                            rs.getBoolean("template_laporan_operasi"), rs.getBoolean("hasil_tindakan_eswl"),
                            rs.getBoolean("checklist_kriteria_masuk_icu"),
                            rs.getBoolean("checklist_kriteria_keluar_icu"),
                            ...
                            rs.getBoolean("pemantauan_ews_neonatus"),
                            rs.getBoolean("validasi_persetujuan_pengajuan_biaya"),
                            rs.getBoolean("riwayat_perawatan_icare_bpjs"), rs.getBoolean("rekap_pengajuan_biaya"),
                            rs.getBoolean("penilaian_awal_medis_ralan_kulit_kelamin"),
                            rs.getBoolean("akun_host_to_host_bank_mandiri"),
                            rs.getBoolean("penilaian_medis_hemodialisa"),
                            rs.getBoolean("penilaian_level_kecemasan_ranap_anak"),
                            rs.getBoolean("penilaian_lanjutan_resiko_jatuh_psikiatri"),
                            rs.getBoolean("penilaian_lanjutan_skrining_fungsional"),
                            rs.getBoolean("penilaian_medis_ralan_rehab_medik"), rs.getBoolean("laporan_anestesi"),
                            rs.getBoolean("template_persetujuan_penolakan_tindakan"),
                            rs.getBoolean("penilaian_medis_ralan_gawat_darurat_psikiatri"),
                            rs.getBoolean("bpjs_referensi_setting_apotek"),
                            rs.getBoolean("bpjs_referensi_obat_apotek"), rs.getBoolean("bpjs_mapping_obat_apotek"),
                            rs.getBoolean("pembayaran_bank_mandiri"), rs.getBoolean("penilaian_ulang_nyeri"),
                            rs.getBoolean("penilaian_terapi_wicara"), rs.getBoolean("bpjs_obat_23hari_apotek"),
                            rs.getBoolean("pengkajian_restrain"), rs.getBoolean("bpjs_kunjungan_sep_apotek"),
                            rs.getBoolean("bpjs_monitoring_klaim_apotek"),
                            rs.getBoolean("bpjs_daftar_pelayanan_obat_apotek"),
                            rs.getBoolean("penilaian_awal_medis_ralan_paru"),
                            rs.getBoolean("catatan_keperawatan_ralan"), rs.getBoolean("catatan_persalinan"),
                            rs.getBoolean("skor_aldrette_pasca_anestesi"),
                            rs.getBoolean("skor_steward_pasca_anestesi"),
                            rs.getBoolean("skor_bromage_pasca_anestesi"), rs.getBoolean("penilaian_pre_induksi"),
                            rs.getBoolean("hasil_usg_urologi"), rs.getBoolean("hasil_usg_gynecologi"),
                            rs.getBoolean("hasil_pemeriksaan_ekg"), rs.getBoolean("hapus_edit_sep_bpjs"),
                            rs.getBoolean("satu_sehat_kirim_diet"), rs.getBoolean("satu_sehat_mapping_obat"),
                            rs.getBoolean("dapur_ringkasan_pembelian"),
                            rs.getBoolean("satu_sehat_kirim_medication"),
                            rs.getBoolean("satu_sehat_kirim_medicationrequest"),
                            rs.getBoolean("penatalaksanaan_terapi_okupasi"),
                            ...
                            rs.getBoolean("konsultasi_medik"), rs.getBoolean("jawaban_konsultasi_medik"),
                            rs.getBoolean("pcare_cek_alergi"), rs.getBoolean("pcare_cek_prognosa"),
                            rs.getBoolean("data_sasaran_usiaproduktif"), rs.getBoolean("data_sasaran_usialansia"),
                            rs.getBoolean("skrining_perilaku_merokok_sekolah_remaja"),
                            rs.getBoolean("skrining_kekerasan_pada_perempuan"), rs.getBoolean("skrining_obesitas"),
                            rs.getBoolean("skrining_risiko_kanker_payudara"),
                            rs.getBoolean("skrining_risiko_kanker_paru"), rs.getBoolean("skrining_tbc"),
                            rs.getBoolean("skrining_kesehatan_gigi_mulut_remaja"),
                            rs.getBoolean("penilaian_awal_keperawatan_ranap_bayi"),
                            rs.getBoolean("booking_mcu_perusahaan"),
                            rs.getBoolean("catatan_observasi_restrain_nonfarma"),
                            rs.getBoolean("catatan_observasi_ventilator"), rs.getBoolean("catatan_anestesi_sedasi"),
                            rs.getBoolean("skrining_puma"), rs.getBoolean("satu_sehat_kirim_careplan"),
                            rs.getBoolean("satu_sehat_kirim_medicationstatement"),
                            rs.getBoolean("skrining_adiksi_nikotin"), rs.getBoolean("skrining_thalassemia"),
                            rs.getBoolean("skrining_instrumen_sdq"), rs.getBoolean("pemantauan_pews_maternal"),
                            rs.getBoolean("validasi_sbar")});
