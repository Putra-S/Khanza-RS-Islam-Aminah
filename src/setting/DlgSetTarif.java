...
public class DlgSetTarif extends javax.swing.JDialog {
    ...
    public DlgSetTarif(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Per Poli Ralan", "Per Jenis Bayar Ralan", "Per Ruang Ranap", "Per Jenis Bayar Ranap",
            "Per Jenis Bayar Laborat", "Per Jenis Bayar Radiologi", "Per Jenis Bayar Operasi", "Per Kelas Ranap",
            "Per Kelas Laborat", "Per Kelas Radiologi", "Per Kelas Operasi"};
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (tabMode.getRowCount() == 0) {
            Sequel.menyimpan("set_tarif", "?,?,?,?,?,?,?,?,?,?,?", "Set Tarif",
                    11, new String[]{
                        YesNo1.getSelectedItem().toString(), YesNo2.
                        getSelectedItem().toString(), YesNo3.getSelectedItem().
                                toString(),
                        YesNo4.getSelectedItem().toString(), YesNo5.
                        getSelectedItem().toString(), YesNo6.getSelectedItem().
                                toString(),
                        YesNo7.getSelectedItem().toString(), YesNo8.
                        getSelectedItem().toString(), YesNo9.getSelectedItem().
                                toString(),
                        YesNo10.getSelectedItem().toString(), YesNo11.
            ...
            JOptionPane.showMessageDialog(null,
                    "Maaf, Hanya diijinkan satu record ...!!!!");
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        Sequel.queryu("delete from set_tarif");
        Sequel.menyimpan("set_tarif", "?,?,?,?,?,?,?,?,?,?,?", "Set Tarif", 11,
                new String[]{
                    YesNo1.getSelectedItem().toString(), YesNo2.
                    getSelectedItem().toString(), YesNo3.getSelectedItem().
                            toString(),
    ...
    private void BtnKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKeluarActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null,
                    "Maaf, data Set Tarif tidak boleh kosong ...!!!!");
            YesNo1.requestFocus();
        } else if (!(tabMode.getRowCount() == 0)) {
            dispose();
        }
    ...
    private static final Logger LOG = Logger.getLogger(DlgSetTarif.class.getName());
