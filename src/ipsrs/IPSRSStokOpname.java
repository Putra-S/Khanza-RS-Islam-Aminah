...
public class IPSRSStokOpname extends javax.swing.JDialog {
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode, Kdbar, "ipsrsopname", "tanggal='" + Tanggal.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tbKamar.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptOpnameIPSRS.jasper", "report",
                    "::[ Stok Opname Non Medis, Penunjang Lab & Radiologi ]::",
                    "select ipsrsopname.kode_brng, ipsrsbarang.nama_brng,ipsrsopname.h_beli, ipsrsbarang.kode_sat, ipsrsopname.tanggal, ipsrsopname.stok, "
                    ...
                    + "where concat(ipsrsbarang.jenis,ipsrsjenisbarang.nm_jenis) like '%" + kdjenis.
                            getText() + nmjns.getText().trim() + "%' and ipsrsopname.tanggal between '" + Valid.
                    SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tgl2.getSelectedItem() + "") + "' and "
                    + "(ipsrsopname.kode_brng like '%" + TCari.getText().trim() + "%' or ipsrsbarang.nama_brng like '%" + TCari.
                    getText().trim() + "%' or ipsrsopname.kode_brng like '%" + TCari.
                            getText().trim() + "%' or ipsrsbarang.kode_sat like '%" + TCari.
                            getText().trim() + "%' or "
                    + "ipsrsopname.keterangan like '%" + TCari.getText().trim() + "%') order by ipsrsopname.tanggal",
                    param);
        }
...
private void StokKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_StokKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            IPSRSStokOpname dialog = new IPSRSStokOpname(
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                pstampil.setString(1, "%" + kdjenis.getText() + nmjns.getText().
                        trim() + "%");
    ...
    private static final Logger LOG = Logger.getLogger(IPSRSStokOpname.class.
            getName());
}
