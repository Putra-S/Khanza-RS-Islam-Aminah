...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptRekapPermintaanNonMedis.jasper", param,
                    "::[ Laporan Ringkasan Permintaan Barang Non Medis ]::");
...
private void BtnSeek2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSeek2KeyPressed
            ...
            for (i = 0; i < tbDokter.getRowCount(); i++) {
                if (tbDokter.getValueAt(i, 0).toString().equals("true")) {
                    harga = Sequel.cariIsiAngka(
                            "select harga from ipsrsbarang where kode_brng=?",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRekapPermintaanNonMedis dialog = new DlgRekapPermintaanNonMedis(
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgRekapPermintaanNonMedis.class.getName());
