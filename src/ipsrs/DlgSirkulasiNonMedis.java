...
public class DlgSirkulasiNonMedis extends javax.swing.JDialog {
    ...
    private double ttltotalbeli = 0, totalbeli = 0, stok = 0, aset = 0, ttlaset = 0, jumlahbeli = 0, jumlahutd = 0,
            totalutd = 0, ttltotalutd = 0, ttltotalpesan = 0, totalpesan = 0, jumlahpesan = 0, jumlahkeluar = 0,
            totalkeluar = 0, ttltotalkeluar = 0, jumlahhibah = 0, totalhibah = 0, ttltotalhibah = 0;
    ...
    public DlgSirkulasiNonMedis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Barang", "Nama Barang", "Satuan", "Stok", "Stok(Rp)", "Pengadaan", "Pengadaan(Rp)",
                    "Penerimaan", "Penerimaan(Rp)", "Stok Keluar", "Stok Keluar(Rp)", "Pengambilan UTD",
                    "Pengambilan UTD(Rp)", "Hibah", "Hibah(Rp)"}) {
            @Override
...
//GEN-FIRST:event_TKdKeyPressed
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        if (tabMode.getRowCount() == 0) {//GEN-FIRST:event_BtnPrintActionPerformed
            ...
            Valid.MyReportqry("rptSirkulasiNonMedis.jasper", "report",
    ...
    private static final Logger LOG = Logger.getLogger(DlgSirkulasiNonMedis.class.getName());
