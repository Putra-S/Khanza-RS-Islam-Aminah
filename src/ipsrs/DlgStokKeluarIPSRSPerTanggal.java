...
public class DlgStokKeluarIPSRSPerTanggal extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptStokKeluarIPSRSPerTanggal.jasper", "report",
    ...
    private double JmlBarang(String tanggal, String kodebarang) {
        return Sequel.cariIsiAngka(
                "select sum(ipsrsdetailpengeluaran.jumlah)"
                + " from ipsrspengeluaran inner join ipsrsdetailpengeluaran "
                + " on ipsrspengeluaran.no_keluar=ipsrsdetailpengeluaran.no_keluar "
                + " where ipsrsdetailpengeluaran.kode_brng='" + kodebarang + "' and ipsrspengeluaran.tanggal=?",
                tanggal);
    }

    private static final Logger LOG = Logger.getLogger(DlgStokKeluarIPSRSPerTanggal.class.getName());
