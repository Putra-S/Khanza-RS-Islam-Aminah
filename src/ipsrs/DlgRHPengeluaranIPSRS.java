...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRHKeluarIpsrs.jasper", "report",
                    "[ Rekap Harian Stok Keluar Barang Non Medis, Radiologi, Ipsrs ]",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRHPengeluaranIPSRS dialog = new DlgRHPengeluaranIPSRS(
            ...
            while (rs.next()) {
                ...
                if ((jumlah + jumlah2) > 0) {
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("satuan"), rs.getString("jenis"), Valid.
                        SetAngka(jumlah + jumlah2), Valid.SetAngka(total)
                    });
                }
            }
            if ((totalkeluar) > 0) {
                tabMode.addRow(new Object[]{"Total Pengeluaran :", "", "", "",
                    "", Valid.SetAngka(totalkeluar)
                });
            }
            this.setCursor(Cursor.getDefaultCursor());
        } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgRHPengeluaranIPSRS.class.getName());
