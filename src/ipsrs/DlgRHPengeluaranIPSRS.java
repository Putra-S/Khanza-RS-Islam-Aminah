...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
                ...
                if ((jumlah + jumlah2) > 0) {
                    tabMode.addRow(
                            new Object[]{rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("satuan"),
                                rs.getString("jenis"), Valid.SetAngka(jumlah + jumlah2), Valid.SetAngka(total)});
                }
            }
            if ((totalkeluar) > 0) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgRHPengeluaranIPSRS.class.getName());
