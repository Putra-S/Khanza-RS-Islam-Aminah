...
public class IPSRSPengajuanBarangNonMedis extends javax.swing.JDialog {
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        ...
        DlgCariPengajuanBarangNonMedis form = new DlgCariPengajuanBarangNonMedis(
                null, false);
        form.emptTeks();
        form.isCek();
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if (NoPengajuan.getText().trim().isEmpty()) {
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                sukses = true;
                if (Sequel.
                        menyimpantf2("pengajuan_barang_nonmedis", "?,?,?,?,?",
                        ...
                        try {
                            if (Valid.SetAngka(tbDokter.getValueAt(i, 0).
                                ...
                                if (Sequel.menyimpantf2(
                                        ...
                                        "?,?,?,?,?,?",
                                        "Detail Pengajuan Barang Non Medis", 6,
                                        new String[]{
...
private void btnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPetugasActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            IPSRSPengajuanBarangNonMedis dialog = new IPSRSPengajuanBarangNonMedis(
    ...
    private void tampil() {
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    iyem = iyem + "{\"KodeBarang\":\"" + rs.getString(1) + "\",\"NamaBarang\":\"" + rs.
                            ...
                            getString(3) + "\",\"Jenis\":\"" + rs.getString(4) + "\",\"Harga\":\"" + rs.
                            getString(5) + "\"},";
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : " + e);
            ...
            fileWriter.write("{\"pengajuanipsrs\":[" + iyem.substring(0, iyem.
                    length() - 1) + "]}");
            fileWriter.flush();
            fileWriter.close();
            iyem = null;
        ...
        try {
            ...
            for (i = 0; i < row; i++) {
                if (!tbDokter.getValueAt(i, 0).toString().isEmpty()) {
                    ...
                    ipsrsjenisbarang[index] = tbDokter.getValueAt(i, 4).
                            toString();
                    harga[index] = Double.valueOf(tbDokter.getValueAt(i, 5).
                            toString());
                    subtotal[index] = Double.valueOf(tbDokter.getValueAt(i, 6).
                            toString());
                    index++;
                }
            }
            ...
            for (i = 0; i < jml; i++) {
                tabMode.addRow(new Object[]{jumlah[i], kodebarang[i],
                    namabarang[i], satuan[i], ipsrsjenisbarang[i], harga[i],
                    subtotal[i]});
            }
                ...
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{
                            ...
                            list.path("Jenis").asText(), list.path("Harga").
                            asDouble(), 0
                        });
                    }
                } else {
                    for (JsonNode list : response) {
                        if (list.path("KodeBarang").asText().toLowerCase().
                            ...
                            tabMode.addRow(new Object[]{
                                ...
                                asText(), list.path("Jenis").asText(), list.
                                path("Harga").asDouble(), 0
                            });
                        }
                    }
                }
    ...
    private void autoNomor() {
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(pengajuan_barang_nonmedis.no_pengajuan,3),signed)),0) from pengajuan_barang_nonmedis where pengajuan_barang_nonmedis.tanggal='" + Valid.
                        SetTgl(Tanggal.getSelectedItem() + "") + "' ",
                "PBNM" + Tanggal.getSelectedItem().toString().substring(6, 10) + Tanggal.
    ...
    private static final Logger LOG = Logger.getLogger(
            IPSRSPengajuanBarangNonMedis.class.getName());
