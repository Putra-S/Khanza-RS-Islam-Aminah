...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRingkasanReturSuplierNonMedis.jasper",
                    "report",
                    "::[ Laporan Ringkasan Retur Ke Suplier Barang Non Medis ]::",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            IPSRSRingkasanReturBeliBarangNonMedis dialog = new IPSRSRingkasanReturBeliBarangNonMedis(
