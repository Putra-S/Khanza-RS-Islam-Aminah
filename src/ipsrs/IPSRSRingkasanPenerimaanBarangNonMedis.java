...
//GEN-FIRST:event_TKdKeyPressed
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRingkasanPenerimaanNonMedis.jasper", "report",
                    "::[ Laporan Ringkasan Penerimaan Barang Non Medis ]::",
                    ...
                    getText() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText() + "%' and ipsrspemesanan.no_faktur like '%" + TCari.
                            getText() + "%' or "
                    ...
                    getText() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText() + "%'  and ipsrsbarang.jenis like '%" + kdjenis.
                            getText() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText() + "%' and ipsrspemesanan.kode_suplier like '%" + TCari.
                            getText() + "%' or "
                    + " ipsrspemesanan.tgl_pesan between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspemesanan.no_faktur like '%" + NoFaktur.
                    getText() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText() + "%'  and ipsrsbarang.jenis like '%" + kdjenis.
                            getText() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText() + "%' and ipsrssuplier.nama_suplier like '%" + TCari.
                            getText() + "%' or "
                    + " ipsrspemesanan.tgl_pesan between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspemesanan.no_faktur like '%" + NoFaktur.
                    getText() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText() + "%'  and ipsrsbarang.jenis like '%" + kdjenis.
                            getText() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText() + "%' and ipsrspemesanan.nip like '%" + TCari.
                            getText() + "%' or "
                    + " ipsrspemesanan.tgl_pesan between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspemesanan.no_faktur like '%" + NoFaktur.
                    ...
                    getText() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText() + "%'  and ipsrsbarang.jenis like '%" + kdjenis.
                            getText() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText() + "%' and ipsrsdetailpesan.kode_brng like '%" + TCari.
                            getText() + "%' or "
                    + " ipsrspemesanan.tgl_pesan between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspemesanan.no_faktur like '%" + NoFaktur.
                    getText() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText() + "%'  and ipsrsbarang.jenis like '%" + kdjenis.
                            getText() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText() + "%' and ipsrsbarang.nama_brng like '%" + TCari.
                            getText() + "%' or "
                    + " ipsrspemesanan.tgl_pesan between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspemesanan.no_faktur like '%" + NoFaktur.
                    getText() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText() + "%'  and ipsrsbarang.jenis like '%" + kdjenis.
                            getText() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText() + "%' and ipsrsdetailpesan.kode_sat like '%" + TCari.
                            getText() + "%' or "
                    + " ipsrspemesanan.tgl_pesan between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspemesanan.no_faktur like '%" + NoFaktur.
                    getText() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText() + "%'  and ipsrsbarang.jenis like '%" + kdjenis.
                            getText() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText() + "%' and ipsrspemesanan.no_order like '%" + TCari.
                            getText() + "%' or "
                    + " ipsrspemesanan.tgl_pesan between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspemesanan.no_faktur like '%" + NoFaktur.
                    getText() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText() + "%'  and ipsrsbarang.jenis like '%" + kdjenis.
                            getText() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText() + "%' and ipsrsjenisbarang.nm_jenis like '%" + TCari.
                            getText() + "%' "
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            IPSRSRingkasanPenerimaanBarangNonMedis dialog = new IPSRSRingkasanPenerimaanBarangNonMedis(
    ...
    private static final Logger LOG = Logger.getLogger(IPSRSRingkasanPenerimaanBarangNonMedis.class.getName());
