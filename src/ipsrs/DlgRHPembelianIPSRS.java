...
//GEN-FIRST:event_TKdKeyPressed
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRekapPengadaanNonMedis.jasper", "report",
                    "::[ Rekap Pengadaan Barang Non Medis ]::",
                    ...
                    + " (ipsrspembelian.no_faktur like '%" + TCari.getText().
                            trim() + "%' or ipsrspembelian.kode_suplier like '%" + TCari.
                            getText().trim() + "%' or ipsrssuplier.nama_suplier like '%" + TCari.
                            getText().trim() + "%' or ipsrspembelian.nip like '%" + TCari.
                            getText().trim() + "%' or petugas.nama like '%" + TCari.
                            getText().trim() + "%' or ipsrsdetailbeli.kode_brng like '%" + TCari.
                            getText().trim() + "%' or ipsrsbarang.nama_brng like '%" + TCari.
                            getText().trim() + "%' or ipsrsdetailbeli.kode_sat like '%" + TCari.
