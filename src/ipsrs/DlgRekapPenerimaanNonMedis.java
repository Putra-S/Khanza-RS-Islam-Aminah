    ...
    public DlgRekapPenerimaanNonMedis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Faktur", "No.Order", "Suplier", "Petugas", "Tgl.Pesan", "Tgl.Faktur", "Jatuh Tempo",
                    "Barang", "Satuan", "Jml.Beli", "Harga Beli(Rp)", "SubTotal(Rp)", "Disk(%)", "Bsr.Disk(Rp)",
                    "Total(Rp)", "Status Bayar"}) {
...
//GEN-FIRST:event_TKdKeyPressed
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRekapPenerimaanNonMedis.jasper", "report",
                    "::[ Rekap Penerimaan Barang Non Medis ]::",
                    ...
                    + " where ipsrspemesanan.tgl_pesan between '" + Valid.
                            SetTgl(TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspemesanan.no_faktur like '%" + NoFaktur.
                    getText().trim() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            getText().trim() + "%' and petugas.nama like '%" + nmptg.
                            getText().trim() + "%'  and ipsrsjenisbarang.nm_jenis like '%" + nmjenis.
                            getText().trim() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText().trim() + "%' and ipsrspemesanan.no_faktur like '%" + TCari.
                            getText().trim() + "%' or "
                    + " ipsrspemesanan.tgl_pesan between '" + Valid.SetTgl(
                    ...
                    getText().trim() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText().trim() + "%'  and ipsrsjenisbarang.nm_jenis like '%" + nmjenis.
                            getText().trim() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText().trim() + "%' and ipsrspemesanan.kode_suplier like '%" + TCari.
                            getText().trim() + "%' or "
                    + " ipsrspemesanan.tgl_pesan between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspemesanan.no_faktur like '%" + NoFaktur.
                    ...
                    getText().trim() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText().trim() + "%'  and ipsrsjenisbarang.nm_jenis like '%" + nmjenis.
                            getText().trim() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText().trim() + "%' and ipsrspemesanan.nip like '%" + TCari.
                            getText().trim() + "%' or "
                    + " ipsrspemesanan.tgl_pesan between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspemesanan.no_faktur like '%" + NoFaktur.
                    ...
                    getText().trim() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText().trim() + "%'  and ipsrsjenisbarang.nm_jenis like '%" + nmjenis.
                            getText().trim() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText().trim() + "%' and ipsrsdetailpesan.kode_brng like '%" + TCari.
                            getText().trim() + "%' or "
                    + " ipsrspemesanan.tgl_pesan between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspemesanan.no_faktur like '%" + NoFaktur.
                    getText().trim() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText().trim() + "%'  and ipsrsjenisbarang.nm_jenis like '%" + nmjenis.
                            getText().trim() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText().trim() + "%' and ipsrsbarang.nama_brng like '%" + TCari.
                            getText().trim() + "%' or "
                    + " ipsrspemesanan.tgl_pesan between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspemesanan.no_faktur like '%" + NoFaktur.
                    getText().trim() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText().trim() + "%'  and ipsrsjenisbarang.nm_jenis like '%" + nmjenis.
                            getText().trim() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText().trim() + "%' and ipsrsdetailpesan.kode_sat like '%" + TCari.
                            getText().trim() + "%' or "
                    + " ipsrspemesanan.tgl_pesan between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspemesanan.no_faktur like '%" + NoFaktur.
                    getText().trim() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText().trim() + "%'  and ipsrsjenisbarang.nm_jenis like '%" + nmjenis.
                            getText().trim() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText().trim() + "%' and ipsrspemesanan.no_order like '%" + TCari.
                            getText().trim() + "%' or "
                    + " ipsrspemesanan.tgl_pesan between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspemesanan.no_faktur like '%" + NoFaktur.
                    getText().trim() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText().trim() + "%'  and ipsrsjenisbarang.nm_jenis like '%" + nmjenis.
                            getText().trim() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText().trim() + "%' and ipsrsjenisbarang.nm_jenis like '%" + TCari.
                            getText().trim() + "%' "
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("no_faktur"), rs.getString("no_order"),
                        ...
                        rs.getString("tgl_faktur"), rs.getString("tgl_tempo"),
            ...
            if (tagihan > 0) {
                tabMode.addRow(new Object[]{"", "Total :", "", "", "", "", "", "", "", null, null, subtotal, null,
                    diskon, tagihan, null});
            }
    ...
    private static final Logger LOG = Logger.getLogger(DlgRekapPenerimaanNonMedis.class.getName());
