...
public class IPSRSRingkasanPengadaanBarangNonMedis extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public IPSRSRingkasanPengadaanBarangNonMedis(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRingkasanPengadaanNonMedis.jasper", "report",
                    "::[ Laporan Ringkasan Pengadaan Barang Non Medis ]::",
                    ...
                    + " where ipsrspembelian.tgl_beli between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspembelian.no_faktur like '%" + NoFaktur.
                    getText() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText() + "%' and ipsrspembelian.no_faktur like '%" + TCari.
                            getText() + "%' or "
                    + " ipsrspembelian.tgl_beli between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspembelian.no_faktur like '%" + NoFaktur.
                    getText() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            getText() + "%' and petugas.nama like '%" + nmptg.
                            getText() + "%'  and ipsrsbarang.jenis like '%" + kdjenis.
                            getText() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText() + "%' and ipsrspembelian.kode_suplier like '%" + TCari.
                            getText() + "%' or "
                    + " ipsrspembelian.tgl_beli between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspembelian.no_faktur like '%" + NoFaktur.
                    ...
                    getText() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText() + "%'  and ipsrsbarang.jenis like '%" + kdjenis.
                            getText() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText() + "%' and ipsrspembelian.nip like '%" + TCari.
                            getText() + "%' or "
                    + " ipsrspembelian.tgl_beli between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspembelian.no_faktur like '%" + NoFaktur.
                    ...
                    getText() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText() + "%'  and ipsrsbarang.jenis like '%" + kdjenis.
                            getText() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText() + "%' and ipsrsbarang.jenis like '%" + TCari.
                            getText() + "%' or "
                    + " ipsrspembelian.tgl_beli between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspembelian.no_faktur like '%" + NoFaktur.
                    getText() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText() + "%'  and ipsrsbarang.jenis like '%" + kdjenis.
                            getText() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText() + "%' and ipsrsdetailbeli.kode_brng like '%" + TCari.
                            getText() + "%' or "
                    + " ipsrspembelian.tgl_beli between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and ipsrspembelian.no_faktur like '%" + NoFaktur.
                    ...
                    getText() + "%' and ipsrssuplier.nama_suplier like '%" + nmsup.
                            ...
                            getText() + "%'  and ipsrsbarang.jenis like '%" + kdjenis.
                            getText() + "%' and ipsrsbarang.nama_brng like '%" + nmbar.
                            getText() + "%' and kodesatuan.satuan like '%" + TCari.
                            getText() + "%' "
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            IPSRSRingkasanPengadaanBarangNonMedis dialog = new IPSRSRingkasanPengadaanBarangNonMedis(
    ...
    private static final Logger LOG = Logger.getLogger(
            IPSRSRingkasanPengadaanBarangNonMedis.class.getName());
