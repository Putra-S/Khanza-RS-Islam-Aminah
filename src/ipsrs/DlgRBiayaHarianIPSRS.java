    ...
    public DlgRBiayaHarianIPSRS(java.awt.Frame parent, boolean modal) {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select ipsrspembelian.tgl_beli,sum(ipsrspembelian.total) from ipsrspembelian  "
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRBiayaIPSRS.jasper", "report",
                    "[ Rekap Biaya Pengadaan Stok Keluar Barang Non Medis, Radiologi, Ipsrs ]",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRBiayaHarianIPSRS dialog = new DlgRBiayaHarianIPSRS(
    ...
    private void prosesCari() {
        try {
            ...
            jumlah = 0;
            while (rs.next()) {
                tabMode.addRow(new Object[]{rs.getString(1), Valid.SetAngka(rs.
                    getDouble(2))});
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgRBiayaHarianIPSRS.class.getName());
