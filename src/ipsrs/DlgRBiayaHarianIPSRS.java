...
public class DlgRBiayaHarianIPSRS extends javax.swing.JDialog {
    ...
    public DlgRBiayaHarianIPSRS(java.awt.Frame parent, boolean modal) {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select ipsrspembelian.tgl_beli,sum(ipsrspembelian.total) from ipsrspembelian  "
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private static final Logger LOG = Logger.getLogger(DlgRBiayaHarianIPSRS.class.getName());
