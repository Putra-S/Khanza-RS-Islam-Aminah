...
public class DlgPengadaanIPSRSPerTanggal extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPengadaanIPSRSPerTanggal dialog = new DlgPengadaanIPSRSPerTanggal(
    ...
    String konversi(int year, int month, int day) {
        ...
        try {
            ...
            Logger.getLogger(DlgPengadaanIPSRSPerTanggal.class.getName()).log(
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgPengadaanIPSRSPerTanggal.class.getName());
