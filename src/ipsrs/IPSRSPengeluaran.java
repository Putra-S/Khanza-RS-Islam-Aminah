    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (NoKeluar.getText().trim().isEmpty()) {
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                sukses = true;
                if (Sequel.menyimpantf2("ipsrspengeluaran", "?,?,?,?",
                    ...
                    for (i = 0; i < jml; i++) {
                        if (Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()) > 0) {
                            if (Sequel.menyimpantf2("ipsrsdetailpengeluaran",
                ...
                if (sukses == true) {
                    ...
                    sukses = jur.simpanJurnal(NoKeluar.getText(), "U",
                            "PENGGUNAAN BARANG NON MEDIS DAN PENUNJANG (LAB & RAD)" + ", OLEH " + akses.
                                    getkode());
                }
...
private void btnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPetugasActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            IPSRSPengeluaran dialog = new IPSRSPengeluaran(
    ...
    private void autoNomor() {
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(ipsrspengeluaran.no_keluar,3),signed)),0) from ipsrspengeluaran where ipsrspengeluaran.tanggal='" + Valid.
                        SetTgl(TglKeluar.getSelectedItem() + "") + "' ",
                "SKNM" + TglKeluar.getSelectedItem().toString().substring(8, 10) + TglKeluar.
    ...
    public void tampil(String nopermintaan, String keterangan) {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select ipsrsbarang.kode_brng, concat(ipsrsbarang.nama_brng,' (',ipsrsbarang.jenis,')'),"
    ...
    private static final Logger LOG = Logger.getLogger(IPSRSPengeluaran.class.
            getName());
}
