...
private void btnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPetugasActionPerformed
    ...
    private void autoNomor() {
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(ipsrspengeluaran.no_keluar,3),signed)),0) from ipsrspengeluaran where ipsrspengeluaran.tanggal='"
                + Valid.SetTgl(TglKeluar.getSelectedItem() + "") + "' ",
                "SKNM" + TglKeluar.getSelectedItem().toString().substring(8, 10)
    ...
    private static final Logger LOG = Logger.getLogger(IPSRSPengeluaran.class.getName());
