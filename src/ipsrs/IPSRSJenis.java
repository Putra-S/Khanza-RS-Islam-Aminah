 ...
 * @author dosen
 */
public class IPSRSJenis extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("ipsrsjenisbarang",
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbKamar.getRowCount(); i++) {
            if (tbKamar.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("ipsrsjenisbarang", "kd_jenis", tbKamar.
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Valid.editTable(tabMode, "ipsrsjenisbarang", "kd_jenis", "?",
                    "nm_jenis=?,kd_jenis=?", 3, new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptIpsrsJenis.jasper", "report",
                    "::[ Data Jenis Barang ]::", "select kd_jenis, nm_jenis "
                    + " from ipsrsjenisbarang where  kd_jenis like '%" + TCari.
                            getText().trim() + "%' or "
...
private void NmKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select kd_jenis,nm_jenis  "
                    + " from ipsrsjenisbarang where  kd_jenis like ? or " + " nm_jenis like ? order by nm_jenis ");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(IPSRSJenis.class.getName());
