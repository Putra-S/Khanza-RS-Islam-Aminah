...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptDataPemesananNonMedis.jasper", "report",
                    "::[ Data Surat Pemesanan Barang Non Medis dan Penunjang ( Lab & Radiologi) ]::",
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
    if (tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString().trim().
        ...
        Sequel.queryu2(
                "delete from surat_pemesanan_non_medis where no_pemesanan=?", 1,
                new String[]{tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).
                            toString()});
        tampil();
    }
    ...
    private void ppDatangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppDatangActionPerformed
        if (tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString().trim().
            ...
            if (Sequel.cariIsi(
                    "select status from surat_pemesanan_non_medis where no_pemesanan=?",
                ...
                Sequel.queryu(
                        "update surat_pemesanan_non_medis set status='Sudah Datang' where no_pemesanan=?",
    ...
    private void ppProsesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppProsesActionPerformed
        if (tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString().trim().
            ...
            Sequel.queryu(
                    "update surat_pemesanan_non_medis set status='Proses Pesan' where no_pemesanan=?",
                    tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString().
                            trim());
            tampil();
        }
            ...
            try {
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        try {
                            ...
                            while (rs2.next()) {
                                Sequel.menyimpan(
                                        ...
                                        getString("kode_brng") + "','"
                                        + rs2.getString("nama_brng") + "','" + Valid.
                                        SetAngka(rs2.getDouble("h_pesan")) + "','" + Valid.
                                        SetAngka(rs2.getDouble("subtotal")) + "','"
                                        + rs2.getDouble("dis") + "','" + Valid.
                                        SetAngka(rs2.getDouble("besardis")) + "','" + Valid.
                        ...
                        Valid.MyReportqry("rptSuratPemesananNonMedis.jasper",
                                "report", "::[ Transaksi Pemesanan Barang ]::",
                                "select * from temporary where temporary.temp37='" + akses.
