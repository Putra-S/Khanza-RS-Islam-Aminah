...
public class DlgSirkulasiNonMedis2 extends javax.swing.JDialog {
    ...
    private double ttltotalbeli = 0, totalbeli = 0, stok = 0, totalstok = 0, jumlahbeli = 0, ttltotalpesan = 0,
            totalpesan = 0, jumlahpesan = 0, jumlahkeluar, totalkeluar, ttltotalkeluar, ttltotalstokawal = 0,
            ttltotalstokakhir = 0, stokakhir = 0, totalstokawal = 0, totalstokakhir = 0, stokawal = 0, jumlahutd = 0,
            totalutd = 0, ttltotalutd = 0, jumlahhibah = 0, totalhibah = 0, ttltotalhibah = 0;
    ...
    public DlgSirkulasiNonMedis2(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Barang", "Nama Barang", "Satuan", "Tgl.Opname", "Stok Awal", "Stok Awal(Rp)",
                    "Pengadaan", "Pengadaan(Rp)", "Penerimaan", "Penerimaan(Rp)", "Stok Keluar", "Stok Keluar(Rp)",
                    "Pengambilan UTD", "Pengambilan UTD(Rp)", "Hibah", "Hibah(Rp)", "Stok Akhir",
                    "Stok Akhir(Rp)"}) {
            @Override
...
//GEN-FIRST:event_TKdKeyPressed
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        if (tabMode.getRowCount() == 0) {//GEN-FIRST:event_BtnPrintActionPerformed
            ...
            Valid.MyReportqry("rptSirkulasiNonMedis2.jasper", "report",
                    "::[ Sirkulasi Barang Non Medis, Penunjang Lab & Radiologi ]::",
    ...
    private void prosesCari() {
        ...
        try {
            ps = koneksi.prepareStatement("select ipsrsbarang.kode_brng,ipsrsbarang.nama_brng, "
                    ...
                    + "ipsrsbarang.nama_brng like ? and kodesatuan.satuan like ? " + " order by ipsrsbarang.kode_brng");
            try {
                ttltotalbeli = 0;
                ttltotalpesan = 0;
                ttltotalkeluar = 0;
                ...
                while (rs.next()) {
                    ...
                    jumlahhibah = 0;
                    totalhibah = 0;
                    tglopname = Sequel.cariIsi("select tanggal from ipsrsopname where kode_brng='" + rs.getString(1)
                    ...
                    // ipsrspemesanan
                    ps2 = koneksi
                            .prepareStatement("select sum(ipsrsdetailpesan.jumlah), sum(ipsrsdetailpesan.subtotal) "
                    ...
                    ps2 = koneksi.prepareStatement(
                            "select sum(ipsrsdetailpengeluaran.jumlah), sum(ipsrsdetailpengeluaran.total) "
                    ...
                    // ipsrshibah
                    ps2 = koneksi.prepareStatement(
                            "select sum(ipsrs_detail_hibah.jumlah), sum(ipsrs_detail_hibah.subtotalhibah) "
                    ...
                    ps2 = koneksi.prepareStatement(
                            "select sum(ipsrsopname.real),(ipsrsopname.real*ipsrsopname.h_beli) from ipsrsopname where kode_brng=? and tanggal=?");
                    try {
                        ps2.setString(1, rs.getString(1));
                        ps2.setString(2, tglopname);
                        rs2 = ps2.executeQuery();
                    ...
                    if ((jumlahbeli > 0) || (jumlahpesan > 0) || (jumlahkeluar > 0) || (stok > 0) || (jumlahutd > 0)
                        ...
                        tabMode.addRow(new Object[]{rs.getString(1), rs.getString(2), rs.getString(3), tglopname,
                            ...
                            Valid.SetAngka(jumlahkeluar), Valid.SetAngka(totalkeluar), Valid.SetAngka(jumlahutd),
                            Valid.SetAngka(totalutd), Valid.SetAngka(jumlahhibah), Valid.SetAngka(totalhibah),
                ...
                tabMode.addRow(new Object[]{"<>>", "Total :", "", "", "", Valid.SetAngka(ttltotalstokawal), "",
                    ...
                    Valid.SetAngka(ttltotalkeluar), "", Valid.SetAngka(ttltotalutd), "",
    ...
    private static final Logger LOG = Logger.getLogger(DlgSirkulasiNonMedis2.class.getName());
