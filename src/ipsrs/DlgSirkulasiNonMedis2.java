...
public class DlgSirkulasiNonMedis2 extends javax.swing.JDialog {
    ...
    public DlgSirkulasiNonMedis2(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Pengambilan UTD", "Pengambilan UTD(Rp)",
...
*/
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSirkulasiNonMedis2 dialog = new DlgSirkulasiNonMedis2(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tglopname = Sequel.cariIsi(
                            "select tanggal from ipsrsopname where kode_brng='" + rs.
                    ...
                    ps2 = koneksi.prepareStatement(
                            "select sum(ipsrsdetailbeli.jumlah), sum(ipsrsdetailbeli.subtotal) "
                    ...
                    //ipsrspemesanan
                    ps2 = koneksi.prepareStatement(
                            "select sum(ipsrsdetailpesan.jumlah), sum(ipsrsdetailpesan.subtotal) "
                    ...
                    ps2 = koneksi.prepareStatement(
                            "select sum(utd_pengambilan_penunjang.jml) as jumlah, "
                ...
                tabMode.addRow(new Object[]{"<>>", "Total :", "", "", "", Valid.
                    SetAngka(ttltotalstokawal), "",
                    Valid.SetAngka(ttltotalbeli), "", Valid.SetAngka(
                    ttltotalpesan), "", Valid.SetAngka(ttltotalkeluar),
                    "", Valid.SetAngka(ttltotalutd), "", Valid.SetAngka(
                    ttltotalhibah), "", Valid.SetAngka(ttltotalstokakhir)
                });
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgSirkulasiNonMedis2.class.getName());
