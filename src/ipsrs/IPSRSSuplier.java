...
public class IPSRSSuplier extends javax.swing.JDialog {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Valid.editTable(tabMode, "ipsrssuplier", "kode_suplier", "?",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptSuplier.jasper", "report",
                    ...
                    + " where ipsrssuplier.kode_suplier like '%" + TCari.
                            getText().trim() + "%' or "
                    ...
                    + " ipsrssuplier.no_telp like '%" + TCari.getText().trim() + "%' order by ipsrssuplier.kode_suplier",
                    param);
        }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("ipsrssuplier", "?,?,?,?,?,?,?",
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select ipsrssuplier.kode_suplier, ipsrssuplier.nama_suplier, "
                    ...
                    + " where ipsrssuplier.kode_suplier like ? or " + " ipsrssuplier.nama_suplier like ? or "
                    + " ipsrssuplier.alamat like ? or " + " ipsrssuplier.kota like ? or "
    ...
    private static final Logger LOG = Logger.getLogger(IPSRSSuplier.class.getName());
