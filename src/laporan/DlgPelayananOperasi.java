...
public class DlgPelayananOperasi extends javax.swing.JDialog {
    ...
    public DlgPelayananOperasi(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr = {"No.", "No.RM", "Nama Pasien", "Operator 1", "Operasi", "Jam Mulai", "Jam Selesai",
            "Durasi(m)"};
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public void tampil() {
        try {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    : "and (reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or dokter.nm_dokter like ? or paket_operasi.nm_perawatan like ? ) ")
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{i, rs.getString("no_rkm_medis"), rs.getString("nm_pasien"),
                        rs.getString("nm_dokter"), rs.getString("nm_perawatan"), rs.getString("tanggal"),
                        rs.getString("selesaioperasi"), rs.getString("durasi")});
                    i++;
                ...
                if (totaljam > 0) {
                    ...
                    tabMode.addRow(new Object[]{"", "", ">60 - <=120 Menit", ": ", "", "", "", "" + duajam});
    ...
    private static final Logger LOG = Logger.getLogger(DlgPelayananOperasi.class.getName());
