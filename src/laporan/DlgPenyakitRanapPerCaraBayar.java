...
public class DlgPenyakitRanapPerCaraBayar extends javax.swing.JDialog {
    ...
    public DlgPenyakitRanapPerCaraBayar(java.awt.Frame parent, boolean modal) {
        ...
        tabMode2 = new DefaultTableModel(null, new String[]{"No.", "Kode",
            "Diagnosa", "Penyakit"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPenyakitRanapPerCaraBayar dialog = new DlgPenyakitRanapPerCaraBayar(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        "nm_penyakit"), rs.getString("jumlah")
                    });
                    i++;
                }
                if (ttljmlpasien > 0) {
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgPenyakitRanapPerCaraBayar.class.getName());
