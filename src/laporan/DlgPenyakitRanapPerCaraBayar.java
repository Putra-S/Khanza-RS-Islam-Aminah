 ...
 * @author perpustakaan
 */
public class DlgPenyakitRanapPerCaraBayar extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (TabRawat.getSelectedIndex() == 0) {
            ...
            if (tabMode.getRowCount() == 0) {
                ...
                Valid.MyReportqry("rptPenyakitRanapCaraBayar.jasper", "report",
                        "::[ Laporan Penyakit Rawat Inap Per Cara Bayar ]::",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{i, rs.getString("kd_penyakit"), rs.getString("nm_penyakit"),
                        rs.getString("jumlah")});
                    i++;
                }
                if (ttljmlpasien > 0) {
                    tabMode.addRow(new Object[]{"", "Total", "", ttljmlpasien});
                }
            } catch (Exception e) {
    ...
    public void tampil2() {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ttljmlpasien += rs.getInt("jumlah");
                    tabMode2.addRow(new Object[]{i, rs.getString("kd_penyakit"), rs.getString("nm_penyakit"),
                        rs.getString("jumlah")});
                    i++;
                }
                if (ttljmlpasien > 0) {
                    tabMode2.addRow(new Object[]{"", "Total", "", ttljmlpasien});
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
            } finally {
    ...
    private static final Logger LOG = Logger.getLogger(DlgPenyakitRanapPerCaraBayar.class.getName());
