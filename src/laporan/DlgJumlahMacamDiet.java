...
public class DlgJumlahMacamDiet extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJumlahMacamDiet dialog = new DlgJumlahMacamDiet(
            ...
            try {
                ...
                while (rs.next()) {
                    h1 = Sequel.cariInteger(
                            ...
                            getSelectedItem() + "-01", rs.getString("kd_diet"));
                    h2 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-02", rs.getString("kd_diet"));
                    h3 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-03", rs.getString("kd_diet"));
                    h4 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-04", rs.getString("kd_diet"));
                    h5 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-05", rs.getString("kd_diet"));
                    h6 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-06", rs.getString("kd_diet"));
                    h7 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-07", rs.getString("kd_diet"));
                    h8 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-08", rs.getString("kd_diet"));
                    h9 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-09", rs.getString("kd_diet"));
                    h10 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-10", rs.getString("kd_diet"));
                    h11 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-11", rs.getString("kd_diet"));
                    h12 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-12", rs.getString("kd_diet"));
                    h13 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-13", rs.getString("kd_diet"));
                    h14 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-14", rs.getString("kd_diet"));
                    h15 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-15", rs.getString("kd_diet"));
                    h16 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-16", rs.getString("kd_diet"));
                    h17 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-17", rs.getString("kd_diet"));
                    h18 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-18", rs.getString("kd_diet"));
                    h19 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-19", rs.getString("kd_diet"));
                    h20 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-20", rs.getString("kd_diet"));
                    h21 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-21", rs.getString("kd_diet"));
                    h22 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-22", rs.getString("kd_diet"));
                    h23 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-23", rs.getString("kd_diet"));
                    h24 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-24", rs.getString("kd_diet"));
                    h25 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-25", rs.getString("kd_diet"));
                    h26 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-26", rs.getString("kd_diet"));
                    h27 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-27", rs.getString("kd_diet"));
                    h28 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-28", rs.getString("kd_diet"));
                    h29 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-29", rs.getString("kd_diet"));
                    h30 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-30", rs.getString("kd_diet"));
                    h31 = Sequel.cariInteger(
                            "select count(detail_beri_diet.kd_diet) from detail_beri_diet inner join diet on detail_beri_diet.kd_diet=diet.kd_diet where detail_beri_diet.tanggal=? and diet.kd_diet=?",
                            ThnCari.getSelectedItem() + "-" + BlnCari.
                            getSelectedItem() + "-31", rs.getString("kd_diet"));
                    jmlh1 += h1;
                    jmlh2 += h2;
                    jmlh3 += h3;
                    jmlh4 += h4;
                    ...
                    tabMode.addRow(new String[]{
                        i + "", rs.getString("nama_diet"), h1 + "", h2 + "",
                        h3 + "", h4 + "", h5 + "", h6 + "", h7 + "", h8 + "",
                        h9 + "", h10 + "",
                        h11 + "", h12 + "", h13 + "", h14 + "", h15 + "",
                        h16 + "", h17 + "", h18 + "", h19 + "", h20 + "",
    ...
    String konversi(int year, int month, int day) {
        ...
        try {
            ...
            Logger.getLogger(DlgJumlahMacamDiet.class.getName()).log(
    ...
    private static final Logger LOG = Logger.getLogger(DlgJumlahMacamDiet.class.
            getName());
