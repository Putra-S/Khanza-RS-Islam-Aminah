 ...
 * @author perpustakaan
 */
public class DlgPerujukLabPerTahun extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptPerujukLabPerTahun.jasper", "report",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
            ...
            try {
                ...
                while (rs.next()) {
                    jan = Sequel.cariInteger(
                            "select count(dokter_perujuk) from periksa_lab where dokter_perujuk=? and tgl_periksa like ?",
    ...
    private static final Logger LOG = Logger.getLogger(DlgPerujukLabPerTahun.class.getName());
