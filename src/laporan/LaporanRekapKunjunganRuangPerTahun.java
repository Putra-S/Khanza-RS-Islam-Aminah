...
public class LaporanRekapKunjunganRuangPerTahun extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public LaporanRekapKunjunganRuangPerTahun(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            LaporanRekapKunjunganRuangPerTahun dialog = new LaporanRekapKunjunganRuangPerTahun(
            ...
            try {
                ...
                while (rs.next()) {
                    jan = Sequel.cariInteger(
                            ...
                            rs.getString("kd_bangsal"), "%" + ThnCari.
                            getSelectedItem() + "-01%");
                    ...
                    tabMode.addRow(new String[]{
                        i + "", rs.getString("nm_bangsal") + " (" + rs.
                        getString("kd_bangsal") + ")", jan + "", feb + "",
                        mar + "", apr + "", mei + "",
                        jun + "", jul + "", agu + "", sep + "", okt + "",
    ...
    private static final Logger LOG = Logger.getLogger(
            LaporanRekapKunjunganRuangPerTahun.class.getName());
