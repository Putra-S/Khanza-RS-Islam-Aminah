...
public class DlgKunjunganRadRanap extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptKunjunganRadRanap.jasper", "report",
                    "::[ Laporan Kunjungan Radiologi Rawat Inap ]::",
    ...
    public void tampil() {
        try {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + "where periksa_radiologi.status='Ranap' and periksa_radiologi.tgl_periksa between ? and ? and bangsal.kd_bangsal like ? and dokter.nm_dokter like ? and penjab.kd_pj like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and bangsal.kd_bangsal like ? or "
                    + "periksa_radiologi.status='Ranap' and periksa_radiologi.tgl_periksa between ? and ? and bangsal.kd_bangsal like ? and dokter.nm_dokter like ? and penjab.kd_pj like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and dokter.nm_dokter like ? or "
                    + "periksa_radiologi.status='Ranap' and periksa_radiologi.tgl_periksa between ? and ? and bangsal.kd_bangsal like ? and dokter.nm_dokter like ? and penjab.kd_pj like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and reg_periksa.no_rkm_medis like ? or "
                    + "periksa_radiologi.status='Ranap' and periksa_radiologi.tgl_periksa between ? and ? and bangsal.kd_bangsal like ? and dokter.nm_dokter like ? and penjab.kd_pj like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.nm_pasien like ? or "
                    + "periksa_radiologi.status='Ranap' and periksa_radiologi.tgl_periksa between ? and ? and bangsal.kd_bangsal like ? and dokter.nm_dokter like ? and penjab.kd_pj like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.alamat like ? "
            ...
            try {
                ...
                ps.setString(3, "%" + kdkamar.getText().trim() + "%");
                ps.setString(4, "%" + nmdokter.getText().trim() + "%");
                ps.setString(5, "%" + kdpenjab.getText().trim() + "%");
                ...
                ps.setString(12, "%" + kdkamar.getText().trim() + "%");
                ps.setString(13, "%" + nmdokter.getText().trim() + "%");
                ps.setString(14, "%" + kdpenjab.getText().trim() + "%");
                ...
                ps.setString(21, "%" + kdkamar.getText().trim() + "%");
                ps.setString(22, "%" + nmdokter.getText().trim() + "%");
                ps.setString(23, "%" + kdpenjab.getText().trim() + "%");
                ...
                ps.setString(30, "%" + kdkamar.getText().trim() + "%");
                ps.setString(31, "%" + nmdokter.getText().trim() + "%");
                ps.setString(32, "%" + kdpenjab.getText().trim() + "%");
                ...
                ps.setString(39, "%" + kdkamar.getText().trim() + "%");
                ps.setString(40, "%" + nmdokter.getText().trim() + "%");
                ps.setString(41, "%" + kdpenjab.getText().trim() + "%");
