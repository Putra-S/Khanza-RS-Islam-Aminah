...
//GEN-FIRST:event_TKdKeyPressed
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("periode",
                    "BULAN " + BlnCari.getSelectedItem() + " TAHUN " + ThnCari.
                    getSelectedItem());
            ...
            for (int r = 0; r < tabMode.getRowCount(); r++) {
                Sequel.menyimpan("temporary", "'" + r + "','"
                        ...
                        getalamatip() + "'", "Daftar Pasien"
                );
            }

            Valid.MyReportqry("rptDaftarPasienRanapTNI.jasper", "report",
                    "::[ Laporan Daftar Nama Pasien Ranap TNI ]::",
    ...
    private static final Logger LOG = Logger.getLogger(DlgDaftarPasienRanapTNI.class.getName());
