        ...
        try {
            ...
            try (BufferedWriter bw = new BufferedWriter(new FileWriter(f))) {
                bw.write(LoadHTML.getText().replaceAll("<head>",
                        ...
                        getemailrs() + "<br><br>"
                        + "<font size='2' face='Tahoma'>KARTU INDEKS PENYAKIT PASIEN RAWAT JALAN PERIODE " + Tgl1.
...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKIPPasienRalan dialog = new DlgKIPPasienRalan(
        ...
        try {
            ...
            try {
                ...
                while (rs2.next()) {
                    ...
                    i++;
                    htmlContent.append(
                            "<td valign='middle' bgcolor='#FFFAFA' align='center'>").
                            append(rs2.getString("png_jawab")).append("</td>");
                }
            } catch (Exception e) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    diagnosa = "";
                    ps2 = koneksi.prepareStatement(
                            "select diagnosa_pasien.kd_penyakit from diagnosa_pasien where diagnosa_pasien.status='Ralan' and diagnosa_pasien.prioritas>1 and diagnosa_pasien.no_rawat=?");
                    try {
            ...
            if ((i - 1) > 0) {
                htmlContent.append(
                        "<tr class='isi'><td valign='middle' align='right' colspan='5'>Total : </td><td valign='middle' align='center'>").
                        ...
                        "</td><td valign='middle' align='center'>").
                        append(rujuk).append(
                        "</td><td valign='middle' align='center'>").append(kbl).
                        append("</td><td valign='middle' align='center'>").
                        append(kbp).append(
                        "</td><td valign='middle' align='center'>").append(kll).
                        append("</td><td valign='middle' align='center'>").
                        append(klp).append("</td>");
                for (z = 0; z < kolom; z++) {
                    htmlContent.append("<td valign='middle' align='center'>").
                            append(jumlahcarabayar[z]).append("</td>");
                }
                htmlContent.append(
                        "</tr>"
                );
    ...
    private static final Logger LOG = Logger.getLogger(DlgKIPPasienRalan.class.
            getName());
