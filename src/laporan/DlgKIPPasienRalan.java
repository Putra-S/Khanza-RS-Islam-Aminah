...
public class DlgKIPPasienRalan extends javax.swing.JDialog {
    ...
    private int hr0s6l = 0, hr0s6p = 0, hr7s28l = 0, hr7s28p = 0, hr28s1thl = 0, hr28s1thp = 0, th1s4l = 0, th1s4p = 0,
            ...
            th45s64p = 0, lbth65l = 0, lbth65p = 0, kolom = 0, pulang = 0, rawat = 0, rujuk = 0, kbl = 0, kbp = 0,
            kll = 0, klp = 0;
    ...
    private String sthr0s6l = "", sthr0s6p = "", sthr7s28l = "", sthr7s28p = "", sthr28s1thl = "", sthr28s1thp = "",
            ...
            diagnosa = "", stpulang = "", strawat = "", strujuk = "", stkbl = "", stkbp = "", stkll = "", stklp = "";
...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
        ...
        try {
            ...
            try {
                ...
                while (rs2.next()) {
                    ...
                    jumlahcarabayar[i] = 0;
                    i++;
                    htmlContent.append("<td valign='middle' bgcolor='#FFFAFA' align='center'>")
                            .append(rs2.getString("png_jawab"))
                            .append("</td>");
                }
            } catch (Exception e) {
            ...
            if ((i - 1) > 0) {
                ...
                for (z = 0; z < kolom; z++) {
                    htmlContent.append("<td valign='middle' align='center'>")
                            .append(jumlahcarabayar[z])
                            .append("</td>");
                }
                htmlContent.append("</tr>");
            }

            LoadHTML.setText("<html>" + "<table width='" + (1750 + (70 * kolom))
    ...
    private static final Logger LOG = Logger.getLogger(DlgKIPPasienRalan.class.getName());
