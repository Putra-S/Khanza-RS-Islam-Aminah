...
public class LaporanRekapSkriningPernapasanRalanPerTahun extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public LaporanRekapSkriningPernapasanRalanPerTahun(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
            ...
            try {
                ...
                while (rs.next()) {
                    jan = Sequel.cariInteger(
                            ...
                            rs.getString("pernapasan"), "%" + ThnCari.
                            getSelectedItem() + "-01%");
                    ...
                    tabMode.addRow(new String[]{
                        i + "", rs.getString("pernapasan"), jan + "", feb + "",
                        mar + "", apr + "", mei + "",
                        jun + "", jul + "", agu + "", sep + "", okt + "",
                ...
                if (i > 1) {
                    tabMode.addRow(new String[]{
                        "", "Jumlah :", ttljan + "", ttlfeb + "", ttlmar + "",
                        ttlapr + "", ttlmei + "",
                        ttljun + "", ttljul + "", ttlagu + "", ttlsep + "",
    ...
    private static final Logger LOG = Logger.getLogger(
            LaporanRekapSkriningPernapasanRalanPerTahun.class.getName());
