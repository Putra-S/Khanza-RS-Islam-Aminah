 ...
 * @author perpustakaan
 */
public class LaporanRekapSkriningPernapasanRalanPerTahun extends javax.swing.JDialog {
    ...
    public LaporanRekapSkriningPernapasanRalanPerTahun(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.", "Skrining Pernapasan Rawat Jalan", "Jan", "Feb",
            "Mar", "Apr", "Mei", "Jun", "Jul", "Agu", "Sep", "Okt", "Nov", "Des", "Total"}) {
            @Override
            ...
            for (int r = 0; r < tabMode.getRowCount(); r++) {
                if (!tbBangsal.getValueAt(r, 0).toString().contains(">>")) {
                    Sequel.menyimpan("temporary", "'" + r + "','"
                            ...
                            getalamatip() + "'",
                            "Skrining Pernapasan Rawat Jalan");
                }
            }

            Valid.MyReportqry("rptRekapSkriningPernapasanRalanPerTahun.jasper",
                    "report",
                    "::[ Laporan Rekap Skrining Pernapasan Rawat Jalan K3 Per Tahun ]::",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            LaporanRekapSkriningPernapasanRalanPerTahun dialog = new LaporanRekapSkriningPernapasanRalanPerTahun(
            ...
            try {
                ...
                while (rs.next()) {
                    jan = Sequel.cariInteger(
                            "select count(pernapasan) from skrining_rawat_jalan where pernapasan=? and tanggal like ?",
                            rs.getString("pernapasan"), "%" + ThnCari.getSelectedItem() + "-01%");
                    feb = Sequel.cariInteger(
                            "select count(pernapasan) from skrining_rawat_jalan where pernapasan=? and tanggal like ?",
                            rs.getString("pernapasan"), "%" + ThnCari.getSelectedItem() + "-02%");
                    mar = Sequel.cariInteger(
                            "select count(pernapasan) from skrining_rawat_jalan where pernapasan=? and tanggal like ?",
                            rs.getString("pernapasan"), "%" + ThnCari.getSelectedItem() + "-03%");
                    apr = Sequel.cariInteger(
                            "select count(pernapasan) from skrining_rawat_jalan where pernapasan=? and tanggal like ?",
                            rs.getString("pernapasan"), "%" + ThnCari.getSelectedItem() + "-04%");
                    mei = Sequel.cariInteger(
                            "select count(pernapasan) from skrining_rawat_jalan where pernapasan=? and tanggal like ?",
                            rs.getString("pernapasan"), "%" + ThnCari.getSelectedItem() + "-05%");
                    jun = Sequel.cariInteger(
                            "select count(pernapasan) from skrining_rawat_jalan where pernapasan=? and tanggal like ?",
                            rs.getString("pernapasan"), "%" + ThnCari.getSelectedItem() + "-06%");
                    jul = Sequel.cariInteger(
                            "select count(pernapasan) from skrining_rawat_jalan where pernapasan=? and tanggal like ?",
                            rs.getString("pernapasan"), "%" + ThnCari.getSelectedItem() + "-07%");
                    agu = Sequel.cariInteger(
                            "select count(pernapasan) from skrining_rawat_jalan where pernapasan=? and tanggal like ?",
                            rs.getString("pernapasan"), "%" + ThnCari.getSelectedItem() + "-08%");
                    sep = Sequel.cariInteger(
                            "select count(pernapasan) from skrining_rawat_jalan where pernapasan=? and tanggal like ?",
                            rs.getString("pernapasan"), "%" + ThnCari.getSelectedItem() + "-09%");
                    okt = Sequel.cariInteger(
                            "select count(pernapasan) from skrining_rawat_jalan where pernapasan=? and tanggal like ?",
                            rs.getString("pernapasan"), "%" + ThnCari.getSelectedItem() + "-10%");
                    nov = Sequel.cariInteger(
                            "select count(pernapasan) from skrining_rawat_jalan where pernapasan=? and tanggal like ?",
                            rs.getString("pernapasan"), "%" + ThnCari.getSelectedItem() + "-11%");
                    des = Sequel.cariInteger(
                            "select count(pernapasan) from skrining_rawat_jalan where pernapasan=? and tanggal like ?",
                            rs.getString("pernapasan"), "%" + ThnCari.getSelectedItem() + "-12%");
                    ttljan += jan;
                    ttlfeb += feb;
                    ttlmar += mar;
                    ttlapr += apr;
                    ...
                    ttlnov += nov;
                    ttldes += des;
                    tabMode.addRow(new String[]{i + "", rs.getString("pernapasan"), jan + "", feb + "", mar + "",
    ...
    private static final Logger LOG = Logger.getLogger(LaporanRekapSkriningPernapasanRalanPerTahun.class.getName());
