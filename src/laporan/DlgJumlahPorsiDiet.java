...
public class DlgJumlahPorsiDiet extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJumlahPorsiDiet dialog = new DlgJumlahPorsiDiet(
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    if ((!rs.getString("nm_bangsal").toLowerCase().contains(
                        ...
                        h1 = Sequel.cariInteger(
                                ...
                                getSelectedItem() + "-01", rs.getString(
                                        "kd_bangsal"));
                        h2 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-02", rs.getString(
                                        "kd_bangsal"));
                        h3 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-03", rs.getString(
                                        "kd_bangsal"));
                        h4 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-04", rs.getString(
                                        "kd_bangsal"));
                        h5 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-05", rs.getString(
                                        "kd_bangsal"));
                        h6 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-06", rs.getString(
                                        "kd_bangsal"));
                        h7 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-07", rs.getString(
                                        "kd_bangsal"));
                        h8 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-08", rs.getString(
                                        "kd_bangsal"));
                        h9 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-09", rs.getString(
                                        "kd_bangsal"));
                        h10 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-10", rs.getString(
                                        "kd_bangsal"));
                        h11 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-11", rs.getString(
                                        "kd_bangsal"));
                        h12 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-12", rs.getString(
                                        "kd_bangsal"));
                        h13 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-13", rs.getString(
                                        "kd_bangsal"));
                        h14 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-14", rs.getString(
                                        "kd_bangsal"));
                        h15 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-15", rs.getString(
                                        "kd_bangsal"));
                        h16 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-16", rs.getString(
                                        "kd_bangsal"));
                        h17 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-17", rs.getString(
                                        "kd_bangsal"));
                        h18 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-18", rs.getString(
                                        "kd_bangsal"));
                        h19 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-19", rs.getString(
                                        "kd_bangsal"));
                        h20 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-20", rs.getString(
                                        "kd_bangsal"));
                        h21 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-21", rs.getString(
                                        "kd_bangsal"));
                        h22 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-22", rs.getString(
                                        "kd_bangsal"));
                        h23 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-23", rs.getString(
                                        "kd_bangsal"));
                        h24 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-24", rs.getString(
                                        "kd_bangsal"));
                        h25 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-25", rs.getString(
                                        "kd_bangsal"));
                        h26 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-26", rs.getString(
                                        "kd_bangsal"));
                        h27 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-27", rs.getString(
                                        "kd_bangsal"));
                        h28 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-28", rs.getString(
                                        "kd_bangsal"));
                        h29 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-29", rs.getString(
                                        "kd_bangsal"));
                        h30 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-30", rs.getString(
                                        "kd_bangsal"));
                        h31 = Sequel.cariInteger(
                                "select count(detail_beri_diet.kd_kamar) from detail_beri_diet inner join kamar inner join bangsal on detail_beri_diet.kd_kamar=kamar.kd_kamar and bangsal.kd_bangsal=kamar.kd_bangsal where detail_beri_diet.tanggal=? and bangsal.kd_bangsal=?",
                                ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-31", rs.getString(
                                        "kd_bangsal"));
                        jmlh1 += h1;
                        jmlh2 += h2;
                        jmlh3 += h3;
                        ...
                        tabMode.addRow(new String[]{
                            i + "", rs.getString("nm_bangsal"), h1 + "", h2 + "",
                            h3 + "", h4 + "", h5 + "", h6 + "", h7 + "", h8 + "",
                            h9 + "", h10 + "",
                            h11 + "", h12 + "", h13 + "", h14 + "", h15 + "",
                            h16 + "", h17 + "", h18 + "", h19 + "", h20 + "",
                ...
                if (i > 1) {
                    tabMode.addRow(new String[]{
                        "", "Total : ", jmlh1 + "", jmlh2 + "", jmlh3 + "",
                        jmlh4 + "", jmlh5 + "", jmlh6 + "", jmlh7 + "",
                        jmlh8 + "", jmlh9 + "", jmlh10 + "",
                        jmlh11 + "", jmlh12 + "", jmlh13 + "", jmlh14 + "",
                        jmlh15 + "", jmlh16 + "", jmlh17 + "", jmlh18 + "",
                        jmlh19 + "", jmlh20 + "",
                        jmlh21 + "", jmlh22 + "", jmlh23 + "", jmlh24 + "",
                        jmlh25 + "", jmlh26 + "", jmlh27 + "", jmlh28 + "",
                        jmlh29 + "", jmlh30 + "", jmlh31 + "",
    ...
    String konversi(int year, int month, int day) {
        ...
        try {
            ...
            Logger.getLogger(DlgJumlahPorsiDiet.class.getName()).log(
    ...
    private static final Logger LOG = Logger.getLogger(DlgJumlahPorsiDiet.class.
            getName());
