 ...
 * @author perpustakaan
 */
public class DlgRanapPerRuang extends javax.swing.JDialog {
                ...
                for (int r = 0; r < tabMode.getRowCount(); r++) {
                    if (!tbBangsal.getValueAt(r, 0).toString().contains(">>")) {
                        Sequel.menyimpan("temporary", "'" + r + "','"
                                ...
                                + tabMode.getValueAt(r, 3).toString() + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
                                getalamatip() + "'", "Transaksi");
                    }
                }

                Valid.MyReportqry("rptRanapPerRuang.jasper", "report",
                        "::[ Laporan Rawat Inap Per Ruang ]::",
                ...
                for (int r = 0; r < tabMode2.getRowCount(); r++) {
                    if (!tbBangsal.getValueAt(r, 0).toString().contains(">>")) {
                        Sequel.menyimpan("temporary", "'" + r + "','"
                                ...
                                + tabMode2.getValueAt(r, 3).toString() + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
                                getalamatip() + "'", "Transaksi");
                    }
                }
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select * from bangsal where bangsal.status='1' and bangsal.kd_bangsal like ? "
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (jmlpasien > 0) {
                        tabMode.addRow(new Object[]{i, rs.getString(2), jmlpasien, jmlhari});
                        i++;
                    }
                }
                if (ttljmlhari > 0) {
                    tabMode.addRow(new Object[]{"", "Jumlah", ttljmlpasien, ttljmlhari});
                    i++;
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (jmlpasien > 0) {
                        tabMode2.addRow(new Object[]{i, rs.getString(2), jmlpasien, jmlhari});
                        i++;
                    }
                }
                if (ttljmlhari > 0) {
                    tabMode2.addRow(new Object[]{"", "Jumlah", ttljmlpasien, ttljmlhari});
                    i++;
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
    ...
    private static final Logger LOG = Logger.getLogger(DlgRanapPerRuang.class.getName());
