...
public class DlgFrekuensiPenyakitRanap extends javax.swing.JDialog {
    ...
    public DlgFrekuensiPenyakitRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Kode", "Nama Penyakit", "Diagnosa Lain", "Lk2(Hidup)",
        ...
        tabMode2 = new DefaultTableModel(null, new Object[]{"Kode", "Nama Penyakit", "Diagnosa Lain", "Lk2(Hidup)",
            "Pr(Hidup)", "Lk2(Mati)", "Pr(Mati)", "Jumlah"}) {
            Class[] types = new Class[]{java.lang.Object.class, java.lang.Object.class, java.lang.Object.class,
                java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class,
                java.lang.Integer.class};
...
//GEN-FIRST:event_TKdKeyPressed
            ...
            if (tbDokter.getRowCount() == 0) {
                ...
                for (int r = 0; r < row; r++) {
                    Sequel.menyimpan("temporary", "'" + r + "','"
                            ...
                            + tbDokter.getValueAt(r, 7).toString() + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
                            getalamatip() + "'", "Rekap Frekuensi Penyakit");
                }
                Valid.panggilUrl(
                        "billing/LaporanPenyakitRanap.php?tanggal1=" + Valid.
                                SetTgl(Tgl1.getSelectedItem() + "") + "&tanggal2=" + Valid.
                        SetTgl(Tgl2.getSelectedItem() + "") + "&alamatip=" + akses.
                        getalamatip() + "&usere=" + koneksiDB.USERHYBRIDWEB() + "&passwordte=" + koneksiDB.
                        PASHYBRIDWEB());
            }
        } else if (TabRawat.getSelectedIndex() == 1) {
            if (tbDokter2.getRowCount() == 0) {
                ...
                for (int r = 0; r < row; r++) {
                    Sequel.menyimpan("temporary", "'" + r + "','"
                            ...
                            + tbDokter2.getValueAt(r, 7).toString() + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
                            getalamatip() + "'", "Rekap Frekuensi Penyakit");
                }
                Valid.panggilUrl(
                        "billing/LaporanPenyakitRanap.php?tanggal1=" + Valid.
    ...
    private void ppGrafikTerbanyakBatangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppGrafikTerbanyakBatangActionPerformed
        if (TabRawat.getSelectedIndex() == 0) {
            if ((tbDokter.getRowCount() > 9) && (Integer.parseInt(tbDokter.
                    getValueAt(0, 7).toString()) >= Integer.parseInt(tbDokter.
                    getValueAt(1, 7).toString()))
                    && (Integer.parseInt(tbDokter.getValueAt(1, 7).toString()) >= Integer.
                    parseInt(tbDokter.getValueAt(2, 7).toString()))
                    && (Integer.parseInt(tbDokter.getValueAt(2, 7).toString()) >= Integer.
                    parseInt(tbDokter.getValueAt(3, 7).toString()))
                    && (Integer.parseInt(tbDokter.getValueAt(3, 7).toString()) >= Integer.
                    parseInt(tbDokter.getValueAt(4, 7).toString()))
                    && (Integer.parseInt(tbDokter.getValueAt(4, 7).toString()) >= Integer.
                    parseInt(tbDokter.getValueAt(5, 7).toString()))
                    && (Integer.parseInt(tbDokter.getValueAt(5, 7).toString()) >= Integer.
                    parseInt(tbDokter.getValueAt(6, 7).toString()))
                    && (Integer.parseInt(tbDokter.getValueAt(6, 7).toString()) >= Integer.
                    parseInt(tbDokter.getValueAt(7, 7).toString()))
                    && (Integer.parseInt(tbDokter.getValueAt(7, 7).toString()) >= Integer.
                    parseInt(tbDokter.getValueAt(8, 7).toString()))
                    && (Integer.parseInt(tbDokter.getValueAt(8, 7).toString()) >= Integer.
                    parseInt(tbDokter.getValueAt(9, 7).toString()))) {
                DefaultCategoryDataset dcd = new DefaultCategoryDataset();
                dcd.setValue(Integer.parseInt(tbDokter.getValueAt(0, 7).
                        toString()),
                        tbDokter.getValueAt(0, 0).toString() + ", " + tbDokter.
                        getValueAt(0, 1).toString() + ", " + tbDokter.
                        getValueAt(0, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter.getValueAt(1, 7).
                        toString()),
                        tbDokter.getValueAt(1, 0).toString() + ", " + tbDokter.
                        getValueAt(1, 1).toString() + ", " + tbDokter.
                        getValueAt(1, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter.getValueAt(2, 7).
                        toString()),
                        tbDokter.getValueAt(2, 0).toString() + ", " + tbDokter.
                        getValueAt(2, 1).toString() + ", " + tbDokter.
                        getValueAt(2, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter.getValueAt(3, 7).
                        toString()),
                        tbDokter.getValueAt(3, 0).toString() + ", " + tbDokter.
                        getValueAt(3, 1).toString() + ", " + tbDokter.
                        getValueAt(3, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter.getValueAt(4, 7).
                        toString()),
                        tbDokter.getValueAt(4, 0).toString() + ", " + tbDokter.
                        getValueAt(4, 1).toString() + ", " + tbDokter.
                        getValueAt(4, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter.getValueAt(5, 7).
                        toString()),
                        tbDokter.getValueAt(5, 0).toString() + ", " + tbDokter.
                        getValueAt(5, 1).toString() + ", " + tbDokter.
                        getValueAt(5, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter.getValueAt(6, 7).
                        toString()),
                        tbDokter.getValueAt(6, 0).toString() + ", " + tbDokter.
                        getValueAt(6, 1).toString() + ", " + tbDokter.
                        getValueAt(6, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter.getValueAt(7, 7).
                        toString()),
                        tbDokter.getValueAt(7, 0).toString() + ", " + tbDokter.
                        getValueAt(7, 1).toString() + ", " + tbDokter.
                        getValueAt(7, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter.getValueAt(8, 7).
                        toString()),
                        tbDokter.getValueAt(8, 0).toString() + ", " + tbDokter.
                        getValueAt(8, 1).toString() + ", " + tbDokter.
                        getValueAt(8, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter.getValueAt(9, 7).
                        toString()),
                        tbDokter.getValueAt(9, 0).toString() + ", " + tbDokter.
                        getValueAt(9, 1).toString() + ", " + tbDokter.
                        getValueAt(9, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));

                JFreeChart freeChart = ChartFactory.createBarChart(
                        "10 Besar Penyakit Di Rawat Inap", "Periode",
                        "Jumlah Penyakit", dcd, PlotOrientation.VERTICAL, true,
                        true, true); //String arg0,String arg1,String arg2,Category Datasheet,Plot Orientation,boolean arg4,boolean arg5,boolean arg6
                ChartFrame cf = new ChartFrame(
                        "Grafik 10 Besar Penyakit Di Rawat Inap", freeChart);

                cf.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                        getHeight() - 20);
            ...
            } else if ((tbDokter.getRowCount() > 8) && (Integer.parseInt(
                    tbDokter.getValueAt(0, 7).toString()) >= Integer.parseInt(
                    tbDokter.getValueAt(1, 7).toString()))
                    && (Integer.parseInt(tbDokter.getValueAt(1, 7).toString()) >= Integer.
                    parseInt(tbDokter.getValueAt(2, 7).toString()))
                    && (Integer.parseInt(tbDokter.getValueAt(2, 7).toString()) >= Integer.
                    parseInt(tbDokter.getValueAt(3, 7).toString()))
            ...
            } else if ((tbDokter.getRowCount() > 7) && (Integer.parseInt(
                    tbDokter.getValueAt(0, 7).toString()) >= Integer.parseInt(
                    tbDokter.getValueAt(1, 7).toString()))
                    && (Integer.parseInt(tbDokter.getValueAt(1, 7).toString()) >= Integer.
                    parseInt(tbDokter.getValueAt(2, 7).toString()))
            ...
            } else if ((tbDokter.getRowCount() > 6) && (Integer.parseInt(
                    tbDokter.getValueAt(0, 7).toString()) >= Integer.parseInt(
                    tbDokter.getValueAt(1, 7).toString()))
                    && (Integer.parseInt(tbDokter.getValueAt(1, 7).toString()) >= Integer.
                    parseInt(tbDokter.getValueAt(2, 7).toString()))
            ...
            } else if ((tbDokter.getRowCount() > 5) && (Integer.parseInt(
                    tbDokter.getValueAt(0, 7).toString()) >= Integer.parseInt(
                    tbDokter.getValueAt(1, 7).toString()))
                    && (Integer.parseInt(tbDokter.getValueAt(1, 7).toString()) >= Integer.
                    parseInt(tbDokter.getValueAt(2, 7).toString()))
            ...
            } else if ((tbDokter.getRowCount() > 4) && (Integer.parseInt(
                    tbDokter.getValueAt(0, 7).toString()) >= Integer.parseInt(
                    tbDokter.getValueAt(1, 7).toString()))
                    && (Integer.parseInt(tbDokter.getValueAt(1, 7).toString()) >= Integer.
                    parseInt(tbDokter.getValueAt(2, 7).toString()))
            ...
            } else if ((tbDokter.getRowCount() > 3) && (Integer.parseInt(
                    tbDokter.getValueAt(0, 7).toString()) >= Integer.parseInt(
                    tbDokter.getValueAt(1, 7).toString()))
                    && (Integer.parseInt(tbDokter.getValueAt(1, 7).toString()) >= Integer.
                    parseInt(tbDokter.getValueAt(2, 7).toString()))
            ...
            } else if ((tbDokter.getRowCount() > 2) && (Integer.parseInt(
                    tbDokter.getValueAt(0, 7).toString()) >= Integer.parseInt(
                    tbDokter.getValueAt(1, 7).toString()))
                    && (Integer.parseInt(tbDokter.getValueAt(1, 7).toString()) >= Integer.
                    parseInt(tbDokter.getValueAt(2, 7).toString()))) {
            ...
            } else if ((tbDokter.getRowCount() > 1) && (Integer.parseInt(
                    tbDokter.getValueAt(0, 7).toString()) >= Integer.parseInt(
                    tbDokter.getValueAt(1, 7).toString()))) {
                DefaultCategoryDataset dcd = new DefaultCategoryDataset();
                dcd.setValue(Integer.parseInt(tbDokter.getValueAt(0, 7).
                ...
                JOptionPane.showMessageDialog(null,
                        "Maaf, Silahkan urutkan secara Descanding/Besar Ke Kecil dengan menklik pada kolom jumlah..!!!!");
            }
        } else if (TabRawat.getSelectedIndex() == 1) {
            if ((tbDokter2.getRowCount() > 9) && (Integer.parseInt(tbDokter2.
                    getValueAt(0, 7).toString()) >= Integer.parseInt(tbDokter2.
                    getValueAt(1, 7).toString()))
                    && (Integer.parseInt(tbDokter2.getValueAt(1, 7).toString()) >= Integer.
                    parseInt(tbDokter2.getValueAt(2, 7).toString()))
                    && (Integer.parseInt(tbDokter2.getValueAt(2, 7).toString()) >= Integer.
                    parseInt(tbDokter2.getValueAt(3, 7).toString()))
                    && (Integer.parseInt(tbDokter2.getValueAt(3, 7).toString()) >= Integer.
                    parseInt(tbDokter2.getValueAt(4, 7).toString()))
                    && (Integer.parseInt(tbDokter2.getValueAt(4, 7).toString()) >= Integer.
                    parseInt(tbDokter2.getValueAt(5, 7).toString()))
                    && (Integer.parseInt(tbDokter2.getValueAt(5, 7).toString()) >= Integer.
                    parseInt(tbDokter2.getValueAt(6, 7).toString()))
                    && (Integer.parseInt(tbDokter2.getValueAt(6, 7).toString()) >= Integer.
                    parseInt(tbDokter2.getValueAt(7, 7).toString()))
                    && (Integer.parseInt(tbDokter2.getValueAt(7, 7).toString()) >= Integer.
                    parseInt(tbDokter2.getValueAt(8, 7).toString()))
                    && (Integer.parseInt(tbDokter2.getValueAt(8, 7).toString()) >= Integer.
                    parseInt(tbDokter2.getValueAt(9, 7).toString()))) {
                DefaultCategoryDataset dcd = new DefaultCategoryDataset();
                dcd.setValue(Integer.parseInt(tbDokter2.getValueAt(0, 7).
                        toString()),
                        tbDokter2.getValueAt(0, 0).toString() + ", " + tbDokter2.
                        getValueAt(0, 1).toString() + ", " + tbDokter2.
                        getValueAt(0, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter2.getValueAt(1, 7).
                        toString()),
                        tbDokter2.getValueAt(1, 0).toString() + ", " + tbDokter2.
                        getValueAt(1, 1).toString() + ", " + tbDokter2.
                        getValueAt(1, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter2.getValueAt(2, 7).
                        toString()),
                        tbDokter2.getValueAt(2, 0).toString() + ", " + tbDokter2.
                        getValueAt(2, 1).toString() + ", " + tbDokter2.
                        getValueAt(2, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter2.getValueAt(3, 7).
                        toString()),
                        tbDokter2.getValueAt(3, 0).toString() + ", " + tbDokter2.
                        getValueAt(3, 1).toString() + ", " + tbDokter2.
                        getValueAt(3, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter2.getValueAt(4, 7).
                        toString()),
                        tbDokter2.getValueAt(4, 0).toString() + ", " + tbDokter2.
                        getValueAt(4, 1).toString() + ", " + tbDokter2.
                        getValueAt(4, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter2.getValueAt(5, 7).
                        toString()),
                        tbDokter2.getValueAt(5, 0).toString() + ", " + tbDokter2.
                        getValueAt(5, 1).toString() + ", " + tbDokter2.
                        getValueAt(5, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter2.getValueAt(6, 7).
                        toString()),
                        tbDokter2.getValueAt(6, 0).toString() + ", " + tbDokter2.
                        getValueAt(6, 1).toString() + ", " + tbDokter2.
                        getValueAt(6, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter2.getValueAt(7, 7).
                        toString()),
                        tbDokter2.getValueAt(7, 0).toString() + ", " + tbDokter2.
                        getValueAt(7, 1).toString() + ", " + tbDokter2.
                        getValueAt(7, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter2.getValueAt(8, 7).
                        toString()),
                        tbDokter2.getValueAt(8, 0).toString() + ", " + tbDokter2.
                        getValueAt(8, 1).toString() + ", " + tbDokter2.
                        getValueAt(8, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                dcd.setValue(Integer.parseInt(tbDokter2.getValueAt(9, 7).
                        toString()),
                        tbDokter2.getValueAt(9, 0).toString() + ", " + tbDokter2.
                        getValueAt(9, 1).toString() + ", " + tbDokter2.
                        getValueAt(9, 7).toString(), Valid.SetTgl(Tgl1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
            ...
            } else if ((tbDokter2.getRowCount() > 8) && (Integer.parseInt(
                    tbDokter2.getValueAt(0, 7).toString()) >= Integer.parseInt(
                    tbDokter2.getValueAt(1, 7).toString()))
                    && (Integer.parseInt(tbDokter2.getValueAt(1, 7).toString()) >= Integer.
                    parseInt(tbDokter2.getValueAt(2, 7).toString()))
                    && (Integer.parseInt(tbDokter2.getValueAt(2, 7).toString()) >= Integer.
                    parseInt(tbDokter2.getValueAt(3, 7).toString()))
            ...
            } else if ((tbDokter2.getRowCount() > 7) && (Integer.parseInt(
                    tbDokter2.getValueAt(0, 7).toString()) >= Integer.parseInt(
                    tbDokter2.getValueAt(1, 7).toString()))
                    && (Integer.parseInt(tbDokter2.getValueAt(1, 7).toString()) >= Integer.
                    parseInt(tbDokter2.getValueAt(2, 7).toString()))
            ...
            } else if ((tbDokter2.getRowCount() > 6) && (Integer.parseInt(
                    tbDokter2.getValueAt(0, 7).toString()) >= Integer.parseInt(
                    tbDokter2.getValueAt(1, 7).toString()))
                    && (Integer.parseInt(tbDokter2.getValueAt(1, 7).toString()) >= Integer.
                    parseInt(tbDokter2.getValueAt(2, 7).toString()))
            ...
            } else if ((tbDokter2.getRowCount() > 5) && (Integer.parseInt(
                    tbDokter2.getValueAt(0, 7).toString()) >= Integer.parseInt(
                    tbDokter2.getValueAt(1, 7).toString()))
                    && (Integer.parseInt(tbDokter2.getValueAt(1, 7).toString()) >= Integer.
                    parseInt(tbDokter2.getValueAt(2, 7).toString()))
            ...
            } else if ((tbDokter2.getRowCount() > 4) && (Integer.parseInt(
                    tbDokter2.getValueAt(0, 7).toString()) >= Integer.parseInt(
                    tbDokter2.getValueAt(1, 7).toString()))
                    && (Integer.parseInt(tbDokter2.getValueAt(1, 7).toString()) >= Integer.
                    parseInt(tbDokter2.getValueAt(2, 7).toString()))
            ...
            } else if ((tbDokter2.getRowCount() > 3) && (Integer.parseInt(
                    tbDokter2.getValueAt(0, 7).toString()) >= Integer.parseInt(
                    tbDokter2.getValueAt(1, 7).toString()))
                    && (Integer.parseInt(tbDokter2.getValueAt(1, 7).toString()) >= Integer.
                    parseInt(tbDokter2.getValueAt(2, 7).toString()))
            ...
            } else if ((tbDokter2.getRowCount() > 2) && (Integer.parseInt(
                    tbDokter2.getValueAt(0, 7).toString()) >= Integer.parseInt(
                    tbDokter2.getValueAt(1, 7).toString()))
                    && (Integer.parseInt(tbDokter2.getValueAt(1, 7).toString()) >= Integer.
                    parseInt(tbDokter2.getValueAt(2, 7).toString()))) {
            ...
            } else if ((tbDokter2.getRowCount() > 1) && (Integer.parseInt(
                    tbDokter2.getValueAt(0, 7).toString()) >= Integer.parseInt(
                    tbDokter2.getValueAt(1, 7).toString()))) {
                DefaultCategoryDataset dcd = new DefaultCategoryDataset();
                dcd.setValue(Integer.parseInt(tbDokter2.getValueAt(0, 7).
        ...
        if (TabRawat.getSelectedIndex() == 0) {
            if ((tbDokter.getRowCount() > 9) && (Integer.parseInt(tbDokter.
                ...
                dpd.setValue(
                        ...
                        getValueAt(0, 1).toString() + ", " + tbDokter.
                        getValueAt(0, 7).toString(), Integer.parseInt(tbDokter.
                        getValueAt(0, 7).toString()));
                dpd.setValue(
                        tbDokter.getValueAt(1, 0).toString() + ", " + tbDokter.
                        getValueAt(1, 1).toString() + ", " + tbDokter.
                        getValueAt(1, 7).toString(), Integer.parseInt(tbDokter.
                        getValueAt(1, 7).toString()));
                dpd.setValue(
                        tbDokter.getValueAt(2, 0).toString() + ", " + tbDokter.
                        getValueAt(2, 1).toString() + ", " + tbDokter.
                        getValueAt(2, 7).toString(), Integer.parseInt(tbDokter.
                        getValueAt(2, 7).toString()));
                dpd.setValue(
                        tbDokter.getValueAt(3, 0).toString() + ", " + tbDokter.
                        getValueAt(3, 1).toString() + ", " + tbDokter.
                        getValueAt(3, 7).toString(), Integer.parseInt(tbDokter.
                        getValueAt(3, 7).toString()));
                dpd.setValue(
                        tbDokter.getValueAt(4, 0).toString() + ", " + tbDokter.
                        getValueAt(4, 1).toString() + ", " + tbDokter.
                        getValueAt(4, 7).toString(), Integer.parseInt(tbDokter.
                        getValueAt(4, 7).toString()));
                dpd.setValue(
                        tbDokter.getValueAt(5, 0).toString() + ", " + tbDokter.
                        getValueAt(5, 1).toString() + ", " + tbDokter.
                        getValueAt(5, 7).toString(), Integer.parseInt(tbDokter.
                        getValueAt(5, 7).toString()));
                dpd.setValue(
                        tbDokter.getValueAt(6, 0).toString() + ", " + tbDokter.
                        getValueAt(6, 1).toString() + ", " + tbDokter.
                        getValueAt(6, 7).toString(), Integer.parseInt(tbDokter.
                        getValueAt(6, 7).toString()));
                dpd.setValue(
                        tbDokter.getValueAt(7, 0).toString() + ", " + tbDokter.
                        getValueAt(7, 1).toString() + ", " + tbDokter.
                        getValueAt(7, 7).toString(), Integer.parseInt(tbDokter.
                        getValueAt(7, 7).toString()));
                dpd.setValue(
                        tbDokter.getValueAt(8, 0).toString() + ", " + tbDokter.
                        getValueAt(8, 1).toString() + ", " + tbDokter.
                        getValueAt(8, 7).toString(), Integer.parseInt(tbDokter.
                        getValueAt(8, 7).toString()));
                dpd.setValue(
                        tbDokter.getValueAt(9, 0).toString() + ", " + tbDokter.
                        getValueAt(9, 1).toString() + ", " + tbDokter.
                        getValueAt(9, 7).toString(), Integer.parseInt(tbDokter.
                        getValueAt(9, 7).toString()));

                JFreeChart freeChart = ChartFactory.createPieChart(
                        "10 Besar Penyakit Di Rawat Inap Periode " + Valid.
                                SetTgl(Tgl1.getSelectedItem() + "") + " s.d. " + Valid.
                        SetTgl(Tgl2.getSelectedItem() + ""), dpd, true, true,
            ...
            if ((tbDokter2.getRowCount() > 9) && (Integer.parseInt(tbDokter2.
                ...
                dpd.setValue(
                        tbDokter2.getValueAt(1, 0).toString() + ", " + tbDokter2.
                        getValueAt(1, 1).toString() + ", " + tbDokter2.
                        getValueAt(1, 7).toString(), Integer.parseInt(tbDokter2.
                        getValueAt(1, 7).toString()));
                dpd.setValue(
                        tbDokter2.getValueAt(2, 0).toString() + ", " + tbDokter2.
                        getValueAt(2, 1).toString() + ", " + tbDokter2.
                        getValueAt(2, 7).toString(), Integer.parseInt(tbDokter2.
                        getValueAt(2, 7).toString()));
                dpd.setValue(
                        tbDokter2.getValueAt(3, 0).toString() + ", " + tbDokter2.
                        getValueAt(3, 1).toString() + ", " + tbDokter2.
                        getValueAt(3, 7).toString(), Integer.parseInt(tbDokter2.
                        getValueAt(3, 7).toString()));
                dpd.setValue(
                        tbDokter2.getValueAt(4, 0).toString() + ", " + tbDokter2.
                        getValueAt(4, 1).toString() + ", " + tbDokter2.
                        getValueAt(4, 7).toString(), Integer.parseInt(tbDokter2.
                        getValueAt(4, 7).toString()));
                dpd.setValue(
                        tbDokter2.getValueAt(5, 0).toString() + ", " + tbDokter2.
                        getValueAt(5, 1).toString() + ", " + tbDokter2.
                        getValueAt(5, 7).toString(), Integer.parseInt(tbDokter2.
                        getValueAt(5, 7).toString()));
                dpd.setValue(
                        tbDokter2.getValueAt(6, 0).toString() + ", " + tbDokter2.
                        getValueAt(6, 1).toString() + ", " + tbDokter2.
                        getValueAt(6, 7).toString(), Integer.parseInt(tbDokter2.
                        getValueAt(6, 7).toString()));
                dpd.setValue(
                        tbDokter2.getValueAt(7, 0).toString() + ", " + tbDokter2.
                        getValueAt(7, 1).toString() + ", " + tbDokter2.
                        getValueAt(7, 7).toString(), Integer.parseInt(tbDokter2.
                        getValueAt(7, 7).toString()));
                dpd.setValue(
                        tbDokter2.getValueAt(8, 0).toString() + ", " + tbDokter2.
                        getValueAt(8, 1).toString() + ", " + tbDokter2.
                        getValueAt(8, 7).toString(), Integer.parseInt(tbDokter2.
                        getValueAt(8, 7).toString()));
                dpd.setValue(
                        tbDokter2.getValueAt(9, 0).toString() + ", " + tbDokter2.
                        getValueAt(9, 1).toString() + ", " + tbDokter2.
                        getValueAt(9, 7).toString(), Integer.parseInt(tbDokter2.
                        getValueAt(9, 7).toString()));
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "where reg_periksa.status_lanjut='Ranap' and diagnosa_pasien.status='Ranap' and reg_periksa.tgl_registrasi between ? and ? "
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    // + "inner join pasien inner join kamar_inap inner join kamar inner
                    // join bangsal inner join dokter inner join penjab inner join
                    // kabupaten "
                    // + "inner join kecamatan inner join kelurahan on
                    // penyakit.kd_penyakit=diagnosa_pasien.kd_penyakit and
                    // reg_periksa.no_rawat=diagnosa_pasien.no_rawat "
                    // + "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and
                    // reg_periksa.no_rawat=kamar_inap.no_rawat and
                    // reg_periksa.kd_pj=penjab.kd_pj "
                    // + "and pasien.kd_kab=kabupaten.kd_kab and
                    // kamar_inap.kd_kamar=kamar.kd_kamar and
                    // kamar.kd_bangsal=bangsal.kd_bangsal and
                    // reg_periksa.kd_dokter=dokter.kd_dokter "
                    // + "and pasien.kd_kec=kecamatan.kd_kec and
                    // pasien.kd_kel=kelurahan.kd_kel "
                    // + "where reg_periksa.status_lanjut='Ranap' and
                    // diagnosa_pasien.status='Ranap' and reg_periksa.tgl_registrasi
                    // between ? and ? "
                    // + "and bangsal.nm_bangsal like ? and dokter.nm_dokter like ? and
                    // penjab.png_jawab like ? and kabupaten.nm_kab like ? and
                    ...
                    // diagnosa_pasien.prioritas<>'1' and diagnosa_pasien.status='Ranap'
                    ...
                    ps3 = koneksi.prepareStatement(
                            "select diagnosa_pasien.no_rawat as jumlah from penyakit inner join diagnosa_pasien inner join reg_periksa inner join pasien_mati "
                            + "inner join pasien inner join kamar_inap inner join kamar inner join bangsal inner join dokter inner join penjab inner join kabupaten "
                            + "inner join kecamatan inner join kelurahan on penyakit.kd_penyakit=diagnosa_pasien.kd_penyakit and reg_periksa.no_rawat=diagnosa_pasien.no_rawat "
                            + "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.no_rawat=kamar_inap.no_rawat and reg_periksa.kd_pj=penjab.kd_pj "
                            + "and pasien.kd_kab=kabupaten.kd_kab and kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and reg_periksa.kd_dokter=dokter.kd_dokter "
                            + "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel and pasien_mati.no_rkm_medis=pasien.no_rkm_medis "
                            + "where reg_periksa.status_lanjut='Ranap' and diagnosa_pasien.status='Ranap' and pasien.jk='L' and reg_periksa.tgl_registrasi between ? and ? "
                    ...
                    ps4 = koneksi.prepareStatement(
                            ...
                            + "and pasien.kd_kab=kabupaten.kd_kab and kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and reg_periksa.kd_dokter=dokter.kd_dokter "
                            + "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel and pasien_mati.no_rkm_medis=pasien.no_rkm_medis "
                            + "where reg_periksa.status_lanjut='Ranap' and diagnosa_pasien.status='Ranap' and pasien.jk='P' and reg_periksa.tgl_registrasi between ? and ? "
                            + "and bangsal.nm_bangsal like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? "
                            + "and diagnosa_pasien.kd_penyakit=? group by diagnosa_pasien.no_rawat");
                    try {
    ...
    private void tampil2() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "and pasien.kd_kab=kabupaten.kd_kab and kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and reg_periksa.kd_dokter=dokter.kd_dokter "
                    + "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel "
                    + "where kamar_inap.stts_pulang<>'Pindah Kamar' and reg_periksa.status_lanjut='Ranap' and diagnosa_pasien.status='Ranap' and "
            ...
            try {
                ...
                while (rs.next()) {
                    // i = 0;
                    // ps2 = koneksi.prepareStatement(
                    // "select diagnosa_pasien.no_rawat from penyakit inner join
                    // diagnosa_pasien inner join reg_periksa "
                    // + "inner join pasien inner join kamar_inap inner join kamar inner
                    // join bangsal inner join dokter inner join penjab inner join
                    // kabupaten "
                    ...
                    // diagnosa_pasien.status='Ranap' and "
                    // + "kamar_inap.tgl_keluar between ? and ? and bangsal.nm_bangsal
                    // like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and
                    // kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and
                    // kelurahan.nm_kel like ? and diagnosa_pasien.kd_penyakit=? group by
                    ...
                    a = 0;
                    ps3 = koneksi.prepareStatement(
                            "select diagnosa_pasien.no_rawat from penyakit inner join diagnosa_pasien inner join reg_periksa inner join pasien_mati "
                            + "inner join pasien inner join kamar_inap inner join kamar inner join bangsal inner join dokter inner join penjab inner join kabupaten "
                            + "inner join kecamatan inner join kelurahan on penyakit.kd_penyakit=diagnosa_pasien.kd_penyakit and reg_periksa.no_rawat=diagnosa_pasien.no_rawat "
                            + "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.no_rawat=kamar_inap.no_rawat and reg_periksa.kd_pj=penjab.kd_pj "
                            + "and pasien.kd_kab=kabupaten.kd_kab and kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and reg_periksa.kd_dokter=dokter.kd_dokter "
                            + "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel and pasien_mati.no_rkm_medis=pasien.no_rkm_medis "
                            + "where kamar_inap.stts_pulang<>'Pindah Kamar' and reg_periksa.status_lanjut='Ranap' and diagnosa_pasien.status='Ranap' and pasien.jk='L' and "
                    ...
                    ps4 = koneksi.prepareStatement(
                            ...
                            + "and pasien.kd_kab=kabupaten.kd_kab and kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and reg_periksa.kd_dokter=dokter.kd_dokter "
                            + "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel and pasien_mati.no_rkm_medis=pasien.no_rkm_medis "
                            + "where kamar_inap.stts_pulang<>'Pindah Kamar' and reg_periksa.status_lanjut='Ranap' and diagnosa_pasien.status='Ranap' and pasien.jk='P' and "
                            + "kamar_inap.tgl_keluar between ? and ? and bangsal.nm_bangsal like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and diagnosa_pasien.kd_penyakit=? group by diagnosa_pasien.no_rawat");
                    try {
                        ps4.setString(1, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                        ps4.setString(2, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                    ...
                    ps5 = koneksi.prepareStatement(
                            ...
                            + "and pasien.kd_kab=kabupaten.kd_kab and kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and reg_periksa.kd_dokter=dokter.kd_dokter "
                            + "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel "
                            + "where reg_periksa.status_lanjut='Ranap' and diagnosa_pasien.status='Ranap' and pasien.jk='L' and "
                            + "kamar_inap.tgl_keluar between ? and ? and bangsal.nm_bangsal like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and diagnosa_pasien.kd_penyakit=? group by diagnosa_pasien.no_rawat");
                    try {
                        ps5.setString(1, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                        ps5.setString(2, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                    ...
                    ps6 = koneksi.prepareStatement(
                            ...
                            + "and pasien.kd_kab=kabupaten.kd_kab and kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and reg_periksa.kd_dokter=dokter.kd_dokter "
                            + "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel "
                            + "where reg_periksa.status_lanjut='Ranap' and diagnosa_pasien.status='Ranap' and pasien.jk='P' and "
                            + "kamar_inap.tgl_keluar between ? and ? and bangsal.nm_bangsal like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and diagnosa_pasien.kd_penyakit=? group by diagnosa_pasien.no_rawat");
                    try {
                        ps6.setString(1, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                        ps6.setString(2, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                    ...
                    tabMode2.addRow(new Object[]{rs.getString("kd_penyakit"), rs.getString("penyakit"), diagnosa, c,
                        d, a, b, (c + d + a + b)});
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
    ...
    private static final Logger LOG = Logger.getLogger(DlgFrekuensiPenyakitRanap.class.getName());
