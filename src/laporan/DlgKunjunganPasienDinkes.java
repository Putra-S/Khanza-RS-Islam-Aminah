 ...
 * @author perpustakaan
 */
public class DlgKunjunganPasienDinkes extends javax.swing.JDialog {
    ...
    private int i = 0, lama = 0, baru = 0, laki = 0, per = 0, j = 0;

    private String setbaru = "", setlama = "", umurlk = "", umurpr = "", kddiagnosa = "", diagnosa = "",
            dokterdpjp = "", status = "", usia = "", subjek = "", objek = "", plan = "", evaluasi = "";
     ...
     * @param modal
     */
    public DlgKunjunganPasienDinkes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(8, 1);
        setSize(885, 674);
        tabMode = new DefaultTableModel(null,
                new String[]{"No.", "Tgl.Masuk", "Minggu Ke", "Nama Pasien", "Keluarga", "Jenis Kelamin", "No.Hp",
                    "Tanggal Lahir", "Usia", "Usia (Bulan)", "Alamat Domisili", "Kelurahan", "Kecamatan",
                    "Kota/Kab", "ICD 10", "Diagnosa", "Gejala", "Kronologi", "Tindakan Yang Dilakukan", "Spesimen",
                    "Hasil Pemeriksaan", "Tindak Lanjut", "Keterangan"}) {
            @Override
        ...
        // tbBangsal.getColumnModel().getColumn(16).setCellRenderer(new
        // TextAreaRenderer());
        // tbBangsal.getColumnModel().getColumn(17).setCellRenderer(new
        // TextAreaRenderer());
        // tbBangsal.getColumnModel().getColumn(18).setCellRenderer(new
        // TextAreaRenderer());
        // tbBangsal.getColumnModel().getColumn(21).setCellRenderer(new
        // TextAreaRenderer());
        ...
        // tbBangsal2.getColumnModel().getColumn(16).setCellRenderer(new
        // TextAreaRenderer());
        // tbBangsal2.getColumnModel().getColumn(17).setCellRenderer(new
        // TextAreaRenderer());
        // tbBangsal2.getColumnModel().getColumn(18).setCellRenderer(new
        // TextAreaRenderer());
        // tbBangsal2.getColumnModel().getColumn(21).setCellRenderer(new
        // TextAreaRenderer());
        ...
        tabMode3 = new DefaultTableModel(null,
                new String[]{"No.", "Tgl.Registrasi", "Minggu Ke", "Nama Pasien", "Keluarga", "Jenis Kelamin",
                    "No.Hp", "Tanggal Lahir", "Usia", "Usia (Bulan)", "Alamat Domisili", "Kelurahan", "Kecamatan",
                    "Kota/Kab", "ICD 10", "Diagnosa", "Gejala", "Kronologi", "Tindakan Yang Dilakukan", "Spesimen",
                    "Hasil Pemeriksaan", "Tindak Lanjut", "Keterangan"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
        ...
        tbRajal.setModel(tabMode3);
        // tbRajalsetDefaultRenderer(Object.class, new
        // WarnaTable(jPanel2.getBackground(),tbBangsal2.getBackground()));
        tbRajal.setPreferredScrollableViewportSize(new Dimension(500, 500));
        tbRajal.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        // tbRajal.getColumnModel().getColumn(16).setCellRenderer(new TextAreaRenderer());
        // tbRajal.getColumnModel().getColumn(17).setCellRenderer(new TextAreaRenderer());
        // tbRajal.getColumnModel().getColumn(18).setCellRenderer(new TextAreaRenderer());
        // tbRajal.getColumnModel().getColumn(21).setCellRenderer(new TextAreaRenderer());
        ...
        tbRajal2.setModel(tabMode4);
        // tbRajal2.setDefaultRenderer(Object.class, new
        // WarnaTable(jPanel2.getBackground(),tbRajal2.getBackground()));
        tbRajal2.setPreferredScrollableViewportSize(new Dimension(500, 500));
        tbRajal2.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        // tbRajal2.getColumnModel().getColumn(16).setCellRenderer(new
        // TextAreaRenderer());
        // tbRajal2.getColumnModel().getColumn(17).setCellRenderer(new
        // TextAreaRenderer());
        // tbRajal2.getColumnModel().getColumn(18).setCellRenderer(new
        // TextAreaRenderer());
        // tbRajal2.getColumnModel().getColumn(21).setCellRenderer(new
        // TextAreaRenderer());

        for (i = 0; i < 23; i++) {
            TableColumn column = tbRajal2.getColumnModel().getColumn(i);
            if (i == 0) {
                column.setPreferredWidth(35);
            } else if (i == 1) {
                column.setPreferredWidth(70);
        ...
        tbRajal2.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Kunjungan Dinkes ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TabRawat.addTab("Berdasar Tanggal Masuk RI", Scroll);
        ...
        TabRawat.addTab("Berdasar Tanggal Keluar RI", Scroll2);
        ...
        Scroll1.setViewportView(tbRajal);

        TabRawat.addTab("Seluruh Kunjungan RJ", Scroll1);

        Scroll3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        Scroll3.setName("Scroll3"); // NOI18N
        Scroll3.setOpaque(true);

        tbRajal2.setName("tbRajal2"); // NOI18N
        Scroll3.setViewportView(tbRajal2);

        TabRawat.addTab("Kunjungan Non Batal RJ", Scroll3);
        ...
        label24.setText("Unit/Poli :");
        label24.setName("label24"); // NOI18N
        label24.setPreferredSize(new java.awt.Dimension(35, 23));
        FormInput.add(label24);
        label24.setBounds(810, 10, 75, 23);
        ...
        BtnSeek8.setBounds(1210, 10, 28, 23);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        param.put("periode", Tgl1.getSelectedItem() + " s.d. " + Tgl2.
                getSelectedItem());
        param.put("lama", lama);
        param.put("baru", baru);
        ...
        if (TabRawat.getSelectedIndex() == 0) {
            if (tabMode.getRowCount() == 0) {
                    ...
                    if (!tbBangsal.getValueAt(r, 0).toString().contains(">>")) {
                        try {
                            Sequel.menyimpan("temporary", "'" + r + "','"
                                    ...
                                    + tabMode.getValueAt(r, 12).toString() + "','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
                ...
                Valid.MyReportqry("rptKunjunganRanap.jasper", "report",
                    ...
                    if (!tbBangsal2.getValueAt(r, 0).toString().contains(">>")) {
                        try {
                            Sequel.menyimpan("temporary", "'" + r + "','"
                                    ...
                                    + tabMode2.getValueAt(r, 12).toString() + "','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
                                    getalamatip() + "'", "Rekap Nota Pembayaran");
                        } catch (Exception e) {
                        }
                    }
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void BtnExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnExcelActionPerformed
        switch (TabRawat.getSelectedIndex()) {
            case 0:
                ...
                break;
            case 1:
                Valid.exportToExcel(tbBangsal2);
                break;
            case 2:
                Valid.exportToExcel(tbRajal);
                break;
            case 3:
                Valid.exportToExcel(tbRajal2);
                break;
            default:
                break;
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKunjunganPasienDinkes dialog = new DlgKunjunganPasienDinkes(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.alamat,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar,reg_periksa.stts_daftar,reg_periksa.p_jawab,pasien.no_tlp,DATE_FORMAT(pasien.tgl_lahir, '%d-%m-%Y') as tgl_lahir,"
                    + "kamar_inap.kd_kamar,bangsal.nm_bangsal,pasien.alamat as almt_pj,kelurahan.nm_kel,kecamatan.nm_kec,kabupaten.nm_kab,kamar_inap.stts_pulang,DATE_FORMAT(kamar_inap.tgl_masuk, '%d-%m-%Y') as tgl_masuk,kamar_inap.tgl_keluar,dokter.nm_dokter,penjab.png_jawab "
            ...
            try {
                ...
                while (rs.next()) {
                    usia = Sequel.cariIsi(
                            "select pasien.tgl_lahir from pasien inner join reg_periksa on pasien.no_rkm_medis=reg_periksa.no_rkm_medis where reg_periksa.no_rawat='"
                    ...
                    if (dokterdpjp.toLowerCase().contains(nmdokter.getText().toLowerCase())) {
                        ...
                        StringBuilder combinedSubjek = new StringBuilder();
                        StringBuilder combinedObjek = new StringBuilder();
                        StringBuilder combinedPlan = new StringBuilder();
                        StringBuilder combinedEvaluasi = new StringBuilder();
                        ps2 = koneksi.prepareStatement(
                                "select pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat,pemeriksaan_ranap.keluhan,pemeriksaan_ranap.pemeriksaan,pemeriksaan_ranap.rtl,pemeriksaan_ranap.evaluasi from pemeriksaan_ranap "
                                + "where pemeriksaan_ranap.no_rawat=? and pemeriksaan_ranap.nip like 'D000%'");
                        try {
                            ps2.setString(1, rs.getString("no_rawat"));
                            rs2 = ps2.executeQuery();
                            while (rs2.next()) {
                                combinedSubjek.append(rs2.getString("tgl_perawatan"))
                                        .append(" ")
                                        .append(rs2.getString("jam_rawat"))
                                        .append(",")
                                        .append(rs2.getString("keluhan"))
                                        .append(" ");
                                combinedObjek.append(rs2.getString("tgl_perawatan"))
                                        .append(" ")
                                        .append(rs2.getString("jam_rawat"))
                                        .append(",")
                                        .append(rs2.getString("pemeriksaan"))
                                        .append(" ");
                                combinedPlan.append(rs2.getString("tgl_perawatan"))
                                        .append(" ")
                                        .append(rs2.getString("jam_rawat"))
                                        .append(",")
                                        .append(rs2.getString("rtl"))
                                        .append(" ");
                                combinedEvaluasi.append(rs2.getString("tgl_perawatan"))
                                        .append(" ")
                                        .append(rs2.getString("jam_rawat"))
                                        .append(",")
                        ...
                        tabMode.addRow(new Object[]{i, rs.getString("tgl_masuk"), "", rs.getString("nm_pasien"),
                            rs.getString("p_jawab"), rs.getString("jk"), rs.getString("no_tlp"),
                            rs.getString("tgl_lahir"), String.valueOf(p.getYears()), String.valueOf(p.getMonths()),
                            rs.getString("alamat"), rs.getString("nm_kel"), rs.getString("nm_kec"),
                            rs.getString("nm_kab"), kddiagnosa, diagnosa, combinedSubjek.toString().trim(),
                            combinedObjek.toString().trim(), combinedPlan.toString().trim(), "", "",
                            combinedEvaluasi.toString().trim()});
                        i++;
                    }
    ...
    public void tampil2() {
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.alamat,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar,reg_periksa.stts_daftar,reg_periksa.p_jawab,pasien.no_tlp,DATE_FORMAT(pasien.tgl_lahir, '%d-%m-%Y') as tgl_lahir,"
                    + "kamar_inap.kd_kamar,bangsal.nm_bangsal,pasien.alamat as almt_pj,kelurahan.nm_kel,kecamatan.nm_kec,kabupaten.nm_kab,kamar_inap.stts_pulang,kamar_inap.tgl_keluar,kamar_inap.tgl_masuk,dokter.nm_dokter,penjab.png_jawab "
                    + "from reg_periksa inner join pasien inner join kamar_inap inner join kamar inner join bangsal inner join dokter inner join penjab "
                    ...
                    + "and reg_periksa.kd_dokter=dokter.kd_dokter and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel where "
                    + "reg_periksa.stts_daftar like '%" + status
                    + "%' and kamar_inap.stts_pulang<>'Pindah Kamar' and kamar_inap.tgl_keluar between ? and ? and bangsal.nm_bangsal like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and dokter.nm_dokter like ? or "
                    + "reg_periksa.stts_daftar like '%" + status
                    + "%' and kamar_inap.stts_pulang<>'Pindah Kamar' and kamar_inap.tgl_keluar between ? and ? and bangsal.nm_bangsal like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.alamat like ? or "
                    + "reg_periksa.stts_daftar like '%" + status
                    + "%' and kamar_inap.stts_pulang<>'Pindah Kamar' and kamar_inap.tgl_keluar between ? and ? and bangsal.nm_bangsal like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.nm_pasien like ? or "
                    + "reg_periksa.stts_daftar like '%" + status
                    + "%' and kamar_inap.stts_pulang<>'Pindah Kamar' and kamar_inap.tgl_keluar between ? and ? and bangsal.nm_bangsal like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and reg_periksa.no_rkm_medis like ? or "
                    + "reg_periksa.stts_daftar like '%" + status
                    + "%' and kamar_inap.stts_pulang<>'Pindah Kamar' and kamar_inap.tgl_keluar between ? and ? and bangsal.nm_bangsal like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and kamar_inap.kd_kamar like ? "
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (dokterdpjp.toLowerCase().contains(nmdokter.getText().toLowerCase())) {
                        ...
                        j = 1;
                        ps2 = koneksi.prepareStatement(
                                "select pemeriksaan_ranap.keluhan,pemeriksaan_ranap.pemeriksaan,pemeriksaan_ranap.rtl,pemeriksaan_ranap.evaluasi from pemeriksaan_ranap "
                                + "where pemeriksaan_ranap.no_rawat=? and pemeriksaan_ranap.nip like 'D000%'");
                        try {
                            ps2.setString(1, rs.getString("no_rawat"));
                            rs2 = ps2.executeQuery();
                            while (rs2.next()) {
                                subjek = rs2.getString(1);
                                objek = rs2.getString(2);
                                plan = rs2.getString(3);
                                evaluasi = rs2.getString(4);
                                j++;
                            }
                        } catch (Exception e) {
                            System.out.println(e);
                        ...
                        tabMode2.addRow(new Object[]{i, rs.getString("tgl_masuk"), "", rs.getString("nm_pasien"),
                            rs.getString("p_jawab"), rs.getString("jk"), rs.getString("no_tlp"),
                            rs.getString("tgl_lahir"), String.valueOf(p.getYears()), String.valueOf(p.getMonths()),
                            rs.getString("alamat"), rs.getString("nm_kel"), rs.getString("nm_kec"),
                            rs.getString("nm_kab"), kddiagnosa, diagnosa, subjek, objek, plan, "", "", evaluasi});
                        i++;
                    }
                }
            } catch (Exception e) {
    ...
    public void tampil3() {
        try {
            ...
            if (nmpoli.getText().trim().isEmpty() && nmdokter.getText().trim().isEmpty()
                ...
                ps = koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.stts_daftar,reg_periksa.stts_daftar,reg_periksa.p_jawab,pasien.no_tlp,DATE_FORMAT(pasien.tgl_lahir, '%d-%m-%Y') as tgl_lahir,"
                        + "dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,pasien.alamat,"
                        + "pasien.alamat as almt_pj,kelurahan.nm_kel,kecamatan.nm_kec,kabupaten.nm_kab,concat(pasien.tmp_lahir,', ',pasien.tgl_lahir) as tgl_lahir,pasien.no_tlp,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar,penjab.png_jawab "
                        ...
                        + "where reg_periksa.stts_daftar like '%" + status
                        + "%' and reg_periksa.status_lanjut='Ralan' and reg_periksa.tgl_registrasi between ? and ? order by reg_periksa.tgl_registrasi,reg_periksa.jam_reg");
            } else {
                ps = koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.stts_daftar,reg_periksa.stts_daftar,reg_periksa.p_jawab,pasien.no_tlp,DATE_FORMAT(pasien.tgl_lahir, '%d-%m-%Y') as tgl_lahir,"
                        + "dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,pasien.alamat,"
                        ...
                        + "and reg_periksa.kd_poli=poliklinik.kd_poli and pasien.kd_kab=kabupaten.kd_kab and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel "
                        + "where reg_periksa.stts_daftar like '%" + status
                        + "%' and reg_periksa.status_lanjut='Ralan' and reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and "
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    LocalDate date = rs.getDate("tgl_registrasi").toLocalDate();
                    ...
                    j = 1;
                    ps2 = koneksi.prepareStatement(
                            "select pemeriksaan_ralan.keluhan,pemeriksaan_ralan.pemeriksaan,pemeriksaan_ralan.rtl,pemeriksaan_ralan.evaluasi from pemeriksaan_ralan "
                            + "where pemeriksaan_ralan.no_rawat=? and pemeriksaan_ralan.nip like 'D000%'");
                    try {
                        ps2.setString(1, rs.getString("no_rawat"));
                        rs2 = ps2.executeQuery();
                        while (rs2.next()) {
                    ...
                    tabMode3
                            .addRow(new Object[]{i, rs.getString("tgl_registrasi"), weekOfYear, rs.getString("nm_pasien"),
                        rs.getString("p_jawab"), rs.getString("jk"), rs.getString("no_tlp"),
                        rs.getString("tgl_lahir"), String.valueOf(p.getYears()), String.valueOf(p.getMonths()),
                        rs.getString("alamat"), rs.getString("nm_kel"), rs.getString("nm_kec"),
                        rs.getString("nm_kab"), kddiagnosa, diagnosa, subjek, objek, plan, "", "", evaluasi});
        ...
        try {
            ...
            if (nmpoli.getText().trim().isEmpty() && nmdokter.getText().trim().isEmpty()
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "and reg_periksa.kd_poli=poliklinik.kd_poli and pasien.kd_kab=kabupaten.kd_kab and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel "
                        + "where reg_periksa.stts_daftar like '%" + status
                        + "%' and reg_periksa.status_lanjut='Ralan' and reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? order by reg_periksa.tgl_registrasi,reg_periksa.jam_reg");
            } else {
                ps = koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.stts_daftar,reg_periksa.stts_daftar,reg_periksa.p_jawab,pasien.no_tlp,DATE_FORMAT(pasien.tgl_lahir, '%d-%m-%Y') as tgl_lahir,"
                        + "dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,pasien.alamat,"
                        ...
                        + "and reg_periksa.kd_poli=poliklinik.kd_poli and pasien.kd_kab=kabupaten.kd_kab and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel "
                        + "where reg_periksa.stts_daftar like '%" + status
                        + "%' and reg_periksa.status_lanjut='Ralan' and reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and "
                        + "(poliklinik.nm_poli like ? or dokter.nm_dokter like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or pasien.alamat like ?) order by reg_periksa.tgl_registrasi,reg_periksa.jam_reg");
            }
    ...
    private static final Logger LOG = Logger.getLogger(DlgKunjunganPasienDinkes.class.getName());
