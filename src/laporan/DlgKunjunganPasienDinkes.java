...
public class DlgKunjunganPasienDinkes extends javax.swing.JDialog {
    ...
    private String setbaru = "", setlama = "", umurlk = "", umurpr = "", kddiagnosa = "", diagnosa = "", dokterdpjp = "", status = "", usia = "", subjek = "", objek = "", plan = "", evaluasi = "";
    ...
    public DlgKunjunganPasienDinkes(java.awt.Frame parent, boolean modal) {
        ...
        setSize(885, 674);
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Tgl.Masuk",
            "Minggu Ke", "Nama Pasien", "Keluarga", "Jenis Kelamin", "No.Hp",
            "Tanggal Lahir", "Usia", "Usia (Bulan)", "Alamat Domisili",
            "Kelurahan", "Kecamatan", "Kota/Kab", "ICD 10", "Diagnosa", "Gejala",
            "Kronologi", "Tindakan Yang Dilakukan", "Spesimen",
...
//        tbBangsal.getColumnModel().getColumn(16).setCellRenderer(new TextAreaRenderer());
//        tbBangsal.getColumnModel().getColumn(17).setCellRenderer(new TextAreaRenderer());
//        tbBangsal.getColumnModel().getColumn(18).setCellRenderer(new TextAreaRenderer());
//        tbBangsal.getColumnModel().getColumn(21).setCellRenderer(new TextAreaRenderer());
        ...
        tabMode2 = new DefaultTableModel(null, new String[]{"No.", "Tgl.Masuk",
            "Minggu Ke", "Nama Pasien", "Keluarga", "Jenis Kelamin", "No.Hp",
            "Tanggal Lahir", "Usia", "Usia (Bulan)", "Alamat Domisili",
            "Kelurahan", "Kecamatan", "Kota/Kab", "ICD 10", "Diagnosa", "Gejala",
            "Kronologi", "Tindakan Yang Dilakukan", "Spesimen",
...
//        tbBangsal2.getColumnModel().getColumn(16).setCellRenderer(new TextAreaRenderer());
//        tbBangsal2.getColumnModel().getColumn(17).setCellRenderer(new TextAreaRenderer());
//        tbBangsal2.getColumnModel().getColumn(18).setCellRenderer(new TextAreaRenderer());
//        tbBangsal2.getColumnModel().getColumn(21).setCellRenderer(new TextAreaRenderer());
        ...
        tabMode3 = new DefaultTableModel(null, new String[]{"No.",
            "Tgl.Registrasi", "Minggu Ke", "Nama Pasien", "Keluarga",
            "Jenis Kelamin", "No.Hp", "Tanggal Lahir", "Usia", "Usia (Bulan)",
            "Alamat Domisili", "Kelurahan", "Kecamatan", "Kota/Kab", "ICD 10",
            "Diagnosa", "Gejala", "Kronologi", "Tindakan Yang Dilakukan",
            "Spesimen", "Hasil Pemeriksaan", "Tindak Lanjut", "Keterangan"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
            }
        ...
        //tbRajalsetDefaultRenderer(Object.class, new WarnaTable(jPanel2.getBackground(),tbBangsal2.getBackground()));
...
//        tbRajal.getColumnModel().getColumn(21).setCellRenderer(new TextAreaRenderer());
        ...
        tabMode4 = new DefaultTableModel(null, new String[]{"No.",
            "Tgl.Registrasi", "Minggu Ke", "Nama Pasien", "Keluarga",
            "Jenis Kelamin", "No.Hp", "Tanggal Lahir", "Usia", "Usia (Bulan)",
            "Alamat Domisili", "Kelurahan", "Kecamatan", "Kota/Kab", "ICD 10",
            "Diagnosa", "Gejala", "Kronologi", "Tindakan Yang Dilakukan",
        ...
        //tbRajal2.setDefaultRenderer(Object.class, new WarnaTable(jPanel2.getBackground(),tbRajal2.getBackground()));
        tbRajal2.setPreferredScrollableViewportSize(new Dimension(500, 500));
        tbRajal2.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
//        tbRajal2.getColumnModel().getColumn(16).setCellRenderer(new TextAreaRenderer());
//        tbRajal2.getColumnModel().getColumn(17).setCellRenderer(new TextAreaRenderer());
//        tbRajal2.getColumnModel().getColumn(18).setCellRenderer(new TextAreaRenderer());
//        tbRajal2.getColumnModel().getColumn(21).setCellRenderer(new TextAreaRenderer());
...
//    }
    ...
    private void initComponents() {
        ...
        TabRawat.addTab("Seluruh Kunjungan RJ", internalFrame2);
        ...
        TabRawat.addTab("Kunjungan Non Batal RJ", internalFrame3);
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKunjunganPasienDinkes dialog = new DlgKunjunganPasienDinkes(
    ...
    public void tampil() {
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    usia = Sequel.cariIsi(
                            "select pasien.tgl_lahir from pasien inner join reg_periksa on pasien.no_rkm_medis=reg_periksa.no_rkm_medis where reg_periksa.no_rawat='" + rs.
                                    getString("no_rawat") + "'");
                    ...
                    try {
                        ps2 = koneksi.prepareStatement(
                                "select dokter.nm_dokter from dpjp_ranap inner join dokter "
                    ...
                    if (dokterdpjp.toLowerCase().contains(nmdokter.getText().
                            toLowerCase())) {
                        setbaru = "";
                        setlama = "";
                        ...
                        try {
                            ...
                            rs2 = ps2.executeQuery();
                            while (rs2.next()) {
                                combinedSubjek.append(rs2.getString(
                                        "tgl_perawatan")).append(" ").append(
                                        rs2.getString("jam_rawat")).append(",").
                                        append(rs2.getString("keluhan")).append(
                                        " ");
                                combinedObjek.append(rs2.getString(
                                        "tgl_perawatan")).append(" ").append(
                                        rs2.getString("jam_rawat")).append(",").
                                        append(rs2.getString("pemeriksaan")).
                                        append(" ");
                                combinedPlan.append(rs2.getString(
                                        "tgl_perawatan")).append(" ").append(
                                        rs2.getString("jam_rawat")).append(",").
                                        append(rs2.getString("rtl")).append(" ");
                                combinedEvaluasi.append(rs2.getString(
                                        "tgl_perawatan")).append(" ").append(
                                        rs2.getString("jam_rawat")).append(",").
                        ...
                        tabMode.addRow(new Object[]{
                            i, rs.getString("tgl_masuk"), "", rs.getString(
                            "nm_pasien"), rs.getString("p_jawab"), rs.getString(
                            "jk"), rs.getString("no_tlp"), rs.getString(
                            "tgl_lahir"), String.valueOf(p.getYears()), String.
                            valueOf(p.getMonths()), rs.getString("alamat"), rs.
                            getString("nm_kel"), rs.getString("nm_kec"), rs.
                            getString("nm_kab"), kddiagnosa, diagnosa,
                            combinedSubjek.toString().trim(), combinedObjek.
                            toString().trim(), combinedPlan.toString().trim(),
                ...
                while (rs.next()) {
                    ...
                    if (dokterdpjp.toLowerCase().contains(nmdokter.getText().
                        ...
                        tabMode2.addRow(new Object[]{
                            ...
                            valueOf(p.getMonths()), rs.getString("alamat"), rs.
                            getString("nm_kel"), rs.getString("nm_kec"), rs.
                            getString("nm_kab"), kddiagnosa, diagnosa, subjek,
                            objek, plan, "", "", evaluasi
                        });
                        i++;
                    }
    ...
    public void tampil3() {
        try {
            ...
            if (nmpoli.getText().trim().isEmpty() && nmdokter.getText().trim().
                    isEmpty() && nmpenjab.getText().trim().isEmpty() && nmkabupaten.
                    getText().trim().isEmpty() && nmkecamatan.getText().trim().
                            isEmpty() && nmkelurahan.getText().trim().isEmpty() && TCari.
            ...
            try {
                if (nmpoli.getText().trim().isEmpty() && nmdokter.getText().
                        ...
                        getText().trim().isEmpty() && nmkecamatan.getText().
                                ...
                                isEmpty() && TCari.getText().trim().isEmpty()) {
                    ps.setString(1, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                    ps.setString(2, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                } else {
                    ps.setString(1, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        System.out.println(
                                "laporan.DlgKunjunganRalan.tampil() 2 :" + e);
                    } finally {
                        if (rs2 != null) {
                            rs2.close();
                        }
                    ...
                    tabMode3.addRow(new Object[]{
                        i, rs.getString("tgl_registrasi"), weekOfYear, rs.
                        getString("nm_pasien"), rs.getString("p_jawab"), rs.
                        getString("jk"), rs.getString("no_tlp"), rs.getString(
                        "tgl_lahir"), String.valueOf(p.getYears()), String.
                        valueOf(p.getMonths()), rs.getString("alamat"), rs.
                        getString("nm_kel"), rs.getString("nm_kec"), rs.
                        getString("nm_kab"), kddiagnosa, diagnosa, subjek, objek,
                        plan, "", "", evaluasi
                    });
                    i++;
                }
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgKunjunganPasienDinkes.class.getName());
