...
public class DlgHarianHAIs2 extends javax.swing.JDialog {
    ...
    private int i = 0, jmlETT, jmlCVL, jmlIVL, jmlUC, jmlVAP, jmlIAD, jmlPLEB, jmlISK, jmlILO, jmldeku, jmlsputum,
...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    private void prosesCari() {
        ...
        try {
            ...
            htmlContent.append("<tr class='isi'>"
                    ...
                    + "</tr>" + "<tr class='isi'>" + "<td valign='middle' bgcolor='#FFFAFA' align='center'>ETT</td>"
                    ...
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center'>Urine</td>" + "</tr>");
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    htmlContent.append("<tr class='isi'><td valign='middle' align='center'>")
                            ...
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getString("ETT"))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getString("CVL"))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getString("IVL"))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getString("UC"))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getString("VAP"))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getString("IAD"))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getString("PLEB"))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getString("ISK"))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getString("ILO"))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getString("HAP"))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getString("Tinea"))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getString("Scabies"))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getString("DEKU"))
                            .append("</td><td valign='middle' align='left'>")
                            .append(rs.getString("SPUTUM"))
                            .append("</td><td valign='middle' align='left'>")
                            .append(rs.getString("DARAH"))
                            .append("</td><td valign='middle' align='left'>")
                            .append(rs.getString("URINE"))
                            .append("</td><td valign='middle' align='left'>")
                            .append(rs.getString("ANTIBIOTIK"))
                            .append("</td><td valign='middle' align='left'>")
                            .append(rs.getString("ruang"))
                            .append("</td></tr>");
                    i++;
                }
                if (i > 1) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgHarianHAIs2.class.getName());
