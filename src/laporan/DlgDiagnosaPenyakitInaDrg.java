...
import bridging.InacbgPengajuanKlaim;
import fungsi.akses;
 ...
 * @author perpustakaan
 */
public class DlgDiagnosaPenyakitInaDrg extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgDiagnosaPenyakitInaDrg(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            TCari.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
                ...
                public void insertUpdate(DocumentEvent e) {
                    if (TCari.getText().length() > 2) {
                        panelDiagnosaInaDrg.setRM(TNoRw.getText(), TNoRM.getText(),
                                Valid.SetTgl(DTPCari1.getSelectedItem() + ""),
                                Valid.SetTgl(DTPCari2.getSelectedItem() + ""), Status.getSelectedItem().toString(),
                                TCari.getText().trim());
                        panelDiagnosaInaDrg.pilihTab();
                        LCount.setText(panelDiagnosaInaDrg.getRecord() + "");
                    }
                }
        ...
        panelDiagnosaInaDrg.tbDiagnosaPasien.addMouseListener(new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent e) {
                if (panelDiagnosaInaDrg.tbDiagnosaPasien.getSelectedRow() != -1) {
                    TNoRw.setText(panelDiagnosaInaDrg.tbDiagnosaPasien
                            .getValueAt(panelDiagnosaInaDrg.tbDiagnosaPasien.getSelectedRow(), 2)
                            .toString());
                    TNoRM.setText(panelDiagnosaInaDrg.tbDiagnosaPasien
                            .getValueAt(panelDiagnosaInaDrg.tbDiagnosaPasien.getSelectedRow(), 3)
                            .toString());
                    TPasien.setText(panelDiagnosaInaDrg.tbDiagnosaPasien
                            .getValueAt(panelDiagnosaInaDrg.tbDiagnosaPasien.getSelectedRow(), 4)
                            .toString());
                }
            }
        ...
        panelDiagnosaInaDrg.tbDiagnosaPasien.addKeyListener(new KeyListener() {
            @Override
        ...
        panelDiagnosaInaDrg.tbTindakanPasien.addMouseListener(new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent e) {
                if (panelDiagnosaInaDrg.tbTindakanPasien.getSelectedRow() != -1) {
                    TNoRw.setText(panelDiagnosaInaDrg.tbTindakanPasien
                            .getValueAt(panelDiagnosaInaDrg.tbTindakanPasien.getSelectedRow(), 2)
                            .toString());
                    TNoRM.setText(panelDiagnosaInaDrg.tbTindakanPasien
                            .getValueAt(panelDiagnosaInaDrg.tbTindakanPasien.getSelectedRow(), 3)
                            .toString());
                    TPasien.setText(panelDiagnosaInaDrg.tbTindakanPasien
                            .getValueAt(panelDiagnosaInaDrg.tbTindakanPasien.getSelectedRow(), 4)
                            .toString());
                }
            }
        ...
        panelDiagnosaInaDrg.tbTindakanPasien.addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {
            }
    ...
    private void initComponents() {
        ...
        panelDiagnosaInaDrg = new laporan.PanelDiagnosaInaDrg();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Riwayat Diagnosa & Prosedur Tindakan INA DRG ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        panelDiagnosaInaDrg.setName("panelDiagnosaInaDrg"); // NOI18N
        internalFrame1.add(panelDiagnosaInaDrg, java.awt.BorderLayout.CENTER);
    ...
    private void TCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TCariKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            panelDiagnosaInaDrg.setRM(TNoRw.getText(), TNoRM.getText(), Valid.SetTgl(
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        panelDiagnosaInaDrg.setRM(TNoRw.getText(), "", Valid.SetTgl(DTPCari1.
    ...
    private void TNoRwKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TNoRwKeyPressed
        Valid.pindah(evt, TCari, panelDiagnosaInaDrg.Diagnosa);
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, panelDiagnosaInaDrg.Diagnosa, BtnBatal);
        }
}//GEN-LAST:event_BtnSimpanKeyPressed

    private void BtnBatalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBatalActionPerformed
        panelDiagnosaInaDrg.batal();
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        if (this.getHeight() < 605) {
            panelDiagnosaInaDrg.ScrollInput.setVerticalScrollBarPolicy(
                    javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
            panelDiagnosaInaDrg.FormData.setPreferredSize(new Dimension(
                    PanelBiasa.WIDTH, 420));
            if (this.getWidth() < 900) {
                panelDiagnosaInaDrg.ScrollInput.setHorizontalScrollBarPolicy(
                        javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
                panelDiagnosaInaDrg.FormData.
            ...
            if (this.getWidth() < 900) {
                panelDiagnosaInaDrg.ScrollInput.setHorizontalScrollBarPolicy(
                        javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
                panelDiagnosaInaDrg.FormData.setPreferredSize(new Dimension(890,
                        PanelBiasa.HEIGHT));
            } else {
                panelDiagnosaInaDrg.ScrollInput.setHorizontalScrollBarPolicy(
                        javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDiagnosaPenyakitInaDrg dialog = new DlgDiagnosaPenyakitInaDrg(new javax.swing.JFrame(), true);
    ...
    private laporan.PanelDiagnosaInaDrg panelDiagnosaInaDrg;
    ...
    public void setNoRm(String norwt, Date tgl1, Date tgl2, String status) {
        ...
        panelDiagnosaInaDrg.setRM(TNoRw.getText(), TNoRM.getText(), Valid.SetTgl(DTPCari1.getSelectedItem() + ""),
                Valid.SetTgl(DTPCari2.getSelectedItem() + ""), Status.getSelectedItem().toString(),
                TCari.getText().trim());
    }
    ...
    private static final Logger LOG = Logger.getLogger(DlgDiagnosaPenyakitInaDrg.class.getName());
