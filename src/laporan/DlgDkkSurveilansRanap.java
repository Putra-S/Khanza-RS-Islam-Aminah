...
public class DlgDkkSurveilansRanap extends javax.swing.JDialog {
    ...
    public DlgDkkSurveilansRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{
            "No.", "Kode ICD 10", "Jenis Penyakit", "0-7 Hr", "8-28 Hr", "< 1",
            "1-4", "5-9", "10-14", "15-19",
            "20-44", "45-54", "55-59", "60-69", "70+", "Laki", "Perp", "Jumlah",
...
private void BtnCari1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCari1KeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDkkSurveilansRanap dialog = new DlgDkkSurveilansRanap(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            ...
                            if (Sequel.cariInteger(
                                    ...
                                    + "diagnosa_pasien.status='Ranap' and reg_periksa.tgl_registrasi between '" + Valid.
                                            SetTgl(Tgl1.getSelectedItem() + "") + "' and "
                                    + "'" + Valid.SetTgl(
                                            Tgl2.getSelectedItem() + "") + "' and diagnosa_pasien.kd_penyakit='" + rs.
                                    getString("kd_penyakit") + "' "
                                    + "and reg_periksa.no_rkm_medis='" + rs2.
                                            getString("no_rkm_medis") + "'") == 1) {
                                ...
                                if (rs2.getString("umur").contains("Hr")) {
                                    if (Valid.SetAngka(rs2.getString("umur").
                                            ...
                                            "Hr", "").replaceAll(" ", "")) <= 7) {
                                        hr0s7 += 1;
                                    } else if (Valid.SetAngka(rs2.getString(
                                            "umur").replaceAll(" Hr", "").
                                            replaceAll("Hr", "").replaceAll(" ",
                                            "")) <= 28) {
                                        hr8s28 += 1;
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        "nm_penyakit"), hr0s7, hr8s28, kr1th, th1s4, th5s9,
                        th10s14, th15s19, th20s44, th45s54, th55s59, th60s69,
                        th70plus, laki, per, jml, ttl, meninggal
                    });
                    i++;
                }
            } catch (Exception e) {
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            ...
                            if (Sequel.cariInteger(
                                    ...
                                    + "diagnosa_pasien.status='Ranap' and kamar_inap.tgl_keluar between '" + Valid.
                                            SetTgl(Tgl1.getSelectedItem() + "") + "' and "
                                    + "'" + Valid.SetTgl(
                                            Tgl2.getSelectedItem() + "") + "' and diagnosa_pasien.kd_penyakit='" + rs.
                                    getString("kd_penyakit") + "' "
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgDkkSurveilansRanap.class.getName());
