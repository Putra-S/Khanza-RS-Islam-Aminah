 ...
 * @author perpustakaan
 */
public class DlgDkkSurveilansRanap extends javax.swing.JDialog {
    ...
    private int i = 0, hr0s7 = 0, hr8s28 = 0, kr1th = 0, th1s4 = 0, th5s9 = 0, th10s14 = 0, th15s19 = 0, th20s44 = 0,
            th45s54 = 0, th55s59 = 0, th60s69 = 0, th70plus = 0, laki = 0, per = 0, jml = 0, ttl = 0, jmltotal,
            meninggal;
    ...
    public DlgDkkSurveilansRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"No.", "Kode ICD 10", "Jenis Penyakit", "0-7 Hr", "8-28 Hr", "< 1", "1-4", "5-9",
                    "10-14", "15-19", "20-44", "45-54", "55-59", "60-69", "70+", "Laki", "Perp", "Jumlah",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (TabRawat.getSelectedIndex() == 0) {
            if (tabMode.getRowCount() == 0) {
                ...
                Valid.MyReportqry("rptSurveilansRanap.jasper", "report",
                        "::[ Surveilans PD3I ]::",
...
private void BtnCari1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCari1KeyPressed
    ...
    private void ppGrafikHidupMatiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppGrafikHidupMatiActionPerformed
        if (tbBangsal.getSelectedRow() > -1) {
            ...
            dpd.setValue("Hidup (" + tbBangsal.getValueAt(tbBangsal.
                    getSelectedRow(), 18).toString() + ")", Integer.parseInt(
                            tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 18).
                                    toString()));
            dpd.setValue("Meninggal (" + tbBangsal.getValueAt(tbBangsal.
                    getSelectedRow(), 19).toString() + ")", Integer.parseInt(
                            tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 19).
                                    toString()));
            JFreeChart freeChart = ChartFactory.createPieChart(
                    "Grafik Pie Perbandingan Pasien Hidup & Mati Periode " + Valid.
                            SetTgl(Tgl1.getSelectedItem() + "") + " S.D. " + Valid.
                    SetTgl(Tgl2.getSelectedItem() + ""), dpd, true, true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
            ChartFrame cf = new ChartFrame("Grafik Pasien Hidup & Mati",
                    freeChart);
            ...
            JOptionPane.showMessageDialog(rootPane,
                    "Silahkan pilih data penyakit terlebih dahulu");
        }
    ...
    private void ppGrafikLakiPerempuanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppGrafikLakiPerempuanActionPerformed
        if (tbBangsal.getSelectedRow() > -1) {
            DefaultPieDataset dpd = new DefaultPieDataset();
            dpd.setValue("Laki-Laki " + Math.round(((Double.parseDouble(
                    tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 15).
                            toString()) / Double.parseDouble(tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 17).
                            toString())) * 100)) + "%(" + tbBangsal.getValueAt(
                            tbBangsal.getSelectedRow(), 15).toString() + ")",
                    Integer.parseInt(tbBangsal.getValueAt(tbBangsal.
                            getSelectedRow(), 15).toString()));
            dpd.setValue("Perempuan " + Math.round(((Double.parseDouble(
                    tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 16).
                            toString()) / Double.parseDouble(tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 17).
                            toString())) * 100)) + "%(" + tbBangsal.getValueAt(
                            tbBangsal.getSelectedRow(), 16).toString() + ")",
                    Integer.parseInt(tbBangsal.getValueAt(tbBangsal.
                            getSelectedRow(), 16).toString()));
            JFreeChart freeChart = ChartFactory.createPieChart(
                    "Grafik Pie Perbandingan Pasien Laki-Laki & Perempuan Periode " + Valid.
                            SetTgl(Tgl1.getSelectedItem() + "") + " S.D. " + Valid.
                    SetTgl(Tgl2.getSelectedItem() + ""), dpd, true, true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
            ChartFrame cf = new ChartFrame("Grafik Pasien Laki-Laki & Perempuan",
                    freeChart);
            cf.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                    getHeight() - 20);
            cf.setLocationRelativeTo(internalFrame1);
    ...
    private void ppGrafikGolonganUmurActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppGrafikGolonganUmurActionPerformed
        if (tbBangsal.getSelectedRow() > -1) {
            DefaultPieDataset dpd = new DefaultPieDataset();
            dpd.setValue("0-7 Hr " + Math.round(((Double.parseDouble(tbBangsal.
                    getValueAt(tbBangsal.getSelectedRow(), 3).toString()) / Double.
                    parseDouble(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),
                            17).toString())) * 100)) + "%(" + tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 3).toString() + ")",
                    Integer.parseInt(tbBangsal.getValueAt(tbBangsal.
                            getSelectedRow(), 3).toString()));
            dpd.setValue("8-28 Hr " + Math.round(((Double.parseDouble(tbBangsal.
                    getValueAt(tbBangsal.getSelectedRow(), 4).toString()) / Double.
                    parseDouble(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),
                            17).toString())) * 100)) + "%(" + tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 4).toString() + ")",
                    Integer.parseInt(tbBangsal.getValueAt(tbBangsal.
                            getSelectedRow(), 4).toString()));
            dpd.setValue("< 1 " + Math.round(((Double.parseDouble(tbBangsal.
                    getValueAt(tbBangsal.getSelectedRow(), 5).toString()) / Double.
                    parseDouble(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),
                            17).toString())) * 100)) + "%(" + tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 5).toString() + ")",
                    Integer.parseInt(tbBangsal.getValueAt(tbBangsal.
                            getSelectedRow(), 5).toString()));
            dpd.setValue("1-4 " + Math.round(((Double.parseDouble(tbBangsal.
                    getValueAt(tbBangsal.getSelectedRow(), 6).toString()) / Double.
                    parseDouble(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),
                            17).toString())) * 100)) + "%(" + tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 6).toString() + ")",
                    Integer.parseInt(tbBangsal.getValueAt(tbBangsal.
                            getSelectedRow(), 6).toString()));
            dpd.setValue("5-9 " + Math.round(((Double.parseDouble(tbBangsal.
                    getValueAt(tbBangsal.getSelectedRow(), 7).toString()) / Double.
                    parseDouble(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),
                            17).toString())) * 100)) + "%(" + tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 7).toString() + ")",
                    Integer.parseInt(tbBangsal.getValueAt(tbBangsal.
                            getSelectedRow(), 7).toString()));
            dpd.setValue("10-14 " + Math.round(((Double.parseDouble(tbBangsal.
                    getValueAt(tbBangsal.getSelectedRow(), 8).toString()) / Double.
                    parseDouble(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),
                            17).toString())) * 100)) + "%(" + tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 8).toString() + ")",
                    Integer.parseInt(tbBangsal.getValueAt(tbBangsal.
                            getSelectedRow(), 8).toString()));
            dpd.setValue("15-19 " + Math.round(((Double.parseDouble(tbBangsal.
                    getValueAt(tbBangsal.getSelectedRow(), 9).toString()) / Double.
                    parseDouble(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),
                            17).toString())) * 100)) + "%(" + tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 9).toString() + ")",
                    Integer.parseInt(tbBangsal.getValueAt(tbBangsal.
                            getSelectedRow(), 9).toString()));
            dpd.setValue("20-44 " + Math.round(((Double.parseDouble(tbBangsal.
                    getValueAt(tbBangsal.getSelectedRow(), 10).toString()) / Double.
                    parseDouble(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),
                            17).toString())) * 100)) + "%(" + tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 10).
                            toString() + ")", Integer.parseInt(tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 10).
                            toString()));
            dpd.setValue("45-54 " + Math.round(((Double.parseDouble(tbBangsal.
                    getValueAt(tbBangsal.getSelectedRow(), 11).toString()) / Double.
                    parseDouble(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),
                            17).toString())) * 100)) + "%(" + tbBangsal.
                            ...
                            getValueAt(tbBangsal.getSelectedRow(), 11).
                            toString()));
            dpd.setValue("55-59 " + Math.round(((Double.parseDouble(tbBangsal.
                    getValueAt(tbBangsal.getSelectedRow(), 12).toString()) / Double.
                    parseDouble(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),
                            17).toString())) * 100)) + "%(" + tbBangsal.
                            ...
                            getValueAt(tbBangsal.getSelectedRow(), 12).
                            toString()));
            dpd.setValue("60-69 " + Math.round(((Double.parseDouble(tbBangsal.
                    getValueAt(tbBangsal.getSelectedRow(), 13).toString()) / Double.
                    parseDouble(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),
                            17).toString())) * 100)) + "%(" + tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 13).
                            toString() + ")", Integer.parseInt(tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 13).
                            toString()));
            dpd.setValue("70+ " + Math.round(((Double.parseDouble(tbBangsal.
                    getValueAt(tbBangsal.getSelectedRow(), 14).toString()) / Double.
                    parseDouble(tbBangsal.getValueAt(tbBangsal.getSelectedRow(),
                            17).toString())) * 100)) + "%(" + tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 14).
                            toString() + ")", Integer.parseInt(tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 14).
                            toString()));
            JFreeChart freeChart = ChartFactory.createPieChart(
                    "Grafik Pie Perbandingan Per Umur Periode " + Valid.SetTgl(
                            Tgl1.getSelectedItem() + "") + " S.D. " + Valid.
                    SetTgl(Tgl2.getSelectedItem() + ""), dpd, true, true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            ...
                            if (Sequel.cariInteger(
                                    "select count(diagnosa_pasien.no_rawat) from reg_periksa inner join diagnosa_pasien "
                                    + "on reg_periksa.no_rawat=diagnosa_pasien.no_rawat where "
                                    + "diagnosa_pasien.status='Ranap' and reg_periksa.tgl_registrasi between '"
                                    + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and " + "'"
                                    + Valid.SetTgl(Tgl2.getSelectedItem() + "")
                                    + "' and diagnosa_pasien.kd_penyakit='" + rs.getString("kd_penyakit") + "' "
                                    + "and reg_periksa.no_rkm_medis='" + rs2.getString("no_rkm_medis")
                                    + "'") == 1) {
                                ...
                                if (rs2.getString("umur").contains("Hr")) {
                                    if (Valid.SetAngka(rs2.getString("umur")
                                            .replaceAll(" Hr", "")
                                            .replaceAll("Hr", "")
                                            .replaceAll(" ", "")) <= 7) {
                                        hr0s7 += 1;
                                    } else if (Valid.SetAngka(rs2.getString("umur")
                                            .replaceAll(" Hr", "")
                                            .replaceAll("Hr", "")
                                            .replaceAll(" ", "")) <= 28) {
                                        hr8s28 += 1;
                    ...
                    jml = per + laki;
                    tabMode.addRow(new Object[]{i, rs.getString("kd_penyakit"), rs.getString("nm_penyakit"), hr0s7,
                        hr8s28, kr1th, th1s4, th5s9, th10s14, th15s19, th20s44, th45s54, th55s59, th60s69, th70plus,
                        laki, per, jml, ttl, meninggal});
                    i++;
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : " + e);
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            ...
                            jmltotal += 1;
                            if (Sequel.cariInteger(
                                    "select count(diagnosa_pasien.no_rawat) from reg_periksa inner join diagnosa_pasien inner join kamar_inap "
                                    + "on reg_periksa.no_rawat=diagnosa_pasien.no_rawat and kamar_inap.no_rawat=reg_periksa.no_rawat where "
                                    + "diagnosa_pasien.status='Ranap' and kamar_inap.tgl_keluar between '"
                                    + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and " + "'"
                                    + Valid.SetTgl(Tgl2.getSelectedItem() + "")
                                    + "' and diagnosa_pasien.kd_penyakit='" + rs.getString("kd_penyakit") + "' "
                                    + "and reg_periksa.no_rkm_medis='" + rs2.getString("no_rkm_medis")
                    ...
                    jml = per + laki;
                    tabMode2.addRow(new Object[]{i, rs.getString("kd_penyakit"), rs.getString("nm_penyakit"), hr0s7,
                        hr8s28, kr1th, th1s4, th5s9, th10s14, th15s19, th20s44, th45s54, th55s59, th60s69, th70plus,
                        laki, per, jml, ttl, meninggal});
                    i++;
                }
    ...
    private static final Logger LOG = Logger.getLogger(DlgDkkSurveilansRanap.class.getName());
