...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgHitungALOS dialog = new DlgHitungALOS(new javax.swing.JFrame(),
                    true);
    ...
    public void tampil() {
        try {
            ...
            try {
                ...
                if (hari > 0) {
                    pasien = Sequel.cariIntegerCount(
                            "select count(no_rawat) from kamar_inap where tgl_masuk between '" + Valid.
                                    SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.
                            SetTgl(Tgl2.getSelectedItem() + "") + "' group by no_rawat");
                    tabMode.addRow(new Object[]{"", "", "",
                        "Jumlah Lama Dirawat", ":", "", "", hari, ""});
                    tabMode.addRow(new Object[]{"", "", "",
                        "Jumlah Pasien Keluar(Hidup+Mati)", ":", "", "", pasien,
                        ""});
                    tabMode.addRow(new Object[]{"", "", "", "Perhitungan ALOS ",
                        ": " + hari + "/" + pasien, "", "", Valid.SetAngka4(
                        (hari / pasien)), ""});
                }
            } catch (Exception e) {
    ...
    public void tampil2() {
        try {
            ...
            try {
                ...
                if (hari > 0) {
                    pasien = Sequel.cariIntegerCount(
                            "select count(no_rawat) from kamar_inap where tgl_keluar between '" + Valid.
                                    SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.
                            SetTgl(Tgl2.getSelectedItem() + "") + "' group by no_rawat");
                    tabMode2.addRow(new Object[]{"", "", "",
                        "Jumlah Lama Dirawat", ":", "", "", hari, ""});
                    tabMode2.addRow(new Object[]{"", "", "",
                        ...
                        ""});
                    tabMode2.addRow(
                            new Object[]{"", "", "", "Perhitungan ALOS ",
                                ": " + hari + "/" + pasien, "", "", Valid.
                                        SetAngka4((hari / pasien)), ""});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgHitungALOS.class.
            getName());
