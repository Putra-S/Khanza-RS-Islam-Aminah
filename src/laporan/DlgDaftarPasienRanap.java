...
public class DlgDaftarPasienRanap extends javax.swing.JDialog {
    ...
    public DlgDaftarPasienRanap(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr = {"No.", "No.RM", "Nama Pasien", "Cara Bayar",
            "Tgl.Masuk", "Tgl.Pulang", "Ruangan", "H.P."};
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptDaftarPasienRanap.jasper", "report",
                    "::[ Laporan Daftar Nama Pasien Ranap ]::",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDaftarPasienRanap dialog = new DlgDaftarPasienRanap(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new String[]{
                        ...
                        "tgl_registrasi"), tglkeluar, kamar, harirawat
                    });
                    i++;
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgDaftarPasienRanap.class.getName());
