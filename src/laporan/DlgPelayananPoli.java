...
public class DlgPelayananPoli extends javax.swing.JDialog {
    ...
    public DlgPelayananPoli(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr = {"No.", "No.RM", "Nama Pasien", "Dokter", "Poli",
            "Jam Registrasi", "Jam Pelayanan Poli", "Durasi(m)"};
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPelayananPoli dialog = new DlgPelayananPoli(
    ...
    private static final Logger LOG = Logger.getLogger(DlgPelayananPoli.class.
            getName());
