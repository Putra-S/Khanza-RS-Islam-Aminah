 ...
 * @author perpustakaan
 */
public class DlgPelayananPoli extends javax.swing.JDialog {
    ...
    public DlgPelayananPoli(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr = {"No.", "No.RM", "Nama Pasien", "Dokter", "Poli", "Jam Registrasi", "Jam Pelayanan Poli",
            "Durasi(m)"};
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPelayananPoli.jasper", param,
                    "::[ Laporan Data Pelayanan Poli ]::");
        }
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private static final Logger LOG = Logger.getLogger(DlgPelayananPoli.class.getName());
