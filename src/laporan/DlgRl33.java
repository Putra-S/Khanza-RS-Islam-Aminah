 ...
 * @author perpustakaan
 */
public class DlgRl33 extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRl33.jasper", "report",
                    "::[ Formulir RL 3.3 ]::",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
            ...
            try {
                ...
                while (rs.next()) {
                    pstindakan = koneksi.prepareStatement(
                            "select jns_perawatan.nm_perawatan,count(jns_perawatan.nm_perawatan) from rawat_jl_dr inner join reg_periksa "
                    ...
                    try {
                        ...
                        while (rstindakan.next()) {
                            tabMode.addRow(new Object[]{i, rstindakan.getString(1), rstindakan.getInt(2)});
                ...
                if (i > 1) {
                    tabMode.addRow(new Object[]{"", "TOTAL", ttl});
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
            } finally {
    ...
    private static final Logger LOG = Logger.getLogger(DlgRl33.class.getName());
