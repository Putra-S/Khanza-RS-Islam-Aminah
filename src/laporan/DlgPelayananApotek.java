...
public class DlgPelayananApotek extends javax.swing.JDialog {
    ...
    public DlgPelayananApotek(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr = {
            "No.", "No.RM", "Nama Pasien", "Dokter", "Poli", "Jam Peresepan",
            "Jam Validasi", "Jam Penyerahan", "Peresepan-Validasi",
            "Validasi-Penyerahan", "Peresepan-Penyerahan"
        };
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPelayananApotek dialog = new DlgPelayananApotek(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        ...
                        "nm_pasien"), rs.getString("nm_dokter"), rs.getString(
                        "nm_poli"),
                        ...
                        "jam_penyerahan"), rs.getString("durasivalidasi"), rs.
                        getString("durasipenyerahan"),
                    ...
                    if (rs.getDouble("durasivalidasi") <= 15) {
                        limabelas++;
                    } else if ((rs.getDouble("durasivalidasi") > 15) && (rs.
                            getDouble("durasivalidasi") <= 30)) {
                        tigapuluh++;
                    } else if ((rs.getDouble("durasivalidasi") > 30) && (rs.
                            getDouble("durasivalidasi") <= 60)) {
                        satujam++;
                    ...
                    if (rs.getDouble("durasipenyerahan") <= 15) {
                        limabelas2++;
                    } else if ((rs.getDouble("durasipenyerahan") > 15) && (rs.
                            getDouble("durasipenyerahan") <= 30)) {
                        tigapuluh2++;
                    } else if ((rs.getDouble("durasipenyerahan") > 30) && (rs.
                            getDouble("durasipenyerahan") <= 60)) {
                        satujam2++;
                    ...
                    if (rs.getDouble("durasipelayanan") <= 15) {
                        limabelas3++;
                    } else if ((rs.getDouble("durasipelayanan") > 15) && (rs.
                            getDouble("durasipelayanan") <= 30)) {
                        tigapuluh3++;
                    } else if ((rs.getDouble("durasipelayanan") > 30) && (rs.
                            getDouble("durasipelayanan") <= 60)) {
                        satujam3++;
    ...
    private static final Logger LOG = Logger.getLogger(DlgPelayananApotek.class.
            getName());
