 ...
 * @author perpustakaan
 */
public class DlgPerujukRadiologiPerTahun extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptPerujukRadiologiPerTahun.jasper", "report",
                    "::[ Laporan Rekap Perujuk Laboratorium Per Tahun ]::",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
            ...
            try {
                ...
                while (rs.next()) {
                    jan = Sequel.cariInteger(
                            "select count(dokter_perujuk) from periksa_radiologi where dokter_perujuk=? and tgl_periksa like ?",
                            rs.getString("kd_dokter"), "%" + ThnCari.getSelectedItem() + "-01%");
                    feb = Sequel.cariInteger(
                            "select count(dokter_perujuk) from periksa_radiologi where dokter_perujuk=? and tgl_periksa like ?",
                            rs.getString("kd_dokter"), "%" + ThnCari.getSelectedItem() + "-02%");
                    mar = Sequel.cariInteger(
                            "select count(dokter_perujuk) from periksa_radiologi where dokter_perujuk=? and tgl_periksa like ?",
                            rs.getString("kd_dokter"), "%" + ThnCari.getSelectedItem() + "-03%");
                    apr = Sequel.cariInteger(
                            "select count(dokter_perujuk) from periksa_radiologi where dokter_perujuk=? and tgl_periksa like ?",
                            rs.getString("kd_dokter"), "%" + ThnCari.getSelectedItem() + "-04%");
                    mei = Sequel.cariInteger(
                            "select count(dokter_perujuk) from periksa_radiologi where dokter_perujuk=? and tgl_periksa like ?",
                            rs.getString("kd_dokter"), "%" + ThnCari.getSelectedItem() + "-05%");
                    jun = Sequel.cariInteger(
                            "select count(dokter_perujuk) from periksa_radiologi where dokter_perujuk=? and tgl_periksa like ?",
                            rs.getString("kd_dokter"), "%" + ThnCari.getSelectedItem() + "-06%");
                    jul = Sequel.cariInteger(
                            "select count(dokter_perujuk) from periksa_radiologi where dokter_perujuk=? and tgl_periksa like ?",
                            rs.getString("kd_dokter"), "%" + ThnCari.getSelectedItem() + "-07%");
                    agu = Sequel.cariInteger(
                            "select count(dokter_perujuk) from periksa_radiologi where dokter_perujuk=? and tgl_periksa like ?",
                            rs.getString("kd_dokter"), "%" + ThnCari.getSelectedItem() + "-08%");
                    sep = Sequel.cariInteger(
                            "select count(dokter_perujuk) from periksa_radiologi where dokter_perujuk=? and tgl_periksa like ?",
                            rs.getString("kd_dokter"), "%" + ThnCari.getSelectedItem() + "-09%");
                    okt = Sequel.cariInteger(
                            "select count(dokter_perujuk) from periksa_radiologi where dokter_perujuk=? and tgl_periksa like ?",
                            rs.getString("kd_dokter"), "%" + ThnCari.getSelectedItem() + "-10%");
                    nov = Sequel.cariInteger(
                            "select count(dokter_perujuk) from periksa_radiologi where dokter_perujuk=? and tgl_periksa like ?",
                            rs.getString("kd_dokter"), "%" + ThnCari.getSelectedItem() + "-11%");
                    des = Sequel.cariInteger(
                            "select count(dokter_perujuk) from periksa_radiologi where dokter_perujuk=? and tgl_periksa like ?",
                            rs.getString("kd_dokter"), "%" + ThnCari.getSelectedItem() + "-12%");
                    ttljan += jan;
                    ttlfeb += feb;
                    ttlmar += mar;
                    ttlapr += apr;
                    ...
                    ttlnov += nov;
                    ttldes += des;
                    tabMode.addRow(new String[]{i + "", rs.getString("nm_dokter"), jan + "", feb + "", mar + "",
    ...
    private static final Logger LOG = Logger.getLogger(DlgPerujukRadiologiPerTahun.class.getName());
