...
public class DlgDosisRadiologi extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptDosisRadiologi.jasper", "report",
                    "::[ Laporan Dosis Radiologi ]::",
                    ...
                    + "where periksa_radiologi.tgl_periksa between '" + Valid.
                            SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tgl2.getSelectedItem() + "") + "' and "
                    + "periksa_radiologi.status like '%" + Status.
                            getSelectedItem().toString().replaceAll(
                                    "Semua Status", "").replaceAll(
                                    "Pemeriksaan Radiologi Rawat Jalan", "Ralan").
                            replaceAll("Pemeriksaan Radiologi Rawat Inap",
                                    "Ranap") + "%' and "
                    + "dokter.nm_dokter like '%" + nmdokter.getText().trim() + "%' and penjab.png_jawab like '%" + nmpenjab.
                    getText().trim() + "%' and kabupaten.nm_kab like '%" + nmkabupaten.
                            getText().trim() + "%' and kecamatan.nm_kec like '%" + nmkecamatan.
                            getText().trim() + "%' and kelurahan.nm_kel like '%" + nmkelurahan.
                            getText().trim() + "%' "
                    + "and (jns_perawatan_radiologi.nm_perawatan like '%" + TCari.
