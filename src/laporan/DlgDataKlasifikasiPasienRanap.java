...
public class DlgDataKlasifikasiPasienRanap extends javax.swing.JDialog {
    ...
    public DlgDataKlasifikasiPasienRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Tanggal", "No.Rawat", "No.R.M.", "Nama Pasien", "Minimal",
            "Partial", "Total", "Kamar", "No.Kamar"}) {
            @Override
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "data_klasifikasi_pasien_ranap.tanggal between ? and ? "
                    + (TCari.getText().trim().isEmpty() ? ""
                    : "and (data_klasifikasi_pasien_ranap.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "
                    + "bangsal.nm_bangsal like ? or pasien.nm_pasien like ?)")
                    + " order by data_klasifikasi_pasien_ranap.tanggal ");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(DlgDataKlasifikasiPasienRanap.class.getName());
