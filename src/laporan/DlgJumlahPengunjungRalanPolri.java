...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    private void prosesCari() {
        ...
        try {
            jumlahcari = Sequel
                    .cariInteger("select count(golongan_polri.id) from golongan_polri order by golongan_polri.id");
            kodecari = new String[jumlahcari];
            jumlahcarabayar = Sequel
                    .cariInteger("select count(penjab.kd_pj) from penjab where penjab.status='1' order by penjab.kd_pj");
            ...
            htmlContent.append(
                    ...
                    .append(jumlahcari)
                    .append("'>PASIEN POLRI</td><td valign='middle' bgcolor='#FFFAFA' align='center' colspan='")
                    .append(jumlahcarabayar)
                    .append("'>PASIEN UMUM</td><td valign='middle' bgcolor='#FFFAFA' align='center' rowspan='2' width='50px'>Total</td></tr>");
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    kolom++;
                    htmlContent.append("<td valign='middle' bgcolor='#FFFFF8' align='center' width='70px'>")
            ...
            for (i = 0; i < jumlahcari; i++) {
                kolom = Sequel.cariInteger(
                        ...
                        + "where pasien_polri.golongan_polri=? and reg_periksa.status_lanjut='Ralan' and reg_periksa.tgl_registrasi between '"
            ...
            for (i = 0; i < jumlahcarabayar; i++) {
                kolom = Sequel.cariInteger(
                        ...
                        + "and reg_periksa.kd_pj=? and reg_periksa.tgl_registrasi between '"
                        + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '"
                        + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' "
                        + "group by reg_periksa.no_rkm_medis",
                        kodebayar[i]);
            ...
            htmlContent.append("<td valign='middle' align='center'>")
                    .append(Valid.SetAngka(total))
                    .append("</td></tr>");
            LoadHTML.setText("<html>" + "<table width='" + (80 + ((jumlahcari + jumlahcarabayar) * 70))
    ...
    private void prosesCari2() {
        ...
        try {
            ...
            for (i = 0; i < jumlahcari; i++) {
                kolom = Sequel.cariInteger(
                        "select count(reg_periksa.no_rkm_medis) from reg_periksa inner join pasien_polri on reg_periksa.no_rkm_medis=pasien_polri.no_rkm_medis "
                        + "where pasien_polri.satuan_polri=? and reg_periksa.status_lanjut='Ralan' and reg_periksa.tgl_registrasi between '"
                        + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '"
                        + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' "
                        + "group by reg_periksa.no_rkm_medis",
                        kodecari[i]);
    ...
    private void prosesCari3() {
        ...
        try {
            jumlahcari = Sequel
                    .cariInteger("select count(pangkat_polri.id) from pangkat_polri order by pangkat_polri.id");
            kodecari = new String[jumlahcari];
            jumlahcarabayar = Sequel
                    .cariInteger("select count(penjab.kd_pj) from penjab where penjab.status='1' order by penjab.kd_pj");
            kodebayar = new String[jumlahcarabayar];
            ...
            for (i = 0; i < jumlahcari; i++) {
                kolom = Sequel.cariInteger(
                        "select count(reg_periksa.no_rkm_medis) from reg_periksa inner join pasien_polri on reg_periksa.no_rkm_medis=pasien_polri.no_rkm_medis "
                        + "where pasien_polri.pangkat_polri=? and reg_periksa.status_lanjut='Ralan' and reg_periksa.tgl_registrasi between '"
                        + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '"
                        + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' "
                        + "group by reg_periksa.no_rkm_medis",
                        kodecari[i]);
    ...
    private void prosesCari4() {
        ...
        try {
            jumlahcari = Sequel
                    .cariInteger("select count(jabatan_polri.id) from jabatan_polri order by jabatan_polri.id");
            kodecari = new String[jumlahcari];
            jumlahcarabayar = Sequel
                    .cariInteger("select count(penjab.kd_pj) from penjab where penjab.status='1' order by penjab.kd_pj");
            kodebayar = new String[jumlahcarabayar];
            ...
            for (i = 0; i < jumlahcari; i++) {
                kolom = Sequel.cariInteger(
                        "select count(reg_periksa.no_rkm_medis) from reg_periksa inner join pasien_polri on reg_periksa.no_rkm_medis=pasien_polri.no_rkm_medis "
                        + "where pasien_polri.jabatan_polri=? and reg_periksa.status_lanjut='Ralan' and reg_periksa.tgl_registrasi between '"
                        + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '"
                        + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' "
                        + "group by reg_periksa.no_rkm_medis",
                        kodecari[i]);
    ...
    private static final Logger LOG = Logger.getLogger(DlgJumlahPengunjungRalanPolri.class.getName());
