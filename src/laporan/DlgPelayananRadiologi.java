...
public class DlgPelayananRadiologi extends javax.swing.JDialog {
    ...
    private int i = 0, limabelas = 0, tigapuluh = 0, satujam = 0, lebihsatujam = 0, lebihduajam = 0, limabelas2 = 0,
            tigapuluh2 = 0, satujam2 = 0, lebihsatujam2 = 0, lebihduajam2 = 0, limabelas3 = 0, tigapuluh3 = 0,
            satujam3 = 0, lebihsatujam3 = 0, lebihduajam3 = 0;
    ...
    public DlgPelayananRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.", "No.RM", "Nama Pasien", "Dokter Perujuk", "No.Order", "Jam Permintaan",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{i, rs.getString("no_rkm_medis"), rs.getString("nm_pasien"),
                        rs.getString("nm_dokter"), rs.getString("noorder"),
                        ...
                        rs.getString("permintaansampel"), rs.getString("sampelhasil"),
                        rs.getString("permintaanhasil")});
                    i++;
                ...
                if (lamajam > 0) {
                    ...
                    tabMode.addRow(new Object[]{"", "", ">30 - <=60 Menit", ": ", "", "", "", "", "" + satujam,
                        "" + satujam2, "" + satujam3});
                    tabMode.addRow(new Object[]{"", "", ">60 - <=120 Menit", ": ", "", "", "", "", "" + lebihsatujam,
                        "" + lebihsatujam2, "" + lebihsatujam3});
                    tabMode.addRow(new Object[]{"", "", ">120 Menit", ": ", "", "", "", "", "" + lebihduajam,
                        "" + lebihduajam2, "" + lebihduajam3});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgPelayananRadiologi.class.getName());
