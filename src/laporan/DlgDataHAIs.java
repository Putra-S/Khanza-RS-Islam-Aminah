...
public class DlgDataHAIs extends javax.swing.JDialog {
    ...
    public DlgDataHAIs(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Tanggal", "No.Rawat", "No.R.M.", "Nama Pasien", "ETT", "CVL", "IVL", "UC", "VAP", "IAD",
                    "Pleb", "ISK", "ILO", "HAP", "Tinea", "Scabies", "Deku", "Sputum", "Darah", "Urine",
                    "Antibiotik", "Kamar", "Kode kamar"}) {
            @Override
    ...
    private static final Logger LOG = Logger.getLogger(DlgDataHAIs.class.getName());
