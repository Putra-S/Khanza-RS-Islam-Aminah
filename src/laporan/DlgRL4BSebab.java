        ...
        try {
            ...
            try (BufferedWriter bw = new BufferedWriter(new FileWriter(f))) {
                bw.write(LoadHTML.getText().replaceAll("<head>",
                        ...
                        getemailrs() + "<br><br>"
                        + "<font size='2' face='Tahoma'>DATA KEADAAN MORBIDITAS PASIEN RAWAT JALAN RUMAH SAKIT PENYEBAB KECELAKAN<br>PERIODE " + Tgl1.
...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRL4BSebab dialog = new DlgRL4BSebab(new javax.swing.JFrame(),
                    true);
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        System.out.println(
                                "laporan.DlgRL4A.prosesCari() 1 : " + e);
                    } finally {
                        if (rs2 != null) {
                            rs2.close();
                        }
                    ...
                    try {
                        ...
                        System.out.println(
                                "laporan.DlgRL4B.prosesCari() 2 : " + e);
                    } finally {
                        if (rs2 != null) {
                            rs2.close();
                        }
    ...
    private static final Logger LOG = Logger.getLogger(DlgRL4BSebab.class.
            getName());
