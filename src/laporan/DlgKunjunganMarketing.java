 ...
 * @author perpustakaan
 */
public class DlgKunjunganMarketing extends javax.swing.JDialog {
    ...
    private String setbaru = "", setlama = "", umurlk = "", umurpr = "", kddiangnosa = "", diagnosa = "", pilihan = "",
            status = "";
     ...
     * @param modal
     */
    public DlgKunjunganMarketing(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.", "tanggal Registrasi", "Nama Dokter", "Poliklinik", "Nama Pasien", "Jenis Kelamin",
                    "Tempat Lahir", "Tanggal Lahir", "Alamat", "Kelurahan", "Kecamatan", "Kabupaten", "No.Telp",
                    "Status Lanjut", "Cara Bayar", "Lama/Baru"}) {
            @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Kunjungan Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TabRawat.addTab("Seluruh Kunjungan", Scroll);
        ...
        TabRawat.addTab("Kunjungan Non Batal", Scroll1);
        ...
        try {
            ...
            pilihan = (String) JOptionPane.showInputDialog(null,
                    ...
                    JOptionPane.QUESTION_MESSAGE, null, new Object[]{
                        "Laporan 1 (HTML)", "Laporan 2 (WPS)", "Laporan 3 (CSV)",
                        "Laporan 4 (Jasper)"}, "Laporan 1 (HTML)");
            switch (pilihan) {
                case "Laporan 1 (HTML)":
                    ...
                    if (TabRawat.getSelectedIndex() == 0) {
                        ...
                        for (i = 0; i < tabMode2.getRowCount(); i++) {
                            htmlContent.append(
                                    "<tr class='isi'><td valign='top'>").append(
                                            tabMode2.getValueAt(i, 0)).append(
                                    "</td><td valign='top' align='center'>").
                                    append(tabMode2.getValueAt(i, 1)).append(
                                    "</td><td valign='top' align='center'>").
                                    append(tabMode2.getValueAt(i, 2)).append(
                                    "</td><td valign='top'>").append(tabMode2.
                                            getValueAt(i, 3)).append(
                                    "</td><td valign='top' align='center'>").
                                    append(tabMode2.getValueAt(i, 4)).append(
                                    "</td><td valign='top' align='center'>").
                                    append(tabMode2.getValueAt(i, 5)).append(
                                    "</td><td valign='top'>").append(tabMode2.
                                            getValueAt(i, 6)).append(
                                    "</td><td valign='top' align='center'>").
                                    append(tabMode2.getValueAt(i, 7)).append(
                                    "</td><td valign='top'>").append(tabMode2.
                                            getValueAt(i, 8)).append(
                                    "</td><td valign='top'>").append(tabMode2.
                                            getValueAt(i, 9)).append(
                    ...
                    bw.write("<html>"
                            ...
                            getemailrs() + "<br><br>"
                            + "<font size='2' face='Tahoma'>LAPORAN KUNJUNGAN RAWAT JALAN PERIODE " + Tgl1.
                ...
                case "Laporan 3 (CSV)":
                    ...
                    if (TabRawat.getSelectedIndex() == 0) {
                        ...
                        for (i = 0; i < tabMode2.getRowCount(); i++) {
                            htmlContent.append("\"").append(tabMode2.getValueAt(
                                    i, 0)).append("\";\"").append(tabMode2.
                                    getValueAt(i, 1)).append("\";\"").append(
                                    tabMode2.getValueAt(i, 2)).append("\";\"").
                                    append(tabMode2.getValueAt(i, 3)).append(
                                    "\";\"").append(tabMode2.getValueAt(i, 4)).
                                    append("\";\"").append(tabMode2.
                                    getValueAt(i, 5)).append("\";\"").append(
                                    tabMode2.getValueAt(i, 6)).append("\";\"").
                                    append(tabMode2.getValueAt(i, 7)).append(
                                    "\";\"").append(tabMode2.getValueAt(i, 8)).
                                    append("\";\"").append(tabMode2.
                                    getValueAt(i, 9)).append("\"\n");
                        }
                    }
                    ...
                    if (TabRawat.getSelectedIndex() == 0) {
                        if (tabMode.getRowCount() > 0) {
                            for (int r = 0; r < tabMode.getRowCount(); r++) {
                                if (!table1.getValueAt(r, 0).toString().
                                        contains(">>")) {
                                    Sequel.menyimpan("temporary",
                                            "'" + r + "','"
                                            + tabMode.getValueAt(r, 0).
                                                    toString() + "','"
                                            + tabMode.getValueAt(r, 1).
                                                    toString() + "','"
                                            + tabMode.getValueAt(r, 2).
                                                    toString() + "','"
                                            + tabMode.getValueAt(r, 3).
                                                    toString() + "','"
                                            + tabMode.getValueAt(r, 4).
                                                    toString() + "','"
                                            + tabMode.getValueAt(r, 5).
                                                    toString() + "','"
                                            + tabMode.getValueAt(r, 6).
                                                    toString() + "','"
                                            + tabMode.getValueAt(r, 7).
                                                    toString() + "','"
                                            + tabMode.getValueAt(r, 8).
                                                    toString() + "','"
                                            + tabMode.getValueAt(r, 9).
                                                    toString() + "','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
                                                    getalamatip() + "'",
                                            "Rekap Nota Pembayaran");
                                }
                            }
                            Valid.MyReportqry("rptKunjunganRalan.jasper",
                                    "report",
                        ...
                        if (tabMode2.getRowCount() > 0) {
                            for (int r = 0; r < tabMode2.getRowCount(); r++) {
                                if (!table2.getValueAt(r, 0).toString().
                                        contains(">>")) {
                                    Sequel.menyimpan("temporary",
                                            "'" + r + "','"
                                            + tabMode2.getValueAt(r, 0).
                                                    toString() + "','"
                                            + tabMode2.getValueAt(r, 1).
                                                    toString() + "','"
                                            + tabMode2.getValueAt(r, 2).
                                                    toString() + "','"
                                            + tabMode2.getValueAt(r, 3).
                                                    toString() + "','"
                                            + tabMode2.getValueAt(r, 4).
                                                    toString() + "','"
                                            + tabMode2.getValueAt(r, 5).
                                                    toString() + "','"
                                            + tabMode2.getValueAt(r, 6).
                                                    toString() + "','"
                                            + tabMode2.getValueAt(r, 7).
                                                    toString() + "','"
                                            + tabMode2.getValueAt(r, 8).
                                                    toString() + "','"
                                            + tabMode2.getValueAt(r, 9).
                                                    toString() + "','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
                                                    getalamatip() + "'",
                                            "Rekap Nota Pembayaran");
                                }
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void BtnExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnExcelActionPerformed
        if (TabRawat.getSelectedIndex() == 0) {
            Valid.exportToExcel(table1);
        } else if (TabRawat.getSelectedIndex() == 1) {
            Valid.exportToExcel(table2);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKunjunganMarketing dialog = new DlgKunjunganMarketing(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        try {
            ...
            if (nmpoli.getText().trim().isEmpty() && nmdokter.getText().trim().isEmpty()
                ...
                ps = koneksi
                        .prepareStatement("select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.stts_daftar,"
                                + "dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,"
                                + "pasien.alamat as almt_pj,kelurahan.nm_kel,kecamatan.nm_kec,kabupaten.nm_kab,pasien.tmp_lahir,pasien.tgl_lahir,pasien.no_tlp,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) as umur,pasien.tgl_daftar,reg_periksa.status_lanjut,penjab.png_jawab "
                ...
                ps = koneksi
                        .prepareStatement("select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.stts_daftar,"
                                ...
                                + "and reg_periksa.kd_poli=poliklinik.kd_poli and pasien.kd_kab=kabupaten.kd_kab and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel "
                                + "where reg_periksa.stts_daftar like '%" + status
                                + "%' and reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and "
            ...
            try {
                ...
                i = 1;
                while (rs.next()) {
                    tabMode.addRow(new Object[]{i, rs.getString("tgl_registrasi"), rs.getString("nm_dokter"),
                        rs.getString("nm_poli"), rs.getString("nm_pasien"), rs.getString("jk"),
                        rs.getString("tmp_lahir"), rs.getString("tgl_lahir"), rs.getString("almt_pj"),
                        rs.getString("nm_kel"), rs.getString("nm_kec"), rs.getString("nm_kab"),
                        rs.getString("no_tlp"), rs.getString("status_lanjut"), rs.getString("png_jawab"),
    ...
    public void tampil2() {
        try {
            ...
            if (nmpoli.getText().trim().isEmpty() && nmdokter.getText().trim().isEmpty()
                ...
                ps = koneksi
                        .prepareStatement("select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.stts_daftar,"
                                ...
                                + "and reg_periksa.kd_poli=poliklinik.kd_poli and pasien.kd_kab=kabupaten.kd_kab and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel "
                                + "where reg_periksa.stts_daftar like '%" + status
                                + "%' and reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? order by reg_periksa.tgl_registrasi,reg_periksa.jam_reg");
            } else {
                ps = koneksi
                        .prepareStatement("select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.stts_daftar,"
                                + "dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,"
                                ...
                                + "and reg_periksa.kd_poli=poliklinik.kd_poli and pasien.kd_kab=kabupaten.kd_kab and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel "
                                + "where reg_periksa.stts_daftar like '%" + status
                                + "%' and reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and "
                                + "(poliklinik.nm_poli like ? or dokter.nm_dokter like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or pasien.alamat like ?) order by reg_periksa.tgl_registrasi,reg_periksa.jam_reg");
            }
            ...
            try {
                ...
                i = 1;
                while (rs.next()) {
                    tabMode2.addRow(new Object[]{i, rs.getString("tgl_registrasi"), rs.getString("nm_dokter"),
                        rs.getString("nm_poli"), rs.getString("nm_pasien"), rs.getString("jk"),
                        rs.getString("tmp_lahir"), rs.getString("tgl_lahir"), rs.getString("almt_pj"),
                        rs.getString("nm_kel"), rs.getString("nm_kec"), rs.getString("nm_kab"),
                        rs.getString("no_tlp"), rs.getString("status_lanjut"), rs.getString("png_jawab"),
    ...
    private static final Logger LOG = Logger.getLogger(DlgKunjunganMarketing.class.getName());
