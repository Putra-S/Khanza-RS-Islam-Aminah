...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCekEntryRalan dialog = new DlgCekEntryRalan(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tnddokter = Sequel.cariInteger(
                            "select count(distinct no_rawat) from rawat_jl_dr where tgl_perawatan=? ",
                            rs.getString(1));
                    ttltnddokter += tnddokter;
                    tndpetugas = Sequel.cariInteger(
                            "select count(distinct no_rawat) from rawat_jl_pr where tgl_perawatan=? ",
                            rs.getString(1));
                    ...
                    billing = Sequel.cariInteger(
                            "select count(distinct no_rawat) from nota_jalan where tanggal=?",
                            rs.getString(1));
                    ttlbilling += billing;
                    tabMode.addRow(new Object[]{
                        rs.getString(1), rs.getString(2), kamarinap, tnddokter,
                        tndpetugas,
                        tnddrpr, pemeriksaan, laborat, radiologi, operasi, obat,
                        diagnosa,
                        prosedur, billing
                    });
                }
                tabMode.addRow(new Object[]{
                    "Total :", ttlregistrasi, ttlkamarinap, ttltnddokter,
                    ttltndpetugas,
                    ttltnddrpr, ttlpemeriksaan, ttllaborat, ttlradiologi,
                    ttloperasi,
    ...
    private static final Logger LOG = Logger.getLogger(DlgCekEntryRalan.class.
            getName());
