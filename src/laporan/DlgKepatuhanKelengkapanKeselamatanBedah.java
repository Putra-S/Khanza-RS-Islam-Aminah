                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        ...
                        bw.write("<html>"
                                ...
                                getemailrs() + "<br><br>"
                                + "<font size='2' face='Tahoma'>REKAP KEPATUHAN KELENGKAPAN KESELAMATAN BEDAH PERIODE " + Tgl1.
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKepatuhanKelengkapanKeselamatanBedah dialog = new DlgKepatuhanKelengkapanKeselamatanBedah(
    ...
    public void tampil() {
        try {
            ...
            try {
                ...
                adaSignInSebelumAnestesi = 0;
                tidakadaSignInSebelumAnestesi = 0;
                adaTimeOutSebelumInsisi = 0;
                kelengkapan = 0;
                tidakadaTimeOutSebelumInsisi = 0;
                adaSignOutSebelumMenutupLuka = 0;
                tidakadaSignOutSebelumMenutupLuka = 0;
                ...
                while (rs.next()) {
                    jumlahlengkap = 0;
                    CheckListPreOperasi = Sequel.cariIsi(
                            "select if(count(checklist_pre_operasi.no_rawat)>0,'Ada','Tidak Ada') from checklist_pre_operasi where checklist_pre_operasi.no_rawat=?",
                    ...
                    SignInSebelumAnestesi = Sequel.cariIsi(
                            "select if(count(signin_sebelum_anestesi.no_rawat)>0,'Ada','Tidak Ada') from signin_sebelum_anestesi where signin_sebelum_anestesi.no_rawat=?",
                            rs.getString("no_rawat"));
                    ...
                    TimeOutSebelumInsisi = Sequel.cariIsi(
                            "select if(count(timeout_sebelum_insisi.no_rawat)>0,'Ada','Tidak Ada') from timeout_sebelum_insisi where timeout_sebelum_insisi.no_rawat=?",
                            rs.getString("no_rawat"));
                    ...
                    SignOutSebelumMenutupLuka = Sequel.cariIsi(
                            "select if(count(signout_sebelum_menutup_luka.no_rawat)>0,'Ada','Tidak Ada') from signout_sebelum_menutup_luka where signout_sebelum_menutup_luka.no_rawat=?",
                            rs.getString("no_rawat"));
                    ...
                    CheckListPostOperasi = Sequel.cariIsi(
                            "select if(count(checklist_post_operasi.no_rawat)>0,'Ada','Tidak Ada') from checklist_post_operasi where checklist_post_operasi.no_rawat=?",
                            rs.getString("no_rawat"));
