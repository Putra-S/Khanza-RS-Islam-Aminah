...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRekapRadiologiPerTahun dialog = new DlgRekapRadiologiPerTahun(
            ...
            try {
                ...
                while (rs.next()) {
                    jan = Sequel.cariInteger(
                            ...
                            rs.getString("kd_jenis_prw"), "%" + ThnCari.
                            getSelectedItem() + "-01%");
                    ...
                    tabMode.addRow(new String[]{
                        i + "", rs.getString("kd_jenis_prw") + " " + rs.
                        getString("nm_perawatan"), jan + "", feb + "", mar + "",
                        apr + "", mei + "", jun + "", jul + "", agu + "",
                        sep + "", okt + "", nov + "", des + "",
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgRekapRadiologiPerTahun.class.getName());
