...
public class DlgKIPPasienRanap extends javax.swing.JDialog {
    ...
    private int hr0s6l = 0, hr0s6p = 0, hr7s28l = 0, hr7s28p = 0, hr28s1thl = 0, hr28s1thp = 0, th1s4l = 0, th1s4p = 0,
            ...
            th45s64p = 0, lbth65l = 0, lbth65p = 0, matilb48 = 0, matikr48 = 0, pulang = 0, aps = 0, lari = 0,
            rujuk = 0, jamdiff = 0;

    private String sthr0s6l = "", sthr0s6p = "", sthr7s28l = "", sthr7s28p = "", sthr28s1thl = "", sthr28s1thp = "",
            stth1s4l = "", stth1s4p = "", stth5s14l = "", stth5s14p = "", stth15s24l = "", stth15s24p = "",
            stth25s44l = "", stth25s44p = "", stth45s64l = "", stth45s64p = "", stlbth65l = "", stlbth65p = "",
            stmatilb48 = "", stmatikr48 = "", stpulang = "", staps = "", stlari = "", strujuk = "", diagnosa = "",
            tglkeluar = "", lamainap = "";
...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    private void prosesCari() {
        ...
        try {
            ...
            htmlContent.append("<tr class='isi'>"
                    ...
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>&rsaquo;&nbsp;64</td>" + "</tr>"
                    ...
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center'>&lsaquo;&nbsp;48&nbsp;JAM</td>" + "</tr>");
                    ...
                    try {
                        ...
                        if (rs2.next()) {
                            ...
                            if (rs2.getString("stts_pulang").equals("Sehat")) {
                                ...
                                jamdiff = Sequel
                                        .cariInteger("SELECT TIMESTAMPDIFF(HOUR,'" + rs.getString("tgl_registrasi") + " "
            ...
            if ((i - 1) > 0) {
                htmlContent.append(
                        ...
                        .append("</td><td valign='middle' align='center'>")
                        .append(lbth65p)
                        .append("</td><td valign='middle' align='center'></td><td valign='middle' align='center'>")
                        .append(pulang)
                        .append("</td><td valign='middle' align='center'>")
                        .append(aps)
                        .append("</td><td valign='middle' align='center'>")
    ...
    private static final Logger LOG = Logger.getLogger(DlgKIPPasienRanap.class.getName());
