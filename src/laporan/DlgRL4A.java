...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    ps3 = koneksi.prepareStatement(
                            "select count(reg_periksa.no_rkm_medis) "
                            + "from diagnosa_pasien inner join reg_periksa inner join pasien inner join kamar_inap "
                            + "on reg_periksa.no_rawat=diagnosa_pasien.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                            + "and kamar_inap.no_rawat=reg_periksa.no_rawat where diagnosa_pasien.status='Ranap' and kamar_inap.stts_pulang='Meninggal' "
                            + "and reg_periksa.tgl_registrasi between ? and ? and diagnosa_pasien.kd_penyakit=? "
                    ...
                    htmlContent.append(
                            ...
                            "</td><td valign='middle' align='center'>").append(
                                    hr0s6l + hr7s28l + hr28s1thl + th1s4l + th5s14l + th15s24l + th25s44l + th45s64l + lbth65l).
                            append("</td><td valign='middle' align='center'>").
                            append(hr0s6p + hr7s28p + hr28s1thp + th1s4p + th5s14p + th15s24p + th25s44p + th45s64p + lbth65p).
                            append("</td><td valign='middle' align='center'>").
    ...
    private static final Logger LOG = Logger.getLogger(DlgRL4A.class.getName());
