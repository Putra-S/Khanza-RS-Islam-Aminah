        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    ps3 = koneksi.prepareStatement("select count(reg_periksa.no_rkm_medis) "
                    ...
                    htmlContent.append("<tr class='isi'><td valign='middle' align='center'>")
                            ...
                            .append(hr0s6l + hr7s28l + hr28s1thl + th1s4l + th5s14l + th15s24l + th25s44l + th45s64l
                                    + lbth65l)
                            .append("</td><td valign='middle' align='center'>")
                            .append(hr0s6p + hr7s28p + hr28s1thp + th1s4p + th5s14p + th15s24p + th25s44p + th45s64p
                                    + lbth65p)
                            .append("</td><td valign='middle' align='center'>")
                            .append(hr0s6l + hr7s28l + hr28s1thl + th1s4l + th5s14l + th15s24l + th25s44l + th45s64l
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    ps3 = koneksi.prepareStatement("select count(pasien_mati.no_rkm_medis) "
