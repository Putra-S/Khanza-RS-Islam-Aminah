...
public class DlgBulananHAIs extends javax.swing.JDialog {
    ...
    private int deku = 0, urine = 0, sputum = 0, darah = 0, antibiotik = 0, pasien = 0, jmlpasien = 0, ETT = 0, CVL = 0,
            IVL = 0, UC = 0, VAP = 0, IAD = 0, PLEB = 0, ISK = 0, ILO = 0, ANTIBIOTIK = 0, jmlHAP, jmlTinea, jmlScabies,
            jmlETT, jmlCVL, jmlIVL, jmlUC, jmlVAP, jmlIAD, jmlPLEB, jmlISK, HAP, Tinea, Scabies, jmlILO, jmldeku,
            jmlsputum, jmldarah, jmlurine, jmlANTIBIOTIK;
...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
            ...
            try {
                ...
                while (rs.next()) {
                    pasien = Sequel.cariInteger(
                            ...
                            rs.getString("tanggal"), "%" + NmKamar.getText().trim() + "%",
                            "%" + NmPenjab.getText().trim() + "%");
                    jmlpasien += pasien;
                    ETT = Sequel.cariInteger(
    ...
    private static final Logger LOG = Logger.getLogger(DlgBulananHAIs.class.getName());
