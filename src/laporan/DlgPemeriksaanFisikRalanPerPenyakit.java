...
public class DlgPemeriksaanFisikRalanPerPenyakit extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgPemeriksaanFisikRalanPerPenyakit(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ...
            try (BufferedWriter bw = new BufferedWriter(new FileWriter(f))) {
                bw.write(LoadHTML.getText().replaceAll("<head>",
                        ...
                        getemailrs() + "<br><br>"
                        + "<font size='2' face='Tahoma'>PEMERIKSAAN FISIK PASIEN RAWAT JALAN PERIODE " + Tgl1.
...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPemeriksaanFisikRalanPerPenyakit dialog = new DlgPemeriksaanFisikRalanPerPenyakit(
            ...
            try {
                ...
                while (rs.next()) {
                    htmlContent.append("<tr class='isi'><td align='left'>").
                            ...
                            "</td><td align='center'>").append(rs.getString(
                                    "no_ktp")).
                            append("</td><td align='center'>").append(
                            kdpenyakit.getText()).append(
                            "</td><td align='center'>").append(rs.getString(
                                    "tinggi")).
                            append("</td><td align='center'>").append(rs.
                            getString("berat")).append(
                            "</td><td align='center'>").append(rs.getString(
                                    "lingkar_perut")).append(
                                    "</td><td align='center'>").append(rs.
                                    getString("tensi")).append(
                            "</td><td align='center'>").append(rs.getString(
                                    "tmp_lahir")).append(
                                    "</td><td align='center'>").append(rs.
                            ...
                            "</td><td align='center'>").append(rs.getString(
                                    "pekerjaan")).append(
                                    "</td><td align='left'>").append(rs.
                                    getString("alamat")).append(
                            "</td><td align='center'>").append(rs.getString(
                                    "no_rkm_medis")).append(
                                    "</td><td align='center'>").append(rs.
                                    getString("tgl_registrasi")).append(
                            "</td></tr>");
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgPemeriksaanFisikRalanPerPenyakit.class.getName());
