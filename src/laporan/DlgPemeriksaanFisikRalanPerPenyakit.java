...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    private void prosesCari() {
        ...
        try {
            ...
            htmlContent.append("<tr class='isi'>"
                    ...
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='5%'>REGISTRASI</td>" + "</tr>");
            ...
            try {
                ...
                while (rs.next()) {
                    htmlContent.append("<tr class='isi'><td align='left'>")
                            ...
                            .append("</td><td align='center'>")
                            .append(kdpenyakit.getText())
                            .append("</td><td align='center'>")
                            .append(rs.getString("tinggi"))
                            .append("</td><td align='center'>")
                            .append(rs.getString("berat"))
                            .append("</td><td align='center'>")
                            .append(rs.getString("lingkar_perut"))
                            .append("</td><td align='center'>")
                            .append(rs.getString("tensi"))
                            .append("</td><td align='center'>")
                            .append(rs.getString("tmp_lahir"))
                            .append("</td><td align='center'>")
                            .append(rs.getString("tgl_lahir"))
                            .append("</td><td align='center'>")
                            .append(rs.getString("pekerjaan"))
    ...
    private static final Logger LOG = Logger.getLogger(DlgPemeriksaanFisikRalanPerPenyakit.class.getName());
