...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBulananKlasifikasiPasienRanap dialog = new DlgBulananKlasifikasiPasienRanap(new javax.swing.JFrame(),
                    true);
    ...
    private static final Logger LOG = Logger.getLogger(DlgBulananKlasifikasiPasienRanap.class.getName());
