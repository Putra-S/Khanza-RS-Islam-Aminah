        ...
        try {
            ...
            try (BufferedWriter bw = new BufferedWriter(new FileWriter(f))) {
                bw.write(LoadHTML.getText().replaceAll("<head>",
                        ...
                        getemailrs() + "<br><br>"
                        + "<font size='2' face='Tahoma'>DATA SASARAN USIA LANSIA<br>TAHUN " + ThnCari.
                        ...
                        + "<td valign='middle' width='35%'>: " + nmkabupaten.
                                getText() + "</td>"
                        + "<td valign='middle' width='15%'>Layanan</td>"
                        + "<td valign='middle' width='35%'> : " + nmpoli.
                                getText() + "</td>"
                        + "</tr>"
                        + "<tr class='isi2'>"
                        + "<td valign='middle' width='15%'>Kecamatan</td>"
                        + "<td valign='middle' width='35%'>: " + nmkecamatan.
                                getText() + "</td>"
                        + "<td valign='middle' width='15%'>Dokter</td>"
                        + "<td valign='middle' width='35%'> : " + nmdokter.
                                getText() + "</td>"
                        + "</tr>"
                        + "<tr class='isi2'>"
                        + "<td valign='middle' width='15%'>Kelurahan</td>"
                        + "<td valign='middle' width='35%'>: " + nmkelurahan.
                                getText() + "</td>"
                        + "<td valign='middle' width='15%'>Cara Bayar</td>"
                        + "<td valign='middle' width='35%'> : " + nmpenjab.
                                getText() + "</td>"
                        + "</tr>"
                        + "</table><br>")
                );
...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDataSasaranUsiaLansia dialog = new DlgDataSasaranUsiaLansia(
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgDataSasaranUsiaLansia.class.getName());
}
