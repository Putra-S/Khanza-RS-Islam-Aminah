 ...
 * @author perpustakaan
 */
public class DlgDkkSurveilansRalan extends javax.swing.JDialog {
    ...
    public DlgDkkSurveilansRalan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr = {"No.", "Kode ICD 10", "Jenis Penyakit", "0-7 Hr", "8-28 Hr", "< 1", "1-4", "5-9",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptSurveilansRalan.jasper", "report",
                    "::[ Surveilans PD3I ]::",
...
private void BtnCari1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCari1KeyPressed
            ...
            while (rs.next()) {
                ...
                while (rs2.next()) {
                    ...
                    if (Sequel.cariInteger(
                            ...
                            + "diagnosa_pasien.status='Ralan' and reg_periksa.tgl_registrasi between '"
                            + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and " + "'"
                            + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and diagnosa_pasien.kd_penyakit='"
                            + rs.getString("kd_penyakit") + "' " + "and reg_periksa.no_rkm_medis='"
                            + rs2.getString("no_rkm_medis") + "'") == 1) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgDkkSurveilansRalan.class.getName());
