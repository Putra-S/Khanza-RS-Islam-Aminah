...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgHarianKlasifikasiPasienRanap dialog = new DlgHarianKlasifikasiPasienRanap(new javax.swing.JFrame(),
                    true);
    ...
    private void prosesCari() {
        ...
        try {
            ...
            htmlContent.append("<tr class='isi'>"
                    ...
                    + "</tr>" + "<tr class='isi'>" + "<td valign='middle' bgcolor='#FFFAFA' align='center'>Minimal</td>"
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center'>Partial</td>"
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center'>Total</td>" + "</tr>");
    ...
    private static final Logger LOG = Logger.getLogger(DlgHarianKlasifikasiPasienRanap.class.getName());
