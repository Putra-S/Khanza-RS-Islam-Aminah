 ...
 * @author perpustakaan
 */
public class DlgKunjunganRadRalan extends javax.swing.JDialog {
    ...
    public DlgKunjunganRadRalan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr = {"No.", "Tanggal & Jam", "No.Radiologi", "No.RM", "Nama Pasien", "L", "P", "Alamat",
            "Kode", "Diagnosa", "Pemeriksaan", "Dokter Perujuk/Pengirim", "Asal Poli"};
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptKunjunganRadRalan.jasper", "report",
                    "::[ Laporan Kunjungan Radiologi Rawat Jalan ]::",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public void tampil() {
        try {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + "where periksa_radiologi.status='Ralan' and periksa_radiologi.tgl_periksa between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.kd_pj like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and poliklinik.nm_poli like ? or "
                    + "periksa_radiologi.status='Ralan' and periksa_radiologi.tgl_periksa between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.kd_pj like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and dokter.nm_dokter like ? or "
                    + "periksa_radiologi.status='Ralan' and periksa_radiologi.tgl_periksa between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.kd_pj like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and reg_periksa.no_rkm_medis like ? or "
                    + "periksa_radiologi.status='Ralan' and periksa_radiologi.tgl_periksa between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.kd_pj like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.nm_pasien like ? or "
                    + "periksa_radiologi.status='Ralan' and periksa_radiologi.tgl_periksa between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? and penjab.kd_pj like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? and pasien.alamat like ? "
    ...
    private static final Logger LOG = Logger.getLogger(DlgKunjunganRadRalan.class.getName());
