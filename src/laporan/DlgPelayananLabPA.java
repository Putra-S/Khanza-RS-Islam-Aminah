 ...
 * @author perpustakaan
 */
public class DlgPelayananLabPA extends javax.swing.JDialog {
    ...
    public DlgPelayananLabPA(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "No.", "No.RM", "Nama Pasien", "Dokter Perujuk", "No.Order",
            "Jam Permintaan", "Jam Sampel",
            "Jam Hasil", "Permintaan-Sampel(m)", "Sampel-Hasil(m)",
            "Permintaan-Hasil(m)"
        }) {
            @Override
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("tanggal", Tgl1.getSelectedItem() + " s.d. " + Tgl2.
                    getSelectedItem());
            ...
            Valid.MyReport("rptPelayananLab.jasper", "report",
                    "::[ Laporan Lama Pelayanan Laboratorium ]::", param);
        }
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPelayananLabPA dialog = new DlgPelayananLabPA(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        ...
                        "jam_sampel"), rs.getString("tgl_hasil") + " " + rs.
                        getString("jam_hasil"),
                        rs.getString("permintaansampel"), rs.getString(
                        "sampelhasil"), rs.getString("permintaanhasil")
                    });
                    i++;
                    lamajam += rs.getDouble("permintaansampel");
                    if (rs.getDouble("permintaansampel") <= 15) {
                        limabelas++;
                    } else if ((rs.getDouble("permintaansampel") > 15) && (rs.
                            getDouble("permintaansampel") <= 30)) {
                        tigapuluh++;
                    } else if ((rs.getDouble("permintaansampel") > 30) && (rs.
                            getDouble("permintaansampel") <= 60)) {
                        satujam++;
                    ...
                    if (rs.getDouble("sampelhasil") <= 15) {
                        limabelas2++;
                    } else if ((rs.getDouble("sampelhasil") > 15) && (rs.
                            getDouble("sampelhasil") <= 30)) {
                        tigapuluh2++;
                    } else if ((rs.getDouble("sampelhasil") > 30) && (rs.
                            getDouble("sampelhasil") <= 60)) {
                        satujam2++;
                    ...
                    if (rs.getDouble("permintaanhasil") <= 15) {
                        limabelas3++;
                    } else if ((rs.getDouble("permintaanhasil") > 15) && (rs.
                            getDouble("permintaanhasil") <= 30)) {
                        tigapuluh3++;
                    } else if ((rs.getDouble("permintaanhasil") > 30) && (rs.
                            getDouble("permintaanhasil") <= 60)) {
                        satujam3++;
                ...
                if (lamajam > 0) {
                    tabMode.addRow(new Object[]{
                        "", "", "Rata-rata (Menit)", ": ", "", "", "", "",
                        "" + Valid.SetAngka6(lamajam / (i - 1)), "" + Valid.
                        SetAngka6(lamajam2 / (i - 1)), "" + Valid.SetAngka6(
                        lamajam3 / (i - 1))
                    });
                    tabMode.addRow(new Object[]{
                        "", "", "0 - 15 Menit", ": ", "", "", "", "",
                        "" + limabelas, "" + limabelas2, "" + limabelas3
                    });
                    tabMode.addRow(new Object[]{
                        "", "", ">15 - <=30 Menit", ": ", "", "", "", "",
                        "" + tigapuluh, "" + tigapuluh2, "" + tigapuluh3
                    });
                    tabMode.addRow(new Object[]{
                        "", "", ">30 - <=60 Menit", ": ", "", "", "", "",
                        "" + satujam, "" + satujam2, "" + satujam3
                    });
                    tabMode.addRow(new Object[]{
                        "", "", ">60 Menit", ": ", "", "", "", "",
                        "" + lebihsatujam, "" + lebihsatujam2,
                        "" + lebihsatujam3
                    });
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgPelayananLabPA.class.
            getName());
