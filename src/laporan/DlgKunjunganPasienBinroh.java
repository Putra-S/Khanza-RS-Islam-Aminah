 ...
 * @author perpustakaan
 */
public class DlgKunjunganPasienBinroh extends javax.swing.JDialog {
    ...
    private String kddiagnosa = "", diagnosa = "", dokterdpjp = "", status = "", usia = "", subjek = "", objek = "",
            plan = "", evaluasi = "", dialog_simpan = "";
     ...
     * @param modal
     */
    public DlgKunjunganPasienBinroh(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(8, 1);
        setSize(885, 674);
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Tgl.Masuk", "Nama Pasien", "Jenis Kelamin",
            "Tanggal Lahir", "Usia", "Alamat Domisili", "Kelurahan", "Kecamatan", "Kota/Kab"}) {
            @Override
        ...
        tabMode2 = new DefaultTableModel(null, new String[]{"No.", "Tgl.Masuk", "Nama Pasien", "Jenis Kelamin",
            "Tanggal Lahir", "Usia", "Alamat Domisili", "Kelurahan", "Kecamatan", "Kota/Kab"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Kunjungan Binroh ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
...
//                try{
//                    ps2=koneksi.prepareStatement("select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.no_rkm_medis,pasien.nm_pasien,concat(pasien.alamat,',',kelurahan.nm_kel,',',kecamatan.nm_kec,',',kabupaten.nm_kab) as alamat,pasien.jk,DATE_FORMAT(pasien.tgl_lahir, '%d-%m-%Y') as tgl_lahir,"+
//                    "kelurahan.nm_kel,kecamatan.nm_kec,kabupaten.nm_kab,DATE_FORMAT(kamar_inap.tgl_masuk, '%d-%m-%Y') as tgl_masuk,kamar_inap.tgl_keluar "+
...
//                    "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and kamar_inap.stts_pulang<>'Pindah Kamar' and reg_periksa.tgl_registrasi between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and bangsal.nm_bangsal like '"+"%"+nmkamar.getText().trim()+"%"+"' and penjab.png_jawab like '"+"%"+nmpenjab.getText().trim()+"%"+"' and kabupaten.nm_kab like '"+"%"+nmkabupaten.getText().trim()+"%"+"' and kecamatan.nm_kec like '"+"%"+nmkecamatan.getText().trim()+"%"+"' and kelurahan.nm_kel like '"+"%"+nmkelurahan.getText().trim()+"%"+"' and pasien.alamat like '"+"%"+TCari.getText().trim()+"%"+"' or "+
//                    "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and kamar_inap.stts_pulang<>'Pindah Kamar' and reg_periksa.tgl_registrasi between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and bangsal.nm_bangsal like '"+"%"+nmkamar.getText().trim()+"%"+"' and penjab.png_jawab like '"+"%"+nmpenjab.getText().trim()+"%"+"' and kabupaten.nm_kab like '"+"%"+nmkabupaten.getText().trim()+"%"+"' and kecamatan.nm_kec like '"+"%"+nmkecamatan.getText().trim()+"%"+"' and kelurahan.nm_kel like '"+"%"+nmkelurahan.getText().trim()+"%"+"' and pasien.nm_pasien like '"+"%"+TCari.getText().trim()+"%"+"' or "+
//                    "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and kamar_inap.stts_pulang<>'Pindah Kamar' and reg_periksa.tgl_registrasi between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and bangsal.nm_bangsal like '"+"%"+nmkamar.getText().trim()+"%"+"' and penjab.png_jawab like '"+"%"+nmpenjab.getText().trim()+"%"+"' and kabupaten.nm_kab like '"+"%"+nmkabupaten.getText().trim()+"%"+"' and kecamatan.nm_kec like '"+"%"+nmkecamatan.getText().trim()+"%"+"' and kelurahan.nm_kel like '"+"%"+nmkelurahan.getText().trim()+"%"+"' and dokter.nm_dokter like '"+"%"+TCari.getText().trim()+"%"+"' or "+
//                    "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and kamar_inap.stts_pulang<>'Pindah Kamar' and reg_periksa.tgl_registrasi between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and bangsal.nm_bangsal like '"+"%"+nmkamar.getText().trim()+"%"+"' and penjab.png_jawab like '"+"%"+nmpenjab.getText().trim()+"%"+"' and kabupaten.nm_kab like '"+"%"+nmkabupaten.getText().trim()+"%"+"' and kecamatan.nm_kec like '"+"%"+nmkecamatan.getText().trim()+"%"+"' and kelurahan.nm_kel like '"+"%"+nmkelurahan.getText().trim()+"%"+"' and reg_periksa.no_rkm_medis like '"+"%"+TCari.getText().trim()+"%"+"' or "+
//                    "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and kamar_inap.stts_pulang<>'Pindah Kamar' and reg_periksa.tgl_registrasi between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and bangsal.nm_bangsal like '"+"%"+nmkamar.getText().trim()+"%"+"' and penjab.png_jawab like '"+"%"+nmpenjab.getText().trim()+"%"+"' and kabupaten.nm_kab like '"+"%"+nmkabupaten.getText().trim()+"%"+"' and kecamatan.nm_kec like '"+"%"+nmkecamatan.getText().trim()+"%"+"' and kelurahan.nm_kel like '"+"%"+nmkelurahan.getText().trim()+"%"+"' and kamar_inap.kd_kamar like '"+"%"+TCari.getText().trim()+"%"+"' "+
...
//                            cell.setCellValue(rs2.getMetaData().getColumnName(i));
//                        }
//
//                        int rowNum = 1;
//                        while (rs2.next()) {
...
//                        }
//
//                        try (FileOutputStream fileOut = new FileOutputStream("KunjunganBinroh.xlsx")) {
...
//                Valid.MyReportqryExcel("select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.no_rkm_medis,pasien.nm_pasien,concat(pasien.alamat,',',kelurahan.nm_kel,',',kecamatan.nm_kec,',',kabupaten.nm_kab) as alamat,pasien.jk,DATE_FORMAT(pasien.tgl_lahir, '%d-%m-%Y') as tgl_lahir,"+
//                    "kelurahan.nm_kel,kecamatan.nm_kec,kabupaten.nm_kab,DATE_FORMAT(kamar_inap.tgl_masuk, '%d-%m-%Y') as tgl_masuk,kamar_inap.tgl_keluar "+
//                    "from reg_periksa inner join pasien inner join kamar_inap inner join kamar inner join bangsal inner join dokter inner join penjab " +
//                    "inner join kabupaten inner join kecamatan inner join kelurahan on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.no_rawat=kamar_inap.no_rawat "+
//                    "and reg_periksa.kd_pj=penjab.kd_pj and pasien.kd_kab=kabupaten.kd_kab and kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal "+
...
//                    "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and kamar_inap.stts_pulang<>'Pindah Kamar' and reg_periksa.tgl_registrasi between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and bangsal.nm_bangsal like '"+"%"+nmkamar.getText().trim()+"%"+"' and penjab.png_jawab like '"+"%"+nmpenjab.getText().trim()+"%"+"' and kabupaten.nm_kab like '"+"%"+nmkabupaten.getText().trim()+"%"+"' and kecamatan.nm_kec like '"+"%"+nmkecamatan.getText().trim()+"%"+"' and kelurahan.nm_kel like '"+"%"+nmkelurahan.getText().trim()+"%"+"' and reg_periksa.no_rkm_medis like '"+"%"+TCari.getText().trim()+"%"+"' or "+
//                    "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and kamar_inap.stts_pulang<>'Pindah Kamar' and reg_periksa.tgl_registrasi between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and bangsal.nm_bangsal like '"+"%"+nmkamar.getText().trim()+"%"+"' and penjab.png_jawab like '"+"%"+nmpenjab.getText().trim()+"%"+"' and kabupaten.nm_kab like '"+"%"+nmkabupaten.getText().trim()+"%"+"' and kecamatan.nm_kec like '"+"%"+nmkecamatan.getText().trim()+"%"+"' and kelurahan.nm_kel like '"+"%"+nmkelurahan.getText().trim()+"%"+"' and kamar_inap.kd_kamar like '"+"%"+TCari.getText().trim()+"%"+"' "+
//                    "group by reg_periksa.no_rawat order by reg_periksa.tgl_registrasi", dialog_simpan);
//
                exportTable(tbBangsal, "data.xlsx");

                JOptionPane.showMessageDialog(null,
                        "Data telah berhasil diexport menjadi file excel,..!!!");
            }
        } else if (TabRawat.getSelectedIndex() == 1) {
            if (tabMode.getRowCount() == 0) {
                JOptionPane.showMessageDialog(null,
...
//                dialog_simpan = Valid.openDialog();
//                Valid.MyReportqryExcel("select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.no_rkm_medis,pasien.nm_pasien,concat(pasien.alamat,',',kelurahan.nm_kel,',',kecamatan.nm_kec,',',kabupaten.nm_kab) as alamat,pasien.jk,DATE_FORMAT(pasien.tgl_lahir, '%d-%m-%Y') as tgl_lahir,"+
//                    "kelurahan.nm_kel,kecamatan.nm_kec,kabupaten.nm_kab,kamar_inap.tgl_keluar,kamar_inap.tgl_masuk "+
//                    "from reg_periksa inner join pasien inner join kamar_inap inner join kamar inner join bangsal inner join dokter inner join penjab " +
...
//                    "and reg_periksa.kd_dokter=dokter.kd_dokter and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kel=kelurahan.kd_kel where "+
//                    "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and kamar_inap.stts_pulang<>'Pindah Kamar' and kamar_inap.tgl_keluar between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and bangsal.nm_bangsal like '"+"%"+nmkamar.getText().trim()+"%"+"' and penjab.png_jawab like '"+"%"+nmpenjab.getText().trim()+"%"+"' and kabupaten.nm_kab like '"+"%"+nmkabupaten.getText().trim()+"%"+"' and kecamatan.nm_kec like '"+"%"+nmkecamatan.getText().trim()+"%"+"' and kelurahan.nm_kel like '"+"%"+nmkelurahan.getText().trim()+"%"+"' and pasien.alamat like '"+"%"+TCari.getText().trim()+"%"+"' or "+
//                    "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and kamar_inap.stts_pulang<>'Pindah Kamar' and kamar_inap.tgl_keluar between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and bangsal.nm_bangsal like '"+"%"+nmkamar.getText().trim()+"%"+"' and penjab.png_jawab like '"+"%"+nmpenjab.getText().trim()+"%"+"' and kabupaten.nm_kab like '"+"%"+nmkabupaten.getText().trim()+"%"+"' and kecamatan.nm_kec like '"+"%"+nmkecamatan.getText().trim()+"%"+"' and kelurahan.nm_kel like '"+"%"+nmkelurahan.getText().trim()+"%"+"' and pasien.nm_pasien like '"+"%"+TCari.getText().trim()+"%"+"' or "+
//                    "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and kamar_inap.stts_pulang<>'Pindah Kamar' and kamar_inap.tgl_keluar between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and bangsal.nm_bangsal like '"+"%"+nmkamar.getText().trim()+"%"+"' and penjab.png_jawab like '"+"%"+nmpenjab.getText().trim()+"%"+"' and kabupaten.nm_kab like '"+"%"+nmkabupaten.getText().trim()+"%"+"' and kecamatan.nm_kec like '"+"%"+nmkecamatan.getText().trim()+"%"+"' and kelurahan.nm_kel like '"+"%"+nmkelurahan.getText().trim()+"%"+"' and dokter.nm_dokter like '"+"%"+TCari.getText().trim()+"%"+"' or "+
//                    "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and kamar_inap.stts_pulang<>'Pindah Kamar' and kamar_inap.tgl_keluar between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and bangsal.nm_bangsal like '"+"%"+nmkamar.getText().trim()+"%"+"' and penjab.png_jawab like '"+"%"+nmpenjab.getText().trim()+"%"+"' and kabupaten.nm_kab like '"+"%"+nmkabupaten.getText().trim()+"%"+"' and kecamatan.nm_kec like '"+"%"+nmkecamatan.getText().trim()+"%"+"' and kelurahan.nm_kel like '"+"%"+nmkelurahan.getText().trim()+"%"+"' and reg_periksa.no_rkm_medis like '"+"%"+TCari.getText().trim()+"%"+"' or "+
//                    "reg_periksa.stts_daftar like '%"+status+"%' and reg_periksa.status_lanjut='Ranap' and reg_periksa.stts<>'Batal' and kamar_inap.stts_pulang<>'Pindah Kamar' and kamar_inap.tgl_keluar between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and bangsal.nm_bangsal like '"+"%"+nmkamar.getText().trim()+"%"+"' and penjab.png_jawab like '"+"%"+nmpenjab.getText().trim()+"%"+"' and kabupaten.nm_kab like '"+"%"+nmkabupaten.getText().trim()+"%"+"' and kecamatan.nm_kec like '"+"%"+nmkecamatan.getText().trim()+"%"+"' and kelurahan.nm_kel like '"+"%"+nmkelurahan.getText().trim()+"%"+"' and kamar_inap.kd_kamar like '"+"%"+TCari.getText().trim()+"%"+"' "+
//                    "group by reg_periksa.no_rawat order by kamar_inap.tgl_keluar", dialog_simpan);
//
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKunjunganPasienBinroh dialog = new DlgKunjunganPasienBinroh(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.no_rkm_medis,pasien.nm_pasien,concat(pasien.alamat,',',kelurahan.nm_kel,',',kecamatan.nm_kec,',',kabupaten.nm_kab) as alamat,pasien.jk,DATE_FORMAT(pasien.tgl_lahir, '%d-%m-%Y') as tgl_lahir,"
                    + "kelurahan.nm_kel,kecamatan.nm_kec,kabupaten.nm_kab,DATE_FORMAT(kamar_inap.tgl_masuk, '%d-%m-%Y') as tgl_masuk,kamar_inap.tgl_keluar "
                    + "from reg_periksa inner join pasien inner join kamar_inap inner join kamar inner join bangsal inner join dokter inner join penjab "
                    + "inner join kabupaten inner join kecamatan inner join kelurahan on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.no_rawat=kamar_inap.no_rawat "
                    + "and reg_periksa.kd_pj=penjab.kd_pj and pasien.kd_kab=kabupaten.kd_kab and kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal "
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{i, rs.getString("tgl_masuk"), rs.getString("nm_pasien"),
                        rs.getString("jk"), rs.getString("tgl_lahir"),
                        String.valueOf(p.getYears()) + "Th " + String.valueOf(p.getMonths()) + "Bl "
    ...
    private void exportTable(JTable table, String filePath) {
        Workbook workbook = new XSSFWorkbook();
    ...
    private static final Logger LOG = Logger.getLogger(DlgKunjunganPasienBinroh.class.getName());
