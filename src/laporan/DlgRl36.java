 ...
 * @author perpustakaan
 */
public class DlgRl36 extends javax.swing.JDialog {
    ...
    public DlgRl36(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr = {"No.", "Spesialisasi", "Total", "Khusus", "Besar",
            "Sedang", "Kecil"};
        ...
        try {
            ...
            pscari = koneksi.prepareStatement(
                    "select count(operasi.kode_paket) from operasi where "
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRl36.jasper", "report",
                    "::[ Formulir RL 3.6 ]::",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
        ...
        try {
            ...
            while (rs.next()) {
                ...
                tabMode.addRow(new Object[]{
                    ...
                    (khusus + besar + sedang + kecil), khusus, besar, sedang,
                    kecil
                });
                i++;
            }
    ...
    private static final Logger LOG = Logger.getLogger(DlgRl36.class.getName());
