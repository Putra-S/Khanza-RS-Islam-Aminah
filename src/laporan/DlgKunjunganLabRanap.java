 ...
 * @author perpustakaan
 */
public class DlgKunjunganLabRanap extends javax.swing.JDialog {
    ...
    public DlgKunjunganLabRanap(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr = {"No.", "Tanggal & Jam", "No.Lab", "No.RM", "Nama Pasien", "L", "P", "Alamat", "Kode",
            "Diagnosa", "Jenis Pemeriksaan", "Dokter Perujuk/Pengirim", "Asal Ruang"};
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptKunjunganLabRanap.jasper", "report",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private static final Logger LOG = Logger.getLogger(DlgKunjunganLabRanap.class.getName());
