...
public class DlgHarianHAIs extends javax.swing.JDialog {
    ...
    private int i = 0, deku = 0, urine = 0, sputum = 0, darah = 0, antibiotik = 0, jmlETT, jmlCVL, jmlIVL, jmlUC,
            jmlVAP, jmlIAD, jmlPLEB, jmlISK, jmlILO, jmldeku, jmlsputum, jmlHAP, jmlTinea, jmlScabies, jmldarah,
            jmlurine, jmlANTIBIOTIK;
...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    private static final Logger LOG = Logger.getLogger(DlgHarianHAIs.class.getName());
