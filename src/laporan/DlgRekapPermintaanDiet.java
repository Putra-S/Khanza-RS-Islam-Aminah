...
public class DlgRekapPermintaanDiet extends javax.swing.JDialog {
    ...
    private int kolom = 0, i = 0, x = 0, jumlah = 0, k1 = 0, k2 = 0, k3 = 0, utama = 0, vip = 0, vvip = 0,
            totaljumlah = 0, jumlahtotalk1 = 0, jumlahtotalk2 = 0, jumlahtotalk3 = 0, jumlahtotalutama = 0,
            jumlahtotalvip = 0, jumlahtotalvvip = 0;

    private String tanggal = "01", stringk1 = "", stringk2 = "", stringk3 = "", stringutama = "", stringvip = "",
            stringvvip = "";
...
//GEN-FIRST:event_TKdKeyPressed
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    kolom++;
                    htmlContent
                            .append("<td valign='middle' bgcolor='#FFFAFA' align='center' width='180px' colspan='6'>")
            ...
            htmlContent
                    .append("<td valign='middle' bgcolor='#FFFAFA' align='center' width='50px' rowspan='2'>Jumlah</td>"
                            + "</tr>");
            ...
            for (x = 1; x < 32; x++) {
                ...
                for (i = 0; i < kolom; i++) {
                    ...
                    k1 = Sequel.cariInteger(
                            ...
                            + "detail_beri_diet.tanggal='" + ThnCari.getSelectedItem() + "-"
                            + BlnCari.getSelectedItem() + "-" + tanggal
                            + "' and kamar.kelas='Kelas 1' and reg_periksa.kd_pj='" + kodebayar[i] + "'");
                    jumlah += k1;
                    totalk1[i] += k1;
                    if (k1 > 0) {
                        stringk1 = "" + k1;
                    ...
                    k2 = Sequel.cariInteger(
                            ...
                            + "detail_beri_diet.tanggal='" + ThnCari.getSelectedItem() + "-"
                            + BlnCari.getSelectedItem() + "-" + tanggal
                            + "' and kamar.kelas='Kelas 2' and reg_periksa.kd_pj='" + kodebayar[i] + "'");
                    jumlah += k2;
                    totalk2[i] += k2;
                    if (k2 > 0) {
                        stringk2 = "" + k2;
                    ...
                    k3 = Sequel.cariInteger(
                            ...
                            + "detail_beri_diet.tanggal='" + ThnCari.getSelectedItem() + "-"
                            + BlnCari.getSelectedItem() + "-" + tanggal
                            + "' and kamar.kelas='Kelas 3' and reg_periksa.kd_pj='" + kodebayar[i] + "'");
                    jumlah += k3;
                    totalk3[i] += k3;
                    if (k3 > 0) {
                        stringk3 = "" + k3;
                    ...
                    utama = Sequel.cariInteger(
                            ...
                            + "detail_beri_diet.tanggal='" + ThnCari.getSelectedItem() + "-"
                            + BlnCari.getSelectedItem() + "-" + tanggal
                            + "' and kamar.kelas='Kelas Utama' and reg_periksa.kd_pj='" + kodebayar[i] + "'");
                    jumlah += utama;
                    totalutama[i] += utama;
                    if (utama > 0) {
                        stringutama = "" + utama;
                    ...
                    vip = Sequel.cariInteger(
                            ...
                            + "detail_beri_diet.tanggal='" + ThnCari.getSelectedItem() + "-"
                            + BlnCari.getSelectedItem() + "-" + tanggal
                            + "' and kamar.kelas='Kelas VIP' and reg_periksa.kd_pj='" + kodebayar[i] + "'");
                    jumlah += vip;
                    totalvip[i] += vip;
                    if (vip > 0) {
                        stringvip = "" + vip;
                    ...
                    vvip = Sequel.cariInteger(
                            ...
                            + "detail_beri_diet.tanggal='" + ThnCari.getSelectedItem() + "-"
                            + BlnCari.getSelectedItem() + "-" + tanggal
                            + "' and kamar.kelas='Kelas VVIP' and reg_periksa.kd_pj='" + kodebayar[i] + "'");
                    jumlah += vvip;
                    totalvvip[i] += vvip;
                    if (vvip > 0) {
                        stringvvip = "" + vvip;
            ...
            for (i = 0; i < kolom; i++) {
                htmlContent.append("<td valign='middle' align='center'><b>")
                        .append(totalk1[i])
                        .append("</b></td><td valign='middle' align='center'><b>")
                        .append(totalk2[i])
                        .append("</b></td><td valign='middle' align='center'><b>")
                        .append(totalk3[i])
                        .append("</b></td><td valign='middle' align='center'><b>")
            ...
            for (i = 0; i < kolom; i++) {
                ...
                htmlContent.append("<tr class='isi'><td valign='middle' colspan='7'>")
                        .append(carabayar[i])
                        .append("</td><td valign='middle' align='center' colspan='2'>")
                        .append(totalk1[i])
                        .append("</td><td valign='middle' align='center' colspan='2'>")
                        .append(totalk2[i])
                        .append("</td><td valign='middle' align='center' colspan='2'>")
                        ...
                        .append("</td><td valign='middle' align='center' colspan='2'>")
                        .append(totalvvip[i])
                        .append("</td><td valign='middle' colspan='")
                        .append((kolom * 6) - 17)
                        .append("'>&nbsp;</td></tr>");
            }
            htmlContent.append(
                    "<tr class='isi'><td valign='middle' colspan='7'><b>Total :</b></td><td valign='middle' align='center' colspan='2'><b>")
                    .append(jumlahtotalk1)
                    .append("</b></td><td valign='middle' align='center' colspan='2'><b>")
                    .append(jumlahtotalk2)
                    .append("</b></td><td valign='middle' align='center' colspan='2'><b>")
                    .append(jumlahtotalk3)
                    .append("</b></td><td valign='middle' align='center' colspan='2'><b>")
                    .append(jumlahtotalutama)
                    .append("</b></td><td valign='middle' align='center' colspan='2'><b>")
                    .append(jumlahtotalvip)
                    .append("</b></td><td valign='middle' align='center' colspan='2'><b>")
                    .append(jumlahtotalvvip)
                    .append("</b></td><td valign='middle' colspan='")
                    .append((kolom * 6) - 17)
                    .append("'>&nbsp;</td></tr>");

            LoadHTML.setText("<html>" + "<table width='" + (50 + (kolom * 180))
                    + "px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"
    ...
    private static final Logger LOG = Logger.getLogger(DlgRekapPermintaanDiet.class.getName());
