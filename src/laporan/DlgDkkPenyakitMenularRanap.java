 ...
 * @author perpustakaan
 */
public class DlgDkkPenyakitMenularRanap extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptDkkPenyakitMenularRanap.jasper", "report",
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            ...
                            if (rs2.getString("umur").contains("Hr") || rs2.getString("umur").contains("Bl")
                                    || rs2.getString("umur").contains("Th")) {
...
//							th60s69l, th60s69p, th70plusl, th70plusp, totall, totalp, totaljml, matil, matip });
    ...
    private static final Logger LOG = Logger.getLogger(DlgDkkPenyakitMenularRanap.class.getName());
