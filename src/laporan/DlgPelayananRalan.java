 ...
 * @author perpustakaan
 */
public class DlgPelayananRalan extends javax.swing.JDialog {
    ...
    public DlgPelayananRalan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr = {"No.", "No.RM", "Nama Pasien", "Dokter", "Poli", "Jam Registrasi", "Jam Selesai Bayar",
            "Durasi(m)"};
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPelayananRalan.jasper", param,
                    "::[ Laporan Data Pelayanan Rawat Jalan ]::");
        }
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private static final Logger LOG = Logger.getLogger(DlgPelayananRalan.class.getName());
