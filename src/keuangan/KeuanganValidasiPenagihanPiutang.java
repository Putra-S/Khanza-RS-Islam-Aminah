...
public class KeuanganValidasiPenagihanPiutang extends javax.swing.JDialog {
    ...
    public KeuanganValidasiPenagihanPiutang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.Penagihan", "Tgl.Penagihan", "Bagian Penagihan",
            "Jatuh Tempo", "Penjamin", "Transfer Ke", "Total Tagihan"}) {
            @Override
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRValidasiPiutang.jasper", "report",
                    ...
                    + "where penagihan_piutang.status='Proses Penagihan' and penjab.nama_perusahaan like '%" + nmpenjab.
                            getText() + "%' and "
                    + "(penagihan_piutang.no_tagihan like '%" + TCari.getText() + "%' or bagianpenagihan.nama like '%" + TCari.
                    getText() + "%' or "
                    + "penjab.nama_perusahaan like '%" + TCari.getText() + "%' or akun_penagihan_piutang.nama_bank like '%" + TCari.
                    getText() + "%')"
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void BtnBayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBayarActionPerformed
        if (tbBangsal.getSelectedRow() > -1) {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            KeuanganPiutangBelumLunas form = new KeuanganPiutangBelumLunas(null,
                    false);
            form.isCek();
    ...
    private void tbBangsalMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbBangsalMouseClicked
        if (tbBangsal.getSelectedRow() != -1) {
            panggilPhoto();
            LCount1.setText(tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 6).
                    toString());
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganValidasiPenagihanPiutang dialog = new KeuanganValidasiPenagihanPiutang(new javax.swing.JFrame(),
                    true);
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("no_tagihan"), rs.getString("tanggal"),
                        rs.getString("nama"), rs.getString("tanggaltempo"), rs.getString("nama_perusahaan"),
                        rs.getString("nama_bank"), Valid.SetAngka(rs.getDouble("total"))});
    ...
    private static final Logger LOG = Logger.getLogger(KeuanganValidasiPenagihanPiutang.class.getName());
