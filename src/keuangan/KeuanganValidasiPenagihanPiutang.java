...
public class KeuanganValidasiPenagihanPiutang extends javax.swing.JDialog {
    ...
    public KeuanganValidasiPenagihanPiutang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{
            "No.Penagihan", "Tgl.Penagihan", "Bagian Penagihan", "Jatuh Tempo",
            "Penjamin", "Transfer Ke", "Total Tagihan"
        }) {
            @Override
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganValidasiPenagihanPiutang dialog = new KeuanganValidasiPenagihanPiutang(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        ...
                        getString("nama"), rs.getString("tanggaltempo"),
                        rs.getString("nama_perusahaan"), rs.getString(
                        "nama_bank"), Valid.SetAngka(rs.getDouble("total"))
                    });
    ...
    private static final Logger LOG = Logger.getLogger(
            KeuanganValidasiPenagihanPiutang.class.getName());
