...
*/
    ...
    private void prosesCari() {
        ...
        try {
            ...
            rs = koneksi.prepareStatement(
                    "select rekening.kd_rek, rekening.nm_rek, sum(rekeningtahun.saldo_awal) "
                    ...
                    + "and rekeningtahun.thn between '" + Valid.SetTgl(Tgl1.
            ...
            while (rs.next()) {
                ...
                if (!(debkred == 0)) {
                    tabMode.addRow(new Object[]{"",
                        i + ". " + rs.getString(1) + " " + rs.getString(2), df2.
                        format(debkred)});
                    i++;
                }
            }
         ...
         i++;
            ...
            tabMode.addRow(new Object[]{"", "Jumlah Total Kas Awal : ", df2.
                format(kasawal)});
            ...
            rs = koneksi.prepareStatement(
                    ...
                    + " and jurnal.tgl_jurnal between '" + Valid.SetTgl(Tgl1.
                            getSelectedItem() + "") + "' "
                    + " and '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' "
            ...
            while (rs.next()) {
                debkred = rs.getDouble(3) + Sequel.cariIsiAngka(
                        ...
                        + "between '" + Valid.
                                SetTgl(Tgl1.getSelectedItem() + "").substring(0,
                                4) + "' and '" + Valid.SetTgl(Tgl2.
                                getSelectedItem() + "").substring(0, 4) + "'");
                /*if(debkred<0){
                    debkred=debkred*(-1);
                }*/
            ...
            tabMode.addRow(new Object[]{"", "Jumlah Total Kas Masuk : ", df2.
                format(penerimaan)});
            ...
            tabMode.addRow(new Object[]{"", "Jumlah Total Kas Keluar : ", df2.
                format(pengeluaran)});
            //total kas
            tabMode.addRow(new Object[]{"", "", ""});
            tabMode.
                    addRow(new Object[]{">> Total Kas", "A + ( B - C )  : ", ""});
            tabMode.addRow(new Object[]{"", df2.format(kasawal) + " + ( " + df2.
                format(penerimaan) + " - " + df2.format(pengeluaran) + " )  : ",
    ...
    private static final Logger LOG = Logger.getLogger(DlgCashflow.class.
            getName());
