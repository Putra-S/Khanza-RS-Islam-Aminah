...
public class DlgDetailJMDokter2 extends javax.swing.JDialog {
    ...
    public DlgDetailJMDokter2(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "Nomor RM", "Nama Pasien", "Tgl.Masuk", "Tgl.Keluar", "DPJP", "Penindak",
                    "Dokter Anestesi", "Dokter Anak", "Kode", "Kategori", "Nama Unit", "Ruangan", "Nama Tindakan",
                    "Jml", "J.S.", "J.P.", "Tarif", "Total J.S.", "Total J.P.", "Total", "Tgl.Trans"}) {
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
            ...
            try {
                ...
                while (rsreg.next()) {
                    ...
                    if (rsreg.getString("status_lanjut").equals("Ralan")) {
                        ...
                        dpjp = Sequel.cariIsi("select dpjp_ranap.kd_dokter from dpjp_ranap where dpjp_ranap.no_rawat=?",
                    ...
                    if (chkRalan.isSelected() == true) {
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                tabMode
                                        .addRow(new Object[]{rsreg.getString("no_rawat"), rsreg.getString("no_rkm_medis"),
                                    rsreg.getString("nm_pasien"), rsreg.getString("tgl_registrasi"), tglkeluar,
                                    dpjp, rstindakan.getString("nm_dokter"), "", "", rsreg.getString("kd_pj"),
                                    rsreg.getString("png_jawab"), "Ralan", namaruangan,
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                tabMode
                                        .addRow(new Object[]{rsreg.getString("no_rawat"), rsreg.getString("no_rkm_medis"),
                                    rsreg.getString("nm_pasien"), rsreg.getString("tgl_registrasi"), tglkeluar,
                                    dpjp, rstindakan.getString("nama"), "", "", rsreg.getString("kd_pj"),
                                    rsreg.getString("png_jawab"), "Ralan", namaruangan,
                                    rstindakan.getString("nm_perawatan"), rstindakan.getString("jumlah"),
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                tabMode
                                    ...
                                    rsreg.getString("nm_pasien"), rsreg.getString("tgl_registrasi"), tglkeluar,
                                    dpjp, rstindakan.getString("nm_dokter"), "", "", rsreg.getString("kd_pj"),
                                    rsreg.getString("png_jawab"), "Ranap", namaruangan,
                                    rstindakan.getString("nm_perawatan"), rstindakan.getString("jumlah"),
                                    rstindakan.getDouble("sarana"), rstindakan.getDouble("tarif_tindakandr"),
                                    (rstindakan.getDouble("sarana") + rstindakan.getDouble("tarif_tindakandr")),
                                    rstindakan.getDouble("totalsarana"), rstindakan.getDouble("totaljm"),
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                tabMode.addRow(new Object[]{rsreg.getString("no_rawat"),
                                    ...
                                    rsreg.getString("tgl_registrasi"), tglkeluar, dpjp,
                                    rstindakan.getString("nm_dokter"), "", "", rsreg.getString("kd_pj"),
                                    rsreg.getString("png_jawab"), "Radiologi", namaruangan,
                                    rstindakan.getString("nm_perawatan"), rstindakan.getString("jumlah"),
                                    rstindakan.getDouble("sarana"), rstindakan.getDouble("tarif_tindakan_dokter"),
                                    (rstindakan.getDouble("sarana")
                            ...
                            while (rstindakan.next()) {
                                ...
                                if (rstindakan.getString("status").equals("Ralan")) {
                                    tabMode.addRow(new Object[]{rsreg.getString("no_rawat"),
                                        ...
                                        rstindakan.getString("dokter_anestesi")),
                                        Sequel.cariIsi(
                                        "select dokter.nm_dokter from dokter where dokter.kd_dokter=?",
                                        rstindakan.getString("dokter_anak")),
                                        rsreg.getString("kd_pj"), rsreg.getString("png_jawab"),
                                        rsreg.getString("nm_poli"), namaruangan,
                                        rstindakan.getString("nm_perawatan"), rstindakan.getString("jumlah"),
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                tabMode.addRow(new Object[]{rsreg.getString("no_rawat"),
                                    ...
                                    rsreg.getString("tgl_registrasi"), tglkeluar, dpjp,
                                    rstindakan.getString("nm_dokter"), "", "", rsreg.getString("kd_pj"),
                                    rsreg.getString("png_jawab"), "Laborat", namaruangan,
                                    rstindakan.getString("nm_perawatan"), rstindakan.getString("jumlah"),
                                    rstindakan.getDouble("sarana"), rstindakan.getDouble("tarif_tindakan_dokter"),
                                    (rstindakan.getDouble("sarana")
                                    + rstindakan.getDouble("tarif_tindakan_dokter")),
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                tabMode
                                    ...
                                    dpjp, rstindakan.getString("nm_dokter"), "", "", rsreg.getString("kd_pj"),
                                    rsreg.getString("png_jawab"), "Laborat", namaruangan,
                                    rstindakan.getString("Pemeriksaan"), rstindakan.getString("jumlah"),
                ...
                if (totalbayar > 0) {
                    tabMode.addRow(new Object[]{"", "", "Total :", "", "", "", "", "", "", "", "", "", "", "", "",
                        null, null, null, totalsarana, totaljm, totalbayar, ""});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgDetailJMDokter2.class.getName());
