...
public class DlgDetailJMDokter2 extends javax.swing.JDialog {
    ...
    public DlgDetailJMDokter2(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "No.Rawat", "Nomor RM", "Nama Pasien", "Tgl.Masuk", "Tgl.Keluar",
            "DPJP",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDetailJMDokter2 dialog = new DlgDetailJMDokter2(
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                tabMode.addRow(new Object[]{
                                    ...
                                    "nm_perawatan"),
                                    rstindakan.getString("jumlah"), rstindakan.
                                    getDouble("sarana"),
                                    rstindakan.getDouble("tarif_tindakandr"),
                                    (rstindakan.getDouble("sarana") + rstindakan.
                                    getDouble("tarif_tindakandr")),
                                    rstindakan.getDouble("totalsarana"),
                                    rstindakan.getDouble("totaljm"),
    ...
    private static final Logger LOG = Logger.getLogger(DlgDetailJMDokter2.class.
            getName());
