...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (chkRalan.isSelected() == true) {
                        psralanpr = koneksi.prepareStatement("select jns_perawatan.nm_perawatan,rawat_jl_pr.bhp,"
                                + "count(rawat_jl_pr.kd_jenis_prw) as jml," + "sum(rawat_jl_pr.bhp) as total "
                        ...
                        psralandrpr = koneksi.prepareStatement("select jns_perawatan.nm_perawatan,rawat_jl_drpr.bhp,"
                                + "count(rawat_jl_drpr.kd_jenis_prw) as jml," + "sum(rawat_jl_drpr.bhp) as total "
                        ...
                        psralandr = koneksi.prepareStatement("select jns_perawatan.nm_perawatan,rawat_jl_dr.bhp,"
                                + "count(rawat_jl_dr.kd_jenis_prw) as jml," + "sum(rawat_jl_dr.bhp) as total "
                    ...
                    if (chkRanap.isSelected() == true) {
                        psranappr = koneksi.prepareStatement("select jns_perawatan_inap.nm_perawatan,rawat_inap_pr.bhp,"
                                + "count(rawat_inap_pr.kd_jenis_prw) as jml, " + "sum(rawat_inap_pr.bhp) as total "
                        ...
                        psranapdrpr = koneksi
                                .prepareStatement("select jns_perawatan_inap.nm_perawatan,rawat_inap_drpr.bhp,"
                        ...
                        psranapdr = koneksi.prepareStatement("select jns_perawatan_inap.nm_perawatan,rawat_inap_dr.bhp,"
                                + "count(rawat_inap_dr.kd_jenis_prw) as jml, " + "sum(rawat_inap_dr.bhp) as total "
                    ...
                    if (chkLaborat.isSelected() == true) {
                        psperiksalab = koneksi.prepareStatement("select jns_perawatan_lab.nm_perawatan,periksa_lab.bhp,"
                                + "count(periksa_lab.kd_jenis_prw) as jml, " + "sum(periksa_lab.bhp) as total, "
                        ...
                        try {
                            ...
                            while (rsperiksalab.next()) {
                                detaillab = 0;
                                psdetaillab = koneksi
                                        .prepareStatement("select sum(detail_periksa_lab.bhp) as total from "
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        psperiksaradiologi = koneksi
                                .prepareStatement("select jns_perawatan_radiologi.nm_perawatan,periksa_radiologi.bhp,"
    ...
    private static final Logger LOG = Logger.getLogger(DlgRBPaketBHP.class.getName());
