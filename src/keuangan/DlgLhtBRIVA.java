...
public class DlgLhtBRIVA extends javax.swing.JDialog {
    ...
    public DlgLhtBRIVA(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr = {"No.RM", "Nama Pasien", "Alamat", "J.K.", "Tgl.Lahir", "Registrasi", "No.Nota/Tagihan",
            "Besar Bayar", "Keterangan", "Status Keperluan", "Closing", "Status Bayar", "Kasir/User",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select * from tagihan_briva where tagihan_briva.tgl_closing between ? and ? "
                    ...
                    : "and (tagihan_briva.no_rkm_medis like ? or tagihan_briva.nm_pasien like ? or "
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{rs.getString("no_rkm_medis"), rs.getString("nm_pasien"),
                        ...
                        rs.getString("tgl_registrasi"), rs.getString("no_tagihan"), rs.getString("besar_bayar"),
                        rs.getString("keterangan"), rs.getString("status_tagihan"), rs.getString("tgl_closing"),
                        rs.getString("status_bayar"), rs.getString("kasir"), rs.getString("diupdatebank"),
    ...
    private static final Logger LOG = Logger.getLogger(DlgLhtBRIVA.class.getName());
