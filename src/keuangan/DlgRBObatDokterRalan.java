...
public class DlgRBObatDokterRalan extends javax.swing.JDialog {
    ...
    public DlgRBObatDokterRalan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.", "Dokter", "Nama Pasien", "Nama Obat", "Jml",
            "Biaya Obat", "Embalase", "Tuslah"};
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (i = 0; i < tabMode.getRowCount(); i++) {
                jumlah = "";
                try {
                    jumlah = Valid.SetAngka(Double.parseDouble(tabMode.
                ...
                total = "";
                try {
                    total = Valid.SetAngka(Double.parseDouble(tabMode.
                ...
                emb = "";
                try {
                    emb = Valid.SetAngka(Double.parseDouble(tabMode.
                ...
                tsl = "";
                try {
                    tsl = Valid.SetAngka(Double.parseDouble(tabMode.
            ...
            Valid.MyReportqry("rptRBObatPerdokterRalan.jasper", "report",
                    "[ Rekap Obat Dokter Perpasien Ralan]",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
        ...
        if (tbDokter.getRowCount() != 0) {
            if (tbDokter.getSelectedRow() > -1) {
                ...
                for (i = 0; i < tbDokter.getRowCount(); i++) {
                    try {
                        if ((!tbDokter.getValueAt(i, 1).toString().substring(0,
                                1).isEmpty()) && (!tbDokter.getValueAt(i, 1).
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRBObatDokterRalan dialog = new DlgRBObatDokterRalan(
    ...
    private void prosesCari() {
        try {
            ...
            try {
                ...
                ttltuslah = 0;
                while (rsdokter.next()) {
                    tabMode.addRow(new Object[]{i + ". ", rsdokter.getString(
                        "nm_dokter"), "", "", null, null, null, null});
                    pstanggal = koneksi.prepareStatement(
                            "select detail_pemberian_obat.tgl_perawatan from reg_periksa inner join detail_pemberian_obat "
                    ...
                    try {
                        ...
                        pstanggal.setString(2, Valid.SetTgl(Tgl1.
                                getSelectedItem() + ""));
                        pstanggal.setString(3, Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                        ...
                        while (rstanggal.next()) {
                            tabMode.addRow(new Object[]{"",
                                "       " + a + ". " + rstanggal.getDate(
                                "tgl_perawatan"), "", "", null, null, null, null});
                            pspasien = koneksi.prepareStatement(
                                    "select reg_periksa.no_rawat,pasien.nm_pasien from reg_periksa inner join pasien inner join detail_pemberian_obat "
                            ...
                            try {
                                pspasien.setString(1, rsdokter.getString(
                                        "kd_dokter"));
                                pspasien.setString(2, rstanggal.getString(
                                        "tgl_perawatan"));
                                pspasien.setString(3,
                                        "%" + pilihancarabayar + "%");
                                ...
                                while (rspasien.next()) {
                                    ...
                                    try {
                                        psobat.setString(1, rspasien.getString(
                                                "no_rawat"));
                                        psobat.setString(2, rstanggal.getString(
                                                "tgl_perawatan"));
                                        ...
                                        if (rsobat.getRow() > 0) {
                                            tabMode.addRow(new Object[]{"", "",
                                                rspasien.getString("no_rawat") + " " + rspasien.
                                                getString("nm_pasien"), "", null,
                                                null, null, null});
                                        }
                                        rsobat.beforeFirst();
                                        while (rsobat.next()) {
                                            ...
                                            ttlbiaya += rsobat.
                                                    getDouble("total");
                                            ttlpasienobat += rsobat.getDouble(
                                                    "total");
                                            ttlpasienembalase += rsobat.
                                                    getDouble("embalase");
                                            embalase += rsobat.getDouble(
                                                    "embalase");
                                            ttlembalase += rsobat.getDouble(
                                                    "embalase");
                                            ttlpasientuslah += rsobat.getDouble(
                                                    "tuslah");
                                            tuslah += rsobat.getDouble("tuslah");
                                            ttltuslah += rsobat.getDouble(
                                                    "tuslah");
                                            tabMode.addRow(new Object[]{"", "",
                                                "", rsobat.
                                                getString("kode_brng") + " " + rsobat.
                                                getString("nama_brng"), rsobat.
                                                getDouble("jml"), rsobat.
                                                getDouble("total"), rsobat.
                                                getDouble("embalase"), rsobat.
                                                getDouble("tuslah")});
                                        }
                                        if (ttlpasienobat > 0) {
                                            tabMode.addRow(new Object[]{"", "",
                                                "Subtotal :", "", 0,
                                                ttlpasienobat, ttlpasienembalase,
                                                ttlpasientuslah});
                                        }
                                    } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgRBObatDokterRalan.class.getName());
}
