...
public class DlgRBObatDokterRalan extends javax.swing.JDialog {
    ...
    private double subtotal = 0, ttlbiaya = 0, embalase = 0, ttlembalase = 0, tuslah = 0, ttltuslah = 0,
            ttlpasienobat = 0, ttlpasienembalase = 0, ttlpasientuslah = 0;
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void prosesCari() {
        try {
            ...
            try {
                ...
                while (rsdokter.next()) {
                    tabMode.addRow(
                            new Object[]{i + ". ", rsdokter.getString("nm_dokter"), "", "", null, null, null, null});
                    ...
                    try {
                        ...
                        while (rstanggal.next()) {
                            tabMode.addRow(new Object[]{"", "       " + a + ". " + rstanggal.getDate("tgl_perawatan"),
                                "", "", null, null, null, null});
                                    ...
                                    try {
                                        ...
                                        while (rsobat.next()) {
                                            ...
                                            tabMode.addRow(new Object[]{"", "", "",
                                                ...
                                                rsobat.getDouble("jml"), rsobat.getDouble("total"),
                                                rsobat.getDouble("embalase"), rsobat.getDouble("tuslah")});
                                        }
                                        if (ttlpasienobat > 0) {
                                            tabMode.addRow(new Object[]{"", "", "Subtotal :", "", 0, ttlpasienobat,
                                                ttlpasienembalase, ttlpasientuslah});
                                        }
                                    } catch (Exception e) {
                        ...
                        if (subtotal > 0) {
                            tabMode.addRow(new Object[]{"", "       " + "Subtotal ", ":", "", null, subtotal,
                                embalase, tuslah});
                        }
                        i++;
                    } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgRBObatDokterRalan.class.getName());
