...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ...
            ps = koneksi
                    .prepareStatement("select titip_faktur.no_tagihan,titip_faktur.tanggal,titip_faktur.nip,petugas.nama,"
                            ...
                            + "where titip_faktur.status='Ditagihkan' " + carisuplier + cari
    ...
    private static final Logger LOG = Logger.getLogger(KeuanganValidasiTagihanObatBHP.class.getName());
