 ...
 * @author perpustakaan
 */
public class KeuanganValidasiTagihanObatBHP extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptValidasiTagihanObatBHP.jasper", "report",
                    "::[ Data Pegajuan Titip Faktur/Tagihan Obat & BHP ]::",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganValidasiTagihanObatBHP dialog = new KeuanganValidasiTagihanObatBHP(
    ...
    private void tampil() {
        ...
        try {
            ...
            if (!nmsuplier.getText().trim().isEmpty()) {
                carisuplier = " and pemesanan.kode_suplier='" + kdsuplier.
                        getText() + "' ";
            }
    ...
    private static final Logger LOG = Logger.getLogger(
            KeuanganValidasiTagihanObatBHP.class.getName());
}
