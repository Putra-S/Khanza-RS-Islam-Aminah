 ...
 * @author perpustakaan
 */
public class KeuanganCariRVPBPJS extends javax.swing.JDialog {
    ...
    private String Piutang_BPJS_RVP = "", Kerugian_Klaim_BPJS_RVP = "", Lebih_Bayar_Klaim_BPJS_RVP = "",
            Tindakan_Ralan = "", Beban_Jasa_Medik_Dokter_Tindakan_Ralan = "",
            ...
            HPP_Obat_Operasi_Ranap = "", Service_Ranap = "", Harian_Ranap = "", PPN_Keluaran = "";

    private double total = 0, sisapiutang = 0, rugihppralan = 0, rugihppranap = 0, ttlpiutang = 0, ttliur = 0,
            ttlsudahdibayar = 0, ttlsisapiutang = 0, ttlinacbg = 0, rugi = 0, lebih = 0;
    ...
    public KeuanganCariRVPBPJS(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"P", "No.Rawat/No.tagihan", "No.SEP VClaim", "Tgl.Bayar",
            "Pasien", "Total Piutang", "Iur/Ekses", "Sudah Dibayar", "Sisa Piutang", "Tarif InaCBG", "Dibayar BPJS",
            "% Bayar", "Kerugian", "Lebih Bayar", "Status", "materialralan", "bhpralan", "tarif_tindakandrralan",
            "tarif_tindakanprralan", "ksoralan", "menejemenralan", "biaya_rawatralan", "materialranap", "bhpranap",
            "tarif_tindakandrranap", "tarif_tindakanprranap", "ksoranap", "menejemenranap", "biaya_rawatranap",
            "bagian_rslabralan", "bhplabralan", "tarif_perujuklabralan", "tarif_tindakan_dokterlabralan",
            "tarif_tindakan_petugaslabralan", "ksolabralan", "menejemenlabralan", "biayalabralan",
            "bagian_rslabranap", "bhplabranap", "tarif_perujuklabranap", "tarif_tindakan_dokterlabranap",
            "tarif_tindakan_petugaslabranap", "ksolabranap", "menejemenlabranap", "biayalabranap",
            "bagian_rsradiologiralan", "bhpradiologiralan", "tarif_perujukradiologiralan",
            ...
            "Petugas Validasi", "Akun Rekening", "Kontra Akun", "Service Ranap", "PPN Obat"}) {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (i = 0; i < row; i++) {
                ...
                lebih += Double.
                        parseDouble(tabMode.getValueAt(i, 13).toString());
                Sequel.menyimpan("temporary", "'" + i + "','"
                        ...
                        + Valid.SetAngka(Double.parseDouble(tabMode.
                                getValueAt(i, 13).toString())) + "','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
            ...
            Sequel.menyimpan("temporary",
                    ...
                    SetAngka(total) + "','','" + Valid.SetAngka(rugi) + "','" + Valid.
                    SetAngka(lebih) + "','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
                    getalamatip() + "'", "RVP Piutang");
            ...
            Valid.MyReportqry("rptRVPPiutang2.jasper", "report",
                    "::[ Data RVP Piutang BPJS ]::",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (i = 0; i < row; i++) {
                if (tabMode.getValueAt(i, 0).toString().equals("true")) {
                    Sequel.mengedit("piutang_pasien", "no_rawat='" + tabMode.
                            getValueAt(i, 1).toString() + "'",
                            "status='Belum Lunas'");
                    Sequel.mengedit("detail_piutang_pasien",
                            "no_rawat='" + tabMode.getValueAt(i, 1).toString() + "' and nama_bayar='" + Sequel.
                            cariIsi("select akun_piutang.nama_bayar from akun_piutang where akun_piutang.kd_rek=?",
                                    tabMode.getValueAt(i, 83).toString()) + "'",
                            "sisapiutang='" + tabMode.getValueAt(i, 8).
                                    toString() + "'");
                    if (Valid.SetAngka(tabMode.getValueAt(i, 11).toString()) >= 100) {
                        Sequel.queryu("delete from tampjurnal");
                        Sequel.menyimpan("tampjurnal", "'" + tabMode.getValueAt(
                                i, 83).toString() + "','PIUTANG BPJS','" + tabMode.
                                        getValueAt(i, 8).toString() + "','0'",
                                "debet=debet+'" + tabMode.getValueAt(i, 8).
                                        toString() + "'", "kd_rek='" + tabMode.
                                        getValueAt(i, 83).toString() + "'");
                        if (Valid.SetAngka(tabMode.getValueAt(i, 13).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Lebih_Bayar_Klaim_BPJS_RVP + "','LEBIH BAYAR BPJS','" + tabMode.
                                            getValueAt(i, 13).toString() + "','0'",
                                    "debet=debet+'" + tabMode.getValueAt(i, 13).
                                            toString() + "'",
                                    "kd_rek='" + Lebih_Bayar_Klaim_BPJS_RVP + "'");
                        }
                        Sequel.menyimpan("tampjurnal", "'" + tabMode.getValueAt(
                                i, 82).toString() + "','Akun Bayar','0','" + tabMode.
                                        getValueAt(i, 10).toString() + "'",
                                "kredit=kredit+'" + tabMode.getValueAt(i, 82).
                                        toString() + "'",
                                "kd_rek='" + koderekening + "'");
                        sukses = jur.simpanJurnal(tabMode.getValueAt(i, 1).
                                toString(), "U",
                                "PEMBATALAN RVP PIUTANG BPJS" + ", OLEH " + akses.
                                        getkode());
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 15).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Sarana_Tindakan_Ralan + "','Beban Jasa Sarana Tindakan Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 15).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 15).
                                            toString())) + "'",
                            ...
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Utang_Jasa_Sarana_Tindakan_Ralan + "','Utang Jasa Sarana Tindakan Ralan','" + ((Valid.
                                            ...
                                            SetAngka(tabMode.getValueAt(i, 15).
                                                    toString())) + "','0'",
                                    "debet=debet+'" + ((Valid.SetAngka(tabMode.
                                            getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 15).
                                            toString())) + "'",
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 17).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Dokter_Tindakan_Ralan + "','Beban_Jasa_Medik_Dokter_Tindakan_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 17).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 17).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 18).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Paramedis_Tindakan_Ralan + "','Beban_Jasa_Medik_Paramedis_Tindakan_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 18).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 18).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 19).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_KSO_Tindakan_Ralan + "','Beban_KSO_Tindakan_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 19).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 19).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 20).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Menejemen_Tindakan_Ralan + "','Beban_Jasa_Menejemen_Tindakan_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 20).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 20).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 21).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 21).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 21).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 22).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Sarana_Tindakan_Ranap + "','Beban_Jasa_Sarana_Tindakan_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 22).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 22).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 24).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Dokter_Tindakan_Ranap + "','Beban_Jasa_Medik_Dokter_Tindakan_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 24).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 24).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 25).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Paramedis_Tindakan_Ranap + "','Beban_Jasa_Medik_Paramedis_Tindakan_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 25).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 25).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 26).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_KSO_Tindakan_Ranap + "','Beban_KSO_Tindakan_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 26).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 26).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 27).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Menejemen_Tindakan_Ranap + "','Beban_Jasa_Menejemen_Tindakan_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 27).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 27).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 28).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 28).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 28).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 29).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Sarana_Laborat_Ralan + "','Beban_Jasa_Sarana_Laborat_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 29).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 29).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 31).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Perujuk_Laborat_Ralan + "','Beban_Jasa_Perujuk_Laborat_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 31).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 31).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 32).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Dokter_Laborat_Ralan + "','Beban_Jasa_Medik_Dokter_Laborat_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 32).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 32).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 33).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Petugas_Laborat_Ralan + "','Beban_Jasa_Medik_Petugas_Laborat_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 33).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 33).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 34).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Kso_Laborat_Ralan + "','Beban_Kso_Laborat_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 34).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 34).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 35).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Menejemen_Laborat_Ralan + "','Beban_Jasa_Menejemen_Laborat_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 35).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 35).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 36).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 36).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 36).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 37).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Sarana_Laborat_Ranap + "','Beban_Jasa_Sarana_Laborat_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 37).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 37).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 39).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Perujuk_Laborat_Ranap + "','Beban_Jasa_Perujuk_Laborat_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 39).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 39).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 40).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Dokter_Laborat_Ranap + "','Beban_Jasa_Medik_Dokter_Laborat_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 40).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 40).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 41).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Petugas_Laborat_Ranap + "','Beban_Jasa_Medik_Petugas_Laborat_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 41).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 41).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 42).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Kso_Laborat_Ranap + "','Beban_Kso_Laborat_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 42).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 42).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 43).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Menejemen_Laborat_Ranap + "','Beban_Jasa_Menejemen_Laborat_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 43).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 43).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 44).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 44).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 44).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 45).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Sarana_Radiologi_Ralan + "','Beban_Jasa_Sarana_Radiologi_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 45).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 45).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 47).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Perujuk_Radiologi_Ralan + "','Beban_Jasa_Perujuk_Radiologi_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 47).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 47).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 48).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Dokter_Radiologi_Ralan + "','Beban_Jasa_Medik_Dokter_Radiologi_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 48).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 48).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 49).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Petugas_Radiologi_Ralan + "','Beban_Jasa_Medik_Petugas_Radiologi_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 49).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 49).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 50).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Kso_Radiologi_Ralan + "','Beban_Kso_Radiologi_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 50).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 50).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 51).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Menejemen_Radiologi_Ralan + "','Beban_Jasa_Menejemen_Radiologi_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 51).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 51).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 52).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 52).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 52).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 53).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Sarana_Radiologi_Ranap + "','Beban_Jasa_Sarana_Radiologi_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 53).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 53).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 55).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Perujuk_Radiologi_Ranap + "','Beban_Jasa_Perujuk_Radiologi_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 55).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 55).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 56).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Dokter_Radiologi_Ranap + "','Beban_Jasa_Medik_Dokter_Radiologi_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 56).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 56).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 57).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Petugas_Radiologi_Ranap + "','Beban_Jasa_Medik_Petugas_Radiologi_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 57).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 57).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 58).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Kso_Radiologi_Ranap + "','Beban_Kso_Radiologi_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 58).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 58).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 59).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Menejemen_Radiologi_Ranap + "','Beban_Jasa_Menejemen_Radiologi_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 59).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 59).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 60).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 60).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 60).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 61).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Dokter_Operasi_Ralan + "','Beban_Jasa_Medik_Dokter_Operasi_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 61).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 61).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 62).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Paramedis_Operasi_Ralan + "','Beban_Jasa_Medik_Paramedis_Operasi_Ralan','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 62).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 62).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 64).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG RAWAT JALAN','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * (Valid.
                                            SetAngka(tabMode.getValueAt(i, 63).
                                                    toString()) + Valid.
                                            SetAngka(tabMode.getValueAt(i, 64).
                                                    toString()))) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * (Valid.
                                    SetAngka(tabMode.getValueAt(i, 63).
                                            toString()) + Valid.SetAngka(
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 65).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Dokter_Operasi_Ranap + "','Beban_Jasa_Medik_Dokter_Operasi_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 65).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 65).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 66).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Beban_Jasa_Medik_Paramedis_Operasi_Ranap + "','Beban_Jasa_Medik_Paramedis_Operasi_Ranap','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 66).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 66).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 68).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * (Valid.
                                            SetAngka(tabMode.getValueAt(i, 67).
                                                    toString()) + Valid.
                                            SetAngka(tabMode.getValueAt(i, 68).
                                                    toString()))) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * (Valid.
                                    SetAngka(tabMode.getValueAt(i, 67).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 77).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 77).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 77).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 79).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 79).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 79).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 80).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 80).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 80).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 75).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 75).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 75).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 76).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 76).
                                                    toString())) + "','0'",
                                    "debet=debet+'" + ((Valid.SetAngka(tabMode.
                                            getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 76).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 78).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 78).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 78).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 69).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 69).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 69).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 70).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 70).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 70).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 72).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 72).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 72).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 74).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 74).
                                                    toString())) + "','0'",
                                    "debet=debet+'" + ((Valid.SetAngka(tabMode.
                                            getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 74).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 84).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 84).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 84).
                        ...
                        if (Valid.SetAngka(tabMode.getValueAt(i, 85).toString()) > 0) {
                            Sequel.menyimpan("tampjurnal",
                                    "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + ((Valid.
                                            SetAngka(tabMode.getValueAt(i, 11).
                                                    toString()) / 100) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 85).
                                                    toString())) + "'",
                                    "kredit=kredit+'" + ((Valid.SetAngka(
                                            tabMode.getValueAt(i, 11).toString()) / 100) * Valid.
                                    SetAngka(tabMode.getValueAt(i, 85).
                        ...
                        if (sukses == true) {
                            Sequel.queryu("delete from tampjurnal");
                            //tindakan ralan
                            if (Valid.SetAngka(tabMode.getValueAt(i, 15).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Sarana_Tindakan_Ralan + "','Beban Jasa Sarana Tindakan Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        15).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Sarana_Tindakan_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Sarana_Tindakan_Ralan + "','Utang Jasa Sarana Tindakan Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        15).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 15).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 17).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Dokter_Tindakan_Ralan + "','Beban_Jasa_Medik_Dokter_Tindakan_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        17).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Medik_Dokter_Tindakan_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Dokter_Tindakan_Ralan + "','Utang_Jasa_Medik_Dokter_Tindakan_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        17).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 17).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 18).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Paramedis_Tindakan_Ralan + "','Beban_Jasa_Medik_Paramedis_Tindakan_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        18).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Medik_Paramedis_Tindakan_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Paramedis_Tindakan_Ralan + "','Utang_Jasa_Medik_Paramedis_Tindakan_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        18).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 18).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 19).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_KSO_Tindakan_Ralan + "','Beban_KSO_Tindakan_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        19).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_KSO_Tindakan_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_KSO_Tindakan_Ralan + "','Utang_KSO_Tindakan_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        19).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 19).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 20).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Menejemen_Tindakan_Ralan + "','Beban_Jasa_Menejemen_Tindakan_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        20).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Menejemen_Tindakan_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Menejemen_Tindakan_Ralan + "','Utang_Jasa_Menejemen_Tindakan_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        20).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 20).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 21).
                                ...
                                Sequel.menyimpan("tampjurnal",
                                        ...
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Tindakan_Ralan + "','PENDAPATAN RAWAT JALAN','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        21).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 21).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 22).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Sarana_Tindakan_Ranap + "','Beban_Jasa_Sarana_Tindakan_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        22).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Sarana_Tindakan_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Sarana_Tindakan_Ranap + "','Utang_Jasa_Sarana_Tindakan_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        22).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 22).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 24).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Dokter_Tindakan_Ranap + "','Beban_Jasa_Medik_Dokter_Tindakan_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        24).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Medik_Dokter_Tindakan_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Dokter_Tindakan_Ranap + "','Utang_Jasa_Medik_Dokter_Tindakan_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        24).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 24).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 25).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Paramedis_Tindakan_Ranap + "','Beban_Jasa_Medik_Paramedis_Tindakan_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        25).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Medik_Paramedis_Tindakan_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Paramedis_Tindakan_Ranap + "','Utang_Jasa_Medik_Paramedis_Tindakan_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        25).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 25).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 26).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_KSO_Tindakan_Ranap + "','Beban_KSO_Tindakan_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        26).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_KSO_Tindakan_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_KSO_Tindakan_Ranap + "','Utang_KSO_Tindakan_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        26).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 26).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 27).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Menejemen_Tindakan_Ranap + "','Beban_Jasa_Menejemen_Tindakan_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        27).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Menejemen_Tindakan_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Menejemen_Tindakan_Ranap + "','Utang_Jasa_Menejemen_Tindakan_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        27).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 27).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 28).
                                ...
                                Sequel.menyimpan("tampjurnal",
                                        ...
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Tindakan_Ranap + "','PENDAPATAN RAWAT INAP','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        28).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 28).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 29).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Sarana_Laborat_Ralan + "','Beban_Jasa_Sarana_Laborat_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        29).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Sarana_Laborat_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Sarana_Laborat_Ralan + "','Utang_Jasa_Sarana_Laborat_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        29).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 29).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 31).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Perujuk_Laborat_Ralan + "','Beban_Jasa_Perujuk_Laborat_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        31).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Perujuk_Laborat_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Perujuk_Laborat_Ralan + "','Utang_Jasa_Perujuk_Laborat_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        31).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 31).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 32).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Dokter_Laborat_Ralan + "','Beban_Jasa_Medik_Dokter_Laborat_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        32).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Medik_Dokter_Laborat_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Dokter_Laborat_Ralan + "','Utang_Jasa_Medik_Dokter_Laborat_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        32).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 32).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 33).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Petugas_Laborat_Ralan + "','Beban_Jasa_Medik_Petugas_Laborat_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        33).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Medik_Petugas_Laborat_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Petugas_Laborat_Ralan + "','Utang_Jasa_Medik_Petugas_Laborat_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        33).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 33).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 34).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Kso_Laborat_Ralan + "','Beban_Kso_Laborat_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        34).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Kso_Laborat_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Kso_Laborat_Ralan + "','Utang_Kso_Laborat_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        34).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 34).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 35).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Menejemen_Laborat_Ralan + "','Beban_Jasa_Menejemen_Laborat_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        35).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Menejemen_Laborat_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Menejemen_Laborat_Ralan + "','Utang_Jasa_Menejemen_Laborat_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        35).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 35).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 36).
                                ...
                                Sequel.menyimpan("tampjurnal",
                                        ...
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Laborat_Ralan + "','PENDAPATAN LABORAT RAWAT JALAN','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        36).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 36).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 37).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Sarana_Laborat_Ranap + "','Beban_Jasa_Sarana_Laborat_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        37).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Sarana_Laborat_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Sarana_Laborat_Ranap + "','Utang_Jasa_Sarana_Laborat_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        37).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 37).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 39).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Perujuk_Laborat_Ranap + "','Beban_Jasa_Perujuk_Laborat_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        39).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 39).
                                                        toString())) + "'",
                                        "kd_rek='" + Beban_Jasa_Perujuk_Laborat_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Perujuk_Laborat_Ranap + "','Utang_Jasa_Perujuk_Laborat_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        39).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 39).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 40).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Dokter_Laborat_Ranap + "','Beban_Jasa_Medik_Dokter_Laborat_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        40).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Medik_Dokter_Laborat_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Dokter_Laborat_Ranap + "','Utang_Jasa_Medik_Dokter_Laborat_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        40).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 40).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 41).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Petugas_Laborat_Ranap + "','Beban_Jasa_Medik_Petugas_Laborat_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        41).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Medik_Petugas_Laborat_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Petugas_Laborat_Ranap + "','Utang_Jasa_Medik_Petugas_Laborat_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        41).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 41).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 42).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Kso_Laborat_Ranap + "','Beban_Kso_Laborat_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        42).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Kso_Laborat_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Kso_Laborat_Ranap + "','Utang_Kso_Laborat_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        42).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 42).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 43).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Menejemen_Laborat_Ranap + "','Beban_Jasa_Menejemen_Laborat_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        43).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Menejemen_Laborat_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Menejemen_Laborat_Ranap + "','Utang_Jasa_Menejemen_Laborat_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        43).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 43).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 44).
                                ...
                                Sequel.menyimpan("tampjurnal",
                                        ...
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Laborat_Ranap + "','PENDAPATAN LABORAT RAWAT INAP','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        44).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 44).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 45).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Sarana_Radiologi_Ralan + "','Beban_Jasa_Sarana_Radiologi_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        45).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Sarana_Radiologi_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Sarana_Radiologi_Ralan + "','Utang_Jasa_Sarana_Radiologi_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        45).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 45).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 47).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Perujuk_Radiologi_Ralan + "','Beban_Jasa_Perujuk_Radiologi_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        47).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 47).
                                                        toString())) + "'",
                                        "kd_rek='" + Beban_Jasa_Perujuk_Radiologi_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Perujuk_Radiologi_Ralan + "','Utang_Jasa_Perujuk_Radiologi_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        47).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 47).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 48).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Dokter_Radiologi_Ralan + "','Beban_Jasa_Medik_Dokter_Radiologi_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        48).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Medik_Dokter_Radiologi_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Dokter_Radiologi_Ralan + "','Utang_Jasa_Medik_Dokter_Radiologi_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        48).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 48).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 49).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Petugas_Radiologi_Ralan + "','Beban_Jasa_Medik_Petugas_Radiologi_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        49).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Medik_Petugas_Radiologi_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Petugas_Radiologi_Ralan + "','Utang_Jasa_Medik_Petugas_Radiologi_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        49).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 49).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 50).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Kso_Radiologi_Ralan + "','Beban_Kso_Radiologi_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        50).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Kso_Radiologi_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Kso_Radiologi_Ralan + "','Utang_Kso_Radiologi_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        50).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 50).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 51).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Menejemen_Radiologi_Ralan + "','Beban_Jasa_Menejemen_Radiologi_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        51).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Menejemen_Radiologi_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Menejemen_Radiologi_Ralan + "','Utang_Jasa_Menejemen_Radiologi_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        51).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 51).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 52).
                                ...
                                Sequel.menyimpan("tampjurnal",
                                        ...
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Radiologi_Ralan + "','PENDAPATAN RADIOLOGI RAWAT JALAN','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        52).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 52).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 53).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Sarana_Radiologi_Ranap + "','Beban_Jasa_Sarana_Radiologi_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        53).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Sarana_Radiologi_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Sarana_Radiologi_Ranap + "','Utang_Jasa_Sarana_Radiologi_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        53).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 53).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 55).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Perujuk_Radiologi_Ranap + "','Beban_Jasa_Perujuk_Radiologi_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        55).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 55).
                                                        toString())) + "'",
                                        "kd_rek='" + Beban_Jasa_Perujuk_Radiologi_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Perujuk_Radiologi_Ranap + "','Utang_Jasa_Perujuk_Radiologi_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        55).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 55).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 56).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Dokter_Radiologi_Ranap + "','Beban_Jasa_Medik_Dokter_Radiologi_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        56).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Medik_Dokter_Radiologi_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Dokter_Radiologi_Ranap + "','Utang_Jasa_Medik_Dokter_Radiologi_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        56).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 56).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 57).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Petugas_Radiologi_Ranap + "','Beban_Jasa_Medik_Petugas_Radiologi_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        57).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Medik_Petugas_Radiologi_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Petugas_Radiologi_Ranap + "','Utang_Jasa_Medik_Petugas_Radiologi_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        57).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 57).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 58).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Kso_Radiologi_Ranap + "','Beban_Kso_Radiologi_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        58).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Kso_Radiologi_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Kso_Radiologi_Ranap + "','Utang_Kso_Radiologi_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        58).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 58).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 59).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Menejemen_Radiologi_Ranap + "','Beban_Jasa_Menejemen_Radiologi_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        59).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Menejemen_Radiologi_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Menejemen_Radiologi_Ranap + "','Utang_Jasa_Menejemen_Radiologi_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        59).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 59).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 60).
                                ...
                                Sequel.menyimpan("tampjurnal",
                                        ...
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Radiologi_Ranap + "','PENDAPATAN RADIOLOGI RAWAT INAP','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        60).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 60).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 61).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Dokter_Operasi_Ralan + "','Beban_Jasa_Medik_Dokter_Operasi_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        61).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Medik_Dokter_Operasi_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Dokter_Operasi_Ralan + "','Utang_Jasa_Medik_Dokter_Operasi_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        61).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 61).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 62).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Paramedis_Operasi_Ralan + "','Beban_Jasa_Medik_Paramedis_Operasi_Ralan','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        62).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Medik_Paramedis_Operasi_Ralan + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Paramedis_Operasi_Ralan + "','Utang_Jasa_Medik_Paramedis_Operasi_Ralan','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        62).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 62).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 64).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Piutang_BPJS_RVP + "','PIUTANG RAWAT JALAN','" + ((Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        63).toString()) + Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        64).toString()))) + "','0'",
                                        ...
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Operasi_Ralan + "','PENDAPATAN OPERASI RAWAT JALAN','0','" + ((Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        63).toString()) + Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        64).toString()))) + "'",
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 65).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Dokter_Operasi_Ranap + "','Beban_Jasa_Medik_Dokter_Operasi_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        65).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 65).
                                                        toString())) + "'",
                                        "kd_rek='" + Beban_Jasa_Medik_Dokter_Operasi_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Dokter_Operasi_Ranap + "','Utang_Jasa_Medik_Dokter_Operasi_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        65).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 65).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 66).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Beban_Jasa_Medik_Paramedis_Operasi_Ranap + "','Beban_Jasa_Medik_Paramedis_Operasi_Ranap','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        66).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                        ...
                                        "kd_rek='" + Beban_Jasa_Medik_Paramedis_Operasi_Ranap + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Utang_Jasa_Medik_Paramedis_Operasi_Ranap + "','Utang_Jasa_Medik_Paramedis_Operasi_Ranap','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        66).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 66).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 68).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','" + ((Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                        ...
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Operasi_Ranap + "','PENDAPATAN OPERASI RAWAT INAP','0','" + ((Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        67).toString()) + Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        68).toString()))) + "'",
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 77).
                                ...
                                Sequel.menyimpan("tampjurnal",
                                        ...
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Kamar_Inap + "','PENDAPATAN KAMAR INAP','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        77).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 77).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 79).
                                ...
                                Sequel.menyimpan("tampjurnal",
                                        ...
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Harian_Ranap + "','PENDAPATAN HARIAN KAMAR INAP','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        79).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 79).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 80).
                                ...
                                if (tbBangsal.getValueAt(i, 14).toString().
                                        equals("Ralan")) {
                                    Sequel.menyimpan("tampjurnal",
                                            "'" + Registrasi_Ralan + "','PENDAPATAN REGISTRASI RALAN','0','" + (Valid.
                                    ...
                                    Sequel.menyimpan("tampjurnal",
                                            "'" + Registrasi_Ranap + "','PENDAPATAN REGISTRASI RALAN','0','" + (Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 80).toString())) + "'",
                                            "kredit=kredit+'" + (Valid.SetAngka(
                                                    tabMode.getValueAt(i, 80).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 75).
                                ...
                                if (tbBangsal.getValueAt(i, 14).toString().
                                        equals("Ralan")) {
                                    Sequel.menyimpan("tampjurnal",
                                            "'" + Tambahan_Ralan + "','PENDAPATAN TAMBAHAN RALAN','0','" + (Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 75).toString())) + "'",
                                            "kredit=kredit+'" + (Valid.SetAngka(
                                                    tabMode.getValueAt(i, 75).
                                    ...
                                    Sequel.menyimpan("tampjurnal",
                                            "'" + Tambahan_Ranap + "','PENDAPATAN TAMBAHAN RANAP','0','" + (Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 75).toString())) + "'",
                                            "kredit=kredit+'" + (Valid.SetAngka(
                                                    tabMode.getValueAt(i, 75).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 76).
                                ...
                                if (tbBangsal.getValueAt(i, 14).toString().
                                        equals("Ralan")) {
                                    Sequel.menyimpan("tampjurnal",
                                            "'" + Potongan_Ralan + "','POTONGAN RALAN','" + (Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 76).toString())) + "','0'",
                                            "debet=debet+'" + (Valid.SetAngka(
                                                    tabMode.getValueAt(i, 76).
                                    ...
                                    Sequel.menyimpan("tampjurnal",
                                            "'" + Potongan_Ranap + "','POTONGAN RANAP','" + (Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 76).toString())) + "','0'",
                                            "debet=debet+'" + (Valid.SetAngka(
                                                    tabMode.getValueAt(i, 76).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 78).
                                ...
                                Sequel.menyimpan("tampjurnal",
                                        ...
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Resep_Pulang_Ranap + "','PENDAPATAN RESEP PULANG','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        78).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 78).
                                ...
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        69).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 69).
                                                        toString())) + "'",
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                if (tbBangsal.getValueAt(i, 14).toString().
                                        equals("Ralan")) {
                                    Sequel.menyimpan("tampjurnal",
                                            "'" + Obat_Ralan + "','OBAT LANGSUNG RALAN','0','" + (Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 69).toString())) + "'",
                                            "kredit=kredit+'" + (Valid.SetAngka(
                                                    tabMode.getValueAt(i, 69).
                                    ...
                                    Sequel.menyimpan("tampjurnal",
                                            "'" + Obat_Ranap + "','OBAT LANGSUNG RANAP','0','" + (Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 69).toString())) + "'",
                                            "kredit=kredit+'" + (Valid.SetAngka(
                                                    tabMode.getValueAt(i, 69).
                            ...
                            if (Valid.SetAngka(tabMode.getValueAt(i, 70).
                                ...
                                Sequel.menyimpan("tampjurnal",
                                        ...
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Obat_Ralan + "','PENDAPATAN OBAT RALAN','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        70).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 70).
                            ...
                            //obat ranap
                            if (Valid.SetAngka(tabMode.getValueAt(i, 72).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        72).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 72).
                                                        toString())) + "'",
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Obat_Ranap + "','PENDAPATAN OBAT RANAP','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        72).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 72).
                            ...
                            //retur obat ranap
                            if (Valid.SetAngka(tabMode.getValueAt(i, 74).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        74).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 74).
                                                        toString())) + "'",
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Retur_Obat_Ranap + "','PENDAPATAN OBAT RANAP','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        74).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 74).
                            ...
                            //service
                            if (Valid.SetAngka(tabMode.getValueAt(i, 84).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        84).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 84).
                                                        toString())) + "'",
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Service_Ranap + "','PENDAPATAN SERVICE INAP','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        84).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 84).
                            ...
                            //PPN Obat
                            if (Valid.SetAngka(tabMode.getValueAt(i, 85).
                                    toString()) > 0) {
                                Sequel.menyimpan("tampjurnal",
                                        "'" + Piutang_BPJS_RVP + "','PIUTANG BPJS','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        85).toString())) + "','0'",
                                        "debet=debet+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 85).
                                                        toString())) + "'",
                                        "kd_rek='" + Piutang_BPJS_RVP + "'");
                                Sequel.menyimpan("tampjurnal",
                                        "'" + PPN_Keluaran + "','PPN KELUARAN','0','" + (Valid.
                                                SetAngka(tabMode.getValueAt(i,
                                                        85).toString())) + "'",
                                        "kredit=kredit+'" + (Valid.SetAngka(
                                                tabMode.getValueAt(i, 85).
                            ...
                            if (sukses == true) {
                                //jurnal kerugian 
                                Sequel.queryu("delete from tampjurnal");
                                if (Valid.SetAngka(tabMode.getValueAt(i, 12).
                                        toString()) > 0) {
                                    Sequel.menyimpan("tampjurnal",
                                            "'" + Kerugian_Klaim_BPJS_RVP + "','KERUGIAN KLAIM BPJS','0','" + tabMode.
                                                    getValueAt(i, 12).toString() + "'",
                                            "kredit=kredit+'" + tabMode.
                                                    getValueAt(i, 12).toString() + "'",
                                            "kd_rek='" + Kerugian_Klaim_BPJS_RVP + "'");
                                    if (Valid.SetAngka(
                                            tabMode.getValueAt(i, 16).toString()) > 0) {
                                        Sequel.menyimpan("tampjurnal",
                                                "'" + HPP_BHP_Tindakan_Ralan + "','HPP RAWAT JALAN','" + (Valid.
                                                        SetAngka(tabMode.
                                                                getValueAt(i, 16).
                                                                toString()) * ((100 - Valid.
                                                        SetAngka(tabMode.
                                    ...
                                    if (Valid.SetAngka(
                                            tabMode.getValueAt(i, 23).toString()) > 0) {
                                        Sequel.menyimpan("tampjurnal",
                                                "'" + HPP_BHP_Tindakan_Ranap + "','HPP RAWAT INAP','" + (Valid.
                                                        SetAngka(tabMode.
                                                                getValueAt(i, 23).
                                                                toString()) * ((100 - Valid.
                                                        SetAngka(tabMode.
                                    ...
                                    if (Valid.SetAngka(
                                            tabMode.getValueAt(i, 30).toString()) > 0) {
                                        Sequel.menyimpan("tampjurnal",
                                                "'" + HPP_Persediaan_Laborat_Rawat_Jalan + "','HPP LAB RAWAT JALAN','" + (Valid.
                                                        SetAngka(tabMode.
                                                                getValueAt(i, 30).
                                                                toString()) * ((100 - Valid.
                                                        SetAngka(tabMode.
                                    ...
                                    if (Valid.SetAngka(
                                            tabMode.getValueAt(i, 38).toString()) > 0) {
                                        Sequel.menyimpan("tampjurnal",
                                                "'" + HPP_Persediaan_Laborat_Rawat_inap + "','HPP LAB RAWAT INAP','" + (Valid.
                                                        SetAngka(tabMode.
                                                                getValueAt(i, 38).
                                                                toString()) * ((100 - Valid.
                                                        SetAngka(tabMode.
                                    ...
                                    if (Valid.SetAngka(
                                            tabMode.getValueAt(i, 46).toString()) > 0) {
                                        Sequel.menyimpan("tampjurnal",
                                                "'" + HPP_Persediaan_Radiologi_Rawat_Jalan + "','HPP RADIOLOGI RAWAT JALAN','" + (Valid.
                                                        SetAngka(tabMode.
                                                                getValueAt(i, 46).
                                                                toString()) * ((100 - Valid.
                                                        SetAngka(tabMode.
                                    ...
                                    if (Valid.SetAngka(
                                            tabMode.getValueAt(i, 54).toString()) > 0) {
                                        Sequel.menyimpan("tampjurnal",
                                                "'" + HPP_Persediaan_Radiologi_Rawat_Inap + "','HPP RADIOLOGI RAWAT INAP','" + (Valid.
                                                        SetAngka(tabMode.
                                                                getValueAt(i, 54).
                                                                toString()) * ((100 - Valid.
                                                        SetAngka(tabMode.
                                    ...
                                    if (Valid.SetAngka(
                                            tabMode.getValueAt(i, 63).toString()) > 0) {
                                        Sequel.menyimpan("tampjurnal",
                                                "'" + HPP_Obat_Operasi_Ralan + "','HPP OPERASI RAWAT JALAN','" + (Valid.
                                                        SetAngka(tabMode.
                                                                getValueAt(i, 63).
                                                                toString()) * ((100 - Valid.
                                                        SetAngka(tabMode.
                                    ...
                                    if (Valid.SetAngka(
                                            tabMode.getValueAt(i, 67).toString()) > 0) {
                                        Sequel.menyimpan("tampjurnal",
                                                "'" + HPP_Obat_Operasi_Ranap + "','HPP OPERASI RAWAT INAP','" + (Valid.
                                                        SetAngka(tabMode.
                                                                getValueAt(i, 67).
                                                                toString()) * ((100 - Valid.
                                                        SetAngka(tabMode.
                                    ...
                                    if (Valid.SetAngka(
                                            tabMode.getValueAt(i, 78).toString()) > 0) {
                                        Sequel.menyimpan("tampjurnal",
                                                "'" + Resep_Pulang_Ranap + "','Resep Pulang Ranap','" + (Valid.
                                                        SetAngka(tabMode.
                                                                getValueAt(i, 78).
                                                                toString()) * ((100 - Valid.
                                                        SetAngka(tabMode.
                                    ...
                                    rugihppralan = (Valid.SetAngka(tabMode.
                                            getValueAt(i, 71).toString()) - (Valid.
                                            SetAngka(tabMode.getValueAt(i, 70).
                                                    toString()) * (Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString()) / 100)));
                                    if (rugihppralan > 0) {
                                        Sequel.menyimpan("tampjurnal",
                                                "'" + HPP_Obat_Rawat_Jalan + "','HPP Obat Ralan','" + rugihppralan + "','0'",
                                                "debet=debet+'" + rugihppralan + "'",
                                                "kd_rek='" + HPP_Obat_Rawat_Jalan + "'");
                                    }
                                    rugihppranap = ((Valid.SetAngka(tabMode.
                                            getValueAt(i, 73).toString()) - Valid.
                                            SetAngka(tabMode.getValueAt(i, 74).
                                                    toString())) - ((Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 69).toString()) + Valid.
                                    ...
                                    if (rugihppranap > 0) {
                                        Sequel.menyimpan("tampjurnal",
                                                "'" + HPP_Obat_Rawat_Inap + "','HPP Obat Ranap','" + rugihppranap + "','0'",
                                                "debet=debet+'" + rugihppranap + "'",
                                                "kd_rek='" + HPP_Obat_Rawat_Inap + "'");
                                    }
                                }

                                Sequel.menyimpan("tampjurnal", "'" + tabMode.
                                        getValueAt(i, 83).toString() + "','PIUTANG BPJS','" + ((Valid.
                                        SetAngka(tabMode.getValueAt(i, 11).
                                                toString()) / 100) * Valid.
                                                SetAngka(tabMode.
                                                        getValueAt(i, 8).
                                        ...
                                        "debet=debet+'" + ((Valid.SetAngka(
                                                ...
                                                SetAngka(tabMode.
                                                        getValueAt(i, 8).
                                                        toString())) + "'",
                                        "kd_rek='" + tabMode.getValueAt(i, 83).
                                                toString() + "'");
                                Sequel.menyimpan("tampjurnal", "'" + tabMode.
                                        getValueAt(i, 82).toString() + "','Akun Bayar','0','" + tabMode.
                                        getValueAt(i, 10).toString() + "'",
                                        "kredit=kredit+'" + tabMode.
                                ...
                                if (sukses == true) {
                                    ...
                                    if (Sequel.queryutf(
                                            "update rawat_jl_dr set material=material*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",tarif_tindakandr=tarif_tindakandr*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",kso=kso*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",menejemen=menejemen*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biaya_rawat=biaya_rawat*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + " where no_rawat='" + tabMode.
                                                    getValueAt(i, 1).toString() + "'") == false) {
                                        sukses = false;
                                    }
                                    if (Sequel.queryutf(
                                            "update rawat_jl_pr set material=material*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",tarif_tindakanpr=tarif_tindakanpr*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",kso=kso*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",menejemen=menejemen*" + (100 / Valid.
                                    ...
                                    if (Sequel.queryutf(
                                            "update rawat_jl_drpr set material=material*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",tarif_tindakandr=tarif_tindakandr*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",tarif_tindakanpr=tarif_tindakanpr*" + (100 / Valid.
                                    ...
                                    if (Sequel.queryutf(
                                            "update rawat_inap_dr set material=material*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",tarif_tindakandr=tarif_tindakandr*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",kso=kso*" + (100 / Valid.
                                    ...
                                    if (Sequel.queryutf(
                                            "update rawat_inap_pr set material=material*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",tarif_tindakanpr=tarif_tindakanpr*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",kso=kso*" + (100 / Valid.
                                    ...
                                    if (Sequel.queryutf(
                                            "update rawat_inap_drpr set material=material*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",tarif_tindakandr=tarif_tindakandr*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",tarif_tindakanpr=tarif_tindakanpr*" + (100 / Valid.
                                    ...
                                    //update rvp laborat
                                    if (Sequel.queryutf(
                                            "update periksa_lab set bagian_rs=bagian_rs*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",tarif_perujuk=tarif_perujuk*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",tarif_tindakan_dokter=tarif_tindakan_dokter*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",tarif_tindakan_petugas=tarif_tindakan_petugas*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",kso=kso*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",menejemen=menejemen*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biaya=biaya*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + " where no_rawat='" + tabMode.
                                                    getValueAt(i, 1).toString() + "'") == false) {
                                        sukses = false;
                                    ...
                                    if (Sequel.queryutf(
                                            "update detail_periksa_lab set bagian_rs=bagian_rs*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",bagian_perujuk=bagian_perujuk*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",bagian_dokter=bagian_dokter*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",bagian_laborat=bagian_laborat*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",kso=kso*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",menejemen=menejemen*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biaya_item=biaya_item*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + " where no_rawat='" + tabMode.
                                                    getValueAt(i, 1).toString() + "'") == false) {
                                        sukses = false;
                                    ...
                                    if (Sequel.queryutf(
                                            "update periksa_radiologi set bagian_rs=bagian_rs*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",tarif_perujuk=tarif_perujuk*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",tarif_tindakan_dokter=tarif_tindakan_dokter*" + (100 / Valid.
                                    ...
                                    //update rvp operasi
                                    if (Sequel.queryutf(
                                            "update operasi set biayaoperator1=biayaoperator1*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayaoperator2=biayaoperator2*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayaoperator3=biayaoperator3*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayaasisten_operator1=biayaasisten_operator1*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayaasisten_operator2=biayaasisten_operator2*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayaasisten_operator3=biayaasisten_operator3*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayainstrumen=biayainstrumen*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayadokter_anak=biayadokter_anak*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayaperawaat_resusitas=biayaperawaat_resusitas*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayadokter_anestesi=biayadokter_anestesi*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayaasisten_anestesi=biayaasisten_anestesi*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayaasisten_anestesi2=biayaasisten_anestesi2*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayabidan=biayabidan*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayabidan2=biayabidan2*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayabidan3=biayabidan3*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayaperawat_luar=biayaperawat_luar*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayaalat=biayaalat*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayasewaok=biayasewaok*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",akomodasi=akomodasi*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",bagian_rs=bagian_rs*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biaya_omloop=biaya_omloop*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biaya_omloop2=biaya_omloop2*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biaya_omloop3=biaya_omloop3*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biaya_omloop4=biaya_omloop4*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biaya_omloop5=biaya_omloop5*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biayasarpras=biayasarpras*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biaya_dokter_pjanak=biaya_dokter_pjanak*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",biaya_dokter_umum=biaya_dokter_umum*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + " where no_rawat='" + tabMode.
                                                    getValueAt(i, 1).toString() + "'") == false) {
                                        sukses = false;
                                    ...
                                    //update rvp kamar
                                    if (Sequel.queryutf(
                                            "update kamar_inap set trf_kamar=trf_kamar*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",ttl_biaya=ttl_biaya*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + " where no_rawat='" + tabMode.
                                                    getValueAt(i, 1).toString() + "'") == false) {
                                        sukses = false;
                                    ...
                                    if (Sequel.queryutf(
                                            "update reg_periksa set biaya_reg=biaya_reg*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + " where no_rawat='" + tabMode.
                                                    getValueAt(i, 1).toString() + "'") == false) {
                                        sukses = false;
                                    ...
                                    if (Sequel.queryutf(
                                            "update tambahan_biaya set besar_biaya=besar_biaya*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + " where no_rawat='" + tabMode.
                                                    getValueAt(i, 1).toString() + "'") == false) {
                                        sukses = false;
                                    ...
                                    if (Sequel.queryutf(
                                            "update pengurangan_biaya set besar_pengurangan=besar_pengurangan*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + " where no_rawat='" + tabMode.
                                                    getValueAt(i, 1).toString() + "'") == false) {
                                        sukses = false;
                                    ...
                                    if (Sequel.queryutf(
                                            "update tagihan_obat_langsung set besar_tagihan=besar_tagihan*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + " where no_rawat='" + tabMode.
                                                    getValueAt(i, 1).toString() + "'") == false) {
                                        sukses = false;
                                    ...
                                    //update rvp obat
                                    if (Sequel.queryutf(
                                            "update detail_pemberian_obat set biaya_obat=biaya_obat*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",total=total*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",embalase=embalase*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + ",tuslah=tuslah*" + (100 / Valid.
                                                    SetAngka(tabMode.getValueAt(
                                                            i, 11).toString())) + " where no_rawat='" + tabMode.
                                                    getValueAt(i, 1).toString() + "'") == false) {
                                        sukses = false;
                    ...
                    if (sukses == true) {
                        if (Sequel.queryu2tf(
                                "delete from bayar_piutang where tgl_bayar=? and no_rawat=? and kd_rek=? and kd_rek_kontra=?",
                                4, new String[]{
                                    tabMode.getValueAt(i, 3).toString(),
                                    tabMode.getValueAt(i, 1).toString(),
                                    tabMode.getValueAt(i, 82).toString(),
                                    tabMode.getValueAt(i, 83).toString()
                                }) == true) {
                            Sequel.meghapus("rvp_klaim_bpjs", "no_rawat",
                                    tabMode.getValueAt(i, 1).toString());
                        } else {
                            sukses = false;
                        }
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    : "and (rvp_klaim_bpjs.no_rawat like ? or reg_periksa.no_rkm_medis like ? "
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString("no_rawat"), rs.getString("no_sep"),
                        rs.getString("tanggal_rvp"), rs.getString("namapasien"), rs.getDouble("totalpiutang"),
                        rs.getDouble("uangmuka"), rs.getDouble("sudahdibayar"), rs.getDouble("sisapiutang"),
                        rs.getDouble("tarifinacbg"), rs.getDouble("dibayarbpjs"), rs.getDouble("persenbayar"),
                        rs.getDouble("rugi"), rs.getDouble("lebih"), rs.getString("status_lanjut"),
                        rs.getDouble("materialralan"), rs.getDouble("bhpralan"),
                        rs.getDouble("tarif_tindakandrralan"), rs.getDouble("tarif_tindakanprralan"),
                        rs.getDouble("ksoralan"), rs.getDouble("menejemenralan"), rs.getDouble("biaya_rawatralan"),
                        rs.getDouble("materialranap"), rs.getDouble("bhpranap"),
                        rs.getDouble("tarif_tindakandrranap"), rs.getDouble("tarif_tindakanprranap"),
                        rs.getDouble("ksoranap"), rs.getDouble("menejemenranap"), rs.getDouble("biaya_rawatranap"),
                        rs.getDouble("bagian_rslabralan"), rs.getDouble("bhplabralan"),
                        rs.getDouble("tarif_perujuklabralan"), rs.getDouble("tarif_tindakan_dokterlabralan"),
                        rs.getDouble("tarif_tindakan_petugaslabralan"), rs.getDouble("ksolabralan"),
                        rs.getDouble("menejemenlabralan"), rs.getDouble("biayalabralan"),
                        rs.getDouble("bagian_rslabranap"), rs.getDouble("bhplabranap"),
                        rs.getDouble("tarif_perujuklabranap"), rs.getDouble("tarif_tindakan_dokterlabranap"),
                        rs.getDouble("tarif_tindakan_petugaslabranap"), rs.getDouble("ksolabranap"),
                        rs.getDouble("menejemenlabranap"), rs.getDouble("biayalabranap"),
                        rs.getDouble("bagian_rsradiologiralan"), rs.getDouble("bhpradiologiralan"),
                        rs.getDouble("tarif_perujukradiologiralan"),
                        rs.getDouble("tarif_tindakan_dokterradiologiralan"),
                        rs.getDouble("tarif_tindakan_petugasradiologiralan"), rs.getDouble("ksoradiologiralan"),
                        rs.getDouble("menejemenradiologiralan"), rs.getDouble("biayaradiologiralan"),
                        rs.getDouble("bagian_rsradiologiranap"), rs.getDouble("bhpradiologiranap"),
                        rs.getDouble("tarif_perujukradiologiranap"),
                        rs.getDouble("tarif_tindakan_dokterradiologiranap"),
                        rs.getDouble("tarif_tindakan_petugasradiologiranap"), rs.getDouble("ksoradiologiranap"),
                        rs.getDouble("menejemenradiologiranap"), rs.getDouble("biayaradiologiranap"),
                        rs.getDouble("jmdokteroperasiralan"), rs.getDouble("jmparamedisoperasiralan"),
                        rs.getDouble("bhpoperasiralan"), rs.getDouble("pendapatanoperasiralan"),
                        rs.getDouble("jmdokteroperasiranap"), rs.getDouble("jmparamedisoperasiranap"),
                        rs.getDouble("bhpoperasiranap"), rs.getDouble("pendapatanoperasiranap"),
                        rs.getDouble("obatlangsung"), rs.getDouble("obatralan"), rs.getDouble("hppobatralan"),
                        rs.getDouble("obatranap"), rs.getDouble("hppobatranap"), rs.getDouble("returobat"),
                        rs.getDouble("tambahanbiaya"), rs.getDouble("potonganbiaya"), rs.getDouble("kamar"),
                        rs.getDouble("reseppulang"), rs.getDouble("harianranap"), rs.getDouble("registrasi"),
                        rs.getString("petugas"), rs.getString("kd_rek"), rs.getString("kd_rek_kontra"),
                        rs.getDouble("service"), rs.getString("ppn_obat")});
    ...
    private static final Logger LOG = Logger.getLogger(KeuanganCariRVPBPJS.class.getName());
