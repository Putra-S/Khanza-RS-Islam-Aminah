...
//GEN-FIRST:event_TKdKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ...
            tanggal = " inventaris_titip_faktur.tanggal between '" + Valid.SetTgl(Tanggal1.getSelectedItem() + "")
            ...
            if (!NmPeg.getText().trim().isEmpty()) {
                petugas = " and concat(inventaris_titip_faktur.nip,petugas.nama) like '%" + KdPeg.getText()
                        + NmPeg.getText() + "%' ";
            }

            if (!TCari.getText().trim().isEmpty()) {
                cari = " and (inventaris_titip_faktur.no_tagihan like '%" + TCari.getText()
                        + "%' or petugas.nama like '%" + TCari.getText()
                        + "%' or inventaris_titip_faktur.keterangan like '%" + TCari.getText()
                        + "%' or inventaris_detail_titip_faktur.no_faktur like '%" + TCari.getText()
                        + "%' or inventaris_suplier.nama_suplier like '%" + TCari.getText() + "%' ) ";
            }
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + "where " + tanggal + status + notagihan + petugas + cari
                    + " group by inventaris_titip_faktur.no_tagihan order by inventaris_titip_faktur.tanggal");
            try {
                rs = ps.executeQuery();
                totaltagihan = 0;
                while (rs.next()) {
                    ...
                    ps2 = koneksi.prepareStatement(
                            ...
                            + "' and " + tanggal + status + notagihan + petugas + cari
                            + " order by inventaris_titip_faktur.tanggal");
                    try {
                        nilaitagihan = 0;
    ...
    private static final Logger LOG = Logger.getLogger(KeuanganCariTagihanAset.class.getName());
