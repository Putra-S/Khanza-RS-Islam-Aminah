...
public class KeuanganRingkasanPiutangPerJensBayar extends javax.swing.JDialog {
    ...
    public KeuanganRingkasanPiutangPerJensBayar(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr = {"Kode", "Jenis/Cara Bayar", "Sisa Piutang"};
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganRingkasanPiutangPerJensBayar dialog = new KeuanganRingkasanPiutangPerJensBayar(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    : "where (penjab.png_jawab like ? or detail_piutang_pasien.kd_pj like ?) ")
            ...
            try {
                ...
                sisapiutang = 0;
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kd_pj"), rs.getString("png_jawab"),
                        rs.getDouble("sisapiutang")});
    ...
    private static final Logger LOG = Logger.getLogger(KeuanganRingkasanPiutangPerJensBayar.class.getName());
