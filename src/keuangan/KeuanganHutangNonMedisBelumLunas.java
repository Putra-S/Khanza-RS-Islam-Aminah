...
public class KeuanganHutangNonMedisBelumLunas extends javax.swing.JDialog {
    ...
    private int row = 0, i;
    private String koderekening = "", tanggaldatang = "", tanggaltempo = "", Bayar_Pemesanan_Non_Medis = Sequel.
            cariIsi("select Bayar_Pemesanan_Non_Medis from set_akun");
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganHutangNonMedisBelumLunas dialog = new KeuanganHutangNonMedisBelumLunas(
    ...
    public void tampil() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + (TCari.getText().trim().isEmpty() ? "" : "and (ipsrspemesanan.no_faktur like ? or ipsrspemesanan.no_order like ? or ipsrspemesanan.tgl_tempo like ? or "
    ...
    private void getData() {
        ...
        for (i = 0; i < row; i++) {
            if (tbBangsal.getValueAt(i, 0).toString().equals("true")) {
                bayar += Double.parseDouble(tbBangsal.getValueAt(i, 10).
                        toString());
            }
        }
    ...
    private void panggilPhoto() {
        if (FormPhoto.isVisible() == true) {
            try {
                ps = koneksi.prepareStatement(
                        "select photo from bukti_pemesanan_logistik where no_faktur=?");
                try {
                        ...
                        if (rs.getString("photo").isEmpty() || rs.getString(
                            ...
                            LoadHTML.setText(
                                    "<html><body><center><img src='http://" + koneksiDB.
                                            ...
                                            PORTWEB() + "/" + koneksiDB.
                                            HYBRIDWEB() + "/penerimaanlogistik/" + rs.
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        ...
                        getDouble("bayar")),
                        0, (rs.getDouble("tagihan") - rs.getDouble("bayar")),
                        rs.getString("nama_bank"), rs.getString("rekening")
                    });
                    sisahutang += rs.getDouble("tagihan");
                    cicilan += rs.getDouble("bayar");
    ...
    private static final Logger LOG = Logger.getLogger(
            KeuanganHutangNonMedisBelumLunas.class.getName());
}
