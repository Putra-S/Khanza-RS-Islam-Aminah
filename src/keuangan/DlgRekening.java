 ...
 * @author dosen
 */
public class DlgRekening extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("rekening", "'" + Kd.getText() + "','"
                    ...
                    + Balan.getSelectedItem().toString().substring(0, 1) + "','0'",
                    "Kode Rekening");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Valid.editTable(tabMode, "rekening", "kd_rek", Kd2, "nm_rek='" + Nm.
                    getText()
                    + "',tipe='" + Tipe.getSelectedItem().toString().
                            substring(0, 1) + "',balance='" + Balan.
                    getSelectedItem().toString().substring(0, 1) + "',kd_rek='" + Kd.
                    getText() + "'");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
            ...
            if (TCari.getText().trim().isEmpty()) {
                ...
                for (int i = 0; i < row; i++) {
                    Sequel.menyimpan("temporary", "'" + i + "','"
                            ...
                            + tabMode.getValueAt(i, 5).toString() + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
                            getalamatip() + "'", "Keuangan");
                }

                Valid.MyReportqry("rptRekening2.jasper", "report",
                        "::[ Data Rekening ]::",
                        "select * from temporary where temporary.temp37='" + akses.
                                getalamatip() + "' order by temporary.no", param);
            } else {
                Valid.MyReportqry("rptRekening.jasper", "report",
                        "::[ Data Rekening ]::",
                        "select kd_rek, nm_rek, tipe, balance "
                        + " from rekening where kd_rek like '%" + TCari.
                                getText().trim() + "%' or "
                        + " nm_rek like '%" + TCari.getText().trim() + "%' or "
                        + " tipe like '%" + TCari.getText().trim() + "%' or "
                        + " balance like '%" + TCari.getText().trim() + "%' order by kd_rek",
                        param);
            }
...
private void NmKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmKeyPressed
    ...
    private void BtnSimpan5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan5ActionPerformed
        if (KdSub.getText().trim().isEmpty()) {
            Valid.textKosong(KdSub, "Kode Rekening");
        } else if (NmSub.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("rekening", "'" + KdSub.getText() + "','"
                    ...
                    + Balan1.getSelectedItem().toString().substring(0, 1) + "','1'",
                    "Kode Rekening") == true) {
                Sequel.menyimpan("subrekening",
                        "'" + Kd.getText() + "','" + KdSub.getText() + "'");
                BtnCariActionPerformed(evt);
                emptTeks2();
            }
        }
    ...
    private void MnSubAkunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSubAkunActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            JOptionPane.showMessageDialog(null,
                    "Maaf, Silahkan anda pilih dulu Akun Rekening...!!!");
    ...
    private void BtnSimpan6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan6ActionPerformed
        if (KdSubInduk.getText().trim().isEmpty()) {
            Valid.textKosong(KdSub, "Kode Rekening");
        } else if (NmSubInduk.getText().trim().isEmpty()) {
            Valid.textKosong(NmSub, "Nama Rekening");
        } else {
            Sequel.meghapus("subrekening", "kd_rek2", Kd.getText());
            if (Sequel.menyimpantf2("subrekening",
                    "'" + KdSubInduk.getText() + "','" + Kd.getText() + "'",
                    "Sub Rekening") == true) {
                Sequel.mengedit("rekening", "kd_rek='" + Kd.getText() + "'",
                        "level='1'");
            } else {
                Sequel.mengedit("rekening", "kd_rek='" + Kd.getText() + "'",
                        "level='0'");
    ...
    private void BtnCari1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCari1ActionPerformed
        Sequel.cariIsi(
                ...
                NmSubInduk, KdSubInduk.getText());
        if (NmSubInduk.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(rootPane,
                    "Akun Rekening tidak ditemukan");
        }
        KdSubInduk.requestFocus();
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select kd_rek, nm_rek, tipe, balance "
                    + " from rekening where level='0' and kd_rek like ? or " + " level='0' and nm_rek like ? or "
                    + " level='0' and tipe like ? or " + " level='0' and balance like ? order by kd_rek");
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString(1), rs.getString(2), rs.getString(1), rs.getString(2),
                        rs.getString(3), rs.getString(4)});
                    ps2 = koneksi
                            .prepareStatement("select rekening.kd_rek, rekening.nm_rek, rekening.tipe, rekening.balance "
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new Object[]{rs2.getString(1), rs2.getString(2), " " + rs2.getString(1),
                            ...
                            try {
                                ...
                                while (rs3.next()) {
                                    tabMode.addRow(
                                            new Object[]{rs3.getString(1), rs3.getString(2), "  " + rs3.getString(1),
                                    ...
                                    try {
                                        ...
                                        while (rs4.next()) {
                                            tabMode.addRow(new Object[]{rs4.getString(1), rs4.getString(2),
                                            ...
                                            try {
                                                ...
                                                while (rs5.next()) {
                                                    tabMode.addRow(new Object[]{rs5.getString(1), rs5.getString(2),
                                                    ...
                                                    try {
                                                        ...
                                                        while (rs6.next()) {
                                                            tabMode.addRow(new Object[]{rs6.getString(1),
                                                                rs6.getString(2), "     " + rs6.getString(1),
                                                            ...
                                                            try {
                                                                ...
                                                                while (rs7.next()) {
                                                                    tabMode.addRow(new Object[]{rs7.getString(1),
                                                                        rs7.getString(2),
                                                                        "      " + rs7.getString(1),
                                                                        "      " + rs7.getString(2),
                                                                        rs7.getString(3), rs7.getString(4)});
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        while (rs8.next()) {
                                                                            tabMode.addRow(new Object[]{
                                                                                rs8.getString(1), rs8.getString(2),
                                                                                "       " + rs8.getString(1),
                                                                                "       " + rs8.getString(2),
                                                                                rs8.getString(3),
                                                                                rs8.getString(4)});
    ...
    public void tampil2() {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select kd_rek, nm_rek, tipe, balance " + " from rekening where kd_rek like ? or "
                            + " nm_rek like ? or " + " tipe like ? or " + " balance like ? order by kd_rek");
            try {
                ps.setString(1, "%" + TCari.getText().trim() + "%");
                ps.setString(2, "%" + TCari.getText().trim() + "%");
                ps.setString(3, "%" + TCari.getText().trim() + "%");
    ...
    private static final Logger LOG = Logger.getLogger(DlgRekening.class.getName());
