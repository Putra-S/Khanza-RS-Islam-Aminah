...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (chkRalan.isSelected() == true) {
                        psralanpr = koneksi.prepareStatement("select jns_perawatan.nm_perawatan,rawat_jl_pr.menejemen,"
                                + "count(rawat_jl_pr.kd_jenis_prw) as jml," + "sum(rawat_jl_pr.menejemen) as total "
                        ...
                        psralandrpr = koneksi
                                .prepareStatement("select jns_perawatan.nm_perawatan,rawat_jl_drpr.menejemen,"
                        ...
                        psralandr = koneksi.prepareStatement("select jns_perawatan.nm_perawatan,rawat_jl_dr.menejemen,"
                                + "count(rawat_jl_dr.kd_jenis_prw) as jml," + "sum(rawat_jl_dr.menejemen) as total "
                    ...
                    if (chkRanap.isSelected() == true) {
                        psranappr = koneksi
                                .prepareStatement("select jns_perawatan_inap.nm_perawatan,rawat_inap_pr.menejemen,"
                        ...
                        psranapdrpr = koneksi
                                .prepareStatement("select jns_perawatan_inap.nm_perawatan,rawat_inap_drpr.menejemen,"
                        ...
                        psranapdr = koneksi
                                .prepareStatement("select jns_perawatan_inap.nm_perawatan,rawat_inap_dr.menejemen,"
                    ...
                    if (chkOperasi.isSelected() == true) {
                        psbagian_rs = koneksi.prepareStatement("select paket_operasi.nm_perawatan,operasi.bagian_rs,"
                                + "count(operasi.kode_paket) as jml, " + "sum(operasi.bagian_rs) as total "
                    ...
                    if (chkLaborat.isSelected() == true) {
                        psperiksalab = koneksi
                                .prepareStatement("select jns_perawatan_lab.nm_perawatan,periksa_lab.menejemen,"
                        ...
                        try {
                            ...
                            while (rsperiksalab.next()) {
                                detaillab = 0;
                                psdetaillab = koneksi
                                        .prepareStatement("select sum(detail_periksa_lab.menejemen) as total from "
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        psperiksaradiologi = koneksi
                                .prepareStatement("select jns_perawatan_radiologi.nm_perawatan,periksa_radiologi.menejemen,"
    ...
    private static final Logger LOG = Logger.getLogger(DlgRBMenejemen.class.getName());
