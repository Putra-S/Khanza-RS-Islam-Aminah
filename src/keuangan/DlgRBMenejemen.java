...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRBMenejemen.jasper", "report",
                    "[ Rekap Bulanan Menejemen Rumah Sakit ]",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRBMenejemen dialog = new DlgRBMenejemen(new javax.swing.JFrame(),
                    true);
                ...
                while (rs.next()) {
                    ...
                    if (chkRalan.isSelected() == true) {
                        ...
                        psralandrpr = koneksi.prepareStatement(
                                "select jns_perawatan.nm_perawatan,rawat_jl_drpr.menejemen,"
                        ...
                        psralandr = koneksi.prepareStatement(
                                "select jns_perawatan.nm_perawatan,rawat_jl_dr.menejemen,"
                    ...
                    if (chkRanap.isSelected() == true) {
                        psranappr = koneksi.prepareStatement(
                                "select jns_perawatan_inap.nm_perawatan,rawat_inap_pr.menejemen,"
                        ...
                        psranapdrpr = koneksi.prepareStatement(
                                "select jns_perawatan_inap.nm_perawatan,rawat_inap_drpr.menejemen,"
                        ...
                        psranapdr = koneksi.prepareStatement(
                                "select jns_perawatan_inap.nm_perawatan,rawat_inap_dr.menejemen,"
                    ...
                    if (chkOperasi.isSelected() == true) {
                        psbagian_rs = koneksi.prepareStatement(
                                "select paket_operasi.nm_perawatan,operasi.bagian_rs,"
                        ...
                        try {
                            ...
                            while (rsbagian_rs.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    "nm_perawatan") + " (N.M.S)",
                                    rsbagian_rs.getString("jml"), Valid.
                                    SetAngka(rsbagian_rs.getDouble("total"))
                                });
                                jm += rsbagian_rs.getDouble("total");
                            }
                        } catch (Exception e) {
                    ...
                    if (chkLaborat.isSelected() == true) {
                        psperiksalab = koneksi.prepareStatement(
                                "select jns_perawatan_lab.nm_perawatan,periksa_lab.menejemen,"
    ...
    private static final Logger LOG = Logger.getLogger(DlgRBMenejemen.class.
            getName());
