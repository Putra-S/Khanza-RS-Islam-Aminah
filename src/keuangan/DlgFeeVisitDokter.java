    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (i = 0; i < tabMode.getRowCount(); i++) {
                try {
                    sjmlvisit = Valid.SetAngka(Double.parseDouble(tabMode.
                            getValueAt(i, 6).toString()));
                } catch (Exception e) {
                    sjmlvisit = "";
                }
                try {
                    sjmlbyphone = Valid.SetAngka(Double.parseDouble(tabMode.
                            getValueAt(i, 7).toString()));
                } catch (Exception e) {
                    sjmlbyphone = "";
                }
                try {
                    starifvisit = Valid.SetAngka(Double.parseDouble(tabMode.
                            getValueAt(i, 8).toString()));
                } catch (Exception e) {
                    starifvisit = "";
                }
                try {
                    starifbyphone = Valid.SetAngka(Double.parseDouble(tabMode.
                            getValueAt(i, 9).toString()));
                } catch (Exception e) {
                    starifbyphone = "";
                }
                try {
                    svisit = Valid.SetAngka(Double.parseDouble(tabMode.
                            getValueAt(i, 10).toString()));
                } catch (Exception e) {
                    svisit = "";
                }
                try {
                    sbyphone = Valid.SetAngka(Double.parseDouble(tabMode.
                            getValueAt(i, 11).toString()));
                } catch (Exception e) {
                    sbyphone = "";
                }
                try {
                    sbruto = Valid.SetAngka(Double.parseDouble(tabMode.
                            getValueAt(i, 12).toString()));
                } catch (Exception e) {
                    sbruto = "";
                }
                try {
                    sjasa = Valid.SetAngka(Double.parseDouble(tabMode.
            ...
            Valid.MyReportqry("rptFeeVisitDokter.jasper", "report",
                    "[ Rekap Jasa Visit Dokter ]",
