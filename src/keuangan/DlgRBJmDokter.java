...
public class DlgRBJmDokter extends javax.swing.JDialog {
    ...
    private PreparedStatement ps, psralandokter, psralandokterdrpr, psranapdokter, psranapdokterdrpr, psbiayaoperator1,
            psbiayaoperator2, psbiayaoperator3, psbiayadokter_anak, psbiayadokter_anestesi, psperiksa_lab, psdetaillab,
            psperiksa_lab2, psdetaillab2, psperiksa_radiologi, psperiksa_radiologi2, psbiaya_dokter_pjanak,
            psbiaya_dokter_umum;

    private ResultSet rs, rsralandokter, rsralandokterdrpr, rsranapdokter, rsranapdokterdrpr, rsbiayaoperator1,
            rsbiayaoperator2, rsbiayaoperator3, rsbiayadokter_anak, rsbiayadokter_anestesi, rsperiksa_lab, rsdetaillab,
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (chkRalan.isSelected() == true) {
                        psralandokter = koneksi
                                .prepareStatement("select jns_perawatan.nm_perawatan,rawat_jl_dr.tarif_tindakandr,"
                        ...
                        psralandokterdrpr = koneksi
                                .prepareStatement("select jns_perawatan.nm_perawatan,rawat_jl_drpr.tarif_tindakandr,"
                        ...
                        try {
                            ...
                            while (rsralandokter.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    + rsralandokter.getString("kd_jenis_prw") + ")",
                                    rsralandokter.getString("jml"),
                                    Valid.SetAngka(rsralandokter.getDouble("total"))});
                            ...
                            while (rsralandokterdrpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rsralandokterdrpr.getString("nm_perawatan") + " ("
                                    + rsralandokterdrpr.getString("kd_jenis_prw") + ")",
                                    rsralandokterdrpr.getString("jml"),
                                    Valid.SetAngka(rsralandokterdrpr.getDouble("total"))});
                    ...
                    if (chkRanap.isSelected() == true) {
                        psranapdokter = koneksi
                                .prepareStatement("select jns_perawatan_inap.nm_perawatan,rawat_inap_dr.tarif_tindakandr,"
                        ...
                        psranapdokterdrpr = koneksi
                                .prepareStatement("select jns_perawatan_inap.nm_perawatan,rawat_inap_drpr.tarif_tindakandr,"
                        ...
                        try {
                            ...
                            while (rsranapdokter.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    + rsranapdokter.getString("kd_jenis_prw") + ")",
                                    rsranapdokter.getString("jml"),
                                    Valid.SetAngka(rsranapdokter.getDouble("total"))});
                                jm += rsranapdokter.getDouble("total");
                            }
                            rsranapdokterdrpr.beforeFirst();
                            while (rsranapdokterdrpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rsranapdokterdrpr.getString("nm_perawatan") + " ("
                                    + rsranapdokterdrpr.getString("kd_jenis_prw") + ")",
                                    rsranapdokterdrpr.getString("jml"),
                                    Valid.SetAngka(rsranapdokterdrpr.getDouble("total"))});
                    ...
                    if (chkOperasi.isSelected() == true) {
                        psbiayaoperator1 = koneksi
                                .prepareStatement("select paket_operasi.nm_perawatan,operasi.biayaoperator1,"
                        ...
                        psbiayaoperator2 = koneksi
                                .prepareStatement("select paket_operasi.nm_perawatan,operasi.biayaoperator2,"
                                        + "count(operasi.kode_paket) as jml, "
                        ...
                        psbiayaoperator3 = koneksi
                                .prepareStatement("select paket_operasi.nm_perawatan,operasi.biayaoperator3,"
                                        + "count(operasi.kode_paket) as jml, "
                        ...
                        psbiayadokter_anak = koneksi
                                .prepareStatement("select paket_operasi.nm_perawatan,operasi.biayadokter_anak,"
                                        + "count(operasi.kode_paket) as jml, "
                        ...
                        psbiaya_dokter_umum = koneksi
                                .prepareStatement("select paket_operasi.nm_perawatan,operasi.biaya_dokter_umum,"
                                        + "count(operasi.kode_paket) as jml, "
                        ...
                        psbiaya_dokter_pjanak = koneksi
                                .prepareStatement("select paket_operasi.nm_perawatan,operasi.biaya_dokter_pjanak,"
                                        + "count(operasi.kode_paket) as jml, "
                        ...
                        psbiayadokter_anestesi = koneksi
                                .prepareStatement("select paket_operasi.nm_perawatan,operasi.biayadokter_anestesi,"
                                        + "count(operasi.kode_paket) as jml, "
                        ...
                        try {
                            ...
                            if ((rsbiayaoperator1.next()) || (rsbiayaoperator2.next()) || (rsbiayaoperator3.next())
                                    || (rsbiayadokter_anak.next()) || (rsbiaya_dokter_pjanak.next())
                                    || (rsbiaya_dokter_umum.next()) || (rsbiayadokter_anestesi.next())) {
                                a++;
                            ...
                            while (rsbiayaoperator1.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    rsbiayaoperator1.getString("jml"),
                                    Valid.SetAngka(rsbiayaoperator1.getDouble("total"))});
                            ...
                            while (rsbiayaoperator2.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    rsbiayaoperator2.getString("jml"),
                                    Valid.SetAngka(rsbiayaoperator2.getDouble("total"))});
                            ...
                            while (rsbiayaoperator3.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    rsbiayaoperator3.getString("jml"),
                                    Valid.SetAngka(rsbiayaoperator3.getDouble("total"))});
                            ...
                            while (rsbiayadokter_anak.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    rsbiayadokter_anak.getString("jml"),
                                    Valid.SetAngka(rsbiayadokter_anak.getDouble("total"))});
                            ...
                            while (rsbiayadokter_anestesi.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsbiayadokter_anestesi.getDouble("total"))});
                            ...
                            while (rsbiaya_dokter_pjanak.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsbiaya_dokter_pjanak.getDouble("total"))});
                            ...
                            while (rsbiaya_dokter_umum.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    rsbiaya_dokter_umum.getString("jml"),
                                    Valid.SetAngka(rsbiaya_dokter_umum.getDouble("total"))});
                    ...
                    if (chkLaborat.isSelected() == true) {
                        psperiksa_lab = koneksi
                                .prepareStatement("select jns_perawatan_lab.nm_perawatan,periksa_lab.tarif_tindakan_dokter,"
                        ...
                        try {
                            ...
                            while (rsperiksa_lab.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    rsperiksa_lab.getString("jml"),
                                    Valid.SetAngka(rsperiksa_lab.getDouble("total"))});
                        ...
                        psdetaillab = koneksi.prepareStatement("select sum(detail_periksa_lab.bagian_dokter) as total,"
                        ...
                        // perujuk Lab
                        psperiksa_lab2 = koneksi
                                .prepareStatement("select jns_perawatan_lab.nm_perawatan,periksa_lab.tarif_perujuk,"
                        ...
                        psdetaillab2 = koneksi
                                .prepareStatement("select sum(detail_periksa_lab.bagian_perujuk) as total, "
                                        + "count(detail_periksa_lab.id_template)as jml,"
                                        + "template_laboratorium.Pemeriksaan, " + "periksa_lab.kd_jenis_prw "
                        ...
                        try {
                            ...
                            while (rsperiksa_radiologi.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    rsperiksa_radiologi.getString("jml"),
                                    Valid.SetAngka(rsperiksa_radiologi.getDouble("total"))});
    ...
    private static final Logger LOG = Logger.getLogger(DlgRBJmDokter.class.getName());
