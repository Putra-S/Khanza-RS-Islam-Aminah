...
public class DlgRBJmDokter extends javax.swing.JDialog {
    ...
    public DlgRBJmDokter(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.", "Nama Dokter", "Tindakan Medis", "Jumlah",
            "Jasa Medis"};
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRBTindakanDokter.jasper", "report",
                    "[ Rekap Bulanan Tindakan Dokter ]",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRBJmDokter dialog = new DlgRBJmDokter(new javax.swing.JFrame(),
                    true);
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (chkRalan.isSelected() == true) {
                        ...
                        try {
                            psralandokter.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + ""));
                            psralandokter.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + ""));
                            psralandokter.
                                    setString(3, rs.getString("kd_dokter"));
                            psralandokter.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsralandokter = psralandokter.executeQuery();

                            psralandokterdrpr.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + ""));
                            psralandokterdrpr.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + ""));
                            psralandokterdrpr.setString(3, rs.getString(
                                    "kd_dokter"));
                            psralandokterdrpr.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            ...
                            while (rsralandokter.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsralandokter.getString(
                                    "nm_perawatan") + " (" + rsralandokter.
                                    getString("kd_jenis_prw") + ")",
                                    rsralandokter.getString("jml"), Valid.
                                    SetAngka(rsralandokter.getDouble("total"))
                                });
                            ...
                            while (rsralandokterdrpr.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsralandokterdrpr.
                                    getString("nm_perawatan") + " (" + rsralandokterdrpr.
                                    getString("kd_jenis_prw") + ")",
                                    rsralandokterdrpr.getString("jml"), Valid.
                                    SetAngka(rsralandokterdrpr.
                                    getDouble("total"))
                                });
                    ...
                    if (chkRanap.isSelected() == true) {
                        ...
                        try {
                            psranapdokter.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + ""));
                            psranapdokter.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + ""));
                            psranapdokter.
                                    setString(3, rs.getString("kd_dokter"));
                            psranapdokter.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsranapdokter = psranapdokter.executeQuery();

                            psranapdokterdrpr.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + ""));
                            psranapdokterdrpr.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + ""));
                            psranapdokterdrpr.setString(3, rs.getString(
                                    "kd_dokter"));
                            psranapdokterdrpr.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsranapdokterdrpr = psranapdokterdrpr.executeQuery();
                            if ((rsranapdokterdrpr.next()) || (rsranapdokter.
                                    next())) {
                                a++;
                                tabMode.addRow(new Object[]{"", "",
                                    a + ". Rawat Inap", "", "", ""});
                            ...
                            while (rsranapdokter.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsranapdokter.getString(
                                    "nm_perawatan") + " (" + rsranapdokter.
                                    getString("kd_jenis_prw") + ")",
                                    rsranapdokter.getString("jml"), Valid.
                                    SetAngka(rsranapdokter.getDouble("total"))
                                });
                            ...
                            while (rsranapdokterdrpr.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsranapdokterdrpr.
                                    getString("nm_perawatan") + " (" + rsranapdokterdrpr.
                                    getString("kd_jenis_prw") + ")",
                                    rsranapdokterdrpr.getString("jml"), Valid.
                                    SetAngka(rsranapdokterdrpr.
                                    getDouble("total"))
                                });
                    ...
                    if (chkOperasi.isSelected() == true) {
                        ...
                        psbiayaoperator2 = koneksi.prepareStatement(
                                "select paket_operasi.nm_perawatan,operasi.biayaoperator2,"
                                + "count(operasi.kode_paket) as jml, "
                        ...
                        psbiayaoperator3 = koneksi.prepareStatement(
                                "select paket_operasi.nm_perawatan,operasi.biayaoperator3,"
                                + "count(operasi.kode_paket) as jml, "
                        ...
                        psbiayadokter_anak = koneksi.prepareStatement(
                                "select paket_operasi.nm_perawatan,operasi.biayadokter_anak,"
                                + "count(operasi.kode_paket) as jml, "
                        ...
                        psbiaya_dokter_umum = koneksi.prepareStatement(
                                "select paket_operasi.nm_perawatan,operasi.biaya_dokter_umum,"
                                + "count(operasi.kode_paket) as jml, "
                        ...
                        psbiaya_dokter_pjanak = koneksi.prepareStatement(
                                "select paket_operasi.nm_perawatan,operasi.biaya_dokter_pjanak,"
                                + "count(operasi.kode_paket) as jml, "
                        ...
                        psbiayadokter_anestesi = koneksi.prepareStatement(
                                "select paket_operasi.nm_perawatan,operasi.biayadokter_anestesi,"
                                + "count(operasi.kode_paket) as jml, "
                        ...
                        try {
                            ...
                            if ((rsbiayaoperator1.next()) || (rsbiayaoperator2.
                                    next()) || (rsbiayaoperator3.next()) || (rsbiayadokter_anak.
                                    next()) || (rsbiaya_dokter_pjanak.next()) || (rsbiaya_dokter_umum.
                                    next()) || (rsbiayadokter_anestesi.next())) {
                                a++;
                                tabMode.addRow(new Object[]{"", "",
                                    a + ". Operasi/VK", "", "", ""});
                            }
                            ...
                            while (rsbiayaoperator1.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsbiayaoperator1.
                                    getString("nm_perawatan") + " (" + rsbiayaoperator1.
                                    getString("kode_paket") + ")(Operator 1)",
                                    rsbiayaoperator1.getString("jml"), Valid.
                                    SetAngka(rsbiayaoperator1.getDouble("total"))
                                });
                            ...
                            while (rsbiayaoperator2.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rsbiayaoperator2.getString(
                                    "nm_perawatan") + " (" + rsbiayaoperator2.
                                    getString("kode_paket") + ")(Operator 2)",
                                    rsbiayaoperator2.getString("jml"), Valid.
                                    SetAngka(rsbiayaoperator2.getDouble("total"))
                                });
                            ...
                            while (rsbiayaoperator3.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rsbiayaoperator3.getString(
                                    "nm_perawatan") + " (" + rsbiayaoperator3.
                                    getString("kode_paket") + ")(Operator 3)",
                                    rsbiayaoperator3.getString("jml"), Valid.
                                    SetAngka(rsbiayaoperator3.getDouble("total"))
                                });
                            ...
                            while (rsbiayadokter_anak.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rsbiayadokter_anak.getString(
                                    "nm_perawatan") + " (" + rsbiayadokter_anak.
                                    getString("kode_paket") + ")(dr Anak)",
                                    rsbiayadokter_anak.getString("jml"), Valid.
                                    SetAngka(rsbiayadokter_anak.getDouble(
                                    "total"))
                                });
                            ...
                            while (rsbiayadokter_anestesi.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    getString("nm_perawatan") + " (" + rsbiayadokter_anestesi.
                                    getString("kode_paket") + ")(dr Anestesi)",
                                    rsbiayadokter_anestesi.getString("jml"),
                            ...
                            while (rsbiaya_dokter_pjanak.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    getString("nm_perawatan") + " (" + rsbiaya_dokter_pjanak.
                                    getString("kode_paket") + ")(dr Pj Anak)",
                                    rsbiaya_dokter_pjanak.getString("jml"),
                            ...
                            while (rsbiaya_dokter_umum.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rsbiaya_dokter_umum.getString(
                                    "nm_perawatan") + " (" + rsbiaya_dokter_umum.
                                    getString("kode_paket") + ")(dr Umum)",
                                    rsbiaya_dokter_umum.getString("jml"), Valid.
                                    SetAngka(rsbiaya_dokter_umum.getDouble(
                                    "total"))
                                });
                        ...
                        try {
                            ...
                            while (rsperiksa_lab.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    "nm_perawatan") + " (" + rsperiksa_lab.
                                    getString("kd_jenis_prw") + ")",
                                    rsperiksa_lab.getString("jml"), Valid.
                                    SetAngka(rsperiksa_lab.getDouble("total"))
                                });
                        ...
                        try {
                            ...
                            while (rsdetaillab.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    "Pemeriksaan") + " (" + rsdetaillab.
                                    getString("kd_jenis_prw") + ")",
                                    rsdetaillab.getString("jml"), rsdetaillab.
                                    getString("total")
                                });
                                jm += rsdetaillab.getDouble("total");
                            }
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        ...
                        try {
                            ...
                            while (rsperiksa_radiologi.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    getString("kd_jenis_prw") + ")",
                                    rsperiksa_radiologi.getString("jml"), Valid.
                        ...
                        psperiksa_radiologi2 = koneksi.prepareStatement(
                                "select jns_perawatan_radiologi.nm_perawatan,periksa_radiologi.tarif_perujuk,"
                                + "periksa_radiologi.kd_jenis_prw,count(periksa_radiologi.kd_jenis_prw) as jml, "
                        ...
                        try {
                            ...
                            System.out.println(
                                    "Notifikasi Radiologi Perujuk : " + e);
                        } finally {
                            if (rsperiksa_radiologi != null) {
                                rsperiksa_radiologi.close();
                            }
    ...
    private static final Logger LOG = Logger.getLogger(DlgRBJmDokter.class.
            getName());
}
