...
//        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgLaporanAnalisa dialog = new DlgLaporanAnalisa(
...
//                    tabMode.addRow(new Object[]{i+". ",rspoli.getString(1),rspoli.getString(2),rspoli.getString(3),"","","",""});
                    pspenjab = koneksi.prepareStatement(
                            "select distinct dokter.nm_dokter from rawat_inap_dr inner join dokter "
...
//                            tabMode.addRow(new Object[]{"","","",rspenjab.getString(1),"","","",""});
                    ...
                    tabMode.addRow(new Object[]{i + ". ", rspoli.getString(1),
                        rspoli.getString(2), rspoli.getString(3), dokterranap,
                        "", "", ""});
                    i++;
                    //tindakan dr
                    ...
                    try {
                        ...
                        while (rstindakan.next()) {
                            tabMode.addRow(new Object[]{"", rspoli.getString(1),
                                rspoli.getString(2), rspoli.getString(3),
                                dokterranap, rstindakan.getString(1),
                                rstindakan.getString(2), (rstindakan.getDouble(
                                "totaljm") + rstindakan.getDouble("totalsarana"))});
                        }
                    } catch (Exception e) {
...
//                tabMode.addRow(new Object[]{">>","Total ",":","",Valid.SetAngka(ttlbiaya),Valid.SetAngka(ttlembalase),Valid.SetAngka(ttltuslah),Valid.SetAngka(ttltotal)});
    ...
    private static final Logger LOG = Logger.getLogger(DlgLaporanAnalisa.class.
            getName());
