...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganValidasiTagihanNonMedis dialog = new KeuanganValidasiTagihanNonMedis(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + "where ipsrs_titip_faktur.status='Ditagihkan' " + carisuplier + cari
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{rs.getString("no_tagihan"), rs.getString("tanggal"),
                        ...
                        Valid.SetAngka(rs.getDouble("tagihan") - bayar)});
    ...
    private static final Logger LOG = Logger.getLogger(KeuanganValidasiTagihanNonMedis.class.getName());
