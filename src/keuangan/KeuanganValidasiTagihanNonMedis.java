 ...
 * @author perpustakaan
 */
public class KeuanganValidasiTagihanNonMedis extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptValidasiTagihanNonMedis.jasper", "report",
                    "::[ Data Pegajuan Titip Faktur/Tagihan Non Medis ]::",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganValidasiTagihanNonMedis dialog = new KeuanganValidasiTagihanNonMedis(
    ...
    private void tampil() {
        ...
        try {
            ...
            if (!nmsuplier.getText().trim().isEmpty()) {
                carisuplier = " and ipsrspemesanan.kode_suplier='" + kdsuplier.
                        getText() + "' ";
            }
    ...
    private static final Logger LOG = Logger.getLogger(
            KeuanganValidasiTagihanNonMedis.class.getName());
}
