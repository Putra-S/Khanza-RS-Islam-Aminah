 ...
 * @author perpustakaan
 */
public class KeuanganTagihanObatBHP extends javax.swing.JDialog {
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if (NoTagihan.getText().trim().isEmpty()) {
            ...
            if (i == JOptionPane.YES_OPTION) {
                ...
                sukses = true;
                if (Sequel.menyimpantf2("titip_faktur", "?,?,?,?,'Ditagihkan'",
                        "No.Tagihan", 4, new String[]{
                    ...
                    for (i = 0; i < row; i++) {
                        if (tabMode.getValueAt(i, 0).toString().equals("true")) {
                            if (Sequel.
                                    menyimpantf2("detail_titip_faktur", "?,?",
    ...
    private void BtnCari1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCari1ActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        KeuanganCariTagihanObatBHP form = new KeuanganCariTagihanObatBHP(null,
                false);
        form.emptTeks();
        form.isCek();
    ...
    private void autoNomor() {
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(no_tagihan,3),signed)),0) from titip_faktur where tanggal='"
                + Valid.SetTgl(Tanggal.getSelectedItem() + "") + "' ",
                "TH" + Tanggal.getSelectedItem().toString().substring(6, 10)
    ...
    private static final Logger LOG = Logger.getLogger(KeuanganTagihanObatBHP.class.getName());
