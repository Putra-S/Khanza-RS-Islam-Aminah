...
public class DlgPembayaranPerAKunBayar3 extends javax.swing.JDialog {
    ...
    private String tanggal2 = "", nopemasukanlain = "", nonota = "", petugas = "", norawatjalan = "", norawatinap = "", notajual = "", carabayar = "", nodeposit = "";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPembayaranPerAKunBayar3 dialog = new DlgPembayaranPerAKunBayar3(
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgPembayaranPerAKunBayar3.class.getName());
}
