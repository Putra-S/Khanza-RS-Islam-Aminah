 ...
 * @author perpustakaan
 */
public class DlgPembayaranPerAKunBayar3 extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ...
            htmlContent.append("<tr class='head'>"
                    ...
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='400px'>Akun Bayar</td>" + "</tr>");
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (!nonota.isEmpty()) {
                        ...
                        carabayar = Sequel.cariIsi(
                                "select png_jawab from penjab inner join reg_periksa on penjab.kd_pj=reg_periksa.kd_pj where reg_periksa.no_rawat=?",
                    ...
                    if ((petugas.toLowerCase().trim().contains(User.getText().toLowerCase().trim()))
                        ...
                        htmlContent.append("<tr class='isi'><td valign='middle' align='center'>")
                                ...
                                .append("</td><td valign='middle' align='left'>")
                                .append(petugas)
                                .append("</td><td><table width='100%' border='0' align='left' cellpadding='3px' cellspacing='0' class='tbl_form'>");
                        for (i = 0; i < kolom; i++) {
                            bayar = 0;
                            ...
                            if (bayar > 0) {
                                htmlContent
                                        .append("<tr class='isi'><td valign='middle' width='70%' align='left' border='0'>")
                                        .append(namabayar[i])
                                        .append("</td><td valign='middle' width='30%' align='right' border='0'>")
    ...
    private static final Logger LOG = Logger.getLogger(DlgPembayaranPerAKunBayar3.class.getName());
