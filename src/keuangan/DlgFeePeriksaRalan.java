    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (i = 0; i < tabMode.getRowCount(); i++) {
                try {
                    sbiaya = Valid.SetAngka(Double.parseDouble(tabMode.
                            getValueAt(i, 4).toString()));
                } catch (Exception e) {
                    sbiaya = "";
                }
                try {
                    sjasadokter = Valid.SetAngka(Double.parseDouble(tabMode.
                            getValueAt(i, 5).toString()));
                } catch (Exception e) {
                    sjasadokter = "";
                }
                try {
                    suangrs = Valid.SetAngka(Double.parseDouble(tabMode.
                ...
                Sequel.menyimpan("temporary", "'" + i + "','"
                        ...
                        + tabMode.getValueAt(i, 3).toString().replaceAll("'",
                                "`") + "','"
                        + sbiaya + "','" + sjasadokter + "','" + suangrs + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
            ...
            Valid.MyReportqry("rptFeePeriksaRalan.jasper", "report",
                    "[ Rekap Fee Pemeriksaan Rawat Jalan ]",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void prosesCari() {
        ...
        try {
            ...
            while (rspasien.next()) {
                ...
                tabMode.addRow(new Object[]{i, rspasien.getString("tgl_registrasi"), rspasien.getString("nm_pasien"),
                    rspasien.getString("png_jawab"), rspasien.getDouble("biaya_rawat"),
                    rspasien.getDouble("tarif_tindakandr"),
                    (rspasien.getDouble("bhp") + rspasien.getDouble("material"))});
                i++;
            }
            if (ttlbiaya > 0) {
                tabMode.addRow(new Object[]{"", "", "Jumlah Total :", "", ttlbiaya, ttljm, ttlrs});
            }
        } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgFeePeriksaRalan.class.getName());
