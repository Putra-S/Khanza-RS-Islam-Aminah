...
public class KeuanganNilaiPiutangPerJenisBayarPerBulan extends javax.swing.JDialog {
    ...
    public KeuanganNilaiPiutangPerJenisBayarPerBulan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Kode", "Jenis/Cara Bayar", "Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli",
...
//GEN-FIRST:event_TKdKeyPressed
            ...
            try {
                ...
                while (rs.next()) {
                    januari = Sequel.cariIsiAngka(
                            "select sum(detail_piutang_pasien.totalpiutang) as total from detail_piutang_pasien inner join piutang_pasien on detail_piutang_pasien.no_rawat=piutang_pasien.no_rawat where detail_piutang_pasien.kd_pj='"
                            + rs.getString("kd_pj") + "' and left(piutang_pasien.tgl_piutang,7)='"
                    ...
                    tabMode.addRow(new Object[]{rs.getString("kd_pj"), rs.getString("png_jawab"), januari, februari,
                        maret, april, mei, juni, juli, agustus, september, oktober, november, desember, tagihan});
                }
                if (tabMode.getRowCount() > 0) {
    ...
    private static final Logger LOG = Logger.getLogger(KeuanganNilaiPiutangPerJenisBayarPerBulan.class.getName());
