...
public class DlgCariKategoriPemasukanLain extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariKategoriPemasukanLain dialog = new DlgCariKategoriPemasukanLain(
    ...
    private void tampil() {
        ...
        try {
            ...
            fileWriter.write("{\"kategoripemasukkan\":[" + iyem.substring(0,
                    iyem.length() - 1) + "]}");
            fileWriter.flush();
            fileWriter.close();
            iyem = null;
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgCariKategoriPemasukanLain.class.getName());
}
