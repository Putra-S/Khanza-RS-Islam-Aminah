...
public class DlgRHJS extends javax.swing.JDialog {
    ...
    public DlgRHJS(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.", "Cara Bayar", "Tgl.Tindakan", "Nama Pasien",
            "Tindakan Medis", "Jasa Sarana"};
        ...
        penjab.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (penjab.getTable().getSelectedRow() != -1) {
                    kdbayar.setText(penjab.getTable().getValueAt(penjab.
                            getTable().getSelectedRow(), 1).toString());
                    nmbayar.setText(penjab.getTable().getValueAt(penjab.
    ...
    private void prosesCari() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select kd_pj,png_jawab from penjab where kd_pj like ? order by png_jawab");
            try {
                ...
                while (rs.next()) {
                    ...
                    if (chkRalan.isSelected() == true) {
                        psrawatjalandr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_jl_dr.material,"
                        ...
                        psrawatjalandrpr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_jl_drpr.material,"
                                + "jns_perawatan.nm_perawatan,reg_periksa.tgl_registrasi "
                                + "from pasien inner join reg_periksa  "
                        ...
                        psrawatjalanpr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_jl_pr.material,"
                                + "jns_perawatan.nm_perawatan,reg_periksa.tgl_registrasi "
                                + "from pasien inner join reg_periksa  "
                        ...
                        try {
                            ...
                            psrawatjalanpr.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + ""));
                            psrawatjalanpr.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + ""));
                            ...
                            if ((rsrawatjalandr.getRow() > 0) || (rsrawatjalandrpr.
                                    getRow() > 0) || (rsrawatjalanpr.getRow() > 0)) {
                                z++;
                            ...
                            while (rsrawatjalandr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    "tgl_registrasi"), rsrawatjalandr.getString(
                                    "nm_pasien"),
                                    rsrawatjalandr.getString("nm_perawatan"),
                                    Valid.SetAngka(rsrawatjalandr.getDouble(
                                    "material"))});
                            ...
                            while (rsrawatjalandrpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    "tgl_registrasi"), rsrawatjalandrpr.
                                    getString("nm_pasien"),
                                    rsrawatjalandrpr.getString("nm_perawatan"),
                                    Valid.SetAngka(rsrawatjalandrpr.getDouble(
                                    "material"))});
                            ...
                            while (rsrawatjalanpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rsrawatjalanpr.getString(
                                    "tgl_registrasi"), rsrawatjalanpr.getString(
                                    "nm_pasien"),
                                    rsrawatjalanpr.getString("nm_perawatan"),
                                    Valid.SetAngka(rsrawatjalanpr.getDouble(
                                    "material"))});
                    ...
                    if (chkRanap.isSelected() == true) {
                        psrawatinapdr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_inap_dr.material,"
                        ...
                        psrawatinapdrpr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_inap_drpr.material,"
                        ...
                        psrawatinappr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_inap_pr.material,"
                        ...
                        try {
                            ...
                            psrawatinappr.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + ""));
                            psrawatinappr.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + ""));
                            ...
                            if ((rsrawatinapdr.getRow() > 0) || (rsrawatinapdrpr.
                                    getRow() > 0) || (rsrawatinappr.getRow() > 0)) {
                                z++;
                                tabMode.addRow(new Object[]{"", "",
                                    z + ". Rawat Inap ", "", "", ""});
                            }
                            ...
                            while (rsrawatinapdr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatinapdr.getDouble(
                                    "material"))});
                            ...
                            while (rsrawatinapdrpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatinapdrpr.getDouble(
                                    "material"))});
                            ...
                            while (rsrawatinappr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rsrawatinappr.getString(
                                    "tgl_perawatan") + " " + rsrawatinappr.
                                    getString("jam_rawat"), rsrawatinappr.
                                    getString("nm_pasien"),
                                    rsrawatinappr.getString("nm_perawatan"),
                                    Valid.SetAngka(rsrawatinappr.getDouble(
                                    "material"))});
                    ...
                    if (chkOperasi.isSelected() == true) {
                        psbiayaalat = koneksi.prepareStatement(
                                "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biayaalat,"
                        ...
                        psbiayasewaok = koneksi.prepareStatement(
                                "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biayasewaok,"
                                + "operasi.tgl_operasi from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "on operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                                + "where operasi.tgl_operasi between ? and ? and reg_periksa.kd_pj=? "
                                + " and operasi.biayasewaok>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                        psakomodasi = koneksi.prepareStatement(
                                "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.akomodasi,"
                                + "operasi.tgl_operasi from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "on operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                                + "where operasi.tgl_operasi between ? and ? and reg_periksa.kd_pj=? "
                                + " and operasi.akomodasi>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                        psbiayasarpras = koneksi.prepareStatement(
                                "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biayasarpras,"
                                + "operasi.tgl_operasi from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "on operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                                + "where operasi.tgl_operasi between ? and ? and reg_periksa.kd_pj=? "
                                + " and operasi.biayasarpras>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                        try {
                            psbiayaalat.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " 00:00:00");
                            psbiayaalat.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " 23:59:59");
                            psbiayaalat.setString(3, rs.getString("kd_pj"));
                            rsbiayaalat = psbiayaalat.executeQuery();
                            rsbiayaalat.last();

                            psbiayasewaok.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " 00:00:00");
                            psbiayasewaok.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " 23:59:59");
                            psbiayasewaok.setString(3, rs.getString("kd_pj"));
                            rsbiayasewaok = psbiayasewaok.executeQuery();
                            rsbiayasewaok.last();

                            psakomodasi.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " 00:00:00");
                            psakomodasi.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " 23:59:59");
                            psakomodasi.setString(3, rs.getString("kd_pj"));
                            rsakomodasi = psakomodasi.executeQuery();
                            rsakomodasi.last();

                            psbiayasarpras.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " 00:00:00");
                            psbiayasarpras.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " 23:59:59");
                            psbiayasarpras.setString(3, rs.getString("kd_pj"));
                            rsbiayasarpras = psbiayasarpras.executeQuery();
                            rsbiayasarpras.last();

                            if ((rsbiayaalat.getRow() > 0) || (rsbiayasewaok.
                                    getRow() > 0) || (rsakomodasi.getRow() > 0) || (rsbiayasarpras.
                                    getRow() > 0)) {
                                z++;
                                tabMode.addRow(new Object[]{"", "",
                                    z + ". Operasi/VK ", "", "", ""});
                            ...
                            while (rsbiayaalat.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsbiayaalat.getString(
                                    "tgl_operasi"), rsbiayaalat.getString(
                                    "nm_pasien"),
                                    rsbiayaalat.getString("nm_perawatan") + " (Alat)",
                                    Valid.SetAngka(rsbiayaalat.getDouble(
                                    "biayaalat"))
                                });
                            ...
                            while (rsbiayasewaok.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsbiayasewaok.getString(
                                    "tgl_operasi"), rsbiayasewaok.getString(
                                    "nm_pasien"),
                                    rsbiayasewaok.getString("nm_perawatan") + " (Sewa OK/VK)",
                                    Valid.SetAngka(rsbiayasewaok.getDouble(
                                    "biayasewaok"))
                                });
                            ...
                            while (rsakomodasi.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsakomodasi.getString(
                                    "tgl_operasi"), rsakomodasi.getString(
                                    "nm_pasien"),
                                    rsakomodasi.getString("nm_perawatan") + " (Akomodasi)",
                                    Valid.SetAngka(rsakomodasi.getDouble(
                                    "akomodasi"))
                                });
                            ...
                            while (rsbiayasarpras.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsbiayasarpras.getString(
                                    "tgl_operasi"), rsbiayasarpras.getString(
                                    "nm_pasien"),
                                    rsbiayasarpras.getString("nm_perawatan") + " (Sarpras)",
                                    Valid.SetAngka(rsbiayasarpras.getDouble(
                                    "biayasarpras"))
                                });
                                total += rsbiayasarpras.
                    ...
                    if (chkLaborat.isSelected() == true) {
                        psperiksa_lab = koneksi.prepareStatement(
                                "select periksa_lab.bagian_rs,pasien.nm_pasien,"
                        ...
                        try {
                            ...
                            while (rsperiksa_lab.next()) {
                                ...
                                try {
                                    psdetail_lab.setString(1, rsperiksa_lab.
                                            getString("no_rawat"));
                                    psdetail_lab.setString(2, rsperiksa_lab.
                                            getString("kd_jenis_prw"));
                                    rsdetail_lab = psdetail_lab.executeQuery();
                                    while (rsdetail_lab.next()) {
                                        detail_lab = rsdetail_lab.getDouble(
                                                "total");
                                    }
                                } catch (Exception e) {
                                    System.out.println("Notifikasi : " + e);
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        psperiksa_radiologi = koneksi.prepareStatement(
                                "select periksa_radiologi.bagian_rs,pasien.nm_pasien,"
                        ...
                        try {
                            ...
                            while (rsperiksa_radiologi.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    rsperiksa_radiologi.getDouble("bagian_rs"))
                                });
