...
public class DlgJnsPerawatanLab extends javax.swing.JDialog {
     ...
     *
     */
    public DlgTemplateLaboratorium template = new DlgTemplateLaboratorium(null,
            false);
    private int i = 0;
...
private void btnPjActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPjActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJnsPerawatanLab dialog = new DlgJnsPerawatanLab(
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(kd_jenis_prw,5),signed)),0) from jns_perawatan_lab",
                "J", 6, TKd);
        TKd.requestFocus();
    }
        ...
        if (tbJnsPerawatan.getSelectedRow() != -1) {
            ...
            TotalBiaya.setText(Valid.SetAngka2(Double.parseDouble(
                    tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),
                            10).toString())));
            Sequel.cariIsi(
                    "select kd_pj from jns_perawatan_lab where kd_jenis_prw=?",
    ...
    private void isjml() {
        if ((!BagianRs.getText().isEmpty()) && (!JMLaborat.getText().isEmpty())
                && (!JMDokter.getText().isEmpty()) && (!JMPerujuk.getText().
                isEmpty())
                && (!Bhp.getText().isEmpty()) && (!KSO.getText().isEmpty())
    ...
    private static final Logger LOG = Logger.getLogger(DlgJnsPerawatanLab.class.
            getName());
