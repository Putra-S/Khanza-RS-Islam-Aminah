...
public class DlgPaymentPoint extends javax.swing.JDialog {
    ...
    public void tampil() {
        ...
        try {
                        ...
                        while (rs.next()) {
                            ...
                            if (CmbStatus.getSelectedItem().toString().equals("Semua")) {
                                ...
                                if (petugas.toLowerCase().trim().contains(User.getText().toLowerCase().trim())) {
                                    ...
                                    tabMode.addRow(new Object[]{i, rs.getString("tgl_bayar"),
                                        rsjamshift.getString("shift"), nonota, rs.getString("nama_pasien"),
                                        Math.round(rs.getDouble("jumlah_bayar")), petugas});
                                }
            ...
            if (CmbStatus.getSelectedItem().toString().equals("Semua")) {
                tabMode.addRow(new Object[]{"", "Modal Awal", ":", "", "", Double.valueOf(ModalAwal.getText()), ""});
                tabMode.addRow(new Object[]{"", "Uang Masuk", ":", "", "", all, ""});
                tabMode.addRow(new Object[]{"", ">> Total", ":", "", "",
                    (all + Double.parseDouble(ModalAwal.getText())), ""});
            } else if (CmbStatus.getSelectedItem().toString().equals("Pagi")) {
                tabMode.addRow(new Object[]{"", "Modal Awal", ":", "", "", Double.valueOf(ModalAwal.getText()), ""});
                tabMode.addRow(new Object[]{"", "Uang Masuk", ":", "", "", pagi, ""});
                tabMode.addRow(new Object[]{"", ">> Total", ":", "", "",
                    (pagi + Double.parseDouble(ModalAwal.getText())), ""});
            } else if (CmbStatus.getSelectedItem().toString().equals("Siang")) {
                tabMode.addRow(new Object[]{"", "Modal Awal", ":", "", "",
                    (Double.parseDouble(ModalAwal.getText()) + pagi), ""});
                tabMode.addRow(new Object[]{"", "Uang Masuk", ":", "", "", siang, ""});
                tabMode.addRow(new Object[]{"", ">> Total", ":", "", "",
                    (pagi + siang + Double.parseDouble(ModalAwal.getText())), ""});
            } else if (CmbStatus.getSelectedItem().toString().equals("Sore")) {
                tabMode.addRow(new Object[]{"", "Modal Awal", ":", "", "",
                    (Double.parseDouble(ModalAwal.getText()) + pagi + siang), ""});
                tabMode.addRow(new Object[]{"", "Uang Masuk", ":", "", "", sore, ""});
                tabMode.addRow(new Object[]{"", ">> Total", ":", "", "",
                    (pagi + siang + sore + Double.parseDouble(ModalAwal.getText())), ""});
            } else if (CmbStatus.getSelectedItem().toString().equals("Malam")) {
                tabMode.addRow(new Object[]{"", "Modal Awal", ":", "", "",
                    (Double.parseDouble(ModalAwal.getText()) + pagi + siang + sore), ""});
                tabMode.addRow(new Object[]{"", "Uang Masuk", ":", "", "", malam, ""});
                tabMode.addRow(new Object[]{"", ">> Total", ":", "", "",
                    (pagi + siang + sore + malam + Double.parseDouble(ModalAwal.getText())), ""});
            }
        } catch (Exception e) {
            System.out.println("Notifikasi : " + e);
        }
    ...
    private static final Logger LOG = Logger.getLogger(DlgPaymentPoint.class.getName());
