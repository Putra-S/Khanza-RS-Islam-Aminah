...
public class DlgAkunBayarHutang extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (nama.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("akun_bayar_hutang", "?,?", "Nama Akun", 2,
                    new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (int i = 0; i < tbJadwal.getRowCount(); i++) {
            if (tbJadwal.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("akun_bayar_hutang", "nama_bayar", tbJadwal.
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (nama.getText().trim().isEmpty()) {
            ...
            if (tbJadwal.getSelectedRow() > -1) {
                Sequel.mengedit("akun_bayar_hutang", "nama_bayar=?",
                        "nama_bayar=?,kd_rek=?", 3, new String[]{
                            nama.getText(), kdrek.getText(), tbJadwal.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptAkunBayarHutang.jasper", "report",
                    "::[ Akun Bayar ]::",
                    ...
                    + "where akun_bayar_hutang.nama_bayar like '%" + TCari.
                            getText().trim() + "%' or "
                    + "rekening.nm_rek like '%" + TCari.getText().trim() + "%' order by akun_bayar_hutang.nama_bayar",
                    param);
        }
...
private void BtnPoliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPoliActionPerformed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select akun_bayar_hutang.nama_bayar,akun_bayar_hutang.kd_rek,rekening.nm_rek "
                            + "from akun_bayar_hutang inner join rekening on akun_bayar_hutang.kd_rek=rekening.kd_rek "
    ...
    private static final Logger LOG = Logger.getLogger(DlgAkunBayarHutang.class.getName());
