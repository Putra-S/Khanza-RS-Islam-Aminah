...
public class KeuanganBayarPemesananNonMedis extends javax.swing.JDialog {
            ...
            try {
                if (sisahutang > 0) {
                    ...
                    Sequel.menyimpan("tampjurnal", "?,?,?,?", "Rekening", 4,
                            new String[]{
                                Bayar_Pemesanan_Non_Medis, "HUTANG USAHA",
                    ...
                    if (sukses == true) {
                        if ((sisahutang <= Double.parseDouble(besar_bayar.
                            ...
                            Sequel.mengedit("ipsrspemesanan", "no_faktur=?",
                        ...
                        if (Sequel.menyimpantf2("bayar_pemesanan_non_medis",
                                "?,?,?,?,?,?,?", "data", 7, new String[]{
                                    Valid.SetTgl(
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        try {
            ...
            sukses = true;
            if (Sequel.queryu2tf(
                    "delete from bayar_pemesanan_non_medis where tgl_bayar=? and no_faktur=? and "
                ...
                Sequel.menyimpan("tampjurnal", "?,?,?,?", "Rekening", 4,
                        new String[]{
                            Bayar_Pemesanan_Non_Medis, "HUTANG USAHA", "0",
                            besar_bayar.getText()
                        });
                sukses = jur.simpanJurnal(no_bukti.getText(), "U",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptBayarPemesananNonMedis.jasper", "report",
                    "::[ Bayar Pemesanan ]::",
                    ...
                    + "bayar_pemesanan_non_medis.tgl_bayar between '" + Valid.
                            SetTgl(TglCari1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglCari2.getSelectedItem() + "") + "' and ipsrssuplier.nama_suplier like '%" + nmsup.
                    getText().trim() + "%' and bayar_pemesanan_non_medis.nama_bayar like '%" + TCari.
                            getText().trim() + "%' or "
                    + "bayar_pemesanan_non_medis.tgl_bayar between '" + Valid.
                            SetTgl(TglCari1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglCari2.getSelectedItem() + "") + "' and ipsrssuplier.nama_suplier like '%" + nmsup.
                    getText().trim() + "%' and bayar_pemesanan_non_medis.no_bukti like '%" + TCari.
                            getText().trim() + "%' or "
                    + "bayar_pemesanan_non_medis.tgl_bayar between '" + Valid.
                            SetTgl(TglCari1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglCari2.getSelectedItem() + "") + "' and ipsrssuplier.nama_suplier like '%" + nmsup.
                    getText().trim() + "%' and bayar_pemesanan_non_medis.keterangan like '%" + TCari.
                            getText().trim() + "%' or "
                    + "bayar_pemesanan_non_medis.tgl_bayar between '" + Valid.
                            SetTgl(TglCari1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglCari2.getSelectedItem() + "") + "' and ipsrssuplier.nama_suplier like '%" + nmsup.
