...
public class DlgRBJS extends javax.swing.JDialog {
    ...
    private PreparedStatement ps, psralanpr, psralandrpr, psralandr, psperiksalab, psranappr, psranapdrpr, psranapdr,
            psbiayaalat, psdetaillab, psperiksaradiologi, psbiayasewaok, psakomodasi, psbiayasarpras;

    private ResultSet rs, rsralanpr, rsralandrpr, rsralandr, rsperiksalab, rsranappr, rsranapdrpr, rsranapdr,
            rsbiayaalat, rsdetaillab, rsperiksaradiologi, rsbiayasewaok, rsakomodasi, rsbiayasarpras;
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (chkRalan.isSelected() == true) {
                        psralanpr = koneksi.prepareStatement("select jns_perawatan.nm_perawatan,rawat_jl_pr.material,"
                                + "count(rawat_jl_pr.kd_jenis_prw) as jml," + "sum(rawat_jl_pr.material) as total "
                        ...
                        psralandrpr = koneksi
                                .prepareStatement("select jns_perawatan.nm_perawatan,rawat_jl_drpr.material,"
                        ...
                        psralandr = koneksi.prepareStatement("select jns_perawatan.nm_perawatan,rawat_jl_dr.material,"
                                + "count(rawat_jl_dr.kd_jenis_prw) as jml," + "sum(rawat_jl_dr.material) as total "
                        ...
                        try {
                            ...
                            while (rsralandr.next()) {
                                tabMode.addRow(new Object[]{"", "", "     " + rsralandr.getString("nm_perawatan"),
                    ...
                    if (chkRanap.isSelected() == true) {
                        psranappr = koneksi
                                .prepareStatement("select jns_perawatan_inap.nm_perawatan,rawat_inap_pr.material,"
                        ...
                        psranapdrpr = koneksi
                                .prepareStatement("select jns_perawatan_inap.nm_perawatan,rawat_inap_drpr.material,"
                        ...
                        psranapdr = koneksi
                                .prepareStatement("select jns_perawatan_inap.nm_perawatan,rawat_inap_dr.material,"
                        ...
                        try {
                            ...
                            while (rsranapdr.next()) {
                                tabMode.addRow(new Object[]{"", "", "     " + rsranapdr.getString("nm_perawatan"),
                    ...
                    if (chkOperasi.isSelected() == true) {
                        psbiayaalat = koneksi.prepareStatement("select paket_operasi.nm_perawatan,operasi.biayaalat,"
                                + "count(operasi.kode_paket) as jml, " + "sum(operasi.biayaalat) as total "
                        ...
                        psbiayasewaok = koneksi
                                .prepareStatement("select paket_operasi.nm_perawatan,operasi.biayasewaok,"
                                        + "count(operasi.kode_paket) as jml, " + "sum(operasi.biayasewaok) as total "
                                        + "from paket_operasi inner join operasi inner join reg_periksa "
                                        + "on operasi.no_rawat=reg_periksa.no_rawat and operasi.kode_paket=paket_operasi.kode_paket "
                                        + "where operasi.tgl_operasi between ? and ? and reg_periksa.kd_pj=? "
                        ...
                        psakomodasi = koneksi.prepareStatement("select paket_operasi.nm_perawatan,operasi.akomodasi,"
                                + "count(operasi.kode_paket) as jml, " + "sum(operasi.akomodasi) as total "
                                + "from paket_operasi inner join operasi inner join reg_periksa "
                                + "on operasi.no_rawat=reg_periksa.no_rawat and operasi.kode_paket=paket_operasi.kode_paket "
                                + "where operasi.tgl_operasi between ? and ? and reg_periksa.kd_pj=? "
                                + "and operasi.akomodasi>0 group by operasi.kode_paket order by paket_operasi.nm_perawatan  ");
                        psbiayasarpras = koneksi
                                .prepareStatement("select paket_operasi.nm_perawatan,operasi.biayasarpras,"
                                        + "count(operasi.kode_paket) as jml, " + "sum(operasi.biayasarpras) as total "
                                        + "from paket_operasi inner join operasi inner join reg_periksa "
                                        + "on operasi.no_rawat=reg_periksa.no_rawat and operasi.kode_paket=paket_operasi.kode_paket "
                                        + "where operasi.tgl_operasi between ? and ? and reg_periksa.kd_pj=? "
                        ...
                        try {
                            ...
                            if ((rsbiayaalat.next()) || (rsbiayasewaok.next()) || (rsakomodasi.next())
                                    || (rsbiayasarpras.next())) {
                                a++;
                            ...
                            while (rsbiayasewaok.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    rsbiayasewaok.getString("jml"),
                                    Valid.SetAngka(rsbiayasewaok.getDouble("total"))});
                            ...
                            while (rsbiayasarpras.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    rsbiayasarpras.getString("jml"),
                                    Valid.SetAngka(rsbiayasarpras.getDouble("total"))});
                    ...
                    if (chkLaborat.isSelected() == true) {
                        psperiksalab = koneksi
                                .prepareStatement("select jns_perawatan_lab.nm_perawatan,periksa_lab.bagian_rs,"
                        ...
                        try {
                            ...
                            while (rsperiksalab.next()) {
                                detaillab = 0;
                                psdetaillab = koneksi
                                        .prepareStatement("select sum(detail_periksa_lab.bagian_rs) as total from "
                                ...
                                try {
                                    ...
                                    tabMode
                                            .addRow(new Object[]{"", "", "     " + rsperiksalab.getString("nm_perawatan"),
                                        rsperiksalab.getString("jml"),
                                        Valid.SetAngka(rsperiksalab.getDouble("total") + detaillab)});
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        psperiksaradiologi = koneksi
                                .prepareStatement("select jns_perawatan_radiologi.nm_perawatan,periksa_radiologi.bagian_rs,"
