...
public class DlgRBJS extends javax.swing.JDialog {
    ...
    public DlgRBJS(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.", "Cara Bayar", "Tindakan Medis", "Jumlah",
            "Jasa Sarana"};
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRBJasaSarana.jasper", "report",
                    "[ Rekap Bulanan Jasa Sarana Rumah Sakit ]",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void prosesCari() {
        ...
        try {
                ...
                while (rs.next()) {
                    ...
                    if (chkRalan.isSelected() == true) {
                        ...
                        psralandrpr = koneksi.prepareStatement(
                                "select jns_perawatan.nm_perawatan,rawat_jl_drpr.material,"
                        ...
                        psralandr = koneksi.prepareStatement(
                                "select jns_perawatan.nm_perawatan,rawat_jl_dr.material,"
                        ...
                        try {
                            ...
                            psralandr.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + ""));
                            psralandr.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + ""));
                            psralandr.setString(3, rs.getString("kd_pj"));
                            rsralandr = psralandr.executeQuery();

                            if (rsralanpr.next() || rsralandrpr.next() || rsralandr.
                                    next()) {
                                a++;
                            ...
                            while (rsralandr.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsralandr.getString(
                                    "nm_perawatan"),
                                    rsralandr.getString("jml"), Valid.SetAngka(
                                    rsralandr.getDouble("total"))
                                });
                    ...
                    if (chkRanap.isSelected() == true) {
                        psranappr = koneksi.prepareStatement(
                                "select jns_perawatan_inap.nm_perawatan,rawat_inap_pr.material,"
                        ...
                        psranapdrpr = koneksi.prepareStatement(
                                "select jns_perawatan_inap.nm_perawatan,rawat_inap_drpr.material,"
                        ...
                        psranapdr = koneksi.prepareStatement(
                                "select jns_perawatan_inap.nm_perawatan,rawat_inap_dr.material,"
                        ...
                        try {
                            ...
                            psranapdr.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + ""));
                            psranapdr.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + ""));
                            psranapdr.setString(3, rs.getString("kd_pj"));
                            rsranapdr = psranapdr.executeQuery();
                            if ((rsranapdrpr.next()) || (rsranappr.next()) || (rsranapdr.
                                    next())) {
                                a++;
                                tabMode.addRow(new Object[]{"", "",
                                    a + ". Rawat Inap ", "", "", ""});
                            ...
                            while (rsranapdr.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsranapdr.getString(
                                    "nm_perawatan"),
                                    rsranapdr.getString("jml"), Valid.SetAngka(
                                    rsranapdr.getDouble("total"))
                                });
                    ...
                    if (chkOperasi.isSelected() == true) {
                        psbiayaalat = koneksi.prepareStatement(
                                "select paket_operasi.nm_perawatan,operasi.biayaalat,"
                        ...
                        psbiayasewaok = koneksi.prepareStatement(
                                "select paket_operasi.nm_perawatan,operasi.biayasewaok,"
                                + "count(operasi.kode_paket) as jml, "
                        ...
                        psakomodasi = koneksi.prepareStatement(
                                "select paket_operasi.nm_perawatan,operasi.akomodasi,"
                                + "count(operasi.kode_paket) as jml, "
                        ...
                        psbiayasarpras = koneksi.prepareStatement(
                                "select paket_operasi.nm_perawatan,operasi.biayasarpras,"
                                + "count(operasi.kode_paket) as jml, "
                        ...
                        try {
                            ...
                            if ((rsbiayaalat.next()) || (rsbiayasewaok.next()) || (rsakomodasi.
                                    next()) || (rsbiayasarpras.next())) {
                                a++;
                                tabMode.addRow(new Object[]{"", "",
                                    a + ". Operasi/VK ", "", "", ""});
                            }
                            ...
                            while (rsbiayaalat.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    "nm_perawatan") + " (Alat)",
                                    rsbiayaalat.getString("jml"), Valid.
                                    SetAngka(rsbiayaalat.getDouble("total"))
                                });
                            ...
                            while (rsbiayasewaok.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    "nm_perawatan") + " (Sewa OK/VK)",
                                    rsbiayasewaok.getString("jml"), Valid.
                                    SetAngka(rsbiayasewaok.getDouble("total"))
                                });
                            ...
                            while (rsakomodasi.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    "nm_perawatan") + " (Akomodasi)",
                                    rsakomodasi.getString("jml"), Valid.
                                    SetAngka(rsakomodasi.getDouble("total"))
                                });
                            ...
                            while (rsbiayasarpras.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    "nm_perawatan") + " (Sarpras)",
                                    rsbiayasarpras.getString("jml"), Valid.
                                    SetAngka(rsbiayasarpras.getDouble("total"))
                                });
                    ...
                    if (chkLaborat.isSelected() == true) {
                        psperiksalab = koneksi.prepareStatement(
                                "select jns_perawatan_lab.nm_perawatan,periksa_lab.bagian_rs,"
                            ...
                            while (rsperiksalab.next()) {
                                ...
                                try {
                                    ...
                                    psdetaillab.setString(2, Valid.SetTgl(Tgl2.
                                            getSelectedItem() + ""));
                                    psdetaillab.setString(3, rsperiksalab.
                                            getString("kd_jenis_prw"));
                                    psdetaillab.setString(4, rs.getString(
                                            "kd_pj"));
                                    ...
                                    tabMode.addRow(new Object[]{
                                        ...
                                        SetAngka(
                                        rsperiksalab.getDouble("total") + detaillab)
                                    });
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        ...
                        try {
                            ...
                            psperiksaradiologi.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + ""));
                            psperiksaradiologi.setString(3, rs.
                                    getString("kd_pj"));
            ...
            if (totaljm > 0) {
                tabMode.addRow(new Object[]{">> ", "Total Jasa Sarana :", " ",
    ...
    private static final Logger LOG = Logger.getLogger(DlgRBJS.class.getName());
