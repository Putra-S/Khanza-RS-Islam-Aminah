    ...
    public DlgRBObatPercaraBayar(java.awt.Frame parent, boolean modal) {
        ...
        try {
            ...
            psresep = koneksi.prepareStatement("select detail_pemberian_obat.tgl_perawatan,detail_pemberian_obat.jam,"
                    ...
                    + "detail_pemberian_obat.tuslah,databarang.kode_brng from reg_periksa inner join pasien inner join "
...
//GEN-FIRST:event_TKdKeyPressed
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (i = 0; i < tabMode.getRowCount(); i++) {
                ...
                Sequel.menyimpan("temporary", "'" + i + "','"
                        ...
                        + jumlah + "','" + total + "','" + emb + "','" + tsl + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
                                getalamatip() + "'", "Rekap Obat Perpenjab Poli");
            }
            ...
            Valid.MyReportqry("rptRBObatPerCaraBayar.jasper", "report",
                    "[ Rekap Obat Per Cara Bayar ]",
