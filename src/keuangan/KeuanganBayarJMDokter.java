...
public class KeuanganBayarJMDokter extends javax.swing.JDialog {
    ...
    public KeuanganBayarJMDokter(java.awt.Frame parent, boolean modal) {
        ...
        NoTagihan.setDocument(new batasInput(17).getKata(NoTagihan));
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if (NoTagihan.getText().trim().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null,
                    "Maaf, data sudah habis. Tidak ada data yang bisa anda simpan...!!!!");
            ...
            if (i == JOptionPane.YES_OPTION) {
                    ...
                    if (form.response.isArray()) {
                        for (JsonNode list : form.response) {
                            if (list.path("NamaAkun").asText().equals(AkunBayar.
                                ...
                                form.koderekening = list.path("KodeRek").
                                        asText();
                            }
                        }
                    }
                ...
                if (Sequel.menyimpantf2("bayar_jm_dokter",
                        "?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Tagihan", 14,
                        new String[]{
                            NoTagihan.getText(), Valid.SetTgl(Tanggal.
                            getSelectedItem() + ""), kddokter.getText(),
                            bayar + "", AkunBayar.getSelectedItem().toString(),
                            Keterangan.getText(),
                            totalrawatjalan + "", totalrawatinap + "",
                            totallabrawatjalan + "", totallabrawatinap + "",
                            totalradrawatjalan + "", totalradrawatinap + "",
                            totaloperasirawatjalan + "",
                            totaloperasirawatinap + ""
                        }) == true) {
                    ...
                    for (i = 0; i < row; i++) {
                        ...
                        if (tabMode.getValueAt(i, 0).toString().equals("true")) {
                            if (tbBangsal.getValueAt(i, 8).toString().equals(
                                    "Rawat Jalan Dr")) {
                                if (Sequel.menyimpantf2("bayar_rawat_jl_dr",
                                        "?,?,?,?,?,?", 6, new String[]{
                                            NoTagihan.getText(), tbBangsal.
                                            getValueAt(i, 3).toString(),
                                            tbBangsal.getValueAt(i, 6).
                                                    toString(),
                                            tbBangsal.getValueAt(i, 1).
                                                    toString(), tbBangsal.
                                                    getValueAt(i, 2).toString(),
                                            tbBangsal.getValueAt(i, 9).
                                                    toString()
                                        }) == false) {
                                    sukses = false;
                                }
                            } else if (tbBangsal.getValueAt(i, 8).toString().
                                    equals("Rawat Jalan DrPr")) {
                                if (Sequel.menyimpantf2("bayar_rawat_jl_drpr",
                                        "?,?,?,?,?,?", 6, new String[]{
                                            NoTagihan.getText(), tbBangsal.
                                            getValueAt(i, 3).toString(),
                                            tbBangsal.getValueAt(i, 6).
                                    ...
                                    equals("Rawat Inap Dr")) {
                                if (Sequel.menyimpantf2("bayar_rawat_inap_dr",
                                        "?,?,?,?,?,?", 6, new String[]{
                                            NoTagihan.getText(), tbBangsal.
                                            getValueAt(i, 3).toString(),
                                            tbBangsal.getValueAt(i, 6).
                                    ...
                                    equals("Rawat Inap DrPr")) {
                                if (Sequel.menyimpantf2("bayar_rawat_inap_drpr",
                                        "?,?,?,?,?,?", 6, new String[]{
                                            NoTagihan.getText(), tbBangsal.
                                            getValueAt(i, 3).toString(),
                                            tbBangsal.getValueAt(i, 6).
                                    ...
                                    equals("Laborat Ralan PJ")) {
                                if (Sequel.menyimpantf2("bayar_periksa_lab",
                                        "?,?,?,?,?,?", 6, new String[]{
                                            NoTagihan.getText(), tbBangsal.
                                            getValueAt(i, 3).toString(),
                                            tbBangsal.getValueAt(i, 6).
                                    ...
                                    equals("Laborat Ralan PJ Detail")) {
                                ...
                                if (Sequel.menyimpantf2(
                                    ...
                                    equals("Laborat Ralan Perujuk Detail")) {
                                if (Sequel.menyimpantf2(
                                ...
                                if (Sequel.menyimpantf2("bayar_periksa_lab",
                                    ...
                                    equals("Laborat Ranap PJ Detail")) {
                                if (Sequel.menyimpantf2(
                                        "bayar_detail_periksa_lab",
                                        "?,?,?,?,?,?,?", 7, new String[]{
                                            NoTagihan.getText(), tbBangsal.
                                ...
                                if (Sequel.menyimpantf2(
                                    ...
                                    equals("Laborat Ranap Perujuk Detail")) {
                                if (Sequel.menyimpantf2(
                                        "bayar_detail_periksa_lab_perujuk",
                                        "?,?,?,?,?,?,?", 7, new String[]{
                                            NoTagihan.getText(), tbBangsal.
                                ...
                                if (Sequel.menyimpantf2(
                                    ...
                                    equals("Radiologi Ralan Perujuk")) {
                                if (Sequel.menyimpantf2(
                                ...
                                if (Sequel.menyimpantf2(
                                    ...
                                    equals("Radiologi Ranap Perujuk")) {
                                if (Sequel.menyimpantf2(
                                        "bayar_periksa_radiologi_perujuk",
                                        "?,?,?,?,?,?", 6, new String[]{
                                            NoTagihan.getText(), tbBangsal.
                                ...
                                if (Sequel.menyimpantf2(
                                    ...
                                    equals("Operasi Ralan dr Anastesi")) {
                                if (Sequel.menyimpantf2(
                                    ...
                                    equals("Operasi Ralan dr PJ Anak")) {
                                if (Sequel.menyimpantf2(
                                ...
                                if (Sequel.menyimpantf2(
                                    ...
                                    equals("Operasi Ranap dr Anastesi")) {
                                if (Sequel.menyimpantf2(
                                        "bayar_operasi_dokter_anestesi",
                                        "?,?,?,?,?", 5, new String[]{
                                            NoTagihan.getText(), tbBangsal.
                                    ...
                                    equals("Operasi Ranap dr PJ Anak")) {
                                if (Sequel.menyimpantf2(
                                        "bayar_operasi_dokter_pjanak",
                                        "?,?,?,?,?", 5, new String[]{
                                            NoTagihan.getText(), tbBangsal.
                    ...
                    JOptionPane.showMessageDialog(rootPane,
                            "Gagal Menyimpan, kemungkinan Nomor J.M. sudah ada sebelumnya...!!");
                }
                ...
                if (sukses == true) {
                    ...
                    if (totalrawatjalan > 0) {
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Utang_Jasa_Medik_Dokter_Tindakan_Ralan + "','Utang Jasa Medik Dokter Tindakan Ralan','" + totalrawatjalan + "','0'",
                                "debet=debet+'" + (totalrawatjalan) + "'",
                                "kd_rek='" + form.Utang_Jasa_Medik_Dokter_Tindakan_Ralan + "'");
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Beban_Jasa_Medik_Dokter_Tindakan_Ralan + "','Beban Jasa Medik Dokter Tindakan Ralan','0','" + totalrawatjalan + "'",
                                "kredit=kredit+'" + (totalrawatjalan) + "'",
                                "kd_rek='" + form.Beban_Jasa_Medik_Dokter_Tindakan_Ralan + "'");
                    }
                    if (totalrawatinap > 0) {
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Utang_Jasa_Medik_Dokter_Tindakan_Ranap + "','Utang Jasa Medik Dokter Tindakan Ranap','" + totalrawatinap + "','0'",
                                "debet=debet+'" + (totalrawatinap) + "'",
                                "kd_rek='" + form.Utang_Jasa_Medik_Dokter_Tindakan_Ranap + "'");
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Beban_Jasa_Medik_Dokter_Tindakan_Ranap + "','Beban Jasa Medik Dokter Tindakan Ranap','0','" + totalrawatinap + "'",
                                "kredit=kredit+'" + (totalrawatinap) + "'",
                                "kd_rek='" + form.Beban_Jasa_Medik_Dokter_Tindakan_Ranap + "'");
                    }
                    if (totallabrawatjalan > 0) {
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Utang_Jasa_Medik_Dokter_Laborat_Ralan + "','Utang Jasa Medik Dokter Laborat Ralan','" + totallabrawatjalan + "','0'",
                                "debet=debet+'" + (totallabrawatjalan) + "'",
                                "kd_rek='" + form.Utang_Jasa_Medik_Dokter_Laborat_Ralan + "'");
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Beban_Jasa_Medik_Dokter_Laborat_Ralan + "','Beban Jasa Medik Dokter Laborat Ralan','0','" + totallabrawatjalan + "'",
                                "kredit=kredit+'" + (totallabrawatjalan) + "'",
                                "kd_rek='" + form.Beban_Jasa_Medik_Dokter_Laborat_Ralan + "'");
                    }
                    if (totallabrawatinap > 0) {
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Beban_Jasa_Medik_Dokter_Laborat_Ranap + "','Beban Jasa Medik Dokter Laborat Ranap','0','" + totallabrawatinap + "'",
                                "kredit=kredit+'" + (totallabrawatinap) + "'",
                                "kd_rek='" + form.Beban_Jasa_Medik_Dokter_Laborat_Ranap + "'");
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Utang_Jasa_Medik_Dokter_Laborat_Ranap + "','Utang Jasa Medik Dokter Laborat Ranap','" + totallabrawatinap + "','0'",
                                "debet=debet+'" + (totallabrawatinap) + "'",
                                "kd_rek='" + form.Utang_Jasa_Medik_Dokter_Laborat_Ranap + "'");
                    }
                    if (totalradrawatjalan > 0) {
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Beban_Jasa_Medik_Dokter_Radiologi_Ralan + "','Beban Jasa Medik Dokter Radiologi Ralan','0','" + totalradrawatjalan + "'",
                                "kredit=kredit+'" + (totalradrawatjalan) + "'",
                                "kd_rek='" + form.Beban_Jasa_Medik_Dokter_Radiologi_Ralan + "'");
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Utang_Jasa_Medik_Dokter_Radiologi_Ralan + "','Utang Jasa Medik Dokter Radiologi Ralan','" + totalradrawatjalan + "','0'",
                                "debet=debet+'" + (totalradrawatjalan) + "'",
                                "kd_rek='" + form.Utang_Jasa_Medik_Dokter_Radiologi_Ralan + "'");
                    }
                    if (totalradrawatinap > 0) {
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Beban_Jasa_Medik_Dokter_Radiologi_Ranap + "','Beban Jasa Medik Dokter Radiologi Ranap','0','" + totalradrawatinap + "'",
                                "kredit=kredit+'" + (totalradrawatinap) + "'",
                                "kd_rek='" + form.Beban_Jasa_Medik_Dokter_Radiologi_Ranap + "'");
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Utang_Jasa_Medik_Dokter_Radiologi_Ranap + "','Utang Jasa Medik Dokter Radiologi Ranap','" + totalradrawatinap + "','0'",
                                "debet=debet+'" + (totalradrawatinap) + "'",
                                "kd_rek='" + form.Utang_Jasa_Medik_Dokter_Radiologi_Ranap + "'");
                    }
                    if (totaloperasirawatjalan > 0) {
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Beban_Jasa_Medik_Dokter_Operasi_Ralan + "','Beban Jasa Medik Dokter Operasi Ralan','0','" + totaloperasirawatjalan + "'",
                                "kredit=kredit+'" + totaloperasirawatjalan + "'",
                                "kd_rek='" + form.Beban_Jasa_Medik_Dokter_Operasi_Ralan + "'");
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Utang_Jasa_Medik_Dokter_Operasi_Ralan + "','Utang Jasa Medik Dokter Operasi Ralan','" + totaloperasirawatjalan + "','0'",
                                "debet=debet+'" + totaloperasirawatjalan + "'",
                                "kd_rek='" + form.Utang_Jasa_Medik_Dokter_Operasi_Ralan + "'");
                    }
                    if (totaloperasirawatinap > 0) {
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Beban_Jasa_Medik_Dokter_Operasi_Ranap + "','Beban Jasa Medik Dokter Operasi Ranap','0','" + totaloperasirawatinap + "'",
                                "kredit=kredit+'" + totaloperasirawatinap + "'",
                                "kd_rek='" + form.Beban_Jasa_Medik_Dokter_Operasi_Ranap + "'");
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Utang_Jasa_Medik_Dokter_Operasi_Ranap + "','Utang Jasa Medik Dokter Operasi Ranap','" + totaloperasirawatinap + "','0'",
                                "debet=debet+'" + totaloperasirawatinap + "'",
                                "kd_rek='" + form.Utang_Jasa_Medik_Dokter_Operasi_Ranap + "'");
                    }
                    if (bayar > 0) {
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.Bayar_JM_Dokter + "','Bayar JM Dokter','" + bayar + "','0'",
                                "debet=debet+'" + (bayar) + "'",
                                "kd_rek='" + form.Bayar_JM_Dokter + "'");
                        Sequel.menyimpan("tampjurnal",
                                "'" + form.koderekening + "','" + AkunBayar.
                                        getSelectedItem().toString() + "','0','" + bayar + "'",
                                "kredit=kredit+'" + (bayar) + "'",
                                "kd_rek='" + form.koderekening + "'");
                    }
                    sukses = form.jur.simpanJurnal(NoTagihan.getText(), "U",
                            "PEMBAYARAN JASA MEDIS DOKTER " + kddokter.getText() + " " + nmdokter.
                            getText() + ", OLEH " + akses.getkode());
                }
    ...
    private void BtnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPetugasActionPerformed
        ...
        form.dokter.emptTeks();
        form.dokter.isCek();
        form.dokter.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void BtnGajiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGajiActionPerformed
        if (kddokter.getText().trim().isEmpty() || nmdokter.getText().trim().
            ...
            if (bayar == 0) {
                JOptionPane.showMessageDialog(null,
                        "Maaf, silahkan pilih jasa medis yang mau dibayar...!!!!");
            } else if (tabMode.getRowCount() == 0) {
                JOptionPane.showMessageDialog(null,
                    ...
                    if (tabMode.getValueAt(i, 0).toString().equals("true")) {
                        Sequel.menyimpan("temporary", "'" + row + "','"
                                ...
                                + Valid.SetAngka(Double.parseDouble(tabMode.
                                        getValueAt(i, 9).toString().replaceAll(
                                        "'", "`")))
                                + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
                                        getalamatip() + "'", "JM Dokter"
                        );
                        row++;
                    }
                }
                ...
                param.put("bulan", Tanggal.getSelectedItem().toString().
                        substring(3, 10));
                param.put("logo", Sequel.cariGambar(
                        "select setting.logo from setting"));
                Valid.MyReportqry("rptSlipBayarJMDokter.jasper", "report",
                        "[ Slip J.M. Dokter  ]",
