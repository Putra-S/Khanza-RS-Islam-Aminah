...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + "where inventaris_titip_faktur.status='Ditagihkan' " + carisuplier + cari
    ...
    private static final Logger LOG = Logger.getLogger(KeuanganValidasiTagihanAset.class.getName());
