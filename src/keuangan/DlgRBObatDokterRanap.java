...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void prosesCari() {
        try {
            ...
            try {
                ...
                while (rsdokter.next()) {
                    tabMode
                            .addRow(new Object[]{i + ". ", rsdokter.getString("nm_dokter"), "", "", null, null, null});
                        ...
                        while (rspasien.next()) {
                            ...
                            try {
                                ...
                                while (rstanggal.next()) {
                                    tabMode.addRow(new Object[]{"", "", rstanggal.getString("tgl_perawatan"), "",
                                        null, null, null, null});
    ...
    private static final Logger LOG = Logger.getLogger(DlgRBObatDokterRanap.class.getName());
