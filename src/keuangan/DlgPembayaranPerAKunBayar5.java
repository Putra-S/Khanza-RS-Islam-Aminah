 ...
 * @author perpustakaan
 */
public class DlgPembayaranPerAKunBayar5 extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ...
            psakunbayar = koneksi
                    .prepareStatement("select akun_bayar.nama_bayar from akun_bayar order by akun_bayar.nama_bayar");
            try {
                ...
                while (rsakunbayar.next()) {
                    ...
                    htmlContent.append("<td valign='middle' bgcolor='#FFFAFA' align='center' width='130px'>")
                            .append(rsakunbayar.getString("nama_bayar"))
                            .append("</td>");
                }
            } catch (Exception e) {
                    ...
                    if ((petugas.toLowerCase().trim().contains(User.getText().toLowerCase().trim()))
                        ...
                        for (i = 0; i < kolom; i++) {
                            bayar = Sequel.cariIsiAngka(
                                    "select sum(detail_nota_inap.besar_bayar) from detail_nota_inap where detail_nota_inap.no_rawat='"
                                    + rs.getString("no_rawat") + "' and detail_nota_inap.nama_bayar='"
                                    + namabayar[i] + "'");
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if ((petugas.toLowerCase().trim().contains(User.getText().toLowerCase().trim()))
                        ...
                        for (i = 0; i < kolom; i++) {
                            bayar = Sequel.cariIsiAngka(
                                    "select sum(detail_nota_jalan.besar_bayar) from detail_nota_jalan where detail_nota_jalan.no_rawat='"
                                    + rs.getString("no_rawat") + "' and detail_nota_jalan.nama_bayar='"
                                    + namabayar[i] + "'");
                            htmlContent.append("<td valign='middle' align='right'>")
                                    .append(Valid.SetAngka(bayar))
                                    .append("</td>");
                ...
                while (rs.next()) {
                    ...
                    if ((petugas.toLowerCase().trim().contains(User.getText().toLowerCase().trim()))
                        ...
                        htmlContent.append("<tr class='isi'><td valign='middle' align='center'>")
                                ...
                                .append("</td><td valign='middle' align='left'>")
                                .append(rs.getString("nama_pasien"))
                                .append("</td><td valign='middle' align='center'>Penjualan Apotek</td><td valign='middle' align='right'>")
                                .append(Valid.SetAngka(rs.getDouble("jumlah_bayar")))
                                .append("</td><td valign='middle' align='left'>")
                                .append(petugas)
                                .append("</td>");
                        for (i = 0; i < kolom; i++) {
                            bayar = Sequel.cariIsiAngka(
                                    "select (sum(detailjual.total)+penjualan.ongkir+penjualan.ppn) from detailjual inner join penjualan on penjualan.nota_jual=detailjual.nota_jual where penjualan.nota_jual='"
                                    + rs.getString("no_nota") + "' and penjualan.nama_bayar='" + namabayar[i]
                                    + "'");
                            htmlContent.append("<td valign='middle' align='right'>")
                                    .append(Valid.SetAngka(bayar))
                                    .append("</td>");
                ...
                while (rs.next()) {
                    ...
                    if ((petugas.toLowerCase().trim().contains(User.getText().toLowerCase().trim()))
                        ...
                        htmlContent.append("<tr class='isi'><td valign='middle' align='center'>")
                                ...
                                .append("</td><td valign='middle' align='left'>")
                                .append(rs.getString("nama_pasien"))
                                .append("</td><td valign='middle' align='center'>Deposit Pasien</td><td valign='middle' align='right'>")
                                .append(Valid.SetAngka(rs.getDouble("jumlah_bayar")))
                                .append("</td><td valign='middle' align='left'>")
                                .append(petugas)
                                .append("</td>");
                        for (i = 0; i < kolom; i++) {
                            bayar = Sequel.cariIsiAngka(
                                    "select sum(deposit.besar_deposit) from deposit where deposit.no_deposit='"
                                    + rs.getString("no_nota") + "' and deposit.nama_bayar='" + namabayar[i]
                                    + "'");
                            htmlContent.append("<td valign='middle' align='right'>")
                                    .append(Valid.SetAngka(bayar))
                                    .append("</td>");
                ...
                while (rs.next()) {
                    ...
                    if ((petugas.toLowerCase().trim().contains(User.getText().toLowerCase().trim()))
                        ...
                        htmlContent.append("<tr class='isi'><td valign='middle' align='center'>")
                                ...
                                .append("</td><td valign='middle' align='left'>")
                                .append(rs.getString("nama_pasien"))
                                .append("</td><td valign='middle' align='center'>Pemasukan Lain-lain</td><td valign='middle' align='right'>")
                                .append(Valid.SetAngka(rs.getDouble("jumlah_bayar")))
                                .append("</td><td valign='middle' align='left'>")
                                .append(petugas)
                                .append("</td>");
                        ...
                        for (i = 0; i < kolom2; i++) {
                            bayar = Sequel.cariIsiAngka(
                                    ...
                                    + rs.getString("no_nota") + "' and kategori_pemasukan_lain.kd_rek2='"
                                    + akunrekening[i] + "'");
                            htmlContent.append("<td valign='middle' align='right'>")
                                    .append(Valid.SetAngka(bayar))
                                    .append("</td>");
            ...
            htmlContent.append(
                    "<tr class='isi'><td valign='middle' align='center'></td><td valign='middle' align='right'>Total :</td><td valign='middle' align='right'></td><td valign='middle' align='center'></td><td valign='middle' align='left'></td><td valign='middle' align='right'>")
            ...
            for (i = 0; i < kolom2; i++) {
                htmlContent.append("<td valign='middle' align='right'>")
                        .append(Valid.SetAngka(totalbayar2[i]))
                        .append("</td>");
            }
            htmlContent.append("</tr>");
            ...
            if ((kolom + kolom2) == 0) {
                ...
                LoadHTML.setText("<html>" + "<table width='" + Integer.toString(700 + ((kolom + kolom2) * 90))
    ...
    private void tampil2() {
        ...
        try {
            ...
            for (i = 0; i < kolom2; i++) {
                htmlContent.append("<td valign='middle' align='right'>")
                        .append(Math.round(totalbayar2[i]))
                        .append("</td>");
            }
            htmlContent.append("</tr>");
    ...
    private static final Logger LOG = Logger.getLogger(DlgPembayaranPerAKunBayar5.class.getName());
