...
public class DlgPembayaranPerAKunBayar5 extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPembayaranPerAKunBayar5 dialog = new DlgPembayaranPerAKunBayar5(
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                while (rsakunbayar.next()) {
                    ...
                    htmlContent.append(
                            ...
                            append(rsakunbayar.getString("nama_bayar")).append(
                            "</td>");
                }
            } catch (Exception e) {
            ...
            for (i = 0; i < kolom2; i++) {
                htmlContent.append("<td valign='middle' align='right'>").append(
                        Valid.SetAngka(totalbayar2[i])).append("</td>");
            }
            htmlContent.append(
                    "</tr>"
            );
            ...
            if ((kolom + kolom2) == 0) {
                ...
                LoadHTML.setText(
                        "<html>"
                        + "<table width='" + Integer.toString(
                                700 + ((kolom + kolom2) * 90)) + "px' border='0' align='left' cellpadding='3px' cellspacing='0' class='tbl_form'>"
                        + htmlContent.toString()
                        + "</table>"
                        + "</html>");
            }
    ...
    private void tampil2() {
        ...
        try {
                ...
                while (rs.next()) {
                    ...
                    if ((petugas.toLowerCase().trim().contains(User.getText().
                        ...
                        for (i = 0; i < kolom; i++) {
                            ...
                            htmlContent.append(
                                    "<td valign='middle' align='right'>").
                                    append(Math.round(bayar)).append("</td>");
                            totalbayar[i] += bayar;
                        }
                        for (i = 0; i < kolom2; i++) {
                            htmlContent.append(
            ...
            for (i = 0; i < kolom2; i++) {
                htmlContent.append("<td valign='middle' align='right'>").append(
                        Math.round(totalbayar2[i])).append("</td>");
            }
            htmlContent.append(
                    "</tr>"
            );
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgPembayaranPerAKunBayar5.class.getName());
}
