...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
                    ...
                    while (rstambahan.next()) {
                        if (a == 1) {
                            tabMode.addRow(new Object[]{"", "",
                                ...
                                rstambahan.getString("nama_biaya"), rstambahan.getDouble("besar_biaya")});
                        } else {
                            tabMode.addRow(new Object[]{"", "", "", rstambahan.getString("nama_biaya"),
    ...
    private static final Logger LOG = Logger.getLogger(DlgDetailTambahan.class.getName());
