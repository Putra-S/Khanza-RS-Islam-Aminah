...
public class DlgDetailTambahan extends javax.swing.JDialog {
    ...
    public DlgDetailTambahan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.", "Tanggal", "Nama Pasien", "Nama Tambahan",
            "Besar Tambahan"};
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi from reg_periksa inner join tambahan_biaya on reg_periksa.no_rawat=tambahan_biaya.no_rawat "
            ...
            pstambahan = koneksi.prepareStatement(
                    "select nama_biaya,besar_biaya from tambahan_biaya where no_rawat=?");
        } catch (Exception e) {
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRTambahan.jasper", "report",
                    "[ Rekap Tambahan Biaya ]",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDetailTambahan dialog = new DlgDetailTambahan(
                    ...
                    while (rstambahan.next()) {
                        if (a == 1) {
                            tabMode.addRow(new Object[]{"", "", rspasien.
                                ...
                                "nama_biaya"), rstambahan.getDouble(
                                "besar_biaya")});
                        } else {
                            tabMode.addRow(new Object[]{"", "", "", rstambahan.
                                getString("nama_biaya"), rstambahan.getDouble(
                                "besar_biaya")});
                        }
    ...
    private static final Logger LOG = Logger.getLogger(DlgDetailTambahan.class.
            getName());
