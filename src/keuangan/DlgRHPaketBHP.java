...
public class DlgRHPaketBHP extends javax.swing.JDialog {
    ...
    public DlgRHPaketBHP(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.", "Cara Bayar", "Tgl.Tindakan", "Nama Pasien",
            "Tindakan Medis", "BHP Medis/Paket Obat"};
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRHPaketBHP.jasper", "report",
                    "::[ Rekap Harian BHP Medis/Paket BHP ]::",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRHPaketBHP dialog = new DlgRHPaketBHP(new javax.swing.JFrame(),
                    true);
    ...
    private void prosesCari() {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (chkRalan.isSelected() == true) {
                        psrawatjalandr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_jl_dr.bhp,"
                        ...
                        psrawatjalandrpr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_jl_drpr.bhp,"
                                + "jns_perawatan.nm_perawatan,reg_periksa.tgl_registrasi "
                                + "from pasien inner join reg_periksa  "
                        ...
                        psrawatjalanpr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_jl_pr.bhp,"
                                + "jns_perawatan.nm_perawatan,reg_periksa.tgl_registrasi "
                                + "from pasien inner join reg_periksa  "
                        ...
                        try {
                            ...
                            while (rsrawatjalandr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    "bhp"))});
                                total += rsrawatjalandr.getDouble("bhp");
                            }
                            ...
                            while (rsrawatjalandrpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    "bhp"))});
                                total += rsrawatjalandrpr.getDouble("bhp");
                            }
                            ...
                            while (rsrawatjalanpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    "bhp"))});
                                total += rsrawatjalanpr.getDouble("bhp");
                            }
                        } catch (Exception e) {
                    ...
                    if (chkRanap.isSelected() == true) {
                        psrawatinapdr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_inap_dr.bhp,"
                        ...
                        psrawatinapdrpr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_inap_drpr.bhp,"
                        ...
                        psrawatinappr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_inap_pr.bhp,"
                        ...
                        try {
                            ...
                            while (rsrawatinapdr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatinapdr.
                                    getDouble("bhp"))});
                                total += rsrawatinapdr.getDouble("bhp");
                            }
                            ...
                            while (rsrawatinapdrpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    "bhp"))});
                                total += rsrawatinapdrpr.getDouble("bhp");
                            }
                            ...
                            while (rsrawatinappr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatinappr.
                                    getDouble("bhp"))});
                                total += rsrawatinappr.getDouble("bhp");
                            }
                        } catch (Exception e) {
                            System.out.println("Notifikasi : " + e);
                        } finally {
                    ...
                    if (chkLaborat.isSelected() == true) {
                        psperiksa_lab = koneksi.prepareStatement(
                                "select periksa_lab.bhp,pasien.nm_pasien,"
                        ...
                        try {
                            ...
                            while (rsperiksa_lab.next()) {
                                ...
                                tabMode.addRow(new Object[]{
                                    ...
                                    Valid.SetAngka(rsperiksa_lab.
                                    getDouble("bhp") + detail_lab)
                                });
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        psperiksa_radiologi = koneksi.prepareStatement(
                                "select periksa_radiologi.bhp,pasien.nm_pasien,"
                        ...
                        try {
                            ...
                            while (rsperiksa_radiologi.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    rsperiksa_radiologi.getDouble("bhp"))
                                });
                                total += rsperiksa_radiologi.getDouble("bhp");
                            }
                        } catch (Exception e) {
                            System.out.println("Notifikasi : " + e);
                        } finally {
                ...
                if (totaljm > 0) {
                    tabMode.addRow(new Object[]{">> ",
                        "Total BHP Medis/Paket Obat :", "", "", "", Valid.
                        SetAngka(totaljm)});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgRHPaketBHP.class.
            getName());
