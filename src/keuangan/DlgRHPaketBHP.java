...
public class DlgRHPaketBHP extends javax.swing.JDialog {
    ...
    private ResultSet rs, rsrawatjalandr, rsrawatjalandrpr, rsrawatjalanpr, rsrawatinapdr, rsrawatinapdrpr,
            rsrawatinappr, rsperiksa_lab, rsdetail_lab, rsperiksa_radiologi;
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void prosesCari() {
        ...
        try {
            ...
            try {
                        ...
                        try {
                            ...
                            while (rsrawatjalandr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatjalandr.getDouble("bhp"))});
                            ...
                            while (rsrawatjalandrpr.next()) {
                                tabMode.addRow(
                                        new Object[]{"", "", "     " + rsrawatjalandrpr.getString("tgl_registrasi"),
                                            ...
                                            Valid.SetAngka(rsrawatjalandrpr.getDouble("bhp"))});
                            ...
                            while (rsrawatjalanpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatjalanpr.getDouble("bhp"))});
                        ...
                        try {
                            ...
                            while (rsrawatinapdr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatinapdr.getDouble("bhp"))});
                            ...
                            while (rsrawatinapdrpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatinapdrpr.getDouble("bhp"))});
                            ...
                            while (rsrawatinappr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatinappr.getDouble("bhp"))});
                        ...
                        try {
                            ...
                            while (rsperiksa_lab.next()) {
                                ...
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsperiksa_lab.getDouble("bhp") + detail_lab)});
                        ...
                        try {
                            ...
                            while (rsperiksa_radiologi.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsperiksa_radiologi.getDouble("bhp"))});
                ...
                if (totaljm > 0) {
                    tabMode.addRow(new Object[]{">> ", "Total BHP Medis/Paket Obat :", "", "", "",
    ...
    private static final Logger LOG = Logger.getLogger(DlgRHPaketBHP.class.getName());
