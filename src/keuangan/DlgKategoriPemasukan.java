...
//   Valid.pindah(evt,Kd,Tahun);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKategoriPemasukan dialog = new DlgKategoriPemasukan(
    ...
    private void getData() {
        ...
        if (row != -1) {
            ...
            Sequel.cariIsi(
                    "select kd_rek from kategori_pemasukan_lain where kode_kategori=?",
                    KdAkun, tbKamar.getValueAt(row, 0).toString());
            Sequel.cariIsi(
                    "select kd_rek2 from kategori_pemasukan_lain where kode_kategori=?",
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgKategoriPemasukan.class.getName());
}
