...
public class KeuanganBubes extends javax.swing.JDialog {
    ...
    public KeuanganBubes(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Tgl.Jurnal", "No.Jurnal", "No.Bukti", "Keterangan",
...
//GEN-FIRST:event_TKdKeyPressed
    ...
    private void prosesCari() {
        ...
        try {
            ps2 = koneksi.prepareStatement("select rekeningtahun.saldo_awal,rekening.tipe, "
                    ...
                    + " where rekeningtahun.kd_rek='" + kdrek.getText() + "' and rekeningtahun.thn like '%"
                ...
                if (rs2.next()) {
                    ...
                    if (ChkBulan.isSelected() == true) {
                        ...
                        sql = "select sum(detailjurnal.debet) as debet,sum(detailjurnal.kredit) as kredit "
                                ...
                                + "detailjurnal.kd_rek='" + kdrek.getText() + "' and jurnal.tgl_jurnal between '"
                                + Tahun.getSelectedItem() + "-01-01' and '" + Tahun.getSelectedItem() + "-"
                                + bulanstring + "-31'";
                        ...
                        if (ChkTanggal.isSelected() == true) {
                            ...
                            sql = "select sum(detailjurnal.debet) as debet,sum(detailjurnal.kredit) as kredit "
                                    ...
                                    + "detailjurnal.kd_rek='" + kdrek.getText() + "' and jurnal.tgl_jurnal between '"
                                    + Tahun.getSelectedItem() + "-01-01' and '" + Tahun.getSelectedItem() + "-"
                                    + Bulan.getSelectedItem() + "-" + bulanstring + "'";
                        }
                    ...
                    if (ChkBulan.isSelected() == true) {
                        ...
                        if (ChkTanggal.isSelected() == true) {
                            tanggal = " jurnal.tgl_jurnal like '%" + Tahun.getSelectedItem() + "-"
                                    + Bulan.getSelectedItem() + "-" + Tanggal.getSelectedItem() + "%' ";
                        }
                    }
                    ...
                    try {
                        ...
                        while (rs.next()) {
                            ...
                            tabMode.addRow(new Object[]{rs.getString(1) + " " + rs.getString(2), rs.getString(3),
                                rs.getString("no_bukti"), rs.getString("keterangan"), saldoawalfix,
                                df2.format(rs.getDouble("debet")), df2.format(rs.getDouble("kredit")),
                                saldoakhirfix});
    ...
    private static final Logger LOG = Logger.getLogger(KeuanganBubes.class.getName());
