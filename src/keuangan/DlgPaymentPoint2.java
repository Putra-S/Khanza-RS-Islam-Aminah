...
public class DlgPaymentPoint2 extends javax.swing.JDialog {
    ...
    public void tampil() {
        ...
        try {
            ...
            try {
                ...
                ps.setString(4, Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                        + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem());
                ps.setString(5, Valid.SetTgl(Tgl2.getSelectedItem() + "") + " " + CmbJam2.getSelectedItem() + ":"
                        + CmbMenit2.getSelectedItem() + ":" + CmbDetik2.getSelectedItem());
                ...
                while (rs.next()) {
                    ...
                    if (petugas.toLowerCase().trim().contains(User.getText().toLowerCase().trim())) {
                        ...
                        tabMode.addRow(new Object[]{i, rs.getString("tgl_bayar"), nonota, rs.getString("nama_pasien"),
    ...
    private static final Logger LOG = Logger.getLogger(DlgPaymentPoint2.class.getName());
