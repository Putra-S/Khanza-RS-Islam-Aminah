...
public class KeuanganJasaTindakan extends javax.swing.JDialog {
    ...
    private double subjasasarana = 0, subjasamedis = 0, subjasamenejemen = 0, subbhp = 0, subtotal = 0,
            ttljasasarana = 0, ttljasamedis = 0, ttljasamenejemen = 0, ttlbhp = 0, ttltotal = 0, jasasarana = 0,
            jasamedis = 0, jasamenejemen = 0, bhp = 0, total = 0;
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void prosesCariSemua() {
        try {
            ...
            htmlContent.append("<tr class='isi'>"
                    ...
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='9%'>Jasa Menejemen</td>"
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='9%'>Paket Obat/BHP</td>"
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='10%'>Total</td>" + "</tr>");
            ...
            if (chkRalan.isSelected() == true) {
                ps = koneksi.prepareStatement(
                        ...
                        + (NmCaraBayar.getText().trim().isEmpty() ? ""
                        : " and reg_periksa.kd_pj='" + KdCaraBayar.getText() + "' ")
                        + "group by reg_periksa.kd_poli) " + " order by poliklinik.nm_poli");
                try {
                    ps.setString(1, Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                            + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem());
                    ps.setString(2, Valid.SetTgl(Tgl2.getSelectedItem() + "") + " " + CmbJam2.getSelectedItem() + ":"
                            + CmbMenit2.getSelectedItem() + ":" + CmbDetik2.getSelectedItem());
                    rs = ps.executeQuery();
                    while (rs.next()) {
                        htmlContent.append("<tr class='isi'><td valign='middle' align='left' colspan='10'>@ ")
                        ...
                        try {
                            ...
                            ps2.setString(2, Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem()
                                    + ":" + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem());
                            ps2.setString(3, Valid.SetTgl(Tgl2.getSelectedItem() + "") + " " + CmbJam2.getSelectedItem()
                                    + ":" + CmbMenit2.getSelectedItem() + ":" + CmbDetik2.getSelectedItem());
                            ...
                            while (rs2.next()) {
                                ...
                                jasamedis = Sequel.cariIsiAngka(
                                        "select sum(rawat_jl_dr.tarif_tindakandr) from rawat_jl_dr where rawat_jl_dr.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and rawat_jl_dr.kd_dokter='" + KdDokter.getText() + "' "),
                                        rs2.getString("no_rawat"))
                                        + Sequel.cariIsiAngka(
                                                "select sum(rawat_jl_pr.tarif_tindakanpr) from rawat_jl_pr where rawat_jl_pr.no_rawat=? "
                                                + (NmDokter.getText().trim().isEmpty() ? ""
                                                : " and rawat_jl_pr.nip='" + KdDokter.getText() + "' "),
                                                rs2.getString("no_rawat"))
                                        + Sequel.cariIsiAngka(
                                                "select sum(rawat_jl_drpr.tarif_tindakandr) from rawat_jl_drpr where rawat_jl_drpr.no_rawat=?"
                                                + (NmDokter.getText().trim().isEmpty() ? ""
                                                : " and rawat_jl_drpr.kd_dokter='" + KdDokter.getText()
                                                + "' "),
                                                rs2.getString("no_rawat"))
                                        + Sequel.cariIsiAngka(
                                                "select sum(rawat_jl_drpr.tarif_tindakanpr) from rawat_jl_drpr where rawat_jl_drpr.no_rawat=?"
                                                + (NmDokter.getText().trim().isEmpty() ? ""
                                                : " and rawat_jl_drpr.nip='" + KdDokter.getText()
                                                + "' "),
                                                rs2.getString("no_rawat"));
                            ...
                            if (rs2.getRow() > 0) {
                                htmlContent.append(
                                        ...
                                        .append("</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(subbhp))
                                        .append("</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(subtotal))
                                        .append("</td></tr><tr class='isi'><td valign='middle' align='left' colspan='10'>&nbsp;</td></tr>");
                            }
                        } catch (Exception e) {
                            System.out.println("Notifikasi : " + e);
                        } finally {
            ...
            if (chkRanap.isSelected() == true) {
                ...
                try {
                    ...
                    if (rs.next()) {
                        htmlContent.append("<tr class='isi'>"
                                + "<td valign='middle' align='left' colspan='10'>@ RAWAT INAP</td>" + "</tr>");
                    }
                    rs.beforeFirst();
                    while (rs.next()) {
                        jasasarana = 0;
                        ...
                        jasasarana = Sequel.cariIsiAngka(
                                ...
                                + Sequel.cariIsiAngka(
                                        ...
                                        rs.getString("no_rawat"));
                        jasamedis = Sequel.cariIsiAngka(
                                "select sum(rawat_inap_dr.tarif_tindakandr) from rawat_inap_dr where rawat_inap_dr.no_rawat=? "
                                + (NmDokter.getText().trim().isEmpty() ? ""
                                : " and rawat_inap_dr.kd_dokter='" + KdDokter.getText() + "' "),
                                rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(rawat_inap_pr.tarif_tindakanpr) from rawat_inap_pr where rawat_inap_pr.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and rawat_inap_pr.nip='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(rawat_inap_drpr.tarif_tindakandr) from rawat_inap_drpr where rawat_inap_drpr.no_rawat=?"
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and rawat_inap_drpr.kd_dokter='" + KdDokter.getText()
                                        + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(rawat_inap_drpr.tarif_tindakanpr) from rawat_inap_drpr where rawat_inap_drpr.no_rawat=?"
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and rawat_inap_drpr.nip='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"));
                        jasamenejemen = Sequel.cariIsiAngka(
            ...
            if (chkOperasi.isSelected() == true) {
                ...
                try {
                    ...
                    if (rs.next()) {
                        htmlContent.append("<tr class='isi'>"
                                + "<td valign='middle' align='left' colspan='10'>@ RUANG OK/VK</td>" + "</tr>");
                    }
                    rs.beforeFirst();
                    while (rs.next()) {
                        jasasarana = 0;
                        ...
                        jasasarana = Sequel.cariIsiAngka(
                                ...
                                rs.getString("no_rawat"));
                        jasamedis = Sequel.cariIsiAngka(
                                "select sum(operasi.biayaoperator1) from operasi where operasi.no_rawat=? "
                                + (NmDokter.getText().trim().isEmpty() ? ""
                                : " and operasi.operator1='" + KdDokter.getText() + "' "),
                                rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biayaoperator2) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.operator2='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biayaoperator3) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.operator3='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biayadokter_anak) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.dokter_anak='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biaya_dokter_umum) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.dokter_umum='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biaya_dokter_pjanak) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.dokter_pjanak='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biayadokter_anestesi) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.dokter_anestesi='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biayaasisten_operator1) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.asisten_operator1='" + KdDokter.getText()
                                        + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biayaasisten_operator2) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.asisten_operator2='" + KdDokter.getText()
                                        + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biayaasisten_operator3) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.asisten_operator3='" + KdDokter.getText()
                                        + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biayainstrumen) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.instrumen='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biayaperawaat_resusitas) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.perawaat_resusitas='" + KdDokter.getText()
                                        + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biayaasisten_anestesi) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.asisten_anestesi='" + KdDokter.getText()
                                        + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biayaasisten_anestesi2) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.asisten_anestesi2='" + KdDokter.getText()
                                        + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biayabidan) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.bidan='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biayabidan2) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.bidan2='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biayabidan3) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.bidan3='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biayaperawat_luar) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.perawat_luar='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biaya_omloop) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.omloop='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biaya_omloop2) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.omloop2='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biaya_omloop3) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.omloop3='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biaya_omloop4) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.omloop4='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(operasi.biaya_omloop5) from operasi where operasi.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and operasi.omloop5='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"));
                        jasamenejemen = Sequel.cariIsiAngka(
                        ...
                        htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                ...
                                .append(rs.getString("tgl_registrasi"))
                                .append("</td><td valign='middle' align='center'>")
                                .append(rs.getString("status_lanjut").equals("Ralan") ? rs.getString("tgl_registrasi")
                                        : Sequel.cariIsi(
                                                "select if(kamar_inap.tgl_keluar='0000-00-00','Belum Pulang',kamar_inap.tgl_keluar) from kamar_inap where kamar_inap.no_rawat=? order by kamar_inap.tgl_keluar desc limit 1 ",
                                                rs.getString("no_rawat")))
                                .append("</td><td valign='middle' align='right'>")
                                ...
                                .append("</td><td valign='middle' align='right'>")
                                .append(Valid.SetAngka(jasamenejemen))
                                .append("</td><td valign='middle' align='right'>0</td><td valign='middle' align='right'>")
                                .append(Valid.SetAngka(total))
                                .append("</td></tr>");
                    }
                    rs.last();
            ...
            if (chkLaborat.isSelected() == true) {
                ...
                try {
                    ...
                    if (rs.next()) {
                        htmlContent.append("<tr class='isi'>"
                                + "<td valign='middle' align='left' colspan='10'>@ LABORATORIUM</td>" + "</tr>");
                    }
                    rs.beforeFirst();
                    while (rs.next()) {
                        jasasarana = 0;
                        ...
                        jasasarana = Sequel.cariIsiAngka(
                                ...
                                + Sequel.cariIsiAngka(
                                        ...
                                        rs.getString("no_rawat"));
                        jasamedis = Sequel.cariIsiAngka(
                                "select sum(periksa_lab.tarif_tindakan_dokter) from periksa_lab where periksa_lab.no_rawat=? "
                                + (NmDokter.getText().trim().isEmpty() ? ""
                                : " and periksa_lab.kd_dokter='" + KdDokter.getText() + "' "),
                                rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(periksa_lab.tarif_perujuk) from periksa_lab where periksa_lab.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and periksa_lab.dokter_perujuk='" + KdDokter.getText()
                                        + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
                                        "select sum(periksa_lab.tarif_tindakan_petugas) from periksa_lab where periksa_lab.no_rawat=? "
                                        + (NmDokter.getText().trim().isEmpty() ? ""
                                        : " and periksa_lab.nip='" + KdDokter.getText() + "' "),
                                        rs.getString("no_rawat"))
                                + Sequel.cariIsiAngka(
            ...
            if (chkRadiologi.isSelected() == true) {
                ...
                try {
                    ...
                    if (rs.next()) {
                        htmlContent.append("<tr class='isi'>"
                                + "<td valign='middle' align='left' colspan='10'>@ RADIOLOGI</td>" + "</tr>");
                    }
                    rs.beforeFirst();
                    while (rs.next()) {
                        jasasarana = 0;
            ...
            if (ttltotal > 0) {
                htmlContent.append(
                        ...
                        .append(Valid.SetAngka(ttljasasarana))
                        .append("</td><td valign='middle' align='right'>")
                        .append(Valid.SetAngka(ttljasamedis))
                        .append("</td><td valign='middle' align='right'>")
                        .append(Valid.SetAngka(ttljasamenejemen))
                        .append("</td><td valign='middle' align='right'>")
                        .append(Valid.SetAngka(ttlbhp))
                        .append("</td><td valign='middle' align='right'>")
                        .append(Valid.SetAngka(ttltotal))
                        .append("</td></tr>");
            }
    ...
    private void prosesCariSemua2() {
        try {
                        ...
                        try {
                            ...
                            while (rs2.next()) {
                                ...
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        ...
                                        .append(rs2.getString("tgl_registrasi"))
                                        .append("</td><td valign='middle' align='right'>")
                                        .append(Math.round(jasasarana))
                                        .append("</td><td valign='middle' align='right'>")
                                        .append(Math.round(jasamedis))
                                        .append("</td><td valign='middle' align='right'>")
                                        .append(Math.round(jasamenejemen))
                                        .append("</td><td valign='middle' align='right'>")
                                        .append(Math.round(bhp))
                                        .append("</td><td valign='middle' align='right'>")
                            ...
                            if (rs2.getRow() > 0) {
                                htmlContent.append(
                                        ...
                                        .append("</td><td valign='middle' align='right'>")
                                        .append(Math.round(subjasamedis))
                                        .append("</td><td valign='middle' align='right'>")
                                        .append(Math.round(subjasamenejemen))
                                        .append("</td><td valign='middle' align='right'>")
                                        .append(Math.round(subbhp))
                                        .append("</td><td valign='middle' align='right'>")
                                        .append(Math.round(subtotal))
                                        .append("</td></tr><tr class='isi'><td valign='middle' align='left' colspan='10'>&nbsp;</td></tr>");
                            }
                        } catch (Exception e) {
                            System.out.println("Notifikasi : " + e);
            ...
            if (ttltotal > 0) {
                htmlContent.append(
                        "<tr class='isi'><td valign='middle' align='left' colspan='5'>JUMLAH TOTAL</td><td valign='middle' align='right'>")
                        .append(Math.round(ttljasasarana))
                        .append("</td><td valign='middle' align='right'>")
                        .append(Math.round(ttljasamedis))
                        .append("</td><td valign='middle' align='right'>")
                        .append(Math.round(ttljasamenejemen))
                        .append("</td><td valign='middle' align='right'>")
                        .append(Math.round(ttlbhp))
                        .append("</td><td valign='middle' align='right'>")
                        .append(Math.round(ttltotal))
                        .append("</td></tr>");
            }
    ...
    private static final Logger LOG = Logger.getLogger(KeuanganJasaTindakan.class.getName());
