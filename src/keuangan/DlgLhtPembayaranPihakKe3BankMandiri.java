...
public final class DlgLhtPembayaranPihakKe3BankMandiri extends javax.swing.JDialog {
    ...
    public DlgLhtPembayaranPihakKe3BankMandiri(java.awt.Frame parent, boolean modal) {
        ...
        setSize(885, 674);
        Object[] rowRwJlDr = {"No.Pembayaran", "Tgl.Pembayaran", "No.Rekening Sumber", "No.Rekening Tujuan",
            "Nama Rekening Tujuan", "Kota/Kabupaten", "Nominal", "Nomor Tagihan", "Metode Pembayaran",
            "Bank Tujuan", "Kode Transaksi", "Asal Transaksi", "Status Transaksi"};
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptPembayaranPihakke3BankMandiri.jasper", "report", "::[ Data Pembayaran Pihak Ke 3 Bank Mandiri ]::",
                    ...
                    + (TCari.getText().isEmpty() ? "" : "and (pembayaran_pihak_ke3_bankmandiri.nomor_pembayaran like '%" + TCari.getText().trim() + "%' or pembayaran_pihak_ke3_bankmandiri.no_rekening_tujuan like '%" + TCari.getText().trim() + "%' "
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    : "and (pembayaran_pihak_ke3_bankmandiri.nomor_pembayaran like ? or pembayaran_pihak_ke3_bankmandiri.no_rekening_tujuan like ? or "
                    ...
                    + "bank_tujuan_transfer_bankmandiri.nama_bank like ? or pembayaran_pihak_ke3_bankmandiri.asal_transaksi like ?) ")
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{rs.getString("nomor_pembayaran"), rs.getString("tgl_pembayaran"),
                        rs.getString("no_rekening_sumber"), rs.getString("no_rekening_tujuan"),
                        rs.getString("atas_nama_rekening_tujuan"), rs.getString("kota_atas_nama_rekening_tujuan"),
                        Valid.SetAngka(rs.getDouble("nominal_pembayaran")), rs.getString("nomor_tagihan"),
                        rs.getString("nama_metode"), rs.getString("nama_bank"), rs.getString("kode_transaksi"),
                        rs.getString("asal_transaksi"), rs.getString("status_transaksi")});
                }
                if (total > 0) {
