...
public class DlgLaporanAnalisa2 extends javax.swing.JDialog {
    ...
    public DlgLaporanAnalisa2(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "No.Rawat", "Nomor RM", "Nama Pasien", "DPJP",
            "Kode Diagnosa", "Diagnosa", "Kode", "Cara Bayar",
        ...
        carabayar.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (carabayar.getTable().getSelectedRow() != -1) {
                    pilihancarabayar = carabayar.getTable().getValueAt(
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgLaporanAnalisa2 dialog = new DlgLaporanAnalisa2(
                ...
                while (rsreg.next()) {
                    ...
                    if (rsreg.getString("status_lanjut").equals("Ralan")) {
                        ...
                        try {
                            ...
                            if (rskamar.next()) {
                                namaruangan = rskamar.getString("nm_bangsal") + "(" + rskamar.
                                        getString("kelas") + ")";
                    ...
                    if (chkRalan.isSelected() == true) {
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                totalsarana += rstindakan.getDouble(
                                        "totalsarana");
                                totaljm += rstindakan.getDouble("totaljm");
                                totalbayar = totalbayar + rstindakan.getDouble(
                                        "totaljm") + rstindakan.getDouble(
                                                "totalsarana");
                                tabMode.addRow(new Object[]{
                                    rsreg.getString("no_rawat"), rsreg.
                                    getString("no_rkm_medis"), rsreg.getString(
                                    "nm_pasien"),
                                    dpjp, kddiagnosa, diagnosa,
                                    rsreg.getString("kd_pj"), rsreg.getString(
                                    "png_jawab"), "Ralan",
                                    namaruangan, rstindakan.getString(
                                    "nm_perawatan"),
                                    rstindakan.getString("jumlah"),
                                    (rstindakan.getDouble("totaljm") + rstindakan.
                                    getDouble("totalsarana"))
                                });
                            }
                        } catch (Exception e) {
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                tabMode.addRow(new Object[]{
                                    ...
                                    rsreg.getString("kd_pj"), rsreg.getString(
                                    "png_jawab"),
                                    "Radiologi", namaruangan, rstindakan.
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                totalbayar = totalbayar + rstindakan.getDouble(
                                        "totaljm") + rstindakan.getDouble(
                                                "totalsarana");
                                if (rstindakan.getString("status").equals(
                                        "Ralan")) {
                                    tabMode.addRow(new Object[]{
                                        rsreg.getString("no_rawat"), rsreg.
                                        ...
                                        getString("nm_pasien"),
                                        dpjp, kddiagnosa, diagnosa,
                                        rsreg.getString("kd_pj"), rsreg.
                                        getString("png_jawab"), rsreg.getString(
                                        "nm_poli"),
                                        namaruangan, rstindakan.getString(
                                        "nm_perawatan"),
                                        rstindakan.getString("jumlah"),
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                tabMode.addRow(new Object[]{
                                    ...
                                    rsreg.getString("kd_pj"), rsreg.getString(
                                    "png_jawab"),
                                    "Laborat", namaruangan, rstindakan.
                                    getString("nm_perawatan"),
                                    rstindakan.getString("jumlah"),
                                    (rstindakan.getDouble("totaljm") + rstindakan.
                                    getDouble("totalsarana"))
                    ...
                    if (chkObat.isSelected() == true) {
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                totaljm = totaljm + rstindakan.getDouble(
                                        "embalase") + rstindakan.getDouble(
                                                "tuslah");
                                ...
                                tabMode.addRow(new Object[]{
                                    ...
                                    rsreg.getString("kd_pj"), rsreg.getString(
                                    "png_jawab"),
                                    "Farmasi", namaruangan, rstindakan.
                                    getString("nama_brng"),
                                    rstindakan.getString("jml"),
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                tabMode.addRow(new Object[]{
                                    ...
                                    rsreg.getString("kd_pj"), rsreg.getString(
                                    "png_jawab"),
                                    "Kamar", namaruangan, rstindakan.getString(
                                    "nm_bangsal"),
                                    rstindakan.getString("lama"),
    ...
    private static final Logger LOG = Logger.getLogger(DlgLaporanAnalisa2.class.
            getName());
