 ...
 * @author Kanit SIRS
 */
public class DlgLaporanAnalisa2 extends javax.swing.JDialog {
    ...
    private String pilihancarabayar = "", tglkeluar = "", namaruangan = "", dpjp = "", kddiagnosa = "", diagnosa = "";

    private PreparedStatement psreg, pskamar, pstindakan, ps2;

    private ResultSet rsreg, rskamar, rstindakan, rs2;
     ...
     * @param modal
     */
    public DlgLaporanAnalisa2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "Nomor RM", "Nama Pasien", "DPJP", "Kode Diagnosa", "Diagnosa", "Kode",
                    "Cara Bayar", "Nama Unit", "Ruangan", "Nama Tindakan", "Jml", "Total"}) {
        ...
        carabayar.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (carabayar.getTable().getSelectedRow() != -1) {
                    pilihancarabayar = carabayar.getTable()
                            .getValueAt(carabayar.getTable().getSelectedRow(), 1)
                            .toString();
                }
                prosesCari();
            }
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        ...
        try {
            ...
            pilihan = (String) JOptionPane.showInputDialog(null,
                    "Silahkan pilih laporan..!", "Laporan Jasa Medis",
                    JOptionPane.QUESTION_MESSAGE, null, new Object[]{
                        "Laporan 1 (HTML)", "Laporan 2 (HTML)",
                        "Laporan 3 (WPS)", "Laporan 4 (WPS)", "Laporan 5 (CSV)",
                        "Laporan 6 (CSV)"}, "Laporan 1 (HTML)");
            switch (pilihan) {
                case "Laporan 1 (HTML)":
                    ...
                    for (i = 0; i < tabMode.getRowCount(); i++) {
                        try {
                            js = Valid.SetAngka(Double.parseDouble(tabMode.
                                    getValueAt(i, 15).toString()));
                        } catch (Exception e) {
                            js = "";
                        }
                        try {
                            jm = Valid.SetAngka(Double.parseDouble(tabMode.
                                    getValueAt(i, 16).toString()));
                        } catch (Exception e) {
                            jm = "";
                        }
                        try {
                            tarif = Valid.SetAngka(Double.parseDouble(tabMode.
                                    getValueAt(i, 17).toString()));
                        } catch (Exception e) {
                            tarif = "";
                        }
                        try {
                            totalsaranas = Valid.SetAngka(Double.parseDouble(
                                    tabMode.getValueAt(i, 18).toString()));
                        } catch (Exception e) {
                            totalsaranas = "";
                        }
                        try {
                            totaljms = Valid.SetAngka(Double.parseDouble(
                                    tabMode.getValueAt(i, 19).toString()));
                        } catch (Exception e) {
                            totaljms = "";
                        }
                        try {
                            totalbayars = Valid.SetAngka(Double.parseDouble(
                        ...
                        htmlContent.append("<tr class='isi'><td valign='top'>").
                                append(tabMode.getValueAt(i, 0).toString().
                                        replaceAll("'", "`")).append(
                                "</td><td valign='top'>").append(tabMode.
                                        getValueAt(i, 1).toString().replaceAll(
                                        "'", "`")).append(
                                ...
                                "</td><td valign='top'>").append(tabMode.
                                        ...
                                        tabMode.getValueAt(i, 6).toString().
                                                replaceAll("'", "`")).append(
                                "</td><td valign='top'>").append(tabMode.
                                        getValueAt(i, 7).toString().replaceAll(
                                        "'", "`")).append(
                                        "</td><td valign='top'>").append(
                                ...
                                "</td><td valign='top'>").append(tabMode.
                                        ...
                                        tabMode.getValueAt(i, 11).toString().
                                                replaceAll("'", "`")).append(
                                "</td><td valign='top'>").append(tabMode.
                                        getValueAt(i, 12).toString().replaceAll(
                                        "'", "`")).append(
                                        "</td><td valign='top'>").append(
                                ...
                                "</td><td valign='top' align='right'>").append(
                                        tarif).append(
                                        "</td><td valign='top' align='right'>").
                                append(totalsaranas).append(
                                "</td><td valign='top' align='right'>").append(
                                        totaljms).append(
                                        "</td><td valign='top' align='right'>").
                                append(totalbayars).append(
                                "</td><td valign='top' align='center'>").append(
                    ...
                    for (i = 0; i < tabMode.getRowCount(); i++) {
                        ...
                        htmlContent.append("\"").append(
                                ...
                                tabMode.getValueAt(i, 14).toString().replaceAll(
                                        "'", "`")).append("\";\"").append(js).
                                append("\";\"").append(jm).append("\";\"").
                                append(tarif).append("\";\"").append(
                                totalsaranas).append("\";\"").append(totaljms).
                                append("\";\"").append(totalbayars).append(
                                "\";\"").append(tabMode.getValueAt(i, 21).
                ...
                case "Laporan 6 (CSV)":
                    ...
                    for (i = 0; i < tabMode.getRowCount(); i++) {
                        ...
                        htmlContent.append("").append(tabMode.getValueAt(i, 0).
                                toString().replaceAll("'", "`")).append(";").
                                append(tabMode.getValueAt(i, 1).toString().
                                        replaceAll("'", "`")).append(";").
                                append(tabMode.getValueAt(i, 2).toString().
                                        replaceAll("'", "`")).append(";").
                                append(tabMode.getValueAt(i, 3).toString().
                                        replaceAll("'", "`")).append(";").
                                append(tabMode.getValueAt(i, 4).toString().
                                        replaceAll("'", "`")).append(";").
                                append(tabMode.getValueAt(i, 5).toString().
                                        replaceAll("'", "`")).append(";").
                                append(tabMode.getValueAt(i, 6).toString().
                                        replaceAll("'", "`")).append(";").
                                append(tabMode.getValueAt(i, 7).toString().
                                        replaceAll("'", "`")).append(";").
                                append(tabMode.getValueAt(i, 8).toString().
                                        replaceAll("'", "`")).append(";").
                                append(tabMode.getValueAt(i, 9).toString().
                                        replaceAll("'", "`")).append(";").
                                append(tabMode.getValueAt(i, 10).toString().
                                        replaceAll("'", "`")).append(";").
                                append(tabMode.getValueAt(i, 11).toString().
                                        replaceAll("'", "`")).append(";").
                                append(tabMode.getValueAt(i, 12).toString().
                                        replaceAll("'", "`")).append(";").
                                append(tabMode.getValueAt(i, 13).toString().
                                        replaceAll("'", "`")).append(";").
                                append(tabMode.getValueAt(i, 14).toString().
                                        replaceAll("'", "`")).append(";").
                                append(js).append(";").append(jm).append(";").
                                append(tarif).append(";").append(totalsaranas).
                                append(";").append(totaljms).append(";").append(
                                totalbayars).append(";").append(tabMode.
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgLaporanAnalisa2 dialog = new DlgLaporanAnalisa2(new javax.swing.JFrame(), true);
            ...
            try {
                ...
                while (rsreg.next()) {
                    ...
                    if (rsreg.getString("status_lanjut").equals("Ralan")) {
                        ...
                        pskamar = koneksi.prepareStatement("select kamar_inap.kd_kamar,bangsal.nm_bangsal,"
                        ...
                        dpjp = Sequel.cariIsi(
                                "select nm_dokter from dpjp_ranap inner join dokter on dpjp_ranap.kd_dokter = dokter.kd_dokter where dpjp_ranap.no_rawat=?",
                        ...
                        try {
                            ps2.setString(1, rsreg.getString("no_rawat"));
                    ...
                    if (chkRalan.isSelected() == true) {
                        // tindakan dr
                        pstindakan = koneksi.prepareStatement("select jns_perawatan.nm_perawatan,dokter.nm_dokter, "
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                totalbayar = totalbayar + rstindakan.getDouble("totaljm")
                                        + rstindakan.getDouble("totalsarana");
                                tabMode.addRow(new Object[]{rsreg.getString("no_rawat"),
                                    rsreg.getString("no_rkm_medis"), rsreg.getString("nm_pasien"), dpjp, kddiagnosa,
                                    diagnosa, rsreg.getString("kd_pj"), rsreg.getString("png_jawab"), "Ralan",
                                    namaruangan, rstindakan.getString("nm_perawatan"),
                                    rstindakan.getString("jumlah"),
                        ...
                        // tindakan perawat
                        pstindakan = koneksi.prepareStatement("select jns_perawatan.nm_perawatan,petugas.nama, "
                    ...
                    if (chkRanap.isSelected() == true) {
                        // tindakan dr
                        pstindakan = koneksi
                                .prepareStatement("select jns_perawatan_inap.nm_perawatan,dokter.nm_dokter, "
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                tabMode.addRow(new Object[]{rsreg.getString("no_rawat"),
                                    rsreg.getString("no_rkm_medis"), rsreg.getString("nm_pasien"), dpjp, kddiagnosa,
                                    diagnosa, rsreg.getString("kd_pj"), rsreg.getString("png_jawab"), "Ranap",
                                    namaruangan, rstindakan.getString("nm_perawatan"),
                                    rstindakan.getString("jumlah"),
                                    (rstindakan.getDouble("totaljm") + rstindakan.getDouble("totalsarana"))});
                            }
                        ...
                        pstindakan = koneksi.prepareStatement("select jns_perawatan_inap.nm_perawatan,petugas.nama, "
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        // tindakan radiologi
                        pstindakan = koneksi
                                .prepareStatement("select jns_perawatan_radiologi.nm_perawatan,dokter.nm_dokter, "
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                tabMode.addRow(new Object[]{rsreg.getString("no_rawat"),
                                    rsreg.getString("no_rkm_medis"), rsreg.getString("nm_pasien"), dpjp, kddiagnosa,
                                    diagnosa, rsreg.getString("kd_pj"), rsreg.getString("png_jawab"), "Radiologi",
                                    namaruangan, rstindakan.getString("nm_perawatan"),
                                    rstindakan.getString("jumlah"),
                                    (rstindakan.getDouble("totaljm") + rstindakan.getDouble("totalsarana"))});
                            }
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                if (rstindakan.getString("status").equals("Ralan")) {
                                    tabMode.addRow(new Object[]{rsreg.getString("no_rawat"),
                                        rsreg.getString("no_rkm_medis"), rsreg.getString("nm_pasien"), dpjp,
                                        kddiagnosa, diagnosa, rsreg.getString("kd_pj"),
                                        rsreg.getString("png_jawab"), rsreg.getString("nm_poli"), namaruangan,
                                        rstindakan.getString("nm_perawatan"), rstindakan.getString("jumlah"),
                                        (rstindakan.getDouble("totaljm") + rstindakan.getDouble("totalsarana"))});
                                } else {
                                    tabMode.addRow(new Object[]{rsreg.getString("no_rawat"),
                                        rsreg.getString("no_rkm_medis"), rsreg.getString("nm_pasien"), dpjp,
                                        kddiagnosa, diagnosa, rsreg.getString("kd_pj"),
                                        rsreg.getString("png_jawab"), "Operasi", namaruangan,
                                        rstindakan.getString("nm_perawatan"), rstindakan.getString("jumlah"),
                                        (rstindakan.getDouble("totaljm") + rstindakan.getDouble("totalsarana"))});
                                }
                            }
                    ...
                    if (chkLaborat.isSelected() == true) {
                        // tindakan lab
                        pstindakan = koneksi.prepareStatement("select jns_perawatan_lab.nm_perawatan,dokter.nm_dokter, "
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                tabMode.addRow(new Object[]{rsreg.getString("no_rawat"),
                                    rsreg.getString("no_rkm_medis"), rsreg.getString("nm_pasien"), dpjp, kddiagnosa,
                                    diagnosa, rsreg.getString("kd_pj"), rsreg.getString("png_jawab"), "Laborat",
                                    namaruangan, rstindakan.getString("nm_perawatan"),
                                    rstindakan.getString("jumlah"),
                                    (rstindakan.getDouble("totaljm") + rstindakan.getDouble("totalsarana"))});
                            }
                        ...
                        pstindakan = koneksi
                                .prepareStatement("select template_laboratorium.Pemeriksaan,dokter.nm_dokter, "
                        ...
                        try {
                            ...
                            while (rstindakan.next()) {
                                ...
                                tabMode.addRow(new Object[]{rsreg.getString("no_rawat"),
                                    rsreg.getString("no_rkm_medis"), rsreg.getString("nm_pasien"), dpjp, kddiagnosa,
                                    diagnosa, rsreg.getString("kd_pj"), rsreg.getString("png_jawab"), "Laborat",
                                    namaruangan, rstindakan.getString("Pemeriksaan"),
                                    rstindakan.getString("jumlah"),
                                    (rstindakan.getDouble("totaljm") + rstindakan.getDouble("totalsarana"))});
                            }
                        } catch (Exception e) {
                    ...
                    if (chkObat.isSelected() == true) {
                        ...
                        pstindakan = koneksi.prepareStatement(
                                ...
                                + "sum(detail_pemberian_obat.total) as total,detail_pemberian_obat.tgl_perawatan "
                                + "from detail_pemberian_obat inner join reg_periksa on detail_pemberian_obat.no_rawat=reg_periksa.no_rawat "
                                + "inner join databarang on detail_pemberian_obat.kode_brng=databarang.kode_brng "
                                + "where detail_pemberian_obat.no_rawat=? group by detail_pemberian_obat.kode_brng order by databarang.nama_brng");
                        try {
                            pstindakan.setString(1, rsreg.getString("no_rawat"));
                            rstindakan = pstindakan.executeQuery();
                            while (rstindakan.next()) {
                                ...
                                tabMode.addRow(new Object[]{rsreg.getString("no_rawat"),
                                    rsreg.getString("no_rkm_medis"), rsreg.getString("nm_pasien"), dpjp, kddiagnosa,
                                    diagnosa, rsreg.getString("kd_pj"), rsreg.getString("png_jawab"), "Farmasi",
                                    namaruangan, rstindakan.getString("nama_brng"), rstindakan.getString("jml"),
                    ...
                    if (chkKamar.isSelected() == true) {
                        // biaya kamar
                        pstindakan = koneksi.prepareStatement(
                                "select bangsal.nm_bangsal,SUM(kamar_inap.lama) AS lama, SUM(kamar_inap.ttl_biaya) as ttl_biaya from kamar_inap "
                                + "inner join kamar on kamar_inap.kd_kamar=kamar.kd_kamar inner join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal where kamar_inap.no_rawat=? "
                                + "group by kamar.kd_kamar");
                        try {
                            pstindakan.setString(1, rsreg.getString("no_rawat"));
                            rstindakan = pstindakan.executeQuery();
                            while (rstindakan.next()) {
                                ...
                                tabMode.addRow(new Object[]{rsreg.getString("no_rawat"),
                                    rsreg.getString("no_rkm_medis"), rsreg.getString("nm_pasien"), dpjp, kddiagnosa,
                                    diagnosa, rsreg.getString("kd_pj"), rsreg.getString("png_jawab"), "Kamar",
                                    namaruangan, rstindakan.getString("nm_bangsal"), rstindakan.getString("lama"),
                                    rstindakan.getDouble("ttl_biaya")});
                            }
                        } catch (Exception e) {
                            System.out.println("Notif Ralan dr : " + e);
                        } finally {
                ...
                if (totalbayar > 0) {
                    tabMode.addRow(new Object[]{"", "", "Total :", "", "", "", "", "", "", "", "", "", totalbayar});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgLaporanAnalisa2.class.getName());
