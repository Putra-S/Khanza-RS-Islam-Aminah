...
public class DlgRBTindakanDokter extends javax.swing.JDialog {
    ...
    private PreparedStatement psdokter, pstindakan, pstindakan2, pspasien, psobat, psobatlangsung, pslaborat,
    ...
    private ResultSet rsdokter, rstindakan, rsobat, rsobatlangsung, rspasien, rslaborat, rsdetailobat, rsregistrasi,
            rsdetailregistrasi, rscarabayar, rsdetailtindakan, rsdetaillaborat, rsdetailobatlangsung, rstambahan,
            rspotongan, rsdetailtambahan, rsdetailpotongan, rsitemlaborat, rsdetailitemlaborat, rsradiologi,
            rsdetailradiologi;
    ...
    public DlgRBTindakanDokter(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.", "Dokter", "Jml.Pas", "Obt+Emb+Tsl", "Laborat", "Paket Tindakan", "Tambahan", "Potongan",
            "Registrasi", "Radiologi", "Total"};
...
private void ppTampilkanPasienBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppTampilkanPasienBtnPrintActionPerformed
                ...
                while (rspasien.next()) {
                    if (pilihancarabayar.equals(rspasien.getString(5))) {
                        ...
                        ttlbiaya = ttlbiaya + detaillaborat + detailradiologi + detailobat + detailobatlangsung
                                - detailpotongan + detailregistrasi + detailtambahan + detailtindakan + detailtindakan2;
    ...
    private static final Logger LOG = Logger.getLogger(DlgRBTindakanDokter.class.getName());
