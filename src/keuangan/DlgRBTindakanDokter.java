...
public class DlgRBTindakanDokter extends javax.swing.JDialog {
    ...
    public DlgRBTindakanDokter(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.", "Dokter", "Jml.Pas", "Obt+Emb+Tsl", "Laborat",
        ...
        try {
            ...
            psdetailitemlaborat = koneksi.prepareStatement(
                    "select sum(detail_periksa_lab.biaya_item) as total from detail_periksa_lab inner join periksa_lab "
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRBTindakanDr.jasper", "report",
                    "[ Rekap Harian Dokter Rawat Jalan ]",
...
private void ppTampilkanPasienBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppTampilkanPasienBtnPrintActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRBTindakanDokter dialog = new DlgRBTindakanDokter(
    ...
    private void prosesCari() {
        try {
            ...
            while (rsdokter.next()) {
                ...
                psobatlangsung.setString(2, Valid.SetTgl(
                        Tgl1.getSelectedItem() + ""));
                psobatlangsung.setString(3, Valid.SetTgl(
                        Tgl2.getSelectedItem() + ""));
                ...
                psitemlaborat.setString(2, Valid.SetTgl(
                        Tgl1.getSelectedItem() + ""));
                psitemlaborat.setString(3, Valid.SetTgl(
                        Tgl2.getSelectedItem() + ""));
                ...
                pstambahan.setString(2, Valid.
                        SetTgl(Tgl1.getSelectedItem() + ""));
                pstambahan.setString(3, Valid.
                        SetTgl(Tgl2.getSelectedItem() + ""));
                ...
                pspotongan.setString(2, Valid.
                        SetTgl(Tgl1.getSelectedItem() + ""));
                pspotongan.setString(3, Valid.
                        SetTgl(Tgl2.getSelectedItem() + ""));
                ...
                psregistrasi.setString(2, Valid.SetTgl(
                        Tgl1.getSelectedItem() + ""));
                psregistrasi.setString(3, Valid.SetTgl(
                        Tgl2.getSelectedItem() + ""));
                ...
                tabMode.addRow(new Object[]{a, rsdokter.getString(2), rsdokter.
                    getString(3), Valid.SetAngka(obat + obatlangsung), Valid.
                    SetAngka(laborat + itemlaborat), Valid.SetAngka(jm + jm2),
                    Valid.SetAngka(tambahan), Valid.SetAngka(potongan), Valid.
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgRBTindakanDokter.class.getName());
