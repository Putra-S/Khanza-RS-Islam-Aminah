            ...
            try {
                ...
                pilihan = (String) JOptionPane.showInputDialog(null,
                        ...
                        JOptionPane.QUESTION_MESSAGE, null, new Object[]{
                            ...
                            "Laporan 3 (CSV)", "Laporan 4 (Jasper)"},
                        "Laporan 1 (HTML)");
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        ...
                        for (i = 0; i < tabMode.getRowCount(); i++) {
                            htmlContent.append(
                                    ...
                                    append(tabMode.getValueAt(i, 3)).append(
                                    "</td></tr>");
                        }
                        ...
                        bw.write("<html>"
                                ...
                                getemailrs() + "<br><br>"
                                + "<font size='2' face='Tahoma'>REKAP JASA MEDIS DOKTER " + Tgl1.
                    ...
                    case "Laporan 4 (Jasper)":
                        ...
                        Valid.MyReportqry("rptRekapJasaMedisDokter.jasper",
                                "report", "::[ Data Rekap Jasa Medis Dokter ]::",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganRekapJmDokter dialog = new KeuanganRekapJmDokter(
                ...
                while (rs.next()) {
                    ...
                    if (jm > 0) {
                        tabMode.addRow(new Object[]{"" + i, rs.getString(
                            "kd_dokter"), rs.getString("nm_dokter"), Math.round(
                            jm)});
                        i++;
                    }
    ...
    private static final Logger LOG = Logger.getLogger(
            KeuanganRekapJmDokter.class.getName());
}
