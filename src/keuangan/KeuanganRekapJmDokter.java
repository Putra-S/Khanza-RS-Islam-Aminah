...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    totaljm += jm;
                    if (jm > 0) {
                        tabMode.addRow(new Object[]{"" + i, rs.getString("kd_dokter"), rs.getString("nm_dokter"),
                            Math.round(jm)});
                        i++;
                    }
    ...
    private static final Logger LOG = Logger.getLogger(KeuanganRekapJmDokter.class.getName());
