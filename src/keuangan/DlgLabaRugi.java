...
//GEN-FIRST:event_TKdKeyPressed
    ...
    private void prosesCari() {
        ...
        try {
            ...
            try {
                ...
                rs = koneksi.prepareStatement("select rekening.kd_rek, rekening.nm_rek  from rekening where "
                        + " rekening.level='0' and rekening.tipe='R' and rekening.balance='K' order by rekening.kd_rek")
                        .executeQuery();
                while (rs.next()) {
                    saldoawal = Sequel.cariIsiAngka(
                            "select sum(rekeningtahun.saldo_awal) from rekeningtahun where rekeningtahun.kd_rek='"
                            + rs.getString(1) + "' and rekeningtahun.thn " + "between '"
                            + Valid.SetTgl(Tgl1.getSelectedItem() + "").substring(0, 4) + "' and '"
                            + Valid.SetTgl(Tgl2.getSelectedItem() + "").substring(0, 4) + "'");
                    debkret = Sequel.cariIsiAngka("select (sum(detailjurnal.kredit)-sum(detailjurnal.debet)) "
                            ...
                            + "detailjurnal.kd_rek='" + rs.getString(1) + "' and jurnal.tgl_jurnal between '"
                    ...
                    try {
                        rs2 = koneksi.prepareStatement(
                                ...
                                + " where subrekening.kd_rek='" + rs.getString(1)
                                + "' and rekening.level='1' and "
                                + "rekening.tipe='R' and rekening.balance='K' order by rekening.kd_rek")
                                .executeQuery();
                        while (rs2.next()) {
                            saldoawal = Sequel.cariIsiAngka(
                                    "select sum(rekeningtahun.saldo_awal) from rekeningtahun where rekeningtahun.kd_rek='"
                                    + rs2.getString(1) + "' and rekeningtahun.thn " + "between '"
                                    + Valid.SetTgl(Tgl1.getSelectedItem() + "").substring(0, 4) + "' and '"
                                    + Valid.SetTgl(Tgl2.getSelectedItem() + "").substring(0, 4) + "'");
                            debkret = Sequel.cariIsiAngka("select (sum(detailjurnal.kredit)-sum(detailjurnal.debet)) "
                                    + "from jurnal inner join detailjurnal on detailjurnal.no_jurnal=jurnal.no_jurnal where "
                                    + "detailjurnal.kd_rek='" + rs2.getString(1) + "' and jurnal.tgl_jurnal between '"
                                    + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '"
                                    + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "'");
                            saldoakhir = saldoawal + debkret;
                            pendapatan += saldoakhir;
                            tabMode.addRow(new Object[]{"", " " + rs2.getString(1) + " " + rs2.getString(2),
                                "  " + df2.format(saldoakhir)});
                            try {
                                rs3 = koneksi.prepareStatement(
                                        "select rekening.kd_rek, rekening.nm_rek, rekening.tipe, rekening.balance "
                                        + " from rekening inner join subrekening on rekening.kd_rek=subrekening.kd_rek2 "
                                        + " where subrekening.kd_rek='" + rs2.getString(1)
                                        + "' and rekening.level='1' and "
                                        + "rekening.tipe='R' and rekening.balance='K' order by rekening.kd_rek")
                                        .executeQuery();
                                while (rs3.next()) {
                                    saldoawal = Sequel.cariIsiAngka(
                                            "select sum(rekeningtahun.saldo_awal) from rekeningtahun where rekeningtahun.kd_rek='"
                                            + rs3.getString(1) + "' and rekeningtahun.thn " + "between '"
                                            + Valid.SetTgl(Tgl1.getSelectedItem() + "").substring(0, 4)
                                            + "' and '"
                                            + Valid.SetTgl(Tgl2.getSelectedItem() + "").substring(0, 4) + "'");
                                    debkret = Sequel
                                            .cariIsiAngka("select (sum(detailjurnal.kredit)-sum(detailjurnal.debet)) "
                                                    + "from jurnal inner join detailjurnal on detailjurnal.no_jurnal=jurnal.no_jurnal where "
                                                    + "detailjurnal.kd_rek='" + rs3.getString(1)
                                                    + "' and jurnal.tgl_jurnal between '"
                                                    + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '"
                                                    + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "'");
                                    saldoakhir = saldoawal + debkret;
                                    pendapatan += saldoakhir;
                                    tabMode.addRow(new Object[]{"", "  " + rs3.getString(1) + " " + rs3.getString(2),
                                        "  " + df2.format(saldoakhir)});
                                    try {
                                        rs4 = koneksi.prepareStatement(
                                                "select rekening.kd_rek, rekening.nm_rek, rekening.tipe, rekening.balance "
                                                + " from rekening inner join subrekening on rekening.kd_rek=subrekening.kd_rek2 "
                                                + " where subrekening.kd_rek='" + rs3.getString(1)
                                                + "' and rekening.level='1' and "
                                                + "rekening.tipe='R' and rekening.balance='K' order by rekening.kd_rek")
                                                .executeQuery();
                                        while (rs4.next()) {
                                            saldoawal = Sequel.cariIsiAngka(
                                                    "select sum(rekeningtahun.saldo_awal) from rekeningtahun where rekeningtahun.kd_rek='"
                                                    + rs4.getString(1) + "' and rekeningtahun.thn "
                                                    + "between '"
                                                    + Valid.SetTgl(Tgl1.getSelectedItem() + "").substring(0, 4)
                                                    + "' and '"
                                                    + Valid.SetTgl(Tgl2.getSelectedItem() + "").substring(0, 4)
                                            ...
                                            debkret = Sequel.cariIsiAngka(
                                                    ...
                                                    + "from jurnal inner join detailjurnal on detailjurnal.no_jurnal=jurnal.no_jurnal where "
                                                    + "detailjurnal.kd_rek='" + rs4.getString(1)
                                                    + "' and jurnal.tgl_jurnal between '"
                                                    + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '"
                                                    + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "'");
                                            saldoakhir = saldoawal + debkret;
                                            ...
                                            tabMode.addRow(new Object[]{"",
                                                "   " + rs4.getString(1) + " " + rs4.getString(2),
                                                "  " + df2.format(saldoakhir)});
                                            try {
                                                rs5 = koneksi.prepareStatement(
                                                        "select rekening.kd_rek, rekening.nm_rek, rekening.tipe, rekening.balance "
                                                        + " from rekening inner join subrekening on rekening.kd_rek=subrekening.kd_rek2 "
                                                        + " where subrekening.kd_rek='" + rs4.getString(1)
                                                        + "' and rekening.level='1' and "
                                                        + "rekening.tipe='R' and rekening.balance='K' order by rekening.kd_rek")
                                                        .executeQuery();
                                                while (rs5.next()) {
                                                    saldoawal = Sequel.cariIsiAngka(
                                                            "select sum(rekeningtahun.saldo_awal) from rekeningtahun where rekeningtahun.kd_rek='"
                                                            + rs5.getString(1) + "' and rekeningtahun.thn "
                                                            + "between '"
                                                    ...
                                                    debkret = Sequel.cariIsiAngka(
                                                            "select (sum(detailjurnal.kredit)-sum(detailjurnal.debet)) "
                                                            + "from jurnal inner join detailjurnal on detailjurnal.no_jurnal=jurnal.no_jurnal where "
                                                            + "detailjurnal.kd_rek='" + rs5.getString(1)
                                                            + "' and jurnal.tgl_jurnal between '"
                                                            + Valid.SetTgl(Tgl1.getSelectedItem() + "")
                                                            + "' and '"
                                                            + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "'");
                                                    ...
                                                    pendapatan += saldoakhir;
                                                    tabMode.addRow(new Object[]{"",
                                                        "    " + rs5.getString(1) + " " + rs5.getString(2),
                                                        "  " + df2.format(saldoakhir)});
                                                    try {
                                                        rs6 = koneksi.prepareStatement(
                                                                "select rekening.kd_rek, rekening.nm_rek, rekening.tipe, rekening.balance "
                                                                + " from rekening inner join subrekening on rekening.kd_rek=subrekening.kd_rek2 "
                                                                + " where subrekening.kd_rek='"
                                                                + rs5.getString(1)
                                                                + "' and rekening.level='1' and "
                                                                + "rekening.tipe='R' and rekening.balance='K' order by rekening.kd_rek")
                                                                .executeQuery();
                                                        while (rs6.next()) {
                                                            ...
                                                            debkret = Sequel.cariIsiAngka(
                                                                    "select (sum(detailjurnal.kredit)-sum(detailjurnal.debet)) "
                                                                    + "from jurnal inner join detailjurnal on detailjurnal.no_jurnal=jurnal.no_jurnal where "
                                                                    + "detailjurnal.kd_rek='" + rs6.getString(1)
                                                                    + "' and jurnal.tgl_jurnal between '"
                                                                    + Valid.SetTgl(Tgl1.getSelectedItem() + "")
                                                                    + "' and '"
                                                                    + Valid.SetTgl(Tgl2.getSelectedItem() + "")
                            ...
                            try {
                                ...
                                while (rs3.next()) {
                                    saldoawal = Sequel.cariIsiAngka(
                                            ...
                                            + Valid.SetTgl(Tgl2.getSelectedItem() + "").substring(0, 4) + "'");
                                    debkret = Sequel
                                            .cariIsiAngka("select (sum(detailjurnal.debet)-sum(detailjurnal.kredit)) "
                                                    + "from jurnal inner join detailjurnal on detailjurnal.no_jurnal=jurnal.no_jurnal where "
                                                    + "detailjurnal.kd_rek='" + rs3.getString(1)
                                                    + "' and jurnal.tgl_jurnal between '"
                                                    + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '"
            ...
            tabMode.addRow(new Object[]{"", "Laba Bersih : Total Pendapatan - Total Biaya-Biaya",
                df2.format(pendapatan - biaya)});
            tabMode.addRow(data);
            ...
            try {
                ...
                rs = koneksi
                        .prepareStatement("select rekening.kd_rek, rekening.nm_rek  from rekening "
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            ...
                            saldoakhir = saldoawal + debkret;
                            modal += saldoakhir;
                            tabMode2.addRow(new Object[]{"", " " + rs2.getString(1) + " " + rs2.getString(2),
                                "  " + df2.format(saldoakhir)});
                            try {
                                rs3 = koneksi.prepareStatement(
                                        "select rekening.kd_rek, rekening.nm_rek, rekening.tipe, rekening.balance "
                                ...
                                while (rs3.next()) {
                                    ...
                                    saldoakhir = saldoawal + debkret;
                                    modal += saldoakhir;
                                    tabMode2.addRow(new Object[]{"", "  " + rs3.getString(1) + " " + rs3.getString(2),
                                        "  " + df2.format(saldoakhir)});
                                    try {
                                        rs4 = koneksi.prepareStatement(
                                                "select rekening.kd_rek, rekening.nm_rek, rekening.tipe, rekening.balance "
            ...
            tabMode2.addRow(new Object[]{"", "Modal Akhir : Laba Bersih + Total Modal",
                df2.format(modal + (pendapatan - biaya))});
            tabMode2.addRow(data);
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    saldoakhir = saldoawal + debkret;
                    aktiva += saldoakhir;
                    tabMode3.addRow(new Object[]{"", rs.getString(1) + " " + rs.getString(2),
                        "  " + df2.format(saldoakhir)});
                    try {
                        rs2 = koneksi.prepareStatement(
                                "select rekening.kd_rek, rekening.nm_rek, rekening.tipe, rekening.balance "
                        ...
                        while (rs2.next()) {
                            ...
                            saldoakhir = saldoawal + debkret;
                            aktiva += saldoakhir;
                            tabMode3.addRow(new Object[]{"", " " + rs2.getString(1) + " " + rs2.getString(2),
                                "  " + df2.format(saldoakhir)});
                            try {
                                rs3 = koneksi.prepareStatement(
                                        "select rekening.kd_rek, rekening.nm_rek, rekening.tipe, rekening.balance "
                                ...
                                while (rs3.next()) {
                                    ...
                                    saldoakhir = saldoawal + debkret;
                                    aktiva += saldoakhir;
                                    tabMode3.addRow(new Object[]{"", "  " + rs3.getString(1) + " " + rs3.getString(2),
                                        "  " + df2.format(saldoakhir)});
                                    try {
                                        rs4 = koneksi.prepareStatement(
                                                "select rekening.kd_rek, rekening.nm_rek, rekening.tipe, rekening.balance "
            ...
            try {
                ...
                tabMode3.addRow(new Object[]{"", "Total Pasiva : Pasiva + Modal Akhir",
                    df2.format(pasiva + modal + (pendapatan - biaya))});
                tabMode3.addRow(data);
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgLabaRugi.class.getName());
