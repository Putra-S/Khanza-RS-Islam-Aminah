 ...
 * @author perpustakaan
 */
public class DlgLhtPiutang extends javax.swing.JDialog {
    ...
    private double sisapiutang = 0, cicilan = 0, diskon = 0, tidakterbayar = 0, totalpiutang = 0, totalcicilan = 0,
            totaluangmuka = 0, totaldiskon = 0, totaltidakterbayar = 0;
    ...
    public DlgLhtPiutang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat/No.tagihan", "Tgl.Piutang", "Pasien", "Status", "Total Piutang", "Uang Muka",
...
private void MnDetailCicilanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDetailCicilanActionPerformed
    ...
    public void tampil() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + " where concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and piutang_pasien.tgl_piutang between ? and ? and "
                    + "(piutang_pasien.no_rawat like ? or piutang_pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or piutang_pasien.status like ?) order by piutang_pasien.tgl_piutang");
            try {
                ...
                while (rs.next()) {
                    ...
                    diskon = Sequel.cariIsiAngka(
                            ...
                            rs.getString(1));
                    tidakterbayar = Sequel.cariIsiAngka(
                    ...
                    tabMode.addRow(new Object[]{rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4),
                        rs.getDouble(5), rs.getDouble(6), cicilan, diskon, tidakterbayar,
                        (rs.getDouble(7) - cicilan - diskon - tidakterbayar), rs.getString(8), rs.getString(9)});
            ...
            if (tabMode.getRowCount() > 0) {
                tabMode.addRow(new Object[]{"TOTAL", ":", "", "", totalpiutang, totaluangmuka, totalcicilan,
                    totaldiskon, totaltidakterbayar, sisapiutang, "", ""});
            }
    ...
    private static final Logger LOG = Logger.getLogger(DlgLhtPiutang.class.getName());
