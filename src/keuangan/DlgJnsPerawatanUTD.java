...
public class DlgJnsPerawatanUTD extends javax.swing.JDialog {
    ...
    public DlgJnsPerawatanUTD(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"P", "Kode Periksa", "Nama Pelayanan", "J.S.Rumah Sakit", "Paket BHP", "J.M.Perujuk",
            "J.M. Dokter", "J.M. Petugas", "K.S.O.", "Manajemen", "Total Tarif", "Jenis Bayar"};
...
private void btnPjActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPjActionPerformed
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(kd_jenis_prw,3),signed)),0) from jns_perawatan_utd", "J", 6,
                TKd);
        TKd.requestFocus();
    }
    ...
    private void getData() {
        if (tbJnsPerawatan.getSelectedRow() != -1) {
            ...
            Manajemen.setText(Valid.SetAngka2(
            ...
            Sequel.cariIsi("select kd_pj from jns_perawatan_utd where kd_jenis_prw=?", kdpnj,
    ...
    private void isjml() {
        if ((!BagianRs.getText().isEmpty()) && (!JMLaborat.getText().isEmpty()) && (!JMDokter.getText().isEmpty())
                ...
                && (!Manajemen.getText().isEmpty())) {
            TotalBiaya.setText(Valid.SetAngka2(Double.parseDouble(BagianRs.getText().trim())
                    + Double.parseDouble(JMDokter.getText().trim()) + Double.parseDouble(Bhp.getText().trim())
                    + Double.parseDouble(JMLaborat.getText().trim()) + Double.parseDouble(JMPerujuk.getText().trim())
    ...
    private static final Logger LOG = Logger.getLogger(DlgJnsPerawatanUTD.class.getName());
