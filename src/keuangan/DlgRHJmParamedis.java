...
public class DlgRHJmParamedis extends javax.swing.JDialog {
    ...
    public DlgRHJmParamedis(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.", "Nama Paramedis", "Tgl.Tindakan", "Nama Pasien",
            "Tindakan Medis", "Jasa Medis"};
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRHTindakanParamedis.jasper", "report",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void BtnDepartemenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDepartemenActionPerformed
        departemen.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRHJmParamedis dialog = new DlgRHJmParamedis(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (chkRalan.isSelected() == true) {
                        ...
                        try {
                            pstindakanprjalan.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + ""));
                            pstindakanprjalan.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + ""));
                            pstindakanprjalan.setString(3, rs.getString("nip"));
                            pstindakanprjalan.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rstindakanprjalan = pstindakanprjalan.executeQuery();
                            rstindakanprjalan.last();
                            pstindakandrprjalan.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + ""));
                            pstindakandrprjalan.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + ""));
                            pstindakandrprjalan.
                                    setString(3, rs.getString("nip"));
                            pstindakandrprjalan.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rstindakandrprjalan = pstindakandrprjalan.
                                    executeQuery();
                            rstindakandrprjalan.last();
                            if ((rstindakanprjalan.getRow() > 0) || (rstindakandrprjalan.
                                    getRow() > 0)) {
                                a++;
                            ...
                            while (rstindakanprjalan.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    rstindakanprjalan.getString("nm_pasien") + " (" + rstindakanprjalan.
                                    getString("kd_pj") + ")",
                                    rstindakanprjalan.getString("nm_perawatan"),
                                    Valid.SetAngka(rstindakanprjalan.getDouble(
                                    "tarif_tindakanpr"))
                                });
                                total += rstindakanprjalan.getDouble(
                                        "tarif_tindakanpr");
                            }
                            ...
                            while (rstindakandrprjalan.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rstindakandrprjalan.
                                    getString("tgl_registrasi"),
                                    rstindakandrprjalan.getString("nm_pasien") + " (" + rstindakandrprjalan.
                                    getString("kd_pj") + ")",
                                    rstindakandrprjalan.
                                    getString("nm_perawatan"), Valid.SetAngka(
                                    rstindakandrprjalan.getDouble(
                                    "tarif_tindakanpr"))
                                });
                                total += rstindakandrprjalan.getDouble(
                                        "tarif_tindakanpr");
                            }
                        } catch (Exception e) {
                    ...
                    if (chkRanap.isSelected() == true) {
                        ...
                        try {
                            pstindakanprinap.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + ""));
                            pstindakanprinap.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + ""));
                            pstindakanprinap.setString(3, rs.getString("nip"));
                            pstindakanprinap.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rstindakanprinap = pstindakanprinap.executeQuery();
                            rstindakanprinap.last();

                            pstindakandrprinap.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + ""));
                            pstindakandrprinap.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + ""));
                            pstindakandrprinap.setString(3, rs.getString("nip"));
                            pstindakandrprinap.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rstindakandrprinap = pstindakandrprinap.
                                    executeQuery();
                            rstindakandrprinap.last();
                            if ((rstindakandrprinap.getRow() > 0) || (rstindakanprinap.
                                    getRow() > 0)) {
                                a++;
                                tabMode.addRow(new Object[]{"", "",
                                    a + ". Rawat Inap", "", "", ""});
                            ...
                            while (rstindakanprinap.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rstindakanprinap.
                                    getString("tgl_perawatan") + " " + rstindakanprinap.
                                    getString("jam_rawat"), rstindakanprinap.
                                    getString("nm_pasien") + " (" + rstindakanprinap.
                                    getString("kd_pj") + ")",
                                    rstindakanprinap.getString("nm_perawatan"),
                                    Valid.SetAngka(rstindakanprinap.getDouble(
                                    "tarif_tindakanpr"))
                                });
                                total += rstindakanprinap.getDouble(
                                        "tarif_tindakanpr");
                            }
                            ...
                            while (rstindakandrprinap.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rstindakandrprinap.
                                    getString("tgl_perawatan") + " " + rstindakandrprinap.
                                    getString("jam_rawat"), rstindakandrprinap.
                                    getString("nm_pasien") + " (" + rstindakandrprinap.
                                    getString("kd_pj") + ")",
                                    rstindakandrprinap.getString("nm_perawatan"),
                                    Valid.SetAngka(rstindakandrprinap.getDouble(
                                    "tarif_tindakanpr"))
                                });
                                total += rstindakandrprinap.getDouble(
                                        "tarif_tindakanpr");
                            }
                        } catch (Exception e) {
                            System.out.println("Notifikasi : " + e);
                    ...
                    if (chkOperasi.isSelected() == true) {
                        psasisten_operator1 = koneksi.prepareStatement(
                                "select operasi.biayaasisten_operator1,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                        ...
                        psasisten_operator2 = koneksi.prepareStatement(
                                "select operasi.biayaasisten_operator2,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        psasisten_operator3 = koneksi.prepareStatement(
                                "select operasi.biayaasisten_operator3,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        psinstrumen = koneksi.prepareStatement(
                                "select operasi.biayainstrumen,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        psperawaat_resusitas = koneksi.prepareStatement(
                                "select operasi.biayaperawaat_resusitas,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        psasisten_anestesi = koneksi.prepareStatement(
                                "select operasi.biayaasisten_anestesi,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        psasisten_anestesi2 = koneksi.prepareStatement(
                                "select operasi.biayaasisten_anestesi2,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        psbidan = koneksi.prepareStatement(
                                "select operasi.biayabidan,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        psbidan2 = koneksi.prepareStatement(
                                "select operasi.biayabidan2,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        psbidan3 = koneksi.prepareStatement(
                                "select operasi.biayabidan3,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        psperawatluar = koneksi.prepareStatement(
                                "select operasi.biayaperawat_luar,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        psomloop2 = koneksi.prepareStatement(
                                "select operasi.biaya_omloop2,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        psomloop3 = koneksi.prepareStatement(
                                "select operasi.biaya_omloop3,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        psomloop4 = koneksi.prepareStatement(
                                "select operasi.biaya_omloop4,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        psomloop5 = koneksi.prepareStatement(
                                "select operasi.biaya_omloop5,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        try {
                            psasisten_operator1.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " 00:00:00");
                            psasisten_operator1.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " 23:59:59");
                            psasisten_operator1.
                                    setString(3, rs.getString("nip"));
                            psasisten_operator1.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsasisten_operator1 = psasisten_operator1.
                                    executeQuery();
                            rsasisten_operator1.last();

                            psasisten_operator2.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " 00:00:00");
                            psasisten_operator2.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " 23:59:59");
                            psasisten_operator2.
                                    setString(3, rs.getString("nip"));
                            psasisten_operator2.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsasisten_operator2 = psasisten_operator2.
                                    executeQuery();
                            rsasisten_operator2.last();

                            psasisten_operator3.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " 00:00:00");
                            psasisten_operator3.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " 23:59:59");
                            psasisten_operator3.
                                    setString(3, rs.getString("nip"));
                            psasisten_operator3.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsasisten_operator3 = psasisten_operator3.
                                    executeQuery();
                            rsasisten_operator3.last();

                            psinstrumen.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " 00:00:00");
                            psinstrumen.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " 23:59:59");
                            psinstrumen.setString(3, rs.getString("nip"));
                            psinstrumen.setString(4,
                                    "%" + KdCaraBayar.getText() + NmCaraBayar.
                                    getText() + "%");
                            rsinstrumen = psinstrumen.executeQuery();
                            rsinstrumen.last();

                            psperawaat_resusitas.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " 00:00:00");
                            psperawaat_resusitas.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " 23:59:59");
                            psperawaat_resusitas.setString(3, rs.
                                    getString("nip"));
                            psperawaat_resusitas.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsperawaat_resusitas = psperawaat_resusitas.
                                    executeQuery();
                            rsperawaat_resusitas.last();

                            psasisten_anestesi.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " 00:00:00");
                            psasisten_anestesi.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " 23:59:59");
                            psasisten_anestesi.setString(3, rs.getString("nip"));
                            psasisten_anestesi.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsasisten_anestesi = psasisten_anestesi.
                                    executeQuery();
                            rsasisten_anestesi.last();

                            psasisten_anestesi2.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " 00:00:00");
                            psasisten_anestesi2.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " 23:59:59");
                            psasisten_anestesi2.
                                    setString(3, rs.getString("nip"));
                            psasisten_anestesi2.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsasisten_anestesi2 = psasisten_anestesi2.
                                    executeQuery();
                            rsasisten_anestesi2.last();

                            psbidan.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " 00:00:00");
                            psbidan.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " 23:59:59");
                            ...
                            psbidan2.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " 00:00:00");
                            psbidan2.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " 23:59:59");
                            psbidan2.setString(3, rs.getString("nip"));
                            psbidan2.setString(4,
                                    "%" + KdCaraBayar.getText() + NmCaraBayar.
                                    getText() + "%");
                            rsbidan2 = psbidan2.executeQuery();
                            rsbidan2.last();

                            psbidan3.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " 00:00:00");
                            psbidan3.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " 23:59:59");
                            psbidan3.setString(3, rs.getString("nip"));
                            psbidan3.setString(4,
                                    "%" + KdCaraBayar.getText() + NmCaraBayar.
                                    getText() + "%");
                            rsbidan3 = psbidan3.executeQuery();
                            rsbidan3.last();

                            psperawatluar.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " 00:00:00");
                            psperawatluar.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " 23:59:59");
                            psperawatluar.setString(3, rs.getString("nip"));
                            psperawatluar.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            ...
                            if ((rsasisten_operator1.getRow() > 0) || (rsasisten_operator2.
                                    getRow() > 0) || (rsasisten_operator3.
                                            getRow() > 0) || (rsinstrumen.
                                            getRow() > 0) || (rsperawaat_resusitas.
                                            getRow() > 0)
                                    || (rsasisten_anestesi.getRow() > 0) || (rsasisten_anestesi2.
                                    getRow() > 0) || (rsbidan.getRow() > 0) || (rsbidan2.
                                    getRow() > 0) || (rsbidan3.getRow() > 0)
                                    || (rsperawatluar.getRow() > 0) || (rsomloop.
                                    getRow() > 0) || (rsomloop2.getRow() > 0) || (rsomloop3.
                                    getRow() > 0) || (rsomloop4.getRow() > 0) || (rsomloop5.
                                    getRow() > 0)) {
                                a++;
                                tabMode.addRow(new Object[]{"", "",
                                    a + ". Operasi/VK", "", "", ""});
                            ...
                            while (rsasisten_operator1.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    rsasisten_operator1.getString("nm_pasien") + " (" + rsasisten_operator1.
                                    getString("kd_pj") + ")",
                                    rsasisten_operator1.
                                    getString("nm_perawatan") + " (Asisten Operator 1)",
                                    Valid.SetAngka(rsasisten_operator1.
                                    getDouble("biayaasisten_operator1"))
                                });
                                total += rsasisten_operator1.getDouble(
                            ...
                            while (rsasisten_operator2.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsasisten_operator2.
                                    getString("tgl_operasi"),
                                    rsasisten_operator2.getString("nm_pasien") + " (" + rsasisten_operator2.
                                    getString("kd_pj") + ")",
                                    rsasisten_operator2.
                                    getString("nm_perawatan") + " (Asisten Operator 2)",
                                    Valid.SetAngka(rsasisten_operator2.
                                    getDouble("biayaasisten_operator2"))
                                });
                                total += rsasisten_operator2.getDouble(
                            ...
                            while (rsasisten_operator3.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsasisten_operator3.
                                    getString("tgl_operasi"),
                                    rsasisten_operator3.getString("nm_pasien") + " (" + rsasisten_operator3.
                                    getString("kd_pj") + ")",
                                    rsasisten_operator3.
                                    getString("nm_perawatan") + " (Asisten Operator 3)",
                                    Valid.SetAngka(rsasisten_operator3.
                                    getDouble("biayaasisten_operator3"))
                                });
                                total += rsasisten_operator3.getDouble(
                            ...
                            while (rsinstrumen.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsinstrumen.getString(
                                    "tgl_operasi"), rsinstrumen.getString(
                                    "nm_pasien") + " (" + rsinstrumen.getString(
                                    "kd_pj") + ")",
                                    rsinstrumen.getString("nm_perawatan") + " (Instrumen)",
                                    Valid.SetAngka(rsinstrumen.getDouble(
                                    "biayainstrumen"))
                                });
                                total += rsinstrumen.getDouble("biayainstrumen");
                            }
                            ...
                            while (rsperawaat_resusitas.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsperawaat_resusitas.
                                    getString("tgl_operasi"),
                                    rsperawaat_resusitas.getString("nm_pasien") + " (" + rsperawaat_resusitas.
                                    getString("kd_pj") + ")",
                                    rsperawaat_resusitas.getString(
                                    "nm_perawatan") + " (Perawat Resusitas)",
                                    Valid.SetAngka(rsperawaat_resusitas.
                                    getDouble("biayaperawaat_resusitas"))
                                });
                                total += rsperawaat_resusitas.getDouble(
                            ...
                            while (rsasisten_anestesi.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsasisten_anestesi.
                                    getString("tgl_operasi"),
                                    rsasisten_anestesi.getString("nm_pasien") + " (" + rsasisten_anestesi.
                                    getString("kd_pj") + ")",
                                    rsasisten_anestesi.getString("nm_perawatan") + " (Asisten Anestesi 1)",
                                    Valid.SetAngka(rsasisten_anestesi.getDouble(
                                    "biayaasisten_anestesi"))
                                });
                                total += rsasisten_anestesi.getDouble(
                                        "biayaasisten_anestesi");
                            }
                            ...
                            while (rsasisten_anestesi2.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsasisten_anestesi2.
                                    getString("tgl_operasi"),
                                    rsasisten_anestesi2.getString("nm_pasien") + " (" + rsasisten_anestesi2.
                                    getString("kd_pj") + ")",
                                    rsasisten_anestesi2.
                                    getString("nm_perawatan") + " (Asisten Anestesi 2)",
                                    Valid.SetAngka(rsasisten_anestesi2.
                                    getDouble("biayaasisten_anestesi2"))
                                });
                                total += rsasisten_anestesi2.getDouble(
                            ...
                            while (rsbidan.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsbidan.getString(
                                    "tgl_operasi"), rsbidan.getString(
                                    "nm_pasien") + " (" + rsbidan.getString(
                                    "kd_pj") + ")",
                                    rsbidan.getString("nm_perawatan") + " (Bidan 1)",
                                    Valid.SetAngka(rsbidan.getDouble(
                                    "biayabidan"))
                                });
                                total += rsbidan.getDouble("biayabidan");
                            }
                            ...
                            while (rsbidan2.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsbidan2.getString(
                                    "tgl_operasi"), rsbidan2.getString(
                                    "nm_pasien") + " (" + rsbidan2.getString(
                                    "kd_pj") + ")",
                                    rsbidan2.getString("nm_perawatan") + " (Bidan 2)",
                                    Valid.SetAngka(rsbidan2.getDouble(
                                    "biayabidan2"))
                                });
                                total += rsbidan2.getDouble("biayabidan2");
                            }
                            ...
                            while (rsbidan3.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsbidan3.getString(
                                    "tgl_operasi"), rsbidan3.getString(
                                    "nm_pasien") + " (" + rsbidan3.getString(
                                    "kd_pj") + ")",
                                    rsbidan3.getString("nm_perawatan") + " (Bidan 3)",
                                    Valid.SetAngka(rsbidan3.getDouble(
                                    "biayabidan3"))
                                });
                                total += rsbidan3.getDouble("biayabidan3");
                            }
                            ...
                            while (rsomloop.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsomloop.getString(
                                    "tgl_operasi"), rsomloop.getString(
                                    "nm_pasien") + " (" + rsomloop.getString(
                                    "kd_pj") + ")",
                                    rsomloop.getString("nm_perawatan") + " (Onloop 1)",
                                    Valid.SetAngka(rsomloop.getDouble(
                                    "biaya_omloop"))
                                });
                                total += rsomloop.getDouble("biaya_omloop");
                            }
                            ...
                            while (rsomloop2.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsomloop2.getString(
                                    "tgl_operasi"), rsomloop2.getString(
                                    "nm_pasien") + " (" + rsomloop2.getString(
                                    "kd_pj") + ")",
                                    rsomloop2.getString("nm_perawatan") + " (Onloop 2)",
                                    Valid.SetAngka(rsomloop2.getDouble(
                                    "biaya_omloop2"))
                                });
                                total += rsomloop2.getDouble("biaya_omloop2");
                            }
                            ...
                            while (rsomloop3.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsomloop3.getString(
                                    "tgl_operasi"), rsomloop3.getString(
                                    "nm_pasien") + " (" + rsomloop3.getString(
                                    "kd_pj") + ")",
                                    rsomloop3.getString("nm_perawatan") + " (Onloop 3)",
                                    Valid.SetAngka(rsomloop3.getDouble(
                                    "biaya_omloop3"))
                                });
                                total += rsomloop3.getDouble("biaya_omloop3");
                            }
                            ...
                            while (rsomloop4.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsomloop4.getString(
                                    "tgl_operasi"), rsomloop4.getString(
                                    "nm_pasien") + " (" + rsomloop4.getString(
                                    "kd_pj") + ")",
                                    rsomloop4.getString("nm_perawatan") + " (Onloop 4)",
                                    Valid.SetAngka(rsomloop4.getDouble(
                                    "biaya_omloop4"))
                                });
                                total += rsomloop4.getDouble("biaya_omloop4");
                            }
                            ...
                            while (rsomloop5.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsomloop5.getString(
                                    "tgl_operasi"), rsomloop5.getString(
                                    "nm_pasien") + " (" + rsomloop5.getString(
                                    "kd_pj") + ")",
                                    rsomloop5.getString("nm_perawatan") + " (Onloop 5)",
                                    Valid.SetAngka(rsomloop5.getDouble(
                                    "biaya_omloop5"))
                                });
                                total += rsomloop5.getDouble("biaya_omloop5");
                            }

                            rsperawatluar.beforeFirst();
                            while (rsperawatluar.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsperawatluar.getString(
                                    "tgl_operasi"), rsperawatluar.getString(
                                    "nm_pasien") + " (" + rsperawatluar.
                                    getString("kd_pj") + ")",
                                    rsperawatluar.getString("nm_perawatan") + " (Perawat Luar)",
                                    Valid.SetAngka(rsperawatluar.getDouble(
                                    "biayaperawat_luar"))
                                });
                                total += rsperawatluar.getDouble(
                                        "biayaperawat_luar");
                            }
                        } catch (Exception e) {
                            System.out.println("Notifikasi : " + e);
                    ...
                    if (chkLaborat.isSelected() == true) {
                        psperiksa_lab = koneksi.prepareStatement(
                                "select periksa_lab.tarif_tindakan_petugas,pasien.nm_pasien,"
                        ...
                        try {
                            ...
                            while (rsperiksa_lab.next()) {
                                ...
                                try {
                                    psdetaillab.setString(1, rsperiksa_lab.
                                            getString("no_rawat"));
                                    psdetaillab.setString(2, rsperiksa_lab.
                                            getString("kd_jenis_prw"));
                                    psdetaillab.setString(3, rsperiksa_lab.
                                            getString("tgl_periksa"));
                                    psdetaillab.setString(4, rsperiksa_lab.
                                            getString("jam"));
                                    rsdetaillab = psdetaillab.executeQuery();
                                    while (rsdetaillab.next()) {
                                        detaillab = rsdetaillab.getDouble(
                                                "total");
                                    }
                                    tabMode.addRow(new Object[]{
                                        "", "", "     " + rsperiksa_lab.
                                        getString("tgl_periksa") + " " + rsperiksa_lab.
                                        getString("jam"), rsperiksa_lab.
                                        getString("nm_pasien") + " (" + rsperiksa_lab.
                                        getString("kd_pj") + ")",
                                        rsperiksa_lab.getString("nm_perawatan"),
                                        Valid.SetAngka(rsperiksa_lab.getDouble(
                                        "tarif_tindakan_petugas") + detaillab)
                                    });
                                    total = total + rsperiksa_lab.getDouble(
                                            "tarif_tindakan_petugas") + detaillab;
                                } catch (Exception e) {
                                    System.out.println("Notifikasi : " + e);
                                } finally {
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        psperiksa_radiologi = koneksi.prepareStatement(
                                "select periksa_radiologi.tarif_tindakan_petugas,pasien.nm_pasien,"
                        ...
                        try {
                            ...
                            if (rsperiksa_radiologi.getRow() > 0) {
                                a++;
                                tabMode.addRow(new Object[]{"", "",
                                    a + ". Detail Pemeriksaan radiologi ", "",
                                    "", ""});
                            }
                            ...
                            while (rsperiksa_radiologi.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    getString("nm_pasien") + " (" + rsperiksa_radiologi.
                                    getString("kd_pj") + ")",
                                    rsperiksa_radiologi.
                                    getString("nm_perawatan"), Valid.SetAngka(
    ...
    private static final Logger LOG = Logger.getLogger(DlgRHJmParamedis.class.
            getName());
