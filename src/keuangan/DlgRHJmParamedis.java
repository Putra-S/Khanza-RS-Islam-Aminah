...
public class DlgRHJmParamedis extends javax.swing.JDialog {
    ...
    private ResultSet rs, rstindakanprjalan, rstindakandrprjalan, rstindakanprinap, rstindakandrprinap, rsdetaillab,
            rsperiksa_lab, rsasisten_operator1, rsasisten_operator2, rsasisten_operator3, rsinstrumen,
            rsperawaat_resusitas, rsasisten_anestesi, rsasisten_anestesi2, rsbidan, rsbidan2, rsbidan3, rsperawatluar,
            rsperiksa_radiologi, rsomloop, rsomloop2, rsomloop3, rsomloop4, rsomloop5;
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (chkRalan.isSelected() == true) {
                        pstindakanprjalan = koneksi
                                .prepareStatement("select pasien.nm_pasien,rawat_jl_pr.tarif_tindakanpr,"
                        ...
                        pstindakandrprjalan = koneksi
                                .prepareStatement("select pasien.nm_pasien,rawat_jl_drpr.tarif_tindakanpr,"
                                        + "jns_perawatan.nm_perawatan,reg_periksa.tgl_registrasi,reg_periksa.kd_pj "
                                        + "from pasien inner join reg_periksa  "
                        ...
                        try {
                            ...
                            while (rstindakanprjalan.next()) {
                                tabMode.addRow(
                                        new Object[]{"", "", "     " + rstindakanprjalan.getString("tgl_registrasi"),
                                            rstindakanprjalan.getString("nm_pasien") + " ("
                                            + rstindakanprjalan.getString("kd_pj") + ")",
                                            rstindakanprjalan.getString("nm_perawatan"),
                                            Valid.SetAngka(rstindakanprjalan.getDouble("tarif_tindakanpr"))});
                                total += rstindakanprjalan.getDouble("tarif_tindakanpr");
                            }
                            rstindakandrprjalan.beforeFirst();
                            while (rstindakandrprjalan.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rstindakandrprjalan.getString("tgl_registrasi"),
                                    rstindakandrprjalan.getString("nm_pasien") + " ("
                                    + rstindakandrprjalan.getString("kd_pj") + ")",
                                    rstindakandrprjalan.getString("nm_perawatan"),
                                    Valid.SetAngka(rstindakandrprjalan.getDouble("tarif_tindakanpr"))});
                                total += rstindakandrprjalan.getDouble("tarif_tindakanpr");
                            }
                        } catch (Exception e) {
                    ...
                    if (chkRanap.isSelected() == true) {
                        ...
                        try {
                            ...
                            while (rstindakanprinap.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rstindakanprinap.getString("tgl_perawatan") + " "
                                    + rstindakanprinap.getString("jam_rawat"),
                                    rstindakanprinap.getString("nm_pasien") + " ("
                                    + rstindakanprinap.getString("kd_pj") + ")",
                                    rstindakanprinap.getString("nm_perawatan"),
                                    Valid.SetAngka(rstindakanprinap.getDouble("tarif_tindakanpr"))});
                                total += rstindakanprinap.getDouble("tarif_tindakanpr");
                            }
                            rstindakandrprinap.beforeFirst();
                            while (rstindakandrprinap.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rstindakandrprinap.getString("tgl_perawatan") + " "
                                    + rstindakandrprinap.getString("jam_rawat"),
                                    rstindakandrprinap.getString("nm_pasien") + " ("
                                    + rstindakandrprinap.getString("kd_pj") + ")",
                                    rstindakandrprinap.getString("nm_perawatan"),
                                    Valid.SetAngka(rstindakandrprinap.getDouble("tarif_tindakanpr"))});
                                total += rstindakandrprinap.getDouble("tarif_tindakanpr");
                            }
                        } catch (Exception e) {
                            System.out.println("Notifikasi : " + e);
                        } finally {
                    ...
                    if (chkOperasi.isSelected() == true) {
                        ...
                        psbidan = koneksi
                                .prepareStatement("select operasi.biayabidan,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                        + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                        + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        psbidan2 = koneksi
                                .prepareStatement("select operasi.biayabidan2,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                        + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                        + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        psbidan3 = koneksi
                                .prepareStatement("select operasi.biayabidan3,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                        + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                        + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        psomloop = koneksi
                                .prepareStatement("select operasi.biaya_omloop,pasien.nm_pasien,paket_operasi.nm_perawatan,"
                                        + "operasi.tgl_operasi,reg_periksa.kd_pj from operasi inner join reg_periksa inner join pasien inner join paket_operasi "
                                        + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "
                        ...
                        try {
                            ...
                            psperawaat_resusitas.setString(4,
                            ...
                            if ((rsasisten_operator1.getRow() > 0) || (rsasisten_operator2.getRow() > 0)
                                    || (rsasisten_operator3.getRow() > 0) || (rsinstrumen.getRow() > 0)
                                    || (rsperawaat_resusitas.getRow() > 0) || (rsasisten_anestesi.getRow() > 0)
                                    || (rsasisten_anestesi2.getRow() > 0) || (rsbidan.getRow() > 0)
                                    || (rsbidan2.getRow() > 0) || (rsbidan3.getRow() > 0)
                                    || (rsperawatluar.getRow() > 0) || (rsomloop.getRow() > 0)
                                    || (rsomloop2.getRow() > 0) || (rsomloop3.getRow() > 0) || (rsomloop4.getRow() > 0)
                                    || (rsomloop5.getRow() > 0)) {
                                a++;
                            ...
                            while (rsasisten_operator1.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rsasisten_operator1.getString("tgl_operasi"),
                                    rsasisten_operator1.getString("nm_pasien") + " ("
                                    + rsasisten_operator1.getString("kd_pj") + ")",
                                    rsasisten_operator1.getString("nm_perawatan") + " (Asisten Operator 1)",
                                    Valid.SetAngka(rsasisten_operator1.getDouble("biayaasisten_operator1"))});
                                total += rsasisten_operator1.getDouble("biayaasisten_operator1");
                            }
                            ...
                            while (rsasisten_operator2.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rsasisten_operator2.getString("tgl_operasi"),
                                    rsasisten_operator2.getString("nm_pasien") + " ("
                                    + rsasisten_operator2.getString("kd_pj") + ")",
                                    rsasisten_operator2.getString("nm_perawatan") + " (Asisten Operator 2)",
                                    Valid.SetAngka(rsasisten_operator2.getDouble("biayaasisten_operator2"))});
                                total += rsasisten_operator2.getDouble("biayaasisten_operator2");
                            }
                            ...
                            while (rsasisten_operator3.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rsasisten_operator3.getString("tgl_operasi"),
                                    rsasisten_operator3.getString("nm_pasien") + " ("
                                    + rsasisten_operator3.getString("kd_pj") + ")",
                                    rsasisten_operator3.getString("nm_perawatan") + " (Asisten Operator 3)",
                                    Valid.SetAngka(rsasisten_operator3.getDouble("biayaasisten_operator3"))});
                                total += rsasisten_operator3.getDouble("biayaasisten_operator3");
                            }

                            // perawat luar
                            rsinstrumen.beforeFirst();
                            while (rsinstrumen.next()) {
                                tabMode.addRow(new Object[]{"", "", "     " + rsinstrumen.getString("tgl_operasi"),
                                    rsinstrumen.getString("nm_pasien") + " (" + rsinstrumen.getString("kd_pj")
                                    + ")",
                                    rsinstrumen.getString("nm_perawatan") + " (Instrumen)",
                                    Valid.SetAngka(rsinstrumen.getDouble("biayainstrumen"))});
                            ...
                            while (rsperawaat_resusitas.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rsperawaat_resusitas.getString("tgl_operasi"),
                                    rsperawaat_resusitas.getString("nm_pasien") + " ("
                                    + rsperawaat_resusitas.getString("kd_pj") + ")",
                                    rsperawaat_resusitas.getString("nm_perawatan") + " (Perawat Resusitas)",
                                    Valid.SetAngka(rsperawaat_resusitas.getDouble("biayaperawaat_resusitas"))});
                                total += rsperawaat_resusitas.getDouble("biayaperawaat_resusitas");
                            }
                            ...
                            while (rsasisten_anestesi.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rsasisten_anestesi.getString("tgl_operasi"),
                                    rsasisten_anestesi.getString("nm_pasien") + " ("
                                    + rsasisten_anestesi.getString("kd_pj") + ")",
                                    rsasisten_anestesi.getString("nm_perawatan") + " (Asisten Anestesi 1)",
                                    Valid.SetAngka(rsasisten_anestesi.getDouble("biayaasisten_anestesi"))});
                                total += rsasisten_anestesi.getDouble("biayaasisten_anestesi");
                            }
                            ...
                            while (rsasisten_anestesi2.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rsasisten_anestesi2.getString("tgl_operasi"),
                                    rsasisten_anestesi2.getString("nm_pasien") + " ("
                                    + rsasisten_anestesi2.getString("kd_pj") + ")",
                                    rsasisten_anestesi2.getString("nm_perawatan") + " (Asisten Anestesi 2)",
                                    Valid.SetAngka(rsasisten_anestesi2.getDouble("biayaasisten_anestesi2"))});
                                total += rsasisten_anestesi2.getDouble("biayaasisten_anestesi2");
                            }
                            ...
                            while (rsbidan.next()) {
                                tabMode.addRow(
                                        new Object[]{"", "", "     " + rsbidan.getString("tgl_operasi"),
                                            rsbidan.getString("nm_pasien") + " (" + rsbidan.getString("kd_pj")
                                            + ")",
                                            rsbidan.getString("nm_perawatan") + " (Bidan 1)",
                                            Valid.SetAngka(rsbidan.getDouble("biayabidan"))});
                            ...
                            while (rsbidan2.next()) {
                                tabMode.addRow(
                                        new Object[]{"", "", "     " + rsbidan2.getString("tgl_operasi"),
                                            rsbidan2.getString("nm_pasien") + " (" + rsbidan2.getString("kd_pj")
                                            + ")",
                                            rsbidan2.getString("nm_perawatan") + " (Bidan 2)",
                                            Valid.SetAngka(rsbidan2.getDouble("biayabidan2"))});
                            ...
                            while (rsbidan3.next()) {
                                tabMode.addRow(
                                        new Object[]{"", "", "     " + rsbidan3.getString("tgl_operasi"),
                                            rsbidan3.getString("nm_pasien") + " (" + rsbidan3.getString("kd_pj")
                                            + ")",
                                            rsbidan3.getString("nm_perawatan") + " (Bidan 3)",
                                            Valid.SetAngka(rsbidan3.getDouble("biayabidan3"))});
                            ...
                            while (rsomloop.next()) {
                                tabMode.addRow(
                                        new Object[]{"", "", "     " + rsomloop.getString("tgl_operasi"),
                                            rsomloop.getString("nm_pasien") + " (" + rsomloop.getString("kd_pj")
                                            + ")",
                                            rsomloop.getString("nm_perawatan") + " (Onloop 1)",
                                            Valid.SetAngka(rsomloop.getDouble("biaya_omloop"))});
                            ...
                            while (rsomloop2.next()) {
                                tabMode
                                        .addRow(new Object[]{"", "", "     " + rsomloop2.getString("tgl_operasi"),
                                    rsomloop2.getString("nm_pasien") + " (" + rsomloop2.getString("kd_pj")
                                    + ")",
                                    rsomloop2.getString("nm_perawatan") + " (Onloop 2)",
                                    Valid.SetAngka(rsomloop2.getDouble("biaya_omloop2"))});
                            ...
                            while (rsomloop3.next()) {
                                tabMode
                                        .addRow(new Object[]{"", "", "     " + rsomloop3.getString("tgl_operasi"),
                                    rsomloop3.getString("nm_pasien") + " (" + rsomloop3.getString("kd_pj")
                                    + ")",
                                    rsomloop3.getString("nm_perawatan") + " (Onloop 3)",
                                    Valid.SetAngka(rsomloop3.getDouble("biaya_omloop3"))});
                            ...
                            while (rsomloop4.next()) {
                                tabMode
                                        .addRow(new Object[]{"", "", "     " + rsomloop4.getString("tgl_operasi"),
                                    rsomloop4.getString("nm_pasien") + " (" + rsomloop4.getString("kd_pj")
                                    + ")",
                                    rsomloop4.getString("nm_perawatan") + " (Onloop 4)",
                                    Valid.SetAngka(rsomloop4.getDouble("biaya_omloop4"))});
                            ...
                            while (rsomloop5.next()) {
                                tabMode
                                        .addRow(new Object[]{"", "", "     " + rsomloop5.getString("tgl_operasi"),
                                    rsomloop5.getString("nm_pasien") + " (" + rsomloop5.getString("kd_pj")
                                    + ")",
                                    rsomloop5.getString("nm_perawatan") + " (Onloop 5)",
                                    Valid.SetAngka(rsomloop5.getDouble("biaya_omloop5"))});
                                total += rsomloop5.getDouble("biaya_omloop5");
                            }

                            rsperawatluar.beforeFirst();
                            while (rsperawatluar.next()) {
                                tabMode.addRow(new Object[]{"", "", "     " + rsperawatluar.getString("tgl_operasi"),
                                    rsperawatluar.getString("nm_pasien") + " (" + rsperawatluar.getString("kd_pj")
                                    + ")",
                                    rsperawatluar.getString("nm_perawatan") + " (Perawat Luar)",
                                    Valid.SetAngka(rsperawatluar.getDouble("biayaperawat_luar"))});
                                total += rsperawatluar.getDouble("biayaperawat_luar");
                            }
                        } catch (Exception e) {
                            System.out.println("Notifikasi : " + e);
                        } finally {
                    ...
                    if (chkLaborat.isSelected() == true) {
                        psperiksa_lab = koneksi
                                .prepareStatement("select periksa_lab.tarif_tindakan_petugas,pasien.nm_pasien,"
                            ...
                            while (rsperiksa_lab.next()) {
                                ...
                                try {
                                    ...
                                    tabMode.addRow(new Object[]{"", "",
                                        ...
                                        rsperiksa_lab.getString("nm_pasien") + " ("
                                        + rsperiksa_lab.getString("kd_pj") + ")",
                                        rsperiksa_lab.getString("nm_perawatan"), Valid.SetAngka(
                                        rsperiksa_lab.getDouble("tarif_tindakan_petugas") + detaillab)});
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        psperiksa_radiologi = koneksi
                                .prepareStatement("select periksa_radiologi.tarif_tindakan_petugas,pasien.nm_pasien,"
                        ...
                        try {
                            ...
                            if (rsperiksa_radiologi.getRow() > 0) {
                                a++;
                                tabMode
                                        .addRow(new Object[]{"", "", a + ". Detail Pemeriksaan radiologi ", "", "", ""});
                            }
                            ...
                            while (rsperiksa_radiologi.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsperiksa_radiologi.getDouble("tarif_tindakan_petugas"))});
                                total += rsperiksa_radiologi.getDouble("tarif_tindakan_petugas");
                            }
                        } catch (Exception e) {
                            System.out.println("Notifikasi : " + e);
                        } finally {
    ...
    private static final Logger LOG = Logger.getLogger(DlgRHJmParamedis.class.getName());
