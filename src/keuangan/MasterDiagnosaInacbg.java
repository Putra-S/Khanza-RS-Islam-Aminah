...
public class MasterDiagnosaInacbg extends javax.swing.JDialog {
    ...
    public MasterDiagnosaInacbg(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Kode", "Inacbg", "Tarif Inacbg", "ICD 10", "Deskripsi",
            "Kelas"};
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterDiagnosaInacbg dialog = new MasterDiagnosaInacbg(
    ...
    private void getData() {
        if (tbSpesialis.getSelectedRow() != -1) {
            TKd.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(), 0).
                    toString());
            KdInacbg.setText(tbSpesialis.
                    getValueAt(tbSpesialis.getSelectedRow(), 1).toString());
            TarifInacbg.setText(tbSpesialis.getValueAt(tbSpesialis.
                    getSelectedRow(), 2).toString());
            ICD10.setText(tbSpesialis.
                    getValueAt(tbSpesialis.getSelectedRow(), 3).toString());
            Deskripsi.setText(tbSpesialis.getValueAt(tbSpesialis.
                    getSelectedRow(), 4).toString());
            Kelas.setSelectedItem(tbSpesialis.getValueAt(tbSpesialis.
...
//       BtnEdit.setEnabled(akses.getmaster_kmkb());
    ...
    private static final Logger LOG = Logger.getLogger(
            MasterDiagnosaInacbg.class.getName());
}
