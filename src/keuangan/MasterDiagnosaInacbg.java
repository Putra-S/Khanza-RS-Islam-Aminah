 ...
 * @author dosen
 */
public class MasterDiagnosaInacbg extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public MasterDiagnosaInacbg(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row = {"Kode", "Inacbg", "Tarif Inacbg", "ICD 10", "Deskripsi", "Kelas"};
        ...
        KdInacbg.setDocument(new batasInput(100).getKata(KdInacbg));
    ...
    private void initComponents() {
        ...
        TarifInacbg = new widget.TextBox();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Master Diagnosa Inacbg ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        panelGlass7.setPreferredSize(new java.awt.Dimension(538, 146));
        ...
        panelGlass7.add(KdInacbg);
        KdInacbg.setBounds(80, 40, 110, 23);

        jLabel5.setText("Tarif Inacbg :");
        jLabel5.setName("jLabel5"); // NOI18N
        jLabel5.setPreferredSize(new java.awt.Dimension(70, 14));
        panelGlass7.add(jLabel5);
        jLabel5.setBounds(0, 70, 70, 23);

        TarifInacbg.setName("TarifInacbg"); // NOI18N
        TarifInacbg.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TarifInacbgKeyPressed(evt);
            }
        });
        panelGlass7.add(TarifInacbg);
        TarifInacbg.setBounds(80, 70, 110, 23);

        jLabel8.setText("ICD 10 :");
        jLabel8.setName("jLabel8"); // NOI18N
        jLabel8.setPreferredSize(new java.awt.Dimension(70, 14));
        panelGlass7.add(jLabel8);
        jLabel8.setBounds(240, 40, 70, 23);
        ...
        panelGlass7.add(Deskripsi);
        Deskripsi.setBounds(80, 100, 350, 23);

        Kelas.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kelas 1", "Kelas 2", "Kelas 3" }));
        Kelas.setName("Kelas"); // NOI18N
        panelGlass7.add(Kelas);
        Kelas.setBounds(320, 70, 100, 23);
    ...
    private void TKdKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TKdKeyPressed
        Valid.pindah(evt, TCari, KdInacbg);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("master_kmkb",
                    "'" + TKd.getText() + "','" + KdInacbg.getText() + "','" + TarifInacbg.
                    getText() + "','" + ICD10.getText() + "','" + Deskripsi.
                    getText() + "','" + Kelas.getSelectedItem().toString() + "'",
                    "Kode") == true) {
                tabMode.addRow(new String[]{TKd.getText(), KdInacbg.getText(),
                    TarifInacbg.getText(), ICD10.getText(), Deskripsi.getText(),
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, KdInacbg, BtnBatal);
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, TKd, "master_kmkb", "kd_kmkb") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                if (Sequel.mengedittf("master_kmkb", "kd_kmkb=?",
                        "kd_kmkb=?,inacbg=?,tarif_ina=?,icd10=?,deskripsi=?,kelas=?",
                        7, new String[]{
                            TKd.getText(), KdInacbg.getText(), TarifInacbg.
                            getText(), ICD10.getText(), Deskripsi.getText(),
                            Kelas.getSelectedItem().toString(), tbSpesialis.
                            getValueAt(tbSpesialis.getSelectedRow(), 0).
                            toString()
                        }) == true) {
                    tbSpesialis.setValueAt(TKd.getText(), tbSpesialis.
                            getSelectedRow(), 0);
                    tbSpesialis.setValueAt(KdInacbg.getText(), tbSpesialis.
                            getSelectedRow(), 1);
                    tbSpesialis.setValueAt(TarifInacbg.getText(), tbSpesialis.
                            getSelectedRow(), 2);
                    tbSpesialis.setValueAt(ICD10.getText(), tbSpesialis.
                            getSelectedRow(), 3);
                    tbSpesialis.setValueAt(Deskripsi.getText(), tbSpesialis.
                            getSelectedRow(), 4);
                    tbSpesialis.setValueAt(Kelas.getSelectedItem().toString(),
                            tbSpesialis.getSelectedRow(), 5);
                    emptTeks();
                }
            }
        }
    ...
    private void TarifInacbgKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TarifInacbgKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TarifInacbgKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterDiagnosaInacbg dialog = new MasterDiagnosaInacbg(new javax.swing.JFrame(), true);
    ...
    private widget.TextBox TarifInacbg;
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from master_kmkb where master_kmkb.icd10 like ? or master_kmkb.inacbg like ? order by master_kmkb.kd_kmkb");
            try {
    ...
    private void getData() {
        if (tbSpesialis.getSelectedRow() != -1) {
            ...
            KdInacbg.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(), 1).toString());
            TarifInacbg.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(), 2).toString());
            ICD10.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(), 3).toString());
            Deskripsi.setText(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(), 4).toString());
            Kelas.setSelectedItem(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(), 5).toString());
        }
    }
    ...
    public void isCek() {
        // BtnSimpan.setEnabled(akses.getmaster_kmkb());
        // BtnHapus.setEnabled(akses.getmaster_kmkb());
        // BtnEdit.setEnabled(akses.getmaster_kmkb());
    }

    private static final Logger LOG = Logger.getLogger(MasterDiagnosaInacbg.class.getName());
