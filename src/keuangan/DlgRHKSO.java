                        ...
                        try {
                            ...
                            while (rsrawatjalandr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatjalandr.getDouble("kso"))});
                            ...
                            while (rsrawatjalandrpr.next()) {
                                tabMode.addRow(
                                        new Object[]{"", "", "     " + rsrawatjalandrpr.getString("tgl_registrasi"),
                                            ...
                                            Valid.SetAngka(rsrawatjalandrpr.getDouble("kso"))});
                            ...
                            while (rsrawatjalanpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatjalanpr.getDouble("kso"))});
                        ...
                        try {
                            ...
                            while (rsrawatinapdr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatinapdr.getDouble("kso"))});
                            ...
                            while (rsrawatinapdrpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatinapdrpr.getDouble("kso"))});
                            ...
                            while (rsrawatinappr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatinappr.getDouble("kso"))});
                        ...
                        try {
                            ...
                            while (rsperiksa_lab.next()) {
                                ...
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsperiksa_lab.getDouble("kso") + detail_lab)});
                        ...
                        try {
                            ...
                            while (rsperiksa_radiologi.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsperiksa_radiologi.getDouble("kso"))});
