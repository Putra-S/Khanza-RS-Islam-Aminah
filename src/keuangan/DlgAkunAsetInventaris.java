...
public class DlgAkunAsetInventaris extends javax.swing.JDialog {
    ...
    public DlgAkunAsetInventaris(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"P", "ID Jenis", "Nama Jenis", "Kode Akun",
            "Nama Akun Rekening"};
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdjenis.getText().trim().isEmpty() || nmjenis.getText().trim().
            ...
            Sequel.menyimpan("akun_aset_inventaris", "?,?", "Nama Jenis", 2,
                    new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (int i = 0; i < tbJadwal.getRowCount(); i++) {
            if (tbJadwal.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("akun_aset_inventaris", "id_jenis", tbJadwal.
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdjenis.getText().trim().isEmpty() || nmjenis.getText().trim().
            ...
            if (tbJadwal.getSelectedRow() > -1) {
                Sequel.mengedit("akun_aset_inventaris", "id_jenis=?",
                        "id_jenis=?,kd_rek=?", 3, new String[]{
                            kdjenis.getText(), kdrek.getText(), tbJadwal.
    ...
    private void BtnKeluarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnKeluarKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, BtnSemua, TCari);
        }
...
private void BtnPoliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPoliActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgAkunAsetInventaris dialog = new DlgAkunAsetInventaris(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "inner join inventaris_jenis on akun_aset_inventaris.id_jenis=inventaris_jenis.id_jenis " + (TCari.
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgAkunAsetInventaris.class.getName());
