...
private void BtnPoliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPoliActionPerformed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "inner join inventaris_jenis on akun_aset_inventaris.id_jenis=inventaris_jenis.id_jenis "
    ...
    private static final Logger LOG = Logger.getLogger(DlgAkunAsetInventaris.class.getName());
