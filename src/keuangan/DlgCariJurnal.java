...
public class DlgCariJurnal extends javax.swing.JDialog {
    ...
    public DlgCariJurnal(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Jurnal", "No.Bukti", "Tgl.Jurnal", "Jenis", "Keterangan", "Debet", "Kredit"}) {
            @Override
...
//GEN-FIRST:event_TKdKeyPressed
    private void TglJurnal2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-LAST:event_TKdKeyPressed
        Valid.pindah(evt, TglJurnal1, Jenis);//GEN-FIRST:event_TglJurnal2KeyPressed
    ...
    private void tampil() {
        tanggal = " jurnal.tgl_jurnal between '" + Valid.SetTgl(TglJurnal1.getSelectedItem() + "") + "' and '"
                + Valid.SetTgl(TglJurnal2.getSelectedItem() + "") + "' " + " and jenis='"
                + Jenis.getSelectedItem().toString().substring(0, 1) + "' ";
        nojur = "";
        rek = "";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                tabMode.addRow(new Object[]{rs.getString(1), rs.getString(2), rs.getString(3) + " " + rs.getString(8),
                    jns, rs.getString(5), "", ""});
                ...
                rs2 = koneksi
                        .prepareStatement(
                                ...
                                + " on detailjurnal.kd_rek=rekening.kd_rek where " + " detailjurnal.no_jurnal='"
                                + rs.getString(1) + "' " + rek + " and detailjurnal.kd_rek like '%"
                                + TCari.getText() + "%' or " + " detailjurnal.no_jurnal='" + rs.getString(1) + "' "
                                + rek + " and rekening.nm_rek like '%" + TCari.getText()
                                + "%'  order by detailjurnal.debet desc  ")
                        .executeQuery();
                subttldebet = 0;
                subttlkredit = 0;
                int no = 1;
                while (rs2.next()) {
                    ...
                    tabMode
                            .addRow(new Object[]{"", "", "", "", no + ". " + rs2.getString(1) + ", " + rs2.getString(2),
                        Valid.SetAngka(rs2.getDouble(3)), Valid.SetAngka(rs2.getDouble(4))});
                    no++;
                }
                rs2.close();
                tabMode.addRow(new Object[]{"", "", "", "", "Total :", Valid.SetAngka(subttldebet),
                    Valid.SetAngka(subttlkredit)});
            }
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariJurnal.class.getName());
