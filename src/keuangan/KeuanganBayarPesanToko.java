...
public class KeuanganBayarPesanToko extends javax.swing.JDialog {
    ...
    public void setData(String nofaktur) {
        ...
        sisahutang = Math.round(Sequel
                .cariIsiAngka("SELECT tokopemesanan.tagihan FROM tokopemesanan where tokopemesanan.no_faktur=?", nofaktur)
                - Sequel.cariIsiAngka(
    ...
    private static final Logger LOG = Logger.getLogger(KeuanganBayarPesanToko.class.getName());
