 ...
 * @author dosen
 */
public class KeuanganBayarPesanToko extends javax.swing.JDialog {
    ...
    private String koderekening = "", akunhutang = Sequel.cariIsi(
            "select Bayar_Pemesanan_Toko from set_akun");
            ...
            try {
                if (sisahutang > 0) {
                    ...
                    Sequel.menyimpan("tampjurnal", "?,?,?,?", "Rekening", 4,
                            new String[]{
                                akunhutang, "HUTANG USAHA", besar_bayar.
                                        getText(), "0"
                            });
                    Sequel.menyimpan("tampjurnal", "?,?,?,?", "Rekening", 4,
                            new String[]{
                    ...
                    sukses = jur.simpanJurnal(no_bukti.getText(), "U",
                            "BAYAR PELUNASAN BARANG NON MEDIS NO.FAKTUR " + no_faktur.
                    ...
                    if (sukses == true) {
                        if ((sisahutang <= Double.parseDouble(besar_bayar.
                            ...
                            Sequel.mengedit("tokopemesanan", "no_faktur=?",
                        ...
                        if (Sequel.menyimpantf2("toko_bayar_pemesanan",
                                "?,?,?,?,?,?,?", "data", 7, new String[]{
                                    Valid.SetTgl(
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        try {
            ...
            sukses = true;
            if (Sequel.queryu2tf(
                    "delete from toko_bayar_pemesanan where tgl_bayar=? and no_faktur=? and "
                ...
                Sequel.menyimpan("tampjurnal", "?,?,?,?", "Rekening", 4,
                        new String[]{
                            akunhutang, "HUTANG USAHA", "0", besar_bayar.
                                    getText()
                        });
                sukses = jur.simpanJurnal(no_bukti.getText(), "U",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptBayarPemesananToko.jasper", "report",
                    "::[ Bayar Pemesanan ]::",
                    ...
                    + "toko_bayar_pemesanan.tgl_bayar between '" + Valid.SetTgl(
                            TglCari1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglCari2.getSelectedItem() + "") + "' and tokosuplier.nama_suplier like '%" + nmsup.
                    getText().trim() + "%' and toko_bayar_pemesanan.no_faktur like '%" + TCari.
                            getText().trim() + "%' or "
                    + "toko_bayar_pemesanan.tgl_bayar between '" + Valid.SetTgl(
                            TglCari1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglCari2.getSelectedItem() + "") + "' and tokosuplier.nama_suplier like '%" + nmsup.
                    getText().trim() + "%' and tokosuplier.nama_suplier like '%" + TCari.
                            getText().trim() + "%' or "
                    + "toko_bayar_pemesanan.tgl_bayar between '" + Valid.SetTgl(
                            TglCari1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglCari2.getSelectedItem() + "") + "' and tokosuplier.nama_suplier like '%" + nmsup.
                    getText().trim() + "%' and toko_bayar_pemesanan.nama_bayar like '%" + TCari.
                            getText().trim() + "%' or "
                    + "toko_bayar_pemesanan.tgl_bayar between '" + Valid.SetTgl(
                            TglCari1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglCari2.getSelectedItem() + "") + "' and tokosuplier.nama_suplier like '%" + nmsup.
                    getText().trim() + "%' and toko_bayar_pemesanan.no_bukti like '%" + TCari.
                            getText().trim() + "%' or "
                    + "toko_bayar_pemesanan.tgl_bayar between '" + Valid.SetTgl(
                            TglCari1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglCari2.getSelectedItem() + "") + "' and tokosuplier.nama_suplier like '%" + nmsup.
                    getText().trim() + "%' and toko_bayar_pemesanan.keterangan like '%" + TCari.
                            getText().trim() + "%' or "
                    + "toko_bayar_pemesanan.tgl_bayar between '" + Valid.SetTgl(
                            TglCari1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglCari2.getSelectedItem() + "") + "' and tokosuplier.nama_suplier like '%" + nmsup.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganBayarPesanToko dialog = new KeuanganBayarPesanToko(
    ...
    public void setData(String nofaktur) {
        ...
        sisahutang = Math.round(Sequel.cariIsiAngka(
                "SELECT tokopemesanan.tagihan FROM tokopemesanan where tokopemesanan.no_faktur=?",
                nofaktur)
                - Sequel.cariIsiAngka(
                        "SELECT ifnull(SUM(toko_bayar_pemesanan.besar_bayar),0) FROM toko_bayar_pemesanan where toko_bayar_pemesanan.no_faktur=?",
                        nofaktur));
    ...
    private static final Logger LOG = Logger.getLogger(
            KeuanganBayarPesanToko.class.getName());
}
