...
public class DlgTemplateLaboratorium extends javax.swing.JDialog {
    ...
    public DlgTemplateLaboratorium(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Pemeriksaan", "Satuan", "N.Rujukan L.D.", "N.Rujukan L.A.", "N.Rujukan P.D.",
            "N.Rujukan P.A.", "J.S. Rmh Skt", "Paket BHP", "J.M. Perujuk", "J.M. Dokter", "J.M. Laborat", "K.S.O.",
            "Menejemen", "Biaya Item", "", ""};
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
    ...
    public void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5),
    ...
    private void getData() {
        ...
        if (row != -1) {
            if ((!tbKamar.getValueAt(row, 6).toString().isEmpty()) && (!tbKamar.getValueAt(row, 7).toString().isEmpty())
    ...
    private static final Logger LOG = Logger.getLogger(DlgTemplateLaboratorium.class.getName());
