 ...
 * @author dosen
 */
public class DlgTemplateLaboratorium extends javax.swing.JDialog {
    ...
    public DlgTemplateLaboratorium(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Pemeriksaan", "Satuan", "N.Rujukan L.D.",
            "N.Rujukan L.A.", "N.Rujukan P.D.",
            "N.Rujukan P.A.", "J.S. Rmh Skt", "Paket BHP", "J.M. Perujuk",
            "J.M. Dokter",
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        if (KdPeriksa.getText().isEmpty() || NmPeriksa.getText().isEmpty()) {
            ...
            if (tbKamar.getSelectedRow() > -1) {
                ...
                tabMode.addRow(new Object[]{"", "", "", "", "", "", 0, 0, 0, 0,
                    0, 0, 0, 0, "", ""});
        ...
        if (reply == JOptionPane.YES_OPTION) {
            ...
            if (row > -1) {
                for (int i = 0; i < row; i++) {
                    ...
                    if (tbKamar.getValueAt(i, 14).toString().isEmpty()) {
                        Sequel.menyimpan("template_laboratorium",
                                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                "Id Hasil Periksa", 17, new String[]{
                                    KdPeriksa.getText(), "0", tbKamar.
                                    getValueAt(i, 0).toString(), tbKamar.
                                    ...
                                    tbKamar.getValueAt(i, 13).toString(),
                                    tbKamar.getValueAt(i, 15).toString()
                                });
                    } else if (!tbKamar.getValueAt(i, 14).toString().isEmpty()) {
                        Sequel.
                                mengedit("template_laboratorium",
                                        "id_template=?",
                                        "Pemeriksaan=?,satuan=?,nilai_rujukan_ld=?,nilai_rujukan_la=?,"
                                        + "nilai_rujukan_pd=?,nilai_rujukan_pa=?,bagian_rs=?,bhp=?,bagian_perujuk=?,bagian_dokter=?,bagian_laborat=?,kso=?,menejemen=?,biaya_item=?,urut=?",
                                        16, new String[]{
                                    ...
                                    tbKamar.getValueAt(i, 13).toString(),
                                    tbKamar.getValueAt(i, 15).toString(),
                                    tbKamar.getValueAt(i, 14).toString()
                                });
                    }
                }
                tampil();
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
    try {
        Sequel.meghapus("template_laboratorium", "id_template", tbKamar.
                getValueAt(tbKamar.getSelectedRow(), 14).toString());
    ...
    private void tbKamarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbKamarKeyPressed
        if (tbKamar.getRowCount() != 0) {
            if ((evt.getKeyCode() == KeyEvent.VK_RIGHT) || (evt.getKeyCode() == KeyEvent.VK_ENTER) || (evt.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTemplateLaboratorium dialog = new DlgTemplateLaboratorium(
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select id_template, Pemeriksaan, satuan, nilai_rujukan_ld, nilai_rujukan_la, nilai_rujukan_pd,"
    ...
    private void getData() {
        ...
        if (row != -1) {
            if ((!tbKamar.getValueAt(row, 6).toString().isEmpty())
                    && (!tbKamar.getValueAt(row, 7).toString().isEmpty())
                    && (!tbKamar.getValueAt(row, 8).toString().isEmpty())
                    && (!tbKamar.getValueAt(row, 9).toString().isEmpty())
                    && (!tbKamar.getValueAt(row, 10).toString().isEmpty())
                    && (!tbKamar.getValueAt(row, 11).toString().isEmpty())
                    && (!tbKamar.getValueAt(row, 12).toString().isEmpty())) {
                tbKamar.setValueAt(Valid.SetAngka(tbKamar.getValueAt(row, 6).
                        toString())
                        ...
                        + Valid.SetAngka(tbKamar.getValueAt(row, 12).toString()),
                        row, 13);
            }
        }
    }
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgTemplateLaboratorium.class.getName());
}
