 ...
 * @author perpustakaan
 */
public class KeuanganRingkasanHutangVendorFarmasi extends javax.swing.JDialog {
    ...
    public KeuanganRingkasanHutangVendorFarmasi(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr = {"Kode Suplier", "Nama Supplier", "Sisa Hutang"};
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            i++;
            Sequel.menyimpan("temporary",
                    "'" + i + "','TOTAL HUTANG :','','" + LCount.getText() + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
                    getalamatip() + "'", "Hutang");
            ...
            Valid.
                    MyReportqry("rptRingkasanHutangVendorFarmasi.jasper",
                            "report", "::[ Ringkasan Hutang Vendor Farmasi ]::",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganRingkasanHutangVendorFarmasi dialog = new KeuanganRingkasanHutangVendorFarmasi(
    ...
    private void tampil() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement("select pemesanan.kode_suplier,datasuplier.nama_suplier,(pemesanan.tagihan-"
                    ...
                    + "where " + tanggaldatang + tanggaltempo
                    + "(pemesanan.status='Belum Dibayar' or pemesanan.status='Belum Lunas') "
                    + (TCari.getText().trim().isEmpty() ? ""
                    : "and (datasuplier.nama_suplier like ? or pemesanan.kode_suplier like ?) ")
            ...
            try {
                ...
                sisahutang = 0;
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kode_suplier"), rs.getString("nama_suplier"),
                        rs.getDouble("sisahutang")});
    ...
    private static final Logger LOG = Logger.getLogger(KeuanganRingkasanHutangVendorFarmasi.class.getName());
