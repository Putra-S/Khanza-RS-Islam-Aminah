...
public class KeuanganRingkasanHutangVendorFarmasi extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public KeuanganRingkasanHutangVendorFarmasi(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + (TCari.getText().trim().isEmpty() ? "" : "and (datasuplier.nama_suplier like ? or pemesanan.kode_suplier like ?) ")
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        ...
                        "nama_suplier"), rs.getDouble("sisahutang")
                    });
    ...
    private static final Logger LOG = Logger.getLogger(
            KeuanganRingkasanHutangVendorFarmasi.class.getName());
