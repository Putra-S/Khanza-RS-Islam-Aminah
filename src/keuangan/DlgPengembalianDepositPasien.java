...
public class DlgPengembalianDepositPasien extends javax.swing.JDialog {
    ...
    public DlgPengembalianDepositPasien(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr = {"No.", "Tanggal", "No.Rawat", "No.RM",
            "Nama Pasien", "Pengembalian", "Petugas"};
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPengembalianDepositPasien dialog = new DlgPengembalianDepositPasien(
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "where pengembalian_deposit.tanggal between ? and ? " + (TCari.
                            getText().isEmpty() ? "" : " and (pengembalian_deposit.no_rawat like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ?) ")
                ...
                while (rs.next()) {
                    ...
                    if (petugas.toLowerCase().trim().contains(User.getText().
                        ...
                        tabMode.addRow(new Object[]{
                            i, rs.getString("tanggal"), rs.getString("no_rawat"),
                            rs.getString("no_rkm_medis"), rs.getString(
                            "nm_pasien"), rs.getDouble("besar_pengembalian"),
                            petugas
                        });
                        i++;
                    }
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgPengembalianDepositPasien.class.getName());
