 ...
 * @author perpustakaan
 */
public class DlgPengembalianDepositPasien extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPengembalianDepositPasien.jasper", "report",
                    "::[ Pengembalian Deposit Pasien ]::", param);
        }
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "where pengembalian_deposit.tanggal between ? and ? "
                    + (TCari.getText().isEmpty() ? ""
                    : " and (pengembalian_deposit.no_rawat like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ?) ")
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (petugas.toLowerCase().trim().contains(User.getText().toLowerCase().trim())) {
                        ...
                        tabMode.addRow(new Object[]{i, rs.getString("tanggal"), rs.getString("no_rawat"),
                            rs.getString("no_rkm_medis"), rs.getString("nm_pasien"),
                            rs.getDouble("besar_pengembalian"), petugas});
                        i++;
                    }
                }
                if (all > 0) {
                    tabMode.addRow(new Object[]{"", "Total :", "", "", "", all, ""});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgPengembalianDepositPasien.class.getName());
