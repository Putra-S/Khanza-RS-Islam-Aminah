...
public class DlgRHJmDokter extends javax.swing.JDialog {
    ...
    public DlgRHJmDokter(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.", "Nama Dokter", "Tgl.Tindakan", "No.Rawat", "No.RM", "Nama Pasien", "Tindakan Medis",
            "Jasa Medis"};
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        ...
        if (TabRawat.getSelectedIndex() == 0) {
            if (tabMode.getRowCount() == 0) {
                ...
                for (int r = 0; r < row; r++) {
                    Sequel.menyimpan("temporary", "'" + r + "','"
                            ...
                            + tabMode.getValueAt(r, 7).toString().
                                    replaceAll("'", "`") + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
                            getalamatip() + "'", "Rekap Harian Tindakan Dokter");
                }
                ...
                Valid.MyReportqry("rptRHTindakanDokter.jasper", "report",
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                        ...
                        bw.write("<html>"
                                ...
                                getemailrs() + "<br><br>"
                                + "<font size='2' face='Tahoma'>REKAP PEMBAYARAN RAWAT JALAN PERIODE " + Tgl1.
                    ...
                    case "Laporan 2 (WPS)":
                        ...
                        bw.write("<html>"
                                ...
                                + akses.getkontakrs() + ", E-mail : " + akses.
                                getemailrs() + "<br><br>"
                                + "<font size='2' face='Tahoma'>DETAIL JM DOKTER PERIODE " + Tgl1.
                                        getSelectedItem() + " s.d. " + Tgl2.
                                        getSelectedItem() + "<br><br></font>"
                                + "</td>"
                                + "</tr>"
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void prosesCariSemua() {
        try {
            ps = koneksi.prepareStatement(
                    "select kd_dokter,nm_dokter from dokter where status='1' and concat(kd_dokter,nm_dokter) like ? order by nm_dokter");
            try {
                ...
                while (rs.next()) {
                    ...
                    if (chkRalan.isSelected() == true) {
                        // rawat jalan
                        psrawatjalandr = koneksi
                                .prepareStatement("select pasien.nm_pasien,rawat_jl_dr.tarif_tindakandr,"
                        ...
                        psrawatjalandrpr = koneksi
                                .prepareStatement("select pasien.nm_pasien,rawat_jl_drpr.tarif_tindakandr,"
                        ...
                        try {
                            psrawatjalandr.setString(1,
                                    Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                                    + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem());
                            psrawatjalandr.setString(2,
                                    Valid.SetTgl(Tgl2.getSelectedItem() + "") + " " + CmbJam2.getSelectedItem() + ":"
                                    + CmbMenit2.getSelectedItem() + ":" + CmbDetik2.getSelectedItem());
                            ...
                            while (rsrawatjalandr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    rsrawatjalandr.getString("no_rawat"), rsrawatjalandr.getString("no_rkm_medis"),
                                    ...
                                    Valid.SetAngka(rsrawatjalandr.getDouble("tarif_tindakandr"))});
                            ...
                            while (rsrawatjalandrpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    + rsrawatjalandrpr.getString("kd_pj") + ")",
                                    rsrawatjalandrpr.getString("nm_perawatan") + " ("
                                    + rsrawatjalandrpr.getString("kd_jenis_prw") + ")",
                                    Valid.SetAngka(rsrawatjalandrpr.getDouble("tarif_tindakandr"))});
                        ...
                        try {
                            ...
                            while (rsrawatinapdr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    rsrawatinapdr.getString("no_rawat"), rsrawatinapdr.getString("no_rkm_medis"),
                                    ...
                                    Valid.SetAngka(rsrawatinapdr.getDouble("tarif_tindakandr"))});
                            ...
                            while (rsrawatinapdrpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    + rsrawatinapdrpr.getString("kd_pj") + ")",
                                    rsrawatinapdrpr.getString("nm_perawatan") + " ("
                                    + rsrawatinapdrpr.getString("kd_jenis_prw") + ")",
                                    Valid.SetAngka(rsrawatinapdrpr.getDouble("tarif_tindakandr"))});
                    ...
                    if (chkOperasi.isSelected() == true) {
                        ...
                        try {
                            ...
                            psbiayadokter_anak.setString(1,
                                    Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                                    + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem());
                            ...
                            psbiaya_dokter_umum.setString(1,
                                    Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                                    + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem());
                            ...
                            psbiaya_dokter_pjanak.setString(1,
                                    Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                                    + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem());
                            psbiaya_dokter_pjanak.setString(2,
                                    Valid.SetTgl(Tgl2.getSelectedItem() + "") + " " + CmbJam2.getSelectedItem() + ":"
                                    + CmbMenit2.getSelectedItem() + ":" + CmbDetik2.getSelectedItem());
                            ...
                            psbiayadokter_anestesi.setString(1,
                                    Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                                    + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem());
                            psbiayadokter_anestesi.setString(2,
                                    Valid.SetTgl(Tgl2.getSelectedItem() + "") + " " + CmbJam2.getSelectedItem() + ":"
                                    + CmbMenit2.getSelectedItem() + ":" + CmbDetik2.getSelectedItem());
                            psbiayadokter_anestesi.setString(3, rs.getString("kd_dokter"));
                            psbiayadokter_anestesi.setString(4,
                                    "%" + KdCaraBayar.getText() + NmCaraBayar.getText() + "%");
                            rsbiayadokter_anestesi = psbiayadokter_anestesi.executeQuery();
                            rsbiayadokter_anestesi.last();

                            if ((rsbiayaoperator1.getRow() > 0) || (rsbiayaoperator2.getRow() > 0)
                                    || (rsbiayaoperator3.getRow() > 0) || (rsbiayadokter_anak.getRow() > 0)
                                    || (rsbiaya_dokter_pjanak.getRow() > 0) || (rsbiaya_dokter_umum.getRow() > 0)
                                    || (rsbiayadokter_anestesi.getRow() > 0)) {
                                z++;
                            ...
                            while (rsbiayaoperator1.next()) {
                                tabMode
                                        .addRow(new Object[]{"", "", "     " + rsbiayaoperator1.getString("tgl_operasi"),
                                    rsbiayaoperator1.getString("no_rawat"),
                                    rsbiayaoperator1.getString("no_rkm_medis"),
                                    rsbiayaoperator1.getString("nm_pasien") + " ("
                                    + rsbiayaoperator1.getString("kd_pj") + ")",
                                    rsbiayaoperator1.getString("nm_perawatan") + " ("
                                    + rsbiayaoperator1.getString("kode_paket") + ")(Operator 1)",
                                    Valid.SetAngka(rsbiayaoperator1.getDouble("biayaoperator1"))});
                            ...
                            while (rsbiayaoperator2.next()) {
                                tabMode
                                        .addRow(new Object[]{"", "", "     " + rsbiayaoperator2.getString("tgl_operasi"),
                                    rsbiayaoperator2.getString("no_rawat"),
                                    rsbiayaoperator2.getString("no_rkm_medis"),
                                    rsbiayaoperator2.getString("nm_pasien") + " ("
                                    + rsbiayaoperator2.getString("kd_pj") + ")",
                                    rsbiayaoperator2.getString("nm_perawatan") + " ("
                                    + rsbiayaoperator2.getString("kode_paket") + ")(Operator 2)",
                                    Valid.SetAngka(rsbiayaoperator2.getDouble("biayaoperator2"))});
                            ...
                            while (rsbiayaoperator3.next()) {
                                tabMode
                                        .addRow(new Object[]{"", "", "     " + rsbiayaoperator3.getString("tgl_operasi"),
                                    rsbiayaoperator3.getString("no_rawat"),
                                    rsbiayaoperator3.getString("no_rkm_medis"),
                                    rsbiayaoperator3.getString("nm_pasien") + " ("
                                    + rsbiayaoperator3.getString("kd_pj") + ")",
                                    rsbiayaoperator3.getString("nm_perawatan") + "  ("
                                    + rsbiayaoperator3.getString("kode_paket") + ")(Operator 3)",
                                    Valid.SetAngka(rsbiayaoperator3.getDouble("biayaoperator3"))});
                            ...
                            while (rsbiayadokter_anak.next()) {
                                tabMode.addRow(
                                        new Object[]{"", "", "     " + rsbiayadokter_anak.getString("tgl_operasi"),
                                            rsbiayadokter_anak.getString("no_rawat"),
                                            rsbiayadokter_anak.getString("no_rkm_medis"),
                                            rsbiayadokter_anak.getString("nm_pasien") + " ("
                                            + rsbiayadokter_anak.getString("kd_pj") + ")",
                                            rsbiayadokter_anak.getString("nm_perawatan") + " ("
                                            + rsbiayadokter_anak.getString("kode_paket") + ")(dr Anak)",
                                            Valid.SetAngka(rsbiayadokter_anak.getDouble("biayadokter_anak"))});
                            ...
                            while (rsbiayadokter_anestesi.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    + rsbiayadokter_anestesi.getString("kode_paket") + ")(dr Anestesi)",
                                    Valid.SetAngka(rsbiayadokter_anestesi.getDouble("biayadokter_anestesi"))});
                            ...
                            while (rsbiaya_dokter_pjanak.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    + rsbiaya_dokter_pjanak.getString("kode_paket") + ")(dr Pj Anak)",
                                    Valid.SetAngka(rsbiaya_dokter_pjanak.getDouble("biaya_dokter_pjanak"))});
                            ...
                            while (rsbiaya_dokter_umum.next()) {
                                tabMode.addRow(
                                        new Object[]{"", "", "     " + rsbiaya_dokter_umum.getString("tgl_operasi"),
                                            ...
                                            + rsbiaya_dokter_umum.getString("kode_paket") + ")(dr Umum)",
                                            Valid.SetAngka(rsbiaya_dokter_umum.getDouble("biaya_dokter_umum"))});
                    ...
                    if (chkLaborat.isSelected() == true) {
                        ...
                        try {
                            ...
                            while (rsperiksa_lab.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    rsperiksa_lab.getString("no_rawat"), rsperiksa_lab.getString("no_rkm_medis"),
                                    ...
                                    Valid.SetAngka(rsperiksa_lab.getDouble("tarif_tindakan_dokter"))});
                        ...
                        // detail periksa lab
                        psdetaillab = koneksi
                                .prepareStatement("select detail_periksa_lab.bagian_dokter,pasien.nm_pasien,"
                        ...
                        try {
                            ...
                            if (rsdetaillab.getRow() > 0) {
                                z++;
                                tabMode.addRow(
                                        new Object[]{"", "", z + ". Detail Pemeriksaan Lab ", "", "", "", "", ""});
                            }
                            ...
                            while (rsdetaillab.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    rsdetaillab.getString("no_rawat"), rsdetaillab.getString("no_rkm_medis"),
                                    ...
                                    Valid.SetAngka(rsdetaillab.getDouble("bagian_dokter"))});
                        ...
                        try {
                            ...
                            while (rsperiksa_lab.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    rsperiksa_lab.getString("nm_perawatan") + " ("
                                    + rsperiksa_lab.getString("kd_jenis_prw") + ")",
                                    Valid.SetAngka(rsperiksa_lab.getDouble("tarif_perujuk"))});
                        ...
                        psdetaillab2 = koneksi
                                .prepareStatement("select detail_periksa_lab.bagian_perujuk,pasien.nm_pasien,"
                                        + "template_laboratorium.Pemeriksaan,reg_periksa.kd_pj,reg_periksa.no_rawat,reg_periksa.no_rkm_medis, "
                                        + "periksa_lab.tgl_periksa,periksa_lab.jam,periksa_lab.kd_jenis_prw "
                                        + "from detail_periksa_lab inner join periksa_lab "
                                        + "inner join reg_periksa inner join pasien inner join template_laboratorium "
                        ...
                        try {
                            ...
                            if (rsdetaillab.getRow() > 0) {
                                z++;
                                tabMode
                                        .addRow(new Object[]{"", "", z + ". Detail Perujuk Lab ", "", "", "", "", ""});
                            }
                            rsdetaillab.beforeFirst();
                            while (rsdetaillab.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    rsdetaillab.getString("Pemeriksaan") + " ("
                                    + rsdetaillab.getString("kd_jenis_prw") + ")",
                                    Valid.SetAngka(rsdetaillab.getDouble("bagian_perujuk"))});
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        ...
                        try {
                            psperiksa_radiologi.setString(1,
                                    Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                                    + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem());
                            ...
                            if (rsperiksa_radiologi.getRow() > 0) {
                                z++;
                                tabMode.addRow(
                                        new Object[]{"", "", z + ". Pemeriksaan radiologi ", "", "", "", "", ""});
                            }
                            ...
                            while (rsperiksa_radiologi.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsperiksa_radiologi.getDouble("tarif_tindakan_dokter"))});
                        ...
                        psperiksa_radiologi2 = koneksi.prepareStatement(
                                "select periksa_radiologi.tarif_perujuk,pasien.nm_pasien,reg_periksa.no_rawat,reg_periksa.no_rkm_medis,"
                                + "jns_perawatan_radiologi.nm_perawatan,periksa_radiologi.tgl_periksa,periksa_radiologi.jam,periksa_radiologi.no_rawat,periksa_radiologi.kd_jenis_prw,reg_periksa.kd_pj "
                                + " from periksa_radiologi inner join reg_periksa on periksa_radiologi.no_rawat=reg_periksa.no_rawat "
                                + " inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                                + " inner join dokter on periksa_radiologi.kd_dokter=dokter.kd_dokter "
                        ...
                        try {
                            psperiksa_radiologi2.setString(1,
                                    Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                                    + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem());
                            psperiksa_radiologi2.setString(2,
                                    Valid.SetTgl(Tgl2.getSelectedItem() + "") + " " + CmbJam2.getSelectedItem() + ":"
                                    + CmbMenit2.getSelectedItem() + ":" + CmbDetik2.getSelectedItem());
                            psperiksa_radiologi2.setString(3, rs.getString("kd_dokter"));
                            psperiksa_radiologi2.setString(4,
                                    "%" + KdCaraBayar.getText() + NmCaraBayar.getText() + "%");
                            ...
                            while (rsperiksa_radiologi.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    rsperiksa_radiologi.getString("nm_perawatan") + " ("
                                    + rsperiksa_radiologi.getString("kd_jenis_prw") + ")",
                                    Valid.SetAngka(rsperiksa_radiologi.getDouble("tarif_perujuk"))});
            ...
            if (totaljm > 0) {
                tabMode
                        .addRow(new Object[]{">> ", "Total Jasa Medis :", "", "", "", "", "", Valid.SetAngka(totaljm)});
            }
        } catch (Exception e) {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    z = 0;
                    htmlContent.append(
                            "<tr class='isi'><td valign='top' align='center'><table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0' class='tbl_form'><tr class='isi'><td valign='middle' align='left' colspan='7'>")
                            .append(i)
                            .append(". ")
                            .append(rs.getString("nm_dokter"))
                            .append("</td></tr><tr class='isi'><td valign='middle' bgcolor='#FFFAFA' align='center' width='10%'>Tanggal</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='9%'>No.Rawat</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='6%'>No.RM</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='22%'>Nama Pasien</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='33%'>Tindakan Medis</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='10%'>Status</td><td valign='middle' bgcolor='#FFFAFA' align='center' width='10%'>Jasa Medis</td></tr>");
                    if (chkRalan.isSelected() == true) {
                        // rawat jalan
                        psrawatjalandr = koneksi
                                .prepareStatement("select pasien.nm_pasien,rawat_jl_dr.tarif_tindakandr,"
                        ...
                        try {
                            ...
                            while (rsrawatjalandr.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        .append(rsrawatjalandr.getString("tgl_perawatan"))
                                        .append(" ")
                                        .append(rsrawatjalandr.getString("jam_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsrawatjalandr.getString("no_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsrawatjalandr.getString("no_rkm_medis"))
                                        .append("</td><td valign='middle' align='left'>")
                                        .append(rsrawatjalandr.getString("nm_pasien"))
                                        .append(" (")
                                        .append(rsrawatjalandr.getString("kd_pj"))
                                        .append(")</td><td valign='middle' align='left'>")
                                        .append(rsrawatjalandr.getString("nm_perawatan"))
                                        .append(" (")
                                        .append(rsrawatjalandr.getString("kd_jenis_prw"))
                                        .append(")</td><td valign='middle' align='center'>Rawat Jalan</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsrawatjalandr.getDouble("tarif_tindakandr")))
                                        .append("</td></tr>");
                                total += rsrawatjalandr.getDouble("tarif_tindakandr");
                            }
                            ...
                            while (rsrawatjalandrpr.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        .append(rsrawatjalandrpr.getString("tgl_perawatan"))
                                        .append(" ")
                                        .append(rsrawatjalandrpr.getString("jam_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsrawatjalandrpr.getString("no_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsrawatjalandrpr.getString("no_rkm_medis"))
                                        .append("</td><td valign='middle' align='left'>")
                                        .append(rsrawatjalandrpr.getString("nm_pasien"))
                                        .append(" (")
                                        .append(rsrawatjalandrpr.getString("kd_pj"))
                                        .append(")</td><td valign='middle' align='left'>")
                                        .append(rsrawatjalandrpr.getString("nm_perawatan"))
                                        .append(" (")
                                        .append(rsrawatjalandrpr.getString("kd_jenis_prw"))
                                        .append(")</td><td valign='middle' align='center'>Rawat Jalan</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsrawatjalandrpr.getDouble("tarif_tindakandr")))
                                        .append("</td></tr>");
                                total += rsrawatjalandrpr.getDouble("tarif_tindakandr");
                            }
                        } catch (Exception e) {
                    ...
                    if (chkRanap.isSelected() == true) {
                        ...
                        try {
                            ...
                            while (rsrawatinapdr.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        .append(rsrawatinapdr.getString("tgl_perawatan"))
                                        .append(" ")
                                        .append(rsrawatinapdr.getString("jam_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsrawatinapdr.getString("no_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsrawatinapdr.getString("no_rkm_medis"))
                                        .append("</td><td valign='middle' align='left'>")
                                        .append(rsrawatinapdr.getString("nm_pasien"))
                                        .append(" (")
                                        .append(rsrawatinapdr.getString("kd_pj"))
                                        .append(")</td><td valign='middle' align='left'>")
                                        .append(rsrawatinapdr.getString("nm_perawatan"))
                                        .append(" (")
                                        .append(rsrawatinapdr.getString("kd_jenis_prw"))
                                        .append(")</td><td valign='middle' align='center'>Rawat Inap</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsrawatinapdr.getDouble("tarif_tindakandr")))
                                        .append("</td></tr>");
                                total += rsrawatinapdr.getDouble("tarif_tindakandr");
                            }
                            ...
                            while (rsrawatinapdrpr.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        .append(rsrawatinapdrpr.getString("tgl_perawatan"))
                                        .append(" ")
                                        .append(rsrawatinapdrpr.getString("jam_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsrawatinapdrpr.getString("no_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsrawatinapdrpr.getString("no_rkm_medis"))
                                        .append("</td><td valign='middle' align='left'>")
                                        .append(rsrawatinapdrpr.getString("nm_pasien"))
                                        .append(" (")
                                        .append(rsrawatinapdrpr.getString("kd_pj"))
                                        .append(")</td><td valign='middle' align='left'>")
                                        .append(rsrawatinapdrpr.getString("nm_perawatan"))
                                        .append(" (")
                                        .append(rsrawatinapdrpr.getString("kd_jenis_prw"))
                                        .append(")</td><td valign='middle' align='center'>Rawat Inap</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsrawatinapdrpr.getDouble("tarif_tindakandr")))
                                        .append("</td></tr>");
                                total += rsrawatinapdrpr.getDouble("tarif_tindakandr");
                            }
                        } catch (Exception e) {
                    ...
                    if (chkOperasi.isSelected() == true) {
                        ...
                        try {
                            ...
                            while (rsbiayaoperator1.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        .append(rsbiayaoperator1.getString("tgl_operasi"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsbiayaoperator1.getString("no_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsbiayaoperator1.getString("no_rkm_medis"))
                                        .append("</td><td valign='middle' align='left'>")
                                        .append(rsbiayaoperator1.getString("nm_pasien"))
                                        .append(" (")
                                        .append(rsbiayaoperator1.getString("kd_pj"))
                                        .append(")</td><td valign='middle' align='left'>")
                                        .append(rsbiayaoperator1.getString("nm_perawatan"))
                                        .append(" (")
                                        .append(rsbiayaoperator1.getString("kode_paket"))
                                        .append(")(Operator 1)</td><td valign='middle' align='center'>Operasi/VK</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsbiayaoperator1.getDouble("biayaoperator1")))
                                        .append("</td></tr>");
                                total += rsbiayaoperator1.getDouble("biayaoperator1");
                            }
                            ...
                            while (rsbiayaoperator2.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        .append(rsbiayaoperator2.getString("tgl_operasi"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsbiayaoperator2.getString("no_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsbiayaoperator2.getString("no_rkm_medis"))
                                        .append("</td><td valign='middle' align='left'>")
                                        .append(rsbiayaoperator2.getString("nm_pasien"))
                                        .append(" (")
                                        .append(rsbiayaoperator2.getString("kd_pj"))
                                        .append(")</td><td valign='middle' align='left'>")
                                        .append(rsbiayaoperator2.getString("nm_perawatan"))
                                        .append(" (")
                                        .append(rsbiayaoperator2.getString("kode_paket"))
                                        .append(")(Operator 2)</td><td valign='middle' align='center'>Operasi/VK</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsbiayaoperator2.getDouble("biayaoperator2")))
                                        .append("</td></tr>");
                                total += rsbiayaoperator2.getDouble("biayaoperator2");
                            }
                            ...
                            while (rsbiayaoperator3.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        .append(rsbiayaoperator3.getString("tgl_operasi"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsbiayaoperator3.getString("no_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsbiayaoperator3.getString("no_rkm_medis"))
                                        .append("</td><td valign='middle' align='left'>")
                                        .append(rsbiayaoperator3.getString("nm_pasien"))
                                        .append(" (")
                                        .append(rsbiayaoperator3.getString("kd_pj"))
                                        .append(")</td><td valign='middle' align='left'>")
                                        .append(rsbiayaoperator3.getString("nm_perawatan"))
                                        .append(" (")
                                        .append(rsbiayaoperator3.getString("kode_paket"))
                                        .append(")(Operator 3)</td><td valign='middle' align='center'>Operasi/VK</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsbiayaoperator3.getDouble("biayaoperator3")))
                                        .append("</td></tr>");
                                total += rsbiayaoperator3.getDouble("biayaoperator3");
                            }
                            ...
                            while (rsbiayadokter_anak.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        .append(rsbiayadokter_anak.getString("tgl_operasi"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsbiayadokter_anak.getString("no_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsbiayadokter_anak.getString("no_rkm_medis"))
                                        .append("</td><td valign='middle' align='left'>")
                                        .append(rsbiayadokter_anak.getString("nm_pasien"))
                                        .append(" (")
                                        .append(rsbiayadokter_anak.getString("kd_pj"))
                                        .append(")</td><td valign='middle' align='left'>")
                                        .append(rsbiayadokter_anak.getString("nm_perawatan"))
                                        .append(" (")
                                        .append(rsbiayadokter_anak.getString("kode_paket"))
                                        .append(")(dr Anak)</td><td valign='middle' align='center'>Operasi/VK</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsbiayadokter_anak.getDouble("biayadokter_anak")))
                                        .append("</td></tr>");
                                total += rsbiayadokter_anak.getDouble("biayadokter_anak");
                            }
                            ...
                            while (rsbiayadokter_anestesi.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        .append(rsbiayadokter_anestesi.getString("tgl_operasi"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsbiayadokter_anestesi.getString("no_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsbiayadokter_anestesi.getString("no_rkm_medis"))
                                        .append("</td><td valign='middle' align='left'>")
                                        .append(rsbiayadokter_anestesi.getString("nm_pasien"))
                                        .append(" (")
                                        .append(rsbiayadokter_anestesi.getString("kd_pj"))
                                        .append(")</td><td valign='middle' align='left'>")
                                        .append(rsbiayadokter_anestesi.getString("nm_perawatan"))
                                        .append(" (")
                                        .append(rsbiayadokter_anestesi.getString("kode_paket"))
                                        .append(")(dr Anestesi)</td><td valign='middle' align='center'>Operasi/VK</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsbiayadokter_anestesi.getDouble("biayadokter_anestesi")))
                                        .append("</td></tr>");
                                total += rsbiayadokter_anestesi.getDouble("biayadokter_anestesi");
                            }
                            ...
                            while (rsbiaya_dokter_pjanak.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        .append(rsbiaya_dokter_pjanak.getString("tgl_operasi"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsbiaya_dokter_pjanak.getString("no_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsbiaya_dokter_pjanak.getString("no_rkm_medis"))
                                        .append("</td><td valign='middle' align='left'>")
                                        .append(rsbiaya_dokter_pjanak.getString("nm_pasien"))
                                        .append(" (")
                                        .append(rsbiaya_dokter_pjanak.getString("kd_pj"))
                                        .append(")</td><td valign='middle' align='left'>")
                                        .append(rsbiaya_dokter_pjanak.getString("nm_perawatan"))
                                        .append(" (")
                                        .append(rsbiaya_dokter_pjanak.getString("kode_paket"))
                                        .append(")(dr Pj Anak)</td><td valign='middle' align='center'>Operasi/VK</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsbiaya_dokter_pjanak.getDouble("biaya_dokter_pjanak")))
                                        .append("</td></tr>");
                                total += rsbiaya_dokter_pjanak.getDouble("biaya_dokter_pjanak");
                            }
                            ...
                            while (rsbiaya_dokter_umum.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        .append(rsbiaya_dokter_umum.getString("tgl_operasi"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsbiaya_dokter_umum.getString("no_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsbiaya_dokter_umum.getString("no_rkm_medis"))
                                        .append("</td><td valign='middle' align='left'>")
                                        .append(rsbiaya_dokter_umum.getString("nm_pasien"))
                                        .append(" (")
                                        .append(rsbiaya_dokter_umum.getString("kd_pj"))
                                        .append(")</td><td valign='middle' align='left'>")
                                        .append(rsbiaya_dokter_umum.getString("nm_perawatan"))
                                        .append(" (")
                                        .append(rsbiaya_dokter_umum.getString("kode_paket"))
                                        .append(")(dr Umum)</td><td valign='middle' align='center'>Operasi/VK</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsbiaya_dokter_umum.getDouble("biaya_dokter_umum")))
                                        .append("</td></tr>");
                                total += rsbiaya_dokter_umum.getDouble("biaya_dokter_umum");
                            }
                        } catch (Exception e) {
                    ...
                    if (chkLaborat.isSelected() == true) {
                        ...
                        try {
                            ...
                            while (rsperiksa_lab.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        .append(rsperiksa_lab.getString("tgl_periksa"))
                                        .append(" ")
                                        .append(rsperiksa_lab.getString("jam"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsperiksa_lab.getString("no_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsperiksa_lab.getString("no_rkm_medis"))
                                        .append("</td><td valign='middle' align='left'>")
                                        .append(rsperiksa_lab.getString("nm_pasien"))
                                        .append(" (")
                                        .append(rsperiksa_lab.getString("kd_pj"))
                                        .append(")</td><td valign='middle' align='left'>")
                                        .append(rsperiksa_lab.getString("nm_perawatan"))
                                        .append(" (")
                                        .append(rsperiksa_lab.getString("kd_jenis_prw"))
                                        .append(")</td><td valign='middle' align='center'>Pemeriksaan Lab</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsperiksa_lab.getDouble("tarif_tindakan_dokter")))
                                        .append("</td></tr>");
                                total += rsperiksa_lab.getDouble("tarif_tindakan_dokter");
                            }
                        } catch (Exception e) {
                        ...
                        try {
                            ...
                            while (rsdetaillab.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        .append(rsdetaillab.getString("tgl_periksa"))
                                        .append(" ")
                                        .append(rsdetaillab.getString("jam"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsdetaillab.getString("no_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsdetaillab.getString("no_rkm_medis"))
                                        .append("</td><td valign='middle' align='left'>")
                                        .append(rsdetaillab.getString("nm_pasien"))
                                        .append(" (")
                                        .append(rsdetaillab.getString("kd_pj"))
                                        .append(")</td><td valign='middle' align='left'>")
                                        .append(rsdetaillab.getString("Pemeriksaan"))
                                        .append(" (")
                                        .append(rsdetaillab.getString("kd_jenis_prw"))
                                        .append(")</td><td valign='middle' align='center'>Detail Pemeriksaan Lab</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsdetaillab.getDouble("bagian_dokter")))
                                        .append("</td></tr>");
                                total += rsdetaillab.getDouble("bagian_dokter");
                            }
                        } catch (Exception e) {
                        ...
                        try {
                            ...
                            while (rsperiksa_lab.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        ...
                                        .append(" (")
                                        .append(rsperiksa_lab.getString("kd_jenis_prw"))
                                        .append(")</td><td valign='middle' align='center'>Perujuk Lab</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsperiksa_lab.getDouble("tarif_perujuk")))
                                        .append("</td></tr>");
                                total += rsperiksa_lab.getDouble("tarif_perujuk");
                            }
                        } catch (Exception e) {
                        ...
                        try {
                            ...
                            while (rsdetaillab.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        ...
                                        .append(" (")
                                        .append(rsdetaillab.getString("kd_jenis_prw"))
                                        .append(")</td><td valign='middle' align='center'>Detail Perujuk Lab</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsdetaillab.getDouble("bagian_perujuk")))
                                        .append("</td></tr>");
                                total += rsdetaillab.getDouble("bagian_perujuk");
                            }
                        } catch (Exception e) {
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        ...
                        try {
                            ...
                            while (rsperiksa_radiologi.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        .append(rsperiksa_radiologi.getString("tgl_periksa"))
                                        .append(" ")
                                        .append(rsperiksa_radiologi.getString("jam"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsperiksa_radiologi.getString("no_rawat"))
                                        .append("</td><td valign='middle' align='center'>")
                                        .append(rsperiksa_radiologi.getString("no_rkm_medis"))
                                        .append("</td><td valign='middle' align='left'>")
                                        .append(rsperiksa_radiologi.getString("nm_pasien"))
                                        .append(" (")
                                        .append(rsperiksa_radiologi.getString("kd_pj"))
                                        .append(")</td><td valign='middle' align='left'>")
                                        .append(rsperiksa_radiologi.getString("nm_perawatan"))
                                        .append(" (")
                                        .append(rsperiksa_radiologi.getString("kd_jenis_prw"))
                                        .append(")</td><td valign='middle' align='center'>Pemeriksaan Radiologi</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsperiksa_radiologi.getDouble("tarif_tindakan_dokter")))
                                        .append("</td></tr>");
                                total += rsperiksa_radiologi.getDouble("tarif_tindakan_dokter");
                            }
                        } catch (Exception e) {
                        ...
                        try {
                            ...
                            while (rsperiksa_radiologi.next()) {
                                htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                                        ...
                                        .append(" (")
                                        .append(rsperiksa_radiologi.getString("kd_jenis_prw"))
                                        .append(")</td><td valign='middle' align='center'>Perujuk Radiologi</td><td valign='middle' align='right'>")
                                        .append(Valid.SetAngka(rsperiksa_radiologi.getDouble("tarif_perujuk")))
                                        .append("</td></tr>");
                                total += rsperiksa_radiologi.getDouble("tarif_perujuk");
                            }
                        } catch (Exception e) {
                    ...
                    htmlContent.append(
                            "<tr class='isi'><td valign='middle' align='left' colspan='6'>&nbsp;Total :</td><td valign='middle' align='right'>")
                            .append(Valid.SetAngka(total))
                            .append("</td></tr>");
                    totaljm += total;

                    htmlContent.append("</table><br>" + "</td>" + "</tr>");
                    i++;
                }
            } catch (Exception e) {
                System.out.println("Notifikasi Pasien : " + e);
            ...
            if (totaljm > 0) {
                htmlContent.append("<tr class='isi'><td valign='middle' align='right'>Total Jasa Medis : ")
                        .append(Valid.SetAngka(totaljm))
                        .append("</td></tr>");
            }
    ...
    private static final Logger LOG = Logger.getLogger(DlgRHJmDokter.class.getName());
