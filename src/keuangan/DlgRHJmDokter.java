...
public class DlgRHJmDokter extends javax.swing.JDialog {
    ...
    public DlgRHJmDokter(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.", "Nama Dokter", "Tgl.Tindakan", "No.Rawat",
            "No.RM", "Nama Pasien", "Tindakan Medis", "Jasa Medis"};
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRHJmDokter dialog = new DlgRHJmDokter(new javax.swing.JFrame(),
                    true);
    ...
    private void prosesCariSemua() {
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (chkRalan.isSelected() == true) {
                        ...
                        try {
                            psrawatjalandr.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " " + CmbJam.
                                            getSelectedItem() + ":" + CmbMenit.
                                            getSelectedItem() + ":" + CmbDetik.
                                            getSelectedItem());
                            psrawatjalandr.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " " + CmbJam2.
                                            getSelectedItem() + ":" + CmbMenit2.
                                            getSelectedItem() + ":" + CmbDetik2.
                                            getSelectedItem());
                            psrawatjalandr.setString(3, rs.
                                    getString("kd_dokter"));
                            psrawatjalandr.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsrawatjalandr = psrawatjalandr.executeQuery();
                            rsrawatjalandr.last();

                            psrawatjalandrpr.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " " + CmbJam.
                                            getSelectedItem() + ":" + CmbMenit.
                                            getSelectedItem() + ":" + CmbDetik.
                                            getSelectedItem());
                            psrawatjalandrpr.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " " + CmbJam2.
                                            getSelectedItem() + ":" + CmbMenit2.
                                            getSelectedItem() + ":" + CmbDetik2.
                                            getSelectedItem());
                            psrawatjalandrpr.setString(3, rs.getString(
                                    "kd_dokter"));
                            psrawatjalandrpr.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsrawatjalandrpr = psrawatjalandrpr.executeQuery();
                            rsrawatjalandrpr.last();
                            if ((rsrawatjalandr.getRow() > 0) || (rsrawatjalandrpr.
                                    getRow() > 0)) {
                                z++;
                            ...
                            while (rsrawatjalandr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rsrawatjalandr.getString(
                                    "tgl_perawatan") + " " + rsrawatjalandr.
                                    getString("jam_rawat"), rsrawatjalandr.
                                    getString("no_rawat"), rsrawatjalandr.
                                    getString("no_rkm_medis"), rsrawatjalandr.
                                    getString("nm_pasien") + " (" + rsrawatjalandr.
                                    getString("kd_pj") + ")",
                                    rsrawatjalandr.getString("nm_perawatan") + " (" + rsrawatjalandr.
                                    getString("kd_jenis_prw") + ")", Valid.
                                    SetAngka(rsrawatjalandr.getDouble(
                                    "tarif_tindakandr"))});
                                total += rsrawatjalandr.getDouble(
                                        "tarif_tindakandr");
                            }
                            ...
                            while (rsrawatjalandrpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    "     " + rsrawatjalandrpr.getString(
                                    "tgl_perawatan") + " " + rsrawatjalandrpr.
                                    getString("jam_rawat"), rsrawatjalandrpr.
                                    getString("no_rawat"), rsrawatjalandrpr.
                                    getString("no_rkm_medis"), rsrawatjalandrpr.
                                    getString("nm_pasien") + " (" + rsrawatjalandrpr.
                                    getString("kd_pj") + ")",
                                    rsrawatjalandrpr.getString("nm_perawatan") + " (" + rsrawatjalandrpr.
                                    getString("kd_jenis_prw") + ")", Valid.
                                    SetAngka(rsrawatjalandrpr.getDouble(
                                    "tarif_tindakandr"))});
                                total += rsrawatjalandrpr.getDouble(
                                        "tarif_tindakandr");
                            }
                        } catch (Exception e) {
                    ...
                    if (chkRanap.isSelected() == true) {
                        ...
                        try {
                            psrawatinapdr.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " " + CmbJam.
                                            getSelectedItem() + ":" + CmbMenit.
                                            getSelectedItem() + ":" + CmbDetik.
                                            getSelectedItem());
                            psrawatinapdr.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " " + CmbJam2.
                                            getSelectedItem() + ":" + CmbMenit2.
                                            getSelectedItem() + ":" + CmbDetik2.
                                            getSelectedItem());
                            psrawatinapdr.
                                    setString(3, rs.getString("kd_dokter"));
                            psrawatinapdr.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsrawatinapdr = psrawatinapdr.executeQuery();
                            rsrawatinapdr.last();

                            psrawatinapdrpr.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " " + CmbJam.
                                            getSelectedItem() + ":" + CmbMenit.
                                            getSelectedItem() + ":" + CmbDetik.
                                            getSelectedItem());
                            psrawatinapdrpr.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " " + CmbJam2.
                                            getSelectedItem() + ":" + CmbMenit2.
                                            getSelectedItem() + ":" + CmbDetik2.
                                            getSelectedItem());
                            psrawatinapdrpr.setString(3, rs.getString(
                                    "kd_dokter"));
                            psrawatinapdrpr.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsrawatinapdrpr = psrawatinapdrpr.executeQuery();
                            rsrawatinapdrpr.last();

                            if ((rsrawatinapdr.getRow() > 0) || (rsrawatinapdrpr.
                                    getRow() > 0)) {
                                z++;
                                tabMode.addRow(new Object[]{"", "",
                                    z + ". Rawat Inap ", "", "", "", "", ""});
                            ...
                            while (rsrawatinapdr.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsrawatinapdr.getString(
                                    "tgl_perawatan") + " " + rsrawatinapdr.
                                    getString("jam_rawat"), rsrawatinapdr.
                                    getString("no_rawat"), rsrawatinapdr.
                                    getString("no_rkm_medis"), rsrawatinapdr.
                                    getString("nm_pasien") + " (" + rsrawatinapdr.
                                    getString("kd_pj") + ")",
                                    rsrawatinapdr.getString("nm_perawatan") + " (" + rsrawatinapdr.
                                    getString("kd_jenis_prw") + ")", Valid.
                                    SetAngka(rsrawatinapdr.getDouble(
                                    "tarif_tindakandr"))
                                });
                                total += rsrawatinapdr.getDouble(
                                        "tarif_tindakandr");
                            }
                            ...
                            while (rsrawatinapdrpr.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsrawatinapdrpr.getString(
                                    "tgl_perawatan") + " " + rsrawatinapdrpr.
                                    getString("jam_rawat"), rsrawatinapdrpr.
                                    getString("no_rawat"), rsrawatinapdrpr.
                                    getString("no_rkm_medis"), rsrawatinapdrpr.
                                    getString("nm_pasien") + " (" + rsrawatinapdrpr.
                                    getString("kd_pj") + ")",
                                    rsrawatinapdrpr.getString("nm_perawatan") + " (" + rsrawatinapdrpr.
                                    getString("kd_jenis_prw") + ")", Valid.
                                    SetAngka(rsrawatinapdrpr.getDouble(
                                    "tarif_tindakandr"))
                                });
                                total += rsrawatinapdrpr.getDouble(
                                        "tarif_tindakandr");
                            }
                        } catch (Exception e) {
                    ...
                    if (chkOperasi.isSelected() == true) {
                        ...
                        try {
                            psbiayaoperator1.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " " + CmbJam.
                                            getSelectedItem() + ":" + CmbMenit.
                                            getSelectedItem() + ":" + CmbDetik.
                                            getSelectedItem());
                            psbiayaoperator1.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " " + CmbJam2.
                                            getSelectedItem() + ":" + CmbMenit2.
                                            getSelectedItem() + ":" + CmbDetik2.
                                            getSelectedItem());
                            psbiayaoperator1.setString(3, rs.getString(
                                    "kd_dokter"));
                            psbiayaoperator1.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsbiayaoperator1 = psbiayaoperator1.executeQuery();
                            rsbiayaoperator1.last();

                            psbiayaoperator2.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " " + CmbJam.
                                            getSelectedItem() + ":" + CmbMenit.
                                            getSelectedItem() + ":" + CmbDetik.
                                            getSelectedItem());
                            psbiayaoperator2.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " " + CmbJam2.
                                            getSelectedItem() + ":" + CmbMenit2.
                                            getSelectedItem() + ":" + CmbDetik2.
                                            getSelectedItem());
                            psbiayaoperator2.setString(3, rs.getString(
                                    "kd_dokter"));
                            psbiayaoperator2.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsbiayaoperator2 = psbiayaoperator2.executeQuery();
                            rsbiayaoperator2.last();

                            psbiayaoperator3.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " " + CmbJam.
                                            getSelectedItem() + ":" + CmbMenit.
                                            getSelectedItem() + ":" + CmbDetik.
                                            getSelectedItem());
                            psbiayaoperator3.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " " + CmbJam2.
                                            getSelectedItem() + ":" + CmbMenit2.
                                            getSelectedItem() + ":" + CmbDetik2.
                                            getSelectedItem());
                            psbiayaoperator3.setString(3, rs.getString(
                                    "kd_dokter"));
                            psbiayaoperator3.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsbiayaoperator3 = psbiayaoperator3.executeQuery();
                            rsbiayaoperator3.last();

                            psbiayadokter_anak.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " " + CmbJam.
                                            getSelectedItem() + ":" + CmbMenit.
                                            getSelectedItem() + ":" + CmbDetik.
                                            getSelectedItem());
                            psbiayadokter_anak.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " " + CmbJam2.
                                            getSelectedItem() + ":" + CmbMenit2.
                                            getSelectedItem() + ":" + CmbDetik2.
                                            getSelectedItem());
                            psbiayadokter_anak.setString(3, rs.getString(
                                    "kd_dokter"));
                            psbiayadokter_anak.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsbiayadokter_anak = psbiayadokter_anak.
                                    executeQuery();
                            rsbiayadokter_anak.last();

                            psbiaya_dokter_umum.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " " + CmbJam.
                                            getSelectedItem() + ":" + CmbMenit.
                                            getSelectedItem() + ":" + CmbDetik.
                                            getSelectedItem());
                            psbiaya_dokter_umum.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " " + CmbJam2.
                                            getSelectedItem() + ":" + CmbMenit2.
                                            getSelectedItem() + ":" + CmbDetik2.
                                            getSelectedItem());
                            psbiaya_dokter_umum.setString(3, rs.getString(
                                    "kd_dokter"));
                            psbiaya_dokter_umum.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsbiaya_dokter_umum = psbiaya_dokter_umum.
                                    executeQuery();
                            rsbiaya_dokter_umum.last();

                            psbiaya_dokter_pjanak.setString(1, Valid.SetTgl(
                                    Tgl1.getSelectedItem() + "") + " " + CmbJam.
                                    getSelectedItem() + ":" + CmbMenit.
                                            getSelectedItem() + ":" + CmbDetik.
                                            getSelectedItem());
                            psbiaya_dokter_pjanak.setString(2, Valid.SetTgl(
                                    Tgl2.getSelectedItem() + "") + " " + CmbJam2.
                                    getSelectedItem() + ":" + CmbMenit2.
                                            getSelectedItem() + ":" + CmbDetik2.
                                            getSelectedItem());
                            psbiaya_dokter_pjanak.setString(3, rs.getString(
                                    "kd_dokter"));
                            psbiaya_dokter_pjanak.setString(4,
                                    "%" + KdCaraBayar.getText() + NmCaraBayar.
                                    getText() + "%");
                            rsbiaya_dokter_pjanak = psbiaya_dokter_pjanak.
                                    executeQuery();
                            rsbiaya_dokter_pjanak.last();

                            psbiayadokter_anestesi.setString(1, Valid.SetTgl(
                                    Tgl1.getSelectedItem() + "") + " " + CmbJam.
                                    getSelectedItem() + ":" + CmbMenit.
                                            getSelectedItem() + ":" + CmbDetik.
                                            getSelectedItem());
                            psbiayadokter_anestesi.setString(2, Valid.SetTgl(
                                    Tgl2.getSelectedItem() + "") + " " + CmbJam2.
                                    getSelectedItem() + ":" + CmbMenit2.
                                            getSelectedItem() + ":" + CmbDetik2.
                                            getSelectedItem());
                            psbiayadokter_anestesi.setString(3, rs.getString(
                                    "kd_dokter"));
                            ...
                            if ((rsbiayaoperator1.getRow() > 0) || (rsbiayaoperator2.
                                    getRow() > 0) || (rsbiayaoperator3.getRow() > 0) || (rsbiayadokter_anak.
                                    getRow() > 0) || (rsbiaya_dokter_pjanak.
                                            getRow() > 0) || (rsbiaya_dokter_umum.
                                            getRow() > 0) || (rsbiayadokter_anestesi.
                                            getRow() > 0)) {
                                z++;
                                tabMode.addRow(new Object[]{"", "",
                                    z + ". Operasi/VK ", "", "", "", "", ""});
                            ...
                            while (rsbiayaoperator1.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsbiayaoperator1.
                                    getString("tgl_operasi"), rsbiayaoperator1.
                                    getString("no_rawat"), rsbiayaoperator1.
                                    getString("no_rkm_medis"), rsbiayaoperator1.
                                    getString("nm_pasien") + " (" + rsbiayaoperator1.
                                    getString("kd_pj") + ")",
                                    rsbiayaoperator1.getString("nm_perawatan") + " (" + rsbiayaoperator1.
                                    getString("kode_paket") + ")(Operator 1)",
                                    Valid.SetAngka(rsbiayaoperator1.getDouble(
                                    "biayaoperator1"))
                                });
                                total += rsbiayaoperator1.getDouble(
                                        "biayaoperator1");
                            }
                            ...
                            while (rsbiayaoperator2.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsbiayaoperator2.
                                    getString("tgl_operasi"), rsbiayaoperator2.
                                    getString("no_rawat"), rsbiayaoperator2.
                                    getString("no_rkm_medis"), rsbiayaoperator2.
                                    getString("nm_pasien") + " (" + rsbiayaoperator2.
                                    getString("kd_pj") + ")",
                                    rsbiayaoperator2.getString("nm_perawatan") + " (" + rsbiayaoperator2.
                                    getString("kode_paket") + ")(Operator 2)",
                                    Valid.SetAngka(rsbiayaoperator2.getDouble(
                                    "biayaoperator2"))
                                });
                                total += rsbiayaoperator2.getDouble(
                                        "biayaoperator2");
                            }
                            ...
                            while (rsbiayaoperator3.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsbiayaoperator3.
                                    getString("tgl_operasi"), rsbiayaoperator3.
                                    getString("no_rawat"), rsbiayaoperator3.
                                    getString("no_rkm_medis"), rsbiayaoperator3.
                                    getString("nm_pasien") + " (" + rsbiayaoperator3.
                                    getString("kd_pj") + ")",
                                    rsbiayaoperator3.getString("nm_perawatan") + "  (" + rsbiayaoperator3.
                                    getString("kode_paket") + ")(Operator 3)",
                                    Valid.SetAngka(rsbiayaoperator3.getDouble(
                                    "biayaoperator3"))
                                });
                                total += rsbiayaoperator3.getDouble(
                                        "biayaoperator3");
                            }
                            ...
                            while (rsbiayadokter_anak.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    getString("kd_pj") + ")",
                                    rsbiayadokter_anak.getString("nm_perawatan") + " (" + rsbiayadokter_anak.
                                    getString("kode_paket") + ")(dr Anak)",
                                    Valid.SetAngka(rsbiayadokter_anak.getDouble(
                                    "biayadokter_anak"))
                                });
                                total += rsbiayadokter_anak.getDouble(
                                        "biayadokter_anak");
                            }
                            ...
                            while (rsbiayadokter_anestesi.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    rsbiayadokter_anestesi.getString(
                                    "no_rkm_medis"), rsbiayadokter_anestesi.
                                    getString("nm_pasien") + " (" + rsbiayadokter_anestesi.
                                    getString("kd_pj") + ")",
                                    rsbiayadokter_anestesi.getString(
                                    "nm_perawatan") + " (" + rsbiayadokter_anestesi.
                                    getString("kode_paket") + ")(dr Anestesi)",
                                    Valid.SetAngka(rsbiayadokter_anestesi.
                            ...
                            while (rsbiaya_dokter_pjanak.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    rsbiaya_dokter_pjanak.getString(
                                    "no_rkm_medis"), rsbiaya_dokter_pjanak.
                                    getString("nm_pasien") + " (" + rsbiaya_dokter_pjanak.
                                    getString("kd_pj") + ")",
                                    rsbiaya_dokter_pjanak.getString(
                                    "nm_perawatan") + " (" + rsbiaya_dokter_pjanak.
                                    getString("kode_paket") + ")(dr Pj Anak)",
                                    Valid.SetAngka(rsbiaya_dokter_pjanak.
                            ...
                            while (rsbiaya_dokter_umum.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    getString("kd_pj") + ")",
                                    rsbiaya_dokter_umum.
                                    getString("nm_perawatan") + " (" + rsbiaya_dokter_umum.
                                    getString("kode_paket") + ")(dr Umum)",
                                    Valid.SetAngka(rsbiaya_dokter_umum.
                    ...
                    if (chkLaborat.isSelected() == true) {
                        ...
                        try {
                            psperiksa_lab.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " " + CmbJam.
                                            getSelectedItem() + ":" + CmbMenit.
                                            getSelectedItem() + ":" + CmbDetik.
                                            getSelectedItem());
                            psperiksa_lab.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " " + CmbJam2.
                                            getSelectedItem() + ":" + CmbMenit2.
                                            getSelectedItem() + ":" + CmbDetik2.
                                            getSelectedItem());
                            psperiksa_lab.
                                    setString(3, rs.getString("kd_dokter"));
                            psperiksa_lab.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            ...
                            while (rsperiksa_lab.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsperiksa_lab.getString(
                                    "tgl_periksa") + " " + rsperiksa_lab.
                                    getString("jam"), rsperiksa_lab.getString(
                                    "no_rawat"), rsperiksa_lab.getString(
                                    "no_rkm_medis"), rsperiksa_lab.getString(
                                    "nm_pasien") + " (" + rsperiksa_lab.
                                    getString("kd_pj") + ")",
                                    rsperiksa_lab.getString("nm_perawatan") + " (" + rsperiksa_lab.
                                    getString("kd_jenis_prw") + ")", Valid.
                                    SetAngka(rsperiksa_lab.getDouble(
                                    "tarif_tindakan_dokter"))
                                });
                                total += rsperiksa_lab.getDouble(
                                        "tarif_tindakan_dokter");
                            }
                        } catch (Exception e) {
                        ...
                        try {
                            ...
                            while (rsdetaillab.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    "tgl_periksa") + " " + rsdetaillab.
                                    getString("jam"), rsdetaillab.getString(
                                    "no_rawat"), rsdetaillab.getString(
                                    "no_rkm_medis"),
                                    rsdetaillab.getString("nm_pasien") + " (" + rsdetaillab.
                                    getString("kd_pj") + ")",
                                    rsdetaillab.getString("Pemeriksaan") + " (" + rsdetaillab.
                                    getString("kd_jenis_prw") + ")", Valid.
                                    SetAngka(rsdetaillab.getDouble(
                                    "bagian_dokter"))
                                });
                        ...
                        try {
                            psperiksa_lab2.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " " + CmbJam.
                                            getSelectedItem() + ":" + CmbMenit.
                                            getSelectedItem() + ":" + CmbDetik.
                                            getSelectedItem());
                            psperiksa_lab2.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " " + CmbJam2.
                                            getSelectedItem() + ":" + CmbMenit2.
                                            getSelectedItem() + ":" + CmbDetik2.
                                            getSelectedItem());
                            psperiksa_lab2.setString(3, rs.
                                    getString("kd_dokter"));
                            psperiksa_lab2.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                        ...
                        try {
                            psdetaillab2.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " " + CmbJam.
                                            getSelectedItem() + ":" + CmbMenit.
                                            getSelectedItem() + ":" + CmbDetik.
                                            getSelectedItem());
                            psdetaillab2.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " " + CmbJam2.
                                            getSelectedItem() + ":" + CmbMenit2.
                                            getSelectedItem() + ":" + CmbDetik2.
                                            getSelectedItem());
                            psdetaillab2.setString(3, rs.getString("kd_dokter"));
                            psdetaillab2.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        ...
                        try {
                            psperiksa_radiologi.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " " + CmbJam.
                                            getSelectedItem() + ":" + CmbMenit.
                                            getSelectedItem() + ":" + CmbDetik.
                                            getSelectedItem());
                            psperiksa_radiologi.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " " + CmbJam2.
                                            getSelectedItem() + ":" + CmbMenit2.
                                            getSelectedItem() + ":" + CmbDetik2.
                                            getSelectedItem());
                            psperiksa_radiologi.setString(3, rs.getString(
                                    "kd_dokter"));
                            psperiksa_radiologi.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsperiksa_radiologi = psperiksa_radiologi.
                                    executeQuery();
                            rsperiksa_radiologi.last();
                            if (rsperiksa_radiologi.getRow() > 0) {
                                z++;
                                tabMode.addRow(new Object[]{"", "",
                                    z + ". Pemeriksaan radiologi ", "", "", "",
                                    "", ""});
                            }
                            ...
                            while (rsperiksa_radiologi.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsperiksa_radiologi.
                                    getString("tgl_periksa") + " " + rsperiksa_radiologi.
                                    getString("jam"), rsperiksa_radiologi.
                                    getString("no_rawat"), rsperiksa_radiologi.
                                    getString("no_rkm_medis"),
                                    rsperiksa_radiologi.getString("nm_pasien") + " (" + rsperiksa_radiologi.
                                    getString("kd_pj") + ")",
                                    rsperiksa_radiologi.
                                    getString("nm_perawatan") + " (" + rsperiksa_radiologi.
                                    getString("kd_jenis_prw") + ")", Valid.
                                    SetAngka(rsperiksa_radiologi.getDouble(
                                    "tarif_tindakan_dokter"))
                                });
                        ...
                        try {
                            psperiksa_radiologi2.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " " + CmbJam.
                                            getSelectedItem() + ":" + CmbMenit.
                                            getSelectedItem() + ":" + CmbDetik.
                                            getSelectedItem());
                            psperiksa_radiologi2.setString(2, Valid.SetTgl(Tgl2.
                                    getSelectedItem() + "") + " " + CmbJam2.
                                            getSelectedItem() + ":" + CmbMenit2.
                                            getSelectedItem() + ":" + CmbDetik2.
                                            getSelectedItem());
                            psperiksa_radiologi2.setString(3, rs.getString(
                                    "kd_dokter"));
                            psperiksa_radiologi2.setString(4, "%" + KdCaraBayar.
                                    getText() + NmCaraBayar.getText() + "%");
                            rsperiksa_radiologi = psperiksa_radiologi2.
                                    executeQuery();
                            rsperiksa_radiologi.last();
                            if (rsperiksa_radiologi.getRow() > 0) {
                                z++;
                            ...
                            System.out.println(
                                    "Notifikasi Perujuk Radiologi : " + e);
                        } finally {
                            if (rsperiksa_radiologi != null) {
                                rsperiksa_radiologi.close();
                            }
            ...
            if (totaljm > 0) {
                tabMode.addRow(new Object[]{">> ", "Total Jasa Medis :", "", "",
    ...
    private void prosesCariSemua2() {
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    htmlContent.append(
                            ...
                            append(i).append(". ").append(rs.getString(
                            "nm_dokter")).append(
                        ...
                        try {
                            ...
                            while (rsrawatjalandr.next()) {
                                htmlContent.append(
                                        ...
                                        append(rsrawatjalandr.getString(
                                                "tgl_perawatan")).append(" ").
                                        append(rsrawatjalandr.getString(
                                                "jam_rawat")).append(
                                        ...
                                        append(rsrawatjalandr.getString(
                                                "kd_jenis_prw")).append(
                                                ")</td><td valign='middle' align='center'>Rawat Jalan</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(rsrawatjalandr.
                            ...
                            while (rsrawatjalandrpr.next()) {
                                htmlContent.append(
                                        "<tr class='isi'><td valign='middle' align='left'>").
                                        append(rsrawatjalandrpr.getString(
                                                "tgl_perawatan")).append(" ").
                                        append(rsrawatjalandrpr.getString(
                                                "jam_rawat")).append(
                                                "</td><td valign='middle' align='center'>").
                                        ...
                                        append(rsrawatjalandrpr.getString(
                                                "kd_jenis_prw")).append(
                                                ")</td><td valign='middle' align='center'>Rawat Jalan</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(rsrawatjalandrpr.
                                                getDouble("tarif_tindakandr"))).
                                        append("</td></tr>");
                                total += rsrawatjalandrpr.getDouble(
                                        "tarif_tindakandr");
                    ...
                    if (chkRanap.isSelected() == true) {
                        ...
                        try {
                            ...
                            while (rsrawatinapdr.next()) {
                                htmlContent.append(
                                        "<tr class='isi'><td valign='middle' align='left'>").
                                        append(rsrawatinapdr.getString(
                                                "tgl_perawatan")).append(" ").
                                        append(rsrawatinapdr.getString(
                                                "jam_rawat")).append(
                                                "</td><td valign='middle' align='center'>").
                                        ...
                                        append(rsrawatinapdr.getString(
                                                "kd_jenis_prw")).append(
                                                ")</td><td valign='middle' align='center'>Rawat Inap</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(rsrawatinapdr.
                                                getDouble("tarif_tindakandr"))).
                                        append("</td></tr>");
                                total += rsrawatinapdr.getDouble(
                                        "tarif_tindakandr");
                            ...
                            while (rsrawatinapdrpr.next()) {
                                htmlContent.append(
                                        "<tr class='isi'><td valign='middle' align='left'>").
                                        append(rsrawatinapdrpr.getString(
                                                "tgl_perawatan")).append(" ").
                                        append(rsrawatinapdrpr.getString(
                                                "jam_rawat")).append(
                                                "</td><td valign='middle' align='center'>").
                                        ...
                                        append(rsrawatinapdrpr.getString(
                                                "nm_pasien")).append(" (").
                                        append(rsrawatinapdrpr.
                                                getString("kd_pj")).append(
                                        ")</td><td valign='middle' align='left'>").
                                        append(rsrawatinapdrpr.getString(
                                                "nm_perawatan")).append(" (").
                                        append(rsrawatinapdrpr.getString(
                                                "kd_jenis_prw")).append(
                                                ")</td><td valign='middle' align='center'>Rawat Inap</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(rsrawatinapdrpr.
                                                getDouble("tarif_tindakandr"))).
                                        append("</td></tr>");
                                total += rsrawatinapdrpr.getDouble(
                                        "tarif_tindakandr");
                    ...
                    if (chkOperasi.isSelected() == true) {
                        ...
                        try {
                            ...
                            while (rsbiayaoperator1.next()) {
                                htmlContent.append(
                                        "<tr class='isi'><td valign='middle' align='left'>").
                                        append(rsbiayaoperator1.getString(
                                                "tgl_operasi")).append(
                                                "</td><td valign='middle' align='center'>").
                                        append(rsbiayaoperator1.getString(
                                                "no_rawat")).append(
                                        ...
                                        append(rsbiayaoperator1.getString(
                                                "kode_paket")).append(
                                                ")(Operator 1)</td><td valign='middle' align='center'>Operasi/VK</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(rsbiayaoperator1.
                            ...
                            while (rsbiayaoperator2.next()) {
                                htmlContent.append(
                                        "<tr class='isi'><td valign='middle' align='left'>").
                                        append(rsbiayaoperator2.getString(
                                                "tgl_operasi")).append(
                                                "</td><td valign='middle' align='center'>").
                                        append(rsbiayaoperator2.getString(
                                                "no_rawat")).append(
                                        ...
                                        append(rsbiayaoperator2.getString(
                                                "kode_paket")).append(
                                                ")(Operator 2)</td><td valign='middle' align='center'>Operasi/VK</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(rsbiayaoperator2.
                            ...
                            while (rsbiayaoperator3.next()) {
                                htmlContent.append(
                                        "<tr class='isi'><td valign='middle' align='left'>").
                                        append(rsbiayaoperator3.getString(
                                                "tgl_operasi")).append(
                                                "</td><td valign='middle' align='center'>").
                                        append(rsbiayaoperator3.getString(
                                                "no_rawat")).append(
                                        ...
                                        append(rsbiayaoperator3.getString(
                                                "kode_paket")).append(
                                                ")(Operator 3)</td><td valign='middle' align='center'>Operasi/VK</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(rsbiayaoperator3.
                            ...
                            while (rsbiayadokter_anak.next()) {
                                htmlContent.append(
                                        "<tr class='isi'><td valign='middle' align='left'>").
                                        append(rsbiayadokter_anak.getString(
                                                "tgl_operasi")).append(
                                                "</td><td valign='middle' align='center'>").
                                        append(rsbiayadokter_anak.getString(
                                                "no_rawat")).append(
                                        ...
                                        append(rsbiayadokter_anak.getString(
                                                "kode_paket")).append(
                                                ")(dr Anak)</td><td valign='middle' align='center'>Operasi/VK</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(
                                                rsbiayadokter_anak.getDouble(
                                                        "biayadokter_anak"))).
                                        append("</td></tr>");
                                total += rsbiayadokter_anak.getDouble(
                                        "biayadokter_anak");
                            ...
                            while (rsbiayadokter_anestesi.next()) {
                                htmlContent.append(
                                        "<tr class='isi'><td valign='middle' align='left'>").
                                        append(rsbiayadokter_anestesi.getString(
                                                "tgl_operasi")).append(
                                                "</td><td valign='middle' align='center'>").
                                        append(rsbiayadokter_anestesi.getString(
                                                "no_rawat")).append(
                                        ...
                                        append(rsbiayadokter_anestesi.getString(
                                                "kode_paket")).append(
                                                ")(dr Anestesi)</td><td valign='middle' align='center'>Operasi/VK</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(
                                                rsbiayadokter_anestesi.
                                                        getDouble(
                                                                "biayadokter_anestesi"))).
                            ...
                            while (rsbiaya_dokter_pjanak.next()) {
                                htmlContent.append(
                                        "<tr class='isi'><td valign='middle' align='left'>").
                                        append(rsbiaya_dokter_pjanak.getString(
                                                "tgl_operasi")).append(
                                                "</td><td valign='middle' align='center'>").
                                        append(rsbiaya_dokter_pjanak.getString(
                                                "no_rawat")).append(
                                        ...
                                        append(rsbiaya_dokter_pjanak.getString(
                                                "kode_paket")).append(
                                                ")(dr Pj Anak)</td><td valign='middle' align='center'>Operasi/VK</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(
                                                rsbiaya_dokter_pjanak.getDouble(
                                                        "biaya_dokter_pjanak"))).
                                        append("</td></tr>");
                                total += rsbiaya_dokter_pjanak.getDouble(
                                        "biaya_dokter_pjanak");
                            ...
                            while (rsbiaya_dokter_umum.next()) {
                                htmlContent.append(
                                        "<tr class='isi'><td valign='middle' align='left'>").
                                        append(rsbiaya_dokter_umum.getString(
                                                "tgl_operasi")).append(
                                                "</td><td valign='middle' align='center'>").
                                        append(rsbiaya_dokter_umum.getString(
                                                "no_rawat")).append(
                                        ...
                                        append(rsbiaya_dokter_umum.getString(
                                                "kode_paket")).append(
                                                ")(dr Umum)</td><td valign='middle' align='center'>Operasi/VK</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(
                                                rsbiaya_dokter_umum.getDouble(
                                                        "biaya_dokter_umum"))).
                                        append("</td></tr>");
                                total += rsbiaya_dokter_umum.getDouble(
                                        "biaya_dokter_umum");
                    ...
                    if (chkLaborat.isSelected() == true) {
                        ...
                        try {
                            ...
                            while (rsperiksa_lab.next()) {
                                htmlContent.append(
                                        "<tr class='isi'><td valign='middle' align='left'>").
                                        append(rsperiksa_lab.getString(
                                                "tgl_periksa")).append(" ").
                                        ...
                                        append(rsperiksa_lab.getString(
                                                "kd_jenis_prw")).append(
                                                ")</td><td valign='middle' align='center'>Pemeriksaan Lab</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(rsperiksa_lab.
                                                getDouble(
                                                        "tarif_tindakan_dokter"))).
                                        append("</td></tr>");
                                total += rsperiksa_lab.getDouble(
                        ...
                        try {
                            ...
                            while (rsdetaillab.next()) {
                                htmlContent.append(
                                        ...
                                        append(rsdetaillab.getString(
                                                "kd_jenis_prw")).append(
                                                ")</td><td valign='middle' align='center'>Detail Pemeriksaan Lab</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(rsdetaillab.
                                                getDouble("bagian_dokter"))).
                                        append("</td></tr>");
                                total += rsdetaillab.getDouble("bagian_dokter");
                            }
                        } catch (Exception e) {
                        ...
                        try {
                            ...
                            while (rsperiksa_lab.next()) {
                                htmlContent.append(
                                        ...
                                        append(rsperiksa_lab.getString(
                                                "kd_jenis_prw")).append(
                                                ")</td><td valign='middle' align='center'>Perujuk Lab</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(rsperiksa_lab.
                                                getDouble("tarif_perujuk"))).
                                        append("</td></tr>");
                                total += rsperiksa_lab.
                        ...
                        try {
                            ...
                            while (rsdetaillab.next()) {
                                htmlContent.append(
                                        ...
                                        append(rsdetaillab.getString(
                                                "kd_jenis_prw")).append(
                                                ")</td><td valign='middle' align='center'>Detail Perujuk Lab</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(rsdetaillab.
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        ...
                        try {
                            ...
                            while (rsperiksa_radiologi.next()) {
                                htmlContent.append(
                                        "<tr class='isi'><td valign='middle' align='left'>").
                                        append(rsperiksa_radiologi.getString(
                                                "tgl_periksa")).append(" ").
                                        append(rsperiksa_radiologi.getString(
                                                "jam")).append(
                                                "</td><td valign='middle' align='center'>").
                                        ...
                                        append(rsperiksa_radiologi.getString(
                                                "kd_jenis_prw")).append(
                                                ")</td><td valign='middle' align='center'>Pemeriksaan Radiologi</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(
                                                rsperiksa_radiologi.getDouble(
                                                        "tarif_tindakan_dokter"))).
                                        append("</td></tr>");
                                total += rsperiksa_radiologi.getDouble(
                                        "tarif_tindakan_dokter");
                        ...
                        try {
                            ...
                            while (rsperiksa_radiologi.next()) {
                                htmlContent.append(
                                        ...
                                        append(rsperiksa_radiologi.getString(
                                                "kd_jenis_prw")).append(
                                                ")</td><td valign='middle' align='center'>Perujuk Radiologi</td><td valign='middle' align='right'>").
                                        append(Valid.SetAngka(
                                                rsperiksa_radiologi.getDouble(
                                                        "tarif_perujuk"))).
                                        append("</td></tr>");
                    ...
                    htmlContent.append(
                            ...
                            append(Valid.SetAngka(total)).append("</td></tr>");
                    totaljm += total;
            ...
            if (totaljm > 0) {
                htmlContent.append(
                        "<tr class='isi'><td valign='middle' align='right'>Total Jasa Medis : ").
                        append(Valid.SetAngka(totaljm)).append("</td></tr>");
            }
            LoadHTML.setText(
                    "<html>"
                    + "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"
    ...
    private static final Logger LOG = Logger.getLogger(DlgRHJmDokter.class.
            getName());
