...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
                ...
                while (rsdokter.next()) {
                    ...
                    while (rsobat.next()) {
                        tabMode.addRow(new Object[]{"", "", rsobat.getString(3),
                            rsobat.getString(1) + " " + rsobat.getString(2), Valid.SetAngka(rsobat.getDouble(4)),
                            Valid.SetAngka(rsobat.getDouble(5)), Valid.SetAngka(rsobat.getDouble(6)),
                    ...
                    if (jmltotal > 0) {
                        tabMode.addRow(new Object[]{"", "", "", "Subtotal :", Valid.SetAngka(jmlbiaya),
                            Valid.SetAngka(jmlembalase), Valid.SetAngka(jmltuslah), Valid.SetAngka(jmltotal)});
                    }
                    a++;
                }
                i++;
    ...
    private static final Logger LOG = Logger.getLogger(DlgRBObatBangsal.class.getName());
