    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (i = 0; i < tabMode.getRowCount(); i++) {
                try {
                    sjmlbacaan = Valid.SetAngka(Double.parseDouble(tabMode.
                            getValueAt(i, 6).toString()));
                } catch (Exception e) {
                    sjmlbacaan = "";
                }
                try {
                    sfeebacaan = Valid.SetAngka(Double.parseDouble(tabMode.
            ...
            Valid.MyReportqry("rptFeeBacaanEkg.jasper", "report",
                    "[ Rekap Fee Bacaan EKG ]",
