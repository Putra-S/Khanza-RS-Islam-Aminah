...
//GEN-FIRST:event_TKdKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ...
            tanggal = " ipsrs_titip_faktur.tanggal between '" + Valid.SetTgl(Tanggal1.getSelectedItem() + "")
            ...
            if (!TCari.getText().trim().isEmpty()) {
                cari = " and (ipsrs_titip_faktur.no_tagihan like '%" + TCari.getText() + "%' or petugas.nama like '%"
                        + TCari.getText() + "%' or ipsrs_titip_faktur.keterangan like '%" + TCari.getText()
                        + "%' or ipsrs_detail_titip_faktur.no_faktur like '%" + TCari.getText()
                        + "%' or ipsrssuplier.nama_suplier like '%" + TCari.getText() + "%' ) ";
            }
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + " group by ipsrs_titip_faktur.no_tagihan order by ipsrs_titip_faktur.tanggal");
            try {
                rs = ps.executeQuery();
                totaltagihan = 0;
                while (rs.next()) {
                    ...
                    ps2 = koneksi.prepareStatement(
                            ...
                            + " order by ipsrs_titip_faktur.tanggal");
                    try {
                        nilaitagihan = 0;
    ...
    private static final Logger LOG = Logger.getLogger(KeuanganCariTagihanNonMedis.class.getName());
