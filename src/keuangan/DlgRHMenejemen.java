...
public class DlgRHMenejemen extends javax.swing.JDialog {
    ...
    private ResultSet rs, rsrawatjalandr, rsrawatjalandrpr, rsrawatjalanpr, rsrawatinapdr, rsrawatinapdrpr,
            rsrawatinappr, rsperiksa_lab, rsdetail_lab, rsperiksa_radiologi, rsbagian_rs;
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
            ...
            try {
                ...
                while (rs.next()) {
                        ...
                        try {
                            ...
                            while (rsrawatjalandr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatjalandr.getDouble("menejemen"))});
                            ...
                            while (rsrawatjalandrpr.next()) {
                                tabMode.addRow(
                                        new Object[]{"", "", "     " + rsrawatjalandrpr.getString("tgl_registrasi"),
                                            ...
                                            Valid.SetAngka(rsrawatjalandrpr.getDouble("menejemen"))});
                            ...
                            while (rsrawatjalanpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatjalanpr.getDouble("menejemen"))});
                        ...
                        try {
                            ...
                            while (rsrawatinapdr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatinapdr.getDouble("menejemen"))});
                            ...
                            while (rsrawatinapdrpr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatinapdrpr.getDouble("menejemen"))});
                            ...
                            while (rsrawatinappr.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsrawatinappr.getDouble("menejemen"))});
                    ...
                    if (chkOperasi.isSelected() == true) {
                        psbagian_rs = koneksi
                                .prepareStatement("select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.bagian_rs,"
                        ...
                        try {
                            ...
                            while (rsbagian_rs.next()) {
                                tabMode.addRow(new Object[]{"", "", "     " + rsbagian_rs.getString("tgl_operasi"),
                                    rsbagian_rs.getString("nm_pasien"),
                                    rsbagian_rs.getString("nm_perawatan") + " (N.M.S)",
                                    Valid.SetAngka(rsbagian_rs.getDouble("bagian_rs"))});
                        ...
                        try {
                            ...
                            while (rsperiksa_lab.next()) {
                                ...
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsperiksa_lab.getDouble("menejemen") + detail_lab)});
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        psperiksa_radiologi = koneksi
                                .prepareStatement("select periksa_radiologi.menejemen,pasien.nm_pasien,"
                        ...
                        try {
                            ...
                            while (rsperiksa_radiologi.next()) {
                                tabMode.addRow(new Object[]{"", "",
                                    ...
                                    Valid.SetAngka(rsperiksa_radiologi.getDouble("menejemen"))});
    ...
    private static final Logger LOG = Logger.getLogger(DlgRHMenejemen.class.getName());
