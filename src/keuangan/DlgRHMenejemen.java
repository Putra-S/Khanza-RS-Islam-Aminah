...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRHMenejemen.jasper", "report",
                    "::[ Rekap Harian Menejemen Rumah Sakit ]::",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRHMenejemen dialog = new DlgRHMenejemen(new javax.swing.JFrame(),
                    true);
    ...
    private void prosesCari() {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (chkRalan.isSelected() == true) {
                        psrawatjalandr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_jl_dr.menejemen,"
                        ...
                        psrawatjalandrpr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_jl_drpr.menejemen,"
                                + "jns_perawatan.nm_perawatan,reg_periksa.tgl_registrasi "
                                + "from pasien inner join reg_periksa  "
                        ...
                        psrawatjalanpr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_jl_pr.menejemen,"
                                + "jns_perawatan.nm_perawatan,reg_periksa.tgl_registrasi "
                                + "from pasien inner join reg_periksa  "
                    ...
                    if (chkRanap.isSelected() == true) {
                        psrawatinapdr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_inap_dr.menejemen,"
                        ...
                        psrawatinapdrpr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_inap_drpr.menejemen,"
                        ...
                        psrawatinappr = koneksi.prepareStatement(
                                "select pasien.nm_pasien,rawat_inap_pr.menejemen,"
                    ...
                    if (chkOperasi.isSelected() == true) {
                        psbagian_rs = koneksi.prepareStatement(
                                "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.bagian_rs,"
                        ...
                        try {
                            psbagian_rs.setString(1, Valid.SetTgl(Tgl1.
                                    getSelectedItem() + "") + " 00:00:00");
                            psbagian_rs.setString(2, Valid.SetTgl(Tgl2.
                            ...
                            while (rsbagian_rs.next()) {
                                tabMode.addRow(new Object[]{
                                    "", "", "     " + rsbagian_rs.getString(
                                    "tgl_operasi"), rsbagian_rs.getString(
                                    "nm_pasien"),
                                    rsbagian_rs.getString("nm_perawatan") + " (N.M.S)",
                                    Valid.SetAngka(rsbagian_rs.getDouble(
                                    "bagian_rs"))
                                });
                    ...
                    if (chkLaborat.isSelected() == true) {
                        psperiksa_lab = koneksi.prepareStatement(
                                "select periksa_lab.menejemen,pasien.nm_pasien,"
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        psperiksa_radiologi = koneksi.prepareStatement(
                                "select periksa_radiologi.menejemen,pasien.nm_pasien,"
                        ...
                        try {
                            ...
                            while (rsperiksa_radiologi.next()) {
                                tabMode.addRow(new Object[]{
                                    ...
                                    rsperiksa_radiologi.getDouble("menejemen"))
                                });
                ...
                if (totaljm > 0) {
                    tabMode.addRow(new Object[]{">> ", "Total Menejemen :", "",
    ...
    private static final Logger LOG = Logger.getLogger(DlgRHMenejemen.class.
            getName());
