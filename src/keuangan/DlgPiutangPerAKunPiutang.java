...
public class DlgPiutangPerAKunPiutang extends javax.swing.JDialog {
    ...
    public void tampil() {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    htmlContent.append("<tr class='isi'><td valign='middle' align='center'>")
                            ...
                            .append(Valid.SetAngka(rs.getDouble("uangmuka")))
                            .append("</td><td valign='middle' align='right'>")
                            .append(Valid.SetAngka(rs.getDouble("totalpiutang")))
                            .append("</td>");
                    for (i = 0; i < kolom; i++) {
                        bayar = Sequel.cariIsiAngka("select totalpiutang from detail_piutang_pasien where no_rawat='"
                                + rs.getString("no_rawat") + "' and nama_bayar='" + akunbayar[i] + "'");
            ...
            htmlContent.append(
                    ...
                    .append(Valid.SetAngka(uangmuka))
                    .append("</td><td valign='middle' align='right'>")
                    .append(Valid.SetAngka(piutang))
                    .append("</td>");
            for (i = 0; i < kolom; i++) {
                htmlContent.append("<td valign='middle' align='right'>")
    ...
    private static final Logger LOG = Logger.getLogger(DlgPiutangPerAKunPiutang.class.getName());
