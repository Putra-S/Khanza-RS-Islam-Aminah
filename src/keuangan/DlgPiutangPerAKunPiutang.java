 ...
 * @author perpustakaan
 */
public class DlgPiutangPerAKunPiutang extends javax.swing.JDialog {
        ...
        try {
            ...
            try (BufferedWriter bw = new BufferedWriter(new FileWriter(f))) {
                bw.write(LoadHTML.getText().replaceAll("<head>",
                        ...
                        getemailrs() + "<br><br>"
                        + "<font size='2' face='Tahoma'>PIUTANG PER AKUN PIUTANG<br>TANGGAL " + Tgl1.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPiutangPerAKunPiutang dialog = new DlgPiutangPerAKunPiutang(
    ...
    public void tampil() {
        ...
        try {
            ...
            htmlContent.append(
                    ...
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='80px'>Tanggal</td>"
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='100px'>No.Nota</td>"
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='220px'>Nama Pasien</td>"
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='90px'>Uang Muka</td>"
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='90px'>Piutang</td>");
            kolom = 0;
            akunbayar = new String[Sequel.cariInteger(
                    "select count(nama_bayar) from akun_piutang")];
            psakunbayar = koneksi.prepareStatement(
                    "select nama_bayar from akun_piutang order by nama_bayar");
            try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    htmlContent.append(
                            ...
                            "</td><td valign='middle' align='center'>").append(
                                    rs.getString("no_nota")).append(
                            "</td><td valign='middle' align='left'>").append(rs.
                                    getString("nm_pasien")).append(
                            "</td><td valign='middle' align='right'>").append(
                                    Valid.SetAngka(rs.getDouble("uangmuka"))).
                            append("</td><td valign='middle' align='right'>").
                            append(Valid.SetAngka(rs.getDouble("totalpiutang"))).
                            append("</td>");
                    for (i = 0; i < kolom; i++) {
                        bayar = Sequel.cariIsiAngka(
                                "select totalpiutang from detail_piutang_pasien where no_rawat='" + rs.
                                        getString("no_rawat") + "' and nama_bayar='" + akunbayar[i] + "'");
                        htmlContent.append("<td valign='middle' align='right'>").
                                append(Valid.SetAngka(bayar)).append("</td>");
                        totalbayar[i] += bayar;
                    }
                    htmlContent.append(
                            "</tr>"
            ...
            htmlContent.append(
                    "<tr class='isi'><td valign='middle' align='center'></td><td valign='middle' align='right'>Total :</td><td valign='middle' align='center'></td><td valign='middle' align='center'></td><td valign='middle' align='right'>").
                    append(Valid.SetAngka(uangmuka)).append(
                    "</td><td valign='middle' align='right'>").append(Valid.
                            SetAngka(piutang)).append("</td>");
            for (i = 0; i < kolom; i++) {
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgPiutangPerAKunPiutang.class.getName());
