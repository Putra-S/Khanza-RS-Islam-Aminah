...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void prosesCari() {
        ...
        try {
                ...
                while (rs.next()) {
                    ...
                    if (chkRalan.isSelected() == true) {
                        ...
                        psralandrpr = koneksi.prepareStatement(
                                "select jns_perawatan.nm_perawatan,rawat_jl_drpr.kso,"
                        ...
                        psralandr = koneksi.prepareStatement(
                                "select jns_perawatan.nm_perawatan,rawat_jl_dr.kso,"
                    ...
                    if (chkRanap.isSelected() == true) {
                        psranappr = koneksi.prepareStatement(
                                "select jns_perawatan_inap.nm_perawatan,rawat_inap_pr.kso,"
                        ...
                        psranapdrpr = koneksi.prepareStatement(
                                "select jns_perawatan_inap.nm_perawatan,rawat_inap_drpr.kso,"
                        ...
                        psranapdr = koneksi.prepareStatement(
                                "select jns_perawatan_inap.nm_perawatan,rawat_inap_dr.kso,"
                    ...
                    if (chkLaborat.isSelected() == true) {
                        psperiksalab = koneksi.prepareStatement(
                                "select jns_perawatan_lab.nm_perawatan,periksa_lab.kso,"
            ...
            if (totaljm > 0) {
                tabMode.addRow(new Object[]{">> ", "Total KSO :", " ", "",
