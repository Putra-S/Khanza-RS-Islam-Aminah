...
//GEN-FIRST:event_TKdKeyPressed
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRBKSO.jasper", "report",
                    "[ Rekap Bulanan KSO ]",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (chkRalan.isSelected() == true) {
                        psralanpr = koneksi.prepareStatement("select jns_perawatan.nm_perawatan,rawat_jl_pr.kso,"
                                + "count(rawat_jl_pr.kd_jenis_prw) as jml," + "sum(rawat_jl_pr.kso) as total "
                        ...
                        psralandrpr = koneksi.prepareStatement("select jns_perawatan.nm_perawatan,rawat_jl_drpr.kso,"
                                + "count(rawat_jl_drpr.kd_jenis_prw) as jml," + "sum(rawat_jl_drpr.kso) as total "
                        ...
                        psralandr = koneksi.prepareStatement("select jns_perawatan.nm_perawatan,rawat_jl_dr.kso,"
                                + "count(rawat_jl_dr.kd_jenis_prw) as jml," + "sum(rawat_jl_dr.kso) as total "
                    ...
                    if (chkRanap.isSelected() == true) {
                        psranappr = koneksi.prepareStatement("select jns_perawatan_inap.nm_perawatan,rawat_inap_pr.kso,"
                                + "count(rawat_inap_pr.kd_jenis_prw) as jml, " + "sum(rawat_inap_pr.kso) as total "
                        ...
                        psranapdrpr = koneksi
                                .prepareStatement("select jns_perawatan_inap.nm_perawatan,rawat_inap_drpr.kso,"
                        ...
                        psranapdr = koneksi.prepareStatement("select jns_perawatan_inap.nm_perawatan,rawat_inap_dr.kso,"
                                + "count(rawat_inap_dr.kd_jenis_prw) as jml, " + "sum(rawat_inap_dr.kso) as total "
                    ...
                    if (chkLaborat.isSelected() == true) {
                        psperiksalab = koneksi.prepareStatement("select jns_perawatan_lab.nm_perawatan,periksa_lab.kso,"
                                + "count(periksa_lab.kd_jenis_prw) as jml, " + "sum(periksa_lab.kso) as total, "
                        ...
                        try {
                            ...
                            while (rsperiksalab.next()) {
                                detaillab = 0;
                                psdetaillab = koneksi
                                        .prepareStatement("select sum(detail_periksa_lab.kso) as total from "
                    ...
                    if (chkRadiologi.isSelected() == true) {
                        psperiksaradiologi = koneksi
                                .prepareStatement("select jns_perawatan_radiologi.nm_perawatan,periksa_radiologi.kso,"
    ...
    private static final Logger LOG = Logger.getLogger(DlgRBKSO.class.getName());
