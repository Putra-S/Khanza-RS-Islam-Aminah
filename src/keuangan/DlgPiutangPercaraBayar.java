...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void prosesCari() {
        try {
            ...
            pspenjab = koneksi.prepareStatement("select kd_pj,png_jawab from penjab where png_jawab like ?");
            try {
                ...
                while (rspenjab.next()) {
                    ...
                    try {
                        ...
                        while (rspiutang.next()) {
                            ...
                            subttlsisapiutang += rspiutang.getDouble("sisapiutang");
                            ttlsisapiutang += rspiutang.getDouble("sisapiutang");
                            tabMode.addRow(new Object[]{"",
                                a + ". " + rspiutang.getString("no_rawat") + " " + rspiutang.getString("pasien"),
                                rspiutang.getString("tgl_piutang"), rspiutang.getDouble("totalpiutang"),
                                rspiutang.getDouble("sisapiutang"), rspiutang.getString("tgltempo")});
                            a++;
                        }
                        if (subttlpiutang > 0) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgPiutangPercaraBayar.class.getName());
