...
public class DlgPendapatanPerCaraBayar extends javax.swing.JDialog {
    ...
    private double nilairalancash = 0, nilaimcucash = 0, nilairanapcash = 0, nilairalanpenjamin = 0,
            nilaimcupenjamin = 0, nilairanappenjamin = 0, ttlnilairalancash = 0, ttlnilaimcucash = 0,
            ttlnilairanapcash = 0, ttlnilairalanpenjamin = 0, ttlnilaimcupenjamin = 0, ttlnilairanappenjamin = 0;
    ...
    private void tampil() {
        ...
        try {
            ...
            htmlContent.append("<tr class='isi'>"
                    ...
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' colspan='2'>RAWAT INAP</td>"
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' rowspan='2'>CASH</td>"
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' rowspan='2'>PENJAMIN</td>" + "</tr>"
                    + "<tr class='isi'>"
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='150px'>NILAI</td>"
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='50px'>QTY</td>"
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='150px'>NILAI</td>"
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='50px'>QTY</td>"
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='150px'>NILAI</td>"
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='50px'>QTY</td>" + "</tr>");
            ...
            try {
                ...
                while (rs.next()) {
                    jmlralan = Sequel.cariInteger(
                            "select count(reg_periksa.no_rawat) from reg_periksa inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join nota_jalan on reg_periksa.no_rawat=nota_jalan.no_rawat where poliklinik.nm_poli not like '%mcu%' and reg_periksa.kd_pj='"
                            + rs.getString("kd_pj")
                            + "' and concat(nota_jalan.tanggal,' ',nota_jalan.jam) between '"
                            + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                            + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem() + "' and '"
                    ...
                    jmlmcu = Sequel.cariInteger(
                            "select count(reg_periksa.no_rawat) from reg_periksa inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join nota_jalan on reg_periksa.no_rawat=nota_jalan.no_rawat where poliklinik.nm_poli like '%mcu%' and reg_periksa.kd_pj='"
                            + rs.getString("kd_pj")
                            + "' and concat(nota_jalan.tanggal,' ',nota_jalan.jam) between '"
                            + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                            + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem() + "' and '"
                    ...
                    jmlranap = Sequel.cariInteger(
                            "select count(reg_periksa.no_rawat) from reg_periksa inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join nota_inap on reg_periksa.no_rawat=nota_inap.no_rawat where reg_periksa.kd_pj='"
                            + rs.getString("kd_pj")
                            + "' and concat(nota_inap.tanggal,' ',nota_inap.jam) between '"
                            + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                            + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem() + "' and '"
                            + Valid.SetTgl(Tgl2.getSelectedItem() + "") + " " + CmbJam2.getSelectedItem() + ":"
                            + CmbMenit2.getSelectedItem() + ":" + CmbDetik2.getSelectedItem() + "'");
                    ...
                    nilaimcucash = Sequel.cariIsiAngka(
                            "select sum(detail_nota_jalan.besar_bayar) from reg_periksa inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join nota_jalan on reg_periksa.no_rawat=nota_jalan.no_rawat inner join detail_nota_jalan on detail_nota_jalan.no_rawat=nota_jalan.no_rawat where poliklinik.nm_poli like '%mcu%' and reg_periksa.kd_pj='"
                            + rs.getString("kd_pj")
                            + "' and concat(nota_jalan.tanggal,' ',nota_jalan.jam) between '"
                            + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                            + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem() + "' and '"
                    ...
                    nilairanapcash = Sequel.cariIsiAngka(
                            "select sum(detail_nota_inap.besar_bayar) from reg_periksa inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join nota_inap on reg_periksa.no_rawat=nota_inap.no_rawat inner join detail_nota_inap on detail_nota_inap.no_rawat=nota_inap.no_rawat where reg_periksa.kd_pj='"
                            + rs.getString("kd_pj")
                            + "' and concat(nota_inap.tanggal,' ',nota_inap.jam) between '"
                            + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                            + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem() + "' and '"
                            ...
                            + CmbMenit2.getSelectedItem() + ":" + CmbDetik2.getSelectedItem() + "'")
                            + Sequel.cariIsiAngka(
                                    "select sum(deposit.besar_deposit) from reg_periksa inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join nota_inap on reg_periksa.no_rawat=nota_inap.no_rawat inner join deposit on deposit.no_rawat=nota_inap.no_rawat where reg_periksa.kd_pj='"
                                    + rs.getString("kd_pj")
                                    + "' and concat(nota_inap.tanggal,' ',nota_inap.jam) between '"
                                    + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem()
                                    + ":" + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem()
                                    + "' and '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + " "
                                    + CmbJam2.getSelectedItem() + ":" + CmbMenit2.getSelectedItem() + ":"
                                    + CmbDetik2.getSelectedItem() + "'")
                            - Sequel.cariIsiAngka(
                                    "select sum(pengembalian_deposit.besar_pengembalian) from reg_periksa inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join nota_inap on reg_periksa.no_rawat=nota_inap.no_rawat inner join pengembalian_deposit on pengembalian_deposit.no_rawat=nota_inap.no_rawat where reg_periksa.kd_pj='"
                                    + rs.getString("kd_pj")
                                    + "' and concat(nota_inap.tanggal,' ',nota_inap.jam) between '"
                                    + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem()
                                    + ":" + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem()
                    ...
                    nilairalanpenjamin = Sequel.cariIsiAngka(
                            "select sum(detail_piutang_pasien.totalpiutang) from reg_periksa inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join nota_jalan on reg_periksa.no_rawat=nota_jalan.no_rawat inner join detail_piutang_pasien on detail_piutang_pasien.no_rawat=nota_jalan.no_rawat where poliklinik.nm_poli not like '%mcu%' and reg_periksa.kd_pj='"
                            + rs.getString("kd_pj")
                            + "' and concat(nota_jalan.tanggal,' ',nota_jalan.jam) between '"
                            + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                            + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem() + "' and '"
                    ...
                    nilaimcupenjamin = Sequel.cariIsiAngka(
                            "select sum(detail_piutang_pasien.totalpiutang) from reg_periksa inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join nota_jalan on reg_periksa.no_rawat=nota_jalan.no_rawat inner join detail_piutang_pasien on detail_piutang_pasien.no_rawat=nota_jalan.no_rawat where poliklinik.nm_poli like '%mcu%' and reg_periksa.kd_pj='"
                            + rs.getString("kd_pj")
                            + "' and concat(nota_jalan.tanggal,' ',nota_jalan.jam) between '"
                            + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                            + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem() + "' and '"
                    ...
                    nilairanappenjamin = Sequel.cariIsiAngka(
                            "select sum(detail_piutang_pasien.totalpiutang) from reg_periksa inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join nota_inap on reg_periksa.no_rawat=nota_inap.no_rawat inner join detail_piutang_pasien on detail_piutang_pasien.no_rawat=nota_inap.no_rawat where reg_periksa.kd_pj='"
                            + rs.getString("kd_pj")
                            + "' and concat(nota_inap.tanggal,' ',nota_inap.jam) between '"
                            + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " " + CmbJam.getSelectedItem() + ":"
                            + CmbMenit.getSelectedItem() + ":" + CmbDetik.getSelectedItem() + "' and '"
                    ...
                    htmlContent.append("<tr class='isi'><td>")
                            ...
                            .append(Valid.SetAngka(nilairalancash + nilairalanpenjamin))
                            .append("</td><td align='center'>")
                            .append(jmlralan)
                            .append("</td><td align='right'>")
                            .append(Valid.SetAngka(nilaimcucash + nilaimcupenjamin))
                            .append("</td><td align='center'>")
                            .append(jmlmcu)
                            .append("</td><td align='right'>")
                            .append(Valid.SetAngka(nilairanapcash + nilairanappenjamin))
                            .append("</td><td align='center'>")
                            .append(jmlranap)
                            .append("</td><td align='right'>")
                            .append(Valid.SetAngka(nilairalancash + nilaimcucash + nilairanapcash))
                            .append("</td><td align='right'>")
                            .append(Valid.SetAngka(nilairalanpenjamin + nilaimcupenjamin + nilairanappenjamin))
                            .append("</td></tr>");
                    i++;
                }
            } catch (Exception e) {
            ...
            htmlContent.append("<tr class='isi'><td></td><td>TOTAL :</td><td align='right'>")
                    .append(Valid.SetAngka(ttlnilairalancash + ttlnilairalanpenjamin))
                    .append("</td><td align='center'>")
                    .append(ttlralan)
                    .append("</td><td align='right'>")
                    .append(Valid.SetAngka(ttlnilaimcucash + ttlnilaimcupenjamin))
                    .append("</td><td align='center'>")
                    .append(ttlmcu)
                    .append("</td><td align='right'>")
                    .append(Valid.SetAngka(ttlnilairanapcash + ttlnilairanappenjamin))
                    .append("</td><td align='center'>")
                    .append(ttlranap)
                    .append("</td><td align='right'>")
                    .append(Valid.SetAngka(ttlnilairalancash + ttlnilaimcucash + ttlnilairanapcash))
                    .append("</td><td align='right'>")
                    .append(Valid.SetAngka(ttlnilairalanpenjamin + ttlnilaimcupenjamin + ttlnilairanappenjamin))
                    .append("</td></tr>");
    ...
    private static final Logger LOG = Logger.getLogger(DlgPendapatanPerCaraBayar.class.getName());
