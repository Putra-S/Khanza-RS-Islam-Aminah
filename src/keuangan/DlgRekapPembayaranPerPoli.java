...
*/
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (int r = 0; r < row; r++) {
                Sequel.menyimpan("temporary", "'" + r + "','"
                        ...
                        getalamatip() + "'", "Rekap Pemasukan Perpoli Dokter");
            }
            ...
            Valid.MyReportqry("rptRekapPembayaranPerPoli.jasper", "report",
                    "[ Rekap Pembayaran Per Bagian/Unit ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRekapPembayaranPerPoli dialog = new DlgRekapPembayaranPerPoli(
            ...
            try {
                ...
                while (rspoli.next()) {
                    ...
                    try {
                        ...
                        psmasuk.setString(2, Valid.SetTgl(
                                Tgl1.getSelectedItem() + ""));
                        psmasuk.setString(3, Valid.SetTgl(
                    ...
                    if (total > 0) {
                        tabMode.addRow(new Object[]{i + ". ", rspoli.
                            getString(2), jmlpas, total});
                        i++;
                    }
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgRekapPembayaranPerPoli.class.getName());
