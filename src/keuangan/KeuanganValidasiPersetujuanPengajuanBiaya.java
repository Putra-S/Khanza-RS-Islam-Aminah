...
public class KeuanganValidasiPersetujuanPengajuanBiaya extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptValidasiPersetujuanPengajuanBiaya.jasper",
                    "report", "::[ Data Pengajuan Biaya Yang Disetujui ]::",
                    ...
                    + "where pengajuan_biaya.status='Disetujui' and pengajuan_biaya.nik_pj like '%" + kdpegawai.
                            getText().trim() + "%' "
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void BtnBayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBayarActionPerformed
        if (tbBangsal.getSelectedRow() > -1) {
            ...
            form.isCek();
            form.emptTeks();
            form.setPengajuan(tbBangsal.
                    getValueAt(tbBangsal.getSelectedRow(), 0).toString(),
                    "Validasi pengajuan No." + tbBangsal.getValueAt(tbBangsal.
                            getSelectedRow(), 0).toString() + " tanggal " + tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 1).toString() + " oleh " + tbBangsal.
                    getValueAt(tbBangsal.getSelectedRow(), 3).toString() + " NIP " + tbBangsal.
                    getValueAt(tbBangsal.getSelectedRow(), 2).toString(),
                    tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 13).
                            toString());
    ...
    private void tbBangsalMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbBangsalMouseClicked
        if (tbBangsal.getSelectedRow() != -1) {
            LCount1.setText(Valid.SetAngka(Double.parseDouble(tbBangsal.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeuanganValidasiPersetujuanPengajuanBiaya dialog = new KeuanganValidasiPersetujuanPengajuanBiaya(
