 ...
 * @author perpustakaan
 */
public class DlgLhtBiaya extends javax.swing.JDialog {
    ...
    public DlgLhtBiaya(java.awt.Frame parent, boolean modal) {
        ...
        setSize(885, 674);
        tabMode = new DefaultTableModel(null, new Object[]{"Keterangan", "Tagihan/Tindakan/Terapi", "", "Biaya",
            "Jumlah", "Tambahan", "Total Biaya"}) {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (int r = 0; r < row; r++) {
                biaya = "";
                try {
                    biaya = Valid.SetAngka(Double.parseDouble(tabMode.
                ...
                tambahan = "";
                try {
                    tambahan = Valid.SetAngka(Double.parseDouble(tabMode.
                ...
                totalx = "";
                try {
                    totalx = Valid.SetAngka(Double.parseDouble(tabMode.
                ...
                Sequel.menyimpan("temporary", "'" + r + "','" + tabMode.
                        getValueAt(r, 0).toString() + "','"
                        + tabMode.getValueAt(r, 1).toString() + "','" + tabMode.
            ...
            Valid.MyReportqry("rptRTagihanMasuk.jasper", "report",
                    "::[ Rekap Tagihan Masuk ]::",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                while (rstampil.next()) {
                    if ((!rstampil.getString("no").contains("Tagihan + PPN"))
                            && (!rstampil.getString("no").contains("Total Tagihan"))) {
                        if (rstampil.getString("no").contains("No.Nota")) {
                            tabMode.addRow(new Object[]{"", "", "", null, null, null, null});
                            tabMode.addRow(new Object[]{rstampil.getString("no"), rstampil.getString("nm_perawatan"),
                                rstampil.getString("pemisah"), rstampil.getObject("satu"),
                                rstampil.getObject("dua"), rstampil.getObject("tiga"),
    ...
    private static final Logger LOG = Logger.getLogger(DlgLhtBiaya.class.getName());
