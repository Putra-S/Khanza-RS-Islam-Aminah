...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                while (rstampil.next()) {
                    if ((!rstampil.getString("no").contains("Tagihan + PPN")) && (!rstampil.
                            getString("no").contains("Total Tagihan"))) {
                        if (rstampil.getString("no").contains("No.Nota")) {
                            tabMode.addRow(new Object[]{"", "", "", null, null,
                                null, null});
                            tabMode.addRow(
                                    new Object[]{rstampil.getString("no"),
                ...
                for (i = 0; i < tabMode.getRowCount(); i++) {
                    try {
                        y = Double.parseDouble(tabMode.getValueAt(i, 6).
                                toString());
                    } catch (Exception e) {
                        y = 0;
                    }
    ...
    private static final Logger LOG = Logger.getLogger(DlgLhtBiaya.class.
            getName());
}
