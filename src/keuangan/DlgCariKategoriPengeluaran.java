 ...
 * @author dosen
 */
public class DlgCariKategoriPengeluaran extends javax.swing.JDialog {
    ...
    public String Host_to_Host_Bank_Mandiri = "", Akun_Biaya_Mandiri = "", kodemcm = "", norekening = "", akun = "",
            kontraakun = "";
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    iyem = iyem + "{\"Kode\":\"" + rs.getString(1) + "\",\"Kategori\":\"" + rs.getString(2)
                            + "\",\"AkunRekening\":\"" + rs.getString(3) + "\",\"KontraAkun\":\"" + rs.getString(4)
                            + "\"},";
                }
            } catch (Exception e) {
            ...
            if (response.isArray()) {
                for (JsonNode list : response) {
                    if (list.path("Kode").asText().toLowerCase().contains(TCari.getText().toLowerCase())
                        ...
                        tabMode.addRow(new Object[]{list.path("Kode").asText(), list.path("Kategori").asText(),
                            list.path("AkunRekening").asText(), list.path("KontraAkun").asText()});
                    }
                }
            }
            myObj.close();
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    fileWriter.write("{\"akunbankmandiri\":\"" + Host_to_Host_Bank_Mandiri + "\",\"kodemcm\":\""
                            + kodemcm + "\",\"akunbiayabankmandiri\":\"" + Akun_Biaya_Mandiri + "\",\"norekening\":\""
                            + norekening + "\"}");
                    fileWriter.flush();
                    fileWriter.close();
                }
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariKategoriPengeluaran.class.getName());
