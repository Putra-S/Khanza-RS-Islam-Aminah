...
public class DlgCariKategoriPengeluaran extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariKategoriPengeluaran dialog = new DlgCariKategoriPengeluaran(
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    iyem = iyem + "{\"Kode\":\"" + rs.getString(1) + "\",\"Kategori\":\"" + rs.
                            getString(2) + "\",\"AkunRekening\":\"" + rs.
                            getString(3) + "\",\"KontraAkun\":\"" + rs.
                            getString(4) + "\"},";
                }
            } catch (Exception e) {
            ...
            fileWriter.write("{\"kategoripengeluaran\":[" + iyem.substring(0,
                    iyem.length() - 1) + "]}");
            fileWriter.flush();
            fileWriter.close();
            iyem = null;
            ...
            if (response.isArray()) {
                for (JsonNode list : response) {
                    if (list.path("Kode").asText().toLowerCase().contains(TCari.
                            getText().toLowerCase()) || list.path("Kategori").
                                    asText().toLowerCase().contains(TCari.
                                            getText().toLowerCase())) {
                        tabMode.addRow(new Object[]{
                            list.path("Kode").asText(), list.path("Kategori").
                            asText(), list.path("AkunRekening").asText(), list.
                            path("KontraAkun").asText()
                        });
                    }
                }
            }
        ...
        try {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    fileWriter.write(
                            "{\"akunbankmandiri\":\"" + Host_to_Host_Bank_Mandiri + "\",\"kodemcm\":\"" + kodemcm + "\",\"akunbiayabankmandiri\":\"" + Akun_Biaya_Mandiri + "\",\"norekening\":\"" + norekening + "\"}");
                    fileWriter.flush();
                    fileWriter.close();
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgCariKategoriPengeluaran.class.getName());
}
