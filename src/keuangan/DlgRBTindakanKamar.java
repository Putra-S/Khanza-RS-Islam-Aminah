...
public class DlgRBTindakanKamar extends javax.swing.JDialog {
    ...
    public DlgRBTindakanKamar(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.", "Bangsal", "Tgl.Masuk", "Tgl.Keluar",
            "Cara Bayar", "Obt+Emb+Tsl", "Laborat", "Paket Tindakan", "Tambahan",
            "Potongan", "Registrasi", "Radiologi", "Kamar", "Total"};
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRBTindakanKamar.jasper", "report",
                    "[ Rekap Harian Per Bangsal/Kamar ]",
    ...
    private void kdbangsalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdbangsalKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_PAGE_DOWN) {
            Sequel.cariIsi(
                    "select nm_bangsal from bangsalklinik where kd_bangsal=?",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRBTindakanKamar dialog = new DlgRBTindakanKamar(
    ...
    private void prosesCari() {
        try {
            ...
            psbangsal = koneksi.prepareStatement(
                    "select kd_bangsal,nm_bangsal from bangsal where  kd_bangsal like ?");
            try {
                ...
                while (rsbangsal.next()) {
                    tabMode.addRow(
                            new Object[]{i + ". ", rsbangsal.getString(2),
                                "", "", "", "", "", "", "", "", "", "", "",
                                ""});
                    a = 1;
                    ...
                    try {
                        ...
                        pspasien.setString(2, Valid.SetTgl(Tgl1.
                                getSelectedItem() + ""));
                        pspasien.setString(3, Valid.SetTgl(Tgl2.
                                getSelectedItem() + ""));
                        ...
                        while (rspasien.next()) {
                            ...
                            try {
                                psobat.setString(1, rspasien.getString(
                                        "no_rawat"));
                            ...
                            try {
                                psobatlangsung.setString(1, rspasien.getString(
                                        "no_rawat"));
                            ...
                            try {
                                psperiksalab.setString(1, rspasien.getString(
                                        "no_rawat"));
                            ...
                            detaillaborat = 0;
                            psdetailperiksalab = koneksi.prepareStatement(
                                    "select sum(biaya_item) from detail_periksa_lab where no_rawat=?");
                            try {
                                psdetailperiksalab.setString(1, rspasien.
                                        getString("no_rawat"));
                            ...
                            jm = 0;
                            psranapdr = koneksi.prepareStatement(
                                    "select sum(biaya_rawat) from rawat_inap_dr where no_rawat=?");
                            try {
                                psranapdr.setString(1, rspasien.getString(
                                        "no_rawat"));
                            ...
                            try {
                                psranapdrpr.setString(1, rspasien.getString(
                                        "no_rawat"));
                            ...
                            try {
                                psranappr.setString(1, rspasien.getString(
                                        "no_rawat"));
                            ...
                            psoperasi = koneksi.prepareStatement(
                                    "select sum(biayaoperator1+biayaoperator2+biayaoperator3+"
                            ...
                            try {
                                psoperasi.setString(1, rspasien.getString(
                                        "no_rawat"));
                            ...
                            try {
                                pstambahan.setString(1, rspasien.getString(
                                        "no_rawat"));
                            ...
                            try {
                                pspotongan.setString(1, rspasien.getString(
                                        "no_rawat"));
                            ...
                            psregistrasi = koneksi.prepareStatement(
                                    "select sum(biaya_reg) from reg_periksa where no_rawat=?");
                            try {
                                psregistrasi.setString(1, rspasien.getString(
                                        "no_rawat"));
                            ...
                            try {
                                psradiologi.setString(1, rspasien.getString(
                                        "no_rawat"));
                            ...
                            try {
                                pskamar.setString(1, rspasien.getString(
                                        "no_rawat"));
                            ...
                            tabMode.addRow(new Object[]{
                                "",
                                a + ". " + rspasien.getString("kd_kamar") + " " + rspasien.
                                getString("nm_pasien"),
                                rspasien.getString("tgl_masuk"), rspasien.
                                getString("tgl_keluar"),
                                rspasien.getString("png_jawab"), Valid.SetAngka(
                                obat + obatlangsung),
                                Valid.SetAngka(laborat + detaillaborat), Valid.
                                SetAngka(jm + jm2 + jm3 + operasi),
                                Valid.SetAngka(tambahan), Valid.SetAngka(
                                potongan), Valid.SetAngka(registrasi),
                                Valid.SetAngka(radiologi), Valid.SetAngka(kamar),
                                Valid.SetAngka(obat + obatlangsung + laborat
                ...
                tabMode.addRow(new Object[]{
                    ...
                    ttlobat + ttlobatlangsung),
                    Valid.SetAngka(ttllaborat + ttldetaillaborat), Valid.
                    SetAngka(ttljm), Valid.SetAngka(ttltambahan),
    ...
    private static final Logger LOG = Logger.getLogger(DlgRBTindakanKamar.class.
            getName());
