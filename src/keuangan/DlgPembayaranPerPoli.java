...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (int r = 0; r < row; r++) {
                ...
                try {
                    stringtotal = Valid.SetAngka(Double.parseDouble(tabMode.
            ...
            param.put("tanggal", Tgl1.getSelectedItem() + " SHIFT " + CmbStatus.
                    getSelectedItem().toString().toUpperCase());
            param.put("emailrs", akses.getemailrs());
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptPembayaranPerPoli.jasper", "report",
                    "[ Pembayaran Per Bagian/Unit ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPembayaranPerPoli dialog = new DlgPembayaranPerPoli(
    ...
    private void prosesCari() {
        try {
            ...
            pspoli = koneksi.prepareStatement(
                    "select kd_poli,nm_poli from poliklinik where nm_poli like ?");
            try {
                ...
                while (rspoli.next()) {
                    tabMode.
                            addRow(new Object[]{rspoli.getString(2), null, null});
                    psdokter = koneksi.prepareStatement(
                            "select dokter.kd_dokter,dokter.nm_dokter from reg_periksa inner join dokter "
                            + "on dokter.kd_dokter=reg_periksa.kd_dokter where reg_periksa.kd_poli=? and reg_periksa.tgl_registrasi=? group by dokter.kd_dokter");
                    try {
                        i = 1;
                        ...
                        while (rsdokter.next()) {
                            psjamshift = koneksi.prepareStatement(
                                    "select * from closing_kasir where shift like ?");
                            try {
                                psjamshift.setString(1, "%" + CmbStatus.
                                ...
                                while (rsjamshift.next()) {
                                    ...
                                    try {
                                        psmasuk.setString(1, rspoli.getString(
                                                "kd_poli"));
                                        psmasuk.setString(2, rsdokter.getString(
                                                "kd_dokter"));
                                        psmasuk.setString(3, Valid.SetTgl(Tgl1.
                                                getSelectedItem() + "") + " " + rsjamshift.
                                                        getString("jam_masuk"));
                                        if (rsjamshift.getString("shift").
                                                equals("Malam")) {
                                            psmasuk.setString(4, Sequel.cariIsi(
                                                    "select DATE_ADD('" + Valid.
                                                            SetTgl(Tgl1.
                                                                    getSelectedItem() + "") + " " + rsjamshift.
                                                            getString(
                                                                    "jam_pulang") + "',INTERVAL 1 DAY)"));
                                        } else {
                                            psmasuk.setString(4, Valid.SetTgl(
                                        ...
                                        while (rsmasuk.next()) {
                                            ...
                                            if (total > 0) {
                                                tabMode.addRow(new Object[]{
                                                    "  " + i + ". " + rsdokter.
                                                    getString("nm_dokter") + " ( " + rsjamshift.
                                                    getString("shift") + " ) ( " + rsmasuk.
                                                    getString(3) + " )", jmlpas,
                                                    total});
                                                i++;
                                            }
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgPembayaranPerPoli.class.getName());
