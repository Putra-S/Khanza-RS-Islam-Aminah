...
public class DlgPembayaranPerPoli extends javax.swing.JDialog {
    ...
    public DlgPembayaranPerPoli(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, row) {
            Class[] types = new Class[]{java.lang.Object.class, java.lang.Integer.class, java.lang.Double.class};
...
//GEN-FIRST:event_TKdKeyPressed
        ...
        try {
            ...
            try {
                ...
                while (rspoli.next()) {
                    ...
                    psdokter = koneksi
                            .prepareStatement("select dokter.kd_dokter,dokter.nm_dokter from reg_periksa inner join dokter "
                            ...
                            try {
                                ...
                                while (rsjamshift.next()) {
                                    ...
                                    try {
                                        ...
                                        psmasuk.setString(3, Valid.SetTgl(Tgl1.getSelectedItem() + "") + " "
                                                + rsjamshift.getString("jam_masuk"));
                                        if (rsjamshift.getString("shift").equals("Malam")) {
                                            psmasuk.setString(4, Sequel.cariIsi("select DATE_ADD('"
                                                    + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " "
                                                    + rsjamshift.getString("jam_pulang") + "',INTERVAL 1 DAY)"));
                                        } else {
                                            psmasuk.setString(4, Valid.SetTgl(Tgl1.getSelectedItem() + "") + " "
                                        ...
                                        while (rsmasuk.next()) {
                                            ...
                                            if (total > 0) {
                                                tabMode.addRow(
                                                        new Object[]{
                                                            "  " + i + ". " + rsdokter.getString("nm_dokter")
                                                            + " ( " + rsjamshift.getString("shift")
                                                            + " ) ( " + rsmasuk.getString(3) + " )",
                                                            jmlpas, total});
                                                i++;
                                            }
    ...
    private static final Logger LOG = Logger.getLogger(DlgPembayaranPerPoli.class.getName());
