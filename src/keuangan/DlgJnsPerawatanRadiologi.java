 ...
 * @author dosen
 */
public class DlgJnsPerawatanRadiologi extends javax.swing.JDialog {
    ...
    public DlgJnsPerawatanRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"P", "Kode Periksa", "Nama Pemeriksaan", "J.S. RS", "Paket BHP", "J.M. Perujuk", "J.M. Dokter",
            "J.M. Petugas", "K.S.O.", "Menejemen", "Total Tarif", "Jenis Bayar", "Kelas"};
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("jns_perawatan_radiologi",
                    "?,?,?,?,?,?,?,?,?,?,?,?,?", "Kode Periksa", 13,
                    new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbJnsPerawatan.getRowCount(); i++) {
            if (tbJnsPerawatan.getValueAt(i, 0).toString().equals("true")) {
                Sequel.mengedit("jns_perawatan_radiologi",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.mengedit("jns_perawatan_radiologi", "kd_jenis_prw=?",
                    "kd_jenis_prw=?,nm_perawatan=?,bagian_rs=?,tarif_tindakan_petugas=?,total_byr=?,kd_pj=?,tarif_tindakan_dokter=?,tarif_perujuk=?,bhp=?,kso=?,menejemen=?,kelas=?",
                    13, new String[]{
                        ...
                        getSelectedItem().toString(), tbJnsPerawatan.getValueAt(
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptTarifRad.jasper", "report",
                    ...
                    + " jns_perawatan_radiologi.status='1' and jns_perawatan_radiologi.kd_jenis_prw like '%" + TCari.
                            getText().trim() + "%' or "
                    + " jns_perawatan_radiologi.status='1' and jns_perawatan_radiologi.nm_perawatan like '%" + TCari.
                            getText().trim() + "%' or "
                    + " jns_perawatan_radiologi.status='1' and jns_perawatan_radiologi.kelas like '%" + TCari.
                            getText().trim() + "%' or "
                    + " jns_perawatan_radiologi.status='1' and penjab.png_jawab like '%" + TCari.
                            getText().trim() + "%' "
    ...
    private void MnRestoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRestoreActionPerformed
        DlgRestoreTarifRadiologi restore = new DlgRestoreTarifRadiologi(null,
                true);
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(kd_jenis_prw,5),signed)),0) from jns_perawatan_radiologi",
                "J", 6, TKd);
        TKd.requestFocus();
    }
    ...
    private void getData() {
        if (tbJnsPerawatan.getSelectedRow() != -1) {
            ...
            Sequel.cariIsi("select kd_pj from jns_perawatan_radiologi where kd_jenis_prw=?", kdpnj,
    ...
    private static final Logger LOG = Logger.getLogger(DlgJnsPerawatanRadiologi.class.getName());
