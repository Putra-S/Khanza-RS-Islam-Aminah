...
public class DlgJnsPerawatanRadiologi extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJnsPerawatanRadiologi dialog = new DlgJnsPerawatanRadiologi(
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(kd_jenis_prw,5),signed)),0) from jns_perawatan_radiologi",
                "J", 6, TKd);
        TKd.requestFocus();
    }
        ...
        if (tbJnsPerawatan.getSelectedRow() != -1) {
            ...
            TotalBiaya.setText(Valid.SetAngka2(Double.parseDouble(
                    tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),
                            10).toString())));
            Sequel.cariIsi(
                    "select kd_pj from jns_perawatan_radiologi where kd_jenis_prw=?",
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgJnsPerawatanRadiologi.class.getName());
