...
public class DlgPembayaranPerAKunBayar extends javax.swing.JDialog {
                    ...
                    try {
                        ...
                        while (rs.next()) {
                            ...
                            if (CmbStatus.getSelectedItem().toString().equals("Semua")) {
                                ...
                                nopemasukanlain = "";
                                nodeposit = "";
                                nonota = Sequel.cariIsi("select no_nota from nota_inap where no_rawat=?",
                                    ...
                                    for (i = 0; i < kolom; i++) {
                                        ...
                                        if (!norawatinap.isEmpty()) {
                                            ...
                                            bayar = Sequel.cariIsiAngka(
                                                    ...
                                                    + nopemasukanlain
                                                    + "' and kategori_pemasukan_lain.kd_rek2='" + akunbayar[i]
                                                    + "'");
                                            htmlContent.append("<td valign='middle' align='right'>")
                                                    .append(Valid.SetAngka(bayar))
                                                    .append("</td>");
    ...
    private void tampil2() {
        ...
        try {
            ...
            if (kolom == 0) {
                ...
                LoadHTML2.setText("<html>" + "<table width='" + Integer.toString(700 + (kolom * 90))
                        + "px' border='0' align='left' cellpadding='3px' cellspacing='0' class='tbl_form'>"
                        + htmlContent.toString() + "</table>" + "</html>");
            }
        } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgPembayaranPerAKunBayar.class.getName());
