...
public class DlgLhtBankMandiri extends javax.swing.JDialog {
    ...
    public DlgLhtBankMandiri(java.awt.Frame parent, boolean modal) {
        ...
        setSize(885, 674);
        Object[] rowRwJlDr = {"No.RM", "Nama Pasien", "Alamat", "J.K.", "Tgl.Lahir", "Umur", "Registrasi",
            "No.Nota/Tagihan", "Besar Bayar", "No.Rawat", "No.ID Reg", "Status Pelayanan", "Tgl.Closing",
            "Status Bayar", "Pembatalan", "Dibatalkan Oleh", "Besar Batal", "Kasir", "Tambahan 1", "Tambahan 2",
            "Tambahan 3", "Diupdate Bank", "Referensi"};
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select * from tagihan_mandiri where tagihan_mandiri.tgl_closing between ? and ? "
                            + (TCari.getText().isEmpty() ? ""
                            : "and (tagihan_mandiri.no_rkm_medis like ? or tagihan_mandiri.nm_pasien like ? or "
                            ...
                            + "tagihan_mandiri.referensi like ? or tagihan_mandiri.no_id like ?) ")
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{rs.getString("no_rkm_medis"), rs.getString("nm_pasien"),
                        rs.getString("alamat"), rs.getString("jk"), rs.getString("tgl_lahir"),
                        rs.getString("umurdaftar"), rs.getString("tgl_registrasi"), rs.getString("no_nota"),
                        Valid.SetAngka(rs.getDouble("besar_bayar")), rs.getString("no_rawat"),
                        rs.getString("no_id"), rs.getString("status_lanjut"), rs.getString("tgl_closing"),
                        rs.getString("status_bayar"), rs.getString("pembatalan"), rs.getString("dibatalkan_oleh"),
                        Valid.SetAngka(rs.getDouble("besar_batal")), rs.getString("kasir"),
                        rs.getString("tambahan1"), rs.getString("tambahan2"), rs.getString("tambahan3"),
                        rs.getString("diupdatebank"), rs.getString("referensi")});
                }
                if (total > 0) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgLhtBankMandiri.class.getName());
