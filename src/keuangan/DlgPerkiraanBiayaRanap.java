 ...
 * @author perpustakaan
 */
public class DlgPerkiraanBiayaRanap extends javax.swing.JDialog {
    ...
    public DlgPerkiraanBiayaRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Kamar/Bangsal", "Perujuk", "Registrasi", "Tindakan",
                    "Obt+Emb+Tsl", "Retur Obat", "Resep Pulang", "Laborat", "Radiologi", "Potongan", "Tambahan",
                    "Kamar", "Operasi", "Harian", "Total", "Deposit", "Kekurangan", "Diagnosa Awal", "ICD 10",
                    "Perkiraan Tarif", "Limit"}) {
            @Override
        ...
        tabModeDiagnosa = new DefaultTableModel(null, new Object[]{"Kode", "Nama Penyakit", "Ciri-ciri Penyakit",
        ...
        tabModeNilaiRS = new DefaultTableModel(null,
                new Object[]{"Keterangan", "Lama Inap", "Biaya", "Diagnosa Penyerta", "Prosedur"}) {
        ...
        tabModeNilaiINACBG = new DefaultTableModel(null,
                new Object[]{"Keterangan", "Lama Inap", "Biaya", "Diagnosa Penyerta", "Prosedur"}) {
            Class[] types = new Class[]{java.lang.Object.class, java.lang.Object.class, java.lang.Double.class,
                java.lang.Object.class, java.lang.Object.class};
...
private void BtnCari1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCari1KeyPressed
    ...
    private void tbDiagnosaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDiagnosaMouseClicked
        if (tbDiagnosa.getSelectedRow() != -1) {
            try {
                ...
                try {
                    ps.setString(1, tbDiagnosa.getValueAt(tbDiagnosa.
                            getSelectedRow(), 0).toString());
                    rs = ps.executeQuery();
                    if (rs.next()) {
                        diag = "";
                        ps2 = koneksi.prepareStatement(
                                "select diagnosa_pasien.kd_penyakit from diagnosa_pasien where diagnosa_pasien.no_rawat=? and diagnosa_pasien.status='Ranap' and diagnosa_pasien.prioritas>'1'");
                        try {
                        ...
                        pros = "";
                        ps2 = koneksi.prepareStatement(
                                "select prosedur_pasien.kode from prosedur_pasien where prosedur_pasien.no_rawat=? and prosedur_pasien.status='Ranap'");
                        try {
                            ps2.setString(1, rs.getString("no_rawat"));
                            rs2 = ps2.executeQuery();
                            while (rs2.next()) {
                        ...
                        tabModeNilaiRS.addRow(new Object[]{
                            "Tarif rawat inap tertinggi diagnosa " + tbDiagnosa.
                            getValueAt(tbDiagnosa.getSelectedRow(), 0).
                            toString(), Sequel.cariIsi(
                            "select sum(lama) from kamar_inap where no_rawat=?",
                            rs.getString("no_rawat")), rs.getDouble("biaya"),
                            diag, pros
                        });
                    }
                } catch (Exception e) {
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        tabModeNilaiRS.addRow(new Object[]{
                            "Tarif rawat inap terendah diagnosa " + tbDiagnosa.
                            getValueAt(tbDiagnosa.getSelectedRow(), 0).
                            toString(), Sequel.cariIsi(
                            "select sum(lama) from kamar_inap where no_rawat=?",
                            rs.getString("no_rawat")), rs.getDouble("biaya"),
        ...
        if (tbBangsal.getSelectedRow() != -1) {
            if (tbDiagnosa.getSelectedRow() != -1) {
                if (tbNilaiRS.getSelectedRow() != -1) {
                    Sequel.meghapus("perkiraan_biaya_ranap", "no_rawat",
                            tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 0).
                                    toString());
                    if (Sequel.menyimpantf2("perkiraan_biaya_ranap", "?,?,?",
                            "data", 3, new String[]{tbBangsal.getValueAt(
                                        tbBangsal.getSelectedRow(), 0).
                                        toString(), tbDiagnosa.getValueAt(
                                        tbDiagnosa.getSelectedRow(), 0).
                                        toString(), tbNilaiRS.getValueAt(
                                        tbNilaiRS.getSelectedRow(), 2).
                                        toString()}) == true) {
                        tampil();
                    } else {
                        JOptionPane.showMessageDialog(null,
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Silahkan Anda pilih dulu perkiraan biaya pasien yang mau dimasukkan perkiraannya ...!!");
                }
            } else {
                JOptionPane.showMessageDialog(null,
                ...
                if (tbNilaiINACBG.getSelectedRow() != -1) {
                    ...
                    if (Sequel.menyimpantf2("perkiraan_biaya_ranap", "?,?,?",
                            "data", 3, new String[]{tbBangsal.getValueAt(
                                        ...
                                        toString(), tbDiagnosa.getValueAt(
                                        tbDiagnosa.getSelectedRow(), 0).
                                        toString(), tbNilaiINACBG.getValueAt(
                                        tbNilaiINACBG.getSelectedRow(), 2).
                                        toString()}) == true) {
                        tampil();
                    } else {
                        JOptionPane.showMessageDialog(null,
        ...
        if (tbBangsal.getSelectedRow() != -1) {
            if (tbDiagnosa.getSelectedRow() != -1) {
                loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.
                        PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/" + "inacbg/pages/perkiraantarif.php?usere=" + koneksiDB.
                        USERHYBRIDWEB() + "&passwordte=" + koneksiDB.
                                PASHYBRIDWEB() + "&norawat=" + tbBangsal.
                                getValueAt(tbBangsal.getSelectedRow(), 0).
                                toString() + "&penyakit=" + tbDiagnosa.
                                getValueAt(tbDiagnosa.getSelectedRow(), 0).
                                toString());
            } else {
                JOptionPane.showMessageDialog(null,
    ...
    private void tbBangsalMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbBangsalMouseClicked
        if (tbBangsal.getSelectedRow() != -1) {
            Diagnosa.setText(tbBangsal.
                    getValueAt(tbBangsal.getSelectedRow(), 20).toString());
        }
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        Sequel
                        .cariIsi("select perujuk from rujuk_masuk where no_rawat=?", rs.getString("no_rawat")),
                        ...
                        Valid.SetAngka(perkiraantarif), pros});
    ...
    private void tampildiagnosa() {
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    tabModeDiagnosa.addRow(new Object[]{rs.getString(1), rs.getString(2), rs.getString(3),
    ...
    private static final Logger LOG = Logger.getLogger(DlgPerkiraanBiayaRanap.class.getName());
