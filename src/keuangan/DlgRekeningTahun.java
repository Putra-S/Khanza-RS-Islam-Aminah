...
public class DlgRekeningTahun extends javax.swing.JDialog {
    ...
    public DlgRekeningTahun(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Tahun", "Kode Rekening", "Nama Rekening", "Tipe", "Balance", "Saldo Awal", "Mutasi Debet",
...
private void NmKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmKeyPressed
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (saldoakhir < 0) {
                        tabMode.addRow(new Object[]{rs.getString(1).substring(0, 4), rs.getString(2), rs.getString(3),
                            rs.getString(4), rs.getString(5), df2.format(rs.getDouble(6)), df2.format(md),
                            df2.format(mk), "(" + df2.format(saldoakhir * (-1)) + ")"});
                    } else {
                        tabMode.addRow(new Object[]{rs.getString(1).substring(0, 4), rs.getString(2), rs.getString(3),
                            rs.getString(4), rs.getString(5), df2.format(rs.getDouble(6)), df2.format(md),
                            df2.format(mk), df2.format(saldoakhir)});
                    }
    ...
    private static final Logger LOG = Logger.getLogger(DlgRekeningTahun.class.getName());
