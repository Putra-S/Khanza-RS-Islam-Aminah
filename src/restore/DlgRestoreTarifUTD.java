 ...
 * @author dosen
 */
public class DlgRestoreTarifUTD extends javax.swing.JDialog {
    ...
    public DlgRestoreTarifUTD(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"P", "Kode Periksa", "Nama Pemeriksaan", "J.S.Rumah Sakit", "Paket BHP", "J.M.Perujuk",
            "J.M. Dokter", "J.M. Petugas", "K.S.O.", "Menejemen", "Total Tarif", "Jenis Bayar"};
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbJnsPerawatan.getRowCount(); i++) {
            if (tbJnsPerawatan.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("jns_perawatan_utd", "kd_jenis_prw",
    ...
    private static final Logger LOG = Logger.getLogger(DlgRestoreTarifUTD.class.getName());
