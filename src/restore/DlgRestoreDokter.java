...
public class DlgRestoreDokter extends javax.swing.JDialog {
    ...
    public DlgRestoreDokter(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"P", "Kode Dokter", "Nama Dokter", "J.K.", "Tmp.Lahir", "Tgl.Lahir", "G.D.", "Agama",
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select dokter.kd_dokter,dokter.nm_dokter,dokter.jk,dokter.tmp_lahir, "
                    ...
                    + "dokter.status='0' and dokter.no_ijn_praktek like ? " + "order by dokter.kd_dokter");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(DlgRestoreDokter.class.getName());
