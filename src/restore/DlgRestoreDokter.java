 ...
 * @author dosen
 */
public class DlgRestoreDokter extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        for (i = 0; i < tbObat.getRowCount(); i++) {
            if (tbObat.getValueAt(i, 0).toString().equals("true")) {
                Sequel.mengedit("dokter", "kd_dokter='" + tbObat.
                        getValueAt(i, 1).toString() + "'", "status='1'");
                Sequel.mengedit("pegawai", "nik='" + tbObat.getValueAt(i, 1).
                        toString() + "'", "stts_aktif='AKTIF'");
            }
        }
        BtnCariActionPerformed(evt);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbObat.getRowCount(); i++) {
            if (tbObat.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("dokter", "kd_dokter", tbObat.getValueAt(i, 1).
                        toString());
            }
        }
        BtnCariActionPerformed(evt);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRestoreDokter dialog = new DlgRestoreDokter(
    ...
    private static final Logger LOG = Logger.getLogger(DlgRestoreDokter.class.
            getName());
