 ...
 * @author dosen
 */
public class DlgRestorePetugas extends javax.swing.JDialog {
    ...
    public DlgRestorePetugas(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {
            "P", "NIP", "Nama Petugas", "J.K.", "Tmp.Lahir", "Tgl.Lahir", "G.D.",
            "Agama", "Stts.Nikah", "Alamat", "Jabatan", "No.Telp"
        };
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        for (i = 0; i < tbObat.getRowCount(); i++) {
            if (tbObat.getValueAt(i, 0).toString().equals("true")) {
                Sequel.mengedit("petugas", "nip='" + tbObat.getValueAt(i, 1).
                        toString() + "'", "status='1'");
            }
        }
        BtnCariActionPerformed(evt);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbObat.getRowCount(); i++) {
            if (tbObat.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("petugas", "nip", tbObat.getValueAt(i, 1).
                        toString());
            }
        }
        BtnCariActionPerformed(evt);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRestorePetugas dialog = new DlgRestorePetugas(
    ...
    private static final Logger LOG = Logger.getLogger(DlgRestorePetugas.class.
            getName());
