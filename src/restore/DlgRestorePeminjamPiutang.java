 ...
 * @author dosen
 */
public class DlgRestorePeminjamPiutang extends javax.swing.JDialog {
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbKamar.getSelectedRow() > -1) {
            Sequel.meghapus("peminjampiutang", "kode_peminjam", tbKamar.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRestorePeminjamPiutang dialog = new DlgRestorePeminjamPiutang(
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgRestorePeminjamPiutang.class.getName());
