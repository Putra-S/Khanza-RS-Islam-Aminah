 ...
 * @author dosen
 */
public class DlgRestoreTarifLab extends javax.swing.JDialog {
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbJnsPerawatan.getRowCount(); i++) {
            if (tbJnsPerawatan.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("jns_perawatan_lab", "kd_jenis_prw",
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    Object[] data = {false, rs.getString(1), rs.getString(2), rs.getDouble(3), rs.getDouble(4),
    ...
    private static final Logger LOG = Logger.getLogger(DlgRestoreTarifLab.class.getName());
