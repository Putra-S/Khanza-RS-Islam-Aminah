 ...
 * @author dosen
 */
public class DlgRestoreDapurBarang extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        for (i = 0; i < tbObat.getRowCount(); i++) {
            if (tbObat.getValueAt(i, 0).toString().equals("true")) {
                Sequel.mengedit("dapurbarang", "kode_brng='" + tbObat.
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbObat.getRowCount(); i++) {
            if (tbObat.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("dapurbarang", "kode_brng", tbObat.getValueAt(i,
                        1).toString());
            }
        }
        BtnCariActionPerformed(evt);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRestoreDapurBarang dialog = new DlgRestoreDapurBarang(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        ...
                        "jenis"), rs.getDouble("stok"), rs.getDouble("harga")
                    });
                }
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgRestoreDapurBarang.class.getName());
