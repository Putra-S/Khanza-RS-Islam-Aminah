...
public class DlgRestoreDapurBarang extends javax.swing.JDialog {
    ...
    public DlgRestoreDapurBarang(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"P", "Kode Barang", "Nama Barang", "Satuan", "Jenis", "Stok", "Harga"};
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString("kode_brng"), rs.getString("nama_brng"),
                        rs.getString("satuan"), rs.getString("jenis"), rs.getDouble("stok"),
                        rs.getDouble("harga")});
                }
    ...
    private static final Logger LOG = Logger.getLogger(DlgRestoreDapurBarang.class.getName());
