 ...
 * @author dosen
 */
public class DlgRestoreIPSRSBarang extends javax.swing.JDialog {
    ...
    public DlgRestoreIPSRSBarang(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {
            "P", "Kode Barang", "Nama Barang", "Satuan", "Jenis", "Stok",
            "Harga"
        };
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        for (i = 0; i < tbObat.getRowCount(); i++) {
            if (tbObat.getValueAt(i, 0).toString().equals("true")) {
                Sequel.mengedit("ipsrsbarang", "kode_brng='" + tbObat.
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbObat.getRowCount(); i++) {
            if (tbObat.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("ipsrsbarang", "kode_brng", tbObat.getValueAt(i,
                        1).toString());
            }
        }
        BtnCariActionPerformed(evt);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRestoreIPSRSBarang dialog = new DlgRestoreIPSRSBarang(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        ...
                        "nm_jenis"), rs.getDouble("stok"), rs.getDouble("harga")
                    });
                }
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgRestoreIPSRSBarang.class.getName());
