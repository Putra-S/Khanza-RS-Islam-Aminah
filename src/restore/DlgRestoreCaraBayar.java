 ...
 * @author dosen
 */
public class DlgRestoreCaraBayar extends javax.swing.JDialog {
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbKamar.getRowCount(); i++) {
            if (tbKamar.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("penjab", "kd_pj", tbKamar.getValueAt(i, 1).
                        toString());
            }
        }
        BtnCariActionPerformed(evt);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select kd_pj, png_jawab, nama_perusahaan, alamat_asuransi, no_telp,attn "
    ...
    private static final Logger LOG = Logger.getLogger(DlgRestoreCaraBayar.class.getName());
