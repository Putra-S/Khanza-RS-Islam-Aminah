 ...
 * @author dosen
 */
public class DlgRestoreKamar extends javax.swing.JDialog {
    ...
    public DlgRestoreKamar(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"P", "Nomer Bed", "Kode Kamar", "Nama Kamar", "Kelas", "Tarif Kamar", "Status Kamar"}) {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        for (i = 0; i < tbJnsPerawatan.getRowCount(); i++) {
            if (tbJnsPerawatan.getValueAt(i, 0).toString().equals("true")) {
                Sequel.mengedit("kamar", "kd_kamar='" + tbJnsPerawatan.
                        getValueAt(i, 1).toString() + "'", "statusdata='1'");
            }
        }
        BtnCariActionPerformed(evt);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbJnsPerawatan.getRowCount(); i++) {
            if (tbJnsPerawatan.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("kamar", "kd_kamar", tbJnsPerawatan.
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select kamar.kd_kamar,kamar.kd_bangsal,bangsal.nm_bangsal, "
                    ...
                    + "kamar.statusdata='0' and kamar.status like ? " + "order by bangsal.nm_bangsal");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(DlgRestoreKamar.class.getName());
