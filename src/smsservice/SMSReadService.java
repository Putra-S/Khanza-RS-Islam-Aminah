...
public class SMSReadService {
    ...
    public void startService() throws Exception {
        ...
        SerialModemGateway gateway = new SerialModemGateway(prop.getProperty("GATEWAYNAME"), // nama
                // GAteway
    ...
    class PesanMasukHandler implements IInboundMessageNotification {
        ...
        public void process(AGateway ag, MessageTypes tipePesan, InboundMessage pesanMasuk) {
            ...
            } catch (IOException | InterruptedException | GatewayException | TimeoutException e) {
            }
        }
    ...
    private static final Logger LOG = Logger.getLogger(SMSReadService.class.getName());
