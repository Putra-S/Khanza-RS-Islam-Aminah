...
public class akses {
  ...
  private static int jml2 = 0, lebar = 0, tinggi = 0;
    ...
    try {
      ps =
          koneksi.prepareStatement(
              "select * from admin where admin.usere=AES_ENCRYPT(?,'nur') and admin.passworde=AES_ENCRYPT(?,'windi')");
      ps2 =
          koneksi.prepareStatement(
              "select * from user where user.id_user=AES_ENCRYPT(?,'nur') and user.password=AES_ENCRYPT(?,'windi')");
      try {
        ps.setString(1, user);
        ps.setString(2, pass);
        rs = ps.executeQuery();
        ...
        if (rs.getRow() >= 1) {
          ...
          akses.inhealth_referensi_jenpel_ruang_rawat =
              rs2.getBoolean("inhealth_referensi_jenpel_ruang_rawat");
          ...
          akses.grafik_kunjungan_statusdaftartahun =
              rs2.getBoolean("grafik_kunjungan_statusdaftartahun");
          akses.grafik_kunjungan_statusdaftartahun2 =
              rs2.getBoolean("grafik_kunjungan_statusdaftartahun2");
          akses.grafik_kunjungan_statusdaftarbulan =
              rs2.getBoolean("grafik_kunjungan_statusdaftarbulan");
          akses.grafik_kunjungan_statusdaftarbulan2 =
              rs2.getBoolean("grafik_kunjungan_statusdaftarbulan2");
          akses.grafik_kunjungan_statusdaftartanggal =
              rs2.getBoolean("grafik_kunjungan_statusdaftartanggal");
          akses.grafik_kunjungan_statusdaftartanggal2 =
              rs2.getBoolean("grafik_kunjungan_statusdaftartanggal2");
          akses.grafik_kunjungan_statusbataltahun =
              rs2.getBoolean("grafik_kunjungan_statusbataltahun");
          akses.grafik_kunjungan_statusbatalbulan =
              rs2.getBoolean("grafik_kunjungan_statusbatalbulan");
          akses.pcare_cek_penyakit = rs2.getBoolean("pcare_cek_penyakit");
          akses.grafik_kunjungan_statusbataltanggal =
              rs2.getBoolean("grafik_kunjungan_statusbataltanggal");
          ...
          akses.grafik_limbahdomestik_pertanggal =
              rs2.getBoolean("grafik_limbahdomestik_pertanggal");
          ...
          akses.skrining_ralan_pernapasan_pertahun =
              rs2.getBoolean("skrining_ralan_pernapasan_pertahun");
          ...
          akses.grafik_pengajuan_aset_departemen =
              rs2.getBoolean("grafik_pengajuan_aset_departemen");
          ...
          akses.inhealth_mapping_tindakan_radiologi =
              rs2.getBoolean("inhealth_mapping_tindakan_radiologi");
          akses.inhealth_mapping_tindakan_laborat =
              rs2.getBoolean("inhealth_mapping_tindakan_laborat");
          akses.inhealth_mapping_tindakan_operasi =
              rs2.getBoolean("inhealth_mapping_tindakan_operasi");
          ...
          akses.penilaian_awal_keperawatan_ralan =
              rs2.getBoolean("penilaian_awal_keperawatan_ralan");
          ...
          akses.penilaian_awal_keperawatan_kebidanan =
              rs2.getBoolean("penilaian_awal_keperawatan_kebidanan");
          ...
          akses.zis_ukuran_rumah_penerima_dankes =
              rs2.getBoolean("zis_ukuran_rumah_penerima_dankes");
          akses.zis_dinding_rumah_penerima_dankes =
              rs2.getBoolean("zis_dinding_rumah_penerima_dankes");
          akses.zis_lantai_rumah_penerima_dankes =
              rs2.getBoolean("zis_lantai_rumah_penerima_dankes");
          akses.zis_atap_rumah_penerima_dankes = rs2.getBoolean("zis_atap_rumah_penerima_dankes");
          akses.zis_kepemilikan_rumah_penerima_dankes =
              rs2.getBoolean("zis_kepemilikan_rumah_penerima_dankes");
          ...
          akses.zis_kategori_phbs_penerima_dankes =
              rs2.getBoolean("zis_kategori_phbs_penerima_dankes");
          ...
          akses.zis_jenis_simpanan_penerima_dankes =
              rs2.getBoolean("zis_jenis_simpanan_penerima_dankes");
          akses.penilaian_awal_keperawatan_anak = rs2.getBoolean("penilaian_awal_keperawatan_anak");
          akses.zis_kategori_asnaf_penerima_dankes =
              rs2.getBoolean("zis_kategori_asnaf_penerima_dankes");
          ...
          akses.bulanan_klasifikasi_pasien_ranap =
              rs2.getBoolean("bulanan_klasifikasi_pasien_ranap");
          ...
          akses.penilaian_awal_keperawatan_ranapkebidanan =
              rs2.getBoolean("penilaian_awal_keperawatan_ranapkebidanan");
          ...
          akses.batal_pendaftaran_mobilejkn_bpjs =
              rs2.getBoolean("batal_pendaftaran_mobilejkn_bpjs");
          ...
          akses.penilaian_awal_medis_ranap_kebidanan =
              rs2.getBoolean("penilaian_awal_medis_ranap_kebidanan");
          akses.penilaian_awal_medis_ralan_kebidanan =
              rs2.getBoolean("penilaian_awal_medis_ralan_kebidanan");
          ...
          akses.grafik_perbaikan_inventaris_pertanggal =
              rs2.getBoolean("grafik_perbaikan_inventaris_pertanggal");
          akses.grafik_perbaikan_inventaris_perbulan =
              rs2.getBoolean("grafik_perbaikan_inventaris_perbulan");
          akses.grafik_perbaikan_inventaris_pertahun =
              rs2.getBoolean("grafik_perbaikan_inventaris_pertahun");
          akses.grafik_perbaikan_inventaris_perpelaksana_status =
              rs2.getBoolean("grafik_perbaikan_inventaris_perpelaksana_status");
          ...
          akses.ringkasan_biaya_obat_pasien_pertanggal =
              rs2.getBoolean("ringkasan_biaya_obat_pasien_pertanggal");
          ...
          akses.bpjs_referensi_spesialistik_apotek =
              rs2.getBoolean("bpjs_referensi_spesialistik_apotek");
          akses.pembayaran_briva = rs2.getBoolean("pembayaran_briva");
          akses.penilaian_awal_keperawatan_ranap =
              rs2.getBoolean("penilaian_awal_keperawatan_ranap");
          akses.nilai_penerimaan_vendor_farmasi_perbulan =
              rs2.getBoolean("nilai_penerimaan_vendor_farmasi_perbulan");
          ...
          akses.nilai_penerimaan_vendor_nonmedis_perbulan =
              rs2.getBoolean("nilai_penerimaan_vendor_nonmedis_perbulan");
          akses.ringkasan_hutang_vendor_nonmedis =
              rs2.getBoolean("ringkasan_hutang_vendor_nonmedis");
          ...
          akses.catatan_observasi_ranap_kebidanan =
              rs2.getBoolean("catatan_observasi_ranap_kebidanan");
          akses.catatan_observasi_ranap_postpartum =
              rs2.getBoolean("catatan_observasi_ranap_postpartum");
          ...
          akses.audit_fasilitas_kebersihan_tangan =
              rs2.getBoolean("audit_fasilitas_kebersihan_tangan");
          akses.audit_fasilitas_apd = rs2.getBoolean("audit_fasilitas_apd");
          akses.audit_pembuangan_limbah_cair_infeksius =
              rs2.getBoolean("audit_pembuangan_limbah_cair_infeksius");
          akses.audit_sterilisasi_alat = rs2.getBoolean("audit_sterilisasi_alat");
          akses.penilaian_awal_medis_ralan_psikiatri =
              rs2.getBoolean("penilaian_awal_medis_ralan_psikiatri");
          ...
          akses.penilaian_awal_medis_ralan_penyakit_dalam =
              rs2.getBoolean("penilaian_awal_medis_ralan_penyakit_dalam");
          akses.penilaian_awal_medis_ralan_mata = rs2.getBoolean("penilaian_awal_medis_ralan_mata");
          akses.penilaian_awal_medis_ralan_neurologi =
              rs2.getBoolean("penilaian_awal_medis_ralan_neurologi");
          akses.sirkulasi_obat6 = rs2.getBoolean("sirkulasi_obat6");
          akses.penilaian_awal_medis_ralan_orthopedi =
              rs2.getBoolean("penilaian_awal_medis_ralan_orthopedi");
          akses.penilaian_awal_medis_ralan_bedah =
              rs2.getBoolean("penilaian_awal_medis_ralan_bedah");
          akses.integrasi_khanza_health_services =
              rs2.getBoolean("integrasi_khanza_health_services");
          ...
          akses.master_masalah_keperawatan_psikiatri =
              rs2.getBoolean("master_masalah_keperawatan_psikiatri");
          akses.master_rencana_keperawatan_psikiatri =
              rs2.getBoolean("master_rencana_keperawatan_psikiatri");
          akses.penilaian_awal_keperawatan_psikiatri =
              rs2.getBoolean("penilaian_awal_keperawatan_psikiatri");
          akses.pemantauan_pews_anak = rs2.getBoolean("pemantauan_pews_anak");
          akses.surat_pulang_atas_permintaan_sendiri =
              rs2.getBoolean("surat_pulang_atas_permintaan_sendiri");
          ...
          akses.penilaian_lanjutan_resiko_jatuh_dewasa =
              rs2.getBoolean("penilaian_lanjutan_resiko_jatuh_dewasa");
          akses.penilaian_lanjutan_resiko_jatuh_anak =
              rs2.getBoolean("penilaian_lanjutan_resiko_jatuh_anak");
          akses.penilaian_awal_medis_ralan_geriatri =
              rs2.getBoolean("penilaian_awal_medis_ralan_geriatri");
          akses.penilaian_tambahan_pasien_geriatri =
              rs2.getBoolean("penilaian_tambahan_pasien_geriatri");
          ...
          akses.satu_sehat_kirim_clinicalimpression =
              rs2.getBoolean("satu_sehat_kirim_clinicalimpression");
          ...
          akses.penilaian_lanjutan_resiko_jatuh_lansia =
              rs2.getBoolean("penilaian_lanjutan_resiko_jatuh_lansia");
          akses.mpp_skrining = rs2.getBoolean("mpp_skrining");
          akses.penilaian_pasien_penyakit_menular =
              rs2.getBoolean("penilaian_pasien_penyakit_menular");
          ...
          akses.penilaian_tambahan_perilaku_kekerasan =
              rs2.getBoolean("penilaian_tambahan_perilaku_kekerasan");
          akses.penilaian_tambahan_beresiko_melarikan_diri =
              rs2.getBoolean("penilaian_tambahan_beresiko_melarikan_diri");
          ...
          akses.penilaian_awal_medis_ralan_bedah_mulut =
              rs2.getBoolean("penilaian_awal_medis_ralan_bedah_mulut");
          ...
          akses.penilaian_awal_keperawatan_ralan_geriatri =
              rs2.getBoolean("penilaian_awal_keperawatan_ralan_geriatri");
          akses.master_masalah_keperawatan_geriatri =
              rs2.getBoolean("master_masalah_keperawatan_geriatri");
          akses.master_rencana_keperawatan_geriatri =
              rs2.getBoolean("master_rencana_keperawatan_geriatri");
          ...
          akses.laporan_tahunan_penolakan_anjuran_medis =
              rs2.getBoolean("laporan_tahunan_penolakan_anjuran_medis");
          ...
          akses.pemeriksaan_fisik_ralan_per_penyakit =
              rs2.getBoolean("pemeriksaan_fisik_ralan_per_penyakit");
          akses.penilaian_lanjutan_resiko_jatuh_geriatri =
              rs2.getBoolean("penilaian_lanjutan_resiko_jatuh_geriatri");
          akses.pemantauan_ews_neonatus = rs2.getBoolean("pemantauan_ews_neonatus");
          akses.validasi_persetujuan_pengajuan_biaya =
              rs2.getBoolean("validasi_persetujuan_pengajuan_biaya");
          ...
          akses.penilaian_awal_medis_ralan_kulit_kelamin =
              rs2.getBoolean("penilaian_awal_medis_ralan_kulit_kelamin");
          ...
          akses.penilaian_level_kecemasan_ranap_anak =
              rs2.getBoolean("penilaian_level_kecemasan_ranap_anak");
          akses.penilaian_lanjutan_resiko_jatuh_psikiatri =
              rs2.getBoolean("penilaian_lanjutan_resiko_jatuh_psikiatri");
          akses.penilaian_lanjutan_skrining_fungsional =
              rs2.getBoolean("penilaian_lanjutan_skrining_fungsional");
          akses.penilaian_medis_ralan_rehab_medik =
              rs2.getBoolean("penilaian_medis_ralan_rehab_medik");
          akses.laporan_anestesi = rs2.getBoolean("laporan_anestesi");
          akses.template_persetujuan_penolakan_tindakan =
              rs2.getBoolean("template_persetujuan_penolakan_tindakan");
          akses.penilaian_medis_ralan_gawat_darurat_psikiatri =
              rs2.getBoolean("penilaian_medis_ralan_gawat_darurat_psikiatri");
          ...
          akses.bpjs_daftar_pelayanan_obat_apotek =
              rs2.getBoolean("bpjs_daftar_pelayanan_obat_apotek");
          ...
          akses.satu_sehat_kirim_medicationrequest =
              rs2.getBoolean("satu_sehat_kirim_medicationrequest");
          akses.penatalaksanaan_terapi_okupasi = rs2.getBoolean("penatalaksanaan_terapi_okupasi");
          akses.satu_sehat_kirim_medicationdispense =
              rs2.getBoolean("satu_sehat_kirim_medicationdispense");
          ...
          akses.satu_sehat_kirim_servicerequest_radiologi =
              rs2.getBoolean("satu_sehat_kirim_servicerequest_radiologi");
          akses.hasil_endoskopi_hidung = rs2.getBoolean("hasil_endoskopi_hidung");
          akses.satu_sehat_kirim_specimen_radiologi =
              rs2.getBoolean("satu_sehat_kirim_specimen_radiologi");
          akses.master_masalah_keperawatan_neonatus =
              rs2.getBoolean("master_masalah_keperawatan_neonatus");
          akses.master_rencana_keperawatan_neonatus =
              rs2.getBoolean("master_rencana_keperawatan_neonatus");
          akses.penilaian_awal_keperawatan_ranap_neonatus =
              rs2.getBoolean("penilaian_awal_keperawatan_ranap_neonatus");
          akses.satu_sehat_kirim_observation_radiologi =
              rs2.getBoolean("satu_sehat_kirim_observation_radiologi");
          akses.satu_sehat_kirim_diagnosticreport_radiologi =
              rs2.getBoolean("satu_sehat_kirim_diagnosticreport_radiologi");
          ...
          akses.satu_sehat_kirim_servicerequest_lab =
              rs2.getBoolean("satu_sehat_kirim_servicerequest_lab");
          akses.satu_sehat_kirim_servicerequest_labmb =
              rs2.getBoolean("satu_sehat_kirim_servicerequest_labmb");
          ...
          akses.satu_sehat_kirim_observation_lab =
              rs2.getBoolean("satu_sehat_kirim_observation_lab");
          akses.satu_sehat_kirim_observation_labmb =
              rs2.getBoolean("satu_sehat_kirim_observation_labmb");
          akses.satu_sehat_kirim_diagnosticreport_lab =
              rs2.getBoolean("satu_sehat_kirim_diagnosticreport_lab");
          akses.satu_sehat_kirim_diagnosticreport_labmb =
              rs2.getBoolean("satu_sehat_kirim_diagnosticreport_labmb");
          akses.kepatuhan_kelengkapan_keselamatan_bedah =
              rs2.getBoolean("kepatuhan_kelengkapan_keselamatan_bedah");
          akses.nilai_piutang_perjenis_bayar_per_bulan =
              rs2.getBoolean("nilai_piutang_perjenis_bayar_per_bulan");
          akses.ringkasan_piutang_jenis_bayar = rs2.getBoolean("ringkasan_piutang_jenis_bayar");
          akses.penilaian_pasien_imunitas_rendah =
              rs2.getBoolean("penilaian_pasien_imunitas_rendah");
          akses.balance_cairan = rs2.getBoolean("balance_cairan");
          akses.catatan_observasi_chbp = rs2.getBoolean("catatan_observasi_chbp");
          akses.catatan_observasi_induksi_persalinan =
              rs2.getBoolean("catatan_observasi_induksi_persalinan");
          ...
          akses.pembayaran_pihak_ke3_bankmandiri =
              rs2.getBoolean("pembayaran_pihak_ke3_bankmandiri");
          akses.metode_pembayaran_bankmandiri = rs2.getBoolean("metode_pembayaran_bankmandiri");
          akses.bank_tujuan_transfer_bankmandiri =
              rs2.getBoolean("bank_tujuan_transfer_bankmandiri");
          akses.kodetransaksi_tujuan_transfer_bankmandiri =
              rs2.getBoolean("kodetransaksi_tujuan_transfer_bankmandiri");
          ...
          akses.skrining_perilaku_merokok_sekolah_remaja =
              rs2.getBoolean("skrining_perilaku_merokok_sekolah_remaja");
          akses.skrining_kekerasan_pada_perempuan =
              rs2.getBoolean("skrining_kekerasan_pada_perempuan");
  ...
  public static void setkodeppkbpjs(String kode_ppk) {
    akses.kode_ppk = kode_ppk;
  }
  ...
  public static String getkodeppkbpjs() {
    return akses.kode_ppk;
  }
  ...
  public static void setperiksalabmbfalse() {
    akses.pemeriksaan_lab_mb = false;
  }
  ...
  public static boolean getchecklist_pre_operasi() {
  ...
  public static boolean getgrafik_limbahb3cair_pertanggal() {
    return akses.grafik_limbahb3cair_pertanggal;
  }

  public static boolean getgrafik_limbahb3cair_perbulan() {
    return akses.grafik_limbahb3cair_perbulan;
  }

  public static boolean getrekap_biaya_registrasi() {
    return akses.rekap_biaya_registrasi;
  }

  public static boolean getkonfirmasi_rekonsiliasi_obat() {
    return akses.konfirmasi_rekonsiliasi_obat;
  }
  ...
  public static boolean getpenilaian_pasien_terminal() {
    return akses.penilaian_pasien_terminal;
  }

  public static boolean getsurat_persetujuan_rawat_inap() {
    return akses.surat_persetujuan_rawat_inap;
  }

  public static boolean getmonitoring_reaksi_tranfusi() {
    return akses.monitoring_reaksi_tranfusi;
  }

  public static boolean getpenilaian_korban_kekerasan() {
    return akses.penilaian_korban_kekerasan;
  }

  public static boolean getpenilaian_lanjutan_resiko_jatuh_lansia() {
    return akses.penilaian_lanjutan_resiko_jatuh_lansia;
  }

  public static boolean getmpp_skrining() {
    return akses.mpp_skrining;
  }

  public static boolean getpenilaian_pasien_penyakit_menular() {
    return akses.penilaian_pasien_penyakit_menular;
  }

  public static boolean getedukasi_pasien_keluarga_rj() {
    return akses.edukasi_pasien_keluarga_rj;
  }

  public static boolean getpemantauan_pews_dewasa() {
    return akses.pemantauan_pews_dewasa;
  }

  public static boolean getpenilaian_tambahan_bunuh_diri() {
    return akses.penilaian_tambahan_bunuh_diri;
  }

  public static boolean getbpjs_antrean_pertanggal() {
    return akses.bpjs_antrean_pertanggal;
  }

  public static boolean getpenilaian_tambahan_perilaku_kekerasan() {
    return akses.penilaian_tambahan_perilaku_kekerasan;
  }

  public static boolean getpenilaian_tambahan_beresiko_melarikan_diri() {
    return akses.penilaian_tambahan_beresiko_melarikan_diri;
  }

  public static boolean getpersetujuan_penundaan_pelayanan() {
    return akses.persetujuan_penundaan_pelayanan;
  }

  public static boolean getsisa_diet_pasien() {
    return akses.sisa_diet_pasien;
  }

  public static boolean getpenilaian_awal_medis_ralan_bedah_mulut() {
    return akses.penilaian_awal_medis_ralan_bedah_mulut;
  }

  public static boolean getpenilaian_pasien_keracunan() {
    return akses.penilaian_pasien_keracunan;
  }

  public static boolean getpemantauan_meows_obstetri() {
    return akses.pemantauan_meows_obstetri;
  }

  public static boolean getcatatan_adime_gizi() {
    return akses.catatan_adime_gizi;
  }

  public static boolean getpengajuan_biaya() {
    return akses.pengajuan_biaya;
  }

  public static boolean getpenilaian_awal_keperawatan_ralan_geriatri() {
    return akses.penilaian_awal_keperawatan_ralan_geriatri;
  }

  public static boolean getmaster_masalah_keperawatan_geriatri() {
    return akses.master_masalah_keperawatan_geriatri;
  }

  public static boolean getmaster_rencana_keperawatan_geriatri() {
    return akses.master_rencana_keperawatan_geriatri;
  }

  public static boolean getchecklist_kriteria_masuk_hcu() {
    return akses.checklist_kriteria_masuk_hcu;
  }

  public static boolean getchecklist_kriteria_keluar_hcu() {
    return akses.checklist_kriteria_keluar_hcu;
  }

  public static boolean getpenilaian_risiko_dekubitus() {
    return akses.penilaian_risiko_dekubitus;
  }

  public static boolean getmaster_menolak_anjuran_medis() {
    return akses.master_menolak_anjuran_medis;
  }

  public static boolean getpenolakan_anjuran_medis() {
    return akses.penolakan_anjuran_medis;
  }

  public static boolean getlaporan_tahunan_penolakan_anjuran_medis() {
    return akses.laporan_tahunan_penolakan_anjuran_medis;
  }

  public static boolean gettemplate_laporan_operasi() {
    return akses.template_laporan_operasi;
  }

  public static boolean gethasil_tindakan_eswl() {
    return akses.hasil_tindakan_eswl;
  }

  public static boolean getchecklist_kriteria_masuk_icu() {
    return akses.checklist_kriteria_masuk_icu;
  }

  public static boolean getchecklist_kriteria_keluar_icu() {
    return akses.checklist_kriteria_keluar_icu;
  }

  public static boolean getakses_dokter_lain_rawat_jalan() {
    return akses.akses_dokter_lain_rawat_jalan;
  }

  public static boolean getfollow_up_dbd() {
    return akses.follow_up_dbd;
  }

  public static boolean getpenilaian_risiko_jatuh_neonatus() {
    return akses.penilaian_risiko_jatuh_neonatus;
  }

  public static boolean getpersetujuan_pengajuan_biaya() {
    return akses.persetujuan_pengajuan_biaya;
  }

  public static boolean getpemeriksaan_fisik_ralan_per_penyakit() {
    return akses.pemeriksaan_fisik_ralan_per_penyakit;
  }

  public static boolean getpenilaian_lanjutan_resiko_jatuh_geriatri() {
    return akses.penilaian_lanjutan_resiko_jatuh_geriatri;
  }

  public static boolean getpemantauan_ews_neonatus() {
    return akses.pemantauan_ews_neonatus;
  }

  public static boolean getvalidasi_persetujuan_pengajuan_biaya() {
    return akses.validasi_persetujuan_pengajuan_biaya;
  }

  public static boolean getriwayat_perawatan_icare_bpjs() {
    return akses.riwayat_perawatan_icare_bpjs;
  }

  public static boolean getrekap_pengajuan_biaya() {
    return akses.rekap_pengajuan_biaya;
  }

  public static boolean getpenilaian_awal_medis_ralan_kulit_kelamin() {
    return akses.penilaian_awal_medis_ralan_kulit_kelamin;
  }

  public static boolean getakun_host_to_host_bank_mandiri() {
    return akses.akun_host_to_host_bank_mandiri;
  }

  public static boolean getpenilaian_medis_ralan_hemodialisa() {
    return akses.penilaian_medis_hemodialisa;
  }

  public static boolean getpenilaian_level_kecemasan_ranap_anak() {
    return akses.penilaian_level_kecemasan_ranap_anak;
  }

  public static boolean getpenilaian_lanjutan_resiko_jatuh_psikiatri() {
    return akses.penilaian_lanjutan_resiko_jatuh_psikiatri;
  }

  public static boolean getpenilaian_lanjutan_skrining_fungsional() {
    return akses.penilaian_lanjutan_skrining_fungsional;
  }

  public static boolean getpenilaian_medis_ralan_rehab_medik() {
    return akses.penilaian_medis_ralan_rehab_medik;
  }

  public static boolean getlaporan_anastesi() {
    return akses.laporan_anestesi;
  }

  public static boolean gettemplate_persetujuan_penolakan_tindakan() {
    return akses.template_persetujuan_penolakan_tindakan;
  }

  public static boolean getpenilaian_medis_ralan_gawat_darurat_psikiatri() {
    return akses.penilaian_medis_ralan_gawat_darurat_psikiatri;
  }

  public static boolean getbpjs_referensi_setting_apotek() {
    return akses.bpjs_referensi_setting_apotek;
  }

  public static boolean getbpjs_referensi_obat_apotek() {
    return akses.bpjs_referensi_obat_apotek;
  }

  public static boolean getbpjs_mapping_obat_apotek() {
    return akses.bpjs_mapping_obat_apotek;
  }

  public static boolean getpembayaran_bank_mandiri() {
    return akses.pembayaran_bank_mandiri;
  }

  public static boolean getpenilaian_ulang_nyeri() {
    return akses.penilaian_ulang_nyeri;
  }

  public static boolean getpenilaian_terapi_wicara() {
    return akses.penilaian_terapi_wicara;
  }

  public static boolean getbpjs_obat_23hari_apotek() {
    return akses.bpjs_obat_23hari_apotek;
  }

  public static boolean getpengkajian_restrain() {
    return akses.pengkajian_restrain;
  }

  public static boolean getbpjs_kunjungan_sep_apotek() {
    return akses.bpjs_kunjungan_sep_apotek;
  }

  public static boolean getbpjs_monitoring_klaim_apotek() {
    return akses.bpjs_monitoring_klaim_apotek;
  }

  public static boolean getbpjs_daftar_pelayanan_obat_apotek() {
    return akses.bpjs_daftar_pelayanan_obat_apotek;
  }

  public static boolean getpenilaian_awal_medis_ralan_paru() {
    return akses.penilaian_awal_medis_ralan_paru;
  }

  public static boolean getcatatan_keperawatan_ralan() {
    return akses.catatan_keperawatan_ralan;
  }

  public static boolean getcatatan_persalinan() {
    return akses.catatan_persalinan;
  }

  public static boolean getskor_aldrette_pasca_anestesi() {
    return akses.skor_aldrette_pasca_anestesi;
  }

  public static boolean getskor_steward_pasca_anestesi() {
    return akses.skor_steward_pasca_anestesi;
  }

  public static boolean getskor_bromage_pasca_anestesi() {
    return akses.skor_bromage_pasca_anestesi;
  }

  public static boolean getpenilaian_pre_induksi() {
    return akses.penilaian_pre_induksi;
  }

  public static boolean gethasil_usg_urologi() {
    return akses.hasil_usg_urologi;
  }

  public static boolean gethasil_usg_gynecologi() {
    return akses.hasil_usg_gynecologi;
  }

  public static boolean gethasil_pemeriksaan_ekg() {
    return akses.hasil_pemeriksaan_ekg;
  }

  public static boolean gethapus_edit_sep_bpjs() {
    return akses.hapus_edit_sep_bpjs;
  }

  public static boolean getsatu_sehat_kirim_diet() {
    return akses.satu_sehat_kirim_diet;
  }

  public static boolean getsatu_sehat_mapping_obat() {
    return akses.satu_sehat_mapping_obat;
  }

  public static boolean getdapur_ringkasan_pembelian() {
    return akses.dapur_ringkasan_pembelian;
  }

  public static boolean getsatu_sehat_kirim_medication() {
    return akses.satu_sehat_kirim_medication;
  }

  public static boolean getsatu_sehat_kirim_medicationrequest() {
    return akses.satu_sehat_kirim_medicationrequest;
  }

  public static boolean getpenatalaksanaan_terapi_okupasi() {
    return akses.penatalaksanaan_terapi_okupasi;
  }

  public static boolean getsatu_sehat_kirim_medicationdispense() {
    return akses.satu_sehat_kirim_medicationdispense;
  }

  public static boolean gethasil_usg_neonatus() {
    return akses.hasil_usg_neonatus;
  }

  public static boolean gethasil_endoskopi_faring_laring() {
    return akses.hasil_endoskopi_faring_laring;
  }

  public static boolean getsatu_sehat_mapping_radiologi() {
    return akses.satu_sehat_mapping_radiologi;
  }

  public static boolean getsatu_sehat_kirim_servicerequest_radiologi() {
    return akses.satu_sehat_kirim_servicerequest_radiologi;
  }

  public static boolean gethasil_endoskopi_hidung() {
    return akses.hasil_endoskopi_hidung;
  }

  public static boolean getsatu_sehat_kirim_specimen_radiologi() {
    return akses.satu_sehat_kirim_specimen_radiologi;
  }

  public static boolean getmaster_masalah_keperawatan_neonatus() {
    return akses.master_masalah_keperawatan_neonatus;
  }

  public static boolean getmaster_rencana_keperawatan_neonatus() {
    return akses.master_rencana_keperawatan_neonatus;
  }

  public static boolean getpenilaian_awal_keperawatan_ranap_neonatus() {
    return akses.penilaian_awal_keperawatan_ranap_neonatus;
  }

  public static boolean getsatu_sehat_kirim_observation_radiologi() {
    return akses.satu_sehat_kirim_observation_radiologi;
  }

  public static boolean getsatu_sehat_kirim_diagnosticreport_radiologi() {
    return akses.satu_sehat_kirim_diagnosticreport_radiologi;
  }

  public static boolean gethasil_endoskopi_telinga() {
    return akses.hasil_endoskopi_telinga;
  }

  public static boolean getsatu_sehat_mapping_lab() {
    return akses.satu_sehat_mapping_lab;
  }

  public static boolean getsatu_sehat_kirim_servicerequest_lab() {
    return akses.satu_sehat_kirim_servicerequest_lab;
  }

  public static boolean getsatu_sehat_kirim_servicerequest_labmb() {
    return akses.satu_sehat_kirim_servicerequest_labmb;
  }

  public static boolean getsatu_sehat_kirim_specimen_lab() {
    return akses.satu_sehat_kirim_specimen_lab;
  }

  public static boolean getsatu_sehat_kirim_specimen_labmb() {
    return akses.satu_sehat_kirim_specimen_labmb;
  }

  public static boolean getsatu_sehat_kirim_observation_lab() {
    return akses.satu_sehat_kirim_observation_lab;
  }

  public static boolean getsatu_sehat_kirim_observation_labmb() {
    return akses.satu_sehat_kirim_observation_labmb;
  }

  public static boolean getsatu_sehat_kirim_diagnosticreport_lab() {
    return akses.satu_sehat_kirim_diagnosticreport_lab;
  }

  public static boolean getsatu_sehat_kirim_diagnosticreport_labmb() {
    return akses.satu_sehat_kirim_diagnosticreport_labmb;
  }

  public static boolean getkepatuhan_kelengkapan_keselamatan_bedah() {
    return akses.kepatuhan_kelengkapan_keselamatan_bedah;
  }

  public static boolean getnilai_piutang_perjenis_bayar_per_bulan() {
    return akses.nilai_piutang_perjenis_bayar_per_bulan;
  }

  public static boolean getringkasan_piutang_jenis_bayar() {
    return akses.ringkasan_piutang_jenis_bayar;
  }

  public static boolean getpenilaian_pasien_imunitas_rendah() {
    return akses.penilaian_pasien_imunitas_rendah;
  }

  public static boolean getbalance_cairan() {
    return akses.balance_cairan;
  }

  public static boolean getcatatan_observasi_chbp() {
    return akses.catatan_observasi_chbp;
  }

  public static boolean getcatatan_observasi_induksi_persalinan() {
    return akses.catatan_observasi_induksi_persalinan;
  }

  public static boolean getskp_kategori_penilaian() {
    return akses.skp_kategori_penilaian;
  }

  public static boolean getskp_kriteria_penilaian() {
    return akses.skp_kriteria_penilaian;
  }

  public static boolean getskp_penilaian() {
    return akses.skp_penilaian;
  }

  public static boolean getreferensi_poli_mobilejknfktp() {
    return akses.referensi_poli_mobilejknfktp;
  }

  public static boolean getreferensi_dokter_mobilejknfktp() {
    return akses.referensi_dokter_mobilejknfktp;
  }

  public static boolean getskp_rekapitulasi_penilaian() {
    return akses.skp_rekapitulasi_penilaian;
  }

  public static boolean getpembayaran_pihak_ke3_bankmandiri() {
    return akses.pembayaran_pihak_ke3_bankmandiri;
  }

  public static boolean getmetode_pembayaran_bankmandiri() {
    return akses.metode_pembayaran_bankmandiri;
  }

  public static boolean getbank_tujuan_transfer_bankmandiri() {
    return akses.bank_tujuan_transfer_bankmandiri;
  }

  public static boolean getkodetransaksi_tujuan_transfer_bankmandiri() {
    return akses.kodetransaksi_tujuan_transfer_bankmandiri;
  }

  public static boolean getkonsultasi_medik() {
    return akses.konsultasi_medik;
  }

  public static boolean getjawaban_konsultasi_medik() {
    return akses.jawaban_konsultasi_medik;
  }

  public static boolean getpcare_cek_alergi() {
    return akses.pcare_cek_alergi;
  }

  public static boolean getpcare_cek_prognosa() {
    return akses.pcare_cek_prognosa;
  }

  public static boolean getdata_sasaran_usiaproduktif() {
    return akses.data_sasaran_usiaproduktif;
  }

  public static boolean getdata_sasaran_usialansia() {
    return akses.data_sasaran_usialansia;
  }

  public static boolean getskrining_perilaku_merokok_sekolah_remaja() {
    return akses.skrining_perilaku_merokok_sekolah_remaja;
  }

  public static boolean getskrining_kekerasan_pada_perempuan() {
    return akses.skrining_kekerasan_pada_perempuan;
  }

  public static boolean getskrining_obesitas() {
    return akses.skrining_obesitas;
  }

  public static boolean getskrining_risiko_kanker_payudara() {
    return akses.skrining_risiko_kanker_payudara;
  }

  public static boolean getskrining_risiko_kanker_paru() {
    return akses.skrining_risiko_kanker_paru;
  }

  public static boolean getpemantauan_pews_maternal() {
    return akses.pemantauan_pews_maternal;
  }

  public static boolean getvalidasi_sbar() {
    return akses.validasi_sbar;
  }

  private akses() {}

  private static final Logger LOG = Logger.getLogger(akses.class.getName());
}
