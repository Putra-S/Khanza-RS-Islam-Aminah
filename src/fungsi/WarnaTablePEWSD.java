...
public class WarnaTablePEWSD extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
        ...
        if ((column == 20) || (column == 21)) {
            if (Integer.parseInt(table.getValueAt(row, 20).toString()) > 8) {
                component.setBackground(Color.BLUE);
                component.setForeground(Color.WHITE);
            } else if ((Integer.parseInt(table.getValueAt(row, 20).toString()) >= 7)
                    || (Integer.parseInt(table.getValueAt(row, 7).toString()) == 7)
                    || (Integer.parseInt(table.getValueAt(row, 13).toString()) == 7)
                    || (Integer.parseInt(table.getValueAt(row, 15).toString()) == 7)
    ...
    private static final Logger LOG = Logger.getLogger(WarnaTablePEWSD.class.getName());
