 ...
 * @author Owner
 */
public class WarnaTablePenyerahanDarah extends DefaultTableCellRenderer {
    ...
    private static final Logger LOG = Logger.getLogger(WarnaTablePenyerahanDarah.class.getName());
