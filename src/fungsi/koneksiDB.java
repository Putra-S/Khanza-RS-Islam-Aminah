      ...
      try {
        ...
        dataSource.setURL(
            "jdbc:mysql://"
                ...
                + "?zeroDateTimeBehavior=convertToNull&autoReconnect=true&useCompression=true&useSSL=false&useUnicode=true&characterEncoding=UTF-8");
          ...
          if (connection.isClosed()) {
            ...
            dataSource.setURL(
                "jdbc:mysql://"
                    ...
                    + "/"
                    + EnkripsiAES.decrypt(prop.getProperty("DATABASE"))
                    + "?zeroDateTimeBehavior=convertToNull&amp;autoReconnect=true&amp;cachePrepStmts=true;useSSL=false");
            dataSource.setUser(EnkripsiAES.decrypt(prop.getProperty("USER")));
            dataSource.setPassword(EnkripsiAES.decrypt(prop.getProperty("PAS")));
            connection = dataSource.getConnection();
          }
