...
public class KeslingLimbahB3MedisCair extends javax.swing.JDialog {
    ...
    public KeslingLimbahB3MedisCair(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.", "NIP", "Petugas", "Tanggal", "Jumlah(L)",
            "Tujuan Penyerahan", "Bukti No.Dokumen", "Sisa di TPS(L)", "Keterangan"}) {
            @Override
...
private void NmPetugasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmPetugasKeyPressed
    ...
    private static final Logger LOG = Logger.getLogger(KeslingLimbahB3MedisCair.class.getName());
