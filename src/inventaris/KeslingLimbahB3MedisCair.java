 ...
 * @author perpustakaan
 */
public class KeslingLimbahB3MedisCair extends javax.swing.JDialog {
    ...
    public KeslingLimbahB3MedisCair(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "No.", "NIP", "Petugas", "Tanggal", "Jumlah(L)", "Tujuan Penyerahan",
            "Bukti No.Dokumen", "Sisa di TPS(L)", "Keterangan"
        }) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Jumlah.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("kesling_limbah_b3medis_cair",
                    "?,?,?,?,?,?,?", "Data", 7, new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            Sequel.meghapus("kesling_limbah_b3medis_cair", "nip", "tanggal",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Jumlah.getText().trim().isEmpty()) {
            ...
            if (tbObat.getSelectedRow() > -1) {
                if (Sequel.mengedittf("kesling_limbah_b3medis_cair",
                        "nip=? and tanggal=?",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptLimbahB3MedisCair.jasper", "report",
                    "::[ Data Limbah Cair B3 Medis Keluar TPS ]::",
                    ...
                    + "kesling_limbah_b3medis_cair.tanggal between '" + Valid.
                            SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and "
                    + "(kesling_limbah_b3medis_cair.nip like '%" + TCari.
                            getText().trim() + "%' or petugas.nama like '%" + TCari.
                            getText().trim() + "%' or kesling_limbah_b3medis_cair.bukti_dokumen like '%" + TCari.
                            getText().trim() + "%') "
...
private void NmPetugasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmPetugasKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeslingLimbahB3MedisCair dialog = new KeslingLimbahB3MedisCair(
    ...
    private static final Logger LOG = Logger.getLogger(
            KeslingLimbahB3MedisCair.class.getName());
}
