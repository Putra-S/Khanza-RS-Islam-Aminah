...
private void TAlamatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TAlamatKeyPressed
    ...
    private void tampil() {
        String sql = "select inventaris_produsen.kode_produsen, inventaris_produsen.nama_produsen, inventaris_produsen.alamat_produsen, inventaris_produsen.no_telp,"
                ...
                + "or inventaris_produsen.website_produsen like '%" + TCari.getText().trim()
                + "%' order by inventaris_produsen.kode_produsen";
        prosesCari(sql);
    }
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(kode_produsen,4),signed)),0) from inventaris_produsen  ",
                "PD", 8, TKd);
        TKd.requestFocus();
    }
    ...
    private static final Logger LOG = Logger.getLogger(InventarisProdusen.class.getName());
