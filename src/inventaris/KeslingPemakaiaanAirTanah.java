 ...
 * @author perpustakaan
 */
public class KeslingPemakaiaanAirTanah extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Meteran.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("kesling_pemakaian_air_tanah", "?,?,?,?,?",
                    "Data", 5, new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            Sequel.meghapus("kesling_pemakaian_air_tanah", "nip", "tanggal",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Meteran.getText().trim().isEmpty()) {
            ...
            if (tbObat.getSelectedRow() > -1) {
                if (Sequel.mengedittf("kesling_pemakaian_air_tanah",
                        "nip=? and tanggal=?",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptPemakaianAirTanah.jasper", "report",
                    ...
                    + "kesling_pemakaian_air_tanah.tanggal between '" + Valid.
                            SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and kesling_pemakaian_air_tanah.nip like '%" + TCari.
                    getText().trim() + "%' or "
                    + "kesling_pemakaian_air_tanah.tanggal between '" + Valid.
                            SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    ...
                    + "kesling_pemakaian_air_tanah.tanggal between '" + Valid.
                            SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and kesling_pemakaian_air_tanah.keterangan like '%" + TCari.
                    getText().trim() + "%' "
...
private void NmPetugasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmPetugasKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeslingPemakaiaanAirTanah dialog = new KeslingPemakaiaanAirTanah(
    ...
    private static final Logger LOG = Logger.getLogger(
            KeslingPemakaiaanAirTanah.class.getName());
}
