...
public class InventarisMerk extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("inventaris_merk",
                    "'" + TKd.getText() + "','" + TNm.getText() + "'", "ID Merk");
            tampil();
            emptTeks();
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.mengedit("inventaris_merk", "id_merk=?",
                    "id_merk=?,nama_merk=?", 3, new String[]{
                        TKd.getText(), TNm.getText(), tbSpesialis.getValueAt(
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        prosesCari(
                "select * from inventaris_merk where id_merk like '%" + TCari.
                        getText().trim() + "%' "
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventarisMerk dialog = new InventarisMerk(new javax.swing.JFrame(),
                    true);
    ...
    private static final Logger LOG = Logger.getLogger(InventarisMerk.class.
            getName());
}
