...
public class KeslingLimbahB3Medis extends javax.swing.JDialog {
    ...
    public KeslingLimbahB3Medis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.", "NIP", "Petugas", "Tanggal", "Jumlah(Kg)",
            "Tujuan Penyerahan", "Bukti No.Dokumen", "Sisa di TPS(Kg)", "Keterangan"}) {
            @Override
...
private void NmPetugasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmPetugasKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select kesling_limbah_b3medis.nip,petugas.nama,kesling_limbah_b3medis.tanggal,"
                            + "kesling_limbah_b3medis.jmllimbah,kesling_limbah_b3medis.tujuan_penyerahan,kesling_limbah_b3medis.bukti_dokumen, "
            ...
            try {
                ...
                total = 0;
                while (rs.next()) {
                    tabMode.addRow(new String[]{i + "", rs.getString(1), rs.getString(2), rs.getString(3),
            ...
            if (total > 0) {
                tabMode.addRow(new String[]{"", "", "JUMLAH :", "", "" + total, "", "", "", ""});
            }
        } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(KeslingLimbahB3Medis.class.getName());
