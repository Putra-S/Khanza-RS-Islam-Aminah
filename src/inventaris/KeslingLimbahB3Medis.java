 ...
 * @author perpustakaan
 */
public class KeslingLimbahB3Medis extends javax.swing.JDialog {
    ...
    public KeslingLimbahB3Medis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "No.", "NIP", "Petugas", "Tanggal", "Jumlah(Kg)",
            "Tujuan Penyerahan", "Bukti No.Dokumen", "Sisa di TPS(Kg)",
            "Keterangan"
        }) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Jumlah.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("kesling_limbah_b3medis", "?,?,?,?,?,?,?",
                    "Data", 7, new String[]{
                        KdPetugas.getText(), Valid.SetTgl(Tanggal.
                        getSelectedItem() + "") + " " + Tanggal.
                                getSelectedItem().toString().substring(11, 19),
                        Jumlah.getText(), Tujuan.getText(), NoDokumen.getText(),
                        Sisa.getText(), Keterangan.getText()
                    }) == true) {
                tampil();
                emptTeks();
            }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            Sequel.meghapus("kesling_limbah_b3medis", "nip", "tanggal", tbObat.
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Jumlah.getText().trim().isEmpty()) {
            ...
            if (tbObat.getSelectedRow() > -1) {
                if (Sequel.mengedittf("kesling_limbah_b3medis",
                        "nip=? and tanggal=?",
                        "nip=?,tanggal=?,jmllimbah=?,tujuan_penyerahan=?,bukti_dokumen=?,sisa_di_tps=?,keterangan=?",
                        9, new String[]{
                            KdPetugas.getText(), Valid.SetTgl(Tanggal.
                            getSelectedItem() + "") + " " + Tanggal.
                                    getSelectedItem().toString().substring(11,
                                            19), Jumlah.getText(), Tujuan.
                            getText(),
                            NoDokumen.getText(), Sisa.getText(), Keterangan.
                            getText(), tbObat.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptLimbahB3Medis.jasper", "report",
                    "::[ Data Limbah Padat B3 Medis Keluar TPS ]::",
                    ...
                    + "kesling_limbah_b3medis.tanggal between '" + Valid.SetTgl(
                            DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and "
                    + "(kesling_limbah_b3medis.nip like '%" + TCari.getText().
                            trim() + "%' or petugas.nama like '%" + TCari.
                            getText().trim() + "%' or kesling_limbah_b3medis.bukti_dokumen like '%" + TCari.
                            getText().trim() + "%') "
...
private void NmPetugasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmPetugasKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeslingLimbahB3Medis dialog = new KeslingLimbahB3Medis(
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Jumlah.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 4).
                    toString());
            Tujuan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 5).
                    toString());
            NoDokumen.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 6).
                    toString());
            Sisa.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 7).
                    toString());
    ...
    private static final Logger LOG = Logger.getLogger(
            KeslingLimbahB3Medis.class.getName());
}
