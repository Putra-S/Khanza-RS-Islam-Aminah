...
public class InventarisAsalHibah extends javax.swing.JDialog {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Valid.editTable(tabMode, "pemberihibah", "kode_pemberi", "?",
                    "kode_pemberi=?,nama_pemberi=?,alamat=?,kota=?,no_telp=?", 6,
                    new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptAsalHibah.jasper", "report",
                    "::[ Data Pemberi Hibah/Asal Hibah ]::",
                    "select pemberihibah.kode_pemberi, pemberihibah.nama_pemberi, "
                    + " pemberihibah.alamat,pemberihibah.kota, pemberihibah.no_telp from pemberihibah "
                    + " where pemberihibah.kode_pemberi like '%" + TCari.
                            getText().trim() + "%' or "
                    + " pemberihibah.nama_pemberi like '%" + TCari.getText().
                            trim() + "%' or "
                    + " pemberihibah.alamat like '%" + TCari.getText().trim() + "%' or "
                    + " pemberihibah.kota like '%" + TCari.getText().trim() + "%' or "
                    + " pemberihibah.no_telp like '%" + TCari.getText().trim() + "%' order by pemberihibah.kode_pemberi",
                    param);
        }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("pemberihibah", "?,?,?,?,?",
                    "Kode Pemberi Hibah", 5, new String[]{
                        Kd.getText(), Nm.getText(), Alamat.getText(), Kota.
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select pemberihibah.kode_pemberi, pemberihibah.nama_pemberi, "
                    + " pemberihibah.alamat,pemberihibah.kota, pemberihibah.no_telp from pemberihibah "
                    + " where pemberihibah.kode_pemberi like ? or " + " pemberihibah.nama_pemberi like ? or "
                    + " pemberihibah.alamat like ? or " + " pemberihibah.kota like ? or "
    ...
    private static final Logger LOG = Logger.getLogger(InventarisAsalHibah.class.getName());
