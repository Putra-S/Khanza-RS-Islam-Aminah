...
public class InventarisPemeliharaanGedung extends javax.swing.JDialog {
    ...
    public InventarisPemeliharaanGedung(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.Pemeliharaan", "NIP", "Penanggung Jawab", "Kegiatan",
            "Tanggal", "Pelaksana", "Biaya", "Jenis Pemeliharaan", "Tindak Lanjut"}) {
            @Override
...
private void TanggalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TanggalKeyPressed
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "pemeliharaan_gedung.jenis_pemeliharaan,pemeliharaan_gedung.tindak_lanjut "
                    + "from pemeliharaan_gedung inner join petugas on pemeliharaan_gedung.nip=petugas.nip where "
                    + "pemeliharaan_gedung.tanggal between ? and ? "
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new String[]{rs.getString("no_pemeliharaan"), rs.getString("nip"),
                        ...
                        rs.getString("jenis_pemeliharaan"), rs.getString("tindak_lanjut")});
                }
                if (total > 0) {
                    tabMode.addRow(new String[]{"", "", "", "Total Biaya : ", "", "", Valid.SetAngka(total), ""});
                }
            } catch (Exception e) {
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(no_pemeliharaan,3),signed)),0) from pemeliharaan_gedung where date_format(tanggal,'%Y-%m-%d')='"
                + Valid.SetTgl(Tanggal.getSelectedItem() + "") + "' ",
                "PG" + Tanggal.getSelectedItem().toString().substring(6, 10)
    ...
    private static final Logger LOG = Logger.getLogger(InventarisPemeliharaanGedung.class.getName());
