...
public class InventarisPemesanan extends javax.swing.JDialog {
    ...
    private InventarisCariPemesanan form = new InventarisCariPemesanan(null,
            false);
    ...
    private String iyem, akunaset = "", Kontra_Penerimaan_AsetInventaris = Sequel.
...
private void btnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPetugasActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventarisPemesanan dialog = new InventarisPemesanan(
    ...
    private void autoNomor() {
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(inventaris_pemesanan.no_faktur,3),signed)),0) from inventaris_pemesanan where inventaris_pemesanan.tgl_pesan='" + Valid.
                        SetTgl(TglPesan.getSelectedItem() + "") + "'",
                "PAI" + TglPesan.getSelectedItem().toString().substring(6, 10) + TglPesan.
    ...
    private static final Logger LOG = Logger.getLogger(
            InventarisPemesanan.class.getName());
