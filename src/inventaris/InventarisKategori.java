...
public class InventarisKategori extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("inventaris_kategori",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.mengedit("inventaris_kategori", "id_kategori=?",
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        prosesCari(
                "select * from inventaris_kategori where id_kategori like '%" + TCari.
                        getText().trim() + "%' "
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventarisKategori dialog = new InventarisKategori(
    ...
    private static final Logger LOG = Logger.getLogger(InventarisKategori.class.
            getName());
}
