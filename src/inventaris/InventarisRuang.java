...
public class InventarisRuang extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from inventaris_ruang where id_ruang like ? " + "or nama_ruang like ? order by id_ruang");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(InventarisRuang.class.getName());
