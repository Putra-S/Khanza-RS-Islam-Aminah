...
public class InventarisRuang extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("inventaris_ruang",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.mengedit("inventaris_ruang", "id_ruang=?",
                    "id_ruang=?,nama_ruang=?", 3, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventarisRuang dialog = new InventarisRuang(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from inventaris_ruang where id_ruang like ? "
    ...
    private static final Logger LOG = Logger.getLogger(InventarisRuang.class.
            getName());
}
