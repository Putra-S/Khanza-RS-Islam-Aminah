 ...
 * @author perpustakaan
 */
public class KeslingLimbahDomestik extends javax.swing.JDialog {
    ...
    public KeslingLimbahDomestik(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "No.", "NIP", "Petugas", "Tgl.Masuk", "Jml.Limbah(Kg)",
            "Tgl.Pengangkutan", "Keterangan"
        }) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Jumlah.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("kesling_limbah_domestik", "?,?,?,?,?",
                    "Data", 5, new String[]{
                        KdPetugas.getText(), Valid.SetTgl(Tanggal.
                        getSelectedItem() + "") + " " + Tanggal.
                                getSelectedItem().toString().substring(11, 19),
                        Jumlah.getText(), Valid.SetTgl(TanggalAngkut.
                        getSelectedItem() + "") + " " + TanggalAngkut.
                                getSelectedItem().toString().substring(11, 19),
                        Keterangan.getText()
                    }) == true) {
                tampil();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            Sequel.meghapus("kesling_limbah_domestik", "nip", "tanggal", tbObat.
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Jumlah.getText().trim().isEmpty()) {
            ...
            if (tbObat.getSelectedRow() > -1) {
                if (Sequel.mengedittf("kesling_limbah_domestik",
                        "nip=? and tanggal=?",
                        "nip=?,tanggal=?,jumlahlimbah=?,tanggalangkut=?,keterangan=?",
                        7, new String[]{
                            KdPetugas.getText(), Valid.SetTgl(TanggalAngkut.
                            getSelectedItem() + "") + " " + TanggalAngkut.
                            ...
                            getSelectedItem() + "") + " " + TanggalAngkut.
                                    getSelectedItem().toString().substring(11,
                                            19), Keterangan.getText(), tbObat.
                            getValueAt(tbObat.getSelectedRow(), 1).toString(),
                            tbObat.getValueAt(tbObat.getSelectedRow(), 3).
                                    toString()
                        }) == true) {
                    tampil();
                    emptTeks();
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptLimbahDomestik.jasper", "report",
                    "::[ Data Catatan Limbah Padat Domestik ]::",
                    ...
                    + "kesling_limbah_domestik.tanggal between '" + Valid.
                            SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and kesling_limbah_domestik.nip like '%" + TCari.
                    getText().trim() + "%' or "
                    + "kesling_limbah_domestik.tanggal between '" + Valid.
                            SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and petugas.nama like '%" + TCari.
                    getText().trim() + "%' or "
                    + "kesling_limbah_domestik.tanggal between '" + Valid.
                            SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and kesling_limbah_domestik.keterangan like '%" + TCari.
                    getText().trim() + "%' "
...
private void NmPetugasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmPetugasKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeslingLimbahDomestik dialog = new KeslingLimbahDomestik(
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Jumlah.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 4).
                    toString());
            Valid.SetTgl2(TanggalAngkut, tbObat.getValueAt(tbObat.
                    getSelectedRow(), 5).toString());
            Keterangan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 6).
                    toString());
        }
    }
    ...
    private static final Logger LOG = Logger.getLogger(
            KeslingLimbahDomestik.class.getName());
}
