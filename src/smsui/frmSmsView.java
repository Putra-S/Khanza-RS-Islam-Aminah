...
public class frmSmsView extends javax.swing.JFrame {
    ...
    public frmSmsView() {
        initComponents();
        setIconImage(new ImageIcon(super.getClass().getResource(
    ...
    private void BtnServiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnServiceActionPerformed
        try {
            ...
            panelStatus1.setStatusKoneksi(PanelStatus.KONEKSI_Catatan,
                    "Catatan saat Koneksi ke database");
            return;
        }
        ...
        try {
            ...
            panelStatus1.setStatusKoneksi(PanelStatus.TERSAMBUNG,
                    "Service tersedia");
        } catch (Exception ex) {
            panelStatus1.setStatusKoneksi(PanelStatus.TERSAMBUNG,
                    "Catatan saat mulai Service");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmSmsView.class.getName()).log(
    ...
    private static final Logger LOG = Logger.getLogger(frmSmsView.class.
            getName());
}
