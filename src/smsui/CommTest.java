...
public class CommTest {
  ...
  /**
   * Wrapper around {@link CommPortIdentifier#getPortIdentifiers()} to be avoid unchecked warnings.
   */
        ...
        for (int i = 0; i < bauds.length; i++) {
          ...
          try {
            ...
            serialPort.setSerialPortParams(
                bauds[i], SerialPort.DATABITS_8, SerialPort.STOPBITS_1, SerialPort.PARITY_NONE);
  ...
  private static final java.util.logging.Logger LOG =
      java.util.logging.Logger.getLogger(CommTest.class.getName());
}
