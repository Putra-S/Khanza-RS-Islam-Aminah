...
public class K3RSBagianTubuh extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("k3rs_bagian_tubuh",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("k3rs_bagian_tubuh", "kode_bagian=?",
                        "kode_bagian=?,bagian_tubuh=?", 3, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            K3RSBagianTubuh dialog = new K3RSBagianTubuh(
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from k3rs_bagian_tubuh where kode_bagian like ? or bagian_tubuh like ? order by kode_bagian");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(K3RSBagianTubuh.class.
            getName());
}
