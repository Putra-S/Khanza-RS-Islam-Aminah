...
public class DlgHarian extends javax.swing.JDialog {
    ...
    public DlgHarian(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Object[] row = {"NIP", "Nama", "Shift", "Jam Datang", "Jam Pulang", "Status", "Keterlambatan", "Durasi",
            "Catatan"};
    ...
    private void getData() {
        ...
        if (row != -1) {
            ...
            try {
                tglMasuk.setDate(
                        new SimpleDateFormat("yyyy-MM-dd").parse(tbBangsal.getValueAt(row, 3).toString().substring(0, 4)
            ...
            try {
                tglPulang.setDate(
                        new SimpleDateFormat("yyyy-MM-dd").parse(tbBangsal.getValueAt(row, 4).toString().substring(0, 4)
    ...
    private static final Logger LOG = Logger.getLogger(DlgHarian.class.getName());
