...
public class DlgBarcode extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (Bcd.getText().trim().isEmpty()) {
            Valid.textKosong(Bcd, "Barcode");
        } else {
            Sequel.menyimpan("barcode", "'" + Id.getText() + "','" + Bcd.
                    getText() + "'", "Barcode");
            tampil();
            emptTeks();
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Id.getText().trim().isEmpty()) {
            ...
            Valid.editTable(tabMode, "barcode", "id", Id, "barcode='" + Bcd.
                    getText() + "'");
            tampil();
            emptTeks();
        }
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                ...
                Valid.MyReport("rptBarcode.jasper", "report",
                        "::[ Kartu Barcode ]::", param);
                ...
                param.put("logo", Sequel.cariGambar(
                        "select setting.logo from setting"));
                Valid.MyReportqry("rptBarcode.jasper", "report",
                        "::[ Kartu Barcode ]::", "select pegawai.id, "
                        + "pegawai.nik,"
                        + "pegawai.nama,"
                        + "pegawai.jk,"
                        + "pegawai.jbtn,"
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select  pegawai.id,pegawai.nik,pegawai.nama,barcode.barcode  from pegawai "
    ...
    private static final Logger LOG = Logger.getLogger(DlgBarcode.class.
            getName());
