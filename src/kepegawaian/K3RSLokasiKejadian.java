...
public class K3RSLokasiKejadian extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("k3rs_lokasi_kejadian",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("k3rs_lokasi_kejadian", "kode_lokasi=?",
                        "kode_lokasi=?,lokasi_kejadian=?", 3, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            K3RSLokasiKejadian dialog = new K3RSLokasiKejadian(
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from k3rs_lokasi_kejadian where kode_lokasi like ? or lokasi_kejadian like ? order by kode_lokasi");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(K3RSLokasiKejadian.class.
            getName());
}
