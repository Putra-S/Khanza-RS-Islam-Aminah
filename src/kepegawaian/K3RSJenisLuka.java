...
public class K3RSJenisLuka extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("k3rs_jenis_luka",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("k3rs_jenis_luka", "kode_luka=?",
                        "kode_luka=?,jenis_luka=?", 3, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            K3RSJenisLuka dialog = new K3RSJenisLuka(new javax.swing.JFrame(),
                    true);
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from k3rs_jenis_luka where kode_luka like ? or jenis_luka like ? order by kode_luka");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(K3RSJenisLuka.class.
            getName());
}
