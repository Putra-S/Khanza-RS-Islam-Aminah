...
public class DlgAuditKamarJenazah extends javax.swing.JDialog {
    ...
    public DlgAuditKamarJenazah(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Tanggal Audit",
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select audit_kamar_jenazah.tanggal,audit_kamar_jenazah.audit1,"
                    + "audit_kamar_jenazah.audit2,audit_kamar_jenazah.audit3,"
                    + "audit_kamar_jenazah.audit4,audit_kamar_jenazah.audit5,"
                    + "audit_kamar_jenazah.audit6,audit_kamar_jenazah.audit7,"
                    + "audit_kamar_jenazah.audit8 from audit_kamar_jenazah "
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    ttlpenilaian += (((audit1 + audit2 + audit3 + audit4 + audit5 + audit6 + audit7 + audit8) / 8)
                            * 100);
                    tabMode.addRow(new String[]{rs.getString("tanggal"), rs.getString("audit1"),
                        rs.getString("audit2"), rs.getString("audit3"), rs.getString("audit4"),
                        rs.getString("audit5"), rs.getString("audit6"), rs.getString("audit7"),
                        rs.getString("audit8"),
                        Math.round(
                ...
                i -= 1;
                if (i > 0) {
                    tabMode.addRow(new String[]{"Ya", "" + ttlaudit1, "" + ttlaudit2, "" + ttlaudit3, "" + ttlaudit4,
                        "" + ttlaudit5, "" + ttlaudit6, "" + ttlaudit7, "" + ttlaudit8, "" + (ttlaudit1 + ttlaudit2
                        + ttlaudit3 + ttlaudit4 + ttlaudit5 + ttlaudit6 + ttlaudit7 + ttlaudit8)});
    ...
    private static final Logger LOG = Logger.getLogger(DlgAuditKamarJenazah.class.getName());
