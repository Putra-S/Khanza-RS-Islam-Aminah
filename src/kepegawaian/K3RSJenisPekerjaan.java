...
public class K3RSJenisPekerjaan extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("k3rs_jenis_pekerjaan",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("k3rs_jenis_pekerjaan", "kode_pekerjaan=?",
                        "kode_pekerjaan=?,jenis_pekerjaan=?", 3, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            K3RSJenisPekerjaan dialog = new K3RSJenisPekerjaan(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from k3rs_jenis_pekerjaan where kode_pekerjaan like ? or jenis_pekerjaan like ? order by kode_pekerjaan");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(K3RSJenisPekerjaan.class.
            getName());
}
