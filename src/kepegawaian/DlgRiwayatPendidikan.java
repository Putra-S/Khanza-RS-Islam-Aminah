...
public class DlgRiwayatPendidikan extends javax.swing.JDialog {
        ...
        try {
            if (engine.getLocation().contains("ListRiwayatPendidikan")) {
                loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + prop.
                        ...
                        "HYBRIDWEB") + "/" + "penggajian/index.php?act=ListRiwayatPendidikan&action=LIHAT&keyword=" + TCari.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRiwayatPendidikan dialog = new DlgRiwayatPendidikan(
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgRiwayatPendidikan.class.getName());
