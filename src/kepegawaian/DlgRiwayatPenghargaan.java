...
public class DlgRiwayatPenghargaan extends javax.swing.JDialog {
        ...
        try {
            if (engine.getLocation().contains("ListRiwayatPenghargaan")) {
                loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + prop.
                        ...
                        "HYBRIDWEB") + "/" + "penggajian/index.php?act=ListRiwayatPenghargaan&action=LIHAT&keyword=" + TCari.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRiwayatPenghargaan dialog = new DlgRiwayatPenghargaan(
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgRiwayatPenghargaan.class.getName());
