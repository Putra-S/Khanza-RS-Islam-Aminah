...
public class K3RSDampakCidera extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("k3rs_dampak_cidera",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("k3rs_dampak_cidera", "kode_dampak=?",
                        "kode_dampak=?,dampak_cidera=?", 3, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            K3RSDampakCidera dialog = new K3RSDampakCidera(
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from k3rs_dampak_cidera where kode_dampak like ? or dampak_cidera like ? order by kode_dampak");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(K3RSDampakCidera.class.
            getName());
}
