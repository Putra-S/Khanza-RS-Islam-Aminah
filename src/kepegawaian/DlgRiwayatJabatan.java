...
public class DlgRiwayatJabatan extends javax.swing.JDialog {
        ...
        try {
            if (engine.getLocation().contains("ListRiwayatPangkat")) {
                loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + prop.
                        ...
                        "HYBRIDWEB") + "/" + "penggajian/index.php?act=ListRiwayatPangkat&action=LIHAT&keyword=" + TCari.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRiwayatJabatan dialog = new DlgRiwayatJabatan(
    ...
    private static final Logger LOG = Logger.getLogger(DlgRiwayatJabatan.class.
            getName());
