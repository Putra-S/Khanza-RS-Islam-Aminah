...
public class DlgAuditSterilisasiAlat extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (KdRuang.getText().trim().isEmpty() || NmRuang.getText().trim().
            ...
            if (Sequel.menyimpantf("audit_sterilisasi_alat",
                    "?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 13, new String[]{
                        ...
                        getSelectedItem().toString(), Audit10.getSelectedItem().
                                toString(),
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbObat.getSelectedRow() != -1) {
            if (Sequel.queryu2tf(
                    "delete from audit_sterilisasi_alat where id_ruang=? and tanggal=?",
                    2, new String[]{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (KdRuang.getText().trim().isEmpty() || NmRuang.getText().trim().
            ...
            Sequel.
                    mengedit("audit_sterilisasi_alat",
                        ...
                        getSelectedItem().toString(), Audit10.getSelectedItem().
                                toString(),
                        Audit11.getSelectedItem().toString(), tbObat.getValueAt(
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptAuditSterilisasiAlat.jasper", "report",
                        "::[ Data Audit Sterilisasi Alat ]::",
                        ...
                        SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' order by audit_sterilisasi_alat.tanggal",
                        param);
            } else {
                Valid.MyReportqry("rptAuditSterilisasiAlat.jasper", "report",
                        "::[ Data Audit Sterilisasi Alat ]::",
                        ...
                        + "and (audit_sterilisasi_alat.id_ruang like '%" + TCari.
                                getText().trim() + "%' or ruang_audit_kepatuhan.nama_ruang like '%" + TCari.
                                getText().trim() + "%') order by audit_sterilisasi_alat.tanggal",
                        param);
            }
        }
