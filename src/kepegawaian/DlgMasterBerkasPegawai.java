...
public class DlgMasterBerkasPegawai extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select * from master_berkas_pegawai where kode like ? "
    ...
    private static final Logger LOG = Logger.getLogger(DlgMasterBerkasPegawai.class.getName());
