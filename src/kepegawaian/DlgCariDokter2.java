...
public class DlgCariDokter2 extends javax.swing.JDialog {
    ...
    public DlgCariDokter2(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Kode Dokter", "Nama Dokter", "J.K.", "Tmp.Lahir",
            ...
            "Stts.Nikah", "Spesialis", "Alumni", "No.Ijin Praktek", "Kuota"};
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariDokter2 dialog = new DlgCariDokter2(new javax.swing.JFrame(),
                    true);
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    iyem = iyem + "{\"KodeDokter\":\"" + rs.getString(1) + "\",\"NamaDokter\":\"" + rs.
                            ...
                            getString(7) + "\",\"AlamatTinggal\":\"" + rs.
                            getString(8).replaceAll("\"", "") + "\",\"NoTelp\":\"" + rs.
                            getString(9) + "\",\"SttsNikah\":\"" + rs.getString(
                            10) + "\",\"Spesialis\":\"" + rs.getString(11) + "\",\"Alumni\":\"" + rs.
                            getString(12).replaceAll("\"", "") + "\",\"NoIjinPraktek\":\"" + rs.
                            getString(13) + "\",\"Kuota\":\"" + rs.getString(14) + "\"},";
                }
            } catch (Exception e) {
            ...
            fileWriter.write("{\"dokter\":[" + iyem.substring(0,
                    iyem.length() - 1) + "]}");
            fileWriter.flush();
            fileWriter.close();
            iyem = null;
                ...
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{
                            ...
                            "NamaDokter").asText(), list.path("JK").asText(),
                            list.path("TmpLahir").asText(), list.
                            path("TglLahir").asText(), list.path("GD").asText(),
                            list.path("Agama").asText(), list.path(
                            "AlamatTinggal").asText(), list.path("NoTelp").
                            asText(), list.path("SttsNikah").asText(), list.
                            path("Spesialis").asText(), list.path("Alumni").
                            asText(), list.path("NoIjinPraktek").asText(), list.
                            path("Kuota").asText()
                        });
                    }
                } else {
                    for (JsonNode list : response) {
                        if (list.path("KodeDokter").asText().toLowerCase().
                                ...
                                path("NamaDokter").asText().toLowerCase().
                                contains(TCari.getText().toLowerCase()) || list.
                                path("Spesialis").asText().toLowerCase().
                                contains(TCari.getText().toLowerCase())) {
                            tabMode.addRow(new Object[]{
                                list.path("KodeDokter").asText(), list.path(
                                "NamaDokter").asText(), list.path("JK").asText(),
                                list.path("TmpLahir").asText(), list.path(
                                "TglLahir").asText(), list.path("GD").asText(),
                                list.path("Agama").asText(), list.path(
                                "AlamatTinggal").asText(), list.path("NoTelp").
                                asText(), list.path("SttsNikah").asText(), list.
                                path("Spesialis").asText(), list.path("Alumni").
                                asText(), list.path("NoIjinPraktek").asText(),
                                list.path("Kuota").asText()
                            });
                        }
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariDokter2.class.
            getName());
}
