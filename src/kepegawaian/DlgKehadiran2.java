...
public class DlgKehadiran2 extends javax.swing.JDialog {
    ...
    private String dayOfWeek, hari, h1 = "", h2 = "", h3 = "", h4 = "", h5 = "", h6 = "", h7 = "", h8 = "", h9 = "", h10 = "", h11 = "", h12 = "", h13 = "",
                ...
                switch (pilihan) {
                    case "Tampilkan Semua":
                        this.setCursor(Cursor.getPredefinedCursor(
                                Cursor.WAIT_CURSOR));
                        Valid.MyReportqry("rptRekapKehadiran.jasper", "report",
                                "::[ Rekap Kehadiran Non Jadwal Tambahan ]::",
                    ...
                    case "Tanpa departemen & jabatan":
                        this.setCursor(Cursor.getPredefinedCursor(
                                Cursor.WAIT_CURSOR));
                        Valid.MyReportqry("rptRekapKehadiran2.jasper", "report",
                                "::[ Rekap Kehadiran Non Jadwal Tambahan ]::",
                                "select * from temporary where temporary.temp37='" + akses.
                                        getalamatip() + "' order by temporary.no",
                                param);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKehadiran2 dialog = new DlgKehadiran2(new javax.swing.JFrame(),
                    true);
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        ps2.setString(2,
                                "%" + ThnCari.getSelectedItem() + "-" + BlnCari.
                                getSelectedItem() + "-01%");
    ...
    private static final Logger LOG = Logger.getLogger(DlgKehadiran2.class.
            getName());
