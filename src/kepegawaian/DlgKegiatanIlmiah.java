...
public class DlgKegiatanIlmiah extends javax.swing.JDialog {
        ...
        try {
            if (engine.getLocation().contains("ListRiwayatSeminar")) {
                loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + prop.
                        ...
                        "HYBRIDWEB") + "/" + "penggajian/index.php?act=ListRiwayatSeminar&action=LIHAT&keyword=" + TCari.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKegiatanIlmiah dialog = new DlgKegiatanIlmiah(
    ...
    private static final Logger LOG = Logger.getLogger(DlgKegiatanIlmiah.class.
            getName());
