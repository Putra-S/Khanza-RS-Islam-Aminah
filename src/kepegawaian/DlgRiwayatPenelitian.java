...
public class DlgRiwayatPenelitian extends javax.swing.JDialog {
                        ...
                        if (newState == State.SUCCEEDED) {
                            try {
                                ...
                                if (engine.getLocation()
                                    ...
                                    Valid
                                            .panggilUrl(engine.getLocation()
                                                    .replaceAll("http://" + koneksiDB.HOSTHYBRIDWEB() + ":"
                                                            + prop.getProperty("PORTWEB") + "/" + prop.getProperty("HYBRIDWEB")
                                                            + "/penggajian/pages/pages/", "penggajian/pages/")
                                                    .replaceAll("http://" + koneksiDB.HOSTHYBRIDWEB() + "/"
                                                            + prop.getProperty("HYBRIDWEB") + "/penggajian/pages/pages/",
                                                            "penggajian/pages/"));
        ...
        try {
            if (engine.getLocation().contains("ListRiwayatPenelitian")) {
                loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + prop.
                        ...
                        "HYBRIDWEB") + "/" + "penggajian/index.php?act=ListRiwayatPenelitian&action=LIHAT&keyword=" + TCari.
	...
	private static final Logger LOG = Logger.getLogger(DlgRiwayatPenelitian.class.getName());
