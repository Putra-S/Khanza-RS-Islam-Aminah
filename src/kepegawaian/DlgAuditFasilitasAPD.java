 ...
 * @author perpustakaan
 */
public class DlgAuditFasilitasAPD extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (KdRuang.getText().trim().isEmpty() || NmRuang.getText().trim().
            ...
            if (Sequel.menyimpantf("audit_fasilitas_apd", "?,?,?,?,?,?,?,?",
                    "Data", 8, new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbObat.getSelectedRow() != -1) {
            if (Sequel.queryu2tf(
                    "delete from audit_fasilitas_apd where id_ruang=? and tanggal=?",
                    2, new String[]{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (KdRuang.getText().trim().isEmpty() || NmRuang.getText().trim().
            ...
            Sequel.mengedit("audit_fasilitas_apd", "id_ruang=? and tanggal=?",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptAuditFasilitasAPD.jasper", "report",
                        "::[ Data Audit Fasilitas APD ]::",
                        ...
                        SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' order by audit_fasilitas_apd.tanggal",
                        param);
            } else {
                Valid.MyReportqry("rptAuditFasilitasAPD.jasper", "report",
                        "::[ Data Audit Fasilitas APD ]::",
                        ...
                        + "and (audit_fasilitas_apd.id_ruang like '%" + TCari.
                                getText().trim() + "%' or ruang_audit_kepatuhan.nama_ruang like '%" + TCari.
                                getText().trim() + "%') order by audit_fasilitas_apd.tanggal",
                        param);
            }
        }
    ...
    private static final Logger LOG = Logger.getLogger(DlgAuditFasilitasAPD.class.getName());
