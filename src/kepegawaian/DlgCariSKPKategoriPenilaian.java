...
public class DlgCariSKPKategoriPenilaian extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ...
            iyem = "";
            ps = koneksi
                    .prepareStatement("select * from skp_kategori_penilaian order by skp_kategori_penilaian.sasaran");
            try {
                rs = ps.executeQuery();
                while (rs.next()) {
                    ...
                    iyem = iyem + "{\"Kode\":\"" + rs.getString(1) + "\",\"Kategori\":\""
                            + rs.getString(2).replaceAll("\"", "") + "\",\"Sasaran\":\""
                            + rs.getString(3)
                                    .replaceAll("\"", "")
                                    .replaceAll("1", "1. Mengidentifikasi Pasien Dengan Benar")
                                    .replaceAll("2", "2. Meningkatkan Komunikasi Yang Efektif")
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariSKPKategoriPenilaian.class.getName());
