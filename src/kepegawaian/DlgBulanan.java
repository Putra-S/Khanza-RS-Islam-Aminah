...
public class DlgBulanan extends javax.swing.JDialog {
    ...
    public void tampil() {
        ...
        try {
            ...
            i = 0;
            while (rs.next()) {
                tabMode.addRow(new String[]{rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5),
    ...
    private static final Logger LOG = Logger.getLogger(DlgBulanan.class.getName());
