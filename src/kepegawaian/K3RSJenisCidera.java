...
public class K3RSJenisCidera extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("k3rs_jenis_cidera",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("k3rs_jenis_cidera", "kode_cidera=?",
                        "kode_cidera=?,jenis_cidera=?", 3, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            K3RSJenisCidera dialog = new K3RSJenisCidera(
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from k3rs_jenis_cidera where kode_cidera like ? or jenis_cidera like ? order by kode_cidera");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(K3RSJenisCidera.class.
            getName());
}
