...
public class DlgCariDokter extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariDokter dialog = new DlgCariDokter(new javax.swing.JFrame(),
                    true);
    ...
    public String tampil3(String kode) {
        ...
        try {
            ...
            if (response.isArray()) {
                for (JsonNode list : response) {
                    if (list.path("KodeDokter").asText().toLowerCase().equals(
                            kode)) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariDokter.class.
            getName());
}
