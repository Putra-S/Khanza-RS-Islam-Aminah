...
public class DlgCariDokter extends javax.swing.JDialog {
            ...
            if (response.isArray()) {
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{list.path("KodeDokter").asText(),
                            list.path("NamaDokter").asText(), list.path("JK").asText(),
                            list.path("TmpLahir").asText(), list.path("TglLahir").asText(),
                            list.path("GD").asText(), list.path("Agama").asText(),
                            list.path("AlamatTinggal").asText(), list.path("NoTelp").asText(),
                            list.path("SttsNikah").asText(), list.path("Spesialis").asText(),
                            list.path("Alumni").asText(), list.path("NoIjinPraktek").asText()});
                    }
                } else {
                    for (JsonNode list : response) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariDokter.class.getName());
