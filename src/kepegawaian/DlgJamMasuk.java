...
public class DlgJamMasuk extends javax.swing.JDialog {
    ...
    public DlgJamMasuk(java.awt.Frame parent, boolean modal) {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from jam_masuk where shift like ? order by shift");
        } catch (Exception e) {
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (int i = 0; i < tbJadwal.getRowCount(); i++) {
            if (tbJadwal.getValueAt(i, 0).toString().equals("true")) {
                Sequel.queryu("delete from jam_masuk where shift='" + tbJadwal.
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        Sequel.mengedit("jam_masuk", "shift=?", "jam_masuk=?,jam_pulang=?", 3,
                new String[]{
                    cmbJam1.getSelectedItem() + ":" + cmbMnt1.getSelectedItem() + ":" + cmbDtk1.
                    getSelectedItem(),
                    cmbJam2.getSelectedItem() + ":" + cmbMnt2.getSelectedItem() + ":" + cmbDtk2.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptJammasuk.jasper", "report",
                    "::[ Jadwal Pegawai ]::",
                    "select * from jam_masuk where shift like '%" + TCari.
    ...
    private static final Logger LOG = Logger.getLogger(DlgJamMasuk.class.
            getName());
}
