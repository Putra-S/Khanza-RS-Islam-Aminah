...
public class DlgJadwalTambahan extends javax.swing.JDialog {
    ...
    private String pilihan = "", dateString, dayOfWeek, hari, h1 = "", h2 = "", h3 = "", h4 = "", h5 = "", h6 = "",
            ...
            public void windowClosed(WindowEvent e) {
                if (jammasuk.getTable().getSelectedRow() != -1) {
                    if (tbJadwal.getSelectedColumn() > 4) {
                        tabMode.setValueAt(
                                jammasuk.getTable().getValueAt(jammasuk.getTable().getSelectedRow(), 1).toString(),
                                tbJadwal.getSelectedRow(), tbJadwal.getSelectedColumn());
                    }
                }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        for (i = 0; i < tabMode.getRowCount(); i++) {
            Sequel.menyimpan2("jadwal_tambahan",
                    "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                    34,
                    new String[]{
                        ...
                        tabMode.getValueAt(i, 9).toString(), tabMode.getValueAt(
                        i, 10).toString(),
                        tabMode.getValueAt(i, 11).toString(), tabMode.
                        getValueAt(i, 12).toString(), tabMode.getValueAt(i, 13).
                        toString(),
                        tabMode.getValueAt(i, 14).toString(), tabMode.
                        getValueAt(i, 15).toString(), tabMode.getValueAt(i, 16).
                        toString(),
                        tabMode.getValueAt(i, 17).toString(), tabMode.
                        getValueAt(i, 18).toString(), tabMode.getValueAt(i, 19).
                        toString(),
                        tabMode.getValueAt(i, 20).toString(), tabMode.
                        getValueAt(i, 21).toString(), tabMode.getValueAt(i, 22).
                        toString(),
                        tabMode.getValueAt(i, 23).toString(), tabMode.
                        getValueAt(i, 24).toString(), tabMode.getValueAt(i, 25).
                        toString(),
                        tabMode.getValueAt(i, 26).toString(), tabMode.
                        getValueAt(i, 27).toString(), tabMode.getValueAt(i, 28).
                        toString(),
                        tabMode.getValueAt(i, 29).toString(), tabMode.
                        getValueAt(i, 30).toString(), tabMode.getValueAt(i, 31).
                        toString(),
                        tabMode.getValueAt(i, 32).toString(), tabMode.
                        getValueAt(i, 33).toString(), tabMode.getValueAt(i, 34).
                        toString(),
                        tabMode.getValueAt(i, 35).toString()
                    },
                    "id=? and tahun=? and bulan=?",
                    ...
                    new String[]{
                        ...
                        getValueAt(i, 33).toString(), tabMode.getValueAt(i, 34).
                        toString(),
                        tabMode.getValueAt(i, 35).toString(), tabMode.
                        getValueAt(i, 1).toString(), ThnCari.getSelectedItem().
                        toString(),
                        BlnCari.getSelectedItem().toString()
                    });
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode.getRowCount() != 0) {
            if (tbJadwal.getSelectedRow() != -1) {
                Sequel.queryu2(
                        "delete from jadwal_tambahan where id=? and tahun=? and bulan=?",
                        3, new String[]{
                            tabMode.getValueAt(tbJadwal.getSelectedRow(), 1).
                                    toString(),
                            ThnCari.getSelectedItem().toString(), BlnCari.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (int r = 0; r < row; r++) {
                Sequel.menyimpan("temporary", "'" + r + "','"
                        ...
                        + tabMode.getValueAt(r, 5).toString().replaceAll(
                                ...
                                replaceAll("0", "").replaceAll("agi", "").
                                replaceAll("iang", "").replaceAll("alam", "").
                                replaceAll(" ", "") + "','"
            ...
            param.put("departemen", Departemen.getSelectedItem().toString().
                    replaceAll("Semua", ""));
            param.put("periode",
            ...
            try {
                pilihan = (String) JOptionPane.showInputDialog(null,
                        "Silahkan pilih model cetak..!", "Jadwal",
                        JOptionPane.QUESTION_MESSAGE, null, new Object[]{
                            "Tampilkan Semua", "Tanpa departemen & jabatan"},
                        "Tampilkan Semua");
                switch (pilihan) {
                    case "Tampilkan Semua":
                        Valid.MyReportqry("rptJadwalPegawai.jasper", "report",
                                "::[ Jadwal Masuk Tambahan Pegawai ]::",
                                "select * from temporary where temporary.temp37='" + akses.
                                        getalamatip() + "' order by temporary.no",
                                param);
                        break;
                    case "Tanpa departemen & jabatan":
                        Valid.MyReportqry("rptJadwalPegawai2.jasper", "report",
                                "::[ Jadwal Masuk Tambahan Pegawai ]::",
                                "select * from temporary where temporary.temp37='" + akses.
                                        getalamatip() + "' order by temporary.no",
                                param);
    ...
    private void tbJadwalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbJadwalKeyPressed
        if (tabMode.getRowCount() != 0) {
            if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
                jammasuk.isCek();
                jammasuk.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                        getHeight());
                jammasuk.setLocationRelativeTo(internalFrame1);
                jammasuk.setVisible(true);
            } else if (evt.getKeyCode() == KeyEvent.VK_DELETE) {
                tabMode.setValueAt("", tbJadwal.getSelectedRow(), tbJadwal.
                        getSelectedColumn());
            }
        }
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    ps2 = koneksi.prepareStatement(
                            "select jadwal_tambahan.h1,jadwal_tambahan.h2,jadwal_tambahan.h3,jadwal_tambahan.h4,jadwal_tambahan.h5,"
                    ...
                    tabMode.addRow(new Object[]{" " + i + ".", rs.getString("id"), rs.getString("nama"),
                        rs.getString("pendidikan"), rs.getString("departemen"), h1, h2, h3, h4, h5, h6, h7, h8, h9,
    ...
    private static final Logger LOG = Logger.getLogger(DlgJadwalTambahan.class.getName());
