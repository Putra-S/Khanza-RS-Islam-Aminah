...
public class DlgJadwalTambahan extends javax.swing.JDialog {
            ...
            public void windowClosed(WindowEvent e) {
                if (jammasuk.getTable().getSelectedRow() != -1) {
                    if (tbJadwal.getSelectedColumn() > 4) {
                        tabMode.setValueAt(jammasuk.getTable().getValueAt(
                                jammasuk.getTable().getSelectedRow(), 1).
                                toString(), tbJadwal.getSelectedRow(), tbJadwal.
                                getSelectedColumn());
                    }
                }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJadwalTambahan dialog = new DlgJadwalTambahan(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{
                        " " + i + ".", rs.getString("id"), rs.getString("nama"),
                        rs.getString("pendidikan"), rs.getString("departemen"),
    ...
    String konversi(int year, int month, int day) {
        ...
        try {
            ...
            Logger.getLogger(DlgJadwalTambahan.class.getName()).
    ...
    private static final Logger LOG = Logger.getLogger(DlgJadwalTambahan.class.
            getName());
