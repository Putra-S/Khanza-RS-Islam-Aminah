...
public class DlgRiwayatNaikGaji extends javax.swing.JDialog {
        ...
        try {
            if (engine.getLocation().contains("ListRiwayatGaji")) {
                loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + prop.
                        ...
                        "HYBRIDWEB") + "/" + "penggajian/index.php?act=ListRiwayatGaji&action=LIHAT&keyword=" + TCari.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRiwayatNaikGaji dialog = new DlgRiwayatNaikGaji(
    ...
    private static final Logger LOG = Logger.getLogger(DlgRiwayatNaikGaji.class.
            getName());
