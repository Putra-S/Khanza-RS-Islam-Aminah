...
public class DlgAuditPengelolaanLinenKotor extends javax.swing.JDialog {
    ...
    private double audit1 = 0, audit2 = 0, audit3 = 0, audit4 = 0, audit5 = 0, ttlaudit1 = 0, audit6 = 0, audit7 = 0,
            audit8 = 0, ttlaudit2 = 0, ttlaudit3 = 0, ttlaudit4 = 0, ttlaudit5 = 0, ttlaudit6 = 0, ttlaudit7 = 0,
            ttlaudit8 = 0, ttlpenilaian = 0;
    ...
    public DlgAuditPengelolaanLinenKotor(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Tanggal Audit", "ID Ruang", "Ruang/Unit",
            ...
            "8.Sudah Tersedia Trolli Khusus Untuk Linen Infeksius Dan Non Infeksius", "Ttl.Nilai(%)"}) {
            @Override
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    ttlaudit8 += audit8;
                    ttlpenilaian += (((audit1 + audit2 + audit3 + audit4 + audit5 + audit6 + audit7 + audit8) / 8)
                            * 100);
                    tabMode.addRow(new String[]{rs.getString("tanggal"), rs.getString("id_ruang"),
                        ...
                        Math.round(
                        ((audit1 + audit2 + audit3 + audit4 + audit5 + audit6 + audit7 + audit8) / 8) * 100)
                        + " %"});
                    i++;
                }
                i -= 1;
                if (i > 0) {
                    ...
                    tabMode.addRow(new String[]{"", "Rata-rata", ":", Math.round((ttlaudit1 / i) * 100) + " %",
                        ...
                        Math.round((ttlaudit8 / i) * 100) + " %", Math.round(ttlpenilaian / i) + " %"});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgAuditPengelolaanLinenKotor.class.getName());
