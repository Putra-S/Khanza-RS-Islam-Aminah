 ...
 * @author perpustakaan
 */
public class DlgAuditCuciTanganMedis extends javax.swing.JDialog {
    ...
    private double sebelum_menyentuh_pasien = 0, sebelum_tehnik_aseptik = 0, setelah_terpapar_cairan_tubuh_pasien = 0,
            setelah_kontak_dengan_pasien = 0, setelah_kontak_dengan_lingkungan_pasien = 0,
            ttlsebelum_menyentuh_pasien = 0, ttlsebelum_tehnik_aseptik = 0, ttlsetelah_terpapar_cairan_tubuh_pasien = 0,
            ttlsetelah_kontak_dengan_pasien = 0, ttlsetelah_kontak_dengan_lingkungan_pasien = 0, ttlpenilaian = 0;
    ...
    public DlgAuditCuciTanganMedis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Tanggal Audit", "NIP/Kode", "Dokter/Paramedis", "Sebelum Menyentuh Pasien",
                    "Sebelum Tehnik Aseptik", "Setelah Terpapar Cairan Tubuh Pasien",
                    "Setelah Kontak Dengan Pasien", "Setelah Kontak Dengan Lingkungan Pasien", "Ttl.Nilai(%)"}) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Nip.getText().trim().isEmpty() || NamaPetugas.getText().trim().
            ...
            if (Sequel.menyimpantf("audit_cuci_tangan_medis", "?,?,?,?,?,?,?",
                    "Data", 7, new String[]{
                        Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Jam.
                        getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
                        getSelectedItem(), Nip.getText(), SebelumMenyentuh.
                        getSelectedItem().toString(),
                        SebelumTehnik.getSelectedItem().toString(),
                        SetelahTerpapar.getSelectedItem().toString(),
                        SetelahKontak.getSelectedItem().toString(),
                        SetelahLingkungan.getSelectedItem().toString()
                    }) == true) {
                tampil();
                emptTeks();
            }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbObat.getSelectedRow() != -1) {
            if (Sequel.queryu2tf(
                    "delete from audit_cuci_tangan_medis where nik=? and tanggal=?",
                    2, new String[]{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Nip.getText().trim().isEmpty() || NamaPetugas.getText().trim().
            ...
            Sequel.mengedit("audit_cuci_tangan_medis", "nik=? and tanggal=?",
                    "tanggal=?,nik=?,sebelum_menyentuh_pasien=?,sebelum_tehnik_aseptik=?,setelah_terpapar_cairan_tubuh_pasien=?,setelah_kontak_dengan_pasien=?,setelah_kontak_dengan_lingkungan_pasien=?",
                    9, new String[]{
                        Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Jam.
                        getSelectedItem() + ":" + Menit.getSelectedItem() + ":" + Detik.
                        getSelectedItem(), Nip.getText(), SebelumMenyentuh.
                        getSelectedItem().toString(), SebelumTehnik.
                                getSelectedItem().toString(), SetelahTerpapar.
                                getSelectedItem().toString(),
                        SetelahKontak.getSelectedItem().toString(),
                        SetelahLingkungan.getSelectedItem().toString(), tbObat.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptAuditCuciTanganMedis.jasper", "report",
                        "::[ Data Audit Cuci Tangan Medis ]::",
                        ...
                        SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' order by audit_cuci_tangan_medis.tanggal",
                        param);
            } else {
                Valid.MyReportqry("rptAuditCuciTanganMedis.jasper", "report",
                        "::[ Data Audit Cuci Tangan Medis ]::",
                        ...
                        + "and (audit_cuci_tangan_medis.nik like '%" + TCari.
                                getText().trim() + "%' or pegawai.nama like '%" + TCari.
                                getText().trim() + "%') order by audit_cuci_tangan_medis.tanggal",
                        param);
            }
        }
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                ttlsebelum_menyentuh_pasien = 0;
                ttlsebelum_tehnik_aseptik = 0;
                ttlsetelah_terpapar_cairan_tubuh_pasien = 0;
                ttlsetelah_kontak_dengan_pasien = 0;
                ttlsetelah_kontak_dengan_lingkungan_pasien = 0;
                ttlpenilaian = 0;
                i = 1;
                while (rs.next()) {
                    sebelum_menyentuh_pasien = Double.parseDouble(
                            rs.getString("sebelum_menyentuh_pasien").replaceAll("Ya", "1").replaceAll("Tidak", "0"));
                    ttlsebelum_menyentuh_pasien += sebelum_menyentuh_pasien;
                    sebelum_tehnik_aseptik = Double.parseDouble(
                            rs.getString("sebelum_tehnik_aseptik").replaceAll("Ya", "1").replaceAll("Tidak", "0"));
                    ttlsebelum_tehnik_aseptik += sebelum_tehnik_aseptik;
                    setelah_terpapar_cairan_tubuh_pasien = Double
                            .parseDouble(rs.getString("setelah_terpapar_cairan_tubuh_pasien")
                                    .replaceAll("Ya", "1")
                                    .replaceAll("Tidak", "0"));
                    ttlsetelah_terpapar_cairan_tubuh_pasien += setelah_terpapar_cairan_tubuh_pasien;
                    setelah_kontak_dengan_pasien = Double.parseDouble(rs.getString("setelah_kontak_dengan_pasien")
                            .replaceAll("Ya", "1")
                            .replaceAll("Tidak", "0"));
                    ttlsetelah_kontak_dengan_pasien += setelah_kontak_dengan_pasien;
                    setelah_kontak_dengan_lingkungan_pasien = Double
                            .parseDouble(rs.getString("setelah_kontak_dengan_lingkungan_pasien")
                                    .replaceAll("Ya", "1")
                                    .replaceAll("Tidak", "0"));
                    ttlsetelah_kontak_dengan_lingkungan_pasien += setelah_kontak_dengan_lingkungan_pasien;
                    ttlpenilaian += (((sebelum_menyentuh_pasien + sebelum_tehnik_aseptik
                            + setelah_terpapar_cairan_tubuh_pasien + setelah_kontak_dengan_pasien
                            + setelah_kontak_dengan_lingkungan_pasien) / 5) * 100);
                    tabMode.addRow(new String[]{rs.getString("tanggal"), rs.getString("nik"), rs.getString("nama"),
                        rs.getString("sebelum_menyentuh_pasien"), rs.getString("sebelum_tehnik_aseptik"),
                        rs.getString("setelah_terpapar_cairan_tubuh_pasien"),
                        rs.getString("setelah_kontak_dengan_pasien"),
                        rs.getString("setelah_kontak_dengan_lingkungan_pasien"),
                        Math.round(((sebelum_menyentuh_pasien + sebelum_tehnik_aseptik
                        + setelah_terpapar_cairan_tubuh_pasien + setelah_kontak_dengan_pasien
                        + setelah_kontak_dengan_lingkungan_pasien) / 5) * 100) + " %"});
                    i++;
                }
                i -= 1;
                if (i > 0) {
                    tabMode.addRow(new String[]{"", "Ya", ":", "" + ttlsebelum_menyentuh_pasien,
                        "" + ttlsebelum_tehnik_aseptik, "" + ttlsetelah_terpapar_cairan_tubuh_pasien,
                        "" + ttlsetelah_kontak_dengan_pasien, "" + ttlsetelah_kontak_dengan_lingkungan_pasien,
                        "" + (ttlsebelum_menyentuh_pasien + ttlsebelum_tehnik_aseptik
                        + ttlsetelah_terpapar_cairan_tubuh_pasien + ttlsetelah_kontak_dengan_pasien
                        + ttlsetelah_kontak_dengan_lingkungan_pasien)});
                    tabMode.addRow(new String[]{"", "Tidak", ":", "" + (i - ttlsebelum_menyentuh_pasien),
                        "" + (i - ttlsebelum_tehnik_aseptik), "" + (i - ttlsetelah_terpapar_cairan_tubuh_pasien),
                        "" + (i - ttlsetelah_kontak_dengan_pasien),
                        "" + (i - ttlsetelah_kontak_dengan_lingkungan_pasien),
                        "" + ((i - ttlsebelum_menyentuh_pasien) + (i - ttlsebelum_tehnik_aseptik)
                        + (i - ttlsetelah_terpapar_cairan_tubuh_pasien)
                        + (i - ttlsetelah_kontak_dengan_pasien)
                        + (i - ttlsetelah_kontak_dengan_lingkungan_pasien))});
                    tabMode.addRow(new String[]{"", "Rata-rata", ":",
                        Math.round((ttlsebelum_menyentuh_pasien / i) * 100) + " %",
                        Math.round((ttlsebelum_tehnik_aseptik / i) * 100) + " %",
                        Math.round((ttlsetelah_terpapar_cairan_tubuh_pasien / i) * 100) + " %",
                        Math.round((ttlsetelah_kontak_dengan_pasien / i) * 100) + " %",
                        Math.round((ttlsetelah_kontak_dengan_lingkungan_pasien / i) * 100) + " %",
    ...
    private static final Logger LOG = Logger.getLogger(DlgAuditCuciTanganMedis.class.getName());
