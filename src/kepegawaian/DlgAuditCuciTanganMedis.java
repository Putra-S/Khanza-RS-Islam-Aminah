...
public class DlgAuditCuciTanganMedis extends javax.swing.JDialog {
    ...
    public DlgAuditCuciTanganMedis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "Tanggal Audit", "NIP/Kode", "Dokter/Paramedis",
            "Sebelum Menyentuh Pasien", "Sebelum Tehnik Aseptik",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgAuditCuciTanganMedis dialog = new DlgAuditCuciTanganMedis(
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                i = 1;
                while (rs.next()) {
                    sebelum_menyentuh_pasien = Double.parseDouble(rs.getString(
                            "sebelum_menyentuh_pasien").replaceAll("Ya", "1").
                            replaceAll("Tidak", "0"));
                    ttlsebelum_menyentuh_pasien += sebelum_menyentuh_pasien;
                    sebelum_tehnik_aseptik = Double.parseDouble(rs.getString(
                            "sebelum_tehnik_aseptik").replaceAll("Ya", "1").
                            replaceAll("Tidak", "0"));
                    ttlsebelum_tehnik_aseptik += sebelum_tehnik_aseptik;
                    setelah_terpapar_cairan_tubuh_pasien = Double.parseDouble(
                    ...
                    setelah_kontak_dengan_pasien = Double.parseDouble(rs.
                            getString("setelah_kontak_dengan_pasien").
                    ...
                    ttlpenilaian += (((sebelum_menyentuh_pasien + sebelum_tehnik_aseptik + setelah_terpapar_cairan_tubuh_pasien + setelah_kontak_dengan_pasien + setelah_kontak_dengan_lingkungan_pasien) / 5) * 100);
                    tabMode.addRow(new String[]{
                        rs.getString("tanggal"), rs.getString("nik"), rs.
                        getString("nama"), rs.getString(
                        "sebelum_menyentuh_pasien"), rs.getString(
                        "sebelum_tehnik_aseptik"),
                        rs.getString("setelah_terpapar_cairan_tubuh_pasien"),
                        rs.getString("setelah_kontak_dengan_pasien"), rs.
                        getString("setelah_kontak_dengan_lingkungan_pasien"),
                        Math.round(
                        ((sebelum_menyentuh_pasien + sebelum_tehnik_aseptik + setelah_terpapar_cairan_tubuh_pasien + setelah_kontak_dengan_pasien + setelah_kontak_dengan_lingkungan_pasien) / 5) * 100) + " %"
                    });
                    i++;
                }
                i -= 1;
                if (i > 0) {
                    tabMode.addRow(new String[]{
                        "", "Ya", ":", "" + ttlsebelum_menyentuh_pasien,
                        "" + ttlsebelum_tehnik_aseptik,
                        "" + ttlsetelah_terpapar_cairan_tubuh_pasien,
                        "" + ttlsetelah_kontak_dengan_pasien,
                    ...
                    tabMode.addRow(new String[]{
                        "", "Tidak", ":", "" + (i - ttlsebelum_menyentuh_pasien),
                        "" + (i - ttlsebelum_tehnik_aseptik),
                    ...
                    tabMode.addRow(new String[]{
                        ...
                        (ttlsebelum_menyentuh_pasien / i) * 100) + " %", Math.
                        round((ttlsebelum_tehnik_aseptik / i) * 100) + " %",
                        Math.round(
                        (ttlsetelah_terpapar_cairan_tubuh_pasien / i) * 100) + " %",
                        Math.round((ttlsetelah_kontak_dengan_pasien / i) * 100) + " %",
                        Math.round(
                        (ttlsetelah_kontak_dengan_lingkungan_pasien / i) * 100) + " %",
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            if (!tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString().
                ...
                SebelumMenyentuh.setSelectedItem(tbObat.getValueAt(tbObat.
                        getSelectedRow(), 3).toString());
                SebelumTehnik.setSelectedItem(tbObat.getValueAt(tbObat.
                        getSelectedRow(), 4).toString());
                SetelahTerpapar.setSelectedItem(tbObat.getValueAt(tbObat.
                        getSelectedRow(), 5).toString());
                SetelahKontak.setSelectedItem(tbObat.getValueAt(tbObat.
                        getSelectedRow(), 6).toString());
                SetelahLingkungan.setSelectedItem(tbObat.getValueAt(tbObat.
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgAuditCuciTanganMedis.class.getName());
}
