...
public class DlgJadwalPegawai extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        for (i = 0; i < tabMode.getRowCount(); i++) {
            Sequel.menyimpan2("jadwal_pegawai",
                    "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                    34,
                    new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode.getRowCount() != 0) {
            if (tbJadwal.getSelectedRow() != -1) {
                Sequel.queryu2(
                        "delete from jadwal_pegawai where id=? and tahun=? and bulan=?",
                        3, new String[]{
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    ps2 = koneksi.prepareStatement(
                            "select jadwal_pegawai.h1,jadwal_pegawai.h2,jadwal_pegawai.h3,jadwal_pegawai.h4,jadwal_pegawai.h5,"
    ...
    private static final Logger LOG = Logger.getLogger(DlgJadwalPegawai.class.getName());
