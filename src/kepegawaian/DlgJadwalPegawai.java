...
public class DlgJadwalPegawai extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgJadwalPegawai dialog = new DlgJadwalPegawai(
    ...
    String konversi(int year, int month, int day) {
        ...
        try {
            ...
            Logger.getLogger(DlgJadwalPegawai.class.getName()).log(Level.SEVERE,
                    null, ex);
        }
    ...
    private static final Logger LOG = Logger.getLogger(DlgJadwalPegawai.class.
            getName());
