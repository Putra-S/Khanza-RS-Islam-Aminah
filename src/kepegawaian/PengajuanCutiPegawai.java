...
public class PengajuanCutiPegawai extends javax.swing.JDialog {
    ...
    public PengajuanCutiPegawai(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.Pengajuan", "Pengajuan", "Tgl Awal", "Tgl Akhir",
            "Jenis Cuti", "Alamat Tujuan", "Jml Cuti", "Kepentingan Cuti", "NIK P.J.", "P.J. Terkait", "Status"}) {
            @Override
...
private void NmPetugasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmPetugasKeyPressed
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_pengajuan"), rs.getString("tanggal"),
                        rs.getString("tanggal_awal"), rs.getString("tanggal_akhir"), rs.getString("urgensi"),
                        rs.getString("alamat"), rs.getString("jumlah"), rs.getString("kepentingan"),
    ...
    private void autoNomor() {
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(pengajuan_cuti.no_pengajuan,3),signed)),0) from pengajuan_cuti where pengajuan_cuti.tanggal='"
    ...
    private static final Logger LOG = Logger.getLogger(PengajuanCutiPegawai.class.getName());
