...
public class DlgBelum extends javax.swing.JDialog {
    ...
    public DlgBelum(java.awt.Frame parent, boolean modal) {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select pegawai.nik, pegawai.nama, pegawai.jk, pegawai.jbtn, pegawai.jnj_jabatan,"
                            ...
                            + "or pegawai.stts_aktif<>'KELUAR' and departemen.nama like ? and pegawai.nama like ? and "
                            + say + "or pegawai.stts_aktif<>'KELUAR' and departemen.nama like ? and pegawai.jk like ? and "
                            + say
                            + "or pegawai.stts_aktif<>'KELUAR' and departemen.nama like ? and pegawai.jbtn like ? and "
                            + say
                            + "or pegawai.stts_aktif<>'KELUAR' and departemen.nama like ? and pegawai.jnj_jabatan like ? and "
                            + say
                            + "or pegawai.stts_aktif<>'KELUAR' and departemen.nama like ? and pegawai.bidang like ? and "
                            + say + " order by pegawai.nik ");
        } catch (Exception ex) {
