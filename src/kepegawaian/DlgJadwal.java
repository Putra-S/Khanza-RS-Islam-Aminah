...
public class DlgJadwal extends javax.swing.JDialog {
    ...
    public DlgJadwal(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"P", "Kode Dokter", "Nama Dokter", "Hari Kerja",
            "Jam Mulai", "Jam Selesai", "Poliklinik", "Kuota"};
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (Kuota.getText().trim().isEmpty()) {
            Valid.textKosong(Kuota, "Kuota");
        } else {
            if (Sequel.menyimpantf("jadwal",
                    "'" + kddokter.getText() + "','" + cmbHari.getSelectedItem() + "','"
                    + cmbJam1.getSelectedItem() + ":" + cmbMnt1.
                    getSelectedItem() + ":" + cmbDtk1.getSelectedItem() + "','"
                    + cmbJam2.getSelectedItem() + ":" + cmbMnt2.
                    getSelectedItem() + ":" + cmbDtk2.getSelectedItem() + "','"
                    + KdPoli.getText() + "','" + Kuota.getText() + "'", "Jadwal") == true) {
                tabMode.addRow(new Object[]{
                    false, kddokter.getText(), nmdokter.getText(), cmbHari.
                    getSelectedItem().toString(),
                    cmbJam1.getSelectedItem() + ":" + cmbMnt1.getSelectedItem() + ":" + cmbDtk1.
                    getSelectedItem(),
                    cmbJam2.getSelectedItem() + ":" + cmbMnt2.getSelectedItem() + ":" + cmbDtk2.
                    getSelectedItem(), TPoli.getText(), Double.valueOf(Kuota.
                    getText())
                });
                emptTeks();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (int i = 0; i < tbJadwal.getRowCount(); i++) {
            if (tbJadwal.getValueAt(i, 0).toString().equals("true")) {
                if (Sequel.queryutf(
                        "delete from jadwal where kd_dokter='" + tbJadwal.
                                getValueAt(i, 1).toString() + "' and hari_kerja='" + tbJadwal.
                        getValueAt(i, 3).toString() + "' "
                        + "and jam_mulai='" + tbJadwal.getValueAt(i, 4).
                                toString() + "'") == true) {
                    tabMode.removeRow(i);
                    i--;
                }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (nmdokter.getText().trim().isEmpty()) {
            ...
            if (tbJadwal.getSelectedRow() != -1) {
                if (Sequel.queryutf("update jadwal set jam_mulai='" + cmbJam1.
                        getSelectedItem() + ":" + cmbMnt1.getSelectedItem() + ":" + cmbDtk1.
                        getSelectedItem() + "',"
                        + "jam_selesai='" + cmbJam2.getSelectedItem() + ":" + cmbMnt2.
                        getSelectedItem() + ":" + cmbDtk2.getSelectedItem() + "',"
                        + "kd_poli='" + KdPoli.getText() + "',kd_dokter='" + kddokter.
                        getText() + "',hari_kerja='" + cmbHari.getSelectedItem() + "',kuota='" + Kuota.
                        getText() + "' where "
                        + "kd_dokter='" + tbJadwal.getValueAt(tbJadwal.
                                getSelectedRow(), 1).toString() + "' "
                        + "and hari_kerja='" + tbJadwal.getValueAt(tbJadwal.
                                getSelectedRow(), 3).toString() + "' "
                        + "and jam_mulai='" + tbJadwal.getValueAt(tbJadwal.
                                getSelectedRow(), 4).toString() + "' "
                        + "and jam_selesai='" + tbJadwal.getValueAt(tbJadwal.
                                getSelectedRow(), 5).toString() + "'") == true) {
                    tbJadwal.setValueAt(false, tbJadwal.getSelectedRow(), 0);
                    tbJadwal.setValueAt(kddokter.getText(), tbJadwal.
                            getSelectedRow(), 1);
                    tbJadwal.setValueAt(nmdokter.getText(), tbJadwal.
                            getSelectedRow(), 2);
                    tbJadwal.setValueAt(cmbHari.getSelectedItem().toString(),
                            tbJadwal.getSelectedRow(), 3);
                    tbJadwal.setValueAt(
                            cmbJam1.getSelectedItem() + ":" + cmbMnt1.
                            getSelectedItem() + ":" + cmbDtk1.getSelectedItem(),
                            tbJadwal.getSelectedRow(), 4);
                    tbJadwal.setValueAt(
                            cmbJam2.getSelectedItem() + ":" + cmbMnt2.
                            getSelectedItem() + ":" + cmbDtk2.getSelectedItem(),
                            tbJadwal.getSelectedRow(), 5);
                    tbJadwal.setValueAt(TPoli.getText(), tbJadwal.
                            getSelectedRow(), 6);
                    tbJadwal.setValueAt(Double.valueOf(Kuota.getText()),
                            tbJadwal.getSelectedRow(), 7);
                    emptTeks();
                }
            }
        }
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptJadwal.jasper", "report",
...
private void BtnPoliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPoliActionPerformed
    ...
    private void getData() {
        ...
        if (row != -1) {
            ...
            cmbJam1.setSelectedItem(tabMode.getValueAt(row, 4).toString().
                    substring(0, 2));
            cmbMnt1.setSelectedItem(tabMode.getValueAt(row, 4).toString().
                    substring(3, 5));
            cmbDtk1.setSelectedItem(tabMode.getValueAt(row, 4).toString().
                    substring(6, 8));
            cmbJam2.setSelectedItem(tabMode.getValueAt(row, 5).toString().
                    substring(0, 2));
            cmbMnt2.setSelectedItem(tabMode.getValueAt(row, 5).toString().
                    substring(3, 5));
            cmbDtk2.setSelectedItem(tabMode.getValueAt(row, 5).toString().
                    substring(6, 8));
            TPoli.setText(tabMode.getValueAt(row, 6).toString());
            Kuota.setText(Valid.SetAngka(Double.parseDouble(tabMode.getValueAt(
                    row, 7).toString())));
            Sequel.cariIsi(
                    "select poliklinik.kd_poli from poliklinik where poliklinik.nm_poli='" + tabMode.
                            getValueAt(row, 6).toString() + "'", KdPoli);
        }
    }

    private static final Logger LOG = Logger.
            getLogger(DlgJadwal.class.getName());
