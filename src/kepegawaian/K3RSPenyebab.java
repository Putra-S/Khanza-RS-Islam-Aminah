...
public class K3RSPenyebab extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("k3rs_penyebab", "'" + TKd.getText() + "','" + TNm.
                    getText() + "'", "Kode");
            tampil();
            emptTeks();
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("k3rs_penyebab", "kode_penyebab=?",
                        "kode_penyebab=?,penyebab_kecelakaan=?", 3,
                        new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            K3RSPenyebab dialog = new K3RSPenyebab(new javax.swing.JFrame(),
                    true);
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from k3rs_penyebab where kode_penyebab like ? or penyebab_kecelakaan like ? order by kode_penyebab");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(K3RSPenyebab.class.
            getName());
}
