...
public class SKPKriteriaPenilaian extends javax.swing.JDialog {
    ...
    public SKPKriteriaPenilaian(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"Kode Kriteria", "Kriteria", "Kode Kategori", "Kategori", "Sasaran"}) {
            @Override
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs
                        .getString(5)
    ...
    private static final Logger LOG = Logger.getLogger(SKPKriteriaPenilaian.class.getName());
