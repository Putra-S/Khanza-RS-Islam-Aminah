...
public class DlgRuangAuditKepatuhan extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("ruang_audit_kepatuhan",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.mengedit("ruang_audit_kepatuhan", "id_ruang=?",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRuangAuditKepatuhan dialog = new DlgRuangAuditKepatuhan(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from ruang_audit_kepatuhan where id_ruang like ? "
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgRuangAuditKepatuhan.class.getName());
}
