...
public final class DlgKehadiran extends javax.swing.JDialog {
    ...
    private String hadir = "0", siang = "0", malam = "0", tepatwaktu = "0", toleransi = "0", terlambat1 = "0",
            terlambat2 = "0", terlambat3 = "0", pagi = "0", keterlambatan = "0", durasi = "0";
    ...
    public DlgKehadiran(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"NIP", "Nama", "Departemen", "Kehadiran", "Pagi", "Siang", "Malam", "Tepat Waktu",
                    "Toleransi", "Terlambat I", "Terlambat II", "Keterlambatan", "Durasi", "Wajib Masuk",
                    "% Hadir"}) {
            @Override
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                liburakhad = Valid.hariAkhad(Integer.parseInt(BlnCari.getSelectedItem().toString()),
                        Integer.parseInt(ThnCari.getSelectedItem().toString()));
                jumlahhari = Valid.jumlahHari(Integer.parseInt(BlnCari.getSelectedItem().toString()),
                        Integer.parseInt(ThnCari.getSelectedItem().toString()));
                ...
                while (rs.next()) {
                    ...
                    if (rs.getString("wajibmasuk").equals("-1")) {
                        ...
                        wajibmasuk = Sequel.cariInteger(
                                ...
                                + "if(h31='',0,1)) from jadwal_pegawai where id='" + rs.getString("id")
                                + "' and " + "tahun='" + ThnCari.getSelectedItem().toString() + "' and bulan='"
                    ...
                    tabMode.addRow(new Object[]{rs.getString(1), rs.getString(2), rs.getString(3), hadir, pagi, siang,
                        malam, tepatwaktu, toleransi, terlambat3, terlambat2, keterlambatan, durasi, wajibmasuk,
                        Math.round((Double.parseDouble(hadir) / wajibmasuk) * 100) + " %"});
                }
            } catch (Exception e) {
