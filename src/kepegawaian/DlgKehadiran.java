...
public class DlgKehadiran extends javax.swing.JDialog {
    ...
    public DlgKehadiran(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "NIP", "Nama", "Departemen", "Kehadiran", "Pagi", "Siang", "Malam",
            "Tepat Waktu", "Toleransi", "Terlambat I", "Terlambat II",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (int r = 0; r < tbBangsal.getRowCount(); r++) {
                Sequel.menyimpan("temporary", "'" + r + "','"
                        ...
                        + tbBangsal.getValueAt(r, 13).toString().replaceAll("'",
                                "`") + "','"
                        + tbBangsal.getValueAt(r, 14).toString().replaceAll("'",
                                "`") + "','','','','','','','','','','','','','','','','','','','','','','" + akses.
            ...
            Valid.MyReportqry("rptHadir.jasper", "report",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKehadiran dialog = new DlgKehadiran(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                liburhariraya = Sequel.cariInteger(
                        "select count(set_hari_libur.tanggal) from set_hari_libur where left(set_hari_libur.tanggal,7)=?",
                        ThnCari.getSelectedItem().toString() + "-" + BlnCari.
                        getSelectedItem().toString());
                liburakhad = Valid.hariAkhad(Integer.parseInt(BlnCari.
                        getSelectedItem().toString()), Integer.parseInt(ThnCari.
                                getSelectedItem().toString()));
                jumlahhari = Valid.jumlahHari(Integer.parseInt(BlnCari.
                        getSelectedItem().toString()), Integer.parseInt(ThnCari.
                                getSelectedItem().toString()));
                ...
                while (rs.next()) {
                    ...
                    if (rs.getString("wajibmasuk").equals("-1")) {
                        ...
                        wajibmasuk = Sequel.cariInteger(
                                "select (if(h1='',0,1)+if(h2='',0,1)+if(h3='',0,1)+if(h4='',0,1)+if(h5='',0,1)+"
                                ...
                                + "if(h31='',0,1)) from jadwal_pegawai where id='" + rs.
                                        getString("id") + "' and "
                                + "tahun='" + ThnCari.getSelectedItem().
                                        toString() + "' and bulan='" + BlnCari.
                                        getSelectedItem().toString() + "'");
                    ...
                    terlambat3 = Valid.SetAngka2(
                            Double.parseDouble(terlambat1) - Double.parseDouble(
                            terlambat2));

                    tabMode.addRow(new Object[]{
                        rs.getString(1), rs.getString(2), rs.getString(3), hadir,
                        pagi, siang, malam, tepatwaktu, toleransi, terlambat3,
                        terlambat2, keterlambatan, durasi, wajibmasuk, Math.
                        round((Double.parseDouble(hadir) / wajibmasuk) * 100) + " %"
                    });
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgKehadiran.class.
            getName());
