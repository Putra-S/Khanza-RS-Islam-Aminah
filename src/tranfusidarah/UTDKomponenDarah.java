...
public class UTDKomponenDarah extends javax.swing.JDialog {
    ...
    public UTDKomponenDarah(java.awt.Frame parent, boolean modal) {
        ...
        tabModeKomponen = new DefaultTableModel(null, new String[]{"Kode", "Nama Komponen", "Lama(Hari)",
            "Jasa Sarana", "Paket BHP", "KSO", "Manajemen", "Total", "Pembatalan"}) {
...
//GEN-FIRST:event_TKdKeyPressed
    private void KodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-LAST:event_TKdKeyPressed
        Valid.pindah(evt, Pembatalan, Lama, TCari);//GEN-FIRST:event_KodeKeyPressed
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    tabModeKomponen
                            .addRow(new Object[]{rs.getString(1), rs.getString(2), rs.getString(3), rs.getDouble(4),
    ...
    private void getData() {
        if (tbKomponen.getSelectedRow() != -1) {
            ...
            JasaSarana.setText("" + Math
                    .round(Double.parseDouble(tabModeKomponen.getValueAt(tbKomponen.getSelectedRow(), 3).toString())));
            PaketBHP.setText("" + Math
                    .round(Double.parseDouble(tabModeKomponen.getValueAt(tbKomponen.getSelectedRow(), 4).toString())));
            KSO.setText("" + Math
                    .round(Double.parseDouble(tabModeKomponen.getValueAt(tbKomponen.getSelectedRow(), 5).toString())));
            Manajemen.setText("" + Math
                    .round(Double.parseDouble(tabModeKomponen.getValueAt(tbKomponen.getSelectedRow(), 6).toString())));
            Total.setText("" + Math
                    .round(Double.parseDouble(tabModeKomponen.getValueAt(tbKomponen.getSelectedRow(), 7).toString())));
            Pembatalan.setText("" + Math
                    .round(Double.parseDouble(tabModeKomponen.getValueAt(tbKomponen.getSelectedRow(), 8).toString())));
        }
    }
    ...
    private void isjml() {
        if ((!JasaSarana.getText().isEmpty()) && (!PaketBHP.getText().isEmpty()) && (!KSO.getText().isEmpty())
                && (!Manajemen.getText().isEmpty())) {
            Total.setText(Valid.SetAngka2(Double.parseDouble(JasaSarana.getText().trim())
                    + Double.parseDouble(PaketBHP.getText().trim()) + Double.parseDouble(KSO.getText().trim())
                    + Double.parseDouble(Manajemen.getText().trim())));
        }
    }

    private static final Logger LOG = Logger.getLogger(UTDKomponenDarah.class.getName());
