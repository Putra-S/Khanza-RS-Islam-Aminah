...
public class UTDStokDarah extends javax.swing.JDialog {
    ...
    public UTDStokDarah(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.Kantung", "Komponen", "G.D.", "Rhesus", "Aftap", "Kadaluarsa", "Asal Darah", "Status",
            "Jasa Sarana", "Paket BHP", "KSO", "Manajemen", "Biaya", "Pembatalan", "Kode Komponen"};
        ...
        komponen.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (komponen.getTable().getSelectedRow() != -1) {
                    ...
                    NoKantong.setText(komponen.getTable().getValueAt(komponen.getTable().getSelectedRow(), 0).toString()
                            + NoKantong.getText());
                    NamaKomponen
                    ...
                    cal.add(Calendar.DATE, Integer
                            .parseInt(komponen.getTable().getValueAt(komponen.getTable().getSelectedRow(), 2).toString()));
...
//GEN-FIRST:event_TKdKeyPressed
    private void NoKantongKeyPressed(java.awt.event.KeyEvent evt) {//GEN-LAST:event_TKdKeyPressed
        Valid.pindah(evt, KodeKomponen, TCari);//GEN-FIRST:event_NoKantongKeyPressed
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    private void tampil() {
        ...
        try {
            if (panelCari.isVisible() == false) {
                ps = koneksi.prepareStatement("select utd_stok_darah.no_kantong,utd_komponen_darah.nama as darah,"
                        + "utd_stok_darah.golongan_darah,utd_stok_darah.resus,"
                        + "utd_stok_darah.tanggal_aftap,utd_stok_darah.tanggal_kadaluarsa,"
                        + "utd_stok_darah.asal_darah,utd_stok_darah.status,"
                        + "utd_komponen_darah.jasa_sarana,utd_komponen_darah.paket_bhp,"
                ...
                ps = koneksi.prepareStatement("select utd_stok_darah.no_kantong,utd_komponen_darah.nama as darah,"
                        ...
                        + "utd_stok_darah.golongan_darah=? and utd_stok_darah.asal_darah=? and "
                        + "utd_komponen_darah.nama like ? " + " order by utd_stok_darah.tanggal_kadaluarsa");
            }
    ...
    private static final Logger LOG = Logger.getLogger(UTDStokDarah.class.getName());
