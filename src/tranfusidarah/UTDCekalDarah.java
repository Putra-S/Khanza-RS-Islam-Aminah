...
public class UTDCekalDarah extends javax.swing.JDialog {
    ...
    public UTDCekalDarah(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Nomor", "No.ID", "Nama Pendonor", "No.Telp", "Tanggal", "Dinas", "NIP", "Petugas Cekal",
            "Keterangan"};
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    private static final Logger LOG = Logger.getLogger(UTDCekalDarah.class.getName());
