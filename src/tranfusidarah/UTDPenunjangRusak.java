...
public class UTDPenunjangRusak extends javax.swing.JDialog {
    ...
    public UTDPenunjangRusak(java.awt.Frame parent, boolean modal) {
        ...
        tabMode2 = new DefaultTableModel(null, new Object[]{"Kode Barang", "Nama Barang", "Jml", "Harga", "Subtotal",
            "Petugas", "", "Tanggal", "Keterangan"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
            }
...
//GEN-FIRST:event_TKdKeyPressed
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        if (nmpetugas.getText().trim().isEmpty() || nip.getText().trim().//GEN-FIRST:event_BtnSimpanActionPerformed
                isEmpty()) {
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    private void nipKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nipKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_PAGE_DOWN) {
            Sequel.cariIsi("select nama from petugas where nip='" + nip.
                    getText() + "'", nmpetugas);
        } else if (evt.getKeyCode() == KeyEvent.VK_PAGE_UP) {
            Sequel.cariIsi("select nama from petugas where nip='" + nip.
                    getText() + "'", nmpetugas);
        ...
        if (tabMode.getRowCount() != 0) {
            if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                if (tbDokter.getSelectedColumn() == 1) {
                    try {
                        if (Valid.SetAngka(tabMode.getValueAt(tbDokter.
                                getSelectedRow(), 0).toString()) > 0) {
                            tbDokter.setValueAt(
                                    Double.toString(
                                            Double.parseDouble(tabMode.
                                                    getValueAt(tbDokter.
                                                            getSelectedRow(), 0).
                                                    toString())
                                            * Double.parseDouble(tabMode.
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode2.getRowCount() == 0) {
            ...
            Sequel.queryu(
                    "delete from utd_penunjang_rusak where kode_brng='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 0) + "' "
                    + "and nip='" + tbKamar.getValueAt(tbKamar.getSelectedRow(),
                            6) + "' "
                    + "and tanggal='" + tbKamar.getValueAt(tbKamar.
                            getSelectedRow(), 7).toString() + "' "
                    + "and jml='" + tbKamar.getValueAt(tbKamar.getSelectedRow(),
                            2) + "'");
            Sequel.menyimpan("utd_stok_penunjang", "'" + tbKamar.getValueAt(
                    tbKamar.getSelectedRow(), 0) + "',"
                    + "'" + tbKamar.getValueAt(tbKamar.getSelectedRow(), 2) + "'",
                    "stok=stok+" + tbKamar.getValueAt(tbKamar.getSelectedRow(),
                            2),
                    "kode_brng='" + tbKamar.getValueAt(tbKamar.getSelectedRow(),
                            0) + "'");
    ...
    private void BtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCetakActionPerformed
        ...
        if (tabMode2.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptUTDPenunjangRusak.jasper", "report",
                    "::[ Data BHP Non Medis Rusak Unit Tranfusi Darah ]::",
                    ...
                    + "where utd_penunjang_rusak.tanggal between '" + Valid.
                            SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and utd_penunjang_rusak.kode_brng like '%" + TCari2.
                    getText().trim() + "%' or "
                    + "utd_penunjang_rusak.tanggal between '" + Valid.SetTgl(
                            DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and ipsrsbarang.nama_brng like '%" + TCari2.
                    getText().trim() + "%' or "
                    + "utd_penunjang_rusak.tanggal between '" + Valid.SetTgl(
                            DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and utd_penunjang_rusak.nip like '%" + TCari2.
                    getText().trim() + "%' or "
                    + "utd_penunjang_rusak.tanggal between '" + Valid.SetTgl(
                            DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and petugas.nama like '%" + TCari2.
                    getText().trim() + "%' or "
                    + "utd_penunjang_rusak.tanggal between '" + Valid.SetTgl(
                            DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and utd_penunjang_rusak.keterangan like '%" + TCari2.
                    getText().trim() + "%' order by utd_penunjang_rusak.tanggal",
                    param);
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{null, rs.getString(1), rs.getString(2), rs.getString(3), 0,
    ...
    public void tampil2() {
        ...
        try {
            ...
            try {
                ...
                while (rs2.next()) {
                    tabMode2.addRow(new Object[]{rs2.getString("kode_brng"),
                        rs2.getString("nama_brng") + " (" + rs2.getString("kode_sat") + ")", rs2.getString("jml"),
                        rs2.getString("harga"), rs2.getString("total"),
                        rs2.getString("nip") + " " + rs2.getString("nama"), rs2.getString("nip"),
                        rs2.getString("tanggal"), rs2.getString("keterangan")});
    ...
    private static final Logger LOG = Logger.getLogger(UTDPenunjangRusak.class.getName());
