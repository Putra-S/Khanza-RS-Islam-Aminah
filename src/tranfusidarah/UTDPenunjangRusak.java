...
public class UTDPenunjangRusak extends javax.swing.JDialog {
    ...
    public UTDPenunjangRusak(java.awt.Frame parent, boolean modal) {
        ...
        tabMode2 = new DefaultTableModel(null, new Object[]{
            "Kode Barang", "Nama Barang", "Jml", "Harga", "Subtotal", "Petugas",
            "", "Tanggal", "Keterangan"
        }) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgUTDMedisRusak")) {
                    if (petugas.getTable().getSelectedRow() != -1) {
                        nip.setText(petugas.getTable().getValueAt(petugas.
...
*/
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (nmpetugas.getText().trim().isEmpty() || nip.getText().trim().
                isEmpty()) {
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            UTDPenunjangRusak dialog = new UTDPenunjangRusak(
    ...
    private void tampil() {
        ...
        for (i = 0; i < jml; i++) {
            tabMode.addRow(new Object[]{jumlah[i], kodebarang[i], namabarang[i],
                hbeli[i], total[i], satuan[i], stokasal[i]});
        }
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{null, rs.getString(1), rs.
            ...
            try {
                ...
                while (rs2.next()) {
                    tabMode2.addRow(new Object[]{
                        ...
                        rs2.getString("total"),
                        rs2.getString("nip") + " " + rs2.getString("nama"),
    ...
    private static final Logger LOG = Logger.getLogger(UTDPenunjangRusak.class.
            getName());
