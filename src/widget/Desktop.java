...
public class Desktop extends JDesktopPane {
    ...
    /*
	 * private Color black =Color.lightGray.darker().darker().darker(); private Color
	 * warna = new Color(150,140,130);
     */
    // private final Color black = new Color(255,205,255);
    private final Color black = new Color(102, 255, 204);

    // private Color warna = new Color(245,101,163).brighter().brighter();
    // private final Color warna = new Color(255,205,255);
    private final Color warna = new Color(102, 255, 204);
    ...
    private static final Logger LOG = Logger.getLogger(Desktop.class.getName());
