...
public class RunText extends Canvas implements Runnable {
  ...
  String text =
      "aku adalah anak gembala selalu riang serta gembira, karena aku rajin bekerja tak kenal lelah ataupun lengah.";
  int textWidth = 600;
  int x;
  int y;
  ...
  private static final Logger LOG = Logger.getLogger(RunText.class.getName());
}
