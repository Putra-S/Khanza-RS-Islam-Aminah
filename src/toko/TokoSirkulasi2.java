...
public class TokoSirkulasi2 extends javax.swing.JDialog {
    ...
    public TokoSirkulasi2(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Stok Awal(Rp)", "Pengadaan", "Pengadaan(Rp)", "Penerimaan",
            "Penerimaan(Rp)", "Penjualan", "Penjualan(Rp)", "Piutang",
            "Piutang(Rp)", "Retur Sup", "Retur Sup(Rp)", "Retur Jual",
            "Retur Jual(Rp)", "Retur Piutang", "Retur Piutang(Rp)", "Stok Akhir",
            "Stok Akhir(Rp)"
        }) {
            @Override
...
*/
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            TokoSirkulasi2 dialog = new TokoSirkulasi2(new javax.swing.JFrame(),
                    true);
    ...
    private void prosesCari() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select tokobarang.kode_brng,tokobarang.nama_brng, "
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tglopname = Sequel.cariIsi(
                            "select tanggal from tokoopname where kode_brng='" + rs.
                                    getString(1) + "' and tanggal between '" + Valid.
                            SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.
                            SetTgl(Tgl2.getSelectedItem() + "") + "' order by tanggal asc limit 1");

                    stok = rs.getDouble("stok");
                    totalstok = rs.getDouble("totalstok");

                    ps2 = koneksi.prepareStatement(
                            "select sum(toko_detail_beli.jumlah), sum(toko_detail_beli.total) "
                    ...
                    //tokopemesanan
                    ps2 = koneksi.prepareStatement(
                            "select sum(toko_detail_pesan.jumlah), sum(toko_detail_pesan.total) "
                    ...
                    ps2 = koneksi.prepareStatement(
                            "select sum(toko_detail_jual.jumlah), sum(toko_detail_jual.total) "
                    ...
                    ps2 = koneksi.prepareStatement(
                            "select sum(toko_detail_piutang.jumlah), sum(toko_detail_piutang.total) "
                    ...
                    if ((stok > 0) || (jumlahbeli > 0) || (jumlahpesan > 0) || (jumlahpenjualan > 0) || (jumlahpiutang > 0) || (jumlahretursup > 0) || (jumlahreturjual > 0) || (jumlahreturpiutang > 0)) {
                        ...
                        tabMode.addRow(new Object[]{rs.getString(1), rs.
                            getString(2),
                            rs.getString(3), tglopname, Valid.SetAngka(stokawal),
                            Valid.SetAngka(totalstokawal),
                            Valid.SetAngka(jumlahbeli), Valid.
                            SetAngka(totalbeli),
                            Valid.SetAngka(jumlahpesan), Valid.SetAngka(
                            totalpesan),
                            Valid.SetAngka(jumlahpenjualan), Valid.SetAngka(
                            totalpenjualan),
                            Valid.SetAngka(jumlahpiutang), Valid.SetAngka(
                            totalpiutang),
                            Valid.SetAngka(jumlahretursup), Valid.SetAngka(
                            totalretursup),
                            Valid.SetAngka(jumlahreturjual), Valid.SetAngka(
                            totalreturjual),
                            Valid.SetAngka(jumlahreturpiutang), Valid.SetAngka(
                            totalreturpiutang),
                ...
                tabMode.addRow(new Object[]{
                    ...
                    ttltotalpenjualan), "", Valid.SetAngka(ttltotalpiutang), "",
                    Valid.SetAngka(ttltotalretursup), "", Valid.SetAngka(
                    ttltotalreturjual), "", Valid.SetAngka(ttltotalreturpiutang),
    ...
    private static final Logger LOG = Logger.getLogger(TokoSirkulasi2.class.
            getName());
