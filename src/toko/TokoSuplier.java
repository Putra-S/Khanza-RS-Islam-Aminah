...
public class TokoSuplier extends javax.swing.JDialog {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            if (tbDokter.getSelectedRow() > -1) {
                Valid.editTable(tabMode, "tokosuplier", "kode_suplier", "?",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptSuplier.jasper", "report",
                    ...
                    + " where tokosuplier.kode_suplier like '%" + TCari.
                            getText().trim() + "%' or "
                    + " tokosuplier.nama_suplier like '%" + TCari.getText().
                            trim() + "%' or "
                    ...
                    + " tokosuplier.no_telp like '%" + TCari.getText().trim() + "%' order by tokosuplier.kode_suplier",
                    param);
        }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("tokosuplier", "?,?,?,?,?,?,?",
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select tokosuplier.kode_suplier, tokosuplier.nama_suplier, "
                    ...
                    + " where tokosuplier.kode_suplier like ? or " + " tokosuplier.nama_suplier like ? or "
                    + " tokosuplier.alamat like ? or " + " tokosuplier.kota like ? or "
    ...
    private static final Logger LOG = Logger.getLogger(TokoSuplier.class.getName());
