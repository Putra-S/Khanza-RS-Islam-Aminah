    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (NoRetur.getText().trim().isEmpty()) {
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                sukses = true;
                if (Sequel.menyimpantf2("tokoreturpiutang", "?,?,?,?,?,?",
                    ...
                    for (i = 0; i < jml; i++) {
                        if (Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()) > 0) {
                            if (Sequel.menyimpantf2("toko_detail_returpiutang",
                                    "?,?,?,?,?,?,?,?", "Transaksi Retur Piutang",
                                    8, new String[]{
                ...
                if (sukses == true) {
                    ...
                    Sequel.menyimpan("tampjurnal", "?,?,?,?", 4, new String[]{
                        Retur_Piutang_Toko, "RETUR PIUTANG", "" + ttl, "0"});
                    Sequel.menyimpan("tampjurnal", "?,?,?,?", 4, new String[]{
                        Kontra_Retur_Piutang_Toko, "KONTRA RETUR PIUTANG", "0",
                        "" + ttl});
                    sukses = jur.simpanJurnal(NoRetur.getText(), "U",
                            "RETUR PIUTANG TOKO" + ", OLEH " + akses.getkode());
                }
