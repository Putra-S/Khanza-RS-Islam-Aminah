 ...
 * @author dosen
 */
public class TokoJenis extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("tokojenisbarang", "'" + Kd.getText() + "','" + Nm.
                    getText() + "'", "Kode Jenis Barang");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbKamar.getRowCount(); i++) {
            if (tbKamar.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("tokojenisbarang", "kd_jenis", tbKamar.
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            if (tbKamar.getSelectedRow() > -1) {
                Valid.editTable(tabMode, "tokojenisbarang", "kd_jenis", "?",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptIpsrsJenis.jasper", "report",
                    ...
                    + " from tokojenisbarang where  kd_jenis like '%" + TCari.
                            getText().trim() + "%' or "
...
private void NmKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select kd_jenis,nm_jenis  "
                    + " from tokojenisbarang where  kd_jenis like ? or " + " nm_jenis like ? order by nm_jenis ");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(TokoJenis.class.getName());
