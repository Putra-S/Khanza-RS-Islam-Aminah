...
*/
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            TokoCariSuplier dialog = new TokoCariSuplier(
    ...
    private void tampil() {
        ...
        try {
            ...
            fileWriter.write("{\"supliertoko\":[" + iyem.substring(0, iyem.
                    length() - 1) + "]}");
            fileWriter.flush();
            fileWriter.close();
            iyem = null;
    ...
    private static final Logger LOG = Logger.getLogger(TokoCariSuplier.class.
            getName());
