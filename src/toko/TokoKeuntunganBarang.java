    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (TabRawat.getSelectedIndex() == 0) {
            if (tabMode.getRowCount() == 0) {
                ...
                Valid.MyReportqry("rptKeuntunganBarangToko1.jasper", "report",
                        "::[ Keuntungan Penjualan Barang Toko ]::",
                        ...
                        + "where tokopenjualan.tgl_jual between '" + Valid.
                                SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.
                        SetTgl(Tgl2.getSelectedItem() + "") + "' "
                        + (TCari.getText().trim().isEmpty() ? "" : " and (tokobarang.nama_brng like '%" + TCari.
                        getText() + "%' or tokopenjualan.nota_jual like '%" + TCari.
                                getText() + "%' or toko_detail_jual.kode_brng like '%" + TCari.
                                getText() + "%' )")
            ...
            if (tabMode2.getRowCount() == 0) {
                ...
                Valid.MyReportqry("rptKeuntunganBarangToko2.jasper", "report",
                        "::[ Keuntungan Piutang Barang Toko ]::",
                        ...
                        SetTgl(Tgl2.getSelectedItem() + "") + "' "
                        + (TCari.getText().trim().isEmpty() ? "" : " and (tokobarang.nama_brng like '%" + TCari.
                        getText() + "%' or tokopiutang.nota_piutang like '%" + TCari.
                                getText() + "%' or toko_detail_piutang.kode_brng like '%" + TCari.
                                getText() + "%' )")
