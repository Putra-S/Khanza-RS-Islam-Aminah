...
public class TokoSirkulasi extends javax.swing.JDialog {
    ...
    private double ttltotalbeli = 0, totalbeli = 0, stok = 0, aset = 0, ttlaset = 0, jumlahbeli = 0, jumlahpiutang = 0,
    ...
    public TokoSirkulasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Barang", "Nama Barang", "Satuan", "Stok", "Stok(Rp)", "Pengadaan", "Pengadaan(Rp)",
                    "Penerimaan", "Penerimaan(Rp)", "Penjualan", "Penjualan(Rp)", "Piutang", "Piutang(Rp)",
                    "Retur Sup", "Retur Sup(Rp)", "Retur Jual", "Retur Jual(Rp)", "Retur Piutang",
                    "Retur Piutang(Rp)"}) {
            @Override
...
//GEN-FIRST:event_TKdKeyPressed
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        if (tabMode.getRowCount() == 0) {//GEN-FIRST:event_BtnPrintActionPerformed
            ...
            Valid.MyReport("rptSirkulasiToko.jasper", "report",
        ...
        try {
            ...
            try {
                ...
                tabMode.addRow(new Object[]{"<>>", "Total :", "", "", Valid.SetAngka(ttlaset), "",
                    ...
                    Valid.SetAngka(ttltotalreturpiutang)});
            } catch (SQLException e) {
    ...
    private static final Logger LOG = Logger.getLogger(TokoSirkulasi.class.getName());
