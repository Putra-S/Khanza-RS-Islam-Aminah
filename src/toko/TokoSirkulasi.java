...
public class TokoSirkulasi extends javax.swing.JDialog {
    ...
    public TokoSirkulasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "Kode Barang", "Nama Barang", "Satuan", "Stok", "Stok(Rp)",
            "Pengadaan", "Pengadaan(Rp)", "Penerimaan", "Penerimaan(Rp)",
            "Penjualan", "Penjualan(Rp)", "Piutang", "Piutang(Rp)", "Retur Sup",
            "Retur Sup(Rp)", "Retur Jual", "Retur Jual(Rp)", "Retur Piutang",
            "Retur Piutang(Rp)"
        }) {
            @Override
...
*/
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            TokoSirkulasi dialog = new TokoSirkulasi(new javax.swing.JFrame(),
                    true);
        ...
        try {
            ...
            try {
                ...
                tabMode.addRow(new Object[]{
                    ...
                    ttltotalpesan), "", Valid.SetAngka(ttltotalpenjualan), "",
                    Valid.SetAngka(ttltotalpiutang), "", Valid.SetAngka(
                    ttltotalretursup), "", Valid.SetAngka(ttltotalreturjual), "",
    ...
    private static final Logger LOG = Logger.getLogger(TokoSirkulasi.class.
            getName());
