...
public class TokoPiutangHarian extends javax.swing.JDialog {
    ...
    public TokoPiutangHarian(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.Nota", "Tanggal", "NIP", "Petugas", "No.Member",
            "Nama Member", "Ongkir", "Uang Muka", "Total", "Jenis", "Sisa Piutang", "Catatan"}) {
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    : "and (tokopiutang.nota_piutang like ? or tokopiutang.nip like ? or "
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{rs.getString("nota_piutang"), rs.getString("tgl_piutang"),
                        rs.getString("nip"), rs.getString("nama"), rs.getString("no_member"),
                        rs.getString("nm_member"), rs.getDouble("ongkir"), rs.getDouble("uangmuka"),
                        rs.getDouble("total"), rs.getString("jns_jual"), rs.getDouble("sisapiutang"),
                        rs.getString("catatan")});
                }
                if (ttlbayar > 0) {
                    tabMode.addRow(
                            new Object[]{"", "", "", "", "", "", ttlongkir, ttluangmuka, ttlbayar, "", ttlsisa, ""});
                }
    ...
    private static final Logger LOG = Logger.getLogger(TokoPiutangHarian.class.getName());
