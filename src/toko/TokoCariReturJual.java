...
//GEN-FIRST:event_TKdKeyPressed
    private void btnSuplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        akses.setform("TokoCariReturJual");//GEN-FIRST:event_btnSuplierActionPerformed
        member.emptTeks();
        member.isCek();
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
    ...
    private void tampil() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement("select tokoreturjual.no_retur_jual,tokoreturjual.no_member,tokomember.nama, "
                    ...
                    + " inner join tokojenisbarang " + " on toko_detail_returjual.kode_brng=tokobarang.kode_brng "
                    ...
                    + " where tokoreturjual.tgl_retur between '" + Valid.SetTgl(TglBeli1.getSelectedItem() + "")
                    + "' and '" + Valid.SetTgl(TglBeli2.getSelectedItem() + "") + "' " + carifaktur + carimember
                    + caripetugas + carijenis + caribarang
                    + (TCari.getText().trim().isEmpty() ? ""
                    : " and (tokoreturjual.no_retur_jual like '%" + TCari.getText()
                    + "%' or tokoreturjual.no_member like '%" + TCari.getText()
                    + "%' or tokomember.nama like '%" + TCari.getText() + "%' or "
                    + " tokoreturjual.nip like '%" + TCari.getText() + "%' or petugas.nama like '%"
                    + TCari.getText() + "%' or toko_detail_returjual.kode_brng like '%"
                    + TCari.getText() + "%' or " + " tokobarang.nama_brng like '%" + TCari.getText()
                    + "%' or toko_detail_returjual.kode_sat like '%" + TCari.getText()
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    ps2 = koneksi.prepareStatement("select toko_detail_returjual.kode_brng,tokobarang.nama_brng, "
                            ...
                            + " toko_detail_returjual.no_retur_jual='" + rs.getString("no_retur_jual") + "'" + carijenis
                            + caribarang + " and (toko_detail_returjual.kode_brng like '%" + TCari.getText().trim()
                            + "%' or tokobarang.nama_brng like '%" + TCari.getText().trim() + "%' or "
                            + " toko_detail_returjual.kode_sat like '%" + TCari.getText().trim()
                            + "%' or tokojenisbarang.nm_jenis like '%" + TCari.getText().trim() + "%' or "
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            ...
                            tabMode.addRow(new Object[]{i + ". " + rs2.getString("kode_brng"),
                                rs2.getString("nama_brng"), "No. Nota : " + rs2.getString("nota_jual"),
                                rs2.getString("satuan"), rs2.getString("jml_retur"),
                                Valid.SetAngka(rs2.getDouble("h_retur")), Valid.SetAngka(rs2.getDouble("total"))});
                            i++;
                        }
                    } catch (SQLException e) {
                    ...
                    tabMode.addRow(new Object[]{"", "Tgl.Retur : " + rs.getString("tgl_retur"), "", "", "",
                        "Total : ", Valid.SetAngka(subtotal)});
                }
            } catch (SQLException e) {
                System.out.println("Notifikasi : " + e);
            } finally {
    ...
    private static final Logger LOG = Logger.getLogger(TokoCariReturJual.class.getName());
