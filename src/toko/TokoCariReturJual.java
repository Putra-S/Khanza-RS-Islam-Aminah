...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptReturJualToko.jasper", "report",
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
        ...
        if (!tbDokter.getValueAt(tbDokter.getSelectedRow(), 6).toString().trim().
            ...
            try {
                pscaripesan = koneksi.prepareStatement(
                        "select no_retur_jual, total from tokoreturjual where no_retur_jual=?");
                try {
                    ...
                    if (rs.next()) {
                        ...
                        sukses = true;
                        pstoko_detail_returjual = koneksi.prepareStatement(
                                "select kode_brng,jml_retur from toko_detail_returjual where no_retur_jual=? ");
                        try {
                            pstoko_detail_returjual.
                                    setString(1, rs.getString(1));
                            rs2 = pstoko_detail_returjual.executeQuery();
                            while (rs2.next()) {
                                Trackbarang.catatRiwayat(rs2.getString(
                                        "kode_brng"), 0, rs2.getDouble(
                                                "jml_retur"), "Retur Jual",
                                        akses.getkode(), "Hapus");
                        ...
                        Sequel.menyimpan("tampjurnal", "?,?,?,?", "Rekening", 4,
                                new String[]{
                                    Sequel.cariIsi(
                                            "select Retur_Jual_Toko from set_akun"),
                        ...
                        Sequel.menyimpan("tampjurnal", "?,?,?,?", "Rekening", 4,
                                new String[]{
                                    Sequel.cariIsi(
                                            "select Kontra_Retur_Jual_Toko from set_akun"),
                                    "KONTRA RETUR JUAL TOKO", rs.getString(
                                            "total"), "0"
                                });

                        sukses = jur.simpanJurnal(rs.getString("no_retur_jual"),
                                "U",
                        ...
                        if (sukses == true) {
                            Sequel.queryu2(
                                    "delete from tokoreturjual where no_retur_jual=?",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            TokoCariReturJual dialog = new TokoCariReturJual(
    ...
    private void tampil() {
        ...
        try {
            ...
            if (!NoFaktur.getText().isEmpty()) {
                carifaktur = " and tokoreturjual.no_retur_jual like '%" + NoFaktur.
                        getText() + "%' ";
            }
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + " where tokoreturjual.tgl_retur between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' " + carifaktur + carimember + caripetugas + carijenis + caribarang
                    + (TCari.getText().trim().isEmpty() ? "" : " and (tokoreturjual.no_retur_jual like '%" + TCari.
                    getText() + "%' or tokoreturjual.no_member like '%" + TCari.
                            getText() + "%' or tokomember.nama like '%" + TCari.
                            getText() + "%' or "
                    + " tokoreturjual.nip like '%" + TCari.getText() + "%' or petugas.nama like '%" + TCari.
                    getText() + "%' or toko_detail_returjual.kode_brng like '%" + TCari.
                            getText() + "%' or "
                    + " tokobarang.nama_brng like '%" + TCari.getText() + "%' or toko_detail_returjual.kode_sat like '%" + TCari.
            ...
            try {
                ...
                tagihan = 0;
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("no_retur_jual"),
                        rs.getString("no_member") + " " + rs.getString("nama"),
                        rs.getString("nip") + " " + rs.getString("nama"), rs.
                        getString("catatan"), "", "", ""
                    });

                    ps2 = koneksi.prepareStatement(
                            "select toko_detail_returjual.kode_brng,tokobarang.nama_brng, "
                            ...
                            + " toko_detail_returjual.no_retur_jual='" + rs.
                                    getString("no_retur_jual") + "'" + carijenis + caribarang
                            + " and (toko_detail_returjual.kode_brng like '%" + TCari.
                                    getText().trim() + "%' or tokobarang.nama_brng like '%" + TCari.
                                    getText().trim() + "%' or "
                            + " toko_detail_returjual.kode_sat like '%" + TCari.
                                    getText().trim() + "%' or tokojenisbarang.nm_jenis like '%" + TCari.
                                    getText().trim() + "%' or "
                            + " toko_detail_returjual.nota_jual like '%" + TCari.
                                    getText().trim() + "%') "
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            ...
                            tabMode.addRow(new Object[]{
                                ...
                                getString("nota_jual"), rs2.getString("satuan"),
                                rs2.getString("jml_retur"), Valid.SetAngka(rs2.
                                getDouble("h_retur")), Valid.SetAngka(rs2.
                                getDouble("total"))
                            });
                            i++;
                        }
    ...
    private static final Logger LOG = Logger.getLogger(TokoCariReturJual.class.
            getName());
