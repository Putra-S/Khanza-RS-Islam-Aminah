...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("no_member"), rs.getString("nama"), rs.getString("jk"),
                        rs.getString("tmp_lahir"), rs.getString("tgl_lahir"), rs.getString("alamat"),
    ...
    private void getData() {
        ...
        if (row != -1) {
            ...
            JK.setSelectedItem(
                    tbPetugas.getValueAt(row, 2).toString().replaceAll("L", "LAKI-LAKI").replaceAll("P", "Perempuan"));
    ...
    private static final Logger LOG = Logger.getLogger(TokoMember.class.getName());
