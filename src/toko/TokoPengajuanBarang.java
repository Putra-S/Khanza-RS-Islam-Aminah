...
public class TokoPengajuanBarang extends javax.swing.JDialog {
    ...
    public TokoPengajuanBarang(java.awt.Frame parent, boolean modal) {
        ...
        Object[] judul = {"Jml", "Kode Barang", "Nama Barang", "Satuan", "Jenis Barang", "Harga Pengajuan",
            "Sub Total"};
...
private void btnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPetugasActionPerformed
        ...
        try {
            ...
            for (i = 0; i < row; i++) {
                if (!tbDokter.getValueAt(i, 0).toString().isEmpty()) {
                    ...
                    h_beli[index] = Double.valueOf(tbDokter.getValueAt(i, 5).toString());
            ...
            for (i = 0; i < jml; i++) {
                tabMode.addRow(new Object[]{jumlah[i], kodebarang[i], namabarang[i], satuan[i], tokojenisbarang[i],
                    h_beli[i], subtotal[i]});
            }
    ...
    private void autoNomor() {
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(no_pengajuan,3),signed)),0) from toko_pengajuan_barang where tanggal='"
    ...
    private static final Logger LOG = Logger.getLogger(TokoPengajuanBarang.class.getName());
