...
public class TokoPengajuanBarang extends javax.swing.JDialog {
    ...
    public TokoPengajuanBarang(java.awt.Frame parent, boolean modal) {
        ...
        Object[] judul = {"Jml", "Kode Barang", "Nama Barang", "Satuan",
            "Jenis Barang", "Harga Pengajuan", "Sub Total"};
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if (NoPengajuan.getText().trim().isEmpty()) {
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                sukses = true;
                if (Sequel.menyimpantf2("toko_pengajuan_barang", "?,?,?,?,?",
                        ...
                        try {
                            if (Valid.SetAngka(tbDokter.getValueAt(i, 0).
                                ...
                                if (Sequel.menyimpantf2(
                                        ...
                                        "?,?,?,?,?,?",
                                        "Detail Pengajuan Barang Toko", 6,
                                        new String[]{
...
private void btnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPetugasActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            TokoPengajuanBarang dialog = new TokoPengajuanBarang(
        ...
        try {
            ...
            for (i = 0; i < row; i++) {
                if (!tbDokter.getValueAt(i, 0).toString().isEmpty()) {
                    ...
                    tokojenisbarang[index] = tbDokter.getValueAt(i, 4).
                            toString();
                    h_beli[index] = Double.valueOf(tbDokter.getValueAt(i, 5).
                            toString());
            ...
            for (i = 0; i < jml; i++) {
                tabMode.addRow(new Object[]{jumlah[i], kodebarang[i],
                    namabarang[i], satuan[i], tokojenisbarang[i], h_beli[i],
                    subtotal[i]});
            }
    ...
    private void autoNomor() {
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(no_pengajuan,3),signed)),0) from toko_pengajuan_barang where tanggal='" + Valid.
                        SetTgl(Tanggal.getSelectedItem() + "") + "' ",
    ...
    private static final Logger LOG = Logger.getLogger(
            TokoPengajuanBarang.class.getName());
