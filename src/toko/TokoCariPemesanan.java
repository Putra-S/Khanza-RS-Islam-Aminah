...
//GEN-FIRST:event_TKdKeyPressed
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPemesananToko.jasper", "report",
                    "::[ Transaksi Penerimaan Barang Toko / Minimarket / Koperasi ]::",
                    param);
        }
            ...
            try {
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        sukses = true;
                        pstoko_detail_pesan = koneksi.prepareStatement(
                                "select toko_detail_pesan.kode_brng,toko_detail_pesan.jumlah from toko_detail_pesan where toko_detail_pesan.no_faktur=? ");
                        try {
                            ...
                            while (rs2.next()) {
                                Trackbarang.catatRiwayat(rs2.getString(
                                        ...
                                        "Penerimaan", akses.getkode(), "Hapus");
                                Sequel.mengedittf("tokobarang", "kode_brng=?",
                        ...
                        if (sukses == true) {
                            ...
                            Sequel.
                                    menyimpan("tampjurnal", "?,?,?,?",
                                        ...
                                        Sequel.cariIsi(
                                                "select Penerimaan_Toko from set_akun"),
                                        "PERSEDIAAN BARANG TOKO", "0", rs.
                                                getString("total")
                                    });
                            ...
                            Sequel.
                                    menyimpan("tampjurnal", "?,?,?,?",
                                            "Rekening", 4, new String[]{
                                        Sequel.cariIsi(
                                                "select Kontra_Penerimaan_Toko from set_akun"),
                                        "HUTANG BARANG TOKO", rs.getString(
                                                "tagihan"), "0"
                                    });
                            sukses = jur.simpanJurnal(rs.getString("no_faktur"),
                                    "U",
                                    "BATAL TRANSAKSI PENERIMAAN TOKO" + ", OLEH " + akses.
                                            getkode());
                        }
                        ...
                        if (sukses == true) {
                            Sequel.Commit();
                            Sequel.queryu2(
                                    "delete from tokopemesanan where no_faktur=?",
    ...
    private void ppBayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBayarActionPerformed
        if (tbDokter.getSelectedRow() > -1) {
            if (!tbDokter.getValueAt(tbDokter.getSelectedRow(), 8).toString().
                ...
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                KeuanganBayarPesanToko bayarpesan = new KeuanganBayarPesanToko(
                        null, false);
