...
public class TokoInputStok extends javax.swing.JDialog {
    ...
    public TokoInputStok(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Real", "Kode Barang", "Nama Barang", "Kategori", "Satuan",
            "Harga", "Stok", "Selisih", "Nominal Hilang(Rp)"}) {
                    ...
                    if (!tbDokter.getValueAt(i, 0).toString().isEmpty()) {
                        try {
                            if (Valid.SetAngka(tbDokter.getValueAt(i, 0).
                                    toString()) >= 0) {
                                if (Sequel.menyimpantf2("tokoopname",
                                        "?,?,?,?,?,?,?,?", "Stok Opname", 8,
                                        new String[]{
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    public void tampil() {
        try {
            ...
            pstampil = koneksi.prepareStatement(
                    "select tokobarang.kode_brng, tokobarang.nama_brng,tokojenisbarang.nm_jenis, tokobarang.kode_sat, "
                    + "tokobarang." + hpptoko
                    + " as dasar,tokobarang.stok from tokobarang inner join tokojenisbarang on tokobarang.jenis=tokojenisbarang.kd_jenis "
            ...
            try {
                ...
                while (rstampil.next()) {
                    tabMode.addRow(new Object[]{"", rstampil.getString("kode_brng"), rstampil.getString("nama_brng"),
                        rstampil.getString("nm_jenis"), rstampil.getString("kode_sat"), rstampil.getDouble("dasar"),
    ...
    private static final Logger LOG = Logger.getLogger(TokoInputStok.class.getName());
