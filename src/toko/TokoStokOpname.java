 ...
 * @author dosen
 */
public class TokoStokOpname extends javax.swing.JDialog {
    ...
    public TokoStokOpname(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Kode Barang", "Nama Barang", "Harga Dasar", "Satuan",
            "Tanggal", "Stok", "Real",
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode, Kdbar, "tokoopname", "tanggal='" + Tanggal.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tbKamar.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptOpnameToko.jasper", "report",
                    "::[ Stok Opname Toko ]::",
                    ...
                    + "where tokoopname.tanggal between '" + Valid.SetTgl(Tgl1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tgl2.getSelectedItem() + "") + "' and tokoopname.kode_brng like '%" + TCari.
                    getText().trim() + "%' or "
                    + "tokoopname.tanggal between '" + Valid.SetTgl(Tgl1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tgl2.getSelectedItem() + "") + "' and tokobarang.nama_brng like '%" + TCari.
                    getText().trim() + "%' or "
                    + "tokoopname.tanggal between '" + Valid.SetTgl(Tgl1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tgl2.getSelectedItem() + "") + "' and tokoopname.kode_brng like '%" + TCari.
                    ...
                    + "tokoopname.tanggal between '" + Valid.SetTgl(Tgl1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tgl2.getSelectedItem() + "") + "' and tokobarang.kode_sat like '%" + TCari.
                    getText().trim() + "%' or "
                    + "tokoopname.tanggal between '" + Valid.SetTgl(Tgl1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tgl2.getSelectedItem() + "") + "' and tokoopname.keterangan like '%" + TCari.
                    getText().trim() + "%' order by tokoopname.tanggal", param);
        }
...
private void StokKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_StokKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            TokoStokOpname dialog = new TokoStokOpname(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                pstampil.
                        setString(10, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                pstampil.
                        setString(11, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                pstampil.setString(12, "%" + TCari.getText().trim() + "%");
                pstampil.
                        setString(13, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                pstampil.
                        setString(14, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                ...
                while (rstampil.next()) {
                    ...
                    tabMode.addRow(new Object[]{rstampil.getString(1),
                        ...
                        getString(6),
                        rstampil.getString(7), rstampil.getString(8), df2.
                        format(rstampil.getDouble(9)),
                        df2.format(rstampil.getDouble(10)), rstampil.getString(
                        11)
                    });
                }
    ...
    private static final Logger LOG = Logger.getLogger(TokoStokOpname.class.
            getName());
}
