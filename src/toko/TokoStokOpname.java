...
public class TokoStokOpname extends javax.swing.JDialog {
    ...
    public TokoStokOpname(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Kode Barang", "Nama Barang", "Harga Dasar", "Satuan", "Tanggal", "Stok", "Real", "Selisih",
            "Total Real", "Nominal Hilang(Rp)", "Keterangan"};
...
private void StokKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_StokKeyPressed
            ...
            try {
                ...
                while (rstampil.next()) {
                    ...
                    tabMode.addRow(new Object[]{rstampil.getString(1), rstampil.getString(2),
                        ...
                        rstampil.getString(6), rstampil.getString(7), rstampil.getString(8),
                        df2.format(rstampil.getDouble(9)), df2.format(rstampil.getDouble(10)),
    ...
    private static final Logger LOG = Logger.getLogger(TokoStokOpname.class.getName());
