...
public class GrafikPegawaiPerKelompokJabatan extends javax.swing.JDialog {
    ...
    public GrafikPegawaiPerKelompokJabatan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "Kelompok Jabatan Pegawai", "Jumlah", "Persentase(%)", "Laki-Laki",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPegawaiPerKelompokJabatan dialog = new GrafikPegawaiPerKelompokJabatan(
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    totall += jmll;
                    totalp += jmlp;
                    tabMode.addRow(new String[]{rs.getString(3) + " (" + rs.
                        getString(1) + ")", rs.getString(2), "", jmll + "", "",
                        jmlp + "", ""});
                }
                if (tabMode.getRowCount() > 0) {
                    tabMode.addRow(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPegawaiPerKelompokJabatan.class.getName());
}
