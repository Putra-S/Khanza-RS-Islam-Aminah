...
public class GrafikPegawaiPerKelompokJabatan extends javax.swing.JDialog {
    ...
    public GrafikPegawaiPerKelompokJabatan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Kelompok Jabatan Pegawai", "Jumlah", "Persentase(%)",
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Kelompok Jabatan",
                            "Kelompok Jabatan", "Jumlah Pegawai", dcd,
                            PlotOrientation.VERTICAL, true, true, true);
                    ChartFrame cf = new ChartFrame(
                            "Grafik Pegawai Per Kelompok Jabatan", freeChart);
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select kelompok_jabatan.kode_kelompok,count(pegawai.kode_kelompok) as jumlah,kelompok_jabatan.nama_kelompok from pegawai inner join kelompok_jabatan "
                                + "on kelompok_jabatan.kode_kelompok=pegawai.kode_kelompok where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI')group by kelompok_jabatan.kode_kelompok").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    JFreeChart freeChart2 = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Kelompok Jabatan",
                            "Kelompok Jabatan", "Jumlah Pegawai", dcd2,
                            PlotOrientation.VERTICAL, true, true, true);
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Kelompok Jabatan", freeChart2);
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select kelompok_jabatan.kode_kelompok,count(pegawai.kode_kelompok) as jumlah,kelompok_jabatan.nama_kelompok from pegawai inner join kelompok_jabatan "
                                + "on kelompok_jabatan.kode_kelompok=pegawai.kode_kelompok where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by kelompok_jabatan.kode_kelompok").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    JFreeChart freeChart3 = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Kelompok Jabatan",
                            "Kelompok Jabatan", "Jumlah Pegawai", dcd3,
                            PlotOrientation.VERTICAL, true, true, true);
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Kelompok Jabatan", freeChart3);
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Kelompok Jabatan", dpd, true,
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    JFreeChart freeChart2 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Kelompok Jabatan", dpd2, true,
                            true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Kelompok Jabatan", freeChart2);
                    cf2.setSize(Scroll.getWidth(), Scroll.getHeight());
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                ...
                                executeQuery();
                        while (rs.next()) {
                            dpd3.setValue(rs.getString(3) + "(" + rs.
                                    getString(1) + ")(" + rs.getString(2) + ")",
                                    rs.getDouble(2));
                        }
                    ...
                    JFreeChart freeChart3 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Kelompok Jabatan", dpd3, true,
                            true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Kelompok Jabatan", freeChart3);
                    cf3.setSize(Scroll.getWidth(), Scroll.getHeight());
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPegawaiPerKelompokJabatan.jasper", "report",
                    "::[ Laporan Jumlah Pegawai Per Kelompok Jabatan ]::", param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPegawaiPerKelompokJabatan dialog = new GrafikPegawaiPerKelompokJabatan(new javax.swing.JFrame(),
                    true);
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    jmll = Sequel.cariInteger(
                            "select count(pegawai.kode_kelompok) from pegawai where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.kode_kelompok=?",
                            rs.getString(1));
                    jmlp = Sequel.cariInteger(
                            "select count(pegawai.kode_kelompok) from pegawai where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.kode_kelompok=?",
                            rs.getString(1));
                    totall += jmll;
                    totalp += jmlp;
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPegawaiPerKelompokJabatan.class.getName());
