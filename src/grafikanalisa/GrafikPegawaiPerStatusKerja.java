...
public class GrafikPegawaiPerStatusKerja extends javax.swing.JDialog {
    ...
    public GrafikPegawaiPerStatusKerja(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "Status Kerja Pegawai", "Jumlah", "Persentase(%)", "Laki-Laki",
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Status Kerja", "Status Kerja",
                            "Jumlah Pegawai", dcd, PlotOrientation.VERTICAL,
                            true, true, true);
                    ChartFrame cf = new ChartFrame(
                            "Grafik Pegawai Per Status Kerja", freeChart);
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select stts_kerja.stts,count(stts_kerja.stts) as jumlah,stts_kerja.ktg from pegawai inner join stts_kerja "
                                + "on stts_kerja.stts=pegawai.stts_kerja where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by stts_kerja.stts").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Status Kerja", freeChart2);
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select stts_kerja.stts,count(stts_kerja.stts) as jumlah,stts_kerja.ktg from pegawai inner join stts_kerja "
                                + "on stts_kerja.stts=pegawai.stts_kerja where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by stts_kerja.stts").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Status Kerja", freeChart3);
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    grafiksql2 kas = new grafiksql2(
                            "Grafik Pegawai Per Status Kerja",
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Status Kerja", dpd, true, true,
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    JFreeChart freeChart2 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Status Kerja", dpd2, true, true,
                            false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Status Kerja", freeChart2);
                    cf2.setSize(Scroll.getWidth(), Scroll.getHeight());
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    JFreeChart freeChart3 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Status Kerja", dpd3, true, true,
                            false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Status Kerja", freeChart3);
                    cf3.setSize(Scroll.getWidth(), Scroll.getHeight());
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPegawaiPerStatusKerja.jasper", "report",
                    "::[ Laporan Jumlah Pegawai Per Status Kerja ]::", param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPegawaiPerStatusKerja dialog = new GrafikPegawaiPerStatusKerja(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    jmll = Sequel.cariInteger(
                            "select count(pegawai.stts_kerja) from pegawai where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.stts_kerja=?",
                            rs.getString(1));
                    jmlp = Sequel.cariInteger(
                            "select count(pegawai.stts_kerja) from pegawai where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.stts_kerja=?",
                            rs.getString(1));
                    totall += jmll;
                    totalp += jmlp;
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPegawaiPerStatusKerja.class.getName());
}
