...
public class GrafikRegistrasiPerUmur extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur),count(concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)) as jumlah "
                    + "from reg_periksa where tgl_registrasi between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Registrasi Per Umur Tanggal " + Valid.SetTgl(Tanggal1.
                        getSelectedItem() + "") + " S.D. " + Valid.SetTgl(
                        Tanggal2.getSelectedItem() + ""), "Umur",
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "where tgl_registrasi between '" + Valid.SetTgl(Tanggal1.
                        ...
                        Tanggal2.getSelectedItem() + "") + "' "
                + "group by concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)",
                "Umur");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikRegistrasiPerUmur dialog = new GrafikRegistrasiPerUmur(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikRegistrasiPerUmur.class.getName());
