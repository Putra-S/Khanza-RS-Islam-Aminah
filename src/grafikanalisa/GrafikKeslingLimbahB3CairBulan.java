...
public class GrafikKeslingLimbahB3CairBulan extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select DATE_FORMAT(kesling_limbah_b3medis_cair.tanggal, '%y-%m'),sum(kesling_limbah_b3medis_cair.jmllimbah) as jumlah "
                    + "from kesling_limbah_b3medis_cair where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + " 23:59:59' group by DATE_FORMAT(kesling_limbah_b3medis_cair.tanggal, '%y-%m')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Limbah Cair B3 Medis Keluar TPS Per Bulan Tanggal " + Valid.
        ...
        ChartFrame cf = new ChartFrame(
                "Grafik Limbah Cair B3 Medis Keluar TPS Per Bulan", freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "group by DATE_FORMAT(kesling_limbah_b3medis_cair.tanggal, '%y-%m')",
                "Bulan");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikKeslingLimbahB3CairBulan dialog = new GrafikKeslingLimbahB3CairBulan(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikKeslingLimbahB3CairBulan.class.getName());
