...
public class GrafikLabRalanPerHari extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Kunjungan Lab Rawat Jalan Per Tanggal Tanggal " + Valid.
        ...
        ChartFrame cf = new ChartFrame(
                "Grafik Kunjungan Lab Rawat Jalan Per Tanggal", freeChart);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikLabRalanPerHari dialog = new GrafikLabRalanPerHari(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikLabRalanPerHari.class.getName());
