...
public class GrafikKeslingLimbahB3CairPertanggal extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public GrafikKeslingLimbahB3CairPertanggal(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select DATE_FORMAT(kesling_limbah_b3medis_cair.tanggal, '%y-%m-%d'),sum(kesling_limbah_b3medis_cair.jmllimbah) as jumlah "
                    + "from kesling_limbah_b3medis_cair where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + " 23:59:59' group by DATE_FORMAT(kesling_limbah_b3medis_cair.tanggal, '%y-%m-%d')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Limbah Cair B3 Medis Keluar TPS Per Tanggal Tanggal " + Valid.
                        SetTgl(Tanggal1.getSelectedItem() + "") + " S.D. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Tanggal",
                "Jumlah (Kg)", dcd, PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame(
                "Grafik Limbah Cair B3 Medis Keluar TPS Per Tanggal", freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "group by DATE_FORMAT(kesling_limbah_b3medis_cair.tanggal, '%y-%m-%d')",
                "Tanggal");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikKeslingLimbahB3CairPertanggal dialog = new GrafikKeslingLimbahB3CairPertanggal(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikKeslingLimbahB3CairPertanggal.class.getName());
