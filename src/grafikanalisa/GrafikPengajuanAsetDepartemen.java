...
public class GrafikPengajuanAsetDepartemen extends javax.swing.JDialog {
    ...
    public GrafikPengajuanAsetDepartemen(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Departemen", "Jumlah Pengajuan", "Persentase Jumlah(%)",
            "Nilai Pengajuan", "Persentase Nilai(%)"}) {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select departemen.nama,count(departemen.dep_id) as jumlah from pengajuan_inventaris inner join pegawai inner join departemen on pengajuan_inventaris.nik=pegawai.nik and pegawai.departemen=departemen.dep_id where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by departemen.dep_id").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Pengajuan Aset/Inventaris Per Departemen Periode " + Valid.
                        SetTgl(Tanggal1.getSelectedItem() + "") + " s.d. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Departemen", "Jumlah",
                dcd, PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame(
                "Pengajuan Aset/Inventaris Per Departemen", freeChart);
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select departemen.nama,sum(total) from pengajuan_inventaris inner join pegawai inner join departemen on pengajuan_inventaris.nik=pegawai.nik and pegawai.departemen=departemen.dep_id where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by departemen.dep_id").
                    executeQuery();
            while (rs.next()) {
                dcd2.setValue(rs.getDouble(2), rs.getString(1) + "(" + Valid.
                        SetAngka(rs.getDouble(2)) + ")", rs.getString(1));
            }
        ...
        JFreeChart freeChart2 = ChartFactory.createBarChart(
                "Pengajuan Aset/Inventaris Per Departemen Periode " + Valid.
                        SetTgl(Tanggal1.getSelectedItem() + "") + " s.d. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Departemen", "Jumlah",
                dcd2, PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf2 = new ChartFrame(
                "Pengajuan Aset/Inventaris Per Departemen", freeChart2);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "where tanggal between '" + Valid.SetTgl(Tanggal1.
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createPieChart(
                "Pengajuan Aset/Inventaris Per Departemen Periode " + Valid.
                        SetTgl(Tanggal1.getSelectedItem() + "") + " s.d. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), dpd, true, true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ChartFrame cf = new ChartFrame(
                "Pengajuan Aset/Inventaris Per Departemen", freeChart);
        cf.setSize(Scroll.getWidth(), Scroll.getHeight());
        cf.setLocationRelativeTo(Scroll);
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    executeQuery();
            while (rs.next()) {
                dpd2.setValue(rs.getString(1) + "(" + Valid.SetAngka(rs.
                        getDouble(2)) + ")", rs.getDouble(2));
            }
        ...
        JFreeChart freeChart2 = ChartFactory.createPieChart(
                "Pengajuan Aset/Inventaris Per Departemen Periode " + Valid.
                        SetTgl(Tanggal1.getSelectedItem() + "") + " s.d. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), dpd2, true, true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ChartFrame cf2 = new ChartFrame(
                "Pengajuan Aset/Inventaris Per Departemen", freeChart2);
        cf2.setSize(Scroll.getWidth(), Scroll.getHeight());
        cf2.setLocationRelativeTo(Scroll);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPengajuanAsetDepartemen.jasper", "report",
                    "::[ Laporan Pengajuan Aset/Inventaris Per Departemen ]::",
                    param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "where tanggal between '" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' and '"
                    + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' group by departemen.dep_id");
            try {
                rs = ps.executeQuery();
                total = 0;
                jumlah = 0;
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{rs.getString("nama"), rs.getString("jumlah"), "0",
                        rs.getDouble("total"), "0"});
                }
                if (tabMode.getRowCount() > 0) {
                    tabMode.addRow(new Object[]{"Jumlah : ", jumlah + "", "100 %", total, "100 %"});
                    for (i = 0; i < tbBangsal.getRowCount(); i++) {
                        tbBangsal.setValueAt(Valid.SetAngka6(
                                (Double.parseDouble(tbBangsal.getValueAt(i, 1).toString()) / jumlah) * 100) + " %", i,
                                2);
                        tbBangsal.setValueAt(Valid.SetAngka6(
                                (Double.parseDouble(tbBangsal.getValueAt(i, 3).toString()) / total) * 100) + " %", i,
                                4);
                    }
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPengajuanAsetDepartemen.class.getName());
