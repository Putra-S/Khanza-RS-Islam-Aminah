...
public class GrafikPengajuanAsetDepartemen extends javax.swing.JDialog {
    ...
    public GrafikPengajuanAsetDepartemen(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Departemen",
            "Jumlah Pengajuan", "Persentase Jumlah(%)", "Nilai Pengajuan",
            "Persentase Nilai(%)"}) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPengajuanAsetDepartemen dialog = new GrafikPengajuanAsetDepartemen(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "where tanggal between '" + Valid.SetTgl(Tanggal1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tanggal2.getSelectedItem() + "") + "' group by departemen.dep_id");
            try {
                rs = ps.executeQuery();
                total = 0;
                jumlah = 0;
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{rs.getString("nama"), rs.
                        getString("jumlah"), "0", rs.getDouble("total"), "0"});
                }
                if (tabMode.getRowCount() > 0) {
                    tabMode.addRow(new Object[]{"Jumlah : ", jumlah + "",
                        "100 %", total, "100 %"});
                    for (i = 0; i < tbBangsal.getRowCount(); i++) {
                        tbBangsal.setValueAt(Valid.SetAngka6((Double.
                                parseDouble(tbBangsal.getValueAt(i, 1).
                                        toString()) / jumlah) * 100) + " %", i,
                                2);
                        tbBangsal.setValueAt(Valid.SetAngka6((Double.
                                parseDouble(tbBangsal.getValueAt(i, 3).
                                        toString()) / total) * 100) + " %", i, 4);
                    }
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPengajuanAsetDepartemen.class.getName());
}
