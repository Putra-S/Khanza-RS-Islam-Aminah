...
public class GrafikPegawaiPerResikoKerja extends javax.swing.JDialog {
    ...
    public GrafikPegawaiPerResikoKerja(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "Risiko Kerja Pegawai", "Jumlah", "Persentase(%)", "Laki-Laki",
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Risiko Kerja", "Risiko Kerja",
                            "Jumlah Pegawai", dcd, PlotOrientation.VERTICAL,
                            true, true, true);
                    ChartFrame cf = new ChartFrame(
                            "Grafik Pegawai Per Risiko Kerja", freeChart);
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select resiko_kerja.kode_resiko,count(pegawai.kode_resiko) as jumlah,resiko_kerja.nama_resiko from pegawai inner join resiko_kerja "
                                + "on resiko_kerja.kode_resiko=pegawai.kode_resiko where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI')group by resiko_kerja.kode_resiko").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Risiko Kerja", freeChart2);
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select resiko_kerja.kode_resiko,count(pegawai.kode_resiko) as jumlah,resiko_kerja.nama_resiko from pegawai inner join resiko_kerja "
                                + "on resiko_kerja.kode_resiko=pegawai.kode_resiko where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by resiko_kerja.kode_resiko").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Risiko Kerja", freeChart3);
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Risiko Kerja", dpd, true, true,
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    JFreeChart freeChart2 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Risiko Kerja", dpd2, true, true,
                            false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Risiko Kerja", freeChart2);
                    cf2.setSize(Scroll.getWidth(), Scroll.getHeight());
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    JFreeChart freeChart3 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Risiko Kerja", dpd3, true, true,
                            false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Risiko Kerja", freeChart3);
                    cf3.setSize(Scroll.getWidth(), Scroll.getHeight());
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPegawaiPerResikoKerja.jasper", "report",
                    "::[ Laporan Jumlah Pegawai Per Risiko Kerja ]::", param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPegawaiPerResikoKerja dialog = new GrafikPegawaiPerResikoKerja(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    jmll = Sequel.cariInteger(
                            "select count(pegawai.kode_resiko) from pegawai where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.kode_resiko=?",
                            rs.getString(1));
                    jmlp = Sequel.cariInteger(
                            "select count(pegawai.kode_resiko) from pegawai where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.kode_resiko=?",
                            rs.getString(1));
                    totall += jmll;
                    totalp += jmlp;
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPegawaiPerResikoKerja.class.getName());
}
