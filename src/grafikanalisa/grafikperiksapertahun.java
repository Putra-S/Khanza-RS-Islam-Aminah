 ...
 * @author Via
 */
public class grafikperiksapertahun extends JDialog {
    ...
    public static CategoryDataset createDataset1(String symbol) { // data grafik nilai K
        ...
        try {
            ...
            ResultSet rs = stat.executeQuery(
                    ...
                    + "from reg_periksa  " + symbol + " group by year(reg_periksa.tgl_registrasi)");
            while (rs.next()) {
    ...
    public grafikperiksapertahun(String title, String symbol) {
        // super(title);
        setTitle(title);
    ...
    private static final Logger LOG = Logger.getLogger(grafikperiksapertahun.class.getName());
