...
public class GrafikHemodialisaPerTanggal extends javax.swing.JDialog {
    ...
    public GrafikHemodialisaPerTanggal(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Tanggal", "Jumlah Hemodialisa Per Tanggal", "Persentase Per Tanggal(%)"}) {
            @Override
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select DATE_FORMAT(hemodialisa.tanggal, '%Y-%m-%d'),count(DATE_FORMAT(hemodialisa.tanggal, '%Y-%m-%d')) as jumlah "
                    + "from hemodialisa where tanggal between '" + Valid.SetTgl(Tanggal1.getSelectedItem() + "")
    ...
    private static final Logger LOG = Logger.getLogger(GrafikHemodialisaPerTanggal.class.getName());
