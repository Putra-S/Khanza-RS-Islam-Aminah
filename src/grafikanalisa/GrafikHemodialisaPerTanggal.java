...
public class GrafikHemodialisaPerTanggal extends javax.swing.JDialog {
    ...
    public GrafikHemodialisaPerTanggal(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Tanggal",
            "Jumlah Hemodialisa Per Tanggal", "Persentase Per Tanggal(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select DATE_FORMAT(hemodialisa.tanggal, '%Y-%m-%d'),count(DATE_FORMAT(hemodialisa.tanggal, '%Y-%m-%d')) as jumlah "
                    + "from hemodialisa where tanggal between '" + Valid.SetTgl(
                            Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by DATE_FORMAT(hemodialisa.tanggal, '%Y-%m-%d')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Hemodialisa Per Tanggal Periode " + Valid.SetTgl(
        ...
        ChartFrame cf = new ChartFrame("Grafik Hemodialisa Per Tanggal",
                freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "group by DATE_FORMAT(hemodialisa.tanggal, '%Y-%m-%d')",
                "Tanggal");
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPeristiwaK3PerTanggal.jasper", "report",
                    "::[ Laporan Jumlah Hemodialisa Per Tanggal ]::", param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikHemodialisaPerTanggal dialog = new GrafikHemodialisaPerTanggal(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikHemodialisaPerTanggal.class.getName());
}
