...
public class GrafikStatusBatalRegPerTanggal extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    + "from reg_periksa where reg_periksa.stts='Batal' and tgl_registrasi between '" + Valid.
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Status Batal Periksa Per Tanggal Tanggal " + Valid.
        ...
        ChartFrame cf = new ChartFrame("Grafik Status Batal Periksa Per Tanggal",
                freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "where reg_periksa.stts='Batal' and tgl_registrasi between '" + Valid.
                        SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                SetTgl(Tanggal2.getSelectedItem() + "") + "' "
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikStatusBatalRegPerTanggal dialog = new GrafikStatusBatalRegPerTanggal(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikStatusBatalRegPerTanggal.class.getName());
