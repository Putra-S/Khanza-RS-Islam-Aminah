...
public class GrafikKunjunganRanapPerTahun extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by year(reg_periksa.tgl_registrasi)").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Kunjungan Ranap Per Tahun Tanggal " + Valid.SetTgl(
        ...
        ChartFrame cf = new ChartFrame("Grafik Kunjungan Ranap Per Tahun",
                freeChart);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikKunjunganRanapPerTahun dialog = new GrafikKunjunganRanapPerTahun(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikKunjunganRanapPerTahun.class.getName());
