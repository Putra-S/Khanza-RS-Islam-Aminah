...
public class GrafikPegawaiPerBidang extends javax.swing.JDialog {
    ...
    public GrafikPegawaiPerBidang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Bidang/Bagian Pegawai", "Jumlah", "Persentase(%)",
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Bidang/Bagian", "Bidang/Bagian",
                            "Jumlah Pegawai", dcd, PlotOrientation.VERTICAL,
                            true, true, true);
                    ChartFrame cf = new ChartFrame(
                            "Grafik Pegawai Per Bidang/Bagian", freeChart);
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select pegawai.bidang,count(pegawai.bidang) as jumlah from pegawai where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by pegawai.bidang").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Bidang/Bagian", freeChart2);
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select pegawai.bidang,count(pegawai.bidang) as jumlah from pegawai where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by pegawai.bidang").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Bidang/Bagian", freeChart3);
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    grafiksql2 kas = new grafiksql2(
                            "Grafik Pegawai Per Bidang/Bagian",
                            "select pegawai.bidang,count(pegawai.bidang) as jumlah from pegawai where pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI' group by pegawai.bidang",
                            "Bidang/Bagian");
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Bidang/Bagian", dpd, true, true,
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    JFreeChart freeChart2 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Bidang/Bagian", dpd2, true, true,
                            false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Bidang/Bagian", freeChart2);
                    cf2.setSize(Scroll.getWidth(), Scroll.getHeight());
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    JFreeChart freeChart3 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Bidang/Bagian", dpd3, true, true,
                            false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Bidang/Bagian", freeChart3);
                    cf3.setSize(Scroll.getWidth(), Scroll.getHeight());
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPegawaiPerBagian.jasper", "report",
                    "::[ Laporan Jumlah Pegawai Per Bidang/Bagian ]::", param);
        }
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    jmll = Sequel.cariInteger(
                            "select count(bidang) from pegawai where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and bidang=?",
                            rs.getString(1));
                    jmlp = Sequel.cariInteger(
                            "select count(bidang) from pegawai where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and bidang=?",
                            rs.getString(1));
                    totall += jmll;
                    totalp += jmlp;
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPegawaiPerBidang.class.getName());
