 ...
 * @author Via
 */
public class grafiksql2 extends JDialog {
     ...
     * @return A dataset.
     */
    public static CategoryDataset createDataset1(String query, String kolom) { // data
        // grafik
        // nilai K
        // dan D
     ...
     * @return A dataset.
     */
    public static CategoryDataset createDataset2(String query, String kolom) { // grafik
        // volume
        DefaultCategoryDataset result = new DefaultCategoryDataset();
     ...
     * @return A chart.
     */
    private static JFreeChart createChart(String query, String kolom) {
        ...
        CategoryDataset dataset2 = createDataset2(query, kolom);
     ...
     * @return A panel.
     */
    public static JPanel createDemoPanel(String query, String kolom) {
        JFreeChart chart = createChart(query, kolom);
    ...
    public grafiksql2(String title, String query, String Kolom) {
        // super(title);
        setTitle(title);
        JPanel chartPanel = createDemoPanel(query, Kolom);
    ...
    private static final Logger LOG = Logger.getLogger(grafiksql2.class.getName());
