...
public class GrafikPeristiwaK3PerJenisPekerjaan extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public GrafikPeristiwaK3PerJenisPekerjaan(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode = new DefaultTableModel(null, new Object[]{"Jenis pekerjaan",
            "Jumlah Peristiwa", "Persentase(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by k3rs_peristiwa.kode_pekerjaan").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                ...
                SetTgl(Tanggal2.getSelectedItem() + ""), "Jenis pekerjaan",
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "where tgl_pelaporan between '" + Valid.SetTgl(Tanggal1.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPeristiwaK3PerJenisPekerjaan.jasper", "report",
                    "::[ Laporan Jumlah Peristiwa K3 Per Jenis pekerjaan ]::",
                    param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPeristiwaK3PerJenisPekerjaan dialog = new GrafikPeristiwaK3PerJenisPekerjaan(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "where tgl_pelaporan between '" + Valid.SetTgl(Tanggal1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tanggal2.getSelectedItem() + "") + "' group by k3rs_peristiwa.kode_pekerjaan");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPeristiwaK3PerJenisPekerjaan.class.getName());
}
