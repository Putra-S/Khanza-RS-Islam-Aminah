...
public class GrafikPeristiwaK3PerJenisPekerjaan extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPeristiwaK3PerJenisPekerjaan dialog = new GrafikPeristiwaK3PerJenisPekerjaan(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select k3rs_jenis_pekerjaan.jenis_pekerjaan,count(k3rs_peristiwa.kode_pekerjaan) as jumlah from k3rs_peristiwa inner join k3rs_jenis_pekerjaan on k3rs_jenis_pekerjaan.kode_pekerjaan=k3rs_peristiwa.kode_pekerjaan "
                    + "where tgl_pelaporan between '" + Valid.SetTgl(Tanggal1.getSelectedItem() + "")
                    + "' and '" + Valid.SetTgl(Tanggal2.getSelectedItem() + "")
                    + "' group by k3rs_peristiwa.kode_pekerjaan");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
                ...
                if (tabMode.getRowCount() > 0) {
                    ...
                    for (i = 0; i < tbBangsal.getRowCount(); i++) {
                        tbBangsal.setValueAt(Valid.SetAngka6(
                                (Double.parseDouble(tbBangsal.getValueAt(i, 1).toString()) / total) * 100) + " %", i,
                                2);
                    }
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPeristiwaK3PerJenisPekerjaan.class.getName());
