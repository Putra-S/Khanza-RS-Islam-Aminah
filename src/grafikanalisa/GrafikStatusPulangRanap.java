...
public class GrafikStatusPulangRanap extends javax.swing.JDialog {
    ...
    public GrafikStatusPulangRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Status Kepulangan Rawat Inap",
            "Jumlah Status Kepulangan Rawat Inap", "Persentase Status Kepulangan Rawat Inap(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select kamar_inap.stts_pulang,count(kamar_inap.stts_pulang) as jumlah "
                    + "from kamar_inap where stts_pulang<>'Pindah Kamar' and tgl_keluar between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by kamar_inap.stts_pulang").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Status Pulang Rawat Inap Periode " + Valid.SetTgl(
                        Tanggal1.getSelectedItem() + "") + " s.d. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Status Pulang",
                "Jumlah", dcd, PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame("Grafik Status Pulang Rawat Inap",
                freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "and tgl_keluar between '" + Valid.SetTgl(Tanggal1.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptStatusPulangRanap.jasper", "report",
                    "::[ Laporan Status Kepulangan Rawat Inap ]::", param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select kamar_inap.stts_pulang,count(kamar_inap.stts_pulang) as jumlah from kamar_inap where stts_pulang<>'Pindah Kamar' "
                    + "and tgl_keluar between '" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' and '"
                    + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' group by kamar_inap.stts_pulang");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikStatusPulangRanap.class.getName());
