...
public class GrafikStatusPulangRanap extends javax.swing.JDialog {
    ...
    public GrafikStatusPulangRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "Status Kepulangan Rawat Inap",
            "Jumlah Status Kepulangan Rawat Inap",
            "Persentase Status Kepulangan Rawat Inap(%)"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikStatusPulangRanap dialog = new GrafikStatusPulangRanap(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "and tgl_keluar between '" + Valid.SetTgl(Tanggal1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tanggal2.getSelectedItem() + "") + "' group by kamar_inap.stts_pulang");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikStatusPulangRanap.class.getName());
}
