...
public class GrafikRadRalanPerTahun extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' and reg_periksa.status_lanjut='Ralan' "
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Kunjungan Rad Rawat Jalan Per Tahun Tanggal " + Valid.
        ...
        ChartFrame cf = new ChartFrame(
                "Grafik Kunjungan Rad Rawat Jalan Per Tahun", freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                "select year(reg_periksa.tgl_registrasi),count(distinct reg_periksa.no_rawat) as jumlah from reg_periksa inner join periksa_radiologi on reg_periksa.no_rawat=periksa_radiologi.no_rawat "
                + "where reg_periksa.tgl_registrasi between '" + Valid.SetTgl(
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikRadRalanPerTahun dialog = new GrafikRadRalanPerTahun(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikRadRalanPerTahun.class.getName());
