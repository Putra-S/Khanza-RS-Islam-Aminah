...
public class GrafikPerbaikanInventarisPerTahun extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public GrafikPerbaikanInventarisPerTahun(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode = new DefaultTableModel(null, new Object[]{"Tahun Perbaikan",
            "Jumlah Perbaikan Inventaris Per Tahun",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPerbaikanInventarisPerTahun dialog = new GrafikPerbaikanInventarisPerTahun(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPerbaikanInventarisPerTahun.class.getName());
}
