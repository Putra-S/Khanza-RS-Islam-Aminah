...
public class GrafikPerbaikanInventarisPerTahun extends javax.swing.JDialog {
    ...
    public GrafikPerbaikanInventarisPerTahun(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Tahun Perbaikan", "Jumlah Perbaikan Inventaris Per Tahun",
            "Perbaikan Inventaris Per Tahun(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select year(perbaikan_inventaris.tanggal),count(year(perbaikan_inventaris.tanggal)) as jumlah "
                    + "from perbaikan_inventaris where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by year(perbaikan_inventaris.tanggal)").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Perbaikan Inventaris Per Tahun Periode " + Valid.SetTgl(
                        Tanggal1.getSelectedItem() + "") + " s.d. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Tahun", "Jumlah", dcd,
                PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame("Grafik Perbaikan Inventaris Per Tahun",
                freeChart);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPerbaikanInventarisPerTahun.jasper", "report",
                    "::[ Laporan Jumlah Perbaikan Inventaris Per Tahun ]::",
                    param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPerbaikanInventarisPerTahun dialog = new GrafikPerbaikanInventarisPerTahun(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select year(perbaikan_inventaris.tanggal),count(year(perbaikan_inventaris.tanggal)) as jumlah "
                    + "from perbaikan_inventaris where tanggal between '"
                    + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' and '"
                    + Valid.SetTgl(Tanggal2.getSelectedItem() + "")
                    + "' group by year(perbaikan_inventaris.tanggal)");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPerbaikanInventarisPerTahun.class.getName());
