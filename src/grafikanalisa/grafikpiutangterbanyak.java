...
public class grafikpiutangterbanyak extends JDialog {
    ...
    public static CategoryDataset createDataset1(String symbol) { // data grafik nilai K
        ...
        try {
            ...
            ResultSet rs = stat.executeQuery(
                    ...
                    + symbol
                    + " group by databarang.nama_brng order by sum(detailpiutang.jumlah) desc limit 10");
            while (rs.next()) {
    ...
    private static JFreeChart createChart(String symbol) {
        ...
        CategoryAxis domainAxis = new CategoryAxis("Grafik 10 Barang Piutang Terbanyak");
    ...
    private static final Logger LOG = Logger.getLogger(grafikpiutangterbanyak.class.getName());
