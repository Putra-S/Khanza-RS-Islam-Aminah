...
public class GrafikRegistrasiPerCacat extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    + "where tgl_registrasi between '" + Valid.SetTgl(Tanggal1.
                            ...
                            Tanggal2.getSelectedItem() + "") + "' group by cacat_fisik.nama_cacat").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Registrasi Per Cacat Fisik Tanggal " + Valid.SetTgl(
                        Tanggal1.getSelectedItem() + "") + " S.D. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Cacat Fisik",
                "Jumlah Pasien", dcd, PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame("Grafik Registrasi Per Cacat Fisik",
                freeChart);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikRegistrasiPerCacat dialog = new GrafikRegistrasiPerCacat(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikRegistrasiPerCacat.class.getName());
