...
public class GrafikRadRalanPerHari extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select DATE_FORMAT(reg_periksa.tgl_registrasi, '%y-%m-%d'),count(distinct reg_periksa.no_rawat) as jumlah "
                    + "from reg_periksa inner join periksa_radiologi on reg_periksa.no_rawat=periksa_radiologi.no_rawat where "
                    + "tgl_registrasi between '" + Valid.SetTgl(Tanggal1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tanggal2.getSelectedItem() + "") + "' and "
                    + "reg_periksa.status_lanjut='Ralan' group by DATE_FORMAT(reg_periksa.tgl_registrasi, '%y-%m-%d')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Kunjungan Rad Rawat Jalan Per Tanggal Tanggal " + Valid.
        ...
        ChartFrame cf = new ChartFrame(
                "Grafik Kunjungan Rad Rawat Jalan Per Tanggal", freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "where tgl_registrasi between '" + Valid.SetTgl(Tanggal1.
                        getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                        Tanggal2.getSelectedItem() + "") + "' and reg_periksa.status_lanjut='Ralan' "
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    + "tgl_registrasi between '" + Valid.SetTgl(Tanggal1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tanggal2.getSelectedItem() + "") + "' and reg_periksa.status_lanjut='Ralan' group by DATE_FORMAT(reg_periksa.tgl_registrasi, '%y-%m-%d')").
                    executeQuery();
            while (rs.next()) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikRadRalanPerHari dialog = new GrafikRadRalanPerHari(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikRadRalanPerHari.class.getName());
