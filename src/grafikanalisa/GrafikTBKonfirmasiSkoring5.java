...
public class GrafikTBKonfirmasiSkoring5 extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select konfirmasiSkoring5,count(konfirmasiSkoring5) as jumlah "
                    + "from data_tb where tanggal_buat_laporan between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + " 23:59:59' group by konfirmasiSkoring5").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Konfirmasi Skoring 5 TB Tanggal " + Valid.SetTgl(
                        Tanggal1.getSelectedItem() + "") + " S.D. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Konfirmasi Skoring 5",
                "Jumlah Pasien", dcd, PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame("Grafik Konfirmasi Skoring 5 TB",
                freeChart);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikTBKonfirmasiSkoring5 dialog = new GrafikTBKonfirmasiSkoring5(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikTBKonfirmasiSkoring5.class.getName());
