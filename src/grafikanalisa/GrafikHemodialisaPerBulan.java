...
public class GrafikHemodialisaPerBulan extends javax.swing.JDialog {
    ...
    public GrafikHemodialisaPerBulan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Bulan", "Jumlah Hemodialisa Per Bulan", "Persentase Per Bulan(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select DATE_FORMAT(hemodialisa.tanggal, '%Y-%m'),count(DATE_FORMAT(hemodialisa.tanggal, '%Y-%m')) as jumlah "
                    + "from hemodialisa where tanggal between '" + Valid.SetTgl(
                            Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by DATE_FORMAT(hemodialisa.tanggal, '%Y-%m')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Hemodialisa Per Bulan Periode " + Valid.SetTgl(Tanggal1.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptHemodialisaPerBulan.jasper", "report",
                    "::[ Laporan Jumlah Hemodialisa Per Bulan ]::", param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "' group by DATE_FORMAT(hemodialisa.tanggal, '%Y-%m')");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikHemodialisaPerBulan.class.getName());
