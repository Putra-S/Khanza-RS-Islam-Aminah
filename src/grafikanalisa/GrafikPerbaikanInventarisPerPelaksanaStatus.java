...
public class GrafikPerbaikanInventarisPerPelaksanaStatus extends javax.swing.JDialog {
    ...
    public GrafikPerbaikanInventarisPerPelaksanaStatus(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Pelaksana Perbaikan", "Status Perbaikan",
            "Jumlah Perbaikan", "Persentase Perbaikan(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select concat(pelaksana,' & ',status),count(concat(pelaksana,' & ',status)) as jumlah "
                    + "from perbaikan_inventaris where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by concat(pelaksana,' & ',status)").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Perbaikan Inventaris Per Pelaksana & Status Tanggal " + Valid.
        ...
        ChartFrame cf = new ChartFrame(
                "Grafik Perbaikan Inventaris Per Pelaksana & Status", freeChart);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPerbaikanInventarisPerPelaksanaStatus.jasper",
                    "report",
                    "::[ Laporan Jumlah Perbaikan Inventaris Per Pelaksana & Status ]::",
                    param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPerbaikanInventarisPerPelaksanaStatus dialog = new GrafikPerbaikanInventarisPerPelaksanaStatus(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select pelaksana,status,count(*) as jumlah from perbaikan_inventaris "
                    ...
                    + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' " + "group by pelaksana,status");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
                ...
                for (i = 0; i < tbBangsal.getRowCount(); i++) {
                    tbBangsal.setValueAt(
                            Math.round((Double.parseDouble(tbBangsal.getValueAt(i, 2).toString()) / total) * 100)
                            + " %",
                            i, 3);
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPerbaikanInventarisPerPelaksanaStatus.class.getName());
