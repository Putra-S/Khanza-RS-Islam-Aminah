...
public class GrafikPerbaikanInventarisPerPelaksanaStatus extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public GrafikPerbaikanInventarisPerPelaksanaStatus(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode = new DefaultTableModel(null,
                new Object[]{"Pelaksana Perbaikan", "Status Perbaikan",
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select pelaksana,status,count(*) as jumlah from perbaikan_inventaris "
                    + "where tanggal between '" + Valid.SetTgl(Tanggal1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tanggal2.getSelectedItem() + "") + "' "
            ...
            try {
                ...
                for (i = 0; i < tbBangsal.getRowCount(); i++) {
                    tbBangsal.setValueAt(Math.round((Double.parseDouble(
                            tbBangsal.getValueAt(i, 2).toString()) / total) * 100) + " %",
                            i, 3);
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPerbaikanInventarisPerPelaksanaStatus.class.getName());
}
