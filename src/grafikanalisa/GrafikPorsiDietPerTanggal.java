...
public class GrafikPorsiDietPerTanggal extends javax.swing.JDialog {
    ...
    public GrafikPorsiDietPerTanggal(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Tanggal", "Jumlah Porsi Diet Per Tanggal", "Persentase Per Tanggal(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select DATE_FORMAT(detail_beri_diet.tanggal, '%Y-%m-%d'),count(DATE_FORMAT(detail_beri_diet.tanggal, '%Y-%m-%d')) as jumlah "
                    + "from detail_beri_diet where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by DATE_FORMAT(detail_beri_diet.tanggal, '%Y-%m-%d')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Porsi Diet Per Tanggal Periode " + Valid.SetTgl(
        ...
        ChartFrame cf = new ChartFrame("Grafik Porsi Diet Per Tanggal",
                freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "group by DATE_FORMAT(detail_beri_diet.tanggal, '%Y-%m-%d')",
                "Tanggal");
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPorsiDietPerTanggal.jasper", "report",
                    "::[ Laporan Jumlah Porsi Diet Per Tanggal ]::", param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select DATE_FORMAT(detail_beri_diet.tanggal, '%Y-%m-%d'),count(DATE_FORMAT(detail_beri_diet.tanggal, '%Y-%m-%d')) as jumlah "
                    + "from detail_beri_diet where tanggal between '"
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPorsiDietPerTanggal.class.getName());
