...
public class GrafikPorsiDietPerTanggal extends javax.swing.JDialog {
    ...
    public GrafikPorsiDietPerTanggal(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Tanggal",
            "Jumlah Porsi Diet Per Tanggal", "Persentase Per Tanggal(%)"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPorsiDietPerTanggal dialog = new GrafikPorsiDietPerTanggal(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPorsiDietPerTanggal.class.getName());
}
