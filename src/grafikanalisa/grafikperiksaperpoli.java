 ...
 * @author Via
 */
public class grafikperiksaperpoli extends JDialog {
    ...
    public static CategoryDataset createDataset1(String symbol) { // data grafik nilai K
        ...
        String series1 = "Unit/Poli";
        String series2 = "Unit/Poli";

        try {
            Statement stat = koneksiDB.condb().createStatement();
            ResultSet rs = stat.executeQuery("select poliklinik.nm_poli,count(poliklinik.nm_poli) as jumlah "
                    + "from reg_periksa inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli " + symbol
    ...
    private static JFreeChart createChart(String symbol) {
        ...
        CategoryAxis domainAxis = new CategoryAxis("Poli/Unit");
    ...
    public grafikperiksaperpoli(String title, String symbol) {
        // super(title);
        setTitle(title);
    ...
    private static final Logger LOG = Logger.getLogger(grafikperiksaperpoli.class.getName());
