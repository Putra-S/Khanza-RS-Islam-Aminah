 ...
 * @author Via
 */
public class grafikpendidikan extends JDialog {
    ...
    public static CategoryDataset createDataset1(String symbol) { // data grafik nilai K
        ...
        try {
            ...
            ResultSet rs = stat.executeQuery(
                    "SELECT pnddkn,count(pnddkn) as jumlah  FROM pasien_ibu " + " " + symbol + " group by pnddkn");
            while (rs.next()) {
    ...
    public grafikpendidikan(String title, String symbol) {
        // super(title);
        setTitle(title);
    ...
    private static final Logger LOG = Logger.getLogger(grafikpendidikan.class.getName());
