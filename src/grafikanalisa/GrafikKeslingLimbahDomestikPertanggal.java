...
public class GrafikKeslingLimbahDomestikPertanggal extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public GrafikKeslingLimbahDomestikPertanggal(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select DATE_FORMAT(kesling_limbah_domestik.tanggal, '%y-%m-%d'),sum(kesling_limbah_domestik.jumlahlimbah) as jumlah "
                    + "from kesling_limbah_domestik where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + " 23:59:59' group by DATE_FORMAT(kesling_limbah_domestik.tanggal, '%y-%m-%d')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Limbah Padat Domestik Per Tanggal Tanggal " + Valid.
        ...
        ChartFrame cf = new ChartFrame(
                "Grafik Limbah Padat Domestik Per Tanggal", freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "group by DATE_FORMAT(kesling_limbah_domestik.tanggal, '%y-%m-%d')",
                "Tanggal");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikKeslingLimbahDomestikPertanggal dialog = new GrafikKeslingLimbahDomestikPertanggal(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikKeslingLimbahDomestikPertanggal.class.getName());
