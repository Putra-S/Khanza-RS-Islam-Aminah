...
public class GrafikStatusRegPerTanggal extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Registrasi Pasien Lama Per Tanggal Tanggal " + Valid.
        ...
        ChartFrame cf = new ChartFrame(
                "Grafik Registrasi Pasien Lama Per Tanggal", freeChart);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikStatusRegPerTanggal dialog = new GrafikStatusRegPerTanggal(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikStatusRegPerTanggal.class.getName());
