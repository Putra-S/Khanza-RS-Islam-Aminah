...
public class GrafikPeristiwaK3PerBagianTubuh extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPeristiwaK3PerBagianTubuh dialog = new GrafikPeristiwaK3PerBagianTubuh(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "' group by k3rs_peristiwa.kode_bagian");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPeristiwaK3PerBagianTubuh.class.getName());
