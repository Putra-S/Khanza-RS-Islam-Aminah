 ...
 * @author Via
 */
public class grafikperiksaperdokter extends JDialog {
    ...
    public static CategoryDataset createDataset1(String symbol) { // data grafik nilai K
        ...
        String series1 = "Dokter";
        String series2 = "Dokter";

        try {
            Statement stat = koneksiDB.condb().createStatement();
            ResultSet rs = stat.executeQuery("select dokter.nm_dokter,count(dokter.nm_dokter) as jumlah "
                    + "from reg_periksa inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter " + symbol
    ...
    private static JFreeChart createChart(String symbol) {
        ...
        CategoryAxis domainAxis = new CategoryAxis("Dokter");
    ...
    private static final Logger LOG = Logger.getLogger(grafikperiksaperdokter.class.getName());
