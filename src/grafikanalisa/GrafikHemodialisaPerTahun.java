...
public class GrafikHemodialisaPerTahun extends javax.swing.JDialog {
    ...
    public GrafikHemodialisaPerTahun(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Tahun", "Jumlah Hemodialisa Per Tahun", "Persentase Per Tahun(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select year(hemodialisa.tanggal),count(year(hemodialisa.tanggal)) as jumlah "
                    + "from hemodialisa where tanggal between '" + Valid.SetTgl(
                            Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by year(hemodialisa.tanggal)").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Hemodialisa Per Tahun Periode " + Valid.SetTgl(Tanggal1.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptHemodialisaPerTahun.jasper", "report",
                    "::[ Laporan Jumlah Hemodialisa Per Tahun ]::", param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select year(hemodialisa.tanggal),count(year(hemodialisa.tanggal)) as jumlah "
                    ...
                    + "' group by year(hemodialisa.tanggal)");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikHemodialisaPerTahun.class.getName());
