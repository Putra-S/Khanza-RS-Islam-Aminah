...
public class GrafikHemodialisaPerTahun extends javax.swing.JDialog {
    ...
    public GrafikHemodialisaPerTahun(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Tahun",
            "Jumlah Hemodialisa Per Tahun", "Persentase Per Tahun(%)"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikHemodialisaPerTahun dialog = new GrafikHemodialisaPerTahun(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikHemodialisaPerTahun.class.getName());
}
