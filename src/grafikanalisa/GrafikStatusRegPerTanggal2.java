...
public class GrafikStatusRegPerTanggal2 extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Registrasi Pasien Baru Per Tanggal Tanggal " + Valid.
        ...
        ChartFrame cf = new ChartFrame(
                "Grafik Registrasi Pasien Baru Per Tanggal", freeChart);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikStatusRegPerTanggal2 dialog = new GrafikStatusRegPerTanggal2(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikStatusRegPerTanggal2.class.getName());
