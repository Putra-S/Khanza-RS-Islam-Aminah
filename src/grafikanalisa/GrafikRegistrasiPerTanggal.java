...
public class GrafikRegistrasiPerTanggal extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Registrasi Per Tanggal Tanggal " + Valid.SetTgl(
        ...
        ChartFrame cf = new ChartFrame("Grafik Registrasi Per Tanggal",
                freeChart);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikRegistrasiPerTanggal dialog = new GrafikRegistrasiPerTanggal(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikRegistrasiPerTanggal.class.getName());
