 ...
 * @author Via
 */
public class grafikpasienperagama extends JDialog {
    ...
    public static CategoryDataset createDataset1(String symbol) { // data grafik nilai K
        ...
        try {
            ...
            ResultSet rs = stat
                    .executeQuery("SELECT agama,count(agama) as jumlah  FROM pasien " + " " + symbol + " group by agama");
            while (rs.next()) {
    ...
    private static JFreeChart createChart(String symbol) {
        ...
        CategoryAxis domainAxis = new CategoryAxis("Agama");
    ...
    public grafikpasienperagama(String title, String symbol) {
        // super(title);
        setTitle(title);
    ...
    private static final Logger LOG = Logger.getLogger(grafikpasienperagama.class.getName());
