...
public class GrafikItemApotekPerIndustriFarmasi extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public GrafikItemApotekPerIndustriFarmasi(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode = new DefaultTableModel(null, new Object[]{
            "Industri Farmasi Item Apotek",
            "Jumlah Industri Farmasi Item Apotek",
            "Persentase Industri Farmasi Item Apotek(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    executeQuery();
            while (rs.next()) {
                dcd.setValue(rs.getDouble(2), rs.getString(3) + "(" + rs.
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Item Apotek Per Industri Farmasi", "Industri Farmasi",
                "Jumlah Item Apotek", dcd, PlotOrientation.VERTICAL, true, true,
                true);
        ChartFrame cf = new ChartFrame("Grafik Item Apotek Per Industri Farmasi",
                freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                "Grafik Item Apotek Per Industri Farmasi",
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createPieChart(
                "Grafik Item Apotek Per Industri Farmasi", dpd, true, true,
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptItemApotekPerIndustriFarmasi.jasper", "report",
                    "::[ Laporan Jumlah Item Apotek Per Industri Farmasi ]::",
                    param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikItemApotekPerIndustriFarmasi dialog = new GrafikItemApotekPerIndustriFarmasi(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikItemApotekPerIndustriFarmasi.class.getName());
}
