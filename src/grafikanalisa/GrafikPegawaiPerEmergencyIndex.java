...
public class GrafikPegawaiPerEmergencyIndex extends javax.swing.JDialog {
    ...
    public GrafikPegawaiPerEmergencyIndex(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "Emergency Index Pegawai", "Jumlah", "Persentase(%)", "Laki-Laki",
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Emergency Index",
                            "Emergency Index", "Jumlah Pegawai", dcd,
                            PlotOrientation.VERTICAL, true, true, true);
                    ChartFrame cf = new ChartFrame(
                            "Grafik Pegawai Per Emergency Index", freeChart);
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select emergency_index.kode_emergency,count(pegawai.kode_emergency) as jumlah,emergency_index.nama_emergency from pegawai inner join emergency_index "
                                + "on emergency_index.kode_emergency=pegawai.kode_emergency where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI')group by emergency_index.kode_emergency").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    JFreeChart freeChart2 = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Emergency Index",
                            "Emergency Index", "Jumlah Pegawai", dcd2,
                            PlotOrientation.VERTICAL, true, true, true);
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Emergency Index", freeChart2);
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select emergency_index.kode_emergency,count(pegawai.kode_emergency) as jumlah,emergency_index.nama_emergency from pegawai inner join emergency_index "
                                + "on emergency_index.kode_emergency=pegawai.kode_emergency where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by emergency_index.kode_emergency").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    JFreeChart freeChart3 = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Emergency Index",
                            "Emergency Index", "Jumlah Pegawai", dcd3,
                            PlotOrientation.VERTICAL, true, true, true);
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Emergency Index", freeChart3);
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Emergency Index", dpd, true,
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    JFreeChart freeChart2 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Emergency Index", dpd2, true,
                            true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Emergency Index", freeChart2);
                    cf2.setSize(Scroll.getWidth(), Scroll.getHeight());
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    JFreeChart freeChart3 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Emergency Index", dpd3, true,
                            true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Emergency Index", freeChart3);
                    cf3.setSize(Scroll.getWidth(), Scroll.getHeight());
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPegawaiPerEmergencyIndex.jasper", "report",
                    "::[ Laporan Jumlah Pegawai Per Emergency Index ]::", param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPegawaiPerEmergencyIndex dialog = new GrafikPegawaiPerEmergencyIndex(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    jmll = Sequel.cariInteger(
                            "select count(pegawai.kode_emergency) from pegawai where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.kode_emergency=?",
                            rs.getString(1));
                    jmlp = Sequel.cariInteger(
                            "select count(pegawai.kode_emergency) from pegawai where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.kode_emergency=?",
                            rs.getString(1));
                    totall += jmll;
                    totalp += jmlp;
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPegawaiPerEmergencyIndex.class.getName());
}
