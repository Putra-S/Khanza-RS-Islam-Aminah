...
public class GrafikKejadianIKPPerBulan extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by DATE_FORMAT(insiden_keselamatan_pasien.tgl_kejadian, '%y-%m')").
                    executeQuery();
            while (rs.next()) {
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "group by DATE_FORMAT(insiden_keselamatan_pasien.tgl_kejadian, '%y-%m')",
                "Bulan");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikKejadianIKPPerBulan dialog = new GrafikKejadianIKPPerBulan(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikKejadianIKPPerBulan.class.getName());
