...
public class GrafikLajuHAIsVAPPerRuang extends javax.swing.JDialog {
    ...
    public GrafikLajuHAIsVAPPerRuang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Kamar/Bangsal", "Jumlah Pasien (Numerator)",
            "Jumlah Hari (Denumerator)", "Laju VAP", "Persentase VAP(%)"}) {
            @Override
    ...
    private static final Logger LOG = Logger.getLogger(GrafikLajuHAIsVAPPerRuang.class.getName());
