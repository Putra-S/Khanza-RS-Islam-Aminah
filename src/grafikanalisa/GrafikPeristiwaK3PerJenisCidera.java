...
public class GrafikPeristiwaK3PerJenisCidera extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPeristiwaK3PerJenisCidera dialog = new GrafikPeristiwaK3PerJenisCidera(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "' group by k3rs_peristiwa.kode_cidera");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPeristiwaK3PerJenisCidera.class.getName());
