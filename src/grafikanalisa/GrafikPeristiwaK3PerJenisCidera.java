...
public class GrafikPeristiwaK3PerJenisCidera extends javax.swing.JDialog {
    ...
    public GrafikPeristiwaK3PerJenisCidera(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Jenis Cidera",
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by k3rs_peristiwa.kode_cidera").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                ...
                SetTgl(Tanggal2.getSelectedItem() + ""), "Jenis Cidera",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPeristiwaK3PerJenisCidera.jasper", "report",
                    "::[ Laporan Jumlah Peristiwa K3 Per Jenis Cidera ]::",
                    param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPeristiwaK3PerJenisCidera dialog = new GrafikPeristiwaK3PerJenisCidera(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "where tgl_pelaporan between '" + Valid.SetTgl(Tanggal1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tanggal2.getSelectedItem() + "") + "' group by k3rs_peristiwa.kode_cidera");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPeristiwaK3PerJenisCidera.class.getName());
}
