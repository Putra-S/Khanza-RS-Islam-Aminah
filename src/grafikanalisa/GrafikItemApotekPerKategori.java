...
public class GrafikItemApotekPerKategori extends javax.swing.JDialog {
    ...
    public GrafikItemApotekPerKategori(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "Kategori Item Apotek", "Jumlah Kategori Item Apotek",
            "Persentase Kategori Item Apotek(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Item Apotek Per Kategori", "Kategori",
                "Jumlah Item Apotek", dcd, PlotOrientation.VERTICAL, true, true,
                true);
        ChartFrame cf = new ChartFrame("Grafik Item Apotek Per Kategori",
                freeChart);
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createPieChart(
                "Grafik Item Apotek Per Kategori", dpd, true, true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ChartFrame cf = new ChartFrame("Grafik Item Apotek Per Kategori",
                freeChart);
        cf.setSize(Scroll.getWidth(), Scroll.getHeight());
        cf.setLocationRelativeTo(Scroll);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptItemApotekPerKategori.jasper", "report",
                    "::[ Laporan Jumlah Item Apotek Per Kategori ]::", param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikItemApotekPerKategori dialog = new GrafikItemApotekPerKategori(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikItemApotekPerKategori.class.getName());
}
