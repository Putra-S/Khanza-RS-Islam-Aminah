...
public class GrafikRegistrasiPerBulan extends javax.swing.JDialog {
    ...
    public GrafikRegistrasiPerBulan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Bulan Registrasi",
            "Jumlah Registrasi Per Bulan", "Persentase Registrasi Per Bulan(%)"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikRegistrasiPerBulan dialog = new GrafikRegistrasiPerBulan(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikRegistrasiPerBulan.class.getName());
}
