...
public class GrafikRadRalanPerBulan extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select DATE_FORMAT(reg_periksa.tgl_registrasi, '%y-%m'),count(distinct reg_periksa.no_rawat) as jumlah "
                    ...
                    + "reg_periksa.status_lanjut='Ralan' group by DATE_FORMAT(reg_periksa.tgl_registrasi, '%y-%m')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Kunjungan Rad Rawat Jalan Per Bulan Tanggal " + Valid.
        ...
        ChartFrame cf = new ChartFrame(
                "Grafik Kunjungan Rad Rawat Jalan Per Bulan", freeChart);
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    + "tgl_registrasi between '" + Valid.SetTgl(Tanggal1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tanggal2.getSelectedItem() + "") + "' and reg_periksa.status_lanjut='Ralan' group by DATE_FORMAT(reg_periksa.tgl_registrasi, '%y-%m')").
                    executeQuery();
            while (rs.next()) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikRadRalanPerBulan dialog = new GrafikRadRalanPerBulan(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikRadRalanPerBulan.class.getName());
