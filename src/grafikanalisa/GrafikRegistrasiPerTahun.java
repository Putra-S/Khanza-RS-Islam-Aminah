...
public class GrafikRegistrasiPerTahun extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Registrasi Per Tahun Tanggal " + Valid.SetTgl(Tanggal1.
                        getSelectedItem() + "") + " S.D. " + Valid.SetTgl(
                        Tanggal2.getSelectedItem() + ""), "Tahun",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikRegistrasiPerTahun dialog = new GrafikRegistrasiPerTahun(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikRegistrasiPerTahun.class.getName());
