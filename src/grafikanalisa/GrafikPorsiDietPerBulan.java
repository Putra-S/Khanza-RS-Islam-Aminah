...
public class GrafikPorsiDietPerBulan extends javax.swing.JDialog {
    ...
    public GrafikPorsiDietPerBulan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Bulan",
            "Jumlah Porsi Diet Per Bulan", "Persentase Per Bulan(%)"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPorsiDietPerBulan dialog = new GrafikPorsiDietPerBulan(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPorsiDietPerBulan.class.getName());
}
