...
public class GrafikPorsiDietPerBulan extends javax.swing.JDialog {
    ...
    public GrafikPorsiDietPerBulan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Bulan", "Jumlah Porsi Diet Per Bulan", "Persentase Per Bulan(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select DATE_FORMAT(detail_beri_diet.tanggal, '%Y-%m'),count(DATE_FORMAT(detail_beri_diet.tanggal, '%Y-%m')) as jumlah "
                    + "from detail_beri_diet where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by DATE_FORMAT(detail_beri_diet.tanggal, '%Y-%m')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Porsi Diet Per Bulan Periode " + Valid.SetTgl(Tanggal1.
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "where tanggal between '" + Valid.SetTgl(Tanggal1.
                        ...
                        Tanggal2.getSelectedItem() + "") + "' "
                + "group by DATE_FORMAT(detail_beri_diet.tanggal, '%Y-%m')",
                "Bulan");
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPorsiDietPerbulan.jasper", "report",
                    "::[ Laporan Jumlah Porsi Diet Per Bulan ]::", param);
        }
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPorsiDietPerBulan.class.getName());
