...
public class GrafikKunjunganRanapPerBulan extends javax.swing.JDialog {
    ...
    public GrafikKunjunganRanapPerBulan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Bulan Kunjungan Ranap",
            "Jumlah Kunjungan Ranap Per Bulan", "Persentase Kunjungan Ranap Per Bulan(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by DATE_FORMAT(reg_periksa.tgl_registrasi, '%y-%m')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Kunjungan Ranap Per Bulan Tanggal " + Valid.SetTgl(
        ...
        ChartFrame cf = new ChartFrame("Grafik Kunjungan Ranap Per Bulan",
                freeChart);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptKunjunganRanapPerBulan.jasper", "report",
                    "::[ Laporan Jumlah Kunjuangan Ranap Per Bulan ]::", param);
        }
    ...
    private static final Logger LOG = Logger.getLogger(GrafikKunjunganRanapPerBulan.class.getName());
