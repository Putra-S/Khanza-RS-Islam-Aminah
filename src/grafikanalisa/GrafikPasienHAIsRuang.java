...
public class GrafikPasienHAIsRuang extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPasienHAIsRuang dialog = new GrafikPasienHAIsRuang(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "from data_HAIs inner join kamar inner join bangsal on data_HAIs.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal where data_HAIs.tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by bangsal.kd_bangsal");
            try {
                rs = ps.executeQuery();
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPasienHAIsRuang.class.getName());
}
