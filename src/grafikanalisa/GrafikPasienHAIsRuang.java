...
public class GrafikPasienHAIsRuang extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by bangsal.kd_bangsal").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Pasien HAIs Per Ruang Periode " + Valid.SetTgl(Tanggal1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(
                        Tanggal2.getSelectedItem() + ""), "Ruang", "Jumlah", dcd,
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPasienHAIsRuang.jasper", "report",
                    "::[ Laporan Pasien HAIs Per Ruang ]::", param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select bangsal.nm_bangsal as bangsal,count(distinct data_HAIs.no_rawat) "
                    + "from data_HAIs inner join kamar inner join bangsal on data_HAIs.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal where data_HAIs.tanggal between '"
                    + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' and '"
                    + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' group by bangsal.kd_bangsal");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPasienHAIsRuang.class.getName());
