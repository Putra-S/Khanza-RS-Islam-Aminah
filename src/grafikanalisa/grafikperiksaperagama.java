 ...
 * @author Via
 */
public class grafikperiksaperagama extends JDialog {
    ...
    private static JFreeChart createChart(String symbol) {
        ...
        CategoryAxis domainAxis = new CategoryAxis("Agama Pasien");
    ...
    public grafikperiksaperagama(String title, String symbol) {
        // super(title);
        setTitle(title);
    ...
    private static final Logger LOG = Logger.getLogger(grafikperiksaperagama.class.getName());
