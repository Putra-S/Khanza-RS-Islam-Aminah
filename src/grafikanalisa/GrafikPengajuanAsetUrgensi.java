...
public class GrafikPengajuanAsetUrgensi extends javax.swing.JDialog {
    ...
    public GrafikPengajuanAsetUrgensi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Urgensi",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPengajuanAsetUrgensi dialog = new GrafikPengajuanAsetUrgensi(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "where tanggal between '" + Valid.SetTgl(Tanggal1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tanggal2.getSelectedItem() + "") + "' group by urgensi");
            try {
                rs = ps.executeQuery();
                total = 0;
                jumlah = 0;
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{rs.getString("urgensi"), rs.
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPengajuanAsetUrgensi.class.getName());
}
