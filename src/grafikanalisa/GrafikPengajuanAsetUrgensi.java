...
public class GrafikPengajuanAsetUrgensi extends javax.swing.JDialog {
    ...
    public GrafikPengajuanAsetUrgensi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Urgensi", "Jumlah Pengajuan", "Persentase Jumlah(%)",
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select urgensi,count(urgensi) as jumlah from pengajuan_inventaris where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by urgensi").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Pengajuan Aset/Inventaris Per Urgensi Periode " + Valid.SetTgl(
                        Tanggal1.getSelectedItem() + "") + " s.d. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Urgensi", "Jumlah",
                dcd, PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame("Pengajuan Aset/Inventaris Per Urgensi",
                freeChart);
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select urgensi,sum(total) from pengajuan_inventaris where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by urgensi").
                    executeQuery();
            while (rs.next()) {
        ...
        ChartFrame cf2 = new ChartFrame("Pengajuan Aset/Inventaris Per Urgensi",
                freeChart2);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPengajuanAsetUrgensi.jasper", "report",
                    "::[ Laporan Pengajuan Aset/Inventaris Per Urgensi ]::",
                    param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' group by urgensi");
            try {
                rs = ps.executeQuery();
                total = 0;
                jumlah = 0;
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{rs.getString("urgensi"), rs.getString("jumlah"), "0",
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPengajuanAsetUrgensi.class.getName());
