...
public class GrafikKeslingLimbahDomestikBulan extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select DATE_FORMAT(kesling_limbah_domestik.tanggal, '%y-%m'),sum(kesling_limbah_domestik.jumlahlimbah) as jumlah "
                    + "from kesling_limbah_domestik where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + " 23:59:59' group by DATE_FORMAT(kesling_limbah_domestik.tanggal, '%y-%m')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Limbah Padat Domestik Per Bulan Tanggal " + Valid.
                        SetTgl(Tanggal1.getSelectedItem() + "") + " S.D. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Bulan", "Jumlah (Kg)",
                dcd, PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame("Grafik Limbah Padat Domestik Per Bulan",
                freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "group by DATE_FORMAT(kesling_limbah_domestik.tanggal, '%y-%m')",
                "Bulan");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikKeslingLimbahDomestikBulan dialog = new GrafikKeslingLimbahDomestikBulan(new javax.swing.JFrame(),
                    true);
	...
	private static final Logger LOG = Logger.getLogger(GrafikKeslingLimbahDomestikBulan.class.getName());
