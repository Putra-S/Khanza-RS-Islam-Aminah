...
public class grafikpasienperpekerjaaan extends JDialog {
    ...
    public static CategoryDataset createDataset1(String symbol) { // data grafik nilai K
        ...
        try {
            ...
            ResultSet rs = stat.executeQuery(
                    "SELECT pekerjaan,count(pekerjaan) as jumlah  FROM pasien " + " " + symbol + " group by pekerjaan");
            while (rs.next()) {
    ...
    private static JFreeChart createChart(String symbol) {
        ...
        CategoryAxis domainAxis = new CategoryAxis("Pekerjaan");
    ...
    private static final Logger LOG = Logger.getLogger(grafikpasienperpekerjaaan.class.getName());
