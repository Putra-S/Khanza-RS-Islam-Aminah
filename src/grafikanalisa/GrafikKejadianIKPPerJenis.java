...
public class GrafikKejadianIKPPerJenis extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    + "where tgl_kejadian between '" + Valid.SetTgl(Tanggal1.
                            ...
                            Tanggal2.getSelectedItem() + "") + "' group by insiden_keselamatan.jenis_insiden").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                ...
                SetTgl(Tanggal2.getSelectedItem() + ""), "Jenis IKP", "Jumlah",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikKejadianIKPPerJenis dialog = new GrafikKejadianIKPPerJenis(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikKejadianIKPPerJenis.class.getName());
