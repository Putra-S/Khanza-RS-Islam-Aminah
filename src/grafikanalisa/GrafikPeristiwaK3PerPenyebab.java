...
public class GrafikPeristiwaK3PerPenyebab extends javax.swing.JDialog {
    ...
    public GrafikPeristiwaK3PerPenyebab(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Penyebab Kecelakaan", "Jumlah Peristiwa", "Persentase(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by k3rs_peristiwa.kode_penyebab").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                ...
                SetTgl(Tanggal2.getSelectedItem() + ""), "Penyebab Kecelakaan",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPeristiwaK3PerPenyebab.jasper", "report",
                    "::[ Laporan Jumlah Peristiwa K3 Per Penyebab Kecelakaan ]::",
                    param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "' group by k3rs_peristiwa.kode_penyebab");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPeristiwaK3PerPenyebab.class.getName());
