...
public class GrafikPeristiwaK3PerPenyebab extends javax.swing.JDialog {
    ...
    public GrafikPeristiwaK3PerPenyebab(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Penyebab Kecelakaan", "Jumlah Peristiwa",
                    "Persentase(%)"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPeristiwaK3PerPenyebab dialog = new GrafikPeristiwaK3PerPenyebab(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "where tgl_pelaporan between '" + Valid.SetTgl(Tanggal1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tanggal2.getSelectedItem() + "") + "' group by k3rs_peristiwa.kode_penyebab");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPeristiwaK3PerPenyebab.class.getName());
}
