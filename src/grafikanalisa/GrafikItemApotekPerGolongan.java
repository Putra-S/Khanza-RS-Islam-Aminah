...
public class GrafikItemApotekPerGolongan extends javax.swing.JDialog {
    ...
    public GrafikItemApotekPerGolongan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "Golongan Item Apotek", "Jumlah Golongan Item Apotek",
            "Persentase Golongan Item Apotek(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Item Apotek Per Golongan", "Golongan",
                "Jumlah Item Apotek", dcd, PlotOrientation.VERTICAL, true, true,
                true);
        ChartFrame cf = new ChartFrame("Grafik Item Apotek Per Golongan",
                freeChart);
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createPieChart(
                "Grafik Item Apotek Per Golongan", dpd, true, true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ChartFrame cf = new ChartFrame("Grafik Item Apotek Per Golongan",
                freeChart);
        cf.setSize(Scroll.getWidth(), Scroll.getHeight());
        cf.setLocationRelativeTo(Scroll);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptItemApotekPerGolongan.jasper", "report",
                    "::[ Laporan Jumlah Item Apotek Per Golongan ]::", param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikItemApotekPerGolongan dialog = new GrafikItemApotekPerGolongan(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikItemApotekPerGolongan.class.getName());
}
