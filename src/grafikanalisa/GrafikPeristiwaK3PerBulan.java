...
public class GrafikPeristiwaK3PerBulan extends javax.swing.JDialog {
    ...
    public GrafikPeristiwaK3PerBulan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Bulan Peristiwa", "Jumlah Peristiwa K3 Per Bulan", "Persentase K3 Per Bulan(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by DATE_FORMAT(k3rs_peristiwa.tgl_pelaporan, '%y-%m')").
                    executeQuery();
            while (rs.next()) {
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "group by DATE_FORMAT(k3rs_peristiwa.tgl_pelaporan, '%y-%m')",
                "Bulan");
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPeristiwaK3PerBulan.jasper", "report",
                    "::[ Laporan Jumlah Peristiwa K3 Per Bulan ]::", param);
        }
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPeristiwaK3PerBulan.class.getName());
