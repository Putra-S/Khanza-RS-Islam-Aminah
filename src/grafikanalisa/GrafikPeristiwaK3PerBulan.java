...
public class GrafikPeristiwaK3PerBulan extends javax.swing.JDialog {
    ...
    public GrafikPeristiwaK3PerBulan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Bulan Peristiwa",
            "Jumlah Peristiwa K3 Per Bulan", "Persentase K3 Per Bulan(%)"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPeristiwaK3PerBulan dialog = new GrafikPeristiwaK3PerBulan(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPeristiwaK3PerBulan.class.getName());
}
