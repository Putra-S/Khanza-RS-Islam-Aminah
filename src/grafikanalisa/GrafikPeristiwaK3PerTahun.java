...
public class GrafikPeristiwaK3PerTahun extends javax.swing.JDialog {
    ...
    public GrafikPeristiwaK3PerTahun(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Tahun Peristiwa",
            "Jumlah Peristiwa K3 Per Tahun", "Persentase K3 Per Tahun(%)"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPeristiwaK3PerTahun dialog = new GrafikPeristiwaK3PerTahun(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPeristiwaK3PerTahun.class.getName());
}
