...
public class GrafikPeristiwaK3PerTahun extends javax.swing.JDialog {
    ...
    public GrafikPeristiwaK3PerTahun(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Tahun Peristiwa", "Jumlah Peristiwa K3 Per Tahun", "Persentase K3 Per Tahun(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by year(k3rs_peristiwa.tgl_pelaporan)").
                    executeQuery();
            while (rs.next()) {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPeristiwaK3PerTahun.jasper", "report",
                    "::[ Laporan Jumlah Peristiwa K3 Per Tahun ]::", param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "' group by year(k3rs_peristiwa.tgl_pelaporan)");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPeristiwaK3PerTahun.class.getName());
