...
public class GrafikPegawaiPerPendidikan extends javax.swing.JDialog {
    ...
    public GrafikPegawaiPerPendidikan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Pendidikan Pegawai",
            "Jumlah", "Persentase(%)", "Laki-Laki", "Laki-Laki(%)", "Perempuan",
            "Perempuan(%)"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPegawaiPerPendidikan dialog = new GrafikPegawaiPerPendidikan(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new String[]{
                        rs.getString(1), rs.getString(2), "", jmll + "", "",
                        jmlp + "", ""
                    });
                }
                if (tabMode.getRowCount() > 0) {
                    tabMode.addRow(
                            new String[]{"Jumlah : ", total + "", "100 %",
                                totall + "", "100 %", totalp + "", "100 %"});
                    for (i = 0; i < tbBangsal.getRowCount(); i++) {
                        tbBangsal.setValueAt(Math.round((Double.parseDouble(
                                tbBangsal.getValueAt(i, 1).toString()) / total) * 100) + " %",
                                i, 2);
                        tbBangsal.setValueAt(Math.round((Double.parseDouble(
                                tbBangsal.getValueAt(i, 3).toString()) / totall) * 100) + " %",
                                i, 4);
                        tbBangsal.setValueAt(Math.round((Double.parseDouble(
                                tbBangsal.getValueAt(i, 5).toString()) / totalp) * 100) + " %",
                                i, 6);
                    }
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPegawaiPerPendidikan.class.getName());
}
