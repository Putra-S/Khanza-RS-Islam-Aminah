...
public class GrafikPegawaiPerPendidikan extends javax.swing.JDialog {
    ...
    public GrafikPegawaiPerPendidikan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Pendidikan Pegawai", "Jumlah", "Persentase(%)",
        ...
        try {
            pilihan = (String) JOptionPane.showInputDialog(null,
                    ...
                    JOptionPane.QUESTION_MESSAGE, null, new Object[]{
                        "Jumlah Pegawai", "Jumlah Pegawai Laki-Laki",
                        "Jumlah Pegawai Perempuan"}, "Jumlah Pegawai");
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Pendidikan", "Pendidikan",
                            "Jumlah Pegawai", dcd, PlotOrientation.VERTICAL,
                            true, true, true);
                    ChartFrame cf = new ChartFrame(
                            "Grafik Pegawai Per Pendidikan", freeChart);
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select pegawai.pendidikan,count(pegawai.pendidikan) as jumlah from pegawai where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by pegawai.pendidikan").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    JFreeChart freeChart2 = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Pendidikan", "Pendidikan",
                            "Jumlah Pegawai", dcd2, PlotOrientation.VERTICAL,
                            true, true, true);
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Pendidikan", freeChart2);
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select pegawai.pendidikan,count(pegawai.pendidikan) as jumlah from pegawai where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by pegawai.pendidikan").
                                executeQuery();
                        while (rs.next()) {
                            dcd3.setValue(rs.getDouble(2),
                                    rs.getString(1) + "(" + rs.getString(2) + ")",
                                    rs.getString(1));
                        }
                    ...
                    JFreeChart freeChart3 = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Pendidikan", "Pendidikan",
                            "Jumlah Pegawai", dcd3, PlotOrientation.VERTICAL,
                            true, true, true);
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Pendidikan", freeChart3);
                    cf3.setSize(Scroll.getWidth(), Scroll.getHeight());
                    cf3.setModalExclusionType(
                            ModalExclusionType.APPLICATION_EXCLUDE);
                    cf3.setLocationRelativeTo(Scroll);
                    cf3.setAlwaysOnTop(true);
                    cf3.setIconImage(new ImageIcon(super.getClass().getResource(
                            "/picture/addressbook-edit24.png")).getImage());
                    cf3.setVisible(true);
                    break;
        ...
        try {
            ...
            switch (pilihan) {
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    break;
                case "Jumlah Pegawai Perempuan":
                    grafiksql2 kas3 = new grafiksql2(
                            "Grafik Pegawai Per Pendidikan",
                            "select pegawai.pendidikan,count(pegawai.pendidikan) as jumlah from pegawai where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by pegawai.pendidikan",
                            "Pendidikan");
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Pendidikan", dpd, true, true,
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                ...
                                executeQuery();
                        while (rs.next()) {
                            dpd2.setValue(rs.getString(1) + "(" + rs.
                    ...
                    JFreeChart freeChart2 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Pendidikan", dpd2, true, true,
                            false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Pendidikan", freeChart2);
                    cf2.setSize(Scroll.getWidth(), Scroll.getHeight());
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                ...
                                executeQuery();
                        while (rs.next()) {
                            dpd3.setValue(rs.getString(1) + "(" + rs.
                                    getString(2) + ")", rs.getDouble(2));
                        }
                    ...
                    JFreeChart freeChart3 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Pendidikan", dpd3, true, true,
                            false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Pendidikan", freeChart3);
                    cf3.setSize(Scroll.getWidth(), Scroll.getHeight());
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPegawaiPerPendidikan.jasper", "report",
                    "::[ Laporan Jumlah Pegawai Per Pendidikan ]::", param);
        }
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    jmll = Sequel.cariInteger(
                            "select count(pegawai.pendidikan) from pegawai where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.pendidikan=?",
                            rs.getString(1));
                    jmlp = Sequel.cariInteger(
                            "select count(pegawai.pendidikan) from pegawai where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.pendidikan=?",
                            rs.getString(1));
                    totall += jmll;
                    totalp += jmlp;
                    tabMode.addRow(new String[]{rs.getString(1), rs.getString(2), "", jmll + "", "", jmlp + "", ""});
                }
                if (tabMode.getRowCount() > 0) {
                    tabMode.addRow(new String[]{"Jumlah : ", total + "", "100 %", totall + "", "100 %", totalp + "",
                        "100 %"});
                    for (i = 0; i < tbBangsal.getRowCount(); i++) {
                        tbBangsal.setValueAt(
                                Math.round((Double.parseDouble(tbBangsal.getValueAt(i, 1).toString()) / total) * 100)
                                + " %",
                                i, 2);
                        tbBangsal.setValueAt(
                                Math.round((Double.parseDouble(tbBangsal.getValueAt(i, 3).toString()) / totall) * 100)
                                + " %",
                                i, 4);
                        tbBangsal.setValueAt(
                                Math.round((Double.parseDouble(tbBangsal.getValueAt(i, 5).toString()) / totalp) * 100)
                                + " %",
                                i, 6);
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPegawaiPerPendidikan.class.getName());
