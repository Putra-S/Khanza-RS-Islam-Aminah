...
public class GrafikKeslingTanahPerBulan extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select DATE_FORMAT(kesling_pemakaian_air_tanah.tanggal, '%y-%m'),sum(kesling_pemakaian_air_tanah.jumlahharian) as jumlah "
                    + "from kesling_pemakaian_air_tanah where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + " 23:59:59' group by DATE_FORMAT(kesling_pemakaian_air_tanah.tanggal, '%y-%m')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Pemakaian Air Tanah Per Bulan Tanggal " + Valid.SetTgl(
                ...
                true);
        ChartFrame cf = new ChartFrame("Grafik Pemakaian Air Tanah Per Bulan",
                freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "group by DATE_FORMAT(kesling_pemakaian_air_tanah.tanggal, '%y-%m')",
                "Bulan");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikKeslingTanahPerBulan dialog = new GrafikKeslingTanahPerBulan(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikKeslingTanahPerBulan.class.getName());
