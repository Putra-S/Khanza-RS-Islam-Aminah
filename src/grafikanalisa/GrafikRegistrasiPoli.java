...
public class GrafikRegistrasiPoli extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    + "where tgl_registrasi between '" + Valid.SetTgl(Tanggal1.
                            ...
                            Tanggal2.getSelectedItem() + "") + "' group by poliklinik.nm_poli").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Registrasi Per Unit/Poli Tanggal " + Valid.SetTgl(
                        Tanggal1.getSelectedItem() + "") + " S.D. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Poliklinik/Unit",
                "Jumlah Pasien", dcd, PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame("Grafik Registrasi Per Unit/Poli",
                freeChart);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikRegistrasiPoli dialog = new GrafikRegistrasiPoli(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikRegistrasiPoli.class.getName());
