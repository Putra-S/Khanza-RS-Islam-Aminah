...
public class GrafikLabRalanPerTahun extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Kunjungan Lab Rawat Jalan Per Tahun Tanggal " + Valid.
        ...
        ChartFrame cf = new ChartFrame(
                "Grafik Kunjungan Lab Rawat Jalan Per Tahun", freeChart);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikLabRalanPerTahun dialog = new GrafikLabRalanPerTahun(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikLabRalanPerTahun.class.getName());
