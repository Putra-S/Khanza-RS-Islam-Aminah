...
public class GrafikRegistrasiPerPerujuk extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select rujuk_masuk.dokter_perujuk,count(rujuk_masuk.dokter_perujuk) as jumlah "
                    ...
                    + "where tgl_registrasi between '" + Valid.SetTgl(Tanggal1.
                            ...
                            Tanggal2.getSelectedItem() + "") + "' group by rujuk_masuk.dokter_perujuk").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Registrasi Per Perujuk Tanggal " + Valid.SetTgl(
                        Tanggal1.getSelectedItem() + "") + " S.D. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Perujuk",
                "Jumlah Pasien", dcd, PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame("Grafik Registrasi Per Perujuk",
                freeChart);
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createPieChart(
                "Grafik Registrasi Per Perujuk Tanggal " + Valid.SetTgl(
                        Tanggal1.getSelectedItem() + "") + " S.D. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), dpd, true, true, false);
        ChartFrame cf = new ChartFrame("Grafik Registrasi Per Perujuk",
                freeChart);
        cf.setSize(Scroll.getWidth(), Scroll.getHeight());
        cf.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptRegistrasiPerPerujuk.jasper", "report",
                    "::[ Laporan Jumlah Registrasi Per Perujuk ]::", param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select rujuk_masuk.dokter_perujuk,count(rujuk_masuk.dokter_perujuk) as jumlah "
                            + "from reg_periksa inner join rujuk_masuk on reg_periksa.no_rawat=rujuk_masuk.no_rawat "
                            + "where tgl_registrasi between '" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' and '"
                            + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' group by rujuk_masuk.dokter_perujuk");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikRegistrasiPerPerujuk.class.getName());
