...
public class GrafikRegistrasiPerPerujuk extends javax.swing.JDialog {
    ...
    public GrafikRegistrasiPerPerujuk(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Perujuk",
            "Jumlah Rujukan", "Persentase Rujukan(%)"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikRegistrasiPerPerujuk dialog = new GrafikRegistrasiPerPerujuk(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikRegistrasiPerPerujuk.class.getName());
}
