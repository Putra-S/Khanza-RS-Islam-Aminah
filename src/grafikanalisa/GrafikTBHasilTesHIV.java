...
public class GrafikTBHasilTesHIV extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select hasil_tes_hiv,count(hasil_tes_hiv) as jumlah "
                    + "from data_tb where tanggal_tes_hiv between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by hasil_tes_hiv").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Hasil Tes HIV TB Tanggal " + Valid.SetTgl(Tanggal1.
                        getSelectedItem() + "") + " S.D. " + Valid.SetTgl(
                        Tanggal2.getSelectedItem() + ""), "Hasil Tes",
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "where tanggal_tes_hiv between '" + Valid.SetTgl(Tanggal1.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikTBHasilTesHIV dialog = new GrafikTBHasilTesHIV(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikTBHasilTesHIV.class.getName());
