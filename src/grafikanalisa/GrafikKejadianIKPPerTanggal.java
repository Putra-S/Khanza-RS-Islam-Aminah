...
public class GrafikKejadianIKPPerTanggal extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by DATE_FORMAT(insiden_keselamatan_pasien.tgl_kejadian, '%y-%m-%d')").
                    executeQuery();
            while (rs.next()) {
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "where tgl_kejadian between '" + Valid.SetTgl(Tanggal1.
                        getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                        Tanggal2.getSelectedItem() + "") + "' "
                + "group by DATE_FORMAT(insiden_keselamatan_pasien.tgl_kejadian, '%y-%m-%d')",
                "Tanggal");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikKejadianIKPPerTanggal dialog = new GrafikKejadianIKPPerTanggal(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikKejadianIKPPerTanggal.class.getName());
