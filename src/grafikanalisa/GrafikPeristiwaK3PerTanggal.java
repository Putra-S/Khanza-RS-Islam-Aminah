...
public class GrafikPeristiwaK3PerTanggal extends javax.swing.JDialog {
    ...
    public GrafikPeristiwaK3PerTanggal(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Tanggal Peristiwa",
            "Jumlah Peristiwa K3 Per Tanggal", "Persentase K3 Per Tanggal(%)"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPeristiwaK3PerTanggal dialog = new GrafikPeristiwaK3PerTanggal(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPeristiwaK3PerTanggal.class.getName());
}
