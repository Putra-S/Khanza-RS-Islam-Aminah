...
public class GrafikPeristiwaK3PerTanggal extends javax.swing.JDialog {
    ...
    public GrafikPeristiwaK3PerTanggal(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Tanggal Peristiwa", "Jumlah Peristiwa K3 Per Tanggal",
            "Persentase K3 Per Tanggal(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by DATE_FORMAT(k3rs_peristiwa.tgl_pelaporan, '%Y-%m-%d')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Peristiwa K3 Per Tanggal Periode " + Valid.SetTgl(
        ...
        ChartFrame cf = new ChartFrame("Grafik Peristiwa K3 Per Tanggal",
                freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "group by DATE_FORMAT(k3rs_peristiwa.tgl_pelaporan, '%Y-%m-%d')",
                "Tanggal");
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPeristiwaK3PerTanggal.jasper", "report",
                    "::[ Laporan Jumlah Peristiwa K3 Per Tanggal ]::", param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select DATE_FORMAT(k3rs_peristiwa.tgl_pelaporan, '%Y-%m-%d'),count(DATE_FORMAT(k3rs_peristiwa.tgl_pelaporan, '%Y-%m-%d')) as jumlah "
                    + "from k3rs_peristiwa where tgl_pelaporan between '"
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPeristiwaK3PerTanggal.class.getName());
