...
public class GrafikKeslingLimbahB3Pertanggal extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select DATE_FORMAT(kesling_limbah_b3medis.tanggal, '%y-%m-%d'),sum(kesling_limbah_b3medis.jmllimbah) as jumlah "
                    + "from kesling_limbah_b3medis where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + " 23:59:59' group by DATE_FORMAT(kesling_limbah_b3medis.tanggal, '%y-%m-%d')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Limbah Padat B3 Medis Keluar TPS Per Tanggal Tanggal " + Valid.
        ...
        ChartFrame cf = new ChartFrame(
                "Grafik Limbah Padat B3 Medis Keluar TPS Per Tanggal", freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "group by DATE_FORMAT(kesling_limbah_b3medis.tanggal, '%y-%m-%d')",
                "Tanggal");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikKeslingLimbahB3Pertanggal dialog = new GrafikKeslingLimbahB3Pertanggal(new javax.swing.JFrame(),
                    true);
	...
	private static final Logger LOG = Logger.getLogger(GrafikKeslingLimbahB3Pertanggal.class.getName());
