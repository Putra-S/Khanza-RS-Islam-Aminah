...
public class GrafikPenerimaanObatPerbulan extends javax.swing.JDialog {
    ...
    public GrafikPenerimaanObatPerbulan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Bulan Penerimaan",
            "Nilai Penerimaan Per Bulan", "Persentase Penerimaan Per Bulan(%)",
            "Nilai Penerimaan"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPenerimaanObatPerbulan dialog = new GrafikPenerimaanObatPerbulan(
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new String[]{rs.getString(1), Valid.SetAngka(
                        rs.getDouble(2)), "", rs.getString(2)});
                }
                tabMode.addRow(new String[]{"Total : ",
                    Valid.SetAngka(total) + "", "100 %", total + ""});
                for (i = 0; i < tbBangsal.getRowCount(); i++) {
                    tbBangsal.setValueAt(Math.round((Double.parseDouble(
                            tbBangsal.getValueAt(i, 3).toString()) / total) * 100) + " %",
                            i, 2);
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPenerimaanObatPerbulan.class.getName());
}
