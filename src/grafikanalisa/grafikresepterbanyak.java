...
public class grafikresepterbanyak extends JDialog {
    ...
    public static CategoryDataset createDataset1(String symbol) { // data grafik nilai K
        ...
        try {
            ...
            ResultSet rs = stat.executeQuery(
                    ...
                    + " group by databarang.nama_brng order by sum(detail_pemberian_obat.jml) desc limit 10");
            while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(grafikresepterbanyak.class.getName());
