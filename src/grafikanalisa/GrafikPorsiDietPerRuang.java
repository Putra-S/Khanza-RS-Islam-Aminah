...
public class GrafikPorsiDietPerRuang extends javax.swing.JDialog {
    ...
    public GrafikPorsiDietPerRuang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Ruang/Bangsal/Kamar", "Jumlah Porsi Diet Per Ruang",
            "Persentase Porsi Diet Per Ruang(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    + "on detail_beri_diet.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal where detail_beri_diet.tanggal between '" + Valid.
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Porsi Diet Per Ruang Tanggal " + Valid.SetTgl(Tanggal1.
                        getSelectedItem() + "") + " S.D. " + Valid.SetTgl(
                        Tanggal2.getSelectedItem() + ""), "Ruang",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPorsiDietPerRuang.jasper", "report",
                    "::[ Laporan Jumlah Porsi Diet Per Ruang ]::", param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select bangsal.nm_bangsal,count(bangsal.nm_bangsal) as jumlah from detail_beri_diet inner join kamar inner join bangsal "
                    + "on detail_beri_diet.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal where detail_beri_diet.tanggal between '"
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPorsiDietPerRuang.class.getName());
