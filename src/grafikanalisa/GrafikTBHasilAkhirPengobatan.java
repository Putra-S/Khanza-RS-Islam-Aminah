...
public class GrafikTBHasilAkhirPengobatan extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select hasil_akhir_pengobatan,count(hasil_akhir_pengobatan) as jumlah "
                    + "from data_tb where tanggal_buat_laporan between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + " 23:59:59' group by hasil_akhir_pengobatan").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Hasil Akhir Pengobatan TB Tanggal " + Valid.SetTgl(
                        Tanggal1.getSelectedItem() + "") + " S.D. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""),
                "Hasil Akhir Pengobatan", "Jumlah Pasien", dcd,
                PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame("Grafik Hasil Akhir Pengobatan TB",
                freeChart);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikTBHasilAkhirPengobatan dialog = new GrafikTBHasilAkhirPengobatan(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikTBHasilAkhirPengobatan.class.getName());
