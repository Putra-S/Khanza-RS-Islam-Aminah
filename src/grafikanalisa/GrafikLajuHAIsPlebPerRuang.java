...
public class GrafikLajuHAIsPlebPerRuang extends javax.swing.JDialog {
    ...
    public GrafikLajuHAIsPlebPerRuang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Kamar/Bangsal",
            "Jumlah Hari IVL (Denumerator)", "Jumlah Kasus Plebitis (Numerator)",
            "Laju Plebitis", "Persentase Plebitis(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' and data_HAIs.PLEB>0 group by bangsal.kd_bangsal").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Laju HAIs Plebitis Per Ruang Periode " + Valid.SetTgl(
                        Tanggal1.getSelectedItem() + "") + " s.d. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Ruang", "Jumlah", dcd,
                PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame("Grafik Laju HAIs Plebitis Per Ruang",
                freeChart);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptLajuHAIsPlebitisPerRuang.jasper", "report",
                    "::[ Laporan Laju HAIs Plebitis Per Ruang ]::", param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikLajuHAIsPlebPerRuang dialog = new GrafikLajuHAIsPlebPerRuang(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "where data_HAIs.tanggal between '" + Valid.SetTgl(
                ...
                if (tabMode.getRowCount() > 0) {
                    ...
                    for (i = 0; i < tbBangsal.getRowCount(); i++) {
                        tbBangsal.setValueAt(Valid.SetAngka6((Double.
                                parseDouble(tbBangsal.getValueAt(i, 2).
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikLajuHAIsPlebPerRuang.class.getName());
}
