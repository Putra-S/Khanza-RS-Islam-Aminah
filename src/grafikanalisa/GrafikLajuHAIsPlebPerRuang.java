...
public class GrafikLajuHAIsPlebPerRuang extends javax.swing.JDialog {
    ...
    public GrafikLajuHAIsPlebPerRuang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Kamar/Bangsal", "Jumlah Hari IVL (Denumerator)",
            "Jumlah Kasus Plebitis (Numerator)", "Laju Plebitis", "Persentase Plebitis(%)"}) {
            @Override
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "where data_HAIs.tanggal between '" + Valid.SetTgl(Tanggal1.getSelectedItem() + "")
                ...
                if (tabMode.getRowCount() > 0) {
                    ...
                    for (i = 0; i < tbBangsal.getRowCount(); i++) {
                        tbBangsal.setValueAt(Valid.SetAngka6(
                                (Double.parseDouble(tbBangsal.getValueAt(i, 2).toString()) / total) * 100) + " %", i,
                                4);
                    }
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikLajuHAIsPlebPerRuang.class.getName());
