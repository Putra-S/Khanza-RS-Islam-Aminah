...
public class GrafikPegawaiPerJenjangJabatan extends javax.swing.JDialog {
    ...
    public GrafikPegawaiPerJenjangJabatan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "Jenjang Jabatan Pegawai", "Jumlah", "Persentase(%)", "Laki-Laki",
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Jenjang Jabatan",
                            "Jenjang Jabatan", "Jumlah Pegawai", dcd,
                            PlotOrientation.VERTICAL, true, true, true);
                    ChartFrame cf = new ChartFrame(
                            "Grafik Pegawai Per Jenjang Jabatan", freeChart);
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select jnj_jabatan.kode,count(jnj_jabatan.kode) as jumlah,jnj_jabatan.nama from pegawai inner join jnj_jabatan "
                                + "on jnj_jabatan.kode=pegawai.jnj_jabatan where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by jnj_jabatan.kode").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    JFreeChart freeChart2 = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Jenjang Jabatan",
                            "Jenjang Jabatan", "Jumlah Pegawai", dcd2,
                            PlotOrientation.VERTICAL, true, true, true);
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Jenjang Jabatan", freeChart2);
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select jnj_jabatan.kode,count(jnj_jabatan.kode) as jumlah,jnj_jabatan.nama from pegawai inner join jnj_jabatan "
                                + "on jnj_jabatan.kode=pegawai.jnj_jabatan where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by jnj_jabatan.kode").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    JFreeChart freeChart3 = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Jenjang Jabatan",
                            "Jenjang Jabatan", "Jumlah Pegawai", dcd3,
                            PlotOrientation.VERTICAL, true, true, true);
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Jenjang Jabatan", freeChart3);
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Jenjang Jabatan", dpd, true,
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    JFreeChart freeChart2 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Jenjang Jabatan", dpd2, true,
                            true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Jenjang Jabatan", freeChart2);
                    cf2.setSize(Scroll.getWidth(), Scroll.getHeight());
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    JFreeChart freeChart3 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Jenjang Jabatan", dpd3, true,
                            true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Jenjang Jabatan", freeChart3);
                    cf3.setSize(Scroll.getWidth(), Scroll.getHeight());
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPegawaiPerJenjangJabatan.jasper", "report",
                    "::[ Laporan Jumlah Pegawai Per Jenjang Jabatan ]::", param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPegawaiPerJenjangJabatan dialog = new GrafikPegawaiPerJenjangJabatan(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    jmll = Sequel.cariInteger(
                            "select count(jnj_jabatan.kode) from pegawai inner join jnj_jabatan "
                            + "on jnj_jabatan.kode=pegawai.jnj_jabatan where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and jnj_jabatan.kode=?",
                            rs.getString(1));
                    jmlp = Sequel.cariInteger(
                            "select count(jnj_jabatan.kode) from pegawai inner join jnj_jabatan "
                            + "on jnj_jabatan.kode=pegawai.jnj_jabatan where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and jnj_jabatan.kode=?",
                            rs.getString(1));
                    totall += jmll;
                    totalp += jmlp;
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPegawaiPerJenjangJabatan.class.getName());
}
