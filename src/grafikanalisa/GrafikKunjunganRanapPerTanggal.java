...
public class GrafikKunjunganRanapPerTanggal extends javax.swing.JDialog {
    ...
    public GrafikKunjunganRanapPerTanggal(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Tanggal Kunjungan Ranap",
            "Jumlah Kunjungan Ranap Per Tanggal", "Persentase Kunjungan Ranap Per Tanggal(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    + "from reg_periksa where reg_periksa.status_lanjut='Ranap' and tgl_registrasi between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by DATE_FORMAT(reg_periksa.tgl_registrasi, '%y-%m-%d')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Kunjungan Ranap Per Tanggal Tanggal " + Valid.SetTgl(
                        Tanggal1.getSelectedItem() + "") + " S.D. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Tanggal",
                "Jumlah Pasien", dcd, PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame("Grafik Kunjungan Ranap Per Tanggal",
                freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "where reg_periksa.status_lanjut='Ranap' and tgl_registrasi between '" + Valid.
                        SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                SetTgl(Tanggal2.getSelectedItem() + "") + "' "
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptKunjunganRanapPerTanggal.jasper", "report",
                    "::[ Laporan Jumlah Kunjuangan Ranap Per Tanggal ]::", param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select DATE_FORMAT(reg_periksa.tgl_registrasi, '%y-%m-%d'),count(DATE_FORMAT(reg_periksa.tgl_registrasi, '%y-%m-%d')) as jumlah from reg_periksa "
                    + "where reg_periksa.status_lanjut='Ranap' and tgl_registrasi between '"
    ...
    private static final Logger LOG = Logger.getLogger(GrafikKunjunganRanapPerTanggal.class.getName());
