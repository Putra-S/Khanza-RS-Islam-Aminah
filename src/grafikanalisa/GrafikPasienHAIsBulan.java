...
public class GrafikPasienHAIsBulan extends javax.swing.JDialog {
    ...
    public GrafikPasienHAIsBulan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Bulan Peristiwa HAIs", "Jumlah Pasien", "Persentase(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select DATE_FORMAT(data_HAIs.tanggal, '%Y-%m'),count(distinct data_HAIs.no_rawat) as jumlah "
                    + "from data_HAIs where tanggal between '" + Valid.SetTgl(
                            Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by DATE_FORMAT(data_HAIs.tanggal, '%Y-%m')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Pasien HAIs Per Bulan Periode " + Valid.SetTgl(Tanggal1.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPasienHAIsBulan.jasper", "report",
                    "::[ Laporan Pasien HAIs Per Bulan ]::", param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select DATE_FORMAT(data_HAIs.tanggal, '%Y-%m'),count(distinct data_HAIs.no_rawat) "
                            + "from data_HAIs where tanggal between '" + Valid.SetTgl(Tanggal1.getSelectedItem() + "")
                            + "' and '" + Valid.SetTgl(Tanggal2.getSelectedItem() + "")
                            + "' group by DATE_FORMAT(data_HAIs.tanggal, '%Y-%m')");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPasienHAIsBulan.class.getName());
