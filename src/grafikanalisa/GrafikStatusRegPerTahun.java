...
public class GrafikStatusRegPerTahun extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Registrasi Pasien Lama Per Tahun Tanggal " + Valid.
        ...
        ChartFrame cf = new ChartFrame("Grafik Registrasi Pasien Lama Per Tahun",
                freeChart);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikStatusRegPerTahun dialog = new GrafikStatusRegPerTahun(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikStatusRegPerTahun.class.getName());
