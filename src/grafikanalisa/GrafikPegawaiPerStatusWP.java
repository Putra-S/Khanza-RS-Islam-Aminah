...
public class GrafikPegawaiPerStatusWP extends javax.swing.JDialog {
    ...
    public GrafikPegawaiPerStatusWP(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Status WP Pegawai",
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Status WP", "Status WP",
                            "Jumlah Pegawai", dcd, PlotOrientation.VERTICAL,
                            true, true, true);
                    ChartFrame cf = new ChartFrame(
                            "Grafik Pegawai Per Status WP", freeChart);
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select stts_wp.stts,count(stts_wp.stts) as jumlah,stts_wp.ktg from pegawai inner join stts_wp "
                                + "on stts_wp.stts=pegawai.stts_wp where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI')group by stts_wp.stts").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Status WP", freeChart2);
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select stts_wp.stts,count(stts_wp.stts) as jumlah,stts_wp.ktg from pegawai inner join stts_wp "
                                + "on stts_wp.stts=pegawai.stts_wp where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by stts_wp.stts").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Status WP", freeChart3);
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Status WP", dpd, true, true,
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    JFreeChart freeChart2 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Status WP", dpd2, true, true,
                            false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Status WP", freeChart2);
                    cf2.setSize(Scroll.getWidth(), Scroll.getHeight());
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    JFreeChart freeChart3 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Status WP", dpd3, true, true,
                            false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Status WP", freeChart3);
                    cf3.setSize(Scroll.getWidth(), Scroll.getHeight());
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPegawaiPerStatusWP.jasper", "report",
                    "::[ Laporan Jumlah Pegawai Per Status WP ]::", param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPegawaiPerStatusWP dialog = new GrafikPegawaiPerStatusWP(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    jmll = Sequel.cariInteger(
                            "select count(pegawai.stts_wp) from pegawai where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.stts_wp=?",
                            rs.getString(1));
                    jmlp = Sequel.cariInteger(
                            "select count(pegawai.stts_wp) from pegawai where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.stts_wp=?",
                            rs.getString(1));
                    totall += jmll;
                    totalp += jmlp;
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPegawaiPerStatusWP.class.getName());
}
