...
public class GrafikPengajuanAsetStatus extends javax.swing.JDialog {
    ...
    public GrafikPengajuanAsetStatus(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Status", "Jumlah Pengajuan", "Persentase Jumlah(%)",
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select status,count(status) as jumlah from pengajuan_inventaris where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by status").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Pengajuan Aset/Inventaris Per Status Periode " + Valid.SetTgl(
                        Tanggal1.getSelectedItem() + "") + " s.d. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Status", "Jumlah", dcd,
                PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame("Pengajuan Aset/Inventaris Per Status",
                freeChart);
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select status,sum(total) from pengajuan_inventaris where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by status").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart2 = ChartFactory.createBarChart(
                "Pengajuan Aset/Inventaris Per Status Periode " + Valid.SetTgl(
                        Tanggal1.getSelectedItem() + "") + " s.d. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Status", "Jumlah",
                dcd2, PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf2 = new ChartFrame("Pengajuan Aset/Inventaris Per Status",
                freeChart2);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPengajuanAsetStatus.jasper", "report",
                    "::[ Laporan Pengajuan Aset/Inventaris Per Status ]::",
                    param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select status,count(status) as jumlah,sum(total) as total from pengajuan_inventaris "
                            + "where tanggal between '" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' and '"
                            + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' group by status");
            try {
                rs = ps.executeQuery();
                total = 0;
                jumlah = 0;
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{rs.getString("status"), rs.getString("jumlah"), "0",
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPengajuanAsetStatus.class.getName());
