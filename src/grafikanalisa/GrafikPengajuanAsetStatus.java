...
public class GrafikPengajuanAsetStatus extends javax.swing.JDialog {
    ...
    public GrafikPengajuanAsetStatus(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Status",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPengajuanAsetStatus dialog = new GrafikPengajuanAsetStatus(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "where tanggal between '" + Valid.SetTgl(Tanggal1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tanggal2.getSelectedItem() + "") + "' group by status");
            try {
                rs = ps.executeQuery();
                total = 0;
                jumlah = 0;
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{rs.getString("status"), rs.
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPengajuanAsetStatus.class.getName());
}
