...
public class GrafikTBPeriodeLaporan extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select id_periode_laporan,count(id_periode_laporan) as jumlah "
                    + "from data_tb where tanggal_buat_laporan between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + " 23:59:59' group by id_periode_laporan").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Periode Laporan TB Tanggal " + Valid.SetTgl(Tanggal1.
                        getSelectedItem() + "") + " S.D. " + Valid.SetTgl(
                        Tanggal2.getSelectedItem() + ""), "Periode Laporan",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikTBPeriodeLaporan dialog = new GrafikTBPeriodeLaporan(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikTBPeriodeLaporan.class.getName());
