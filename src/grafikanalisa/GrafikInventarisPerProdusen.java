...
public class GrafikInventarisPerProdusen extends javax.swing.JDialog {
    ...
    public GrafikInventarisPerProdusen(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Nama Produsen", "Jumlah", "Persentase(%)", "Nilai Aset", "Nilai Aset(%)"}) {
        ...
        try {
            ...
            switch (pilihan) {
                case "Jumlah Inventaris":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select inventaris_produsen.kode_produsen,count(inventaris_produsen.kode_produsen) as jumlah,inventaris_produsen.nama_produsen from inventaris inner join inventaris_barang inner join inventaris_produsen on inventaris_produsen.kode_produsen=inventaris_barang.kode_produsen "
                    ...
                    JFreeChart freeChart = ChartFactory.createBarChart(
                            "Grafik Jumlah Inventaris Per Produsen",
                            "Produsen Inventaris", "Jumlah Inventaris", dcd,
                            PlotOrientation.VERTICAL, true, true, true);
                    ChartFrame cf = new ChartFrame(
                            "Grafik Jumlah Inventaris Per Produsen", freeChart);
                ...
                case "Nilai Inventaris":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select inventaris_produsen.kode_produsen,sum(inventaris.harga) as harga,inventaris_produsen.nama_produsen from inventaris inner join inventaris_barang inner join inventaris_produsen on inventaris_produsen.kode_produsen=inventaris_barang.kode_produsen "
                                + "and inventaris.kode_barang=inventaris_barang.kode_barang group by inventaris_produsen.kode_produsen").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    JFreeChart freeChart2 = ChartFactory.createBarChart(
                            "Grafik Jumlah Inventaris Per Produsen",
                            "Produsen Inventaris", "Jumlah Inventaris", dcd2,
                            PlotOrientation.VERTICAL, true, true, true);
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Jumlah Inventaris Per Produsen", freeChart2);
            ...
            switch (pilihan) {
                case "Jumlah Inventaris":
                    ...
                    JFreeChart freeChart = ChartFactory.createPieChart(
                            "Grafik Jumlah Inventaris Per Produsen", dpd, true,
                ...
                case "Nilai Inventaris":
                    ...
                    JFreeChart freeChart2 = ChartFactory.createPieChart(
                            "Grafik Jumlah Inventaris Per Produsen", dpd2, true,
                            true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Jumlah Inventaris Per Produsen", freeChart2);
                    cf2.setSize(Scroll.getWidth(), Scroll.getHeight());
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptInventarisPerProdusen.jasper", "report",
                    "::[ Laporan Jumlah Inventaris Per Produsen Inventaris ]::",
                    param);
        }
            ...
            try {
                ...
                if (tabMode.getRowCount() > 0) {
                    ...
                    for (i = 0; i < tbInventaris.getRowCount(); i++) {
                        tbInventaris.setValueAt(
                                Math.round((Double.parseDouble(tbInventaris.getValueAt(i, 1).toString()) / total) * 100)
                                + " %",
                                i, 2);
                        tbInventaris.setValueAt(Math
                                .round((Double.parseDouble(tbInventaris.getValueAt(i, 3).toString()) / totalaset) * 100)
                                + " %", i, 4);
                    }
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikInventarisPerProdusen.class.getName());
