 ...
 * @author Via
 */
public class grafikreseptersedikit extends JDialog {
    ...
    public static CategoryDataset createDataset1(String symbol) { // data grafik nilai K
        ...
        try {
            ...
            ResultSet rs = stat.executeQuery(
                    ...
                    + "on detail_pemberian_obat.kode_brng=databarang.kode_brng where " + symbol
                    + " group by databarang.nama_brng order by sum(detail_pemberian_obat.jml) asc limit 10");
            while (rs.next()) {
     ...
     */
    public grafikreseptersedikit(String title, String symbol) {
        setTitle(title);
    ...
    private static final Logger LOG = Logger.getLogger(grafikreseptersedikit.class.getName());
