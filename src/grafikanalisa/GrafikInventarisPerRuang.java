...
public class GrafikInventarisPerRuang extends javax.swing.JDialog {
    ...
    public GrafikInventarisPerRuang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Nama Ruang",
            "Jumlah", "Persentase(%)", "Nilai Aset", "Nilai Aset(%)"}) {
        ...
        try {
            ...
            switch (pilihan) {
                case "Jumlah Inventaris":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select inventaris_ruang.id_ruang,count(inventaris.id_ruang) as jumlah,inventaris_ruang.nama_ruang from inventaris inner join inventaris_ruang "
                                + "on inventaris_ruang.id_ruang=inventaris.id_ruang  group by inventaris_ruang.id_ruang").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    JFreeChart freeChart = ChartFactory.createBarChart(
                            "Grafik Jumlah Inventaris Per Ruang",
                            "Ruang Inventaris", "Jumlah Inventaris", dcd,
                            PlotOrientation.VERTICAL, true, true, true);
                    ChartFrame cf = new ChartFrame(
                            "Grafik Jumlah Inventaris Per Ruang", freeChart);
                ...
                case "Nilai Inventaris":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select inventaris_ruang.id_ruang,sum(inventaris.harga) as harga,inventaris_ruang.nama_ruang from inventaris inner join inventaris_ruang "
                                + "on inventaris_ruang.id_ruang=inventaris.id_ruang group by inventaris_ruang.id_ruang").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    JFreeChart freeChart2 = ChartFactory.createBarChart(
                            "Grafik Jumlah Inventaris Per Ruang",
                            "Ruang Inventaris", "Jumlah Inventaris", dcd2,
                            PlotOrientation.VERTICAL, true, true, true);
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Jumlah Inventaris Per Ruang", freeChart2);
            ...
            switch (pilihan) {
                case "Jumlah Inventaris":
                    ...
                    JFreeChart freeChart = ChartFactory.createPieChart(
                            "Grafik Jumlah Inventaris Per Ruang", dpd, true,
                ...
                case "Nilai Inventaris":
                    ...
                    JFreeChart freeChart2 = ChartFactory.createPieChart(
                            "Grafik Jumlah Inventaris Per Ruang", dpd2, true,
                            true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Jumlah Inventaris Per Ruang", freeChart2);
                    cf2.setSize(Scroll.getWidth(), Scroll.getHeight());
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptInventarisPerRuang.jasper", "report",
                    "::[ Laporan Jumlah Inventaris Per Ruang Inventaris ]::",
                    param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikInventarisPerRuang dialog = new GrafikInventarisPerRuang(
                ...
                if (tabMode.getRowCount() > 0) {
                    ...
                    for (i = 0; i < tbBangsal.getRowCount(); i++) {
                        tbBangsal.setValueAt(Math.round((Double.parseDouble(
                                ...
                                i, 2);
                        tbBangsal.setValueAt(Math.round((Double.parseDouble(
                                tbBangsal.getValueAt(i, 3).toString()) / totalaset) * 100) + " %",
                                i, 4);
                    }
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikInventarisPerRuang.class.getName());
}
