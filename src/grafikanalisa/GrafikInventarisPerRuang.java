...
public class GrafikInventarisPerRuang extends javax.swing.JDialog {
    ...
    public GrafikInventarisPerRuang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Nama Ruang", "Jumlah", "Persentase(%)", "Nilai Aset", "Nilai Aset(%)"}) {
                ...
                if (tabMode.getRowCount() > 0) {
                    ...
                    for (i = 0; i < tbBangsal.getRowCount(); i++) {
                        tbBangsal.setValueAt(
                                ...
                                + " %",
                                i, 2);
                        tbBangsal.setValueAt(Math.round(
                                (Double.parseDouble(tbBangsal.getValueAt(i, 3).toString()) / totalaset) * 100) + " %",
                                i, 4);
                    }
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikInventarisPerRuang.class.getName());
