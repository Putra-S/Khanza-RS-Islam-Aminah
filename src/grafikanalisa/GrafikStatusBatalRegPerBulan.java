...
public class GrafikStatusBatalRegPerBulan extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Status Batal Periksa Per Bulan Tanggal " + Valid.SetTgl(
        ...
        ChartFrame cf = new ChartFrame("Grafik Status Batal Periksa Per Bulan",
                freeChart);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikStatusBatalRegPerBulan dialog = new GrafikStatusBatalRegPerBulan(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikStatusBatalRegPerBulan.class.getName());
