...
public class GrafikReportEMRDokter extends javax.swing.JDialog {
    ...
    public GrafikReportEMRDokter(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"NIP", "Nama",
            "Jumlah Pasien", "Awal Medis IGD",
            "CPPT/SOAP Ralan", "Awal Medis Ranap", "CPPT/SOAP ranap",
            "Resep NonRacikan"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikReportEMRDokter dialog = new GrafikReportEMRDokter(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "(SELECT count( penilaian_medis_igd.no_rawat ) FROM penilaian_medis_igd WHERE penilaian_medis_igd.tanggal BETWEEN '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "'"
                    + "AND penilaian_medis_igd.kd_dokter = reg_periksa.kd_dokter ) AS awalmedisigd,"
                    + "((SELECT	count( penilaian_medis_ranap.no_rawat )	FROM	penilaian_medis_ranap WHERE	penilaian_medis_ranap.tanggal BETWEEN '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "'"
                    + "AND penilaian_medis_ranap.kd_dokter = reg_periksa.kd_dokter) +"
                    + "(SELECT count( penilaian_medis_ranap_kandungan.no_rawat ) FROM penilaian_medis_ranap_kandungan WHERE penilaian_medis_ranap_kandungan.tanggal BETWEEN '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "'"
                    + "AND penilaian_medis_ranap_kandungan.kd_dokter = reg_periksa.kd_dokter )) AS AWRANAP,"
                    + "(SELECT count( pemeriksaan_ralan.no_rawat ) FROM pemeriksaan_ralan WHERE pemeriksaan_ralan.tgl_perawatan BETWEEN '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "'"
                    + "AND pemeriksaan_ralan.nip = reg_periksa.kd_dokter ) AS CPPTRALANDOKTER,"
                    + "(SELECT count( pemeriksaan_ranap.no_rawat ) FROM pemeriksaan_ranap WHERE pemeriksaan_ranap.tgl_perawatan BETWEEN '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "'"
                    + "AND pemeriksaan_ranap.nip = reg_periksa.kd_dokter ) AS CPPTRANAP,"
                    + "(SELECT	count( resep_obat.no_resep ) FROM	resep_obat WHERE resep_obat.tgl_peresepan BETWEEN '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "'"
                    ...
                    + "INNER JOIN dokter ON reg_periksa.kd_dokter = dokter.kd_dokter "
                    + "WHERE "
                    + "        reg_periksa.tgl_registrasi BETWEEN '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "'"
                    + "        AND reg_periksa.status_bayar = 'Sudah Bayar' "
                    + "        AND dokter.STATUS = '1' "
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikReportEMRDokter.class.getName());
}
