...
public class GrafikPorsiDietPerTahun extends javax.swing.JDialog {
    ...
    public GrafikPorsiDietPerTahun(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Tahun", "Jumlah Porsi Diet Per Tahun", "Persentase Per Tahun(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select year(detail_beri_diet.tanggal),count(year(detail_beri_diet.tanggal)) as jumlah "
                    + "from detail_beri_diet where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by year(detail_beri_diet.tanggal)").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Porsi Diet Per Tahun Periode " + Valid.SetTgl(Tanggal1.
                        getSelectedItem() + "") + " s.d. " + Valid.SetTgl(
                        Tanggal2.getSelectedItem() + ""), "Tahun", "Jumlah", dcd,
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPorsiDietPerTahun.jasper", "report",
                    "::[ Laporan Jumlah Porsi Diet Per Tahun ]::", param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "' group by year(detail_beri_diet.tanggal)");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPorsiDietPerTahun.class.getName());
