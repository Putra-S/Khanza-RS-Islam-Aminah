...
public class GrafikPorsiDietPerTahun extends javax.swing.JDialog {
    ...
    public GrafikPorsiDietPerTahun(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Tahun",
            "Jumlah Porsi Diet Per Tahun", "Persentase Per Tahun(%)"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPorsiDietPerTahun dialog = new GrafikPorsiDietPerTahun(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPorsiDietPerTahun.class.getName());
}
