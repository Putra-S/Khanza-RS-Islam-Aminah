...
public class GrafikInventarisPerKategori extends javax.swing.JDialog {
    ...
    public GrafikInventarisPerKategori(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Nama Kategori", "Jumlah", "Persentase(%)", "Nilai Aset", "Nilai Aset(%)"}) {
        ...
        try {
            ...
            switch (pilihan) {
                case "Jumlah Inventaris":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select inventaris_kategori.id_kategori,count(inventaris_kategori.id_kategori) as jumlah,inventaris_kategori.nama_kategori from inventaris inner join inventaris_barang inner join inventaris_kategori on inventaris_kategori.id_kategori=inventaris_barang.id_kategori "
                    ...
                    JFreeChart freeChart = ChartFactory.createBarChart(
                            "Grafik Jumlah Inventaris Per Kategori",
                            "Kategori Inventaris", "Jumlah Inventaris", dcd,
                            PlotOrientation.VERTICAL, true, true, true);
                    ChartFrame cf = new ChartFrame(
                            "Grafik Jumlah Inventaris Per Kategori", freeChart);
                ...
                case "Nilai Inventaris":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select inventaris_kategori.id_kategori,sum(inventaris.harga) as harga,inventaris_kategori.nama_kategori from inventaris inner join inventaris_barang inner join inventaris_kategori on inventaris_kategori.id_kategori=inventaris_barang.id_kategori "
                                + "and inventaris.kode_barang=inventaris_barang.kode_barang group by inventaris_kategori.id_kategori").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    JFreeChart freeChart2 = ChartFactory.createBarChart(
                            "Grafik Jumlah Inventaris Per Kategori",
                            "Kategori Inventaris", "Jumlah Inventaris", dcd2,
                            PlotOrientation.VERTICAL, true, true, true);
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Jumlah Inventaris Per Kategori", freeChart2);
            ...
            switch (pilihan) {
                case "Jumlah Inventaris":
                    ...
                    JFreeChart freeChart = ChartFactory.createPieChart(
                            "Grafik Jumlah Inventaris Per Kategori", dpd, true,
                ...
                case "Nilai Inventaris":
                    ...
                    JFreeChart freeChart2 = ChartFactory.createPieChart(
                            "Grafik Jumlah Inventaris Per Kategori", dpd2, true,
                            true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Jumlah Inventaris Per Kategori", freeChart2);
                    cf2.setSize(Scroll.getWidth(), Scroll.getHeight());
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptInventarisPerKategori.jasper", "report",
                    "::[ Laporan Jumlah Inventaris Per Kategori Inventaris ]::",
                    param);
        }
    ...
    private static final Logger LOG = Logger.getLogger(GrafikInventarisPerKategori.class.getName());
