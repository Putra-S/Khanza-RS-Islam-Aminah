...
public class GrafikPeristiwaK3PerLokasiKejadian extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public GrafikPeristiwaK3PerLokasiKejadian(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode = new DefaultTableModel(null, new Object[]{"Lokasi Kejadian",
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by k3rs_peristiwa.kode_lokasi").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                ...
                SetTgl(Tanggal2.getSelectedItem() + ""), "Lokasi Kejadian",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPeristiwaK3PerLokasiKejadian.jasper", "report",
                    "::[ Laporan Jumlah Peristiwa K3 Per Lokasi Kejadian ]::",
                    param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPeristiwaK3PerLokasiKejadian dialog = new GrafikPeristiwaK3PerLokasiKejadian(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "where tgl_pelaporan between '" + Valid.SetTgl(Tanggal1.
                            getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                            Tanggal2.getSelectedItem() + "") + "' group by k3rs_peristiwa.kode_lokasi");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPeristiwaK3PerLokasiKejadian.class.getName());
}
