...
public class GrafikPeristiwaK3PerLokasiKejadian extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPeristiwaK3PerLokasiKejadian dialog = new GrafikPeristiwaK3PerLokasiKejadian(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "' group by k3rs_peristiwa.kode_lokasi");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPeristiwaK3PerLokasiKejadian.class.getName());
