...
public class GrafikPerbaikanInventarisPerBulan extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public GrafikPerbaikanInventarisPerBulan(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode = new DefaultTableModel(null, new Object[]{
            "Bulan Perbaikan Inventaris",
            "Jumlah Perbaikan Inventaris Per Bulan",
            "Persentase Perbaikan Inventaris Per Bulan(%)"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPerbaikanInventarisPerBulan dialog = new GrafikPerbaikanInventarisPerBulan(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPerbaikanInventarisPerBulan.class.getName());
}
