...
public class GrafikPerbaikanInventarisPerBulan extends javax.swing.JDialog {
    ...
    public GrafikPerbaikanInventarisPerBulan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Bulan Perbaikan Inventaris",
            "Jumlah Perbaikan Inventaris Per Bulan", "Persentase Perbaikan Inventaris Per Bulan(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select DATE_FORMAT(perbaikan_inventaris.tanggal, '%y-%m'),count(DATE_FORMAT(perbaikan_inventaris.tanggal, '%y-%m')) as jumlah "
                    + "from perbaikan_inventaris where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by DATE_FORMAT(perbaikan_inventaris.tanggal, '%y-%m')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Perbaikan Inventaris Per Bulan Tanggal " + Valid.SetTgl(
                        Tanggal1.getSelectedItem() + "") + " S.D. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Bulan", "Jumlah", dcd,
                PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame("Grafik Perbaikan Inventaris Per Bulan",
                freeChart);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPerbaikanInventarisPerBulan.jasper", "report",
                    "::[ Laporan Jumlah Perbaikan Inventaris Per Bulan ]::",
                    param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPerbaikanInventarisPerBulan dialog = new GrafikPerbaikanInventarisPerBulan(new javax.swing.JFrame(),
                    true);
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPerbaikanInventarisPerBulan.class.getName());
