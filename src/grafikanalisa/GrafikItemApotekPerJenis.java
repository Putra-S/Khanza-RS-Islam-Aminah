...
public class GrafikItemApotekPerJenis extends javax.swing.JDialog {
    ...
    public GrafikItemApotekPerJenis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Jenis Item Apotek",
            "Jumlah Jenis Item Apotek", "Persentase Jenis Item Apotek(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Item Apotek Per Jenis", "Jenis", "Jumlah Item Apotek",
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createPieChart(
                "Grafik Item Apotek Per Jenis", dpd, true, true, false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
        ChartFrame cf = new ChartFrame("Grafik Item Apotek Per Jenis", freeChart);
        cf.setSize(Scroll.getWidth(), Scroll.getHeight());
        cf.setLocationRelativeTo(Scroll);
        cf.setModalExclusionType(ModalExclusionType.APPLICATION_EXCLUDE);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptItemApotekPerJenis.jasper", "report",
                    "::[ Laporan Jumlah Item Apotek Per Jenis ]::", param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikItemApotekPerJenis dialog = new GrafikItemApotekPerJenis(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikItemApotekPerJenis.class.getName());
}
