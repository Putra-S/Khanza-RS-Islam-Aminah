...
public class GrafikItemApotekPerJenis extends javax.swing.JDialog {
    ...
    public GrafikItemApotekPerJenis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Jenis Item Apotek", "Jumlah Jenis Item Apotek", "Persentase Jenis Item Apotek(%)"}) {
            @Override
    ...
    private static final Logger LOG = Logger.getLogger(GrafikItemApotekPerJenis.class.getName());
