 ...
 * @author Via
 */
public class grafikjkel extends JDialog {
    ...
    public static CategoryDataset createDataset1(String symbol) { // data grafik nilai K
        ...
        try {
            ...
            ResultSet rs = stat
                    .executeQuery("SELECT jk,count(jk) as jumlah  FROM pasien " + " " + symbol + " group by jk");
            while (rs.next()) {
    ...
    public grafikjkel(String title, String symbol) {
        // super(title);
        setTitle(title);
    ...
    private static final Logger LOG = Logger.getLogger(grafikjkel.class.getName());
