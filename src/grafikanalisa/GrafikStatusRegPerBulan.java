...
public class GrafikStatusRegPerBulan extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    + "from reg_periksa where reg_periksa.stts_daftar='Lama' and tgl_registrasi between '" + Valid.
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Registrasi Pasien Lama Per Bulan Tanggal " + Valid.
        ...
        ChartFrame cf = new ChartFrame("Grafik Registrasi Pasien Lama Per Bulan",
                freeChart);
    ...
    private void BtnPrint4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint4ActionPerformed
        grafiksql2 kas = new grafiksql2(
                ...
                + "where reg_periksa.stts_daftar='Lama' and tgl_registrasi between '" + Valid.
                        SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                SetTgl(Tanggal2.getSelectedItem() + "") + "' "
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikStatusRegPerBulan dialog = new GrafikStatusRegPerBulan(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikStatusRegPerBulan.class.getName());
