...
public class GrafikStatusRegPerTahun2 extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Registrasi Pasien Baru Per Tahun Tanggal " + Valid.
        ...
        ChartFrame cf = new ChartFrame("Grafik Registrasi Pasien Baru Per Tahun",
                freeChart);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikStatusRegPerTahun2 dialog = new GrafikStatusRegPerTahun2(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikStatusRegPerTahun2.class.getName());
