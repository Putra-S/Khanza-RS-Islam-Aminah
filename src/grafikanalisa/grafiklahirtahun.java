...
public class grafiklahirtahun extends JDialog {
    ...
    public static CategoryDataset createDataset1(String symbol) { // data grafik nilai K
        ...
        try {
            ...
            ResultSet rs = stat
                    .executeQuery("SELECT year(tgl_lahir),count(year(tgl_lahir)) as jumlah  FROM pasien_bayi "
    ...
    private static final Logger LOG = Logger.getLogger(grafiklahirtahun.class.getName());
