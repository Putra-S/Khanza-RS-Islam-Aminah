...
public class GrafikPerbaikanInventarisPerTanggal extends javax.swing.JDialog {
    ...
    public GrafikPerbaikanInventarisPerTanggal(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Tanggal Perbaikan Inventaris",
            "Jumlah Perbaikan Inventaris Per Tanggal", "Persentase Perbaikan Inventaris Per Tanggal(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select DATE_FORMAT(perbaikan_inventaris.tanggal, '%y-%m-%d'),count(DATE_FORMAT(perbaikan_inventaris.tanggal, '%y-%m-%d')) as jumlah "
                    + "from perbaikan_inventaris where tanggal between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' group by DATE_FORMAT(perbaikan_inventaris.tanggal, '%y-%m-%d')").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Perbaikan Inventaris Per Tanggal Tanggal " + Valid.
                        SetTgl(Tanggal1.getSelectedItem() + "") + " S.D. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Tanggal", "Jumlah",
                dcd, PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame("Grafik Perbaikan Inventaris Per Tanggal",
                freeChart);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPerbaikanInventarisPerTanggal.jasper", "report",
                    "::[ Laporan Jumlah Perbaikan Inventaris Per Tanggal ]::",
                    param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikPerbaikanInventarisPerTanggal dialog = new GrafikPerbaikanInventarisPerTanggal(
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPerbaikanInventarisPerTanggal.class.getName());
