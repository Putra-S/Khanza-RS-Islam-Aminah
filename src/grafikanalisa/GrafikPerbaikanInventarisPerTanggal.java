...
public class GrafikPerbaikanInventarisPerTanggal extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public GrafikPerbaikanInventarisPerTanggal(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode = new DefaultTableModel(null, new Object[]{
            "Tanggal Perbaikan Inventaris",
            "Jumlah Perbaikan Inventaris Per Tanggal",
            "Persentase Perbaikan Inventaris Per Tanggal(%)"}) {
            @Override
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikPerbaikanInventarisPerTanggal.class.getName());
}
