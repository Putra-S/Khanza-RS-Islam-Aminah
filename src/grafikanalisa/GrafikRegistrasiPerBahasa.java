...
public class GrafikRegistrasiPerBahasa extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    + "where tgl_registrasi between '" + Valid.SetTgl(Tanggal1.
                            ...
                            Tanggal2.getSelectedItem() + "") + "' group by bahasa_pasien.nama_bahasa").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Registrasi Per Bahasa Tanggal " + Valid.SetTgl(Tanggal1.
                        getSelectedItem() + "") + " S.D. " + Valid.SetTgl(
                        Tanggal2.getSelectedItem() + ""), "Bahasa",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikRegistrasiPerBahasa dialog = new GrafikRegistrasiPerBahasa(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikRegistrasiPerBahasa.class.getName());
