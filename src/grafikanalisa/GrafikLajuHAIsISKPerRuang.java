...
public class GrafikLajuHAIsISKPerRuang extends javax.swing.JDialog {
    ...
    public GrafikLajuHAIsISKPerRuang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Kamar/Bangsal",
            "Jumlah Pasien (Numerator)", "Jumlah Hari (Denumerator)", "Laju ISK",
            "Persentase ISK(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    SetTgl(Tanggal2.getSelectedItem() + "") + "' and data_HAIs.ISK>0 group by bangsal.kd_bangsal").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Laju HAIs ISK Per Ruang Periode " + Valid.SetTgl(
                        Tanggal1.getSelectedItem() + "") + " s.d. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Ruang", "Jumlah", dcd,
                PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame("Grafik Laju HAIs ISK Per Ruang",
                freeChart);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptLajuHAIsISKPerRuang.jasper", "report",
                    "::[ Laporan Laju HAIs ISK Per Ruang ]::", param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikLajuHAIsISKPerRuang dialog = new GrafikLajuHAIsISKPerRuang(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikLajuHAIsISKPerRuang.class.getName());
}
