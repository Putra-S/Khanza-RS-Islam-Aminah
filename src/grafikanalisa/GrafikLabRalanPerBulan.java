...
public class GrafikLabRalanPerBulan extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Kunjungan Lab Rawat Jalan Per Bulan Tanggal " + Valid.
        ...
        ChartFrame cf = new ChartFrame(
                "Grafik Kunjungan Lab Rawat Jalan Per Bulan", freeChart);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikLabRalanPerBulan dialog = new GrafikLabRalanPerBulan(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikLabRalanPerBulan.class.getName());
