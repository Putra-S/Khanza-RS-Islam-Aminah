...
public class GrafikKunjunganRanapPerRuang extends javax.swing.JDialog {
    ...
    public GrafikKunjunganRanapPerRuang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Ruang/Bangsal/Kamar", "Jumlah Kunjungan Ranap Per Ruang",
            "Persentase Kunjungan Ranap Per Ruang(%)"}) {
            @Override
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    + "where reg_periksa.status_lanjut='Ranap' and kamar_inap.stts_pulang<>'Pindah Kamar' and reg_periksa.tgl_registrasi between '" + Valid.
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Kunjungan Ranap Per Ruang Tanggal " + Valid.SetTgl(
                        Tanggal1.getSelectedItem() + "") + " S.D. " + Valid.
                SetTgl(Tanggal2.getSelectedItem() + ""), "Ruang",
                "Jumlah Pasien", dcd, PlotOrientation.VERTICAL, true, true, true);
        ChartFrame cf = new ChartFrame("Grafik Kunjungan Ranap Per Ruang",
                freeChart);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptKunjunganRanapPerRuang.jasper", "report",
                    "::[ Laporan Jumlah Kunjuangan Ranap Per Ruang ]::", param);
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select bangsal.nm_bangsal,count(bangsal.nm_bangsal) as jumlah from reg_periksa inner join kamar_inap inner join kamar inner join bangsal "
                    + "on reg_periksa.no_rawat=kamar_inap.no_rawat and kamar_inap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal and reg_periksa.tgl_registrasi=kamar_inap.tgl_masuk "
                    + "where reg_periksa.status_lanjut='Ranap' and kamar_inap.stts_pulang<>'Pindah Kamar' and reg_periksa.tgl_registrasi between '"
                    + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' and '"
                    + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' " + "group by bangsal.nm_bangsal");
            try {
                rs = ps.executeQuery();
                total = 0;
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(GrafikKunjunganRanapPerRuang.class.getName());
