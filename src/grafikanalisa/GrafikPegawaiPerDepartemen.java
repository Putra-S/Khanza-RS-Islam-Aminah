...
public class GrafikPegawaiPerDepartemen extends javax.swing.JDialog {
    ...
    public GrafikPegawaiPerDepartemen(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Departemen Pegawai", "Jumlah", "Persentase(%)",
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createBarChart(
                            "Grafik Pegawai Per Departemen", "Departemen",
                            "Jumlah Pegawai", dcd, PlotOrientation.VERTICAL,
                            true, true, true);
                    ChartFrame cf = new ChartFrame(
                            "Grafik Pegawai Per Departemen", freeChart);
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select departemen.dep_id,count(departemen.dep_id) as jumlah,departemen.nama from pegawai inner join departemen "
                                + "on departemen.dep_id=pegawai.departemen where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by departemen.dep_id").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Departemen", freeChart2);
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    try {
                        rs = koneksi.prepareStatement(
                                "select departemen.dep_id,count(departemen.dep_id) as jumlah,departemen.nama from pegawai inner join departemen "
                                + "on departemen.dep_id=pegawai.departemen where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') group by departemen.dep_id").
                                executeQuery();
                        while (rs.next()) {
                    ...
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Departemen", freeChart3);
            ...
            switch (pilihan) {
                case "Jumlah Pegawai":
                    ...
                    JFreeChart freeChart = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Departemen", dpd, true, true,
                ...
                case "Jumlah Pegawai Laki-Laki":
                    ...
                    JFreeChart freeChart2 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Departemen", dpd2, true, true,
                            false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf2 = new ChartFrame(
                            "Grafik Pegawai Per Departemen", freeChart2);
                    cf2.setSize(Scroll.getWidth(), Scroll.getHeight());
                ...
                case "Jumlah Pegawai Perempuan":
                    ...
                    JFreeChart freeChart3 = ChartFactory.createPieChart(
                            "Grafik Pegawai Per Departemen", dpd3, true, true,
                            false); //String title,PieDatasheet datasheet,boolean legends,boolean tooltips,boolean url 
                    ChartFrame cf3 = new ChartFrame(
                            "Grafik Pegawai Per Departemen", freeChart3);
                    cf3.setSize(Scroll.getWidth(), Scroll.getHeight());
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptPegawaiPerDepartemen.jasper", "report",
                    "::[ Laporan Jumlah Pegawai Per Departemen ]::", param);
        }
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    jmll = Sequel.cariInteger(
                            "select count(departemen.dep_id) as jumlah,departemen.nama from pegawai inner join departemen "
                            + "on departemen.dep_id=pegawai.departemen where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and departemen.dep_id=?",
                            rs.getString(1));
                    jmlp = Sequel.cariInteger(
                            "select count(departemen.dep_id) as jumlah,departemen.nama from pegawai inner join departemen "
                            + "on departemen.dep_id=pegawai.departemen where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and departemen.dep_id=?",
                            rs.getString(1));
                    totall += jmll;
                    totalp += jmlp;
    ...
    private static final Logger LOG = Logger.getLogger(GrafikPegawaiPerDepartemen.class.getName());
