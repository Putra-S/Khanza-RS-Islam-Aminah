...
public class GrafikStatusBatalRegPerTahun extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Status Batal Periksa Per Tahun Tanggal " + Valid.SetTgl(
        ...
        ChartFrame cf = new ChartFrame("Grafik Status Batal Periksa Per Tahun",
                freeChart);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikStatusBatalRegPerTahun dialog = new GrafikStatusBatalRegPerTahun(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikStatusBatalRegPerTahun.class.getName());
