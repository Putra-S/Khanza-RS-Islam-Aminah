...
public class GrafikTBTipeDiagnosis extends javax.swing.JDialog {
    ...
    private void BtnPrint3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint3ActionPerformed
        ...
        try {
            rs = koneksi.prepareStatement(
                    "select tipe_diagnosis,count(tipe_diagnosis) as jumlah "
                    + "from data_tb where tanggal_buat_laporan between '" + Valid.
                            SetTgl(Tanggal1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                    SetTgl(Tanggal2.getSelectedItem() + "") + " 23:59:59' group by tipe_diagnosis").
                    executeQuery();
            while (rs.next()) {
        ...
        JFreeChart freeChart = ChartFactory.createBarChart(
                "Grafik Tipe Diagnosis TB Tanggal " + Valid.SetTgl(Tanggal1.
                        getSelectedItem() + "") + " S.D. " + Valid.SetTgl(
                        Tanggal2.getSelectedItem() + ""), "Tipe Diagnosis",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            GrafikTBTipeDiagnosis dialog = new GrafikTBTipeDiagnosis(
    ...
    private static final Logger LOG = Logger.getLogger(
            GrafikTBTipeDiagnosis.class.getName());
