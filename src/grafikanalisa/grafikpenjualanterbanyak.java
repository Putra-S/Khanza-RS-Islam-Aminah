...
public class grafikpenjualanterbanyak extends JDialog {
    ...
    public static CategoryDataset createDataset1(String symbol) { // data grafik nilai K
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + symbol + " group by databarang.nama_brng order by sum(detailjual.jumlah) desc limit 10");
            try {
                rs = ps.executeQuery();
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(grafikpenjualanterbanyak.class.getName());
