 ...
 * @author dosen
 */
public class SuratKlasifikasi extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("surat_klasifikasi", "?,?", "Kode", 2,
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbBangsal.getRowCount(); i++) {
            if (tbBangsal.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("surat_klasifikasi", "kd", tbBangsal.getValueAt(
                        i, 1).toString());
            }
        }
        tampil();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbBangsal.getSelectedRow() > -1) {
                Sequel.mengedit("surat_klasifikasi", "kd=?",
                        "klasifikasi=?,kd=?", 3, new String[]{TNm.getText(),
                            TKd.getText(), tbBangsal.getValueAt(tbBangsal.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptSuratKlasifikasi.jasper", param,
                    "::[ Laporan Klasifikasi Surat ]::");
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratKlasifikasi dialog = new SuratKlasifikasi(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from surat_klasifikasi where kd like ? "
    ...
    private static final Logger LOG = Logger.getLogger(SuratKlasifikasi.class.
            getName());
}
