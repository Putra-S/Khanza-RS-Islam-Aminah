...
public class SuratKlasifikasi extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from surat_klasifikasi where kd like ? " + "or klasifikasi like ? order by kd");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(SuratKlasifikasi.class.getName());
