...
public class MasterTemplatePersetujuanPenolakanTindakan extends javax.swing.JDialog {
    ...
    public MasterTemplatePersetujuanPenolakanTindakan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Template", "Diagnosa", "Tindakan Kedokteran", "Indikasi Tindakan", "Tata Cara",
                    "Tujuan", "Risiko", "Komplikasi", "Prognosis", "Alternatif & Resikonya", "Lain-lain",
                    "Biaya"}) {
            @Override
...
//GEN-FIRST:event_TKdKeyPressed
    private void KdKeyPressed(java.awt.event.KeyEvent evt) {//GEN-LAST:event_TKdKeyPressed
        Valid.pindah(evt, TCari, Biaya);//GEN-FIRST:event_KdKeyPressed
    ...
    private static final Logger LOG = Logger.getLogger(MasterTemplatePersetujuanPenolakanTindakan.class.getName());
