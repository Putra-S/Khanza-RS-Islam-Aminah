...
public class SuratKeteranganCovid extends javax.swing.JDialog {
    ...
    public SuratKeteranganCovid(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Surat", "No.Rawat", "No.R.M.", "Nama Pasien", "Kode Dokter",
                    "Dokter Penanggung Jawab", "NIP", "Petugas", "Rapid Test IgM", "Rapid Test IgG", "S", "TS",
                    "Berlaku", "Sampai"}) {
            @Override
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    : "and (surat_keterangan_covid.no_surat like ? or dokter.nm_dokter like ? or pasien.no_rkm_medis like ? or "
                    + "pasien.nm_pasien like ? or petugas.nama like ? or surat_keterangan_covid.no_rawat like ?)")
                    + " order by surat_keterangan_covid.no_surat");
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_surat"), rs.getString("no_rawat"),
                        ...
                        rs.getString("nm_dokter"), rs.getString("nip"), rs.getString("nama"), rs.getString("igm"),
                        rs.getString("igg"), rs.getString("sehat"), rs.getString("tidaksehat"),
                        rs.getString("berlakumulai"), rs.getString("berlakuselsai")});
                }
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(no_surat,3),signed)),0) from surat_keterangan_covid where berlakumulai='"
                + Valid.SetTgl(TanggalAwal.getSelectedItem() + "") + "' ",
                "SKRT" + TanggalAwal.getSelectedItem().toString().substring(6, 10)
    ...
    private static final Logger LOG = Logger.getLogger(SuratKeteranganCovid.class.getName());
