...
public class SuratCutiHamil extends javax.swing.JDialog {
    ...
    public SuratCutiHamil(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "No.Surat", "No.Rawat", "No.R.M.", "Nama Pasien", "Pekerjaan",
            "Tgl.Periksa", "Dalam Keadaan Hamil", "Mulai Cuti", "Taksiran Lahir",
        ...
        KeadaanPasien.setDocument(new batasInput((byte) 25).getKata(
                KeadaanPasien));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratCutiHamil dialog = new SuratCutiHamil(new javax.swing.JFrame(),
                    true);
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(surat_cuti_hamil.no_surat,3),signed)),0) from surat_cuti_hamil inner join reg_periksa on surat_cuti_hamil.no_rawat=reg_periksa.no_rawat where reg_periksa.tgl_registrasi='" + Valid.
                        SetTgl(MulaiCuti.getSelectedItem() + "") + "' ",
                "SCH" + MulaiCuti.getSelectedItem().toString().substring(6, 10) + MulaiCuti.
                getSelectedItem().toString().substring(3, 5) + MulaiCuti.
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            TPasien.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 3).
                    toString());
            KeadaanPasien.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 6).
                    toString());
            Valid.SetTgl(MulaiCuti, tbObat.
                    getValueAt(tbObat.getSelectedRow(), 7).toString());
            Valid.SetTgl(TaksiranLahir, tbObat.getValueAt(tbObat.
    ...
    private static final Logger LOG = Logger.getLogger(SuratCutiHamil.class.
            getName());
}
