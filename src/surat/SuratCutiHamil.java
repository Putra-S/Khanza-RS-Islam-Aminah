 ...
 * @author salimmulyana
 */
public class SuratCutiHamil extends javax.swing.JDialog {
    ...
    public SuratCutiHamil(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Surat", "No.Rawat", "No.R.M.", "Nama Pasien", "Pekerjaan", "Tgl.Periksa",
                    "Dalam Keadaan Hamil", "Mulai Cuti", "Taksiran Lahir", "Kode Dokter", "Nama Dokter"}) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (KeadaanPasien.getText().trim().isEmpty()) {
            Valid.textKosong(TNoRw, "Dalam Keadaan Hamil");
        } else {
            if (Sequel.menyimpantf("surat_cuti_hamil", "?,?,?,?,?", "No.Surat",
                    5, new String[]{
                        TNoRw.getText(), KeadaanPasien.getText(), Valid.SetTgl(
                        MulaiCuti.getSelectedItem() + ""), Valid.SetTgl(
                        TaksiranLahir.getSelectedItem() + ""), NoSurat.getText(),}) == true) {
                tampil();
                emptTeks();
            }
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (NoSurat.getText().trim().isEmpty()) {
            ...
            if (tbObat.getSelectedRow() != -1) {
                if (Sequel.mengedittf("surat_cuti_hamil", "no_surat=?",
                        "no_rawat=?,keterangan_hamil=?,terhitung_mulai=?,perkiraan_lahir=?,no_surat=?",
                        6, new String[]{
                            TNoRw.getText(), KeadaanPasien.getText(), Valid.
                            SetTgl(MulaiCuti.getSelectedItem() + ""), Valid.
                            SetTgl(TaksiranLahir.getSelectedItem() + ""),
                            NoSurat.getText(), tbObat.getValueAt(tbObat.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            tgl = " reg_periksa.tgl_registrasi between '" + Valid.SetTgl(
                    DTPCari1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                    DTPCari2.getSelectedItem() + "") + "' ";
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptDataSuratCutiHamil.jasper", "report",
                        "::[ Data Surat Cuti Hamil ]::",
                ...
                Valid.MyReportqry("rptDataSuratCutiHamil.jasper", "report",
                        ...
                        + "where " + tgl + "and (no_surat like '%" + TCari.
                                getText().trim() + "%' or surat_cuti_hamil.no_rawat like '%" + TCari.
                                getText().trim() + "%' or "
                        + "reg_periksa.no_rkm_medis like '%" + TCari.getText().
                                trim() + "%' or pasien.nm_pasien like '%" + TCari.
                                getText().trim() + "%' or "
                        + "reg_periksa.tgl_registrasi like '%" + TCari.getText().
                                trim() + "%') "
    ...
    private void MnCetakSuratHamilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratHamilActionPerformed
        if (TPasien.getText().trim().isEmpty()) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptSuratCutiHamil.jasper", "report",
                    "::[ Surat Cuti Hamil ]::",
    ...
    public void tampil() {
        ...
        try {
            tgl = " reg_periksa.tgl_registrasi between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + "' and '"
            ...
            if (TCari.getText().trim().isEmpty()) {
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "%' or surat_cuti_hamil.no_rawat like '%" + TCari.getText().trim() + "%' or "
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(surat_cuti_hamil.no_surat,3),signed)),0) from surat_cuti_hamil inner join reg_periksa on surat_cuti_hamil.no_rawat=reg_periksa.no_rawat where reg_periksa.tgl_registrasi='"
                + Valid.SetTgl(MulaiCuti.getSelectedItem() + "") + "' ",
                "SCH" + MulaiCuti.getSelectedItem().toString().substring(6, 10)
                + MulaiCuti.getSelectedItem().toString().substring(3, 5)
                + MulaiCuti.getSelectedItem().toString().substring(0, 2),
                3, NoSurat);
    ...
    private static final Logger LOG = Logger.getLogger(SuratCutiHamil.class.getName());
