...
public class SuratIndeks extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select * from surat_indeks where kd like ? " + "or indeks like ? order by kd");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(SuratIndeks.class.getName());
