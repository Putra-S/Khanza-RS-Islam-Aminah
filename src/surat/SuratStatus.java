...
public class SuratStatus extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select * from surat_status where kd like ? " + "or status like ? order by kd");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(SuratStatus.class.getName());
