...
public class SuratPernyataanPasienUmum extends javax.swing.JDialog {
    ...
    public SuratPernyataanPasienUmum(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "J.K.", "Tgl.Lahir", "Tanggal", "Nama Penanggung Jawab",
            "Tempat Lahir P.J.", "Tgl.Lahir P.J.", "Hubungan", "J.K. P.J.",
            "Nomor Telp/HP", "Nomor KTP", "Alamat P.J.", "NIP", "Nama Petugas"
        }) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().trim().isEmpty() || TPasien.getText().trim().
        ...
        } else if (TempatLahir.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("surat_pernyataan_pasien_umum",
                    "?,?,?,?,?,?,?,?,?,?,?,?", "Data", 12, new String[]{
                        NoSurat.getText(), TNoRw.getText(), Valid.SetTgl(
                        Tanggal.getSelectedItem() + ""), NamaPJ.getText(),
                        NoKTP.getText(),
                        TempatLahir.getText(), Valid.SetTgl(TglLahir.
                        getSelectedItem() + ""), JKPJ.getSelectedItem().
                                toString().substring(0, 1),
                        AlamatPj.getText(), Hubungan.getSelectedItem().
                        toString(), NoTelp.getText(), NIP.getText()
                    }) == true) {
                tabMode.addRow(new String[]{
                    ...
                    getText(), TempatLahir.getText(), Valid.SetTgl(TglLahir.
                    getSelectedItem() + ""),
                    Hubungan.getSelectedItem().toString(), JKPJ.
                    getSelectedItem().toString().substring(0, 1), NoTelp.
                    getText(), NoKTP.getText(),
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptDataFormulirPernyataanPasienUmum.jasper",
                        "report", "::[ Data Formulir Pernyataan Pasien Umum ]::",
                        ...
                        + "surat_pernyataan_pasien_umum.tanggal between '" + Valid.
                                SetTgl(DTPCari1.getSelectedItem() + "") + "' and '" + Valid.
                        SetTgl(DTPCari2.getSelectedItem() + "") + "' order by surat_pernyataan_pasien_umum.tanggal",
                        param);
            } else {
                Valid.MyReportqry("rptDataFormulirPernyataanPasienUmum.jasper",
                        "report", "::[ Data Formulir Pernyataan Pasien Umum ]::",
                        ...
                        + "(reg_periksa.no_rawat like '%" + TCari.getText().
                                trim() + "%' or pasien.no_rkm_medis like '%" + TCari.
                                getText().trim() + "%' or pasien.nm_pasien like '%" + TCari.
                                getText().trim() + "%' or "
                        + "surat_pernyataan_pasien_umum.alamatpj like '%" + TCari.
                                getText().trim() + "%' or surat_pernyataan_pasien_umum.nama_pj like '%" + TCari.
                                getText().trim() + "%' or "
                        + "surat_pernyataan_pasien_umum.nip like '%" + TCari.
    ...
    private void btnAmbilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbObat.getSelectedRow() > -1) {
                ...
                Sequel.queryu(
                        "insert into antripernyataanumum values('" + tbObat.
                                getValueAt(tbObat.getSelectedRow(), 0).
                                toString() + "','" + tbObat.getValueAt(tbObat.
                                getSelectedRow(), 1).toString() + "')");
                Sequel.queryu(
                        "delete from surat_pernyataan_pasien_umum_pembuat_pernyataan where no_surat='" + tbObat.
                                getValueAt(tbObat.getSelectedRow(), 0).
                                toString() + "'");
            } else {
                JOptionPane.showMessageDialog(rootPane,
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            if (lokasifile.isEmpty()) {
                JOptionPane.showMessageDialog(null,
                        "Maaf, Silahkan ambil photo bukti pernyataan pasien umum terlebih dahulu..!!!!");
            } else {
                Map<String, Object> param = new HashMap<>();
                param.put("namars", akses.getnamars());
                param.put("alamatrs", akses.getalamatrs());
                ...
                param.put("photo",
                        ...
                        PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/pernyataanumum/" + lokasifile);
                ...
                param.put("finger",
                        ...
                        getkabupatenrs() + "\nDitandatangani secara elektronik oleh " + tbObat.
                                getValueAt(tbObat.getSelectedRow(), 17).
                                toString() + "\nID " + (finger.isEmpty() ? tbObat.
                        getValueAt(tbObat.getSelectedRow(), 16).toString() : finger) + "\n" + Valid.
                        SetTgl3(tbObat.getValueAt(tbObat.getSelectedRow(), 7).
                                toString()));
                Valid.MyReportqry("rptSuratPernyataanPasienUmum.jasper",
                        "report", "::[ Surat Pernyataan Pasien Umum ]::",
                        ...
                        + "where surat_pernyataan_pasien_umum.no_surat='" + tbObat.
                                getValueAt(tbObat.getSelectedRow(), 0).
                                toString() + "'", param);
            }
        } else {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratPernyataanPasienUmum dialog = new SuratPernyataanPasienUmum(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        getString("tempat_lahirpj"), rs.getString("lahirpj"),
                        rs.getString("hubungan"), rs.getString("jkpj"), rs.
                        getString("no_telp"), rs.getString("no_ktppj"),
                        rs.getString("alamatpj"), rs.getString("nip"), rs.
                        getString("nama")
                    });
                }
    ...
    public void emptTeks() {
        ...
        AlamatPj.setText("");
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(surat_pernyataan_pasien_umum.no_surat,3),signed)),0) from surat_pernyataan_pasien_umum where surat_pernyataan_pasien_umum.tanggal='" + Valid.
                        SetTgl(Tanggal.getSelectedItem() + "") + "' ",
                "PPU" + Tanggal.getSelectedItem().toString().substring(6, 10) + Tanggal.
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            NamaPJ.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 8).
                    toString());
            TempatLahir.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 9).
                    toString());
            ...
            JKPJ.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(), 12).
                    ...
                    "Perempuan"));
            NoTelp.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 13).
                    toString());
            NoKTP.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 14).
                    toString());
            AlamatPj.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 15).
                    toString());
    ...
    private void ganti() {
        if (Sequel.mengedittf("surat_pernyataan_pasien_umum", "no_surat=?",
                "no_surat=?,no_rawat=?,tanggal=?,nama_pj=?,no_ktppj=?,tempat_lahirpj=?,lahirpj=?,jkpj=?,alamatpj=?,hubungan=?,no_telp=?,nip=?",
                13, new String[]{
                    NoSurat.getText(), TNoRw.getText(), Valid.SetTgl(Tanggal.
                    getSelectedItem() + ""), NamaPJ.getText(), NoKTP.getText(),
                    TempatLahir.getText(), Valid.SetTgl(TglLahir.
                    getSelectedItem() + ""), JKPJ.getSelectedItem().toString().
                            substring(0, 1),
                    AlamatPj.getText(), Hubungan.getSelectedItem().toString(),
                    NoTelp.getText(), NIP.getText(), tbObat.getValueAt(tbObat.
    ...
    private void hapus() {
        if (Sequel.queryu2tf(
                "delete from surat_pernyataan_pasien_umum where no_surat=?", 1,
                new String[]{
    ...
    private void panggilPhoto() {
        if (FormPhoto.isVisible() == true) {
            ...
            try {
                ps = koneksi.prepareStatement(
                        "select surat_pernyataan_pasien_umum_pembuat_pernyataan.photo from surat_pernyataan_pasien_umum_pembuat_pernyataan where surat_pernyataan_pasien_umum_pembuat_pernyataan.no_surat=?");
                try {
    ...
    private static final Logger LOG = Logger.getLogger(
            SuratPernyataanPasienUmum.class.getName());
}
