...
public class SuratKeteranganBebasTBC extends javax.swing.JDialog {
    ...
    public SuratKeteranganBebasTBC(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "No.Surat", "No.Rawat", "No.R.M.", "Nama Pasien", "Tanggal",
            "Kode Dokter", "Dokter", "Keperluan"
        }) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratKeteranganBebasTBC dialog = new SuratKeteranganBebasTBC(
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(surat_bebas_tbc.no_surat,3),signed)),0) from surat_bebas_tbc where surat_bebas_tbc.tanggalsurat='" + Valid.
                        SetTgl(TanggalSurat.getSelectedItem() + "") + "' ",
                "STBC" + TanggalSurat.getSelectedItem().toString().substring(6,
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            KdDok.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 5).
                    toString());
            TDokter.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 6).
                    toString());
            Keperluan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 7).
                    toString());
        }
    }
    ...
    private static final Logger LOG = Logger.getLogger(
            SuratKeteranganBebasTBC.class.getName());
}
