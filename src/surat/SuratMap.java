 ...
 * @author dosen
 */
public class SuratMap extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("surat_map", "?,?", "Kode", 2, new String[]{
                TKd.getText(), TNm.getText()}) == true) {
                tampil();
                emptTeks();
            } else {
                TKd.requestFocus();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbBangsal.getRowCount(); i++) {
            if (tbBangsal.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("surat_map", "kd", tbBangsal.getValueAt(i, 1).
                        toString());
            }
        }
        tampil();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbBangsal.getSelectedRow() > -1) {
                Sequel.mengedit("surat_map", "kd=?", "map=?,kd=?", 3,
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptSuratMap.jasper", param,
                    "::[ Laporan Map Surat ]::");
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from surat_map where kd like ? "
                    + "or map like ? order by kd");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(SuratMap.class.getName());
}
