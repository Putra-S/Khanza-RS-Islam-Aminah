...
public class MasterMenolakAnjuranMedis extends javax.swing.JDialog {
    ...
    public MasterMenolakAnjuranMedis(java.awt.Frame parent, boolean modal) {
        ...
        TNm.setDocument(new batasInput(40).getKata(TNm));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("master_menolak_anjuran_medis", "'" + TKd.
                    getText() + "','" + TNm.getText() + "'", "Kode") == true) {
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, TKd, "master_menolak_anjuran_medis",
                "kode_penolakan") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                if (Sequel.mengedittf("master_menolak_anjuran_medis",
                        "kode_penolakan=?", "kode_penolakan=?,nama_penolakan=?",
                        3, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterMenolakAnjuranMedis dialog = new MasterMenolakAnjuranMedis(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from master_menolak_anjuran_medis where master_menolak_anjuran_medis.kode_penolakan like ? or master_menolak_anjuran_medis.nama_penolakan like ? order by master_menolak_anjuran_medis.kode_penolakan");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(
            MasterMenolakAnjuranMedis.class.getName());
}
