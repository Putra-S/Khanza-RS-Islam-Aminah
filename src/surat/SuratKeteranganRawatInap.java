 ...
 * @author salimmulyana
 */
public class SuratKeteranganRawatInap extends javax.swing.JDialog {
    ...
    public SuratKeteranganRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Surat", "No.Rawat", "No.R.M.", "Nama Pasien", "Dari Tanggal", "Sampai Tanggal"}) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (NoSurat.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("surat_keterangan_rawat_inap", "?,?,?,?",
                    "No.Surat", 4, new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, NoSurat, "surat_keterangan_rawat_inap",
                "no_surat") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (NoSurat.getText().trim().isEmpty()) {
            ...
            if (tbObat.getSelectedRow() != -1) {
                if (Sequel.mengedittf("surat_keterangan_rawat_inap",
                        "no_surat=?",
                        "no_surat=?,no_rawat=?,tanggalawal=?,tanggalakhir=?", 5,
                        new String[]{
                            NoSurat.getText(), TNoRw.getText(), Valid.SetTgl(
                            TanggalAwal.getSelectedItem() + ""), Valid.SetTgl(
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            tgl = " surat_keterangan_rawat_inap.tanggalawal between '" + Valid.
                    SetTgl(DTPCari1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(DTPCari2.getSelectedItem() + "") + "' ";
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptDataSuratKeteranganRawatInap.jasper",
                        "report", "::[ Data Surat Keterangan Rawat Inap ]::",
                ...
                Valid.MyReportqry("rptDataSuratKeteranganRawatInap.jasper",
                        ...
                        + "where " + tgl + "and no_surat like '%" + TCari.
                                getText().trim() + "%' or "
                        + tgl + "and surat_keterangan_rawat_inap.no_rawat like '%" + TCari.
                                getText().trim() + "%' or "
                        + tgl + "and reg_periksa.no_rkm_medis like '%" + TCari.
                                getText().trim() + "%' or "
                        + tgl + "and pasien.nm_pasien like '%" + TCari.getText().
                                trim() + "%' or "
                        + tgl + "and surat_keterangan_rawat_inap.tanggalawal like '%" + TCari.
                                getText().trim() + "%' or "
                        + tgl + "and surat_keterangan_rawat_inap.tanggalakhir like '%" + TCari.
                                getText().trim() + "%' "
    ...
    private void MnCetakSuratRawatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratRawatActionPerformed
        if (TPasien.getText().trim().isEmpty()) {
            ...
            param.put("dokter", Sequel.cariIsi(
                    "select nm_dokter from dokter inner join dpjp_ranap on dpjp_ranap.kd_dokter=dokter.kd_dokter where dpjp_ranap.no_rawat=?",
                    TNoRw.getText()));
            param.put("namars", akses.getnamars());
            param.put("alamatrs", akses.getalamatrs());
            param.put("kotars", akses.getkabupatenrs());
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptSuratKeteranganRawatInap.jasper", "report",
    ...
    public void tampil() {
        ...
        try {
            tgl = " surat_keterangan_rawat_inap.tanggalawal between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "")
            ...
            if (TCari.getText().trim().isEmpty()) {
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "and surat_keterangan_rawat_inap.no_rawat like '%" + TCari.getText().trim() + "%' or "
                        + tgl + "and reg_periksa.no_rkm_medis like '%" + TCari.getText().trim() + "%' or " + tgl
                        + "and pasien.nm_pasien like '%" + TCari.getText().trim() + "%' or " + tgl
                        + "and surat_keterangan_rawat_inap.tanggalawal like '%" + TCari.getText().trim()
                        + "%' or " + tgl + "and surat_keterangan_rawat_inap.tanggalakhir like '%"
                        + TCari.getText().trim() + "%' " + "order by surat_keterangan_rawat_inap.no_surat");
            }
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(surat_keterangan_rawat_inap.no_surat,3),signed)),0) from surat_keterangan_rawat_inap where surat_keterangan_rawat_inap.tanggalawal='"
                + Valid.SetTgl(TanggalAwal.getSelectedItem() + "") + "' ",
                "SKR" + TanggalAwal.getSelectedItem().toString().substring(6, 10)
    ...
    private static final Logger LOG = Logger.getLogger(SuratKeteranganRawatInap.class.getName());
