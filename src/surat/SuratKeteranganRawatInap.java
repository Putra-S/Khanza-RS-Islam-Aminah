...
public class SuratKeteranganRawatInap extends javax.swing.JDialog {
    ...
    public SuratKeteranganRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "No.Surat", "No.Rawat", "No.R.M.", "Nama Pasien", "Dari Tanggal",
            "Sampai Tanggal"
        }) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratKeteranganRawatInap dialog = new SuratKeteranganRawatInap(
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(surat_keterangan_rawat_inap.no_surat,3),signed)),0) from surat_keterangan_rawat_inap where surat_keterangan_rawat_inap.tanggalawal='" + Valid.
                        SetTgl(TanggalAwal.getSelectedItem() + "") + "' ",
                "SKR" + TanggalAwal.getSelectedItem().toString().
    ...
    private static final Logger LOG = Logger.getLogger(
            SuratKeteranganRawatInap.class.getName());
}
