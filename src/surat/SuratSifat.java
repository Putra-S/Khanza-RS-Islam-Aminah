...
public class SuratSifat extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select * from surat_sifat where kd like ? " + "or sifat like ? order by kd");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(SuratSifat.class.getName());
