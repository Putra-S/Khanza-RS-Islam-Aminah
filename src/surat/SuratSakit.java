 ...
 * @author salimmulyana
 */
public class SuratSakit extends javax.swing.JDialog {
    ...
    public SuratSakit(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.Surat Sakit", "No.Rawat", "No.R.M.", "Nama Pasien",
            "Dari Tanggal", "Sampai Tanggal", "Lama Sakit"}) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (NoSurat.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("suratsakit", "?,?,?,?,?", "No.Surat Sakit",
                    5, new String[]{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (NoSurat.getText().trim().isEmpty()) {
            ...
            if (tbObat.getSelectedRow() != -1) {
                if (Sequel.mengedittf("suratsakit", "no_surat=?",
                        "no_surat=?,no_rawat=?,tanggalawal=?,tanggalakhir=?,lamasakit=?",
                        6, new String[]{
                            NoSurat.getText(), TNoRw.getText(), Valid.SetTgl(
                            TanggalAwal.getSelectedItem() + ""), Valid.SetTgl(
                            TanggalAkhir.getSelectedItem() + ""), LamaSakit.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            tgl = " suratsakit.tanggalawal between '" + Valid.SetTgl(DTPCari1.
                    getSelectedItem() + "") + "' and '" + Valid.SetTgl(DTPCari2.
                            getSelectedItem() + "") + "' ";
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptDataSuratSakit.jasper", "report",
                        "::[ Data Surat Sakit Pasien ]::",
                ...
                Valid.MyReportqry("rptDataSuratSakit.jasper", "report",
                        ...
                        + "where " + tgl + "and no_surat like '%" + TCari.
                                getText().trim() + "%' or "
                        + tgl + "and suratsakit.no_rawat like '%" + TCari.
                                getText().trim() + "%' or "
                        + tgl + "and reg_periksa.no_rkm_medis like '%" + TCari.
                                getText().trim() + "%' or "
                        + tgl + "and pasien.nm_pasien like '%" + TCari.getText().
                                trim() + "%' or "
                        + tgl + "and suratsakit.tanggalawal like '%" + TCari.
                                getText().trim() + "%' or "
                        + tgl + "and suratsakit.tanggalakhir like '%" + TCari.
                                getText().trim() + "%' "
    ...
    private void MnCetakSuratSakitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSakitActionPerformed
        if (TPasien.getText().trim().isEmpty()) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptSuratSakit5.jasper", "report",
                    "::[ Surat Sakit ]::",
        ...
        if (TPasien.getText().trim().isEmpty()) {
            ...
            param.put("finger",
                    ...
                    getkabupatenrs() + "\nDitandatangani secara elektronik oleh " + namadokter + "\nID " + (finger.
                            ...
                            cariIsi("select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y') from reg_periksa where reg_periksa.no_rawat=?",
                                    TNoRw.getText()));
            Valid.MyReportqry("rptSuratSakit7.jasper", "report",
                    "::[ Surat Sakit ]::",
        ...
        if (TPasien.getText().trim().isEmpty()) {
            ...
            param.put("finger",
                    ...
                    getkabupatenrs() + "\nDitandatangani secara elektronik oleh " + namadokter + "\nID " + (finger.
                            ...
                            cariIsi("select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y') from reg_periksa where reg_periksa.no_rawat=?",
                                    TNoRw.getText()));
            Valid.MyReportqry("rptSuratSakit.jasper", "report",
                    "::[ Surat Sakit ]::",
        ...
        if (TPasien.getText().trim().isEmpty()) {
            ...
            param.put("finger",
                    ...
                    getkabupatenrs() + "\nDitandatangani secara elektronik oleh " + namadokter + "\nID " + (finger.
                            ...
                            cariIsi("select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y') from reg_periksa where reg_periksa.no_rawat=?",
                                    TNoRw.getText()));
            Valid.MyReportqry("rptSuratSakit3.jasper", "report",
                    "::[ Surat Sakit ]::",
        ...
        if (TPasien.getText().trim().isEmpty()) {
            ...
            param.put("finger",
                    ...
                    getkabupatenrs() + "\nDitandatangani secara elektronik oleh " + namadokter + "\nID " + (finger.
                            ...
                            cariIsi("select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y') from reg_periksa where reg_periksa.no_rawat=?",
                                    TNoRw.getText()));
            Valid.MyReportqry("rptSuratSakit4.jasper", "report",
                    "::[ Surat Sakit ]::",
    ...
    public void tampil() {
        ...
        try {
            tgl = " suratsakit.tanggalawal between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + "' and '"
            ...
            if (TCari.getText().trim().isEmpty()) {
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "and suratsakit.no_rawat like '%" + TCari.getText().trim() + "%' or " + tgl
                        + "and reg_periksa.no_rkm_medis like '%" + TCari.getText().trim() + "%' or " + tgl
                        + "and pasien.nm_pasien like '%" + TCari.getText().trim() + "%' or " + tgl
                        + "and suratsakit.tanggalawal like '%" + TCari.getText().trim() + "%' or " + tgl
                        + "and suratsakit.tanggalakhir like '%" + TCari.getText().trim() + "%' "
                        + "order by suratsakit.no_surat");
            }
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(suratsakit.no_surat,3),signed)),0) from suratsakit where suratsakit.tanggalawal='"
                + Valid.SetTgl(TanggalAwal.getSelectedItem() + "") + "' ",
                "SKS" + TanggalAwal.getSelectedItem().toString().substring(6, 10)
    ...
    private static final Logger LOG = Logger.getLogger(SuratSakit.class.getName());
