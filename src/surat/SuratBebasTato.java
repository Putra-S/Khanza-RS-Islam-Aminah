...
public class SuratBebasTato extends javax.swing.JDialog {
    ...
    public SuratBebasTato(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Hasil Pemeriksaan", "Kode Dokter", "Nama Dokter", "Keperluan"
        }) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratBebasTato dialog = new SuratBebasTato(new javax.swing.JFrame(),
                    true);
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(surat_bebas_tato.no_surat,3),signed)),0) from surat_bebas_tato where surat_bebas_tato.tanggalperiksa='" + Valid.
                        SetTgl(TanggalPeriksa.getSelectedItem() + "") + "' ",
                "SBT" + TanggalPeriksa.getSelectedItem().toString().substring(6,
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            HasilPeriksa.setSelectedItem(tbObat.getValueAt(tbObat.
    ...
    private static final Logger LOG = Logger.getLogger(SuratBebasTato.class.
            getName());
}
