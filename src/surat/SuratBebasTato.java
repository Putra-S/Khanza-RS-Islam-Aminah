 ...
 * @author salimmulyana
 */
public class SuratBebasTato extends javax.swing.JDialog {
    ...
    public SuratBebasTato(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.Surat", "No.Rawat", "No.R.M.", "Nama Pasien",
            "Tgl.Periksa", "Hasil Pemeriksaan", "Kode Dokter", "Nama Dokter", "Keperluan"}) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (NoSurat.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("surat_bebas_tato", "?,?,?,?,?", "No.Surat",
                    5, new String[]{
                        NoSurat.getText(), TNoRw.getText(), Valid.SetTgl(
                        TanggalPeriksa.getSelectedItem() + ""), HasilPeriksa.
                        getSelectedItem() + "", Keperluan.getText()
                    }) == true) {
                tampil();
                emptTeks();
            }
        ...
        if (NoSurat.getText().trim().isEmpty()) {
            ...
            if (tbObat.getSelectedRow() != -1) {
                if (Sequel.mengedittf("surat_bebas_tato", "no_surat=?",
                    ...
                    tbObat.setValueAt(HasilPeriksa.getSelectedItem().toString(),
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            tgl = " surat_bebas_tato.tanggalperiksa between '" + Valid.SetTgl(
                    DTPCari1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                    DTPCari2.getSelectedItem() + "") + "' ";
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptDataSuratBebasTato.jasper", "report",
                        "::[ Data Surat Keterangan Bebas Tato ]::",
                ...
                Valid.MyReportqry("rptDataSuratBebasTato.jasper", "report",
                        ...
                        + "where " + tgl + "and (no_surat like '%" + TCari.
                                getText().trim() + "%' or surat_bebas_tato.no_rawat like '%" + TCari.
                                getText().trim() + "%' or "
                        + "reg_periksa.no_rkm_medis like '%" + TCari.getText().
                                trim() + "%' or  pasien.nm_pasien like '%" + TCari.
                                getText().trim() + "%' or "
                        + "surat_bebas_tato.tanggalperiksa like '%" + TCari.
                                getText().trim() + "%' or surat_bebas_tato.keperluan like '%" + TCari.
                                getText().trim() + "%') "
    ...
    private void MnCetakSuratBebasTatoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratBebasTatoActionPerformed
        if (TPasien.getText().trim().isEmpty()) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptSuratBebasTato.jasper", "report",
                    "::[ Surat Keterangan Bertato/ Tidak Bertato ]::",
    ...
    public void tampil() {
        ...
        try {
            tgl = " surat_bebas_tato.tanggalperiksa between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "")
            ...
            if (TCari.getText().trim().isEmpty()) {
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "%' or surat_bebas_tato.no_rawat like '%" + TCari.getText().trim() + "%' or "
                        + "reg_periksa.no_rkm_medis like '%" + TCari.getText().trim()
                        + "%' or  pasien.nm_pasien like '%" + TCari.getText().trim() + "%' or "
                        + "surat_bebas_tato.tanggalperiksa like '%" + TCari.getText().trim()
                        + "%' or surat_bebas_tato.keperluan like '%" + TCari.getText().trim() + "%') "
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(surat_bebas_tato.no_surat,3),signed)),0) from surat_bebas_tato where surat_bebas_tato.tanggalperiksa='"
                + Valid.SetTgl(TanggalPeriksa.getSelectedItem() + "") + "' ",
                "SBT" + TanggalPeriksa.getSelectedItem().toString().substring(6, 10)
    ...
    private static final Logger LOG = Logger.getLogger(SuratBebasTato.class.getName());
