 ...
 * @author dosen
 */
public class SuratBalas extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("surat_balas", "?,?", "Kode", 2,
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbBangsal.getRowCount(); i++) {
            if (tbBangsal.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("surat_balas", "kd", tbBangsal.getValueAt(i, 1).
                        toString());
            }
        }
        tampil();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbBangsal.getSelectedRow() > -1) {
                Sequel.mengedit("surat_balas", "kd=?", "balas=?,kd=?", 3,
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptSuratStatusBalas.jasper", param,
                    "::[ Laporan Status Balas Surat ]::");
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from surat_balas where kd like ? "
    ...
    private static final Logger LOG = Logger.getLogger(SuratBalas.class.
            getName());
}
