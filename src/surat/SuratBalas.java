...
public class SuratBalas extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select * from surat_balas where kd like ? " + "or balas like ? order by kd");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(SuratBalas.class.getName());
