...
public class SuratKewaspadaanKesehatan extends javax.swing.JDialog {
    ...
    public SuratKewaspadaanKesehatan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "No.Surat", "No.Rawat", "No.R.M.", "Nama Pasien", "Tgl.Periksa",
            "Keluhan", "Kode Dokter", "Nama Dokter", "Keperluan"
        }) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratKewaspadaanKesehatan dialog = new SuratKewaspadaanKesehatan(
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(surat_kewaspadaan_kesehatan.no_surat,3),signed)),0) from surat_kewaspadaan_kesehatan where surat_kewaspadaan_kesehatan.tanggalperiksa='" + Valid.
                        SetTgl(TanggalPeriksa.getSelectedItem() + "") + "' ",
                "SKK" + TanggalPeriksa.getSelectedItem().toString().substring(6,
                        10) + TanggalPeriksa.getSelectedItem().toString().
                        substring(3, 5) + TanggalPeriksa.getSelectedItem().
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            Keluhan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 5).
                    toString());
    ...
    private static final Logger LOG = Logger.getLogger(
            SuratKewaspadaanKesehatan.class.getName());
}
