 ...
 * @author salimmulyana
 */
public class SuratKewaspadaanKesehatan extends javax.swing.JDialog {
    ...
    public SuratKewaspadaanKesehatan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.Surat", "No.Rawat", "No.R.M.", "Nama Pasien",
            "Tgl.Periksa", "Keluhan", "Kode Dokter", "Nama Dokter", "Keperluan"}) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (NoSurat.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("surat_kewaspadaan_kesehatan", "?,?,?,?,?",
                    "No.Surat", 5, new String[]{
                        NoSurat.getText(), TNoRw.getText(), Valid.SetTgl(
                        TanggalPeriksa.getSelectedItem() + ""), Keluhan.
                        getText(), Keperluan.getText()
                    }) == true) {
                tampil();
                emptTeks();
            }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, NoSurat, "surat_kewaspadaan_kesehatan",
                "no_surat") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (NoSurat.getText().trim().isEmpty()) {
            ...
            if (tbObat.getSelectedRow() != -1) {
                if (Sequel.mengedittf("surat_kewaspadaan_kesehatan",
                        "no_surat=?",
                        "no_surat=?,no_rawat=?,tanggalperiksa=?,keluhan_saat_ini=?,keperluan=?",
                        6, new String[]{
                            NoSurat.getText(), TNoRw.getText(), Valid.SetTgl(
                            TanggalPeriksa.getSelectedItem() + ""), Keluhan.
                    ...
                    tbObat.
                            setValueAt(Keluhan.getText(), tbObat.
                                    getSelectedRow(), 5);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            tgl = " surat_kewaspadaan_kesehatan.tanggalperiksa between '" + Valid.
                    SetTgl(DTPCari1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(DTPCari2.getSelectedItem() + "") + "' ";
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptDataSuratKewaspadaanKesehatan.jasper",
                        "report",
                        "::[ Data Surat Keterangan Kewaspadaan Kesehatan ]::",
                ...
                Valid.MyReportqry("rptDataSuratKewaspadaanKesehatan.jasper",
                        ...
                        + "where " + tgl + "and (no_surat like '%" + TCari.
                                getText().trim() + "%' or surat_kewaspadaan_kesehatan.no_rawat like '%" + TCari.
                                getText().trim() + "%' or "
                        + "reg_periksa.no_rkm_medis like '%" + TCari.getText().
                                trim() + "%' or  pasien.nm_pasien like '%" + TCari.
                                getText().trim() + "%' or "
                        + "surat_kewaspadaan_kesehatan.tanggalperiksa like '%" + TCari.
                                getText().trim() + "%' or surat_kewaspadaan_kesehatan.keperluan like '%" + TCari.
                                getText().trim() + "%') "
    ...
    private void MnCetakSuratKewaspadaanKesehatanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratKewaspadaanKesehatanActionPerformed
        if (TPasien.getText().trim().isEmpty()) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptSuratKewaspadaanKesehatan.jasper", "report",
                    "::[ Surat Keterangan Kewaspadaan Kesehatan ]::",
    ...
    public void tampil() {
        ...
        try {
            tgl = " surat_kewaspadaan_kesehatan.tanggalperiksa between '"
            ...
            if (TCari.getText().trim().isEmpty()) {
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "from surat_kewaspadaan_kesehatan inner join reg_periksa on surat_kewaspadaan_kesehatan.no_rawat=reg_periksa.no_rawat "
                        + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on dokter.kd_dokter=reg_periksa.kd_dokter "
                        + "where " + tgl + "and (no_surat like '%" + TCari.getText().trim()
                        + "%' or surat_kewaspadaan_kesehatan.no_rawat like '%" + TCari.getText().trim()
                        + "%' or " + "reg_periksa.no_rkm_medis like '%" + TCari.getText().trim()
                        + "%' or  pasien.nm_pasien like '%" + TCari.getText().trim() + "%' or "
                        + "surat_kewaspadaan_kesehatan.tanggalperiksa like '%" + TCari.getText().trim()
                        + "%' or surat_kewaspadaan_kesehatan.keperluan like '%" + TCari.getText().trim()
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(surat_kewaspadaan_kesehatan.no_surat,3),signed)),0) from surat_kewaspadaan_kesehatan where surat_kewaspadaan_kesehatan.tanggalperiksa='"
                + Valid.SetTgl(TanggalPeriksa.getSelectedItem() + "") + "' ",
                "SKK" + TanggalPeriksa.getSelectedItem().toString().substring(6, 10)
                + TanggalPeriksa.getSelectedItem().toString().substring(3, 5)
                + TanggalPeriksa.getSelectedItem().toString().substring(0, 2),
                3, NoSurat);
    ...
    private static final Logger LOG = Logger.getLogger(SuratKewaspadaanKesehatan.class.getName());
