...
public class SuratRuang extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select * from surat_ruang where kd like ? " + "or ruang like ? order by kd");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(SuratRuang.class.getName());
