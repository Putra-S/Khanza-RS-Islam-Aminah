...
public class SuratAlmari extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select * from surat_lemari where kd like ? " + "or lemari like ? order by kd");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(SuratAlmari.class.getName());
