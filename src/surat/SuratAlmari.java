 ...
 * @author dosen
 */
public class SuratAlmari extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("surat_lemari", "?,?", "Kode", 2,
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbBangsal.getRowCount(); i++) {
            if (tbBangsal.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("surat_lemari", "kd",
                        tbBangsal.getValueAt(i, 1).toString());
            }
        }
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbBangsal.getSelectedRow() > -1) {
                Sequel.mengedit("surat_lemari", "kd=?", "lemari=?,kd=?", 3,
                        new String[]{TNm.getText(), TKd.getText(), tbBangsal.
                            getValueAt(tbBangsal.getSelectedRow(), 1).toString()});
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptSuratAlmari.jasper", param,
                    "::[ Laporan Almari Surat ]::");
        }
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from surat_lemari where kd like ? "
                    + "or lemari like ? order by kd");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(SuratAlmari.class.
            getName());
}
