 ...
 * @author perpustakaan
 */
public class SuratMasuk extends javax.swing.JDialog {
            ...
            case 0:
                try {
                    loadURLInput(
                            ...
                            PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/" + "surat/login2.php?act=login&usere=" + koneksiDB.
            ...
            case 1:
                try {
                    loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.
                            PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/" + "surat/login.php?act=login&usere=" + koneksiDB.
                            USERHYBRIDWEB() + "&passwordte=" + koneksiDB.
    ...
    private static final Logger LOG = Logger.getLogger(SuratMasuk.class.getName());
