 ...
 * @author salimmulyana
 */
public class SuratTidakHamil extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (NoSurat.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("surat_hamil", "?,?,?,?", "No.Surat", 4,
                    new String[]{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (NoSurat.getText().trim().isEmpty()) {
            ...
            if (tbObat.getSelectedRow() != -1) {
                if (Sequel.mengedittf("surat_hamil", "no_surat=?",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            tgl = " surat_hamil.tanggalperiksa between '" + Valid.SetTgl(
                    DTPCari1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(
                    DTPCari2.getSelectedItem() + "") + "' ";
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptDataSuratHamil.jasper", "report",
                        "::[ Data Surat Keterangan Hamil/Tidak Hamil ]::",
                ...
                Valid.MyReportqry("rptDataSuratHamil.jasper", "report",
                        ...
                        + "where " + tgl + "and (no_surat like '%" + TCari.
                                getText().trim() + "%' or surat_hamil.no_rawat like '%" + TCari.
                                getText().trim() + "%' or "
                        + "reg_periksa.no_rkm_medis like '%" + TCari.getText().
                                trim() + "%' or pasien.nm_pasien like '%" + TCari.
                                getText().trim() + "%' or "
                        + "surat_hamil.tanggalperiksa like '%" + TCari.getText().
                                trim() + "%') "
    ...
    private void MnCetakSuratHamilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratHamilActionPerformed
        if (TPasien.getText().trim().isEmpty()) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptSuratTidakHamil.jasper", "report",
    ...
    public void tampil() {
        ...
        try {
            tgl = " surat_hamil.tanggalperiksa between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + "' and '"
            ...
            if (TCari.getText().trim().isEmpty()) {
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "%' or surat_hamil.no_rawat like '%" + TCari.getText().trim() + "%' or "
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(surat_hamil.no_surat,3),signed)),0) from surat_hamil where surat_hamil.tanggalperiksa='"
                + Valid.SetTgl(TanggalPeriksa.getSelectedItem() + "") + "' ",
                "SKH" + TanggalPeriksa.getSelectedItem().toString().substring(6, 10)
    ...
    private static final Logger LOG = Logger.getLogger(SuratTidakHamil.class.getName());
