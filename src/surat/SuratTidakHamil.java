...
public class SuratTidakHamil extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratTidakHamil dialog = new SuratTidakHamil(
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(surat_hamil.no_surat,3),signed)),0) from surat_hamil where surat_hamil.tanggalperiksa='" + Valid.
                        SetTgl(TanggalPeriksa.getSelectedItem() + "") + "' ",
                "SKH" + TanggalPeriksa.getSelectedItem().toString().substring(6,
    ...
    private static final Logger LOG = Logger.getLogger(SuratTidakHamil.class.
            getName());
}
