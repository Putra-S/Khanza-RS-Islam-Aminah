...
public class SuratKeteranganSehat extends javax.swing.JDialog {
    ...
    public SuratKeteranganSehat(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.Surat", "No.Rawat", "No.R.M.", "Nama Pasien",
            "Tanggal", "BB", "TB", "Tensi", "Suhu", "Buta Warna", "Keperluan", "Kesimpulan"}) {
            @Override
    ...
    public void tampil() {
        ...
        try {
            tgl = " surat_keterangan_sehat.tanggalsurat between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "")
            ...
            if (TCari.getText().trim().isEmpty()) {
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "and surat_keterangan_sehat.no_rawat like '%" + TCari.getText().trim() + "%' or "
                        + tgl + "and reg_periksa.no_rkm_medis like '%" + TCari.getText().trim() + "%' or " + tgl
                        + "and pasien.nm_pasien like '%" + TCari.getText().trim() + "%' or " + tgl
                        + "and surat_keterangan_sehat.tanggalsurat like '%" + TCari.getText().trim() + "%' "
                        + "order by surat_keterangan_sehat.no_surat");
            }
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(surat_keterangan_sehat.no_surat,3),signed)),0) from surat_keterangan_sehat where surat_keterangan_sehat.tanggalsurat='"
                + Valid.SetTgl(TanggalSurat.getSelectedItem() + "") + "' ",
                "SKD" + TanggalSurat.getSelectedItem().toString().substring(6, 10)
    ...
    private static final Logger LOG = Logger.getLogger(SuratKeteranganSehat.class.getName());
