...
public class InventoryRingkasanPenjualanBarangMedis extends javax.swing.JDialog {
    ...
    private String nofak = "", mem = "", ptg = "", sat = "", bar = "", tanggal = "",
            order = "order by databarang.nama_brng";
...
//GEN-FIRST:event_TKdKeyPressed
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRingkasanPenjualanObat.jasper", "report",
                    "::[ Laporan Ringkasan Penjualan Obat/Alkes/BHP Medis ]::",
                    ...
                    getText() + "%' or "
                    + "databarang.kode_sat like '%" + TCari.getText() + "%' or jenis.nama like '%" + TCari.
                    getText() + "%') "
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventoryRingkasanPenjualanBarangMedis dialog = new InventoryRingkasanPenjualanBarangMedis(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select detailjual.kode_brng,databarang.nama_brng, detailjual.kode_sat,"
                    ...
                    + " from penjualan inner join petugas inner join bangsal inner join jenis  "
                    + " inner join detailjual inner join databarang inner join kodesatuan "
                    + " on detailjual.kode_brng=databarang.kode_brng " + " and databarang.kode_sat=kodesatuan.kode_sat "
                    + " and penjualan.kd_bangsal=bangsal.kd_bangsal " + " and penjualan.nota_jual=detailjual.nota_jual "
                    + " and penjualan.nip=petugas.nip and databarang.kdjns=jenis.kdjns "
                    + " where penjualan.status='Sudah Dibayar' and " + tanggal + nofak + mem + ptg + sat + bar + " and "
                    + "(penjualan.nota_jual like '%" + TCari.getText() + "%' or penjualan.no_rkm_medis like '%"
                    ...
                    + "%' or databarang.nama_brng like '%" + TCari.getText() + "%' or " + "databarang.kode_sat like '%"
    ...
    private static final Logger LOG = Logger.getLogger(InventoryRingkasanPenjualanBarangMedis.class.getName());
