...
public class DlgReturObatPasien extends javax.swing.JDialog {
    ...
    public DlgReturObatPasien(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Tanggal Retur", "No.Rawat", "Pasien", "Barang",
            "Jml.Retur", "Kode Barang", "Asal Stok", "No.Batch", "No.Faktur"}) {
            @Override
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                while (rstampil.next()) {
                    tabMode.addRow(new Object[]{rstampil.getString("tanggal"), rstampil.getString("no_rawat"),
                        rstampil.getString("pasien"), rstampil.getString("barang"), rstampil.getString("jml"),
                        rstampil.getString("kode_brng"),
                        Sequel.cariIsi("select kd_bangsal from stok_obat_pasien where kode_brng='"
                        + rstampil.getString("kode_brng") + "' and no_batch='"
                        + rstampil.getString("no_batch") + "' and no_faktur='"
    ...
    private static final Logger LOG = Logger.getLogger(DlgReturObatPasien.class.getName());
