...
public class DlgObatPerTanggal extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (lokasi.isEmpty()) {
                Valid.MyReportqry("rptObatPerTanggal.jasper", "report",
                        "::[ Pemberian Obat Ke Pasien Per Tanggal ]::",
                ...
                Valid.MyReportqry("rptObatPerTanggal2.jasper", "report",
                        "::[ Pemberian Obat Ke Pasien Per Tanggal ]::",
                        "select * from temporary where temporary.temp37='" + akses.
                                getalamatip() + "' order by temporary.no", param);
            }
    ...
    private double JmlObat(String tanggal, String kodebarang) {
        return Sequel.cariIsiAngka(
                "select sum(jml) from detail_pemberian_obat where kode_brng='" + kodebarang + "' and tgl_perawatan=?",
                tanggal);
    }
