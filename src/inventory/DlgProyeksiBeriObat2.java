...
public class DlgProyeksiBeriObat2 extends javax.swing.JDialog {
    ...
    public DlgProyeksiBeriObat2(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Tgl.Beri", "No.Rawat", "Barang", "Satuan", "Biaya Obat", "Jml.Obat", "Subtotal Biaya",
            "Emb+Tsl", "Total Biaya", "Harga Beli", "Total Beli", "Keuntungan"};
...
//GEN-FIRST:event_TKdKeyPressed
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            say = " detail_pemberian_obat.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') "
                    ...
                    + " and detail_pemberian_obat.tgl_perawatan between '" + Valid.
    ...
    private static final Logger LOG = Logger.getLogger(DlgProyeksiBeriObat2.class.getName());
