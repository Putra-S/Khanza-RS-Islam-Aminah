 ...
 * @author dosen
 */
public class DlgJenis extends javax.swing.JDialog {
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbKamar.getRowCount(); i++) {
            if (tbKamar.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("jenis", "kdjns", tbKamar.getValueAt(i, 1).
                        toString());
            }
        }
        BtnCariActionPerformed(evt);
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Valid.editTable(tabMode, "jenis", "kdjns", "?",
                    "nama=?,keterangan=?,kdjns=?", 4, new String[]{
                        Nm.getText(), Keterangan.getText(), Kd.getText(),
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptJenis.jasper", "report", "::[ Data Jenis ]::",
                    "select kdjns, nama, keterangan "
                    + " from jenis where  kdjns like '%" + TCari.getText().
                            trim() + "%' or "
                    + " nama like '%" + TCari.getText().trim() + "%' or "
                    + " keterangan like '%" + TCari.getText().trim() + "%' order by kdjns",
                    param);
        }
...
private void KeteranganKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KeteranganKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select kdjns, nama, keterangan from jenis where  kdjns like ? or nama like ? or keterangan like ? order by nama ");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(DlgJenis.class.getName());
}
