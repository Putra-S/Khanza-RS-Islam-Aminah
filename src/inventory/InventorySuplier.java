...
public class InventorySuplier extends javax.swing.JDialog {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Valid.editTable(tabMode, "datasuplier", "kode_suplier", "?",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptSuplier.jasper", "report",
                    ...
                    + " where datasuplier.kode_suplier like '%" + TCari.
                            getText().trim() + "%' or "
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("datasuplier", "?,?,?,?,?,?,?",
...
//GEN-FIRST:event_TKdKeyPressed
    private void KdKeyPressed(java.awt.event.KeyEvent evt) {//GEN-LAST:event_TKdKeyPressed
        Valid.pindah(evt, NoRek, Telp, TCari);//GEN-FIRST:event_KdKeyPressed
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select datasuplier.kode_suplier, datasuplier.nama_suplier, "
                    + " datasuplier.alamat,datasuplier.kota, datasuplier.no_telp,"
                    + " datasuplier.nama_bank,datasuplier.rekening from datasuplier "
                    + " where datasuplier.kode_suplier like ? or " + " datasuplier.nama_suplier like ? or "
                    + " datasuplier.alamat like ? or " + " datasuplier.kota like ? or "
    ...
    private static final Logger LOG = Logger.getLogger(InventorySuplier.class.getName());
