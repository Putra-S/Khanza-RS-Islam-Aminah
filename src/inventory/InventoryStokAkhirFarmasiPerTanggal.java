...
public class InventoryStokAkhirFarmasiPerTanggal extends javax.swing.JDialog {
    ...
    private String dateString, dayOfWeek, hari, h1 = "", h2 = "", h3 = "", h4 = "", h5 = "", h6 = "", h7 = "", h8 = "",
            h9 = "", h10 = "", h11 = "", h12 = "", h13 = "", h14 = "", h15 = "", h16 = "", h17 = "", h18 = "", h19 = "",
            h20 = "", h21 = "", h22 = "", h23 = "", h24 = "", h25 = "", h26 = "", h27 = "", h28 = "", h29 = "",
            h30 = "", h31 = "";

    private String stokawal = "", s1 = "", s2 = "", s3 = "", s4 = "", s5 = "", s6 = "", s7 = "", s8 = "", s9 = "",
...
//GEN-FIRST:event_TKdKeyPressed
        ...
        if (KdGudang.getText().isEmpty() || NmGudang.getText().isEmpty()) {
            ...
            try {
                ps = koneksi.prepareStatement(
                        "select databarang.kode_brng,databarang.nama_brng from databarang where databarang.status='1' "
                ...
                try {
                    ...
                    while (rs.next()) {
                        stokawal = Sequel.cariIsi(
                                "select riwayat_barang_medis.stok_akhir from riwayat_barang_medis where riwayat_barang_medis.tanggal < '"
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-01' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                        ...
                        s2 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-02' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s2)) {
                            s2 = s1;
                        ...
                        s3 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-03' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s3)) {
                            s3 = s2;
                        ...
                        s4 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-04' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s4)) {
                            s4 = s3;
                        ...
                        s5 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-05' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s5)) {
                            s5 = s4;
                        ...
                        s6 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-06' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s6)) {
                            s6 = s5;
                        ...
                        s7 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-07' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s7)) {
                            s7 = s6;
                        ...
                        s8 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-08' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s8)) {
                            s8 = s7;
                        ...
                        s9 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-09' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s9)) {
                            s9 = s8;
                        ...
                        s10 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-10' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s10)) {
                            s10 = s9;
                        ...
                        s11 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-11' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s11)) {
                            s11 = s10;
                        ...
                        s12 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-12' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s12)) {
                            s12 = s11;
                        ...
                        s13 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-13' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s13)) {
                            s13 = s12;
                        ...
                        s14 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-14' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s14)) {
                            s14 = s13;
                        ...
                        s15 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-15' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s15)) {
                            s15 = s14;
                        ...
                        s16 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-16' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s16)) {
                            s16 = s15;
                        ...
                        s17 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-17' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s17)) {
                            s17 = s16;
                        ...
                        s18 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-18' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s18)) {
                            s18 = s17;
                        ...
                        s19 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-19' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s19)) {
                            s19 = s18;
                        ...
                        s20 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-20' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s20)) {
                            s20 = s19;
                        ...
                        s21 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-21' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s21)) {
                            s21 = s20;
                        ...
                        s22 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-22' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s22)) {
                            s22 = s21;
                        ...
                        s23 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-23' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s23)) {
                            s23 = s22;
                        ...
                        s24 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-24' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s24)) {
                            s24 = s23;
                        ...
                        s25 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-25' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s25)) {
                            s25 = s24;
                        ...
                        s26 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-26' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s26)) {
                            s26 = s25;
                        ...
                        s27 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-27' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s27)) {
                            s27 = s26;
                        ...
                        s28 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-28' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s28)) {
                            s28 = s27;
                        ...
                        s29 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-29' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s29)) {
                            s29 = s28;
                        ...
                        s30 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-30' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s30)) {
                            s30 = s29;
                        ...
                        s31 = Sequel.cariIsi(
                                ...
                                + ThnCari.getSelectedItem().toString() + "-"
                                + BlnCari.getSelectedItem().toString()
                                + "-31' and riwayat_barang_medis.kode_brng='" + rs.getString("kode_brng")
                                + "' and riwayat_barang_medis.kd_bangsal='" + KdGudang.getText()
                                + "' order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                        if ("".equals(s31)) {
                            s31 = s30;
                        ...
                        tabMode.addRow(new String[]{rs.getString("kode_brng"), rs.getString("nama_brng"), s1, s2, s3,
                            s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17, s18, s19, s20, s21, s22,
    ...
    private static final Logger LOG = Logger.getLogger(InventoryStokAkhirFarmasiPerTanggal.class.getName());
