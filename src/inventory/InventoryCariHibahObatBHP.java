...
*/
    ...
    private void kdsupKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdsupKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_PAGE_DOWN) {
            Sequel.cariIsi(
                    "select nama_pemberi from pemberihibah where kode_pemberi=?",
                    nmsup, kdsup.getText());
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (i = 0; i < row; i++) {
                Sequel.menyimpan("temporary", "'" + i + "','"
                        ...
                        getalamatip() + "'", "Transaksi Hibah Obat & BHP");
            }
            i++;
            ...
            Valid.MyReportqry("rptHibahObatBHP.jasper", "report",
                    "::[ Transaksi Hibah Obat, Alkes & BHP Medis ]::",
        ...
        if (tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).toString().trim().
            ...
            try {
                pscaribeli = koneksi.prepareStatement(
                        "select no_hibah, totalnilai, kd_bangsal,tgl_hibah from hibah_obat_bhp where no_hibah=?");
                try {
                    ...
                    if (rs.next()) {
                        ...
                        sukses = true;
                        psdetailhibah_obat_bhp = koneksi.prepareStatement(
                                "select kode_brng,jumlah2,no_batch,no_hibah from detailhibah_obat_bhp where no_hibah=? ");
                        try {
                            ...
                            while (rs2.next()) {
                                if (aktifkanbatch.equals("yes")) {
                                    Trackobat.catatRiwayat(rs2.getString(
                                            ...
                                            getString("no_hibah"), rs.getString(
                                            "no_hibah"));
                        ...
                        if (sukses == true) {
                            ...
                            Sequel.
                                    menyimpan("tampjurnal", "?,?,?,?",
                                        ...
                                        "PERSEDIAAN HIBAH OBAT & BHP", "0", rs.
                                                getString("totalnilai")
                                    });
                            Sequel.
                                    menyimpan("tampjurnal", "?,?,?,?",
                                            "Rekening", 4, new String[]{
                                        ...
                                        "PENDAPATAN HIBAH", rs.getString(
                                                "totalnilai"), "0"
                                    });
                            sukses = jur.simpanJurnal(rs.getString("no_hibah"),
                                    "U", "BATAL HIBAH OBAT & BHP DI " + Sequel.
                        ...
                        if (sukses == true) {
                            Sequel.queryu2(
                                    "delete from hibah_obat_bhp where no_hibah=?",
