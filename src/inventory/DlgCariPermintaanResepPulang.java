...
*/
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPermintaanResepPulang dialog = new DlgCariPermintaanResepPulang(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new String[]{"", "Jumlah", "Satuan",
                        "Aturan Pakai", "Kode Obat", "Nama Obat", "", ""});
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new String[]{
                                ...
                                "kode_sat"), rs2.getString("dosis"), rs2.
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgCariPermintaanResepPulang.class.getName());
}
