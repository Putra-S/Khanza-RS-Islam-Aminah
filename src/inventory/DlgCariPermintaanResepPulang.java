...
//GEN-FIRST:event_TKdKeyPressed
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbPemisahan.getValueAt(tbPemisahan.getSelectedRow(), 0).
                ...
                Sequel.meghapus("permintaan_resep_pulang", "no_permintaan",
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(
                            new String[]{"", "Jumlah", "Satuan", "Aturan Pakai", "Kode Obat", "Nama Obat", "", ""});
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new String[]{"", rs2.getString("jml"), rs2.getString("kode_sat"),
                                rs2.getString("dosis"), rs2.getString("kode_brng"), rs2.getString("nama_brng"), "",
                                ""});
                        }
                    } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariPermintaanResepPulang.class.getName());
