...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariKonversi dialog = new DlgCariKonversi(
            ...
            if (!nmsat1.getText().equals(nmsat2.getText())) {
                try {
                    ResultSet rs = koneksi.createStatement().executeQuery(
                            "select nilai,nilai_konversi from konver_sat where kode_sat='" + kdsat1.
                                    getSelectedItem() + "' and sat_konversi='" + kdsat2.
                                    getSelectedItem() + "'");
                    if (rs.next()) {
                        n2.setText(Double.toString(Double.parseDouble(n1.
                                getText()) * (rs.getDouble(2) / rs.getDouble(1))));
                    } else if (!rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariKonversi.class.
            getName());
