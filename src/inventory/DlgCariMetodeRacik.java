...
public class DlgCariMetodeRacik extends javax.swing.JDialog {
            ...
            if (response.isArray()) {
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{i + "", list.path("KodeRacik").asText(),
                            list.path("NamaRacik").asText()});
                        i++;
                    }
                } else {
                    for (JsonNode list : response) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariMetodeRacik.class.getName());
