...
public class DlgCopyResep extends javax.swing.JDialog {
    ...
    public DlgCopyResep(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.Resep", "Tgl.Resep", "Jam Resep", "No.Rawat",
            "No.RM", "Pasien", "Dokter Peresep", "Kode Dokter", "Status"};
...
*/
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCopyResep dialog = new DlgCopyResep(new javax.swing.JFrame(),
                    true);
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new String[]{"", "Jumlah", "Satuan",
                        ...
                        rs.getString("status_asal").replaceAll("ralan",
                        "Rawat Jalan").replaceAll("ranap", "Rawat Inap")});
    ...
    private static final Logger LOG = Logger.getLogger(DlgCopyResep.class.
            getName());
}
