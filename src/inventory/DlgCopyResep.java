...
public class DlgCopyResep extends javax.swing.JDialog {
    ...
    public DlgCopyResep(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.Resep", "Tgl.Resep", "Jam Resep", "No.Rawat", "No.RM", "Pasien", "Dokter Peresep",
            "Kode Dokter", "Status"};
    ...
    private void BtnKeluarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnKeluarKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, DTPCari1, BtnTambah);
        }
...
//GEN-FIRST:event_TKdKeyPressed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbPemisahan.getValueAt(tbPemisahan.getSelectedRow(), 0).
                ...
                if (jmlparsial > 0) {
                    ...
                    if (Sequel.cariRegistrasi(tbPemisahan.getValueAt(
                            tbPemisahan.getSelectedRow(), 3).toString()) > 0) {
                        JOptionPane.showMessageDialog(rootPane,
                                "Data billing sudah terverifikasi ..!!");
                    } else {
                        panggilform2();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbPemisahan.getValueAt(tbPemisahan.getSelectedRow(), 0).
                ...
                Sequel.meghapus("resep_obat", "no_resep", tbPemisahan.
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_resep"), rs.getString("tgl_peresepan"),
                        ...
                        rs.getString("status")});
                    tabMode.addRow(new String[]{"", "Jumlah", "Satuan", "Aturan Pakai", "Kode/No",
                        "Nama Obat/Racikan", "", "",
                        rs.getString("status_asal")
                        .replaceAll("ralan", "Rawat Jalan")
                        .replaceAll("ranap", "Rawat Inap")});
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new String[]{"", rs2.getString("jml"), rs2.getString("kode_sat"),
                                rs2.getString("aturan_pakai"), rs2.getString("kode_brng"),
                    ...
                    try {
                        ...
                        rs2 = ps2.executeQuery();
                        while (rs2.next()) {
                            tabMode.addRow(new String[]{"", rs2.getString("jml_dr"), rs2.getString("metode"),
                                rs2.getString("aturan_pakai"), "No.Racik : " + rs2.getString("no_racik"),
                            ...
                            try {
                                ...
                                while (rs3.next()) {
                                    tabMode.addRow(new String[]{"", "   " + rs3.getString("jml"),
                                        "   " + rs3.getString("kode_sat"), "", "   " + rs3.getString("kode_brng"),
    ...
    private static final Logger LOG = Logger.getLogger(DlgCopyResep.class.getName());
