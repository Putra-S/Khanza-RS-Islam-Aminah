...
private void KdKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TKdKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDaftarPermintaanStokPasien dialog = new DlgDaftarPermintaanStokPasien(
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new String[]{
                                ...
                                getString("kode_sat"), rs2.
                                getString("kode_brng"), rs2.getString(
                                "nama_brng"),
                                "00 : " + rs2.getString("jam00").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "01 : " + rs2.getString("jam01").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "02 : " + rs2.getString("jam02").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "03 : " + rs2.getString("jam03").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "04 : " + rs2.getString("jam04").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "05 : " + rs2.getString("jam05").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "06 : " + rs2.getString("jam06").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "07 : " + rs2.getString("jam07").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "08 : " + rs2.getString("jam08").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "09 : " + rs2.getString("jam09").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "10 : " + rs2.getString("jam10").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "11 : " + rs2.getString("jam11").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "12 : " + rs2.getString("jam12").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "13 : " + rs2.getString("jam13").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "14 : " + rs2.getString("jam14").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "15 : " + rs2.getString("jam15").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "16 : " + rs2.getString("jam16").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "17 : " + rs2.getString("jam17").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "18 : " + rs2.getString("jam18").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "19 : " + rs2.getString("jam19").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "20 : " + rs2.getString("jam20").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "21 : " + rs2.getString("jam21").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "22 : " + rs2.getString("jam22").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  "
                                + "23 : " + rs2.getString("jam23").replaceAll(
                                "true", "✓").replaceAll("false", "✕") + "  |  "
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgDaftarPermintaanStokPasien.class.getName());
}
