...
public class DlgAturanPakai extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Nama.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("master_aturan_pakai",
                    "'" + Nama.getText() + "'", "Aturan Pakai") == true) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgAturanPakai dialog = new DlgAturanPakai(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from master_aturan_pakai where aturan like ? ");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(DlgAturanPakai.class.
            getName());
}
