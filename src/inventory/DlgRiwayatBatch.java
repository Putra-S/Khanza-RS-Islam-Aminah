            ...
            try (BufferedWriter bw = new BufferedWriter(new FileWriter(f))) {
                if (TabRawat.getSelectedIndex() == 0) {
                    bw.write(LoadHTML.getText().replaceAll("<head>", "<head>"
                            ...
                            getemailrs() + "<br><br>"
                            + "<font size='2' face='Tahoma'>DATA RIWAYAT BATCH<br>PERIODE BARANG DATANG " + Tgl1.
...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    private void prosesCari() {
        ...
        try {
            ...
            htmlContent.append("<tr class='head'>"
                    ...
                    + "<td valign='middle' bgcolor='#FFFAFA' align='center' width='65px'>Sisa</td>" + "</tr>");

            ps = koneksi.prepareStatement("select data_batch.no_batch,data_batch.kode_brng,databarang.nama_brng,"
            ...
            try {
                ...
                while (rs.next()) {
                    htmlContent.append("<tr class='isi'><td valign='middle' align='left'>")
                            .append(rs.getString("no_batch"))
                            .append("</td><td valign='middle' align='left'>")
                            .append(rs.getString("kode_brng"))
                            .append("</td><td valign='middle' align='left'>")
                            .append(rs.getString("nama_brng"))
                            .append("</td><td valign='middle' align='left'>")
                            .append(rs.getString("kode_sat"))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getString("tgl_beli"))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getString("tgl_kadaluarsa"))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getString("asal"))
                            .append("</td><td valign='middle' align='left'>")
                            .append(rs.getString("no_faktur"))
                            .append("</td><td valign='middle' align='right'>")
                            .append(Valid.SetAngka(rs.getDouble("h_beli")))
                            .append("</td><td valign='middle' align='right'>")
                            .append(Valid.SetAngka(rs.getDouble("ralan")))
                            .append("</td><td valign='middle' align='right'>")
                            .append(Valid.SetAngka(rs.getDouble("kelas1")))
                            .append("</td><td valign='middle' align='right'>")
                            .append(Valid.SetAngka(rs.getDouble("kelas2")))
                            .append("</td><td valign='middle' align='right'>")
                            .append(Valid.SetAngka(rs.getDouble("kelas3")))
                            .append("</td><td valign='middle' align='right'>")
                            .append(Valid.SetAngka(rs.getDouble("utama")))
                            .append("</td><td valign='middle' align='right'>")
                            .append(Valid.SetAngka(rs.getDouble("vip")))
                            .append("</td><td valign='middle' align='right'>")
                            .append(Valid.SetAngka(rs.getDouble("vvip")))
                            .append("</td><td valign='middle' align='right'>")
                            .append(Valid.SetAngka(rs.getDouble("beliluar")))
                            .append("</td><td valign='middle' align='right'>")
                            .append(Valid.SetAngka(rs.getDouble("jualbebas")))
                            .append("</td><td valign='middle' align='right'>")
                            .append(Valid.SetAngka(rs.getDouble("karyawan")))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getDouble("jumlahbeli"))
                            .append("</td><td valign='middle' align='center'>")
                            .append(rs.getDouble("sisa"))
                            .append("</td></tr>");
                    // penjualan
                    try {
                        rs2 = koneksi.prepareStatement(
                                ...
                                + "where penjualan.status='Sudah Dibayar' and detailjual.kode_brng='"
                                + rs.getString("kode_brng") + "' and detailjual.no_batch='"
                                + rs.getString("no_batch") + "' and detailjual.no_faktur='"
                                + rs.getString("no_faktur") + "'")
                                .executeQuery();
                        if (rs2.next()) {
                            htmlContent.append("<tr class='isi'>" + "<td valign='top'></td>" + "<td valign='top'></td>"
                            ...
                            rs2.beforeFirst();
                            while (rs2.next()) {
                                htmlContent.append("<tr><td valign='top'>")
                                        .append(rs2.getString("nota_jual"))
                                        .append("</td><td valign='top' align='center'>")
                                        .append(rs2.getString("tgl_jual"))
                                        .append("</td><td valign='top' align='center'>(-) ")
                                        .append(rs2.getDouble("jumlah"))
                                        ...
                                        .append("</td><td valign='top'>")
                                        .append(rs2.getString("kd_bangsal"))
                                        .append(" ")
                                        .append(rs2.getString("nm_bangsal"))
                                        .append("</td><td valign='top'>")
                    ...
                    try {
                        rs2 = koneksi.prepareStatement(
                                ...
                                + "where detail_pemberian_obat.kode_brng='" + rs.getString("kode_brng")
                                + "' and detail_pemberian_obat.no_batch='" + rs.getString("no_batch")
                                + "' and detail_pemberian_obat.no_faktur='" + rs.getString("no_faktur") + "'")
                                .executeQuery();
                        if (rs2.next()) {
                            htmlContent.append("<tr class='isi'>" + "<td valign='top'></td>" + "<td valign='top'></td>"
                            ...
                            while (rs2.next()) {
                                htmlContent.append("<tr><td valign='top'>")
                                        ...
                                        .append(" ")
                                        .append(rs2.getString("jam"))
                                        .append("</td><td valign='top' align='center'>(-) ")
                                        .append(rs2.getDouble("jml"))
                                        .append("</td><td valign='top'>")
                                        .append(rs2.getString("no_rkm_medis"))
                                        .append(" ")
                                        .append(rs2.getString("nm_pasien"))
                    ...
                    try {
                        rs2 = koneksi
                                .prepareStatement("select utd_pengambilan_medis.jml,utd_pengambilan_medis.tanggal, "
                                        ...
                                        + "where utd_pengambilan_medis.kode_brng='" + rs.getString("kode_brng")
                                        + "' and utd_pengambilan_medis.no_batch='" + rs.getString("no_batch")
                                        + "' and utd_pengambilan_medis.no_faktur='" + rs.getString("no_faktur") + "'")
                                .executeQuery();
                        if (rs2.next()) {
                            htmlContent.append("<tr class='isi'>" + "<td valign='top'></td>" + "<td valign='top'></td>"
                            ...
                            rs2.beforeFirst();
                            while (rs2.next()) {
                                htmlContent.append("<tr><td valign='top' align='center'>")
                                        .append(rs2.getString("tanggal"))
                                        .append("</td><td valign='top' align='center'>(-) ")
                                        .append(rs2.getDouble("jml"))
                                        .append("</td><td valign='top'>")
                                        .append(rs2.getString("kd_bangsal_dr"))
                                        .append(" ")
                                        .append(rs2.getString("nm_bangsal"))
                                        .append("</td><td valign='top'>")
                                        .append(rs2.getString("keterangan"))
                    ...
                    try {
                        rs2 = koneksi.prepareStatement(
                                ...
                                + "where detreturjual.kode_brng='" + rs.getString("kode_brng")
                                + "' and detreturjual.no_batch='" + rs.getString("no_batch")
                                + "' and detreturjual.no_faktur='" + rs.getString("no_faktur") + "'")
                                .executeQuery();
                        if (rs2.next()) {
                            htmlContent.append("<tr class='isi'>" + "<td valign='top'></td>" + "<td valign='top'></td>"
                            ...
                            while (rs2.next()) {
                                htmlContent.append("<tr><td valign='top'>")
                                        .append(rs2.getString("no_retur_jual"))
                                        .append("</td><td valign='top' align='center'>")
                                        .append(rs2.getString("tgl_retur"))
                                        .append("</td><td valign='top' align='center'>(+) ")
                                        .append(rs2.getDouble("jml_retur"))
                                        .append("</td><td valign='top'>")
                                        .append(rs2.getString("nip"))
                                        .append(" ")
                                        .append(rs2.getString("nama"))
                    ...
                    try {
                        rs2 = koneksi.prepareStatement(
                                ...
                                + "where detailpiutang.kode_brng='" + rs.getString("kode_brng")
                                + "' and detailpiutang.no_batch='" + rs.getString("no_batch")
                                + "' and detailpiutang.no_faktur='" + rs.getString("no_faktur") + "'")
                                .executeQuery();
                        if (rs2.next()) {
                            htmlContent.append("<tr class='isi'>" + "<td valign='top'></td>" + "<td valign='top'></td>"
                                    + "<td valign='top' align='right'>Piutang :</td>" + "<td valign='top' colspan='18'>"
                                    + "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0'>"
                                    + "<tr class='isi'>"
                                    + "<td valign='middle' bgcolor='#fdfff9' align='center' width='7%'>No.Nota</td>"
                            ...
                            while (rs2.next()) {
                                htmlContent.append("<tr><td valign='top'>")
                                        .append(rs2.getString("nota_piutang"))
                                        .append("</td><td valign='top' align='center'>")
                                        .append(rs2.getString("tgl_piutang"))
                                        .append("</td><td valign='top' align='center'>(-) ")
                                        .append(rs2.getDouble("jumlah"))
                                        .append("</td><td valign='top'>")
                                        .append(rs2.getString("nip"))
                    ...
                    try {
                        rs2 = koneksi.prepareStatement(
                                ...
                                + "where detreturpiutang.kode_brng='" + rs.getString("kode_brng")
                                + "' and detreturpiutang.no_batch='" + rs.getString("no_batch")
                                + "' and detreturpiutang.no_faktur='" + rs.getString("no_faktur") + "'")
                                .executeQuery();
                        if (rs2.next()) {
                            htmlContent.append("<tr class='isi'>" + "<td valign='top'></td>" + "<td valign='top'></td>"
                            ...
                            while (rs2.next()) {
                                htmlContent.append("<tr><td valign='top'>")
                                        .append(rs2.getString("no_retur_piutang"))
                                        .append("</td><td valign='top' align='center'>")
                                        .append(rs2.getString("tgl_retur"))
                                        .append("</td><td valign='top' align='center'>(+) ")
                                        .append(rs2.getDouble("jml_retur"))
                    ...
                    try {
                        rs2 = koneksi.prepareStatement(
                                ...
                                + "where detreturbeli.kode_brng='" + rs.getString("kode_brng")
                                + "' and detreturbeli.no_batch='" + rs.getString("no_batch")
                                + "' and detreturbeli.no_faktur='" + rs.getString("no_faktur") + "'")
                                .executeQuery();
                        if (rs2.next()) {
                            htmlContent.append("<tr class='isi'>" + "<td valign='top'></td>" + "<td valign='top'></td>"
                            ...
                            while (rs2.next()) {
                                htmlContent.append("<tr><td valign='top'>")
                                        .append(rs2.getString("no_retur_beli"))
                                        .append("</td><td valign='top' align='center'>")
                                        .append(rs2.getString("tgl_retur"))
                                        .append("</td><td valign='top' align='center'>(-) ")
                                        .append(rs2.getDouble("jml_retur"))
                                        ...
                                        .append(rs2.getString("nama"))
                                        .append("</td><td valign='top'>")
                                        .append(rs2.getString("kode_suplier"))
                                        .append(" ")
                                        .append(rs2.getString("nama_suplier"))
                                        .append("</td><td valign='top'>")
                                        .append(rs2.getString("kd_bangsal"))
                                        .append(" ")
                                        .append(rs2.getString("nm_bangsal"))
                                        .append("</td><td valign='top'>")
                                        .append(rs2.getString("no_faktur"))
                                        .append("</td></tr>");
                            }
                            htmlContent.append("</table>" + "</td>" + "</tr>");
                        }
                ...
                while (rs.next()) {
                    ...
                    try {
                        rs2 = koneksi.prepareStatement(
                                ...
                                + "where gudangbarang.kode_brng='" + rs.getString("kode_brng")
                                + "' and gudangbarang.no_batch='" + rs.getString("no_batch") + "' "
                                + "and gudangbarang.no_faktur='" + rs.getString("no_faktur")
                        ...
                        if (rs2.next()) {
                            htmlContent.append("<tr class='isi'>"
                                    ...
                                    + "<td valign='middle' bgcolor='#fdfff9' align='center'>Stok</td>" + "</tr>");

                            rs2.beforeFirst();
                            while (rs2.next()) {
                                htmlContent.append(
                                        "<tr class='isi'><td valign='middle' align='left' colspan='2'>&nbsp;</td><td valign='top' colspan='7'>")
                                        .append(rs2.getString("nm_bangsal"))
                                        .append("</td><td valign='top' align='center'>")
                                        .append(rs2.getDouble("stok"))
                                        .append("</td></tr>");
                            }

                            htmlContent.append("<tr class='isi'>"
                                    + "<td valign='middle' align='left' colspan='11'><hr></td>" + "</tr>");
                        }
                    } catch (Exception e) {
                        System.out.println("Notif : " + e);
                    } finally {
    ...
    private static final Logger LOG = Logger.getLogger(DlgRiwayatBatch.class.getName());
