...
*/
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventoryVerifikasiPenerimaan dialog = new InventoryVerifikasiPenerimaan(
    ...
    private void tampil() {
        ...
        try {
            ...
            if (!NoFaktur.getText().trim().isEmpty()) {
                carifaktur = " and surat_pemesanan_medis.no_pemesanan='" + NoFaktur.
                        getText() + "' ";
            }
            if (!nmsup.getText().trim().isEmpty()) {
                carisuplier = " and surat_pemesanan_medis.kode_suplier='" + kdsup.
                        getText() + "' ";
            }
            if (!nmptg.getText().trim().isEmpty()) {
                caripegawai = " and surat_pemesanan_medis.nip='" + kdptg.
                        getText() + "' ";
            }
            if (!TCari.getText().trim().isEmpty()) {
                carikeyword = " and (surat_pemesanan_medis.no_pemesanan like '%" + TCari.
                        getText().trim() + "%' or "
                        + " surat_pemesanan_medis.kode_suplier like '%" + TCari.
                                getText().trim() + "%' or "
                        + " datasuplier.nama_suplier like '%" + TCari.getText().
                                trim() + "%' or "
                        + " surat_pemesanan_medis.nip like '%" + TCari.getText().
                                trim() + "%' or "
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + "and surat_pemesanan_medis.tanggal between '" + Valid.
            ...
            try {
                ...
                while (rs.next()) {
                    pspenerimaan = koneksi.prepareStatement(
                            ...
                            + "pemesanan.meterai,pemesanan.tagihan,pemesanan.no_order,(to_days(pemesanan.tgl_pesan)-to_days('" + rs.
                            ...
                            + "where pemesanan.no_order='" + rs.getString(
                                    "no_pemesanan") + "'");
                    try {
                        ...
                        if (rspenerimaan.next()) {
                            ...
                            pssub = koneksi.prepareStatement(
                                    ...
                                    + "inner join kodesatuan on detail_surat_pemesanan_medis.kode_sat=kodesatuan.kode_sat where detail_surat_pemesanan_medis.no_pemesanan='" + rs.
                            ...
                            try {
                                ...
                                while (rssub.next()) {
                                    ...
                                    pssubpenerimaan = koneksi.prepareStatement(
                                            ...
                                            + "where detailpesan.no_faktur='" + rspenerimaan.
                                                    getString("no_faktur") + "' and detailpesan.kode_brng='" + rssub.
                                            getString("kode_brng") + "'");
                                    try {
                            ...
                            pssisipan = koneksi.prepareStatement(
                                    "select sum(subtotal),sum(besardis),sum(total) from detailpesan where no_faktur='" + rspenerimaan.
                                            getString("no_faktur") + "' "
                                    + "and kode_brng not in (select kode_brng from detail_surat_pemesanan_medis where no_pemesanan='" + rs.
                                            getString("no_pemesanan") + "')");
                            try {
    ...
    private static final Logger LOG = Logger.getLogger(
            InventoryVerifikasiPenerimaan.class.getName());
}
