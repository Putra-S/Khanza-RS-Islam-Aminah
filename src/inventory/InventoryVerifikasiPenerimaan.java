...
//GEN-FIRST:event_TKdKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + "and surat_pemesanan_medis.tanggal between '"
                    ...
                    + " order by surat_pemesanan_medis.tanggal,surat_pemesanan_medis.no_pemesanan ");
            jmltotaltagihan = 0;
            jmlfaktur = 0;
            jmlsisipan = 0;
            faktursisipan = 0;
            ...
            try {
                ...
                while (rs.next()) {
                    pspenerimaan = koneksi.prepareStatement(
                            ...
                            + "pemesanan.meterai,pemesanan.tagihan,pemesanan.no_order,(to_days(pemesanan.tgl_pesan)-to_days('"
                    ...
                    try {
                        ...
                        if (rspenerimaan.next()) {
                            ...
                            htmlContent.append(
                                    ...
                                    .append("</td><td valign='middle' align='center'>Depo : ")
                            ...
                            pssub = koneksi.prepareStatement(
                                    ...
                                    + "inner join kodesatuan on detail_surat_pemesanan_medis.kode_sat=kodesatuan.kode_sat where detail_surat_pemesanan_medis.no_pemesanan='"
                            ...
                            try {
                                ...
                                while (rssub.next()) {
                                    ...
                                    pssubpenerimaan = koneksi.prepareStatement(
                                            ...
                                            + "where detailpesan.no_faktur='"
                                            + rspenerimaan.getString("no_faktur")
                                            + "' and detailpesan.kode_brng='" + rssub.getString("kode_brng")
                                            + "'");
                                    try {
                            ...
                            pssisipan = koneksi.prepareStatement(
                                    "select sum(subtotal),sum(besardis),sum(total) from detailpesan where no_faktur='"
                                    + rspenerimaan.getString("no_faktur") + "' "
                                    + "and kode_brng not in (select kode_brng from detail_surat_pemesanan_medis where no_pemesanan='"
                                    + rs.getString("no_pemesanan") + "')");
                            try {
                            ...
                            htmlContent.append(
                                    ...
                                    .append(Valid.SetAngka(rs.getDouble("total1")))
                                    .append("</td><td align='right' colspan='2'>")
                                    .append(Valid.SetAngka(rs.getDouble("potongan")))
                                    .append("</td><td align='right'>")
                                    .append(Valid.SetAngka(rs.getDouble("total2")))
    ...
    private static final Logger LOG = Logger.getLogger(InventoryVerifikasiPenerimaan.class.getName());
