...
public class DlgSirkulasiBarang4 extends javax.swing.JDialog {
    ...
    public DlgSirkulasiBarang4(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Barang", "Nama Barang", "Satuan", "Tgl.Opname", "Stok Awal", "Pengadaan",
                    "Penerimaan", "Penjualan", "Ke Pasien", "Piutang Jual", "Retur Beli", "Retur Jual",
                    "Retur Piutang", "Pengambilan UTD", "Stok Keluar Medis", "Resep Pulang", "Mutasi Masuk",
                    "Mutasi Keluar", "Hibah", "Stok Akhir"}) {
            @Override
    ...
    private void prosesCari() {
        ...
        try {
                ...
                while (rs.next()) {
                    ...
                    if ((jumlahbeli > 0) || (jumlahpesan > 0) || (jumlahjual > 0) || (jumlahpasin > 0)
                        ...
                        tabMode.addRow(new Object[]{rs.getString(1), rs.getString(2), rs.getString(3), tglopname,
                            Valid.SetAngka(stokawal) + " (" + Valid.SetAngka(totalstokawal) + ")",
                            ...
                            Valid.SetAngka(jumlahpasin) + " (" + Valid.SetAngka(totalpasin) + ")",
            ...
            tabMode.addRow(new Object[]{"<>>", "Total :", "", "", Valid.SetAngka(ttltotalstokawal),
                ...
                Valid.SetAngka(ttltotalpasin), Valid.SetAngka(ttltotalpiutang), Valid.SetAngka(ttltotalretbeli),
                Valid.SetAngka(ttltotalretjual), Valid.SetAngka(ttltotalretpiut), Valid.SetAngka(ttltotalutd),
    ...
    private void prosesCari2(String lokasi) {
        ...
        try {
            ...
            try {
                ...
                if (aktifkanbatch.equals("yes")) {
                    qrystok = "select sum(gudangbarang.stok),(sum(gudangbarang.stok)*" + hppfarmasi
                            + ") as aset,gudangbarang." + hppfarmasi + " as harga "
                            + "from gudangbarang inner join databarang on gudangbarang.kode_brng=databarang.kode_brng "
