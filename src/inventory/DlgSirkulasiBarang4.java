...
public class DlgSirkulasiBarang4 extends javax.swing.JDialog {
    ...
    public DlgSirkulasiBarang4(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Pengadaan", "Penerimaan", "Penjualan",
            "Ke Pasien", "Piutang Jual", "Retur Beli", "Retur Jual",
            "Retur Piutang", "Pengambilan UTD",
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (lokasi.isEmpty()) {
                Valid.MyReportqry("rptSirkulasi7.jasper", "report",
                        "::[ Sirkulasi Barang ]::",
                ...
                Valid.MyReportqry("rptSirkulasi8.jasper", "report",
                        "::[ Sirkulasi Barang ]::",
                        "select * from temporary where temporary.temp37='" + akses.
                                getalamatip() + "' order by temporary.no", param);
            }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSirkulasiBarang4 dialog = new DlgSirkulasiBarang4(
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    ps2 = koneksi.prepareStatement(
                            "select sum(opname.real),(opname.real*opname.h_beli),count(opname.real) from opname where kode_brng=? and tanggal=?");
                    try {
                        ps2.setString(1, rs.getString(1));
                        ps2.setString(2, tglopname);
                        rs2 = ps2.executeQuery();
                    ...
                    if ((jumlahbeli > 0) || (jumlahpesan > 0) || (jumlahjual > 0) || (jumlahpasin > 0) || (jumlahpiutang > 0) || (jumlahhibah > 0)
                        ...
                        tabMode.addRow(new Object[]{
                            ...
                            tglopname, Valid.SetAngka(stokawal) + " (" + Valid.
                            SetAngka(totalstokawal) + ")",
                            Valid.SetAngka(jumlahbeli) + " (" + Valid.SetAngka(
                            totalbeli) + ")",
                            Valid.SetAngka(jumlahpesan) + " (" + Valid.SetAngka(
                            totalpesan) + ")",
                            Valid.SetAngka(jumlahjual) + " (" + Valid.SetAngka(
                            totaljual) + ")",
                            Valid.SetAngka(jumlahpasin) + " (" + Valid.SetAngka(
                            totalpasin) + ")",
                            Valid.SetAngka(jumlahpiutang) + " (" + Valid.
                            SetAngka(totalpiutang) + ")", Valid.SetAngka(
                            jumlahretbeli) + " (" + Valid.SetAngka(totalretbeli) + ")",
                            Valid.SetAngka(jumlahretjual) + " (" + Valid.
                            SetAngka(totalretjual) + ")", Valid.SetAngka(
                            jumlahretpiut) + " (" + Valid.SetAngka(totalretpiut) + ")",
                            Valid.SetAngka(jumlahutd) + " (" + Valid.SetAngka(
                            totalutd) + ")",
                            Valid.SetAngka(jumlahkeluar) + " (" + Valid.
                            SetAngka(totalkeluar) + ")",
                            Valid.SetAngka(jumlahrespulang) + " (" + Valid.
                            SetAngka(totalrespulang) + ")", Valid.SetAngka(
                            jumlahmutasimasuk) + " (" + Valid.SetAngka(
                            totalmutasimasuk) + ")",
                            Valid.SetAngka(jumlahmutasikeluar) + " (" + Valid.
                            SetAngka(totalmutasikeluar) + ")", Valid.SetAngka(
                            jumlahhibah) + " (" + Valid.SetAngka(totalhibah) + ")",
            ...
            tabMode.addRow(new Object[]{
                ...
                Valid.SetAngka(ttltotalkeluar), Valid.
                SetAngka(ttltotalrespulang),
                Valid.SetAngka(ttltotalmutasimasuk), Valid.SetAngka(
                ttltotalmutasikeluar), Valid.SetAngka(ttltotalhibah), Valid.
                SetAngka(ttltotalstokakhir)
            });
        } catch (Exception e) {
    ...
    private void prosesCari2(String lokasi) {
        ...
        try {
            ...
            try {
                ...
                if (aktifkanbatch.equals("yes")) {
                    qrystok = "select sum(gudangbarang.stok),(sum(gudangbarang.stok)*" + hppfarmasi + ") as aset,gudangbarang." + hppfarmasi + " as harga "
                            + "from gudangbarang inner join databarang on gudangbarang.kode_brng=databarang.kode_brng "
                ...
                while (rs.next()) {
                    ...
                    ps2 = koneksi.prepareStatement(
                            "select sum(opname.real),(opname.real*opname.h_beli) from opname where kode_brng=? and tanggal=? and kd_bangsal=?");
                    try {
                        ps2.setString(1, rs.getString(1));
                        ps2.setString(2, tglopname);
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgSirkulasiBarang4.class.getName());
