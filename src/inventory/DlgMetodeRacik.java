 ...
 * @author dosen
 */
public class DlgMetodeRacik extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("metode_racik", "'" + Kd.getText() + "','" + Nm.
                    getText() + "'", "Kode Racik");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbKamar.getRowCount(); i++) {
            if (tbKamar.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("metode_racik", "kd_racik", tbKamar.
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Valid.editTable(tabMode, "metode_racik", "kd_racik", "?",
                    "nm_racik=?,kd_racik=?", 3, new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptMetodeRacik.jasper", "report",
                    "::[ Data Racik ]::", "select kd_racik, nm_racik "
                    + " from metode_racik where  kd_racik like '%" + TCari.
                            getText().trim() + "%' or "
...
private void NmKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select kd_racik,nm_racik  " + " from metode_racik where  kd_racik like ? or "
    ...
    private static final Logger LOG = Logger.getLogger(DlgMetodeRacik.class.getName());
