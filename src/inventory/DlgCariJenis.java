 ...
 * @author dosen
 */
public class DlgCariJenis extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariJenis dialog = new DlgCariJenis(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select * from jenis order by jenis.nama ");
            try {
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(
                            new String[]{rs.getString(1), rs.getString(2),
                                rs.getString(3)});
                    iyem = iyem + "{\"KodeJenis\":\"" + rs.getString(1) + "\",\"NamaJenis\":\"" + rs.
                            getString(2) + "\",\"Keterangan\":\"" + rs.
                            getString(3) + "\"},";
                }
            } catch (Exception e) {
            ...
            fileWriter.write("{\"jenisobat\":[" + iyem.substring(0, iyem.
                    length() - 1) + "]}");
            fileWriter.flush();
            fileWriter.close();
            iyem = null;
                ...
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{
                            list.path("KodeJenis").asText(), list.path(
                            "NamaJenis").asText(), list.path("Keterangan").
                            asText()
                        });
                    }
                } else {
                    for (JsonNode list : response) {
                        if (list.path("NamaJenis").asText().toLowerCase().
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariJenis.class.
            getName());
}
