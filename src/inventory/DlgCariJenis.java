...
public class DlgCariJenis extends javax.swing.JDialog {
            ...
            if (response.isArray()) {
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{list.path("KodeJenis").asText(), list.path("NamaJenis").asText(),
                            list.path("Keterangan").asText()});
                    }
                } else {
                    for (JsonNode list : response) {
                        if (list.path("NamaJenis").asText().toLowerCase().contains(TCari.getText().toLowerCase())) {
                            tabMode.addRow(new Object[]{list.path("KodeJenis").asText(),
                                list.path("NamaJenis").asText(), list.path("Keterangan").asText()});
                        }
                    }
                }
            }
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariJenis.class.getName());
