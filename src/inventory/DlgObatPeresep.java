...
public class DlgObatPeresep extends javax.swing.JDialog {
    ...
    public DlgObatPeresep(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.", "Kode", "Nama", "Jml", "Satuan", "Harga", "Subtotal"}) {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (i = 0; i < tabMode.getRowCount(); i++) {
                ...
                Harga = "";
                try {
                    Harga = Valid.SetAngka(Double.parseDouble(tabMode.
                ...
                Subtotal = "";
                try {
                    Subtotal = Valid.SetAngka(Double.parseDouble(tabMode.
                ...
                Sequel.menyimpan("temporary",
                        "'" + i + "','" + No + "','" + Kode + "','" + Nama + "','" + Jml + "','" + Satuan + "','" + Harga + "','" + Subtotal + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
            ...
            Valid.MyReportqry("rptObatPerResep.jasper", "report",
                    "[ Rekap Obat Per Resep ]",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void prosesCari() {
        try {
            ...
            try {
                ...
                total = 0;
                while (rs.next()) {
                    tabMode.addRow(new Object[]{i, "No.Resep : " + rs.getString("no_resep"),
                        rs.getString("nm_pasien"), null, null, null, null});
                    tabMode.addRow(new Object[]{null, null, "No.Rawat : " + rs.getString("no_rawat"), null, null,
                        null, null});
                    tabMode.addRow(new Object[]{null, null, "Tgl.Resep : " + rs.getString("tgl_perawatan"), null,
                        null, null, null});
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new Object[]{null, rs2.getString("kode_brng"), rs2.getString("nama_brng"),
                                rs2.getDouble("jml"), rs2.getString("kode_sat"), rs2.getDouble("biaya_obat"),
                                rs2.getDouble("total")});
            ...
            tabMode.addRow(new Object[]{null, null, null, null, null, null, null});
            tabMode.addRow(new Object[]{">>", "TOTAL", null, null, null, null, total});
            this.setCursor(Cursor.getDefaultCursor());
        } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgObatPeresep.class.getName());
