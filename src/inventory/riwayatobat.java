...
public class riwayatobat {
     ...
     * @param keterangan
     */
    public void catatRiwayat(String kodebarang, double masuk, double keluar, String posisi, String petugas,
            String kdbangsal, String status, String nobatch, String nofaktur, String keterangan) {
        try {
            stokakhir = 0;
            stokawal = 0;
            psawal = koneksi.prepareStatement(
            ...
            ps = koneksi.prepareStatement(
                    "insert into riwayat_barang_medis values(?,?,?,?,?,?,current_date(),current_time(),?,?,?,?,?,?)");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(riwayatobat.class.getName());
