 ...
 * @author dosen
 */
public class DlgGolongan extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("golongan_barang", "'" + Kd.getText() + "','" + Nm.
                    getText() + "'", "Kode Golongan");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbKamar.getRowCount(); i++) {
            if (tbKamar.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("golongan_barang", "kode", tbKamar.getValueAt(i,
                        1).toString());
            }
        }
        BtnCariActionPerformed(evt);
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Valid.editTable(tabMode, "golongan_barang", "kode", "?",
                    "nama=?,kode=?", 3, new String[]{
                        Nm.getText(), Kd.getText(), tbKamar.getValueAt(tbKamar.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptGolongan.jasper", "report",
                    "::[ Data Golongan ]::", "select kode, nama "
                    + " from golongan_barang where  kode like '%" + TCari.
                            getText().trim() + "%' or "
...
private void NmKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select kode,nama  " + " from golongan_barang where  kode like ? or "
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    Object[] data = {false, rs.getString(1), rs.getString(2)};
                    tabMode.addRow(data);
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgGolongan.class.getName());
