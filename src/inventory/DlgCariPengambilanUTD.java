 ...
 * @author dosen
 */
public class DlgCariPengambilanUTD extends javax.swing.JDialog {
    ...
    public DlgCariPengambilanUTD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Kode Barang", "Nama Barang", "Jml", "Harga", "Subtotal",
            "Dari", "", "Tanggal", "Keterangan", "No.Batch", "No.Faktur"}) {
            @Override
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            sukses = true;
            if (Sequel.queryutf(
                    "delete from utd_pengambilan_medis where kode_brng='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 0) + "' "
                    + "and kd_bangsal_dr='" + tbKamar.getValueAt(tbKamar.
                            getSelectedRow(), 6) + "' "
                    ...
                    + "and no_faktur='" + tbKamar.getValueAt(tbKamar.
                            getSelectedRow(), 10) + "' ") == true) {
                Sequel.menyimpan("utd_stok_medis", "'" + tbKamar.getValueAt(
                        tbKamar.getSelectedRow(), 0) + "',"
                        + "'-" + tbKamar.getValueAt(tbKamar.getSelectedRow(), 2) + "','" + tbKamar.
                ...
                if (aktifkanbatch.equals("yes")) {
                    ...
                    Sequel.menyimpan("gudangbarang", "'" + tbKamar.getValueAt(
                            ...
                            "stok=stok+" + tbKamar.getValueAt(tbKamar.
                                    getSelectedRow(), 2),
                            "kode_brng='" + tbKamar.getValueAt(tbKamar.
                                    getSelectedRow(), 0) + "' and "
                            + "kd_bangsal='" + tbKamar.getValueAt(tbKamar.
                                    getSelectedRow(), 6) + "' "
                            + "and no_batch='" + tbKamar.getValueAt(tbKamar.
                                    getSelectedRow(), 9) + "' "
                            + "and no_faktur='" + tbKamar.getValueAt(tbKamar.
            ...
            if (sukses == true) {
                ...
                Sequel.menyimpan("tampjurnal", "?,?,?,?", 4, new String[]{
                    ...
                    "PENGAMBILAN BHP MEDIS UTD", "0", "" + tbKamar.getValueAt(
                    tbKamar.getSelectedRow(), 4)});
                Sequel.menyimpan("tampjurnal", "?,?,?,?", 4, new String[]{
                    Sequel.
                    cariIsi("select Kontra_Pengambilan_Utd from set_akun"),
                    "PERSEDIAAN BARANG/OBAT/ALKES/BHP", "" + tbKamar.getValueAt(
                    tbKamar.getSelectedRow(), 4), "0"});
                sukses = jur.simpanJurnal(DTPCari1.getSelectedItem().toString(),
                        "U",
                        "PEMBATALAN PENGAMBILAN BHP MEDIS UTD DARI " + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 5) + ", OLEH " + akses.
                        getkode());
            }
...
private void BtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCetakActionPerformed
    ...
    if (tabMode.getRowCount() == 0) {
        ...
        Valid.MyReportqry("rptPengambilanUTD.jasper", "report",
                "::[ Transaksi Pengambilan BHP Medis UTD ]::",
                ...
                + "where utd_pengambilan_medis.tanggal between '" + Valid.
                        SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and utd_pengambilan_medis.kode_brng like '%" + TCari.
                getText().trim() + "%' or "
                + "utd_pengambilan_medis.tanggal between '" + Valid.SetTgl(
                        DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and databarang.nama_brng like '%" + TCari.
                getText().trim() + "%' or "
                + "utd_pengambilan_medis.tanggal between '" + Valid.SetTgl(
                        DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and utd_pengambilan_medis.kd_bangsal_dr like '%" + TCari.
                getText().trim() + "%' or "
                + "utd_pengambilan_medis.tanggal between '" + Valid.SetTgl(
                        DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and bangsal.nm_bangsal like '%" + TCari.
                getText().trim() + "%' or "
                + "utd_pengambilan_medis.tanggal between '" + Valid.SetTgl(
                        DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.
                SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and utd_pengambilan_medis.keterangan like '%" + TCari.
                getText().trim() + "%' order by utd_pengambilan_medis.tanggal",
                param);
...
// TODO add your handling code here:
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kode_brng"),
                        ...
                        rs.getString("hargabeli"), rs.getString("total"),
                        rs.getString("kd_bangsal_dr") + " " + rs.getString("nm_bangsal"),
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariPengambilanUTD.class.getName());
