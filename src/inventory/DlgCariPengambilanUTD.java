...
public class DlgCariPengambilanUTD extends javax.swing.JDialog {
    ...
    public DlgCariPengambilanUTD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "Kode Barang", "Nama Barang", "Jml", "Harga", "Subtotal", "Dari", "",
            "Tanggal", "Keterangan", "No.Batch", "No.Faktur"
        }) {
            @Override
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPengambilanUTD dialog = new DlgCariPengambilanUTD(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("nama_brng") + " (" + rs.getString(
                        "kode_sat") + ")",
                        rs.getString("jml"), rs.getString("hargabeli"),
                        rs.getString("total"),
                        rs.getString("kd_bangsal_dr") + " " + rs.getString(
                        "nm_bangsal"),
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgCariPengambilanUTD.class.getName());
