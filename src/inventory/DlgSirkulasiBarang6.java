...
public class DlgSirkulasiBarang6 extends javax.swing.JDialog {
    ...
    private double jumlahjual = 0, jumlahbeli = 0, jumlahpesan = 0, jumlahpiutang = 0, jumlahutd = 0, jumlahkeluar = 0,
            ...
            jumlahpasin = 0, jumlahrespulang = 0, jumlahhibah = 0, stokawal = 0, stokakhir = 0, totaljual = 0,
            ...
            totalrespulang = 0, totalhibah = 0, totalstokawal = 0, totalstokakhir = 0, ttltotaljual = 0,
            ...
            ttltotalretpiut = 0, ttltotalpasin = 0, ttltotalrespulang = 0, ttltotalhibah = 0, ttltotalstokawal = 0,
            ttltotalstokakhir = 0, harga = 0;
    ...
    public DlgSirkulasiBarang6(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Barang", "No.Batch", "No.Faktur", "Nama Barang", "Satuan", "Tgl.Awal", "Stok Awal",
                    "Stok Awal(Rp)", "Pengadaan", "Pengadaan(Rp)", "Penerimaan", "Penerimaan(Rp)", "Penjualan",
                    "Penjualan(Rp)", "Ke Pasien", "Ke Pasien(Rp)", "Piutang Jual", "Piutang Jual(Rp)", "Retur Beli",
    ...
    private void prosesCari() {
        if (KdGudang.getText().isEmpty()) {
            ...
            try {
                ...
                ttltotalstokakhir = 0;
                ps = koneksi
                        .prepareStatement("select databarang.kode_brng,databarang.nama_brng,kodesatuan.satuan,databarang."
                                + hppfarmasi + " as harga "
                        ...
                        try {
                            ...
                            while (rs2.next()) {
                                ...
                                harga = Sequel.cariIsiAngka("select data_batch." + hppfarmasi
                                        + " from data_batch where data_batch.kode_brng='" + rs.getString("kode_brng")
                                        + "' and data_batch.no_batch='" + rs2.getString("no_batch")
                                        + "' and data_batch.no_faktur='" + rs2.getString("no_faktur") + "' ");
                                if (harga <= 0) {
                                ...
                                if ((jumlahbeli > 0) || (jumlahpesan > 0) || (jumlahjual > 0) || (jumlahpasin > 0)
                                        ...
                                        || (jumlahmutasikeluar > 0) || (jumlahutd > 0) || (jumlahkeluar > 0)
                                        || (jumlahretbeli > 0) || (jumlahretjual > 0) || (jumlahretpiut > 0)
                                        || (stokawal > 0) || (stokakhir > 0) || (jumlahrespulang > 0)) {
                                    tabMode.addRow(new String[]{rs.getString("kode_brng"), rs2.getString("no_batch"),
                                        rs2.getString("no_faktur"), rs.getString("nama_brng"),
                                        rs.getString("satuan"), tglopname, Valid.SetAngka(stokawal),
                                        Valid.SetAngka(totalstokawal), Valid.SetAngka(jumlahbeli),
                                        Valid.SetAngka(totalbeli), Valid.SetAngka(jumlahpesan),
                                        Valid.SetAngka(totalpesan), Valid.SetAngka(jumlahjual),
                                        Valid.SetAngka(totaljual), Valid.SetAngka(jumlahpasin),
                                        Valid.SetAngka(totalpasin), Valid.SetAngka(jumlahpiutang),
                                        Valid.SetAngka(totalpiutang), Valid.SetAngka(jumlahretbeli),
                                        Valid.SetAngka(totalretbeli), Valid.SetAngka(jumlahretjual),
                                        Valid.SetAngka(totalretjual), Valid.SetAngka(jumlahretpiut),
                                        Valid.SetAngka(totalretpiut), Valid.SetAngka(jumlahutd),
                                        Valid.SetAngka(totalutd), Valid.SetAngka(jumlahkeluar),
                                        Valid.SetAngka(totalkeluar), Valid.SetAngka(jumlahrespulang),
                                        Valid.SetAngka(totalrespulang), Valid.SetAngka(jumlahmutasimasuk),
                                        Valid.SetAngka(totalmutasimasuk), Valid.SetAngka(jumlahmutasikeluar),
                                        Valid.SetAngka(totalmutasikeluar), Valid.SetAngka(jumlahhibah),
                                        Valid.SetAngka(totalhibah), Valid.SetAngka(stokakhir),
                ...
                tabMode.addRow(new Object[]{"<>>", "Total :", "", "", "", "", "", Valid.SetAngka(ttltotalstokawal),
                    ...
                    Valid.SetAngka(ttltotaljual), "", Valid.SetAngka(ttltotalpasin), "",
