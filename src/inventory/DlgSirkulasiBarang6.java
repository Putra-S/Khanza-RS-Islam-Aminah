...
public class DlgSirkulasiBarang6 extends javax.swing.JDialog {
    ...
    public DlgSirkulasiBarang6(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "Kode Barang", "No.Batch", "No.Faktur", "Nama Barang", "Satuan",
            "Tgl.Awal", "Stok Awal", "Stok Awal(Rp)", "Pengadaan",
            "Pengadaan(Rp)",
...
*/
                    ...
                    case "Laporan 1 (HTML)":
                        ...
                        for (i = 0; i < tabMode.getRowCount(); i++) {
                            htmlContent.append(
                                    ...
                                    append(tabMode.getValueAt(i, 6)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 7)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 8)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 9)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 10)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 11)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 12)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 13)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 14)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 15)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 16)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 17)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 18)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 19)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 20)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 21)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 22)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 23)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 24)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 25)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 26)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 27)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 28)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 29)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 30)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 31)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 32)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 33)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 34)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 35)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 36)).append(
                                    "</td><td valign='top' align='right'>").
                                    append(tabMode.getValueAt(i, 37)).append(
                                    "</td></tr>");
                        }
                        ...
                        bw.write("<html>"
                                ...
                                getemailrs() + "<br><br>"
                                + "<font size='2' face='Tahoma'>SIRKULASI OBAT/ALKES/BHP PERIODE " + Tgl1.
                    ...
                    case "Laporan 3 (CSV)":
                        ...
                        for (i = 0; i < tabMode.getRowCount(); i++) {
                            htmlContent.append("\"").append(tabMode.
                                    ...
                                    append(tabMode.getValueAt(i, 32)).append(
                                    "\";\"").append(tabMode.getValueAt(i, 33)).
                                    append("\";\"").append(tabMode.getValueAt(i,
                                    34)).append("\";\"").append(tabMode.
                                    getValueAt(i, 35)).append("\";\"").append(
                                    tabMode.getValueAt(i, 36)).append("\";\"").
                                    append(tabMode.getValueAt(i, 37)).append(
                                    "\"\n");
                        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSirkulasiBarang6 dialog = new DlgSirkulasiBarang6(
        ...
        if (KdGudang.getText().isEmpty()) {
            ...
            try {
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            while (rs2.next()) {
                                ...
                                try {
                                    ps3.setString(1, Valid.SetTgl(Tgl1.
                                            getSelectedItem() + ""));
                                    ...
                                    if (rs3.next()) {
                                        tglopname = rs3.getString("tanggal") + " " + rs3.
                                                getString("jam");
                                ...
                                harga = Sequel.cariIsiAngka(
                                        "select data_batch." + hppfarmasi + " from data_batch where data_batch.kode_brng='" + rs.
                                                getString("kode_brng") + "' and data_batch.no_batch='" + rs2.
                                        getString("no_batch") + "' and data_batch.no_faktur='" + rs2.
                                        getString("no_faktur") + "' ");
                                if (harga <= 0) {
                                ...
                                try {
                                    ...
                                    ps3.setString(5, Valid.SetTgl(Tgl2.
                                            getSelectedItem() + ""));
                                ...
                                ps3 = koneksi.prepareStatement(
                                        ...
                                        + "order by concat(riwayat_barang_medis.tanggal,' ',riwayat_barang_medis.jam) desc limit 1");
                                try {
                                    ps3.setString(1, Valid.SetTgl(Tgl2.
                                ...
                                if ((jumlahbeli > 0) || (jumlahpesan > 0) || (jumlahjual > 0) || (jumlahpasin > 0) || (jumlahpiutang > 0) || (jumlahhibah > 0) || (jumlahmutasimasuk > 0) || (jumlahmutasikeluar > 0)
                                    ...
                                    tabMode.addRow(new String[]{
                                        rs.getString("kode_brng"), rs2.
                                        getString("no_batch"), rs2.getString(
                                        "no_faktur"), rs.getString("nama_brng"),
                                        rs.getString("satuan"),
                                        tglopname, Valid.SetAngka(stokawal),
                                        Valid.SetAngka(totalstokawal), Valid.
                                        SetAngka(jumlahbeli), Valid.SetAngka(
                                        totalbeli),
                                        Valid.SetAngka(jumlahpesan), Valid.
                                        SetAngka(totalpesan), Valid.SetAngka(
                                        jumlahjual), Valid.SetAngka(totaljual),
                                        Valid.SetAngka(jumlahpasin), Valid.
                                        SetAngka(totalpasin), Valid.SetAngka(
                                        jumlahpiutang), Valid.SetAngka(
                                        totalpiutang),
                                        Valid.SetAngka(jumlahretbeli), Valid.
                                        SetAngka(totalretbeli), Valid.SetAngka(
                                        jumlahretjual), Valid.SetAngka(
                                        totalretjual),
                                        Valid.SetAngka(jumlahretpiut), Valid.
                                        SetAngka(totalretpiut), Valid.SetAngka(
                                        jumlahutd), Valid.SetAngka(totalutd),
                                        Valid.SetAngka(jumlahkeluar), Valid.
                                        SetAngka(totalkeluar), Valid.SetAngka(
                                        jumlahrespulang), Valid.SetAngka(
                                        totalrespulang),
                                        Valid.SetAngka(jumlahmutasimasuk),
                                        Valid.SetAngka(totalmutasimasuk), Valid.
                                        SetAngka(jumlahmutasikeluar), Valid.
                                        SetAngka(totalmutasikeluar),
                                        Valid.SetAngka(jumlahhibah), Valid.
                                        SetAngka(totalhibah), Valid.SetAngka(
                                        stokakhir), Valid.SetAngka(
                                        totalstokakhir)
                                    });
                ...
                tabMode.addRow(new Object[]{
                    ...
                    ttltotalstokawal), "", Valid.SetAngka(ttltotalbeli), "",
                    Valid.SetAngka(ttltotalpesan), "", Valid.SetAngka(
                    ttltotaljual),
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgSirkulasiBarang6.class.getName());
