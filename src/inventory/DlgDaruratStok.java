...
//GEN-FIRST:event_TKdKeyPressed
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptDaruratStok.jasper", "report",
                    "::[ Darurat Stok Obat/BHP/Alkes ]::",
                ...
                while (rs.next()) {
                    ...
                    if (stok <= rs.getDouble("stokminimal")) {
                        tabMode.addRow(new Object[]{rs.getString("kode_brng"), rs.getString("nama_brng"),
                            rs.getString("satuan"), rs.getString("nama"), rs.getDouble("stokminimal"), stok});
                    }
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgDaruratStok.class.getName());
