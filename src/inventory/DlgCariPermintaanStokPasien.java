...
public class DlgCariPermintaanStokPasien extends javax.swing.JDialog {
    ...
    public DlgCariPermintaanStokPasien(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.Permintaan", "Tanggal", "Jam", "No.Rawat", "No.RM", "Pasien", "Dokter Yang Meminta",
            "Kode Dokter"};
    ...
    private void BtnKeluarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnKeluarKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, DTPCari1, BtnHapus);
        }
...
//GEN-FIRST:event_TKdKeyPressed
    private void ChkTanggalItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-LAST:event_TKdKeyPressed
        tampil();//GEN-FIRST:event_ChkTanggalItemStateChanged
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            JOptionPane.showMessageDialog(null,
                    "Maaf, Silahkan pilih data permintaan dokter..!!");
        } else {
            if (tbPemisahan.getValueAt(tbPemisahan.getSelectedRow(), 0).
                    toString().isEmpty()) {
                JOptionPane.showMessageDialog(rootPane,
                        "Silahkan pilih No.Permintaan yang mau dihapus ..!!");
            } else {
                Sequel.meghapus("permintaan_stok_obat_pasien", "no_permintaan",
    ...
    public void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_permintaan"), rs.getString("tgl_permintaan"),
                        rs.getString("jam"), rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        rs.getString("nm_pasien"), rs.getString("nm_dokter"), rs.getString("kd_dokter")});
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new String[]{"", rs2.getString("jml"), rs2.getString("kode_sat"),
                                rs2.getString("kode_brng"), rs2.getString("nama_brng"),
                                "00 : " + rs2.getString("jam00").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "01 : "
                                + rs2.getString("jam01").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "02 : "
                                + rs2.getString("jam02").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "03 : "
                                + rs2.getString("jam03").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "04 : "
                                + rs2.getString("jam04").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "05 : "
                                + rs2.getString("jam05").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "06 : "
                                + rs2.getString("jam06").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "07 : "
                                + rs2.getString("jam07").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "08 : "
                                + rs2.getString("jam08").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "09 : "
                                + rs2.getString("jam09").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "10 : "
                                + rs2.getString("jam10").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "11 : "
                                + rs2.getString("jam11").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "12 : "
                                + rs2.getString("jam12").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "13 : "
                                + rs2.getString("jam13").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "14 : "
                                + rs2.getString("jam14").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "15 : "
                                + rs2.getString("jam15").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "16 : "
                                + rs2.getString("jam16").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "17 : "
                                + rs2.getString("jam17").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "18 : "
                                + rs2.getString("jam18").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "19 : "
                                + rs2.getString("jam19").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "20 : "
                                + rs2.getString("jam20").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "21 : "
                                + rs2.getString("jam21").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "22 : "
                                + rs2.getString("jam22").replaceAll("true", "V").replaceAll("false", "X")
                                + "  " + "23 : "
                                + rs2.getString("jam23").replaceAll("true", "V").replaceAll("false", "X")
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariPermintaanStokPasien.class.getName());
