...
public class DlgCariPermintaanStokPasien extends javax.swing.JDialog {
    ...
    public DlgCariPermintaanStokPasien(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.Permintaan", "Tanggal", "Jam", "No.Rawat", "No.RM",
            "Pasien", "Dokter Yang Meminta", "Kode Dokter"};
...
*/
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPermintaanStokPasien dialog = new DlgCariPermintaanStokPasien(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        "tgl_permintaan"), rs.getString("jam"), rs.getString(
                        "no_rawat"),
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new String[]{
                                ...
                                "kode_sat"), rs2.getString("kode_brng"), rs2.
                                getString("nama_brng"),
                                "00 : " + rs2.getString("jam00").replaceAll(
                                "true", "V").replaceAll("false", "X") + "  "
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgCariPermintaanStokPasien.class.getName());
}
