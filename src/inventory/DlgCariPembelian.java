...
public class DlgCariPembelian extends javax.swing.JDialog {
    ...
    private String aktifkanbatch = "no", akunpengadaan = Sequel.cariIsi("select set_akun.Pengadaan_Obat from set_akun"),
    ...
    public DlgCariPembelian(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Tgl.Beli", "No.Faktur", "Suplier", "Petugas", "Barang", "Satuan", "Jml", "Harga Beli(Rp)",
...
//GEN-FIRST:event_TKdKeyPressed
    private void btnSuplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        akses.setform("DlgCariPembelian");//GEN-FIRST:event_btnSuplierActionPerformed
        suplier.emptTeks();
        suplier.isCek();
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptPembelian.jasper", "report",
                    "::[ Transaksi Pembelian Obat/BHP/Alkes ]::",
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
            ...
            try {
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        sukses = true;
                        psdetailbeli = koneksi.prepareStatement(
                                "select detailbeli.kode_brng,detailbeli.jumlah2,detailbeli.no_batch,detailbeli.no_faktur from detailbeli where detailbeli.no_faktur=? ");
                        try {
                        ...
                        if (sukses == true) {
                            ...
                            Sequel.
                                    menyimpan("tampjurnal", "?,?,?,?",
                                        ...
                                        akunpengadaan, "PENGADAAN OBAT", "0",
                                        rs.getString("total2")
                                    });
                            if (rs.getDouble("ppn") > 0) {
                                Sequel.menyimpan("tampjurnal", "?,?,?,?",
                                        "Rekening", 4, new String[]{
                                            PPN_Masukan, "PPN Masukan Obat", "0",
                                            rs.getString("ppn")
                                        });
                            }
                            Sequel.
                                    menyimpan("tampjurnal", "?,?,?,?",
                                            "Rekening", 4, new String[]{
                                        rs.getString("kd_rek"), "AKUN BAYAR",
                                        rs.getString("tagihan"), "0"
                                    });
                            sukses = jur.simpanJurnal(rs.getString("no_faktur"),
                                    "U", "BATAL PEMBELIAN DI " + Sequel.cariIsi(
                        ...
                        if (sukses == true) {
                            Sequel.queryu2(
                                    "delete from pembelian where no_faktur=?", 1,
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select pembelian.tgl_beli,pembelian.no_faktur, "
                    ...
                    + " and detailbeli.kode_sat=kodesatuan.kode_sat " + " and pembelian.kd_bangsal=bangsal.kd_bangsal "
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        tabMode.addRow(new Object[]{"", "", "", "", "", "Total", ":", "",
                            Valid.SetAngka(rs.getDouble("total1")), "", Valid.SetAngka(rs.getDouble("potongan")),
                        ...
                        tagihan += Sequel.cariIsiAngka("select tagihan from pembelian where no_faktur=?",
                                rs.getString(2));
                    } catch (Exception e) {
                        System.out.println("Notifikasi : " + e);
                    } finally {
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariPembelian.class.getName());
