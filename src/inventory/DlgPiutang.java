...
public class DlgPiutang extends javax.swing.JDialog {
    ...
    public DlgPiutang(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Kode Barang", "Nama Barang", "Satuan", "Harga(Rp)",
            "Jml",
            "Subtotal(Rp)", "Diskon(%)", "Diskon(Rp)", "Total(Rp)", "No.Batch",
            "No.Faktur", "Aturan Pakai"};
        ...
        Jmljual.getDocument().addDocumentListener(
        ...
        Tambah.getDocument().addDocumentListener(
                new javax.swing.event.DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                isHitung();
        ...
        Kurang.getDocument().addDocumentListener(
                new javax.swing.event.DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                isHitung();
        ...
        HrgJual.getDocument().addDocumentListener(
                new javax.swing.event.DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                isHitung();
        ...
        Disc.getDocument().addDocumentListener(
                new javax.swing.event.DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                isDiskon();
        ...
        Bsrdisc.getDocument().addDocumentListener(
                new javax.swing.event.DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                isHitung();
                ...
                if (akses.getform().equals("DlgPiutang")) {
                    if (bangsal.getTable().getSelectedRow() != -1) {
                        ...
                        if (aktifkanbatch.equals("yes")) {
                            Stok.setText(Double.toString(Sequel.cariIsiAngka(
                                    "select gudangbarang.stok from gudangbarang where gudangbarang.kd_bangsal='" + kdgudang.
                                            getText() + "' and kode_brng='" + kdbar.
                                            getText() + "' and no_batch='" + NoBatch.
                                            getText() + "' and no_faktur='" + NoFaktur.
                                            getText() + "'")));
                        } else {
                            Stok.setText(Double.toString(Sequel.cariIsiAngka(
                                    "select gudangbarang.stok from gudangbarang where gudangbarang.kd_bangsal='" + kdgudang.
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPiutang")) {
                    if (form.member.getTable().getSelectedRow() != -1) {
                        kdpasien.setText(form.member.getTable().getValueAt(
                                form.member.getTable().getSelectedRow(), 1).
                                toString());
                        nmpasien.setText(form.member.getTable().getValueAt(
                                form.member.getTable().getSelectedRow(), 2).
                                toString());
                    }
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPiutang")) {
                    if (form.barang.getTable().getSelectedRow() != -1) {
                        kdbar.setText(form.barang.getTable().getValueAt(
                                form.barang.getTable().getSelectedRow(), 1).
                                toString());
                        nmbar.setText(form.barang.getTable().getValueAt(
                                form.barang.getTable().getSelectedRow(), 2).
                                toString());
                        satuanbar.setText(form.barang.getTable().getValueAt(
                                form.barang.getTable().getSelectedRow(), 6).
                                toString());
                        if (hppfarmasi.equals("dasar")) {
                            HrgBeli.setText(form.barang.getTable().getValueAt(
                                    form.barang.getTable().getSelectedRow(), 10).
                                    toString());
                        } else {
                            HrgBeli.setText(form.barang.getTable().getValueAt(
                                    form.barang.getTable().getSelectedRow(), 11).
                                    toString());
                        }

                        if (Jenisjual.getSelectedItem().equals("Jual Bebas")) {
                            HrgJual.setText(form.barang.getTable().getValueAt(
                                    form.barang.getTable().getSelectedRow(), 20).
                                    toString());
                        } else if (Jenisjual.getSelectedItem().
                                equals("Karyawan")) {
                            HrgJual.setText(form.barang.getTable().getValueAt(
                                    form.barang.getTable().getSelectedRow(), 21).
                                    toString());
                        } else if (Jenisjual.getSelectedItem().equals(
                                "Beli Luar")) {
                            HrgJual.setText(form.barang.getTable().getValueAt(
                                    form.barang.getTable().getSelectedRow(), 19).
                                    toString());
                        } else if (Jenisjual.getSelectedItem().equals(
                                "Rawat Jalan")) {
                            HrgJual.setText(form.barang.getTable().getValueAt(
                                    form.barang.getTable().getSelectedRow(), 12).
                                    toString());
                        } else if (Jenisjual.getSelectedItem().equals("Kelas 1")) {
                            HrgJual.setText(form.barang.getTable().getValueAt(
                                    form.barang.getTable().getSelectedRow(), 13).
                                    toString());
                        } else if (Jenisjual.getSelectedItem().equals("Kelas 2")) {
                            HrgJual.setText(form.barang.getTable().getValueAt(
                                    form.barang.getTable().getSelectedRow(), 14).
                                    toString());
                        } else if (Jenisjual.getSelectedItem().equals("Kelas 3")) {
                            HrgJual.setText(form.barang.getTable().getValueAt(
                                    form.barang.getTable().getSelectedRow(), 15).
                                    toString());
                        } else if (Jenisjual.getSelectedItem().equals("Utama")) {
                            HrgJual.setText(form.barang.getTable().getValueAt(
                                    form.barang.getTable().getSelectedRow(), 16).
                                    toString());
                        } else if (Jenisjual.getSelectedItem().equals("VIP")) {
                            HrgJual.setText(form.barang.getTable().getValueAt(
                                    form.barang.getTable().getSelectedRow(), 17).
                                    toString());
                        } else if (Jenisjual.getSelectedItem().equals("VVIP")) {
                            HrgJual.setText(form.barang.getTable().getValueAt(
                                    form.barang.getTable().getSelectedRow(), 18).
                                    toString());
                        } else if (Jenisjual.getSelectedItem().equals(
                                "Harga Beli")) {
                            HrgJual.setText(form.barang.getTable().getValueAt(
                        ...
                        if (aktifkanbatch.equals("yes")) {
                            NoBatch.setText(form.barang.getTable().getValueAt(
                                    form.barang.getTable().getSelectedRow(), 32).
                                    toString());
                            NoFaktur.setText(form.barang.getTable().getValueAt(
                                    form.barang.getTable().getSelectedRow(), 33).
                                    toString());
                            Stok.setText(Double.toString(Sequel.cariIsiAngka(
                                    "select gudangbarang.stok from gudangbarang where gudangbarang.kd_bangsal='" + kdgudang.
                                            getText() + "' and gudangbarang.kode_brng='" + kdbar.
                                            getText() + "' and gudangbarang.no_batch='" + NoBatch.
                                            getText() + "' and gudangbarang.no_faktur='" + NoFaktur.
                                            getText() + "'")));
                        } else {
                            Stok.setText(Double.toString(Sequel.cariIsiAngka(
                                    "select gudangbarang.stok from gudangbarang where gudangbarang.kd_bangsal='" + kdgudang.
                                            getText() + "' and gudangbarang.kode_brng='" + kdbar.
                                            getText() + "' and gudangbarang.no_batch='' and gudangbarang.no_faktur=''")));
                        }
        ...
        aturan_pakai.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (aturan_pakai.getTable().getSelectedRow() != -1) {
                    Aturan.setText(aturan_pakai.getTable().getValueAt(
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        if (aktifkanbatch.equals("yes") && NoFaktur.getText().isEmpty()) {
            Valid.textKosong(NoFaktur, "No.Faktur");
        } else if (aktifkanbatch.equals("yes") && NoBatch.getText().isEmpty()) {
            Valid.textKosong(NoBatch, "No.Batch");
        } else if (nmbar.getText().trim().isEmpty()) {
            Valid.textKosong(kdbar, "barang");
        } else if (Jmljual.getText().trim().isEmpty() || Jmljual.getText().
                trim().equals("0")) {
            Valid.textKosong(Jmljual, "jumlah barang");
        } else if (Disc.getText().trim().isEmpty() || Bsrdisc.getText().trim().
                isEmpty()) {
            Valid.textKosong(kdbar, "barang");
        } else {
            try {
                ...
                if (jumlah > stok) {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Maaf, stok tidak mencukupi. Maksimal yang bisa diretur " + stok + " " + satuanbar.
                                    getText());
                } else {
                    if (Sequel.menyimpantf("tamppiutang",
                            "'" + kdbar.getText() + "','" + nmbar.getText() + "','" + satuanbar.
                            getText() + "','" + HrgJual.getText() + "','" + HrgBeli.
                            getText() + "','" + Jmljual.getText() + "','" + subtotal.
                            getText() + "','" + Disc.getText() + "','" + Bsrdisc.
                            getText() + "','" + Total.getText() + "','" + NoBatch.
                            getText() + "','" + akses.getkode() + "','" + NoFaktur.
                            getText() + "','" + Aturan.getText() + "'",
                            "Kode Barang, No.Batch, No.Faktur") == true) {
                        emptTeks();
                        tampil();
                    }
                }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (nmbar.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null,
                    "Maaf, Pilih dulu data yang akan Anda hapus dengan menklik data pada tabel...!!!");
            tbDokter.requestFocus();
        } else {
            Valid.hapusTable(tabMode, kdbar, "tamppiutang",
                    "no_batch='" + NoBatch.getText() + "' and no_faktur='" + NoFaktur.
                    getText() + "' and petugas='" + akses.getkode() + "' and kode_brng");
            tampil();
            emptTeks();
        }
...
*/
    ...
    private void BtnPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPasienActionPerformed
        ...
        form.member.isCek();
        form.member.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void BtnBrgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBrgActionPerformed
        if (nmgudang.getText().isEmpty()) {
            ...
            form.barang.isCek();
            form.barang.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                    getHeight() - 20);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if (NoNota.getText().trim().isEmpty()) {
        ...
        } else if (UangMuka.getText().trim().isEmpty()) {
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                sukses = true;
                if (Sequel.menyimpantf2("piutang",
                        "'" + NoNota.getText() + "','" + Valid.SetTgl(TglJual.
                        getSelectedItem() + "") + "','" + kdptg.getText() + "','" + kdpasien.
                        getText()
                        + "','" + nmpasien.getText() + "','" + catatan.getText() + "','" + Jenisjual.
                        getSelectedItem() + "','" + ongkir + "','" + uangmuka + "','" + (ttljual + ongkir - uangmuka)
                        + "','Umum','" + Valid.SetTgl(
                                TglTempo.getSelectedItem() + "") + "','" + kdgudang.
                        getText() + "'", "No.Nota") == true) {
                    simpan();
                } else {
                    autoNomor();
                    if (Sequel.menyimpantf2("piutang",
                            "'" + NoNota.getText() + "','" + Valid.SetTgl(
                            TglJual.getSelectedItem() + "") + "','" + kdptg.
                            getText() + "','" + kdpasien.getText()
                            + "','" + nmpasien.getText() + "','" + catatan.
                            getText() + "','" + Jenisjual.getSelectedItem() + "','" + ongkir + "','" + uangmuka + "','" + (ttljual + ongkir - uangmuka)
                            + "','Umum','" + Valid.SetTgl(TglTempo.
                                    getSelectedItem() + "") + "','" + kdgudang.
                                    getText() + "'", "No.Nota") == true) {
                        simpan();
                    } else {
                        autoNomor();
                ...
                if (sukses == true) {
                    ...
                    Sequel.menyimpan2("tampjurnal", "'" + Sequel.cariIsi(
                            "select Piutang_Obat from set_akun") + "','PIUTANG OBAT','" + (ttljual + ongkir - uangmuka) + "','0'",
                            "Rekening");
                    Sequel.menyimpan2("tampjurnal", "'" + Sequel.cariIsi(
                            "select Kontra_Piutang_Obat from set_akun") + "','PERSEDIAAN','0','" + (ttljual + ongkir - uangmuka) + "'",
                            "Rekening");
                    sukses = jur.simpanJurnal(NoNota.getText(), "U",
                            "PIUTANG DI " + nmgudang.getText().toUpperCase() + ", OLEH " + akses.
                            getkode());
                }
                if (sukses == true) {
                    Sequel.Commit();
                        ...
                        switch (pilihanetiket) {
                            case "Cetak Aturan Pakai Model 1":
                                ...
                                if (Sequel.cariInteger(
                                        "select count(*) from detailpiutang where nota_piutang=? and aturan_pakai<>''",
                                        NoNota.getText()) > 0) {
                                    Valid.MyReportqry(
                                            "rptItemResepPiutang.jasper",
                                            "report",
                                            "::[ Aturan Pakai Obat ]::",
                                            ...
                                            + "where piutang.nota_piutang='" + NoNota.
                                                    getText() + "' and detailpiutang.aturan_pakai<>''",
                                            param);
                                }
                                this.setCursor(Cursor.getDefaultCursor());
                                break;
    ...
    private void BtnBatalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBatalActionPerformed
        Sequel.queryu("delete from tamppiutang where petugas='" + akses.
                getkode() + "'");
        tampil();
        Ongkir.setText("0");
        UangMuka.setText("0");
    ...
    private void BtnNotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnNotaActionPerformed
        ...
        if (NoNota.getText().trim().isEmpty()) {
            ...
            Valid.panggilUrl("billing/NotaApotek3.php?nonota=" + NoNota.
                    getText() + "&kdptg=" + kdptg.getText() + "&muka=" + UangMuka.
                    getText() + "&ongkir=" + Ongkir.getText() + "&tanggal=" + Valid.
                    SetTgl(TglJual.getSelectedItem() + "") + "&nm_member=" + nmpasien.
                    getText().replaceAll(" ", "_") + "&tgltempo=" + Valid.
                    SetTgl(TglTempo.getSelectedItem() + "") + "&catatan=" + catatan.
                    getText().replaceAll(" ", "_") + "&usere=" + koneksiDB.
...
private void BtnGudangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGudangActionPerformed
    ...
    private void BtnBrg1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBrg1ActionPerformed
        aturan_pakai.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void isHitung() {
        ...
        if (!HrgJual.getText().trim().isEmpty()) {
            hargajual = Double.parseDouble(HrgJual.getText());
        }

        try {
            if (!Tambah.getText().trim().isEmpty()) {
            ...
            if (e.toString().contains("java.lang.NumberFormatException")) {
                JOptionPane.showMessageDialog(null,
                        "Perhatikan format angka yang dipakai oleh komputer..!!");
            } else {
                JOptionPane.showMessageDialog(null,
                        "Terjadi kesalahan saat menghitung tambah...!!");
            }
        }
        try {
            if (!Kurang.getText().trim().isEmpty()) {
            ...
            if (e.toString().contains("java.lang.NumberFormatException")) {
                ...
                JOptionPane.showMessageDialog(null,
                        "Terjadi kesalahan saat menghitung kurang...!!");
            }
        }
        try {
            if (!Jmljual.getText().trim().isEmpty()) {
            ...
            if (e.toString().contains("java.lang.NumberFormatException")) {
                ...
                JOptionPane.showMessageDialog(null,
                        "Terjadi kesalahan saat menghitung jumlah...!!");
            }
        }

        subtotal.
                setText(Valid.SetAngka2((hargajual + tambah - kurang) * jumlah));
        if (!Stok.getText().trim().isEmpty()) {
            stok = Double.parseDouble(Stok.getText());
        }

        try {
            if (!Bsrdisc.getText().trim().isEmpty()) {
            ...
            if (e.toString().contains("java.lang.NumberFormatException")) {
                ...
                JOptionPane.showMessageDialog(null,
                        "Terjadi kesalahan saat menghitung besar diskon...!!");
            }
        }

        Total.setText(Valid.SetAngka2(
                Double.parseDouble(subtotal.getText()) - diskon));
        if (!UangMuka.getText().trim().isEmpty()) {
            Sisa.setText(Valid.SetAngka2(
                    Double.parseDouble(subtotal.getText()) - Double.parseDouble(
                    UangMuka.getText())));
        }
    }

    private void isDiskon() {
        if (!Disc.getText().trim().isEmpty()) {
            try {
                Bsrdisc.setText(Valid.SetAngka2((Double.parseDouble(Disc.
                        getText()) / 100) * Double.parseDouble(subtotal.
                                getText())));
            } catch (Exception e) {
                Disc.setText("0");
                Bsrdisc.setText("0");
    ...
    private void cariBatch() {
        try {
            if ((!NoBatch.getText().isEmpty()) && NoFaktur.getText().isEmpty()) {
                ps = koneksi.prepareStatement(
            ...
            } else if ((!NoBatch.getText().isEmpty()) && (!NoFaktur.getText().
                    isEmpty())) {
                ps = koneksi.prepareStatement(
    ...
    private void autoNomor() {
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(piutang.nota_piutang,3),signed)),0) from piutang where piutang.tgl_piutang='" + Valid.
                        SetTgl(TglJual.getSelectedItem() + "") + "' ",
                "PD" + TglJual.getSelectedItem().toString().substring(8, 10) + TglJual.
                getSelectedItem().toString().substring(3, 5) + TglJual.
    ...
    private void simpan() {
        try {
            ps = koneksi.prepareStatement(
                    "select tamppiutang.kode_brng,tamppiutang.satuan,tamppiutang.h_jual,tamppiutang.h_beli,tamppiutang.jumlah,tamppiutang.subtotal,tamppiutang.dis,tamppiutang.bsr_dis,tamppiutang.total,tamppiutang.no_batch,tamppiutang.no_faktur,tamppiutang.aturan_pakai from tamppiutang where tamppiutang.petugas=?");
            try {
                ps.setString(1, akses.getkode());
                rs = ps.executeQuery();
                while (rs.next()) {
                    if (Sequel.menyimpantf2("detailpiutang", "'" + NoNota.
                            getText() + "','" + rs.getString(1) + "','" + rs.
                            getString(2) + "','" + rs.getString(3)
                            + "','" + rs.getString(4) + "','" + rs.getString(5) + "','" + rs.
                            getString(6) + "','" + rs.getString(7) + "','" + rs.
                            getString(8) + "','" + rs.getString(9) + "','" + rs.
                            getString("no_batch") + "','" + rs.getString(
                            "no_faktur") + "','" + rs.getString("aturan_pakai") + "'",
                            "Obat/BHP/Alkes") == true) {
                        if (aktifkanbatch.equals("yes")) {
                            Sequel.mengedit("data_batch",
                                    ...
                                    "sisa=sisa-?", 4, new String[]{
                                        rs.getString(5), rs.
                                        getString("no_batch"), rs.getString(1),
                                        rs.getString("no_faktur")
                                    });
                            Trackobat.catatRiwayat(rs.getString(1), 0, rs.
                                    getDouble(5), "Piutang", akses.getkode(),
                                    kdgudang.getText(), "Simpan", rs.getString(
                                    "no_batch"), rs.getString("no_faktur"),
                                    NoNota.getText() + " " + kdpasien.getText() + " " + nmpasien.
                                    getText());
                            Sequel.menyimpan("gudangbarang", "'" + rs.getString(
                                    1) + "','" + kdgudang.getText() + "','-" + rs.
                                    getString(5) + "','" + rs.getString(
                                    "no_batch") + "','" + rs.getString(
                                            "no_faktur") + "'",
                                    "stok=stok-'" + rs.getString(5) + "'",
                                    "kode_brng='" + rs.getString(1) + "' and kd_bangsal='" + kdgudang.
                                    getText() + "' and no_batch='" + rs.
                                            getString("no_batch") + "' and no_faktur='" + rs.
                                    getString("no_faktur") + "'");
                        } else {
                            Trackobat.catatRiwayat(rs.getString(1), 0, rs.
                                    getDouble(5), "Piutang", akses.getkode(),
    ...
    private static final Logger LOG = Logger.getLogger(DlgPiutang.class.
            getName());
}
