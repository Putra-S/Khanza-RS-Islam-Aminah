...
public class DlgKadaluarsaBatch extends javax.swing.JDialog {
    ...
    public DlgKadaluarsaBatch(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.Batch", "Kode Barang", "Nama Barang", "Satuan", "Tgl.Datang", "Kadaluarsa", "Asal",
            "No.Faktur", "Harga Beli", "Jml.Beli", "Sisa"};
...
//GEN-FIRST:event_TKdKeyPressed
    ...
    private static final Logger LOG = Logger.getLogger(DlgKadaluarsaBatch.class.getName());
