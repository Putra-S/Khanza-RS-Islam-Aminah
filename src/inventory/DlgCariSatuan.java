...
public class DlgCariSatuan extends javax.swing.JDialog {
            ...
            if (response.isArray()) {
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(
                                new Object[]{list.path("KodeSatuan").asText(), list.path("NamaSatuan").asText()});
                    }
                } else {
                    for (JsonNode list : response) {
                        if (list.path("NamaSatuan").asText().toLowerCase().contains(TCari.getText().toLowerCase())) {
                            tabMode.addRow(new Object[]{list.path("KodeSatuan").asText(),
                                list.path("NamaSatuan").asText()});
                        }
                    }
                }
            }
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariSatuan.class.getName());
