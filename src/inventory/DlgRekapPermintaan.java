...
public class DlgRekapPermintaan extends javax.swing.JDialog {
    ...
    private InventorySuratPemesanan form = new InventorySuratPemesanan(null,
            false);
    ...
    public DlgRekapPermintaan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"P", "Kode Barang", "Nama Barang", "Satuan", "Jenis",
            "Jumlah", "Kode Sat", "Isi Besar"};
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptRekapPermintaan.jasper", param,
                    "::[ Laporan Ringkasan Permintaan Obat/Alkes/BHP Medis ]::");
...
private void BtnSeek2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSeek2KeyPressed
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null,
                    "Maaf, data sudah habis. Tidak ada data yang bisa anda pilih...!!!!");
            //TCari.requestFocus();
        } else if (tabMode.getRowCount() != 0) {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            ...
            for (i = 0; i < tbDokter.getRowCount(); i++) {
                if (tbDokter.getValueAt(i, 0).toString().equals("true")) {
                    harga = Sequel.cariIsiAngka(
                            "select h_beli from databarang where kode_brng=?",
                            tbDokter.getValueAt(i, 1).toString());
                    jml = Double.parseDouble(tbDokter.getValueAt(i, 5).
                            toString());
                    form.tabMode().addRow(new Object[]{
                        ...
                        Double.valueOf(tbDokter.getValueAt(i, 7).toString()), 1
                    });
                }
            }
            form.panggilgetData();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRekapPermintaan dialog = new DlgRekapPermintaan(
    ...
    private void prosesCari() {
        try {
            ...
            for (i = 0; i < tbDokter.getRowCount(); i++) {
                if (tbDokter.getValueAt(i, 0).toString().equals("true")) {
                    pilihan[z] = Boolean.parseBoolean(tbDokter.getValueAt(i, 0).
                            toString());
            ...
            for (i = 0; i < z; i++) {
                tabMode.addRow(new Object[]{
                    pilihan[i], kodebarang[i], namabarang[i], satuan[i],
                    jenis[i], jumlah[i], kodesat[i]
                });
            }
    ...
    private static final Logger LOG = Logger.getLogger(DlgRekapPermintaan.class.
            getName());
