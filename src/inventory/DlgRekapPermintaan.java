...
private void BtnSeek2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSeek2KeyPressed
    ...
    private void prosesCari() {
        try {
            ...
            for (i = 0; i < z; i++) {
                tabMode.addRow(new Object[]{pilihan[i], kodebarang[i], namabarang[i], satuan[i], jenis[i], jumlah[i],
                    kodesat[i]});
            }
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString("kode_brng"), rs.getString("nama_brng"),
                        ...
                        rs.getString("kode_sat"), rs.getString("isi")});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgRekapPermintaan.class.getName());
