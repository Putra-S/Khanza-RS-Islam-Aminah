...
public class DlgCekStok extends javax.swing.JDialog {
    ...
    public DlgCekStok(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Barang", "Nama Barang", "Kategori", "Satuan", "Harga", "Stok"}) {
    ...
    private void BtnKeluarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnKeluarKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, kdgudang, TCari);
        }
...
private void BtnGudangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGudangActionPerformed
                ...
                while (rstampil.next()) {
                    ...
                    if (!nmgudang.getText().isEmpty()) {
                        psstok = koneksi.prepareStatement(
                                "select ifnull(sum(stok),'0') from gudangbarang where kd_bangsal=? and kode_brng=?");
                        try {
                    ...
                    tabMode.addRow(new Object[]{rstampil.getString("kode_brng"), rstampil.getString("nama_brng"),
                        rstampil.getString("nama"), rstampil.getString("kode_sat"), rstampil.getDouble("dasar"),
                        stokbarang});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgCekStok.class.getName());
