...
public class DlgKategori extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("kategori_barang", "'" + Kd.getText() + "','" + Nm.
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbKamar.getRowCount(); i++) {
            if (tbKamar.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("kategori_barang", "kode", tbKamar.getValueAt(i,
                        1).toString());
            }
        }
        BtnCariActionPerformed(evt);
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Valid.editTable(tabMode, "kategori_barang", "kode", "?",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptKategori.jasper", "report",
                    "::[ Data Kategori ]::", "select kode, nama "
                    + " from kategori_barang where  kode like '%" + TCari.
                            getText().trim() + "%' or "
...
private void NmKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select kode,nama  " + " from kategori_barang where  kode like ? or "
    ...
    private static final Logger LOG = Logger.getLogger(DlgKategori.class.getName());
