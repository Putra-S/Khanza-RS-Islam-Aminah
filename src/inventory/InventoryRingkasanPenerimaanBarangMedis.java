...
public class InventoryRingkasanPenerimaanBarangMedis extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public InventoryRingkasanPenerimaanBarangMedis(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRingkasanPenerimaanObat.jasper", "report",
                    "::[ Laporan Ringkasan Penerimaan Obat/Alkes/BHP Medis ]::",
                    ...
                    + " pemesanan.no_faktur like '%" + NoFaktur.getText() + "%' and datasuplier.nama_suplier like '%" + nmsup.
                    getText() + "%' and petugas.nama like '%" + nmptg.getText() + "%' and "
                    + " jenis.nama like '%" + nmjenis.getText() + "%' and databarang.nama_brng like '%" + nmbar.
                    getText() + "%' and industrifarmasi.nama_industri like '%" + NmIF.
                            getText() + "%' and "
                    + " (pemesanan.no_faktur like '%" + TCari.getText() + "%' or pemesanan.kode_suplier like '%" + TCari.
                    getText() + "%' or datasuplier.nama_suplier like '%" + TCari.
                            getText() + "%' or "
                    + " pemesanan.nip like '%" + TCari.getText() + "%' or petugas.nama like '%" + TCari.
                    getText() + "%' or bangsal.nm_bangsal like '%" + TCari.
                            getText() + "%' or "
                    + " detailpesan.kode_brng like '%" + TCari.getText() + "%' or databarang.nama_brng like '%" + TCari.
                    ...
                    getText() + "%' or pemesanan.no_order like '%" + TCari.
                            getText() + "%' or "
                    + " jenis.nama like '%" + TCari.getText() + "%') group by detailpesan.kode_brng " + order,
                    param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventoryRingkasanPenerimaanBarangMedis dialog = new InventoryRingkasanPenerimaanBarangMedis(
    ...
    private static final Logger LOG = Logger.getLogger(
            InventoryRingkasanPenerimaanBarangMedis.class.getName());
