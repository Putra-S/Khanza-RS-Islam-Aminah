...
public class DlgRiwayatBarangMedis extends javax.swing.JDialog {
    ...
    public DlgRiwayatBarangMedis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Barang", "Awal", "Masuk", "Keluar", "Akhir", "Posisi",
...
//GEN-FIRST:event_TKdKeyPressed
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        if (tabMode.getRowCount() == 0) {//GEN-FIRST:event_BtnPrintActionPerformed
            ...
            if (nmbar.getText().trim().isEmpty() && NmGudang.getText().trim().
                    isEmpty() && TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptRiwayatBarangMedis.jasper", "report",
                        ...
                        + "riwayat_barang_medis.tanggal between '" + Valid.
                                SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.
                        SetTgl(Tgl2.getSelectedItem() + "") + "' order by riwayat_barang_medis.tanggal,riwayat_barang_medis.jam ",
                        param);
            } else {
                Valid.MyReportqry("rptRiwayatBarangMedis.jasper", "report",
                        "::[ Riwayat Obat, Alkes & BHP ]::",
                        ...
                        + "riwayat_barang_medis.tanggal between '" + Valid.
                                SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.
                        SetTgl(Tgl2.getSelectedItem() + "") + "' and databarang.nama_brng like '%" + nmbar.
                        getText() + "%' and bangsal.nm_bangsal like '%" + NmGudang.
                                getText() + "%' and "
                        + "(riwayat_barang_medis.kode_brng like '%" + TCari.
                                getText().trim() + "%' or databarang.nama_brng like '%" + TCari.
                                getText().trim() + "%' or riwayat_barang_medis.petugas like '%" + TCari.
                                getText().trim() + "%' or riwayat_barang_medis.no_batch like '%" + TCari.
                                getText().trim() + "%' or "
                        + "riwayat_barang_medis.no_faktur like '%" + TCari.
                                getText().trim() + "%' or bangsal.nm_bangsal like '%" + TCari.
                                getText().trim() + "%' or riwayat_barang_medis.kd_bangsal like '%" + TCari.
                                getText().trim() + "%' or riwayat_barang_medis.status like '%" + TCari.
                                getText().trim() + "%' or "
                        + "riwayat_barang_medis.keterangan like '%" + TCari.
                                getText().trim() + "%' or riwayat_barang_medis.posisi like '%" + TCari.
                                getText().trim() + "%') order by riwayat_barang_medis.tanggal,riwayat_barang_medis.jam ",
                        param);
            }
    ...
    private void prosesCari() {
        ...
        try {
            if (nmbar.getText().trim().isEmpty() && NmGudang.getText().trim().isEmpty()
                    && TCari.getText().trim().isEmpty()) {
                ps = koneksi.prepareStatement("select riwayat_barang_medis.kode_brng,databarang.nama_brng,"
                        + "riwayat_barang_medis.stok_awal,riwayat_barang_medis.masuk,"
                        + "riwayat_barang_medis.keluar,riwayat_barang_medis.stok_akhir,"
                        + "riwayat_barang_medis.posisi,riwayat_barang_medis.tanggal,"
                        + "riwayat_barang_medis.jam,riwayat_barang_medis.petugas,"
                ...
                ps = koneksi.prepareStatement("select riwayat_barang_medis.kode_brng,databarang.nama_brng,"
                        ...
                        + "riwayat_barang_medis.posisi like ?) "
                        + "order by riwayat_barang_medis.tanggal,riwayat_barang_medis.jam ");
            }
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kode_brng") + " " + rs.getString("nama_brng"),
                        rs.getString("stok_awal"), rs.getString("masuk"), rs.getString("keluar"),
                        rs.getString("stok_akhir"), rs.getString("posisi"), rs.getString("tanggal"),
                        rs.getString("jam"), rs.getString("petugas"),
                        rs.getString("kd_bangsal") + " " + rs.getString("nm_bangsal"), rs.getString("status"),
                        rs.getString("no_batch"), rs.getString("no_faktur"), rs.getString("keterangan")});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgRiwayatBarangMedis.class.getName());
