...
public class DlgRiwayatBarangMedis extends javax.swing.JDialog {
    ...
    public DlgRiwayatBarangMedis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            ...
            "Tanggal", "Jam", "Petugas", "Lokasi", "Status", "No.Batch",
            "No.Faktur", "Keterangan"
        }) {
            @Override
...
*/
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRiwayatBarangMedis dialog = new DlgRiwayatBarangMedis(
    ...
    private void prosesCari() {
        ...
        try {
            ...
            try {
                if (nmbar.getText().trim().isEmpty() && NmGudang.getText().
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgRiwayatBarangMedis.class.getName());
