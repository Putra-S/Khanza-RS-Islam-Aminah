...
public class DlgBarang extends javax.swing.JDialog {
    ...
    public DlgBarang(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"P", "Kode Barang", "Nama Barang", "Kd.Sat Besar", "Nm.Satuan Besar", "Isi",
                    "Kd.Sat Kecil", "Nm.Satuan Kecil", "Kps", "Kandungan", "Hrg.Dasar(Rp)", "Hrg.Beli(Rp)",
                    "Ralan(Rp)", "Ranap K1(Rp)", "Ranap K2(Rp)", "Ranap K3(Rp)", "Kelas Utama/BPJS(Rp)",
                    "Ranap VIP(Rp)", "Ranap VVIP(Rp)", "Beli Luar(Rp)", "Jual Bebas(Rp)", "Karyawan(Rp)",
                    "Stok Min", "Kode Jenis", "Nama Jenis", "Kadaluwarsa", "Kode I.F.", "Industri Farmasi",
                    "Kode Kategori", "Kategori", "Kode Golongan", "Golongan"}) {
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgBarang")) {
                    if (satuan.getTable().getSelectedRow() != -1) {
                        if (i == 1) {
                            kdsat.setText(
                                    satuan.getTable().getValueAt(satuan.getTable().getSelectedRow(), 0).toString());
                            nmsat.setText(
                                    satuan.getTable().getValueAt(satuan.getTable().getSelectedRow(), 1).toString());
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgBarang")) {
                    if (golongan.getTable().getSelectedRow() != -1) {
                        kdgolongan.setText(
                                golongan.getTable().getValueAt(golongan.getTable().getSelectedRow(), 0).toString());
                        nmgolongan.setText(
                                golongan.getTable().getValueAt(golongan.getTable().getSelectedRow(), 1).toString());
                    }
                }
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgBarang")) {
                    if (kategori.getTable().getSelectedRow() != -1) {
                        kdkategori.setText(
                                kategori.getTable().getValueAt(kategori.getTable().getSelectedRow(), 0).toString());
                        nmkategori.setText(
                                kategori.getTable().getValueAt(kategori.getTable().getSelectedRow(), 1).toString());
                    }
                }
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgBarang")) {
                    if (industri.getTable().getSelectedRow() != -1) {
                        KdIF.setText(
                                industri.getTable().getValueAt(industri.getTable().getSelectedRow(), 0).toString());
                        NmIF.setText(
                                industri.getTable().getValueAt(industri.getTable().getSelectedRow(), 1).toString());
                    }
                    BtnIF.requestFocus();
                }
            }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
        ...
        } else if (Letak.getText().trim().isEmpty()) {
            Valid.textKosong(Letak, "Kandungan");
        } else if (beli.getText().trim().isEmpty()) {
            Valid.textKosong(beli, "Harga Beli");
        } else if (ralan.getText().trim().isEmpty()) {
            Valid.textKosong(ralan, "Harga Ralan");
        } else if (kelas1.getText().trim().isEmpty()) {
            Valid.textKosong(kelas1, "Harga Ranap Kelas 1");
        } else if (kelas2.getText().trim().isEmpty()) {
            Valid.textKosong(kelas2, "Harga Ranap Kelas 2");
        } else if (kelas3.getText().trim().isEmpty()) {
            Valid.textKosong(kelas3, "Harga Ranap Kelas 3");
        } else if (utama.getText().trim().isEmpty()) {
            Valid.textKosong(utama, "Harga Ranap Kelas Utama");
        } else if (kelasvip.getText().trim().isEmpty()) {
            Valid.textKosong(kelasvip, "Harga Ranap Kelas VIP");
        } else if (kelasvvip.getText().trim().isEmpty()) {
            Valid.textKosong(kelasvvip, "Harga Ranap Kelas VVIP");
        } else if (beliluar.getText().trim().isEmpty()) {
            Valid.textKosong(beliluar, "Harga Jika Beli dari Apotek Lain");
        } else if (jualbebas.getText().trim().isEmpty()) {
            Valid.textKosong(jualbebas, "Harga Jual Obat Bebas");
        } else if (karyawan.getText().trim().isEmpty()) {
            Valid.textKosong(karyawan, "Harga Karyawan");
        } else if (kdsat.getText().trim().isEmpty() || nmsat.getText().trim().
                isEmpty()) {
            Valid.textKosong(kdsat, "Satuan");
        } else if (kdjns.getText().trim().isEmpty() || nmjns.getText().trim().
                isEmpty()) {
            Valid.textKosong(kdjns, "Jenis");
        } else if (kdkategori.getText().trim().isEmpty() || nmkategori.getText().
                trim().isEmpty()) {
            Valid.textKosong(kdkategori, "Kategori");
        } else if (kdgolongan.getText().trim().isEmpty() || nmgolongan.getText().
                trim().isEmpty()) {
            Valid.textKosong(kdgolongan, "Golongan");
        } else if (stok_minimal.getText().trim().isEmpty()) {
        ...
        } else if (KdIF.getText().trim().isEmpty() || NmIF.getText().trim().
                isEmpty()) {
            ...
            if (Valid.editTabletf(tabMode, "databarang", "kode_brng", "?",
                    "nama_brng=?,kode_brng=?,kapasitas=?,kode_sat=?,letak_barang=?,"
                    + "h_beli=?,ralan=?,kelas1=?,kelas2=?,stokminimal=?,kdjns=?,kelas3=?,utama=?,vip=?,vvip=?,beliluar=?,jualbebas=?,"
                    + "karyawan=?,expire=?,kode_industri=?,kode_kategori=?,kode_golongan=?,kode_satbesar=?,dasar=?,isi=?",
                    26, new String[]{
                        Nm.getText(), Kd.getText(), Kapasitas.getText(), kdsat.
                        getText(), Letak.getText(), beli.getText(), ralan.
                        getText(),
                        kelas1.getText(), kelas2.getText(), stok_minimal.
                        getText(), kdjns.getText(), kelas3.getText(), utama.
                        getText(),
                        kelasvip.getText(), kelasvvip.getText(), beliluar.
                        getText(), jualbebas.getText(), karyawan.getText(),
                        tanggal, KdIF.getText(),
                        kdkategori.getText(), kdgolongan.getText(), kdsatBesar.
                        getText(), dasar.getText(), Isi.getText(),
                ...
                tbObat.setValueAt(kdsatBesar.getText(), tbObat.getSelectedRow(),
                        3);
                tbObat.setValueAt(nmsatBesar.getText(), tbObat.getSelectedRow(),
                        4);
                tbObat.setValueAt(Double.valueOf(Isi.getText()), tbObat.
                        getSelectedRow(), 5);
                tbObat.setValueAt(kdsat.getText(), tbObat.getSelectedRow(), 6);
                tbObat.setValueAt(nmsat.getText(), tbObat.getSelectedRow(), 7);
                tbObat.setValueAt(Double.valueOf(Kapasitas.getText()), tbObat.
                        getSelectedRow(), 8);
                tbObat.setValueAt(Letak.getText(), tbObat.getSelectedRow(), 9);
                tbObat.setValueAt(Double.valueOf(dasar.getText()), tbObat.
                        getSelectedRow(), 10);
                tbObat.setValueAt(Double.valueOf(beli.getText()), tbObat.
                        getSelectedRow(), 11);
                tbObat.setValueAt(Double.valueOf(ralan.getText()), tbObat.
                        getSelectedRow(), 12);
                tbObat.setValueAt(Double.valueOf(kelas1.getText()), tbObat.
                        getSelectedRow(), 13);
                tbObat.setValueAt(Double.valueOf(kelas2.getText()), tbObat.
                        getSelectedRow(), 14);
                tbObat.setValueAt(Double.valueOf(kelas3.getText()), tbObat.
                        getSelectedRow(), 15);
                tbObat.setValueAt(Double.valueOf(utama.getText()), tbObat.
                        getSelectedRow(), 16);
                tbObat.setValueAt(Double.valueOf(kelasvip.getText()), tbObat.
                        getSelectedRow(), 17);
                tbObat.setValueAt(Double.valueOf(kelasvvip.getText()), tbObat.
                        getSelectedRow(), 18);
                tbObat.setValueAt(Double.valueOf(beliluar.getText()), tbObat.
                        getSelectedRow(), 19);
                tbObat.setValueAt(Double.valueOf(jualbebas.getText()), tbObat.
                        getSelectedRow(), 20);
                tbObat.setValueAt(Double.valueOf(karyawan.getText()), tbObat.
                        getSelectedRow(), 21);
                tbObat.setValueAt(Double.valueOf(stok_minimal.getText()),
                ...
                tbObat.setValueAt(kdkategori.getText(), tbObat.getSelectedRow(),
                        28);
                tbObat.setValueAt(nmkategori.getText(), tbObat.getSelectedRow(),
                        29);
                tbObat.setValueAt(kdgolongan.getText(), tbObat.getSelectedRow(),
                        30);
                tbObat.setValueAt(nmgolongan.getText(), tbObat.getSelectedRow(),
                        31);
                emptTeks();
            }
        }
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptBarang.jasper", "report",
                        "::[ Data Barang ]::",
                ...
                Valid.MyReportqry("rptBarang.jasper", "report",
                        ...
                        + " inner join golongan_barang on databarang.kode_golongan=golongan_barang.kode "
                        + " inner join kategori_barang on databarang.kode_kategori=kategori_barang.kode "
                        + " where databarang.status='1' and databarang.kode_brng like '%" + TCari.
                                getText().trim() + "%' or "
                        + " databarang.status='1' and databarang.nama_brng like '%" + TCari.
                                getText().trim() + "%' or "
                        + " databarang.status='1' and databarang.kode_sat like '%" + TCari.
                                getText().trim() + "%' or "
                        + " databarang.status='1' and kodesatuan.satuan like '%" + TCari.
                                getText().trim() + "%' or "
                        + " databarang.status='1' and databarang.kode_satbesar like '%" + TCari.
                                getText().trim() + "%' or "
                        + " databarang.status='1' and satuanbesar.satuan like '%" + TCari.
                                getText().trim() + "%' or "
                        + " databarang.status='1' and databarang.letak_barang like '%" + TCari.
                                getText().trim() + "%' or "
                        + " databarang.status='1' and databarang.kdjns like '%" + TCari.
                                getText().trim() + "%' or "
                        + " databarang.status='1' and jenis.nama like '%" + TCari.
                                getText().trim() + "%' or "
                        + " databarang.status='1' and databarang.kode_industri like '%" + TCari.
                                getText().trim() + "%' or "
                        + " databarang.status='1' and kategori_barang.nama like '%" + TCari.
                                getText().trim() + "%' or "
                        + " databarang.status='1' and golongan_barang.nama like '%" + TCari.
                                getText().trim() + "%' or "
                        + " databarang.status='1' and industrifarmasi.nama_industri like '%" + TCari.
                                getText().trim() + "%' order by databarang.nama_brng",
                        param);
            }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("databarang",
                    "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                    "Kode Barang", 26, new String[]{
                        Kd.getText(), Nm.getText(), kdsatBesar.getText(), kdsat.
                        getText(), Letak.getText(), dasar.getText(), beli.
                        getText(), ralan.getText(),
                        kelas1.getText(), kelas2.getText(), kelas3.getText(),
                        utama.getText(), kelasvip.getText(), kelasvvip.getText(),
                        beliluar.getText(),
                        jualbebas.getText(), karyawan.getText(), stok_minimal.
                        getText(), kdjns.getText(), Isi.getText(), Kapasitas.
                        getText(), tanggal, "1",
                        KdIF.getText(), kdkategori.getText(), kdgolongan.
                        getText()
                    }) == true) {
                tabMode.addRow(new Object[]{
                    false, Kd.getText(), Nm.getText(), kdsatBesar.getText(),
                    nmsatBesar.getText(), Double.valueOf(Isi.getText()), kdsat.
                    getText(), nmsat.getText(),
                    Double.valueOf(Kapasitas.getText()), Letak.getText(),
                    Double.valueOf(dasar.getText()), Double.valueOf(beli.
                    getText()),
                    Double.valueOf(ralan.getText()), Double.valueOf(kelas1.
                    getText()), Double.valueOf(kelas2.getText()), Double.
                    valueOf(kelas3.getText()),
                    Double.valueOf(utama.getText()), Double.valueOf(kelasvip.
                    getText()), Double.valueOf(kelasvvip.getText()), Double.
                    valueOf(beliluar.getText()),
                    Double.valueOf(jualbebas.getText()), Double.valueOf(
                    karyawan.getText()), Double.valueOf(stok_minimal.getText()),
                    kdjns.getText(), nmjns.getText(),
                    tanggal, KdIF.getText(), NmIF.getText(), kdkategori.
                    getText(), nmkategori.getText(), kdgolongan.getText(),
                    nmgolongan.getText()
                });
                LCount.setText("" + tabMode.getRowCount());
                emptTeks();
...
private void BtnSatuanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSatuanActionPerformed
    ...
    satuan.isCek();
    satuan.setSize(internalFrame1.getWidth() - 20,
...
private void stok_minimalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_stok_minimalKeyPressed
    ...
    private void stok_minimalMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_stok_minimalMouseExited
        if (stok_minimal.getText().isEmpty()) {
    ...
    private void ppBarcodeBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBarcodeBtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptBarcodeBarang.jasper", "report",
                    "::[ Data Barang ]::",
    ...
    private void ppBarcodeItemBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBarcodeItemBtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            int jml;
            try {
                jml = Integer.parseInt(JOptionPane.showInputDialog(
                        "Masukkan jumlah barcode yang mau dicetak !!!"));
            } catch (Exception e) {
                jml = 0;
            }
            ...
            if (jml > 0) {
                ...
                param.put("logo", Sequel.cariGambar(
                        "select setting.logo from setting"));
                Valid.MyReportqry("rptBarcodeItem.jasper", "report",
                        "::[ Barcode Perbarang ]::",
...
private void KapasitasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KapasitasKeyPressed
    ...
    private void BtnIFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnIFActionPerformed
        akses.setform("DlgBarang");
        industri.isCek();
        industri.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void BtnSatuanBesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSatuanBesarActionPerformed
        ...
        akses.setform("DlgBarang");
        satuan.isCek();
        satuan.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
        satuan.setLocationRelativeTo(internalFrame1);
        satuan.setAlwaysOnTop(false);
        satuan.setVisible(true);
                ...
                try {
                    ...
                    while (rs.next()) {
                        tabMode.addRow(new Object[]{false, rs.getString("kode_brng"), rs.getString("nama_brng"),
                            rs.getString("kode_satbesar"), rs.getString("satuanbesar"), rs.getDouble("isi"),
                            rs.getString("kode_sat"), rs.getString("satuan"), rs.getDouble("kapasitas"),
                            rs.getString("letak_barang"), rs.getDouble("dasar"), rs.getDouble("h_beli"),
                            rs.getDouble("ralan"), rs.getDouble("kelas1"), rs.getDouble("kelas2"),
                            rs.getDouble("kelas3"), rs.getDouble("utama"), rs.getDouble("vip"),
                            rs.getDouble("vvip"), rs.getDouble("beliluar"), rs.getDouble("jualbebas"),
                            rs.getDouble("karyawan"), rs.getDouble("stokminimal"), rs.getString("kdjns"),
                            rs.getString("nama"), rs.getString("expire"), rs.getString("kode_industri"),
                            rs.getString("nama_industri"), rs.getString("kode_kategori"), rs.getString("kategori"),
                            rs.getString("kode_golongan"), rs.getString("golongan")});
                    }
                    LCount.setText("" + tabMode.getRowCount());
                } catch (Exception e) {
                ...
                try {
                    ...
                    while (rs.next()) {
                        tabMode.addRow(new Object[]{false, rs.getString("kode_brng"), rs.getString("nama_brng"),
                            ...
                            rs.getString("nama"), rs.getString("expire"), rs.getString("kode_industri"),
                            rs.getString("nama_industri"), rs.getString("kode_kategori"), rs.getString("kategori"),
                            rs.getString("kode_golongan"), rs.getString("golongan"), rs.getString("no_batch"),
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString("kode_brng"), rs.getString("nama_brng"),
                        ...
                        rs.getDouble("stokminimal"), rs.getString("kdjns"), rs.getString("nama"),
                        rs.getString("expire"), rs.getString("kode_industri"), rs.getString("nama_industri"),
                        rs.getString("kode_kategori"), rs.getString("kategori"), rs.getString("kode_golongan"),
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            ...
                            try {
                                ...
                                tabMode.addRow(new Object[]{false, "", "    " + rs2.getString(2), ": " + stokgudang,
                        ...
                        tabMode.addRow(new Object[]{false, "", "  Total Stok", ": " + totalstok, "", null, null, null,
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        tabMode.addRow(new Object[]{false, "", "    " + nmlokasi, ": " + stokgudang, "", null, null,
                            null, null, null, null, null, null, null, null, null, null, null, null, null, null,
                    ...
                    try {
                        ...
                        while (rs.next()) {
                            tabMode.addRow(new Object[]{false, rs.getString("kode_brng"), rs.getString("nama_brng"),
                                ...
                                rs.getDouble("karyawan"), rs.getDouble("stokminimal"), rs.getString("kdjns"),
                                rs.getString("nama"), rs.getString("expire"), rs.getString("kode_industri"),
                                rs.getString("nama_industri"), rs.getString("kode_kategori"),
                                rs.getString("kategori"), rs.getString("kode_golongan"), rs.getString("golongan"),
                    ...
                    try {
                        ...
                        while (rs.next()) {
                            tabMode.addRow(new Object[]{false, rs.getString("kode_brng"), rs.getString("nama_brng"),
                                ...
                                rs.getString("nama"), rs.getString("expire"), rs.getString("kode_industri"),
                                rs.getString("nama_industri"), rs.getString("kode_kategori"),
                                rs.getString("kategori"), rs.getString("kode_golongan"),
                                rs.getString("golongan")});
                        }
                    } catch (Exception e) {
                        System.out.println("Notifikasi : " + e);
    ...
    public void emptTeks() {
        ...
        Kd.requestFocus();
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(databarang.kode_brng,4),signed)),0)  from databarang ", "B",
                9, Kd);
    ...
    private void getData() {
        ...
        if (row != -1) {
            ...
            if (tbObat.getValueAt(row, 25).toString().isEmpty()
                    || (tbObat.getValueAt(row, 25).toString().length() == 0)) {
                ChkKadaluarsa.setSelected(false);
                DTPExpired.setDate(new Date());
            } else {
                ChkKadaluarsa.setSelected(true);
            ...
            try {
                if (!beli.getText().isEmpty()) {
                    switch (pengaturanharga) {
                        case "Per Jenis":
                            if (kdjns.getText().isEmpty()) {
                                Valid.textKosong(kdjns, "Kode Jenis");
                            } else {
                                try {
                                    rs = koneksi
                                            .prepareStatement("select * from setpenjualan where setpenjualan.kdjns='"
                                                    + kdjns.getText() + "'")
                                            .executeQuery();
                                    if (rs.next()) {
    ...
    public void isBatch() {
        tabMode = new DefaultTableModel(null,
                new Object[]{"P", "Kode Barang", "Nama Barang", "Kd.Sat Besar", "Nm.Satuan Besar", "Isi",
                    ...
                    "Ranap VIP(Rp)", "Ranap VVIP(Rp)", "Beli Luar(Rp)", "Jual Bebas(Rp)", "Karyawan(Rp)",
                    "Stok Min", "Kode Jenis", "Nama Jenis", "Kadaluwarsa", "Kode I.F.", "Industri Farmasi",
                    "Kode Kategori", "Kategori", "Kode Golongan", "Golongan", "No.Batch", "No.Faktur"}) {
            Class[] types = new Class[]{java.lang.Boolean.class, java.lang.Object.class, java.lang.Object.class,
                java.lang.Object.class, java.lang.Object.class, java.lang.Double.class, java.lang.Object.class,
                java.lang.Object.class, java.lang.Double.class, java.lang.Object.class, java.lang.Double.class,
                java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class,
    ...
    private static final Logger LOG = Logger.getLogger(DlgBarang.class.getName());
