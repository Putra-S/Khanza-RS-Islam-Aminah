 ...
 * @author dosen
 */
public class DlgCariAturanPakai extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariAturanPakai dialog = new DlgCariAturanPakai(
    ...
    private void tampil() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select * from master_aturan_pakai order by aturan ");
            try {
                rs = ps.executeQuery();
                while (rs.next()) {
            ...
            fileWriter.write("{\"aturanpakai\":[" + iyem.substring(0, iyem.
                    length() - 1) + "]}");
            fileWriter.flush();
            fileWriter.close();
            iyem = null;
        ...
        try {
            ...
            if (response.isArray()) {
                if (TCari.getText().trim().isEmpty()) {
                    ...
                    for (JsonNode list : response) {
                        if (list.path("AturanPakai").asText().toLowerCase().
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariAturanPakai.class.
            getName());
}
