...
public class DlgResepPulang extends javax.swing.JDialog {
    ...
    public DlgResepPulang(java.awt.Frame parent, boolean modal) {
        ...
        setSize(628, 674);
        tabMode = new DefaultTableModel(null, new Object[]{"No.Rawat", "Tgl.Resep", "Jam", "Pasien", "Obat", "Jml",
            "Harga", "Total", "Dosis", "No.Batch", "No.Faktur"}) {
        ...
        inputresep.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (inputresep.getTable().getSelectedRow() != -1) {
                    KdBarang.setText(
                            inputresep.getTable().getValueAt(inputresep.getTable().getSelectedRow(), 1).toString());
                    NmBarang.setText(
                            inputresep.getTable().getValueAt(inputresep.getTable().getSelectedRow(), 2).toString());
                    Satuan.setText(
                            inputresep.getTable().getValueAt(inputresep.getTable().getSelectedRow(), 3).toString());
                    tampil();
                }
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    private void getData() {
        if (tbResep.getSelectedRow() != -1) {
            ...
            Sequel.cariIsi("select kode_brng from databarang where concat(kode_brng,' ',nama_brng)=?", KdBarang,
                    tbResep.getValueAt(tbResep.getSelectedRow(), 4).toString());
            Sequel.cariIsi("select nama_brng from databarang where concat(kode_brng,' ',nama_brng)=?", NmBarang,
                    tbResep.getValueAt(tbResep.getSelectedRow(), 4).toString());
            Sequel.cariIsi("select kode_sat from databarang where concat(kode_brng,' ',nama_brng)=?", Satuan,
                    tbResep.getValueAt(tbResep.getSelectedRow(), 4).toString());
        }
    }
    ...
    private static final Logger LOG = Logger.getLogger(DlgResepPulang.class.getName());
