        ...
        if (aktifkanbatch.equals("yes")) {//GEN-FIRST:event_BtnSimpanActionPerformed
            ...
            for (i = 0; i < jml; i++) {
                if ((Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()) > 0) && (tbDokter.
                        getValueAt(i, 10).toString().trim().isEmpty() || tbDokter.
                    ...
                    if (i == JOptionPane.YES_OPTION) {
                        ...
                        for (i = 0; i < tbDokter.getRowCount(); i++) {
                            if (Valid.SetAngka(tbDokter.getValueAt(i, 0).
                                    toString()) > 0) {
                                if (Sequel.menyimpantf2("stok_obat_pasien",
                                        "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                        "Stok Obat Pasien", 33, new String[]{
                                            Valid.SetTgl(
                                                    Tgl.getSelectedItem() + ""),
                                            cmbJam.getSelectedItem() + ":" + cmbMnt.
                                            getSelectedItem() + ":" + cmbDtk.
                                                    getSelectedItem(), norawat.
                                                    getText(), tabMode.
                                                    getValueAt(i, 1).toString(),
                                            tabMode.getValueAt(i, 0).toString(),
                                            kdgudang.getText(), tabMode.
                                    ...
                                    ttlhpp += (Valid.SetAngka(tabMode.
                                            getValueAt(i, 0).toString()) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 8).
                                                    toString()));
                                    ttljual += (Valid.SetAngka(tabMode.
                                            getValueAt(i, 0).toString()) * Valid.
                                            SetAngka(tabMode.getValueAt(i, 7).
                                                    toString()));
                                    ...
                                    if (aktifkanbatch.equals("yes")) {
                                        ...
                                        Trackobat.catatRiwayat(tabMode.
                                                getValueAt(i, 1).toString(), 0,
                                                Valid.SetAngka(tabMode.
                                                        getValueAt(i, 0).
                                                        toString()),
                                                "Stok Pasien Ranap", akses.
                                                        getkode(), kdgudang.
                                                        getText(), "Simpan",
                                        ...
                                        Sequel.menyimpan("gudangbarang",
                                                ...
                                                "kode_brng='" + tabMode.
                                                        ...
                                                        getValueAt(i, 10).
                                                        toString() + "' and no_faktur='" + tabMode.
                                                        getValueAt(i, 11).
                                                        toString() + "'");
                                    } else {
                                        Trackobat.catatRiwayat(tabMode.
                        ...
                        if (!nopermintaan.isEmpty()) {
                            Sequel.mengedit("permintaan_stok_obat_pasien",
                                    "no_permintaan='" + nopermintaan + "'",
                                    "tgl_validasi='" + Valid.SetTgl(Tgl.
                                            getSelectedItem() + "") + "',jam_validasi='" + cmbJam.
                                            getSelectedItem() + ":" + cmbMnt.
                                            getSelectedItem() + ":" + cmbDtk.
                                            getSelectedItem() + "',status='Sudah'");
                        }
    ...
    private void pilihancetak() {
        pilihanetiket = (String) JOptionPane.showInputDialog(null, "Silahkan pilih cetak aturan pakai..!!",
                ...
                new Object[]{"Cetak Aturan Pakai Model 1", "Cetak Aturan Pakai Model 2", "Cetak Aturan Pakai Model 3",
                    ...
                    "Cetak Aturan Pakai Model 2 & Cetak Label Obat 2",
                    "Cetak Aturan Pakai Model 3 & Cetak Label Obat 2"},
