...
public class DlgDaftarPermintaanResep extends javax.swing.JDialog {
    ...
    private String bangsal = "", aktifkanparsial = "no", kamar = "", alarm = "", DEPOAKTIFOBAT = "", rincianobat = "",
            ...
            NoRawat = "", NoRM = "", Pasien = "", DokterPeresep = "", Status = "", KodeDokter = "", Ruang = "", KodeRuang = "", dpjputama = "";
    ...
    public DlgDaftarPermintaanResep(java.awt.Frame parent, boolean modal) {
        ...
        tabMode2 = new DefaultTableModel(null, new Object[]{
            "No.Resep", "Tgl.Resep", "Poli/Unit", "Status", "Pasien",
            "Dokter Peresep"
        }) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
        ...
        //tbObat.setDefaultRenderer(Object.class, new WarnaTable(panelJudul.getBackground(),tbObat.getBackground()));
        tbDetailResepRalan.setPreferredScrollableViewportSize(new Dimension(500,
                500));
        tbDetailResepRalan.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 6; i++) {
            TableColumn column = tbDetailResepRalan.getColumnModel().
                    getColumn(i);
            if (i == 0) {
                column.setPreferredWidth(75);
            } else if (i == 1) {
        ...
        tabMode3 = new DefaultTableModel(null, new Object[]{
            "No.Resep", "Tgl.Peresepan", "Jam Peresepan", "No.Rawat", "No.RM",
            "Pasien", "Dokter Peresep", "DPJP Ranap Utama",
            "Status", "Kode Dokter", "Ruang/Kamar", "Kode Bangsal",
            "Jenis Bayar", "Tgl.Validasi", "Jam Validasi"
        }) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
        ...
        tabMode4 = new DefaultTableModel(null, new Object[]{
            "No.Resep", "Tgl.Resep", "Ruang/Kamar", "Status", "Pasien",
            "Dokter Peresep"
        }) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
        ...
        //tbObat.setDefaultRenderer(Object.class, new WarnaTable(panelJudul.getBackground(),tbObat.getBackground()));
        tbDetailResepRanap.setPreferredScrollableViewportSize(new Dimension(500,
                500));
        tbDetailResepRanap.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 6; i++) {
            TableColumn column = tbDetailResepRanap.getColumnModel().
                    getColumn(i);
            if (i == 0) {
                column.setPreferredWidth(75);
            } else if (i == 1) {
        ...
        tabMode5 = new DefaultTableModel(null, new Object[]{
            "No.Permintaan", "Tanggal", "Jam", "No.Rawat", "No.RM", "Pasien",
            "Dokter Yang Meminta",
            "Status", "Kode Dokter", "Ruang/Kamar", "Kode Bangsal",
            "Jenis Bayar"
        }) {
        ...
        //tbObat.setDefaultRenderer(Object.class, new WarnaTable(panelJudul.getBackground(),tbObat.getBackground()));
        tbPermintaanStok.setPreferredScrollableViewportSize(new Dimension(500,
                500));
        ...
        tabMode6 = new DefaultTableModel(null, new Object[]{
            "No.Permintaan", "Tanggal", "Ruang/Kamar", "Status", "Pasien",
            "Dokter Yang Meminta"
        }) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
        ...
        //tbObat.setDefaultRenderer(Object.class, new WarnaTable(panelJudul.getBackground(),tbObat.getBackground()));
        tbDetailPermintaanStok.setPreferredScrollableViewportSize(new Dimension(
                500, 500));
        tbDetailPermintaanStok.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 6; i++) {
            TableColumn column = tbDetailPermintaanStok.getColumnModel().
                    getColumn(i);
            if (i == 0) {
                column.setPreferredWidth(95);
            } else if (i == 1) {
        ...
        //tbObat.setDefaultRenderer(Object.class, new WarnaTable(panelJudul.getBackground(),tbObat.getBackground()));
        tbPermintaanResepPulang.setPreferredScrollableViewportSize(
                new Dimension(500, 500));
        tbPermintaanResepPulang.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 12; i++) {
            TableColumn column = tbPermintaanResepPulang.getColumnModel().
                    getColumn(i);
            if (i == 0) {
                column.setPreferredWidth(95);
            } else if (i == 1) {
        ...
        tbPermintaanResepPulang.setDefaultRenderer(Object.class,
                new WarnaTable());
        ...
        //tbObat.setDefaultRenderer(Object.class, new WarnaTable(panelJudul.getBackground(),tbObat.getBackground()));
        tbDetailPermintaanResepPulang.setPreferredScrollableViewportSize(
                new Dimension(500, 500));
        tbDetailPermintaanResepPulang.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (int i = 0; i < 6; i++) {
            TableColumn column = tbDetailPermintaanResepPulang.getColumnModel().
                    getColumn(i);
            if (i == 0) {
                column.setPreferredWidth(95);
            } else if (i == 1) {
        ...
        tbDetailPermintaanResepPulang.setDefaultRenderer(Object.class,
                new WarnaTable());
    ...
    private void initComponents() {
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-08-2024 12:59:22" }));
        ...
        BtnPRBBPJS.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnPRBBPJS.setText("Data PRB BPJS");
        BtnPRBBPJS.setFocusPainted(false);
        BtnPRBBPJS.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPRBBPJS.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnPRBBPJS.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPRBBPJS.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnPRBBPJS.setName("BtnPRBBPJS"); // NOI18N
        BtnPRBBPJS.setPreferredSize(new java.awt.Dimension(135, 23));
        BtnPRBBPJS.setRoundRect(false);
        BtnPRBBPJS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPRBBPJSActionPerformed(evt);
            }
        });
        FormMenu.add(BtnPRBBPJS);
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (tabMode.getRowCount() == 0) {
                    ...
                    Sequel.queryu(
                            "delete from temporary_resep where temp37='" + akses.
                                    getalamatip() + "'");
                    ...
                    Valid.MyReportqry("rptDaftarPermintaanResep.jasper",
                            "report", "::[ Laporan Daftar Permintaan Resep ]::",
                ...
                if (tabMode2.getRowCount() == 0) {
                    ...
                    for (int i = 0; i < tabMode2.getRowCount(); i++) {
                        Sequel.menyimpan("temporary_resep",
                                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                38, new String[]{
                                    "" + i, tabMode2.getValueAt(i, 0).toString(),
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptDaftarResep.jasper", "report",
                            "::[ Daftar Resep Obat ]::",
                            "select * from temporary_resep where temporary_resep.temp37='" + akses.
                                    getalamatip() + "' order by temporary_resep.no",
                            param);
                ...
                if (tabMode3.getRowCount() == 0) {
                    ...
                    for (int i = 0; i < tabMode3.getRowCount(); i++) {
                        Sequel.menyimpan("temporary_resep",
                                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                38, new String[]{
                                    "" + i, tabMode3.getValueAt(i, 0).toString(),
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptDaftarPermintaanResep2.jasper",
                            "report", "::[ Laporan Daftar Permintaan Resep ]::",
                            "select * from temporary_resep where temporary_resep.temp37='" + akses.
                                    getalamatip() + "' order by temporary_resep.no",
                            param);
                ...
                if (tabMode4.getRowCount() == 0) {
                    ...
                    for (int i = 0; i < tabMode4.getRowCount(); i++) {
                        Sequel.menyimpan("temporary_resep",
                                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                38, new String[]{
                                    "" + i, tabMode4.getValueAt(i, 0).toString(),
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptDaftarResep2.jasper", "report",
                            "::[ Daftar Resep Obat ]::",
                            "select * from temporary_resep where temporary_resep.temp37='" + akses.
                                    getalamatip() + "' order by temporary_resep.no",
                            param);
                ...
                if (tabMode5.getRowCount() == 0) {
                    ...
                    for (int i = 0; i < tabMode5.getRowCount(); i++) {
                        Sequel.menyimpan("temporary_resep",
                                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                38, new String[]{
                                    "" + i, tabMode5.getValueAt(i, 0).toString(),
                                    tabMode5.getValueAt(i, 1).toString(),
                                    tabMode5.getValueAt(i, 2).toString(),
                                    tabMode5.getValueAt(i, 3).toString(),
                                    tabMode5.getValueAt(i, 4).toString(),
                                    tabMode5.getValueAt(i, 5).toString(),
                                    tabMode5.getValueAt(i, 6).toString(),
                                    tabMode5.getValueAt(i, 7).toString(),
                                    tabMode5.getValueAt(i, 8).toString(),
                                    tabMode5.getValueAt(i, 9).toString(), "",
                                    tabMode5.getValueAt(i, 11).toString(),
                                    "", "", "", "", "", "", "", "", "", "", "",
                                    "", "", "", "", "", "", "", "", "", "", "",
                                    "", "", akses.getalamatip()
                                });
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptDaftarPermintaanResep3.jasper",
                            "report",
                            "::[ Laporan Daftar Permintaan Stok Pasien ]::",
                            "select * from temporary_resep where temporary_resep.temp37='" + akses.
                                    getalamatip() + "' order by temporary_resep.no",
                            param);
                    this.setCursor(Cursor.getDefaultCursor());
                ...
                if (tabMode6.getRowCount() == 0) {
                    ...
                    for (int i = 0; i < tabMode6.getRowCount(); i++) {
                        Sequel.menyimpan("temporary_resep",
                                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                38, new String[]{
                                    "" + i, tabMode6.getValueAt(i, 0).toString(),
                                    tabMode6.getValueAt(i, 1).toString(),
                                    tabMode6.getValueAt(i, 2).toString(),
                                    tabMode6.getValueAt(i, 3).toString(),
                                    tabMode6.getValueAt(i, 4).toString(),
                                    tabMode6.getValueAt(i, 5).toString().
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptDaftarResep3.jasper", "report",
                            "::[ Daftar Permintaan Stok Obat Pasien ]::",
                            "select * from temporary_resep where temporary_resep.temp37='" + akses.
                                    getalamatip() + "' order by temporary_resep.no",
                            param);
                    this.setCursor(Cursor.getDefaultCursor());
                ...
                if (tabMode7.getRowCount() == 0) {
                    ...
                    for (int i = 0; i < tabMode7.getRowCount(); i++) {
                        Sequel.menyimpan("temporary_resep",
                                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                38, new String[]{
                                    "" + i, tabMode7.getValueAt(i, 0).toString(),
                                    tabMode7.getValueAt(i, 1).toString(),
                                    tabMode7.getValueAt(i, 2).toString(),
                                    tabMode7.getValueAt(i, 3).toString(),
                                    tabMode7.getValueAt(i, 4).toString(),
                                    tabMode7.getValueAt(i, 5).toString(),
                                    tabMode7.getValueAt(i, 6).toString(),
                                    tabMode7.getValueAt(i, 7).toString(),
                                    tabMode7.getValueAt(i, 8).toString(),
                                    tabMode7.getValueAt(i, 9).toString(), "",
                                    tabMode7.getValueAt(i, 11).toString(),
                                    "", "", "", "", "", "", "", "", "", "", "",
                                    "", "", "", "", "", "", "", "", "", "", "",
                                    "", "", akses.getalamatip()
                                });
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptDaftarPermintaanResepPulang.jasper",
                            "report",
                            "::[ Laporan Daftar Permintaan Resep Pulang ]::",
                            "select * from temporary_resep where temporary_resep.temp37='" + akses.
                                    getalamatip() + "' order by temporary_resep.no",
                            param);
                    this.setCursor(Cursor.getDefaultCursor());
                ...
                if (tabMode8.getRowCount() == 0) {
                    ...
                    for (int i = 0; i < tabMode8.getRowCount(); i++) {
                        Sequel.menyimpan("temporary_resep",
                                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                38, new String[]{
                                    "" + i, tabMode8.getValueAt(i, 0).toString(),
                                    tabMode8.getValueAt(i, 1).toString(),
                                    tabMode8.getValueAt(i, 2).toString(),
                                    tabMode8.getValueAt(i, 3).toString(),
                                    tabMode8.getValueAt(i, 4).toString(),
                                    tabMode8.getValueAt(i, 5).toString(), "", "",
                                    "", "", "", "", "", "", "", "", "", "", "",
                                    "", "", "", "", "", "", "", "", "", "", "",
                                    "", "", "", "", "", "", akses.getalamatip()
                                });
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptDaftarResepPulang.jasper", "report",
                            "::[ Daftar Permintaan Resep Pulang ]::",
                            "select * from temporary_resep where temporary_resep.temp37='" + akses.
                                    getalamatip() + "' order by temporary_resep.no",
                            param);
                    this.setCursor(Cursor.getDefaultCursor());
            ...
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (akses.getberi_obat() == true) {
                    if (tabMode.getRowCount() == 0) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Maaf, Silahkan pilih data resep dokter yang mau divalidasi..!!");
                    } else {
                        if (Status.equals("Sudah Terlayani")) {
                            JOptionPane.showMessageDialog(rootPane,
                                    "Resep sudah tervalidasi ..!!");
                        } else {
                            jmlparsial = 0;
                            ...
                            if (jmlparsial > 0) {
                                ...
                                Sequel.queryu(
                                        "insert into antriapotek2 values('" + NoResep + "','1','" + NoRawat + "')");
                                panggilform();
                            } else {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Maaf, Anda tidak punya hak akses untuk mengvalidasi...!!!!");
                    TCari.requestFocus();
                }
            } else if (TabRawatJalan.getSelectedIndex() == 1) {
                JOptionPane.showMessageDialog(null,
                        "Maaf, silahkan buka Daftar Resep...!!!!");
                TCari.requestFocus();
            }
        } else if (TabPilihRawat.getSelectedIndex() == 1) {
            if (TabRawatInap.getSelectedIndex() == 0) {
                ...
                if (akses.getstok_obat_pasien() == true) {
                    if (tabMode5.getRowCount() == 0) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Maaf, Silahkan pilih data permintaan stok pasien yang mau divalidasi..!!");
                    } else {
                        if (Status.equals("Sudah Terlayani")) {
                            JOptionPane.showMessageDialog(rootPane,
                                    "Permintaan Stok Pasien sudah tervalidasi ..!!");
                        } else {
                            if (Sequel.cariRegistrasi(NoRawat) > 0) {
                                JOptionPane.showMessageDialog(rootPane,
                                        "Data billing sudah terverifikasi ..!!");
                ...
                JOptionPane.showMessageDialog(null,
                        "Maaf, silahkan buka Permintaan Stok...!!!!");
                TCari.requestFocus();
            } else if (TabRawatInap.getSelectedIndex() == 4) {
                if (akses.getresep_pulang() == true) {
                    if (tabMode7.getRowCount() == 0) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Maaf, Silahkan pilih data permintaan resep pulang yang mau divalidasi..!!");
                    } else {
                        if (Status.equals("Sudah Terlayani")) {
                            JOptionPane.showMessageDialog(rootPane,
                                    "Permintaan Resep Pulang sudah tervalidasi ..!!");
                        } else {
                            if (Sequel.cariRegistrasi(NoRawat) > 0) {
                                JOptionPane.showMessageDialog(rootPane,
                                        "Data billing sudah terverifikasi ..!!");
                ...
                JOptionPane.showMessageDialog(null,
                        "Maaf, silahkan buka Permintaan Resep Pulang...!!!!");
                TCari.requestFocus();
            }
        }
...
*/
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (tabMode.getRowCount() == 0) {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Maaf, Silahkan pilih data resep dokter yang mau diubah..!!");
                } else {
                    if (Status.equals("Sudah Terlayani")) {
                        JOptionPane.showMessageDialog(rootPane,
                                "Resep sudah tervalidasi ..!!");
                    } else {
                        DlgPeresepanDokter resep = new DlgPeresepanDokter(null,
                                false);
                        resep.setSize(internalFrame1.getWidth() - 20,
                                internalFrame1.getHeight() - 20);
                        resep.setLocationRelativeTo(internalFrame1);
                        resep.MatikanJam();
                        resep.setNoRm(NoRawat, Valid.SetTgl2(TglPeresepan),
                                JamPeresepan.substring(0, 2), JamPeresepan.
                                substring(3, 5), JamPeresepan.substring(6, 8),
                                KodeDokter, DokterPeresep, "ralan");
                        resep.isCek();
            ...
            if (TabRawatInap.getSelectedIndex() == 0) {
                if (tabMode3.getRowCount() == 0) {
                    ...
                    if (Status.equals("Sudah Terlayani")) {
                        ...
                        kamar = Sequel.cariIsi(
                                "select kd_bangsal from kamar inner join kamar_inap on kamar_inap.kd_kamar=kamar.kd_kamar "
                        ...
                        resep.setNoRm(NoRawat, Valid.SetTgl2(TglPeresepan),
                                JamPeresepan.substring(0, 2), JamPeresepan.
                                substring(3, 5), JamPeresepan.substring(6, 8),
                                KodeDokter, DokterPeresep, "ranap");
                        resep.isCek();
                        resep.tampilobat(NoResep);
                        TeksKosong();
                        resep.setVisible(true);
                ...
                if (tabMode5.getRowCount() == 0) {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Maaf, Silahkan pilih data permintaan stok yang mau divalidasi..!!");
                } else {
                    if (Status.equals("Sudah Terlayani")) {
                        JOptionPane.showMessageDialog(rootPane,
                                "Permintaan stok sudah tervalidasi ..!!");
                    } else {
                        kamar = Sequel.cariIsi(
                                "select kd_bangsal from kamar inner join kamar_inap on kamar_inap.kd_kamar=kamar.kd_kamar "
                                + "where kamar_inap.no_rawat=? order by kamar_inap.tgl_masuk desc limit 1 ",
                        ...
                        DlgPermintaanStokPasien permintaan = new DlgPermintaanStokPasien(
                                null, false);
                        permintaan.setSize(internalFrame1.getWidth() - 20,
                                internalFrame1.getHeight() - 20);
                ...
                if (tabMode7.getRowCount() == 0) {
                    ...
                    if (Status.equals("Sudah Terlayani")) {
                        ...
                        DlgPermintaanResepPulang permintaan = new DlgPermintaanResepPulang(
                                null, false);
                        permintaan.setSize(internalFrame1.getWidth() - 20,
                                internalFrame1.getHeight() - 20);
                        permintaan.setLocationRelativeTo(internalFrame1);
                ...
                JOptionPane.showMessageDialog(null,
                        "Maaf, silahkan buka Permintaan Resep...!!!!");
                TCari.requestFocus();
            }
        }
            ...
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (akses.getresep_dokter() == true) {
                    if (tabMode.getRowCount() == 0) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Maaf, Silahkan pilih data resep dokter yang mau dihapus..!!");
                    } else {
                        if (Status.equals("Sudah Terlayani")) {
                            JOptionPane.showMessageDialog(rootPane,
                                    "Resep sudah tervalidasi ..!!");
            ...
            if (TabRawatInap.getSelectedIndex() == 0) {
                ...
                if (akses.getpermintaan_stok_obat_pasien() == true) {
                    if (tabMode5.getRowCount() == 0) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Maaf, Silahkan pilih data permintaan stok yang mau dihapus..!!");
                    } else {
                        if (Status.equals("Sudah Terlayani")) {
                            JOptionPane.showMessageDialog(rootPane,
                                    "permintaan stok sudah tervalidasi ..!!");
                        } else {
                            Sequel.meghapus("permintaan_stok_obat_pasien",
                                    "no_permintaan", NoResep);
                            TeksKosong();
                            tampil5();
                        }
                    }
                ...
                if (akses.getpermintaan_resep_pulang() == true) {
                    if (tabMode7.getRowCount() == 0) {
                        ...
                        if (Status.equals("Sudah Terlayani")) {
                            ...
                            Sequel.meghapus("permintaan_resep_pulang",
                                    "no_permintaan", NoResep);
                            TeksKosong();
                            tampil7();
                        }
                ...
                JOptionPane.showMessageDialog(null,
                        "Maaf, silahkan buka Permintaan Resep Pulag...!!!!");
                TCari.requestFocus();
            }
        }
    ...
    private void BtnPenyerahanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPenyerahanActionPerformed
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (akses.getberi_obat() == true) {
                    if (tabMode.getRowCount() == 0) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Maaf, Silahkan pilih data resep dokter yang mau diserahkan..!!");
                    } else {
                        Sequel.queryu("delete from antriapotek3");
                        Sequel.queryu(
                                "insert into antriapotek3 values('" + NoResep + "','1','" + NoRawat + "')");
                        Sequel.queryu(
                                "delete from bukti_penyerahan_resep_obat where no_resep='" + NoResep + "'");
                        if (tbResepRalan.getValueAt(tbResepRalan.
                                getSelectedRow(), 12).toString().equals(
                                        "0000-00-00") || tbResepRalan.
                                        getValueAt(tbResepRalan.getSelectedRow(),
                                                12).toString().trim().isEmpty() || tbResepRalan.
                                        getValueAt(tbResepRalan.getSelectedRow(),
                                                12).toString() == null) {
                            JOptionPane.showMessageDialog(null,
                                    "Maaf, Resep belum divalidasi...!!!!");
                        } else {
                            TanggalPulang.setDate(new Date());
                            this.setCursor(Cursor.getPredefinedCursor(
                                    Cursor.WAIT_CURSOR));
                            WindowAmbilSampel.setLocationRelativeTo(
                                    internalFrame1);
            ...
            JOptionPane.showMessageDialog(null,
                    "Maaf, Penyerahan resep hanya untuk rawat jalan..!!!!");
            TCari.requestFocus();
        }
            ...
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (akses.getberi_obat() == true) {
                    if (tabMode.getRowCount() == 0) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Maaf, Silahkan pilih data resep dokter yang sudah divalidasi..!!");
                    } else {
                        if (Status.equals("Sudah Terlayani")) {
                            this.setCursor(Cursor.getPredefinedCursor(
                                    Cursor.WAIT_CURSOR));
                            DlgPemberianObat form = new DlgPemberianObat(null,
                                    false);
                            form.setSize(internalFrame1.getWidth(),
                                    internalFrame1.getHeight());
                            form.setLocationRelativeTo(internalFrame1);
                            form.isCek();
                            form.setNoRm3(NoRawat, DTPCari1.getDate(), DTPCari2.
                                    getDate(), "ralan");
                            form.tampilPO();
                            ...
                            JOptionPane.showMessageDialog(null,
                                    "Maaf, Silahkan pilih data yang sudah divalidasi..!!");
                        }
                    }
                } else {
                    JOptionPane.showMessageDialog(null,
                            "Maaf, Anda tidak punya hak akses untuk melihat data yang sudah divalidasi...!!!!");
                    TCari.requestFocus();
                }
            } else if (TabRawatJalan.getSelectedIndex() == 1) {
                JOptionPane.showMessageDialog(null,
            ...
            if (TabRawatInap.getSelectedIndex() == 0) {
                if (akses.getberi_obat() == true) {
                    if (tabMode3.getRowCount() == 0) {
                        ...
                        if (Status.equals("Sudah Terlayani")) {
                            ...
                            form.setLocationRelativeTo(internalFrame1);
                            form.isCek();
                            form.setNoRm2(NoRawat, DTPCari1.getDate(), DTPCari2.
                                    getDate(), "ranap");
                            form.tampilPO();
                            form.setVisible(true);
                            this.setCursor(Cursor.getDefaultCursor());
                ...
                if (akses.getstok_obat_pasien() == true) {
                    if (tabMode5.getRowCount() == 0) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Maaf, Silahkan pilih data permintaan stok pasien yang sudah divalidasi..!!");
                    } else {
                        if (Status.equals("Sudah Terlayani")) {
                            this.setCursor(Cursor.getPredefinedCursor(
                                    Cursor.WAIT_CURSOR));
                            ...
                            opname.isCek();
                            opname.setNoRm2(NoRawat, DTPCari1.getDate(),
                                    DTPCari2.getDate());
                            opname.setSize(internalFrame1.getWidth() - 20,
                                    internalFrame1.getHeight() - 20);
                ...
                if (akses.getresep_pulang() == true) {
                    if (tabMode7.getRowCount() == 0) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Maaf, Silahkan pilih data permintaan resep pulang yang sudah divalidasi..!!");
                    } else {
                        if (Status.equals("Sudah Terlayani")) {
                            DlgResepPulang reseppulang = new DlgResepPulang(null,
                                    false);
                            reseppulang.isCek();
                            reseppulang.setNoRm(NoRawat, NoRM, Pasien, DTPCari1.
                                    getDate(), DTPCari2.getDate());
                            reseppulang.tampil();
                            reseppulang.setSize(internalFrame1.getWidth() - 20,
                                    internalFrame1.getHeight() - 20);
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (tabMode.getRowCount() == 0) {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Maaf, Silahkan pilih data pasien yang mau dimasukkan piutang..!!");
                } else {
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    ...
                    penjualan.setSize(internalFrame1.getWidth() - 20,
                            internalFrame1.getHeight() - 20);
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (tabMode.getRowCount() == 0) {
                    ...
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    RMKonselingFarmasi penjualan = new RMKonselingFarmasi(null,
                            false);
                    penjualan.isCek();
                    penjualan.emptTeks();
            ...
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (akses.getberi_obat() == true) {
                    if (tabMode.getRowCount() == 0) {
                        ...
                        resume.setSize(internalFrame1.getWidth(),
                                internalFrame1.getHeight());
    ...
    private void BtnSEPBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSEPBPJSActionPerformed
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (TabRawatJalan.getSelectedIndex() == 0) {
                ...
                JOptionPane.showMessageDialog(null,
                        "Maaf, hanya untuk rawat jalan kebutuhan klaim 23 hari...!!!!");
                TCari.requestFocus();
            }
        } else if (TabPilihRawat.getSelectedIndex() == 1) {
            JOptionPane.showMessageDialog(null,
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (tabMode.getRowCount() == 0) {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Maaf, Silahkan pilih data pasien yang mau dibuatkan resep luar..!!");
                } else {
                    this.setCursor(Cursor.
                            getPredefinedCursor(Cursor.WAIT_CURSOR));
                    InventoryResepLuar resep = new InventoryResepLuar(null,
                            false);
                    resep.setSize(internalFrame1.getWidth(), internalFrame1.
                            getHeight());
                    resep.setLocationRelativeTo(internalFrame1);
                    resep.setNoRm(NoRawat, KodeDokter, DokterPeresep,
                            NoRM + " " + Pasien);
                    resep.isCek();
                    resep.tampilobat();
                    resep.setVisible(true);
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (tabMode.getRowCount() == 0) {
                        ...
                        try {
                            ...
                            while (rs.next()) {
                                Sequel.menyimpan("temporary_resep",
                                        "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                        38, new String[]{
                                            "" + i, rs.getString("nama_brng"),
                                            rs.getString("aturan_pakai"), rs.
                                            getString("jml"), rs.getString(
                                            "satuan"), "", "", "", "", "", "",
                                            "", "", "", "", "", "", "", "", "",
                                            "", "", "", "", "", "", "", "", "",
                                            "", "", "", "", "", "", "", "",
                        ...
                        try {
                            ...
                            while (rs.next()) {
                                ...
                                try {
                                    ...
                                    while (rs2.next()) {
                                        rincianobat = rs2.getString("nama_brng") + " " + rs2.
                                                getString("jml") + "," + rincianobat;
                                    }
                                } catch (Exception e) {
                                    System.out.println(
                                            "Notifikasi Detail Racikan : " + e);
                                } finally {
                                    if (rs2 != null) {
                                        rs2.close();
                                    }
                                ...
                                rincianobat = rincianobat.substring(0,
                                        rincianobat.length() - 1);

                                Sequel.menyimpan("temporary_resep",
                                        "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                        38, new String[]{
                                            "" + i,
                                            rs.getString("nama_racik") + " (" + rincianobat + ")",
                                            rs.getString("aturan_pakai"), rs.
                                            getString("jml_dr"), rs.getString(
                                            "nm_racik"), "", "", "", "", "", "",
                                            "", "", "", "", "", "", "", "", "",
                                            "", "", "", "", "", "", "", "", "",
                                            "", "", "", "", "", "", "", "",
                    ...
                    param.put("emailrs", akses.getemailrs());
                    param.put("kontakrs", akses.getkontakrs());
                    param.put("penanggung", Sequel.cariIsi(
                    ...
                    param.put("finger",
                            ...
                            getkabupatenrs() + "\nDitandatangani secara elektronik oleh " + DokterPeresep + "\nID " + (finger.
                                    isEmpty() ? KodeDokter : finger) + "\n" + Valid.
                                    SetTgl3(TglPeresepan));
                    param.put("jam", JamPeresepan);
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptLembarObat2.jasper", "report",
            ...
            if (TabRawatInap.getSelectedIndex() == 0) {
                ...
                JOptionPane.showMessageDialog(null,
                        "Maaf, silahkan buka daftar resep Rawat Jalan/Rawat Inap...!!!!");
                TCari.requestFocus();
            }
        }
    }//GEN-LAST:event_BtnResepAwalActionPerformed

  private void BtnPRBBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPRBBPJSActionPerformed
      this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
      BPJSDataPRB form = new BPJSDataPRB(null, false);
      form.setSize(internalFrame1.getWidth() - 20,
              internalFrame1.getHeight() - 20);
      form.setLocationRelativeTo(internalFrame1);
      form.setVisible(true);
      this.setCursor(Cursor.getDefaultCursor());
  }//GEN-LAST:event_BtnPRBBPJSActionPerformed
            ...
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (akses.gettelaah_resep() == true) {
                    if (tabMode.getRowCount() == 0) {
                        ...
                        this.setCursor(Cursor.getPredefinedCursor(
                                Cursor.WAIT_CURSOR));
                        InventoryTelaahResep aplikasi = new InventoryTelaahResep(
                                null, false);
                        aplikasi.emptTeks();
                        aplikasi.isCek();
                        aplikasi.setNoRm(NoResep, NoRawat, DTPCari2.getDate());
                        aplikasi.tampil();
                        aplikasi.setSize(internalFrame1.getWidth() - 20,
                                internalFrame1.getHeight() - 20);
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Maaf, Anda tidak punya hak akses untuk telaah resep...!!!!");
                    TCari.requestFocus();
                }
            } else if (TabRawatJalan.getSelectedIndex() == 1) {
                JOptionPane.showMessageDialog(null,
    ...
    private void BtnSimpan4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan4ActionPerformed
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (tbResepRalan.getSelectedRow() != -1) {
                if (tbResepRalan.getValueAt(tbResepRalan.getSelectedRow(), 0).
                        toString().trim().isEmpty()) {
                    Valid.textKosong(TanggalPulang, "No.Resep");
                } else {
                    if (Sequel.mengedittf("resep_obat", "no_resep=?",
                            "tgl_penyerahan=?,jam_penyerahan=?", 3,
                            new String[]{
                                Valid.SetTgl(
                                        TanggalPulang.getSelectedItem() + ""),
                                TanggalPulang.getSelectedItem().toString().
                                        substring(11, 19), tbResepRalan.
                                getValueAt(tbResepRalan.getSelectedRow(), 0).
                                toString()
                            }) == true) {
                        tbResepRalan.setValueAt(Valid.SetTgl(TanggalPulang.
                                getSelectedItem() + ""), tbResepRalan.
                                        getSelectedRow(), 14);
                        tbResepRalan.setValueAt(TanggalPulang.getSelectedItem().
                                toString().substring(11, 19), tbResepRalan.
                                getSelectedRow(), 15);
                        WindowAmbilSampel.dispose();
                    }
                }
                ...
                JOptionPane.showMessageDialog(null,
                        "Maaf, silahkan pilih data permintaan...!!!!");
                TCari.requestFocus();
            }
        } else if (TabPilihRawat.getSelectedIndex() == 1) {
            JOptionPane.showMessageDialog(null,
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDaftarPermintaanResep dialog = new DlgDaftarPermintaanResep(
    ...
    private widget.Button BtnPRBBPJS;
                ...
                if (cmbStatus.getSelectedItem().toString().equals("Semua")) {
                    while (rs.next()) {
                        tabMode.addRow(new String[]{
                            rs.getString("no_resep"), rs.getString(
                            "tgl_peresepan"), rs.getString("jam_peresepan"), rs.
                            getString("no_rawat"),
                            rs.getString("no_rkm_medis"), rs.getString(
                            "nm_pasien"), rs.getString("nm_dokter"), rs.
                            getString("status"),
                            rs.getString("kd_dokter"), rs.getString("nm_poli"),
                            rs.getString("kd_poli"), rs.getString("png_jawab"),
                            rs.getString("tgl_perawatan"), rs.getString("jam"),
                            rs.getString("tgl_penyerahan"), rs.getString(
                            "jam_penyerahan")
                        });
                    }
                } else {
                    while (rs.next()) {
                        if (rs.getString("status").equals(cmbStatus.
                                getSelectedItem().toString())) {
                            tabMode.addRow(new String[]{
                                rs.getString("no_resep"), rs.getString(
                                "tgl_peresepan"), rs.getString("jam_peresepan"),
                                rs.getString("no_rawat"),
                                rs.getString("no_rkm_medis"), rs.getString(
                                "nm_pasien"), rs.getString("nm_dokter"), rs.
                                getString("status"),
                                rs.getString("kd_dokter"), rs.getString(
                                "nm_poli"), rs.getString("kd_poli"), rs.
                                getString("png_jawab"),
                                rs.getString("tgl_perawatan"), rs.getString(
                                "jam"), rs.getString("tgl_penyerahan"), rs.
                                getString("jam_penyerahan")
                            });
                        }
                    }
                }
    ...
    private void getData() {
        if (tbResepRalan.getSelectedRow() != -1) {
            NoResep = tbResepRalan.getValueAt(tbResepRalan.getSelectedRow(), 0).
                    toString();
            TglPeresepan = tbResepRalan.
                    getValueAt(tbResepRalan.getSelectedRow(), 1).toString();
            JamPeresepan = tbResepRalan.
                    getValueAt(tbResepRalan.getSelectedRow(), 2).toString();
            NoRawat = tbResepRalan.getValueAt(tbResepRalan.getSelectedRow(), 3).
                    toString();
            NoRM = tbResepRalan.getValueAt(tbResepRalan.getSelectedRow(), 4).
                    toString();
            Pasien = tbResepRalan.getValueAt(tbResepRalan.getSelectedRow(), 5).
                    toString();
            DokterPeresep = tbResepRalan.getValueAt(tbResepRalan.
                    getSelectedRow(), 6).toString();
            Status = tbResepRalan.getValueAt(tbResepRalan.getSelectedRow(), 7).
                    toString();
            KodeDokter = tbResepRalan.getValueAt(tbResepRalan.getSelectedRow(),
                    8).toString();
            Ruang = tbResepRalan.getValueAt(tbResepRalan.getSelectedRow(), 9).
                    toString();
            KodeRuang = tbResepRalan.getValueAt(tbResepRalan.getSelectedRow(),
                    10).toString();
        }
    }
    ...
    private void getData2() {
        if (tbResepRanap.getSelectedRow() != -1) {
            NoResep = tbResepRanap.getValueAt(tbResepRanap.getSelectedRow(), 0).
                    toString();
            TglPeresepan = tbResepRanap.
                    getValueAt(tbResepRanap.getSelectedRow(), 1).toString();
            JamPeresepan = tbResepRanap.
                    getValueAt(tbResepRanap.getSelectedRow(), 2).toString();
            NoRawat = tbResepRanap.getValueAt(tbResepRanap.getSelectedRow(), 3).
                    toString();
            NoRM = tbResepRanap.getValueAt(tbResepRanap.getSelectedRow(), 4).
                    toString();
            Pasien = tbResepRanap.getValueAt(tbResepRanap.getSelectedRow(), 5).
                    toString();
            DokterPeresep = tbResepRanap.getValueAt(tbResepRanap.
                    getSelectedRow(), 6).toString();
            Status = tbResepRanap.getValueAt(tbResepRanap.getSelectedRow(), 7).
                    toString();
            KodeDokter = tbResepRanap.getValueAt(tbResepRanap.getSelectedRow(),
                    8).toString();
            Ruang = tbResepRanap.getValueAt(tbResepRanap.getSelectedRow(), 9).
                    toString();
            KodeRuang = tbResepRanap.getValueAt(tbResepRanap.getSelectedRow(),
                    10).toString();
        }
    }
    ...
    private void getData3() {
        if (tbPermintaanStok.getSelectedRow() != -1) {
            NoResep = tbPermintaanStok.getValueAt(tbPermintaanStok.
                    getSelectedRow(), 0).toString();
            TglPeresepan = tbPermintaanStok.getValueAt(tbPermintaanStok.
                    getSelectedRow(), 1).toString();
            JamPeresepan = tbPermintaanStok.getValueAt(tbPermintaanStok.
                    getSelectedRow(), 2).toString();
            NoRawat = tbPermintaanStok.getValueAt(tbPermintaanStok.
                    getSelectedRow(), 3).toString();
            NoRM = tbPermintaanStok.
                    getValueAt(tbPermintaanStok.getSelectedRow(), 4).toString();
            Pasien = tbPermintaanStok.getValueAt(tbPermintaanStok.
                    getSelectedRow(), 5).toString();
            DokterPeresep = tbPermintaanStok.getValueAt(tbPermintaanStok.
                    getSelectedRow(), 6).toString();
            Status = tbPermintaanStok.getValueAt(tbPermintaanStok.
                    getSelectedRow(), 7).toString();
            KodeDokter = tbPermintaanStok.getValueAt(tbPermintaanStok.
                    getSelectedRow(), 8).toString();
            Ruang = tbPermintaanStok.getValueAt(tbPermintaanStok.
                    getSelectedRow(), 9).toString();
            KodeRuang = tbPermintaanStok.getValueAt(tbPermintaanStok.
    ...
    private void getData4() {
        if (tbPermintaanResepPulang.getSelectedRow() != -1) {
            NoResep = tbPermintaanResepPulang.getValueAt(
                    tbPermintaanResepPulang.getSelectedRow(), 0).toString();
            TglPeresepan = tbPermintaanResepPulang.getValueAt(
                    tbPermintaanResepPulang.getSelectedRow(), 1).toString();
            JamPeresepan = tbPermintaanResepPulang.getValueAt(
                    tbPermintaanResepPulang.getSelectedRow(), 2).toString();
            NoRawat = tbPermintaanResepPulang.getValueAt(
                    tbPermintaanResepPulang.getSelectedRow(), 3).toString();
            NoRM = tbPermintaanResepPulang.getValueAt(tbPermintaanResepPulang.
                    getSelectedRow(), 4).toString();
            Pasien = tbPermintaanResepPulang.getValueAt(tbPermintaanResepPulang.
                    getSelectedRow(), 5).toString();
            DokterPeresep = tbPermintaanResepPulang.getValueAt(
                    tbPermintaanResepPulang.getSelectedRow(), 6).toString();
            Status = tbPermintaanResepPulang.getValueAt(tbPermintaanResepPulang.
                    getSelectedRow(), 7).toString();
            KodeDokter = tbPermintaanResepPulang.getValueAt(
                    tbPermintaanResepPulang.getSelectedRow(), 8).toString();
            Ruang = tbPermintaanResepPulang.getValueAt(tbPermintaanResepPulang.
                    getSelectedRow(), 9).toString();
            KodeRuang = tbPermintaanResepPulang.getValueAt(
                    tbPermintaanResepPulang.getSelectedRow(), 10).toString();
        }
    }
    ...
    private void tampil2() {
        ...
        try {
            ...
            if (DEPOAKTIFOBAT.isEmpty()) {
                ps = koneksi.prepareStatement(
                        "select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,resep_obat.no_rawat,pasien.no_rkm_medis,"
            ...
            try {
                ...
                if (cmbStatus.getSelectedItem().toString().equals("Semua")) {
                    while (rs.next()) {
                        ...
                        tabMode2.addRow(new String[]{"", "", "Jumlah",
                            "Kode Obat", "Nama Obat", "Aturan Pakai"});
                        ps2 = koneksi.prepareStatement(
                        ...
                        try {
                            ...
                            while (rs2.next()) {
                                tabMode2.addRow(new String[]{
                                    "", "", rs2.getString("jml") + " " + rs2.
                                    getString("kode_sat"), rs2.getString(
                        ...
                        try {
                            ...
                            while (rs2.next()) {
                                tabMode2.addRow(new String[]{
                                    "", "", rs2.getString("jml_dr") + " " + rs2.
                                    getString("metode"), "No.Racik : " + rs2.
                                    getString("no_racik"), rs2.getString(
                                    "nama_racik"), rs2.getString("aturan_pakai")
                                });
                                ...
                                try {
                                    ...
                                    while (rs3.next()) {
                                        tabMode2.addRow(new String[]{
                                            "", "",
                                            "   " + rs3.getString("jml") + " " + rs3.
                                            getString("kode_sat"), "   " + rs3.
                                            getString("kode_brng"), "   " + rs3.
                                            getString("nama_brng"), ""
                                        });
                                    }
                                } catch (Exception e) {
                    ...
                    while (rs.next()) {
                        if (rs.getString("status").equals(cmbStatus.
                            ...
                            tabMode2.addRow(new String[]{
                                rs.getString("no_resep"), rs.getString(
                                "tgl_perawatan") + " " + rs.getString("jam"),
                                rs.getString("nm_poli"), rs.getString("status"),
                                rs.getString("no_rawat") + " " + rs.getString(
                                "no_rkm_medis") + " " + rs.
                                getString("nm_pasien") + " (" + rs.getString(
                                "png_jawab") + ")",
                                rs.getString("nm_dokter")
                            });
                            tabMode2.addRow(new String[]{"", "", "Jumlah",
    ...
    private void panggilform2() {
        ...
        bangsal = Sequel.cariIsi(
                ...
                kamar);
        if (bangsal.isEmpty()) {
            if (Sequel.cariIsi("select set_lokasi.asal_stok from set_lokasi").
                    equals("Gunakan Stok Bangsal")) {
                akses.setkdbangsal(kamar);
            } else {
                akses.setkdbangsal(Sequel.cariIsi(
        ...
        dlgobt2.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void panggilform3() {
        ...
        dlgstok.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void panggilform4() {
        ...
        dlgresepulang.setNoRm(NoRawat, NoRM, Pasien, "-", DTPCari1.
                getSelectedItem().toString(), Sequel.cariIsi(
                        "select current_time()"));
        dlgresepulang.isCek();
        dlgresepulang.tampil2(NoResep);
        dlgresepulang.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
                ...
                if (cmbStatus.getSelectedItem().toString().equals("Semua")) {
                    while (rs.next()) {
                        ...
                        tabMode3.addRow(new String[]{
                            ...
                            getString("no_rawat"),
                            rs.getString("no_rkm_medis"), rs.getString(
                            "nm_pasien"), rs.getString("nm_dokter"), dpjputama,
                            rs.getString("status"),
                            rs.getString("kd_dokter"), rs.
                            getString("nm_bangsal"), rs.getString("kd_bangsal"),
                    ...
                    while (rs.next()) {
                        ...
                        if (rs.getString("status").equals(cmbStatus.
                            ...
                            tabMode3.addRow(new String[]{
                                ...
                                rs.getString("no_rawat"),
                                rs.getString("no_rkm_medis"), rs.getString(
                                "nm_pasien"), rs.getString("nm_dokter"),
                                dpjputama, rs.getString("status"),
                                rs.getString("kd_dokter"), rs.getString(
                                "nm_bangsal"), rs.getString("kd_bangsal"), rs.
                                getString("png_jawab"),
                                rs.getString("tgl_perawatan"), rs.getString(
                                "jam")
                            });
            ...
            try {
                ...
                if (cmbStatus.getSelectedItem().toString().equals("Semua")) {
                    while (rs.next()) {
                        ...
                        tabMode4.addRow(new String[]{"", "", "Jumlah",
                            "Kode Obat", "Nama Obat", "Aturan Pakai"});
                        ps2 = koneksi.prepareStatement(
                                "select databarang.kode_brng,databarang.nama_brng,resep_dokter.jml,"
                                + "databarang.kode_sat,resep_dokter.aturan_pakai from resep_dokter inner join databarang on "
    ...
    public void tampil5() {
        ...
        try {
            ...
            if (DEPOAKTIFOBAT.isEmpty()) {
                ps = koneksi.prepareStatement(
                        "select permintaan_stok_obat_pasien.no_permintaan,permintaan_stok_obat_pasien.tgl_permintaan,permintaan_stok_obat_pasien.jam,"
                ...
                if (cmbStatus.getSelectedItem().toString().equals("Semua")) {
                    while (rs.next()) {
                        tabMode5.addRow(new String[]{
                            ...
                            "tgl_permintaan"), rs.getString("jam"), rs.
                            getString("no_rawat"),
                            rs.getString("no_rkm_medis"), rs.getString(
                            "nm_pasien"), rs.getString("nm_dokter"), rs.
                            getString("status"),
    ...
    public void tampil6() {
        ...
        try {
            ...
            if (DEPOAKTIFOBAT.isEmpty()) {
                ps = koneksi.prepareStatement(
                        "select permintaan_stok_obat_pasien.no_permintaan,permintaan_stok_obat_pasien.tgl_permintaan,permintaan_stok_obat_pasien.jam,permintaan_stok_obat_pasien.no_rawat,pasien.no_rkm_medis,"
                ...
                if (cmbStatus.getSelectedItem().toString().equals("Semua")) {
                    while (rs.next()) {
                        tabMode6.addRow(new String[]{
                            rs.getString("no_permintaan"), rs.getString(
                            "tgl_permintaan") + " " + rs.getString("jam"),
                            rs.getString("nm_bangsal"), rs.getString("status"),
                            rs.getString("no_rawat") + " " + rs.getString(
                            "no_rkm_medis") + " " + rs.getString("nm_pasien") + " (" + rs.
                            getString("png_jawab") + ")",
                        ...
                        tabMode6.addRow(new String[]{"", "", "Jumlah",
                            "Kode Obat", "Nama Obat", "Aturan Pakai"});
                        ps2 = koneksi.prepareStatement(
                        ...
                        try {
                            ...
                            while (rs2.next()) {
                                tabMode6.addRow(new String[]{
                                    ...
                                    getString("kode_sat"), rs2.getString(
                                    "kode_brng"), rs2.getString("nama_brng"),
                                    "00 : " + rs2.getString("jam00").replaceAll(
                                    "true", "✓").replaceAll("false", "✕") + "  "
                                    + "01 : " + rs2.getString("jam01").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "02 : " + rs2.getString("jam02").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "03 : " + rs2.getString("jam03").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "04 : " + rs2.getString("jam04").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "05 : " + rs2.getString("jam05").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "06 : " + rs2.getString("jam06").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "07 : " + rs2.getString("jam07").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "08 : " + rs2.getString("jam08").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "09 : " + rs2.getString("jam09").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "10 : " + rs2.getString("jam10").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "11 : " + rs2.getString("jam11").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "12 : " + rs2.getString("jam12").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "13 : " + rs2.getString("jam13").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "14 : " + rs2.getString("jam14").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "15 : " + rs2.getString("jam15").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "16 : " + rs2.getString("jam16").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "17 : " + rs2.getString("jam17").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "18 : " + rs2.getString("jam18").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "19 : " + rs2.getString("jam19").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "20 : " + rs2.getString("jam20").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "21 : " + rs2.getString("jam21").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "22 : " + rs2.getString("jam22").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  "
                                    + "23 : " + rs2.getString("jam23").
                                    replaceAll("true", "✓").replaceAll("false",
                                    "✕") + "  |  "
                                    + rs2.getString("aturan_pakai")
                                });
    ...
    public void tampil7() {
        ...
        try {
            ...
            if (DEPOAKTIFOBAT.isEmpty()) {
                ps = koneksi.prepareStatement(
                        "select permintaan_resep_pulang.no_permintaan,permintaan_resep_pulang.tgl_permintaan,permintaan_resep_pulang.jam,"
    ...
    public void tampil8() {
        ...
        try {
            ...
            if (DEPOAKTIFOBAT.isEmpty()) {
                ps = koneksi.prepareStatement(
                        "select permintaan_resep_pulang.no_permintaan,permintaan_resep_pulang.tgl_permintaan,permintaan_resep_pulang.jam,permintaan_resep_pulang.no_rawat,pasien.no_rkm_medis,"
            ...
            try {
                ...
                if (cmbStatus.getSelectedItem().toString().equals("Semua")) {
                    while (rs.next()) {
                        ...
                        tabMode8.addRow(new String[]{"", "", "Jumlah",
                            "Kode Obat", "Nama Obat", "Aturan Pakai"});
                        ps2 = koneksi.prepareStatement(
                ...
                if (detik.equals("05")) {
                    ...
                    if (formalarm.contains("ralan")) {
                        ...
                        for (i = 0; i < tbResepRalan.getRowCount(); i++) {
                            if (tbResepRalan.getValueAt(i, 7).toString().equals(
                                    "Belum Terlayani")) {
                                resepbaru++;
                            }
                        }
                    ...
                    if (formalarm.contains("ranap")) {
                        ...
                        for (i = 0; i < tbResepRanap.getRowCount(); i++) {
                            if (tbResepRanap.getValueAt(i, 7).toString().equals(
                                    "Belum Terlayani")) {
                                resepbaru++;
                            }
                        }
                        ...
                        for (i = 0; i < tbPermintaanStok.getRowCount(); i++) {
                            if (tbPermintaanStok.getValueAt(i, 7).toString().
                                    equals("Belum Terlayani")) {
                                resepbaru++;
                            }
                        }
                        ...
                        for (i = 0; i < tbPermintaanResepPulang.getRowCount(); i++) {
                            if (tbPermintaanResepPulang.getValueAt(i, 7).
                                    toString().equals("Belum Terlayani")) {
                                resepbaru++;
                            }
                        }
                    }
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgDaftarPermintaanResep.class.getName());
}
