...
public class DlgCariGolongan extends javax.swing.JDialog {
            ...
            if (response.isArray()) {
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{list.path("KodeGolongan").asText(),
                            list.path("NamaGolongan").asText()});
                    }
                } else {
                    for (JsonNode list : response) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariGolongan.class.getName());
