 ...
 * @author dosen
 */
public class DlgCariObat3 extends javax.swing.JDialog {
    ...
    private double stokmasuk = 0, pagi = 0, siang = 0, sore = 0, malam = 0, keluar = 0, retur = 0, harga = 0, kapasitas = 0,
            kenaikan = 0, returshs = 0, hilang = 0, beli = 0, embalase = Sequel.
                    cariIsiAngka("select embalase_per_obat from set_embalase"),
            tuslah = Sequel.cariIsiAngka(
                    "select tuslah_per_obat from set_embalase");
    ...
    public DlgCariObat3(java.awt.Frame parent, boolean modal) {
        ...
        setSize(856, 350);
        Object[] row = {"K", "Kode Barang", "Nama Barang", "Msk", "Pg", "Sg",
            "Sr", "Ml", "Ttl.Msk", "Ttl.Klr", "Retur", "Rtr.Sh", "Ttl.Hlg",
            "No.Batch", "No.Faktur", "Aturan Pakai",
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                for (i = 0; i < jml; i++) {
                    ...
                    kapasitas = 1;
                    beli = 0;
                    pscariharga = koneksi.prepareStatement(
                            "select databarang.kelas1,databarang.kelas2,databarang.kelas3,"
                    ...
                    try {
                        pscariharga.setString(1, tbObat.getValueAt(i, 1).
                                toString());
                        rscariharga = pscariharga.executeQuery();
                        while (rscariharga.next()) {
                            beli = rscariharga.getDouble("dasar");
                            if (kenaikan > 0) {
                                harga = Valid.roundUp(rscariharga.getDouble(
                                        "h_beli") + (rscariharga.getDouble(
                                                "h_beli") * kenaikan), 100);
                            } else {
                    ...
                    pagi = 0;
                    try {
                        pagi = Double.parseDouble(tbObat.getValueAt(i, 4).
                                toString());
                    } catch (Exception e) {
                        pagi = 0;
                    }
                    siang = 0;
                    try {
                        siang = Double.parseDouble(tbObat.getValueAt(i, 5).
                                toString());
                    } catch (Exception e) {
                        siang = 0;
                    }
                    sore = 0;
                    try {
                        sore = Double.parseDouble(tbObat.getValueAt(i, 6).
                                toString());
                    } catch (Exception e) {
                        sore = 0;
                    }
                    malam = 0;
                    try {
                        malam = Double.parseDouble(tbObat.getValueAt(i, 7).
                                toString());
                    } catch (Exception e) {
                        malam = 0;
                    }
                    retur = 0;
                    try {
                        retur = Double.parseDouble(tbObat.getValueAt(i, 10).
                                toString());
                    } catch (Exception e) {
                        retur = 0;
                    }
                    ...
                    try {
                        ...
                        pshapusobat.setString(2, Valid.SetTgl(Tanggal.
                                getSelectedItem() + ""));
                        pshapusobat.setString(3, tbObat.getValueAt(i, 1).
                                toString());
                        pshapusobat.setString(4, tbObat.getValueAt(i, 13).
                                toString());
                        pshapusobat.setString(5, tbObat.getValueAt(i, 14).
                                toString());
                    ...
                    if (retur > 0) {
                        ...
                        try {
                            ...
                            psretur.setString(2, tbObat.getValueAt(i, 1).
                                    toString());
                            psretur.setString(3, tbObat.getValueAt(i, 13).
                                    toString());
                            psretur.setString(4, tbObat.getValueAt(i, 14).
                                    toString());
                            rsretur = psretur.executeQuery();
                            if (rsretur.next()) {
                                if (aktifkanbatch.equals("yes")) {
                                    Trackobat.catatRiwayat(tbObat.getValueAt(i,
                                            1).toString(), 0, rsretur.getDouble(
                                                    "jml"), "Retur Pasien",
                                            akses.getkode(), kdgudang.getText(),
                                            "Hapus", tbObat.getValueAt(i, 13).
                                                    toString(), tbObat.
                                    ...
                                    psupdategudang = koneksi.prepareStatement(
                                            "update gudangbarang set stok=stok-? where kode_brng=? and kd_bangsal=? and no_batch=? and no_faktur=?");
                                    try {
                                        psupdategudang.setDouble(1, rsretur.
                                                getDouble("jml"));
                                        psupdategudang.setString(2, tbObat.
                                                getValueAt(i, 1).toString());
                                        psupdategudang.setString(3, kdgudang.
                                                getText());
                                        psupdategudang.setString(4, tbObat.
                                                getValueAt(i, 13).toString());
                                        psupdategudang.setString(5, tbObat.
                                                getValueAt(i, 14).toString());
                        ...
                        try {
                            ...
                            pshapusretur.setString(2, tbObat.getValueAt(i, 1).
                                    toString());
                            pshapusretur.setString(3, tbObat.getValueAt(i, 13).
                                    toString());
                            pshapusretur.setString(4, tbObat.getValueAt(i, 14).
                                    toString());
                        ...
                        psimpanretur = koneksi.prepareStatement(
                                "insert into returpasien values(?,?,?,?,?,?)");
                        try {
                            psimpanretur.setString(1, Valid.SetTgl(Tanggal.
                                    getSelectedItem() + ""));
                            psimpanretur.setString(2, TNoRw.getText());
                            psimpanretur.setString(3, tbObat.getValueAt(i, 1).
                                    toString());
                            psimpanretur.setDouble(4, retur);
                            psimpanretur.setString(5, tbObat.getValueAt(i, 13).
                                    toString());
                            psimpanretur.setString(6, tbObat.getValueAt(i, 14).
                                    toString());
                            psimpanretur.executeUpdate();

                            if (aktifkanbatch.equals("yes")) {
                                Trackobat.catatRiwayat(tbObat.getValueAt(i, 1).
                                        toString(), retur, 0, "Retur Pasien",
                                        akses.getkode(), kdgudang.getText(),
                                        "Simpan", tbObat.getValueAt(i, 13).
                                ...
                                Sequel.mengedit("data_batch",
                                        ...
                                        "sisa=sisa+?", 4, new String[]{
                                            ...
                                            tbObat.getValueAt(i, 14).toString(),
                                            tbObat.getValueAt(i, 1).toString()
                                        });
                                psupdategudang2 = koneksi.prepareStatement(
                                        "update gudangbarang set stok=stok+? where kode_brng=? and kd_bangsal=? and no_batch=? and no_faktur=?");
                                try {
                                    psupdategudang2.setDouble(1, retur);
                                    psupdategudang2.setString(2, tbObat.
                                            getValueAt(i, 1).toString());
                                    psupdategudang2.setString(3, kdgudang.
                                            getText());
                                    psupdategudang2.setString(4, tbObat.
                                            getValueAt(i, 13).toString());
                                    psupdategudang2.setString(5, tbObat.
                                            getValueAt(i, 14).toString());
                    ...
                    psobatsimpan = koneksi.prepareStatement(
                            "insert into detail_pemberian_obat values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                    try {
                        if (pagi > 0) {
                            psobatsimpan.setString(1, Valid.SetTgl(Tanggal.
                                    getSelectedItem() + ""));
                            psobatsimpan.setString(2, "07:00:00");
                            psobatsimpan.setString(3, TNoRw.getText());
                            psobatsimpan.setString(4, tbObat.getValueAt(i, 1).
                                    toString());
                            psobatsimpan.setDouble(5, beli);
                            psobatsimpan.setDouble(6, harga);
                            if (tbObat.getValueAt(i, 0).toString().
                                    equals("true")) {
                            ...
                            psobatsimpan.setString(13, tbObat.getValueAt(i, 13).
                                    toString());
                            psobatsimpan.setString(14, tbObat.getValueAt(i, 14).
                                    toString());
...
private void TanggalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TanggalKeyPressed
                ...
                while (rspasien.next()) {
                    ...
                    for (i = 0; i < tbObat.getRowCount(); i++) {
                        Sequel.menyimpan("temporary", "'" + i + "','"
                                ...
                                + tbObat.getValueAt(i, 12).toString() + "','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
                    ...
                    param.put("tanggal", Valid.SetTgl(
                    ...
                    Valid.MyReportqry("rptObatPasien.jasper", "report",
                            "::[ Obat Keluar Masuk ]::",
        ...
        if (tbObat.getRowCount() != 0) {
            if (evt.getKeyCode() == KeyEvent.VK_DELETE) {
                if (tbObat.getSelectedRow() != -1) {
                    if ((tbObat.getSelectedColumn() == 4) || (tbObat.
                            getSelectedColumn() == 5) || (tbObat.
                                    getSelectedColumn() == 6) || (tbObat.
                                    getSelectedColumn() == 7) || (tbObat.
                                    getSelectedColumn() == 10)) {
                        try {
                            tbObat.setValueAt(null, tbObat.getSelectedRow(),
                                    tbObat.getSelectedColumn());
                        } catch (Exception e) {
                        }
                    }
                }
                ...
                if (tbObat.getSelectedColumn() == 13) {
                    try {
                        if (tbObat.getValueAt(tbObat.getSelectedRow(), 13).
                                toString().equals("0") || tbObat.getValueAt(
                                tbObat.getSelectedRow(), 13).toString().
                                isEmpty() || tbObat.getValueAt(tbObat.
                                        getSelectedRow(), 13).toString().equals(
                                                "0.0") || tbObat.getValueAt(
                                        tbObat.getSelectedRow(), 13).toString().
                                        equals("0,0")) {
                            tbObat.setValueAt(embalase, tbObat.getSelectedRow(),
                                    13);
                        }
                    } catch (Exception e) {
                    ...
                    try {
                        if (tbObat.getValueAt(tbObat.getSelectedRow(), 14).
                                toString().equals("0") || tbObat.getValueAt(
                                tbObat.getSelectedRow(), 14).toString().
                                isEmpty() || tbObat.getValueAt(tbObat.
                                        getSelectedRow(), 14).toString().equals(
                                                "0.0") || tbObat.getValueAt(
                                        tbObat.getSelectedRow(), 14).toString().
                                        equals("0,0")) {
                            tbObat.setValueAt(tuslah, tbObat.getSelectedRow(),
                                    14);
                        }
                    } catch (Exception e) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariObat3 dialog = new DlgCariObat3(new javax.swing.JFrame(),
                    true);
            ...
            try {
                ...
                while (rstampilbarang.next()) {
                    ...
                    try {
                        ...
                        psstokmasuk.setString(2, Valid.SetTgl(Tanggal.
                                getSelectedItem() + ""));
                        psstokmasuk.setString(3, rstampilbarang.getString(
                                "kode_brng"));
                        psstokmasuk.setString(4, rstampilbarang.getString(
                                "no_batch"));
                        psstokmasuk.setString(5, rstampilbarang.getString(
                                "no_faktur"));
                    ...
                    try {
                        ...
                        pspemberian.setString(2, Valid.SetTgl(Tanggal.
                                getSelectedItem() + ""));
                        pspemberian.setString(3, rstampilbarang.getString(
                                "kode_brng"));
                        pspemberian.setString(4, "00:00:01");
                        pspemberian.setString(5, "10:00:00");
                        pspemberian.setString(6, rstampilbarang.getString(
                                "no_batch"));
                        pspemberian.setString(7, rstampilbarang.getString(
                                "no_faktur"));
                    ...
                    try {
                        ...
                        pskeluar.setString(2, rstampilbarang.getString(
                                "kode_brng"));
                        pskeluar.setString(3, rstampilbarang.getString(
                                "no_batch"));
                        pskeluar.setString(4, rstampilbarang.getString(
                                "no_faktur"));
                    ...
                    try {
                        psretur.setString(1, TNoRw.getText());
                        psretur.setString(2, rstampilbarang.getString(
                                "kode_brng"));
                        psretur.setString(3, rstampilbarang.
                                getString("no_batch"));
                        psretur.setString(4, rstampilbarang.getString(
                                "no_faktur"));
                        rsretur = psretur.executeQuery();
                        if (rsretur.next()) {
                    ...
                    tabMode.addRow(new Object[]{
                        false, rstampilbarang.getString("kode_brng"),
                        rstampilbarang.getString("nama_brng"), stokmasuk, pagi,
                        siang, sore, malam, rstampilbarang.getDouble("jumlah"),
                        keluar, retur, returshs, hilang, rstampilbarang.
                        getString("no_batch"), rstampilbarang.getString(
                        "no_faktur"), rstampilbarang.getString("aturan_pakai"),
                        rstampilbarang.getString("jam00").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam01").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam02").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam03").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam04").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam05").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam06").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam07").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam08").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam09").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam10").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam11").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam12").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam13").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam14").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam15").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam16").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam17").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam18").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam19").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam20").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam21").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam22").
                        replaceAll("true", "V").replaceAll("false", "X"),
                        rstampilbarang.getString("jam23").
                        replaceAll("true", "V").replaceAll("false", "X")
                    });
                }
            } catch (Exception e) {
    ...
    public void setNoRm(String norwt, String norm, String pasien, Date tanggal) {
        ...
        kelas.setText(Sequel.cariIsi(
                ...
                + "where kamar_inap.no_rawat=? and kamar_inap.stts_pulang='-' order by STR_TO_DATE(concat(kamar_inap.tgl_masuk,' ',jam_masuk),'%Y-%m-%d %H:%i:%s') desc limit 1",
                norwt));
    ...
    private void getData() {
        ...
        if (TNoRw.getText().trim().isEmpty()) {
            ...
            Kd2.
                    setText(tbObat.getValueAt(tbObat.getSelectedRow(), 1).
                            toString());
            int kolom = tbObat.getSelectedColumn();
            if ((kolom == 4) || (kolom == 5) || (kolom == 6) || (kolom == 7)) {
                pagi = 0;
                try {
                    pagi = Double.parseDouble(tbObat.getValueAt(row, 4).
                            toString());
                } catch (Exception e) {
                    pagi = 0;
                }
                siang = 0;
                try {
                    siang = Double.parseDouble(tbObat.getValueAt(row, 5).
                            toString());
                } catch (Exception e) {
                    siang = 0;
                }
                sore = 0;
                try {
                    sore = Double.parseDouble(tbObat.getValueAt(row, 6).
                            toString());
                } catch (Exception e) {
                    sore = 0;
                }
                malam = 0;
                try {
                    malam = Double.parseDouble(tbObat.getValueAt(row, 7).
                            toString());
                } catch (Exception e) {
                    malam = 0;
                }
                stokmasuk = 0;
                try {
                    stokmasuk = Double.parseDouble(tbObat.getValueAt(row, 8).
                            toString());
                } catch (Exception e) {
                    stokmasuk = 0;
                }
                if (tbObat.getValueAt(row, 0).toString().equals("false")) {
                    ...
                    try {
                        ...
                        pscariharga = koneksi.prepareStatement(
                                ...
                                + "where databarang.kode_brng=?");
                        try {
                            pscariharga.setString(1, tbObat.getValueAt(row, 1).
                                    toString());
                            rscariharga = pscariharga.executeQuery();
                            while (rscariharga.next()) {
                                if (rscariharga.getDouble("kapasitas") > 0) {
                                    kapasitas = rscariharga.getDouble(
                                            "kapasitas");
                                }
                            }
                        } catch (Exception e) {
                        ...
                        if ((stokmasuk - ((pagi / kapasitas) + (siang / kapasitas) + (sore / kapasitas) + (malam / kapasitas))) < 0) {
                            ...
                            tbObat.setValueAt(
                                    ((pagi / kapasitas) + (siang / kapasitas) + (sore / kapasitas) + (malam / kapasitas)),
                                    row, 9);
                        }
                    } catch (Exception ex) {
                        System.out.println(ex);
                ...
                retur = 0;
                try {
                    retur = Double.parseDouble(tbObat.getValueAt(row, 10).
                            toString());
                } catch (Exception e) {
                    retur = 0;
                }
                stokmasuk = 0;
                try {
                    stokmasuk = Double.parseDouble(tbObat.getValueAt(row, 11).
                            toString());
                } catch (Exception e) {
                    stokmasuk = 0;
                }
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariObat3.class.
            getName());
}
