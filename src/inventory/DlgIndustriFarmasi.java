...
//GEN-FIRST:event_TKdKeyPressed
    private void KdKeyPressed(java.awt.event.KeyEvent evt) {//GEN-LAST:event_TKdKeyPressed
        Valid.pindah(evt, Telp, Nm, TCari);//GEN-FIRST:event_KdKeyPressed
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select industrifarmasi.kode_industri, industrifarmasi.nama_industri, "
                    + " industrifarmasi.alamat,industrifarmasi.kota, industrifarmasi.no_telp from industrifarmasi "
                    + " where industrifarmasi.kode_industri like ? or " + " industrifarmasi.nama_industri like ? or "
                    + " industrifarmasi.alamat like ? or " + " industrifarmasi.kota like ? or "
    ...
    private static final Logger LOG = Logger.getLogger(DlgIndustriFarmasi.class.getName());
