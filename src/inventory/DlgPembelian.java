...
public class DlgPembelian extends javax.swing.JDialog {
    ...
    private String aktifkanbatch = "no", pengaturanharga = "", hargadasar = "", Pengadaan_Obat = Sequel.
            cariIsi("select set_akun.Pengadaan_Obat from set_akun"),
            PPN_Masukan = Sequel.cariIsi(
                    "select set_akun.PPN_Masukan from set_akun"), kode_akun_bayar = "", pakaippn = "";
    ...
    public DlgPembelian(java.awt.Frame parent, boolean modal) {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select set_harga_obat.setharga,set_harga_obat.hargadasar,set_harga_obat.ppn from set_harga_obat");
            try {
                rs = ps.executeQuery();
                if (rs.next()) {
...
*/
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if (NoFaktur.getText().trim().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null,
                    "Maaf, Silahkan masukkan pembelian...!!!!");
            tbDokter.requestFocus();
        } else {
            ...
            if (reply == JOptionPane.YES_OPTION) {
                try {
                    ...
                    try {
                        ...
                        if (response.isArray()) {
                            for (JsonNode list : response) {
                                if (list.path("NamaAkun").asText().equals(
                                        AkunBayar.getSelectedItem().toString())) {
                                    kode_akun_bayar = list.path("KodeRek").
                                            asText();
                                }
                            }
                        }
                    ...
                    if (Sequel.
                            menyimpantf2("pembelian", "?,?,?,?,?,?,?,?,?,?,?",
                                    "No.Faktur", 11, new String[]{
                                NoFaktur.getText(), kdsup.getText(), kdptg.
                                getText(), Valid.SetTgl(TglBeli.
                                        getSelectedItem() + ""),
                                "" + sbttl, "" + ttldisk, "" + ttl, "" + ppn,
                                "" + (ttl + ppn), kdgudang.getText(),
                                kode_akun_bayar
                            }) == true) {
                        jml = tbDokter.getRowCount();
                        for (i = 0; i < jml; i++) {
                            ...
                            try {
                                if (Valid.SetAngka(tbDokter.getValueAt(i, 0).
                                        toString()) > 0) {
                                    if (Sequel.menyimpantf2("detailbeli",
                                            "?,?,?,?,?,?,?,?,?,?,?,?",
                                            "Transaksi Pembelian", 12,
                                            new String[]{
                                                NoFaktur.getText(),
                                                tbDokter.getValueAt(i, 2).
                                                        toString(),
                                                tbDokter.getValueAt(i, 1).
                                                        toString(),
                                                tbDokter.getValueAt(i, 0).
                                                        toString(),
                                                tbDokter.getValueAt(i, 7).
                                                        toString(),
                                                tbDokter.getValueAt(i, 8).
                                                        toString(),
                                                tbDokter.getValueAt(i, 9).
                                                        toString(),
                                        ...
                                        if (aktifkanbatch.equals("yes")) {
                                            Trackobat.catatRiwayat(tbDokter.
                                                    ...
                                                    Valid.SetAngka(tbDokter.
                                                            getValueAt(i, 12).
                                                            toString()), 0,
                                                    "Pengadaan", akses.getkode(),
                                                    kdgudang.getText(), "Simpan",
                                                    tbDokter.getValueAt(i, 13).
                                                            toString(),
                                                    NoFaktur.getText(),
                                                    NoFaktur.getText() + " " + nmsup.
                                                    getText());
                                            Sequel.menyimpan("gudangbarang",
                                                    "'" + tbDokter.getValueAt(i,
                                                            2).toString() + "','" + kdgudang.
                                                            getText() + "','" + tbDokter.
                                                            getValueAt(i, 12).
                                                            toString() + "','" + tbDokter.
                        ...
                        if (sukses == true) {
                            ...
                            Sequel.menyimpan2("tampjurnal", "?,?,?,?", 4,
                                    new String[]{Pengadaan_Obat, "PEMBELIAN",
                                        "" + ttl, "0"});
                            if (ppn > 0) {
                                Sequel.menyimpan2("tampjurnal", "?,?,?,?", 4,
                                        new String[]{PPN_Masukan,
                                            "PPN Masukan Obat", "" + ppn, "0"});
                            }
                            Sequel.menyimpan2("tampjurnal", "?,?,?,?", 4,
                                    new String[]{kode_akun_bayar, AkunBayar.
                                                getSelectedItem().toString(),
                                        "0", "" + (ttl + ppn)});
                            sukses = jur.simpanJurnal(NoFaktur.getText(), "U",
                                    "PEMBELIAN DI " + nmgudang.getText().
...
private void btnGudangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGudangActionPerformed
                ...
                case KeyEvent.VK_ENTER:
                    try {
                        if ((tbDokter.getSelectedColumn() == 2) || (tbDokter.
                            ...
                            setKonversi(tbDokter.getSelectedRow());
                            try {
                                tbDokter.setValueAt(Math.round(Double.
                                        parseDouble(tbDokter.getValueAt(
                                                tbDokter.getSelectedRow(), 8).
                                                toString())
                                        * (Double.parseDouble(tbDokter.
                                                getValueAt(tbDokter.
                                                        getSelectedRow(), 9).
                                ...
                                tbDokter.
                                        setValueAt(0, tbDokter.getSelectedRow(),
                                                10);
                            }
                            getData();
                ...
                case KeyEvent.VK_DELETE:
                    try {
                        if (tbDokter.getSelectedColumn() == 0) {
                            tbDokter.setValueAt(null, tbDokter.getSelectedRow(),
                                    0);
                    ...
                    try {
                        if (tbDokter.getSelectedColumn() == 0) {
                            if (tbDokter.
                                    ...
                                    toString().equals("0") || tbDokter.
                                    getValueAt(tbDokter.getSelectedRow(), 0).
                                    toString().equals("0.0") || tbDokter.
                                    getValueAt(tbDokter.getSelectedRow(), 0).
                                    toString().equals("0,0")) {
                                tbDokter.setValueAt("", tbDokter.
                                        getSelectedRow(), 0);
                            }
                        } else if (tbDokter.getSelectedColumn() == 7) {
                            if (tbDokter.
                            ...
                            if (tbDokter.
                                    getValueAt(tbDokter.getSelectedRow(), 9).
                                    toString().equals("0") || tbDokter.
                                    getValueAt(tbDokter.getSelectedRow(), 9).
                                    toString().equals("0.0") || tbDokter.
                                    getValueAt(tbDokter.getSelectedRow(), 9).
                            ...
                            if (tbDokter.getValueAt(tbDokter.getSelectedRow(),
                                    10).toString().equals("0") || tbDokter.
                                    getValueAt(tbDokter.getSelectedRow(), 10).
                                    toString().equals("0.0") || tbDokter.
                                    getValueAt(tbDokter.getSelectedRow(), 10).
                                    toString().equals("0,0")) {
                                tbDokter.setValueAt("", tbDokter.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPembelian dialog = new DlgPembelian(new javax.swing.JFrame(),
                    true);
    ...
    private void autoNomor() {
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(pembelian.no_faktur,3),signed)),0) from pembelian where pembelian.tgl_beli='" + Valid.
                        SetTgl(TglBeli.getSelectedItem() + "") + "'",
                "PG" + TglBeli.getSelectedItem().toString().substring(6, 10) + TglBeli.
        ...
        if ((!tbDokter.getValueAt(i, 13).toString().isEmpty()) && (!tbDokter.
            ...
            Sequel.menyimpan2("data_batch",
                    ...
                    new String[]{
                        ...
                        getValueAt(i, 2).toString(), Valid.SetTgl(TglBeli.
                        getSelectedItem() + ""), Valid.SetTgl(tbDokter.
                                getValueAt(i, 6).toString()), "Pengadaan",
                        NoFaktur.getText(),
    ...
    private static final Logger LOG = Logger.getLogger(DlgPembelian.class.
            getName());
}
