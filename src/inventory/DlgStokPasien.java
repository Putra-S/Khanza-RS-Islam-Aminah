 ...
 * @author dosen
 */
public class DlgStokPasien extends javax.swing.JDialog {
    ...
    public DlgStokPasien(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {
            "Tanggal", "Jam", "No.Rawat", "Pasien", "Barang", "Jml", "Asal Stok",
            "Kode Barang", "Kode Bangsal", "No.Batch", "No.Faktur",
            "Aturan Pakai",
        ...
        if (tbKamar.getSelectedRow() != -1) {
            if (Sequel.cariInteger(
                    ...
                    + "kode_brng='" + tbKamar.getValueAt(tbKamar.
                            getSelectedRow(), 7).toString() + "' and "
                    + "no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and "
                    + "no_batch='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 9).toString() + "' and "
                    + "no_faktur='" + tbKamar.getValueAt(tbKamar.
                            getSelectedRow(), 10).toString() + "' ") > 0) {
                JOptionPane.showMessageDialog(null,
                        "Maaf, data Obat/Alkes/BHP sudah digunakan dalam pemberian obat.\nSilahkan hapus data Obat/Alkes/BHP yang ada dalam pemberian obat terlebih dahulu..!!!");
            } else {
                if (Sequel.cariRegistrasi(tbKamar.getValueAt(tbKamar.
                    ...
                    if (aktifkanbatch.equals("yes")) {
                        Sequel.mengedit("data_batch",
                                "no_batch=? and no_faktur=? and kode_brng=?",
                                "sisa=sisa+?", 4, new String[]{
                                    ...
                                    tbKamar.getValueAt(tbKamar.getSelectedRow(),
                                            9).toString(),
                                    tbKamar.getValueAt(tbKamar.getSelectedRow(),
                                            10).toString(), tbKamar.getValueAt(
                                            tbKamar.getSelectedRow(), 7).
                                            toString()
                                });
                        Trackobat.catatRiwayat(tbKamar.getValueAt(tbKamar.
                                getSelectedRow(), 7).toString(), Valid.SetAngka(
                                        tbKamar.getValueAt(tbKamar.
                                                getSelectedRow(), 5).toString()),
                                0, "Stok Pasien Ranap", akses.getkode(),
                                tbKamar.getValueAt(tbKamar.getSelectedRow(), 8).
                                        toString(), "Hapus", tbKamar.getValueAt(
                                        tbKamar.getSelectedRow(), 9).toString(),
                                tbKamar.getValueAt(tbKamar.getSelectedRow(), 10).
                                        toString(), tbKamar.getValueAt(tbKamar.
                                        getSelectedRow(), 2).toString() + " " + tbKamar.
                                        getValueAt(tbKamar.getSelectedRow(), 3).
                                        toString());
                        Sequel.menyimpan("gudangbarang", "'" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 7).
                                toString() + "','" + tbKamar.getValueAt(tbKamar.
                                        getSelectedRow(), 8).toString() + "','" + tbKamar.
                                        getValueAt(tbKamar.getSelectedRow(), 5).
                                        toString() + "','" + tbKamar.getValueAt(
                                        tbKamar.getSelectedRow(), 9).toString() + "','" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 10).
                                toString() + "'",
                                "stok=stok+'" + tbKamar.getValueAt(tbKamar.
                                        getSelectedRow(), 5).toString() + "'",
                                "kode_brng='" + tbKamar.getValueAt(tbKamar.
                                        getSelectedRow(), 7).toString() + "' and kd_bangsal='" + tbKamar.
                                        getValueAt(tbKamar.getSelectedRow(), 8).
                                        toString() + "' and no_batch='" + tbKamar.
                                        getValueAt(tbKamar.getSelectedRow(), 9).
                        ...
                        Trackobat.catatRiwayat(tbKamar.getValueAt(tbKamar.
                                ...
                                0, "Stok Pasien Ranap", akses.getkode(),
                                tbKamar.getValueAt(tbKamar.getSelectedRow(), 8).
                                        toString(), "Hapus", "", "", tbKamar.
                                        getValueAt(tbKamar.getSelectedRow(), 2).
                                        toString() + " " + tbKamar.getValueAt(
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().trim().isEmpty()) {
                Valid.MyReportqry("rptStokPasien.jasper", "report",
                        "::[ Pemberian Stok Obat, Alkes & BHP Medis ]::",
                        ...
                        + "where stok_obat_pasien.tanggal between '" + Valid.
                                SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.
                        SetTgl(Tgl2.getSelectedItem() + "") + "' order by stok_obat_pasien.tanggal",
                        param);
            } else {
                Valid.MyReportqry("rptStokPasien.jasper", "report",
                        "::[ Pemberian Stok Obat, Alkes & BHP Medis ]::",
                        ...
                        + "where stok_obat_pasien.tanggal between '" + Valid.
                                SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.
                        SetTgl(Tgl2.getSelectedItem() + "") + "' and stok_obat_pasien.no_rawat like '%" + TCari.
                        getText().trim() + "%' or "
                        + "stok_obat_pasien.tanggal between '" + Valid.SetTgl(
                        ...
                        + "stok_obat_pasien.tanggal between '" + Valid.SetTgl(
                                Tgl1.getSelectedItem() + "") + "' and '" + Valid.
                        SetTgl(Tgl2.getSelectedItem() + "") + "' and stok_obat_pasien.no_batch like '%" + TCari.
                        getText().trim() + "%' or "
                        + "stok_obat_pasien.tanggal between '" + Valid.SetTgl(
                                Tgl1.getSelectedItem() + "") + "' and '" + Valid.
                        SetTgl(Tgl2.getSelectedItem() + "") + "' and stok_obat_pasien.no_faktur like '%" + TCari.
                        getText().trim() + "%' or "
                        + "stok_obat_pasien.tanggal between '" + Valid.SetTgl(
                                Tgl1.getSelectedItem() + "") + "' and '" + Valid.
                        SetTgl(Tgl2.getSelectedItem() + "") + "' and bangsal.nm_bangsal like '%" + TCari.
                        getText().trim() + "%' order by stok_obat_pasien.tanggal",
                        param);
            }
        }
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam00='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 2).
                                toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 0).
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam00='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam01='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam01='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam02='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam02='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam03='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam03='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam04='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam04='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam05='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam05='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam06='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam06='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam07='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam07='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam08='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam08='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam09='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam09='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam10='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam10='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam11='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam11='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam12='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam12='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam13='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam13='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam14='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam14='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam15='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam15='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam16='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam16='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam17='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam17='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam18='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam18='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam19='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam19='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam20='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam20='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam21='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam21='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam22='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam22='true'",
                        param);
            }
            if (Sequel.cariInteger(
                    "select count(*) from stok_obat_pasien where stok_obat_pasien.no_rawat='" + tbKamar.
                            getValueAt(tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                    getValueAt(tbKamar.getSelectedRow(), 1).toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam23='true'") > 0) {
                ...
                Valid.MyReportqry("rptItemStokPasien.jasper", "report",
                        ...
                        + "where stok_obat_pasien.no_rawat='" + tbKamar.
                                ...
                                toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                                getValueAt(tbKamar.getSelectedRow(), 1).
                                toString() + "' and stok_obat_pasien.aturan_pakai<>'' and stok_obat_pasien.jam23='true'",
                        param);
            }
            this.setCursor(Cursor.getDefaultCursor());
        }
    ...
    private void ppLabelObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLabelObatActionPerformed
        ...
        Valid.MyReportqry("rptLabelDaftarObatStokPasien.jasper", "report",
                ...
                + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                + "inner join databarang on stok_obat_pasien.kode_brng=databarang.kode_brng "
                + "where  stok_obat_pasien.no_rawat='" + tbKamar.getValueAt(
                        tbKamar.getSelectedRow(), 2).toString() + "' and stok_obat_pasien.tanggal='" + tbKamar.
                getValueAt(tbKamar.getSelectedRow(), 0).toString() + "' and stok_obat_pasien.jam='" + tbKamar.
                getValueAt(tbKamar.getSelectedRow(), 1).toString() + "'", param);
        this.setCursor(Cursor.getDefaultCursor());
    ...
    private void ppLabelObat2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLabelObat2ActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (Sequel.cariInteger(
                ...
                param.put("logo", Sequel.cariGambar(
                        "select setting.logo from setting"));
                Valid.MyReportqry("rptLabelDaftarObatStokPasien2.jasper",
                        "report", "::[ Aturan Pakai Obat ]::",
                        "select stok_obat_pasien.tanggal,stok_obat_pasien.jam, stok_obat_pasien.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"
                        + "stok_obat_pasien.kode_brng,databarang.nama_brng, stok_obat_pasien.jumlah,stok_obat_pasien.kd_bangsal,"
                        + "stok_obat_pasien.no_batch,stok_obat_pasien.no_faktur,stok_obat_pasien.aturan_pakai "
                        + "from stok_obat_pasien inner join reg_periksa on stok_obat_pasien.no_rawat=reg_periksa.no_rawat "
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgStokPasien dialog = new DlgStokPasien(new javax.swing.JFrame(),
                    true);
        ...
        try {
            ...
            try {
                if (TCari.getText().trim().isEmpty()) {
                    ...
                    pstampil.setString(19, Valid.SetTgl(
                            Tgl1.getSelectedItem() + ""));
                    pstampil.setString(20, Valid.SetTgl(
                            Tgl2.getSelectedItem() + ""));
                ...
                while (rstampil.next()) {
                    tabMode.addRow(new Object[]{
                        rstampil.getString(1), rstampil.getString(2), rstampil.
                        getString(3), rstampil.getString(4),
                        rstampil.getString(5), rstampil.getString(6), rstampil.
                        getString(7), rstampil.getString(8),
                        rstampil.getString(9), rstampil.getString(10), rstampil.
                        getString(11), rstampil.getString(12),
                        rstampil.getString(13).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(14).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(15).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(16).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(17).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(18).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(19).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(20).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(21).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(22).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(23).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(24).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(25).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(26).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(27).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(28).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(29).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(30).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(31).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(32).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(33).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(34).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(35).replaceAll("true", "✓").
                        replaceAll("false", "✕"),
                        rstampil.getString(36).replaceAll("true", "✓").
                        replaceAll("false", "✕")
                    });
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(DlgStokPasien.class.
            getName());
}
