...
public class DlgStokPasien extends javax.swing.JDialog {
    ...
    public DlgStokPasien(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Tanggal", "Jam", "No.Rawat", "Pasien", "Barang", "Jml", "Asal Stok", "Kode Barang",
            "Kode Bangsal", "No.Batch", "No.Faktur", "Aturan Pakai", "00", "01", "02", "03", "04", "05", "06", "07",
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                while (rstampil.next()) {
                    tabMode.addRow(new Object[]{rstampil.getString(1), rstampil.getString(2), rstampil.getString(3),
                        rstampil.getString(4), rstampil.getString(5), rstampil.getString(6), rstampil.getString(7),
                        rstampil.getString(8), rstampil.getString(9), rstampil.getString(10),
    ...
    private static final Logger LOG = Logger.getLogger(DlgStokPasien.class.getName());
