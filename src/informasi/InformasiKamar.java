...
public class InformasiKamar extends javax.swing.JDialog {
    ...
    public InformasiKamar(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Nomer Bad", "Kode Kamar", "Nama Kamar", "Kelas", "Tarif Kamar", "Status"};
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select kamar.kd_kamar,kamar.kd_bangsal,bangsal.nm_bangsal, "
                    ...
                    + " kamar.statusdata='1' and kamar.status like ? " + "order by bangsal.nm_bangsal");
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4),
                        Valid.SetAngka(rs.getDouble(5)), rs.getString(6)});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(InformasiKamar.class.getName());
