...
public class InformasiTarifLab extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString(1), rs.getString(2), Valid.SetAngka(rs.getDouble(3)),
                        rs.getString(4)});
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new String[]{"", "   " + rs2.getString(1),
                                Valid.SetAngka(rs2.getDouble(2)), rs.getString(4)});
                        }
                    } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(InformasiTarifLab.class.getName());
