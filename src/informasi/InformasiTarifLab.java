 ...
 * @author dosen
 */
public class InformasiTarifLab extends javax.swing.JDialog {
    ...
    public InformasiTarifLab(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Kode Periksa", "Nama Pemeriksaan",
            "Total Biaya Periksa", "Jenis Bayar"};
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InformasiTarifLab dialog = new InformasiTarifLab(
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new String[]{
                                "", "   " + rs2.getString(1), Valid.SetAngka(
                                rs2.getDouble(2)), rs.getString(4)
                            });
                        }
                    } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(InformasiTarifLab.class.
            getName());
