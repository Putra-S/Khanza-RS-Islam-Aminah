...
private void R3ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_R3ItemStateChanged
    ...
    public void tampil() {
        if (R1.isSelected() == true) {
            ...
            kmr = " kamar_inap.tgl_keluar='" + Valid.SetTgl(DTPCari3.getSelectedItem() + "")
                    + "' and kamar_inap.jam_keluar between '" + cmbJam1.getSelectedItem() + ":"
                    + cmbMnt1.getSelectedItem() + ":" + cmbDtk1.getSelectedItem() + "' and '"
            ...
            if (!BangsalCari.getText().isEmpty()) {
                kmr = " kamar_inap.tgl_keluar='" + Valid.SetTgl(DTPCari3.getSelectedItem() + "")
                        ...
                        + cmbMnt1.getSelectedItem() + ":" + cmbDtk1.getSelectedItem() + "' and '"
                        + cmbJam2.getSelectedItem() + ":" + cmbMnt2.getSelectedItem() + ":" + cmbDtk2.getSelectedItem()
                        + "' and bangsal.nm_bangsal='" + BangsalCari.getText() + "' ";
            }
        }
        ...
        if (!TCari.getText().isEmpty()) {
            key = kmr + "and kamar_inap.no_rawat like '%" + TCari.getText().trim() + "%' or " + kmr
                    ...
                    + TCari.getText().trim() + "%' or " + kmr + "and kamar.trf_kamar like '%" + TCari.getText().trim()
                    + "%' or " + kmr + "and kamar_inap.tgl_masuk like '%" + TCari.getText().trim() + "%' or " + kmr
        ...
        try {
            rs = koneksi.prepareStatement(
                    ...
                    + "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab " + "where  " + key
            ...
            while (rs.next()) {
                tabMode.addRow(new String[]{rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4),
                    rs.getString(5), rs.getString(6), Valid.SetAngka(rs.getDouble(7)), rs.getString(8),
                    rs.getString(9), rs.getString(10), rs.getString(11), rs.getString(12), rs.getString(13),
                    Valid.SetAngka(rs.getDouble(14)), rs.getString(15), rs.getString(16), rs.getString(17)});
            }
        } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(InformasiKamarInap.class.getName());
