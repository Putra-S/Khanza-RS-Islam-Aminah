...
public class InformasiTarifOperasi extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("kode_paket"), rs.getString("nm_perawatan"),
                        Valid.SetAngka(rs.getDouble("jumlah")), rs.getString("png_jawab")});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(InformasiTarifOperasi.class.getName());
