...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{"", "Isi : " + Sequel.cariInteger(
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new Object[]{"", rs2.getString("kd_kamar") + " " + rs2.getString("kelas"),
                    ...
                    tabMode.addRow(new Object[]{"", "Kosong : " + Sequel.cariInteger(
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new Object[]{"", rs2.getString("kd_kamar"),
                                Valid.SetAngka(rs2.getDouble("trf_kamar"))});
                        }
                    } catch (Exception e) {
                        System.out.println("Notifikasi : " + e);
    ...
    private static final Logger LOG = Logger.getLogger(InformasiAnalisaKamin.class.getName());
