 ...
 * @author dosen
 */
public class InformasiTarifRanap extends javax.swing.JDialog {
    ...
    public InformasiTarifRanap(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Kode", "Nama Tindakan/Perawatan/Tagihan", "Kategori", "Tarif", "Jenis Bayar",
            "Kamar/Bangsal"};
    ...
    private static final Logger LOG = Logger.getLogger(InformasiTarifRanap.class.getName());
