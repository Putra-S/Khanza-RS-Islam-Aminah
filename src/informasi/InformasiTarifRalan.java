 ...
 * @author dosen
 */
public class InformasiTarifRalan extends javax.swing.JDialog {
    ...
    public InformasiTarifRalan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Kode", "Nama Tindakan/Perawatan/Tagihan", "Kategori", "Tarif", "Jenis Bayar", "Unit/Poli"};
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString(1), rs.getString(2), rs.getString(3),
                        Valid.SetAngka(rs.getDouble(4)), rs.getString(5), rs.getString(6)});
                }
            } catch (Exception e) {
    ...
    private void tampil3() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode3.addRow(new Object[]{rs.getString(1), rs.getString(2), rs.getString(3),
                        Valid.SetAngka(rs.getDouble(4)), rs.getString(5), rs.getString(6)});
                }
            } catch (Exception e) {
                System.out.println(e);
    ...
    private static final Logger LOG = Logger.getLogger(InformasiTarifRalan.class.getName());
