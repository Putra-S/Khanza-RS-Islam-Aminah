...
public class InformasiJadwal extends javax.swing.JDialog {
    ...
    public InformasiJadwal(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Nama Dokter", "Hari Kerja", "Jam Mulai", "Jam Selesai",
            "Poliklinik"};
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InformasiJadwal dialog = new InformasiJadwal(
    ...
    private static final Logger LOG = Logger.getLogger(InformasiJadwal.class.
            getName());
