...
//    private final DefaultTableModel TabModeCatatan;
    ...
    private void initComponents() {
        ...
        FormInput.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        ...
        kddokter2.setPreferredSize(new java.awt.Dimension(62, 24));
        kddokter2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                kddokter2ActionPerformed(evt);
            }
        });
        ...
        jLabel11.setText("Dr Perujuk :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(10, 70, 60, 23);
        ...
        BtnSeekDokter3.setBounds(358, 72, 28, 23);

        jLabel55.setText("Catatan :");
        jLabel55.setName("jLabel55"); // NOI18N
        FormInput.add(jLabel55);
        jLabel55.setBounds(10, 100, 60, 23);
        ...
        scrollPane4.setBounds(73, 102, 660, 68);

        jLabel20.setText("Diagnosa :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(370, 72, 77, 23);
        ...
        Diagnosa.setBounds(450, 70, 250, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if ((!kddokter2.getText().trim().isEmpty()) && (!TDokter2.
                getText().trim().isEmpty()) && (!Catatan.getText().trim().
                        isEmpty())) {
...
//                            LCount.setText(""+TabModeCatatan.getRowCount());{          
    ...
    private void BtnSeekDokter3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeekDokter3ActionPerformed
        ...
        dokter3.emptTeks();
        dokter3.isCek();
        dokter3.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void kddokter2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kddokter2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_kddokter2ActionPerformed
