...
public class DlgPengantarRanap extends javax.swing.JDialog {
    ...
    public DlgPengantarRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "J.K.", "Umur", "Alamat", "No.Telp", "No.KTP",
                    "Cara Bayar", "Asal Poli/Unit", "Dokter Yang Memeriksa", "Tanggal", "Diagnosa Awal",
                    "Indikasi Masuk", "Dokter DPJP", "SMF", "Rencana Tindak Lanjut", "Pemeriksaan Penunjang",
                    "KodeDokter"}) {
            @Override
        ...
        dokter.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (dokter.getTable().getSelectedRow() != -1) {
                    if ((dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(), 0).toString() + " - "
    ...
    private void initComponents() {
        ...
        IndikasiMasuk = new widget.TextBox();
        jLabel17 = new widget.Label();
        DokterDPJP = new widget.TextBox();
        jLabel18 = new widget.Label();
        SMF = new widget.TextBox();
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(878, 371));
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-10-2024" }));
        ...
        Diagnosa.setBounds(74, 100, 170, 23);
        ...
        btnDiagnosa.setBounds(250, 100, 28, 23);

        jLabel16.setText("Indikasi Masuk :");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(280, 100, 90, 23);

        IndikasiMasuk.setEditable(false);
        IndikasiMasuk.setHighlighter(null);
        IndikasiMasuk.setName("IndikasiMasuk"); // NOI18N
        FormInput.add(IndikasiMasuk);
        IndikasiMasuk.setBounds(370, 100, 250, 23);

        jLabel17.setText("DPJP :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(0, 130, 69, 23);

        DokterDPJP.setEditable(false);
        DokterDPJP.setHighlighter(null);
        DokterDPJP.setName("DokterDPJP"); // NOI18N
        FormInput.add(DokterDPJP);
        DokterDPJP.setBounds(180, 130, 190, 23);

        jLabel18.setText("SMF :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(400, 130, 40, 23);

        SMF.setEditable(false);
        SMF.setHighlighter(null);
        SMF.setName("SMF"); // NOI18N
        FormInput.add(SMF);
        SMF.setBounds(440, 130, 180, 23);

        jLabel19.setText("RTL :");
        jLabel19.setName("jLabel19"); // NOI18N
        FormInput.add(jLabel19);
        jLabel19.setBounds(0, 160, 69, 23);

        jLabel20.setText("Penunjang :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(0, 260, 69, 23);
        ...
        scrollPane1.setViewportView(RTL);

        FormInput.add(scrollPane1);
        scrollPane1.setBounds(70, 160, 550, 90);
        ...
        scrollPane2.setViewportView(Penunjang);

        FormInput.add(scrollPane2);
        scrollPane2.setBounds(70, 260, 550, 90);
        ...
        btnDokterDPJP.setBounds(370, 130, 28, 23);
        ...
        KdDokterDPJP.setBounds(74, 130, 100, 24);
        ...
        ScrollMenu.setPreferredSize(new java.awt.Dimension(125, 43));

        FormMenu.setBackground(new java.awt.Color(255, 255, 255));
        FormMenu.setBorder(null);
        FormMenu.setName("FormMenu"); // NOI18N
        FormMenu.setPreferredSize(new java.awt.Dimension(120, 43));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (NoRw.getText().trim().isEmpty() || NoRM.getText().trim().isEmpty() || NmPasien.
                getText().trim().isEmpty()) {
            Valid.textKosong(TCari, "Pasien");
        } else if (Diagnosa.getText().trim().isEmpty()) {
            Valid.textKosong(Diagnosa, "Diagnosa");
        } else {
            if (Sequel.menyimpantf("permintaan_ranap", "?,?,?,?,?", "Pasien", 5,
                    new String[]{ //                        NoRw.getText(), Valid.SetTgl(
                    //                        DTPTgl.getSelectedItem() + ""), KdKamar.getText(),
                    //                        Diagnosa.getText(), Catatan.getText()
                    }) == true) {
                tampil();
                emptTeks();
            }
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, Penunjang, BtnBatal);
        }
...
//                        + (TCari.getText().isEmpty() ? "" : "and (permintaan_ranap.no_rawat like '%" + TCari.
//                        getText().trim() + "%' or reg_periksa.no_rkm_medis like '%" + TCari.
//                                getText().trim() + "%' or pasien.nm_pasien like '%" + TCari.
//                                getText().trim() + "%' "
//                        + "or penjab.png_jawab like '%" + TCari.getText().trim() + "%' or poliklinik.nm_poli like '%" + TCari.
//                        getText().trim() + "%' or dokter.nm_dokter like '%" + TCari.
//                                getText().trim() + "%' or bangsal.nm_bangsal like '%" + TCari.
//                                getText().trim() + "%' "
//                        + "or permintaan_ranap.diagnosa like '%" + TCari.
//                                getText().trim() + "%')") + " order by permintaan_ranap.tanggal";
...
//                        + "inner join kamar on permintaan_ranap.kd_kamar=kamar.kd_kamar "
//                        + "inner join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal "
//                        + "where permintaan_ranap.no_rawat in (select DISTINCT no_rawat from kamar_inap) and permintaan_ranap.tanggal between '" + Valid.
...
//            }
            ...
            Valid.MyReportqry("rptPermintaanRawatInap.jasper", "report",
                    "::[ Data Pemesanan Rawat Inap ]::", sql, param);
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
        ...
        if (NoRw.getText().trim().isEmpty() || NoRM.getText().trim().isEmpty() || NmPasien.
            ...
            if (tbObat.getSelectedRow() > -1) {
                if (Sequel.mengedittf("permintaan_ranap", "no_rawat=?",
                        "no_rawat=?,tanggal=?,kd_kamar=?,diagnosa=?,catatan=?",
                        6, new String[]{ //                            NoRw.getText(), Valid.SetTgl(DTPTgl.
                        //                            getSelectedItem() + ""), KdKamar.getText(),
                        //                            Diagnosa.getText(), Catatan.getText(), tbObat.
    ...
    private void DiagnosaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagnosaKeyPressed
        Valid.pindah(evt, DTPTgl, IndikasiMasuk);
    ...
    private void btnDiagnosaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnDiagnosaKeyPressed
        Valid.pindah(evt, Diagnosa, IndikasiMasuk);
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbObat.getSelectedRow() != -1) {
                ...
                param.put("logo", Sequel.cariGambar(
                        "select setting.logo from setting"));
                Valid.
                        MyReportqry("rptSuratPermintaanRawatInap.jasper",
                                "report", "::[ Surat Permintaan Rawat Inap ]::",
    ...
    private void BtnRiwayatPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRiwayatPasienActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbObat.getSelectedRow() != -1) {
                ...
                resume.setNoRm(tbObat.getValueAt(tbObat.getSelectedRow(), 1).
                        toString(), tbObat.
                                getValueAt(tbObat.getSelectedRow(), 2).
                                toString());
    ...
    private widget.TextBox IndikasiMasuk;
    ...
    public void tampil() {
        ...
        try {
            ...
            // "select
            // permintaan_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.jk,reg_periksa.umurdaftar,reg_periksa.sttsumur,"
            // +
            // "pasien.no_tlp,penjab.png_jawab,poliklinik.nm_poli,dokter.nm_dokter,permintaan_ranap.tanggal,permintaan_ranap.kd_kamar,kamar.kd_bangsal,"
            // +
            ...
            // + "inner join kamar on permintaan_ranap.kd_kamar=kamar.kd_kamar "
            // + "inner join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal "
            // + "where permintaan_ranap.no_rawat not in (select DISTINCT no_rawat from
            // kamar_inap) "
            // + (TCari.getText().isEmpty() ? "" : "and (permintaan_ranap.no_rawat like ?
            // or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? "
            // + "or penjab.png_jawab like ? or poliklinik.nm_poli like ? or
            // dokter.nm_dokter like ? or bangsal.nm_bangsal like ? "
            // + "or permintaan_ranap.diagnosa like ?)") + " order by
            ...
            // + "inner join kamar on permintaan_ranap.kd_kamar=kamar.kd_kamar "
            // + "inner join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal "
            // + "where permintaan_ranap.no_rawat in (select DISTINCT no_rawat from
            // kamar_inap) and permintaan_ranap.tanggal between ? and ? "
            // + (TCari.getText().isEmpty() ? "" : "and (permintaan_ranap.no_rawat like ?
            // or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? "
            // + "or penjab.png_jawab like ? or poliklinik.nm_poli like ? or
            // dokter.nm_dokter like ? or bangsal.nm_bangsal like ? "
    ...
    private void isForm() {
        if (ChkInput.isSelected() == true) {
            ...
            PanelInput.setPreferredSize(new Dimension(WIDTH, 405));
            ...
            if (aktif == true) {
                ...
                if (detik.equals("05")) {
                    bookingbaru = Sequel.cariInteger(
                            "select count(*) from permintaan_ranap where no_rawat not in (select DISTINCT no_rawat from kamar_inap) ");
                    if (bookingbaru > 0) {
                        try {
    ...
    private static final Logger LOG = Logger.getLogger(DlgPengantarRanap.class.getName());
