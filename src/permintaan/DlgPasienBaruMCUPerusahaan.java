...
public class DlgPasienBaruMCUPerusahaan extends javax.swing.JDialog {
    ...
    private String tahun = "", awalantahun = "", bulan = "", awalanbulan = "", posisitahun = "", pengurutan = "",
            kdkel = "", kdkec = "", kdkab = "", kdprop = "", kdbahasa = "", kdcacatfisik = "", kdsuku = "";
    ...
    public DlgPasienBaruMCUPerusahaan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"P", "No.Pengajuan", "Nama Pasien", "No.KTP", "J.K", "Tempat Lahir", "Tgl.Lahir",
                    "Nama Ibu", "Alamat", "Kelurahan", "Kecamatan", "Kabupaten", "Propinsi", "G.D.", "Pekerjaan",
                    "Status Nikah", "Agama/Kepercayaan", "Tanggal MCU", "No.Telp/No.HP", "Umur", "Pendidikan",
                    "P.J./Keluarga", "Nama P.J./Keluarga", "Pekerjaan P.J/Keluarga", "Alamat P.J./Keluarga",
                    "Kelurahan P.J./Keluarga", "Kecamatan P.J./Keluarga", "Kabupaten P.J./Keluarga",
                    "Propinsi P.J./Keluarga", "Suku Bangsa Pasien", "Bahasa Pasien", "Cacat Fisik", "Email", "NIP",
                    "Status"}) {
            @Override
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select set_urut_no_rkm_medis.urutan,set_urut_no_rkm_medis.tahun,set_urut_no_rkm_medis.bulan,set_urut_no_rkm_medis.posisi_tahun_bulan from set_urut_no_rkm_medis");
            try {
                rs = ps.executeQuery();
                if (rs.next()) {
...
//GEN-FIRST:event_TKdKeyPressed
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        for(i=0;i<tbDokter.getRowCount();i++){//GEN-FIRST:event_BtnSimpanActionPerformed
    ...
    public void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString("no_pengajuan"), rs.getString("nm_pasien"),
                        rs.getString("no_ktp"), rs.getString("jk"), rs.getString("tmp_lahir"),
                        rs.getString("tgl_lahir"), rs.getString("nm_ibu"), rs.getString("alamat"),
                        rs.getString("kelurahan"), rs.getString("kecamatan"), rs.getString("kabupaten"),
                        rs.getString("propinsi"), rs.getString("gol_darah"), rs.getString("pekerjaan"),
                        rs.getString("stts_nikah"), rs.getString("agama"), rs.getString("tgl_mcu"),
                        rs.getString("no_tlp"), rs.getString("umur"), rs.getString("pnd"), rs.getString("keluarga"),
                        rs.getString("namakeluarga"), rs.getString("pekerjaanpj"), rs.getString("alamatpj"),
                        rs.getString("kelurahanpj"), rs.getString("kecamatanpj"), rs.getString("kabupatenpj"),
                        rs.getString("propinsipj"), rs.getString("suku_bangsa"), rs.getString("bahasa_pasien"),
                        rs.getString("cacat_fisik"), rs.getString("email"), rs.getString("nip"),
                        rs.getString("status")});
                }
            } catch (Exception e) {
