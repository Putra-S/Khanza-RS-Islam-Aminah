...
public class DlgPermintaanKonsultasiMedik extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (NoRw.getText().trim().isEmpty() || NoRM.getText().trim().isEmpty() || NmPasien.
            ...
            JOptionPane.showMessageDialog(null,
                    "Maaf, Dokter yang dikonsuli jangan diri sendiri...!");
        } else if (KdDokterDikonsuli.getText().trim().isEmpty() || NmDokterDikonsuli.
                getText().trim().isEmpty()) {
            Valid.textKosong(BtnDokterDIkonsuli, "Dokter Dikonsuli");
        } else if (DiagnosaKerja.getText().trim().isEmpty()) {
            Valid.textKosong(DiagnosaKerja, "Diagnosa Kerja");
        } else if (UraianKonsultasi.getText().trim().isEmpty()) {
            Valid.textKosong(UraianKonsultasi, "Uraian Konsultasi");
        } else {
            if (Sequel.menyimpantf("konsultasi_medik", "?,?,?,?,?,?,?,?",
                    "No.Permintaan", 8, new String[]{
                        ...
                        Permintaan.getSelectedItem().toString(), KdDokter.
                        getText(), KdDokterDikonsuli.getText(), DiagnosaKerja.
                        getText(), UraianKonsultasi.getText()
                    }) == true) {
                R1.setSelected(true);
                tampil();
                emptTeks();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            if (Sequel.queryu2tf(
                    "delete from konsultasi_medik where no_permintaan=?", 1,
                    new String[]{
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
        ...
        if (NoRw.getText().trim().isEmpty() || NoRM.getText().trim().isEmpty() || NmPasien.
            ...
            if (tbObat.getSelectedRow() > -1) {
                if (akses.getkode().equals("Admin Utama")) {
                    ...
                    if (!tbObat.getValueAt(tbObat.getSelectedRow(), 18).
                            toString().isEmpty()) {
                        JOptionPane.showMessageDialog(null,
                                "Sudah ada jawaban dokter yang dikonsuli, data tidak bisa diubah ..!!");
                    } else {
                        ganti();
                    }
                }
            ...
            if (tbObat.getSelectedRow() != -1) {
                if (akses.getkode().equals("Admin Utama")) {
                    ...
                    if (KdDokterDikonsuli.getText().equals(akses.getkode())) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Maaf, hanya bisa dijawab oleh dokter yang dikonsuli...!!!!");
                    }
                }
            } else {
                JOptionPane.showMessageDialog(null,
            ...
            if (tbObat.getSelectedRow() != -1) {
                if (!tbObat.getValueAt(tbObat.getSelectedRow(), 18).toString().
                    ...
                    finger = Sequel.cariIsi(
                            ...
                            tbObat.getValueAt(tbObat.getSelectedRow(), 10).
                                    toString());
                    param.put("finger",
                            ...
                            getValueAt(tbObat.getSelectedRow(), 10).toString() : finger) + "\n" + Valid.
                            SetTgl3(tbObat.
                                    getValueAt(tbObat.getSelectedRow(), 8).
                                    toString()));
                    finger = Sequel.cariIsi(
                            "select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",
                            tbObat.getValueAt(tbObat.getSelectedRow(), 12).
                                    toString());
                    param.put("finger2",
                            "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.
                            getkabupatenrs() + "\nDitandatangani secara elektronik oleh " + tbObat.
                                    getValueAt(tbObat.getSelectedRow(), 13).
                                    toString() + "\nID " + (finger.isEmpty() ? tbObat.
                            getValueAt(tbObat.getSelectedRow(), 12).toString() : finger) + "\n" + Valid.
                            SetTgl3(tbObat.getValueAt(tbObat.getSelectedRow(),
                                    16).toString()));
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReportqry("rptDokumentasiKonsultasiMedik.jasper",
                            "report", "::[ Dokumentasi Konsultasi Medik ]::",
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Maaf, belum ada jawaban dokter yang dikonsuli...!!!!");
                }
            } else {
                JOptionPane.showMessageDialog(null,
                        "Maaf, silahkan pilih data...!!!!");
    ...
    private void BtnSimpanJawabanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanJawabanActionPerformed
        if (NoRw.getText().trim().isEmpty() || NoRM.getText().trim().isEmpty() || NmPasien.
            ...
            Valid.textKosong(UraianKonsultasi, "Uraian Konsultasi");
        } else if (JawabanDiagnosaKerja.getText().trim().isEmpty()) {
        ...
        } else if (JawabanKonsultasi.getText().trim().isEmpty()) {
            Valid.textKosong(JawabanKonsultasi, "Jawaban Konsultasi");
        } else if (KdDokter.getText().equals(KdDokterDikonsuli.getText())) {
            JOptionPane.showMessageDialog(null,
                    "Maaf, Dokter yang dikonsuli jangan diri sendiri...!");
        } else {
            if (Sequel.menyimpantf("jawaban_konsultasi_medik", "?,?,?,?", 4,
                    new String[]{
                        NoPermintaan.getText(), Valid.SetTgl(TanggalJawab.
                        getSelectedItem() + "") + " " + TanggalJawab.
                                getSelectedItem().toString().substring(11, 19),
                        JawabanDiagnosaKerja.getText(), JawabanKonsultasi.
                        getText()
                    }, "no_permintaan=?",
                    "tanggal=?,diagnosa_kerja=?,uraian_jawaban=?", 4,
                    new String[]{
                        Valid.SetTgl(TanggalJawab.getSelectedItem() + "") + " " + TanggalJawab.
                        getSelectedItem().toString().substring(11, 19),
                        JawabanDiagnosaKerja.getText(), JawabanKonsultasi.
                        getText(), NoPermintaan.getText()
                    }) == true) {
                R2.setSelected(true);
                tampil();
                emptTeks();
                ...
                JOptionPane.showMessageDialog(null,
                        "Maaf, gagal menyimpan atau mengedit jawaban konsultasi medik...!!!");
                R1.setSelected(true);
                tampil();
                emptTeks();
            }
