        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (tabMode.getRowCount() == 0) {
                    ...
                    Valid.MyReport("rptLapPermintaanLabPA.jasper", "report",
                            "::[ Data Permintaan Laboratorium PA ]::", param);
                }
                ...
                if (tabMode2.getRowCount() == 0) {
                    ...
                    for (i = 0; i < row; i++) {
                        ...
                        Sequel.menyimpan("temporary_permintaan_lab", "'0','"
                                ...
                                + tabMode2.getValueAt(i, 24).toString() + "','','','','','','','','','','','',''",
                                "Periksa Lab");
                    }
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReport("rptLapPermintaanLabPA2.jasper", "report",
                            "::[ Data Detail Permintaan Laboratorium PA ]::",
                            param);
                }
            }
        } else if (TabPilihRawat.getSelectedIndex() == 1) {
                ...
                if (tabMode3.getRowCount() == 0) {
                    ...
                    for (i = 0; i < row; i++) {
                        ...
                        Sequel.menyimpan("temporary_permintaan_lab", "'0','"
                                ...
                                + tabMode3.getValueAt(i, 24).toString() + "','','','','','','','','','','','',''",
                                "Periksa Lab");
                    }
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReport("rptLapPermintaanLabPA3.jasper", "report",
                            "::[ Data Permintaan Laboratorium PA ]::", param);
                }
                ...
                if (tabMode4.getRowCount() == 0) {
                    ...
                    for (i = 0; i < row; i++) {
                        ...
                        Sequel.menyimpan("temporary_permintaan_lab", "'0','"
                                ...
                                + tabMode4.getValueAt(i, 24).toString() + "','','','','','','','','','','','',''",
                                "Periksa Lab");
                    }
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReport("rptLapPermintaanLabPA4.jasper", "report",
                            "::[ Data Detail Permintaan Laboratorium PA ]::",
                            param);
                }
            }
                ...
                if (NoPermintaan.trim().isEmpty()) {
                    ...
                    if (Sampel.isEmpty() || akses.getkode().
                        ...
                        if ((Sequel.cariInteger(
                                "select count(noorder) from permintaan_pemeriksaan_labpa where stts_bayar='Sudah' and noorder=?",
                                NoPermintaan)
                                + Sequel.cariInteger(
                                        "select count(noorder) from permintaan_detail_permintaan_labpa where stts_bayar='Sudah' and noorder=?",
                                        NoPermintaan)) > 0) {
                            JOptionPane.showMessageDialog(null,
                                    "Maaf, Tidak boleh dihapus karena sudah ada tindakan yang sudah dibayar.\nSilahkan hubungi kasir...!!!!");
                        } else {
                            Sequel.meghapus("permintaan_labpa", "noorder",
                                    NoPermintaan);
                            TeksKosong();
                            tampil();
                        }
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (!NoRawat.isEmpty()) {
                if (NoPermintaan.trim().isEmpty()) {
                    ...
                    if (Sequel.mengedittf("permintaan_labpa", "noorder=?",
                        ...
                        pilihan = (String) JOptionPane.showInputDialog(null,
                                ...
                                "Konfirmasi", JOptionPane.QUESTION_MESSAGE, null,
                                new Object[]{"Tidak Ada",
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (!NoRawat.isEmpty()) {
                ...
                if (NoPermintaan.trim().isEmpty()) {
                    ...
                    param.put("tanggalpa",
                            (pernahdilakukandi.isEmpty() ? "" : tanggalpa));
                    ...
                    Valid.MyReport("rptPermintaanLabPA.jasper", "report",
                            "::[ Permintaan Laboratorium Patologi Anatomi ]::",
                            param);
                }
                TeksKosong();
                this.setCursor(Cursor.getDefaultCursor());
                ...
                if (NoPermintaan.trim().isEmpty()) {
                    ...
                    Valid.
                            MyReportqry("rptBarcodePermintaanLab.jasper",
                                    ...
                                    "select noorder from permintaan_labpa where no_rawat='" + NoRawat + "'",
                                    param);
                    TeksKosong();
                    this.setCursor(Cursor.getDefaultCursor());
                }
            ...
            if (cmbStatus.getSelectedIndex() == 0) {
                ps = koneksi.prepareStatement(
                        ...
                        + (semua ? "" : "and dokter.nm_dokter like ? and bangsal.nm_bangsal like ? and "
                                + "(permintaan_labpa.noorder like ? or permintaan_labpa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "
                                + "pasien.nm_pasien like ? or permintaan_labpa.diagnosa_klinis like ? or dokter.nm_dokter like ? or penjab.png_jawab like ? )")
                        + "group by permintaan_labpa.noorder order by permintaan_labpa.tgl_permintaan desc,permintaan_labpa.jam_permintaan desc,kamar_inap.tgl_masuk desc");
            } else {
                ps = koneksi.prepareStatement(
                        "select permintaan_labpa.noorder,permintaan_labpa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,permintaan_labpa.tgl_permintaan,"
                        + "if(permintaan_labpa.jam_permintaan='00:00:00','',permintaan_labpa.jam_permintaan) as jam_permintaan,reg_periksa.kd_pj,penjab.png_jawab,"
            ...
            if (cmbStatus.getSelectedIndex() == 0) {
                ps = koneksi.prepareStatement(
                        ...
                        + (semua ? "" : "and dokter.nm_dokter like ? and bangsal.nm_bangsal like ? and "
                                ...
                                + "pasien.nm_pasien like ? or jns_perawatan_lab.nm_perawatan like ? or "
                                + "permintaan_labpa.diagnosa_klinis like ? or dokter.nm_dokter like ? or penjab.png_jawab like ?)")
                        + "group by permintaan_labpa.noorder,permintaan_pemeriksaan_labpa.kd_jenis_prw order by permintaan_labpa.tgl_permintaan desc,permintaan_labpa.jam_permintaan desc,kamar_inap.tgl_masuk desc");
            } else {
                ps = koneksi.prepareStatement(
                        "select distinct permintaan_labpa.noorder,permintaan_labpa.no_rawat,reg_periksa.no_rkm_medis,reg_periksa.kd_pj,"
                        + "pasien.nm_pasien,jns_perawatan_lab.nm_perawatan,permintaan_labpa.tgl_permintaan,penjab.png_jawab,"
