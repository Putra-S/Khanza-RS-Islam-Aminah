...
public class DlgCariPermintaanLab extends javax.swing.JDialog {
    ...
    private String pilihan = "", alarm = "", formalarm = "", nol_detik, detik, tglsampel = "", tglhasil = "", norm = "",
            kamar = "", namakamar = "", la = "", ld = "", pa = "", pd = "", InformasiTambahan, DiagnosaKlinis,
            NoPermintaan = "", NoRawat = "", Pasien = "", Permintaan = "", JamPermintaan = "", Sampel = "",
            JamSampel = "", Hasil = "", JamHasil = "", KodeDokter = "", DokterPerujuk = "", Ruang = "", json = "",
            finger = "", usia = "";
    ...
    public DlgCariPermintaanLab(java.awt.Frame parent, boolean modal) {
        ...
        tabMode2 = new DefaultTableModel(null,
                new Object[]{"No.Permintaan", "No.Rawat", "Pasien", "Pemeriksaan", "Detail Pemeriksaan", "Satuan",
                    "Nilai Rujukan", "Permintaan", "Jam", "Sampel", "Jam", "Hasil", "Jam", "Kode Dokter",
                    "Dokter Perujuk", "Poli Registrasi", "Informasi Tambahan", "Diagnosis Klinis", "Kode Bayar",
                    "Jenis Bayar"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
        ...
        tabMode4 = new DefaultTableModel(null,
                new Object[]{"No.Permintaan", "No.Rawat", "Pasien", "Pemeriksaan", "Detail Pemeriksaan", "Satuan",
                    "Nilai Rujukan", "Permintaan", "Jam", "Sampel", "Jam", "Hasil", "Jam", "Kode Dokter",
                    "Dokter Perujuk", "Kamar Terakhir", "Informasi Tambahan", "Diagnosis Klinis", "Kode Bayar",
                    "Jenis Bayar"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
    ...
    private void initComponents() {
        ...
        FormMenu.setPreferredSize(new java.awt.Dimension(187, 485));
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (tabMode.getRowCount() == 0) {
                    ...
                    Valid.MyReport("rptLapPermintaanLab.jasper", "report",
                            "::[ Data Permintaan Laboratorium ]::", param);
                }
                ...
                if (tabMode2.getRowCount() == 0) {
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReport("rptLapPermintaanLab2.jasper", "report",
                            "::[ Data Detail Permintaan Laboratorium ]::", param);
                }
            }
        } else if (TabPilihRawat.getSelectedIndex() == 1) {
            if (TabRawatInap.getSelectedIndex() == 0) {
                if (tabMode3.getRowCount() == 0) {
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReport("rptLapPermintaanLab3.jasper", "report",
                            "::[ Data Permintaan Laboratorium ]::", param);
                }
                ...
                if (tabMode4.getRowCount() == 0) {
                    ...
                    param.put("logo", Sequel.cariGambar(
                            "select setting.logo from setting"));
                    Valid.MyReport("rptLapPermintaanLab4.jasper", "report",
                            "::[ Data Detail Permintaan Laboratorium ]::", param);
                }
            }
        }
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
    if (TabPilihRawat.getSelectedIndex() == 0) {
        if (TabRawatJalan.getSelectedIndex() == 0) {
            if (!NoRawat.isEmpty()) {
                if (NoPermintaan.trim().isEmpty() || DiagnosaKlinis.trim().
                        isEmpty()) {
                    ...
                    if (Sampel.isEmpty() || akses.getkode().
                        ...
                        if ((Sequel.cariInteger(
                                "select count(noorder) from permintaan_pemeriksaan_lab where stts_bayar='Sudah' and noorder=?",
                                NoPermintaan)
                                + Sequel.cariInteger(
                                        "select count(noorder) from permintaan_detail_permintaan_lab where stts_bayar='Sudah' and noorder=?",
                                        NoPermintaan)) > 0) {
                            JOptionPane.showMessageDialog(null,
                                    "Maaf, Tidak boleh dihapus karena sudah ada tindakan yang sudah dibayar.\nSilahkan hubungi kasir...!!!!");
                        } else {
                            Sequel.meghapus("permintaan_lab", "noorder",
                                    NoPermintaan);
                            TeksKosong();
                            tampil();
                        }
...
private void tbLabRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbLabRalanKeyPressed
                    ...
                    if (NoPermintaan.trim().isEmpty() || DiagnosaKlinis.trim().
                        ...
                        if (Sampel.isEmpty()) {
                            JOptionPane.showMessageDialog(rootPane,
                                    "Maaf, silahkan ambil sampel terlebih dahulu..!!");
                        } else {
                            this.setCursor(Cursor.getPredefinedCursor(
                                    Cursor.WAIT_CURSOR));
                            DlgPeriksaLaboratorium dlgro = new DlgPeriksaLaboratorium(
                                    null, false);
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (!NoRawat.isEmpty()) {
                if (NoPermintaan.trim().isEmpty() || DiagnosaKlinis.trim().
                    ...
                    if (Sequel.mengedittf("permintaan_lab", "noorder=?",
                            "tgl_sampel=?,jam_sampel=?", 3, new String[]{
                                Valid.SetTgl(
                                        TanggalPulang.getSelectedItem() + ""),
                                TanggalPulang.getSelectedItem().toString().
                                        substring(11, 19), NoPermintaan
                            }) == true) {
                        WindowAmbilSampel.dispose();
                        try {
                            pilihan = (String) JOptionPane.showInputDialog(null,
                                    "Waktu pengambilan sampel berhasil disimpan, apakah ada yang ingin dicetak..?",
                                    "Konfirmasi", JOptionPane.QUESTION_MESSAGE,
                                    null, new Object[]{"Tidak Ada",
                                        "Barcode No.Permintaan 1",
                                        "Barcode No.Permintaan 2",
                                        "Lembar Permintaan Lab",
                                        "Lembar Permintaan Lab & Barcode No.Permintaan 1",
                                        "Lembar Permintaan Lab & Barcode No.Permintaan 2"},
                                    "Tidak Ada");
                            switch (pilihan) {
                                case "Tidak Ada":
                                    break;
                        ...
                        TeksKosong();
                        tbLabRalan.setValueAt(Valid.SetTgl(TanggalPulang.
                                getSelectedItem() + ""), tbLabRalan.
                                        getSelectedRow(), 5);
                        tbLabRalan.setValueAt(TanggalPulang.getSelectedItem().
                                toString().substring(11, 19), tbLabRalan.
                                getSelectedRow(), 6);
                    }
                }
            } else {
            ...
            if (!NoRawat.isEmpty()) {
                if (NoPermintaan.trim().isEmpty() || DiagnosaKlinis.trim().
                    ...
                    if (Sequel.mengedittf("permintaan_lab", "noorder=?",
                        ...
                        TeksKosong();
                        tbLabRanap.setValueAt(Valid.SetTgl(TanggalPulang.
                                getSelectedItem() + ""), tbLabRanap.
                                        getSelectedRow(), 5);
                        tbLabRanap.setValueAt(TanggalPulang.getSelectedItem().
                                toString().substring(11, 19), tbLabRanap.
                                getSelectedRow(), 6);
                    }
                }
            } else {
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (!NoRawat.isEmpty()) {
                ...
                if (NoPermintaan.trim().isEmpty() || DiagnosaKlinis.trim().
                            ...
                            while (rs2.next()) {
                                ...
                                try {
                                    ...
                                    while (rs3.next()) {
                                        ...
                                        pa = "";
                                        pd = "";
                                        if (!rs3.getString("nilai_rujukan_ld").
                                                isEmpty()) {
                                            ld = "LD : " + rs3.getString(
                                                    "nilai_rujukan_ld");
                                        }
                                        if (!rs3.getString("nilai_rujukan_la").
                                                isEmpty()) {
                                            la = ", LA : " + rs3.getString(
                                                    "nilai_rujukan_la");
                                        }
                                        if (!rs3.getString("nilai_rujukan_pa").
                                                isEmpty()) {
                                            pd = ", PD : " + rs3.getString(
                                                    "nilai_rujukan_pd");
                                        }
                                        if (!rs3.getString("nilai_rujukan_pd").
                                                isEmpty()) {
                                            pa = " PA : " + rs3.getString(
                                                    "nilai_rujukan_pa");
                                        }
                    ...
                    Valid.MyReport("rptPermintaanLab.jasper", "report",
                            "::[ Permintaan Laboratorium ]::", param);
                }
                TeksKosong();
                this.setCursor(Cursor.getDefaultCursor());
            } else {
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (!NoRawat.isEmpty()) {
                if (NoPermintaan.trim().isEmpty() || DiagnosaKlinis.trim().
                    ...
                    param.put("emailrs", akses.getemailrs());
                    Valid.
                            MyReportqry("rptBarcodePermintaanLab.jasper",
                                    "report",
                                    "::[ Barcode No.Permintaan Lab ]::",
                                    "select noorder from permintaan_lab where no_rawat='" + NoRawat + "'",
                                    param);
                    TeksKosong();
                    this.setCursor(Cursor.getDefaultCursor());
                }
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (!NoRawat.isEmpty()) {
                if (NoPermintaan.trim().isEmpty() || DiagnosaKlinis.trim().
                    ...
                    param.put("kontakrs", akses.getkontakrs());
                    param.put("emailrs", akses.getemailrs());
                    Valid.MyReportqry("rptBarcodePermintaanLab2.jasper",
                            "report", "::[ Barcode No.Permintaan Lab ]::",
                            "select noorder from permintaan_lab where no_rawat='" + NoRawat + "'",
                            param);
                    TeksKosong();
                    this.setCursor(Cursor.getDefaultCursor());
                ...
                if (NoPermintaan.trim().isEmpty() || DiagnosaKlinis.trim().
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                pilihan = "R";
                                if (rs.getString("informasi_tambahan").
                                        toLowerCase().contains("cito")) {
                                    pilihan = "U";
                                }
                                Permintaan = "";
                                ps2 = koneksi.prepareStatement(
                                        "select permintaan_pemeriksaan_lab.kd_jenis_prw from permintaan_pemeriksaan_lab where permintaan_pemeriksaan_lab.noorder=?");
                                try {
                                    ps2.setString(1, NoPermintaan);
                                    rs2 = ps2.executeQuery();
                                    while (rs2.next()) {
                                        Permintaan = rs2.getString(
                                                "kd_jenis_prw") + "~" + Permintaan;
                                    }
                                    Permintaan = Permintaan.substring(0,
                                            Permintaan.length() - 1);
                                } catch (Exception e) {
                                    System.out.println("Notif : " + e);
                                } finally {
                                ...
                                koneksisysmex.prepareStatement(
                                        "insert into LIS_ORDER values('0',now(),'NW','" + rs.
                                        ...
                                        getString("nm_kec") + "','" + rs.
                                        getString("nm_kab") + "',"
                                        + "'OP','" + rs.getString("tgl_lahir") + "','" + rs.
                                        getString("jk") + "','" + rs.getString(
                                        "noorder") + "','" + rs.getString(
                                                "tgl_permintaan") + " " + rs.
                                                getString("jam_permintaan") + "',"
                                        + "'" + rs.getString("kd_poli") + "^" + rs.
                                        getString("nm_poli") + "','" + rs.
                                        getString("dokter_perujuk") + "^" + rs.
                                        getString("nm_dokter") + "',"
                                        + "'" + rs.getString("kd_poli") + "','" + pilihan + "','" + rs.
                                        getString("diagnosa_klinis") + "','" + rs.
                                        getString("no_rawat") + "',"
                                        + "'" + Permintaan + "','0')").
                                        executeUpdate();
                                ...
                                Permintaan = "";
                                ps2 = koneksi.prepareStatement(
                                        "select permintaan_detail_permintaan_lab.id_template from permintaan_detail_permintaan_lab where permintaan_detail_permintaan_lab.noorder=?");
                                try {
                                    ps2.setString(1, NoPermintaan);
                                    rs2 = ps2.executeQuery();
                                    while (rs2.next()) {
                                        Permintaan = rs2.
                                                getString("id_template") + "~" + Permintaan;
                                    }
                                    Permintaan = Permintaan.substring(0,
                                            Permintaan.length() - 1);
                                } catch (Exception e) {
                                ...
                                koneksisysmex.prepareStatement(
                                        "insert into LIS_ORDER_DETAIL values('0',now(),'NW','" + rs.
                                                getString("no_rkm_medis") + "','" + rs.
                                        getString("nm_pasien") + "',"
                                        + "'" + rs.getString("alamat") + "','" + rs.
                                        getString("nm_kel") + "','" + rs.
                            ...
                            if (rs.next()) {
                                ...
                                koneksisysmex.prepareStatement(
                                        ...
                                        "noorder") + "','" + rs.getString(
                                                "tgl_permintaan") + " " + rs.
                                                getString("jam_permintaan") + "',"
                                        + "'" + rs.getString("kd_bangsal") + "^" + rs.
                                        getString("nm_bangsal") + "','" + rs.
                                        getString("dokter_perujuk") + "^" + rs.
                                        getString("nm_dokter") + "',"
                                        + "'" + rs.getString("kd_kamar") + "','" + pilihan + "','" + rs.
                                        getString("diagnosa_klinis") + "','" + rs.
                                        getString("no_rawat") + "',"
                                        + "'" + Permintaan + "','0')").
                                        executeUpdate();
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                koneksielims.prepareStatement(
                                        "insert into permintaan_lab values('" + rs.
                                                getString("noorder") + "','" + rs.
                                        getString("no_rawat") + "','" + rs.
                                        getString("no_rkm_medis") + "',"
                                        + "'" + rs.getString("nm_pasien") + "','" + rs.
                                        getString("email") + "','" + rs.
                                        getString("jk") + "','" + rs.getString(
                                        "tmp_lahir") + "','" + rs.getString(
                                                "tgl_lahir") + "',"
                                        + "'" + rs.getString("alamat") + ", " + rs.
                                        getString("nm_kel") + ", " + rs.
                                        getString("nm_kec") + ", " + rs.
                                        getString("nm_kab") + ", " + rs.
                                        getString("nm_prop") + "',"
                                        + "'" + rs.getString("tgl_permintaan") + "','" + rs.
                                        getString("jam_permintaan") + "','" + rs.
                                        getString("dokter_perujuk") + "','" + rs.
                                        getString("nm_dokter") + "',"
                                        + "'" + rs.getString("status") + "','" + rs.
                                        getString("kd_poli") + "','" + rs.
                                        getString("nm_poli") + "','" + rs.
                                        getString("kd_pj") + "','" + rs.
                                        getString("png_jawab") + "',"
                                        + "'" + rs.getString(
                                                "informasi_tambahan") + "','" + rs.
                                                getString("diagnosa_klinis") + "')").
                                        executeUpdate();
                                ps2 = koneksi.prepareStatement(
                                        "select permintaan_detail_permintaan_lab.noorder,permintaan_detail_permintaan_lab.kd_jenis_prw,permintaan_detail_permintaan_lab.id_template from permintaan_detail_permintaan_lab where permintaan_detail_permintaan_lab.noorder=?");
                                try {
                                    ps2.setString(1, NoPermintaan);
                                    rs2 = ps2.executeQuery();
                                    while (rs2.next()) {
                                        koneksielims.prepareStatement(
                                                "insert into detail_permintaan_lab values('" + rs2.
                                                        getString("noorder") + "','" + rs2.
                                                getString("kd_jenis_prw") + "','" + rs2.
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                ...
                                ps2 = koneksi.prepareStatement(
                                        "select noorder, kd_jenis_prw, id_template from permintaan_detail_permintaan_lab where noorder=?");
                                try {
                                    ps2.setString(1, NoPermintaan);
                                    rs2 = ps2.executeQuery();
                                    while (rs2.next()) {
            ...
            if (!NoRawat.isEmpty()) {
                ...
                if (NoPermintaan.trim().isEmpty() || DiagnosaKlinis.trim().
                    ...
                    loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.
                            PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/" + "apiteras.php?nopermintaan=" + NoPermintaan);
                }
                TeksKosong();
                this.setCursor(Cursor.getDefaultCursor());
            } else {
                ...
                if (!NoRawat.isEmpty()) {
                    if (NoPermintaan.trim().isEmpty() || DiagnosaKlinis.trim().
                        ...
                        this.setCursor(Cursor.getPredefinedCursor(
                                Cursor.WAIT_CURSOR));
                        loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.
                                PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/" + "apiteras2.php?nopermintaan=" + NoPermintaan);
                        this.setCursor(Cursor.getDefaultCursor());
                    }
                } else {
                    JOptionPane.showMessageDialog(null,
                    ...
                    if (NoPermintaan.trim().isEmpty() || DiagnosaKlinis.trim().
                        ...
                        if (!json.isEmpty()) {
                            try {
                                ...
                                Sequel.queryu(
                                        "delete from temporary_permintaan_lab");
                                if (response.isArray()) {
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                koneksismartlab.prepareStatement(
                                        "insert into HisToLisHeader values('0','" + rs.
                                                getString("no_rawat") + "','" + rs.
                                        getString("noorder") + "','Rawat Jalan',"
                                        + "'" + rs.getString("no_rkm_medis") + "','" + rs.
                                        ...
                                        getString("diagnosa_klinis") + "','" + rs.
                                        getString("png_jawab") + "',"
                                        + "'Ralan','0','" + Sequel.cariIsi(
                                                "select count(noorder) from permintaan_detail_permintaan_lab where noorder='" + rs.
                                                        getString("noorder") + "'") + "',"
                                        + "'0','" + rs.getString("noorder") + "','" + rs.
                                        getString("nm_dokter") + "','A','" + rs.
                                        getString("nm_poli") + "','N','0','" + rs.
                                        getString("tgl_permintaan") + "',"
                                        + "'" + rs.getString("tgl_permintaan") + "')").
                                        executeUpdate();
                                try {
                                    rs3 = koneksismartlab.prepareStatement(
                                            "select RowID from HisToLisHeader where HisNoOrder='" + rs.
                                                    getString("noorder") + "'").
                                            executeQuery();
                                    if (rs3.next()) {
                                        i = rs3.getInt("RowID");
                                ...
                                try {
                                    ...
                                    while (rs2.next()) {
                                        koneksismartlab.prepareStatement(
                                                "insert HisToLisDetail values('0','" + i + "', '" + rs2.
                                                        getString("id_template") + "','N','" + rs.
                                                getString("tgl_permintaan") + "','0')").
                                                executeUpdate();
                                    }
                                } catch (Exception e) {
                                    System.out.println("Notif : " + e);
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                koneksismartlab.prepareStatement(
                                        ...
                                        getString("diagnosa_klinis") + "','" + rs.
                                        getString("png_jawab") + "',"
                                        + "'" + rs.getString("kelas") + "','0','" + Sequel.
                                        cariIsi("select count(noorder) from permintaan_detail_permintaan_lab where noorder='" + rs.
                                                getString("noorder") + "'") + "',"
                                        + "'0','" + rs.getString("noorder") + "','" + rs.
                                        getString("nm_dokter") + "','A','" + rs.
                                        getString("kd_kamar") + "','N','0','" + rs.
                                        getString("tgl_permintaan") + "',"
                                        + "'" + rs.getString("tgl_permintaan") + "')").
                                        executeUpdate();
                                try {
                ...
                if (!NoRawat.isEmpty()) {
                    if (NoPermintaan.trim().isEmpty() || DiagnosaKlinis.trim().
                        ...
                        if (Sampel.isEmpty()) {
                            ...
                            dlgro.isCek();
                            dlgro.
                                    setOrderVANSLAB(NoPermintaan, NoRawat,
                                            "Ralan");
                            dlgro.setDokterPerujuk(KodeDokter, DokterPerujuk);
                            TeksKosong();
                            dlgro.setVisible(true);
    ...
    private void tampil() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + "if(permintaan_lab.tgl_hasil='0000-00-00','',permintaan_lab.tgl_hasil) as tgl_hasil,if(permintaan_lab.jam_hasil='00:00:00','',permintaan_lab.jam_hasil) as jam_hasil,reg_periksa.umurdaftar,pasien.umur,DATE_FORMAT(pasien.tgl_lahir, '%d-%m-%Y') as tgl_lahir,"
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode
                            .addRow(new String[]{rs.getString("noorder"), rs.getString("no_rawat"),
                        rs.getString("no_rkm_medis") + " " + rs.getString("nm_pasien") + ", "
                        + rs.getString("tgl_lahir") + ", " + String.valueOf(p.getYears()) + "Th "
                        + String.valueOf(p.getMonths()) + "Bl " + String.valueOf(p.getDays()) + "Hr",
                        ...
                        rs.getString("nm_poli"), rs.getString("informasi_tambahan"),
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new Object[]{"", "", rs2.getString("nm_perawatan"), "", "", "", "", "", "",
                                "", "Nilai Rujukan L.D.", "Nilai Rujukan L.A.", "Nilai Rujukan P.D.",
                                "Nilai Rujukan P.A.", "", ""});
                            ps3 = koneksi.prepareStatement(
                                    "select permintaan_detail_permintaan_lab.id_template,template_laboratorium.Pemeriksaan,"
                                    + "template_laboratorium.satuan,template_laboratorium.nilai_rujukan_ld,template_laboratorium.nilai_rujukan_la,"
                            ...
                            try {
                                ...
                                rs3 = ps3.executeQuery();
                                while (rs3.next()) {
                                    tabMode.addRow(new Object[]{"", "", "  " + rs3.getString("Pemeriksaan"),
                                        rs3.getString("satuan"), "", "", "", "", "", "",
                                        rs3.getString("nilai_rujukan_ld"), rs3.getString("nilai_rujukan_la"),
                                        rs3.getString("nilai_rujukan_pd"), rs3.getString("nilai_rujukan_pa"), "",
                                        ""});
                                }
                            } catch (Exception e) {
                                System.out.println("Notif 3 : " + e);
    ...
    private void tampil2() {
        ...
        try {
            semua = CrDokter.getText().trim().isEmpty() && CrPoli.getText().trim().isEmpty()
                    && TCari.getText().trim().isEmpty();
            ps = koneksi
                    .prepareStatement("select permintaan_lab.noorder,permintaan_lab.no_rawat,reg_periksa.no_rkm_medis,"
                            ...
                            + "if(permintaan_lab.jam_hasil='00:00:00','',permintaan_lab.jam_hasil) as jam_hasil,reg_periksa.umurdaftar,pasien.umur,DATE_FORMAT(pasien.tgl_lahir, '%d-%m-%Y') as tgl_lahir,"
                            + "permintaan_lab.dokter_perujuk,dokter.nm_dokter,poliklinik.nm_poli,permintaan_lab.informasi_tambahan,permintaan_lab.diagnosa_klinis "
                            + "from permintaan_lab inner join reg_periksa on permintaan_lab.no_rawat=reg_periksa.no_rawat "
                            + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode2
                        ...
                        + rs.getString("tgl_lahir") + ", " + String.valueOf(p.getYears()) + "Th "
                        + String.valueOf(p.getMonths()) + "Bl " + String.valueOf(p.getDays()) + "Hr",
                        rs.getString("nm_perawatan"), rs.getString("Pemeriksaan"), rs.getString("satuan"),
                        ld + la + pd + pa, rs.getString("tgl_permintaan"), rs.getString("jam_permintaan"),
                        rs.getString("tgl_sampel"), rs.getString("jam_sampel"), rs.getString("tgl_hasil"),
                        rs.getString("jam_hasil"), rs.getString("dokter_perujuk"), rs.getString("nm_dokter"),
                        rs.getString("nm_poli"), rs.getString("informasi_tambahan"),
                        rs.getString("diagnosa_klinis"), rs.getString("kd_pj"), rs.getString("png_jawab")});
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    try {
                        ...
                        rs2 = ps2.executeQuery();
                        while (rs2.next()) {
                            tabMode3.addRow(new Object[]{"", "", rs2.getString("nm_perawatan"), "", "", "", "", "",
                                "", "", "Nilai Rujukan L.D.", "Nilai Rujukan L.A.", "Nilai Rujukan P.D.",
                                "Nilai Rujukan P.A.", "", ""});
                            ps3 = koneksi.prepareStatement(
                                    "select permintaan_detail_permintaan_lab.id_template,template_laboratorium.Pemeriksaan,"
                            ...
                            try {
                                ...
                                rs3 = ps3.executeQuery();
                                while (rs3.next()) {
                                    tabMode3.addRow(new Object[]{"", "", "  " + rs3.getString("Pemeriksaan"),
                                        rs3.getString("satuan"), "", "", "", "", "", "",
                                        rs3.getString("nilai_rujukan_ld"), rs3.getString("nilai_rujukan_la"),
                                        rs3.getString("nilai_rujukan_pd"), rs3.getString("nilai_rujukan_pa"), "",
                                        ""});
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode4.addRow(new String[]{rs.getString("noorder"), rs.getString("no_rawat"),
                        ...
                        rs.getString("tgl_sampel"), rs.getString("jam_sampel"), rs.getString("tgl_hasil"),
                        rs.getString("jam_hasil"), rs.getString("dokter_perujuk"), rs.getString("nm_dokter"),
                        rs.getString("nm_bangsal"), rs.getString("informasi_tambahan"),
                        rs.getString("diagnosa_klinis"), rs.getString("kd_pj"), rs.getString("png_jawab")});
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
    ...
    private static final Logger LOG = Logger.getLogger(DlgCariPermintaanLab.class.getName());
