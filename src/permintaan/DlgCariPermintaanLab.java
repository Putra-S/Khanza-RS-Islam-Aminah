...
public class DlgCariPermintaanLab extends javax.swing.JDialog {
    ...
    public DlgCariPermintaanLab(java.awt.Frame parent, boolean modal) {
        ...
        tbLabRalan.setDefaultRenderer(Object.class,
                new WarnaTablePermintaanLab());

        tabMode2 = new DefaultTableModel(null, new Object[]{
            "No.Permintaan", "No.Rawat", "Pasien", "Pemeriksaan",
            "Detail Pemeriksaan", "Satuan", "Nilai Rujukan", "Permintaan", "Jam",
            "Sampel", "Jam", "Hasil",
        ...
        tbLabRanap.setDefaultRenderer(Object.class,
                new WarnaTablePermintaanLab());
...
private void tbLabRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbLabRalanKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPermintaanLab dialog = new DlgCariPermintaanLab(
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            tabMode.addRow(new Object[]{
                                ...
                                "", "", "", "", "", "Nilai Rujukan L.D.",
                                "Nilai Rujukan L.A.", "Nilai Rujukan P.D.",
                                "Nilai Rujukan P.A.", "", ""
                            });
                            ps3 = koneksi.prepareStatement(
                                    "select permintaan_detail_permintaan_lab.id_template,template_laboratorium.Pemeriksaan,"
                            ...
                            try {
                                ...
                                while (rs3.next()) {
                                    tabMode.addRow(new Object[]{
                                        "", "", "  " + rs3.getString(
                                        "Pemeriksaan"), rs3.getString("satuan"),
                                        "", "", "", "", "", "", rs3.getString(
                                        "nilai_rujukan_ld"), rs3.getString(
                                        "nilai_rujukan_la"), rs3.getString(
                                        "nilai_rujukan_pd"), rs3.getString(
                                        "nilai_rujukan_pa"), "", ""
                                    });
                                }
                            } catch (Exception e) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode2.addRow(new String[]{
                        ...
                        getString("umur"),
                        rs.getString("nm_perawatan"), rs.
                        getString("Pemeriksaan"), rs.getString("satuan"),
                        ld + la + pd + pa,
                        rs.getString("tgl_permintaan"), rs.getString(
                        "jam_permintaan"), rs.getString("tgl_sampel"),
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode4.addRow(new String[]{
                        ...
                        ld + la + pd + pa,
                        rs.getString("tgl_permintaan"), rs.getString(
                        "jam_permintaan"), rs.getString("tgl_sampel"), rs.
                        getString("jam_sampel"),
                ...
                engine.getLoadWorker().stateProperty().addListener(
                    ...
                    public void changed(ObservableValue ov,
                        ...
                        if (newState == Worker.State.SUCCEEDED) {
                            try {
                                System.out.println("Eksekusi URL : " + engine.
                                        getLocation());
                                if (engine.getLocation().contains("SuksesKirim")) {
                                    ...
                                    json = "";
                                    json = engine.getLocation().replaceAll(
                                            "http://" + koneksiDB.
                                    ...
                                    if (!json.isEmpty()) {
                                        ...
                                        dlgro.setSize(
                                                ...
                                                internalFrame1.getHeight() - 20);
                                        dlgro.setLocationRelativeTo(
                                                internalFrame1);
                                        dlgro.emptTeks();
                                        dlgro.isCek();
                                        dlgro.
                                                setOrderLICA(NoPermintaan,
                                                        NoRawat, "Ralan");
                                        dlgro.setDokterPerujuk(KodeDokter,
                                                DokterPerujuk);
                                        TeksKosong();
                                        dlgro.setVisible(true);
                                    }
    ...
    private static final Logger LOG = Logger.getLogger(
            DlgCariPermintaanLab.class.getName());
