 ...
 * @author dosen
 */
public class DlgListWA extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgListWA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-10-2023" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-10-2023" }));
        ...
        TanggalBooking.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-10-2023 08:50:54" }));
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-10-2023 08:50:54" }));
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
            ...
            if (tbObat.getValueAt(i, 0).toString().equals("true") && tbObat.
                ...
                if (Sequel.menyimpantf2("reg_periksa",
                        ...
                        new String[]{
                            ...
                            tbObat.getValueAt(i, 5).toString(), jam(),
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgListWA dialog = new DlgListWA(new javax.swing.JFrame(), true);
    ...
    private void isBooking() {
        if (Sequel.menyimpantf("booking_registrasi", "?,?,?,?,?,?,?,?,?,?,?,?", "Pasien dan Tanggal", 12,
    ...
    private static final Logger LOG = Logger.getLogger(DlgListWA.class.getName());
