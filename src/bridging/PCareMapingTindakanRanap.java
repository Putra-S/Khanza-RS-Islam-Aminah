 ...
 * @author dosen
 */
public class PCareMapingTindakanRanap extends javax.swing.JDialog {
    ...
    private PCareCekReferensiTindakan barangpcare = new PCareCekReferensiTindakan(
            null, false);
    ...
    public PCareMapingTindakanRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode RS", "Nama Tindakan RS", "Kode PCare",
                    "Nama Tindakan PCare"}) {
            @Override
        ...
        barang.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (barang.getTable().getSelectedRow() != -1) {
                    kdtindakan.setText(barang.getTable().getValueAt(barang.
                            getTable().getSelectedRow(), 1).toString());
                    TTindakan.setText(barang.getTable().getValueAt(barang.
            ...
            public void windowClosed(WindowEvent e) {
                if (barangpcare.getTable().getSelectedRow() != -1) {
                    KdTindakanPCare.setText(
                            barangpcare.getTable().getValueAt(barangpcare.
                                    getTable().getSelectedRow(), 1).toString());
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdtindakan.getText().trim().isEmpty() || TTindakan.getText().trim().
                isEmpty()) {
            Valid.textKosong(kdtindakan, "Tindakan RS");
        } else if (KdTindakanPCare.getText().trim().isEmpty() || NmTindakanPCare.
                getText().trim().isEmpty()) {
            Valid.textKosong(KdTindakanPCare, "Tindakan PCare");
        } else {
            if (Sequel.menyimpantf("maping_tindakan_ranap_pcare", "?,?,?",
                    "Mapping Tindakan", 3, new String[]{
                        kdtindakan.getText(), KdTindakanPCare.getText(),
                        NmTindakanPCare.getText()
                    }) == true) {
                tampil();
                emptTeks();
            }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode, kdtindakan, "maping_tindakan_ranap_pcare",
                "kd_jenis_prw");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdtindakan.getText().trim().isEmpty() || TTindakan.getText().trim().
            ...
            if (tbJnsPerawatan.getSelectedRow() > -1) {
                if (Sequel.mengedittf("maping_tindakan_ranap_pcare",
                        "kd_jenis_prw=?",
                        "kd_jenis_prw=?,kd_tindakan_pcare=?,nm_tindakan_pcare=?",
                        4, new String[]{
                            kdtindakan.getText(), KdTindakanPCare.getText(),
                            NmTindakanPCare.getText(), tbJnsPerawatan.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptMapingTindakanRanapPCare.jasper", "report",
                    "::[ Mapping Tindakan Ranap di PCare ]::", param);
        }
...
private void btnPoliBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliBPJSActionPerformed
    barangpcare.setSize(internalFrame1.getWidth() - 20, internalFrame1.
            getHeight() - 20);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareMapingTindakanRanap dialog = new PCareMapingTindakanRanap(
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kd_jenis_prw"),
                        rs.getString("nm_perawatan"),
                        rs.getString("kd_tindakan_pcare"), rs.getString(
                        "nm_tindakan_pcare")});
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if (tbJnsPerawatan.getSelectedRow() != -1) {
            kdtindakan.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 0).toString());
            TTindakan.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 1).toString());
            KdTindakanPCare.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 2).toString());
            NmTindakanPCare.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareMapingTindakanRanap.class.getName());
