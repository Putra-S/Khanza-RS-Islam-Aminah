...
public class PCareMapingPoli extends javax.swing.JDialog {
    ...
    private PCareCekReferensiPoli polipcare = new PCareCekReferensiPoli(null, false);
    ...
    public PCareMapingPoli(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Poli", "Nama Poli", "Kode Poli PCare", "Nama Poli PCare"}) {
            @Override
        ...
        polipcare.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (polipcare.getTable().getSelectedRow() != -1) {
                    KdPoliPCare
                            .setText(polipcare.getTable().getValueAt(polipcare.getTable().getSelectedRow(), 1).toString());
                    NmPoliPCare
                            .setText(polipcare.getTable().getValueAt(polipcare.getTable().getSelectedRow(), 2).toString());
...
private void btnPoliBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliBPJSActionPerformed
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kd_poli_rs"), rs.getString("nm_poli"),
                        rs.getString("kd_poli_pcare"), rs.getString("nm_poli_pcare")});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(PCareMapingPoli.class.getName());
