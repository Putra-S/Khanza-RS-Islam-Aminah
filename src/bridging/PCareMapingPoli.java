 ...
 * @author dosen
 */
public class PCareMapingPoli extends javax.swing.JDialog {
    ...
    private PCareCekReferensiPoli polipcare = new PCareCekReferensiPoli(null,
            false);
    ...
    public PCareMapingPoli(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Poli", "Nama Poli", "Kode Poli PCare",
                    "Nama Poli PCare"}) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdpoli.getText().trim().isEmpty() || TPoli.getText().trim().
            ...
            if (Sequel.menyimpantf("maping_poliklinik_pcare", "?,?,?",
                    "Mapping Poli", 3, new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode, kdpoli, "maping_poliklinik_pcare",
                "kd_poli_rs");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdpoli.getText().trim().isEmpty() || TPoli.getText().trim().
            ...
            if (tbJnsPerawatan.getSelectedRow() > -1) {
                if (Sequel.mengedittf("maping_poliklinik_pcare", "kd_poli_rs=?",
                        "kd_poli_rs=?,kd_poli_pcare=?,nm_poli_pcare=?", 4,
                        new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptMapingPoliPCare.jasper", "report",
                    "::[ Mapping Poli RS & PCare ]::", param);
        }
...
private void btnPoliBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliBPJSActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareMapingPoli dialog = new PCareMapingPoli(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kd_poli_rs"), rs.
                        getString("nm_poli"),
                        rs.getString("kd_poli_pcare"), rs.getString(
                        "nm_poli_pcare")});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(PCareMapingPoli.class.
            getName());
