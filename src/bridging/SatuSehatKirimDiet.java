...
public class SatuSehatKirimDiet extends javax.swing.JDialog {
    ...
    public SatuSehatKirimDiet(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"P", "Tanggal Registrasi", "No.Rawat", "No.RM",
                    ...
                    "ID Encounter", "Instruksi Diet/Gizi", "Petugas/Praktisi",
                    "No.KTP Praktisi", "Tanggal",
                    "ID Diet"}) {
            @Override
                    ...
                    try {
                        ...
                        json = "{"
                                ...
                                + "\"date\" : \"" + tbObat.getValueAt(i, 10).
                                        toString().replaceAll(" ", "T") + "01+07:00\" ,"
                                + "\"author\" : ["
                                + "{"
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimDiet dialog = new SatuSehatKirimDiet(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString(
                        ...
                        rs.getString("no_ktp"), rs.getString("id_encounter"),
    ...
    private static final Logger LOG = Logger.getLogger(SatuSehatKirimDiet.class.
            getName());
