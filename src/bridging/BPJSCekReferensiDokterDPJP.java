...
public class BPJSCekReferensiDokterDPJP extends javax.swing.JDialog {
    ...
    public void tampil(String poli) {
        try {
            ...
            URL = link + "/referensi/dokter/pelayanan/1/tglPelayanan/" + Valid.SetTgl(DTPCari1.getSelectedItem() + "")
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kode").asText().toLowerCase().contains(poli.toLowerCase())
                            ...
                            tabMode.addRow(
                                    new Object[]{i + ".", list.path("kode").asText(), list.path("nama").asText()});
                        }
                        i++;
                    }
                }
    ...
    public void tampil2(String poli) {
        try {
            URL = link + "/referensi/dokter/pelayanan/2/tglPelayanan/" + Valid.SetTgl(DTPCari1.getSelectedItem() + "")
                    + "/Spesialis/" + KdSep.getText();
    ...
    private static final Logger LOG = Logger.getLogger(BPJSCekReferensiDokterDPJP.class.getName());
