 ...
 * @author dosen
 */
public class MobileJKNFKTPReferensiPoli extends javax.swing.JDialog {
    ...
    public MobileJKNFKTPReferensiPoli(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"No.", "Kode Unit/Poli", "Nama Unit/Poli",
                    "Kode Sub", "Nama Sub Spesialis"}) {
            @Override
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariMobileJKNFKTPReferensiPoli.jasper",
                    "report", "[ Pencarian Referensi Unit/Poli ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MobileJKNFKTPReferensiPoli dialog = new MobileJKNFKTPReferensiPoli(
    ...
    public void tampil() {
        try {
            URL = link + "/ref/poli/tanggal/" + Valid.SetTgl(Tanggal.
                    getSelectedItem() + "");
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        if (list.path("kodepoli").asText().toLowerCase().
    ...
    private static final Logger LOG = Logger.getLogger(
            MobileJKNFKTPReferensiPoli.class.getName());
