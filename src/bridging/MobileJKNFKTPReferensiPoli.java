...
public class MobileJKNFKTPReferensiPoli extends javax.swing.JDialog {
    ...
    public MobileJKNFKTPReferensiPoli(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"No.", "Kode Unit/Poli", "Nama Unit/Poli", "Kode Sub", "Nama Sub Spesialis"}) {
            @Override
    ...
    private static final Logger LOG = Logger.getLogger(MobileJKNFKTPReferensiPoli.class.getName());
