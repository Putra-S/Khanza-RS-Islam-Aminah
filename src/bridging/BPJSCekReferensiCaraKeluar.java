 ...
 * @author dosen
 */
public class BPJSCekReferensiCaraKeluar extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiCaraKeluar dialog = new BPJSCekReferensiCaraKeluar(
    ...
    public void tampil(String poli) {
        try {
            ...
            root = mapper.readTree(api.getRest()
                    .exchange(URL + "/referensi/carakeluar", HttpMethod.GET,
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSCekReferensiCaraKeluar.class.getName());
