...
public class BPJSCekReferensiCaraKeluar extends javax.swing.JDialog {
    ...
    public void tampil(String poli) {
        try {
            ...
            root = mapper.readTree(api.getRest()
                    .exchange(URL + "/referensi/carakeluar", HttpMethod.GET, requestEntity, String.class)
                    .getBody());
    ...
    private static final Logger LOG = Logger.getLogger(BPJSCekReferensiCaraKeluar.class.getName());
