...
public class AkunRekeningBankJateng extends javax.swing.JDialog {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdrek.getText().trim().isEmpty() || nmrek.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                ...
                if (Sequel.menyimpantf("set_akun_bankjateng",
                        "?,aes_encrypt(?,'nur'),aes_encrypt(?,'windi')",
                        "Akun Rekening", 3, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            AkunRekeningBankJateng dialog = new AkunRekeningBankJateng(
    ...
    private static final Logger LOG = Logger.getLogger(
            AkunRekeningBankJateng.class.getName());
