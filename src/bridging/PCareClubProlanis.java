 ...
 * @author dosen
 */
public class PCareClubProlanis extends javax.swing.JDialog {
    ...
    public PCareClubProlanis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Club ID",
            "Kode", "Nama Program", "Tgl.Mulai",
            "Tgl.Akhir", "Alamat Club", "Nama Club", "No.HP Ketua",
            "Nama Ketua Club"}) {
            @Override
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (int r = 0; r < row; r++) {
                Sequel.menyimpan("temporary", "'" + r + "','"
                        ...
                        + tabMode.getValueAt(r, 9).toString() + "','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
            ...
            Valid.MyReportqry("rptCariPCAREClubProlanis.jasper", "report",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareClubProlanis dialog = new PCareClubProlanis(
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        tabMode.addRow(new Object[]{i + ".",
                            list.path("clubId").asText(),
                            list.path("jnsKelompok").path("kdProgram").asText(),
                            list.path("jnsKelompok").path("nmProgram").asText(),
                            list.path("tglMulai").asText(),
                            list.path("tglAkhir").asText(), list.path("alamat").
                            asText(),
                            list.path("nama").asText(), list.path("ketua_noHP").
                            asText(),
                            list.path("ketua_nama").asText()});
                        i++;
                    }
                }
            } else {
    ...
    private static final Logger LOG = Logger.getLogger(PCareClubProlanis.class.
            getName());
