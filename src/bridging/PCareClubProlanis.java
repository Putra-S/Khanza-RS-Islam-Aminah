...
public class PCareClubProlanis extends javax.swing.JDialog {
    ...
    public PCareClubProlanis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Club ID", "Kode", "Nama Program", "Tgl.Mulai",
            "Tgl.Akhir", "Alamat Club", "Nama Club", "No.HP Ketua", "Nama Ketua Club"}) {
            @Override
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        tabMode.addRow(new Object[]{i + ".", list.path("clubId").asText(),
                            list.path("jnsKelompok").path("kdProgram").asText(),
                            list.path("jnsKelompok").path("nmProgram").asText(), list.path("tglMulai").asText(),
                            list.path("tglAkhir").asText(), list.path("alamat").asText(),
                            list.path("nama").asText(), list.path("ketua_noHP").asText(),
    ...
    private static final Logger LOG = Logger.getLogger(PCareClubProlanis.class.getName());
