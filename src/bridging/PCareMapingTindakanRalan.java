 ...
 * @author dosen
 */
public class PCareMapingTindakanRalan extends javax.swing.JDialog {
    ...
    public PCareMapingTindakanRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode RS", "Nama Tindakan Ralan", "Kode PCare",
                    "Nama Tindakan PCare"}) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdtindakan.getText().trim().isEmpty() || TTindakan.getText().trim().
            ...
            if (Sequel.menyimpantf("maping_tindakan_pcare", "?,?,?",
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode, kdtindakan, "maping_tindakan_pcare",
                "kd_jenis_prw");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdtindakan.getText().trim().isEmpty() || TTindakan.getText().trim().
            ...
            if (tbJnsPerawatan.getSelectedRow() > -1) {
                if (Sequel.mengedittf("maping_tindakan_pcare", "kd_jenis_prw=?",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptMapingTindakanPCare.jasper", "report",
                    "::[ Mapping Tindakan PCare ]::", param);
        }
...
private void btnPoliBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliBPJSActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareMapingTindakanRalan dialog = new PCareMapingTindakanRalan(
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareMapingTindakanRalan.class.getName());
