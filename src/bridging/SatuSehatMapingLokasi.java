...
public class SatuSehatMapingLokasi extends javax.swing.JDialog {
    ...
    private final DefaultTableModel tabMode, tabModeKamar, tabModeRuangOK, tabModeRuangLabPK, tabModeRuangLabPA,
            tabModeRuangLabMB, tabModeRuangRadiologi, tabModeRuangFarmasi;
    ...
    private void btnDepartemenRSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDepartemenRSActionPerformed
        pilih = 1;
        organisasi.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TabRawat.getSelectedIndex() == 0) {
            if (KodeDepartemen.getText().trim().isEmpty() || NamaDepartemen.
            ...
            } else if (KodePoli.getText().trim().isEmpty() || NamaPoli.getText().
                    trim().isEmpty()) {
                Valid.textKosong(KodePoli, "Poli/Unit");
            } else if (Longitude.getText().trim().isEmpty()) {
                Valid.textKosong(Longitude, "Longitude");
            } else if (Latitude.getText().trim().isEmpty()) {
                Valid.textKosong(Latitude, "Latitude");
            } else if (Altitude.getText().trim().isEmpty()) {
                ...
                try {
                    ...
                    json = "{"
                            ...
                            + "\"identifier\": ["
                            + "{"
                            + "\"system\": \"http://sys-ids.kemkes.go.id/location/" + koneksiDB.
                                    IDSATUSEHAT() + "\","
                            ...
                            + "\"reference\": \"Organization/" + IDOrganisasi.
                                    getText() + "\""
                            + "}"
                            + "}";
                    ...
                    json = api.getRest().exchange(link + "/Location",
                    ...
                    if (!response.asText().isEmpty()) {
                        if (Sequel.
                                menyimpantf("satu_sehat_mapping_lokasi_ralan",
                                        "?,?,?,?,?,?",
                                        "Kode Poli/Kode Unit/ID Lokasi", 6,
                                        new String[]{
                                            KodePoli.getText(), IDOrganisasi.
                                            getText(), response.asText(),
                                            Longitude.getText(), Latitude.
                                            getText(), Altitude.getText()
                                        }) == true) {
                            tabMode.addRow(new String[]{
                                KodePoli.getText(), NamaPoli.getText(),
                                response.asText(), Longitude.getText(),
                                Latitude.getText(),
                                Altitude.getText(), KodeDepartemen.getText(),
                                NamaDepartemen.getText(), IDOrganisasi.getText()
                            });
                            emptTeks();
            ...
            if (KodeDepartemenKamar.getText().trim().isEmpty() || NamaDepartemenKamar.
                    getText().trim().isEmpty()) {
                Valid.textKosong(KodeDepartemenKamar, "Departemen/Organisasi");
            } else if (KodeKamar.getText().trim().isEmpty() || NamaKamar.
                    getText().trim().isEmpty()) {
                Valid.textKosong(KodeKamar, "Kamar/Ruang");
            } else if (LongitudeKamar.getText().trim().isEmpty()) {
                Valid.textKosong(LongitudeKamar, "Longitude");
            } else if (LatitudeKamar.getText().trim().isEmpty()) {
                Valid.textKosong(LatitudeKamar, "Latitude");
            } else if (AltitudeKamar.getText().trim().isEmpty()) {
                ...
                try {
                    ...
                    json = "{"
                            ...
                            + "\"description\": \"" + NamaKamar.getText() + " Nomor " + KodeKamar.
                            getText() + "\","
                            + "\"mode\": \"instance\","
                            + "\"telecom\": ["
                            + "{"
                            ...
                            + "},"
                            + "\"managingOrganization\": {"
                            + "\"reference\": \"Organization/" + IDOrganisasiKamar.
                                    getText() + "\""
                            + "}"
                            + "}";
                    System.out.println("Request JSON : " + json);
                    ...
                    if (!response.asText().isEmpty()) {
                        if (Sequel.
                                menyimpantf("satu_sehat_mapping_lokasi_ranap",
                                        "?,?,?,?,?,?",
                                        "Kode Kamar/Kode Ruang/ID Lokasi", 6,
                                        new String[]{
                                            KodeKamar.getText(),
                                            IDOrganisasiKamar.getText(),
                                            response.asText(), LongitudeKamar.
                                            getText(), LatitudeKamar.getText(),
                                            AltitudeKamar.getText()
                                        }) == true) {
                            tabModeKamar.addRow(new String[]{
                                KodeKamar.getText(), NamaKamar.getText(),
                                response.asText(), LongitudeKamar.getText(),
                                LatitudeKamar.getText(),
                                AltitudeKamar.getText(), KodeDepartemenKamar.
                                getText(), NamaDepartemenKamar.getText(),
                                IDOrganisasiKamar.getText()
                            });
                            emptTeks();
            ...
            if (tabModeRuangOK.getRowCount() == 0) {
                if (KodeDepartemenRuangOK.getText().trim().isEmpty() || NamaDepartemenRuangOK.
                        getText().trim().isEmpty()) {
                    Valid.textKosong(KodeDepartemenRuangOK,
                            "Departemen/Organisasi");
                } else if (LongitudeRuangOK.getText().trim().isEmpty()) {
                    Valid.textKosong(LongitudeRuangOK, "Longitude");
                } else if (LatitudeRuangOK.getText().trim().isEmpty()) {
                    Valid.textKosong(LatitudeRuangOK, "Latitude");
                } else if (AltitudeRuangOK.getText().trim().isEmpty()) {
                    ...
                    try {
                        ...
                        json = "{"
                                ...
                                + "},"
                                + "\"managingOrganization\": {"
                                + "\"reference\": \"Organization/" + IDOrganisasiRuangOK.
                                        getText() + "\""
                                + "}"
                                + "}";
                        System.out.println("Request JSON : " + json);
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.menyimpantf(
                                    ...
                                    "?,?,?,?,?", "ID Lokasi", 5, new String[]{
                                        IDOrganisasiRuangOK.getText(), response.
                                        asText(), LongitudeRuangOK.getText(),
                                        LatitudeRuangOK.getText(),
                                        AltitudeRuangOK.getText()
                                    }) == true) {
                                tabModeRuangOK.addRow(new String[]{
                                    response.asText(), LongitudeRuangOK.
                                    getText(), LatitudeRuangOK.getText(),
                                    AltitudeRuangOK.getText(),
                                    KodeDepartemenRuangOK.getText(),
                                    NamaDepartemenRuangOK.getText(),
                                    IDOrganisasiRuangOK.getText()
                                });
                                emptTeks();
                                LCount.
                                        setText("" + tabModeRuangOK.
                                                getRowCount());
                            }
                        } else {
                            JOptionPane.showMessageDialog(null,
                ...
                JOptionPane.showMessageDialog(null,
                        "Untuk Ruang OK hanya diijinkan satu mapping lokasi");
            }
        } else if (TabRawat.getSelectedIndex() == 3) {
            if (tabModeRuangLabPK.getRowCount() == 0) {
                if (KodeDepartemenRuangLabPK.getText().trim().isEmpty() || NamaDepartemenRuangLabPK.
                        getText().trim().isEmpty()) {
                    Valid.textKosong(KodeDepartemenRuangLabPK,
                            "Departemen/Organisasi");
                } else if (LongitudeRuangLabPK.getText().trim().isEmpty()) {
                    Valid.textKosong(LongitudeRuangLabPK, "Longitude");
                } else if (LatitudeRuangLabPK.getText().trim().isEmpty()) {
                    Valid.textKosong(LatitudeRuangLabPK, "Latitude");
                } else if (AltitudeRuangLabPK.getText().trim().isEmpty()) {
                    ...
                    try {
                        ...
                        json = "{"
                                ...
                                + "},"
                                + "\"position\": {"
                                + "\"longitude\": " + LongitudeRuangLabPK.
                                        getText() + ","
                                + "\"latitude\": " + LatitudeRuangLabPK.
                                        getText() + ","
                                + "\"altitude\": " + AltitudeRuangLabPK.
                                        getText()
                                + "},"
                                + "\"managingOrganization\": {"
                                + "\"reference\": \"Organization/" + IDOrganisasiRuangLabPK.
                                        getText() + "\""
                                + "}"
                                + "}";
                        System.out.println("Request JSON : " + json);
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.menyimpantf(
                                    ...
                                    "?,?,?,?,?", "ID Lokasi", 5, new String[]{
                                        IDOrganisasiRuangLabPK.getText(),
                                        response.asText(), LongitudeRuangLabPK.
                                        getText(), LatitudeRuangLabPK.getText(),
                                        AltitudeRuangLabPK.getText()
                                    }) == true) {
                                tabModeRuangLabPK.addRow(new String[]{
                                    response.asText(), LongitudeRuangLabPK.
                                    getText(), LatitudeRuangLabPK.getText(),
                                    AltitudeRuangLabPK.getText(),
                                    KodeDepartemenRuangLabPK.getText(),
                                    NamaDepartemenRuangLabPK.getText(),
                                    IDOrganisasiRuangLabPK.getText()
                                });
                                emptTeks();
                                LCount.setText("" + tabModeRuangLabPK.
                                        getRowCount());
                            }
                        } else {
                            JOptionPane.showMessageDialog(null,
                ...
                JOptionPane.showMessageDialog(null,
                        "Untuk Ruang Lab PK hanya diijinkan satu mapping lokasi");
            }
        } else if (TabRawat.getSelectedIndex() == 4) {
            if (tabModeRuangLabPA.getRowCount() == 0) {
                if (KodeDepartemenRuangLabPA.getText().trim().isEmpty() || NamaDepartemenRuangLabPA.
                        getText().trim().isEmpty()) {
                    Valid.textKosong(KodeDepartemenRuangLabPA,
                            "Departemen/Organisasi");
                } else if (LongitudeRuangLabPA.getText().trim().isEmpty()) {
                    Valid.textKosong(LongitudeRuangLabPA, "Longitude");
                } else if (LatitudeRuangLabPA.getText().trim().isEmpty()) {
                    Valid.textKosong(LatitudeRuangLabPA, "Latitude");
                } else if (AltitudeRuangLabPA.getText().trim().isEmpty()) {
                    ...
                    try {
                        ...
                        json = "{"
                                ...
                                + "},"
                                + "\"position\": {"
                                + "\"longitude\": " + LongitudeRuangLabPA.
                                        getText() + ","
                                + "\"latitude\": " + LatitudeRuangLabPA.
                                        getText() + ","
                                + "\"altitude\": " + AltitudeRuangLabPA.
                                        getText()
                                + "},"
                                + "\"managingOrganization\": {"
                                + "\"reference\": \"Organization/" + IDOrganisasiRuangLabPA.
                                        getText() + "\""
                                + "}"
                                + "}";
                        System.out.println("Request JSON : " + json);
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.menyimpantf(
                                    ...
                                    "?,?,?,?,?", "ID Lokasi", 5, new String[]{
                                        IDOrganisasiRuangLabPA.getText(),
                                        response.asText(), LongitudeRuangLabPA.
                                        getText(), LatitudeRuangLabPA.getText(),
                                        AltitudeRuangLabPA.getText()
                                    }) == true) {
                                tabModeRuangLabPA.addRow(new String[]{
                                    response.asText(), LongitudeRuangLabPA.
                                    getText(), LatitudeRuangLabPA.getText(),
                                    AltitudeRuangLabPA.getText(),
                                    KodeDepartemenRuangLabPA.getText(),
                                    NamaDepartemenRuangLabPA.getText(),
                                    IDOrganisasiRuangLabPA.getText()
                                });
                                emptTeks();
                                LCount.setText("" + tabModeRuangLabPA.
                                        getRowCount());
                            }
                        } else {
                            JOptionPane.showMessageDialog(null,
                ...
                JOptionPane.showMessageDialog(null,
                        "Untuk Ruang Lab PA hanya diijinkan satu mapping lokasi");
            }
        } else if (TabRawat.getSelectedIndex() == 5) {
            if (tabModeRuangLabMB.getRowCount() == 0) {
                if (KodeDepartemenRuangLabMB.getText().trim().isEmpty() || NamaDepartemenRuangLabMB.
                        getText().trim().isEmpty()) {
                    Valid.textKosong(KodeDepartemenRuangLabMB,
                            "Departemen/Organisasi");
                } else if (LongitudeRuangLabMB.getText().trim().isEmpty()) {
                    Valid.textKosong(LongitudeRuangLabMB, "Longitude");
                } else if (LatitudeRuangLabMB.getText().trim().isEmpty()) {
                    Valid.textKosong(LatitudeRuangLabMB, "Latitude");
                } else if (AltitudeRuangLabMB.getText().trim().isEmpty()) {
                    ...
                    try {
                        ...
                        json = "{"
                                ...
                                + "},"
                                + "\"position\": {"
                                + "\"longitude\": " + LongitudeRuangLabMB.
                                        getText() + ","
                                + "\"latitude\": " + LatitudeRuangLabMB.
                                        getText() + ","
                                + "\"altitude\": " + AltitudeRuangLabMB.
                                        getText()
                                + "},"
                                + "\"managingOrganization\": {"
                                + "\"reference\": \"Organization/" + IDOrganisasiRuangLabMB.
                                        getText() + "\""
                                + "}"
                                + "}";
                        System.out.println("Request JSON : " + json);
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.menyimpantf(
                                    ...
                                    "?,?,?,?,?", "ID Lokasi", 5, new String[]{
                                        IDOrganisasiRuangLabMB.getText(),
                                        response.asText(), LongitudeRuangLabMB.
                                        getText(), LatitudeRuangLabMB.getText(),
                                        AltitudeRuangLabMB.getText()
                                    }) == true) {
                                tabModeRuangLabMB.addRow(new String[]{
                                    response.asText(), LongitudeRuangLabMB.
                                    getText(), LatitudeRuangLabMB.getText(),
                                    AltitudeRuangLabMB.getText(),
                                    KodeDepartemenRuangLabMB.getText(),
                                    NamaDepartemenRuangLabMB.getText(),
                                    IDOrganisasiRuangLabMB.getText()
                                });
                                emptTeks();
                                LCount.setText("" + tabModeRuangLabMB.
                                        getRowCount());
                            }
                        } else {
                            JOptionPane.showMessageDialog(null,
                ...
                JOptionPane.showMessageDialog(null,
                        "Untuk Ruang Lab MB hanya diijinkan satu mapping lokasi");
            }
        } else if (TabRawat.getSelectedIndex() == 6) {
            if (tabModeRuangRadiologi.getRowCount() == 0) {
                if (KodeDepartemenRuangRadiologi.getText().trim().isEmpty() || NamaDepartemenRuangRadiologi.
                        getText().trim().isEmpty()) {
                    Valid.textKosong(KodeDepartemenRuangRadiologi,
                            "Departemen/Organisasi");
                } else if (LongitudeRuangRadiologi.getText().trim().isEmpty()) {
                    Valid.textKosong(LongitudeRuangRadiologi, "Longitude");
                } else if (LatitudeRuangRadiologi.getText().trim().isEmpty()) {
                    Valid.textKosong(LatitudeRuangRadiologi, "Latitude");
                } else if (AltitudeRuangRadiologi.getText().trim().isEmpty()) {
                    ...
                    try {
                        ...
                        json = "{"
                                ...
                                + "},"
                                + "\"position\": {"
                                + "\"longitude\": " + LongitudeRuangRadiologi.
                                        getText() + ","
                                + "\"latitude\": " + LatitudeRuangRadiologi.
                                        getText() + ","
                                + "\"altitude\": " + AltitudeRuangRadiologi.
                                        getText()
                                + "},"
                                + "\"managingOrganization\": {"
                                + "\"reference\": \"Organization/" + IDOrganisasiRuangRadiologi.
                                        getText() + "\""
                                + "}"
                                + "}";
                        System.out.println("Request JSON : " + json);
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.menyimpantf(
                                    ...
                                    "?,?,?,?,?", "ID Lokasi", 5, new String[]{
                                        IDOrganisasiRuangRadiologi.getText(),
                                        response.asText(),
                                        LongitudeRuangRadiologi.getText(),
                                        LatitudeRuangRadiologi.getText(),
                                        AltitudeRuangRadiologi.getText()
                                    }) == true) {
                                tabModeRuangRadiologi.addRow(new String[]{
                                    response.asText(), LongitudeRuangRadiologi.
                                    getText(), LatitudeRuangRadiologi.getText(),
                                    AltitudeRuangRadiologi.getText(),
                                    KodeDepartemenRuangRadiologi.getText(),
                                    NamaDepartemenRuangRadiologi.getText(),
                                    IDOrganisasiRuangRadiologi.getText()
                                });
                                emptTeks();
                                LCount.setText("" + tabModeRuangRadiologi.
                                        getRowCount());
                            }
                        } else {
                            JOptionPane.showMessageDialog(null,
            ...
            if (KodeDepartemenFarmasi.getText().trim().isEmpty() || NamaDepartemenFarmasi.
                    getText().trim().isEmpty()) {
                Valid.textKosong(KodeDepartemenFarmasi, "Departemen/Organisasi");
            } else if (KodeFarmasi.getText().trim().isEmpty() || NamaFarmasi.
                    getText().trim().isEmpty()) {
                Valid.textKosong(KodeFarmasi, "Farmasi/Depo");
            } else if (LongitudeFarmasi.getText().trim().isEmpty()) {
                Valid.textKosong(LongitudeFarmasi, "Longitude");
            } else if (LatitudeFarmasi.getText().trim().isEmpty()) {
                Valid.textKosong(LatitudeFarmasi, "Latitude");
            } else if (AltitudeFarmasi.getText().trim().isEmpty()) {
                ...
                try {
                    ...
                    json = "{"
                            ...
                            + "},"
                            + "\"managingOrganization\": {"
                            + "\"reference\": \"Organization/" + IDOrganisasiFarmasi.
                                    getText() + "\""
                            + "}"
                            + "}";
                    System.out.println("URL : " + link + "/Location");
                    ...
                    if (!response.asText().isEmpty()) {
                        if (Sequel.menyimpantf(
                                ...
                                "?,?,?,?,?,?", "Kode Depo/Kode Farmasi", 6,
                                new String[]{
                                    KodeFarmasi.getText(), IDOrganisasiFarmasi.
                                    getText(), response.asText(),
                                    LongitudeFarmasi.getText(), LatitudeFarmasi.
                                    getText(), AltitudeFarmasi.getText()
                                }) == true) {
                            tabModeRuangFarmasi.addRow(new String[]{
                                KodeFarmasi.getText(), NamaFarmasi.getText(),
                                response.asText(), LongitudeFarmasi.getText(),
                                LatitudeFarmasi.getText(),
                                AltitudeFarmasi.getText(),
                                KodeDepartemenFarmasi.getText(),
                                NamaDepartemenFarmasi.getText(),
                                IDOrganisasiFarmasi.getText()
                            });
                            emptTeks();
                            LCount.setText("" + tabModeRuangFarmasi.
                                    getRowCount());
                        }
                    } else {
                        JOptionPane.showMessageDialog(null,
        ...
        if (TabRawat.getSelectedIndex() == 0) {
            if (tbJnsPerawatan.getSelectedRow() > -1) {
                try {
                    ...
                    json = api.getRest().exchange(
                            link + "/Location/" + tbJnsPerawatan.getValueAt(
                                    tbJnsPerawatan.getSelectedRow(), 2).
                    ...
                    response = root.path("id");
                    if (!response.asText().isEmpty()) {
                        if (Valid.hapusTabletf(tabMode, KodePoli,
                                "satu_sehat_mapping_lokasi_ralan", "kd_poli") == true) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Gagal melakukan mapping lokasi ke server Satu Sehat Kemenkes");
                    }
                } catch (HeadlessException | IOException | KeyManagementException | NoSuchAlgorithmException | RestClientException e) {
                    System.out.println("Notifikasi Bridging : " + e);
                    JOptionPane.showMessageDialog(null,
            ...
            if (tbLokasiKamar.getSelectedRow() > -1) {
                try {
                    ...
                    json = "{"
                            + "\"resourceType\": \"Location\","
                            + "\"id\": \"" + tbLokasiKamar.getValueAt(
                                    tbLokasiKamar.getSelectedRow(), 2).
                                    toString() + "\","
                            + "\"identifier\": ["
                            + "{"
                            + "\"system\": \"http://sys-ids.kemkes.go.id/location/" + koneksiDB.
                    ...
                    requestEntity = new HttpEntity(json, headers);
                    json = api.getRest().exchange(
                            link + "/Location/" + tbLokasiKamar.getValueAt(
                                    tbLokasiKamar.getSelectedRow(), 2).
                                    toString(), HttpMethod.PUT, requestEntity,
                            String.class).getBody();
                    System.out.println("Result JSON : " + json);
                    ...
                    response = root.path("id");
                    if (!response.asText().isEmpty()) {
                        if (Valid.hapusTabletf(tabModeKamar, KodeKamar,
                                "satu_sehat_mapping_lokasi_ranap", "kd_kamar") == true) {
                            tabModeKamar.removeRow(tbLokasiKamar.
                                    getSelectedRow());
                            emptTeks();
                            LCount.setText("" + tabModeKamar.getRowCount());
                        }
            ...
            if (KodeDepartemenRuangOK.getText().trim().isEmpty() || NamaDepartemenRuangOK.
                ...
                if (tbLokasiRuangOK.getSelectedRow() > -1) {
                    try {
                        ...
                        json = "{"
                                + "\"resourceType\": \"Location\","
                                + "\"id\": \"" + tbLokasiRuangOK.getValueAt(
                                        tbLokasiRuangOK.getSelectedRow(), 0).
                                        toString() + "\","
                                + "\"identifier\": ["
                                + "{"
                                + "\"system\": \"http://sys-ids.kemkes.go.id/location/" + koneksiDB.
                        ...
                        requestEntity = new HttpEntity(json, headers);
                        json = api.getRest().exchange(
                                link + "/Location/" + tbLokasiRuangOK.
                                        getValueAt(tbLokasiRuangOK.
                                                getSelectedRow(), 0).toString(),
                        ...
                        response = root.path("id");
                        if (!response.asText().isEmpty()) {
                            if (Sequel.meghapustf(
                                    "satu_sehat_mapping_lokasi_ruangok",
                                    "id_lokasi_satusehat", tbLokasiRuangOK.
                                            getValueAt(tbLokasiRuangOK.
                                                    getSelectedRow(), 0).
                                            toString()) == true) {
                                tabModeRuangOK.removeRow(tbLokasiRuangOK.
                                        getSelectedRow());
                                emptTeks();
                                LCount.
                                        setText("" + tabModeRuangOK.
            ...
            if (KodeDepartemenRuangLabPK.getText().trim().isEmpty() || NamaDepartemenRuangLabPK.
                ...
                if (tbLokasiRuangLabPK.getSelectedRow() > -1) {
                    try {
                        ...
                        json = "{"
                                + "\"resourceType\": \"Location\","
                                + "\"id\": \"" + tbLokasiRuangLabPK.getValueAt(
                                        tbLokasiRuangLabPK.getSelectedRow(), 0).
                                        toString() + "\","
                                + "\"identifier\": ["
                                + "{"
                                + "\"system\": \"http://sys-ids.kemkes.go.id/location/" + koneksiDB.
                        ...
                        requestEntity = new HttpEntity(json, headers);
                        json = api.getRest().exchange(
                                link + "/Location/" + tbLokasiRuangLabPK.
                                        getValueAt(tbLokasiRuangLabPK.
                                                getSelectedRow(), 0).toString(),
                                HttpMethod.PUT, requestEntity, String.class).
                                getBody();
                        System.out.println("Result JSON : " + json);
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.meghapustf(
                                    "satu_sehat_mapping_lokasi_ruanglab",
                                    "id_lokasi_satusehat", tbLokasiRuangLabPK.
                                            getValueAt(tbLokasiRuangLabPK.
                                                    getSelectedRow(), 0).
                                            toString()) == true) {
                                tabModeRuangLabPK.removeRow(tbLokasiRuangLabPK.
                                        getSelectedRow());
                                emptTeks();
                                LCount.setText("" + tabModeRuangLabPK.
                                        getRowCount());
            ...
            if (KodeDepartemenRuangLabPA.getText().trim().isEmpty() || NamaDepartemenRuangLabPA.
                ...
                if (tbLokasiRuangLabPA.getSelectedRow() > -1) {
                    try {
                        ...
                        json = "{"
                                + "\"resourceType\": \"Location\","
                                + "\"id\": \"" + tbLokasiRuangLabPA.getValueAt(
                                        tbLokasiRuangLabPA.getSelectedRow(), 0).
                                        toString() + "\","
                                + "\"identifier\": ["
                                + "{"
                                + "\"system\": \"http://sys-ids.kemkes.go.id/location/" + koneksiDB.
                        ...
                        requestEntity = new HttpEntity(json, headers);
                        json = api.getRest().exchange(
                                link + "/Location/" + tbLokasiRuangLabPA.
                                        getValueAt(tbLokasiRuangLabPA.
                                                getSelectedRow(), 0).toString(),
                                HttpMethod.PUT, requestEntity, String.class).
                                getBody();
                        System.out.println("Result JSON : " + json);
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.meghapustf(
                                    "satu_sehat_mapping_lokasi_ruanglabpa",
                                    "id_lokasi_satusehat", tbLokasiRuangLabPA.
                                            getValueAt(tbLokasiRuangLabPA.
                                                    getSelectedRow(), 0).
                                            toString()) == true) {
                                tabModeRuangLabPA.removeRow(tbLokasiRuangLabPA.
                                        getSelectedRow());
                                emptTeks();
                                LCount.setText("" + tabModeRuangLabPA.
                                        getRowCount());
            ...
            if (KodeDepartemenRuangLabMB.getText().trim().isEmpty() || NamaDepartemenRuangLabMB.
                ...
                if (tbLokasiRuangLabMB.getSelectedRow() > -1) {
                    try {
                        ...
                        json = "{"
                                + "\"resourceType\": \"Location\","
                                + "\"id\": \"" + tbLokasiRuangLabMB.getValueAt(
                                        tbLokasiRuangLabMB.getSelectedRow(), 0).
                                        toString() + "\","
                                + "\"identifier\": ["
                                + "{"
                                + "\"system\": \"http://sys-ids.kemkes.go.id/location/" + koneksiDB.
                        ...
                        requestEntity = new HttpEntity(json, headers);
                        json = api.getRest().exchange(
                                link + "/Location/" + tbLokasiRuangLabMB.
                                        getValueAt(tbLokasiRuangLabMB.
                                                getSelectedRow(), 0).toString(),
                                HttpMethod.PUT, requestEntity, String.class).
                                getBody();
                        System.out.println("Result JSON : " + json);
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.meghapustf(
                                    "satu_sehat_mapping_lokasi_ruanglabmb",
                                    "id_lokasi_satusehat", tbLokasiRuangLabMB.
                                            getValueAt(tbLokasiRuangLabMB.
                                                    getSelectedRow(), 0).
                                            toString()) == true) {
                                tabModeRuangLabMB.removeRow(tbLokasiRuangLabMB.
                                        getSelectedRow());
                                emptTeks();
                                LCount.setText("" + tabModeRuangLabMB.
                                        getRowCount());
            ...
            if (KodeDepartemenRuangRadiologi.getText().trim().isEmpty() || NamaDepartemenRuangRadiologi.
                ...
                if (tbLokasiRuangRadiologi.getSelectedRow() > -1) {
                    try {
                        ...
                        json = "{"
                                + "\"resourceType\": \"Location\","
                                + "\"id\": \"" + tbLokasiRuangRadiologi.
                                        getValueAt(tbLokasiRuangRadiologi.
                                                getSelectedRow(), 0).toString() + "\","
                                + "\"identifier\": ["
                                + "{"
                                + "\"system\": \"http://sys-ids.kemkes.go.id/location/" + koneksiDB.
                        ...
                        requestEntity = new HttpEntity(json, headers);
                        json = api.getRest().exchange(
                                link + "/Location/" + tbLokasiRuangRadiologi.
                                        getValueAt(tbLokasiRuangRadiologi.
                                                getSelectedRow(), 0).toString(),
                                HttpMethod.PUT, requestEntity, String.class).
                                getBody();
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.meghapustf(
                                    "satu_sehat_mapping_lokasi_ruangrad",
                                    "id_lokasi_satusehat",
                                    tbLokasiRuangRadiologi.getValueAt(
                                            tbLokasiRuangRadiologi.
                                                    getSelectedRow(), 0).
                                            toString()) == true) {
                                tabModeRuangRadiologi.removeRow(
                                        tbLokasiRuangRadiologi.getSelectedRow());
                                emptTeks();
                                LCount.setText("" + tabModeRuangRadiologi.
                                        getRowCount());
                            }
            ...
            if (tbLokasiFarmasi.getSelectedRow() > -1) {
                try {
                    ...
                    json = "{"
                            + "\"resourceType\": \"Location\","
                            + "\"id\": \"" + tbLokasiFarmasi.getValueAt(
                                    tbLokasiFarmasi.getSelectedRow(), 2).
                                    toString() + "\","
                            + "\"identifier\": ["
                            + "{"
                            + "\"system\": \"http://sys-ids.kemkes.go.id/location/" + koneksiDB.
                    ...
                    requestEntity = new HttpEntity(json, headers);
                    json = api.getRest().exchange(
                            link + "/Location/" + tbLokasiFarmasi.getValueAt(
                                    tbLokasiFarmasi.getSelectedRow(), 2).
                                    toString(), HttpMethod.PUT, requestEntity,
                            String.class).getBody();
                    System.out.println("Result JSON : " + json);
                    ...
                    response = root.path("id");
                    if (!response.asText().isEmpty()) {
                        if (Valid.hapusTabletf(tabModeRuangFarmasi, KodeFarmasi,
                                "satu_sehat_mapping_lokasi_depo_farmasi",
                                "kd_bangsal") == true) {
                            tabModeRuangFarmasi.removeRow(tbLokasiFarmasi.
                                    getSelectedRow());
                            emptTeks();
                            LCount.setText("" + tabModeRuangFarmasi.
                                    getRowCount());
                    ...
                    try {
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.mengedittf(
                                    ...
                                    7, new String[]{
                                        KodePoli.getText(), IDOrganisasi.
                                        getText(), response.asText(), Longitude.
                                        getText(), Latitude.getText(), Altitude.
                                        getText(), tbJnsPerawatan.getValueAt(
                                                tbJnsPerawatan.getSelectedRow(),
                                                0).toString()
                                    }) == true) {
                                tabMode.setValueAt(KodePoli.getText(),
                                        tbJnsPerawatan.getSelectedRow(), 0);
                                tabMode.setValueAt(NamaPoli.getText(),
                                        tbJnsPerawatan.getSelectedRow(), 1);
                                tabMode.setValueAt(response.asText(),
                                        tbJnsPerawatan.getSelectedRow(), 2);
                                tabMode.setValueAt(Longitude.getText(),
                                        tbJnsPerawatan.getSelectedRow(), 3);
                                tabMode.setValueAt(Latitude.getText(),
                                        tbJnsPerawatan.getSelectedRow(), 4);
                                tabMode.setValueAt(Altitude.getText(),
                                        tbJnsPerawatan.getSelectedRow(), 5);
                                tabMode.setValueAt(KodeDepartemen.getText(),
                                        tbJnsPerawatan.getSelectedRow(), 6);
                                tabMode.setValueAt(NamaDepartemen.getText(),
                                        tbJnsPerawatan.getSelectedRow(), 7);
                                tabMode.setValueAt(IDOrganisasi.getText(),
                                        tbJnsPerawatan.getSelectedRow(), 8);
                                emptTeks();
                            }
                        } else {
                            JOptionPane.showMessageDialog(null,
                    ...
                    try {
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.mengedittf(
                                    ...
                                    "kd_kamar=?",
                                    "kd_kamar=?,id_organisasi_satusehat=?,id_lokasi_satusehat=?,longitude=?,latitude=?,altittude=?",
                                    7, new String[]{
                                        KodeKamar.getText(), IDOrganisasiKamar.
                                        getText(), response.asText(),
                                        LongitudeKamar.getText(), LatitudeKamar.
                                        getText(), AltitudeKamar.getText(),
                                        tbLokasiKamar.getValueAt(tbLokasiKamar.
                                                getSelectedRow(), 0).toString()
                                    }) == true) {
                                tabModeKamar.setValueAt(KodeKamar.getText(),
                                        tbLokasiKamar.getSelectedRow(), 0);
                                tabModeKamar.setValueAt(NamaKamar.getText(),
                                        tbLokasiKamar.getSelectedRow(), 1);
                                tabModeKamar.setValueAt(response.asText(),
                                        tbLokasiKamar.getSelectedRow(), 2);
                                tabModeKamar.
                                        setValueAt(LongitudeKamar.getText(),
                                                tbLokasiKamar.getSelectedRow(),
                                                3);
                                tabModeKamar.setValueAt(LatitudeKamar.getText(),
                                        tbLokasiKamar.getSelectedRow(), 4);
                                tabModeKamar.setValueAt(AltitudeKamar.getText(),
                                        tbLokasiKamar.getSelectedRow(), 5);
                                tabModeKamar.setValueAt(KodeDepartemenKamar.
                                        getText(), tbLokasiKamar.
                                                getSelectedRow(), 6);
                                tabModeKamar.setValueAt(NamaDepartemenKamar.
                                        getText(), tbLokasiKamar.
                                                getSelectedRow(), 7);
                                tabModeKamar.setValueAt(IDOrganisasiKamar.
                                        getText(), tbLokasiKamar.
                                                getSelectedRow(), 8);
                                emptTeks();
                            }
                    ...
                    try {
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.mengedittf(
                                    "satu_sehat_mapping_lokasi_ruangok",
                                    "id_lokasi_satusehat=?",
                                    "id_organisasi_satusehat=?,id_lokasi_satusehat=?,longitude=?,latitude=?,altittude=?",
                                    6, new String[]{
                                        IDOrganisasiRuangOK.getText(), response.
                                        asText(), LongitudeRuangOK.getText(),
                                        LatitudeRuangOK.getText(),
                                        AltitudeRuangOK.getText(),
                                        tbLokasiRuangOK.getValueAt(
                                                tbLokasiRuangOK.getSelectedRow(),
                                                0).toString()
                                    }) == true) {
                                tabModeRuangOK.setValueAt(response.asText(),
                                        tbLokasiRuangOK.getSelectedRow(), 0);
                                tabModeRuangOK.setValueAt(LongitudeRuangOK.
                                        getText(), tbLokasiRuangOK.
                                                getSelectedRow(), 1);
                                tabModeRuangOK.setValueAt(LatitudeRuangOK.
                                        getText(), tbLokasiRuangOK.
                                                getSelectedRow(), 2);
                                tabModeRuangOK.setValueAt(AltitudeRuangOK.
                                        getText(), tbLokasiRuangOK.
                                                getSelectedRow(), 3);
                                tabModeRuangOK.setValueAt(KodeDepartemenRuangOK.
                                        getText(), tbLokasiRuangOK.
                                                getSelectedRow(), 4);
                                tabModeRuangOK.setValueAt(NamaDepartemenRuangOK.
                                        getText(), tbLokasiRuangOK.
                                                getSelectedRow(), 5);
                                tabModeRuangOK.setValueAt(IDOrganisasiRuangOK.
                                        getText(), tbLokasiRuangOK.
                                                getSelectedRow(), 6);
                                emptTeks();
                            }
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.mengedittf(
                                    ...
                                    6, new String[]{
                                        ...
                                        getText(), LatitudeRuangLabPK.getText(),
                                        AltitudeRuangLabPK.getText(),
                                        tbLokasiRuangLabPK.getValueAt(
                                                tbLokasiRuangLabPK.
                                                        getSelectedRow(), 0).
                                                toString()
                                    }) == true) {
                                tabModeRuangLabPK.setValueAt(response.asText(),
                                        tbLokasiRuangLabPK.getSelectedRow(), 0);
                                tabModeRuangLabPK.setValueAt(
                                        LongitudeRuangLabPK.getText(),
                                        tbLokasiRuangLabPK.getSelectedRow(), 1);
                                tabModeRuangLabPK.setValueAt(LatitudeRuangLabPK.
                                        getText(), tbLokasiRuangLabPK.
                                                getSelectedRow(), 2);
                                tabModeRuangLabPK.setValueAt(AltitudeRuangLabPK.
                                        getText(), tbLokasiRuangLabPK.
                                                getSelectedRow(), 3);
                                tabModeRuangLabPK.setValueAt(
                                        KodeDepartemenRuangLabPK.getText(),
                                        tbLokasiRuangLabPK.getSelectedRow(), 4);
                                tabModeRuangLabPK.setValueAt(
                                        NamaDepartemenRuangLabPK.getText(),
                                        tbLokasiRuangLabPK.getSelectedRow(), 5);
                                tabModeRuangLabPK.setValueAt(
                                        IDOrganisasiRuangLabPK.getText(),
                                        tbLokasiRuangLabPK.getSelectedRow(), 6);
                                emptTeks();
                            }
                        } else {
                            JOptionPane.showMessageDialog(null,
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.mengedittf(
                                    ...
                                    6, new String[]{
                                        ...
                                        getText(), LatitudeRuangLabPA.getText(),
                                        AltitudeRuangLabPA.getText(),
                                        tbLokasiRuangLabPA.getValueAt(
                                                tbLokasiRuangLabPA.
                                                        getSelectedRow(), 0).
                                                toString()
                                    }) == true) {
                                tabModeRuangLabPA.setValueAt(response.asText(),
                                        tbLokasiRuangLabPA.getSelectedRow(), 0);
                                tabModeRuangLabPA.setValueAt(
                                        LongitudeRuangLabPA.getText(),
                                        tbLokasiRuangLabPA.getSelectedRow(), 1);
                                tabModeRuangLabPA.setValueAt(LatitudeRuangLabPA.
                                        getText(), tbLokasiRuangLabPA.
                                                getSelectedRow(), 2);
                                tabModeRuangLabPA.setValueAt(AltitudeRuangLabPA.
                                        getText(), tbLokasiRuangLabPA.
                                                getSelectedRow(), 3);
                                tabModeRuangLabPA.setValueAt(
                                        KodeDepartemenRuangLabPA.getText(),
                                        tbLokasiRuangLabPA.getSelectedRow(), 4);
                                tabModeRuangLabPA.setValueAt(
                                        NamaDepartemenRuangLabPA.getText(),
                                        tbLokasiRuangLabPA.getSelectedRow(), 5);
                                tabModeRuangLabPA.setValueAt(
                                        IDOrganisasiRuangLabPA.getText(),
                                        tbLokasiRuangLabPA.getSelectedRow(), 6);
                                emptTeks();
                            }
                        } else {
                            JOptionPane.showMessageDialog(null,
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.mengedittf(
                                    ...
                                    6, new String[]{
                                        ...
                                        getText(), LatitudeRuangLabMB.getText(),
                                        AltitudeRuangLabMB.getText(),
                                        tbLokasiRuangLabMB.getValueAt(
                                                tbLokasiRuangLabMB.
                                                        getSelectedRow(), 0).
                                                toString()
                                    }) == true) {
                                tabModeRuangLabMB.setValueAt(response.asText(),
                                        tbLokasiRuangLabMB.getSelectedRow(), 0);
                                tabModeRuangLabMB.setValueAt(
                                        LongitudeRuangLabMB.getText(),
                                        tbLokasiRuangLabMB.getSelectedRow(), 1);
                                tabModeRuangLabMB.setValueAt(LatitudeRuangLabMB.
                                        getText(), tbLokasiRuangLabMB.
                                                getSelectedRow(), 2);
                                tabModeRuangLabMB.setValueAt(AltitudeRuangLabMB.
                                        getText(), tbLokasiRuangLabMB.
                                                getSelectedRow(), 3);
                                tabModeRuangLabMB.setValueAt(
                                        KodeDepartemenRuangLabMB.getText(),
                                        tbLokasiRuangLabMB.getSelectedRow(), 4);
                                tabModeRuangLabMB.setValueAt(
                                        NamaDepartemenRuangLabMB.getText(),
                                        tbLokasiRuangLabMB.getSelectedRow(), 5);
                                tabModeRuangLabMB.setValueAt(
                                        IDOrganisasiRuangLabMB.getText(),
                                        tbLokasiRuangLabMB.getSelectedRow(), 6);
                                emptTeks();
                            }
                        } else {
                            JOptionPane.showMessageDialog(null,
                    ...
                    try {
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.mengedittf(
                                ...
                                tabModeRuangRadiologi.setValueAt(response.
                                        asText(), tbLokasiRuangRadiologi.
                                                getSelectedRow(), 0);
                                tabModeRuangRadiologi.setValueAt(
                                        LongitudeRuangRadiologi.getText(),
                                        tbLokasiRuangRadiologi.getSelectedRow(),
                                        1);
                                tabModeRuangRadiologi.setValueAt(
            ...
            if (KodeDepartemenFarmasi.getText().trim().isEmpty() || NamaDepartemenFarmasi.
                ...
                if (tbLokasiFarmasi.getSelectedRow() > -1) {
                    try {
                        ...
                        requestEntity = new HttpEntity(json, headers);
                        json = api.getRest().exchange(
                                link + "/Location/" + tbLokasiFarmasi.
                                        getValueAt(tbLokasiFarmasi.
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.mengedittf(
                                    ...
                                    7, new String[]{
                                        KodeFarmasi.getText(),
                                        IDOrganisasiFarmasi.getText(), response.
                                        asText(), LongitudeFarmasi.getText(),
                                        LatitudeFarmasi.getText(),
                                        AltitudeFarmasi.getText(),
                                        tbLokasiFarmasi.getValueAt(
                                                tbLokasiFarmasi.getSelectedRow(),
                                                0).toString()
                                    }) == true) {
                                tabModeRuangFarmasi.setValueAt(KodeFarmasi.
                                        getText(), tbLokasiFarmasi.
                                                getSelectedRow(), 0);
                                tabModeRuangFarmasi.setValueAt(NamaFarmasi.
                                        getText(), tbLokasiFarmasi.
                                                getSelectedRow(), 1);
                                tabModeRuangFarmasi.
                                        setValueAt(response.asText(),
                                                tbLokasiFarmasi.getSelectedRow(),
                                                2);
                                tabModeRuangFarmasi.setValueAt(LongitudeFarmasi.
                                        getText(), tbLokasiFarmasi.
                                                getSelectedRow(), 3);
                                tabModeRuangFarmasi.setValueAt(LatitudeFarmasi.
                                        getText(), tbLokasiFarmasi.
                                                getSelectedRow(), 4);
                                tabModeRuangFarmasi.setValueAt(AltitudeFarmasi.
                                        getText(), tbLokasiFarmasi.
                                                getSelectedRow(), 5);
                                tabModeRuangFarmasi.setValueAt(
                                        KodeDepartemenFarmasi.getText(),
                                        tbLokasiFarmasi.getSelectedRow(), 6);
                                tabModeRuangFarmasi.setValueAt(
                                        NamaDepartemenFarmasi.getText(),
                                        tbLokasiFarmasi.getSelectedRow(), 7);
                                tabModeRuangFarmasi.setValueAt(
                                        IDOrganisasiFarmasi.getText(),
                                        tbLokasiFarmasi.getSelectedRow(), 8);
                                emptTeks();
                            }
                        } else {
                            JOptionPane.showMessageDialog(null,
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (TabRawat.getSelectedIndex() == 0) {
            ...
            if (tabMode.getRowCount() == 0) {
                ...
                Valid.MyReport("rptMapingLokasiSatuSehat.jasper", "report",
                        "::[ Mapping Poli/Lokasi Satu Sehat Kemenkes ]::", param);
            }
            ...
            if (tabModeKamar.getRowCount() == 0) {
                ...
                param.put("logo", Sequel.cariGambar(
                        "select setting.logo from setting"));
                param.put("parameter", "%" + TCari.getText().trim() + "%");
                Valid.MyReport("rptMapingLokasiSatuSehat2.jasper", "report",
                        "::[ Mapping Kamar Inap/Ruang Inap Satu Sehat Kemenkes ]::",
                        param);
            }
            this.setCursor(Cursor.getDefaultCursor());
        } else if (TabRawat.getSelectedIndex() == 2) {
            ...
            if (tabModeRuangOK.getRowCount() == 0) {
                ...
                param.put("logo", Sequel.cariGambar(
                        "select setting.logo from setting"));
                Valid.MyReport("rptMapingLokasiSatuSehat3.jasper", "report",
                        "::[ Mapping Lokasi Ruang Operasi Satu Sehat Kemenkes ]::",
                        param);
            }
            this.setCursor(Cursor.getDefaultCursor());
        } else if (TabRawat.getSelectedIndex() == 3) {
            ...
            if (tabModeRuangLabPK.getRowCount() == 0) {
                ...
                param.put("logo", Sequel.cariGambar(
                        "select setting.logo from setting"));
                Valid.MyReport("rptMapingLokasiSatuSehat4.jasper", "report",
                        "::[ Mapping Lokasi Ruang Laboratorium Patologi Klinis Satu Sehat Kemenkes ]::",
                        param);
            }
            this.setCursor(Cursor.getDefaultCursor());
        } else if (TabRawat.getSelectedIndex() == 4) {
            ...
            if (tabModeRuangLabPA.getRowCount() == 0) {
                ...
                param.put("logo", Sequel.cariGambar(
                        "select setting.logo from setting"));
                Valid.MyReport("rptMapingLokasiSatuSehat5.jasper", "report",
                        "::[ Mapping Lokasi Ruang Laboratorium Patologi Anatomi Satu Sehat Kemenkes ]::",
                        param);
            }
            this.setCursor(Cursor.getDefaultCursor());
        } else if (TabRawat.getSelectedIndex() == 5) {
            ...
            if (tabModeRuangLabMB.getRowCount() == 0) {
                ...
                param.put("logo", Sequel.cariGambar(
                        "select setting.logo from setting"));
                Valid.MyReport("rptMapingLokasiSatuSehat6.jasper", "report",
                        "::[ Mapping Lokasi Ruang Laboratorium Mikrobiologi & Bio Molekuler Satu Sehat Kemenkes ]::",
                        param);
            }
            this.setCursor(Cursor.getDefaultCursor());
        } else if (TabRawat.getSelectedIndex() == 6) {
            ...
            if (tabModeRuangRadiologi.getRowCount() == 0) {
                ...
                param.put("logo", Sequel.cariGambar(
                        "select setting.logo from setting"));
                Valid.MyReport("rptMapingLokasiSatuSehat7.jasper", "report",
                        "::[ Mapping Lokasi Ruang Radiologi Satu Sehat Kemenkes ]::",
                        param);
            }
            this.setCursor(Cursor.getDefaultCursor());
        } else if (TabRawat.getSelectedIndex() == 7) {
            ...
            if (tabModeRuangFarmasi.getRowCount() == 0) {
                ...
                param.put("logo", Sequel.cariGambar(
                        "select setting.logo from setting"));
                param.put("parameter", "%" + TCari.getText().trim() + "%");
                Valid.MyReport("rptMapingLokasiSatuSehat8.jasper", "report",
                        "::[ Mapping Lokasi Depo/Farmasi Satu Sehat Kemenkes ]::",
                        param);
            }
            this.setCursor(Cursor.getDefaultCursor());
        }
    ...
    private void btnFarmasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFarmasiActionPerformed
        kamar.bangsal.isCek();
        kamar.bangsal.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "poliklinik.nm_poli like ? or satu_sehat_mapping_lokasi_ralan.kd_poli like ?")
    ...
    private void tampilkamar() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + (TCari.getText().isEmpty() ? ""
                    : "where satu_sehat_mapping_departemen.dep_id like ? or departemen.nama like ? or "
                    + "bangsal.nm_bangsal like ? or satu_sehat_mapping_lokasi_ranap.kd_kamar like ?")
                    + " order by departemen.nama");
            try {
                if (!TCari.getText().isEmpty()) {
                    ps.setString(1, "%" + TCari.getText() + "%");
    ...
    private void tampilruangfarmasi() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + (TCari.getText().isEmpty() ? ""
                    : "where satu_sehat_mapping_departemen.dep_id like ? or departemen.nama like ? or "
                    + "bangsal.nm_bangsal like ? or satu_sehat_mapping_lokasi_depo_farmasi.kd_bangsal like ?")
                    + " order by departemen.nama");
            try {
                if (!TCari.getText().isEmpty()) {
                    ps.setString(1, "%" + TCari.getText() + "%");
