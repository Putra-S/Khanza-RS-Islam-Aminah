 ...
 * @author dosen
 */
public class BPJSDataFingerPrintPasien extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSDataFingerPrintPasien dialog = new BPJSDataFingerPrintPasien(
    ...
    public void tampil() {
        try {
            ...
            URL = link + "/SEP/FingerPrint/List/Peserta/TglPelayanan/"
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        tabMode.addRow(
                                new Object[]{i + "", list.path("noKartu").
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSDataFingerPrintPasien.class.getName());
