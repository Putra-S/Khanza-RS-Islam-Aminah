 ...
 * @author dosen
 */
public class SisruteCekReferensiKriteriaJenis extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SisruteCekReferensiKriteriaJenis dialog = new SisruteCekReferensiKriteriaJenis(new javax.swing.JFrame(),
                    true);
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        if (list.path("ID").asText().toLowerCase().contains(faskes.toLowerCase())
                            ...
                            tabMode.addRow(new Object[]{i + ".", list.path("ID").asText(),
                                list.path("PELAYANAN").asText()});
                            i++;
                        }
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(SisruteCekReferensiKriteriaJenis.class.getName());
