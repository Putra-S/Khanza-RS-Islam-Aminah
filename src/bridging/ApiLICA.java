...
public class ApiLICA {
    ...
    try {
      ...
      try {
        ...
        while (rs.next()) {
          ...
          stringbalik =
              getRest()
                  .exchange(URL + "/insert", HttpMethod.POST, requestEntity, String.class)
                  .getBody();
  ...
  public void ambil(String nopermintaan) {
    try {
      ...
      stringbalik =
          getRest()
              .exchange(URL + "/get/" + nopermintaan, HttpMethod.GET, requestEntity, String.class)
              .getBody();
  ...
  private static final Logger LOG = Logger.getLogger(ApiLICA.class.getName());
}
