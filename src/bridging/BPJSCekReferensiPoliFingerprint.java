 ...
 * @author dosen
 */
public class BPJSCekReferensiPoliFingerprint extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public BPJSCekReferensiPoliFingerprint(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"No.", "Kode Subspesialis", "Nama Subspesialis", "Kode Poli", "Nama Poli"}) {
            @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pencarian Data Referensi Poli Fingerprint ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        internalFrame1.getAccessibleContext().setAccessibleName("::[ Pencarian Data Referensi Poli Fingerprint ]::");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiPoliFingerprint dialog = new BPJSCekReferensiPoliFingerprint(new javax.swing.JFrame(),
                    true);
            ...
            if (nameNode.path("code").asText().equals("1")) {
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        if (list.path("kodesubspesialis").asText().toLowerCase().contains(poli.toLowerCase())
                                || list.path("namasubspesialis").asText().toLowerCase().contains(poli.toLowerCase())
                                || list.path("kodepoli").asText().toLowerCase().contains(poli.toLowerCase())
                                || list.path("namapoli").asText().toLowerCase().contains(poli.toLowerCase())) {
                            tabMode.addRow(new Object[]{i + ".", list.path("kodesubspesialis").asText(),
                                list.path("namasubspesialis").asText(), list.path("kodepoli").asText(),
    ...
    private static final Logger LOG = Logger.getLogger(BPJSCekReferensiPoliFingerprint.class.getName());
