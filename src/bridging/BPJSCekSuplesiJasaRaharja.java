...
public class BPJSCekSuplesiJasaRaharja extends javax.swing.JDialog {
    ...
    public BPJSCekSuplesiJasaRaharja(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No", "No.Registrasi", "No.SEP", "No.SEP Awal",
            "No.Surat Jaminan", "Tgl.Kejadian",
            "Tgl.SEP"};
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekSuplesiJasaRaharja dialog = new BPJSCekSuplesiJasaRaharja(
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        tabMode.addRow(
                                new Object[]{i + "", list.path("noRegister").
                                            asText(), list.path("noSep").
                                            asText(),
                                    list.path("noSepAwal").asText(), list.path(
                                    "noSuratJaminan").asText(),
                                    list.path("tglKejadian").asText(), list.
                                    path("tglSep").asText()});
                        i++;
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSCekSuplesiJasaRaharja.class.getName());
