...
public class BPJSCekSuplesiJasaRaharja extends javax.swing.JDialog {
    ...
    public BPJSCekSuplesiJasaRaharja(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No", "No.Registrasi", "No.SEP", "No.SEP Awal", "No.Surat Jaminan", "Tgl.Kejadian",
            "Tgl.SEP"};
                ...
                if (akses.getform().equals("DlgBPJSCekSuplesiJasaRaharja")) {
                    if (pasien.getTable().getSelectedRow() != -1) {
                        if (pasien.getTable().getValueAt(pasien.getTable().getSelectedRow(), 19).toString().isEmpty()) {
                            ...
                            NoKartu.setText(
                                    pasien.getTable().getValueAt(pasien.getTable().getSelectedRow(), 19).toString());
                            NamaPasien.setText(
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (int r = 0; r < row; r++) {
                Sequel.menyimpan("temporary", "'" + r + "','"
                        ...
                        + tabMode.getValueAt(r, 6).toString() + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.
            ...
            Valid.MyReportqry("rptCariBPJSSuplesiJasaRaharja.jasper", "report",
                    "[ Data Suplesi Jasa Raharja ]",
    ...
    public void tampil(String nomorkartu) {
        try {
            ...
            URL = link + "/sep/JasaRaharja/Suplesi/" + nomorkartu + "/tglPelayanan/"
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        tabMode.addRow(
                                new Object[]{i + "", list.path("noRegister").asText(), list.path("noSep").asText(),
                                    list.path("noSepAwal").asText(), list.path("noSuratJaminan").asText(),
                                    list.path("tglKejadian").asText(), list.path("tglSep").asText()});
                        i++;
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(BPJSCekSuplesiJasaRaharja.class.getName());
