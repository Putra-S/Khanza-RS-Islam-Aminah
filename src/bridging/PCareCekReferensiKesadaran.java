...
public class PCareCekReferensiKesadaran extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiKesadaran dialog = new PCareCekReferensiKesadaran(
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kdSadar").asText().toLowerCase().
                                contains(diagnosa.toLowerCase())
                                || list.path("nmSadar").asText().toLowerCase().
                                        contains(diagnosa.toLowerCase())) {
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareCekReferensiKesadaran.class.getName());
