 ...
 * @author dosen
 */
public class BPJSCekReferensiProsedur extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariBPJSReferensiProsedur.jasper", "report",
                    "[ Pencarian Referensi Prosedur/Tindakan ]",
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if (Poli.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null,
                    "Silahkan masukkan pencarian terlebih dahulu..!!!");
        } else {
            tampil(Poli.getText());
        }
        this.setCursor(Cursor.getDefaultCursor());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiProsedur dialog = new BPJSCekReferensiProsedur(
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSCekReferensiProsedur.class.getName());
