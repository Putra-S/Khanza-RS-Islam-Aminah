...
public class BPJSCekReferensiProsedur extends javax.swing.JDialog {
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (response.path("procedure").isArray()) {
                    ...
                    for (JsonNode list : response.path("procedure")) {
                        tabMode
                                .addRow(new Object[]{i + ".", list.path("kode").asText(), list.path("nama").asText()});
                        i++;
                    }
                }
            } else {
    ...
    private static final Logger LOG = Logger.getLogger(BPJSCekReferensiProsedur.class.getName());
