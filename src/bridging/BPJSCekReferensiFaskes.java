 ...
 * @author dosen
 */
public class BPJSCekReferensiFaskes extends javax.swing.JDialog {
    ...
    public BPJSCekReferensiFaskes(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Faskes",
            "Nama Faskes"}) {
            @Override
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariBPJSReferensiFaskes.jasper", "report",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiFaskes dialog = new BPJSCekReferensiFaskes(
    ...
    public void tampil(String faskes) {
        try {
            ...
            if (nameNode.path("code").asText().equals("200")) {
                tabMode.addRow(new Object[]{"A", "Faskes 1", ""});
                ...
                System.out.println("Notif Faskes 1 : " + nameNode.
                        path("message").asText());
            }
    ...
    public void tampil2(String faskes) {
        try {
            ...
            if (nameNode.path("message").asText().equals("Sukses")) {
                ...
                tabMode.addRow(new Object[]{"B", "Faskes 2/RS", ""});
                response = mapper.readTree(api.Decrypt(root.path("response").
                        asText(), utc));
                // response = root.path("response");
                if (response.path("faskes").isArray()) {
                ...
                System.out.println("Notif Faskes 2 : " + nameNode.
                        path("message").asText());
            }
        } catch (IOException | InvalidAlgorithmParameterException | InvalidKeyException | KeyManagementException
                | NoSuchAlgorithmException | BadPaddingException | IllegalBlockSizeException | NoSuchPaddingException
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSCekReferensiFaskes.class.getName());
