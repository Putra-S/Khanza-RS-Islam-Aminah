...
public class BPJSCekRujukanKartuRS extends javax.swing.JDialog {
    ...
    private String kdkel = "", kdkec = "", kdkab = "", kdprop = "", nosisrute = "", ADDANTRIANAPIMOBILEJKN = "no",
            BASENOREG = "", URUTNOREG = "", link = "", statuspasien = "", pengurutan = "", tahun = "", bulan = "",
            posisitahun = "", awalantahun = "", awalanbulan = "", no_ktp = "", tmp_lahir = "", nm_ibu = "", alamat = "",
            pekerjaan = "", no_tlp = "", tglkkl = "0000-00-00", jammulai = "", umur = "", umurdaftar = "0",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekRujukanKartuRS dialog = new BPJSCekRujukanKartuRS(
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSCekRujukanKartuRS.class.getName());
