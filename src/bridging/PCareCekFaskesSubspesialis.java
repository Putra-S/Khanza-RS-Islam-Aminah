 ...
 * @author dosen
 */
public class PCareCekFaskesSubspesialis extends javax.swing.JDialog {
    ...
    private PCareCekReferensiSubspesialis spesialis = new PCareCekReferensiSubspesialis(
            null, false);
    ...
    public PCareCekFaskesSubspesialis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode PPK",
            "Nama PPK", "Alamat", "No.Telp",
            "Kelas", "Cabang", "Jarak", "Jadwal", "Rujuk", "Kps", "Persentase"}) {
            @Override
        ...
        spesialis.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (spesialis.getTable().getSelectedRow() != -1) {
                    KdSpesialis
                            .setText(spesialis.getTable().getValueAt(spesialis.
    ...
    private void BtnPropinsiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPropinsiActionPerformed
        spesialis.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariPCAREFaskesSubspesialis.jasper", "report",
                    "[ Pencarian Referensi Rujukan Subpesialis ]",
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        if (KdSpesialis.getText().trim().isEmpty() || NmSpesialis.getText().
                trim().isEmpty()) {
            JOptionPane.showMessageDialog(null,
                    "Silahkan pilih subspesialis dulu..!!");
            BtnPropinsi.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            tampil(KdSpesialis.getText(), KdSarana.getText(), Tanggal.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekFaskesSubspesialis dialog = new PCareCekFaskesSubspesialis(
    ...
    public void tampil(String spesialistik, String sarana, String tanggal) {
        try {
            URL = link + "/spesialis/rujuk/subspesialis/" + spesialistik + "/sarana/" + sarana + "/tglEstRujuk/"
                    + tanggal;
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        tabMode.addRow(new Object[]{i + ".", list.path("kdppk").
                            ...
                            list.path("alamatPpk").asText(), list.
                            path("telpPpk").asText(),
                            list.path("kelas").asText(), list.path("nmkc").
                            asText(), list.path("distance").asText(),
                            list.path("jadwal").asText(), list.path("jmlRujuk").
                            asText(),
                            list.path("kapasitas").asText(), list.path(
                            "persentase").asText()});
                        i++;
                    }
                }
    ...
    public void setCari(String kodespesialis, String namaspesialis,
            String kodesarana, String namasarana,
            Date tanggal) {
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareCekFaskesSubspesialis.class.getName());
