...
public class PCareMapingObat extends javax.swing.JDialog {
    ...
    public PCareMapingObat(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Obat RS", "Nama Obat RS", "Kode Obat PCare", "Nama Obat PCare"}) {
            @Override
...
private void btnPoliBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliBPJSActionPerformed
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kode_brng"), rs.getString("nama_brng"),
                        rs.getString("kode_brng_pcare"), rs.getString("nama_brng_pcare")});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(PCareMapingObat.class.getName());
