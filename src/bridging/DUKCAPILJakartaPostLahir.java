...
public class DUKCAPILJakartaPostLahir {
    ...
    private static final Logger LOG = Logger.getLogger(DUKCAPILJakartaPostLahir.class.getName());
    ...
    public boolean post(
        ...
        try {
            URL
                    ...
                    + "&app=SILaporLahir&pget=Kelahiran&pusr=admin&proc=POSTLAHIR&nokk="
                    + nokk
                    + "&nmbayi="
                    + nmbayi
                    + "&tgllhr="
        ...
        } catch (HeadlessException | IOException | JSONException | RestClientException ex) {
            status = false;
