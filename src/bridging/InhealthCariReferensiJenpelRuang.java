...
public class InhealthCariReferensiJenpelRuang extends javax.swing.JDialog {
    ...
    private InhealthReferensiJenpelRuang bangsal = new InhealthReferensiJenpelRuang(
            null, false);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InhealthCariReferensiJenpelRuang dialog = new InhealthCariReferensiJenpelRuang(
                ...
                while (rs.next()) {
                    tabMode.addRow(
                            new Object[]{rs.getString(1), rs.getString(2),
                                ...
                                rs.getString(5), rs.getDouble(6), rs.
                                getDouble(7), rs.getString(8)});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(
            InhealthCariReferensiJenpelRuang.class.getName());
