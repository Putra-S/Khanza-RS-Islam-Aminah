 ...
 * @author dosen
 */
public class BPJSCekReferensiPenyakit extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariBPJSReferensiDiagnosa.jasper", "report",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiPenyakit dialog = new BPJSCekReferensiPenyakit(
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSCekReferensiPenyakit.class.getName());
