...
public class SatuSehatKirimProcedure extends javax.swing.JDialog {
    ...
    public SatuSehatKirimProcedure(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"P", "Tanggal Registrasi", "No.Rawat", "No.RM", "Nama Pasien", "No.KTP Pasien",
                    "Stts Rawat", "Stts Lanjut", "Tanggal Pulang", "ID Encounter", "ICD 9", "Nama Prosedur",
                    "ID Procedure"}) {
            ...
            if (tbObat.getValueAt(i, 0).toString().equals("true") && (!tbObat.
                ...
                try {
                    ...
                    try {
                        ...
                        json = api.getRest().exchange(link + "/Procedure",
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.menyimpantf2("satu_sehat_procedure",
                                    "?,?,?,?", "Prosedur", 4, new String[]{
                ...
                try {
                    ...
                    try {
                        ...
                        json = "{"
                                ...
                                + "}";
                        System.out.println(
                                "URL : " + link + "/Procedure/" + tbObat.
                                        getValueAt(i, 12).toString());
                        System.out.println("Request JSON : " + json);
                        requestEntity = new HttpEntity(json, headers);
                        json = api.getRest().exchange(
                                link + "/Procedure/" + tbObat.getValueAt(i, 12).
    ...
    private void tampil() {
        if (cekBoxBelumKirim.isSelected() == true) {
            cekbok = " and satu_sehat_procedure.id_procedure is null and pasien.no_ktp <> '-' ";
        } else {
            cekbok = "";
        }
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false,
                        ...
                        rs.getString("pulang"), rs.getString("id_encounter"), rs.getString("kode"),
    ...
    private static final Logger LOG = Logger.getLogger(SatuSehatKirimProcedure.class.getName());
