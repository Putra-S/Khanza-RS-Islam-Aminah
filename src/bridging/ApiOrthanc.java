...
public class ApiOrthanc {
  ...
  public JsonNode AmbilSeries(String Norm, String Tanggal1, String Tanggal2) {
    ...
    try {
      ...
      System.out.println(
          "URL : " + koneksiDB.URLORTHANC() + ":" + koneksiDB.PORTORTHANC() + "/tools/find");
      requestJson =
          getRest()
              .exchange(
                  koneksiDB.URLORTHANC() + ":" + koneksiDB.PORTORTHANC() + "/tools/find",
                  HttpMethod.POST,
                  requestEntity,
                  String.class)
              .getBody();
      ...
      JOptionPane.showMessageDialog(
          null, "Gagal mengambil data dari Orthanc, silahkan hubungi administrator ..!!");
    }
    return root;
  }
  ...
  public JsonNode AmbilPng(String NoRawat, String Series) {
    ...
    try {
      ...
      System.out.println(
          "URL : " + koneksiDB.URLORTHANC() + ":" + koneksiDB.PORTORTHANC() + "/series/" + Series);
      requestJson =
          getRest()
              .exchange(
      ...
      System.out.println("Notifikasi : " + e);
      JOptionPane.showMessageDialog(
          null, "Gagal mengambil Gambar PNG dari Orthanc, silahkan hubungi administrator ..!!");
    }
    return root;
  }
  ...
  public JsonNode AmbilJpg(String NoRawat, String Series) {
    ...
    try {
      ...
      System.out.println("Notifikasi : " + e);
      JOptionPane.showMessageDialog(
          null, "Gagal mengambil Gambar JPG dari Orthanc, silahkan hubungi administrator ..!!");
    }
    return root;
  }
  ...
  public JsonNode AmbilBmp(String NoRawat, String Series) {
    ...
    try {
      ...
      System.out.println("Notifikasi : " + e);
      JOptionPane.showMessageDialog(
          null, "Gagal mengambil Gambar BMP dari Orthanc, silahkan hubungi administrator ..!!");
    }
    return root;
  }
  ...
  public JsonNode AmbilDcm(String NoRawat, String Series) {
    ...
    try {
      ...
      System.out.println("Notifikasi : " + e);
      JOptionPane.showMessageDialog(
          null, "Gagal mengambil Gambar DCM dari Orthanc, silahkan hubungi administrator ..!!");
    }
    return root;
  }
  ...
  private static final Logger LOG = Logger.getLogger(ApiOrthanc.class.getName());
}
