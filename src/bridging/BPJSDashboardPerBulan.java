...
public class BPJSDashboardPerBulan extends javax.swing.JDialog {
    ...
    public BPJSDashboardPerBulan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"No.", "Kode PPK", "Nama PPK", "Kode Poli", "Nama Poli", "Tanggal", "Jumlah Antrian",
                    "W.T Admisi", "Rata W.T Admisi", "W.L Admisi", "Rata W.L Admisi", "W.T Poli", "Rata W.T Poli",
                    "W.L Poli", "Rata W.L Poli", "W.T Farmasi", "Rata W.T Farmasi", "W.L Farmasi",
    ...
    private void initComponents() {
        ...
        Tanggal.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        Tanggal.setMaximumRowCount(12);
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12" }));
        Tanggal.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Tanggal.setName("Tanggal"); // NOI18N
        Tanggal.setPreferredSize(new java.awt.Dimension(70, 25));
        panelGlass6.add(Tanggal);

        Tahun.setEditable(true);
        Tahun.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        Tahun.setMaximumRowCount(12);
        Tahun.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030" }));
        Tahun.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Tahun.setName("Tahun"); // NOI18N
        Tahun.setPreferredSize(new java.awt.Dimension(70, 25));
        panelGlass6.add(Tahun);

        Waktu.setEditable(true);
        Waktu.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        Waktu.setMaximumRowCount(2);
        Waktu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "rs", "server" }));
        Waktu.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Waktu.setName("Waktu"); // NOI18N
        Waktu.setPreferredSize(new java.awt.Dimension(70, 25));
        panelGlass6.add(Waktu);
...
//            Valid.pindah(evt,Poli,BtnPrint);
    ...
    public void tampil() {
        try {
            ...
            URL = link + "/dashboard/waktutunggu/bulan/" + Tanggal.getSelectedItem() + "/tahun/"
                    + Tahun.getSelectedItem() + "/waktu/" + Waktu.getSelectedItem() + "";
            ...
            if (nameNode.path("code").asText().equals("200") || nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        ...
                        tabMode.addRow(new Object[]{i + ".", list.path("kdppk").asText(), list.path("nmppk").asText(),
                            list.path("kodepoli").asText(), list.path("namapoli").asText(),
                            list.path("tanggal").asText(), list.path("jumlah_antrean").asText(),
    ...
    private static final Logger LOG = Logger.getLogger(BPJSDashboardPerBulan.class.getName());
