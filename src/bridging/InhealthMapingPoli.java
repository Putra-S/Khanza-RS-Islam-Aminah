...
public class InhealthMapingPoli extends javax.swing.JDialog {
    ...
    public InhealthMapingPoli(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Unit RS", "Nama Unit RS", "Kode Unit Inhealth", "Nama Unit Inhealth"}) {
            @Override
            ...
            public void windowClosed(WindowEvent e) {
                if (poliinhealth.getTable().getSelectedRow() != -1) {
                    KdPoliInhealth.setText(
                            poliinhealth.getTable().getValueAt(poliinhealth.getTable().getSelectedRow(), 1).toString());
                    NmPoliInhealth.setText(
                            poliinhealth.getTable().getValueAt(poliinhealth.getTable().getSelectedRow(), 2).toString());
...
private void btnPoliInhealthActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliInhealthActionPerformed
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kd_poli_rs"), rs.getString("nm_poli"),
                        rs.getString("kd_poli_inhealth"), rs.getString("nm_poli_inhealth")});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(InhealthMapingPoli.class.getName());
