 ...
 * @author dosen
 */
public class InhealthMapingPoli extends javax.swing.JDialog {
    ...
    private InhealthCekReferensiPoli poliinhealth = new InhealthCekReferensiPoli(
            null, false);
    ...
    public InhealthMapingPoli(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Unit RS", "Nama Unit RS",
                    "Kode Unit Inhealth", "Nama Unit Inhealth"}) {
            @Override
        ...
        KdPoliInhealth.setDocument(new batasInput((byte) 15).getKata(
                KdPoliInhealth));
            ...
            public void windowClosed(WindowEvent e) {
                if (poliinhealth.getTable().getSelectedRow() != -1) {
                    KdPoliInhealth.setText(
                            poliinhealth.getTable().getValueAt(poliinhealth.
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdpoli.getText().trim().isEmpty() || TPoli.getText().trim().
                isEmpty()) {
            Valid.textKosong(kdpoli, "Unit RS");
        } else if (KdPoliInhealth.getText().trim().isEmpty() || NmPoliInhealth.
                getText().trim().isEmpty()) {
            Valid.textKosong(KdPoliInhealth, "Unit Inhealth");
        } else {
            if (Sequel.menyimpantf("inhealth_maping_poli", "?,?,?",
                    "Mapping Unit", 3, new String[]{
                        kdpoli.getText(), KdPoliInhealth.getText(),
                        NmPoliInhealth.getText()
                    }) == true) {
                tampil();
                emptTeks();
            }
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, btnPoliInhealth, BtnBatal);
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdpoli.getText().trim().isEmpty() || TPoli.getText().trim().
            ...
            if (tbJnsPerawatan.getSelectedRow() > -1) {
                if (Sequel.mengedittf("inhealth_maping_poli", "kd_poli_rs=?",
                        "kd_poli_rs=?,kd_poli_inhealth=?,nm_poli_inhealth=?", 4,
                        new String[]{
                            kdpoli.getText(), KdPoliInhealth.getText(),
                            NmPoliInhealth.getText(), tbJnsPerawatan.getValueAt(
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptMapingPoliInhealth.jasper", "report",
                    "::[ Mapping Unit RS & Inhealth ]::", param);
        }
...
private void btnPoliInhealthActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliInhealthActionPerformed
    poliinhealth.setSize(internalFrame1.getWidth() - 20, internalFrame1.
            getHeight() - 20);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InhealthMapingPoli dialog = new InhealthMapingPoli(
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kd_poli_rs"), rs.
                        getString("nm_poli"),
                        rs.getString("kd_poli_inhealth"), rs.getString(
                        "nm_poli_inhealth")});
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if (tbJnsPerawatan.getSelectedRow() != -1) {
            kdpoli.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 0).toString());
            TPoli.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 1).toString());
            KdPoliInhealth.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 2).toString());
            NmPoliInhealth.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
    ...
    private static final Logger LOG = Logger.getLogger(InhealthMapingPoli.class.
            getName());
