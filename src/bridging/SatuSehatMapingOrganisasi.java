...
public class SatuSehatMapingOrganisasi extends javax.swing.JDialog {
    ...
    public SatuSehatMapingOrganisasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Departemen", "Nama Departemen", "ID Organisasi Satu Sehat"}) {
            @Override
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("dep_id"), rs.getString("nama"),
    ...
    private static final Logger LOG = Logger.getLogger(SatuSehatMapingOrganisasi.class.getName());
