...
public class SatuSehatIHSPraktisi extends javax.swing.JDialog {
    ...
    public SatuSehatIHSPraktisi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"P", "Kode Praktisi", "Nama Praktisi",
                    "NIK Praktisi", "IHS Praktisi"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatIHSPraktisi dialog = new SatuSehatIHSPraktisi(
	...
	private void tampil() {
        ...
        try {
            ps = koneksi
                    .prepareStatement(
                            "SELECT pegawai.nik,pegawai.nama,satu_sehat_ihs_praktisi.ihsnumber,pegawai.no_ktp "
            ...
            try {
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString("nik"), rs.
                        getString("nama"),
    ...
    private static final Logger LOG = Logger.getLogger(
            SatuSehatIHSPraktisi.class.getName());
