...
public class BPJSCekReferensiDokterKontrol extends javax.swing.JDialog {
    ...
    public BPJSCekReferensiDokterKontrol(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"No.", "Kode Dokter", "Nama Dokter", "Jadwal Praktek", "Kapasitas"}) {
            @Override
    ...
    public void tampil() {
        try {
            ...
            root = mapper.readTree(api.getRest()
                    .exchange(
                            URL + "/" + JenisKontrol.getText().substring(0, 1) + "/KdPoli/" + Poli.getText()
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kodeDokter").asText().toLowerCase().contains(Dokter.getText().toLowerCase())
                            ...
                            tabMode.addRow(new Object[]{i + ".", list.path("kodeDokter").asText(),
                                list.path("namaDokter").asText(), list.path("jadwalPraktek").asText(),
    ...
    private static final Logger LOG = Logger.getLogger(BPJSCekReferensiDokterKontrol.class.getName());
