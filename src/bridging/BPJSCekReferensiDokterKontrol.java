 ...
 * @author dosen
 */
public class BPJSCekReferensiDokterKontrol extends javax.swing.JDialog {
    ...
    public BPJSCekReferensiDokterKontrol(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"No.", "Kode Dokter", "Nama Dokter",
                    "Jadwal Praktek", "Kapasitas"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiDokterKontrol dialog = new BPJSCekReferensiDokterKontrol(
    ...
    public void tampil() {
        try {
            ...
            root = mapper.readTree(api.getRest()
                    .exchange(
                            URL + "/" + JenisKontrol.getText().substring(0, 1) + "/KdPoli/" + Poli.
                            getText()
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kodeDokter").asText().toLowerCase().
                                contains(Dokter.getText().toLowerCase())
                                || list.path("namaDokter")
                                        .asText()
                                        .toLowerCase()
                                        .contains(Dokter.getText().toLowerCase())) {
                            tabMode.addRow(new Object[]{i + ".", list.path(
                                "kodeDokter").asText(),
                                list.path("namaDokter").asText(), list.path(
                                "jadwalPraktek").asText(),
    ...
    public void SetKontrol(String kodepoli, String jeniskontrol,
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSCekReferensiDokterKontrol.class.getName());
