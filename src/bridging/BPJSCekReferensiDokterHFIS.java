 ...
 * @author dosen
 */
public class BPJSCekReferensiDokterHFIS extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariBPJSReferensiDokterHFIS.jasper", "report",
                    "[ Pencarian Referensi Dokter HFIS ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiDokterHFIS dialog = new BPJSCekReferensiDokterHFIS(
            ...
            if (nameNode.path("code").asText().equals("1")) {
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        if (list.path("namadokter").asText().toLowerCase().
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSCekReferensiDokterHFIS.class.getName());
