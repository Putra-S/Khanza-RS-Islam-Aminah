...
public class InhealthMapingDokter extends javax.swing.JDialog {
    ...
    public InhealthMapingDokter(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Kode Dokter RS", "Nama Dokter RS", "Kode Inhealth"}) {
            @Override
    ...
    private static final Logger LOG = Logger.getLogger(InhealthMapingDokter.class.getName());
