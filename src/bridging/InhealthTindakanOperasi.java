 ...
 * @author dosen
 */
public class InhealthTindakanOperasi extends javax.swing.JDialog {
    ...
    private DlgJnsPerawatanOperasi barang = new DlgJnsPerawatanOperasi(null,
            false);
    ...
    public InhealthTindakanOperasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode RS", "Nama Tindakan Operasi", "Tarif",
                    "Kode Inhealth"}) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdtindakan.getText().trim().isEmpty() || TTindakan.getText().trim().
            ...
            if (Sequel.menyimpantf("inhealth_tindakan_operasi", "?,?",
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode, kdtindakan, "inhealth_tindakan_operasi",
                "kode_paket");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdtindakan.getText().trim().isEmpty() || TTindakan.getText().trim().
            ...
            if (tbJnsPerawatan.getSelectedRow() > -1) {
                if (Sequel.mengedittf("inhealth_tindakan_operasi",
                        "kode_paket=?", "kode_paket=?,kd_inhealth=?", 3,
                        new String[]{
                            kdtindakan.getText(), KdTindakanInhealth.getText(),
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptMapingTindakanInhealthOperasi.jasper", "report",
                    "::[ Mapping Tarif Operasi Inhealth ]::", param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InhealthTindakanOperasi dialog = new InhealthTindakanOperasi(
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kode_paket"), rs.
    ...
    private static final Logger LOG = Logger.getLogger(
            InhealthTindakanOperasi.class.getName());
