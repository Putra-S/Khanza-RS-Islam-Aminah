 ...
 * @author perpustakaan
 */
public class ReklasifikasiRalan extends javax.swing.JDialog {
    ...
    private double all = 0, Laborat = 0, Radiologi = 0, Obat = 0, Ralan_Dokter = 0, Ralan_Dokter_paramedis = 0,
            ...
            ttlRegistrasi = 0, untungrugiinacbg = 0, Operasi = 0, ttlOperasi = 0, kebidanan = 0, operasi2 = 0,
            tarifincabg = 0, ttltarifincabg = 0, ttluntungrugiinacbg = 0, ttlkebidanan = 0;
            ...
            for (int r = 0; r < tabMode.getRowCount(); r++) {
                Sequel.menyimpan("temporary2", "'" + r + "','"
                        ...
                        + tabMode.getValueAt(r, 91).toString().replaceAll("'",
                                "`") + "','"
                        + tabMode.getValueAt(r, 92).toString().replaceAll("'",
                                "`") + "','','','','','','','','" + akses.
                                getalamatip() + "'", "data");
            }
...
private void BtnCari1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCari1KeyPressed
    ...
    private void MnBillingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBillingActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.cariInteger(
                    "select count(no_rawat) from piutang_pasien where no_rawat=?",
    ...
    public void tampil() {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    status = "Sembuh";
                    if (Sequel.cariInteger("select count(no_rawat) from rujuk where no_rawat=?",
                            rs.getString("no_rawat")) > 0) {
                        status = "Dirujuk";
                    } else if (Sequel.cariInteger("select count(no_rkm_medis) from pasien_mati where no_rkm_medis=?",
                    ...
                    pspenyakit = koneksi.prepareStatement("select kd_penyakit,prioritas from diagnosa_pasien where "
                    ...
                    try {
                        ...
                        tarifincabg = Sequel.cariIsiAngka(
                                ...
                                + Sequel.cariIsiAngka(
                                        ...
                                        rs.getString("no_rawat"));
                        if (tarifincabg > 0) {
                            untungrugiinacbg = tarifincabg - (Operasi + Laborat + Radiologi + Obat + Ralan_Dokter
                                    + Ralan_Dokter_paramedis + Ralan_Paramedis + Tambahan + Potongan + Registrasi);
                        } else {
                            untungrugiinacbg = 0;
                        }
                    ...
                    tabMode.addRow(new Object[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        rs.getString("png_jawab"), rs.getString("tgl_registrasi") + " " + rs.getString("jam_reg"),
                        rs.getString("tanggal") + " " + rs.getString("jam"), "1", rs.getString("jk"),
                        rs.getString("tgl_lahir"), "RJ", "Reguler", status, du, ds1, ds2, ds3, ds4, ds5, ds6, ds7,
                        ds8, ds9, ds10, ds11, ds12, ds13, ds14, ds15, ds16, ds17, ds18, ds19, ds20, ds21, ds22,
                        ds23, ds24, ds25, ds26, ds27, ds28, ds29, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12,
                        ...
                        rs.getString("no_rawat")),
                        Valid.SetAngka(Operasi + Laborat + Radiologi + Obat + Ralan_Dokter + Ralan_Dokter_paramedis
                        + Ralan_Paramedis + Tambahan + Potongan + Registrasi),
                        Valid.SetAngka(kebidanan), Valid.SetAngka(operasi2),
                        Valid.SetAngka(Ralan_Dokter + Ralan_Dokter_paramedis), 0, Valid.SetAngka(Ralan_Paramedis),
                        Valid.SetAngka(Tambahan + Registrasi), 0, Valid.SetAngka(Laborat), 0,
                        Valid.SetAngka(Radiologi), 0, 0, 0, Valid.SetAngka(Obat), 0, 0, 0, Valid.SetAngka(Potongan),
            ...
            if (all > 0) {
                tabMode.addRow(new Object[]{"Total", ":", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                    ...
                    Valid.SetAngka(ttlObat), "", "", "", Valid.SetAngka(ttlPotongan),
    ...
    private static final Logger LOG = Logger.getLogger(ReklasifikasiRalan.class.getName());
