...
public class CoronaReferensiKewarganegaraan extends javax.swing.JDialog {
    ...
    public void tampil() {
        try {
            ...
            root = mapper.readTree(api.getRest()
                    .exchange(link + "/Referensi/kewarganegaraan", HttpMethod.GET, requestEntity, String.class)
                    .getBody());
            ...
            if (response.isArray()) {
                for (JsonNode list : response) {
                    if (list.path("nationality").asText().toLowerCase().contains(TCari.getText().toLowerCase())) {
                        tabMode.addRow(
                                new Object[]{list.path("id_nation").asText(), list.path("nationality").asText()});
                    }
                }
            }
    ...
    private static final Logger LOG = Logger.getLogger(CoronaReferensiKewarganegaraan.class.getName());
