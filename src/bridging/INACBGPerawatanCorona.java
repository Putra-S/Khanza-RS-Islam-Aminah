...
public class INACBGPerawatanCorona extends javax.swing.JDialog {
    ...
    public INACBGPerawatanCorona(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Masuk", "Pemulasaran Jenazah",
                    "Kantong Jenazah", "Peti Jenazah", "Plastik Erat", "Desinfektan Jenazah", "Mobil Jenazah",
                    "Desinfektan Mobil Jenazah", "Status Covid", "No.Jaminan/KTP/JKN", "Episode 1", "Episode 2",
                    "Episode 3", "Episode 4", "Episode 5", "Episode 6", "Comorbid"}) {
            @Override
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        rs.getString("nm_pasien"), rs.getString("tgl_registrasi"),
                        rs.getString("pemulasaraan_jenazah"), rs.getString("kantong_jenazah"),
                        rs.getString("peti_jenazah"), rs.getString("plastik_erat"),
                        rs.getString("desinfektan_jenazah"), rs.getString("mobil_jenazah"),
                        rs.getString("desinfektan_mobil_jenazah"), rs.getString("covid19_status_cd"),
                        rs.getString("nomor_kartu_t"), rs.getString("episodes1"), rs.getString("episodes2"),
                        rs.getString("episodes3"), rs.getString("episodes4"), rs.getString("episodes5"),
    ...
    private static final Logger LOG = Logger.getLogger(INACBGPerawatanCorona.class.getName());
