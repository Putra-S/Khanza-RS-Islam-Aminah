...
public class INACBGPerawatanCorona extends javax.swing.JDialog {
    ...
    public INACBGPerawatanCorona(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "Tgl.Masuk",
                    "Pemulasaran Jenazah",
                    "Kantong Jenazah", "Peti Jenazah", "Plastik Erat",
                    "Desinfektan Jenazah", "Mobil Jenazah",
                    "Desinfektan Mobil Jenazah", "Status Covid",
                    "No.Jaminan/KTP/JKN", "Episode 1", "Episode 2",
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (NoJaminan.getText().trim().isEmpty()) {
            Valid.textKosong(NoJaminan, "No.Jaminan");
        } else if (Episodes1.getText().trim().isEmpty()) {
            Valid.textKosong(Episodes1, "Jumlah Hari");
        } else if (Episodes2.getText().trim().isEmpty()) {
            Valid.textKosong(Episodes2, "Jumlah Hari");
        } else if (Episodes3.getText().trim().isEmpty()) {
            Valid.textKosong(Episodes3, "Jumlah Hari");
        } else if (Episodes4.getText().trim().isEmpty()) {
            Valid.textKosong(Episodes4, "Jumlah Hari");
        } else if (Episodes5.getText().trim().isEmpty()) {
            Valid.textKosong(Episodes5, "Jumlah Hari");
        } else if (Episodes6.getText().trim().isEmpty()) {
            Valid.textKosong(Episodes6, "Jumlah Hari");
        } else {
            if (Sequel.menyimpantf("perawatan_corona",
                    "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 17,
                    new String[]{
                        NoRawat.getText(), PemulasaranJenazah.getSelectedItem().
                        toString(), KantongJenazah.getSelectedItem().toString(),
                        PetiJenazah.getSelectedItem().toString(),
                        PlastikErat.getSelectedItem().toString(),
                        DesinfektanJenazah.getSelectedItem().toString(),
                        MobilJenazah.getSelectedItem().toString(),
                        DesinFektanMobilJenazah.getSelectedItem().toString(),
                        StatusCovid.getSelectedItem().toString(), NoJaminan.
                        getText(), Episodes1.getText(),
                        Episodes2.getText(), Episodes3.getText(), Episodes4.
                        getText(), Episodes5.getText(), Episodes6.getText(),
                        Comorbid.getSelectedItem().toString()
                    }) == true) {
                emptTeks();
                tampil();
            }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            Sequel.meghapus("perawatan_corona", "no_rawat", tbObat.getValueAt(
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptPerawatanCorona.jasper", "report",
                    "::[ Kebutuhan Perawatan Pasien Corona Untuk Penagihan INACBG ]::",
                    ...
                    + "reg_periksa.tgl_registrasi between '" + Valid.SetTgl(
                            DTPCari1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(DTPCari2.getSelectedItem() + "") + "' "
                    + (TCari.getText().trim().isEmpty() ? "" : "and (reg_periksa.no_rawat like '%" + TCari.
                    getText().trim() + "%' or reg_periksa.no_rkm_medis like '%" + TCari.
                            getText().trim() + "%' "
                    + "or pasien.nm_pasien like '%" + TCari.getText().trim() + "%' or perawatan_corona.covid19_status_cd like '%" + TCari.
                    getText().trim() + "%' or "
                    + "perawatan_corona.nomor_kartu_t like '%" + TCari.getText().
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (NoRM.getText().trim().isEmpty() || NamaPasien.getText().trim().
            ...
            if (tbObat.getSelectedRow() > -1) {
                if (Sequel.mengedittf("perawatan_corona", "no_rawat=?",
                        "no_rawat=?,pemulasaraan_jenazah=?,kantong_jenazah=?,peti_jenazah=?,plastik_erat=?,desinfektan_jenazah=?,mobil_jenazah=?,desinfektan_mobil_jenazah=?,covid19_status_cd=?,nomor_kartu_t=?,episodes1=?,episodes2=?,episodes3=?,episodes4=?,episodes5=?,episodes6=?,covid19_cc_ind=?",
                        18, new String[]{
                            NoRawat.getText(), PemulasaranJenazah.
                            getSelectedItem().toString(), KantongJenazah.
                                    getSelectedItem().toString(), PetiJenazah.
    ...
    private void MnKartuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKartuActionPerformed
        if (NoRM.getText().trim().isEmpty() || NamaPasien.getText().trim().
            ...
            Sequel.cariIsi("select no_peserta from pasien where no_rkm_medis=?",
                    NoJaminan, NoRM.getText());
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            INACBGPerawatanCorona dialog = new INACBGPerawatanCorona(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_rawat"), rs.
                        ...
                        rs.getString("pemulasaraan_jenazah"), rs.getString(
                        "kantong_jenazah"),
                        rs.getString("peti_jenazah"), rs.getString(
                        "plastik_erat"),
                        rs.getString("desinfektan_jenazah"), rs.getString(
                        "mobil_jenazah"),
                        rs.getString("desinfektan_mobil_jenazah"), rs.getString(
                        "covid19_status_cd"),
                        rs.getString("nomor_kartu_t"), rs.getString("episodes1"),
                        rs.getString("episodes2"),
                        rs.getString("episodes3"), rs.getString("episodes4"),
                        rs.getString("episodes5"),
                        rs.getString("episodes6"), rs.
                        getString("covid19_cc_ind")});
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            NamaPasien.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 2).
                    toString());
            PemulasaranJenazah.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 4).toString());
            KantongJenazah.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 5).toString());
            PetiJenazah.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 6).toString());
            PlastikErat.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 7).toString());
            DesinfektanJenazah.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 8).toString());
            MobilJenazah.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 9).toString());
            DesinFektanMobilJenazah.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 10).toString());
            StatusCovid.setSelectedItem(tbObat.getValueAt(tbObat.
                    getSelectedRow(), 11).toString());
            NoJaminan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 12).
                    toString());
            Episodes1.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 13).
                    toString());
            Episodes2.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 14).
                    toString());
            Episodes3.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 15).
                    toString());
            Episodes4.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 16).
                    toString());
            Episodes5.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 17).
                    toString());
            Episodes6.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 18).
                    toString());
            Comorbid.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),
                    19).toString());
        }
    }
    ...
    public void setPasien(String norawat, String norm, String namapasien) {
        ...
        Sequel.cariIsi(
                ...
                NoJaminan, norm);
        Sequel.cariIsi(
                "select reg_periksa.tgl_registrasi from reg_periksa where reg_periksa.no_rawat='" + norawat + "'",
                DTPCari1);
    ...
    private static final Logger LOG = Logger.getLogger(
            INACBGPerawatanCorona.class.getName());
