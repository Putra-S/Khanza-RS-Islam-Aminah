...
public class BPJSDataFingerPasien extends javax.swing.JDialog {
    ...
    public BPJSDataFingerPasien(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No", "No.Kartu", "Nama", "Tgl.SEP", "Jns.Pelayanan",
            "Persetujuan", "Status"};
...
//GEN-LAST:event_btnPasienKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSDataFingerPasien dialog = new BPJSDataFingerPasien(
  ...
  // End of variables declaration//GEN-END:variables
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        tabMode
                                .addRow(new Object[]{i + "", list.path("kode").
                            asText(), list.path("status").asText()});
                        i++;
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSDataFingerPasien.class.getName());
