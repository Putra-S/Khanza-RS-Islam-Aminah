 ...
 * @author dosen
 */
public class BPJSDataFingerPasien extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public BPJSDataFingerPasien(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row = {"No", "No.Kartu", "Nama", "Tgl.SEP", "Jns.Pelayanan", "Persetujuan", "Status"};
...
//GEN-BEGIN:initComponents
    ...
    DTPTanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-01-2024" }));
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("peserta", "Tanggal : " + Valid.SetTgl(DTPTanggal.
                    getSelectedItem() + ""));
            param.put("kontakrs", akses.getkontakrs());
            param.put("emailrs", akses.getemailrs());
            param.put("logo", Sequel.cariGambar(
                    "select setting.logo from setting"));
            Valid.MyReportqry("rptCariBPJSDataFingerPrint.jasper", "report",
                    "[ Data Pasien Finger Print ]",
    ...
    private void NoKartuKeyPressed(java.awt.event.KeyEvent evt) {
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                BtnCariActionPerformed(null);//GEN-FIRST:event_NoKartuKeyPressed
    ...
    private void btnPasienActionPerformed(java.awt.event.ActionEvent evt) {
        pasien.emptTeks();
            pasien.isCek();//GEN-FIRST:event_btnPasienActionPerformed
...
//GEN-FIRST:event_btnPasienKeyPressed
    /**
  		 * @param args the command line arguments//GEN-LAST:event_btnPasienKeyPressed
		 */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSDataFingerPasien dialog = new BPJSDataFingerPasien(new javax.swing.JFrame(), true);
  ...
  // End of variables declaration//GEN-END:variables
    ...
    public void tampil() {
        try {
            ...
            URL = link + "/SEP/FingerPrint/Peserta/" + NoKartu.getText() + "/TglPelayanan/"
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        tabMode
                                .addRow(new Object[]{i + "", list.path("kode").asText(), list.path("status").asText()});
                        i++;
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(BPJSDataFingerPasien.class.getName());
