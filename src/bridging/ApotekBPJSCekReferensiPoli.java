...
public class ApotekBPJSCekReferensiPoli extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariBPJSReferensiPoliApotek.jasper", "report",
                    "[ Pencarian Referensi Poli Apotek BPJS ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ApotekBPJSCekReferensiPoli dialog = new ApotekBPJSCekReferensiPoli(
    ...
    private static final Logger LOG = Logger.getLogger(
            ApotekBPJSCekReferensiPoli.class.getName());
