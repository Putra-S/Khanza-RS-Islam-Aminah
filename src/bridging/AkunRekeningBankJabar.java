...
public class AkunRekeningBankJabar extends javax.swing.JDialog {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdrek.getText().trim().isEmpty() || nmrek.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                ...
                if (Sequel.menyimpantf("set_akun_bankjabar", "?,?",
                        "Akun Rekening", 2, new String[]{
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdrek.getText().trim().isEmpty() || nmrek.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("set_akun_bankjabar", "?,?", "Akun Rekening",
                    2, new String[]{
                        kdrek.getText(), TKd.getText()
                    }) == true) {
                tampil();
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi
                    .prepareStatement("select set_akun_bankjabar.kd_rek,rekening.nm_rek,set_akun_bankjabar.kode_bank "
    ...
    private static final Logger LOG = Logger.getLogger(AkunRekeningBankJabar.class.getName());
