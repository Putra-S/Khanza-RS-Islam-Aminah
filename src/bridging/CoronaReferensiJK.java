 ...
 * @author dosen
 */
public class CoronaReferensiJK extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            CoronaReferensiJK dialog = new CoronaReferensiJK(
    ...
    public void tampil() {
        try {
            ...
            root = mapper.readTree(api.getRest()
                    .exchange(link + "/Referensi/gender", HttpMethod.GET,
            ...
            if (response.isArray()) {
                for (JsonNode list : response) {
                    tabMode.addRow(new Object[]{list.path("id_gender").asText(),
                        list.path("gender").asText()});
                }
            }
    ...
    private static final Logger LOG = Logger.getLogger(CoronaReferensiJK.class.
            getName());
