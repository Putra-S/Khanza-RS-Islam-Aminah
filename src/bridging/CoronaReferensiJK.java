...
public class CoronaReferensiJK extends javax.swing.JDialog {
    ...
    public void tampil() {
        try {
            ...
            root = mapper.readTree(api.getRest()
                    .exchange(link + "/Referensi/gender", HttpMethod.GET, requestEntity, String.class)
                    .getBody());
            Valid.tabelKosong(tabMode);
            response = root.path("jenis_kelamin");
            if (response.isArray()) {
                for (JsonNode list : response) {
                    tabMode.addRow(new Object[]{list.path("id_gender").asText(), list.path("gender").asText()});
                }
            }
    ...
    private static final Logger LOG = Logger.getLogger(CoronaReferensiJK.class.getName());
