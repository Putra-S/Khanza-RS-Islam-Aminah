...
public class BPJSCekReferensiSpesialistikKontrol extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public BPJSCekReferensiSpesialistikKontrol(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"No.", "Kode Poli", "Nama Poli", "Kapasitas",
                    "Jml.Rencana", "Persentase"}) {
            @Override
    ...
    public void tampil() {
        try {
            ...
            System.out.println(URL + "/" + JenisKontrol.getText().
                    substring(0, 1) + "/nomor/" + Nomor.getText()
                    + "/TglRencanaKontrol/" + TanggalKontrol.getText());
            root = mapper.readTree(api.getRest()
                    .exchange(
                            URL + "/" + JenisKontrol.getText().substring(0, 1) + "/nomor/" + Nomor.
                            getText()
                            + "/TglRencanaKontrol/" + TanggalKontrol.getText(),
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kodePoli").asText().toLowerCase().
                            ...
                            tabMode.addRow(new Object[]{i + ".", list.path(
                                ...
                                "kapasitas").asText(),
                                list.path("jmlRencanaKontroldanRujukan").
                                asText(),
     ...
     */
    public void SetKontrol(String nomor, String jeniskontrol,
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSCekReferensiSpesialistikKontrol.class.getName());
