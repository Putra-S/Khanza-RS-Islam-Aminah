...
public class ApotekBPJSDaftarPelayananObat extends javax.swing.JDialog {
    ...
    public ApotekBPJSDaftarPelayananObat(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"No.SEP Apotek", "No.SEP Asal", "No.Resep", "No.Kartu", "Nama Peserta", "Kode Jenis",
                    "Jenis Obat", "Tgl.Pelayanan", "Kode Obat", "Nama Obat", "Tipe Obat", "Signa 1", "Signa 2",
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (response.path("detailsep").path("listobat").isArray()) {
                    for (JsonNode list : response.path("detailsep").path("listobat")) {
                        tabMode.addRow(new Object[]{list.path("kodeobat").asText(), list.path("namaobat").asText(),
                            list.path("prb").asText(), list.path("kronis").asText(), list.path("kemo").asText(),
    ...
    public void bodyWithDeleteRequest() throws Exception {
        ...
        try {
            ...
            requestJson = "{\"nosepapotek\":\"" + tbKamar.getValueAt(tbKamar.getSelectedRow(), 0).toString()
    ...
    private static final Logger LOG = Logger.getLogger(ApotekBPJSDaftarPelayananObat.class.getName());
