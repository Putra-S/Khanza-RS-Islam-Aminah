...
public class MobileJKNPembatalanPendaftaran extends javax.swing.JDialog {
    ...
    public MobileJKNPembatalanPendaftaran(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.RM", "Nama Pasien", "No.Rawat Batal",
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("no_rkm_medis"), rs.getString("nm_pasien"),
                        rs.getString("no_rawat_batal"), rs.getString("nomorreferensi"),
                        rs.getString("tanggalbatal"), rs.getString("keterangan"), rs.getString("statuskirim")});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(MobileJKNPembatalanPendaftaran.class.getName());
