 ...
 * @author dosen
 */
public class PCareCekFaskesAlihRawat extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariPCAREFaskesAlihRawat.jasper", "report",
                    "[ Pencarian Referensi Rujukan Alih Rawat ]",
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        ...
        if (NoKartu.getText().trim().isEmpty()) {
            ...
            tampil(Khusus.getSelectedItem().toString().substring(0, 3), NoKartu.
                    getText(), Tanggal.getSelectedItem().toString());
        }
        this.setCursor(Cursor.getDefaultCursor());
    ...
    public void tampil(String kode, String nokartu, String tanggal) {
        try {
            ...
            root = mapper.readTree(api.getRest()
                    .exchange(URL + kode + "/noKartu/" + nokartu + "/tglEstRujuk/" + tanggal, HttpMethod.GET, requestEntity,
                            String.class)
                    .getBody());
    ...
    private static final Logger LOG = Logger.getLogger(PCareCekFaskesAlihRawat.class.getName());
