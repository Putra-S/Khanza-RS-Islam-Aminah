...
public class SatuSehatIHSPasien extends javax.swing.JDialog {
    ...
    public SatuSehatIHSPasien(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"P", "No Rkm Medis", "Nama Pasien", "NIK Pasien",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatIHSPasien dialog = new SatuSehatIHSPasien(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString(
                        ...
                        rs.getString("no_ktp"), rs.getString("ihsnumber"), rs.getString("tgl_lahir"), rs.getString("jk")});
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
            } finally {
    ...
    private static final Logger LOG = Logger.getLogger(SatuSehatIHSPasien.class.
            getName());
