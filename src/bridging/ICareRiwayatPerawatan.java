...
public class ICareRiwayatPerawatan extends javax.swing.JDialog {
    ...
    public void tampil() {
        try {
            ...
            String requestJsonResponse = mapper.writeValueAsString(
                    api.getRest().exchange(validateUrl, HttpMethod.POST, requestEntity, Object.class).getBody());
    ...
    private static final Logger LOG = Logger.getLogger(ICareRiwayatPerawatan.class.getName());
