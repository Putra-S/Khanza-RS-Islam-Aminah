...
public class ICareRiwayatPerawatan extends javax.swing.JDialog {
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        ...
        } else if (KdDPJPLayanan.getText().isEmpty()) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ICareRiwayatPerawatan dialog = new ICareRiwayatPerawatan(
    ...
    public void tampil() {
        try {
            ...
            // requestJson=
            // mapper.writeValueAsString(api.getRest().exchange(link+"/validate",
            // HttpMethod.POST, requestEntity,Object.class).getBody());
            ...
            requestJson = "{\"param\": \"" + NoKartu.getText().trim() + "\",\"kodedokter\": "
                    + KdDPJPLayanan.getText().trim() + "}";
            System.out.println("JSON : " + requestJson + "\n");

            requestEntity = new HttpEntity<>(requestJson, headers);
            String validateUrl = link + "/validate"; // Store the URL in a local variable
            System.out.println("URL:" + validateUrl);
            String requestJsonResponse = mapper.writeValueAsString(
                    api.getRest().exchange(validateUrl, HttpMethod.POST,
    ...
    // Number> observableValue, Number oldValue, final Number newValue) -> {
    // SwingUtilities.invokeLater(() -> {
    // progressBar.setValue(newValue.intValue());
    // });
    // });
    //
    // engine.getLoadWorker().exceptionProperty().addListener((ObservableValue<? extends
    ...
    //
    //
    // engine.locationProperty().addListener((ObservableValue<? extends String> ov, String
    ...
    private void createScene() {
        Platform.runLater(() -> {
            ...
            engine.setOnStatusChanged(event -> lblStatus.
                    setText(event.getData()));

            engine.getLoadWorker()
                    .workDoneProperty()
                    .addListener(
                            (observable, oldValue, newValue) -> progressBar.
            ...
            engine.getLoadWorker().exceptionProperty().addListener(
                    (observable, old, value) -> {
                        if (engine.getLoadWorker().getState() == FAILED) {
                            ...
                            showMessageDialog(PanelContent,
            ...
            engine.locationProperty().addListener(
                    (observable, oldValue, newValue) -> txtURL.setText(newValue));

            engine.getLoadWorker().stateProperty().addListener(
                    (observable, oldState, newState) -> {
                        if (newState == State.SUCCEEDED) {
                            try {
                                System.out.println("URL : " + engine.
                                        getLocation());
                            } catch (Exception ex) {
                                System.out.println("Notifikasi : " + ex);
                            }
    ...
    private static final Logger LOG = Logger.getLogger(
            ICareRiwayatPerawatan.class.getName());
