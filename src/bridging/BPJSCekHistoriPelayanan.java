 ...
 * @author dosen
 */
public class BPJSCekHistoriPelayanan extends javax.swing.JDialog {
    ...
    public BPJSCekHistoriPelayanan(java.awt.Frame parent, boolean modal) {
        ...
        cal.set(cal.get(Calendar.YEAR), cal.get(Calendar.MONTH) - 2, 1); // to get
        // previous
        // year add -1
    ...
    private static final Logger LOG = Logger.getLogger(BPJSCekHistoriPelayanan.class.getName());
