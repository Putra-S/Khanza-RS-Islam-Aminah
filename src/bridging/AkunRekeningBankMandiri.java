...
public class AkunRekeningBankMandiri extends javax.swing.JDialog {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdrek.getText().trim().isEmpty() || nmrek.getText().trim().isEmpty()) {
        ...
        } else if (KdRekBiaya.getText().trim().isEmpty() || NmRekBiaya.getText().
                trim().isEmpty()) {
        ...
        } else if (ClientID.getText().trim().isEmpty()) {
            Valid.textKosong(ClientID, "Client ID");
        } else if (ClientSecret.getText().trim().isEmpty()) {
            Valid.textKosong(ClientSecret, "Client Password");
        } else if (KodeFaskes.getText().trim().isEmpty()) {
            Valid.textKosong(KodeFaskes, "Kode Faskes");
        } else if (KodeMCM.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                ...
                if (Sequel.menyimpantf("set_akun_mandiri",
                        "?,?,aes_encrypt(?,'nur'),aes_encrypt(?,'windi'),aes_encrypt(?,'nur'),aes_encrypt(?,'windi'),?,?,?",
                        "Akun Rekening", 9, new String[]{
                            kdrek.getText(), KdRekBiaya.getText(), Username.
                            getText(), Password.getText(), ClientID.getText(),
                            ClientSecret.getText(), KodeFaskes.getText(),
                            KodeMCM.getText(), NoRekening.getText()
                        }) == true) {
                    tampil();
                    emptTeks();
                }
        ...
        if (kdrek.getText().trim().isEmpty() || nmrek.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("set_akun_mandiri",
                    ...
                    "Akun Rekening", 9, new String[]{
                        kdrek.getText(), KdRekBiaya.getText(), Username.
                        getText(), Password.getText(), ClientID.getText(),
                        ClientSecret.getText(), KodeFaskes.getText(), KodeMCM.
                        getText(), NoRekening.getText()
                    }) == true) {
                tampil();
                emptTeks();
            }
