...
public class PilihanBridgingAsuransi extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PilihanBridgingAsuransi dialog = new PilihanBridgingAsuransi(
    ...
    public void isCek() {
        ...
        btnCekBPJSRujukanKartuPCare.setEnabled(akses.
                getbpjs_cek_rujukan_kartu_pcare());
        btnCekBPJSRujukanKartuRS.
                setEnabled(akses.getbpjs_cek_rujukan_kartu_rs());
        btnCekEligibilitasInhealth.setEnabled(akses.
                getinhealth_cek_eligibilitas());
        btnPCarePendaftaran.setEnabled(akses.getbridging_pcare_daftar());
    }

    private static final Logger LOG = Logger.getLogger(
            PilihanBridgingAsuransi.class.getName());
