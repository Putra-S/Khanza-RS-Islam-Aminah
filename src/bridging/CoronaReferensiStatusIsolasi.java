 ...
 * @author dosen
 */
public class CoronaReferensiStatusIsolasi extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            CoronaReferensiStatusIsolasi dialog = new CoronaReferensiStatusIsolasi(
    ...
    public void tampil() {
        try {
            ...
            root = mapper.readTree(api.getRest()
                    .exchange(link + "/Referensi/status_isolasi", HttpMethod.GET,
            ...
            if (response.isArray()) {
                for (JsonNode list : response) {
                    if (list.path("status_isolasi").asText().toLowerCase().
                            contains(TCari.getText().toLowerCase())) {
                        tabMode.addRow(new Object[]{list.path("id_isolasi").
                            asText(),
                            list.path("status_isolasi").asText()});
                    }
                }
            }
    ...
    private static final Logger LOG = Logger.getLogger(
            CoronaReferensiStatusIsolasi.class.getName());
