...
public class BPJSCekKodeBooking extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekKodeBooking dialog = new BPJSCekKodeBooking(
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (response.isArray()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{"Waktu RS", ": " + list.
                            path("wakturs").asText()});
                        tabMode.addRow(new Object[]{"Waktu", ": " + list.path(
                            "waktu").asText()});
                        tabMode.addRow(new Object[]{"Task Name", ": " + list.
                            path("taskname").asText()});
                        tabMode.addRow(new Object[]{"Task ID", ": " + list.path(
                            "taskid").asText()});
                        tabMode.addRow(new Object[]{"Kode Booking", ": " + list.
                            path("kodebooking").asText()});
                        tabMode.addRow(new Object[]{"", ""});
                    }
                }
            } else {
                System.out.println("Notif : " + nameNode.path("message").
                        asText());
            }
    ...
    private static final Logger LOG = Logger.getLogger(BPJSCekKodeBooking.class.
            getName());
