...
public class ApiINACBG {
    ...
    private static final String KEY_RS = koneksiDB.KEYEKLAIMINACBG();
    private static final String URL_WS = koneksiDB.URLEKLAIMINACBG();
    private static final String KELAS_RS = koneksiDB.KELASRSEKLAIMINACBG();
    private HttpHeaders headers;
    private HttpEntity requestEntity;
    private JsonNode root;
    private ObjectMapper mapper = new ObjectMapper();
    private String requestJson="",response="";
    ...
    public JsonNode request(String request) throws Exception {
...
//        System.out.println("Encrypted Request (Base64): " + encryptedRequest);
        ...
        requestEntity = new HttpEntity<>(encryptedRequest, headers);
...
//        System.out.println("Trimmed Response: " + trimmedResponse);
    ...
    public JsonNode request3(String request) throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        ...
        // Membersihkan dan mendekripsi respons
        String trimmedResponse = cleanResponse(responseBody);
        String decryptedResponse = mcDecrypt(trimmedResponse, getKey());

        // Mengonversi string JSON ke JsonNode menggunakan Jackson
        return objectMapper.readTree(decryptedResponse);
    }
