 ...
 * @author dosen
 */
public class BPJSCekReferensiDiagnosaPRB extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.
                    MyReportqry("rptCariBPJSReferensiDiagnosaPRB.jasper",
                            "report", "[ Pencarian Referensi Diagnosa PRB ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiDiagnosaPRB dialog = new BPJSCekReferensiDiagnosaPRB(
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSCekReferensiDiagnosaPRB.class.getName());
