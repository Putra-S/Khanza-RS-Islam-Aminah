...
public final class SatuSehatKirimMedicationStatement extends javax.swing.JDialog {
    ...
    private String link = "", json = "", idpasien = "", signa1 = "1", signa2 = "1", cekbok = "";
    ...
    public SatuSehatKirimMedicationStatement(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"P", "Tanggal Registrasi", "No.Rawat", "No.RM", "Nama Pasien", "No.KTP Pasien",
                    ...
                    "Route System", "Route Display", "Denominator Code", "Denominator System", "Waktu Penyerahan",
                    "Jumlah", "ID Medication", "Aturan Pakai", "No.Resep", "ID Medication Statement", "No.Racik",
                    "Status"}) {
            @Override
    ...
    private void BtnKirimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimActionPerformed
        for (i = 0; i < tbObat.getRowCount(); i++) {
            if (tbObat.getValueAt(i, 0).toString().equals("true") && (!tbObat.getValueAt(i, 5).toString().isEmpty()) && (!tbObat.getValueAt(i, 7).toString().isEmpty()) && tbObat.getValueAt(i, 26).toString().isEmpty()) {
                try {
                    ...
                    if (tbObat.getValueAt(i, 27).toString().isEmpty()) {
                        try {
                            ...
                            json = "{"
                                    ...
                                    "}"
                                    + "],"
                                    + "\"effectiveDateTime\": \"" + tbObat.getValueAt(i, 21).toString().replaceAll(" ", "T") + "+07:00\","
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimMedicationStatement dialog = new SatuSehatKirimMedicationStatement(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        if (cekBoxBelumKirim.isSelected() == true) {
            cekbok = " and satu_sehat_medicationstatement.id_medicationstatement is null and pasien.no_ktp <> '-'";
        } else {
            cekbok = "";
        }
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "where resep_obat.tgl_penyerahan<>'0000-00-00' and nota_jalan.tanggal between ? and ? " + cekbok + " "
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString("tgl_registrasi") + " " + rs.getString("jam_reg"),
                        ...
                        rs.getString("tgl_penyerahan") + " " + rs.getString("jam_penyerahan"), rs.getString("jml"),
                        rs.getString("id_medication"), rs.getString("aturan_pakai"), rs.getString("no_resep"),
                        rs.getString("id_medicationstatement"), "", "Ralan"});
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
            } finally {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + "left join satu_sehat_medicationstatement on satu_sehat_medicationstatement.no_resep=resep_dokter.no_resep and satu_sehat_medicationstatement.kode_brng=resep_dokter.kode_brng "
                    + "where resep_obat.tgl_penyerahan<>'0000-00-00' and nota_inap.tanggal between ? and ? " + cekbok + " "
                    + (TCari.getText().isEmpty() ? ""
                    : "and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "
                    + "pasien.nm_pasien like ? or pasien.no_ktp like ? or satu_sehat_mapping_obat.kode_brng like ? or satu_sehat_mapping_obat.obat_display like ?) "));
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString("tgl_registrasi") + " " + rs.getString("jam_reg"),
                        ...
                        rs.getString("tgl_penyerahan") + " " + rs.getString("jam_penyerahan"), rs.getString("jml"),
                        rs.getString("id_medication"), rs.getString("aturan_pakai"), rs.getString("no_resep"),
                        rs.getString("id_medicationstatement"), "", "Ranap"});
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
            } finally {
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString("tgl_registrasi") + " " + rs.getString("jam_reg"),
                        ...
                        rs.getString("tgl_penyerahan") + " " + rs.getString("jam_penyerahan"), rs.getString("jml"),
                        rs.getString("id_medication"), rs.getString("aturan_pakai"), rs.getString("no_resep"),
                        rs.getString("id_medicationstatement"), rs.getString("no_racik"), "Ralan"});
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
            } finally {
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString("tgl_registrasi") + " " + rs.getString("jam_reg"),
                        ...
                        rs.getString("tgl_penyerahan") + " " + rs.getString("jam_penyerahan"), rs.getString("jml"),
                        rs.getString("id_medication"), rs.getString("aturan_pakai"), rs.getString("no_resep"),
                        rs.getString("id_medicationstatement"), rs.getString("no_racik"), "Ranap"});
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
            } finally {
