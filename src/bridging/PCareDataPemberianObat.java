...
public class PCareDataPemberianObat extends javax.swing.JDialog {
    ...
    private String aktifkanbatch = "no", URL = "", link = "", otorisasi, Suspen_Piutang_Obat_Ranap = "",
            Obat_Ranap = "", HPP_Obat_Rawat_Inap = "", Persediaan_Obat_Rawat_Inap = "", Suspen_Piutang_Obat_Ralan = "",
            Obat_Ralan = "", HPP_Obat_Rawat_Jalan = "", Persediaan_Obat_Rawat_Jalan = "", utc = "";
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
    if (tbDokter.getSelectedRow() != -1) {
        if (Sequel.cariRegistrasi(tbDokter.getValueAt(tbDokter.getSelectedRow(),
                3).toString()) > 0) {
            ...
            ttlhpp = Sequel.cariIsiAngka(
                    "select sum(h_beli*jml) from detail_pemberian_obat where no_rawat='" + tbDokter.
                            getValueAt(tbDokter.getSelectedRow(), 3).toString() + "' "
                    + "and kode_brng='" + tbDokter.getValueAt(tbDokter.
                            getSelectedRow(), 7).toString() + "' "
                    + "and tgl_perawatan='" + tbDokter.getValueAt(tbDokter.
                            getSelectedRow(), 0).toString() + "' "
                    + "and jam='" + tbDokter.getValueAt(tbDokter.
                            getSelectedRow(), 1).toString() + "' "
                    + "and no_batch='" + tbDokter.getValueAt(tbDokter.
                            getSelectedRow(), 16).toString() + "' "
                    + "and no_faktur='" + tbDokter.getValueAt(tbDokter.
                            getSelectedRow(), 17).toString() + "' ");
            ttljual = Sequel.cariIsiAngka(
                    "select sum(total) from detail_pemberian_obat where no_rawat='" + tbDokter.
                            getValueAt(tbDokter.getSelectedRow(), 3).toString() + "' "
                    + "and kode_brng='" + tbDokter.getValueAt(tbDokter.
                            getSelectedRow(), 7).toString() + "' "
                    + "and tgl_perawatan='" + tbDokter.getValueAt(tbDokter.
            ...
            if (Sequel.queryutf("delete from detail_pemberian_obat where "
                    ...
                    + "and no_batch='" + tbDokter.getValueAt(tbDokter.
                            getSelectedRow(), 16).toString() + "' "
                    + "and no_faktur='" + tbDokter.getValueAt(tbDokter.
                            getSelectedRow(), 17).toString() + "' ") == true) {
                Sequel.queryu(
                        "delete from aturan_pakai where no_rawat='" + tbDokter.
                ...
                if (aktifkanbatch.equals("yes")) {
                    Sequel.mengedit("data_batch",
                            ...
                            "sisa=sisa+?", 3, new String[]{
                                tbDokter.getValueAt(tbDokter.getSelectedRow(),
                                        11).toString(),
                                tbDokter.getValueAt(tbDokter.getSelectedRow(),
                                        16).toString(),
                                tbDokter.
                    ...
                    Trackobat.catatRiwayat(tbDokter.getValueAt(tbDokter.
                            getSelectedRow(), 7).toString(), Valid.SetAngka(
                                    tbDokter.getValueAt(tbDokter.
                                            getSelectedRow(), 11).toString()),
                            0, "Pemberian Obat", akses.getkode(), tbDokter.
                            getValueAt(tbDokter.getSelectedRow(), 15).toString(),
                            "Hapus", tbDokter.getValueAt(tbDokter.
                                    getSelectedRow(), 16).toString(), tbDokter.
                                    getValueAt(tbDokter.getSelectedRow(), 17).
                                    toString(),
                            tbDokter.getValueAt(tbDokter.getSelectedRow(), 3).
                                    toString() + " " + tbDokter.getValueAt(
                                    tbDokter.getSelectedRow(), 4).toString() + " " + tbDokter.
                            getValueAt(tbDokter.getSelectedRow(), 5).toString()
                    );
                    Sequel.menyimpan("gudangbarang", "'" + tbDokter.getValueAt(
                            ...
                            + "'" + tbDokter.getValueAt(tbDokter.
                                    getSelectedRow(), 17).toString() + "'",
                            "stok=stok+'" + tbDokter.getValueAt(tbDokter.
                                    getSelectedRow(), 11).toString() + "'",
                            "kode_brng='" + tbDokter.getValueAt(tbDokter.
                                    getSelectedRow(), 7).toString() + "' and "
                            + "kd_bangsal='" + tbDokter.getValueAt(tbDokter.
                                    getSelectedRow(), 15).toString() + "' and "
                            + "no_batch='" + tbDokter.getValueAt(tbDokter.
                                    getSelectedRow(), 16).toString() + "' and "
                            + "no_faktur='" + tbDokter.getValueAt(tbDokter.
                                    getSelectedRow(), 17).toString() + "'");
                } else {
                    Trackobat.catatRiwayat(tbDokter.getValueAt(tbDokter.
                            getSelectedRow(), 7).toString(), Valid.SetAngka(
            ...
            if (sukses == true) {
                if (tbDokter.getValueAt(tbDokter.getSelectedRow(), 17).
                    ...
                    if (ttlhpp > 0) {
                        Sequel.menyimpan("tampjurnal",
                                "'" + HPP_Obat_Rawat_Inap + "','HPP Persediaan Obat Rawat Inap','0','" + ttlhpp + "'",
                                "Rekening");
                        Sequel.menyimpan("tampjurnal",
                    ...
                    sukses = jur.simpanJurnal(tbDokter.getValueAt(tbDokter.
                            ...
                            "PEMBATALAN PEMBERIAN OBAT RAWAT INAP PASIEN, OLEH " + akses.
                                    getkode());
                } else if (tbDokter.getValueAt(tbDokter.getSelectedRow(), 17).
                    ...
                    if (ttlhpp > 0) {
                        Sequel.menyimpan("tampjurnal",
                                "'" + HPP_Obat_Rawat_Jalan + "','HPP Persediaan Obat Rawat Jalan','0','" + ttlhpp + "'",
                                "Rekening");
                        Sequel.menyimpan("tampjurnal",
                    ...
                    sukses = jur.simpanJurnal(tbDokter.getValueAt(tbDokter.
                            getSelectedRow(), 3).toString(), "U",
                            "PEMBATALAN PEMBERIAN OBAT RAWAT JALAN PASIEN, OLEH " + akses.
                                    getkode());
                }
            }
            ...
            if (sukses == true) {
                try {
                    URL = link + "/obat/" + tbDokter.getValueAt(tbDokter.
                            getSelectedRow(), 6).toString() + "/kunjungan/" + tbDokter.
