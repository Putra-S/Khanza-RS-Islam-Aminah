...
public class INACBGCoderNIK extends javax.swing.JDialog {
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select inacbg_coder_nik.nik,pegawai.nama,inacbg_coder_nik.no_ik "
    ...
    private static final Logger LOG = Logger.getLogger(INACBGCoderNIK.class.getName());
