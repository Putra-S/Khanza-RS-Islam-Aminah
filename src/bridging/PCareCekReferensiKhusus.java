 ...
 * @author dosen
 */
public class PCareCekReferensiKhusus extends javax.swing.JDialog {
    ...
    public PCareCekReferensiKhusus(java.awt.Frame parent, boolean modal) {
        ...
        setSize(628, 674);
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Khusus",
            "Nama Khusus"}) {
            @Override
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariPCAREReferensiKhusus.jasper", "report",
                    "[ Pencarian Referensi Khusus ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiKhusus dialog = new PCareCekReferensiKhusus(
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kdKhusus").asText().toLowerCase().
                                contains(diagnosa.toLowerCase())
                                || list.path("nmKhusus").asText().toLowerCase().
                                        contains(diagnosa.toLowerCase())) {
                            tabMode.addRow(new Object[]{i + ".", list.path(
                                "kdKhusus").asText(),
                                list.path("nmKhusus").asText()});
                            i++;
                        }
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareCekReferensiKhusus.class.getName());
