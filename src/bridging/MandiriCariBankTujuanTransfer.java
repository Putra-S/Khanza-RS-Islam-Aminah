...
public class MandiriCariBankTujuanTransfer extends javax.swing.JDialog {
            ...
            if (response.isArray()) {
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{list.path("KodeBank").asText(), list.path("NamaBank").asText()});
                    }
                } else {
                    for (JsonNode list : response) {
                        if (list.path("KodeBank").asText().toLowerCase().contains(TCari.getText().toLowerCase())
                                || list.path("NamaBank")
                                        .asText()
                                        .toLowerCase()
                                        .contains(TCari.getText().toLowerCase())) {
                            tabMode.addRow(
                                    new Object[]{list.path("KodeBank").asText(), list.path("NamaBank").asText()});
                        }
                    }
                }
            }
    ...
    private static final Logger LOG = Logger.getLogger(MandiriCariBankTujuanTransfer.class.getName());
