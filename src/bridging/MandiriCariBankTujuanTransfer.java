 ...
 * @author dosen
 */
public class MandiriCariBankTujuanTransfer extends javax.swing.JDialog {
    ...
    public MandiriCariBankTujuanTransfer(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{"Kode Bank",
            "Nama Bank"}) {
            @Override
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        ...
        MandiriBankTujuanTransfer form = new MandiriBankTujuanTransfer(null,
                false);
        form.emptTeks();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MandiriCariBankTujuanTransfer dialog = new MandiriCariBankTujuanTransfer(
    ...
    private void tampil() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select * from bank_tujuan_transfer_bankmandiri order by bank_tujuan_transfer_bankmandiri.kode_bank ");
            try {
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(
                            new String[]{rs.getString(1), rs.getString(2)});
                    iyem = iyem + "{\"KodeBank\":\"" + rs.getString(1) + "\",\"NamaBank\":\"" + rs.
                            getString(2)
                            + "\"},";
                }
            } catch (Exception e) {
            ...
            fileWriter.write("{\"mandiribanktujuantransfer\":[" + iyem.
            ...
            if (response.isArray()) {
                if (TCari.getText().trim().isEmpty()) {
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{list.path("KodeBank").
                            asText(), list.path("NamaBank").asText()});
                    }
                } else {
                    for (JsonNode list : response) {
                        if (list.path("KodeBank").asText().toLowerCase().
                                ...
                                || list.path("NamaBank")
                                        ...
                                        .contains(TCari.getText().toLowerCase())) {
                            tabMode.addRow(
                                    new Object[]{list.path("KodeBank").asText(),
                                        list.path("NamaBank").asText()});
                        }
                    }
                }
            }
    ...
    private static final Logger LOG = Logger.getLogger(
            MandiriCariBankTujuanTransfer.class.getName());
