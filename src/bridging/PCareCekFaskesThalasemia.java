...
public class PCareCekFaskesThalasemia extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekFaskesThalasemia dialog = new PCareCekFaskesThalasemia(
    ...
    public void tampil(String spesialistik, String kode, String nokartu,
            String tanggal) {
        try {
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareCekFaskesThalasemia.class.getName());
