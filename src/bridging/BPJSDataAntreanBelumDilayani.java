...
//            Valid.pindah(evt,Poli,BtnPrint);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSDataAntreanBelumDilayani dialog = new BPJSDataAntreanBelumDilayani(new javax.swing.JFrame(), true);
    ...
    private static final Logger LOG = Logger.getLogger(BPJSDataAntreanBelumDilayani.class.getName());
