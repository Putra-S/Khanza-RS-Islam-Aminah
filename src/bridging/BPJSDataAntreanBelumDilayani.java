 ...
 * @author dosen
 */
public class BPJSDataAntreanBelumDilayani extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public BPJSDataAntreanBelumDilayani(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"No.", "Kode Booking", "Tanggal", "Kode Poli",
                    "Kode Dokter", "Jam Praktek", "NIK",
                    "Nomor Kartu", "No. HP", "No. RM", "Jenis Kunjungan",
                    "Nomor Referensi", "Sumber Data",
                    "Kepesertaan", "No Antrean", "Estimasi Dilayani",
                    "Waktu Insert", "Status"}) {
            @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Antrean Belum Dilayani ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel16.setText("Tampilkan Data :");
...
//            Valid.pindah(evt,Poli,BtnPrint);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSDataAntreanBelumDilayani dialog = new BPJSDataAntreanBelumDilayani(
    ...
    public void tampil() {
        try {
            ...
            URL = link + "/antrean/pendaftaran/aktif";
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        ...
                        tabMode.addRow(new Object[]{i + ".", list.path(
                            ...
                            list.path("kodedokter").asText(), list.path(
                            "jampraktek").asText(),
                            list.path("nik").asText(), list.path("nokapst").
                            asText(), list.path("nohp").asText(),
                            list.path("norekammedis").asText(), list.path(
                            "jeniskunjungan").asText(),
                            list.path("nomorreferensi").asText(), list.path(
                            "sumberdata").asText(),
                            list.path("ispeserta").asText(), list.path(
                            "noantrean").asText(),
                            sdf.format(list.path("estimasidilayani").asLong()),
                            sdf.format(list.path("createdtime").asLong()), list.
                            path("status").asText()});
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSDataAntreanBelumDilayani.class.getName());
