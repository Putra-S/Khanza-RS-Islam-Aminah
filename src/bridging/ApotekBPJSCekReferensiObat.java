...
public class ApotekBPJSCekReferensiObat extends javax.swing.JDialog {
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (response.path("list").isArray()) {
                    for (JsonNode list : response.path("list")) {
                        tabMode.addRow(new Object[]{list.path("kode").asText(), list.path("nama").asText(),
    ...
    private static final Logger LOG = Logger.getLogger(ApotekBPJSCekReferensiObat.class.getName());
