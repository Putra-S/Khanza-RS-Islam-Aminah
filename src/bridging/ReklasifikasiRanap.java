 ...
 * @author perpustakaan
 */
public class ReklasifikasiRanap extends javax.swing.JDialog {
    ...
    private double all = 0, Laborat = 0, Radiologi = 0, Operasi = 0, Obat = 0, Ranap_Dokter = 0, Ranap_Paramedis = 0,
            Ranap_Dokter_Paramedis = 0, Ralan_Dokter = 0, Ralan_Paramedis = 0, ttlRalan_Dokter_Paramedis = 0,
            Ralan_Dokter_Paramedis = 0, Tambahan = 0, Potongan = 0, Kamar = 0, Registrasi = 0, Harian = 0,
            Retur_Obat = 0, Resep_Pulang = 0, ttlRanap_Dokter_Paramedis = 0, Service = 0, ttlLaborat = 0,
            ttlRadiologi = 0, ttlOperasi = 0, ttlObat = 0, ttlRanap_Dokter = 0, ttlRanap_Paramedis = 0,
            ttlRalan_Dokter = 0, ttlRalan_Paramedis = 0, ttlTambahan = 0, ttlPotongan = 0, ttlKamar = 0,
            ttlRegistrasi = 0, ttlHarian = 0, ttlRetur_Obat = 0, ttlResep_Pulang = 0, ttlService = 0, operasi2 = 0,
            kebidanan = 0, tarifincabg = 0, ttltarifincabg = 0, ttluntungrugiinacbg = 0, ttlkebidanan = 0,
            untungrugiinacbg = 0;

    private String sqlps2 = "select sum(totalbiaya) from billing where no_rawat=? and status=? ";

    private String status = "", du = "", ds1 = "", ds2 = "", ds3 = "", ds4 = "", ds5 = "", ds6 = "", ds7 = "", ds8 = "",
            ds9 = "", ds10 = "", ds11 = "", ds12 = "", ds13 = "", ds14 = "", ds15 = "", ds16 = "", ds17 = "", ds18 = "",
            ds19 = "", ds20 = "", ds21 = "", ds22 = "", ds23 = "", ds24 = "", ds25 = "", ds26 = "", ds27 = "",
            ds28 = "", ds29 = "", p1 = "", p2 = "", p3 = "", p4 = "", p5 = "", p6 = "", p7 = "", p8 = "", p9 = "",
    ...
    public ReklasifikasiRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.Rawat", "No.RM", "Cara Bayar", "Waktu Masuk",
            "Waktu Keluar", "LOS(hari)", "J.K.", "Tgl.Lahir", "Tipe Rawat", "Kelas Rawat", "Stts Keluar", "D.U",
            "D.S 1", "D.S 2", "D.S 3", "D.S 4", "D.S 5", "D.S 6", "D.S 7", "D.S 8", "D.S 9", "D.S 10", "D.S 11",
            "D.S 12", "D.S 13", "D.S 14", "D.S 15", "D.S 16", "D.S 17", "D.S 18", "D.S 19", "D.S 20", "D.S 21",
            "D.S 22", "D.S 23", "D.S 24", "D.S 25", "D.S 26", "D.S 27", "D.S 28", "D.S 29", "P 1", "P 2", "P 3",
            ...
            "P 30", "INA-CBG", "Total Trf RS", "Trf P. Non-Bedah", "Trf P. Bedah", "Trf Ksl/Vst Dokter",
            "Trf Ksl/Vst Tng. Ahli", "Trf Tnd Keperawatan", "Tarif Penunjang", "Trf Radioterapi", "Trf Lab",
            "Trf UTD", "Trf Radiologi", "Trf Rehabilitasi", "Trf Akomodasi", "Trf Ruang Intensif", "Trf Obat",
            "Trf Alkes", "Trf BMHP", "Trf Sewa Alat", "Potongan", "Tarif InaCBG", "Untung/Rugi InaCBG"}) {
            @Override
        ...
        for (int i = 0; i < 93; i++) {
            ...
            if (i == 0) {
                ...
                column.setPreferredWidth(80);
            } else if ((i == 11) || (i == 12) || (i == 13) || (i == 14) || (i == 15) || (i == 16) || (i == 17)
                    || (i == 18) || (i == 19) || (i == 20) || (i == 21) || (i == 22) || (i == 23) || (i == 24)
                    || (i == 25) || (i == 26) || (i == 27) || (i == 28) || (i == 29) || (i == 30) || (i == 31)
                    || (i == 32) || (i == 33) || (i == 34) || (i == 35) || (i == 36) || (i == 37) || (i == 38)
                    || (i == 39) || (i == 66) || (i == 40) || (i == 41) || (i == 42) || (i == 43) || (i == 44)
                    || (i == 45) || (i == 46) || (i == 47) || (i == 48) || (i == 49) || (i == 50) || (i == 51)
                    || (i == 52) || (i == 53) || (i == 54) || (i == 55) || (i == 56) || (i == 57) || (i == 58)
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Sequel.queryu("delete from temporary2 where temp37='" + akses.
                    getalamatip() + "'");
            ...
            Valid.MyReportqry("rptReklasifikasiRalan.jasper", "report",
                    "::[ Reklasifikasi Ranap ]::",
                    "select * from temporary2 where temporary2.temp100='" + akses.
                            getalamatip() + "' order by temporary2.no", param);
        }
...
private void BtnCari1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCari1KeyPressed
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "and reg_periksa.no_rawat=nota_inap.no_rawat " + "and kamar_inap.kd_kamar=kamar.kd_kamar "
            ...
            try {
                ...
                ttlRetur_Obat = 0;
                ttlResep_Pulang = 0;
                ttlRalan_Dokter_Paramedis = 0;
                ttlRanap_Dokter_Paramedis = 0;
                ttlService = 0;
                ttltarifincabg = 0;
                ttluntungrugiinacbg = 0;
                ttlkebidanan = 0;
                while (rs.next()) {
                    if (!rs.getString("stts_pulang").equals("-")) {
                        if (!rs.getString("stts_pulang").equals("Pindah Kamar")) {
                            ...
                            pspenyakit = koneksi
                                    .prepareStatement("select kd_penyakit,prioritas from diagnosa_pasien where "
                            ...
                            psprosedur = koneksi.prepareStatement("select kode,prioritas from prosedur_pasien where "
                                    + "no_rawat=? and status='Ranap' order by prioritas");
                            try {
                            ...
                            operasi2 = 0;
                            kebidanan = 0;
                            operasi2 = Sequel.cariIsiAngka(
                                    "select sum(operasi.biayaoperator1+operasi.biayaoperator2+operasi.biayaoperator3+"
                                    ...
                                    + "operasi.biaya_omloop3+operasi.biayasarpras) from operasi where kategori<>'-' and no_rawat=?",
                                    rs.getString("no_rawat"));
                            kebidanan = Sequel.cariIsiAngka(
                                    "select sum(operasi.biayaoperator1+operasi.biayaoperator2+operasi.biayaoperator3+"
                                    + "operasi.biayaasisten_operator1+operasi.biayaasisten_operator2+operasi.biayainstrumen+"
                                    + "operasi.biayadokter_anak+operasi.biayaperawaat_resusitas+operasi.biayadokter_anestesi+"
                                    + "operasi.biayaasisten_anestesi+operasi.biayabidan+operasi.biayabidan2+operasi.biayabidan3+"
                            ...
                            tarifincabg = Sequel.cariIsiAngka(
                                    "select inacbg_grouping_stage1.tarif from inacbg_grouping_stage1 inner join bridging_sep on inacbg_grouping_stage1.no_sep=bridging_sep.no_sep where bridging_sep.no_rawat=?",
                                    rs.getString("no_rawat"))
                                    + Sequel.cariIsiAngka(
                                            "select inacbg_grouping_stage12.tarif from inacbg_grouping_stage12 inner join inacbg_klaim_baru2 on inacbg_grouping_stage12.no_sep=inacbg_klaim_baru2.no_sep where inacbg_klaim_baru2.no_rawat=?",
                                            rs.getString("no_rawat"))
                                    + Sequel.cariIsiAngka(
                                            "select inacbg_grouping_stage1_internal.tarif from inacbg_grouping_stage1_internal inner join bridging_sep_internal on inacbg_grouping_stage1_internal.no_sep=bridging_sep_internal.no_sep where bridging_sep_internal.no_rawat=?",
                                            rs.getString("no_rawat"));
                            if (tarifincabg > 0) {
                                untungrugiinacbg = tarifincabg - (Laborat + Radiologi + Operasi + Obat + Ranap_Dokter
                            ...
                            tabMode.addRow(new Object[]{rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                                ...
                                rs.getString("tgl_keluar") + " " + rs.getString("jam_keluar"), rs.getString("lama"),
                                rs.getString("jk"), rs.getString("tgl_lahir"), "Ranap", rs.getString("kelas"),
                                rs.getString("stts_pulang"), du, ds1, ds2, ds3, ds4, ds5, ds6, ds7, ds8, ds9, ds10,
                                ds11, ds12, ds13, ds14, ds15, ds16, ds17, ds18, ds19, ds20, ds21, ds22, ds23, ds24,
                                ds25, ds26, ds27, ds28, ds29, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12,
                                p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27, p28, p29,
                                p30,
                                Sequel.cariIsi(
                                "select inacbg_grouping_stage1.code_cbg from inacbg_grouping_stage1 inner join bridging_sep on bridging_sep.no_sep=inacbg_grouping_stage1.no_sep where bridging_sep.no_rawat=?",
                                rs.getString("no_rawat"))
                                + " "
                                + Sequel.cariIsi(
                                "select inacbg_grouping_stage1_internal.code_cbg from inacbg_grouping_stage1_internal inner join bridging_sep_internal on bridging_sep_internal.no_sep=inacbg_grouping_stage1_internal.no_sep where bridging_sep_internal.no_rawat=?",
                                rs.getString("no_rawat")),
                                Valid.SetAngka(Laborat + Radiologi + Operasi + Obat + Ranap_Dokter
                                + Ranap_Dokter_Paramedis + Ranap_Paramedis + Ralan_Dokter
                                + Ralan_Dokter_Paramedis + Ralan_Paramedis + Tambahan + Potongan + Kamar
                                + Registrasi + Harian + Retur_Obat + Resep_Pulang + Service),
                                Valid.SetAngka(kebidanan), Valid.SetAngka(Operasi - kebidanan),
                                Valid.SetAngka(Ranap_Dokter + Ralan_Dokter),
                                Valid.SetAngka(Ranap_Dokter_Paramedis + Ralan_Dokter_Paramedis),
                                Valid.SetAngka(Ranap_Paramedis + Ralan_Paramedis),
                                Valid.SetAngka(Tambahan + Registrasi + Service), 0, Valid.SetAngka(Laborat), 0,
                                Valid.SetAngka(Radiologi), 0, Valid.SetAngka(Kamar + Harian), 0,
                                Valid.SetAngka(Obat + Retur_Obat + Resep_Pulang), 0, 0, 0, Valid.SetAngka(Potongan),
                ...
                if (all > 0) {
                    tabMode.addRow(new Object[]{"Total", ":", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                        ...
                        Valid.SetAngka(ttlOperasi - ttlkebidanan),
                        Valid.SetAngka(ttlRanap_Dokter + ttlRalan_Dokter),
                        Valid.SetAngka(ttlRanap_Dokter_Paramedis + ttlRalan_Dokter_Paramedis),
                        Valid.SetAngka(ttlRanap_Paramedis + ttlRalan_Paramedis),
                        Valid.SetAngka(ttlTambahan + ttlRegistrasi + ttlService), "", Valid.SetAngka(ttlLaborat),
                        "", Valid.SetAngka(ttlRadiologi), "", Valid.SetAngka(ttlKamar + ttlHarian), "",
                        Valid.SetAngka(ttlObat + ttlRetur_Obat + ttlResep_Pulang), "", "", "",
                        Valid.SetAngka(ttlPotongan), Valid.SetAngka(ttltarifincabg),
    ...
    private static final Logger LOG = Logger.getLogger(ReklasifikasiRanap.class.getName());
