...
public class ReklasifikasiRanap extends javax.swing.JDialog {
    ...
    public ReklasifikasiRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.Rawat", "No.RM",
            "Cara Bayar", "Waktu Masuk",
            "Waktu Keluar", "LOS(hari)", "J.K.", "Tgl.Lahir", "Tipe Rawat",
            "Kelas Rawat", "Stts Keluar", "D.U",
            "D.S 1", "D.S 2", "D.S 3", "D.S 4", "D.S 5", "D.S 6", "D.S 7",
            "D.S 8", "D.S 9", "D.S 10", "D.S 11",
            "D.S 12", "D.S 13", "D.S 14", "D.S 15", "D.S 16", "D.S 17", "D.S 18",
            "D.S 19", "D.S 20", "D.S 21",
            "D.S 22", "D.S 23", "D.S 24", "D.S 25", "D.S 26", "D.S 27", "D.S 28",
            "D.S 29", "P 1", "P 2", "P 3",
            "P 4", "P 5", "P 6", "P 7", "P 8", "P 9", "P 10", "P 11", "P 12",
            "P 13", "P 14", "P 15", "P 16",
            "P 17", "P 18", "P 19", "P 20", "P 21", "P 22", "P 23", "P 24",
            "P 25", "P 26", "P 27", "P 28", "P 29",
            "P 30", "INA-CBG", "Total Trf RS", "Trf P. Non-Bedah",
            "Trf P. Bedah", "Trf Ksl/Vst Dokter",
            "Trf Ksl/Vst Tng. Ahli", "Trf Tnd Keperawatan", "Tarif Penunjang",
            "Trf Radioterapi", "Trf Lab",
            "Trf UTD", "Trf Radiologi", "Trf Rehabilitasi", "Trf Akomodasi",
            "Trf Ruang Intensif", "Trf Obat",
            "Trf Alkes", "Trf BMHP", "Trf Sewa Alat", "Potongan", "Tarif InaCBG",
            "Untung/Rugi InaCBG"}) {
            @Override
...
private void BtnCari1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCari1KeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ReklasifikasiRanap dialog = new ReklasifikasiRanap(
                ...
                while (rs.next()) {
                    if (!rs.getString("stts_pulang").equals("-")) {
                        if (!rs.getString("stts_pulang").equals("Pindah Kamar")) {
                            ...
                            try {
                                pspenyakit.
                                        setString(1, rs.getString("no_rawat"));
                            ...
                            tabMode.addRow(
                                    new Object[]{rs.getString("no_rawat"),
                                        rs.getString("no_rkm_medis"),
                                        rs.getString("png_jawab"),
                                        rs.getString("tgl_masuk") + " " + rs.
                                        getString("jam_masuk"),
                                        rs.getString("tgl_keluar") + " " + rs.
                                        getString("jam_keluar"), rs.
                                        getString("lama"),
                                        rs.getString("jk"), rs.getString(
                                        "tgl_lahir"), "Ranap", rs.getString(
                                                "kelas"),
                                        rs.getString("stts_pulang"), du, ds1,
                                        ds2, ds3, ds4, ds5, ds6, ds7, ds8,
                                        ds9, ds10,
                                        ds11, ds12, ds13, ds14, ds15, ds16,
                                        ds17, ds18, ds19, ds20, ds21, ds22,
                                        ds23, ds24,
                                        ds25, ds26, ds27, ds28, ds29, p1, p2,
                                        ...
                                        Valid.SetAngka(
                                                ...
                                                + Ralan_Dokter_Paramedis + Ralan_Paramedis + Tambahan + Potongan + Kamar
                                                + Registrasi + Harian + Retur_Obat + Resep_Pulang + Service),
                                        Valid.SetAngka(kebidanan), Valid.
                                        SetAngka(Operasi - kebidanan),
                                        Valid.SetAngka(
                                                Ranap_Dokter + Ralan_Dokter),
                                        Valid.SetAngka(
                                                Ranap_Dokter_Paramedis + Ralan_Dokter_Paramedis),
                                        Valid.SetAngka(
                                                Ranap_Paramedis + Ralan_Paramedis),
                                        Valid.SetAngka(
                                                Tambahan + Registrasi + Service),
                                        0, Valid.SetAngka(Laborat), 0,
                                        Valid.SetAngka(Radiologi), 0, Valid.
                                        SetAngka(Kamar + Harian), 0,
                                        Valid.SetAngka(
                                                Obat + Retur_Obat + Resep_Pulang),
                                        0, 0, 0, Valid.SetAngka(Potongan),
                                        Valid.SetAngka(tarifincabg), Valid.
                                        SetAngka(untungrugiinacbg)});
                        }
                    }
                }
                if (all > 0) {
                    tabMode.addRow(
                            new Object[]{"Total", ":", "", "", "", "", "",
                                ...
                                "",
                                "", "", "", "", "", "", "", "", "", "",
                                Valid.SetAngka(all), Valid.SetAngka(
                                ttlkebidanan),
                                Valid.SetAngka(ttlOperasi - ttlkebidanan),
                                Valid.SetAngka(
                                        ttlRanap_Dokter + ttlRalan_Dokter),
                                Valid.SetAngka(
                                        ttlRanap_Dokter_Paramedis + ttlRalan_Dokter_Paramedis),
                                Valid.SetAngka(
                                        ttlRanap_Paramedis + ttlRalan_Paramedis),
                                Valid.SetAngka(
                                        ttlTambahan + ttlRegistrasi + ttlService),
                                "", Valid.SetAngka(ttlLaborat),
                                "", Valid.SetAngka(ttlRadiologi), "", Valid.
                                SetAngka(ttlKamar + ttlHarian), "",
                                Valid.SetAngka(
                                        ttlObat + ttlRetur_Obat + ttlResep_Pulang),
                                "", "", "",
                                Valid.SetAngka(ttlPotongan), Valid.SetAngka(
                                ttltarifincabg),
    ...
    private static final Logger LOG = Logger.getLogger(ReklasifikasiRanap.class.
            getName());
