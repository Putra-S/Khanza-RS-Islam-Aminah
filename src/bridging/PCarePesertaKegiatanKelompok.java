...
public class PCarePesertaKegiatanKelompok extends javax.swing.JDialog {
    ...
    public PCarePesertaKegiatanKelompok(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Edu Id", "Pelayanan", "Kegiatan", "Kelompok",
                    "Materi",
                    "Pembicara", "Lokasi", "Keterangan", "Biaya", "No.Kartu",
                    "No.RM", "Nama Pasien"}) {
...
private void BtnHapusKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnHapusKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCarePesertaKegiatanKelompok dialog = new PCarePesertaKegiatanKelompok(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("eduId"), rs.
                        getString("tglPelayanan"),
                        rs.getString("nmKegiatan"), rs.getString("nmKelompok"),
                        rs.getString("materi"),
                        rs.getString("pembicara"), rs.getString("lokasi"), rs.
                        getString("keterangan"),
                        rs.getDouble("biaya"), rs.getString("no_peserta"), rs.
    ...
    public void bodyWithDeleteRequest() throws Exception {
        ...
        try {
            URL = link + "/kelompok/peserta/" + tbDokter.getValueAt(tbDokter.
                    getSelectedRow(), 0).toString() + "/"
                    + tbDokter.getValueAt(tbDokter.getSelectedRow(), 9).
                            toString();
            ...
            if (nameNode.path("code").asText().equals("200")) {
                if (Sequel.queryu2tf(
                        "delete from pcare_peserta_kegiatan_kelompok where eduId=? and no_rkm_medis=?",
                        2,
                        new String[]{tbDokter.getValueAt(tbDokter.
                                    getSelectedRow(), 0).toString(),
                            tbDokter.getValueAt(tbDokter.getSelectedRow(), 10).
                                    toString()}) == true) {
                    tampil();
                }
            } else {
    ...
    private static final Logger LOG = Logger.getLogger(
            PCarePesertaKegiatanKelompok.class.getName());
