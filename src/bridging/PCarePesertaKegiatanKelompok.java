...
public class PCarePesertaKegiatanKelompok extends javax.swing.JDialog {
    ...
    public PCarePesertaKegiatanKelompok(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Edu Id", "Pelayanan", "Kegiatan", "Kelompok", "Materi",
            "Pembicara", "Lokasi", "Keterangan", "Biaya", "No.Kartu", "No.RM", "Nama Pasien"}) {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (TabRawat.getSelectedIndex() == 0) {
            ...
            if (tabMode.getRowCount() == 0) {
                ...
                Valid.MyReport("rptPCarePesertaKegiatanKelompok.jasper",
                        "report", "::[ Data Kegiatan Kelompok PCare ]::", param);
            }
            ...
            try {
                ...
                try (BufferedWriter bw = new BufferedWriter(new FileWriter(f))) {
                    bw.write(LoadHTML1.getText().replaceAll("<head>", "<head>"
                            ...
                            getemailrs() + "<br><br>"
                            + "<font size='2' face='Tahoma'>Detail Peserta Kegiatan Kelompok PCARE Tanggal Pelayanan " + DTPCari1.
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
    if (TabRawat.getSelectedIndex() == 0) {
        ...
        JOptionPane.showMessageDialog(null,
                "Hanya bisa dilakukan hapus di Data Peserta..!!!");
...
private void BtnHapusKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnHapusKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select pcare_kegiatan_kelompok.eduId,pcare_kegiatan_kelompok.tglPelayanan,"
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("eduId"), rs.getString("tglPelayanan"),
                        rs.getString("nmKegiatan"), rs.getString("nmKelompok"), rs.getString("materi"),
                        rs.getString("pembicara"), rs.getString("lokasi"), rs.getString("keterangan"),
                        rs.getDouble("biaya"), rs.getString("no_peserta"), rs.getString("no_rkm_medis"),
    ...
    private void tampil2() {
        ...
        try {
            ...
            htmlContent
                    .append("<tr class='head'>" + "<td valign='top' bgcolor='#FFFAFA' align='center' width='1%'>No.</td>"
                            ...
                            + "<td valign='top' bgcolor='#FFFAFA' align='center' width='6%'>Biaya</td>" + "</tr>");
            ps = koneksi.prepareStatement("select eduId,tglPelayanan,nmKegiatan,nmKelompok,materi, "
            ...
            try {
                ...
                while (rs.next()) {
                    htmlContent.append("<tr class='isi'><td valign='top' align='center'>")
                            ...
                            .append(rs.getString("eduId"))
                            .append("</td><td valign='top' align='center'>")
                            .append(rs.getString("tglPelayanan"))
                            .append("</td><td valign='top'>")
                            .append(rs.getString("nmKegiatan"))
                            .append("</td><td valign='top'>")
                            .append(rs.getString("nmKelompok"))
                            .append("</td><td valign='top'>")
                            .append(rs.getString("materi"))
                            .append("</td><td valign='top'>")
                            .append(rs.getString("pembicara"))
                            .append("</td><td valign='top'>")
                            .append(rs.getString("lokasi"))
                            .append("</td><td valign='top'>")
                            .append(rs.getString("keterangan"))
                            .append("</td><td valign='top' align='right'>")
                            .append(Valid.SetAngka(rs.getDouble("biaya")))
                            .append("</td></tr><tr class='isi'><td valign='top' align='center'></td><td valign='top' align='right' colspan='2'>Daftar Peserta :</td><td valign='top' colspan='7'><table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0' class='tbl_form'><tr class='isi'><td valign='top' bgcolor='#fdfff9' align='center' width='1%'>No.</td><td valign='top' bgcolor='#fdfff9' align='center' width='9%'>No.Kartu</td><td valign='top' bgcolor='#fdfff9' align='center' width='7%'>No.RM</td><td valign='top' bgcolor='#fdfff9' align='center' width='25%'>Nama Pasien</td><td valign='top' bgcolor='#fdfff9' align='center' width='8%'>Umur</td><td valign='top' bgcolor='#fdfff9' align='center' width='1%'>J.K.</td><td valign='top' bgcolor='#fdfff9' align='center' width='34%'>Alamat</td><td valign='top' bgcolor='#fdfff9' align='center' width='15%'>Pekerjaan</td></tr>");
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            htmlContent.append("<tr class='isi'><td valign='top' align='center'>")
                                    .append(a)
                                    .append("</td><td valign='top'>")
                                    .append(rs2.getString("no_peserta"))
                                    .append("</td><td valign='top'>")
                                    .append(rs2.getString("no_rkm_medis"))
                                    .append("</td><td valign='top'>")
                                    .append(rs2.getString("nm_pasien"))
                                    .append("</td><td valign='top' align='center'>")
                                    .append(rs2.getString("Umur"))
                                    .append("</td><td valign='top' align='center'>")
                                    .append(rs2.getString("jk"))
                                    .append("</td><td valign='top'>")
                                    .append(rs2.getString("alamat"))
                                    .append("</td><td valign='top'>")
                                    .append(rs2.getString("pekerjaan"))
                                    .append("</td></tr>");
                            a++;
                        }
                    } catch (Exception e) {
    ...
    public void bodyWithDeleteRequest() throws Exception {
        ...
        try {
            URL = link + "/kelompok/peserta/" + tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString() + "/"
                    + tbDokter.getValueAt(tbDokter.getSelectedRow(), 9).toString();
            ...
            if (nameNode.path("code").asText().equals("200")) {
                if (Sequel.queryu2tf("delete from pcare_peserta_kegiatan_kelompok where eduId=? and no_rkm_medis=?", 2,
                        new String[]{tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString(),
                            tbDokter.getValueAt(tbDokter.getSelectedRow(), 10).toString()}) == true) {
                    tampil();
                }
            } else {
    ...
    private static final Logger LOG = Logger.getLogger(PCarePesertaKegiatanKelompok.class.getName());
