 ...
 * @author dosen
 */
public class PCareCekReferensiSubspesialis extends javax.swing.JDialog {
    ...
    private PCareCekReferensiSpesialis spesialis = new PCareCekReferensiSpesialis(
            null, false);
    ...
    public PCareCekReferensiSubspesialis(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.",
            "Kode Subspesialis", "Nama Subspesialis"}) {
            @Override
        ...
        Subspesialis.setDocument(new batasInput((byte) 100).
                getKata(Subspesialis));

        if (koneksiDB.CARICEPAT().equals("aktif")) {
            Subspesialis.getDocument().addDocumentListener(
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariPCAREReferensiSubspesialis.jasper",
                    "report", "[ Pencarian Referensi Subpesialis ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiSubspesialis dialog = new PCareCekReferensiSubspesialis(
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kdSubSpesialis").asText().toLowerCase().
                                contains(diagnosa.toLowerCase())
                                || list.path("nmSubSpesialis")
                                        .asText()
                                        .toLowerCase()
                                        .contains(diagnosa.toLowerCase())) {
                            tabMode.addRow(new Object[]{i + ".", list.path(
                                "kdSubSpesialis").asText(),
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareCekReferensiSubspesialis.class.getName());
