...
public class PCareCekReferensiSubspesialis extends javax.swing.JDialog {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kdSubSpesialis").asText().toLowerCase().contains(diagnosa.toLowerCase())
                            ...
                            tabMode.addRow(new Object[]{i + ".", list.path("kdSubSpesialis").asText(),
    ...
    private static final Logger LOG = Logger.getLogger(PCareCekReferensiSubspesialis.class.getName());
