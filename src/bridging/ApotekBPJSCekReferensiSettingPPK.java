...
public class ApotekBPJSCekReferensiSettingPPK extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ApotekBPJSCekReferensiSettingPPK dialog = new ApotekBPJSCekReferensiSettingPPK(new javax.swing.JFrame(),
                    true);
    ...
    public void tampil(String keyword) {
        try {
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                tabMode.addRow(new Object[]{"Kode", ": " + response.path("kode").asText()});
                tabMode.addRow(new Object[]{"Nama Apoteker", ": " + response.path("namaapoteker").asText()});
                tabMode.addRow(new Object[]{"Nama Kepala", ": " + response.path("namakepala").asText()});
                tabMode.addRow(new Object[]{"Jabatan Kepala", ": " + response.path("jabatankepala").asText()});
                tabMode.addRow(new Object[]{"NIP Kepala", ": " + response.path("nipkepala").asText()});
                tabMode.addRow(new Object[]{"SIUP", ": " + response.path("siup").asText()});
                tabMode.addRow(new Object[]{"Alamat", ": " + response.path("alamat").asText()});
                tabMode.addRow(new Object[]{"Kota", ": " + response.path("kota").asText()});
                tabMode.addRow(new Object[]{"Nama Verifikator", ": " + response.path("namaverifikator").asText()});
                tabMode.addRow(new Object[]{"NPP Verifikator", ": " + response.path("nppverifikator").asText()});
                tabMode
                        .addRow(new Object[]{"Nama Petugas Apotek", ": " + response.path("namapetugasapotek").asText()});
                tabMode
                        .addRow(new Object[]{"NIP Petugas Apotek", ": " + response.path("nippetugasapotek").asText()});
                tabMode.addRow(new Object[]{"Check Stock", ": " + response.path("checkstock").asText()});
            } else {
    ...
    private static final Logger LOG = Logger.getLogger(ApotekBPJSCekReferensiSettingPPK.class.getName());
