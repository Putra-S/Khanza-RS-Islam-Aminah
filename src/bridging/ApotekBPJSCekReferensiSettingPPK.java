...
public class ApotekBPJSCekReferensiSettingPPK extends javax.swing.JDialog {
    ...
    private ApotekBPJSCekReferensiFaskes faskes = new ApotekBPJSCekReferensiFaskes(
            null, false);
    ...
    public ApotekBPJSCekReferensiSettingPPK(java.awt.Frame parent, boolean modal) {
        ...
        if (koneksiDB.CARICEPAT().equals("aktif")) {
            KodePPK.getDocument().addDocumentListener(
        ...
        faskes.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (faskes.getTable().getSelectedRow() != -1) {
                    KodePPK.setText(faskes.getTable().getValueAt(faskes.
                            getTable().getSelectedRow(), 1).toString());
                    NamaPPK.setText(faskes.getTable().getValueAt(faskes.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariApotekBPJSReferensiSettingPPK.jasper",
                    "report", "[ Pencarian Referensi Setting PPK Apotek BPJS ]",
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        if (KodePPK.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null,
                    "Silahkan masukkan faskes terlebih dahulu..!!");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ApotekBPJSCekReferensiSettingPPK dialog = new ApotekBPJSCekReferensiSettingPPK(
        ...
        try {
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                tabMode.addRow(new Object[]{"Kode",
                    ": " + response.path("kode").asText()});
                tabMode.addRow(new Object[]{"Nama Apoteker", ": " + response.
                    path("namaapoteker").asText()});
                tabMode.addRow(new Object[]{"Nama Kepala", ": " + response.path(
                    "namakepala").asText()});
                tabMode.addRow(new Object[]{"Jabatan Kepala", ": " + response.
                    path("jabatankepala").asText()});
                tabMode.addRow(new Object[]{"NIP Kepala", ": " + response.path(
                    "nipkepala").asText()});
                tabMode.addRow(new Object[]{"SIUP",
                    ": " + response.path("siup").asText()});
                tabMode.addRow(new Object[]{"Alamat", ": " + response.path(
                    "alamat").asText()});
                tabMode.addRow(new Object[]{"Kota",
                    ": " + response.path("kota").asText()});
                tabMode.addRow(new Object[]{"Nama Verifikator", ": " + response.
                    path("namaverifikator").asText()});
                tabMode.addRow(new Object[]{"NPP Verifikator", ": " + response.
                    path("nppverifikator").asText()});
                tabMode
                        .addRow(new Object[]{"Nama Petugas Apotek",
                    ": " + response.path("namapetugasapotek").asText()});
                tabMode
                        .addRow(new Object[]{"NIP Petugas Apotek",
                    ": " + response.path("nippetugasapotek").asText()});
                tabMode.addRow(new Object[]{"Check Stock", ": " + response.path(
                    "checkstock").asText()});
            } else {
    ...
    private static final Logger LOG = Logger.getLogger(
            ApotekBPJSCekReferensiSettingPPK.class.getName());
