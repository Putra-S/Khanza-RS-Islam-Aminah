...
public class BPJSTaskIDJamDiambil extends javax.swing.JDialog {
    ...
    public BPJSTaskIDJamDiambil(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.Rawat", "Tanggal", "Jam", "Nama Pasien", "Poliklinik",
            "Dokter", "Cara Bayar", "Task Id 3", "Task Id 4", "Task Id 5", "Task Id 6", "Task Id 7"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("no_rawat"), rs.getString("tgl_registrasi"),
                        rs.getString("jam_reg"), rs.getString("nm_pasien"), rs.getString("nm_poli"),
                        rs.getString("nm_dokter"), rs.getString("png_jawab"), rs.getString("Taskid3"),
                        rs.getString("Taskid4"), rs.getString("Taskid5"), rs.getString("Taskid6"),
    ...
    private static final Logger LOG = Logger.getLogger(BPJSTaskIDJamDiambil.class.getName());
