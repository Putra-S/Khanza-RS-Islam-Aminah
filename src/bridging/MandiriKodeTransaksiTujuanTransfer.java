 ...
 * @author dosen
 */
public class MandiriKodeTransaksiTujuanTransfer extends javax.swing.JDialog {
    ...
    private MandiriCariMetodePembayaran metodepembayaran = new MandiriCariMetodePembayaran(
            null, false);

    private MandiriCariBankTujuanTransfer banktujuan = new MandiriCariBankTujuanTransfer(
            null, false);
     ...
     * @param modal
     */
    public MandiriKodeTransaksiTujuanTransfer(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Kode Metode",
            "Metode Pembayaran", "Kode Bank",
            "Bank Tujuan Transaksi", "Kode Transaksi"}) {
            @Override
        ...
        KodeTransaksi.setDocument(new batasInput((byte) 15).getKata(
                KodeTransaksi));
        ...
        metodepembayaran.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (metodepembayaran.getTable().getSelectedRow() != -1) {
                    KodeMetode.setText(metodepembayaran.getTable()
                            .getValueAt(metodepembayaran.getTable().
                                    getSelectedRow(), 0)
                            .toString());
                    MetodePembayaran.setText(metodepembayaran.getTable()
                            .getValueAt(metodepembayaran.getTable().
                                    getSelectedRow(), 1)
                            .toString());
        ...
        banktujuan.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (banktujuan.getTable().getSelectedRow() != -1) {
                    KodeBank.setText(
                            banktujuan.getTable().getValueAt(banktujuan.
    ...
    private void btnMetodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMetodeActionPerformed
        ...
        metodepembayaran.setSize(internalFrame1.getWidth() - 20, internalFrame1.
                getHeight() - 20);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (KodeMetode.getText().trim().isEmpty() || MetodePembayaran.getText().
                trim().isEmpty()) {
            Valid.textKosong(KodeMetode, "Metode Pembyaran");
        } else if (KodeBank.getText().trim().isEmpty() || BankTujuan.getText().
                trim().isEmpty()) {
            Valid.textKosong(KodeBank, "Bank Tujuan Transaksi");
        } else {
            if (Sequel.menyimpantf("kodetransaksi_tujuan_transfer_bankmandiri",
                    "?,?,?", "Metode Pembayaran & Bank Tujuan Transfer", 3,
                    new String[]{
                        KodeMetode.getText(), KodeBank.getText(), KodeTransaksi.
                        getText()
                    }) == true) {
                tabMode.addRow(new Object[]{
                    KodeMetode.getText(), MetodePembayaran.getText(), KodeBank.
                    getText(), BankTujuan.getText(), KodeTransaksi.getText()
                });
                emptTeks();
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            Valid.pindah(evt, KodeTransaksi, BtnBatal);
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbJnsPerawatan.getSelectedRow() != -1) {
            if (Sequel.queryu2tf(
                    "delete from kodetransaksi_tujuan_transfer_bankmandiri where kode_metode=? and kode_bank=?",
                    2, new String[]{
                        tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                                getSelectedRow(), 0).toString(), tbJnsPerawatan.
        ...
        if (KodeMetode.getText().trim().isEmpty() || MetodePembayaran.getText().
            ...
            if (tbJnsPerawatan.getSelectedRow() > -1) {
                if (Sequel.mengedittf(
                        ...
                        "kode_metode=? and kode_bank=?",
                        "kode_metode=?,kode_bank=?,kode_transaksi=?", 5,
                        new String[]{
                            KodeMetode.getText(), KodeBank.getText(),
                            KodeTransaksi.getText(), tbJnsPerawatan.getValueAt(
                            tbJnsPerawatan.getSelectedRow(), 0).toString(),
                            tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                                    getSelectedRow(), 2).toString()
                        }) == true) {
                    tabMode.setValueAt(KodeMetode.getText(), tbJnsPerawatan.
                            getSelectedRow(), 0);
                    tabMode.setValueAt(MetodePembayaran.getText(),
                            tbJnsPerawatan.getSelectedRow(), 1);
                    tabMode.setValueAt(KodeBank.getText(), tbJnsPerawatan.
                            getSelectedRow(), 2);
                    tabMode.setValueAt(BankTujuan.getText(), tbJnsPerawatan.
                            getSelectedRow(), 3);
                    tabMode.setValueAt(KodeTransaksi.getText(), tbJnsPerawatan.
                            getSelectedRow(), 4);
                    emptTeks();
                } else {
                    JOptionPane.showMessageDialog(null,
                            "Maaf, gagal mengubah data...!!!!");
                }
            }
        }
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptMandiriKodeTransaksiTujuanTransfer.jasper",
                    "report",
                    "::[ Kode Transaksi Bank Tujuan Transfer Bank Mandiri ]::",
                    param);
        }
...
private void btnBankActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBankActionPerformed
    banktujuan.isCek();
    banktujuan.setSize(internalFrame1.getWidth() - 20, internalFrame1.
            getHeight() - 20);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MandiriKodeTransaksiTujuanTransfer dialog = new MandiriKodeTransaksiTujuanTransfer(
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kode_metode"), rs.
                        getString("nama_metode"),
                        rs.getString("kode_bank"), rs.getString("nama_bank"),
    ...
    private void getData() {
        if (tbJnsPerawatan.getSelectedRow() != -1) {
            KodeMetode.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 0).toString());
            MetodePembayaran.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 1).toString());
            KodeBank.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 2).toString());
            BankTujuan.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 3).toString());
            KodeTransaksi.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
    ...
    public void isCek() {
        BtnSimpan.setEnabled(akses.
                getkodetransaksi_tujuan_transfer_bankmandiri());
        BtnHapus.
                setEnabled(akses.getkodetransaksi_tujuan_transfer_bankmandiri());
    ...
    private static final Logger LOG = Logger.getLogger(
            MandiriKodeTransaksiTujuanTransfer.class.getName());
