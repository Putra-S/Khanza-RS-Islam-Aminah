...
public class MandiriKodeTransaksiTujuanTransfer extends javax.swing.JDialog {
    ...
    public MandiriKodeTransaksiTujuanTransfer(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Kode Metode", "Metode Pembayaran", "Kode Bank",
            ...
            public void windowClosed(WindowEvent e) {
                if (metodepembayaran.getTable().getSelectedRow() != -1) {
                    KodeMetode.setText(metodepembayaran.getTable()
                            .getValueAt(metodepembayaran.getTable().getSelectedRow(), 0)
                            .toString());
                    MetodePembayaran.setText(metodepembayaran.getTable()
                            .getValueAt(metodepembayaran.getTable().getSelectedRow(), 1)
                            .toString());
        ...
        banktujuan.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (banktujuan.getTable().getSelectedRow() != -1) {
                    KodeBank.setText(
                            banktujuan.getTable().getValueAt(banktujuan.getTable().getSelectedRow(), 0).toString());
                    BankTujuan.setText(
                            banktujuan.getTable().getValueAt(banktujuan.getTable().getSelectedRow(), 1).toString());
...
private void btnBankActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBankActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MandiriKodeTransaksiTujuanTransfer dialog = new MandiriKodeTransaksiTujuanTransfer(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kode_metode"), rs.getString("nama_metode"),
                        rs.getString("kode_bank"), rs.getString("nama_bank"), rs.getString("kode_transaksi")});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(MandiriKodeTransaksiTujuanTransfer.class.getName());
