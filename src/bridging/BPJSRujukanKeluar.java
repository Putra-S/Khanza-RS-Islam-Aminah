...
public class BPJSRujukanKeluar extends javax.swing.JDialog {
    ...
    public BPJSRujukanKeluar(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No.SEP", "No.Rawat", "No.RM", "Nama Pasien", "Tgl.Rujukan", "No.Rujukan", "Kode PPK",
            "Nama PPK Rujukan", "Jenis Pelayanan", "Tipe Rujukan", "Catatan", "Kode Diagnosa", "Nama Diagnosa",
    ...
    private static final Logger LOG = Logger.getLogger(BPJSRujukanKeluar.class.getName());
