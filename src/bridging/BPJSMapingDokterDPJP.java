 ...
 * @author dosen
 */
public class BPJSMapingDokterDPJP extends javax.swing.JDialog {
    ...
    private BPJSCekReferensiDokterDPJP polipcare = new BPJSCekReferensiDokterDPJP(
            null, false);
    ...
    public BPJSMapingDokterDPJP(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Dokter RS", "Nama Dokter RS",
                    "Kode DPJP VClaim", "Nama Dokter DPJP VClaim"}) {
            @Override
        ...
        polipcare.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (polipcare.getTable().getSelectedRow() != -1) {
                    KdPoliPCare
                            .setText(polipcare.getTable().getValueAt(polipcare.
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (KdPoliPCare.getText().trim().isEmpty() || NmPoliPCare.
                getText().trim().isEmpty()) {
            Valid.textKosong(KdPoliPCare, "Dokter PCare");
        } else {
            if (Sequel.menyimpantf("maping_dokter_dpjpvclaim", "?,?,?",
                    "Mapping Dokter", 3, new String[]{
                        kdpoli.getText(), KdPoliPCare.getText(), NmPoliPCare.
                        getText()
                    }) == true) {
                tampil();
                emptTeks();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode, kdpoli, "maping_dokter_dpjpvclaim",
                "kd_dokter");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdpoli.getText().trim().isEmpty() || TPoli.getText().trim().
            ...
            if (tbJnsPerawatan.getSelectedRow() > -1) {
                if (Sequel.mengedittf("maping_dokter_dpjpvclaim", "kd_dokter=?",
                        "kd_dokter=?,kd_dokter_bpjs=?,nm_dokter_bpjs=?", 4,
                        new String[]{
                            kdpoli.getText(), KdPoliPCare.getText(),
                            NmPoliPCare.getText(), tbJnsPerawatan.getValueAt(
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptMapingDokterDPJPVClaim.jasper", "report",
                    "::[ Mapping Dokter RS & DPJP VClaim ]::", param);
        }
...
private void btnPoliBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliBPJSActionPerformed
    polipcare.setSize(internalFrame1.getWidth() - 20,
            internalFrame1.getHeight() - 20);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSMapingDokterDPJP dialog = new BPJSMapingDokterDPJP(
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kd_dokter"), rs.
                        getString("nm_dokter"),
    ...
    private void getData() {
        if (tbJnsPerawatan.getSelectedRow() != -1) {
            ...
            TPoli.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 1).toString());
            KdPoliPCare.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 2).toString());
            NmPoliPCare.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSMapingDokterDPJP.class.getName());
