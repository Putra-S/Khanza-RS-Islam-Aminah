...
public class BPJSMapingDokterDPJP extends javax.swing.JDialog {
    ...
    public BPJSMapingDokterDPJP(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Dokter RS", "Nama Dokter RS", "Kode DPJP VClaim", "Nama Dokter DPJP VClaim"}) {
            @Override
...
private void btnPoliBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliBPJSActionPerformed
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kd_dokter"), rs.getString("nm_dokter"),
    ...
    private static final Logger LOG = Logger.getLogger(BPJSMapingDokterDPJP.class.getName());
