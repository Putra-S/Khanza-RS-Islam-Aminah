...
public class SatuSehatKirimSpecimenLabPK extends javax.swing.JDialog {
    ...
    public SatuSehatKirimSpecimenLabPK(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"P", "No.Rawat", "No.RM", "Nama Pasien",
                    ...
                    "Tgl & Jam Sampel", "Detail Pemeriksaan", "Lab Code",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimSpecimenLabPK dialog = new SatuSehatKirimSpecimenLabPK(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString("no_rawat"),
                        ...
                        "jam_sampel"), rs.getString("Pemeriksaan"),
                        ...
                        "id_template"), rs.getString("id_specimen"),
    ...
    private static final Logger LOG = Logger.getLogger(
            SatuSehatKirimSpecimenLabPK.class.getName());
