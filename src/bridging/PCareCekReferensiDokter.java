 ...
 * @author dosen
 */
public class PCareCekReferensiDokter extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariPCAREReferensiDokter.jasper", "report",
                    "[ Pencarian Referensi Dokter ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiDokter dialog = new PCareCekReferensiDokter(
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kdDokter").asText().toLowerCase().
                                contains(diagnosa.toLowerCase())
                                || list.path("nmDokter").asText().toLowerCase().
                                        contains(diagnosa.toLowerCase())) {
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareCekReferensiDokter.class.getName());
