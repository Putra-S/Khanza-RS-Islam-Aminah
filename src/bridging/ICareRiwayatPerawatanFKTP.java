 ...
 * @author dosen
 */
public class ICareRiwayatPerawatanFKTP extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ICareRiwayatPerawatanFKTP dialog = new ICareRiwayatPerawatanFKTP(
    ...
    public void tampil() {
        try {
            ...
            // System.out.println("X-authorization:"+"Basic
            ...
            requestJson = mapper.writeValueAsString(
                    api.getRest().exchange(link + "/validate", HttpMethod.POST,
                        ...
                        .addListener(
                                (ObservableValue<? extends String> observable, String oldValue, final String newValue) -> {
                                    SwingUtilities.invokeLater(() -> {
                                        ICareRiwayatPerawatanFKTP.this.setTitle(
                                                newValue);
                                    });
                                });
    ...
    private static final Logger LOG = Logger.getLogger(
            ICareRiwayatPerawatanFKTP.class.getName());
