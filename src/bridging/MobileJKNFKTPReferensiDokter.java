...
public class MobileJKNFKTPReferensiDokter extends javax.swing.JDialog {
    ...
    public MobileJKNFKTPReferensiDokter(java.awt.Frame parent, boolean modal) {
        ...
        setSize(628, 674);
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Unit/Poli", "Nama Unit/Poli", "Kode Sub",
            "Nama Sub Spesialis", "Kode Dokter", "Nama Dokter", "Jam Praktek", "Kapasitas"}) {
            @Override
    ...
    public void tampil() {
        try {
            ...
            root = mapper.readTree(api.getRest()
                    .exchange(link + "/ref/poli/tanggal/" + Valid.SetTgl(Tanggal.getSelectedItem() + ""), HttpMethod.GET,
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        ...
                        System.out.println("URL : " + link + "/ref/dokter/kodepoli/" + list.path("kodepoli").asText()
                        ...
                        root2 = mapper.readTree(api.getRest()
                                .exchange(
                                        link + "/ref/dokter/kodepoli/" + list.path("kodepoli").asText() + "/tanggal/"
                                ...
                                for (JsonNode list2 : response2) {
                                    if (list2.path("kodedokter")
                                        ...
                                        tabMode.addRow(new Object[]{i + ".", list.path("kodepoli").asText(),
                                            list.path("namapoli").asText(), list.path("kdsubspesialis").asText(),
                                            list.path("nmsubspesialis").asText(), list2.path("kodedokter").asText(),
                                            list2.path("namadokter").asText(), list2.path("jampraktek").asText(),
    ...
    private static final Logger LOG = Logger.getLogger(MobileJKNFKTPReferensiDokter.class.getName());
