 ...
 * @author dosen
 */
public class BPJSCekReferensiPoli extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariBPJSReferensiPoli.jasper", "report",
                    "[ Pencarian Referensi Poli ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiPoli dialog = new BPJSCekReferensiPoli(
    ...
    public void tampil(String poli) {
        try {
            ...
            // System.out.println(api.getRest().exchange(URL, HttpMethod.GET,
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSCekReferensiPoli.class.getName());
