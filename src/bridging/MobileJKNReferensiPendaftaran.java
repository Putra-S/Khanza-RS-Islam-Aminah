...
public class MobileJKNReferensiPendaftaran extends javax.swing.JDialog {
    ...
    public MobileJKNReferensiPendaftaran(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Rawat", "No.RM", "Nama Pasien", "No.HP", "No.Kartu", "NIK", "Tanggal", "Poliklinik",
                    "Dokter", "Jam Praktek", "Jenis Kunjungan", "Nomor Referensi", "Status", "Validasi Checkin",
                    "No.Booking"}) {
            @Override
                ...
                try {
                    ...
                    requestJson = "{"
                            + "\"kodebooking\": \"" + tbJnsPerawatan.getValueAt(
                                    ...
                                    toString() + "\","
                            + "\"keterangan\": \"Pembatalan Di Lakukan Otomatis Oleh System Rumah Sakit Karena Ada Perubahan Jadwal/Jam Praktek Dokter\""
                            + "}";
                        ...
                        Sequel.queryu2(
                                "delete from referensi_mobilejkn_bpjs_taskid where taskid='99' and no_rawat='" + tbJnsPerawatan.
                                        getValueAt(tbJnsPerawatan.
                                                getSelectedRow(), 0).toString() + "'");
                        Sequel.queryu2(
                                "delete from reg_periksa where no_rawat='" + tbJnsPerawatan.
                                        getValueAt(tbJnsPerawatan.
                                                getSelectedRow(), 0).toString() + "'");
                    }
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("no_rawat"), rs.getString("norm"),
                        rs.getString("nm_pasien"), rs.getString("nohp"), rs.getString("nomorkartu"),
    ...
    private static final Logger LOG = Logger.getLogger(MobileJKNReferensiPendaftaran.class.getName());
