...
public class InhealthTindakanRanap extends javax.swing.JDialog {
    ...
    public InhealthTindakanRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Kode RS", "Nama Tindakan Ranap", "Ttl Biaya Dr",
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kd_jenis_prw"), rs.getString("nm_perawatan"),
                        Valid.SetAngka(rs.getDouble("total_byrdr")), Valid.SetAngka(rs.getDouble("total_byrpr")),
                        Valid.SetAngka(rs.getDouble("total_byrdrpr")), rs.getString("kd_inhealth")});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(InhealthTindakanRanap.class.getName());
