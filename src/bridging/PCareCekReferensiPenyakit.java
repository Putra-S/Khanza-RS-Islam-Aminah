...
public class PCareCekReferensiPenyakit extends javax.swing.JDialog {
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        tabMode.addRow(new Object[]{i + ".", list.path("kdDiag").asText(),
                            list.path("nmDiag").asText(), list.path("nonSpesialis").asText()});
                        i++;
                    }
                }
            } else {
    ...
    private static final Logger LOG = Logger.getLogger(PCareCekReferensiPenyakit.class.getName());
