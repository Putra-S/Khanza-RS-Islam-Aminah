 ...
 * @author dosen
 */
public class PCareCekReferensiPenyakit extends javax.swing.JDialog {
    ...
    public PCareCekReferensiPenyakit(java.awt.Frame parent, boolean modal) {
        ...
        setSize(628, 674);
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode ICD X",
            "Nama Penyakit", "Non Spesialis"}) {
            @Override
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariPCAREReferensiDiagnosa.jasper", "report",
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        ...
        if (diagnosa.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null,
                    "Silahkan masukkan diagnosa terlebih dahulu..!!!");
        } else {
            tampil(diagnosa.getText());
        }
        this.setCursor(Cursor.getDefaultCursor());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiPenyakit dialog = new PCareCekReferensiPenyakit(
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        tabMode.addRow(new Object[]{i + ".",
                            list.path("kdDiag").asText(),
                            list.path("nmDiag").asText(), list.path(
                            "nonSpesialis").asText()});
                        i++;
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareCekReferensiPenyakit.class.getName());
