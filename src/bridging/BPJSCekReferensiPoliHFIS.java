...
public class BPJSCekReferensiPoliHFIS extends javax.swing.JDialog {
    ...
    public BPJSCekReferensiPoliHFIS(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"No.", "Kode Poli", "Nama Poli", "Kode Subspesialis", "Nama Subspesialis"}) {
            @Override
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        if (list.path("nmpoli").asText().toLowerCase().contains(poli.toLowerCase())
                            ...
                            tabMode.addRow(new Object[]{i + ".", list.path("kdpoli").asText(),
                                list.path("nmpoli").asText(), list.path("kdsubspesialis").asText(),
    ...
    private static final Logger LOG = Logger.getLogger(BPJSCekReferensiPoliHFIS.class.getName());
