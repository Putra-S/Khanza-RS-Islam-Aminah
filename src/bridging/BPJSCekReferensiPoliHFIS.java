 ...
 * @author dosen
 */
public class BPJSCekReferensiPoliHFIS extends javax.swing.JDialog {
    ...
    public BPJSCekReferensiPoliHFIS(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"No.", "Kode Poli", "Nama Poli",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiPoliHFIS dialog = new BPJSCekReferensiPoliHFIS(
            ...
            if (nameNode.path("code").asText().equals("1")) {
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        if (list.path("nmpoli").asText().toLowerCase().contains(
                                poli.toLowerCase())
                                ...
                                || list.path("kdsubspesialis").asText().
                                        toLowerCase().contains(poli.
                                                toLowerCase())
                                || list.path("kdpoli").asText().toLowerCase().
                                        contains(poli.toLowerCase())) {
                            tabMode.addRow(new Object[]{i + ".", list.path(
                                "kdpoli").asText(),
                                list.path("nmpoli").asText(), list.path(
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSCekReferensiPoliHFIS.class.getName());
