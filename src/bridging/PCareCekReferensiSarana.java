 ...
 * @author dosen
 */
public class PCareCekReferensiSarana extends javax.swing.JDialog {
    ...
    public PCareCekReferensiSarana(java.awt.Frame parent, boolean modal) {
        ...
        setSize(628, 674);
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Sarana",
            "Nama Sarana"}) {
            @Override
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariPCAREReferensiSarana.jasper", "report",
                    "[ Pencarian Referensi Sarana ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiSarana dialog = new PCareCekReferensiSarana(
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kdSarana").asText().toLowerCase().
                                contains(diagnosa.toLowerCase())
                                || list.path("nmSarana").asText().toLowerCase().
                                        contains(diagnosa.toLowerCase())) {
                            tabMode.addRow(new Object[]{i + ".", list.path(
                                "kdSarana").asText(),
                                list.path("nmSarana").asText()});
                            i++;
                        }
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareCekReferensiSarana.class.getName());
