...
public class ApiCareStream {
        ...
        while (rs.next()) {
          ...
          requestJson =
              "{"
                  ...
                  + "\"last_name\": \"\","
                  + "\"sex\": \""
                  + rs.getString("jk").replaceAll("L", "M").replaceAll("P", "F")
                  + "\","
                  + "\"birthDate\": \""
                  ...
                  + "\","
                  + "\"modality\": \""
                  + rs.getString("kd_jenis_prw").substring(0, 2)
                  + "\","
                  + "\"clinicalDiagnosis\": \""
          ...
          stringbalik =
              getRest()
                  .exchange(URL + "/putOrder/", HttpMethod.POST, requestEntity, String.class)
                  .getBody();
  ...
  private static final Logger LOG = Logger.getLogger(ApiCareStream.class.getName());
}
