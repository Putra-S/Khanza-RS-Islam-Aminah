 ...
 * @author dosen
 */
public class PCareCekReferensiSpesialis extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariPCAREReferensiSpesialis.jasper", "report",
                    "[ Pencarian Referensi Unit/Spesialis ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiSpesialis dialog = new PCareCekReferensiSpesialis(
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kdSpesialis").asText().toLowerCase().
                                contains(diagnosa.toLowerCase())
                                || list.path("nmSpesialis").asText().
                                        toLowerCase().contains(diagnosa.
                                                toLowerCase())) {
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareCekReferensiSpesialis.class.getName());
