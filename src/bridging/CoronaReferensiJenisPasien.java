 ...
 * @author dosen
 */
public class CoronaReferensiJenisPasien extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            CoronaReferensiJenisPasien dialog = new CoronaReferensiJenisPasien(
    ...
    public void tampil() {
        try {
            ...
            root = mapper.readTree(api.getRest()
                    .exchange(link + "/Referensi/jenis_pasien", HttpMethod.GET,
            ...
            if (response.isArray()) {
                for (JsonNode list : response) {
                    if (list.path("deskripsi").asText().toLowerCase().contains(
                            TCari.getText().toLowerCase())) {
                        tabMode.addRow(new Object[]{
                            list.path("id_jenis_pasien").asText(),
    ...
    private static final Logger LOG = Logger.getLogger(
            CoronaReferensiJenisPasien.class.getName());
