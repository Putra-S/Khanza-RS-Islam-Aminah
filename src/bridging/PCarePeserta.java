 ...
 * @author dosen
 */
public class PCarePeserta extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCarePeserta dialog = new PCarePeserta(new javax.swing.JFrame(),
                    true);
    ...
    public void tampil(String nopeserta) {
        try {
            ...
            root = mapper.readTree(
                    api.getRest().exchange(URL + nopeserta, HttpMethod.GET,
    ...
    private static final Logger LOG = Logger.getLogger(PCarePeserta.class.
            getName());
