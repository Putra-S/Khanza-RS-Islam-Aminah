...
public class SatuSehatMapingVaksin extends javax.swing.JDialog {
    ...
    public SatuSehatMapingVaksin(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Vaksin Code", "Vaksin System", "Kode Vaksin",
                    "Nama Vaksin", "Vaksin Display",
                    "Route Code", "Route System", "Route Display", "Dose Code",
                    "Dose System", "Dose Unit"}) {
            @Override
        ...
        VaksinSystem.setDocument(new batasInput((byte) 100).
                getKata(VaksinSystem));
        VaksinDisplay.setDocument(new batasInput((byte) 80).getKata(
                VaksinDisplay));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (VaksinCode.getText().trim().isEmpty()) {
            Valid.textKosong(VaksinCode, "Vaksin Code");
        } else if (VaksinSystem.getText().trim().isEmpty()) {
        ...
        } else if (VaksinDisplay.getText().trim().isEmpty()) {
        ...
        } else if (DoseCode.getText().trim().isEmpty()) {
            Valid.textKosong(DoseCode, "Dose Code");
        } else if (DoseSystem.getText().trim().isEmpty()) {
            Valid.textKosong(DoseSystem, "Dose System");
        } else if (DoseUnit.getText().trim().isEmpty()) {
            Valid.textKosong(DoseUnit, "Dose Unit");
        } else {
            if (Sequel.menyimpantf("satu_sehat_mapping_vaksin",
                    "?,?,?,?,?,?,?,?,?,?", "Mapping Vaksin", 10, new String[]{
                        KodeBarang.getText(), VaksinCode.getText(),
                        VaksinSystem.getText(), VaksinDisplay.getText(),
                        RouteCode.getText(),
                        RouteSystem.getText(), RouteDisplay.getText(), DoseCode.
                        getText(), DoseSystem.getText(), DoseUnit.getText()
                    }) == true) {
                tabMode.addRow(new String[]{
                    VaksinCode.getText(), VaksinSystem.getText(), KodeBarang.
                    getText(), NamaBarang.getText(), VaksinDisplay.getText(),
                    RouteCode.getText(), RouteSystem.getText(), RouteDisplay.
                    getText(), DoseCode.getText(), DoseSystem.getText(),
                    DoseUnit.getText()
                });
                emptTeks();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (Valid.hapusTabletf(tabMode, KodeBarang, "satu_sehat_mapping_vaksin",
                "kode_brng") == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (VaksinCode.getText().trim().isEmpty()) {
            ...
            if (tbJnsPerawatan.getSelectedRow() > -1) {
                if (Sequel.
                        mengedittf("satu_sehat_mapping_vaksin", "kode_brng=?",
                                "kode_brng=?,vaksin_code=?,vaksin_system=?,vaksin_display=?,"
                                + "route_code=?,route_system=?,route_display=?,dose_quantity_code=?,dose_quantity_system=?,dose_quantity_unit=?",
                                11, new String[]{
                            KodeBarang.getText(), VaksinCode.getText(),
                            VaksinSystem.getText(), VaksinDisplay.getText(),
                            RouteCode.getText(),
                            RouteSystem.getText(), RouteDisplay.getText(),
                            DoseCode.getText(), DoseSystem.getText(), DoseUnit.
                            getText(),
                    ...
                    tabMode.setValueAt(KodeBarang.getText(), tbJnsPerawatan.
                            getSelectedRow(), 0);
                    tabMode.setValueAt(VaksinCode.getText(), tbJnsPerawatan.
                            getSelectedRow(), 1);
                    tabMode.setValueAt(VaksinSystem.getText(), tbJnsPerawatan.
                            getSelectedRow(), 2);
                    tabMode.setValueAt(VaksinDisplay.getText(), tbJnsPerawatan.
                            getSelectedRow(), 3);
                    ...
                    tabMode.setValueAt(RouteDisplay.getText(), tbJnsPerawatan.
                            getSelectedRow(), 6);
                    tabMode.setValueAt(DoseCode.getText(), tbJnsPerawatan.
                            getSelectedRow(), 7);
                    tabMode.setValueAt(DoseSystem.getText(), tbJnsPerawatan.
                            getSelectedRow(), 8);
                    tabMode.setValueAt(DoseUnit.getText(), tbJnsPerawatan.
                            getSelectedRow(), 9);
                    emptTeks();
                }
            }
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptMapingVaksinSatuSehat.jasper", "report",
                    "::[ Mapping Vaksin Satu Sehat Kemenkes ]::", param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatMapingVaksin dialog = new SatuSehatMapingVaksin(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    : "where satu_sehat_mapping_vaksin.kode_brng like ? or databarang.nama_brng like ? or "
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("vaksin_code"), rs.
                        getString("vaksin_system"),
                        ...
                        rs.getString("dose_quantity_code"), rs.getString(
    ...
    private void getData() {
        if (tbJnsPerawatan.getSelectedRow() != -1) {
            VaksinCode.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 0).toString());
            VaksinSystem.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
            ...
            VaksinDisplay.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
            ...
            DoseCode.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 8).toString());
            DoseSystem.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 9).toString());
            DoseUnit.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
    ...
    private static final Logger LOG = Logger.getLogger(
            SatuSehatMapingVaksin.class.getName());
