...
public class SatuSehatMapingVaksin extends javax.swing.JDialog {
    ...
    public SatuSehatMapingVaksin(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Vaksin Code", "Vaksin System", "Kode Vaksin", "Nama Vaksin", "Vaksin Display",
                    "Route Code", "Route System", "Route Display", "Dose Code", "Dose System", "Dose Unit"}) {
            @Override
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("vaksin_code"), rs.getString("vaksin_system"),
                        rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("vaksin_display"),
                        rs.getString("route_code"), rs.getString("route_system"), rs.getString("route_display"),
                        rs.getString("dose_quantity_code"), rs.getString("dose_quantity_system"),
    ...
    private static final Logger LOG = Logger.getLogger(SatuSehatMapingVaksin.class.getName());
