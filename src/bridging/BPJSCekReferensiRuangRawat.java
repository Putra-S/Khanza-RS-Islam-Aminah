 ...
 * @author dosen
 */
public class BPJSCekReferensiRuangRawat extends javax.swing.JDialog {
    ...
    public BPJSCekReferensiRuangRawat(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Ruang",
            "Nama Ruang"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiRuangRawat dialog = new BPJSCekReferensiRuangRawat(
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSCekReferensiRuangRawat.class.getName());
