 ...
 * @author dosen
 */
public class SisruteCekReferensiAlasanRujuk extends javax.swing.JDialog {
    ...
    public SisruteCekReferensiAlasanRujuk(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Alasan",
            "Alasan Rujuk"}) {
            @Override
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariSisruteReferensiAlasanRujuk.jasper",
                    "report", "[ Pencarian Referensi Alasan Rujuk ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SisruteCekReferensiAlasanRujuk dialog = new SisruteCekReferensiAlasanRujuk(
    ...
    private static final Logger LOG = Logger.getLogger(
            SisruteCekReferensiAlasanRujuk.class.getName());
