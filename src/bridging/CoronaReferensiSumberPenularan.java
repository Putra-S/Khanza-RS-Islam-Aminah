 ...
 * @author dosen
 */
public class CoronaReferensiSumberPenularan extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            CoronaReferensiSumberPenularan dialog = new CoronaReferensiSumberPenularan(
    ...
    public void tampil() {
        try {
            ...
            root = mapper.readTree(api.getRest()
                    .exchange(link + "/Referensi/sebab_penularan",
            ...
            if (response.isArray()) {
                for (JsonNode list : response) {
                    if (list.path("sources").asText().toLowerCase().contains(
                            TCari.getText().toLowerCase())) {
                        tabMode.addRow(new Object[]{list.path("id_source").
                            asText(), list.path("sources").asText()});
                    }
                }
            }
    ...
    private static final Logger LOG = Logger.getLogger(
            CoronaReferensiSumberPenularan.class.getName());
