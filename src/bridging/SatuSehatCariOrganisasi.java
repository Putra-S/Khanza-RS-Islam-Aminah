...
public class SatuSehatCariOrganisasi extends javax.swing.JDialog {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    iyem = iyem + "{\"KodeDepartemen\":\"" + rs.getString(1) + "\",\"NamaDepartemen\":\""
                            + rs.getString(2) + "\",\"IdOrganisasi\":\"" + rs.getString(3) + "\"},";
                }
            } catch (Exception e) {
        ...
        try {
            ...
            if (response.isArray()) {
                for (JsonNode list : response) {
                    if (list.path("KodeDepartemen").asText().toLowerCase().contains(TCari.getText().toLowerCase())
                            || list.path("NamaDepartemen")
                                    .asText()
                                    .toLowerCase()
                                    .contains(TCari.getText().toLowerCase())) {
                        tabMode.addRow(new Object[]{list.path("KodeDepartemen").asText(),
                            list.path("NamaDepartemen").asText(), list.path("IdOrganisasi").asText()});
                    }
                }
            }
            myObj.close();
    ...
    private static final Logger LOG = Logger.getLogger(SatuSehatCariOrganisasi.class.getName());
