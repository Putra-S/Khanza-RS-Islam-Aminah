...
public class PCareCariKegiatanKelompok extends javax.swing.JDialog {
    ...
    public PCareCariKegiatanKelompok(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"No.", "Club ID", "Kode", "Nama Program", "Tgl.Mulai", "Tgl.Akhir", "Alamat Club",
                    "Nama Club", "No.HP Ketua", "Nama Ketua Club", "Edu Id", "Pelayanan", "Kegiatan", "Kelompok",
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        tabMode.addRow(new Object[]{i + ".", list.path("clubProl").path("clubId").asText(),
                            ...
                            list.path("clubProl").path("ketua_nama").asText(), list.path("eduId").asText(),
    ...
    private static final Logger LOG = Logger.getLogger(PCareCariKegiatanKelompok.class.getName());
