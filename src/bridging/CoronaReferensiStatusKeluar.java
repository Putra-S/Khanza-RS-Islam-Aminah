 ...
 * @author dosen
 */
public class CoronaReferensiStatusKeluar extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            CoronaReferensiStatusKeluar dialog = new CoronaReferensiStatusKeluar(
    ...
    public void tampil() {
        try {
            ...
            root = mapper.readTree(api.getRest()
                    .exchange(link + "/Referensi/status_keluar", HttpMethod.GET,
            ...
            if (response.isArray()) {
                for (JsonNode list : response) {
                    if (list.path("status").asText().toLowerCase().contains(
                            TCari.getText().toLowerCase())) {
                        tabMode.addRow(new Object[]{list.path("id_status").
    ...
    private static final Logger LOG = Logger.getLogger(
            CoronaReferensiStatusKeluar.class.getName());
