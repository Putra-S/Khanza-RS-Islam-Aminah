...
public class InhealthTindakanRadiologi extends javax.swing.JDialog {
    ...
    private DlgJnsPerawatanRadiologi barang = new DlgJnsPerawatanRadiologi(null, false);
    ...
    public InhealthTindakanRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode RS", "Nama Tindakan Radiologi", "Tarif", "Kode Inhealth"}) {
            @Override
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kd_jenis_prw"), rs.getString("nm_perawatan"),
                        Valid.SetAngka(rs.getDouble("total_byr")), rs.getString("kd_inhealth")});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(InhealthTindakanRadiologi.class.getName());
