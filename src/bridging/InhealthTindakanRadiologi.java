 ...
 * @author dosen
 */
public class InhealthTindakanRadiologi extends javax.swing.JDialog {
    ...
    private DlgJnsPerawatanRadiologi barang = new DlgJnsPerawatanRadiologi(null,
            false);
    ...
    public InhealthTindakanRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode RS", "Nama Tindakan Radiologi", "Tarif",
                    "Kode Inhealth"}) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdtindakan.getText().trim().isEmpty() || TTindakan.getText().trim().
            ...
            if (Sequel.menyimpantf("inhealth_tindakan_radiologi", "?,?",
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode, kdtindakan, "inhealth_tindakan_radiologi",
                "kd_jenis_prw");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdtindakan.getText().trim().isEmpty() || TTindakan.getText().trim().
            ...
            if (tbJnsPerawatan.getSelectedRow() > -1) {
                if (Sequel.mengedittf("inhealth_tindakan_radiologi",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.
                    MyReport("rptMapingTindakanInhealthRadiologi.jasper",
                            "report", "::[ Mapping Tarif Radiologi Inhealth ]::",
                            param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InhealthTindakanRadiologi dialog = new InhealthTindakanRadiologi(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kd_jenis_prw"),
                        ...
                        Valid.SetAngka(rs.getDouble("total_byr")), rs.getString(
                        "kd_inhealth")});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(
            InhealthTindakanRadiologi.class.getName());
