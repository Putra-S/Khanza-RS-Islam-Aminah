...
//            Valid.pindah(evt,Poli,BtnPrint);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSDataAntreanPerTanggal dialog = new BPJSDataAntreanPerTanggal(
    ...
    public void tampil() {
        try {
            ...
            URL = link + "/antrean/pendaftaran/tanggal/" + Valid.SetTgl(Tanggal.
                    getSelectedItem() + "");
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        ...
                        tabMode.addRow(new Object[]{i + ".", list.path(
                            ...
                            path("status").asText()});
                        if (list.path("status").asText().
                                equals("Belum dilayani")) {
                            tot_belum += 1;
                        }
                        ...
                        if (list.path("status").asText().
                                equals("Belum dilayani")
                                && list.path("sumberdata").asText().equals(
                                        "Bridging Antrean")
        ...
        sep = Sequel
                .cariInteger(
                        "select count(bridging_sep.no_rawat) from bridging_sep where bridging_sep.tglsep = '"
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSDataAntreanPerTanggal.class.getName());
