 ...
 * @author dosen
 */
public class InhealthCekReferensiPoli extends javax.swing.JDialog {
    ...
    private String kodeppk = Sequel.cariIsi(
            "select kode_ppkinhealth from setting"), requestJson = "";
    ...
    public InhealthCekReferensiPoli(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Poli",
            "Nama Poli"}) {
            @Override
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariInhealthReferensiPoli.jasper", "report",
                    "[ Pencarian Referensi Poli Inhealth ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InhealthCekReferensiPoli dialog = new InhealthCekReferensiPoli(
    ...
    public void tampil(String poli) {
        try {
            ...
            requestJson = "{ \"token\": \"" + koneksiDB.TOKENINHEALTH() + "\"," + "\"kodeprovider\": \"" + kodeppk
                    + "\"," + "\"keyword\": \"" + poli + "\"" + "}";
            HttpEntity requestEntity = new HttpEntity(requestJson, headers);
            RestTemplate rest = new RestTemplate();
            ObjectMapper mapper = new ObjectMapper();
            // System.out.println("Data : "+rest.exchange(URL, HttpMethod.POST,
            ...
            if (root.isArray()) {
                ...
                for (JsonNode list : root) {
                    if (list.path("STATUS").asText().equals("True")) {
                        tabMode.addRow(
                                new Object[]{i + ".", list.path("KDPOLI").
                                            asText(), list.path("NMPOLI").
                                            asText()});
                        i++;
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(
            InhealthCekReferensiPoli.class.getName());
