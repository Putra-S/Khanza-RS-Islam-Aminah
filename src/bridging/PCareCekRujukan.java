...
public class PCareCekRujukan extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekRujukan dialog = new PCareCekRujukan(
    ...
    public void tampil(String diagnosa) {
        try {
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                tabMode.addRow(new Object[]{"No.Rujukan", ": " + response.path(
                    "noRujukan").asText()});
                tabMode.addRow(new Object[]{"PPK", ": " + response.path("ppk").
                    path("kdPPK").asText() + " "
                    + response.path("ppk").path("nmPPK").asText()});
                tabMode.addRow(new Object[]{"Alamat PPK", ": " + response.path(
                    "ppk").path("alamat").asText()});
                tabMode
                        .addRow(new Object[]{"Kantor Cabang", ": " + response.
                    path("ppk").path("kc").path("kdKC").asText()
                    + " " + response.path("ppk").path("kc").path("nmKC").
                    asText()});
                tabMode.addRow(
                        new Object[]{"Alamat KC", ": " + response.path("ppk").
                                    path("kc").path("alamat").asText()});
                tabMode
                        .addRow(new Object[]{"Telp KC", ": " + response.path(
                    "ppk").path("kc").path("telp").asText()});
                tabMode.addRow(new Object[]{"Fax KC", ": " + response.
                    path("ppk").path("kc").path("fax").asText()});
                tabMode.addRow(new Object[]{"Kota KC",
                    ": " + response.path("ppk").path("kc").path("dati").path(
                    "kdDati").asText() + " "
                    + response.path("ppk").path("kc").path("dati").
                    path("nmDati").asText()});
                tabMode.addRow(new Object[]{"Regional KC",
                    ": " + response.path("ppk").path("kc").path("kdKR").path(
                    "kdKR").asText() + " "
                    + response.path("ppk").path("kc").path("kdKR").path("nmKR").
                    asText()});
                tabMode.addRow(new Object[]{"Tgl.Kunjungan", ": " + response.
                    path("tglKunjungan").asText()});
                tabMode.addRow(new Object[]{"Poli Kunjungan", ": " + response.
                    path("poli").path("kdPoli").asText()
                ...
                tabMode.addRow(new Object[]{"Nama Peserta", ": " + response.
                    path("nmPst").asText()});
                tabMode.addRow(new Object[]{"Tgl.Lahir", ": " + response.path(
                    "tglLahir").asText()});
                tabMode.addRow(new Object[]{"J.K.", ": "
                    + response.path("sex").asText().replaceAll("P", "Perempuan").
                    replaceAll("L", "Laki-Laki")});
                tabMode.addRow(new Object[]{"Diagnosa", ": " + response.path(
                    "diag1").path("kdDiag").asText() + " "
                    + response.path("diag1").path("nmDiag").asText()});
                tabMode.addRow(new Object[]{"Dokter", ": " + response.path(
                    "dokter").path("kdDokter").asText() + " "
                    + response.path("dokter").path("nmDokter").asText()});
                tabMode.addRow(new Object[]{"TACC",
                    ": " + response.path("tacc").path("nmTacc").asText() + ", "
                    + response.path("tacc").path("alasanTacc").asText()});
                tabMode.addRow(new Object[]{"Info Denda", ": " + response.path(
                    "infoDenda").asText()});
            } else {
    ...
    private static final Logger LOG = Logger.getLogger(PCareCekRujukan.class.
            getName());
