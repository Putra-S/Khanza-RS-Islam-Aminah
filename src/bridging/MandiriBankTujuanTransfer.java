 ...
 * @author dosen
 */
public class MandiriBankTujuanTransfer extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("bank_tujuan_transfer_bankmandiri",
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbJabatan.getSelectedRow() != -1) {
            if (Sequel.meghapustf("bank_tujuan_transfer_bankmandiri",
                    "kode_bank", tbJabatan.
                            getValueAt(tbJabatan.getSelectedRow(), 0).toString()) == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbJabatan.getSelectedRow() > -1) {
                if (Sequel.mengedittf("bank_tujuan_transfer_bankmandiri",
                        "kode_bank=?", "kode_bank=?,nama_bank=?", 3,
                        new String[]{
                            TKd.getText(), TNm.getText(), tbJabatan.getValueAt(
                            tbJabatan.getSelectedRow(), 0).toString()
                        }) == true) {
                    tabMode.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MandiriBankTujuanTransfer dialog = new MandiriBankTujuanTransfer(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select bank_tujuan_transfer_bankmandiri.kode_bank, bank_tujuan_transfer_bankmandiri.nama_bank "
    ...
    private static final Logger LOG = Logger.getLogger(
            MandiriBankTujuanTransfer.class.getName());
