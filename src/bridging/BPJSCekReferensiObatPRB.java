 ...
 * @author dosen
 */
public class BPJSCekReferensiObatPRB extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariBPJSReferensiObatPRB.jasper", "report",
                    "[ Pencarian Referensi Obat PRB ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiObatPRB dialog = new BPJSCekReferensiObatPRB(
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSCekReferensiObatPRB.class.getName());
