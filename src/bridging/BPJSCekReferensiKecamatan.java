 ...
 * @author dosen
 */
public class BPJSCekReferensiKecamatan extends javax.swing.JDialog {
        ...
        kabupaten.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (kabupaten.getTable().getSelectedRow() != -1) {
                    ...
                    NmKab.setText(kabupaten.getTable().getValueAt(kabupaten.
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        if (KdKab.getText().trim().isEmpty() || NmKab.getText().trim().isEmpty()) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiKecamatan dialog = new BPJSCekReferensiKecamatan(
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSCekReferensiKecamatan.class.getName());
