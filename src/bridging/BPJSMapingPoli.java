...
public class BPJSMapingPoli extends javax.swing.JDialog {
    ...
    public BPJSMapingPoli(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Unit RS", "Nama Unit RS", "Kode Unit BPJS", "Nama Unit BPJS"}) {
            @Override
        ...
        polibpjs.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (polibpjs.getTable().getSelectedRow() != -1) {
                    KdPoliBPJS
                            .setText(polibpjs.getTable().getValueAt(polibpjs.getTable().getSelectedRow(), 1).toString());
                    NmPoliBPJS
                            .setText(polibpjs.getTable().getValueAt(polibpjs.getTable().getSelectedRow(), 2).toString());
...
private void btnPoliBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliBPJSActionPerformed
    ...
    private static final Logger LOG = Logger.getLogger(BPJSMapingPoli.class.getName());
