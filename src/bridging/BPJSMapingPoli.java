 ...
 * @author dosen
 */
public class BPJSMapingPoli extends javax.swing.JDialog {
    ...
    public BPJSMapingPoli(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Unit RS", "Nama Unit RS", "Kode Unit BPJS",
                    "Nama Unit BPJS"}) {
            @Override
        ...
        polibpjs.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (polibpjs.getTable().getSelectedRow() != -1) {
                    KdPoliBPJS
                            .setText(polibpjs.getTable().getValueAt(polibpjs.
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        } else if (KdPoliBPJS.getText().trim().isEmpty() || NmPoliBPJS.getText().
                trim().isEmpty()) {
            Valid.textKosong(KdPoliBPJS, "Unit BPJS");
        } else {
            if (Sequel.menyimpantf("maping_poli_bpjs", "?,?,?", "Mapping Unit",
                    3, new String[]{
                        kdpoli.getText(), KdPoliBPJS.getText(), NmPoliBPJS.
                        getText()
                    }) == true) {
                tampil();
                emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdpoli.getText().trim().isEmpty() || TPoli.getText().trim().
            ...
            if (tbJnsPerawatan.getSelectedRow() > -1) {
                if (Sequel.mengedittf("maping_poli_bpjs", "kd_poli_rs=?",
                        "kd_poli_rs=?,kd_poli_bpjs=?,nm_poli_bpjs=?", 4,
                        new String[]{
                            kdpoli.getText(), KdPoliBPJS.getText(), NmPoliBPJS.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptMapingPoliBPJS.jasper", "report",
                    "::[ Mapping Unit RS & BPJS ]::", param);
        }
...
private void btnPoliBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliBPJSActionPerformed
    polibpjs.setSize(internalFrame1.getWidth() - 20,
            internalFrame1.getHeight() - 20);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSMapingPoli dialog = new BPJSMapingPoli(new javax.swing.JFrame(),
                    true);
    ...
    private void getData() {
        if (tbJnsPerawatan.getSelectedRow() != -1) {
            ...
            TPoli.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 1).toString());
            KdPoliBPJS.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 2).toString());
            NmPoliBPJS.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
    ...
    private static final Logger LOG = Logger.getLogger(BPJSMapingPoli.class.
            getName());
