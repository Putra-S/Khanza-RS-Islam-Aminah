 ...
 * @author dosen
 */
public class PCareCekReferensiProvider extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariPCAREReferensiProvider.jasper", "report",
                    "[ Pencarian Referensi Provider ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiProvider dialog = new PCareCekReferensiProvider(
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kdProvider").asText().toLowerCase().
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareCekReferensiProvider.class.getName());
