 ...
 * @author dosen
 */
public class SisruteCekReferensiPelayanan extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariSisruteReferensiPelayanan.jasper",
                    "report", "[ Pencarian Referensi Pelayanan ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SisruteCekReferensiPelayanan dialog = new SisruteCekReferensiPelayanan(
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        if (list.path("kode").asText().toLowerCase().contains(
                                faskes.toLowerCase())
                                || list.path("pelayanan").asText().toLowerCase().
    ...
    private static final Logger LOG = Logger.getLogger(
            SisruteCekReferensiPelayanan.class.getName());
