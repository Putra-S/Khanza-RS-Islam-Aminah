 ...
 * @author dosen
 */
public class PCareMapingDokter extends javax.swing.JDialog {
    ...
    private PCareCekReferensiDokter polipcare = new PCareCekReferensiDokter(null,
            false);
    ...
    public PCareMapingDokter(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Dokter RS", "Nama Dokter RS",
                    "Kode Dokter PCare", "Nama Dokter PCare"}) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdpoli.getText().trim().isEmpty() || TPoli.getText().trim().
            ...
            if (Sequel.menyimpantf("maping_dokter_pcare", "?,?,?",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdpoli.getText().trim().isEmpty() || TPoli.getText().trim().
            ...
            if (tbJnsPerawatan.getSelectedRow() > -1) {
                if (Sequel.mengedittf("maping_dokter_pcare", "kd_dokter=?",
                        "kd_dokter=?,kd_dokter_pcare=?,nm_dokter_pcare=?", 4,
                        new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptMapingDokterPCare.jasper", "report",
                    "::[ Mapping Dokter RS & PCare ]::", param);
        }
...
private void btnPoliBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliBPJSActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareMapingDokter dialog = new PCareMapingDokter(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kd_dokter"), rs.
                        getString("nm_dokter"),
                        rs.getString("kd_dokter_pcare"), rs.getString(
                        "nm_dokter_pcare")});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(PCareMapingDokter.class.
            getName());
