...
public class PCareMapingDokter extends javax.swing.JDialog {
    ...
    public PCareMapingDokter(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Dokter RS", "Nama Dokter RS", "Kode Dokter PCare", "Nama Dokter PCare"}) {
            @Override
...
private void btnPoliBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliBPJSActionPerformed
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kd_dokter"), rs.getString("nm_dokter"),
                        rs.getString("kd_dokter_pcare"), rs.getString("nm_dokter_pcare")});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(PCareMapingDokter.class.getName());
