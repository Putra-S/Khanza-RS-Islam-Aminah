...
public class PCareCekReferensiTindakan extends javax.swing.JDialog {
    ...
    public PCareCekReferensiTindakan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"No.", "Kode Tindakan", "Nama Tindakan", "Maksimal Tarif"}) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kdTindakan").asText().toLowerCase().contains(key.toLowerCase())
                            ...
                            tabMode.addRow(new Object[]{i + ".", list.path("kdTindakan").asText(),
                                list.path("nmTindakan").asText(), list.path("maxTarif").asDouble()});
                            i++;
                        }
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(PCareCekReferensiTindakan.class.getName());
