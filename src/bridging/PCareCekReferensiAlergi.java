...
public class PCareCekReferensiAlergi extends javax.swing.JDialog {
    ...
    public void tampil(String diagnosa) {
        try {
            ...
            root = mapper.readTree(api.getRest()
                    .exchange(URL + Jenis.getSelectedItem().toString().substring(0, 2), HttpMethod.GET, requestEntity,
                            String.class)
                    .getBody());
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kdAlergi").asText().toLowerCase().contains(diagnosa.toLowerCase())
                            ...
                            tabMode.addRow(new Object[]{i + ".", list.path("kdAlergi").asText(),
    ...
    private static final Logger LOG = Logger.getLogger(PCareCekReferensiAlergi.class.getName());
