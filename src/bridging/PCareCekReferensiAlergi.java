 ...
 * @author dosen
 */
public class PCareCekReferensiAlergi extends javax.swing.JDialog {
    ...
    public PCareCekReferensiAlergi(java.awt.Frame parent, boolean modal) {
        ...
        setSize(628, 674);
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Alergi",
            "Nama Alergi"}) {
            @Override
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariPCAREReferensiAlergi.jasper", "report",
                    "[ Pencarian Referensi Alergi ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiAlergi dialog = new PCareCekReferensiAlergi(
    ...
    public void tampil(String diagnosa) {
        try {
            ...
            System.out.println("URL : " + URL + Jenis.getSelectedItem().
                    toString().substring(0, 2));
            root = mapper.readTree(api.getRest()
                    .exchange(URL + Jenis.getSelectedItem().toString().
                            substring(0, 2), HttpMethod.GET, requestEntity,
                            String.class)
                    .getBody());
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kdAlergi").asText().toLowerCase().
                                contains(diagnosa.toLowerCase())
                                || list.path("nmAlergi").asText().toLowerCase().
                                        contains(diagnosa.toLowerCase())) {
                            tabMode.addRow(new Object[]{i + ".", list.path(
                                "kdAlergi").asText(),
                                list.path("nmAlergi").asText()});
                            i++;
                        }
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareCekReferensiAlergi.class.getName());
