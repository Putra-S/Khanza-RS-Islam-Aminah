...
public class SatuSehatKirimServiceRequestLabPK extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimServiceRequestLabPK dialog = new SatuSehatKirimServiceRequestLabPK(new javax.swing.JFrame(),
                    true);
    ...
    private static final Logger LOG = Logger.getLogger(SatuSehatKirimServiceRequestLabPK.class.getName());
