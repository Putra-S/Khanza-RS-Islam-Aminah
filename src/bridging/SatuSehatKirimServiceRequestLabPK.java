 ...
 * @author dosen
 */
public class SatuSehatKirimServiceRequestLabPK extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SatuSehatKirimServiceRequestLabPK(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"P", "No.Rawat", "No.RM", "Nama Pasien",
                    ...
                    "ID Service Request", "ID Detail", "Kode Pemeriksaan"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimServiceRequestLabPK dialog = new SatuSehatKirimServiceRequestLabPK(
    ...
    private static final Logger LOG = Logger.getLogger(
            SatuSehatKirimServiceRequestLabPK.class.getName());
