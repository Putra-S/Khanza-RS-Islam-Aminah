 ...
 * @author dosen
 */
public class CoronaReferensiKabupaten extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            CoronaReferensiKabupaten dialog = new CoronaReferensiKabupaten(
    ...
    public void tampil() {
        try {
            ...
            body = "{" + "\"propinsi\":\"" + kodeprop + "\"" + "}";
            requestEntity = new HttpEntity(body, headers);
            root = mapper.readTree(api.getRest()
                    .exchange(link + "/Referensi/Kabupaten", HttpMethod.POST,
            ...
            if (response.isArray()) {
                for (JsonNode list : response) {
                    if (list.path("nama").asText().toLowerCase().contains(TCari.
                            getText().toLowerCase())) {
    ...
    private static final Logger LOG = Logger.getLogger(
            CoronaReferensiKabupaten.class.getName());
