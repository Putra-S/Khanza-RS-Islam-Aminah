...
public class CoronaReferensiKabupaten extends javax.swing.JDialog {
    ...
    public void tampil() {
        try {
            ...
            root = mapper.readTree(api.getRest()
                    .exchange(link + "/Referensi/Kabupaten", HttpMethod.POST, requestEntity, String.class)
                    .getBody());
    ...
    private static final Logger LOG = Logger.getLogger(CoronaReferensiKabupaten.class.getName());
