 ...
 * @author dosen
 */
public class SisruteCekReferensiDiagnosa extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.
                    MyReportqry("rptCariSisruteReferensiDiagnosa.jasper",
                            "report", "[ Pencarian Referensi Diagnosa ]",
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        ...
        if (diagnosa.getText().trim().length() < 3) {
            JOptionPane.showMessageDialog(null,
                    "Silahkan masukkan pencarian terlebih dahulu. Minimal 3 karakter...!!!");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SisruteCekReferensiDiagnosa dialog = new SisruteCekReferensiDiagnosa(
    ...
    private static final Logger LOG = Logger.getLogger(
            SisruteCekReferensiDiagnosa.class.getName());
