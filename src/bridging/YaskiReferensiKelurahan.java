 ...
 * @author dosen
 */
public class YaskiReferensiKelurahan extends javax.swing.JDialog {

    private final DefaultTableModel tabMode;

    private validasi Valid = new validasi();

    private YaskiReferensiKecamatan propinsi = new YaskiReferensiKecamatan(null,
            false);
	...
	public YaskiReferensiKelurahan(java.awt.Frame parent, boolean modal) {
        ...
        if (koneksiDB.CARICEPAT().equals("aktif")) {
            Kabupaten.getDocument().addDocumentListener(
        ...
        propinsi.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (propinsi.getTable().getSelectedRow() != -1) {
                    ...
                    NmProp.setText(propinsi.getTable().getValueAt(propinsi.
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        if (KdProp.getText().trim().isEmpty() || NmProp.getText().trim().
                isEmpty()) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            YaskiReferensiKelurahan dialog = new YaskiReferensiKelurahan(
        ...
        try {
            ...
            if (response.isArray()) {
                ...
                for (JsonNode list : response) {
                    if (list.path("nama").asText().toLowerCase().contains(poli.
                            toLowerCase())
                            && list.path("id_kecamatan").asText().equals(KdProp.
                                    getText())) {
                        tabMode.addRow(new Object[]{i + ".", list.path("id").
    ...
    private static final Logger LOG = Logger.getLogger(
            YaskiReferensiKelurahan.class.getName());
