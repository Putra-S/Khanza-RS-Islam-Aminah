 ...
 * @author dosen
 */
public class BPJSCekReferensiKelasRawat extends javax.swing.JDialog {
    ...
    public BPJSCekReferensiKelasRawat(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Kelas",
            "Nama Kelas"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiKelasRawat dialog = new BPJSCekReferensiKelasRawat(
    ...
    private static final Logger LOG = Logger.getLogger(
            BPJSCekReferensiKelasRawat.class.getName());
