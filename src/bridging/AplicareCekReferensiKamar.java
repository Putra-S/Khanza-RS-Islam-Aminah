 ...
 * @author dosen
 */
public class AplicareCekReferensiKamar extends javax.swing.JDialog {
    ...
    public AplicareCekReferensiKamar(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"No.", "Kode Kelas",
            "Nama Kelas"}) {
            @Override
        ...
        if (koneksiDB.CARICEPAT().equals("aktif")) {
            Kelas.getDocument().addDocumentListener(
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariAplicareReferensiKamar.jasper", "report",
                    "[ Pencarian Referensi Kamar Aplicare ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            AplicareCekReferensiKamar dialog = new AplicareCekReferensiKamar(
        ...
        try {
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kodekelas").asText().toLowerCase().
                                contains(Kelas.getText().toLowerCase())
                                || list.path("namakelas")
                                        .asText()
                                        .toLowerCase()
                                        .contains(Kelas.getText().toLowerCase())) {
            ...
            if (ex.toString().contains("UnknownHostException")) {
                JOptionPane.showMessageDialog(rootPane,
                        "Koneksi ke server Aplicare terputus...!");
            }
        }
    }
    ...
    private static final Logger LOG = Logger.getLogger(
            AplicareCekReferensiKamar.class.getName());
