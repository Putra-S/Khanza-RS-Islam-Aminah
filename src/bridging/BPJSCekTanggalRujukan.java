...
public class BPJSCekTanggalRujukan extends javax.swing.JDialog {
    ...
    public BPJSCekTanggalRujukan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"No.", "Kode Diag", "Nama Diagnosa", "Keluhan", "No.Rujuk/Kunjungan", "Kode Pelayanan",
                    "Pelayanan", "Nama COB Asuransi", "No.COB", "Tgl.TAT COB", "Tgl.TMT COB", "Kode Kelas",
                    "Hak Kelas", "Dinsos", "No.SKTM Dinsos", "Prolanis PRB", "Kode Peserta", "Jenis Peserta",
                    "No.M.R", "No.Telp", "Nama Pasien", "NIK", "No.Kartu", "Pisa", "Kode Provider", "Nama Provider",
                    "Sex", "Kode Status", "Status Peserta", "Cetak Kartu", "Tgl.Lahir", "Tgl.TAT", "Tgl.TMT",
                    "Umur Saat Pelayanan", "Umur Sekarang", "Kode Poli", "Poli Rujukan", "Kode Perujuk", "Perujuk",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
                    ...
                    for (JsonNode list : response) {
                        ...
                        switch (cmbStatus.getSelectedItem().toString()) {
                            case "Semua":
                                ...
                                tabMode.addRow(new Object[]{i + ".", list.path("diagnosa").path("kode").asText(),
                                    list.path("diagnosa").path("nama").asText(), list.path("keluhan").asText(),
                                    list.path("noKunjungan").asText(), list.path("pelayanan").path("kode").asText(),
    ...
    private static final Logger LOG = Logger.getLogger(BPJSCekTanggalRujukan.class.getName());
