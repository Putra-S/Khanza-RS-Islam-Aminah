...
public class ApiBPJSLZString {
    ...
    private static final Map<char[], Map<Character, Integer>> baseReverseDic
            = new HashMap<char[], Map<Character, Integer>>();

    private static final Logger LOG = Logger.getLogger(ApiBPJSLZString.class.getName());
    ...
    public static String compressToBase64(String input) {
        ...
        String res
                = ApiBPJSLZString._compress(
                        input,
                        6,
                        new CompressFunctionWrapper() {
                    @Override
    ...
    public static String decompressFromBase64(final String inputStr) {
        ...
        return ApiBPJSLZString._decompress(
                inputStr.length(),
                32,
                new DecompressFunctionWrapper() {
            @Override
    ...
    public static String compressToUTF16(String input) {
        ...
        return ApiBPJSLZString._compress(
                input,
                15,
                new CompressFunctionWrapper() {
            @Override
    ...
    private static String _compress(
        ...
        String context_wc = "";
        String context_w = "";
        int context_enlargeIn = 2; // Compensate for the first entry which should not
        // count
    ...
    private static String _decompress(
            int length, int resetValue, DecompressFunctionWrapper getNextValue) {
        ...
        while (true) {
            ...
            // TODO: very strange here, c above is as char/string, here further is a int,
            // rename "c" in the switch as "cc"
            int cc;
            switch (cc = bits) {
                case 0:
                    bits = 0;
    ...
    private abstract static class CompressFunctionWrapper {

        public abstract char doFunc(int i);
    }

    private abstract static class DecompressFunctionWrapper {
