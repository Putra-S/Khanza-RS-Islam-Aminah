 ...
 * @author dosen
 */
public class ApotekBPJSCekReferensiSpesialistik extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public ApotekBPJSCekReferensiSpesialistik(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new String[]{"No.",
            "Kode Spesialistik", "Nama Spesialistik"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ApotekBPJSCekReferensiSpesialistik dialog = new ApotekBPJSCekReferensiSpesialistik(
    ...
    private static final Logger LOG = Logger.getLogger(
            ApotekBPJSCekReferensiSpesialistik.class.getName());
