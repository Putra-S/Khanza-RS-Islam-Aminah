 ...
 * @author dosen
 */
public class SatuSehatKirimMedicationDispense extends javax.swing.JDialog {
    ...
    private String link = "", json = "", idpasien = "", iddokter = "", signa1 = "1", signa2 = "1", cekbok = "";
    ...
    public SatuSehatKirimMedicationDispense(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"P", "Tanggal Registrasi", "No.Rawat", "No.RM", "Nama Pasien", "No.KTP Pasien",
                    ...
                    "ID Medication Dispense", "No.Batch", "No.Faktur", "Tgl.Validasi", "Status", "ID Location",
                    "Asal Depo", "ID Medication Request"}) {
    ...
    private void BtnKirimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimActionPerformed
        for (i = 0; i < tbObat.getRowCount(); i++) {
            if (tbObat.getValueAt(i, 0).toString().equals("true") && (!tbObat.
                    getValueAt(i, 5).toString().isEmpty()) && (!tbObat.
                    getValueAt(i, 7).toString().isEmpty()) && tbObat.getValueAt(
                    i, 26).toString().isEmpty()) {
                try {
                    ...
                    arrSplit = tbObat.getValueAt(i, 24).toString().toLowerCase().
                            split("x");
                    signa1 = "1";
                    try {
                    ...
                    try {
                        ...
                        json = "{"
                                ...
                                + "\"identifier\": ["
                                + "{"
                                + "\"system\": \"http://sys-ids.kemkes.go.id/prescription/" + koneksiDB.
                                        IDSATUSEHAT() + "\","
                                + "\"use\": \"official\","
                                + "\"value\": \"" + tbObat.getValueAt(i, 25).
                                        toString() + "\""
                                + "},"
                                + "{"
                                + "\"system\": \"http://sys-ids.kemkes.go.id/prescription-item/" + koneksiDB.
                                        IDSATUSEHAT() + "\","
                                + "\"use\": \"official\","
                                + "\"value\": \"" + tbObat.getValueAt(i, 11).
                                        toString() + "\""
                                + "}"
                                + "],"
                                + "\"status\": \"completed\","
                                ...
                                + "\"code\": \"" + tbObat.getValueAt(i, 30).
                                        toString().replaceAll("Ralan",
                                                "outpatient").
                                        replaceAll("Ranap", "inpatient") + "\","
                                + "\"display\": \"" + tbObat.getValueAt(i, 30).
                                        toString().replaceAll("Ralan",
                                                "Outpatient").
                                        replaceAll("Ranap", "Inpatient") + "\""
                                + "}"
                                ...
                                + "\"display\": \"" + tbObat.getValueAt(i, 32).
                                        toString() + "\""
                                + "},"
                                + "\"authorizingPrescription\": ["
                                + "{"
                                + "\"reference\": \"MedicationRequest/" + tbObat.
                                        getValueAt(i, 33).toString() + "\""
                                + "}"
                                + "],"
                                + "\"quantity\": {"
                                + "\"system\": \"" + tbObat.getValueAt(i, 20).
                                        toString() + "\","
                                + "\"code\": \"" + tbObat.getValueAt(i, 19).
                                        toString() + "\","
                                + "\"value\": " + tbObat.getValueAt(i, 22).
                                        toString()
                                + "},"
                                + "\"whenPrepared\": \"" + tbObat.getValueAt(i,
                                        21).toString().replaceAll(" ", "T") + "Z\","
                                + "\"whenHandedOver\": \"" + tbObat.
                                        getValueAt(i, 29).toString().replaceAll(
                                        " ", "T") + "Z\","
                                + "\"dosageInstruction\": ["
                                + "{"
                                + "\"sequence\": 1,"
                                + "\"text\": \"" + tbObat.getValueAt(i, 24).
                                        toString() + "\","
                                + "\"timing\": {"
                                + "\"repeat\": {"
                                + "\"frequency\": " + signa2 + ","
                                ...
                                + "\"coding\": ["
                                + "{"
                                + "\"system\": \"" + tbObat.getValueAt(i, 17).
                                        toString() + "\","
                                + "\"code\": \"" + tbObat.getValueAt(i, 16).
                                        toString() + "\","
                                ...
                                + "}";
                        System.out.println(
                                "URL : " + link + "/MedicationDispense");
                        System.out.println("Request JSON : " + json);
                        requestEntity = new HttpEntity(json, headers);
                        json = api.getRest().exchange(
                                link + "/MedicationDispense", HttpMethod.POST,
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.menyimpantf2(
                                    ...
                                    new String[]{
                                        ...
                                        tbObat.getValueAt(i, 29).toString().
                                                substring(0, 10), tbObat.
                                        getValueAt(i, 29).toString().substring(
                                        11, 19),
                                        tbObat.getValueAt(i, 11).toString(),
                                        tbObat.getValueAt(i, 27).toString(),
                                        tbObat.getValueAt(i, 28).toString(),
                                        response.asText()
                                    }) == true) {
    ...
    private void BtnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnUpdateActionPerformed
        for (i = 0; i < tbObat.getRowCount(); i++) {
            if (tbObat.getValueAt(i, 0).toString().equals("true") && (!tbObat.
                    ...
                    getValueAt(i, 26).toString().isEmpty())) {
                try {
                    idpasien = cekViaSatuSehat.tampilIDPasien(tbObat.getValueAt(
                            i, 5).toString());
                    iddokter = cekViaSatuSehat.tampilIDParktisi(tbObat.
                    ...
                    try {
                        ...
                        json = "{"
                                ...
                                + "}";
                        System.out.println(
                                "URL : " + link + "/MedicationDispense/" + tbObat.
                                        getValueAt(i, 26).toString());
                        System.out.println("Request JSON : " + json);
                        requestEntity = new HttpEntity(json, headers);
                        json = api.getRest().exchange(
                                link + "/MedicationDispense/" + tbObat.
                                        getValueAt(i, 26).toString(),
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimMedicationDispense dialog = new SatuSehatKirimMedicationDispense(new javax.swing.JFrame(),
                    true);
    ...
    private void tampil() {
        if (cekBoxBelumKirim.isSelected() == true) {
            cekbok = " and satu_sehat_medicationdispense.id_medicationdispanse is null and pasien.no_ktp <> '-' ";
        } else {
            cekbok = "";
        }
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString("tgl_registrasi") + " " + rs.getString("jam_reg"),
                        ...
                        rs.getString("id_medication"), rs.getString("aturan"), rs.getString("no_resep"),
                        rs.getString("id_medicationdispanse"), rs.getString("no_batch"), rs.getString("no_faktur"),
                        rs.getString("tgl_perawatan") + " " + rs.getString("jam"), "Ralan",
                        rs.getString("id_lokasi_satusehat"), rs.getString("nm_bangsal"),
                        rs.getString("id_medicationrequest")});
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
            } finally {
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString("tgl_registrasi") + " " + rs.getString("jam_reg"),
                        ...
                        rs.getString("id_medication"), rs.getString("aturan"), rs.getString("no_resep"),
                        rs.getString("id_medicationdispanse"), rs.getString("no_batch"), rs.getString("no_faktur"),
                        rs.getString("tgl_perawatan") + " " + rs.getString("jam"), "Ranap",
                        rs.getString("id_lokasi_satusehat"), rs.getString("nm_bangsal"),
                        rs.getString("id_medicationrequest")});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(SatuSehatKirimMedicationDispense.class.getName());
