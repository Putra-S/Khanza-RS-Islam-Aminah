...
public class ApotekBPJSKunjunganSEP extends javax.swing.JDialog {
    ...
    public void tampil(String keyword) {
        try {
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                tabMode.addRow(
                        new Object[]{"Kode Faskes Asal Resep", ": " + response.path("faskesasalresep").asText()});
                tabMode.addRow(
                        new Object[]{"Nama Faskes Asal Resep", ": " + response.path("nmfaskesasalresep").asText()});
                tabMode.addRow(new Object[]{"Nomor Kartu", ": " + response.path("nokartu").asText()});
                tabMode.addRow(new Object[]{"Nama Peserta", ": " + response.path("namapeserta").asText()});
                tabMode.addRow(new Object[]{"Jenis Kelamin",
                    ": " + response.path("jnskelamin")
                    .asText()
                    .replaceAll("P", "PEREMPUAN")
                    .replaceAll("L", "LAKI-LAKI")});
                tabMode.addRow(new Object[]{"Tanggal Lahir", ": " + response.path("tgllhr").asText()});
                tabMode.addRow(new Object[]{"Pisat", ": " + response.path("pisat").asText()});
                tabMode.addRow(new Object[]{"Kode Jenis Peserta", ": " + response.path("kdjenispeserta").asText()});
                tabMode.addRow(new Object[]{"Nama Jenis Peserta", ": " + response.path("nmjenispeserta").asText()});
                tabMode.addRow(new Object[]{"Kode BU", ": " + response.path("kodebu").asText()});
                tabMode.addRow(new Object[]{"Nama BU", ": " + response.path("namabu").asText()});
                tabMode.addRow(new Object[]{"Tanggal SEP", ": " + response.path("tglsep").asText()});
                tabMode.addRow(new Object[]{"Tanggal Pulang SEP", ": " + response.path("tglplgsep").asText()});
                tabMode.addRow(new Object[]{"Jenis Pelayanan", ": " + response.path("jnspelayanan").asText()});
                tabMode.addRow(new Object[]{"Nama Diagnosa", ": " + response.path("nmdiag").asText()});
                tabMode.addRow(new Object[]{"Layanan/Poli", ": " + response.path("poli").asText()});
                tabMode.addRow(new Object[]{"Flag PRB", ": " + response.path("flagprb").asText()});
                tabMode.addRow(new Object[]{"Nama PRB", ": " + response.path("namaprb").asText()});
                tabMode.addRow(new Object[]{"Kode Dokter", ": " + response.path("kodedokter").asText()});
                tabMode.addRow(new Object[]{"Nama Dokter", ": " + response.path("namadokter").asText()});
            } else {
    ...
    private static final Logger LOG = Logger.getLogger(ApotekBPJSKunjunganSEP.class.getName());
