...
public class SatuSehatKirimObservationRadiologi extends javax.swing.JDialog {
    ...
    public SatuSehatKirimObservationRadiologi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"P", "No.Rawat", "No.RM", "Nama Pasien", "No.KTP Pasien", "No.Permintaan",
                    "Tgl & Jam Hasil", "Nama Pemeriksaan", "Radiologi Code", "Radiologi System",
                    "Radiologi Display", "Hasil Radiologi", "Kode Pemeriksaan", "ID Specimen", "Kode Dokter",
                    "Nama Dokter", "No.KTP Dokter", "ID Encounter", "ID Observation"}) {
    ...
    private void BtnKirimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimActionPerformed
        for (i = 0; i < tbObat.getRowCount(); i++) {
            if (tbObat.getValueAt(i, 0).toString().equals("true") && (!tbObat.
                    ...
                    getValueAt(i, 16).toString().isEmpty()) && tbObat.
                ...
                try {
                    ...
                    try {
                        ...
                        json = "{"
                                ...
                                + "\"identifier\": ["
                                + "{"
                                + "\"system\": \"http://sys-ids.kemkes.go.id/observation/" + koneksiDB.
                                        IDSATUSEHAT() + "\","
                                + "\"value\": \"" + tbObat.getValueAt(i, 5).
                                ...
                                + "\"coding\": ["
                                + "{"
                                + "\"system\": \"" + tbObat.getValueAt(i, 9).
                                        toString() + "\","
                                + "\"code\": \"" + tbObat.getValueAt(i, 8).
                                        toString() + "\","
                                ...
                                + "\"display\": \"Hasil Pemeriksaan Radiologi " + tbObat.
                                        getValueAt(i, 7).toString() + " No.Rawat " + tbObat.
                                getValueAt(i, 1).toString() + ", Atas Nama Pasien " + tbObat.
                                getValueAt(i, 3).toString() + ", No.RM " + tbObat.
                                getValueAt(i, 2).toString() + ", Pada Tanggal " + tbObat.
                                ...
                                + "\"effectiveDateTime\": \"" + tbObat.
                                        getValueAt(i, 6).toString().replaceAll(
                                        " ", "T") + "+07:00\","
                                + "\"valueString\": \"" + tbObat.getValueAt(i,
                                        11).toString().replaceAll(
                                                "(\r\n|\r|\n|\n\r)", "<br>").
                                        replaceAll("\t", " ") + "\""
                                + "}";
                    ...
                    try {
                        ...
                        json = "{"
                                ...
                                + "\"display\": \"Hasil Pemeriksaan Radiologi " + tbObat.
                                        getValueAt(i, 7).toString() + " No.Rawat " + tbObat.
                                getValueAt(i, 1).toString() + ", Atas Nama Pasien " + tbObat.
                                getValueAt(i, 3).toString() + ", Pada Tanggal " + tbObat.
                                getValueAt(i, 6).toString() + "\""
                                + "},"
                                + "\"specimen\": {"
                                + "\"reference\": \"Specimen/" + tbObat.
                                ...
                                + "}";
                        System.out.println(
                                "URL : " + link + "/Observation/" + tbObat.
                                        getValueAt(i, 18).toString());
                        System.out.println("Request JSON : " + json);
                        requestEntity = new HttpEntity(json, headers);
                        json = api.getRest().exchange(
                                link + "/Observation/" + tbObat.
                                        getValueAt(i, 18).toString(),
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimObservationRadiologi dialog = new SatuSehatKirimObservationRadiologi(new javax.swing.JFrame(),
                    true);
	...
	private void tampil() {
        if (cekBoxBelumKirim.isSelected() == true) {
            cekbok = " and satu_sehat_observation_radiologi.id_observation is null and pasien.no_ktp <> '-' ";
        } else {
            cekbok = "";
        }
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString("no_rawat"), rs.getString("no_rkm_medis"),
                        ...
                        rs.getString("tgl_hasil") + " " + rs.getString("jam_hasil"), rs.getString("nm_perawatan"),
                        rs.getString("code"), rs.getString("system"), rs.getString("display"),
                        rs.getString("hasil"), rs.getString("kd_jenis_prw"), rs.getString("id_specimen"),
                        rs.getString("kd_dokter"), rs.getString("nama"), rs.getString("ktppraktisi"),
                        rs.getString("id_encounter"), rs.getString("id_observation")});
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
            } finally {
    ...
    private static final Logger LOG = Logger.getLogger(SatuSehatKirimObservationRadiologi.class.getName());
