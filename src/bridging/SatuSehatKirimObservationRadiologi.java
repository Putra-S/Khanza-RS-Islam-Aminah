...
public class SatuSehatKirimObservationRadiologi extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SatuSehatKirimObservationRadiologi(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null,
                new String[]{"P", "No.Rawat", "No.RM", "Nama Pasien",
                    ...
                    "Tgl & Jam Hasil", "Nama Pemeriksaan", "Radiologi Code",
                    "Radiologi System",
                    "Radiologi Display", "Hasil Radiologi", "Kode Pemeriksaan",
                    "ID Specimen", "Kode Dokter",
                    "Nama Dokter", "No.KTP Dokter", "ID Encounter",
                    "ID Observation"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimObservationRadiologi dialog = new SatuSehatKirimObservationRadiologi(
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{false, rs.getString("no_rawat"),
                        ...
                        "jam_hasil"), rs.getString("nm_perawatan"),
                        rs.getString("code"), rs.getString("system"), rs.
                        getString("display"),
                        rs.getString("hasil"), rs.getString("kd_jenis_prw"), rs.
                        getString("id_specimen"),
                        rs.getString("kd_dokter"), rs.getString("nama"), rs.
    ...
    private static final Logger LOG = Logger.getLogger(
            SatuSehatKirimObservationRadiologi.class.getName());
