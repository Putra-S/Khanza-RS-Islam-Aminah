...
public class BRIApiIntegrasi extends javax.swing.JDialog {
    ...
    public BRIApiIntegrasi(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Kode Akun", "Akun Rekening", "Consumer Key", "Consumer Secret", "Institution Code",
            "BRIVA No", "URL API"};
    ...
    private static final Logger LOG = Logger.getLogger(BRIApiIntegrasi.class.getName());
