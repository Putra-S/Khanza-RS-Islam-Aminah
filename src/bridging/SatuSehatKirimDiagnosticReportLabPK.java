...
public class SatuSehatKirimDiagnosticReportLabPK extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SatuSehatKirimDiagnosticReportLabPK(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimDiagnosticReportLabPK dialog = new SatuSehatKirimDiagnosticReportLabPK(
    ...
    private static final Logger LOG = Logger.getLogger(
            SatuSehatKirimDiagnosticReportLabPK.class.getName());
