 ...
 * @author dosen
 */
public class SatuSehatKirimSpecimenRadiologi extends javax.swing.JDialog {
	...
	private void tampil() {
        if (cekBoxBelumKirim.isSelected() == true) {
            cekbok = " and satu_sehat_specimen_radiologi.id_specimen is null and pasien.no_ktp <> '-' ";
        } else {
            cekbok = "";
        }
