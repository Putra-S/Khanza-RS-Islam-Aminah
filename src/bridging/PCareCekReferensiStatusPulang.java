 ...
 * @author dosen
 */
public class PCareCekReferensiStatusPulang extends javax.swing.JDialog {
    ...
    public PCareCekReferensiStatusPulang(java.awt.Frame parent, boolean modal) {
        ...
        setSize(628, 674);
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Status",
            "Nama Status"}) {
            @Override
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariPCAREReferensiStatusPulang.jasper",
                    "report", "[ Pencarian Referensi Status Pulang ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiStatusPulang dialog = new PCareCekReferensiStatusPulang(
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kdStatusPulang").asText().toLowerCase().
                                contains(diagnosa.toLowerCase())
                                || list.path("nmStatusPulang")
                                        .asText()
                                        .toLowerCase()
                                        .contains(diagnosa.toLowerCase())) {
                            tabMode.addRow(new Object[]{i + ".", list.path(
                                "kdStatusPulang").asText(),
                                list.path("nmStatusPulang").asText()});
                            i++;
                        }
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareCekReferensiStatusPulang.class.getName());
