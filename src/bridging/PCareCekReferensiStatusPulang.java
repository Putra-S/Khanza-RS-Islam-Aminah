...
public class PCareCekReferensiStatusPulang extends javax.swing.JDialog {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kdStatusPulang").asText().toLowerCase().contains(diagnosa.toLowerCase())
                            ...
                            tabMode.addRow(new Object[]{i + ".", list.path("kdStatusPulang").asText(),
    ...
    private static final Logger LOG = Logger.getLogger(PCareCekReferensiStatusPulang.class.getName());
