 ...
 * @author dosen
 */
public class PCareCekReferensiPoli extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariPCAREReferensiPoli.jasper", "report",
                    "[ Pencarian Referensi Unit/Poli ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiPoli dialog = new PCareCekReferensiPoli(
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kdPoli").asText().toLowerCase().contains(
                                diagnosa.toLowerCase())
                                || list.path("nmPoli").asText().toLowerCase().
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareCekReferensiPoli.class.getName());
