 ...
 * @author dosen
 */
public class YaskiReferensiPropinsi extends javax.swing.JDialog {
    ...
    public YaskiReferensiPropinsi(java.awt.Frame parent, boolean modal) {
        ...
        if (koneksiDB.CARICEPAT().equals("aktif")) {
            Propinsi.getDocument().addDocumentListener(
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            YaskiReferensiPropinsi dialog = new YaskiReferensiPropinsi(
        ...
        try {
            ...
            if (response.isArray()) {
                ...
                for (JsonNode list : response) {
                    if (list.path("id").asText().toLowerCase().contains(poli.
                            toLowerCase())
    ...
    private static final Logger LOG = Logger.getLogger(
            YaskiReferensiPropinsi.class.getName());
