...
public class SisruteCekReferensiKriteriaRujukan extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SisruteCekReferensiKriteriaRujukan(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SisruteCekReferensiKriteriaRujukan dialog = new SisruteCekReferensiKriteriaRujukan(
    ...
    private static final Logger LOG = Logger.getLogger(
            SisruteCekReferensiKriteriaRujukan.class.getName());
