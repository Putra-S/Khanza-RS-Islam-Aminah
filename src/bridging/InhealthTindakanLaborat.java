 ...
 * @author dosen
 */
public class InhealthTindakanLaborat extends javax.swing.JDialog {
    ...
    public InhealthTindakanLaborat(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode RS", "Nama Tindakan Laborat", "Tarif",
                    "Kode Inhealth"}) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdtindakan.getText().trim().isEmpty() || TTindakan.getText().trim().
            ...
            if (Sequel.menyimpantf("inhealth_tindakan_laborat", "?,?",
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode, kdtindakan, "inhealth_tindakan_laborat",
                "kd_jenis_prw");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdtindakan.getText().trim().isEmpty() || TTindakan.getText().trim().
            ...
            if (tbJnsPerawatan.getSelectedRow() > -1) {
                if (Sequel.mengedittf("inhealth_tindakan_laborat",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptMapingTindakanInhealthLaborat.jasper", "report",
                    "::[ Mapping Tarif Laborat Inhealth ]::", param);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InhealthTindakanLaborat dialog = new InhealthTindakanLaborat(
    ...
    private static final Logger LOG = Logger.getLogger(
            InhealthTindakanLaborat.class.getName());
