 ...
 * @author dosen
 */
public class PCareCekReferensiPrognosa extends javax.swing.JDialog {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariPCAREReferensiPrognosa.jasper", "report",
                    "[ Pencarian Referensi Prognosa ]",
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiPrognosa dialog = new PCareCekReferensiPrognosa(
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        if (list.path("kdPrognosa").asText().toLowerCase().
                                contains(diagnosa.toLowerCase())
                                || list.path("nmPrognosa").asText().
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareCekReferensiPrognosa.class.getName());
