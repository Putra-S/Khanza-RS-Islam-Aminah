 ...
 * @author dosen
 */
public class CoronaReferensiKecamatan extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            CoronaReferensiKecamatan dialog = new CoronaReferensiKecamatan(
    ...
    public void tampil() {
        try {
            ...
            body = "{" + "\"kabkota\":\"" + kodekab + "\"" + "}";
            requestEntity = new HttpEntity(body, headers);
            root = mapper.readTree(api.getRest()
                    .exchange(link + "/Referensi/Kecamatan", HttpMethod.POST,
    ...
    private static final Logger LOG = Logger.getLogger(
            CoronaReferensiKecamatan.class.getName());
