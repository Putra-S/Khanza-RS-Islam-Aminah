...
public class CoronaReferensiKecamatan extends javax.swing.JDialog {
    ...
    public void tampil() {
        try {
            ...
            root = mapper.readTree(api.getRest()
                    .exchange(link + "/Referensi/Kecamatan", HttpMethod.POST, requestEntity, String.class)
                    .getBody());
    ...
    private static final Logger LOG = Logger.getLogger(CoronaReferensiKecamatan.class.getName());
