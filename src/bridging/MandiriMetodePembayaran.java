 ...
 * @author dosen
 */
public class MandiriMetodePembayaran extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("metode_pembayaran_bankmandiri", "'" + TKd.
                    getText() + "','" + TNm.getText() + "','" + Biaya.getText() + "'",
                    "Kode") == true) {
                tabMode.addRow(new Object[]{
                    TKd.getText(), TNm.getText(), Double.
                    valueOf(Biaya.getText())
                });
                emptTeks();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tbJabatan.getSelectedRow() != -1) {
            if (Sequel.
                    meghapustf("metode_pembayaran_bankmandiri", "kode_metode",
                            tbJabatan.getValueAt(tbJabatan.getSelectedRow(), 0).
                                    toString()) == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbJabatan.getSelectedRow() > -1) {
                if (Sequel.mengedittf("metode_pembayaran_bankmandiri",
                        "kode_metode=?",
                        "kode_metode=?,nama_metode=?,biaya_transaksi=?", 4,
                        new String[]{
                            TKd.getText(), TNm.getText(), Biaya.getText(),
                            tbJabatan.getValueAt(tbJabatan.getSelectedRow(), 0).
                                    toString()
                        }) == true) {
                    tabMode.
                            setValueAt(TKd.getText(), tbJabatan.getSelectedRow(),
                                    0);
                    tabMode.
                            setValueAt(TNm.getText(), tbJabatan.getSelectedRow(),
                                    1);
                    tabMode.setValueAt(Double.valueOf(Biaya.getText()),
                            tbJabatan.getSelectedRow(), 2);
                    emptTeks();
                }
            } else {
                JOptionPane.showMessageDialog(null,
                        "Maaf, Silahkan pilih data yang mau diganti...!!!!");
            }
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MandiriMetodePembayaran dialog = new MandiriMetodePembayaran(
    ...
    private void getData() {
        if (tbJabatan.getSelectedRow() != -1) {
            TKd.setText(tbJabatan.getValueAt(tbJabatan.getSelectedRow(), 0).
                    toString());
            TNm.setText(tbJabatan.getValueAt(tbJabatan.getSelectedRow(), 1).
                    toString());
            Biaya.setText(tbJabatan.getValueAt(tbJabatan.getSelectedRow(), 2).
                    toString());
        }
    }
    ...
    private static final Logger LOG = Logger.getLogger(
            MandiriMetodePembayaran.class.getName());
