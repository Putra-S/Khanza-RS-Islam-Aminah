...
public class MandiriMetodePembayaran extends javax.swing.JDialog {
    ...
    public MandiriMetodePembayaran(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Kode", "Metode Pembayaran", "Biaya Transaksi"}) {
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString(1), rs.getString(2), rs.getDouble(3)});
                }
            } catch (Exception e) {
    ...
    private static final Logger LOG = Logger.getLogger(MandiriMetodePembayaran.class.getName());
