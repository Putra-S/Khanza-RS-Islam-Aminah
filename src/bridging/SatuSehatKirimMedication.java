...
public class SatuSehatKirimMedication extends javax.swing.JDialog {
    ...
    public SatuSehatKirimMedication(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new String[]{"P", "KFA Code",
            "KFA System", "Kode Barang",
            "KFA Display", "Form Code", "Form System", "Form Display", "Status",
            "ID Medication Satu Sehat"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimMedication dialog = new SatuSehatKirimMedication(
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(
                            new Object[]{false, rs.getString("obat_code"),
                                rs.getString("obat_system"),
                                rs.getString("kode_brng"), rs.getString(
                                "obat_display"), rs.getString("form_code"),
                                rs.getString("form_system"), rs.getString(
                                "form_display"),
                                rs.getString("status").replaceAll("0",
                                        "inactive").
                                        replaceAll("1", "active"),
    ...
    private static final Logger LOG = Logger.getLogger(
            SatuSehatKirimMedication.class.getName());
