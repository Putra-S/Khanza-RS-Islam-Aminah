 ...
 * @author dosen
 */
public class SatuSehatKirimSpecimenLabMB extends javax.swing.JDialog {
                ...
                try {
                    ...
                    try {
                        ...
                        if (!response.asText().isEmpty()) {
                            if (Sequel.
                                    menyimpantf2("satu_sehat_specimen_lab_mb",
                                            "?,?,?,?", "No.Order", 4,
                                            new String[]{
    ...
    private static final Logger LOG = Logger.getLogger(SatuSehatKirimSpecimenLabMB.class.getName());
