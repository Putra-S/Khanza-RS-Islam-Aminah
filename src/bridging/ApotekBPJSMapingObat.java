...
public class ApotekBPJSMapingObat extends javax.swing.JDialog {
    ...
    public ApotekBPJSMapingObat(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Obat RS", "Nama Obat RS", "Kode Obat BPJS", "Nama Obat Apotek BPJS"}) {
            @Override
        ...
        barangbpjs.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (barangbpjs.getTable().getSelectedRow() != -1) {
                    KdObatBPJS.setText(
                            barangbpjs.getTable().getValueAt(barangbpjs.getTable().getSelectedRow(), 0).toString());
                    NmObatBPJS.setText(
                            barangbpjs.getTable().getValueAt(barangbpjs.getTable().getSelectedRow(), 1).toString());
...
private void btnPoliBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliBPJSActionPerformed
    ...
    private static final Logger LOG = Logger.getLogger(ApotekBPJSMapingObat.class.getName());
