...
public class ApotekBPJSMapingObat extends javax.swing.JDialog {
    ...
    private ApotekBPJSCekReferensiDPHO barangbpjs = new ApotekBPJSCekReferensiDPHO(
            null, false);
    ...
    public ApotekBPJSMapingObat(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Obat RS", "Nama Obat RS", "Kode Obat BPJS",
                    "Nama Obat Apotek BPJS"}) {
            @Override
        ...
        barang.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (barang.getTable().getSelectedRow() != -1) {
                    ...
                    TObat.setText(barang.getTable().getValueAt(
        ...
        barangbpjs.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (barangbpjs.getTable().getSelectedRow() != -1) {
                    KdObatBPJS.setText(
                            barangbpjs.getTable().getValueAt(barangbpjs.
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (kdobat.getText().trim().isEmpty() || TObat.getText().trim().
                isEmpty()) {
            Valid.textKosong(kdobat, "Obat RS");
        } else if (KdObatBPJS.getText().trim().isEmpty() || NmObatBPJS.getText().
                trim().isEmpty()) {
            Valid.textKosong(KdObatBPJS, "Obat Apotek BPJS");
        } else {
            if (Sequel.menyimpantf("maping_obat_apotek_bpjs", "?,?,?",
                    "Mapping Obat", 3, new String[]{
                        kdobat.getText(), KdObatBPJS.getText(), NmObatBPJS.
                        getText()
                    }) == true) {
                tampil();
                emptTeks();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.
                hapusTable(tabMode, kdobat, "maping_obat_apotek_bpjs",
                        "kode_brng");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (kdobat.getText().trim().isEmpty() || TObat.getText().trim().
            ...
            if (tbJnsPerawatan.getSelectedRow() > -1) {
                if (Sequel.mengedittf("maping_obat_apotek_bpjs", "kode_brng=?",
                        "kode_brng=?,kode_brng_apotek_bpjs=?,nama_brng_apotek_bpjs=?",
                        4, new String[]{
                            kdobat.getText(), KdObatBPJS.getText(), NmObatBPJS.
                            getText(), tbJnsPerawatan.getValueAt(tbJnsPerawatan.
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptMapingObatApotekBPJS.jasper", "report",
                    "::[ Mapping Obat Apotek BPJS ]::", param);
        }
...
private void btnPoliBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliBPJSActionPerformed
    barangbpjs.setSize(internalFrame1.getWidth() - 20, internalFrame1.
            getHeight() - 20);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ApotekBPJSMapingObat dialog = new ApotekBPJSMapingObat(
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString("kode_brng"), rs.
                        getString("nama_brng"),
                        rs.getString("kode_brng_apotek_bpjs"), rs.getString(
    ...
    private void getData() {
        if (tbJnsPerawatan.getSelectedRow() != -1) {
            kdobat.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 0).toString());
            TObat.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 1).toString());
            KdObatBPJS.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
                    getSelectedRow(), 2).toString());
            NmObatBPJS.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.
    ...
    private static final Logger LOG = Logger.getLogger(
            ApotekBPJSMapingObat.class.getName());
