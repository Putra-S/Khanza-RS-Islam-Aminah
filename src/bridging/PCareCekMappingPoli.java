 ...
 * @author dosen
 */
public class PCareCekMappingPoli extends javax.swing.JDialog {
    ...
    public PCareCekMappingPoli(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"Kode Unit", "Nama Unit", "Kode Unit PCare", "Nama Unit PCare"}) {
            @Override
    ...
    private static final Logger LOG = Logger.getLogger(PCareCekMappingPoli.class.getName());
