 ...
 * @author dosen
 */
public class PCareCekReferensiObat extends javax.swing.JDialog {
    ...
    public PCareCekReferensiObat(java.awt.Frame parent, boolean modal) {
        ...
        setSize(628, 674);
        tabMode = new DefaultTableModel(null, new String[]{"No.", "Kode Obat",
            "Nama Obat", "Sedia"}) {
            @Override
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptCariPCAREReferensiObat.jasper", "report",
                    "[ Pencarian Referensi Obat ]",
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        ...
        if (diagnosa.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null,
                    "Silahkan masukkan kode/nama obat terlebih dahulu..!!!");
        } else {
            tampil(diagnosa.getText());
        }
        this.setCursor(Cursor.getDefaultCursor());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PCareCekReferensiObat dialog = new PCareCekReferensiObat(
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        tabMode.addRow(new Object[]{i + ".",
                            list.path("kdObat").asText(),
                            list.path("nmObat").asText(), list.path("sedia").
                            asText()});
                        i++;
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(
            PCareCekReferensiObat.class.getName());
