...
public class PCareCekReferensiObat extends javax.swing.JDialog {
            ...
            if (nameNode.path("message").asText().equals("OK")) {
                ...
                if (response.path("list").isArray()) {
                    ...
                    for (JsonNode list : response.path("list")) {
                        tabMode.addRow(new Object[]{i + ".", list.path("kdObat").asText(),
                            list.path("nmObat").asText(), list.path("sedia").asText()});
                        i++;
                    }
                }
            } else {
    ...
    private static final Logger LOG = Logger.getLogger(PCareCekReferensiObat.class.getName());
