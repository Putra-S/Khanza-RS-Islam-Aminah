 ...
 * @author dosen
 */
public class SisruteCekReferensiKriteriaSarana extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SisruteCekReferensiKriteriaSarana(java.awt.Frame parent,
            boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SisruteCekReferensiKriteriaSarana dialog = new SisruteCekReferensiKriteriaSarana(
            ...
            if (nameNode.asText().equals("200")) {
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        if (list.path("kode_sarana").asText().toLowerCase().
                                contains(faskes.toLowerCase())
                                || list.path("sarana").asText().toLowerCase().
                                        contains(faskes.toLowerCase())) {
                            tabMode.addRow(new Object[]{i + ".", list.path(
                                "kode_sarana").asText(),
                                list.path("sarana").asText()});
                            i++;
                        }
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(
            SisruteCekReferensiKriteriaSarana.class.getName());
