...
public class SisruteCekReferensiKriteriaSarana extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SisruteCekReferensiKriteriaSarana dialog = new SisruteCekReferensiKriteriaSarana(new javax.swing.JFrame(),
                    true);
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        if (list.path("kode_sarana").asText().toLowerCase().contains(faskes.toLowerCase())
                            ...
                            tabMode.addRow(new Object[]{i + ".", list.path("kode_sarana").asText(),
    ...
    private static final Logger LOG = Logger.getLogger(SisruteCekReferensiKriteriaSarana.class.getName());
