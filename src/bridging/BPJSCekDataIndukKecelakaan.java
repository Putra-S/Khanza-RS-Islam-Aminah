...
public class BPJSCekDataIndukKecelakaan extends javax.swing.JDialog {
    ...
    public BPJSCekDataIndukKecelakaan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No", "No.SEP", "Tgl.Kejadian", "PPK Pelayanan", "Kode Prop", "Kode Kab", "Kode Kec",
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (response.isArray()) {
                    ...
                    for (JsonNode list : response) {
                        tabMode.addRow(new Object[]{i + "", list.path("noSEP").asText(),
                            list.path("tglKejadian").asText(), list.path("ppkPelSEP").asText(),
                            list.path("kdProp").asText(), list.path("kdKab").asText(), list.path("kdKec").asText(),
                            list.path("ketKejadian").asText(), list.path("noSEPSuplesi").asText()});
                        i++;
                    }
                }
    ...
    private static final Logger LOG = Logger.getLogger(BPJSCekDataIndukKecelakaan.class.getName());
