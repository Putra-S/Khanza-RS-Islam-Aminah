...
public class InhealthTindakanRalan extends javax.swing.JDialog {
    ...
    public InhealthTindakanRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Kode RS", "Nama Tindakan Ralan", "Ttl Biaya Dr",
    ...
    private static final Logger LOG = Logger.getLogger(InhealthTindakanRalan.class.getName());
