...
public class PerpustakaanRuang extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("perpustakaan_ruang",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("perpustakaan_ruang", "kd_ruang=?",
                        "kd_ruang=?,nm_ruang=?", 3, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PerpustakaanRuang dialog = new PerpustakaanRuang(
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from perpustakaan_ruang where kd_ruang like ? or nm_ruang like ? order by kd_ruang");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(PerpustakaanRuang.class.
            getName());
}
