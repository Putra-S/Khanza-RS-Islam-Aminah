...
public class PerpustakaanPengarang extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("perpustakaan_pengarang",
                    "'" + TKd.getText() + "','" + TNm.getText() + "'",
                    "Kode Pengarang/Penulis");
            tampil();
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        Valid.hapusTable(tabMode, TKd, "perpustakaan_pengarang",
                "kode_pengarang");
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("perpustakaan_pengarang", "kode_pengarang=?",
                        "kode_pengarang=?,nama_pengarang=?", 3, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PerpustakaanPengarang dialog = new PerpustakaanPengarang(
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from perpustakaan_pengarang where kode_pengarang like ? or nama_pengarang like ? order by kode_pengarang");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(
            PerpustakaanPengarang.class.getName());
}
