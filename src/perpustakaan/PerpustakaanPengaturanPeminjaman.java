...
public class PerpustakaanPengaturanPeminjaman extends javax.swing.JDialog {
    ...
    public PerpustakaanPengaturanPeminjaman(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"Maksimal Buku Dipinjam", "Maksimal Lama Peminjaman",
            "Denda Keterlambatan Perhari(Rp)"}) {
            @Override
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (MakBuku.getText().trim().isEmpty() || MakBuku.getText().trim().
                equals("0")) {
            Valid.textKosong(MakBuku, "Maksimal Buku Dipinjam");
        } else if (Lama.getText().trim().isEmpty() || Lama.getText().trim().
                equals("0")) {
            Valid.textKosong(Lama, "Maksimal Lama Peminjaman");
        } else if (Denda.getText().trim().isEmpty() || Denda.getText().trim().
                equals("0")) {
            Valid.textKosong(Denda, "Denda Keterlambatan Perhari");
        } else if (tabMode.getRowCount() == 0) {
            Sequel.menyimpan("perpustakaan_set_peminjaman", "'" + MakBuku.
                    getText() + "','" + Lama.getText() + "','" + Denda.getText() + "'",
                    "Pengaturan Peminjaman");
            tampil();
            emptTeks();
        } else if (tabMode.getRowCount() > 0) {
            JOptionPane.showMessageDialog(null,
                    "Maaf, Hanya diijinkan satu Pengaturan Peminjaman di Perpustakaan...!!!!");
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            MakBuku.requestFocus();
        } else if (MakBuku.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null,
    ...
    private void BtnKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKeluarActionPerformed
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null,
                    "Maaf, data Pengaturan Peminjaman di Perpustakaan tidak boleh kosong ...!!!!");
            MakBuku.requestFocus();
        } else if (!(tabMode.getRowCount() == 0)) {
            dispose();
        }
...
private void MakBukuKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_MakBukuKeyPressed
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (MakBuku.getText().trim().isEmpty() || MakBuku.getText().trim().
            ...
            if (tbAdmin.getSelectedRow() > -1) {
                Sequel.queryu("delete from perpustakaan_set_peminjaman");
                Sequel.menyimpan("perpustakaan_set_peminjaman", "'" + MakBuku.
                        getText() + "','" + Lama.getText() + "','" + Denda.
                        getText() + "'", "Pengaturan Peminjaman");
                tampil();
                emptTeks();
            }
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PerpustakaanPengaturanPeminjaman dialog = new PerpustakaanPengaturanPeminjaman(new javax.swing.JFrame(),
                    true);
    ...
    private static final Logger LOG = Logger.getLogger(PerpustakaanPengaturanPeminjaman.class.getName());
