...
public class PerpustakaanPengaturanPeminjaman extends javax.swing.JDialog {
    ...
    public PerpustakaanPengaturanPeminjaman(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{
            "Maksimal Buku Dipinjam", "Maksimal Lama Peminjaman",
...
private void MakBukuKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_MakBukuKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PerpustakaanPengaturanPeminjaman dialog = new PerpustakaanPengaturanPeminjaman(
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from perpustakaan_set_peminjaman ");
            try {
                rs = ps.executeQuery();
                while (rs.next()) {
    ...
    private static final Logger LOG = Logger.getLogger(
            PerpustakaanPengaturanPeminjaman.class.getName());
}
