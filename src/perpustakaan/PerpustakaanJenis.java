...
public class PerpustakaanJenis extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("perpustakaan_jenis_buku",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("perpustakaan_jenis_buku", "id_jenis=?",
                        "id_jenis=?,nama_jenis=?", 3, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PerpustakaanJenis dialog = new PerpustakaanJenis(
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from perpustakaan_jenis_buku where id_jenis like ? or nama_jenis like ? order by id_jenis");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(PerpustakaanJenis.class.
            getName());
}
