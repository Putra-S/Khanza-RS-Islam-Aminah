...
public class PerpustakaanEbook extends javax.swing.JDialog {
        ...
        try {
            if (engine.getLocation().contains("List")) {
                loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + prop.
                        ...
                        "HYBRIDWEB") + "/" + "ebook/index.php?act=List&action=TAMBAH&keyword=" + TCari.
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PerpustakaanEbook dialog = new PerpustakaanEbook(
    ...
    private static final Logger LOG = Logger.getLogger(PerpustakaanEbook.class.
            getName());
