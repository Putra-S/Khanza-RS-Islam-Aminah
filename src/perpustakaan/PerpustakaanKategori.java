...
public class PerpustakaanKategori extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("perpustakaan_kategori",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TKd.getText().trim().isEmpty()) {
            ...
            if (tbSpesialis.getSelectedRow() > -1) {
                Sequel.mengedit("perpustakaan_kategori", "id_kategori=?",
                        "id_kategori=?,nama_kategori=?", 3, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            PerpustakaanKategori dialog = new PerpustakaanKategori(
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select * from perpustakaan_kategori where id_kategori like ? or nama_kategori like ? order by id_kategori");
            try {
    ...
    private static final Logger LOG = Logger.getLogger(
            PerpustakaanKategori.class.getName());
}
