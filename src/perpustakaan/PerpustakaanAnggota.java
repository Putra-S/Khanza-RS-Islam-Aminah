...
public class PerpustakaanAnggota extends javax.swing.JDialog {
    ...
    public PerpustakaanAnggota(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null,
                new Object[]{"No.Anggota", "Nama Anggota", "Tempat Lahir", "Tgl.Lahir", "J.K.", "Alamat Anggota",
...
private void EmailKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_EmailKeyPressed
    ...
    public void tampil() {
        ...
        try {
            gabung = "";
            if (chkGabung.isSelected() == true) {
                gabung = " tgl_gabung between '" + Valid.SetTgl(Gabung1.getSelectedItem() + "") + "' and '"
                        + Valid.SetTgl(Gabung2.getSelectedItem() + "") + "' and ";
            }

            habis = "";
            if (ChkHabis.isSelected() == true) {
                habis = " masa_berlaku between '" + Valid.SetTgl(Habis1.getSelectedItem() + "") + "' and '"
                        + Valid.SetTgl(Habis2.getSelectedItem() + "") + "' and ";
            }
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + gabung + habis + " alamat like ? or " + gabung + habis + " no_telp like ? or " + gabung
                    + habis + " jenis_anggota like ? or " + gabung + habis + " nomer_id like ? "
                    + "order by no_anggota");
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    tabMode.addRow(new String[]{rs.getString("no_anggota"), rs.getString("nama_anggota"),
                        rs.getString("tmp_lahir"), rs.getString("tgl_lahir"), rs.getString("j_kel"),
                        rs.getString("alamat"), rs.getString("no_telp"), rs.getString("email"),
                        rs.getString("tgl_gabung"), rs.getString("masa_berlaku"), rs.getString("jenis_anggota"),
                        rs.getString("nomer_id")});
                }
            } catch (Exception e) {
    ...
    public void emptTeks() {
        ...
        Alamat.setText("");
        TCari.setText("");
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(no_anggota,8),signed)),0) from perpustakaan_anggota  ", "AP",
                8, NoAnggota);
    ...
    private void getData() {
        if (tbJnsPerawatan.getSelectedRow() != -1) {
            ...
            JK.setSelectedItem(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(), 4)
                    .toString()
    ...
    private static final Logger LOG = Logger.getLogger(PerpustakaanAnggota.class.getName());
