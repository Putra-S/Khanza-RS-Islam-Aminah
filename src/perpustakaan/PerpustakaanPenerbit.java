...
private void TAlamatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TAlamatKeyPressed
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "or perpustakaan_penerbit.no_telp like ? " + "or perpustakaan_penerbit.email like ? "
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(kode_penerbit,4),signed)),0) from perpustakaan_penerbit  ",
                "PK", 8, TKd);
        TKd.requestFocus();
    }
    ...
    private static final Logger LOG = Logger.getLogger(PerpustakaanPenerbit.class.getName());
