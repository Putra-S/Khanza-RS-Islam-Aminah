 ...
 * @author dosen
 */
public class ZISPengeluaranPenerimaDankes extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("zis_keterangan_pengeluaran_penerima_dankes",
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbKamar.getRowCount(); i++) {
            if (tbKamar.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("zis_keterangan_pengeluaran_penerima_dankes",
        ...
        if (Kd.getText().trim().isEmpty()) {
            ...
            if (tbKamar.getSelectedRow() > -1) {
                Valid.editTable(tabMode,
                        "zis_keterangan_pengeluaran_penerima_dankes", "kode",
...
private void NmKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ZISPengeluaranPenerimaDankes dialog = new ZISPengeluaranPenerimaDankes(
    ...
    private static final Logger LOG = Logger.getLogger(
            ZISPengeluaranPenerimaDankes.class.getName());
