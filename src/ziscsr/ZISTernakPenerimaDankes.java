 ...
 * @author dosen
 */
public class ZISTernakPenerimaDankes extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Sequel.menyimpan("zis_keterangan_ternak_penerima_dankes", "'" + Kd.
                    getText() + "','" + Nm.getText() + "'", "Kode");
            BtnCariActionPerformed(evt);
            emptTeks();
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for (i = 0; i < tbKamar.getRowCount(); i++) {
            if (tbKamar.getValueAt(i, 0).toString().equals("true")) {
                Sequel.meghapus("zis_keterangan_ternak_penerima_dankes", "kode",
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            if (tbKamar.getSelectedRow() > -1) {
                Valid.
                        editTable(tabMode,
                                "zis_keterangan_ternak_penerima_dankes", "kode",
...
private void NmKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select kode,keterangan  " + " from zis_keterangan_ternak_penerima_dankes where  kode like ? or "
    ...
    private static final Logger LOG = Logger.getLogger(ZISTernakPenerimaDankes.class.getName());
