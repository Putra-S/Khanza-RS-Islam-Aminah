...
public class SplashScreen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/logorsi.png"))); // NOI18N

        lbStatus.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbStatus.setText("Status");

        label1.setText("SIMRS RS ISLAM AMINAH BLITAR");
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    doTask("Menginisialisasi Aplikasi", 25);
                    doTask("Menginisialisasi Aplikasi", 50);
                    doTask("Menginisialisasi Aplikasi", 75);
                    doTask("Menginisialisasi Aplikasi", 100);
                    doTask("Done", 100);
                    utama.isWall();
                    dispose();
