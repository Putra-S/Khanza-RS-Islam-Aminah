...
*/
    ...
    private void kdsupKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdsupKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_PAGE_DOWN) {
            Sequel.cariIsi(
                    "select dapursuplier.nama_suplier from dapursuplier where dapursuplier.kode_suplier=?",
                    nmsup, kdsup.getText());
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRekapPengadaanDapur.jasper", "report",
                    "::[ Rekap Pengadaan Barang Dapur Kering & Basah ]::",
                    ...
                    + " where dapurpembelian.tgl_beli between '" + Valid.SetTgl(
                            TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                    SetTgl(TglBeli2.getSelectedItem() + "") + "' and dapurpembelian.no_faktur like '%" + NoFaktur.
                    getText().trim() + "%' and dapursuplier.nama_suplier like '%" + nmsup.
                            getText().trim() + "%' and petugas.nama like '%" + nmptg.
                            getText().trim() + "%'  and dapurbarang.jenis like '%" + Jenis.
                            getSelectedItem().toString().replaceAll("Semua", "").
                            trim() + "%' and dapurbarang.nama_brng like '%" + nmbar.
                            getText().trim() + "%' and "
                    + " (dapurpembelian.no_faktur like '%" + TCari.getText().
                            trim() + "%' or dapurpembelian.kode_suplier like '%" + TCari.
                            getText().trim() + "%' or dapursuplier.nama_suplier like '%" + TCari.
                            getText().trim() + "%' or dapurpembelian.nip like '%" + TCari.
                            getText().trim() + "%' or petugas.nama like '%" + TCari.
                            getText().trim() + "%' or dapurdetailbeli.kode_brng like '%" + TCari.
                            getText().trim() + "%' or dapurbarang.nama_brng like '%" + TCari.
                            getText().trim() + "%' or dapurdetailbeli.kode_sat like '%" + TCari.
                            getText().trim() + "%' or dapurbarang.jenis like '%" + TCari.
                            getText().trim() + "%') "
