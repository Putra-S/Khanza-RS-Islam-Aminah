...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void prosesCari() {
        try {
            ...
            ps = koneksi
                    .prepareStatement("select dapurpembelian.tgl_beli,sum(dapurpembelian.total) from dapurpembelian  "
    ...
    private static final Logger LOG = Logger.getLogger(DapurRBiayaHarian.class.getName());
