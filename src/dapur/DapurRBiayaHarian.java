...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRBiayaDapur.jasper", "report",
                    "[ Rekap Biaya Pengadaan Stok Keluar Barang Dapur Kering & Basah ]",
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DapurRBiayaHarian dialog = new DapurRBiayaHarian(
    ...
    private void prosesCari() {
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select dapurpembelian.tgl_beli,sum(dapurpembelian.total) from dapurpembelian  "
            ...
            try {
                ...
                jumlah = 0;
                while (rs.next()) {
                    tabMode.addRow(new Object[]{rs.getString(1), Valid.SetAngka(
                        rs.getDouble(2))});
    ...
    private static final Logger LOG = Logger.getLogger(DapurRBiayaHarian.class.
            getName());
