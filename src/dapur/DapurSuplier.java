...
public class DapurSuplier extends javax.swing.JDialog {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            Valid.editTable(tabMode, "dapursuplier", "kode_suplier", "?",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptSuplier.jasper", "report",
                    ...
                    + " where dapursuplier.kode_suplier like '%" + TCari.
                            getText().trim() + "%' or "
                    + " dapursuplier.nama_suplier like '%" + TCari.getText().
                            trim() + "%' or "
                    ...
                    + " dapursuplier.no_telp like '%" + TCari.getText().trim() + "%' order by dapursuplier.kode_suplier",
                    param);
        }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (Kd.getText().trim().isEmpty()) {
            ...
            if (Sequel.menyimpantf("dapursuplier", "?,?,?,?,?,?,?",
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("select dapursuplier.kode_suplier, dapursuplier.nama_suplier, "
                    ...
                    + " where dapursuplier.kode_suplier like ? or " + " dapursuplier.nama_suplier like ? or "
                    + " dapursuplier.alamat like ? or " + " dapursuplier.kota like ? or "
    ...
    private static final Logger LOG = Logger.getLogger(DapurSuplier.class.getName());
