...
private void btnSatuanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSatuanActionPerformed
                ...
                while (rs.next()) {
                    tabMode.addRow(
                            new Object[]{rs.getString("kode_brng"), rs.getString("nama_brng"), rs.getString("satuan"),
                                rs.getString("jenis"), rs.getDouble("stok"), rs.getDouble("harga")});
                }
            } catch (Exception e) {
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        KodeBarang.requestFocus();
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(dapurbarang.kode_brng,4),signed)),0) from dapurbarang  ", "D",
                5, KodeBarang);
        KodeBarang.requestFocus();
    }
    ...
    private void getData() {
        if (tbJnsPerawatan.getSelectedRow() != -1) {
            ...
            KodeSatuan
                    .setText(Sequel.cariIsi("select dapurbarang.kode_sat from dapurbarang where dapurbarang.kode_brng=?",
                            KodeBarang.getText()));
        }
    }
    ...
    private static final Logger LOG = Logger.getLogger(DapurBarang.class.getName());
