...
//GEN-FIRST:event_TKdKeyPressed
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReportqry("rptRingkasanPengadaanDapur.jasper", "report",
                    "::[ Laporan Ringkasan Pengadaan Barang Dapur ]::",
                    ...
                    getText() + "%' and dapursuplier.nama_suplier like '%" + nmsup.
                            getText() + "%' and petugas.nama like '%" + nmptg.
                            getText() + "%'  and dapurbarang.jenis like '%" + Jenis.
                            getSelectedItem().toString().replaceAll("Semua", "") + "%' and dapurbarang.nama_brng like '%" + nmbar.
                    getText() + "%' and "
                    + "(dapurpembelian.no_faktur like '%" + TCari.getText() + "%' or dapurpembelian.kode_suplier like '%" + TCari.
                    getText() + "%' or dapursuplier.nama_suplier like '%" + TCari.
                            getText() + "%' or dapurpembelian.nip like '%" + TCari.
                            getText() + "%' or petugas.nama like '%" + TCari.
                            getText() + "%' or dapurbarang.jenis like '%" + TCari.
                            getText() + "%' or dapurdetailbeli.kode_brng like '%" + TCari.
