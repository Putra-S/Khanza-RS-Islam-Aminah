...
//GEN-FIRST:event_TKdKeyPressed
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-LAST:event_TKdKeyPressed
        if (tabMode.getRowCount() == 0) {//GEN-FIRST:event_BtnPrintActionPerformed
            ...
            if (nmbar.getText().trim().isEmpty() && TCari.getText().trim().
                    isEmpty()) {
                Valid.MyReportqry("rptRiwayatBarangDapur.jasper", "report",
                        "::[ Riwayat Barang Dapur Kering & Basah ]::",
                        ...
                        + "dapur_riwayat_barang.tanggal between '" + Valid.
                                SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.
                        SetTgl(Tgl2.getSelectedItem() + "") + "' order by dapur_riwayat_barang.tanggal,dapur_riwayat_barang.jam ",
                        param);
            } else {
                Valid.MyReportqry("rptRiwayatBarangDapur.jasper", "report",
                        "::[ Riwayat Barang Dapur Kering & Basah ]::",
                        ...
                        + "dapur_riwayat_barang.tanggal between '" + Valid.
                                SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.
                        SetTgl(Tgl2.getSelectedItem() + "") + "' and dapurbarang.nama_brng like '%" + nmbar.
                        getText() + "%' and "
                        + "(dapur_riwayat_barang.kode_brng like '%" + TCari.
                                getText().trim() + "%' or dapurbarang.nama_brng like '%" + TCari.
                                getText().trim() + "%' or dapur_riwayat_barang.petugas like '%" + TCari.
                                getText().trim() + "%' or "
                        + "dapur_riwayat_barang.status like '%" + TCari.
                                getText().trim() + "%') order by dapur_riwayat_barang.tanggal,dapur_riwayat_barang.jam ",
                        param);
            }
    ...
    private void kdbarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdbarKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_PAGE_DOWN) {
            Sequel.
                    cariIsi("select nama_brng from dapurbarang where kode_brng=?",
                            nmbar, kdbar.getText());
        } else if (evt.getKeyCode() == KeyEvent.VK_PAGE_UP) {
            Sequel.
                    cariIsi("select nama_brng from dapurbarang where kode_brng=?",
    ...
    private void prosesCari() {
        ...
        try {
            if (nmbar.getText().trim().isEmpty() && TCari.getText().trim().isEmpty()) {
                ps = koneksi.prepareStatement("select dapur_riwayat_barang.kode_brng,dapurbarang.nama_brng,"
                        + "dapur_riwayat_barang.stok_awal,dapur_riwayat_barang.masuk,"
                        + "dapur_riwayat_barang.keluar,dapur_riwayat_barang.stok_akhir,"
                        + "dapur_riwayat_barang.posisi,dapur_riwayat_barang.tanggal,"
                        + "dapur_riwayat_barang.jam,dapur_riwayat_barang.petugas,"
    ...
    private static final Logger LOG = Logger.getLogger(DapurRiwayatBarang.class.getName());
