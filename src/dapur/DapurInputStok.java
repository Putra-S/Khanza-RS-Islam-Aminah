                    ...
                    if (!tbDokter.getValueAt(i, 0).toString().isEmpty()) {
                        try {
                            if (Valid.SetAngka(tbDokter.getValueAt(i, 0).
                                    toString()) >= 0) {
                                if (Sequel.menyimpantf2("dapuropname",
                                        "?,?,?,?,?,?,?,?,?,?", "Stok Opname", 10,
                                        new String[]{
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DapurInputStok dialog = new DapurInputStok(new javax.swing.JFrame(),
                    true);
    ...
    private static final Logger LOG = Logger.getLogger(DapurInputStok.class.
            getName());
