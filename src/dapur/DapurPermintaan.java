...
*/
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if (NoPermintaan.getText().trim().isEmpty()) {
        ...
        } else if (Ruangan.getText().trim().isEmpty()) {
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                sukses = true;
                if (Sequel.menyimpantf2("permintaan_dapur", "?,?,?,?,?",
                        "No.Permintaan", 5, new String[]{
                            NoPermintaan.getText(), Ruangan.getText(), kdptg.
                            getText(), Valid.SetTgl(
                                    Tanggal.getSelectedItem() + ""), "Baru"
                        }) == true) {
                        ...
                        try {
                            if (Valid.SetAngka(tbDokter.getValueAt(i, 0).
                                ...
                                if (Sequel.menyimpantf2(
                                        ...
                                        "Detail Permintaan", 5, new String[]{
...
private void btnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPetugasActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DapurPermintaan dialog = new DapurPermintaan(
    ...
    private void tampil() {
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    iyem = iyem + "{\"KodeBarang\":\"" + rs.getString(1) + "\",\"NamaBarang\":\"" + rs.
                            ...
                            getString(3) + "\",\"Jenis\":\"" + rs.getString(4) + "\"},";
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : " + e);
            } finally {
            ...
            fileWriter.write("{\"permintaandapur\":[" + iyem.substring(0, iyem.
                    length() - 1) + "]}");
            fileWriter.flush();
            fileWriter.close();
            iyem = null;
        ...
        try {
            ...
            for (i = 0; i < jml; i++) {
                tabMode.addRow(new Object[]{jumlah[i], kodebarang[i],
                    namabarang[i], satuan[i], jenis[i], keterangan[i]});
            }
                ...
                for (JsonNode list : response) {
                    if (list.path("KodeBarang").asText().toLowerCase().contains(
                            ...
                            "NamaBarang").asText().toLowerCase().contains(TCari.
                                    ...
                                    "Jenis").asText().toLowerCase().contains(
    ...
    private void autoNomor() {
        Valid.autoNomer3(
                "select ifnull(MAX(CONVERT(RIGHT(permintaan_dapur.no_permintaan,3),signed)),0) from permintaan_dapur where permintaan_dapur.tanggal='" + Valid.
                        SetTgl(Tanggal.getSelectedItem() + "") + "' ",
                "PD" + Tanggal.getSelectedItem().toString().substring(8, 10) + Tanggal.
                getSelectedItem().toString().substring(3, 5) + Tanggal.
                getSelectedItem().toString().substring(0, 2), 3, NoPermintaan);
    }

    private static final Logger LOG = Logger.getLogger(DapurPermintaan.class.
            getName());
