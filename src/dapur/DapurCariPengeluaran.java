...
//GEN-FIRST:event_TKdKeyPressed
    ...
    private void kdbarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdbarKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_PAGE_DOWN) {
            Sequel.cariIsi(
                    "select dapurbarang.nama_brng from dapurbarang where dapurbarang.kode_brng=?",
                    nmbar, kdbar.getText());
        } else if (evt.getKeyCode() == KeyEvent.VK_PAGE_UP) {
            Sequel.cariIsi(
                    "select dapurbarang.nama_brng from dapurbarang where dapurbarang.kode_brng=?",
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (TabRawat.getSelectedIndex() == 0) {
            ...
            if (tabMode.getRowCount() == 0) {
                ...
                Valid.MyReportqry("rptPengeluaranDapur.jasper", "report",
            ...
            if (tabMode2.getRowCount() == 0) {
                ...
                param.put("logo", Sequel.cariGambar(
                        "select setting.logo from setting"));
                Valid.MyReportqry("rptPengeluaranDapur2.jasper", "report",
                        "::[ Transaksi Pengeluaran Barang ]::",
                        ...
                        + "where dapurpengeluaran.tanggal between '" + Valid.
                                SetTgl(TglBeli1.getSelectedItem() + "") + "' and '" + Valid.
                        SetTgl(TglBeli2.getSelectedItem() + "") + "' and dapurpengeluaran.no_keluar like '%" + NoKeluar.
                        getText() + "%' and petugas.nama like '%" + nmptg.
                                getText() + "%'  and dapurbarang.jenis like '%" + Jenis.
                                getSelectedItem().toString().replaceAll("Semua",
                                        "") + "%' and dapurbarang.nama_brng like '%" + nmbar.
                                getText() + "%' and "
                        + "(dapurpengeluaran.no_keluar like '%" + TCari.
                                getText() + "%' or dapurpengeluaran.keterangan like '%" + TCari.
                                getText() + "%' or dapurpengeluaran.nip like '%" + TCari.
                                getText() + "%' or petugas.nama like '%" + TCari.
                                getText() + "%' or dapurbarang.jenis like '%" + TCari.
                                getText() + "%' or dapurdetailpengeluaran.kode_brng like '%" + TCari.
                                getText() + "%' or dapurbarang.nama_brng like '%" + TCari.
                                getText() + "%' or "
                        + "dapurdetailpengeluaran.kode_sat like '%" + TCari.
                                getText() + "%' or kodesatuan.satuan like '%" + TCari.
                                getText() + "%') order by dapurpengeluaran.tanggal,dapurpengeluaran.no_keluar ",
                        param);
            }
            this.setCursor(Cursor.getDefaultCursor());
        }
            ...
            try {
                ...
                while (rs2.next()) {
                    Trackbarang.catatRiwayat(rs2.getString("kode_brng"), rs2.
                            ...
                            getkode(), "Hapus");
                    Sequel.mengedit("dapurbarang", "kode_brng=?", "stok=stok+?",
                            2, new String[]{
                ...
                sukses = jur.simpanJurnal(tbDokter.getValueAt(tbDokter.
                        ...
                        "PEMBATALAN PENGGUNAAN BARANG DAPUR KERING DAN BASAH" + ", OLEH " + akses.
                                getkode());

                if (sukses == true) {
                    Sequel.queryu2(
                            "delete from dapurpengeluaran where no_keluar=?", 1,
